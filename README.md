...
* Latest Linux kernel (RaspberryPi: [4.14.79](https://github.com/raspberrypi/linux/tree/rpi-4.14.y), Tinkerboard: [4.14.89](https://github.com/armbian/build/tree/master/patch/kernel/rockchip-next)) with hard-float (ARMv7) support
...
* One or more of the following HomeMatic/HomeMatic-Wired/homematicIP/homematicIP-Wired capabale devices:
  * HomeMatic َ+ homematicIP:
    ...
    * USB Radio Module Adapter PCB – [HB-RF-USB](https://github.com/alexreinert/PCB/tree/master/HB-RF-USB)
  * homematicIP only:
