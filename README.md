...
## :cookie: Features
* 100% HomeMatic [CCU2](http://www.eq-3.com/products/homematic/control-units-and-gateways/homematic-central-control-unit-ccu2.html)/[CCU3](http://www.eq-3.com/products/homematic/control-units-and-gateways/-473.html) system compliant based on latest [OCCU 2.35.15](https://github.com/eq-3/occu) CCU software environment
