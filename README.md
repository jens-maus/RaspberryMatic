...
* Based on latest [Buildroot 2018.11](http://buildroot.org/) lightweight Linux operating system
* Latest Linux kernel (RaspberryPi: [4.14.79](https://github.com/raspberrypi/linux/tree/rpi-4.14.y), Tinkerboard: [4.14.87](https://github.com/armbian/build/tree/master/patch/kernel/rockchip-next)) with hard-float (ARMv7) support
