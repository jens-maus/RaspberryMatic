...
___
RaspberryMatic is a free and non-commercial OpenSource operating system alternative for running a _[CCU3](https://www.homematic-ip.com/en/products/detail/smart-home-central-control-unit-ccu3.html)_ or _[ELV Charly](https://www.elv.de/elv-smart-home-zentrale-charly-starter-set-bausatz.html)_ smart home central for providing a cloud-free [homematicIP](https://www.homematic-ip.com/) / [HomeMatic](http://homematic.com/) IoT hardware connectivity. RaspberryMatic has the aim to be 100% compatible to the vendor distributed _HomeMatic CCU3 control central_ (CCU3) for a cloud-free use of homematicIP/HomeMatic IoT hardware. It can be either installed on all kind of freely available single-board-computers (SBC) like a [RaspberryPi](https://www.raspberrypi.org/), [ASUS Tinkerboard](https://www.asus.com/Single-Board-Computer/Tinker-Board-S/), [Hardkernel ODROID](https://www.hardkernel.com/shop/odroid-c4/) or directly on a CCU3 hardware device. Alternatively, it can also be installed as a full virtual appliance on modern virtualization environments (e.g. Proxmox VE, VirtualBox, Docker/OCI, Kubernetes/K8s, Home Assistant, vmWare ESXi, etc.). On top of that wider range of supported operating platforms, it also provides a wide range of exclusive features on different levels (WebUI, Linux OS, connectivity, etc.) to support end users with an enhanced user experience compared to the standard vendor-provided CCU3 firmware distributed by [eQ-3](https://eq-3.de)/[ELV](https://elv.de/).
