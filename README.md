...
* Latest Linux kernel (RaspberryPi: [4.19.27](https://github.com/raspberrypi/linux/tree/rpi-4.19.y), Tinkerboard: [4.19.27](https://github.com/armbian/build/tree/master/patch/kernel/rockchip-next)) with hard-float (ARMv7) support
