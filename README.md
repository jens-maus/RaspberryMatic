...
* Latest Linux kernel (RaspberryPi: [4.14.34](https://github.com/raspberrypi/linux/tree/rpi-4.14.y), Tinkerboard: [4.14.52](https://github.com/rockchip-linux/kernel)) with hard-float (ARMv7) support
