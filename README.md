...
* Includes embedded JAVA8 runtime environment ([1.8.0_202-8.36.0.152](http://www.azul.com/downloads/zulu-embedded/))
...
* Based on latest [Buildroot 2019.02](http://buildroot.org/) lightweight Linux operating system
* Latest Linux kernel (RaspberryPi: [4.19.30](https://github.com/raspberrypi/linux/tree/rpi-4.19.y), Tinkerboard: [4.19.31](https://github.com/armbian/build/tree/master/patch/kernel/rockchip-next)) with hard-float (ARMv7) support
