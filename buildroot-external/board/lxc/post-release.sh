...
echo "$(stat -c %s "./release/RaspberryMatic-${PRODUCT_VERSION}-${BOARD}.tar.gz") $(cat "./release/RaspberryMatic-${PRODUCT_VERSION}-${BOARD}.tar.gz.sha256")" >>"./release/RaspberryMatic-${PRODUCT_VERSION}-${BOARD}.mf"
