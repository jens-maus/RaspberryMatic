...
# set bootargs
setenv bootargs "console=${console} kgdboc=${console} scandelay=5 root=${rootfs_str} ro rootfstype=ext4 fsck.repair=yes init_on_alloc=1 init_on_free=1 slab_nomerge iomem=relaxed pti=on rootwait rootdelay=5 consoleblank=120 quiet loglevel=${loglevel} net.ifnames=0 usb-storage.quirks=${usbstoragequirks} ${extraargs} ${bootargs}"
