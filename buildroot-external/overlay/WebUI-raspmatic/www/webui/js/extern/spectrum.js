...
(function (factory) {
    ...
    function spectrum(element, o) {
        ...
        function initialize() {
            ...
            inputRed.on("change", setTextInput);
            inputRed.on("keydown", function (e) { if (e.keyCode == 13) { inputGreen.focus().select(); }});
            inputGreen.on("change", setTextInput);
            inputGreen.on("keydown", function (e) { if (e.keyCode == 13) { inputBlue.focus().select(); }});
            inputBlue.on("change", setTextInput);
            inputBlue.on("keydown", function (e) { if (e.keyCode == 13) { inputRed.focus().select(); } });
        ...
        function updateOriginalInput(fireCallback) {
            ...
            if (isInput) {
                boundElement.val(convertWhiteValue(displayColor));
            }
