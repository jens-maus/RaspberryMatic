...
namespace XmlRpc {
  ...
  class XMLRPC_DLLEXPORT XmlRpcErrorHandler {
  public:
    ...
    //! Define virtual destructor to avoid compiler warnings
  ...
  class XMLRPC_DLLEXPORT XmlRpcLogHandler {
  public:
  ...
  int XMLRPC_DLLEXPORT getVerbosity();
  //! Sets log message verbosity. This is short for XmlRpcLogHandler::setVerbosity(level)
  void XMLRPC_DLLEXPORT setVerbosity(int level);
