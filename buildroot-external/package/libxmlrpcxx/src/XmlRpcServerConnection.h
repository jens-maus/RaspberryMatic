...
namespace XmlRpc {
  ...
  class XMLRPC_DLLEXPORT XmlRpcServerConnection : public XmlRpcSource {
  public:
    // Static data
	...
	static const int  BINARY_SIGNATURE_SIZE;
  ...
  protected:
    ...
    void generateResponse(XmlRpcValue& result);
	...
	// Whether the request has binary form
	bool _isBinary;
  };
} // namespace XmlRpc
