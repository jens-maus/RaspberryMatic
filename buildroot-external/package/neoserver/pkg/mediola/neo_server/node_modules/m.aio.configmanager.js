...
m.aio.configmanager.TenantsPersistHandler={load:function(a,b,c){var d=new m.aio.configmanager.Tenants;d.parent=a;var e=this,f=require("fs");f.readdir(b,function(a,k){a?c(a):require("async").eachSeries(k,function(a,c){var g=require("path");f.stat(b+g.sep+a,function(f,h){!f&&h.isDirectory()?m.aio.configmanager.TenantPersistHandler.load(d,b+g.sep+a,function(a,b){b?e._load(d,b,function(a,b){c(a,b)}):c()}):c()})},function(a){a?c(a):(d.sort(),c(null,d))})})},_load:function(a,b,c){var d=this;require("async").waterfall([function(c){d._preLoadNode(a,
b,c)},function(b,c){d._loadNode(a,b,c)},function(b,c){d._postLoadNode(a,b,c)}],function(a,b){c(a,b)})},_preLoadNode:function(a,b,c){var d=!1;if(!b.index||0>b.index)b.index=1,d=!0;b.name||(b.name="new_config",d=!0);do{var e=!1;for(var f=0;f<a.children.length;f++){var g=a.children[f];g.index==b.index&&(b.index++,e=d=!0);g.name==b.name&&(d=/[(]{1}[\d]+[)]{1}$/,d.test(b.name)?(e=b.name.match(d)[0],e=parseInt(e),e++,b.name=b.name.replace(d,"("+e+")")):b.name+="(0)",e=d=!0);g.license&&g.license.licenseTxt&&
b.license&&b.license.licenseTxt&&g.license.type==b.license.type&&g.license.id==b.license.id&&g.license.version==b.license.version&&(b.license=null,e=d=!0)}}while(e);d&&(b._changed=!0);c(null,b)},_loadNode:function(a,b,c){b.parent=a;a.children.push(b);c(null,b)},_postLoadNode:function(a,b,c){b._changed?m.aio.configmanager.TenantPersistHandler.save(a,b,function(a){delete b._changed;c(a,b)}):c(null,b)}};
...
m.aio.configmanager.PageContentPersistHandler={save:function(a,b,c,d){a=a.getFolderPath();var e=b.getFile(!0);if(a)if(e){var f=require("path");e=a+f.sep+e;if(c){var g=c.content;g||(g={});g.classid&&"control"===g.classid||(g.classid="control");g.index=b.index;b=require("fs-extra");var k=require("fs");b.ensureFile(e,function(a){a?d(a):(a=require("unorm").nfc(JSON.stringify(g)),k.writeFile(e,a,function(a){d(a)}))})}else d(Error("content is null"))}else d(Error("page file is null"));else d(Error("parent folder path is null"))},
