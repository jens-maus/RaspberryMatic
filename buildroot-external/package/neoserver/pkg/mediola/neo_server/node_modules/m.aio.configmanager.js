...
load:function(a,b){var c=new m.aio.configmanager.Config,d=require("path");this._loadSettings(a+d.sep+m.aio.configmanager.Config.SETTING,function(d){d?b(d):(c.folder=a,m.aio.configmanager.TenantsPersistHandler.load(c,a,function(a,d){a?b(a):(d.parent=c,c.tenants=d,b(null,c))}))})},_loadSettings:function(a,b){var c=require("fs");c.exists(a,function(d){d?c.readFile(a,function(a,c){if(a)b(a);else{a={};if(0<c.length)try{a=JSON.parse(c.toString())}catch(g){b(null,{});return}b(null,a)}}):b(null,{})})}};
...
m.aio.configmanager.Tenants.prototype.decideOnDefault=function(a){for(var b=!1,c=[],d=0;d<this.children.length;d++){var e=this.children[d];e.default&&(e.license?b=!0:c.push(e))}if(b&&0<c.length){var f=this,g=function(b){if(b>=c.length)a();else{var d=c[b];d.default=!1;m.aio.configmanager.TenantPersistHandler.save(f,d,function(a){g(b+1)})}};g(0)}else a()};m.aio.configmanager.Tenants.prototype.getFolderPath=function(){return this.parent?this.parent.getFolderPath():null};
...
m.aio.configmanager.TenantsPersistHandler={load:function(a,b,c){var d=new m.aio.configmanager.Tenants;d.parent=a;var e=this,f=require("fs");f.readdir(b,function(a,k){a?c(a):require("async").eachSeries(k,function(a,c){var g=require("path");f.stat(b+g.sep+a,function(f,h){!f&&h.isDirectory()?m.aio.configmanager.TenantPersistHandler.load(d,b+g.sep+a,function(a,b){b?e._load(d,b,function(a,b){c(a,b)}):c()}):c()})},function(a){a?c(a):(d.sort(),d.decideOnDefault(function(){c(null,d)}))})})},_load:function(a,
b,c){var d=this;require("async").waterfall([function(c){d._preLoadNode(a,b,c)},function(b,c){d._loadNode(a,b,c)},function(b,c){d._postLoadNode(a,b,c)}],function(a,b){c(a,b)})},_preLoadNode:function(a,b,c){var d=!1;if(!b.index||0>b.index)b.index=1,d=!0;b.name||(b.name="new_config",d=!0);do{var e=!1;for(var f=0;f<a.children.length;f++){var g=a.children[f];g.index==b.index&&(b.index++,e=d=!0);g.name==b.name&&(d=/[(]{1}[\d]+[)]{1}$/,d.test(b.name)?(e=b.name.match(d)[0],e=parseInt(e),e++,b.name=b.name.replace(d,
...
break}b=m.aio.configmanager.TenantJSONHandler.fromJSON(c);if(!b){d(Error("data format invalid"));break}var f=null,g=!1;if(b.name&&a.name!=b.name){for(c=0;c<e.children.length;c++){var k=e.children[c];if(k.name==b.name){d(Error("tenant name is already existed"));return}}g=!0;f=a.name;a.name=b.name}var h=!1,l=null;if(b.default){h=!0;for(c=0;c<e.children.length;c++)if(k=e.children[c],k.default){k.default=!1;l=k;break}a.default=b.default}var n=null,p=!1;if(b.license&&b.license.licenseTxt&&(!a.license||
a.license.licenseTxt!=b.license.licenseTxt)){if(!b.license.valid){d(Error("license invalid"));break}for(c=0;c<e.children.length;c++)if(k=e.children[c],k.index!=b.index&&k.license&&k.license.type==b.license.type&&k.license.id==b.license.id&&k.license.version==b.license.version){d(Error("tenant license is already existed"));return}p=!0;n=a.license;a.license=b.license}g||p||h?m.aio.configmanager.TenantPersistHandler.save(e,a,function(b){b?(g&&(a.id=f),p&&(a.license=n),h&&(a.default=!1,l&&(l.default=
!0)),d(b)):(p&&a.license&&!a.license.isTestLicense()&&require("m.aio.infomanager.js").retrieveInfo(),p&&a.license&&a.license.isTestLicense()&&(n&&n.id==a.license.id?(b=n.getStartDate(),a.license.saveStartDateWithDate(b)):a.license.saveStartDate()),h&&l?m.aio.configmanager.TenantPersistHandler.save(e,l,function(b){d(b,m.aio.configmanager.TenantJSONHandler.toJSON(a))}):d(null,m.aio.configmanager.TenantJSONHandler.toJSON(a)))}):d(null,m.aio.configmanager.TenantJSONHandler.toJSON(a));break;default:d(Error("no such method"))}}};
...
license:b.license?b.license.licenseTxt:null}),function(b){a(b)})}],function(a){c(a)})}else c(Error("tenant folder is null"));else c(Error("parent folder path is null"))},load:function(a,b,c){var d=new m.aio.configmanager.Tenant;d.parent=a;var e=require("path");this._loadSettings(b+e.sep+m.aio.configmanager.Tenant.SETTING,function(a,g){a?c(a):g?(d.index=g.index?g.index:-1,a=b.lastIndexOf(e.sep),d.folder=b.substr(a+1),d.name=g.name,d.license=g.license,d.default=g.default?!0:!1,d&&d.license&&(d.license.parent=
d,d.license.isTestLicense()&&!d.license.getStartDate()&&d.license.saveStartDate()),m.aio.configmanager.RemotesPersistHandler.load(d,b+e.sep+m.aio.configmanager.Tenant.REMOTES,function(a,b){a?c(a):(b.parent=d,d.remotes=b,c(null,d))})):c(null,null)})},_loadSettings:function(a,b){var c=require("fs");c.exists(a,function(d){d?c.readFile(a,function(a,c){if(a)b(a);else{a={};if(0<c.length)try{a=JSON.parse(c.toString())}catch(g){b(null,a);return}a.license&&(a.license=m.aio.configmanager.LicenseManager.resolve(a.license));
...
m.aio.configmanager.RemotesPersistHandler={load:function(a,b,c){var d=new m.aio.configmanager.Remotes;d.parent=a;var e=this,f=require("fs");f.exists(b,function(a){a?f.readdir(b,function(a,g){if(a)c(a);else{a=require("async");var l=require("path");a.eachSeries(g,function(a,c){f.stat(b+l.sep+a,function(f,g){!f&&g.isDirectory()?m.aio.configmanager.RemotePersistHandler.load(d,b+l.sep+a,function(a,b){b?e._load(d,b,function(a,b){c(a,b)}):c()}):c()})},function(a){a?c(a):(d.sort(),c(null,d))})}}):c(null,
...
b,c){var d=new m.aio.configmanager.Remote;d.parent=a;var e=require("path");this._loadSettings(b+e.sep+m.aio.configmanager.Remote.SETTING,function(a,g){a?c(a):g?(d.index=g.index?g.index:-1,d.skin=g.skin?g.skin:null,d.info=g.info?g.info:{},a=b.lastIndexOf(e.sep),d.id=b.substr(a+1),m.aio.configmanager.PagesPersistHandler.load(d,b+e.sep+m.aio.configmanager.Remote.PAGES,function(a,b){a?c(a):(b.parent=d,d.pages=b,c(null,d))})):c(null,null)})},_loadSettings:function(a,b){var c=require("fs");c.exists(a,function(d){d?
c.readFile(a,function(a,c){if(a)b(a);else{a={};if(0<c.length)try{a=JSON.parse(c.toString())}catch(g){b(null,a);return}b(null,a)}}):b(null,null)})},remove:function(a,b,c){var d=function(a){for(var b=require("fs"),c=require("path"),e=b.readdirSync(a),f=0;f<e.length;f++){var n=c.join(a,e[f]);console.log("try to delete:"+n);var p=b.statSync(n);"."!=n&&".."!=n&&(p.isDirectory()?(console.log(n+" is folder"),d(n)):(b.unlinkSync(n),console.log(n+" deleted ("+f+"/"+e.length+")")))}console.log("try to delete folder:"+
...
m.aio.configmanager.PagesPersistHandler={load:function(a,b,c){var d=m.aio.configmanager.Page.FILE_EXT,e=new m.aio.configmanager.Pages;e.parent=a;var f=this,g=require("fs");g.exists(b,function(a){a?g.readdir(b,function(a,l){if(a)c(a);else{a=require("async");var h=require("path");a.eachLimit(l,10,function(a,c){var l=h.extname(a);l==d.PAGE||l==d.POPUP?g.stat(b+h.sep+a,function(d,l){!d&&l.isFile()?m.aio.configmanager.PagePersistHandler.load(e,b+h.sep+a,function(a,b){b?f._load(e,b,function(a,b){c(a,b)}):
c()}):c()}):c()},function(a){e.sort();a?c(a):c(null,e)})}}):c(null,e)})},_load:function(a,b,c){var d=this;require("async").waterfall([function(c){d._preLoadNode(a,b,c)},function(b,c){d._loadNode(a,b,c)},function(c,f){d._postLoadNode(a,b,f)}],function(a,b){c(a,b)})},_preLoadNode:function(a,b,c){var d=!1;if(!b.index||0>b.index)b.index=1,d=!0;do{var e=!1;for(var f=0;f<a.children.length;f++)a.children[f].index==b.index&&(b.index++,e=d=!0)}while(e);d&&(b._changed=!0);c(null,b)},_loadNode:function(a,b,
c){b.parent=a;a.children.push(b);c(null,b)},_postLoadNode:function(a,b,c){b._changed?m.aio.configmanager.PagePersistHandler.save(a,b,function(a){delete b._changed;c(a,b)}):c(null,b)}};m.aio.configmanager.Page=function(a){m.aio.configmanager.Node.call(this,a);this.parent=a;this.index=-1;this.id=null;this.isPopup=!1};m.aio.configmanager.Page.prototype=Object.create(m.aio.configmanager.Node.prototype);m.aio.configmanager.Page.prototype.constructor=m.aio.configmanager.Page;
...
new m.aio.configmanager.Page;f.parent=a;var g=require("fs");g.exists(b,function(a){a?g.readFile(b,function(a,l){if(a)c(a);else{a=require("path");a=b.lastIndexOf(a.sep);var g=b.substr(a+1),h=!1;a=g.indexOf(e.PAGE);0<=a&&a===g.length-e.PAGE.length&&(h=!0,f.id=g.replace(e.PAGE,""));a=g.indexOf(e.POPUP);0<=a&&a===g.length-e.POPUP.length&&(h=!0,f.id=g.replace(e.POPUP,""),f.isPopup=!0);if(h){if(0<l.length)try{var k=JSON.parse(l.toString());f.index=k.index}catch(q){d.saveDamageFile(b,l,function(){c(null,
...
m.aio.configmanager.PageContent.prototype.processResourceList=function(a,b,c){var d=function(a,b,c){return b?a.processResourceSync(b,c):null},e=function(a,b){if(b&&b.states&&"object"===typeof b.states){var c="string"===typeof b.path?b.path.length:0,e;for(e in b.states){var f=b.states[e];if(f&&"object"===typeof f&&"string"===typeof f.i){var l=0!==f.p&&"string"===typeof b.path;h=d(a,l?b.path+"/"+f.i:f.i,f.s);k=k||!!h;h&&(f=l?c+1:0,0===f&&"/"==h[0]&&f++,b.states[e].i=h.substr(f))}}}},f=function(a,b){if(b&&
b.info&&"object"===typeof b.info){var c="string"===typeof b.info.path?b.info.path+"/":"",e;for(e in b.info){var f=b.info[e];"path"!=e&&f&&"string"===typeof f&&(h=d(a,c+f,b.img_skin),k=k||!!h,h&&(b.info[e]=h.substr(0<c.length?c.length:1)))}}};try{var g,k=!1;if(this.content){if(this.content.widget&&this.content.widget.bgimg){var h=d(b,this.content.widget.bgimg,this.content.widget.bgimg_skin);k=k||!!h;h&&(this.content.widget.bgimg=h)}this.content.infos&&this.content.infos.forEach(function(c){if(c.widget){h=
d(b,c.widget.img,c.widget.img_skin);k=k||!!h;h&&(c.widget.img=h);h=d(b,c.widget.bgimg,c.widget.bgimg_skin);k=k||!!h;h&&(c.widget.bgimg=h);if(c.widget.path&&c.widget.images)for(g=0;g<c.widget.images.length;g++){var l=c.widget.images[g];if(l){var p=0<=l.indexOf("/")?"":c.widget.path+"/";h=d(b,p+l,c.widget.img_skin);k=k||!!h;h&&(c.widget.images[g]=h.substr(p.length))}}c.widget._default&&"string"===typeof c.widget._default&&b.processDefaultImageSync(c.widget);e(b,c.widget);f(b,c.widget);"string"===typeof c.widget.stateRuleRef&&
a&&a.parent&&(l=(l=a.parent.parent)&&l.info&&l.info.stateRules)&&l[c.widget.stateRuleRef]&&e(b,l[c.widget.stateRuleRef])}});this.content.buttons&&this.content.buttons.forEach(function(c){if(c.widget){h=d(b,c.widget.img,c.widget.img_skin);k=k||!!h;h&&(c.widget.img=h);h=d(b,c.widget.bgimg,c.widget.bgimg_skin);k=k||!!h;h&&(c.widget.bgimg=h);if(c.widget.path&&c.widget.images)for(g=0;g<c.widget.images.length;g++){var l=c.widget.images[g];if(l){var p=0<=l.indexOf("/")?"":c.widget.path+"/";h=d(b,p+l,c.widget.img_skin);
k=k||!!h;h&&(c.widget.images[g]=h.substr(p.length))}}c.widget._default&&"string"===typeof c.widget._default&&b.processDefaultImageSync(c.widget);e(b,c.widget);f(b,c.widget);"string"===typeof c.widget.stateRuleRef&&a&&a.parent&&(l=(l=a.parent.parent)&&l.info&&l.info.stateRules)&&l[c.widget.stateRuleRef]&&e(b,l[c.widget.stateRuleRef])}});this.content.selects&&this.content.selects.forEach(function(a){a.widget&&(h=d(b,a.widget.img_n,a.widget.img_skin_n),k=k||!!h,h&&(a.widget.img_n=h),h=d(b,a.widget.img_y,
a.widget.img_skin_y),k=k||!!h,h&&(a.widget.img_y=h),h=d(b,a.widget.bgimg,a.widget.bgimg_skin),k=k||!!h,h&&(a.widget.bgimg=h))});this.content.sliders&&this.content.sliders.forEach(function(a){a.widget&&(a=a.widget)&&b.processWidgetSync(a)});this.content.roundsliders&&this.content.roundsliders.forEach(function(a){a.widget&&(a=a.widget)&&b.processWidgetSync(a)});this.content.colorchoosers&&this.content.colorchoosers.forEach(function(a){a.widget&&(a=a.widget)&&b.processWidgetSync(a)});this.content.analogmeters&&
this.content.analogmeters.forEach(function(a){a.widget&&(a=a.widget)&&b.processWidgetSync(a)});this.content.amps&&this.content.amps.forEach(function(a){a.widget&&(a=a.widget)&&b.processWidgetSync(a)})}k?m.aio.configmanager.PageContentPersistHandler.save(a.parent,a,this,function(a){c&&c(a)}):c&&c(null)}catch(l){c&&c(l)}};
...
m.aio.configmanager.PageContentPersistHandler={save:function(a,b,c,d){a=a.getFolderPath();var e=b.getFile(!0);if(a)if(e){var f=require("path");e=a+f.sep+e;if(c){var g=c.content;g||(g={});g.classid&&"control"===g.classid||(g.classid="control");g.index=b.index;b=require("fs-extra");var k=require("fs");b.ensureFile(e,function(a){if(a)d(a);else{a=require("unorm");var b=null;try{b=a.nfc(JSON.stringify(g))}catch(n){d(n);return}b?k.writeFile(e,b,function(a){d(a)}):d(Error("Stringified and normalized data is empty."))}})}else d(Error("content is null"))}else d(Error("page file is null"));
else d(Error("parent folder path is null"))},load:function(a,b){var c=new m.aio.configmanager.PageContent,d=require("fs");d.exists(a,function(e){e?d.readFile(a,function(a,d){if(a)b(a);else{if(0<d.length)try{c.content=JSON.parse(d.toString())}catch(k){b(null,c);return}b(null,c)}}):b(null,c)})},loadSync:function(a){var b=new m.aio.configmanager.PageContent,c=require("fs");try{var d=c.readFileSync(a);0<d.length&&(b.content=JSON.parse(d.toString()))}catch(e){}return b}};m.aio.configmanager.Util={FILENAME_REGEX:/[\\/:"*?<>|]+/g};
