...
m.aio.configmanager.TenantsPersistHandler={load:function(a,b,c){var d=new m.aio.configmanager.Tenants;d.parent=a;var e=this,f=require("fs");f.readdir(b,function(a,k){a?c(a):require("async").eachSeries(k,function(a,c){var g=require("path");f.stat(b+g.sep+a,function(f,l){!f&&l.isDirectory()?m.aio.configmanager.TenantPersistHandler.load(d,b+g.sep+a,function(a,b){b?e._load(d,b,function(a,b){c(a,b)}):c()}):c()})},function(a){a?c(a):(d.sort(),c(null,d))})})},_load:function(a,b,c){var d=this;require("async").waterfall([function(c){d._preLoadNode(a,
...
function(a,b){require("m.aio.devicemanager.js").saveRemote(a,function(c){b(c,a)})}.bind(this),function(a,b){require("m.aio.macromanager.js").saveRemote(a,function(c){b(c,a)})}.bind(this),function(a,b){require("m.aio.skinmanager.js").saveRemote(a,e,function(c,e){c?b(c):(a.skin=e.skin,m.aio.configmanager.RemotePersistHandler.save(d,a,function(c){b(c,m.aio.configmanager.RemoteJSONHandler.toJSON(a))}))})}.bind(this)],function(a,b){c&&c(a,b)}):c(Error("data format invalid:id is empty")):c(Error("data format invalid"))}else c(Error("remote is isolated"))}};
...
m.aio.configmanager.PagesPersistHandler={load:function(a,b,c){var d=new m.aio.configmanager.Pages;d.parent=a;var e=this,f=require("fs");f.exists(b,function(a){a?f.readdir(b,function(a,g){if(a)c(a);else{a=require("async");var l=require("path");a.eachLimit(g,10,function(a,c){".p"==l.extname(a)?f.stat(b+l.sep+a,function(f,g){!f&&g.isFile()?m.aio.configmanager.PagePersistHandler.load(d,b+l.sep+a,function(a,b){b?e._load(d,b,function(a,b){c(a,b)}):c()}):c()}):c()},function(a){d.sort();a?c(a):c(null,d)})}}):
c(null,d)})},_load:function(a,b,c){var d=this;require("async").waterfall([function(c){d._preLoadNode(a,b,c)},function(b,c){d._loadNode(a,b,c)},function(c,f){d._postLoadNode(a,b,f)}],function(a,b){c(a,b)})},_preLoadNode:function(a,b,c){var d=!1;if(!b.index||0>b.index)b.index=1,d=!0;do{var e=!1;for(var f=0;f<a.children.length;f++)a.children[f].index==b.index&&(b.index++,e=d=!0)}while(e);d&&(b._changed=!0);c(null,b)},_loadNode:function(a,b,c){b.parent=a;a.children.push(b);c(null,b)},_postLoadNode:function(a,
...
a;var f=require("fs");f.exists(b,function(a){a?f.readFile(b,function(a,f){if(a)c(a);else{a=require("path");a=b.lastIndexOf(a.sep);var l=b.substr(a+1);a=l.indexOf(".p");if(-1==a||a!=l.length-2)c(null,null);else{e.id=l.replace(".p","");if(0<f.length)try{var g=JSON.parse(f.toString());e.index=g.index}catch(p){d.saveDamageFile(b,f,function(){c(null,e)});return}c(null,e)}}}):c(null,null)})},saveDamageFile:function(a,b,c){require("fs").writeFile(a+".bk",b,c)},remove:function(a,b,c){a=a.getFolderPath();
...
b.info&&"object"===typeof b.info){var c="string"===typeof b.info.path?b.info.path+"/":"",e;for(e in b.info){var f=b.info[e];"path"!=e&&f&&"string"===typeof f&&(h=d(a,c+f,b.img_skin),k=k||!!h,h&&(b.info[e]=h.substr(0<c.length?c.length+2:1)))}}};try{var g,k=!1;if(this.content){if(this.content.widget&&this.content.widget.bgimg){var h=d(b,this.content.widget.bgimg,this.content.widget.bgimg_skin);k=k||!!h;h&&(this.content.widget.bgimg=h)}this.content.infos&&this.content.infos.forEach(function(c){if(c.widget){h=
d(b,c.widget.img,c.widget.img_skin);k=k||!!h;h&&(c.widget.img=h);h=d(b,c.widget.bgimg,c.widget.bgimg_skin);k=k||!!h;h&&(c.widget.bgimg=h);if(c.widget.path&&c.widget.images)for(g=0;g<c.widget.images.length;g++){var l=c.widget.images[g];l&&(h=d(b,c.widget.path+"/"+l,c.widget.img_skin),k=k||!!h,h&&(c.widget.images[g]=h.substr(c.widget.path.length+1)))}e(b,c.widget);f(b,c.widget);"string"===typeof c.widget.stateRuleRef&&a&&a.parent&&(l=(l=a.parent.parent)&&l.info&&l.info.stateRules)&&l[c.widget.stateRuleRef]&&
e(b,l[c.widget.stateRuleRef])}});this.content.buttons&&this.content.buttons.forEach(function(c){if(c.widget){h=d(b,c.widget.img,c.widget.img_skin);k=k||!!h;h&&(c.widget.img=h);h=d(b,c.widget.bgimg,c.widget.bgimg_skin);k=k||!!h;h&&(c.widget.bgimg=h);if(c.widget.path&&c.widget.images)for(g=0;g<c.widget.images.length;g++){var l=c.widget.images[g];l&&(h=d(b,c.widget.path+"/"+l,c.widget.img_skin),k=k||!!h,h&&(c.widget.images[g]=h.substr(c.widget.path.length+1)))}e(b,c.widget);f(b,c.widget);"string"===
typeof c.widget.stateRuleRef&&a&&a.parent&&(l=(l=a.parent.parent)&&l.info&&l.info.stateRules)&&l[c.widget.stateRuleRef]&&e(b,l[c.widget.stateRuleRef])}});this.content.selects&&this.content.selects.forEach(function(a){a.widget&&(h=d(b,a.widget.img_n,a.widget.img_skin_n),k=k||!!h,h&&(a.widget.img_n=h),h=d(b,a.widget.img_y,a.widget.img_skin_y),k=k||!!h,h&&(a.widget.img_y=h),h=d(b,a.widget.bgimg,a.widget.bgimg_skin),k=k||!!h,h&&(a.widget.bgimg=h))});this.content.sliders&&this.content.sliders.forEach(function(a){a.widget&&
(a=a.widget)&&b.processWidgetSync(a)});this.content.roundsliders&&this.content.roundsliders.forEach(function(a){a.widget&&(a=a.widget)&&b.processWidgetSync(a)});this.content.colorchoosers&&this.content.colorchoosers.forEach(function(a){a.widget&&(a=a.widget)&&b.processWidgetSync(a)});this.content.analogmeters&&this.content.analogmeters.forEach(function(a){a.widget&&(a=a.widget)&&b.processWidgetSync(a)});this.content.amps&&this.content.amps.forEach(function(a){a.widget&&(a=a.widget)&&b.processWidgetSync(a)})}k?
m.aio.configmanager.PageContentPersistHandler.save(a.parent,a,this,function(a){c&&c(a)}):c&&c(null)}catch(l){c&&c(l)}};
...
m.aio.configmanager.PageContentPersistHandler={save:function(a,b,c,d){a=a.getFolderPath();var e=b.getFile();if(a)if(e){var f=require("path");e=a+f.sep+e+".p";if(c){var g=c.content;g||(g={});g.classid&&"control"===g.classid||(g.classid="control");g.index=b.index;b=require("fs-extra");var k=require("fs");b.ensureFile(e,function(a){a?d(a):(a=require("unorm").nfc(JSON.stringify(g)),k.writeFile(e,a,function(a){d(a)}))})}else d(Error("content is null"))}else d(Error("page file is null"));else d(Error("parent folder path is null"))},
