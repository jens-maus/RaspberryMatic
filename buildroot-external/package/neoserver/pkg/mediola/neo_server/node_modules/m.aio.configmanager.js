...
m.aio.configmanager.ConfigPersistHandler={save:function(a,b){var c=a.getFolderPath();if(c){a=require("async");var d=require("fs");a.series([function(a){d.exists(c,function(b){b?d.stat(c,function(b,d){b?a(b):d.isDirectory()?a():a(Error(c+" is not a folder"))}):require("fs-extra").mkdirs(c,function(b){a(b)})})},function(a){var b=require("path");d.writeFile(c+b.sep+m.aio.configmanager.Config.SETTING,JSON.stringify({}),function(b){a(b)})}],function(a){b(a)})}else b(Error("folder of the config is invalid"))},
load:function(a,b){var c=new m.aio.configmanager.Config,d=require("path");this._loadSettings(a+d.sep+m.aio.configmanager.Config.SETTING,function(d){d?b(d):(c.folder=a,m.aio.configmanager.TenantsPersistHandler.load(c,a,function(a,d){a?b(a):(d.parent=c,c.tenants=d,b(null,c))}))})},_loadSettings:function(a,b){var c=require("fs");c.exists(a,function(d){d?c.readFile(a,function(a,c){if(a)b(a);else{a={};if(0<c.length)try{a=JSON.parse(c.toString())}catch(h){b(null,{});return}b(null,a)}}):b(null,{})})}};
...
m.aio.configmanager.Tenants.prototype.decideOnDefault=function(a){for(var b=!1,c=[],d=0;d<this.children.length;d++){var e=this.children[d];e.default&&(e.license?b=!0:c.push(e))}if(b&&0<c.length){var f=this,h=function(b){if(b>=c.length)a();else{var d=c[b];d.default=!1;m.aio.configmanager.TenantPersistHandler.save(f,d,function(a){h(b+1)})}};h(0)}else a()};m.aio.configmanager.Tenants.prototype.getFolderPath=function(){return this.parent?this.parent.getFolderPath():null};
...
m.aio.configmanager.TenantsPersistHandler={load:function(a,b,c){var d=new m.aio.configmanager.Tenants;d.parent=a;var e=this,f=require("fs");f.readdir(b,function(a,l){a?c(a):require("async").eachSeries(l,function(a,c){var h=require("path");f.stat(b+h.sep+a,function(f,k){!f&&k.isDirectory()?m.aio.configmanager.TenantPersistHandler.load(d,b+h.sep+a,function(a,b){b?e._load(d,b,function(a,b){c(a,b)}):c()}):c()})},function(a){a?c(a):(d.sort(),d.decideOnDefault(function(){c(null,d)}))})})},_load:function(a,
b,c){var d=this;require("async").waterfall([function(c){d._preLoadNode(a,b,c)},function(b,c){d._loadNode(a,b,c)},function(b,c){d._postLoadNode(a,b,c)}],function(a,b){c(a,b)})},_preLoadNode:function(a,b,c){var d=!1;if(!b.index||0>b.index)b.index=1,d=!0;b.name||(b.name="new_config",d=!0);do{var e=!1;for(var f=0;f<a.children.length;f++){var h=a.children[f];h.index==b.index&&(b.index++,e=d=!0);h.name==b.name&&(d=/[(]{1}[\d]+[)]{1}$/,d.test(b.name)?(e=b.name.match(d)[0],e=parseInt(e),e++,b.name=b.name.replace(d,
"("+e+")")):b.name+="(0)",e=d=!0);h.license&&h.license.licenseTxt&&b.license&&b.license.licenseTxt&&h.license.type==b.license.type&&h.license.id==b.license.id&&h.license.version==b.license.version&&(b.license=null,e=d=!0)}}while(e);d&&(b._changed=!0);c(null,b)},_loadNode:function(a,b,c){b.parent=a;a.children.push(b);c(null,b)},_postLoadNode:function(a,b,c){b._changed?m.aio.configmanager.TenantPersistHandler.save(a,b,function(a){delete b._changed;c(a,b)}):c(null,b)}};
...
break}b=m.aio.configmanager.TenantJSONHandler.fromJSON(c);if(!b){d(Error("data format invalid"));break}var f=null,h=!1;if(b.name&&a.name!=b.name){for(c=0;c<e.children.length;c++){var l=e.children[c];if(l.name==b.name){d(Error("tenant name is already existed"));return}}h=!0;f=a.name;a.name=b.name}var g=!1,k=null;if(b.default){g=!0;for(c=0;c<e.children.length;c++)if(l=e.children[c],l.default){l.default=!1;k=l;break}a.default=b.default}var p=null,n=!1;if(b.license&&b.license.licenseTxt&&(!a.license||
a.license.licenseTxt!=b.license.licenseTxt)){if(!b.license.valid){d(Error("license invalid"));break}for(c=0;c<e.children.length;c++)if(l=e.children[c],l.index!=b.index&&l.license&&l.license.type==b.license.type&&l.license.id==b.license.id&&l.license.version==b.license.version){d(Error("tenant license is already existed"));return}n=!0;p=a.license;a.license=b.license}h||n||g?m.aio.configmanager.TenantPersistHandler.save(e,a,function(b){b?(h&&(a.id=f),n&&(a.license=p),g&&(a.default=!1,k&&(k.default=
!0)),d(b)):(n&&a.license&&!a.license.isTestLicense()&&require("m.aio.infomanager.js").retrieveInfo(),n&&a.license&&a.license.isTestLicense()&&(p&&p.id==a.license.id?(b=p.getStartDate(),a.license.saveStartDateWithDate(b)):a.license.saveStartDate()),g&&k?m.aio.configmanager.TenantPersistHandler.save(e,k,function(b){d(b,m.aio.configmanager.TenantJSONHandler.toJSON(a))}):d(null,m.aio.configmanager.TenantJSONHandler.toJSON(a)))}):d(null,m.aio.configmanager.TenantJSONHandler.toJSON(a));break;default:d(Error("no such method"))}}};
...
license:b.license?b.license.licenseTxt:null}),function(b){a(b)})}],function(a){c(a)})}else c(Error("tenant folder is null"));else c(Error("parent folder path is null"))},load:function(a,b,c){var d=new m.aio.configmanager.Tenant;d.parent=a;var e=require("path");this._loadSettings(b+e.sep+m.aio.configmanager.Tenant.SETTING,function(a,h){a?c(a):h?(d.index=h.index?h.index:-1,a=b.lastIndexOf(e.sep),d.folder=b.substr(a+1),d.name=h.name,d.license=h.license,d.default=h.default?!0:!1,d&&d.license&&(d.license.parent=
d,d.license.isTestLicense()&&!d.license.getStartDate()&&d.license.saveStartDate()),m.aio.configmanager.RemotesPersistHandler.load(d,b+e.sep+m.aio.configmanager.Tenant.REMOTES,function(a,b){a?c(a):(b.parent=d,d.remotes=b,c(null,d))})):c(null,null)})},_loadSettings:function(a,b){var c=require("fs");c.exists(a,function(d){d?c.readFile(a,function(a,c){if(a)b(a);else{a={};if(0<c.length)try{a=JSON.parse(c.toString())}catch(h){b(null,a);return}a.license&&(a.license=m.aio.configmanager.LicenseManager.resolve(a.license));
b(null,a)}}):b(null,null)})},remove:function(a,b,c){a=a.getFolderPath();b=b.getFolder();if(a)if(b){var d=require("path");b=a+d.sep+b;require("fs-extra").remove(b,function(a){c(a)})}else c(Error("tenant folder is null"));else c(Error("parent folder path is null"))}};m.aio.configmanager.Remotes=function(a){m.aio.configmanager.ListNode.call(this,a);this.parent=a;this.children=[]};m.aio.configmanager.Remotes.prototype=Object.create(m.aio.configmanager.ListNode.prototype);
...
m.aio.configmanager.RemotesPersistHandler={load:function(a,b,c){var d=new m.aio.configmanager.Remotes;d.parent=a;var e=this,f=require("fs");f.exists(b,function(a){a?f.readdir(b,function(a,h){if(a)c(a);else{a=require("async");var k=require("path");a.eachSeries(h,function(a,c){f.stat(b+k.sep+a,function(f,h){!f&&h.isDirectory()?m.aio.configmanager.RemotePersistHandler.load(d,b+k.sep+a,function(a,b){b?e._load(d,b,function(a,b){c(a,b)}):c()}):c()})},function(a){a?c(a):(d.sort(),c(null,d))})}}):c(null,
d)})},_load:function(a,b,c){var d=this;require("async").waterfall([function(c){d._preLoadNode(a,b,c)},function(b,c){d._loadNode(a,b,c)},function(b,c){d._postLoadNode(a,b,c)}],function(a,b){c(a,b)})},_preLoadNode:function(a,b,c){var d=!1;if(!b.index||0>b.index)b.index=1,d=!0;do{var e=!1;for(var f=0;f<a.children.length;f++)a.children[f].index==b.index&&(b.index++,e=d=!0)}while(e);d&&(b._changed=!0);c(null,b)},_loadNode:function(a,b,c){b.parent=a;a.children.push(b);c(null,b)},_postLoadNode:function(a,
...
b,c){var d=new m.aio.configmanager.Remote;d.parent=a;var e=require("path");this._loadSettings(b+e.sep+m.aio.configmanager.Remote.SETTING,function(a,h){a?c(a):h?(d.index=h.index?h.index:-1,d.skin=h.skin?h.skin:null,d.info=h.info?h.info:{},a=b.lastIndexOf(e.sep),d.id=b.substr(a+1),m.aio.configmanager.PagesPersistHandler.load(d,b+e.sep+m.aio.configmanager.Remote.PAGES,function(a,b){a?c(a):(b.parent=d,d.pages=b,c(null,d))})):c(null,null)})},_loadSettings:function(a,b){var c=require("fs");c.exists(a,function(d){d?
c.readFile(a,function(a,c){if(a)b(a);else{a={};if(0<c.length)try{a=JSON.parse(c.toString())}catch(h){b(null,a);return}b(null,a)}}):b(null,null)})},remove:function(a,b,c){var d=function(a){for(var b=require("fs"),c=require("path"),e=b.readdirSync(a),f=0;f<e.length;f++){var p=c.join(a,e[f]);console.log("try to delete:"+p);var n=b.statSync(p);"."!=p&&".."!=p&&(n.isDirectory()?(console.log(p+" is folder"),d(p)):(b.unlinkSync(p),console.log(p+" deleted ("+f+"/"+e.length+")")))}console.log("try to delete folder:"+
a);b.rmdirSync(a);console.log("folder:"+a+" deleted")};a=a.getFolderPath();b=b.getFolder();if(a)if(b){var e=require("path");b=a+e.sep+b;try{d(b),c()}catch(f){console.error(f),c(f)}}else c(Error("remote folder is null"));else c(Error("parent folder path is null"))},move:function(a,b,c,d){a=a.getFolderPath();b=b.getFolder();if(a)if(b){var e=require("path");b=a+e.sep+b;c=a+e.sep+c;a=require("fs");console.log("start to move remote folder");a.rename(b,c,function(a){d(a)})}else d(Error("remote folder is null"));
...
m.aio.configmanager.PagesPersistHandler={load:function(a,b,c){var d=m.aio.configmanager.Page.FILE_EXT,e=new m.aio.configmanager.Pages;e.parent=a;var f=this,h=require("fs");h.exists(b,function(a){a?h.readdir(b,function(a,k){if(a)c(a);else{a=require("async");var g=require("path");a.eachLimit(k,10,function(a,c){var k=g.extname(a);if(k!==d.PAGE&&k!==d.POPUP)c();else{var p=b+g.sep+a;h.stat(p,function(a,b){a||!b.isFile()?c(a):m.aio.configmanager.PagePersistHandler.load(e,p,function(a,b){b?f._load(e,b,function(a,
b){c(a,b)}):c()})})}},function(a){e.sort();a?c(a):c(null,e)})}}):c(null,e)})},_load:function(a,b,c){var d=this;require("async").waterfall([function(c){d._preLoadNode(a,b,c)},function(b,c){d._loadNode(a,b,c)},function(c,f){d._postLoadNode(a,b,f)}],function(a,b){c(a,b)})},_preLoadNode:function(a,b,c){var d=!1;if(!b.index||0>b.index)b.index=1,d=!0;do{var e=!1;for(var f=0;f<a.children.length;f++)a.children[f].index==b.index&&(b.index++,e=d=!0)}while(e);d&&(b._changed=!0);c(null,b)},_loadNode:function(a,
b,c){b.parent=a;a.children.push(b);c(null,b)},_postLoadNode:function(a,b,c){b._changed?m.aio.configmanager.PagePersistHandler.save(a,b,function(a){delete b._changed;c(a,b)}):c(null,b)}};m.aio.configmanager.Page=function(a){m.aio.configmanager.Node.call(this,a);this.parent=a;this.index=-1;this.id=null;this.isPopup=!1};m.aio.configmanager.Page.prototype=Object.create(m.aio.configmanager.Node.prototype);m.aio.configmanager.Page.prototype.constructor=m.aio.configmanager.Page;
...
m.aio.configmanager.PagePersistHandler={save:function(a,b,c){var d=a.getFolderPath(),e=b.getFile(!0);if(d)if(e){var f=require("path");e=d+f.sep+e;m.aio.configmanager.PageContentPersistHandler.load(e,function(d,e){d?c(d):(e.content||(e.content={}),e.content.index=b.index,m.aio.configmanager.PageContentPersistHandler.save(a,b,e,function(a){c(a,b)}))})}else c(Error("page file is null"));else c(Error("parent folder path is null"))},load:function(a,b,c){var d=this,e=m.aio.configmanager.Page.FILE_EXT,f=
new m.aio.configmanager.Page;f.parent=a;var h=require("fs");h.exists(b,function(a){a?h.readFile(b,function(a,k){if(a)c(a);else{a=require("path");a=b.lastIndexOf(a.sep);var h=b.substr(a+1),g=!1;a=h.indexOf(e.PAGE);0<=a&&a===h.length-e.PAGE.length&&(g=!0,f.id=h.replace(e.PAGE,""));a=h.indexOf(e.POPUP);0<=a&&a===h.length-e.POPUP.length&&(g=!0,f.id=h.replace(e.POPUP,""),f.isPopup=!0);if(g){if(0<k.length)try{var l=JSON.parse(k.toString());f.index=l.index}catch(q){d.saveDamageFile(b,k,function(){c(null,
f)});return}c(null,f)}else c(null,null)}}):c(null,null)})},saveDamageFile:function(a,b,c){require("fs").writeFile(a+".bk",b,c)},remove:function(a,b,c){a=a.getFolderPath();b=b.getFile(!0);if(a)if(b){var d=require("path");b=a+d.sep+b;require("fs-extra").remove(b,function(a){c(a)})}else c(Error("page file is null"));else c(Error("parent folder path is null"))},move:function(a,b,c,d){a=a.getFolderPath();var e=b.getFile();if(a)if(e){var f=require("path");b=b.getFileExt();e=a+f.sep+e+b;c=a+f.sep+c+b;require("fs-extra").move(e,
c,function(a){d(a)})}else d(Error("page file is null"));else d(Error("parent folder path is null"))}};m.aio.configmanager.PageContent=function(a){m.aio.configmanager.Node.call(this,a);this.content=null};m.aio.configmanager.PageContent.prototype=Object.create(m.aio.configmanager.Node.prototype);m.aio.configmanager.PageContent.prototype.constructor=m.aio.configmanager.PageContent;
m.aio.configmanager.PageContent.prototype.processResourceList=function(a,b,c){var d=function(a,b,c){return b?a.processResourceSync(b,c):null},e=function(a,b){if(b&&b.states&&"object"===typeof b.states){var c="string"===typeof b.path?b.path.length:0,e;for(e in b.states){var f=b.states[e];if(f&&"object"===typeof f&&"string"===typeof f.i){var k=0!==f.p&&"string"===typeof b.path;g=d(a,k?b.path+"/"+f.i:f.i,f.s);l=l||!!g;g&&(f=k?c+1:0,0===f&&"/"==g[0]&&f++,b.states[e].i=g.substr(f))}}}},f=function(a,b){if(b&&
b.info&&"object"===typeof b.info){var c="string"===typeof b.info.path?b.info.path+"/":"",e;for(e in b.info){var f=b.info[e];"path"!=e&&f&&"string"===typeof f&&(g=d(a,c+f,b.img_skin),l=l||!!g,g&&(b.info[e]=g.substr(0<c.length?c.length:1)))}}};try{var h,l=!1;if(this.content){if(this.content.widget&&this.content.widget.bgimg){var g=d(b,this.content.widget.bgimg,this.content.widget.bgimg_skin);l=l||!!g;g&&(this.content.widget.bgimg=g)}this.content.infos&&this.content.infos.forEach(function(c){if(c.widget){g=
d(b,c.widget.img,c.widget.img_skin);l=l||(g?c.widget.img!==g:!1);g&&(c.widget.img=g);g=d(b,c.widget.bgimg,c.widget.bgimg_skin);l=l||(g?c.widget.bgimg!==g:!1);g&&(c.widget.bgimg=g);if(c.widget.path&&c.widget.images)for(h=0;h<c.widget.images.length;h++){var k=c.widget.images[h];if(k){var n=0<=k.indexOf("/")?"":c.widget.path+"/";g=d(b,n+k,c.widget.img_skin);l=l||(g?n+k!==g:!1);g&&(c.widget.images[h]=g.substr(n.length))}}c.widget._default&&"string"===typeof c.widget._default&&b.processDefaultImageSync(c.widget);
e(b,c.widget);f(b,c.widget);"string"===typeof c.widget.stateRuleRef&&a&&a.parent&&(k=(k=a.parent.parent)&&k.info&&k.info.stateRules)&&k[c.widget.stateRuleRef]&&e(b,k[c.widget.stateRuleRef])}});this.content.buttons&&this.content.buttons.forEach(function(c){if(c.widget){g=d(b,c.widget.img,c.widget.img_skin);l=l||(g?c.widget.img!==g:!1);g&&(c.widget.img=g);g=d(b,c.widget.bgimg,c.widget.bgimg_skin);l=l||(g?c.widget.bgimg!==g:!1);g&&(c.widget.bgimg=g);if(c.widget.path&&c.widget.images)for(h=0;h<c.widget.images.length;h++){var k=
c.widget.images[h];if(k){var n=0<=k.indexOf("/")?"":c.widget.path+"/";g=d(b,n+k,c.widget.img_skin);l=l||(g?n+k!==g:!1);g&&(c.widget.images[h]=g.substr(n.length))}}c.widget._default&&"string"===typeof c.widget._default&&b.processDefaultImageSync(c.widget);e(b,c.widget);f(b,c.widget);"string"===typeof c.widget.stateRuleRef&&a&&a.parent&&(k=(k=a.parent.parent)&&k.info&&k.info.stateRules)&&k[c.widget.stateRuleRef]&&e(b,k[c.widget.stateRuleRef])}});this.content.selects&&this.content.selects.forEach(function(a){a.widget&&
(g=d(b,a.widget.img_n,a.widget.img_skin_n),l=l||(g?a.widget.img_n!==g:!1),g&&(a.widget.img_n=g),g=d(b,a.widget.img_y,a.widget.img_skin_y),l=l||(g?a.widget.img_y!==g:!1),g&&(a.widget.img_y=g),g=d(b,a.widget.bgimg,a.widget.bgimg_skin),l=l||(g?a.widget.bgimg!==g:!1),g&&(a.widget.bgimg=g))});this.content.sliders&&this.content.sliders.forEach(function(a){a.widget&&(a=a.widget)&&b.processWidgetSync(a)});this.content.roundsliders&&this.content.roundsliders.forEach(function(a){a.widget&&(a=a.widget)&&b.processWidgetSync(a)});
this.content.colorchoosers&&this.content.colorchoosers.forEach(function(a){a.widget&&(a=a.widget)&&b.processWidgetSync(a)});this.content.analogmeters&&this.content.analogmeters.forEach(function(a){a.widget&&(a=a.widget)&&b.processWidgetSync(a)});this.content.amps&&this.content.amps.forEach(function(a){a.widget&&(a=a.widget)&&b.processWidgetSync(a)})}l?m.aio.configmanager.PageContentPersistHandler.save(a.parent,a,this,function(a){c&&c(a)}):c&&c(null)}catch(k){c&&c(k)}};
...
m.aio.configmanager.PageContentPersistHandler={save:function(a,b,c,d){a=a.getFolderPath();var e=b.getFile(!0);if(a)if(e)if(c)if(c.content&&"object"===typeof c.content){var f=require("fs-extra"),h=require("path"),l=require("unorm");c=c.content;c.index=b.index;c.classid&&"control"===c.classid||(c.classid="control");var g=null;try{g=l.nfc(JSON.stringify(c))}catch(n){d(n);return}if(g){var k=null;e=a+h.sep+e;try{f.existsSync(e)&&(k=e+"-"+Date.now()+".old",f.copySync(e,k))}catch(n){XC.debugf("[m.aio.configmanager.PageContentPersistHandler.save] Could either not check file or copy it."+
n.message,"error");d(n);return}var p=function(){if(k)try{XC.debugf('[m.aio.configmanager.PageContentPersistHandler.save] Trying to restore backup "'+k+'" ...'),f.moveSync(k,e,{overwrite:!0}),XC.debugf("[m.aio.configmanager.PageContentPersistHandler.save] Restored file as "+e),k=null}catch(n){XC.debugf("[m.aio.configmanager.PageContentPersistHandler.save] Failed to restore backup: "+n.message,"error")}};f.ensureFile(e,function(a){a?(p(),d(a)):f.writeFile(e,g,function(a){if(a)p();else if(k)try{f.unlinkSync(k)}catch(q){XC.debugf("[m.aio.configmanager.PageContentPersistHandler.save] Failed to delete backup file: "+
q.message,"error")}d(a)})})}else d(Error("Stringified and normalized data is empty."))}else d(Error("missing page content"));else d(Error("content is null"));else d(Error("page file is null"));else d(Error("parent folder path is null"))},load:function(a,b){var c=new m.aio.configmanager.PageContent,d=require("fs");d.exists(a,function(e){e?d.readFile(a,function(a,d){if(a)b(a);else{if(0<d.length)try{c.content=JSON.parse(d.toString())}catch(l){b(l,c);return}b(null,c)}}):b(null,c)})},loadSync:function(a){var b=
