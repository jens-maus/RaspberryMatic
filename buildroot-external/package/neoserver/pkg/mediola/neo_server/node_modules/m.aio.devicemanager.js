...
m.aio.devicemanager.IntHandler.prototype.execute=function(a,c,b,d,e){var f=m.aio.devicemanager.DMError,h=m.aio.devicemanager.DMError.ERROR_CODE;if("readWithoutLicense"==a||this.tenant.license)if("readWithoutLicense"==a||this._permit(this.tenant)){switch(a){case "create":a="_create";break;case "read":a="_read";b&&b.filter&&(b=m.aio.devicemanager.Filter.build(b));break;case "readWithoutLicense":a="_read";b&&b.filter&&(b=m.aio.devicemanager.Filter.build(b));b||(b={});b.ignoreLicense=!0;break;case "update":a=
"_update";break;case "delete":a="_delete";break;default:d&&d(new f(h.UNKNOW,"op "+a+" unknow"));return}switch(c){case "gateway":m.aio.devicemanager._GatewayHandler[a](b,this,d,e);break;case "device":m.aio.devicemanager._DeviceHandler[a](b,this,d,e);break;case "room":m.aio.devicemanager._RoomHandler[a](b,this,d,e);break;case "gatewaytype":m.aio.devicemanager._GatewaytypeHandler[a](b,this,d);break;case "gatewaydevicetype":m.aio.devicemanager._GatewayDeviceTypeHandler[a](b,this,d);break;case "ipdevicetype":m.aio.devicemanager._IpdevicetypeHandler[a](b,
this,d);break;case "deviceinfo":m.aio.devicemanager._DeviceInfoHandler[a](b,this,d);break;default:d&&d(new f(h.UNKNOW,"type "+c+" unknow"))}}else d(Error("not permitted"));else d(new f(h.INVALID,"no license"))};
...
(e=e.devicemanager.applyNeoServerFilterGateway(b.info,a,c.deviceinfo))&&(b.info=e,d.push(b))}}):a&&a instanceof m.aio.devicemanager.IPEventFilter?e.forEach(function(b){b=JSON.parse(JSON.stringify(b));if(b.info&&b.info.sys){var e=c.dm.getModule(b.info.sys);e&&e.devicemanager&&e.devicemanager.applyIPEventFilterGateway&&(e=e.devicemanager.applyIPEventFilterGateway(b.info,a,c.deviceinfo))&&(b.info=e,d.push(b))}}):d=e;if(a&&a.ignoreLicense)b(null,d);else{var f=[],h=m.aio.devicemanager._configmanager.LicenseManager;
d.forEach(function(a){var b=JSON.parse(JSON.stringify(a));h.permitFeature("read",a.info,c.tenant.license)||(b._no_permission=!0);f.push(b)});b(null,f)}},_readSync:function(a,c){var b=[],d=c.data.gateways;a instanceof m.aio.devicemanager.PropertyFilter&&a.properties?d.forEach(function(c){a.match(c)&&b.push(c)}):a&&a instanceof m.aio.devicemanager.UIFilter?d.forEach(function(d){d=JSON.parse(JSON.stringify(d));if(d.info&&d.info.sys){var e=c.dm.getModule(d.info.sys);e&&e.devicemanager&&e.devicemanager.applyUIFilterGateway&&
...
"index "+a+" invalid"));return}for(var f=c.data.gateways,h,g,k=0;k<f.length;k++)a===f[k].index&&(h=f[k],g=k);h?m.aio.devicemanager._configmanager.LicenseManager.permitFeature("delete",h.info,c.tenant.license)?(f=c.dm.getModule(h.info.sys))?f.devicemanager?f.devicemanager.deleteGateway(h.info,c,function(d){d?b(d):(c.data.gateways.splice(g,1),c.data.devices&&c.data.devices.forEach(function(c){c.info&&c.info.gateway&&c.info.gateway==a&&(c.info.gateway=0)}),c._save(function(a){b(a,h)}))}):b(new d(e.INVALID,
"sys "+h.info.sys+" do not have device manager implementation")):b(new d(e.UNKNOW,"sys "+h.info.sys+" unknow")):b(new d(e.NOT_PERMITTED,"sys "+h.info.sys+" not permitted")):b(new d(e.NOT_FOUND,"no gateway has index "+a))}else b(new d(e.INVALID,"index "+a+" invalid"))},_deleteUnlicensed:function(a,c,b){var d=[],e=c.gateways;if(e){for(var f=m.aio.devicemanager._configmanager.LicenseManager,h=0;h<e.length;h++){var g=e[h];f.permitFeature("add",g.info,a.tenant.license)&&d.push(g)}c.gateways=d}b&&b()}};
m.aio.devicemanager._DeviceHandler={_findGateway:function(a,c){if(!a||!a.data)return null;a=a.data.gateways;if(!a)return null;for(var b=0;b<a.length;b++){var d=a[b];if(d&&d.index==c)return d}return null},_create:function(a,c,b,d){var e=m.aio.devicemanager.DMError,f=m.aio.devicemanager.DMError.ERROR_CODE,h=c.data.devices,g=m.aio.devicemanager._configmanager.LicenseManager,k=null;a.info&&a.info.gateway&&(k=this._findGateway(c,a.info.gateway));if(g.permitFeature("create",a.info,c.tenant.license,a.index,
h,k?k.info:null))if(a.name){if(a.index&&"string"===typeof a.index)if(a.index.match(/^[-]?\d+$/))a.index=parseInt(a.index);else{b(new e(f.INVALID,"index "+a.index+" invalid"));return}if(a.room){g=c.data.rooms;g||(c.data.rooms=[],g=c.data.rooms);k=!1;for(var l=0;l<g.length;l++)if(g[l].index==a.room){k=!0;break}if(k)if(a.info)if(a.info.sys)if(h||(c.data.devices=[],h=c.data.devices),g=require("m.aio.infomanager").getDeviceCount(a.info,c.tenant.license),0==g)b(Error("allow device count is 0"));else{if(-1!=
g){for(l=k=0;l<h.length;l++){var n=h[l];n.info&&n.info.sys==a.info.sys&&k++}if(k>=g){b(Error("reach maximum device count "+g));return}}g=1;for(k=0;k<h.length;k++){l=h[k];l.index===g&&g++;if(0<a.index&&l.index===a.index){b(new e(f.INDEX_EXISTS,"index "+a.index+" exists"));return}if(l.name===a.name&&l.room===a.room){b(new e(f.NAME_EXISTS,"name "+a.name+" exists"));return}}if(!a.index||0>=a.index)a.index=g;(h=c.dm.getModule(a.info.sys))?h.devicemanager?h.devicemanager.createDevice(a.info,c,function(e,
f){e?b(e):(a.info=f,c._insertIntoArray(a,c.data.devices),d?b(null,a):c._save(function(c){b(c,a)}))}):b(new e(f.INVALID,"sys "+a.info.sys+" do not have device manager implementation")):b(new e(f.UNKNOW,"sys "+a.info.sys+" unknow"))}else b(new e(f.INVALID,"sys "+a.info.sys+" invalid"));else b(new e(f.INVALID,"info "+a.info+" invalid"));else b(new e(f.INVALID,"room "+a.room+" do not exist"))}else b(new e(f.INVALID,"room "+a.room+" invalid"))}else b(new e(f.INVALID,"name "+a.name+" invalid"));else b(new e(f.NOT_PERMITTED,
"sys "+a.info.sys+" not permitted"))},_read:function(a,c,b){var d=[],e=c.data.devices;a&&a instanceof m.aio.devicemanager.PropertyFilter&&a.properties?e.forEach(function(c){a.match(c)&&d.push(c)}):a&&a instanceof m.aio.devicemanager.UIFilter?e.forEach(function(b){b=JSON.parse(JSON.stringify(b));if(b.info&&b.info.sys){var e=null;b.info.gateway&&c&&(e=c.findGatewayWithIndexIngnoreLicense(b.info.gateway));var f=c.dm.getModule(b.info.sys);f&&f.devicemanager&&f.devicemanager.applyUIFilter&&(e=f.devicemanager.applyUIFilter(b.info,
a,c.deviceinfo,c,e?e.info:null))&&(b.info=e,d.push(b))}}):a&&a instanceof m.aio.devicemanager.NeoServerFilter?e.forEach(function(b){b=JSON.parse(JSON.stringify(b));if(b.info&&b.info.sys){var e=c.dm.getModule(b.info.sys);e&&e.devicemanager&&e.devicemanager.applyNeoServerFilter&&(e=e.devicemanager.applyNeoServerFilter(b.info,a,c.deviceinfo,c))&&(b.info=e,d.push(b))}}):a&&a instanceof m.aio.devicemanager.IPEventFilter?e.forEach(function(b){b=JSON.parse(JSON.stringify(b));if(b.info&&b.info.sys){var e=
null;b.info.gateway&&c&&(e=c.findGatewayWithIndexIngnoreLicense(b.info.gateway));var f=c.dm.getModule(b.info.sys);f&&f.devicemanager&&f.devicemanager.applyIPEventFilter&&(e=f.devicemanager.applyIPEventFilter(b.info,a,c.deviceinfo,c,e?e.info:null))&&(b.info=e,d.push(b))}}):d=e;if(a&&a.ignoreLicense)b(null,d);else{var f=[],h=m.aio.devicemanager._configmanager.LicenseManager,g=this;d.forEach(function(a){var b=null;a.info&&a.info.gateway&&(b=g._findGateway(c,a.info.gateway));var d=JSON.parse(JSON.stringify(a));
h.permitFeature("read",a.info,c.tenant.license,a.index,e,b?b.info:null)||(d._no_permission=!0);f.push(d)});b(null,f)}},_readSync:function(a,c){var b=[],d=c.data.devices;a&&a instanceof m.aio.devicemanager.PropertyFilter&&a.properties?d.forEach(function(c){a.match(c)&&b.push(c)}):a&&a instanceof m.aio.devicemanager.UIFilter?d.forEach(function(d){d=JSON.parse(JSON.stringify(d));if(d.info&&d.info.sys){var e=c.dm.getModule(d.info.sys);e&&e.devicemanager&&e.devicemanager.applyUIFilter&&(e=e.devicemanager.applyUIFilter(d.info,
a,c.deviceinfo,c))&&(d.info=e,b.push(d))}}):a&&a instanceof m.aio.devicemanager.NeoServerFilter?d.forEach(function(d){d=JSON.parse(JSON.stringify(d));if(d.info&&d.info.sys){var e=c.dm.getModule(d.info.sys);e&&e.devicemanager&&e.devicemanager.applyNeoServerFilter&&(e=e.devicemanager.applyNeoServerFilter(d.info,a,c.deviceinfo,c))&&(d.info=e,b.push(d))}}):a&&a instanceof m.aio.devicemanager.IPEventFilter?d.forEach(function(d){d=JSON.parse(JSON.stringify(d));if(d.info&&d.info.sys){var e=null;d.info.gateway&&
c&&(e=c.findGatewayWithIndexIngnoreLicense(d.info.gateway));var f=c.dm.getModule(d.info.sys);f&&f.devicemanager&&f.devicemanager.applyIPEventFilter&&(e=f.devicemanager.applyIPEventFilter(d.info,a,c.deviceinfo,c,e?e.info:null))&&(d.info=e,b.push(d))}}):b=d;if(a&&a.ignoreLicense)return b;var e=[],f=m.aio.devicemanager._configmanager.LicenseManager,h=this;b.forEach(function(a){var b=null;a.info&&a.info.gateway&&(b=h._findGateway(c,a.info.gateway));var g=JSON.parse(JSON.stringify(a));f.permitFeature("read",
a.info,c.tenant.license,a.index,d,b?b.info:null)||(g._no_permission=!0);e.push(g)});return e},_update:function(a,c,b,d){var e=m.aio.devicemanager.DMError,f=m.aio.devicemanager.DMError.ERROR_CODE,h=c.data.devices;if(a.index){if("string"===typeof a.index)if(a.index.match(/^[-]?\d+$/))a.index=parseInt(a.index);else{b(new e(f.INVALID,"index "+a.index+" invalid"));return}if(a.name)if(a.room)if(a.info)if(a.info.sys){var g=null;a.info&&a.info.gateway&&(g=this._findGateway(c,a.info.gateway));var k=m.aio.devicemanager._configmanager.LicenseManager;
if(k.permitFeature("update",a.info,c.tenant.license,a.index,h,g?g.info:null)){var l,n=c.data.rooms,q;for(l=0;l<n.length;l++)a.room===n[l].index&&(q=n[l]);if(q){var u=-1;for(l=0;l<h.length;l++)if(a.index===h[l].index){var p=h[l];u=l}else if(h[l].name===a.name&&h[l].room===a.room){b(new e(f.NAME_EXISTS,"name "+a.name+" exists"));return}p?(p.info&&p.info.gateway&&(g=this._findGateway(c,p.info.gateway)),k.permitFeature("update",p.info,c.tenant.license,p.index,h,g?g.info:null)?(g=c.dm.getModule(a.info.sys))?
g.devicemanager?g.devicemanager.updateDevice(a.info,c,function(e,f){e?b(e):(a.info=f,h[u]=a,d?b(null,a):c._save(function(c){b(c,a)}))}):b(new e(f.INVALID,"sys "+a.info.sys+" do not have device manager implementation")):b(new e(f.UNKNOW,"sys "+a.info.sys+" unknow")):b(new e(f.NOT_PERMITTED,"sys "+p.info.sys+" not permitted"))):b(new e(f.NOT_FOUND,"no device has index "+a.index))}else b(new e(f.NOT_FOUND,"no room has index "+a.index))}else b(new e(f.NOT_PERMITTED,"sys "+a.info.sys+" not permitted"))}else b(new e(f.INVALID,
"sys "+a.info.sys+" invalid"));else b(new e(f.INVALID,"info "+a.info+" invalid"));else b(new e(f.INVALID,"room "+a.room+" invalid"));else b(new e(f.INVALID,"name "+a.name+" invalid"))}else b(new e(f.INVALID,"index "+a.index+" invalid"))},_delete:function(a,c,b,d){var e=m.aio.devicemanager.DMError,f=m.aio.devicemanager.DMError.ERROR_CODE;if(a){if(a&&"string"===typeof a)if(a.match(/^[-]?\d+$/))a=parseInt(a);else{b(new e(f.INVALID,"index "+a+" invalid"));return}for(var h=c.data.devices,g,k,l=0;l<h.length;l++)a===
h[l].index&&(g=h[l],k=l);g?(a=null,g.info&&g.info.gateway&&(a=this._findGateway(c,g.info.gateway)),m.aio.devicemanager._configmanager.LicenseManager.permitFeature("delete",g.info,c.tenant.license,g.index,h,a?a.info:null)?(h=c.dm.getModule(g.info.sys))?h.devicemanager?h.devicemanager.deleteDevice(g.info,c,function(a){a?b(a):(c.data.devices.splice(k,1),d?b(null,g):c._save(function(a){b(a,g)}))}):b(new e(f.INVALID,"sys "+g.info.sys+" do not have device manager implementation")):b(new e(f.UNKNOW,"sys "+
g.info.sys+" unknow")):b(new e(f.NOT_PERMITTED,"sys "+g.info.sys+" not permitted"))):b(new e(f.NOT_FOUND,"no device has index "+a))}else b(new e(f.INVALID,"index "+a+" invalid"))},_deleteUnlicensed:function(a,c,b){var d=[],e=c.devices;if(e){for(var f=m.aio.devicemanager._configmanager.LicenseManager,h=0;h<e.length;h++){var g=e[h],k=null;g.info&&g.info.gateway&&(k=this._findGateway(a,g.info.gateway));f.permitFeature("add",g.info,a.tenant.license,g.index,e,k?k.info:null)&&d.push(g)}c.devices=d}b&&b()}};
m.aio.devicemanager._RoomHandler={_create:function(a,c,b){var d=m.aio.devicemanager.DMError,e=m.aio.devicemanager.DMError.ERROR_CODE;if(a.name){if(a.index&&"string"===typeof a.index)if(a.index.match(/^[-]?\d+$/))a.index=parseInt(a.index);else{b(new d(e.INVALID,"index "+a.index+" invalid"));return}var f=c.data.rooms;f||(c.data.rooms=[],f=c.data.rooms);for(var h=1,g=0;g<f.length;g++){var k=f[g];k.index===h&&h++;if(0<=a.index&&k.index===a.index){b(new d(e.INDEX_EXISTS,"index "+a.index+" exists"));return}if(k.name===
a.name){b(new d(e.NAME_EXISTS,"name "+a.name+" exists"));return}}if(!a.index||0>=a.index)a.index=h;c._insertIntoArray(a,c.data.rooms);c._save(function(c){b(c,a)})}else b(new d(e.INVALID,"name "+a.name+" invalid"))},_read:function(a,c,b){var d=[];c=c.data.rooms;a&&a instanceof m.aio.devicemanager.PropertyFilter&&a.properties?(c.forEach(function(b){a.match(b)&&d.push(b)}),b(null,d)):b(null,c)},_readSync:function(a,c){var b=[];c=c.data.rooms;return a&&a instanceof m.aio.devicemanager.PropertyFilter&&
a.properties?(c.forEach(function(c){a.match(c)&&b.push(c)}),b):c},_update:function(a,c,b){var d=m.aio.devicemanager.DMError,e=m.aio.devicemanager.DMError.ERROR_CODE;if(a.index){if("string"===typeof a.index)if(a.index.match(/^[-]?\d+$/))a.index=parseInt(a.index);else{b(new d(e.INVALID,"index "+a.index+" invalid"));return}if(a.name){var f,h=c.data.rooms;for(f=0;f<h.length;f++)if(a.index===h[f].index)var g=h[f];else if(a.name===h[f].name){b(new d(e.NAME_EXISTS,"name "+a.name+" exists"));return}g?(d=
g.name!==a.name,a.info&&"object"===typeof a.info?(d=!0,g.info=a.info):g.info&&(d=!0,delete g.info),d?(g.name=a.name,c._save(function(a){b(a,g)})):b(null,g)):b(new d(e.NOT_FOUND,"no room has index "+a.index))}else b(new d(e.INVALID,"name "+a.name+" invalid"))}else b(new d(e.INVALID,"index "+a.index+" invalid"))},_delete:function(a,c,b){var d=m.aio.devicemanager.DMError,e=m.aio.devicemanager.DMError.ERROR_CODE;if(a){if(a&&"string"===typeof a)if(a.match(/^[-]?\d+$/))a=parseInt(a);else{b(new d(e.INVALID,
"index "+a+" invalid"));return}var f=c.data.rooms,h=-1,g;for(g=0;g<f.length;g++)if(a===f[g].index){var k=f[g];h=g}if(k){d=c.data.devices;for(g=0;g<d.length;g++)a===d[g].room&&(d[g].room=0);0<=h&&(c.data.rooms.splice(h,1),c._save(function(a){b(a,k)}))}else b(new d(e.NOT_FOUND,"no room has index "+a))}else b(new d(e.INVALID,"index "+a+" invalid"))}};
m.aio.devicemanager._GatewaytypeHandler={_read:function(a,c,b){a=[];var d={};for(h in c.dm.modules)if(c.dm.modules.hasOwnProperty(h)){var e=c.dm.modules[h];var f=require("xnm.aio."+e+".js");e&&f&&(d[e]=f)}var h=m.aio.devicemanager._configmanager.LicenseManager;for(var g in d)d.hasOwnProperty(g)&&(f=d[g]),f.devicemanager&&"function"===typeof f.devicemanager.getGatewayType&&(e=f.devicemanager.getGatewayType({lm:h,license:c.tenant.license}))&&(a=a.concat(e));f=[];for(g=0;g<a.length;g++)h.permitFeature("read",
a[g],c.tenant.license)&&f.push(a[g]);b(null,f)}};
...
m.aio.devicemanager._IpdevicetypeHandler={_read:function(a,c,b){a=[];var d={};for(h in c.dm.modules)if(c.dm.modules.hasOwnProperty(h)){var e=c.dm.modules[h];var f=require("xnm.aio."+e+".js");e&&f&&(d[e]=f)}var h=m.aio.devicemanager._configmanager.LicenseManager;for(var g in d)d.hasOwnProperty(g)&&(f=d[g]),f.devicemanager&&"function"===typeof f.devicemanager.getIPDeviceType&&(e=f.devicemanager.getIPDeviceType(c.deviceinfo,{lm:h,license:c.tenant.license}))&&(a=a.concat(e));f=[];for(g=0;g<a.length;g++)h.permitFeature("read",
a[g],c.tenant.license)&&f.push(a[g]);b(null,f)}};
...
m.aio.devicemanager.DeviceManager.prototype.reloadTenant=function(a,c){for(var b=-1,d=0;d<this.handlers.length;d++){var e=this.handlers[d];if(e&&e.tenant&&e.tenant.index==a.index){b=d;break}}-1!=b&&this.handlers.splice(b,1);this._loadTenant(a,c)};m.aio.devicemanager.DeviceManager.prototype.execute=function(a,c,b,d,e,f){for(var h=null,g=0;g<this.handlers.length;g++){var k=this.handlers[g];if(k.tenant&&k.tenant.index==c){h=k;break}}h?h.execute(a,b,d,function(a,b){e(a,b)},f):e(Error("no such tenant"))};
m.aio.devicemanager.DeviceManager.prototype.batchModeEnd=function(a,c){for(var b=null,d=0;d<this.handlers.length;d++){var e=this.handlers[d];if(e.tenant&&e.tenant.index==a){b=e;break}}b?b._save(c):callback(Error("no such tenant"))};m.aio.devicemanager.DeviceManager.prototype.executeSync=function(a,c,b,d){for(var e=null,f=0;f<this.handlers.length;f++){var h=this.handlers[f];if(h.tenant&&h.tenant.index==c){e=h;break}}if(!e)throw Error("no such tenant");return e.executeSync(a,b,d)};
...
m.aio.devicemanager.DeviceManager.prototype.saveRemote=function(a,c){if(a.parent){var b=a.parent.parent;if(b){for(var d=null,e=0;e<this.handlers.length;e++){var f=this.handlers[e];if(f.tenant&&f.tenant.index==b.index){d=f;break}}if(d){var h=this;d.deleteUnlicensed(function(b,d){b?c&&c(b):h.saveRemoteWithDB(a,d,function(a){c&&c(a)})})}else c(Error("no such tenant"))}else c&&c(Error("remote do not belong to any tenant"))}else c&&c(Error("remote is isolated"))};
m.aio.devicemanager.DeviceManager.prototype.saveRemoteWithDB=function(a,c,b){if(a.parent){var d=a.parent.parent;if(d){var e=d.getFolderPath();if(e){var f=a.getFolderPath();a=require("fs");var h=require("path"),g=this,k=e+h.sep+m.aio.devicemanager.DeviceManager.DB,l=f+h.sep+m.aio.devicemanager.DeviceManager.DB;a.writeFile(l,JSON.stringify(c),function(a){a?b&&b(a):(k=e+h.sep+m.aio.devicemanager.DeviceManager.DEVICE_INFO,l=f+h.sep+m.aio.devicemanager.DeviceManager.DEVICE_INFO,g._copyFile(k,l,function(a){b&&
...
m.aio.devicemanager.DeviceManager.prototype._loadTenant=function(a,c){var b=function(a,b){require("fs").writeFile(a,m.aio.devicemanager.DeviceManager.DEFAULT_DEVICE_INFO,function(a){b(a)})},d=function(a,c,d){var e=require("fs");e.exists(c,function(f){f?e.readFile(c,{encoding:"utf8"},function(b,c){b||0<c.length&&a.setDeviceInfo(c);d()}):b(c,function(b){b?d():e.readFile(c,{encoding:"utf8"},function(b,c){b||0<c.length&&a.setDeviceInfo(c);d()})})})},e=this,f=require("path"),h=a.getFolderPath();if(h){var g=
new m.aio.devicemanager.IntHandler(e,a,{devices:[],rooms:[],gateways:[]});this.handlers.push(g);a=h+f.sep+m.aio.devicemanager.DeviceManager.DB;var k=h+f.sep+m.aio.devicemanager.DeviceManager.DEVICE_INFO,l=require("fs-extra"),n=!1;l.existsSync(a+".enc")&&(a+=".enc",n=!0);var q=function(){d(g,k,function(){c&&c()})};(function(a,b,c){var d=require("fs");d.exists(b,function(f){f?d.readFile(b,{encoding:"utf8"},function(d,f){if(!d&&0<f.length)try{String(b).endsWith(".enc")&&(f=f.replace(/[\r\n]/g,""),f=
require("x.crypt").AES.decodeString(f,e.ml_v1_info()));var g=JSON.parse(f);g&&(a.data=g,a.data.devices||(a.data.devices=[]),a._sort(a.data.devices),a.data.gateways||(a.data.gateways=[]),a._sort(a.data.gateways),a.data.rooms||(a.data.rooms=[]),a._sort(a.data.rooms))}catch(t){console.error(t)}c()}):d.writeFile(b,"",function(){c()})})})(g,a,function(){n?q():g._save(function(){var a=f.join(h,"cloud"),b=f.join(h,"automation"),c=f.join(h,"remotes");if(l.existsSync(a))try{l.remove(a)}catch(r){console.error(r)}if(l.existsSync(b))try{var d=
l.readdirSync(b);for(a=0;a<d.length;a++){var e=d[a];if(l.statSync(f.join(b,e)).isDirectory()){var g=f.join(b,e,"db");l.existsSync(g)&&l.remove(g)}}}catch(r){console.error(r)}if(l.existsSync(c))try{var k=l.readdirSync(c);for(b=0;b<k.length;b++){var n=k[b];if(l.statSync(f.join(c,n)).isDirectory()){var t=f.join(c,n,"device_db");l.existsSync(t)&&l.remove(t)}}}catch(r){console.error(r)}q()})})}else c()};
m.aio.devicemanager.DeviceManager.prototype.supportSmartWidget=function(a,c){if(!a||!a.info)return!1;var b=null;a.info.gateway&&c&&(c=this.getIntHandler(c))&&(c=c.findGatewayWithIndex(a.info.gateway))&&(b=c);return require("m.aio.smartwidget.js").supportSmartWidget(a.info,b?b.info:null)};
m.aio.devicemanager.DeviceManager.prototype.applySmartWidgetFilter=function(a,c,b,d){var e=this.getIntHandler(a);if(e)if(a=e.findDeviceWithIndex(c))if(a.info){var f=e.findRoomWithIndex(a.room),h=null;f&&(h=f.name);f=null;a.info.gateway&&e&&(f=e.findGatewayWithIndex(a.info.gateway));var g=require("m.aio.smartwidget.js");e=JSON.parse(JSON.stringify(a));if(c=g.applySmartWidgetFilter(a.info,f?f.info:null,b,{index:c,name:a.name,room:h}))e.smartwidget=c;d&&d(null,e)}else d&&d(null,[]);else c=Error("can not read device with id:"+
