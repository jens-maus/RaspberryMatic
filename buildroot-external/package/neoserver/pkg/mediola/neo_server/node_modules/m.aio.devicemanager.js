...
m.aio.devicemanager.IntHandler.prototype._save=function(a){var c=require("fs"),b=require("path");b=this.tenant.getFolderPath()+b.sep+m.aio.devicemanager.DeviceManager.DB;c.writeFile(b,JSON.stringify(this.data),function(c){a(c)})};m.aio.devicemanager.IntHandler.prototype._sort=function(a){var c=a.length-1;do for(var b=!1,d=0;d<c;++d)a[d].index>a[d+1].index&&(b=a[d],a[d]=a[d+1],a[d+1]=b,b=!0);while(1==b)};
m.aio.devicemanager.IntHandler.prototype._saveDeviceInfo=function(a){var c=require("fs"),b=require("path");b=this.tenant.getFolderPath()+b.sep+m.aio.devicemanager.DeviceManager.DEVICE_INFO;c.writeFile(b,this.deviceinfo._xml,function(c){a(c)})};
...
m.aio.devicemanager.UIFilter?e.forEach(function(b){b=JSON.parse(JSON.stringify(b));if(b.info&&b.info.sys){var g=c.dm.getModule(b.info.sys);g&&g.devicemanager&&g.devicemanager.applyUIFilterGateway&&(g=g.devicemanager.applyUIFilterGateway(b.info,a,c.deviceinfo))&&(b.info=g,d.push(b))}}):a&&a instanceof m.aio.devicemanager.NeoServerFilter?e.forEach(function(b){b=JSON.parse(JSON.stringify(b));if(b.info&&b.info.sys){var g=c.dm.getModule(b.info.sys);g&&g.devicemanager&&g.devicemanager.applyNeoServerFilterGateway&&
(g=g.devicemanager.applyNeoServerFilterGateway(b.info,a,c.deviceinfo))&&(b.info=g,d.push(b))}}):a&&a instanceof m.aio.devicemanager.IPEventFilter?e.forEach(function(b){b=JSON.parse(JSON.stringify(b));if(b.info&&b.info.sys){var g=c.dm.getModule(b.info.sys);g&&g.devicemanager&&g.devicemanager.applyIPEventFilterGateway&&(g=g.devicemanager.applyIPEventFilterGateway(b.info,a,c.deviceinfo))&&(b.info=g,d.push(b))}}):d=e;if(a&&a.ignoreLicense)b(null,d);else{var f=[],h=m.aio.devicemanager._configmanager.LicenseManager;
d.forEach(function(a){var b=JSON.parse(JSON.stringify(a));h.permitFeature("read",a.info,c.tenant.license)||(b._no_permission=!0);f.push(b)});b(null,f)}},_readSync:function(a,c){var b=[],d=c.data.gateways;a instanceof m.aio.devicemanager.PropertyFilter&&a.properties?d.forEach(function(c){a.match(c)&&b.push(c)}):a&&a instanceof m.aio.devicemanager.UIFilter?d.forEach(function(d){d=JSON.parse(JSON.stringify(d));if(d.info&&d.info.sys){var g=c.dm.getModule(d.info.sys);g&&g.devicemanager&&g.devicemanager.applyUIFilterGateway&&
(g=g.devicemanager.applyUIFilterGateway(d.info,a,c.deviceinfo))&&(d.info=g,b.push(d))}}):a&&a instanceof m.aio.devicemanager.NeoServerFilter?d.forEach(function(d){d=JSON.parse(JSON.stringify(d));if(d.info&&d.info.sys){var g=c.dm.getModule(d.info.sys);g&&g.devicemanager&&g.devicemanager.applyNeoServerFilterGateway&&(g=g.devicemanager.applyNeoServerFilterGateway(d.info,a,c.deviceinfo))&&(d.info=g,b.push(d))}}):a&&a instanceof m.aio.devicemanager.IPEventFilter?d.forEach(function(d){d=JSON.parse(JSON.stringify(d));
if(d.info&&d.info.sys){var g=c.dm.getModule(d.info.sys);g&&g.devicemanager&&g.devicemanager.applyIPEventFilterGateway&&(g=g.devicemanager.applyIPEventFilterGateway(d.info,a,c.deviceinfo))&&(d.info=g,b.push(d))}}):b=d;if(a&&a.ignoreLicense)return b;var e=[],f=m.aio.devicemanager._configmanager.LicenseManager;b.forEach(function(a){var b=JSON.parse(JSON.stringify(a));f.permitFeature("read",a.info,c.tenant.license)||(b._no_permission=!0);e.push(b)});return e},_update:function(a,c,b){var d=m.aio.devicemanager.DMError,
...
f.permitFeature("update",k.info,c.tenant.license)?(f=c.dm.getModule(a.info.sys))?f.devicemanager?f.devicemanager.updateGateway(k.info,a.info,c,function(d,g){if(d)b(d);else{k.name=a.name;k.info=g;for(var e in a)a.hasOwnProperty(e)&&"name"!=e&&"info"!=e&&"index"!=e&&a[e]&&(k[e]=a[e]);c._save(function(a){b(a,k)})}}):b(new d(e.INVALID,"sys "+a.info.sys+" do not have device manager implementation")):b(new d(e.UNKNOW,"sys "+a.info.sys+" unknow")):b(new d(e.NOT_PERMITTED,"sys "+k.info.sys+" not permitted")):
...
m.aio.devicemanager._DeviceHandler={_create:function(a,c,b){var d=m.aio.devicemanager.DMError,e=m.aio.devicemanager.DMError.ERROR_CODE,f=c.data.devices;if(m.aio.devicemanager._configmanager.LicenseManager.permitFeature("create",a.info,c.tenant.license,a.index,f))if(a.name){if(a.index&&"string"===typeof a.index)if(a.index.match(/^[-]?\d+$/))a.index=parseInt(a.index);else{b(new d(e.INVALID,"index "+a.index+" invalid"));return}if(a.room){var h=c.data.rooms;h||(c.data.rooms=[],h=c.data.rooms);for(var g=
!1,k=0;k<h.length;k++)if(h[k].index==a.room){g=!0;break}if(g)if(a.info)if(a.info.sys)if(f||(c.data.devices=[],f=c.data.devices),h=require("m.aio.infomanager").getDeviceCount(a.info,c.tenant.license),0==h)b(Error("allow device count is 0"));else{if(-1!=h){for(k=g=0;k<f.length;k++){var l=f[k];l.info&&l.info.sys==a.info.sys&&g++}if(g>=h){b(Error("reach maximum device count "+h));return}}h=1;for(g=0;g<f.length;g++){k=f[g];k.index===h&&h++;if(0<a.index&&k.index===a.index){b(new d(e.INDEX_EXISTS,"index "+
a.index+" exists"));return}if(k.name===a.name&&k.room===a.room){b(new d(e.NAME_EXISTS,"name "+a.name+" exists"));return}}if(!a.index||0>=a.index)a.index=h;(f=c.dm.getModule(a.info.sys))?f.devicemanager?f.devicemanager.createDevice(a.info,c,function(d,e){d?b(d):(a.info=e,c._insertIntoArray(a,c.data.devices),c._save(function(c){b(c,a)}))}):b(new d(e.INVALID,"sys "+a.info.sys+" do not have device manager implementation")):b(new d(e.UNKNOW,"sys "+a.info.sys+" unknow"))}else b(new d(e.INVALID,"sys "+a.info.sys+
...
(b._no_permission=!0);e.push(b)});return e},_update:function(a,c,b){var d=m.aio.devicemanager.DMError,e=m.aio.devicemanager.DMError.ERROR_CODE,f=c.data.devices;if(a.index){if("string"===typeof a.index)if(a.index.match(/^[-]?\d+$/))a.index=parseInt(a.index);else{b(new d(e.INVALID,"index "+a.index+" invalid"));return}if(a.name)if(a.room)if(a.info)if(a.info.sys){var h=m.aio.devicemanager._configmanager.LicenseManager;if(h.permitFeature("update",a.info,c.tenant.license,a.index,f)){var g,k=c.data.rooms,
l;for(g=0;g<k.length;g++)a.room===k[g].index&&(l=k[g]);if(l){var p=-1;for(g=0;g<f.length;g++)if(a.index===f[g].index){var n=f[g];p=g}else if(f[g].name===a.name&&f[g].room===a.room){b(new d(e.NAME_EXISTS,"name "+a.name+" exists"));return}n?h.permitFeature("update",n.info,c.tenant.license,n.index,f)?(h=c.dm.getModule(a.info.sys))?h.devicemanager?h.devicemanager.updateDevice(a.info,c,function(d,e){d?b(d):(a.info=e,f[p]=a,c._save(function(c){b(c,a)}))}):b(new d(e.INVALID,"sys "+a.info.sys+" do not have device manager implementation")):
b(new d(e.UNKNOW,"sys "+a.info.sys+" unknow")):b(new d(e.NOT_PERMITTED,"sys "+n.info.sys+" not permitted")):b(new d(e.NOT_FOUND,"no device has index "+a.index))}else b(new d(e.NOT_FOUND,"no room has index "+a.index))}else b(new d(e.NOT_PERMITTED,"sys "+a.info.sys+" not permitted"))}else b(new d(e.INVALID,"sys "+a.info.sys+" invalid"));else b(new d(e.INVALID,"info "+a.info+" invalid"));else b(new d(e.INVALID,"room "+a.room+" invalid"));else b(new d(e.INVALID,"name "+a.name+" invalid"))}else b(new d(e.INVALID,
"index "+a.index+" invalid"))},_delete:function(a,c,b){var d=m.aio.devicemanager.DMError,e=m.aio.devicemanager.DMError.ERROR_CODE;if(a){if(a&&"string"===typeof a)if(a.match(/^[-]?\d+$/))a=parseInt(a);else{b(new d(e.INVALID,"index "+a+" invalid"));return}for(var f=c.data.devices,h,g,k=0;k<f.length;k++)a===f[k].index&&(h=f[k],g=k);h?m.aio.devicemanager._configmanager.LicenseManager.permitFeature("delete",h.info,c.tenant.license)?(a=c.dm.getModule(h.info.sys))?a.devicemanager?a.devicemanager.deleteDevice(h.info,
c,function(a){a?b(a):(c.data.devices.splice(g,1),c._save(function(a){b(a,h)}))}):b(new d(e.INVALID,"sys "+h.info.sys+" do not have device manager implementation")):b(new d(e.UNKNOW,"sys "+h.info.sys+" unknow")):b(new d(e.NOT_PERMITTED,"sys "+h.info.sys+" not permitted")):b(new d(e.NOT_FOUND,"no device has index "+a))}else b(new d(e.INVALID,"index "+a+" invalid"))},_deleteUnlicensed:function(a,c,b){var d=[],e=c.devices;if(e){for(var f=m.aio.devicemanager._configmanager.LicenseManager,h=0;h<e.length;h++){var g=
e[h];f.permitFeature("add",g.info,a.tenant.license,g.index,e)&&d.push(g)}c.devices=d}b&&b()}};
...
a.properties?(c.forEach(function(c){a.match(c)&&b.push(c)}),b):c},_update:function(a,c,b){var d=m.aio.devicemanager.DMError,e=m.aio.devicemanager.DMError.ERROR_CODE;if(a.index){if("string"===typeof a.index)if(a.index.match(/^[-]?\d+$/))a.index=parseInt(a.index);else{b(new d(e.INVALID,"index "+a.index+" invalid"));return}if(a.name){var f,h=c.data.rooms;for(f=0;f<h.length;f++)if(a.index===h[f].index)var g=h[f];else if(a.name===h[f].name){b(new d(e.NAME_EXISTS,"name "+a.name+" exists"));return}g?g.name!==
a.name?(g.name=a.name,c._save(function(a){b(a,g)})):b(null,g):b(new d(e.NOT_FOUND,"no room has index "+a.index))}else b(new d(e.INVALID,"name "+a.name+" invalid"))}else b(new d(e.INVALID,"index "+a.index+" invalid"))},_delete:function(a,c,b){var d=m.aio.devicemanager.DMError,e=m.aio.devicemanager.DMError.ERROR_CODE;if(a){if(a&&"string"===typeof a)if(a.match(/^[-]?\d+$/))a=parseInt(a);else{b(new d(e.INVALID,"index "+a+" invalid"));return}var f=c.data.rooms,h=-1,g;for(g=0;g<f.length;g++)if(a===f[g].index){var k=
f[g];h=g}if(k){d=c.data.devices;for(g=0;g<d.length;g++)a===d[g].room&&(d[g].room=0);0<=h&&(c.data.rooms.splice(h,1),c._save(function(a){b(a,k)}))}else b(new d(e.NOT_FOUND,"no room has index "+a))}else b(new d(e.INVALID,"index "+a+" invalid"))}};
...
m.aio.devicemanager.DeviceManager.prototype.reloadTenant=function(a,c){for(var b=-1,d=0;d<this.handlers.length;d++){var e=this.handlers[d];if(e&&e.tenant&&e.tenant.index==a.index){b=d;break}}-1!=b&&this.handlers.splice(b,1);this._loadTenant(a,c)};m.aio.devicemanager.DeviceManager.prototype.execute=function(a,c,b,d,e){for(var f=null,h=0;h<this.handlers.length;h++){var g=this.handlers[h];if(g.tenant&&g.tenant.index==c){f=g;break}}f?f.execute(a,b,d,function(a,b){e(a,b)}):e(Error("no such tenant"))};
m.aio.devicemanager.DeviceManager.prototype.executeSync=function(a,c,b,d){for(var e=null,f=0;f<this.handlers.length;f++){var h=this.handlers[f];if(h.tenant&&h.tenant.index==c){e=h;break}}if(!e)throw Error("no such tenant");return e.executeSync(a,b,d)};
...
function(a){c&&c(a)}):c&&c()})):c&&c(null)}else c&&c(Error("not permitted"))}):c(Error("no such tenant"))};m.aio.devicemanager.DeviceManager.prototype.getIntHandler=function(a){for(var c=0;c<this.handlers.length;c++){var b=this.handlers[c];if(b.tenant&&b.tenant.index==a)return b}return null};
...
b(a)}))})}else b&&b(Error("invalid tenant folder"))}else b&&b(Error("remote do not belong to any tenant"))}else b&&b(Error("remote is isolated"))};m.aio.devicemanager.DeviceManager.prototype._copyFile=function(a,c,b){var d=require("fs-extra");d.exists(a,function(e){e?d.copy(a,c,function(a){b&&b(a)}):b&&b()})};
...
new m.aio.devicemanager.IntHandler(e,a,{devices:[],rooms:[],gateways:[]});this.handlers.push(g);a=h+f.sep+m.aio.devicemanager.DeviceManager.DB;var k=h+f.sep+m.aio.devicemanager.DeviceManager.DEVICE_INFO;require("fs").existsSync(a+".enc")&&(a+=".enc");(function(a,b,c){var d=require("fs");d.exists(b,function(f){f?d.readFile(b,{encoding:"utf8"},function(d,f){if(!d&&0<f.length)try{String(b).endsWith(".enc")&&(f=require("x.crypt").AES.decodeString(f,e.ml_v1_info()));var g=JSON.parse(f);g&&(a.data=g,a.data.devices||
(a.data.devices=[]),a._sort(a.data.devices),a.data.gateways||(a.data.gateways=[]),a._sort(a.data.gateways),a.data.rooms||(a.data.rooms=[]),a._sort(a.data.rooms))}catch(q){console.error(q)}c()}):d.writeFile(b,"",function(){c()})})})(g,a,function(){d(g,k,function(){c&&c()})})}else c()};
...
m.aio.devicemanager.DeviceManager.prototype.applySmartWidgetFilter=function(a,c,b,d){var e=this.getIntHandler(a);if(e)if(a=e.findDeviceWithIndex(c))if(a.info){var f=e.findRoomWithIndex(a.room);e=null;f&&(e=f.name);var h=this.getModule(a.info.sys);if(h&&h.devicemanager&&h.devicemanager.applySmartWidgetFilter){f=JSON.parse(JSON.stringify(a));if(c=h.devicemanager.applySmartWidgetFilter(a.info,b,{index:c,name:a.name,room:e}))f.smartwidget=c;d&&d(null,f)}else d&&d(null,[])}else d&&d(null,[]);else c=Error("can not read device with id:"+
