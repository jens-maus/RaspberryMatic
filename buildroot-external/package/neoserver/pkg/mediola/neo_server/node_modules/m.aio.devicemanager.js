...
m.aio.devicemanager.DeviceManager.prototype.supportSmartWidget=function(a){return a&&a.info?require("m.aio.smartwidget.js").supportSmartWidget(a.info):!1};
m.aio.devicemanager.DeviceManager.prototype.applySmartWidgetFilter=function(a,c,b,d){var e=this.getIntHandler(a);if(e)if(a=e.findDeviceWithIndex(c))if(a.info){var f=e.findRoomWithIndex(a.room);e=null;f&&(e=f.name);var g=require("m.aio.smartwidget.js");f=JSON.parse(JSON.stringify(a));if(c=g.applySmartWidgetFilter(a.info,b,{index:c,name:a.name,room:e}))f.smartwidget=c;d&&d(null,f)}else d&&d(null,[]);else c=Error("can not read device with id:"+c),c.code=500,d&&d(c);else c=Error("no such tenant with index:"+
a),c.code=500,d&&d(c)};
m.aio.devicemanager.DeviceManager.prototype.applySmartWidgetFilterForGateway=function(a,c,b,d){var e=this.getIntHandler(a);if(e)if(e=e.findGatewayWithIndex(c))if(e.info){var f=this.getModule(e.info.sys);if(f&&f.devicemanager&&f.devicemanager.applySmartWidgetFilterForGateway){a=JSON.parse(JSON.stringify(e));if(c=f.devicemanager.applySmartWidgetFilterForGateway(e.info,b,{index:c,name:e.name}))a.smartwidget=c;d&&d(null,a)}else d&&d(null,[])}else d&&d(null,[]);else c=Error("can not read device with id:"+c),
c.code=500,d&&d(c);else c=Error("no such tenant with index:"+a),c.code=500,d&&d(c)};m.aio.devicemanager.DeviceManager.prototype.ml_v1_info=function(){return require("x.crypt").SHA1("0cc6c6df12537fc79522a1ac15f1f592e93fdeb3")};
