...
m.aio.skinmanager.Widget.loadType=function(a,b,e,d){var c=require("fs"),f=require("async"),g=require("path");c.readdir(a,function(c,q){if(c)d&&d(c);else{var k=[];f.eachLimit(q,100,function(c,d){m.aio.skinmanager.Widget.load(a+g.sep+c,b,c,e,function(a,b){!a&&b&&k.push(b);d()})},function(a){d&&d(a,k)})}})};
m.aio.skinmanager.Widget.load=function(a,b,e,d,c){var f=require("fs"),g=require("path");require("async");f.readdir(a,function(f,q){if(f)c&&c(f);else{f=require("unorm");var k=new m.aio.skinmanager.Widget;k.skin=d;k.type=f.nfc(b);k.name=f.nfc(e);var h=[];q.forEach(function(b){b=new m.aio.skinmanager.Resource.loadSync(a+g.sep+b,b,k);h.push(b)});h&&0!=h.length?(k.resources=h,c&&c(null,k)):c&&c(Error("widget has no resources"))}})};
...
{type:this.type,name:this.name,resources:[]};a._loc=this.getLocation();this.resources.forEach(function(b){a.resources.push(b.toJSON())});return a}};m.aio.skinmanager.Skin=function(a){this.type=a;this.path=this.schema=this.base=this.version=this.name=this.id=null};m.aio.skinmanager.Skin.SETTINGS_FILE="settings";m.aio.skinmanager.Skin.TYPE={SYSTEM:1,CUSTOM:2,REMOTE:3,DUMMY:4};
...
break;case m.aio.skinmanager.Skin.TYPE.REMOTE:if(!e.tenantId||!e.remoteId){d&&d(Error("skinType info invalid"));return}f=new m.aio.skinmanager.RemoteSkin(e.tenantId,e.remoteId);break;case m.aio.skinmanager.Skin.TYPE.DUMMY:if(!e.tenantId||!e.remoteId){d&&d(Error("skinType info invalid"));return}f=new m.aio.skinmanager.DummySkin(e.tenantId,e.remoteId);break;default:d&&d(Error("skin type invalid"));return}f.id=b;f.name=c.name;f.version=c.version?c.version:0;f.version=c.version?c.version:0;f.base=c.base;
f.schema=c.schema?c.schema:0;f.path=a;d&&d(null,f)}else d&&d(Error("skin has no name"))}else d&&d(Error("settings file of "+g+" is empty"))})}else d&&d(Error("invalid skin path"))};
m.aio.skinmanager.Skin.prototype={updateVersion:function(a,b){var e=this,d=require("fs"),c=require("path"),f=this.path+c.sep+m.aio.skinmanager.Skin.SETTINGS_FILE;d.readFile(f,{encoding:"utf8"},function(c,k){if(c)b&&b(c);else if(k&&0!=k.length){c=null;try{c=JSON.parse(k)}catch(q){b&&b(Error("settings file of "+f+" is not in json"));return}parseInt(c.version)==parseInt(a)?b&&b(null):(c.version=parseInt(a),d.writeFile(f,JSON.stringify(c),{encoding:"utf8"},function(c){c||(e.version=parseInt(a));b&&b(c)}))}else b&&
b(Error("settings file of "+f+" is empty"))})},loadWidgets:function(a){var b=require("fs"),e=require("path"),d=require("async");b.readdir(this.path,function(b,f){if(b)a&&a(b);else{var c=[];d.eachLimit(f,100,function(a,b){m.aio.skinmanager.Widget.loadType(this.path+e.sep+a,a,this,function(a,d){!a&&d&&(c=c.concat(d));b()})}.bind(this),function(b){a&&a(b,c)}.bind(this))}}.bind(this))},toJSON:function(){return{type:this.type,id:this.id,name:this.name,version:this.version,base:this.base,schema:this.schema,
folder:this.path}}};m.aio.skinmanager.SystemSkin=function(){m.aio.skinmanager.Skin.call(this,m.aio.skinmanager.Skin.TYPE.SYSTEM)};m.aio.skinmanager.SystemSkin.prototype=new m.aio.skinmanager.Skin;m.aio.skinmanager.SystemSkin.prototype.constructor=m.aio.skinmanager.SystemSkin;m.aio.skinmanager.SystemSkin.prototype.getURL=function(){var a=new m.aio.skinmanager.LocalUrl;a.skinId=this.id;return a};m.aio.skinmanager.CustomSkin=function(){m.aio.skinmanager.Skin.call(this,m.aio.skinmanager.Skin.TYPE.CUSTOM)};
m.aio.skinmanager.CustomSkin.prototype=new m.aio.skinmanager.Skin;m.aio.skinmanager.CustomSkin.prototype.constructor=m.aio.skinmanager.CustomSkin;m.aio.skinmanager.CustomSkin.prototype.getURL=function(){var a=new m.aio.skinmanager.LocalUrl;a.skinId=this.id;return a};m.aio.skinmanager.RemoteSkin=function(a,b){m.aio.skinmanager.Skin.call(this,m.aio.skinmanager.Skin.TYPE.REMOTE);this.tenantId=a;this.remoteId=b};m.aio.skinmanager.RemoteSkin.URL_PREFIX="REMOTE";m.aio.skinmanager.RemoteSkin.prototype=new m.aio.skinmanager.Skin;
m.aio.skinmanager.RemoteSkin.prototype.constructor=m.aio.skinmanager.RemoteSkin;m.aio.skinmanager.RemoteSkin.prototype.getURL=function(){var a=new m.aio.skinmanager.InRemoteUrl;a.tenantId=this.tenantId;a.remoteId=this.remoteId;a.skinId=this.id;return a};m.aio.skinmanager.DummySkin=function(a,b){m.aio.skinmanager.Skin.call(this,m.aio.skinmanager.Skin.TYPE.DUMMY);this.id=m.aio.skinmanager.SkinManager.CUSTOM_IN_REMOTE_WIDGET_FOLDER;this.tenantId=a;this.remoteId=b};
m.aio.skinmanager.DummySkin.prototype=new m.aio.skinmanager.Skin;m.aio.skinmanager.DummySkin.prototype.constructor=m.aio.skinmanager.DummySkin;m.aio.skinmanager.DummySkin.prototype.getURL=function(){var a=new m.aio.skinmanager.InRemoteCustomWidgetUrl;a.tenantId=this.tenantId;a.remoteId=this.remoteId;return a};m.aio.skinmanager.LocalCustomWidgetDummySkin=function(){m.aio.skinmanager.Skin.call(this,m.aio.skinmanager.Skin.TYPE.DUMMY)};m.aio.skinmanager.LocalCustomWidgetDummySkin.prototype=new m.aio.skinmanager.Skin;
...
this.skins,function(a,b){!a&&b&&(d=d.concat(b));e&&e(null,d)})},uploadResource:function(a,b,e,d,c,f){if(a&&b){e||(e=m.aio.skinmanager.Widget.DEFAULT_CUSTOM_WIDGET_TYPE);d||(d=m.aio.skinmanager.Widget.DEFAULT_CUSTOM_WIDGET_NAME);c||(c=a);a=require("path");var g=require("async"),k=require("fs-extra"),q=require("fs-extra"),l=this.customWidgetPath+a.sep+e+a.sep+d,h=l+a.sep+c;g.series([function(a){k.ensureDir(l,a)},function(a){k.exists(h,function(b){b?q.move(h,h+"_del",function(b){b?a(b):k.unlink(h+"_del",
function(b){a(b)})}):a()})},function(a){q.move(b,h,function(b){a(b)})}],function(a){a?f&&f(a):(a=new m.aio.skinmanager.LocalCustomWidgetUrl,a.widgetType=e,a.widgetName=d,a.resourcePath=c,f&&f(null,a.toString()))})}else f&&f(Error("invalid paramters"))},_uploadResource:function(a,b,e,d,c){if(a&&b&&e&&d){var f=require("path");this._getRemoteFolder(a,b,function(g,k){if(g)c&&c(g);else{g=require("async");var q=require("fs"),l=k+f.sep+m.aio.skinmanager.SkinManager.RESOURCE_FOLDER;g.series([function(a){q.mkdir(l,
function(){a()})},function(a){l=l+f.sep+m.aio.skinmanager.SkinManager.CUSTOM_IN_REMOTE_WIDGET_FOLDER;q.mkdir(l,function(){a()})},function(a){l=l+f.sep+m.aio.skinmanager.Widget.DEFAULT_CUSTOM_WIDGET_TYPE;q.mkdir(l,function(){a()})},function(a){l=l+f.sep+m.aio.skinmanager.Widget.DEFAULT_CUSTOM_WIDGET_NAME;q.mkdir(l,function(){a()})}],function(g){g?c&&c(g):q.rename(d,l+f.sep+e,function(d){d?c&&c(d):(d=new m.aio.skinmanager.InRemoteCustomWidgetUrl,d.tenantId=a,d.remoteId=b,d.widgetType=m.aio.skinmanager.Widget.DEFAULT_CUSTOM_WIDGET_TYPE,
...
e=e.join(a.path,b);return d.existsSync(e)?e:a.base?this._getLocalSkinResourcePath(a.base,b):null},_getLocalSkinWidgetPath:function(a,b,e){var d=require("path"),c=require("fs");a=this._getSkin(this.skins,a);if(!a||!a.path)return null;d=d.join(a.path,b,e);return c.existsSync(d)?d:a.base?this._getLocalSkinResourcePath(a.base,b,e):null},saveRemote2:function(a,b,e){var d=require("fs-extra"),c=require("path"),f=require("async"),g=a.getFolderPath();if(g){var k=a.index,q=a.parent.parent.index,l=b&&b.skin&&
b.skin.id?b.skin.id:null,h=!(!a||!a.skin||!a.skin.id),p=b&&b.skin&&b.skin.inRemote,y=(new Date).getTime(),r=this._getInRemoteSkinsFolder(g),w=this._getInRemoteCustomWidgetFolder(g),x=g+c.sep+this.RESOURCE_FOLDER,A=g+c.sep+this.RESOURCE_FOLDER+"_"+y,B=g+c.sep+this.RESOURCE_FOLDER+"_"+y+c.sep+this.SKIN_FLODER,z=r+c.sep+b.skin.id,D=function(a){a=a.split("/");if("custom"!=a[0])return!1;if(2<a.length&&"custom"==a[0]){if(a[1].match(/^.+__\d+$/))return!1;a=a[a.length-1].split(".");if(3<=a.length&&a[a.length-
2].match(/^\d+$/))return!1}return!0},E=function(a,b){a=a.toString();b=b.split(".");2==b.length?b.splice(1,0,a):3<=b.length&&(b[b.length-2].match(/^\d+$/)?parseInt(b[b.length-2])<parseInt(a)&&(b[b.length-2]=a):b.splice([b.length-2],0,a));return b.join(".")},t=function(a,b,c){var d=require("fs-extra"),e=require("path"),f=require("md5"),g=function(a){a=d.readFileSync(a);return f(a)},u=0;b=E(u,b);for(var v=a+e.sep+b;d.existsSync(v);){if(d.statSync(v).size==d.statSync(c).size&&g(v)==g(v))return b;u++;
b=E(u,b);v=a+e.sep+b}d.copySync(c,v,{clobber:!0});return b},C=function(a,b){var e,f=b.length;a:{var n=a.split("/");if(2<n.length&&"custom"==n[0]){if(n[1].match(/^.+__\d+$/)){var g=!0;break a}n=n[n.length-1].split(".");if(3<=n.length&&n[n.length-2].match(/^\d+$/)){g=!0;break a}}g=!1}for(var G=D(a);f--;){var h=b[f].getLocation();switch(h){case "local_custom":if(G)for(n=b[f].resources.length;n--;)if(b[f].resources[n].getRef()==a)return h=x+c.sep+"custom"+c.sep+b[f].type+c.sep+b[f].name,(e=t(h,b[f].resources[n].name,
b[f].resources[n].file))?"custom/"+b[f].type+"/"+b[f].name+"/"+e:null;break;case "in_remote_custom":if(G)for(n=b[f].resources.length;n--;){if(b[f].resources[n].getRef()==a){var p=b[f];e=b[f].resources[n];break}}else if(g)for(n=b[f].resources.length;n--;)if(b[f].resources[n].getRef()==a)return a=b[f].skin.path,"\\"==c.sep&&(a=a.replace(/\\/g,"/")),a=a.split("/"),2<a.length&&(a[a.length-2]=a[a.length-2]+"_"+y),a=a.join(c.sep),a=a+c.sep+b[f].type+c.sep+b[f].name+c.sep+b[f].resources[n].name,p=b[f].type,
e=p.indexOf("__"),0<e&&(p=p.substr(0,e)),h=w+c.sep+p+c.sep+b[f].name,(e=t(h,b[f].resources[n].name,a))?"custom/"+p+"/"+b[f].name+"/"+e:null;break;default:if(0==a.indexOf(b[f].type+"/"+b[f].name))for(n=b[f].resources.length;n--;)if(b[f].resources[n].getRef()==a){"in_remote_skin"==h?(a=B,a=a+c.sep+b[f].type+c.sep+b[f].name+c.sep+b[f].resources[n].name,h=r+c.sep+l+c.sep+b[f].type+c.sep+b[f].name+c.sep+b[f].resources[n].name,d.copySync(a,h,{clobber:!0})):b[f].resources[n].copySync(r,l);return}}}if(p&&
e)return a=p.skin.path,"\\"==c.sep&&(a=a.replace(/\\/g,"/")),a=a.split("/"),2<a.length&&(a[a.length-2]=a[a.length-2]+"_"+y),a=a.join(c.sep),a=a+c.sep+p.type+c.sep+p.name+c.sep+e.name,h=w+c.sep+p.type+c.sep+p.name,(e=t(h,e.name,a))?"custom/"+p.type+"/"+p.name+"/"+e:null};f.waterfall([function(a){p?a():d.remove(r,function(b){a(b)})},function(a){this.getRemoteWidgets(q,k,h?l:null,p,function(b,c){b?a(b):d.exists(x,function(b){b?d.move(x,A,function(b){a(b,c)}):a(null,c)})}.bind(this))}.bind(this),function(b,
d){a.processResourceList({resourceBuf:[],widgetBuf:[],processResourceSync:function(a){for(var c=0;c<this.resourceBuf.length;c++)if(this.resourceBuf[c]&&this.resourceBuf[c].ref==a)return this.resourceBuf[c].newRef;try{var d=C(a,b);this.resourceBuf.push({ref:a,newRef:d});return d}catch(J){return null}},processWidgetSync:function(a){for(var d=0;d<this.widgetBuf.length;d++){var f=this.widgetBuf[d];if(f&&f.widgetType==a.widgetType&&f.widgetName==a.widgetName)return}try{for(d=0;d<b.length;d++)if(a.widgetType==
b[d].type&&a.widgetName==b[d].name){var g=b[d];break}if(g)switch(g.getLocation()){case "in_remote_skin":case "in_remote_custom":var p=g.skin.path;"\\"==c.sep&&(p=p.replace(/\\/g,"/"));var h=p.split("/");3<h.length&&(h[h.length-3]=h[h.length-3]+"_"+y);p=h.join(c.sep);g._copySync(p,r,l);break;default:g.copySync(r,l,e)}this.widgetBuf.push(a)}catch(L){}}},function(a){d(a)})},function(a){d.remove(A,a)},function(a){d.ensureDir(z,function(e){e?a(e):d.writeFile(z+c.sep+m.aio.skinmanager.Skin.SETTINGS_FILE,
JSON.stringify({name:"in-remote"}),function(c){c||(b.skin.inRemote=!0);a(c)})})}],function(a){e&&e(a,b)})}else e&&e(Error("remote folder path invalid"))},saveRemote:function(a,b,e){var d=require("fs-extra"),c=require("path"),f=require("async"),g=require("m.aio.skinmanager.js"),k=a.getFolderPath();if(k){var q=b&&b.skin&&b.skin.id?b.skin.id:null,l=b&&b.skin&&b.skin.inRemote,h=this._getInRemoteResourceFolder(k),p=this._getInRemoteSkinsFolder(k),y=this.customWidgetPath.replace(this.CUSTOM_IN_REMOTE_WIDGET_FOLDER,
""),r=p+c.sep+b.skin.id,w=function(a){return"custom"==a.split("/")[0]},x=function(a){if(!w(a))return!1;a=a.split("/");if(2<a.length){if(a[1].match(/^.+__\d+$/))return!0;a=a[a.length-1].split(".");if(3<=a.length&&a[a.length-2].match(/^\d+$/))return!0}return!1},A=function(a){return w(a)?!x(a):!1},B=function(a){return w(a)?!1:!(w(a)?0:l)},z=function(a,b){if(x(a)||A(a))return c.join(h,a);B(a);return c.join(p,b||q,a)},D=function(a,b){b=b.split("/");var c=b[b.length-1].split(".");c.splice(c.length-1,0,
""+a);b[b.length-1]=c.join(".");return b.join("/")},E=function(a,b){var c=require("fs-extra"),d=require("md5"),e=function(a){a=c.readFileSync(a);return d(a)};if(c.existsSync(b))return c.statSync(b).size==c.statSync(a).size&&e(b)==e(a)?b:null;c.copySync(a,b,{clobber:!0});return b},t=[],C=[],u={},v={},F=function(a){for(var b=d.readdirSync(a),e=0,f,g=0;g<b.length;g++)f=c.join(a,b[g]),(f=d.statSync(f).isDirectory()?F(f):H(f))&&e++;return e==b.length?(d.removeSync(a),!0):!1},H=function(a){if(-1!=t.indexOf(a))return!1;
var b=require("unorm").nfc(a);if(-1!=t.indexOf(b))return!1;for(b=0;b<C.length;b++){var c=C[b];if(a.substr(0,c.length)==c)return!1}d.removeSync(a);return!0};f.waterfall([function(a){l?a():d.remove(p,function(b){a(b)})},function(b){a.processResourceList({resourceBuf:[],widgetBuf:[],processResourceSync:function(a,b){try{var e=b+":"+a;if(u[e])var f=u[e];else{var r=x(a)?c.join(h,a):A(a)?c.join(y,a):B(a)?g._getLocalSkinResourcePath(b||q,a):c.join(p,a);var n=z(a,b);if(x(a)||(w(a)?0:l))u[e]=a,t.push(n),f=
a;else if(A(a)){var k=D(0,a);n=z(k);for(b=0;!E(r,n);)k=D(++b,a),n=z(k);u[e]=k;t.push(n);f=k}else d.copySync(r,n,{clobber:!0}),u[e]=a,t.push(n),f=void 0}this.resourceBuf.push({ref:a,newRef:f});return f}catch(M){return null}},processWidgetSync:function(a){try{var b=a.widgetType+"/"+a.widgetName;a.widgetSkin&&(b=a.widgetSkin+"/"+b);if(!v[b]){var e=l?c.join(p,a.widgetSkin||q,a.widgetType,a.widgetName):g._getLocalSkinWidgetPath(a.widgetSkin||q,a.widgetType,a.widgetName);var f=c.join(p,a.widgetSkin||q,
a.widgetType,a.widgetName);l||d.copySync(e,f,{clobber:!0});v[b]=!0;C.push(f)}this.widgetBuf.push(a)}catch(K){}}},function(a){b(a)})},function(a){try{for(var b=require("unorm"),c=0;c<t.length;c++)t[c]=b.nfc(t[c]);d.existsSync(h)&&F(h);a(null)}catch(I){a(I)}},function(a){d.ensureDir(r,function(e){e?a(e):d.writeFile(r+c.sep+m.aio.skinmanager.Skin.SETTINGS_FILE,JSON.stringify({name:"in-remote"}),function(c){c||(b.skin.inRemote=!0);a(c)})})}],function(a){a&&(console.error(a),this._logger.log("error",a));
e&&e(a,b)}.bind(this))}else e&&e(Error("remote folder path invalid"))},downloadSystemSkin:function(a,b,e,d){var c="webservice.mediola.com",f=443,g="";switch(process.env.CLOUD){case "local":c=process.env.CLOUD_HOST?process.env.CLOUD_HOST:"localhost";f=8080;g="/webservice";break;case "dev":c=process.env.CLOUD_HOST?process.env.CLOUD_HOST:"mediola-dev.elasticbeanstalk.com";f=80;break;default:c=process.env.CLOUD_HOST?process.env.CLOUD_HOST:"webservice.mediola.com",f=443}var k=function(a,b,d){var e=d;d=
443===f?require("https"):require("http");a={host:c,port:f,path:g+"/creatorneo/skin/getSkinUrl?license="+a+"&skinName="+encodeURIComponent(b),method:"GET",timeout:2E4,headers:{"User-Agent":"mediola",Connection:"close"}};var h="";a=d.request(a,function(a){a.setEncoding("utf8");a.on("data",function(a){h+=a});a.on("end",function(){if(e)if(200==a.statusCode){try{var b=JSON.parse(h)}catch(z){e(Error("request response invalid:"+h))}b&&b.url?e(null,b.url,b.version):e(Error("request response invalid:"+h))}else e(Error("request failed:"+
h));e=null})});if(a.on&&"function"==typeof a.on)a.on("error",function(a){e&&e(a);e=null});a.setTimeout&&a.setTimeout(2E4);a.end()},q=this,l=this._logger,h=this._configmanager;a="config/tenants/"+a;l.log("debug","start to download system skin "+b);e&&e(0,"start");h.trace(a,function(a,c){if(a)d&&d(a);else{var f=c.license;e&&e(1,"get skin info from server");l.log("debug","try to get skin "+b+" info from server");k(f.licenseTxt,b,function(a,c,g){a?d&&d(a):q._checkSystemSkinExists(b,g,function(a,h){a?
d&&d(a):h?(l.log("debug","find system skin "+b),q._updateInfomanager(f,b,function(){d&&d()})):q._downloadAndSaveSkin(f,c,b,g,e,function(a){a?d&&d(a):q._updateInfomanager(f,b,function(){d&&d()})})})})}})},_checkSystemSkinExists:function(a,b,e){for(var d=!1,c=0;c<this.skins.length;c++)if(this.skins[c]&&1==this.skins[c].type&&this.skins[c].id==a){var f=this.skins[c].version?parseInt(this.skins[c].version):0,g=b?parseInt(b):0;if(f>=g){d=!0;break}}e&&e(null,d)},_downloadAndSaveSkin:function(a,b,e,d,c,
f){var g=this,k=this._logger,q=function(a,b,c){var d=require("adm-zip"),e=require("m.aio.filemanager.js").getTmpDir(),f=require("path"),g=require("fs-extra");a=new d(a);b=f.join(e,b);try{g.existsSync(b)&&g.removeSync(b),g.ensureDirSync(b),a.extractAllTo(b,!0),c&&c(null,b)}catch(B){c&&c(B)}},l=function(a,b,c,d){var e=require("path"),f=require("fs-extra"),g=e.join(a,c);f.existsSync(g)&&f.removeSync(g);f.move(b,g,{limit:100},function(a){f.chmod(g,511,function(a){d&&d(a,g)})})};c&&c(1,"get skin info from server");
k.log("debug","start download skin "+e+" zip from server");c&&c(2,"download skin");(function(a,b,c){var d=c;a=require("url").parse(a);c=require("http");-1!=a.protocol.indexOf("https")&&(c=require("https"));a.method="GET";a.timeout=2E4;var e=require("m.aio.filemanager.js").getTmpDir(),f=require("path"),g=require("fs"),h=0,l=f.join(e,(new Date).getTime()+".zip"),p=g.createWriteStream(l);p.on("error",function(a){d&&d(a);d=null});a=c.request(a,function(a){var c=a.headers["content-length"];k.log("trace",
"http skin zip length:"+c);var e=!1,f=!1;a.pipe(p);p.on("finish",function(){p.close(function(){f=!0;e&&f&&d&&(200!=a.statusCode?d(Error("http response code:"+a.statusCode)):d(null,l),d=null)})});a.on("data",function(a){h+=a.length;k.log("trace","receive chunk:"+a.length+" total:"+h+"/"+c);b&&b(parseFloat("2."+h),"download chunk "+h,{count:h,total:parseInt(c)})});a.on("end",function(){(e=!0,f)&&d&&(200!=a.statusCode?d(Error("http response code:"+a.statusCode)):d(null,l),d=null)})});if(a.on&&"function"==
typeof a.on)a.on("error",function(a){d&&d(a);d=null});a.setTimeout&&a.setTimeout(2E4);a.end()})(b,c,function(a,b){a?f&&f(a):(c&&c(3,"unpack skin"),k.log("debug","start unpack skin from file:"+b),q(b,e,function(a,b){a?f&&f(a):(k.log("debug","move skin from:"+b+" to:"+g.sysSkinsPath),l(g.sysSkinsPath,b,e,function(a,b){a?f&&f(a):(c&&c(4,"load skin"),k.log("debug","load skin "+e+" from:"+b),m.aio.skinmanager.Skin.load(b,e,{skinType:1},function(a,b){if(a)f&&f(a);else{a=-1;for(var c=0;c<g.skins.length;c++)if(g.skins[c]&&
g.skins[c].type==b.type&&g.skins[c].id==b.id){a=c;break}-1!=a&&g.skins.splice(a,1);g.skins.push(b);b.updateVersion(d,function(a){f&&f(a)})}}))}))}))})},_updateInfomanager:function(a,b,e){require("m.aio.infomanager").updateDownloadSkin(a,b,function(){e&&e()})}};"undefined"!=typeof module&&null!=module&&(module.exports=m.aio.skinmanager.SkinManager);
