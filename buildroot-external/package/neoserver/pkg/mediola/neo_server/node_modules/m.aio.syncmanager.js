...
a,e.name),f=n.readFileSync(f),e=e.name,a&&(e=a+"/"+e),p.file(e,f))}else e.isDirectory()&&u(a+"/"+e.name)}};a._fileExistsSync(f)&&p.file("device_db",n.readFileSync(f));a._fileExistsSync(g)&&p.file("device_db.enc",n.readFileSync(g));a._fileExistsSync(h)&&p.file("macros_db",n.readFileSync(h));if(a._fileExistsSync(k))if(e=n.statSync(k),e.isDirectory())u("automation");else{e=Error("Automation folder is not a directory: "+k);a._logger.log("error",e.message);c&&c(e);c=null;return}p.generateNodeStream({compression:"DEFLATE",
