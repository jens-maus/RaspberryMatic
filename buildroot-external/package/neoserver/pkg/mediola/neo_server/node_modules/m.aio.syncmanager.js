...
b)try{f.removeSync(g)}catch(n){}c(a,e)}):c()}):c()},function(c){var b=d.getMacrosFile();b?fs.exists(b,function(d){d?a._getFileInfos(b,e,function(a,b){c(a,b)}):c()}):c()},function(c){var b=d.getDeviceinfoFile();b?fs.exists(b,function(d){d?a._getFileInfos(b,e,function(a,b){c(a,b)}):c()}):c()}],function(a,b){var e=[];b&&b.forEach(function(a){a&&e.push(a)});c&&c(a,e)})},_getTenantDatabaseInfo:function(d,b){var c=this,a=d.getFolderPath();async.parallel([function(b){var e=d.getDeviceFile();e?fs.exists(e,
