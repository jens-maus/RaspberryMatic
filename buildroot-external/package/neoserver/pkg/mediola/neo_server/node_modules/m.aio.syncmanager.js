...
var h=m.aio.syncmanager.RemoteDownloader.OPTIONS.path+"/creatorneo/remote/downloadFile";b=b.ref.split("/");for(var k=0;k<b.length;k++)b[k]=encodeURI(b[k]);b=m.aio.syncmanager.RemoteDownloader.PROTOCOL+"://"+a+":"+f+h+"/"+b.join("/");a=this._username?encodeURIComponent(this._username):"";f=this._password?encodeURIComponent(this._password):"";b+="?username="+a+"&password="+f;this._logger.log("trace","download file url:"+b);var l=e.createWriteStream(g);d.get(b,function(a){a.pipe(l);l.on("finish",function(){l.close(c)})}).on("error",
