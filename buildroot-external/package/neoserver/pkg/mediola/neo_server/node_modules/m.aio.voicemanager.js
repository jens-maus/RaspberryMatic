...
function(c,b,a){return this._processCommandsFromMap(n.NETATMO_MAP,c,b,a)};n.prototype._processCommandsFromMap=function(c,b,a,d,e){a||(a="de");a=a.toLowerCase();for(var g={},k=n.LANG.indexOf(a),h=0;h<b.info.command.length;h++){var f=b.info.command[h];if("string"!=f.type||"aio"==b.info.sys&&"STRING"==b.info.type)if("root"==f.type)this._processRootCommandsFromMap(g,f,c,b,a,d,e);else{var l={type:"POST",url:"/cmd",original:f.name,data:{XC_FNC:"SendRM",device:b.index,command:JSON.parse(JSON.stringify(f.ref))}},
q=f.name.toLowerCase(),p=n.MAP[q]?n.MAP[q][k]:null;(q=c&&c[q]?c[q][k]:null)&&(p=q);var r=null;q=b.info.sys;if(this._customMap&&q&&this._customMap[q]){var t=this._customMap[q];r=t[f.name]?t[f.name][k]:null}r&&(p=r);if("%d"==f.ref.ext||"%f"==f.ref.ext||"%s"==f.ref.ext)l.data.command.ext="{val}","%f"==f.ref.ext&&(l["float"]=1),f.ref.extMeta&&(r=f.ref.extMeta.indexOf("-",1),-1!=r&&(q=parseFloat(f.ref.extMeta.substr(0,r)),r=parseFloat(f.ref.extMeta.substr(r+1)),l.min=q,l.max=r)),f.ref.scale&&(l.step=parseFloat(f.ref.scale)),
p||(p=f.name),"value"==p?g[p]=l:(d&&!d.values&&(d.values={}),d&&d.values&&(d.values[p]=l));else if("%e"==f.ref.ext){if(p||(p=f.name),f.ref.extMeta&&0<f.ref.extMeta.length)for(r=0;r<f.ref.extMeta.length;r++){var u=JSON.parse(JSON.stringify(l));u.data.command.ext=f.ref.extMeta[r];u.original+=" "+f.ref.extMeta[r];var v=p+" "+f.ref.extMeta[r];this._customMap&&q&&this._customMap[q]&&(t=this._customMap[q],(t=t[u.original]?t[u.original][k]:null)&&(v=t));g[v]=u}}else"rgb"==f.type||"rgbw"==f.type?(l=JSON.parse(JSON.stringify(l)),
l.data.command.ext="FF0000",g[n.MAP.red[k]]=l,l=JSON.parse(JSON.stringify(l)),l.data.command.ext="FF00FF",g[n.MAP.purple[k]]=l,l=JSON.parse(JSON.stringify(l)),l.data.command.ext="0000FF",g[n.MAP.blue[k]]=l,l=JSON.parse(JSON.stringify(l)),l.data.command.ext="00FFFF",g[n.MAP.cyan[k]]=l,l=JSON.parse(JSON.stringify(l)),l.data.command.ext="00FF00",g[n.MAP.green[k]]=l,l=JSON.parse(JSON.stringify(l)),l.data.command.ext="FFFF00",g[n.MAP.yellow[k]]=l,l=JSON.parse(JSON.stringify(l)),l.data.command.ext="FF8C00",
g[n.MAP.orange[k]]=l,"rgbw"==f.type&&(l=JSON.parse(JSON.stringify(l)),l.data.command.ext="FFFFFF",g[n.MAP.white[k]]=l)):(p||(p=f.name),g[p]=l,r&&(l.mappedCustom=!0))}}return g};n.prototype._processRootCommandsFromMap=function(c,b,a,d,e,g,k){e||(e="de");e=e.toLowerCase();e=n.LANG.indexOf(e);if(b&&b.value&&b.children&&0!=b.children.length){if("mainzone"!=b.value&&"global"!=b.value){c=g.name+" "+b.name;var h={name:c,type:g.type,sys:g.sys,baseurl:g.baseurl,commands:{}};k[c]=h;c=h.commands}for(k=0;k<b.children.length;k++)if(h=
b.children[k],("string"!=h.type||"aio"==d.info.sys&&"STRING"==d.info.type)&&"root"!=h.type){var f={type:"POST",url:"/cmd",original:h.name,data:{XC_FNC:"SendRM",device:d.index,command:JSON.parse(JSON.stringify(h.ref))}};f.data.command.path=[b.value];var l=h.name.toLowerCase(),q=n.MAP[l]?n.MAP[l][e]:null;(l=a&&a[l]?a[l][e]:null)&&(q=l);var p=null;l=d.info.sys;if(this._customMap&&l&&this._customMap[l]){var r=this._customMap[l];p=r[h.name]?r[h.name][e]:null}p&&(q=p);if("%d"==h.ref.ext||"%f"==h.ref.ext||
"%s"==h.ref.ext)f.data.command.ext="{val}","%f"==h.ref.ext&&(f["float"]=1),h.ref.extMeta&&(p=h.ref.extMeta.indexOf("-",1),-1!=p&&(l=parseFloat(h.ref.extMeta.substr(0,p)),p=parseFloat(h.ref.extMeta.substr(p+1)),f.min=l,f.max=p)),h.ref.scale&&(f.step=parseFloat(h.ref.scale)),q||(q=h.name),"value"!=q&&(g&&!g.values&&(g.values={}),g&&g.values&&(g.values[q]=f));else if("%e"==h.ref.ext){if(q||(q=h.name),h.ref.extMeta&&0<h.ref.extMeta.length)for(p=0;p<h.ref.extMeta.length;p++){var t=JSON.parse(JSON.stringify(f));
t.data.command.ext=h.ref.extMeta[p];t.original+=" "+h.ref.extMeta[p];var u=q+" "+h.ref.extMeta[p];this._customMap&&l&&this._customMap[l]&&(r=this._customMap[l],(r=r[t.original]?r[t.original][e]:null)&&(u=r));c[u]=t}}else"rgb"==h.type||"rgbw"==h.type?(f=JSON.parse(JSON.stringify(f)),f.data.command.ext="FF0000",c[n.MAP.red[e]]=f,f=JSON.parse(JSON.stringify(f)),f.data.command.ext="FF00FF",c[n.MAP.purple[e]]=f,f=JSON.parse(JSON.stringify(f)),f.data.command.ext="0000FF",c[n.MAP.blue[e]]=f,f=JSON.parse(JSON.stringify(f)),
f.data.command.ext="00FFFF",c[n.MAP.cyan[e]]=f,f=JSON.parse(JSON.stringify(f)),f.data.command.ext="00FF00",c[n.MAP.green[e]]=f,f=JSON.parse(JSON.stringify(f)),f.data.command.ext="FFFF00",c[n.MAP.yellow[e]]=f,f=JSON.parse(JSON.stringify(f)),f.data.command.ext="FF8C00",c[n.MAP.orange[e]]=f,"rgbw"==h.type&&(f=JSON.parse(JSON.stringify(f)),f.data.command.ext="FFFFFF",c[n.MAP.white[e]]=f)):(q||(q=h.name),c[q]=f,p&&(f.mappedCustom=!0))}return c}};n.prototype._isDeviceHeater=function(c){var b="hm-cc-rt-dn;hm-cc-rt-dn-bom;hm-cc-tc;hm-cc-vg-1;hm-tc-it-wm-w-eu;hmip-bwth;hmip-bwth24;hmip-etrv;hmip-etrv-2;hmip-etrv-b;hmip-etrv-b1;hmip-etrv-c;hmip-heating;hmip-sth;hmip-sthd;hmip-wth;hmip-wth-2;hmip-wth-b;hmipw-sth;hmipw-sthd;hmipw-wth;zel stg rm fwt".split(";"),
a="heater thermostat wallthermo wallthermostat ip_heater ip_wallthermo ip_wallthermo2".split(" ");if(!c||!c.info)return!1;c=c.info;if("hm"==c.sys)return a=String(c.type).toLowerCase(),0<=b.indexOf(a);if("aio"==c.sys)if("HM"==c.type){if(-1!=a.indexOf(c.data))return!0}else{if("FHT80b"==c.type)return!0}else if("max"==c.sys){if(1==c.type||2==c.type||3==c.type)return!0}else if("tado"==c.sys||"netatmo"==c.sys&&"NATherm1"==c.type)return!0;return!1};n.prototype._isDeviceScene=function(c){return c&&c.info&&
"hm"==c.info.sys?"Prog"==c.info.type:!1};n.prototype._isDeviceBlind=function(c){return c&&c.info?"NY"===c.info.type&&"shutter"===c.info.data?!0:!1:!1};n.prototype._getDeviceCatagory=function(c){if(!c||!c.info)return null;if(this._isDeviceHeater(c))return"heater";if(this._isDeviceScene(c))return"scene";if(this._isDeviceBlind(c))return"blind";if(!c.info.command)return null;if("fibaro"==c.info.sys)return this._getFibaroHCDeviceCatagory(c);for(var b=c.info.command,a=!1,d=0;d<b.length;d++){var e=b[d];
if(e&&e.name){e=e.name.toLowerCase();if(("hue"==c.info.sys||"osram"==c.info.sys)&&"brightness"==e)return"light";if("moveto"==e||"move to"==e||"position to"==e||"positionto"==e)return"blind";if("dimto"==e||"dim to"==e||"levelto"==e||"level to"==e)return"light";"on"==e&&(a=!0)}}return a||a?"switch":null};n.prototype._getFibaroHCDeviceCatagory=function(c){c=c.info.command;for(var b=[],a=0;a<c.length;a++){var d=c[a];d&&d.name&&(d=d.name.toLowerCase(),-1==b.indexOf(d)&&b.push(d))}return-1!=b.indexOf("open")&&
-1!=b.indexOf("close")?"blind":-1!=b.indexOf("up")&&-1!=b.indexOf("down")&&-1!=b.indexOf("set value")?"light":-1!=b.indexOf("on")&&-1!=b.indexOf("off")?"switch":null};n.prototype._convertDeviceToCloudFormat=function(c,b,a,d,e){var g=c.info.sys,k=c.info.type,h=this._getDeviceCatagory(c);h&&(k=h);k={name:b,type:k,module:g,sys:g,baseurl:a,commands:{},states:{}};if("aio"==g&&"TASK"==c.info.type)return{name:b,type:"scene",module:g,sys:g,baseurl:a,commands:{on:{type:"POST",url:"/cmd",original:"run",data:{XC_FNC:"SendRM",
device:c.index,command:{value:"run"}}}}};if("hm"==g&&"Prog"==c.info.type)return k={name:b,type:"scene",module:g,sys:g,baseurl:a,commands:{on:{type:"POST",url:"/cmd",original:"run",data:{XC_FNC:"SendRM",device:c.index,command:{value:"progExec"}}}}};if(c.info.command&&0<c.info.command.length){switch(g){case "hm":b=this._processHMCommands(c,d,k,e);break;case "aio":b=this._processAIOCommands(c,d,k,e);break;case "sonos":b=this._processSonosCommands(c,d,k,e);break;case "hue":b=this._processHueCommands(c,
d,k,e);break;case "easyled":case "milight":case "milightv6":b=this._processMilightCommands(c,d,k,e);break;case "lightify":b=this._processOsramCommands(c,d,k,e);break;case "harmony":b=this._processHarmonyCommands(c,d,k,e);break;case "pioneer":case "onkyo":case "denon":case "yamaha":b=this._processHarmonyCommands(c,d,k,e);break;case "mcontrol":b=this._processMcontrolCommands(c,d,k,e);break;case "fibaro":b=this._processFibaroHCCommands(c,d,k,e);break;case "tado":b=this._processTadoCommands(c,d,k,e);
break;case "netatmo":b=this._processNetatmoCommands(c,d,k,e);break;default:b=this._processCommandsFromMap(null,c,d,k,e)}k.commands=b}c.info.status&&0<Object.keys(c.info.status).length&&(k.states=c.info.status);return k};n.prototype._resovleDeviceID=function(c,b,a){var d=c.name;a=a[c.room];if("_cameras"==d.substr(0,8)){a=null;var e=d.indexOf(":");d=d.substr(e+1)}"_progs&sysvars"==a&&(a=b[c.info.gateway],"gw"==d.substr(0,2)&&(e=d.indexOf("_"),d=d.substr(e+1)));b=(a?a+" ":"")+(d?d:"");c.cloud.alias&&
(b=c.cloud.alias);return b};n.prototype._resovleBaseUrl=function(c,b){var a=c,d=c.indexOf(":");-1!=d&&(a=c.substr(0,d));return"https://"+a+"/rapi/"+b};n.prototype.getAccessToken=function(c,b){if(c)if("aio"!=c.sys&&"neoserver"!=c.sys)b&&b(Error("gateway type invalid"));else{var a=this,d=require("xnm.aio.gateway.js");if("neoserver"==c.sys){c=JSON.parse(JSON.stringify(c));c.sys="aio";c.version="EA";var e=d.resolveGateway(c,!0)}else e=d.resolveGateway(c);e?d.Admin.getGatewaySID(e,function(g,k){g?(a._logger.log("warn",
"get gateway sid error:"+g.message),g.code="50001",g.message="get gateway sid error:"+g.message,b&&b(g)):k?c.password?d.Admin.V5.getInfo(e,function(h,f){h?(a._logger.log("warn","get gateway info error:"+h.message),h.message="get gateway info error:"+h.message,h.code="50101",b&&b(h)):f&&f.server?!f.cfg||parseInt(f.cfg,16)&64?(a._logger.log("warn","gateway cloud server is deactivated"),h=Error("gateway cloud server is deactivated"),h.code="50103",b&&b(h)):a._getAccessToken(f.server,k,c.password,!1,
function(l,q){l?(l=Error("get accesss token error:"+l.message),l.code="50003",b&&b(l)):q?b&&b(null,q,f.server,k):a._getAccessToken(f.server,k,c.password,!0,function(p,r){p?(p=Error("generate accesss token error:"+p.message),p.code="50004",b&&b(p)):r?b&&b(null,r,f.server,k):b&&b(Error("access token empty"))})}):(a._logger.log("warn","gateway has no cloud server"),h=Error("gateway has no cloud server"),h.code="50102",b&&b(h))}):(g=Error("gateway has no password"),g.code="50002",b&&b(g)):(g=Error("gateway has no sid"),
g.code="50002",b&&b(g))}):b&&b(Error("gateway json invalid"))}else b&&b(Error("gateway json is null"))};n.prototype.generateConfig=function(c,b,a,d,e,g,k,h,f,l){var q=require("url").parse("https://"+h),p=function(z){for(var x=z.length,A={};x--;){var B=z[x];A[B.index]=B.name}return A}(b),r=function(z){for(var x=z.length,A={};x--;){var B=z[x];A[B.index]=B.name}return A}(a);a={};h=this._resovleBaseUrl(h,g);b=f=null;for(var t=0;t<c.length;t++){var u=c[t];!u||!u.info||"cloudservice"==u.info.sys&&u.info.module||
"_webpages"==u.name.substr(0,9)||(f=this._resovleDeviceID(u,r,p),b=this._convertDeviceToCloudFormat(u,f,h,e,a),b.data={mod:"mediola",ccs:q.hostname,accessToken:g,deviceID:u.index},a[f]=b)}c={};e=null;if(d&&d.groups)for(g=0;g<d.groups.length;g++)if((q=d.groups[g])&&q.macros&&0!=q.macros.length)for(p=q.name,r=0;r<q.macros.length;r++)if(b=q.macros[r],f=b.name,b.cloud&&b.cloud.enabled){f=(p?p+" ":"")+(f?f:"");b.cloud.alias&&(f=b.cloud.alias);e="";t=f.toLowerCase();u="on off an aus up down auf ab hoch runter ein".split(" ");
for(var v=0;v<u.length;v++){var w=u[v],y=t.substr(t.length-w.length);t.length>w.length&&y==w&&(e=f.substr(0,t.length-w.length).trim(),c[e]||(c[e]=[]),c[e].push({original_id:f,command:w}))}b={name:f,type:"scene",baseurl:h,local:"http://"+k.ip+(k.port?":"+k.port:""),commands:{on:{type:"POST",url:"/cmd",data:{XC_FNC:"DoMacroRM",groupIdx:q.index,macroIdx:b.index}}}};a[f]=b}for(e in c){d=c[e];b={name:e,type:"scene",baseurl:h,local:"http://"+k.ip+(k.port?":"+k.port:""),commands:{}};g=f=!1;for(q=0;q<d.length;q++)if((p=
d[q])&&p.original_id&&p.command&&(r=p.original_id,t=a[r],delete a[r],t)){r=t.commands.on;t=p.command;switch(p.command){case "on":case "an":case "ein":f=!0;t="on";break;case "off":case "aus":f=!0;t="off";break;case "up":case "auf":case "hoch":g=!0;t="up";break;case "down":case "ab":case "runter":g=!0,t="down"}b.commands[t]=r}f?b.type="switch":g&&(b.type="blind");a[e]=b}l&&l(null,a)};n.prototype.uploadConfig=function(c,b,a){b={type:"mediola",configuration:b};var d=c.ip;d||(d=require("url").parse(n.REMOTE_SERVER).host);
var e=c.port;e||(e=443);var g=c.username?c.username:"";c=c.password?c.password:"";c={host:d,port:e,path:"/alexa/setConfiguration",method:"POST",timeout:3E4,auth:g+":"+c,user:g,password:c,headers:{"Content-Type":'text/xml; charset="utf-8"',Authorization:"Basic "+(new Buffer(g+":"+c)).toString("base64"),Connection:"close"}};var k=this;this._logger.log("trace","upload config to:"+JSON.stringify(c));c=require("https").request(c,function(h){h.setEncoding("utf8");var f="";h.on("data",function(l){f+=l});
h.on("end",function(){if(200==h.statusCode){k._logger.log("trace","upload config reponse:"+f);try{var l=JSON.parse(f);if(l.XC_ERR){var q=Error(l.XC_ERR.msg);q.code=l.XC_ERR.code;a&&a(q)}else l.XC_SUC&&a&&a()}catch(p){a&&a(p)}}else k._logger.log("warn","upload config error +"+h.statusCode+":"+f),a&&a(Error("http response:"+h.statusCode))})});if(c.on)c.on("error",function(h){k._logger.log("warn","upload config error:"+h.message);a&&a(h);a=null});c.write(JSON.stringify(b));c.end()};n.prototype.setCustomCommandMap=
function(c){this._customMap=c};n.prototype.loadCustomComamndMap=function(c,b){var a=require("fs-extra");a.ensureFile(c,function(d){d?b&&b(null,{}):a.readFile(c,"utf8",function(e,g){if(e)b&&b(e);else if(g)try{var k=JSON.parse(g);b&&b(null,k)}catch(h){b&&b(null,{})}else b&&b(null,{})})})};n.prototype.saveCustomCommandMap=function(c,b,a){var d=require("fs-extra");d.ensureFile(c,function(e){if(e)a&&a(null,{});else try{var g=JSON.stringify(b,null,2);d.writeFile(c,g,function(k){a&&a(k)})}catch(k){a&&a(k)}})};
return n}();
