...
d=require("path").resolve(__dirname,"runner2.js"),e=require("loop-protect");e.method="protect";c.readFile(d,{encoding:"utf8"},function(c,d){c?b(c):(c=d.replace("//%CODE",a),c=e.rewriteLoops(c),b(null,c))})},_readScript=function(a,b){var c=require("fs");require("path");c.readFile(a,"utf8",function(a,c){b&&b(a,c)})},_runScript=function(a){_readScript(a,function(b,c){b?console.error("read script "+a+" error",b):_processJsFile(c,function(b,c){b?console.error("process script "+a+" error",b):require("vm").runInThisContext(c)})})};
