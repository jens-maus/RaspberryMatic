...
$.ajax=function(a){var b=require("url").parse(a.url),c={host:b.hostname,port:b.port,path:b.path,method:"GET"},d="string";a.dataType&&(d=a.dataType);a.method&&(c.method=a.method);a.type&&(c.method=a.type);a.headers&&(c.headers=a.headers);if(a.username||a.password)c.auth=(a.username?a.username:"")+":"+(a.password?a.password:"");a.timeout&&(c.timeout=a.timeout);if(a.data)if("object"==typeof a.data){c.headers||(c.headers={});var g=require("querystring").stringify(a.data,null,null,{encodeURIComponent:encodeURI});
c.headers["Content-Type"]="application/x-www-form-urlencoded";"POST"==c.method||"PUT"==c.method?c.headers["Content-Length"]=g.length:"GET"==c.method&&(c.path=c.path+"?"+g)}else"string"==typeof a.data&&(c.headers||(c.headers={}),"POST"==c.method||"PUT"==c.method)&&(c.headers["Content-Length"]=Buffer.byteLength(a.data,"utf8"));a.contentType&&(c.headers||(c.headers={}),c.headers["Content-Type"]=a.contentType);a.complete&&(a.error=a.complete);var h=require("http");"https:"==b.protocol&&(h=require("https"),
process&&process.env&&(process.env.NODE_TLS_REJECT_UNAUTHORIZED="0"),c.port||(c.port=443));var e=h.request(c,function(b){if(a.statusCode&&a.statusCode[b.statusCode])a.statusCode[b.statusCode]();var c="";b.on("data",function(a){c+=a});b.on("end",function(){var e={getAllResponseHeaders:function(){return b.headers},getResponseHeader:function(a){return b.headers[a]}};if(200==b.statusCode)if(a.complete)a.complete({responseText:c});else{if(a.success){if("json"==d)try{c=JSON.parse(c)}catch(r){a.error&&a.error({status:b.statusCode,
