...
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(h,d,b){if(h==Array.prototype||h==Object.prototype)return h;h[d]=b.value;return h};$jscomp.getGlobal=function(h){h=["object"==typeof globalThis&&globalThis,h,"object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global];for(var d=0;d<h.length;++d){var b=h[d];if(b&&b.Math==Math)return b}throw Error("Cannot find global object");};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.IS_SYMBOL_NATIVE="function"===typeof Symbol&&"symbol"===typeof Symbol("x");$jscomp.TRUST_ES6_POLYFILLS=!$jscomp.ISOLATE_POLYFILLS||$jscomp.IS_SYMBOL_NATIVE;$jscomp.polyfills={};$jscomp.propertyToPolyfillSymbol={};$jscomp.POLYFILL_PREFIX="$jscp$";var $jscomp$lookupPolyfilledValue=function(h,d){var b=$jscomp.propertyToPolyfillSymbol[d];if(null==b)return h[d];b=h[b];return void 0!==b?b:h[d]};
$jscomp.polyfill=function(h,d,b,c){d&&($jscomp.ISOLATE_POLYFILLS?$jscomp.polyfillIsolated(h,d,b,c):$jscomp.polyfillUnisolated(h,d,b,c))};$jscomp.polyfillUnisolated=function(h,d,b,c){b=$jscomp.global;h=h.split(".");for(c=0;c<h.length-1;c++){var a=h[c];if(!(a in b))return;b=b[a]}h=h[h.length-1];c=b[h];d=d(c);d!=c&&null!=d&&$jscomp.defineProperty(b,h,{configurable:!0,writable:!0,value:d})};
$jscomp.polyfillIsolated=function(h,d,b,c){var a=h.split(".");h=1===a.length;c=a[0];c=!h&&c in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var f=0;f<a.length-1;f++){var e=a[f];if(!(e in c))return;c=c[e]}a=a[a.length-1];b=$jscomp.IS_SYMBOL_NATIVE&&"es6"===b?c[a]:null;d=d(b);null!=d&&(h?$jscomp.defineProperty($jscomp.polyfills,a,{configurable:!0,writable:!0,value:d}):d!==b&&(void 0===$jscomp.propertyToPolyfillSymbol[a]&&($jscomp.propertyToPolyfillSymbol[a]=$jscomp.IS_SYMBOL_NATIVE?$jscomp.global.Symbol(a):
$jscomp.POLYFILL_PREFIX+a),$jscomp.defineProperty(c,$jscomp.propertyToPolyfillSymbol[a],{configurable:!0,writable:!0,value:d})))};$jscomp.initSymbol=function(){};
$jscomp.polyfill("Symbol",function(h){if(h)return h;var d=function(a,f){this.$jscomp$symbol$id_=a;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:f})};d.prototype.toString=function(){return this.$jscomp$symbol$id_};var b=0,c=function(a){if(this instanceof c)throw new TypeError("Symbol is not a constructor");return new d("jscomp_symbol_"+(a||"")+"_"+b++,a)};return c},"es6","es3");
...
body:"stream"}},{path:"/reset",options:{method:"GET",source:1,lock:1}},{path:"/reboot",options:{method:"GET"}},{path:"/log",options:{method:"GET",source:1}},{path:"/getLogs",options:{method:"GET",source:1}},{path:"/log",options:{method:"DELETE"}},{path:"/lock",options:{method:"GET",lock:function(c,a,f){return!c||"cloud"==a.source&&!f.getRCS()?!1:!0}}},{path:"/unlock",options:{method:"GET",lock:function(c,a,f){return!c||"cloud"==a.source&&!f.getRCS()?!1:!0}}},{path:"/tm/http",options:{method:"GET"}},
{path:"/sapi",options:{method:"POST",body:"text",auth:0}},{path:"/",options:{method:"GET",auth:0}}];b.prototype.addRoute=function(c,a,f){"function"==typeof a&&(f=a,a=null);return this._dispatcher.add(c,a,f)};b.prototype._setDefaultRoutes=function(){var c=this,a=function(f,e){var k=null;k=require("url").parse(f.url).pathname;k="/"==k?"/":"/"+k.split("/")[1];c.doRequest(k,f,e,function(g){void 0!=g&&null!=g&&("object"==typeof g?e.json(g):e.send(g))})};this._routes.forEach(function(f){c.addRoute(f.path,
f.options,a)})};b.prototype._startServer=function(c){var a=this;this._setDefaultRoutes();this._app.set("case sensitive routing",!0);this._app.use(function(f,e,k){e.header("Access-Control-Allow-Origin","*");e.header("Access-Control-Allow-Headers","Origin, X-Requested-With, Content-Type, Accept, Authorization");var g=require("x.logger.js").getLogger("x.hub.Server.Access");g.log("debug",f.method+":"+f.url);f.source="webserver";e.on("finish",function(){g.log("debug",f.method+":"+f.url+" -> HTTP:"+e.statusCode)});
k()});this._dispatcher.init();this._app.use("*",function(f,e){XC.debugf("INVALID REQ: "+f.url);e.json({XC_ERR:{code:"000001",msg:"invalid request"}})});this._app.use(function(f,e,k,g){XC.debugf(f);k.json({XC_ERR:{code:"000002",msg:f.stack}})});this._httpserver.listen(this._port,function(){var f=a._httpserver.address().port;a._logger.log("info","listening on port "+f+"...");c&&c()})};b.prototype.doRequest=function(c,a,f,e){!e&&f&&"function"==typeof f&&(e=f,f=null);var k=this;if("/"==c){var g='<!DOCTYPE html>\n<html>\n<head>\n<meta http-equiv="content-type" content="text/html; charset=utf-8" />\n<title>'+
...
u);l()})},function(l){k._platform._time.getNTPServers(function(r,u){!r&&u&&(n.XC_SUC.ntp=u.join(","));l()})},function(l){k._platform.getLocation(function(r,u,w){!r&&u&&w&&(n.XC_SUC.loc=(u+w).toUpperCase());k._platform._time.getTimezoneEncoded(function(A,C){!A&&C&&(n.XC_SUC.loc=n.XC_SUC.loc?C.toUpperCase()+n.XC_SUC.loc:C.toUpperCase());l()})})},function(l){n.XC_SUC.mediola_mac=k._platform._network.getMediolaMac();k._platform._network.getNetwork(function(r,u){if(!r&&u){var w=function(E){return E?{ip:E.ip,
sn:E.subnet,gw:E.router,dhcp:E.dhcp,dns:E.dns?E.dns.join(","):E.dns,mac:E.mac?E.mac.replace(/:/g,"-"):null}:null},A=Object.keys(u);if(0==A.length)return;r=w(u.eth0);var C=w(u.wlan0),G=null;u.eth0||u.wlan0||(G=w(u[A[0]]));u=null;r&&r.ip?(u=r,n.XC_SUC.primary_net="eth0"):C&&C.ip?(u=C,n.XC_SUC.primary_net="wlan0"):G&&G.ip&&(u=C,n.XC_SUC.primary_net=A[0]);for(var F in u)n.XC_SUC[F]=u[F];n.XC_SUC.cfg&&u&&(F=parseInt(n.XC_SUC.cfg,16),F=!0===u.dhcp?F&-129:F|128,n.XC_SUC.cfg=F.toString(16),2>n.XC_SUC.cfg.length&&
