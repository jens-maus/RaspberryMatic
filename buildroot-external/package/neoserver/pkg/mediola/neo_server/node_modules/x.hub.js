...
(a=require("os"))&&a.freemem&&(k.XC_SUC.mem=Math.floor(a.freemem()/1E3));try{global.LOAD_MODULES&&-1!=global.LOAD_MODULES.indexOf("enocean")&&(f=require("x.hub.m.enocean.js"))&&(g=f.getEnoceanInfo(),k.XC_SUC.enocean=g)}catch(y){}f=require("async");f.parallel([function(a){d._platform.getSTMSettings(function(b,d){!b&&d&&(k.XC_SUC.stm_settings=d);a()})},function(a){k.XC_SUC.rcs=d.getRCS();a()},function(a){k.XC_SUC.locked=d.isLocked();a()},function(a){d._platform.getExtraInfo(function(b,d){!b&&d&&(k.XC_SUC.extra=
d);a()})},function(a){d._platform._time.getNTPServers(function(b,d){!b&&d&&(k.XC_SUC.ntp=d.join(","));a()})},function(a){d._platform.getLocation(function(b,c,e){!b&&c&&e&&(k.XC_SUC.loc=(c+e).toUpperCase());d._platform._time.getTimezoneEncoded(function(b,d){!b&&d&&(k.XC_SUC.loc=k.XC_SUC.loc?d.toUpperCase()+k.XC_SUC.loc:d.toUpperCase());a()})})},function(a){k.XC_SUC.mediola_mac=d._platform._network.getMediolaMac();d._platform._network.getNetwork(function(b,d){if(!b&&d){var c=function(a){return a?{ip:a.ip,
sn:a.subnet,gw:a.router,dhcp:a.dhcp,dns:a.dns?a.dns.join(","):a.dns,mac:a.mac?a.mac.replace(/:/g,"-"):null}:null},e=Object.keys(d);if(0==e.length)return;b=c(d.eth0);var f=c(d.wlan0),g=null;d.eth0||d.wlan0||(g=c(d[e[0]]));d=null;b&&b.ip?(d=b,k.XC_SUC.primary_net="eth0"):f&&f.ip?(d=f,k.XC_SUC.primary_net="wlan0"):g&&g.ip&&(d=f,k.XC_SUC.primary_net=e[0]);for(var h in d)k.XC_SUC[h]=d[h];k.XC_SUC.cfg&&d&&(h=parseInt(k.XC_SUC.cfg,16),h=!0===d.dhcp?h&-129:h|128,k.XC_SUC.cfg=h.toString(16),2>k.XC_SUC.cfg.length&&
...
function(a){a?e(a):d._doSTMCommandRequest(b,!1,e)});else this._doSTMCommandRequest(b,!1,e);else if("/config"==a){var r=!1,q,v=!1,w=null;!b.query||1!=b.query.poweroff&&"true"!=b.query.poweroff&&1!=b.query.poweroff||(w=!0);f=require("async");f.series([function(a){var c=b.query.enable_stm_states_buffer,e=b.query.stm_states_buffer_timeout,f=null;if("1"==c||"true"==c||1==c)f||(f={}),f.enable_stm_states_buffer=!0;else if("0"==c||"false"==c||0==c)f||(f={}),f.enable_stm_states_buffer=!1;isNaN(parseInt(e))||
(f||(f={}),f.stm_states_buffer_timeout=parseInt(e));f?d._platform._stm.setSettings(f,function(){a()}):a()},function(a){b.query.name&&(d._name=b.query.name,localStorage&&localStorage.setItem("x.hub.Server.name",b.query.name));b.query.vid&&(d._vid=b.query.vid,localStorage&&localStorage.setItem("x.hub.Server.vid",b.query.vid));if(b.query.pwd||""==b.query.pwd){var c=require("x.crypt.js");0===b.query.pwd.length?(d._pwd="",b.query.cloud=0):d._pwd=c.MD5(unescape(encodeURI(b.query.pwd+"_SALT!")));localStorage&&
...
b.query.disable_st_states);b.query.sid&&localStorage&&(localStorage.setItem("x.hub.v5.SID",b.query.sid),r=!0);b.query.ckey&&localStorage&&(localStorage.setItem("x.hub.v5.cloudKey",b.query.ckey),r=!0);b.query.cserver&&localStorage&&(localStorage.setItem("x.hub.v5.cloudServer",b.query.cserver),r=!0);b.query.cport&&localStorage&&(localStorage.setItem("x.hub.v5.cloudPort",b.query.cport),r=!0);b.query.cloud&&localStorage&&(c=255,localStorage.getItem("x.hub.v5.config")&&(c=parseInt(localStorage.getItem("x.hub.v5.config"),
16)),c=1==b.query.cloud?c&-65:c|64,c=c.toString(16),2>c.length&&(c="0"+c),localStorage.setItem("x.hub.v5.config",c.toUpperCase()),r=!0);a()},function(a){if(b.query.loc){if(2==b.query.loc.length)var c=b.query.loc;else if(8==b.query.loc.length){var e=b.query.loc.substr(0,4);var f=b.query.loc.substr(4)}else 10==b.query.loc.length&&(c=b.query.loc.substr(0,2),e=b.query.loc.substr(2,4),f=b.query.loc.substr(6));d.setTimeZoneCompatiable(c,function(b){b&&(q=b);d.setLocation(e,f,function(b){b&&(q=b);a()})})}else a()},
function(a){if(b.query.year&&b.query.month&&b.query.date&&b.query.hour&&b.query.minute){var c=parseInt(b.query.year),e=parseInt(b.query.month),f=parseInt(b.query.date),g=parseInt(b.query.hour),h=parseInt(b.query.minute);d.setDateTime(c,e,f,g,h,function(b){b&&(q=b);a()})}else a()},function(a){b.query.apin?d.setPin(b.query.pin,b.query.apin,function(b){b&&(q=Error("failed to config"));a(b)}):a()},function(a){if(void 0==b.query.rcs||null==b.query.rcs||""==b.query.rcs)a();else{var c=null;if("1"==b.query.rcs||
"true"==b.query.rcs||1==b.query.rcs)c=!0;else if("0"==b.query.rcs||"false"==b.query.rcs||0==b.query.rcs)c=!1;else{a();return}d.setRCS(c,function(b){b&&(q=Error("failed to config"));a(b)})}},function(a){var c={};b.query.ip&&b.query.sn&&b.query.gw&&b.query.dns&&(c.IP=b.query.ip,c.SN=b.query.sn,c.GW=b.query.gw,c.DNS=b.query.dns,c.DHCP=!1);b.query.dhcp&&1==b.query.dhcp&&(c={DHCP:!0});b.query.ntp&&(c.NTP=b.query.ntp);b.query.mac&&(c.MAC=b.query.mac);0>=Object.keys(c).length?a():d._platform.setIPData(c,
function(b,d){b?q=b:v=d;a()})}],function(){r&&d._cloudConnect&&d._cloudConnect.init(d);e&&(q?e(JSON.stringify({XC_ERR:{code:"000001",msg:q.message}})):e('{"XC_SUC": {}}'));1==w?d.poweroff(1E3):v&&d.restart(1E3)})}else if("/executeCommand"==a)f=require("x.logger.js").getLogger("GeneralExecuteCommand API"),b.json&&(b.query=b.json),f.log("trace","general execute command:"+JSON.stringify(b.query)),b.query&&b.query.data?(g=b.query.type,f=b.query.data,f.device&&!f.device.sys&&(f.device.sys=g),f.gateway&&
!f.gateway.sys&&(f.gateway.sys=g),g=require("x.hub.commandman.js"),g.commandHandler.executeCommand(f.device,f.gateway,f.command,function(a){a.error?e('{"XC_ERR":{"code":"000000","msg":"'+a.error.message+'"}}'):e('{"XC_SUC":{}}')})):e('{"XC_ERR":{"code":"000001", "msg":"invalid request"}}');else if("/getStates"==a)f=require("x.logger.js").getLogger("GeneralGetStates API"),f.log("trace","general get states:"+JSON.stringify(b.query)),b.json&&(b.query=b.json),b.query&&b.query.data?(g=b.query.type,f=b.query.data,
...
'"}}'):a&&a.data?e(JSON.stringify({XC_SUC:{data:JSON.stringify(a.data)}})):e('{"XC_SUC":{}}')})):e('{"XC_ERR":{"code":"000001", "msg":"invalid request"}}');else if("/getKey"==a)if(f=b.query?b.query.k:null){var t=(b.headers?b.headers["x-forwarded-for"]:null)||(b.connection?b.connection.remoteAddress:null);if(t){var u=require("x.hub.password");u.registSecureClient(t,f,function(a,b){a?e&&e({XC_ERR:{code:"000000",msg:a.message}}):e&&e({XC_SUC:b})})}else e&&e({XC_ERR:{code:"000000",msg:"can not get client ip address"}})}else k=
...
msg:"get peripheral internal error"}}))});else if("/update"==a)b.method&&"post"==b.method.toLowerCase()&&b.query&&"st"==b.query.type?d._platform.updateSTM(b,c,function(){e&&e()}):b.query&&"st"==b.query.type?d._platform.updateSTM(null,c,function(){e&&e()}):d._platform.updateFirmware(b.query?b.query.url:null,function(a,b){a?c.json({XC_ERR:{code:a.code?a.code:"000000",msg:a.message}}):(c.json({XC_SUC:{}}),b&&d._platform.reboot(null,1E3));e&&e()});else if("/backup"==a)d._platform.backup(b,c,function(){e&&
e()});else if("/restore"==a)d._platform.restore(b,c,function(){e&&e()});else if("/reset"==a)b.query&&b.query.type?"st"==b.query.type?d._platform._stm.reset(function(a){a?e&&e({XC_ERR:{msg:a.message}}):e&&e({XC_SUC:{}})}):"st_reboot"==b.query.type?d._platform._stm.reboot(function(a){a?e&&e({XC_ERR:{msg:a.message}}):e&&e({XC_SUC:{}})}):"knx"==b.query.type?require("x.hub.m.knx.js").reset(function(a){a&&!a.error?e&&e({XC_SUC:{}}):e&&e({XC_ERR:{code:"000000",message:"reset knx failed"}})}):"zwave"==b.query.type&&
d._platform._zwayServer.reset(function(a){a?e&&e({XC_ERR:{msg:a.message}}):e&&e({XC_SUC:{}})}):(e&&e('{"XC_SUC":{}}'),d.restart(1E3));else if("/reboot"==a)e&&e('{"XC_SUC":{}}'),f=null,b.query&&b.query.mode&&"recovery"==b.query.mode&&(f="recovery"),d._platform.reboot(f,1E3);else if("/wifi"==a)switch(f=b.path,f=f.substr(5),f){case "/scan":d._platform._network.scanWifi(b.query,function(a,b){a?e&&e(JSON.stringify({XC_ERR:{code:a.code?a.code:"000000",msg:a.message}})):e&&e(JSON.stringify({XC_SUC:b?b:[]}))});
break;case "/connect":d._platform._network.connectWifi(b.query,function(a){a?e&&e(JSON.stringify({XC_ERR:{code:a.code?a.code:"000000",msg:a.message}})):(e&&e(JSON.stringify({XC_SUC:{}})),d.restart(1E3))});break;case "/disconnect":d._platform._network.disconnectWifi(b.query,function(a){a?e&&e(JSON.stringify({XC_ERR:{code:a.code?a.code:"000000",msg:a.message}})):(e&&e(JSON.stringify({XC_SUC:{}})),d.restart(1E3))});break;case "/info":d._platform._network.getWifiInfo(b.query,function(a,b){a?e&&e(JSON.stringify({XC_ERR:{code:a.code?
a.code:"000000",msg:a.message}})):e&&e(JSON.stringify({XC_SUC:b}))});break;case "/config":f={};"true"==b.query.dhcp||1==b.query.dhcp||1==b.query.dhcp?f={dhcp:!0}:b.query.ip&&b.query.sn&&b.query.gw&&b.query.dns&&(f.ip=b.query.ip,f.subnet=b.query.sn,f.router=b.query.gw,f.dns=b.query.dns?b.query.dns.split(","):[],f.dhcp=!1);if(0>=Object.keys(f).length){e&&e(JSON.stringify({XC_SUC:{}}));break}d._platform._network.setNetwork("wlan0",f,function(a){a?e&&e(JSON.stringify({XC_ERR:{code:a.code?a.code:"000000",
msg:a.message}})):(e&&e(JSON.stringify({XC_SUC:{}})),d.restart(1E3))});break;default:e&&e({XC_ERR:{code:"000001",message:"invalid request"}})}else if("/log"==a||"/getLogs"==a)b.method&&"get"==b.method.toLowerCase()?d.getLogs(function(a,b,d){if(a)c.status(500),c.json({XC_ERR:{code:"100000",msg:a.message}}),e&&e();else{var f=require("fs-extra");c.setHeader("Content-disposition","attachment; filename="+b);c.sendFile(d,null,function(a){f.removeSync(d);a&&(c.status(500),c.json({XC_ERR:{code:"100000",msg:a.message}}));
e&&e(a)})}}):b.method&&"delete"==b.method.toLowerCase()&&d.clearLogs(function(a){a?e&&e({XC_ERR:{code:"100000",msg:a.message}}):e&&e({XC_SUC:{}})});else if("/tm"==a)if(f=require("url").parse(b.url).pathname,"/tm/http"==f)require("x.hub.taskman.js").taskManager.onHttpEvt(b.query,function(a,b){a?e&&e('{"XC_ERR":{"msg":'+a.message+"}}"):b?e&&e('{"XC_SUC":{}}'):e&&e('{"XC_ERR":{"msg":"no such trigger"}}')});else e&&e(JSON.stringify({XC_ERR:{code:"000000",msg:"invalid request"}}));else"/lock"==a?(f=b.query?
b.query.pin:null,d.lock(f,function(a){a?e&&e(JSON.stringify({XC_ERR:{code:a.code,msg:a.message}})):e&&e(JSON.stringify({XC_SUC:{}}))})):"/unlock"==a?(f=b.query?b.query.pin:null,d.unlock(f,function(a){a?e&&e(JSON.stringify({XC_ERR:{code:a.code,msg:a.message}})):e&&e(JSON.stringify({XC_SUC:{}}))})):"/sapi"==a?(t=(b.headers?b.headers["x-forwarded-for"]:null)||(b.connection?b.connection.remoteAddress:null))?(d=this,u=require("x.hub.password"),u.decodeSecureReq(t,b,function(a,b){if(!a){require("x.logger.js").getLogger("x.hub.Server.Access").log("debug",
b.method+":"+b.url);var c={json:function(a){u.encodeSecureRsp(t,JSON.stringify(a),function(a,b){a?e&&e({XC_ERR:{code:"000000",msg:a.message}}):e&&e(b)})},send:function(a){u.encodeSecureRsp(t,a,function(a,b){a?e&&e({XC_ERR:{code:"000000",msg:a.message}}):e&&e(b)})}};d._dispatcher.doRequest(b,c,function(a){void 0!=a&&null!=a&&("object"==typeof a?c.json(a):c.send(a))})}})):e&&e({XC_ERR:{code:"000000",msg:"can not get client ip address"}}):e&&e('{"XC_ERR":{"code":"000001", "msg":"invalid request"}}')};
a.prototype._doSTMCommandRequest=function(a,b,c){if(a){var d=this._platform._stm;if(d){var e=this;if("string"==typeof a){var f=16;var h=a;-1<h.indexOf("?")&&(h=h.substr(h.indexOf("?")+1))}else"POST"==a.method?(f=17,h=a.json?JSON.stringify(a.json):a.body):(f=16,h=a.url,-1<h.indexOf("?")&&(h=h.substr(h.indexOf("?")+1))),a.locked?"cloud"==a.source?16==f?f=18:17==f&&(f=19):"webserver"!=a.source||a.pinMatch||(16==f?f=18:17==f&&(f=19)):"cloud"==a.source&&(16==f?f=20:17==f&&(f=21));d.sendCommand(f,h,function(a){a&&
a.error?e._logger.log("trace",h+" --\x3e FAIL:"+a.error):a&&a.data?e._logger.log("trace",h+" --\x3e "+a.data.toString()):e._logger.log("trace",h+" --\x3e FAIL");if(a&&a.data){var d="XC_SUC";a.error&&(d="XC_ERR");b?c("{"+d+"}"+a.data.toString()):c('{"'+d+'": '+a.data.toString()+"}")}else b?c("{XC_ERR}internal error"):a&&a.error?c(JSON.stringify({XC_ERR:{code:"000000",msg:a.error}})):c('{"XC_ERR":{"code":"000000", "msg":"internal error"}}')})}else b?c("{XC_ERR}no stm"):c('{"XC_ERR":{"code":"000001", "msg":"no stm"}}')}else b?
c("{XC_ERR}invalid request"):c('{"XC_ERR":{"code":"000001", "msg":"invalid request"}}')};a.prototype.setLED=function(a,b){if(a&&"string"==typeof a&&a.match(/^([a-fA-F0-9]){4}/g)){var d=this._platform._led;if(d){var c=parseInt(a.substr(0,2),16);a=parseInt(a.substr(2,2),16);var e;switch(a){case 0:var f=e=a=0;break;case 1:a=0;e=255;f=0;break;case 2:e=a=0;f=255;break;case 3:a=255;f=e=0;break;case 4:e=a=255;f=0;break;case 5:f=e=a=255;break;case 6:a=255;e=0;f=255;break;case 7:a=0;f=e=255;break;default:b&&
b(Error("invalid set led color:"+a));return}0===c?d.setColor(a,e,f,function(a){b&&b(a)}):1==c?d.saveColor(a,e,f,function(a){b&&b(a)}):b&&b(Error("invalid set led command:"+c))}else b&&b(Error("no led"))}else b&&b(Error("invalid set led data: "+a))};a.prototype.restart=function(a){this._platform.reboot(null,a)};a.prototype.poweroff=function(a){this._platform.poweroff(a)};a.prototype.reset=function(a,b){var c=require("path"),d=require("fs"),e=require("fs-extra"),f=require("x.hub.fileman.js").fileManager.getUserRootDataPath();
this._logger.log("debug","reset ("+a+")");switch(a){case "passwords":a=c.join(f,"localstorage","x.hub.Server.pwd");d.existsSync(a)&&(this._logger.log("trace","remove file "+a),e.removeSync(a));require("x.hub.password.js").reset(function(){b&&b(null,!0)});break;case "network":this._platform.reset("network",function(a,c){b&&b(a,c)});break;case "factory":d.existsSync(f)&&(this._logger.log("trace","clear folder "+f),e.emptyDirSync(f));this._platform.reset("factory",function(a,c){b&&b(a,c)});break;default:b&&
b(Error("unknonw reset mode: "+a))}};a.prototype.getTimezoneSync=function(){return this._platform.getTimezoneSync()};a.prototype.setTimeZoneCompatiable=function(a,b){this._platform.setTZData(a,function(c){c||process.nextTick(function(){require("x.hub.eventbus.js").emit("locationchange",{timezone:a})});b&&b(c)})};a.prototype.getTimeZoneCompatiable=function(a){this._platform.getTZData(a)};a.prototype.setLocation=function(a,b,c){this._platform.setLocation(a,b,function(d){d||process.nextTick(function(){require("x.hub.eventbus.js").emit("locationchange",
{lat:a,long:b})});c&&c(d)})};a.prototype.getLocation=function(a){this._platform.getLocation(function(b,c,d){a&&a(b,c,d)})};a.prototype.setDateTime=function(a,b,c,e,l,f){isNaN(a)||1970>a||9999<a?f&&f(Error("year invalid")):isNaN(b)||1>b||12<b?f&&f(Error("month invalid")):isNaN(c)||1>c||31<c?f&&f(Error("date invalid")):isNaN(e)||0>e||23<e?f&&f(Error("hour invalid")):isNaN(l)||0>l||59<l?f&&f(Error("minute invalid")):this._platform.setTime({year:a,month:b,date:c,hour:e,minute:l},f)};a.prototype.getLogs=
function(a){var b=require("x.hub.fileman.js").fileManager.getUserLogPath(),c=require("os").tmpdir(),d=require("path"),e=require("fs-extra"),f=require("archiver"),m="logs_"+(new Date).toISOString().substr(0,16).replace(/T/g,"").replace(/-/g,"").replace(/:/g,"")+".zip",n=d.join(c,m);c=e.createWriteStream(n);f=f("zip");c.on("close",function(){a&&(a(null,m,n),a=null)});c.on("error",function(b){a&&(a(b),a=null)});f.on("error",function(b){a&&(a(b),a=null)});f.pipe(c);f.directory(b);f.finalize()};a.prototype.clearLogs=
function(a){require("x.hub.logman.js").clearLogs(function(b){a&&a(b)})};a.prototype.getCloudServer=function(){return this._cloudConnect.getCloudServer()};a.prototype.getCloudPort=function(){return this._cloudConnect.getCloudPort()};a.prototype.isCloudConnected=function(){return this._cloudConnect.isConnected()};a.prototype.isLocked=function(){return this._locked};a.prototype.lock=function(a,b){!a||this.checkPin(a)?(localStorage.setItem("x.hub.Server.lock",!0),this._locked=!0,b&&b(null)):(a=Error("failed to lock"),
a.code="000003",b&&b(a))};a.prototype.unlock=function(a,b){a&&this.checkPin(a)?(localStorage.setItem("x.hub.Server.lock",!1),this._locked=!1,b&&b(null)):(a=Error("access denied (locked)"),a.code="000007",b&&b(a))};a.prototype.setPin=function(a,b,c){a=require("x.hub.password.js").setPin(a,b);c&&c(a?null:Error("failed"))};a.prototype.checkPin=function(a){return require("x.hub.password.js").checkPin(a)};a.prototype.getRCS=function(){return this._rcs};a.prototype.setRCS=function(a,b){localStorage.getItem("x.hub.Server.rcs",
a);this._rcs=a;b&&b()};return a}();x.hub.Handler=function(){this.server=null};x.hub.Handler.prototype.Server=x.hub.Server;x.hub.Handler.prototype.ServerNEO=x.hub.ServerNEO;x.hub.Handler.prototype.ServerV6=x.hub.ServerV6;x.hub.Handler.prototype.getServer=function(){return this.server};"undefined"!=typeof exports&&"undefined"!=typeof module&&module.exports&&(exports=module.exports=new x.hub.Handler);
