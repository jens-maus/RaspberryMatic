...
function(b){g=Buffer.concat([g,b])});a.on("end",function(){a.size=g.length;a.body=g.toString("utf8");a.json=null;if(!b.opts||!b.opts.body||"json"==b.opts.body)try{a.json=JSON.parse(g)}catch(w){}c()})}})(c,a,d,function(){h(c,a,d,g,e,function(){c.callback(a,d,function(){b()})})})};e.prototype._findRoute=function(c,a,d){for(var b=function(b,a){return"/"==a&&b!=a?!1:a.length<=b.length&&b.substr(0,a.length)==a?!0:"*"==a?!0:!1},h=function(b,a){return 0!=(("webserver"==b?1:"cloud"==b?2:3)&a)},g=a.path;c<
...
a.header("content-type")){var e=new Buffer([]);a.on("data",function(b){e=Buffer.concat([e,b])});a.on("end",function(){a.body=e.toString("utf8");a.json=null;try{a.json=JSON.parse(e)}catch(g){}c._preHandleRequest(a,d,b)})}else c._preHandleRequest(a,d,b)});this._app.get("/info",function(a,d){try{c.doRequest("/info",a,function(b){d.send(b)})}catch(b){console.error(b)}});this._app.get("/set",function(a,d){c.doRequest("/set",a,function(b){d.send(b)})});this._app.get("/cmd",function(a,d){c.doRequest("/cmd",
...
a,function(b){d.send(b)})});this._app.get("/config",function(a,d){var b=!0,e=!1;a.query.name&&0<a.query.name.length&&(c._name=a.query.name,localStorage&&localStorage.setItem("x.hub.Server.name",a.query.name));a.query.vid&&0<a.query.vid.length&&(c._vid=a.query.vid,localStorage&&localStorage.setItem("x.hub.Server.vid",a.query.vid));if(a.query.pwd||""==a.query.pwd)e=require("x.crypt.js"),0===a.query.pwd.length?(c._pwd="",a.query.cloud=0):c._pwd=e.MD5(unescape(encodeURI(a.query.pwd+"_SALT!"))),localStorage&&
localStorage.setItem("x.hub.Server.pwd",c._pwd),e=!0;if(a.query.loc){if(2==a.query.loc.length)var g=a.query.loc;else if(8==a.query.loc.length){var l=a.query.loc.substr(0,4);var f=a.query.loc.substr(4)}else 10==a.query.loc.length&&(g=a.query.loc.substr(0,2),l=a.query.loc.substr(2,4),f=a.query.loc.substr(6));g&&localStorage&&localStorage.setItem("x.hub.Server.timezone",g);l&&localStorage&&localStorage.setItem("x.hub.Server.geo.lat",l);f&&localStorage&&localStorage.setItem("x.hub.Server.geo.long",f);
if("A1"==c.HWV)b=!1,c._platform.setLocation(l,f,function(b){b?d.json({XC_ERR:{code:"000000",msg:"set coordinate failed: "+b.message}}):c._platform.setTZData(g,function(b){b?d.json({XC_ERR:{code:"000000",msg:"set timezone failed: "+b.message}}):d.json({XC_SUC:{}})})});else{var m=require("x.hub.eventbus.js");m.emit("locationchange",{timezone:g,lat:l,long:f})}}a.query.neoserver&&localStorage&&(localStorage.setItem("x.hub.taskman.NEO_SERVER",a.query.neoserver),m=require("x.hub.eventbus.js"),m.emit("neoserver_activation",
...
!1),a.query.dhcp&&1==a.query.dhcp&&(f={DHCP:!0}),a.query.ntp&&(f.NTP=a.query.ntp),a.query.mac&&(f.MAC=a.query.mac),0<Object.keys(f).length&&("EA"==c.HWV?(b=!1,l=require("x.hub.v5.js"),l.Native.setIPData(c,f,function(b){b?(d.send('{"XC_SUC":{}}'),c.restart(1E3)):d.send('{"XC_ERR":{"code":"000000", "msg":"internal error"}}')})):"CA"==c.HWV&&(b=!1,require("x.hub.v6.js").setIPData(f,function(b,a){b?d.json({XC_ERR:{code:"000000",msg:b.message}}):(d.json({XC_SUC:{}}),a&&c.restart(1E3))})));a.query.sid&&
...
e&-65:e|64,e=e.toString(16),2>e.length&&(e="0"+e),localStorage.setItem("x.hub.v5.config",e.toUpperCase()),e=!0);if("A20"==c.hostType&&a.query.year&&a.query.month&&a.query.date&&a.query.hour&&a.query.minute){b=!1;f=parseInt(a.query.year);m=parseInt(a.query.month);var n=parseInt(a.query.date),p=parseInt(a.query.hour);a=parseInt(a.query.minute);if(isNaN(f)||1970>f||9999<f){d.send('{"XC_ERR":{"code":"000000", "msg":"year invalid"}}');return}if(isNaN(m)||1>m||12<m){d.send('{"XC_ERR":{"code":"000000", "msg":"month invalid"}}');
return}if(isNaN(n)||1>n||31<n){d.send('{"XC_ERR":{"code":"000000", "date":"year invalid"}}');return}if(isNaN(p)||0>p||23<p){d.send('{"XC_ERR":{"code":"000000", "date":"hour invalid"}}');return}if(isNaN(a)||0>a||59<a){d.send('{"XC_ERR":{"code":"000000", "date":"minute invalid"}}');return}l=require("x.hub.v5.js");l.Native.setDateTime(f,m,n,p,a,function(b){b?(require("x.hub.eventbus.js").emit("timechange",{}),d.send('{"XC_SUC":{}}')):d.send('{"XC_ERR":{"code":"000000", "msg":"internal error"}}')})}e&&
...
x.hub.ServerV6=function(){var e=function(){var a=function(b,a){this._expressApp=b;this._server=a;this._routes=[]};a.prototype.add=function(b,a,d){if(!b)throw Error("invalid arguments");a&&"function"==typeof a&&!d&&(d=a,a=null);if(!d)throw Error("invalid arguments");this._routes.push({path:b,opts:a,callback:d})};a.prototype.doRequest=function(b,a,d){var c=this,e=function(b,a,g){c._findRoute(b,a,function(b,f){if(b)try{c._doRoute(b,a,g,function(){e(f+1,a,g)})}catch(y){g.json({XC_ERR:{code:"000000",msg:y.message}})}else d()})};
...
if(!b.opts||!b.opts.body||"json"==b.opts.body)try{a.json=JSON.parse(e)}catch(z){}c()})}})(b,a,d,function(){e(b,a,d,l,k,function(){g(b,a,d,h._server,function(){b.callback(a,d,function(){c()})})})})};a.prototype._findRoute=function(b,a,d){for(var c=function(b,a){return b?"/"==a&&b!=a?!1:a.length<=b.length&&b.substr(0,a.length)==a?!0:"*"==a?!0:!1:!1},e=function(b,a){return 0!=(("webserver"==b?1:"cloud"==b?2:3)&a)},g=a.path;b<this._routes.length;b++){var h=this._routes[b];if(h&&h.path&&c(g,h.path)){if(h.opts){if(h.opts.method&&
...
{path:"/sapi",options:{method:"POST",body:"text",auth:0}},{path:"/",options:{method:"GET",auth:0}}];a.prototype.addRoute=function(a,b,c){"function"==typeof b&&(c=b,b=null);return this._dispatcher.add(a,b,c)};a.prototype._setDefaultRoutes=function(){var a=this,b=function(b,d){var c=null;c=require("url").parse(b.url).pathname;c="/"==c?"/":"/"+c.split("/")[1];a.doRequest(c,b,d,function(a){void 0!=a&&null!=a&&("object"==typeof a?d.json(a):d.send(a))})};this._routes.forEach(function(d){a.addRoute(d.path,
d.options,b)})};a.prototype._startServer=function(a){var b=this;this._setDefaultRoutes();this._app.set("case sensitive routing",!0);this._app.use(function(a,b,d){b.header("Access-Control-Allow-Origin","*");b.header("Access-Control-Allow-Headers","Origin, X-Requested-With, Content-Type, Accept, Authorization");var c=require("x.logger.js").getLogger("x.hub.Server.Access");c.log("debug",a.method+":"+a.url);a.source="webserver";b.on("finish",function(){c.log("debug",a.method+":"+a.url+" -> HTTP:"+b.statusCode)});
d()});this._dispatcher.init();this._app.use("*",function(a,b){XC.debugf("INVALID REQ: "+a.url);b.json({XC_ERR:{code:"000001",msg:"invalid request"}})});this._app.use(function(a,b,d,c){XC.debugf(a);d.json({XC_ERR:{code:"000002",msg:a.stack}})});this._httpserver.listen(this._port,function(){var d=b._httpserver.address().port;b._logger.log("info","listening on port "+d+"...");a&&a()})};a.prototype.doRequest=function(a,b,c,e){!e&&c&&"function"==typeof c&&(e=c,c=null);var d=this;if("/"==a){var f='<!DOCTYPE html>\n<html>\n<head>\n<meta http-equiv="content-type" content="text/html; charset=utf-8" />\n<title>'+
...
a){var k={XC_SUC:{name:this._name,mhv:"XH II-"+this.hostType,msv:this.VERSION,msb:this.BUILD,hwv:this.HWV,vid:this._vid,start:this._startup,time:Math.round((new Date).getTime()/1E3)}},w="020D",y="0087";localStorage.getItem("x.hub.Server.geo.lat")&&(w=localStorage.getItem("x.hub.Server.geo.lat"));localStorage.getItem("x.hub.Server.geo.long")&&(y=localStorage.getItem("x.hub.Server.geo.long"));localStorage.getItem("x.hub.v5.config")&&(k.XC_SUC.cfg=localStorage.getItem("x.hub.v5.config"));localStorage.getItem("x.hub.v5.cloudServer")&&
localStorage.getItem("x.hub.v5.cloudPort")?k.XC_SUC.server=localStorage.getItem("x.hub.v5.cloudServer")+":"+localStorage.getItem("x.hub.v5.cloudPort"):(a=require("x.hub.v5.js").CloudConnect,k.XC_SUC.server=a.prototype.CLOUD_SERVER+":"+a.prototype.CLOUD_SERVER_PORT);localStorage.getItem("x.hub.v5.SID")&&(k.XC_SUC.sid=localStorage.getItem("x.hub.v5.SID"));localStorage.getItem("x.hub.taskman.NEO_SERVER")&&(k.XC_SUC.neoserver=localStorage.getItem("x.hub.taskman.NEO_SERVER"));localStorage.getItem("x.hub.m.hm.CCU_INIT_STATE")&&
(k.XC_SUC.ccu_init_state=localStorage.getItem("x.hub.m.hm.CCU_INIT_STATE"));localStorage.getItem("x.hub.Server.DISABLE_ST_STATES")&&(k.XC_SUC.disable_st_states=localStorage.getItem("x.hub.Server.DISABLE_ST_STATES"));(a=require("os"))&&a.freemem&&(k.XC_SUC.mem=Math.floor(a.freemem()/1E3));try{global.LOAD_MODULES&&-1!=global.LOAD_MODULES.indexOf("enocean")&&(f=require("x.hub.m.enocean.js"))&&(g=f.getEnoceanInfo(),k.XC_SUC.enocean=g)}catch(q){}f=require("async");f.parallel([function(a){k.XC_SUC.rcs=
d.getRCS();a()},function(a){k.XC_SUC.locked=d.isLocked();a()},function(a){d._platform.getExtraInfo(function(b,d){!b&&d&&(k.XC_SUC.extra=d);a()})},function(a){d._platform._time.getNTPServers(function(b,d){!b&&d&&(k.XC_SUC.ntp=d.join(","));a()})},function(a){d._platform._time.getTimezoneEncoded(function(b,d){!b&&d&&(k.XC_SUC.loc=(d+w+y).toUpperCase());a()})},function(a){k.XC_SUC.mediola_mac=d._platform._network.getMediolaMac();d._platform._network.getNetwork(function(b,d){if(!b&&d){var c=function(a){return a?
{ip:a.ip,sn:a.subnet,gw:a.router,dhcp:a.dhcp,dns:a.dns?a.dns.join(","):a.dns,mac:a.mac?a.mac.replace(/:/g,"-"):null}:null},e=Object.keys(d);if(0==e.length)return;b=c(d.eth0);var f=c(d.wlan0),g=null;d.eth0||d.wlan0||(g=c(d[e[0]]));d=null;b&&b.ip?(d=b,k.XC_SUC.primary_net="eth0"):f&&f.ip?(d=f,k.XC_SUC.primary_net="wlan0"):g&&g.ip&&(d=f,k.XC_SUC.primary_net=e[0]);for(var q in d)k.XC_SUC[q]=d[q];k.XC_SUC.cfg&&d&&(q=parseInt(k.XC_SUC.cfg,16),q=!0===d.dhcp?q&-129:q|128,k.XC_SUC.cfg=q.toString(16),2>k.XC_SUC.cfg.length&&
(k.XC_SUC.cfg="0"+k.XC_SUC.cfg),k.XC_SUC.cfg=k.XC_SUC.cfg.toUpperCase());k.XC_SUC.eth0=b;k.XC_SUC.wlan0=f}a()})}],function(){e(JSON.stringify(k))})}else if("/command"==a)if((f=b.query.XC_FNC)&&this._commandFunctions[f.toLowerCase()])this._commandFunctions[f.toLowerCase()](b,c);else this._doSTMCommandRequest(b,!0,function(a){c.send(a)});else if("/cmd"==a)if(f=b.query.XC_FNC,!f&&b.json&&b.json.XC_FNC&&(f=b.json.XC_FNC,b.query=b.json),f&&this._cmdFunctions[f.toLowerCase()])this._cmdFunctions[f.toLowerCase()](b,
function(a){a?e(a):d._doSTMCommandRequest(b,!1,e)});else this._doSTMCommandRequest(b,!1,e);else if("/config"==a){var r=!1,t,A=!1,z=null;!b.query||1!=b.query.poweroff&&"true"!=b.query.poweroff&&1!=b.query.poweroff||(z=!0);f=require("async");f.series([function(a){b.query.name&&(d._name=b.query.name,localStorage&&localStorage.setItem("x.hub.Server.name",b.query.name));b.query.vid&&(d._vid=b.query.vid,localStorage&&localStorage.setItem("x.hub.Server.vid",b.query.vid));if(b.query.pwd||""==b.query.pwd){var c=
require("x.crypt.js");0===b.query.pwd.length?(d._pwd="",b.query.cloud=0):d._pwd=c.MD5(unescape(encodeURI(b.query.pwd+"_SALT!")));localStorage&&localStorage.setItem("x.hub.Server.pwd",d._pwd);r=!0}b.query.neoserver&&localStorage&&(localStorage.setItem("x.hub.taskman.NEO_SERVER",b.query.neoserver),c=require("x.hub.eventbus.js"),c.emit("neoserver_activation",b.query.neoserver));b.query.ccu_init_state&&localStorage&&(localStorage.setItem("x.hub.m.hm.CCU_INIT_STATE",b.query.ccu_init_state),c=require("x.hub.eventbus.js"),
c.emit("x.hub.m.hm.CCU_INIT_STATE",b.query.ccu_init_state));b.query.disable_st_states&&localStorage&&localStorage.setItem("x.hub.Server.DISABLE_ST_STATES",b.query.disable_st_states);b.query.sid&&localStorage&&(localStorage.setItem("x.hub.v5.SID",b.query.sid),r=!0);b.query.ckey&&localStorage&&(localStorage.setItem("x.hub.v5.cloudKey",b.query.ckey),r=!0);b.query.cserver&&localStorage&&(localStorage.setItem("x.hub.v5.cloudServer",b.query.cserver),r=!0);b.query.cport&&localStorage&&(localStorage.setItem("x.hub.v5.cloudPort",
b.query.cport),r=!0);b.query.cloud&&localStorage&&(c=255,localStorage.getItem("x.hub.v5.config")&&(c=parseInt(localStorage.getItem("x.hub.v5.config"),16)),c=1==b.query.cloud?c&-65:c|64,c=c.toString(16),2>c.length&&(c="0"+c),localStorage.setItem("x.hub.v5.config",c.toUpperCase()),r=!0);a()},function(a){if(b.query.loc){if(2==b.query.loc.length)var c=b.query.loc;else if(8==b.query.loc.length){var e=b.query.loc.substr(0,4);var f=b.query.loc.substr(4)}else 10==b.query.loc.length&&(c=b.query.loc.substr(0,
2),e=b.query.loc.substr(2,4),f=b.query.loc.substr(6));d.setTimeZoneCompatiable(c,function(b){b&&(t=b);d.setLocation(e,f,function(b){b&&(t=b);a()})})}else a()},function(a){b.query.apin?d.setPin(b.query.pin,b.query.apin,function(b){b&&(t=Error("failed to config"));a(b)}):a()},function(a){if(void 0==b.query.rcs||null==b.query.rcs||""==b.query.rcs)a();else{var c=null;if("1"==b.query.rcs||"true"==b.query.rcs||1==b.query.rcs)c=!0;else if("0"==b.query.rcs||"false"==b.query.rcs||0==b.query.rcs)c=!1;else{a();
return}d.setRCS(c,function(b){b&&(t=Error("failed to config"));a(b)})}},function(a){var c={};b.query.ip&&b.query.sn&&b.query.gw&&b.query.dns&&(c.IP=b.query.ip,c.SN=b.query.sn,c.GW=b.query.gw,c.DNS=b.query.dns,c.DHCP=!1);b.query.dhcp&&1==b.query.dhcp&&(c={DHCP:!0});b.query.ntp&&(c.NTP=b.query.ntp);b.query.mac&&(c.MAC=b.query.mac);0>=Object.keys(c).length?a():d._platform.setIPData(c,function(b,d){b?t=b:A=d;a()})}],function(){r&&d._cloudConnect&&d._cloudConnect.init(d);e&&(t?e(JSON.stringify({XC_ERR:{code:"000001",
msg:t.message}})):e('{"XC_SUC": {}}'));1==z?d.poweroff(1E3):A&&d.restart(1E3)})}else if("/executeCommand"==a)f=require("x.logger.js").getLogger("GeneralExecuteCommand API"),b.json&&(b.query=b.json),f.log("trace","general execute command:"+JSON.stringify(b.query)),b.query&&b.query.data?(g=b.query.type,f=b.query.data,f.device&&!f.device.sys&&(f.device.sys=g),f.gateway&&!f.gateway.sys&&(f.gateway.sys=g),g=require("x.hub.commandman.js"),g.commandHandler.executeCommand(f.device,f.gateway,f.command,function(a){a.error?
e('{"XC_ERR":{"code":"000000","msg":"'+a.error.message+'"}}'):e('{"XC_SUC":{}}')})):e('{"XC_ERR":{"code":"000001", "msg":"invalid request"}}');else if("/getStates"==a)f=require("x.logger.js").getLogger("GeneralGetStates API"),f.log("trace","general get states:"+JSON.stringify(b.query)),b.json&&(b.query=b.json),b.query&&b.query.data?(g=b.query.type,f=b.query.data,f.device&&!f.device.sys&&(f.device.sys=g),f.gateway&&!f.gateway.sys&&(f.gateway.sys=g),g=require("x.hub.commandman.js"),f.deviceList?g.commandHandler.getMultiStatesLegacy(f.device,
f.gateway,f.deviceList,function(a){a.error?e('{"XC_ERR":{"code":"000000","msg":"'+a.error.message+'"}}'):a&&a.data?e(JSON.stringify({XC_SUC:{data:JSON.stringify(a.data)}})):e('{"XC_SUC":{}}')}):g.commandHandler.getState(f.device,f.gateway,f.status,function(a){a.error?e('{"XC_ERR":{"code":"000000","msg":"'+a.error.message+'"}}'):a&&a.data?e(JSON.stringify({XC_SUC:{data:JSON.stringify(a.data)}})):e('{"XC_SUC":{}}')})):e('{"XC_ERR":{"code":"000001", "msg":"invalid request"}}');else if("/getKey"==a)if(f=
b.query?b.query.k:null){var u=(b.headers?b.headers["x-forwarded-for"]:null)||(b.connection?b.connection.remoteAddress:null);if(u){var v=require("x.hub.password");v.registSecureClient(u,f,function(a,b){a?e&&e({XC_ERR:{code:"000000",msg:a.message}}):e&&e({XC_SUC:b})})}else e&&e({XC_ERR:{code:"000000",msg:"can not get client ip address"}})}else k={XC_SUC:{}},localStorage.getItem("x.hub.v5.cloudKey")&&(k.XC_SUC.cloud=localStorage.getItem("x.hub.v5.cloudKey")),require("x.hub.v5.js").getPublicKey(function(a){k.XC_SUC.key=
a;e&&e(k)});else if("/peripheral"==a)require("x.hub.peripheralman.js").getUSBDevicesShortInfo(function(a){a?a.error?e&&e(JSON.stringify({XC_ERR:{code:"000001",msg:a.error}})):a.data?e&&e(JSON.stringify({XC_SUC:a.data})):e&&e(JSON.stringify({XC_ERR:{code:"000001",msg:"get peripheral internal error"}})):e&&e(JSON.stringify({XC_ERR:{code:"000001",msg:"get peripheral internal error"}}))});else if("/update"==a)b.method&&"post"==b.method.toLowerCase()&&b.query&&"st"==b.query.type?d._platform.updateSTM(b,
c,function(){e&&e()}):b.query&&"st"==b.query.type?d._platform.updateSTM(null,c,function(){e&&e()}):d._platform.updateFirmware(b.query?b.query.url:null,function(a,b){a?c.json({XC_ERR:{code:a.code?a.code:"000000",msg:a.message}}):(c.json({XC_SUC:{}}),b&&d._platform.reboot(null,1E3));e&&e()});else if("/backup"==a)d._platform.backup(b,c,function(){e&&e()});else if("/restore"==a)d._platform.restore(b,c,function(){e&&e()});else if("/reset"==a)b.query&&b.query.type?"st"==b.query.type?d._platform._stm.reset(function(a){a?
e&&e({XC_ERR:{msg:a.message}}):e&&e({XC_SUC:{}})}):"st_reboot"==b.query.type?d._platform._stm.reboot(function(a){a?e&&e({XC_ERR:{msg:a.message}}):e&&e({XC_SUC:{}})}):"knx"==b.query.type?require("x.hub.m.knx.js").reset(function(a){a&&!a.error?e&&e({XC_SUC:{}}):e&&e({XC_ERR:{code:"000000",message:"reset knx failed"}})}):"zwave"==b.query.type&&d._platform._zwayServer.reset(function(a){a?e&&e({XC_ERR:{msg:a.message}}):e&&e({XC_SUC:{}})}):(e&&e('{"XC_SUC":{}}'),d.restart(1E3));else if("/reboot"==a)e&&
e('{"XC_SUC":{}}'),f=null,b.query&&b.query.mode&&"recovery"==b.query.mode&&(f="recovery"),d._platform.reboot(f,1E3);else if("/wifi"==a)switch(f=b.path,f=f.substr(5),f){case "/scan":d._platform._network.scanWifi(b.query,function(a,b){a?e&&e(JSON.stringify({XC_ERR:{code:a.code?a.code:"000000",msg:a.message}})):e&&e(JSON.stringify({XC_SUC:b?b:[]}))});break;case "/connect":d._platform._network.connectWifi(b.query,function(a){a?e&&e(JSON.stringify({XC_ERR:{code:a.code?a.code:"000000",msg:a.message}})):
(e&&e(JSON.stringify({XC_SUC:{}})),d.restart(1E3))});break;case "/disconnect":d._platform._network.disconnectWifi(b.query,function(a){a?e&&e(JSON.stringify({XC_ERR:{code:a.code?a.code:"000000",msg:a.message}})):(e&&e(JSON.stringify({XC_SUC:{}})),d.restart(1E3))});break;case "/info":d._platform._network.getWifiInfo(b.query,function(a,b){a?e&&e(JSON.stringify({XC_ERR:{code:a.code?a.code:"000000",msg:a.message}})):e&&e(JSON.stringify({XC_SUC:b}))});break;case "/config":f={};"true"==b.query.dhcp||1==
b.query.dhcp||1==b.query.dhcp?f={dhcp:!0}:b.query.ip&&b.query.sn&&b.query.gw&&b.query.dns&&(f.ip=b.query.ip,f.subnet=b.query.sn,f.router=b.query.gw,f.dns=b.query.dns?b.query.dns.split(","):[],f.dhcp=!1);if(0>=Object.keys(f).length){e&&e(JSON.stringify({XC_SUC:{}}));break}d._platform._network.setNetwork("wlan0",f,function(a){a?e&&e(JSON.stringify({XC_ERR:{code:a.code?a.code:"000000",msg:a.message}})):(e&&e(JSON.stringify({XC_SUC:{}})),d.restart(1E3))});break;default:e&&e({XC_ERR:{code:"000001",message:"invalid request"}})}else if("/log"==
a||"/getLogs"==a)b.method&&"get"==b.method.toLowerCase()?d.getLogs(function(a,b,d){if(a)c.status(500),c.json({XC_ERR:{code:"100000",msg:a.message}}),e&&e();else{var f=require("fs-extra");c.setHeader("Content-disposition","attachment; filename="+b);c.sendFile(d,null,function(a){f.removeSync(d);a&&(c.status(500),c.json({XC_ERR:{code:"100000",msg:a.message}}));e&&e(a)})}}):b.method&&"delete"==b.method.toLowerCase()&&d.clearLogs(function(a){a?e&&e({XC_ERR:{code:"100000",msg:a.message}}):e&&e({XC_SUC:{}})});
else if("/tm"==a)if(f=require("url").parse(b.url).pathname,"/tm/http"==f)require("x.hub.taskman.js").taskManager.onHttpEvt(b.query,function(a,b){a?e&&e('{"XC_ERR":{"msg":'+a.message+"}}"):b?e&&e('{"XC_SUC":{}}'):e&&e('{"XC_ERR":{"msg":"no such trigger"}}')});else e&&e(JSON.stringify({XC_ERR:{code:"000000",msg:"invalid request"}}));else"/lock"==a?(f=b.query?b.query.pin:null,d.lock(f,function(a){a?e&&e(JSON.stringify({XC_ERR:{code:a.code,msg:a.message}})):e&&e(JSON.stringify({XC_SUC:{}}))})):"/unlock"==
a?(f=b.query?b.query.pin:null,d.unlock(f,function(a){a?e&&e(JSON.stringify({XC_ERR:{code:a.code,msg:a.message}})):e&&e(JSON.stringify({XC_SUC:{}}))})):"/sapi"==a?(u=(b.headers?b.headers["x-forwarded-for"]:null)||(b.connection?b.connection.remoteAddress:null))?(d=this,v=require("x.hub.password"),v.decodeSecureReq(u,b,function(a,b){if(!a){require("x.logger.js").getLogger("x.hub.Server.Access").log("debug",b.method+":"+b.url);var c={json:function(a){v.encodeSecureRsp(u,JSON.stringify(a),function(a,b){a?
e&&e({XC_ERR:{code:"000000",msg:a.message}}):e&&e(b)})},send:function(a){v.encodeSecureRsp(u,a,function(a,b){a?e&&e({XC_ERR:{code:"000000",msg:a.message}}):e&&e(b)})}};d._dispatcher.doRequest(b,c,function(a){void 0!=a&&null!=a&&("object"==typeof a?c.json(a):c.send(a))})}})):e&&e({XC_ERR:{code:"000000",msg:"can not get client ip address"}}):e&&e('{"XC_ERR":{"code":"000001", "msg":"invalid request"}}')};a.prototype._doSTMCommandRequest=function(a,b,c){if(a){var d=this._platform._stm;if(d){var e=this;
if("string"==typeof a){var f=16;var h=a;-1<h.indexOf("?")&&(h=h.substr(h.indexOf("?")+1))}else"POST"==a.method?(f=17,h=a.json?JSON.stringify(a.json):a.body):(f=16,h=a.url,-1<h.indexOf("?")&&(h=h.substr(h.indexOf("?")+1))),a.locked?"cloud"==a.source?16==f?f=18:17==f&&(f=19):"webserver"!=a.source||a.pinMatch||(16==f?f=18:17==f&&(f=19)):"cloud"==a.source&&(16==f?f=20:17==f&&(f=21));d.sendCommand(f,h,function(a){a&&a.error?e._logger.log("trace",h+" --\x3e FAIL:"+a.error):a&&a.data?e._logger.log("trace",
h+" --\x3e "+a.data.toString()):e._logger.log("trace",h+" --\x3e FAIL");if(a&&a.data){var d="XC_SUC";a.error&&(d="XC_ERR");b?c("{"+d+"}"+a.data.toString()):c('{"'+d+'": '+a.data.toString()+"}")}else b?c("{XC_ERR}internal error"):a&&a.error?c(JSON.stringify({XC_ERR:{code:"000000",msg:a.error}})):c('{"XC_ERR":{"code":"000000", "msg":"internal error"}}')})}else b?c("{XC_ERR}no stm"):c('{"XC_ERR":{"code":"000001", "msg":"no stm"}}')}else b?c("{XC_ERR}invalid request"):c('{"XC_ERR":{"code":"000001", "msg":"invalid request"}}')};
a.prototype.setLED=function(a,b){if(a&&"string"==typeof a&&a.match(/^([a-fA-F0-9]){4}/g)){var d=this._platform._led;if(d){var c=parseInt(a.substr(0,2),16);a=parseInt(a.substr(2,2),16);var e;switch(a){case 0:var f=e=a=0;break;case 1:a=0;e=255;f=0;break;case 2:e=a=0;f=255;break;case 3:a=255;f=e=0;break;case 4:e=a=255;f=0;break;case 5:f=e=a=255;break;case 6:a=255;e=0;f=255;break;case 7:a=0;f=e=255;break;default:b&&b(Error("invalid set led color:"+a));return}0===c?d.setColor(a,e,f,function(a){b&&b(a)}):
1==c?d.saveColor(a,e,f,function(a){b&&b(a)}):b&&b(Error("invalid set led command:"+c))}else b&&b(Error("no led"))}else b&&b(Error("invalid set led data: "+a))};a.prototype.restart=function(a){this._platform.reboot(null,a)};a.prototype.poweroff=function(a){this._platform.poweroff(a)};a.prototype.reset=function(a,b){var c=require("path"),d=require("fs"),e=require("fs-extra"),f=require("x.hub.fileman.js").fileManager.getUserRootDataPath();this._logger.log("debug","reset ("+a+")");switch(a){case "passwords":a=
c.join(f,"localstorage","x.hub.Server.pwd");d.existsSync(a)&&(this._logger.log("trace","remove file "+a),e.removeSync(a));require("x.hub.password.js").reset(function(){b&&b(null,!0)});break;case "network":this._platform.reset("network",function(a,c){b&&b(a,c)});break;case "factory":d.existsSync(f)&&(this._logger.log("trace","clear folder "+f),e.emptyDirSync(f));this._platform.reset("factory",function(a,c){b&&b(a,c)});break;default:b&&b(Error("unknonw reset mode: "+a))}};a.prototype.getTimezoneSync=
function(){return this._platform.getTimezoneSync()};a.prototype.setTimeZoneCompatiable=function(a,b){this._platform.setTZData(a,function(c){c||process.nextTick(function(){require("x.hub.eventbus.js").emit("locationchange",{timezone:a})});b&&b(c)})};a.prototype.getTimeZoneCompatiable=function(a){this._platform.getTZData(a)};a.prototype.setLocation=function(a,b,c){this._platform.setLocation(a,b,function(d){d||process.nextTick(function(){require("x.hub.eventbus.js").emit("locationchange",{lat:a,long:b})});
c&&c(d)})};a.prototype.getLocation=function(a){this._platform.getLocation(function(b,c,d){a&&a(b,c,d)})};a.prototype.getLogs=function(a){var b=require("x.hub.fileman.js").fileManager.getUserLogPath(),c=require("os").tmpdir(),d=require("path"),e=require("fs-extra"),f=require("archiver"),m="logs_"+(new Date).toISOString().substr(0,16).replace(/T/g,"").replace(/-/g,"").replace(/:/g,"")+".zip",n=d.join(c,m);c=e.createWriteStream(n);f=f("zip");c.on("close",function(){a&&(a(null,m,n),a=null)});c.on("error",
function(b){a&&(a(b),a=null)});f.on("error",function(b){a&&(a(b),a=null)});f.pipe(c);f.directory(b);f.finalize()};a.prototype.clearLogs=function(a){require("x.hub.logman.js").clearLogs(function(b){a&&a(b)})};a.prototype.getCloudServer=function(){return this._cloudConnect.getCloudServer()};a.prototype.getCloudPort=function(){return this._cloudConnect.getCloudPort()};a.prototype.isCloudConnected=function(){return this._cloudConnect.isConnected()};a.prototype.isLocked=function(){return this._locked};
a.prototype.lock=function(a,b){!a||this.checkPin(a)?(localStorage.setItem("x.hub.Server.lock",!0),this._locked=!0,b&&b(null)):(a=Error("failed to lock"),a.code="000003",b&&b(a))};a.prototype.unlock=function(a,b){a&&this.checkPin(a)?(localStorage.setItem("x.hub.Server.lock",!1),this._locked=!1,b&&b(null)):(a=Error("access denied (locked)"),a.code="000007",b&&b(a))};a.prototype.setPin=function(a,b,c){a=require("x.hub.password.js").setPin(a,b);c&&c(a?null:Error("failed"))};a.prototype.checkPin=function(a){return require("x.hub.password.js").checkPin(a)};
a.prototype.getRCS=function(){return this._rcs};a.prototype.setRCS=function(a,b){localStorage.getItem("x.hub.Server.rcs",a);this._rcs=a;b&&b()};return a}();x.hub.Handler=function(){this.server=null};x.hub.Handler.prototype.Server=x.hub.Server;x.hub.Handler.prototype.ServerNEO=x.hub.ServerNEO;x.hub.Handler.prototype.ServerV6=x.hub.ServerV6;x.hub.Handler.prototype.getServer=function(){return this.server};
