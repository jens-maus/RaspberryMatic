...
x.hub.logman.Handler=function(){Handler=function(){};Handler.prototype.init=function(a,c){var b=global.LOG_LEVEL;if(localStorage){var d=localStorage.getItem("x.hub.Server.logLevel");"undefined"!=typeof d&&null!=d&&(b=d)}this._setupLogger(a,b);"fatal"==b?this._clearLogFiles(c):c&&c()};Handler.prototype.setLoggger=function(a,c,b){require("x.logger.js").setLevel(c,a);!a&&localStorage&&localStorage.setItem("x.hub.Server.logLevel",c);a||"fatal"!=c?b&&b():this._clearLogFiles(b)};Handler.prototype.clearLogs=
function(a){this._clearLogFiles(a)};Handler.prototype.compressLogs=function(a){var c=require("x.hub.fileman.js").fileManager.getUserLogPath(),b=require("os").tmpdir(),d=require("path"),f=require("fs-extra"),e=require("archiver"),g="logs_"+(new Date).toISOString().substr(0,16).replace(/T/g,"").replace(/-/g,"").replace(/:/g,"")+".zip",h=d.join(b,g);b=f.createWriteStream(h);e=e("zip");b.on("close",function(){a&&(a(null,g,h),a=null)});b.on("error",function(b){a&&(a(b),a=null)});e.on("error",function(b){a&&
(a(b),a=null)});e.pipe(b);e.directory(c);e.finalize()};Handler.prototype._setupLogger=function(a,c){var b=require("fs-extra"),d=require("path");require("x.logger.js").setFile(a.getLogFile());require("x.logger.js").setLogFolder(a.getUserLogPath());require("x.logger.js")._fileMaxSize=2048;require("x.logger.js").setLevel(c);require("x.logger.js").setTagFile("x.hub.v5.CloudConnect","v5p_cloud_access.log");require("x.logger.js").setLogToConsole(!1,"x.hub.v5.CloudConnect");b.ensureFileSync(d.resolve(a.getUserLogPath(),
...
function(a){var c=require("x.hub.fileman.js").fileManager,b=require("path"),d=require("x.logger.js").getFile();d?this._clearLogFile(b.resolve(c.getUserLogPath(),d),a):a&&a()};Handler.prototype._clearTagFiles=function(a){var c=require("x.hub.fileman.js").fileManager,b=require("x.logger.js").getTagFiles(),d=require("path"),f=[],e;for(e in b)b[e]&&f.push(b[e]);if(0==f.length)a&&a();else{var g=0,h=this,k=function(){g++;g<f.length?h._clearLogFile(d.resolve(c.getUserLogPath(),f[g]),k):a&&a()};this._clearLogFile(d.resolve(c.getUserLogPath(),
f[g]),k)}};Handler.prototype._clearLogFile=function(a,c){if(a){var b=require("fs-extra");b.ensureFile(a,function(d){d?c&&c(d):b.writeFile(a,"",function(a){c&&c(a)})})}else c&&c()};return Handler}();module.exports=new x.hub.logman.Handler;
