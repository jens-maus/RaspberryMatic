...
function(a,c){var b=require("fs-extra"),d=require("path");require("x.logger.js").setFile(a.getLogFile());require("x.logger.js").setLogFolder(a.getUserLogPath());require("x.logger.js")._fileMaxSize=2048;require("x.logger.js").setLevel(c);require("x.logger.js").setTagFile("CloudRemoteAccess","cloud_access.log");b.ensureFileSync(d.resolve(a.getUserLogPath(),"v5p_taskmanager.log"));require("x.logger.js").setTagFile("x.hub.taskman","v5p_taskmanager.log");require("x.logger.js").setLogToConsole(!1,"x.hub.taskman");
b.ensureFileSync(d.resolve(a.getUserLogPath(),"v5p_homematic.log"));require("x.logger.js").setTagFile("x.hub.m.hm","v5p_homematic.log");require("x.logger.js").setTagFile("xnm.aio.hm","v5p_homematic.log");require("x.logger.js").setLogToConsole(!1,"x.hub.m.hm");require("x.logger.js").setLogToConsole(!1,"xnm.aio.hm");global.LOAD_MODULES&&-1!=global.LOAD_MODULES.indexOf("enocean")&&(b.ensureFileSync(d.resolve(a.getUserLogPath(),"v5p_enocean.log")),require("x.logger.js").setTagFile("x.hub.m.enocean","v5p_enocean.log"),
require("x.logger.js").setLogToConsole(!1,"x.hub.m.enocean"));global.LOAD_MODULES&&-1!=global.LOAD_MODULES.indexOf("zigbee")&&(b.ensureFileSync(d.resolve(a.getUserLogPath(),"v5p_zigbee.log")),require("x.logger.js").setTagFile("x.hub.m.zigbee","v5p_zigbee.log"),require("x.logger.js").setLogToConsole(!1,"x.hub.m.zigbee"));global.LOAD_MODULES&&-1!=global.LOAD_MODULES.indexOf("zway")&&(b.ensureFileSync(d.resolve(a.getUserLogPath(),"v5p_zwave.log")),require("x.logger.js").setTagFile("x.hub.m.zway","v5p_zwave.log"),
require("x.logger.js").setLogToConsole(!1,"x.hub.m.zway"));global.LOAD_MODULES&&-1!=global.LOAD_MODULES.indexOf("knx")&&(b.ensureFileSync(d.resolve(a.getUserLogPath(),"v5p_knx.log")),require("x.logger.js").setTagFile("x.hub.m.knx","v5p_knx.log"),require("x.logger.js").setTagFile("xnm.aio.knx","v5p_knx.log"),require("x.logger.js").setLogToConsole(!1,"x.hub.m.knx"),require("x.logger.js").setLogToConsole(!1,"xnm.aio.knx"));b.ensureFileSync(d.resolve(a.getUserLogPath(),"v5p_aiogateway.log"));require("x.logger.js").setTagFile("x.hub.m.gateway",
"v5p_aiogateway.log");require("x.logger.js").setTagFile("xnm.aio.gateway","v5p_aiogateway.log");require("x.logger.js").setLogToConsole(!1,"x.hub.m.gateway");require("x.logger.js").setLogToConsole(!1,"xnm.aio.gateway");b.ensureFileSync(d.resolve(a.getUserLogPath(),"v5p_rf_st.log"));require("x.logger.js").setTagFile("x.hub.v5.USBSerial","v5p_rf_st.log");require("x.logger.js").setLogToConsole(!1,"x.hub.v5.USBSerial")};Handler.prototype._clearLogFiles=function(a){var c=this;this._clearMainLogFile(function(){c._clearTagFiles(function(){c._clearConsoleDumpFile(function(){a&&
