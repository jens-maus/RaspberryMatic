var util=require("util"),EventEmitter=require("events");require("x.logger.js").setLevel("trace","x.hub.m.cams");var x=x||{};x.hub=x.hub||{};x.hub.m=x.hub.m||{};x.hub.m.cams=x.hub.m.cams||{};x.hub.m.cams.CAMS_MODULE=require("xnm.aio.cams.js");
...
b,c){require("x.hub.commandman.js").commandHandler.executeCommandLegacy(a,null,b,c)};c.prototype.checkDeviceMatch=function(a,b){return b&&b.device&&a&&a.device&&b.device.manufacturer==a.device.manufacturer&&b.device.model==a.device.model?b.device.ip==a.device.ip:!1};c.prototype.getDoorBirdHandler=function(){return this._doorBirdHandler};c.prototype._startDoorBirdMonitor=function(a,b,c){if(a&&a.ip){var e=a.ip;this._doorBirdMonitors[e]?(c&&c.callback&&this._doorBirdMonitors[e].addCallback(c.callback),
b&&b(null,this._doorBirdMonitors[e])):x.hub.m.cams.CAMS_MODULE.resolveDevice(a)?(a=new x.hub.m.cams.DoorBirdMonitor(a,this),this._doorBirdMonitors[e]=a,c&&c.callback&&a.addCallback(c.callback),a.start(),b&&b(null,a)):b&&b(Error("doorbird json format invalid"))}else b&&b(Error("harmony hub format invalid"))};c.prototype._stopDoorBirdMonitor=function(a,b,c){if(a&&a.ip){var e=this,h=a.ip;(a=this._doorBirdMonitors[h])?(c&&c.callback&&a.removeCallback(c.callback),a.stop(function(a,c){!a&&c&&delete e._doorBirdMonitors[h];
