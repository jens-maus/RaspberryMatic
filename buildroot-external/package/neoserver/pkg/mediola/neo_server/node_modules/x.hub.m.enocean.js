var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(g,b,a){g!=Array.prototype&&g!=Object.prototype&&(g[b]=a.value)};$jscomp.getGlobal=function(g){return"undefined"!=typeof window&&window===g?g:"undefined"!=typeof global&&null!=global?global:g};$jscomp.global=$jscomp.getGlobal(this);$jscomp.SYMBOL_PREFIX="jscomp_symbol_";
$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.Symbol=function(){var g=0;return function(b){return $jscomp.SYMBOL_PREFIX+(b||"")+g++}}();
...
$jscomp.iteratorPrototype=function(g){$jscomp.initSymbolIterator();g={next:g};g[$jscomp.global.Symbol.iterator]=function(){return this};return g};$jscomp.iteratorFromArray=function(g,b){$jscomp.initSymbolIterator();g instanceof String&&(g+="");var a=0,f={next:function(){if(a<g.length){var e=a++;return{value:b(e,g[e]),done:!1}}f.next=function(){return{done:!0,value:void 0}};return f.next()}};f[Symbol.iterator]=function(){return f};return f};
...
var b=0,h=0;1==e.slf.mac_alro?b=3:2==e.slf.mac_alro&&(b=4);1==e.slf.rlc_tx&&(1==e.slf.rlc_algo?h=2:2==e.slf.rlc_algo&&(h=3));var l=a.userData.length-b-h,r=a.userData.slice(0,l),m=null,u=null;h&&(u=a.userData.slice(l,l+h));b&&(m=a.userData.slice(l+h));b=u?u:e.rlc;h=!0;m&&(m=this.checkCmac(a.rorg,r,b,e.completeKey,m),m.rlc&&b.toString("hex")!=m.rlc.toString("hex")&&(b=m.rlc,e.rlc=m.rlc),m&&m.ok?(this._logger.log("trace","receive from "+f+" with cmac rlc:"+b.toString("hex")),delete this._unsync[f]):
(h=!1,this._logger.log("warn","receive from "+f+" with cmac out of snyc, last rlc:"+b.toString("hex")),this._unsync[f]=b.toString("hex")));f=null;h&&3==e.slf.data_enc&&(r=this.decryptVAES(b,g,e.completeKey,r),f=a.convertToPacket(r).toRadioTelegram());e.rlc=this._incRLC(b);this._logger.log("trace","senderID next rlc:"+e.rlc.toString("hex"));this._saveSec(this._secInfo);return f};b.prototype.decryptVAES=function(a,f,e,b){for(var k=b.length,l=Math.ceil(k/16),g=[],m=null,u=0;u<l;u++){var y=16*u,C=y+16;
C>k&&(C=k);y=b.slice(y,C);m=this._doVAESblock(a,f,e,m,y);g.push(m.data);m=m.enc}return Buffer.concat(g)};b.prototype._doVAESblock=function(a,f,e,b,h){a=this._xor(a,f);b&&(a=this._xor(a,b));e=this._doAES128(e,null,a);b=this._xor(e,h);b=b.slice(0,h.length);return{data:b,enc:e}};b.prototype.checkCmac=function(a,f,e,b,h){if(e){for(var k=this._bufToInt(e),g=0;128>g;g++){if(0!=g){k+=1;var m=65535;3==e.length&&(m=16777215);k>m&&(k=0)}m=this._intToBuf(k,e.length);m=this.calcCmac(a,f,m,b,h.length);if(m.toString("hex")==
h.toString("hex"))return{ok:!0,rlc:this._intToBuf(k,e.length)}}return{ok:!1,rlc:this._intToBuf(k,e.length)}}m=this.calcCmac(a,f,null,b,h.length);return m.toString("hex")==h.toString("hex")?{ok:!0}:{ok:!1}};b.prototype.calcCmac=function(a,f,e,b,h){var k=this._getCmacSubkey(b),g=new Buffer(1);g.writeUInt8(a);g=Buffer.concat([g,f]);e&&(g=Buffer.concat([g,e]));a=g.length;f=Math.ceil(a/16);e=null;for(var m=0;m<f;m++){var u=16*m;var y=u+16;y>a&&(y=a);u=g.slice(u,y);e=u=this._doCmacBlock(b,k.k1,k.k2,u,e)}return u.slice(0,
...
if(f){b=f._address;var e=this._devices[b];e&&e._data==f._data&&(f._states=e._states);this._devices[b]=f;this._saveDevices(this._devices,function(b){a&&a(b,f)})}else b=Error("unknow profile"),b.errorCode=this.UNKNOWN_PROFILE_ERR,a&&a(b)}else b=Error("device json invalid"),a&&a(b)};g.prototype.updateDevice=function(b,a,f){if(b)if(a&&a.data){var e=this._devices[b];a.address||(a.address=b);a.address=a.address.toLowerCase();a.senderID&&(a.senderID=a.senderID.toLowerCase());var g=x.hub.m.enocean.profiles.parseJson(a);
...
delete this._devices[b.address];this.emit("deleteDevice",e);this._saveDevices(this._devices,function(b){a&&a(b,f)})}else a&&a()};g.prototype.onLearnAddDeleteDevice=function(b,a){if(b&&b.address)if(this._devices[b.address])this.deleteDevice(b,function(b,e){a&&a(b,1,e)});else this.onLearnDevice(null,b,function(b,e){a&&a(b,0,e)});else a&&a()};g.prototype.onLearnDevice=function(b,a,f){if(a&&a.address&&a.data){var e=x.hub.m.enocean.profiles.parseJson(a);if(e){var g=a.address;if(this._devices[g]){var h=
this._devices[g];g=h.toJSON();if(g.data!=a.data||g.vendor!=a.vendor)a=Error("address "+a.address+" already exists, please delete it first"),a.errorCode=this.ALREADY_EXISTS_ERR,f&&f(a);else if(g.senderID!=a.senderID){h._senderID=a.senderID;if("bb-aa-cc"==h._data||"d2-06-10"==h._data)h.executeCommand(null,{value:"alertOn"}),h.executeCommand(null,{value:"preAlarmOn"});else if("afriso_water_eco"==e._data)e.onLearn();this._saveDevices(this._devices,function(a){f&&f(a,h)})}else f&&f(null,h)}else{b&&(a=
b.address)&&a!=g&&this._devices[a]&&delete this._devices[a];this._devices[g]=e;if("bb-aa-cc"==e._data||"d2-06-10"==e._data)e.executeCommand(null,{value:"alertOn"}),e.executeCommand(null,{value:"preAlarmOn"});else if("afriso_water_eco"==e._data)e.onLearn();this._saveDevices(this._devices,function(a){f&&f(a,e)})}}else a=Error("unknow profile"),a.errorCode=this.UNKNOWN_PROFILE_ERR,f&&f(a)}else a=Error("device json invalid"),f&&f(a)};g.prototype.deviceParamsUpdated=function(b,a){this._saveDevices(this._devices,
function(b){a&&a(b)})};g.prototype.isVirtual=function(b){var a=x.hub.m.enocean.SENDER_ID;if(!a)return!1;var f=parseInt(a,16)+1;a=parseInt(a,16)+128;b=parseInt(b,16);return b>=f&&b<=a};g.prototype.getVirtualSenderID=function(){var b=x.hub.m.enocean.SENDER_ID;if(!b)return[];var a=parseInt(b,16)+1;b=parseInt(b,16)+128;var f=[],e=this._devices,g;for(g in e){var h=e[g];h&&h._senderID&&(h=parseInt(h._senderID,16),h>=a&&h<=b&&f.push(h))}return f};g.prototype.getVirtualAddress=function(){var b=[],a=this._devices,
f;for(f in a)"x"==f.charAt(0)&&(a=parseInt(f.substr(1),16),0<=a&&268435455>=a&&b.push(f));return b};g.prototype.getFreeSenderIdCount=function(){return 128-this.getVirtualSenderID().length};g.prototype.getNextFreeSenderId=function(){var b=x.hub.m.enocean.SENDER_ID;if(!b)return null;var a=parseInt(b,16)+1;b=parseInt(b,16)+128;for(var f=this.getVirtualSenderID(),e=null;a<=b;a++)if(-1==f.indexOf(a)){e=a;break}if(e)for(e=e.toString(16).toLowerCase();8>e.length;)e="0"+e;return e};g.prototype.getNextFreeAddress=
function(){for(var b=this.getVirtualAddress(),a=null,f=0;268435455>=f;f++){for(var e=f.toString(16);7>e.length;)e="0"+e;e="x"+e;if(-1==b.indexOf(e)){a=e;break}}return a};g.prototype.generateVirtual=function(b,a){if(b&&b.data){var f=b.senderID;if(!f&&(f=this.getNextFreeSenderId(),!f)){a&&a(Error("no sender id available"));return}b.senderID=f;b.address=f;b.virtual=!0;if(f=this.findDevice(b)){var e=f.toJSON();b.data!=e.data?a&&a(Error("device of another type with the same address exists")):b.vendor&&
...
b&&b(e):a.readFile(f,"utf8",function(a,e){if(a)b&&b(a);else if(e)try{a={};var f=JSON.parse(e),g;for(g in f){var h=x.hub.m.enocean.profiles.parseDBJson(f[g]);h&&(a[g]=h)}b&&b(null,a)}catch(u){b&&b(u)}else b&&b(null,{})})})};g.prototype._saveDevices=function(b,a){var f=this._getFile(),e={},g;for(g in b)e[g]=b[g].toDBJSON();fs_extra.writeFile(f,JSON.stringify(e,null,2),function(b){a&&a(b)})};return g}();
x.hub.m.enocean.ESP3=function(){var g=function(a,b,e){this.type=a;this.data=b;this.optData=e};g.TYPE={1:"RADIO_ERP1",2:"RESPONSE",3:"RADIO_SUB_TEL",4:"EVENT",5:"COMMAND_COMMAND",6:"SMART_ACK_COMMAND",7:"REMOTE_MAN_COMMAND",9:"RADIO_MESSAGE",10:"RADIO_ERP2",16:"RADIO_802_15_4",17:"COMMAND_2_4"};g.prototype.toBuffer=function(){var a=new Buffer(6);a.writeUInt8(85,0);a.writeUInt16BE(this.data.length,1);a.writeUInt8(this.optData?this.optData.length:0,3);a.writeUInt8(this.type,4);a.writeUInt8(0,5);var b=
x.hub.m.enocean.CRC8(a.slice(1,5));a.writeUInt8(b,5);var e=this.optData?Buffer.concat([this.data,this.optData],this.data.length+this.optData.length):this.data;b=x.hub.m.enocean.CRC8(e);a=Buffer.concat([a,e],6+e.length+1);a.writeUInt8(b,a.length-1);return a};g.prototype.toJSON=function(){return{dataLen:this.data.length,optLen:this.optData?this.optData.length:0,type:this.type,typeName:g.TYPE[this.type],data:this.data.toString("hex"),optData:this.optData?this.optData.toString("hex"):null}};g.prototype.toPacket=
...
retCode:this.retCode.toString(16),resData:this.resData?this.resData.toString("hex"):null,optData:this.optData?this.optData.toString("hex"):null}};a.prototype.toFrame=function(){var a=new Buffer(1);a.writeUInt8(this.retCode,0);this.resData&&(a=Buffer.concat([a,this.resData]));return new g(2,a,this.optData)};a.prototype.toResponse=function(){return t.resolve(this)};a.resolve=function(b){var e;var f=b.data.readUInt8(0);1<b.data.length&&(e=b.data.slice(1));return new a(f,e,b.optData)};var f=function(a,
...
this.securityLvl])]));return new g(1,a,b)};f.prototype.toRadioTelegram=function(){return l.resolve(this)};f.resolve=function(a){var b=!1;if(a.optData){b=!0;var e=a.optData.readUInt8(0);var n=a.optData.slice(1,5).toString("hex");var g=a.optData.readUInt8(5);var h=a.optData.readUInt8(6)}return new f(a.data,b,e,n,g,h)};var e=function(a){this.data=a};e.prototype.toJSON=function(){return{data:this.data.toString("hex")}};e.prototype.toFrame=function(){return new g(6,this.data,null)};e.prototype.toSACommand=
function(){return O.resolve(this)};e.resolve=function(a){return new e(a.data)};var k=function(a){this.data=a};k.prototype.toJSON=function(){return{data:this.data.toString("hex")}};k.prototype.toFrame=function(){return new g(5,this.data,null)};k.prototype.toCommandCommand=function(){return pa.resolve(this)};k.resolve=function(a){return new k(a.data)};var h=function(a){this.data=a};h.prototype.toJSON=function(){return{data:this.data.toString("hex")}};h.prototype.toFrame=function(){return new g(4,this.data,
null)};h.prototype.toEvent=function(){return p.resolve(this)};h.resolve=function(a){return new h(a.data)};var l=function(a,b){this.rorg=a;this.optData=b;this.optData||(this.optData={subTelNum:1,dstId:"FFFFFFFF",dBm:255,securityLvl:0})};l.prototype.setDstId=function(a){this.optData.dstId=a?a:"FFFFFFFF"};l.resolve=function(a){if(!a.data)return null;switch(a.data.readUInt8(0)){case 208:return C.resolve(a);case 246:return J.resolve(a);case 213:return K.resolve(a);case 165:return z.resolve(a);case 210:return w.resolve(a);
case 212:return V.resolve(a);case 53:return Y.resolve(a);case 49:return P.resolve(a);case 64:return y.resolve(a);case 176:return r.resolve(a);case 178:return u.resolve(a);default:return null}};var r=function(){var a=function(a,b,e){8<=e&&(e=8);0>=e&&(e=1);var f=Math.floor(b/8),n=b%8;b=Math.pow(2,e)-1;if(8<n+e)return e=16-n-e,a.readUInt16BE(f)>>e&b;e=8-n-e;return a.readUInt8(f)>>e&b},b=function(a){this.type=a};b.prototype.getType=function(){return this.type};b.resolve=function(b,n){if(n+2>8*b.length)return null;
var h=a(b,n,2),H=null;switch(h){case 0:H=e.resovle(b,n);break;case 1:H={type:h,sigType:b.readUInt16BE(0)>>6&255,valueType:b.readUInt16BE(0)>>2&3,resolution:b.readUInt16BE(0)&15,engMin:b.readUInt8(2),scalingMin:b.readUInt16BE(3)>>12&15,engMax:b.readUInt16BE(3)>>4&255,scalingMax:b.readUInt16BE(3)&15};break;case 2:H=f.resovle(b,n);break;case 3:H=g.resovle(b,n)}return H};var e=function(a,b,e){this.type=0;this.sigType=a;this.dataLen=b;this.data=e};e.prototype=new b;e.prototype.constructor=e;e.prototype.getBitLength=
function(){return 2==this.sigType?50:18};e.prototype.getProductID=function(){return 2==this.sigType?this.data?this.data.readUInt32BE(0):null:null};e.resovle=function(b,f){if(f+18>8*b.legnth)return null;var n=a(b,f+2,8),g=a(b,f+10,8),h=null;if(2==n){if(f+50>8*b.legnth)return null;h=new Buffer(4);h.writeUInt8(a(b,f+18,8),0);h.writeUInt8(a(b,f+26,8),1);h.writeUInt8(a(b,f+34,8),2);h.writeUInt8(a(b,f+42,8),3)}else 1==n&&(h=null);return new e(n,g,h)};new b;var f=function(a,b){this.type=2;this.sigType=a;
this.valueType=b};f.prototype=new b;f.prototype.constructor=f;f.prototype.getBitLength=function(){return 12};f.resovle=function(b,e){if(e+12>8*b.length)return null;var n=a(b,e+2,8);b=a(b,e+10,2);return new f(n,b)};f.prototype.toJSON=function(){return{sigType:this.sigType,valueType:this.valueType}};var g=function(a,b,e){this.type=3;this.sigType=a;this.valueType=b;this.resolution=e};g.prototype=new b;g.prototype.constructor=g;g.prototype.getBitLength=function(){return 16};g.prototype.toJSON=function(){return{sigType:this.sigType,
valueType:this.valueType,resolution:this.resolution}};g.resovle=function(b,e){if(e+16>8*b.length)return null;var f=a(b,e+2,8),n=a(b,e+10,2);b=a(b,e+12,4);return new g(f,n,b)};var h=function(a,b,e){l.call(this,176);this.manufacturerID=a;this.dataDirection=b;this.purpose=e;this.productID=null;this.outboudChannels={};this.inboundChannels={};this.status=this.senderID=null};h.prototype=new l;h.prototype.constructor=h;h.prototype.getManufacturerId=function(){return this.manufacturerID};h.prototype.getProductId=
function(){return this.productID};h.prototype.toJSON=function(){var a={manufacturerID:this.manufacturerID,dataDirection:this.dataDirection,purpose:this.purpose,productID:this.productID,outboudChannels:{},inboundChannels:{}},b;for(b in this.outboudChannels)a.outboudChannels[b]=this.outboudChannels[b].toJSON();for(b in this.inboundChannels)a.inboundChannels[b]=this.inboundChannels[b].toJSON();return a};h.resolve=function(a){var e=a.data;a=e.readUInt16BE(1)>>5&2047;var f=e.readUInt16BE(1)>>4&1,n=e.readUInt16BE(1)>>
2&3;a=new h(a,f,n);f=e.slice(3,e.length-5);n=e.slice(e.length-5,e.length-1);e=e.readUInt8(e.length-1);a.senderID=n.toString("hex");a.status=e;for(var g=n=e=0;;){var H=b.resolve(f,n);if(!H)break;0==e?0==H.getType()?a.productID=H.getProductID():(a.outboudChannels[g]=H,g++,e=1):1==e?0==H.getType()?e=2:(a.outboudChannels[g]=H,g++,e=1):2==e&&(a.inboundChannels[g]=H,g++);n+=H.getBitLength()}return a};return h}(),m=function(){var a=function(a,b,e,f,n){l.call(this,177);this.manufacturerID=a;this.result=b;
this.chnAcknoledgement=e;this.senderID=f;this.status=n};a.prototype=new l;a.prototype.constructor=a;a.prototype.toPacket=function(){var a=new Buffer(3);a.writeUInt8(this.rorg,0);a.writeUInt16BE(this.manufacturerID<<5|this.result<<3,1);if(3==this.result){var b=[];if(this.chnAcknoledgement){for(var e=Math.ceil(this.chnAcknoledgement.length/8),n=0;n<e.length;n++)b.push(0);for(e=0;e<this.chnAcknoledgement.length;e++)n=Math.floor(e/8),b[n]|=chnAcknoledgement[e]<<8-e%8-1}a=Buffer.concat([a,new Buffer(b)])}a=
Buffer.concat([a,new Buffer(this.senderID,"hex")]);a=Buffer.concat([a,new Buffer([this.status])]);b=1;e="FFFFFFFF";n=255;var g=0;this.optData&&(b=this.optData.subTelNum,e=this.optData.dstId,n=this.optData.dBm,g=this.optData.securityLvl);return new f(a,!0,b,e,n,g)};a.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),manufacturerID:this.manufacturerID.toString(16),result:this.result,chnAcknoledgement:this.chnAcknoledgement,senderID:this.senderID,receiverID:this.receiverID}};return a}(),
u=function(){var a=function(a,b,e){l.call(this,178);this.data=a;this.senderID=b;this.status=e};a.prototype=new l;a.prototype.constructor=a;a.prototype.toPacket=function(){var a=new Buffer(1);a.writeUInt8(this.rorg,0);this.data&&(a=Buffer.concat([a,this.data]));a=Buffer.concat([a,new Buffer(this.senderID,"hex")]);a=Buffer.concat([a,new Buffer([this.status])]);var b=1,e="FFFFFFFF",n=255,g=0;this.optData&&(b=this.optData.subTelNum,e=this.optData.dstId,n=this.optData.dBm,g=this.optData.securityLvl);return new f(a,
!0,b,e,n,g)};a.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),data:this.data?this.data.toString("hex"):null,senderID:this.senderID,status:this.status}};a.resolve=function(b){var e=b.data;b=e.slice(1,e.length-5);var f=e.slice(e.length-5,e.length-1);e=e.readUInt8(e.length-1);return new a(b,f.toString("hex"),e)};return a}(),y=function(a,b,e,f,g,h,k,m){l.call(this,64,m);this.seq=a;this.idx=b;this.len=e;this.crorg=f;this.data=g;this.senderID=h;this.status=k};y.prototype=new l;y.prototype.constructor=
...
status:this.status}};y.resolve=function(a){var b=a.data,e=b.readUInt8(1)>>6&3,f=b.readUInt8(1)&63;if(0==f){var n=b.readUInt16BE(2);var g=b.readUInt8(4);var h=b.slice(5,b.length-5)}else g=n=null,h=b.slice(2,b.length-5);var k=b.slice(b.length-5,b.length-1).toString("hex");b=b.readUInt8(b.length-1);var l;a.hasOpt&&(l={subTelNum:a.subTelNum,dstId:a.dstId,dBm:a.dBm,securityLvl:a.securityLvl});return new y(e,f,n,g,h,k,b,l)};var C=function(a,b,e,f){l.call(this,208,f);this.messageIndex=a;this.userData=b;
this.senderID=e};C.prototype=new l;C.prototype.constructor=C;C.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),messageIndex:this.messageIndex,userData:this.userData?this.userData.toString("hex"):null,senderID:this.senderID}};C.prototype.toPacket=function(){var a=new Buffer(2);a.writeUInt8(this.rorg,0);a.writeUInt8(this.messageIndex,1);this.userData&&(a=Buffer.concat([a,this.userData]));a=Buffer.concat([a,new Buffer(this.senderID,"hex")]);var b=1,e="FFFFFFFF",g=255,h=0;this.optData&&
(b=this.optData.subTelNum,e=this.optData.dstId,g=this.optData.dBm,h=this.optData.securityLvl);return new f(a,!0,b,e,g,h)};C.resolve=function(a){var b=a.data,e=b.readUInt8(1),f=null,n=null;switch(e){case 1:f=0;n=b.slice(2,6).toString("hex");break;case 4:case 6:f=b.slice(2,3),n=b.slice(3,7).toString("hex")}var g;a.hasOpt&&(g={subTelNum:a.subTelNum,dstId:a.dstId,dBm:a.dBm,securityLvl:a.securityLvl});return new C(e,f,n,g)};var J=function(a,b,e,f,g,h){l.call(this,246,h);this.userData=a?a:0;this.senderID=
b;this.t21=e?e:0;this.nu=f?f:0;this.rc=g?g:0};J.prototype=new l;J.prototype.constructor=J;J.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),userData:this.userData.toString(16),senderID:this.senderID,t21:this.t21,nu:this.nu,rc:this.rc}};J.prototype.toPacket=function(){var a=new Buffer(2);a.writeUInt8(this.rorg,0);a.writeUInt8(this.userData,1);a=Buffer.concat([a,new Buffer(this.senderID,"hex")]);a=Buffer.concat([a,new Buffer([this.t21<<5|this.nu<<4||this.rc])]);var b=1,e="FFFFFFFF",g=
255,h=0;this.optData&&(b=this.optData.subTelNum,e=this.optData.dstId,g=this.optData.dBm,h=this.optData.securityLvl);return new f(a,!0,b,e,g,h)};J.resolve=function(a){var b=a.data,e=b.readUInt8(1),f=b.slice(2,6).toString("hex"),g=b.readUInt8(6)>>5&1,n=b.readUInt8(6)>>4&1,h;a.hasOpt&&(h={subTelNum:a.subTelNum,dstId:a.dstId,dBm:a.dBm,securityLvl:a.securityLvl});return new J(e,f,g,n,b&15,h)};var K=function(a,b,e,f){l.call(this,213,f);this.userData=a;this.senderID=b;this.rc=e?e:0};K.prototype=new l;K.prototype.constructor=
K;K.prototype.getLearnBit=function(){return this.userData>>3&1};K.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),userData:this.userData.toString(16),learn:this.getLearnBit(),senderID:this.senderID,rc:this.rc}};K.resolve=function(a){var b=a.data,e=b.readUInt8(1),f=b.slice(2,6).toString("hex");b=b.readUInt8(6)&15;var g;a.hasOpt&&(g={subTelNum:a.subTelNum,dstId:a.dstId,dBm:a.dBm,securityLvl:a.securityLvl});return new K(e,f,b,g)};var z=function(a,b,e,f){l.call(this,165,f);this.userData=
a;this.senderID=b;this.rc=e?e:0};z.prototype=new l;z.prototype.constructor=z;z.prototype.getLearnType=function(){return this.userData.readUInt8(3)>>7&1};z.prototype.getLearnBit=function(){return this.userData.readUInt8(3)>>3&1};z.prototype.getLearnStatus=function(){return this.userData.readUInt8(3)>>4&1};z.prototype.getLearnResult=function(){return this.userData.readUInt8(3)>>5&1};z.prototype.getEEPResult=function(){return this.userData.readUInt8(3)>>6&1};z.prototype.getFunc=function(){return this.userData.readUInt8(0)>>
2&63};z.prototype.getType=function(){var a=this.userData.readUInt8(0)&3,b=this.userData.readUInt8(1)>>3&31;return a<<5|b};z.prototype.getManufacturerId=function(){var a=this.userData.readUInt8(1)&7,b=this.userData.readUInt8(2);return a<<8|b};z.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),userData:this.userData.toString("hex"),learnType:this.getLearnType(),learn:this.getLearnBit(),learnStatus:this.getLearnStatus(),learnResult:this.getLearnResult(),eepResult:this.getEEPResult(),func:this.getFunc(),
type:this.getType(),manufacturerId:this.getManufacturerId(),senderID:this.senderID,rc:this.rc}};z.prototype.toPacket=function(){var a=new Buffer(1);a.writeUInt8(this.rorg,0);a=Buffer.concat([a,this.userData]);a=Buffer.concat([a,new Buffer(this.senderID,"hex")]);a=Buffer.concat([a,new Buffer([this.rc&15])]);return this.optData?new f(a,!0,this.optData.subTelNum,this.optData.dstId,this.optData.dBm,this.optData.securityLvl):new f(a,!1)};z.resolve=function(a){var b=a.data,e=b.slice(1,5),f=b.slice(5,9).toString("hex");
b=b.readUInt8(9)&15;var g;a.hasOpt&&(g={subTelNum:a.subTelNum,dstId:a.dstId,dBm:a.dBm,securityLvl:a.securityLvl});return new z(e,f,b,g)};var w=function(a,b,e,f){l.call(this,210,f);this.userData=a;this.senderID=b;this.status=e};w.prototype=new l;w.prototype.constructor=w;w.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),userData:this.userData.toString("hex"),senderID:this.senderID,status:this.status,optData:this.optData}};w.prototype.toPacket=function(){var a=new Buffer(1);a.writeUInt8(this.rorg,
0);a=Buffer.concat([a,this.userData]);a=Buffer.concat([a,new Buffer(this.senderID,"hex")]);a=Buffer.concat([a,new Buffer([this.status])]);return this.optData?new f(a,!0,this.optData.subTelNum,this.optData.dstId,this.optData.dBm,this.optData.securityLvl):new f(a,!1)};w.resolve=function(a){var b=a.data,e=b.slice(1,b.length-5),f=b.slice(b.length-5,b.length-1).toString("hex");b=b.readUInt8(b.length-1);var g;a.hasOpt&&(g={subTelNum:a.subTelNum,dstId:a.dstId,dBm:a.dBm,securityLvl:a.securityLvl});return new w(e,
f,b,g)};var Q=function(a,b,e,f,g){l.call(this,166);this.rorg_en=a;this.data=b;this.dstID=e;this.senderID=f;this.status=g};Q.prototype=new l;Q.prototype.constructor=Q;Q.prototype.toPacket=function(){var a=new Buffer(2);a.writeUInt8(this.rorg,0);a.writeUInt8(this.rorg_en,1);a=Buffer.concat([a,this.data]);a=Buffer.concat([a,new Buffer(this.dstID,"hex")]);a=Buffer.concat([a,new Buffer(this.senderID,"hex")]);a=Buffer.concat([a,new Buffer([this.status])]);return new f(a,!1)};var V=function(a,b,e,f,g,h,
k,m,r,p,t){l.call(this,212);this.cmd=a;this.ute=b;this.rspExpected=e;this.subtype=f;this.numChannel=g;this.manufactureID=h;this.eepType=k;this.eepFunc=m;this.eepRorg=r;this.senderID=p;this.status=t};V.prototype=new l;V.prototype.constructor=V;V.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),ute:this.ute,rspExpected:this.rspExpected,subtype:this.subtype,cmd:this.cmd,numChannel:this.numChannel,manufactureID:this.manufactureID,eepType:this.eepType.toString(16),eepFunc:this.eepFunc.toString(16),
...
new f(a,!0,this.optData.subTelNum,this.optData.dstId,this.optData.dBm,this.optData.securityLvl):new f(a,!1)};V.resolve=function(a){var b=a.data.slice(1,8),e=a.data.slice(8,12).toString("hex"),f=a.data.readUInt8(12),g=b.readUInt8(0)>>7&1,h=b.readUInt8(0)&15,n=b.readUInt8(1),k=b.slice(2,4).toString("hex"),l=b.readUInt8(4),m=b.readUInt8(5),r=b.readUInt8(6),p=b.readUInt8(0)>>6&1;b=b.readUInt8(0)>>4&3;e=new V(h,g,p,b,n,k,l,m,r,e,f);a.hasOpt&&(e.optData={subTelNum:a.subTelNum,dstId:a.dstId,dBm:a.dBm,securityLvl:a.securityLvl});
return e};var Y=function(a,b,e,f){l.call(this,53,f);this.userData=a;this.senderID=b;this.status=e};Y.prototype=new l;Y.prototype.constructor=Y;Y.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),userData:this.userData.toString("hex"),senderID:this.senderID,status:this.status,optData:this.optData}};Y.resolve=function(a){var b=a.data,e=b.slice(1,b.length-5),f=b.slice(b.length-5,b.length-1).toString("hex");b=b.readUInt8(b.length-1);var g;a.hasOpt&&(g={subTelNum:a.subTelNum,dstId:a.dstId,
dBm:a.dBm,securityLvl:a.securityLvl});return new Y(e,f,b,g)};var P=function(a,b,e,f){l.call(this,49,f);this.userData=a;this.senderID=b;this.status=e};P.prototype=new l;P.prototype.constructor=P;P.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),userData:this.userData.toString("hex"),senderID:this.senderID,status:this.status,optData:this.optData}};P.prototype.convertToPacket=function(a){a=Buffer.concat([a,new Buffer(this.senderID,"hex"),new Buffer([this.status])]);return this.optData?
new f(a,!0,this.optData.subTelNum,this.optData.dstId,this.optData.dBm,this.optData.securityLvl):new f(a,!1)};P.resolve=function(a){var b=a.data,e=b.slice(1,b.length-5),f=b.slice(b.length-5,b.length-1).toString("hex");b=b.readUInt8(b.length-1);var g;a.hasOpt&&(g={subTelNum:a.subTelNum,dstId:a.dstId,dBm:a.dBm,securityLvl:a.securityLvl});return new P(e,f,b,g)};l.SIG=C;l.RPS=J;l.BS1=K;l.BS4=z;l.VLD=w;l.ADT=Q;l.UTE=V;l.TS=Y;l.SM=P;l.GP_TI=r;l.GP_TR=m;l.GP_CD=u;var t=function(a,b){this._code=a;this._rspData=
b};t.CODE={0:"RET_OK",1:"RET_ERROR",2:"RET_NOT_SUPPORTED",3:"RET_WRONG_PARAM",4:"RET_OPERATION_DENIED",5:"RET_LOCK_SET",6:"RET_BUFFER_TO_SMALL",7:"RET_NO_FREE_BUFFER"};t.prototype.toJSON=function(){return{code:this._code,rspData:this._rspData?this._rspData.toString("hex"):null}};t.prototype.toPacket=function(){return new a(this._code,this._rspData)};t.resolve=function(a){return new t(a.retCode,a.resData)};m=function(a,b){t.call(this,0);this._responseTime=a;this._confirmCode=b};m.prototype.toPacket=
function(){var b=new Buffer(3);b.writeUInt16BE(this._responseTime,0);b.writeUInt8(this._confirmCode,2);return new a(this._code,b)};m.prototype.toJSON=function(){return{code:this._code,responseTime:this._responseTime,confirmCode:this._confirmCode}};t.Response_OK_SA_CONFIRM_LEARN=m;var p=function(a){this._code=a};p.resolve=function(a){if(!a.data)return null;switch(a.data.readUInt8(0)){case 1:return Z.resolve(a);case 2:return L.resolve(a);default:return null}};var Z=function(){this._code=1};Z.prototype=
new p;Z.prototype.constructor=Z;Z.prototype.toJSON=function(){return{code:this._code}};Z.prototype.toPacket=function(){var a=new Buffer(1);a.writeUInt8(this._code,0);return new h(a)};Z.resolve=function(a){return new Z};var L=function(a,b,e,f,g,h,k){this._code=2;this._priority=a;this._manufacturerId=b;this._eep=e;this._rssi=f;this._pm_candidateId=g;this._sa_clientId=h;this._hop_count=k};L.prototype=new p;L.prototype.constructor=L;L.prototype.getEEP=function(){return this._eep?this._eep.substr(0,2)+
"-"+this._eep.substr(2,2)+"-"+this._eep.substr(4,2):null};L.prototype.getPMCandidateId=function(){return this._pm_candidateId};L.prototype.getSAClientId=function(){return this._sa_clientId};L.prototype.getHopCount=function(){return this._hop_count};L.prototype.toJSON=function(){return{code:this._code,priority:this._priority,manufacturerId:this._manufacturerId,eep:this.getEEP(),rssi:this._rssi,pm_candidateId:this._pm_candidateId,sa_clientId:this._sa_clientId,hop_count:this._hop_count}};L.prototype.toPacket=
function(){var a=new Buffer(4);a.writeUInt8(this._code,0);a.writeUInt8(this._priority,1);a.writeUInt16BE(this._manufacturerId&1023,2);a=Buffer.concat([a,new Buffer(this._eep,"hex")]);a=Buffer.concat([a,new Buffer([this._rssi])]);a=Buffer.concat([a,new Buffer(this._pm_candidateId,"hex")]);a=Buffer.concat([a,new Buffer(this._sa_clientId,"hex")]);a=Buffer.concat([a,new Buffer([this._hop_count])]);return new h(a)};L.resolve=function(a){var b=a.data;a=b.readUInt8(1);var e=b.readUInt16BE(2)&1023,f=b.slice(4,
7).toString("hex"),g=b.readUInt8(7),h=b.slice(8,12).toString("hex"),k=b.slice(12,16).toString("hex");b=b.readUInt8(16);return new L(a,e,f,g,h,k,b)};p.SA_RECLAIM_NOT_SUCCESSFUL=Z;p.SA_CONFIRM_LEARN=L;var pa=function(a){this._code=a};pa.resolve=function(a){if(!a.data)return null;switch(a.data.readUInt8(0)){case 9:return CO_WR_REPEATER.resolve(a);default:return null}};CO_WR_REPEATER=function(a,b){this._code=9;this._enable=a;this._level=b};CO_WR_REPEATER.prototype=new pa;CO_WR_REPEATER.prototype.constructor=
CO_WR_REPEATER;CO_WR_REPEATER.prototype.toJSON=function(){return{code:this._code,enable:this._enable,level:this._level}};CO_WR_REPEATER.prototype.toPacket=function(){var a=new Buffer(3);a.writeUInt8(this._code,0);a.writeUInt8(this._enable,1);a.writeUInt8(this._level,2);return new k(a)};CO_WR_REPEATER.resolve=function(a){a=a.data.readUInt8(1);var b=CO_WR_REPEATER.readUInt8(2);return new CO_WR_REPEATER(a,b)};pa.CO_WR_REPEATER=CO_WR_REPEATER;var O=function(a){this._code=a};O.resolve=function(a){if(!a.data)return null;
switch(a.data.readUInt8(0)){case 1:return R.resolve(a);case 6:return aa.resolve(a);case 8:return ba.resolve(a);default:return null}};var R=function(a,b,e){this._code=1;this._enable=a;this._extended=b;this._timeout=e};R.prototype=new O;R.prototype.constructor=R;R.prototype.toJSON=function(){return{code:this._code,enable:this._enable,extended:this._extended,timeout:this._timeout}};R.prototype.toPacket=function(){var a=new Buffer(7);a.writeUInt8(this._code,0);a.writeUInt8(this._enable,1);a.writeUInt8(this._extended,
2);a.writeUInt32BE(this._timeout,3);return new e(a)};R.resolve=function(a){var b=a.data;a=b.readUInt8(1);var e=b.readUInt8(2);b=b.readUInt32BE(3);return new R(a,e,b)};var da=function(a){this._code=5;this._saClientId=a};da.prototype=new O;da.prototype.constructor=da;da.prototype.toJSON=function(){return{code:this._code,clientId:this._saClientId}};da.prototype.toPacket=function(){var a=new Buffer(1);a.writeUInt8(this._code,0);a=Buffer.concat([a,new Buffer(this._saClientId,"hex")]);return new e(a)};
da.resolve=function(a){a=a.data.slice(1,5).toString("hex");return new da(a)};var aa=function(){this._code=6};aa.prototype=new O;aa.prototype.constructor=aa;aa.prototype.toJSON=function(){return{code:this._code}};aa.prototype.toPacket=function(){var a=new Buffer(1);a.writeUInt8(this._code,0);return new e(a)};aa.resolve=function(a){return new aa};var ba=function(a){this._code=8;this._mailBoxCount=a};ba.prototype=new O;ba.prototype.constructor=ba;ba.prototype.toJSON=function(){return{code:this._code,
mailBoxCount:this._mailBoxCount}};ba.prototype.toPacket=function(){var a=new Buffer(2);a.writeUInt8(this._code,0);a.writeUInt8(this._mailBoxCount,1);return new e(a)};ba.resolve=function(a){a=a.data.readUInt8(1);return new ba(a)};O.SA_WR_LEARNMODE=R;O.SA_WR_RESET=da;O.SA_RD_LEARNEDCLIENTS=aa;O.SA_WR_POSTMASTER=ba;var Qa=function(){var a=function(a){this._esp3=a;this._buffer={}};a.prototype.receiveChainedTelegram=function(a){var b=a.getSenderID(),e=a.getSeq(),f=a.getIdx();this._buffer[b]||(this._buffer[b]=
{});var g=this._buffer[b];g[e]||(g[e]=[]);g=g[e];for(var h=0;h<=f;h++)h!=f?g.length<f&&(g[h]=null):g[h]=a;this._checkChain(b,e)};a.prototype._checkChain=function(a,b){var e=this._buffer[a][b];if(e[0]){var g=e[0],h=g.getLen(),k=g.getCRORG();g=0;var l=new Buffer(1);l.writeUInt8(k);for(k=0;k<e.length;k++){var n=e[k];if(!n)return;n=n.getData();g+=n.length;l=Buffer.concat([l,n])}g>=h&&(delete this._buffer[a][b],l=Buffer.concat([l,new Buffer(a,"hex")]),l=Buffer.concat([l,new Buffer("00","hex")]),a=new f(l,
!1),this._esp3._onEORadio_ERP1(a))}};return a}(),v=function(a){this._logger=require("x.logger.js").getLogger("x.hub.m.enocean.ESP3");this._controller=a;this._listeners=[];a&&this._listeners.push(a);this._recomm=new x.hub.m.enocean.ReComm(this);this._baseID=this._serial=null;this._rdata=new Buffer([]);this._frameBuffer=[];this._learnHandler=null;this._learning=!1;this._learnTO=null;this._cdmHandler=new Qa(this)};v.RESPONSE_TO=1500;v.prototype.attachSerial=function(a,b){var e=this;this._serial=new x.hub.m.enocean.Serial(a);
this._serial.setListener(this);this._serial.open(function(a){a?(e._serial.setListener(null),e._serial=null,b&&b(a)):e.readBaseID(function(a,f){a?(e._serial.setListener(null),e._serial.close(),e._serial=null,b&&b(a)):(x.hub.m.enocean.SENDER_ID||(x.hub.m.enocean.SENDER_ID=f,localStorage&&localStorage.setItem("x.hub.m.enocean.SENDER_ID",f)),e._baseID=f,b&&b())})})};v.prototype.removeSerial=function(a,b){this._serial.setListener(null);this._serial.close();this._baseID=this._serial=null;b&&b()};v.prototype.getSerial=
function(){return this._serial};v.prototype.addListener=function(a){a&&-1==this._listeners.indexOf(a)&&this._listeners.push(a)};v.prototype.removeListener=function(a){a&&(a=this._listeners.indexOf(a),-1!=a&&this._listeners.splice(a,1))};v.prototype.readBaseID=function(a){var b=this,e=new g(5,new Buffer("08","hex"));this.sendFrame(e,!0,function(e,f){e?(b._logger.log("warn","read base id error:"+e.stack),a&&a(e)):f&&f.retCode?(e=Error("read BaseID error"),e.code=f.retCode,b._logger.log("warn","read base id error return code:"+
f.retCode),a&&a(e)):(e=f.resData.toString("hex"),a&&a(null,e.toLowerCase()))},8E3)};v.prototype.startLearn=function(a,b,e,f){if(this._serial){if(!b||0>=b)b=3E4;if(this._learning)f&&f(Error("learning another type right now"));else{this._learnHandler=a;this._learning=!0;var g=this;this._learnTO=setTimeout(function(){g._learning=!1;g._learnTO=null;var a=g._learnHandler;g._learnHandler=null;if(a&&a.onLearnTimeout)a.onLearnTimeout()},b);e?(a=new R(1,e.extended?e.extended:0,0),this.sendSACommand(a,!0,function(a){f&&
f(a)})):f&&f()}}else f&&f(Error("port not opened"))};v.prototype.stopLearn=function(a,b,e){this._learnTO&&clearTimeout(this._learnTO);this._learning=!1;this._learnTO=this._learnHandler=null;if(b){e&&e();var f=this;setTimeout(function(){var a=new R(0,b.extended?b.extended:0,0);f.sendSACommand(a,!0,function(a){e&&e(a)})},2E3)}else e&&e()};v.prototype.sendTelegram=function(a,b,e){this.sendPacket(a.toPacket(),b,e)};v.prototype.sendResponse=function(a,b){this._logger.log("trace","send RESPONSE:"+JSON.stringify(a.toJSON()));
this.sendPacket(a.toPacket(),!1,b)};v.prototype.sendSACommand=function(a,b,e){this._logger.log("trace","send SA_COMMAND:"+JSON.stringify(a.toJSON()));this.sendPacket(a.toPacket(),b,e)};v.prototype.sendCommandCommand=function(a,b,e){this._logger.log("trace","send COMMAND_COMMAND:"+JSON.stringify(a.toJSON()));this.sendPacket(a.toPacket(),b,e)};v.prototype.sendPacket=function(a,b,e){this.sendFrame(a.toFrame(),b,e)};v.prototype.sendFrame=function(a,b,e,f){var g=this._frameBuffer.length;this._frameBuffer.push({frame:a,
callback:e,timeout:null,response:b,to:f});0==g&&this._sendNextFrame()};v.prototype._sendNextFrame=function(){if(0!=this._frameBuffer.length){var a=this._frameBuffer[0],b=a.frame,e=a.callback,f=a.response;if(this._serial){var g=this;b=b.toBuffer();this._logger.log("trace","send raw frame:"+b.toString("hex"));this._serial.sendPacket(b,function(b){if(b||!f){try{e&&e(b)}catch(Ga){}g._frameBuffer.splice(0,1);g._sendNextFrame()}else b=a.to,b||(b=v.RESPONSE_TO),a.timeout=setTimeout(function(){var a=g._frameBuffer[0];
if(a){a=a.callback;var b=Error("enocean response timeout");b.code=100;try{a&&a(b)}catch(db){}}g._frameBuffer.splice(0,1);g._sendNextFrame()},b)})}else e&&e(Error("port not opened")),this._frameBuffer.splice(0,1),this._sendNextFrame()}};v.prototype.onSerialData=function(a){a=this._rdata=Buffer.concat([this._rdata,a]);for(var b=0;b<a.length;)if(85!=a[b])b++;else{if(b+6>=a.length)break;var e=(a[b+1]<<8)+a[b+2],f=a[b+3],h=a[b+5];if(a.length<b+e+f+7)break;if(x.hub.m.enocean.CRC8(a.slice(b+1,b+5))!=h)b++;
else if(h=a[b+e+f+6],x.hub.m.enocean.CRC8(a.slice(b+6,b+6+e+f))!=h)b++;else{h={type:a[b+4],dataLen:e,optLen:f,radioType:a[b+6],data:a.slice(b+6,b+6+e),optData:a.slice(b+6+e,b+6+e+f),rawByte:a.slice(0,b+6+e+f+1).toString("hex")};var k=new g(h.type,h.data,h.optData);if(166==h.radioType||210==h.radioType||165==h.radioType||246==h.radioType||213==h.radioType)h.senderId=h.data.slice(e-5,e-1).toString("hex");try{this._onEOFrame(k,h)}catch(Ga){this._logger.log("warn","process frame exception:"+Ga.stack)}b=
b+6+e+f+1}}0!=b&&0<a.length&&b<=a.length&&(a=a.slice(b));this._rdata=a};v.prototype.onSerialError=function(a){this._serial.setListener(null);this._serial=null};v.prototype._onEOFrame=function(a,b){this._logger.log("trace","receive raw frame:"+b.rawByte);this._logger.log("debug","receive enocean frame:"+JSON.stringify(a.toJSON()));this._listeners.forEach(function(e){e._onEOFrame&&e._onEOFrame(a,b.rawByte)});var e=a.toPacket();e&&this._onEOPacket(e)};v.prototype._onEOPacket=function(b){this._logger.log("debug",
"receive enocean packet:"+JSON.stringify(b.toJSON()));this._listeners.forEach(function(a){a._onEOPacket&&a._onEOPacket(b)});b instanceof f?this._onEORadio_ERP1(b):b instanceof a?this._onEOResponse_Packet(b):b instanceof h&&this._onEOEvent_Packet(b)};v.prototype._onEORadio_ERP1=function(a){(a=a.toRadioTelegram())&&this._onEO_ERP1_Telegram(a)};v.prototype._onEOResponse_Packet=function(a){try{var b=a.toResponse();this._onEO_Response(b)}catch(Pa){}if(0!=this._frameBuffer.length){var e=this._frameBuffer[0];
b=e.callback;(e=e.timeout)&&clearTimeout(e);try{b&&b(null,a)}catch(Pa){}this._frameBuffer.splice(0,1);this._sendNextFrame()}};v.prototype._onEOEvent_Packet=function(a){(a=a.toEvent())&&this._onEO_Event(a)};v.prototype._onEO_ERP1_Telegram=function(a){this._logger.log("debug","receive enocean telegram:"+JSON.stringify(a.toJSON()));if(64==a.rorg)this._cdmHandler.receiveChainedTelegram(a);else if(this._listeners.forEach(function(b){b._onEOTelegram&&b._onEOTelegram(a)}),49==a.rorg&&(a=this._controller._secHandler.resolve(a))&&
...
v.ESP3_Frame=g;v.Telegram=l;v.RADIO_ERP1_Packet=f;v.Event=p;v.Response=t;v.COMMAND_COMMAND=pa;v.SA_COMMAND=O;return v}();
...
time:-1}};var d=this;this._params=c?c.params:null;this._params||(this._params={alive:900,sync:0,eep:1,type:0,alarm:0,alarm_sens:0});this._aliveTO=setTimeout(function(){d._aliveTimeout()},2E3*this._params.alive)};b.TEMPALTE={id:null,eep:null,desc:"Window",manufacturer:"SIEGENIA-AUBI KG",vendor:"siegenia",params:{alive:900,sync:0,eep:1,type:0,alarm:0,alarm_sens:0}};b.prototype=new g;b.prototype.constructor=b;b.prototype.evalTelegram=function(c){var d={};if(210==c.rorg)if(c=c.userData,1==c[0]&&8==c.length){var a=
c[1]&239,b=(c[2]<<24)+(c[3]<<16)+(c[4]<<8)+c[5],e=c[6]>>7;d={type:1,TBT:!1,batteryOK:!0,battery:c[6]&127,motionSensor:c[7]>>6,accelerationSensor:(c[7]&48)>>4,magneticSensor:(c[7]&12)>>2,error:c[7]&3,count:b};e&&(d.batteryOK=!1);100<d.battery&&(d.battery=100);d.code=a;switch(a){case 0:d.state="?";d.handle="?";d.counter00=b;break;case 1:d.state="closed";d.handle="closed";d.counter01=b;break;case 2:d.state="closed";d.handle="open";d.counter02=b;break;case 3:d.state="closed";d.handle="tilted";d.counter03=
b;break;case 4:d.state="open";d.handle="closed";d.counter04=b;break;case 5:d.state="open";d.handle="open";d.TBT=!0;d.counter05=b;break;case 6:d.state="open";d.handle="tilted";d.TBT=!0;d.counter06=b;break;case 7:d.state="tilted";d.handle="closed";d.TBT=!0;d.counter07=b;break;case 8:d.state="tilted";d.handle="open";d.TBT=!0;d.counter08=b;break;case 9:d.state="tilted";d.handle="tilted";d.counter09=b;break;case 10:d.state="?",d.handle="?",d.counter0A=b}}else if(2==c[0]&&2==c.length)switch(d.type=2,c[1]&
15){case 1:d.burglary=!0;break;default:d.burglary=!1}else if(c[0]=2==c.length){d.type=17;switch((c[1]&192)>>6){case 0:d.calibrationState="ok";break;case 1:d.calibrationState="error";break;case 2:d.calibrationState="invalid";break;case 3:d.calibrationState="not_supported"}c=c[1]&63;d.calibrationStep=c;switch(c){case 0:d.calibrationCasement="none";d.calibrationHandle="none";break;case 1:d.calibrationCasement="closed";d.calibrationHandle="closed";break;case 2:d.calibrationCasement="closed";d.calibrationHandle=
...
b.prototype.evalData=function(c,d,a){var b=this;b._states.aliveTimeout.value=!1;clearTimeout(this._aliveTO);this._aliveTO=setTimeout(function(){b._aliveTimeout()},2E3*this._params.alive);(c=this.evalTelegram(d))?(d=[],c.aliveMsg||(d=this.checkStateChange(c)),a&&a(null,d)):a&&a(Error("data format invalid"))};b.prototype.checkStateChange=function(c){var d=this._states,a=[],b;for(b in c)if("aliveMsg"!=b){var e={};e.key=b;e.value=c[b];e.changed=!1;var f=d[b]?d[b].value:null;f!=c[b]&&(e.oldvalue=f,e.changed=
!0);"burglary"!=b&&"calibrationState"!=b&&"calibrationCasement"!=b&&"calibrationHandle"!=b&&(this._states[b]={value:c[b],time:(new Date).getTime()});a.push(e)}return a};b.prototype._resolveStates=function(c,d){d={};if(210==c[0])if(c=c.slice(1,c.length-5),1==c[0]&&8==c.length){var a=c[1]&239,b=(c[2]<<24)+(c[3]<<16)+(c[4]<<8)+c[5],e=c[6]>>7;d={aliveMsg:1==(c[1]&128)>>7,TBT:!1,batteryOK:!0,battery:c[6]&127,motionSensor:c[7]>>6,accelerationSensor:(c[7]&48)>>4,magneticSensor:(c[7]&12)>>2,error:c[7]&3,
count:b};e&&(d.batteryOK=!1);100<d.battery&&(d.battery=100);switch(a){case 0:d.state="closed";d.handle="closed";d.counter00=b;break;case 1:d.state="closed";d.handle="open";d.counter01=b;break;case 2:d.state="open";d.handle="open";d.counter02=b;break;case 3:d.state="closed";d.handle="tilted";d.counter03=b;break;case 4:d.state="tilted";d.handle="tilted";d.counter04=b;break;case 5:d.state="closed";d.handle="tilted";d.TBT=!0;d.counter05=b;break;case 6:d.state="tilted";d.handle="tilted";d.TBT=!0;d.counter06=
b;break;case 7:d.state="closed";d.handle="open";d.TBT=!0;d.counter07=b;break;case 8:d.state="open";d.handle="open";d.TBT=!0;d.counter08=b;break;case 9:d.state="open";d.handle="closed";d.counter09=b;break;case 10:d.state="open",d.handle="tilted",d.counter0A=b}}else if(2==c[0]&&2==c.length)switch(c[1]&15){case 1:d.burglary=!0;break;default:d.burglary=!1}else if(c[0]=2==c.length){switch((c[1]&192)>>6){case 0:d.calibrationState="ok";break;case 1:d.calibrationState="error";break;case 2:d.calibrationState=
"invalid";break;case 3:d.calibrationState="not_supported"}switch(c[1]&63){case 0:d.calibrationCasement="none";d.calibrationHandle="none";break;case 1:d.calibrationCasement="closed";d.calibrationHandle="closed";break;case 2:d.calibrationCasement="closed";d.calibrationHandle="open";break;case 3:d.calibrationCasement="closed";d.calibrationHandle="tilted";break;case 4:d.calibrationCasement="open";d.calibrationHandle="closed";break;case 5:d.calibrationCasement="open";d.calibrationHandle="open";break;case 6:d.calibrationCasement=
"open";d.calibrationHandle="tilted";break;case 7:d.calibrationCasement="tilted";d.calibrationHandle="closed";break;case 8:d.calibrationCasement="tilted";d.calibrationHandle="open";break;case 9:d.calibrationCasement="tilted",d.calibrationHandle="tilted"}}return d};b.prototype._aliveTimeout=function(){this.activeStateChange({aliveTimeout:!0})};b.prototype.fromJSON=function(c){if(!g.prototype.fromJSON.call(this,c))return null;this._params||(this._params={alive:900,sync:0,eep:1,type:0,alarm:0,alarm_sens:0});
return this};b.prototype.fromDBJSON=function(c){if(!g.prototype.fromDBJSON.call(this,c))return null;this._params||(this._params={alive:900,sync:0,eep:1,type:0,alarm:0,alarm_sens:0});return this};var a=function(c){g.call(this,c);this._logger=require("x.logger.js").getLogger("x.hub.m.enocean.profiles.MacoWindow");this._data="d5-xx-xx";this._desc="Window";this._vendor="maco"};a.TEMPALTE={id:null,eep:null,desc:"Window",manufacturer:"Mayer & Co Beschl\u00e4ge GmbH"};a.prototype=new g;a.prototype.constructor=
a;a.prototype.evalData=function(c,d,a){(c=this._resolveStates(c,d))?(c=this.checkStateChange(c),a&&a(null,c)):a&&a(Error("data format invalid"))};a.prototype._resolveStates=function(c,d){d={};if(213==c[0]){c=c.slice(1,c.length-5);var a=(c[0]&8)>>3,b=(c[0]&6)>>1,e=c[0]&1;switch((c[0]&48)>>4){case 0:d.state="unused";break;case 1:d.state="tilted";break;case 2:d.state="open";break;case 3:d.state="closed"}d.learn=a;d.battery=b;d.alarm=e}return d};a.prototype.toDBJSON=function(){return{id:this._address,
eep:this._data,desc:this._desc,manufacturer:"Mayer & Co Beschl\u00e4ge GmbH",vendor:this._vendor}};var f=function(c){g.call(this,c);this._logger=require("x.logger.js").getLogger("x.hub.m.enocean.profiles.SodaHandle");this._data="f6-so-da"};f.TEMPALTE={id:null,eep:null};f.prototype=new g;f.prototype.constructor=f;f.prototype.evalTelegram=function(c){var d={};if(246==c.rorg)switch(c.userData){case 240:d.state="tilted";break;case 192:d.state="open";break;case 208:d.state="closed"}return d};f.prototype.evalData=
function(c,d,a){(c=this.evalTelegram(d))?(c=this.checkStateChange(c),a&&a(null,c)):a&&a(Error("data format invalid"))};f.prototype.toJSON=function(c,d){return{address:this._address,data:this._data,vendor:"soda"}};f.prototype.toDBJSON=function(){return{id:this._address,eep:this._data,desc:"Window_Handle",manufacturer:"SODA",vendor:"soda"}};var e=function(c){g.call(this,c);this._data="f6-??-??"};e.prototype=new g;e.prototype.constructor=e;var k=function(c){e.call(this,c);this._data="f6-01-01";this._longPressThreshold=
1E3};k.STATES=["button"];k.COMMANDS=["shortPress","longPress","press","release"];k.prototype=new e;k.prototype.constructor=h;k.prototype.evalTelegram=function(c){var d={};246==c.rorg&&(d.button=c.userData>>4&1?"pressed":"released");return d};k.prototype.buildData=function(c){return c<<4};k.prototype.checkStateChange=function(c){var d=this._states,a=[],b=(new Date).getTime(),e;for(e in c){var f={};f.key=e;f.value=c[e];f.changed=!1;var g=d[e]?d[e].value:null,h=d[e]?d[e].time:null,k=c[e];g!=k&&(f.oldvalue=
g,f.changed=!0);this._states[e]={value:c[e],time:b};f.changed&&a.push(f);"pressed"==g&&"released"==k&&(!h||b-h<this._longPressThreshold?(f={},f.key=e,f.value="shortPress"):(f={},f.key=e,f.value="longPress"),f.changed=!0,a.push(f))}return a};k.prototype.executeCommand=function(c,d,a){if(this._senderID)if(d&&d.value){var b=this,e=100;switch(d.value){case "longPress":e=this._longPressThreshold;case "shortPress":var q=this.buildData(1);var f=new x.hub.m.enocean.ESP3.Telegram.RPS(q,this._senderID,1,1,
0,null);c.sendTelegram(f,!0,function(d){d?a&&a(d):(b.activeStateChange({button:"pressed"}),setTimeout(function(){q=b.buildData(0);f=new x.hub.m.enocean.ESP3.Telegram.RPS(q,b._senderID,1,1,0,null);c.sendTelegram(f,!0,function(c){b.activeStateChange({button:"released"});a&&a(c)})},e))});break;case "press":q=this.buildData(1);f=new x.hub.m.enocean.ESP3.Telegram.RPS(q,this._senderID,1,1,0,null);c.sendTelegram(f,!0,function(c){b.activeStateChange({button:"pressed"});a&&a(c)});break;case "release":q=this.buildData(0),
f=new x.hub.m.enocean.ESP3.Telegram.RPS(q,this._senderID,1,1,0,null),c.sendTelegram(f,!0,function(c){b.activeStateChange({button:"released"});a&&a(c)})}}else a&&a(Error("command invalid"));else a&&a(Error("sender id is null"))};var h=function(c){e.call(this,c);this._data="f6-02-01";this._longPressThreshold=1E3};h.STATES=["buttonAI","buttonAO","buttonBI","buttonBO"];h.COMMANDS="shortPressAI longPressAI pressAI releaseAI shortPressAO longPressAO pressAO releaseAO shortPressBI longPressBI pressBI releaseBI shortPressBO longPressBO pressBO releaseBO".split(" ");
h.prototype=new e;h.prototype.constructor=h;h.prototype.evalTelegram=function(c){var d={};if(246==c.rorg){var a=c.userData>>5&7,b=c.userData>>1&7,e=c.userData&1,f=c.t21,g=c.nu;c=c.userData>>4&1?"pressed":"released";if(1==f&&1==g){switch(a){case 0:var h=c;break;case 1:var k=c;break;case 2:var l=c;break;case 3:var m=c}if(e)switch(b){case 0:h=c;break;case 1:k=c;break;case 2:l=c;break;case 3:m=c}}else if(1==f&&0==g)switch(a){case 0:m=l=k=h=c}h&&(d.buttonAI=h);k&&(d.buttonAO=k);l&&(d.buttonBI=l);m&&(d.buttonBO=
m)}return d};h.prototype.buildData=function(c,d,a,b){return c<<5|d<<4|a<<1|b};h.prototype.checkStateChange=function(c){var d=this._states,a=[],b=(new Date).getTime(),e;for(e in c){var f={};f.key=e;f.value=c[e];f.changed=!1;var g=d[e]?d[e].value:null,h=d[e]?d[e].time:null,k=c[e];g!=k&&(f.oldvalue=g,f.changed=!0);this._states[e]={value:c[e],time:b};f.changed&&("pressed"==k||"released"==k&&"pressed"==g)&&a.push(f);"pressed"==g&&"released"==k&&(!h||b-h<this._longPressThreshold?(f={},f.key=e,f.value="shortPress"):
(f={},f.key=e,f.value="longPress"),f.changed=!0,a.push(f))}return a};h.prototype.executeCommand=function(c,d,a){if(this._senderID)if(d&&d.value){var b=this,e=100,q=d.value.substr(d.value.length-2),f={},g=0;switch(q){case "AI":g=0;break;case "AO":g=1;break;case "BI":g=2;break;case "BO":g=3}switch(d.value){case "longPressAI":case "longPressAO":case "longPressBI":case "longPressBO":e=this._longPressThreshold;case "shortPressAI":case "shortPressAO":case "shortPressBI":case "shortPressBO":var h=this.buildData(g,
1,0,0);var k=new x.hub.m.enocean.ESP3.Telegram.RPS(h,this._senderID,1,1,0,null);c.sendTelegram(k,!0,function(d){d?a&&a(d):(f["button"+q]="pressed",b.activeStateChange(f),setTimeout(function(){h=b.buildData(0,0,0,0);k=new x.hub.m.enocean.ESP3.Telegram.RPS(h,b._senderID,1,1,0,null);c.sendTelegram(k,!0,function(c){f["button"+q]="released";b.activeStateChange(f);a&&a(c)})},e))});break;case "pressAI":case "pressAO":case "pressBI":case "pressBO":h=this.buildData(g,1,0,0);k=new x.hub.m.enocean.ESP3.Telegram.RPS(h,
this._senderID,1,1,0,null);c.sendTelegram(k,!0,function(c){f["button"+q]="pressed";b.activeStateChange(f);a&&a(c)});break;case "releaseAI":case "releaseAO":case "releaseBI":case "releaseBO":h=b.buildData(0,0,0,0);k=new x.hub.m.enocean.ESP3.Telegram.RPS(h,this._senderID,1,1,0,null);c.sendTelegram(k,!0,function(c){f["button"+q]="released";b.activeStateChange(f);a&&a(c)});break;default:a&&a(Error("unknow command"))}}else a&&a(Error("command invalid"));else a&&a(Error("sender id is null"))};var l=function(c){h.call(this,
c);this._data="f6-02-02"};h.STATES=["buttonAI","buttonAO","buttonBI","buttonBO"];l.COMMANDS="shortPressAI longPressAI pressAI releaseAI shortPressAO longPressAO pressAO releaseAO shortPressBI longPressBI pressBI releaseBI shortPressBO longPressBO pressBO releaseBO".split(" ");l.prototype=new h;l.prototype.constructor=l;var r=function(c){e.call(this,c);this._data="f6-02-03"};r.STATES=["state"];r.COMMANDS=["auto","manu","dimUp","dimDown"];r.prototype=new e;r.prototype.constructor=r;r.prototype.evalTelegram=
function(c){var d={};if(246==c.rorg)switch(c.userData){case 48:d.state="auto";break;case 16:d.state="manu";break;case 112:d.state="dimUp";break;case 80:d.state="dimDown"}return d};r.prototype.executeCommand=function(c,d,a){if(this._senderID)if(d&&d.value){switch(d.value){case "auto":var b=48;break;case "manu":b=16;break;case "dimUp":b=112;break;case "dimDown":b=80;break;default:a&&a(Error("unknow command"))}this.activeStateChange({state:d.value});d=new x.hub.m.enocean.ESP3.Telegram.RPS(b,this._senderID,
1,1,0,null);c.sendTelegram(d,!0,function(c){a&&a(c)})}else a&&a(Error("command invalid"));else a&&a(Error("sender id is null"))};var m=function(c){h.call(this,c);this._data="f6-02-04";this._longPressThreshold=1E3};m.STATES=["buttonAI","buttonAO","buttonBI","buttonBO","energyBow"];m.prototype=new h;m.prototype.constructor=m;m.prototype.evalTelegram=function(c){var d={};if(246==c.rorg){var a=c.userData>>3&1,b=c.userData>>2&1,e=c.userData>>1&1,f=c.userData&1;d.energyBow=c.userData>>7&1?"pressed":"released";
...
u.prototype=new h;u.prototype.constructor=u;u.prototype.evalTelegram=function(c){var d={};if(246==c.rorg){var a=c.userData>>5&7,b=c.userData>>1&7,e=c.userData&1,f=c.t21,g=c.nu;c=c.userData>>4&1?"pressed":"released";if(0==f&&1==g){switch(a){case 0:var h=c;break;case 1:var k=c;break;case 2:var l=c;break;case 3:var m=c;break;case 4:var ia=c;break;case 5:var r=c;break;case 6:var p=c;break;case 7:var n=c}if(e)switch(b){case 0:h=c;break;case 1:k=c;break;case 2:l=c;break;case 3:m=c;break;case 4:ia=c;break;
case 5:r=c;break;case 6:p=c;break;case 7:n=c}}else if(0==f&&0==g)switch(a){case 0:case 7:n=p=r=ia=m=l=k=h=c}h&&(d.buttonAI=h);k&&(d.buttonAO=k);l&&(d.buttonBI=l);m&&(d.buttonBO=m);ia&&(d.buttonCI=ia);r&&(d.buttonCO=r);p&&(d.buttonDI=p);n&&(d.buttonDO=n)}return d};u.prototype.executeCommand=function(c,d,a){if(this._senderID)if(d&&d.value){var b=this,e=100,q=d.value.substr(d.value.length-2),f={},g=0;switch(q){case "AI":g=0;break;case "AO":g=1;break;case "BI":g=2;break;case "BO":g=3;break;case "CI":g=
...
1,1,0,null);c.sendTelegram(k,!0,function(d){d?a&&a(d):(f["button"+q]="pressed",b.activeStateChange(f),setTimeout(function(){h=b.buildData(0,0,0,0);k=new x.hub.m.enocean.ESP3.Telegram.RPS(h,b._senderID,1,1,0,null);c.sendTelegram(k,!0,function(c){f["button"+q]="released";b.activeStateChange(f);a&&a(c)})},e))});break;case "pressAI":case "pressAO":case "pressBI":case "pressBO":case "pressCI":case "pressCO":case "pressDI":case "pressDO":h=this.buildData(g,1,0,0);k=new x.hub.m.enocean.ESP3.Telegram.RPS(h,
this._senderID,1,1,0,null);c.sendTelegram(k,!0,function(c){f["button"+q]="pressed";b.activeStateChange(f);a&&a(c)});break;case "releaseAI":case "releaseAO":case "releaseBI":case "releaseBO":case "releaseCI":case "releaseCO":case "releaseDI":case "releaseDO":h=b.buildData(0,0,0,0);k=new x.hub.m.enocean.ESP3.Telegram.RPS(h,this._senderID,1,1,0,null);c.sendTelegram(k,!0,function(c){f["button"+q]="released";b.activeStateChange(f);a&&a(c)});break;default:a&&a(Error("unknow command"))}}else a&&a(Error("command invalid"));
else a&&a(Error("sender id is null"))};var y=function(c){u.call(this,c);this._data="f6-03-02"};y.STATES="buttonAI buttonAO buttonBI buttonBO buttonCI buttonCO buttonDI buttonDO".split(" ");y.COMMANDS="shortPressAI longPressAI pressAI releaseAI shortPressAO longPressAO pressAO releaseAO shortPressBI longPressBI pressBI releaseBI shortPressBO longPressBO pressBO releaseBO shortPressCI longPressCI pressCI releaseCI shortPressCO longPressCO pressCO releaseCO shortPressDI longPressDI pressDI releaseDI shortPressDO longPressDO pressDO releaseDO".split(" ");
y.prototype=new u;y.prototype.constructor=y;var C=function(c){e.call(this,c);this._data="f6-04-01"};C.STATES=["keycard"];C.prototype=new e;C.prototype.constructor=C;C.prototype.evalTelegram=function(c){var d={};if(246==c.rorg){var a=c.t21,b=c.nu;c=c.userData;1==a&&1==b&&112==c?d.keycard="inserted":1==a&&0==b&&0==c&&(d.keycard="takeout")}return d};var J=function(c){e.call(this,c);this._data="f6-04-02"};J.STATES=["keycard"];J.prototype=new e;J.prototype.constructor=J;J.prototype.evalTelegram=function(c){var d=
{};if(246==c.rorg){var a=c.userData>>7&1;c=c.userData>>2&1;1==a&&1==c?d.keycard="inserted":0==a&&0==c&&(d.keycard="takeout")}return d};var K=function(c){e.call(this,c);this._data="f6-05-00"};K.STATES=["wind","lowbat"];K.prototype=new e;K.prototype.constructor=K;K.prototype.evalTelegram=function(c){var d={};if(246==c.rorg)switch(c.userData){case 0:d.wind="ok";this._states.lowbat||(d.lowbat=!1);break;case 16:d.wind="alarm";this._states.lowbat||(d.lowbat=!1);break;case 48:d.lowbat=!0}return d};var z=
function(c){e.call(this,c);this._data="f6-05-01"};z.COMMANDS=["reset"];z.STATES=["water"];z.prototype=new e;z.prototype.constructor=z;z.prototype.evalTelegram=function(c){var d={};if(246==c.rorg){var a=c.nu,b=c.userData;1==c.t21&&1==a&&17==b&&(d.water="alarm")}return d};z.prototype.executeCommand=function(c,d,a){if(d&&d.value)switch(d.value){case "reset":this.activeStateChange({water:"ok"});a&&a();break;default:a&&a(Error("no such command"))}else a&&a(Error("command invalid"))};var w=function(c){e.call(this,
c);this._data="f6-05-02"};w.STATES=["smoke","lowbat"];w.prototype=new e;w.prototype.constructor=w;w.prototype.evalTelegram=function(c){var d={};if(246==c.rorg)switch(c.userData){case 0:d.smoke="ok";this._states.lowbat||(d.lowbat=!1);break;case 16:d.smoke="alarm";this._states.lowbat||(d.lowbat=!1);break;case 48:d.lowbat=!0}return d};var Q=function(c){e.call(this,c);this._data="f6-10-00"};Q.STATES=["window","handle_pos","handle_raw"];Q.prototype=new e;Q.prototype.constructor=Q;Q.prototype.evalTelegram=
function(c){var d={};246==c.rorg&&(c=c.userData,0==(c&208^192)?(d.window="open",d.handle_pos="middle"):0==(c&240^240)?(d.window="closed",d.handle_pos="down"):0==(c&240^208)&&(d.window="tilted",d.handle_pos="up"),d.handle_raw=c);return d};var V=function(c){e.call(this,c);this._data="f6-10-01"};V.STATES=["window","handle_pos","handle_raw"];V.prototype=new e;V.prototype.constructor=V;V.prototype.evalTelegram=function(c){var d={};246==c.rorg&&(c=c.userData&15,0==(c&13^12)?(d.window="open",d.handle_pos=
"middle"):0==(c&15^15)?(d.window="closed",d.handle_pos="down"):0==(c&15^13)&&(d.window="tilted",d.handle_pos="up"),d.handle_raw=c);return d};var Y=function(c){g.call(this,c);this._data="d5-??-??"};Y.prototype=new g;Y.prototype.constructor=Y;var P=function(c){Y.call(this,c);this._data="d5-00-01"};P.STATES=["contact","contact_raw"];P.prototype=new Y;P.prototype.constructor=P;P.prototype.evalTelegram=function(c){var d={};213==c.rorg&&(c=c.userData,1==(c>>3&1)&&(c&=1,d.contact=c?"closed":"open",d.contact_raw=
c));return d};var t=function(c){g.call(this,c);this._data="a5-??-??";this.TEACH_IN_VARIATION=2;this.UNIQUE_GATEWAY_SENDERID=!0};t.prototype=new g;t.prototype.constructor=t;t.prototype.getTeachinType=function(){return"4BS"};t.prototype.isTeachinBidirectional=function(){return!1};var p=function(c){t.call(this,c);this._data="a5-02-??";this._tmpMin=-40;this._tmpMax=0};p.STATES=["temperature","temperature_raw"];p.prototype=new t;p.prototype.constructor=p;p.prototype.evalTelegram=function(c){var d={};if(165==
c.rorg){var a=c.userData.readUInt8(3);c=c.userData.readUInt8(2);1==(a>>3&1)&&(d.temperature=parseFloat(((255-c)/255*(this._tmpMax-this._tmpMin)+this._tmpMin).toFixed(1)),d.temperature_raw=c)}return d};var Z=function(c){p.call(this,c);this._data="a5-02-01";this._tmpMin=-40;this._tmpMax=0};Z.STATES=["temperature","temperature_raw"];Z.prototype=new p;Z.prototype.constructor=Z;var L=function(c){p.call(this,c);this._data="a5-02-02";this._tmpMin=-30;this._tmpMax=10};L.STATES=["temperature","temperature_raw"];
L.prototype=new p;L.prototype.constructor=L;var pa=function(c){p.call(this,c);this._data="a5-02-03";this._tmpMin=-20;this._tmpMax=20};pa.STATES=["temperature","temperature_raw"];pa.prototype=new p;pa.prototype.constructor=pa;var O=function(c){p.call(this,c);this._data="a5-02-04";this._tmpMin=-10;this._tmpMax=30};O.STATES=["temperature","temperature_raw"];O.prototype=new p;O.prototype.constructor=O;var R=function(c){p.call(this,c);this._data="a5-02-05";this._tmpMin=0;this._tmpMax=40};R.STATES=["temperature",
"temperature_raw"];R.prototype=new p;R.prototype.constructor=R;var da=function(c){p.call(this,c);this._data="a5-02-06";this._tmpMin=10;this._tmpMax=50};da.STATES=["temperature","temperature_raw"];da.prototype=new p;da.prototype.constructor=da;var aa=function(c){p.call(this,c);this._data="a5-02-07";this._tmpMin=20;this._tmpMax=60};aa.STATES=["temperature","temperature_raw"];aa.prototype=new p;aa.prototype.constructor=aa;var ba=function(c){p.call(this,c);this._data="a5-02-08";this._tmpMin=30;this._tmpMax=
70};ba.STATES=["temperature","temperature_raw"];ba.prototype=new p;ba.prototype.constructor=ba;var Qa=function(c){p.call(this,c);this._data="a5-02-09";this._tmpMin=40;this._tmpMax=80};Qa.STATES=["temperature","temperature_raw"];Qa.prototype=new p;Qa.prototype.constructor=Qa;var v=function(c){p.call(this,c);this._data="a5-02-0a";this._tmpMin=50;this._tmpMax=90};v.STATES=["temperature","temperature_raw"];v.prototype=new p;v.prototype.constructor=v;var n=function(c){p.call(this,c);this._data="a5-02-0b";
this._tmpMin=60;this._tmpMax=100};n.STATES=["temperature","temperature_raw"];n.prototype=new p;n.prototype.constructor=n;var H=function(c){p.call(this,c);this._data="a5-02-10";this._tmpMin=-60;this._tmpMax=20};H.STATES=["temperature","temperature_raw"];H.prototype=new p;H.prototype.constructor=H;var dc=function(c){p.call(this,c);this._data="a5-02-11";this._tmpMin=-50;this._tmpMax=30};dc.STATES=["temperature","temperature_raw"];dc.prototype=new p;dc.prototype.constructor=dc;var Pa=function(c){p.call(this,
c);this._data="a5-02-12";this._tmpMin=-40;this._tmpMax=40};Pa.STATES=["temperature","temperature_raw"];Pa.prototype=new p;Pa.prototype.constructor=Pa;var ec=function(c){p.call(this,c);this._data="a5-02-13";this._tmpMin=-30;this._tmpMax=50};ec.STATES=["temperature","temperature_raw"];ec.prototype=new p;ec.prototype.constructor=ec;var fc=function(c){p.call(this,c);this._data="a5-02-14";this._tmpMin=-20;this._tmpMax=60};fc.STATES=["temperature","temperature_raw"];fc.prototype=new p;fc.prototype.constructor=
fc;var Ga=function(c){p.call(this,c);this._data="a5-02-15";this._tmpMin=-10;this._tmpMax=70};Ga.STATES=["temperature","temperature_raw"];Ga.prototype=new p;Ga.prototype.constructor=Ga;var gc=function(c){p.call(this,c);this._data="a5-02-16";this._tmpMin=0;this._tmpMax=80};gc.STATES=["temperature","temperature_raw"];gc.prototype=new p;gc.prototype.constructor=gc;var db=function(c){p.call(this,c);this._data="a5-02-17";this._tmpMin=10;this._tmpMax=90};db.STATES=["temperature","temperature_raw"];db.prototype=
new p;db.prototype.constructor=db;var hc=function(c){p.call(this,c);this._data="a5-02-18";this._tmpMin=20;this._tmpMax=100};hc.STATES=["temperature","temperature_raw"];hc.prototype=new p;hc.prototype.constructor=hc;var ic=function(c){p.call(this,c);this._data="a5-02-19";this._tmpMin=30;this._tmpMax=110};ic.STATES=["temperature","temperature_raw"];ic.prototype=new p;ic.prototype.constructor=ic;var jc=function(c){p.call(this,c);this._data="a5-02-1a";this._tmpMin=40;this._tmpMax=120};jc.STATES=["temperature",
"temperature_raw"];jc.prototype=new p;jc.prototype.constructor=jc;var kc=function(c){p.call(this,c);this._data="a5-02-1b";this._tmpMin=50;this._tmpMax=130};kc.STATES=["temperature","temperature_raw"];kc.prototype=new p;kc.prototype.constructor=kc;var Ha=function(c){t.call(this,c);this._data="a5-02-20";this._tmpMin=-10;this._tmpMax=41.2};Ha.STATES=["temperature","temperature_raw"];Ha.prototype=new t;Ha.prototype.constructor=Ha;Ha.prototype.evalTelegram=function(c){var d={};if(165==c.rorg){var a=c.userData.readUInt8(3);
c=c.userData.readUInt16BE(1);1==(a>>3&1)&&(a=c&1023,d.temperature=parseFloat(((1023-a)/1023*(this._tmpMax-this._tmpMin)+this._tmpMin).toFixed(1)),d.temperature_raw=a)}return d};var lc=function(c){Ha.call(this,c);this._data="a5-02-30";this._tmpMin=-40;this._tmpMax=62.3};lc.STATES=["temperature","temperature_raw"];lc.prototype=new Ha;lc.prototype.constructor=lc;var ja=function(c){t.call(this,c);this._data="a5-04-??";this._humMin=0;this._humMax=100;this._tempMin=0;this._tempMax=40};ja.STATES=["humidity",
"humidity_raw","temperature","temperature_raw","available"];ja.prototype=new t;ja.prototype.constructor=ja;ja.prototype.evalTelegram=function(c){var d={};if(165==c.rorg){var a=c.userData.readUInt8(3),b=c.userData.readUInt8(2);c=c.userData.readUInt8(1);1==(a>>3&1)&&(d.humidity=parseFloat((c/250*(this._humMax-this._humMin)+this._humMin).toFixed(1)),d.humidity_raw=c,d.temperature=parseFloat((b/250*(this._tempMax-this._tempMin)+this._tempMin).toFixed(1)),d.temperature_raw=b,d.available=a>>1&1?!0:!1)}return d};
var mc=function(c){ja.call(this,c);this._data="a5-04-01"};mc.STATES=ja.STATES;mc.prototype=new ja;mc.prototype.constructor=mc;var Ra=function(c){ja.call(this,c);this._data="a5-04-02";this._tempMin=-20;this._tempMax=60};Ra.STATES=ja.STATES;Ra.prototype=new ja;Ra.prototype.constructor=Ra;var eb=function(c){ja.call(this,c);this._data="a5-04-03";this._tempMin=-20;this._tempMax=60};eb.STATES=["humidity","humidity_raw","temperature","temperature_raw","type"];eb.prototype=new ja;eb.prototype.constructor=
eb;eb.prototype.evalTelegram=function(c){var d={};if(165==c.rorg){var a=c.userData.readUInt8(3),b=c.userData.readUInt16BE(1);c=c.userData.readUInt8(0);1==(a>>3&1)&&(d.humidity=parseFloat((c/255*(this._humMax-this._humMin)+this._humMin).toFixed(1)),d.humidity_raw=c,b&=1023,d.temperature=parseFloat((b/1023*(this._tempMax-this._tempMin)+this._tempMin).toFixed(1)),d.temperature_raw=b,d.type=a&1?"event":"heartbeat")}return d};var M=function(c){t.call(this,c);this._data="a5-06-??";this._svcMin=0;this._svcMax=
5.1;this._ill2Min=300;this._ill2Max=3E4;this._ill1Min=600;this._ill1Max=6E4};M.STATES="voltage voltage_raw illumination2 illumination2_raw illumination1 illumination1_raw illumination illumination_raw range range_raw".split(" ");M.prototype=new t;M.prototype.constructor=M;M.prototype.evalTelegram=function(c){var d={};if(165==c.rorg){var a=c.userData.readUInt8(3),b=c.userData.readUInt8(2),e=c.userData.readUInt8(1);c=c.userData.readUInt8(0);if(1==(a>>3&1)){d.voltage=parseFloat((c/255*(this._svcMax-
this._svcMin)+this._svcMin).toFixed(1));d.voltage_raw=c;d.illumination2=parseFloat((e/255*(this._ill2Max-this._ill2Min)+this._ill2Min).toFixed(1));d.illumination2_raw=e;d.illumination1=parseFloat((b/255*(this._ill1Max-this._ill1Min)+this._ill1Min).toFixed(1));d.illumination1_raw=b;a&=1;switch(a){case 0:d.range="db1";d.illumination=d.illumination1;d.illumination_raw=b;break;case 1:d.range="db2",d.illumination=d.illumination2,d.illumination_raw=b}d.range_raw=a}}return d};var Sa=function(c){M.call(this,
c);this._data="a5-06-01"};Sa.STATES=M.STATES;Sa.prototype=new M;Sa.prototype.constructor=Sa;var Ia=function(c){M.call(this,c);this._data="a5-06-02";this._ill2Min=0;this._ill2Max=510;this._ill1Min=0;this._ill1Max=1020};Ia.STATES=M.STATES;Ia.prototype=new M;Ia.prototype.constructor=Ia;var fb=function(c){M.call(this,c);this._data="a5-06-03";this._svcMin=0;this._svcMax=5.1};fb.STATES=["voltage","voltage_raw","illumination","illumination_raw"];fb.prototype=new M;fb.prototype.constructor=fb;fb.prototype.evalTelegram=
function(c){var d={};if(165==c.rorg){var a=c.userData.readUInt8(3),b=c.userData.readUInt16BE(1);c=c.userData.readUInt8(0);1==(a>>3&1)&&(d.voltage=parseFloat((c/255*(this._svcMax-this._svcMin)+this._svcMin).toFixed(1)),d.voltage_raw=c,a=b>>6&1023,d.illumination=a,d.illumination_raw=a)}return d};var gb=function(c){M.call(this,c);this._data="a5-06-04";this._tmpMin=-20;this._tmpMax=60};gb.STATES="temperature temperature_raw illumination illumination_raw energy energy_raw temperature_avail energy_avail".split(" ");
gb.prototype=new M;gb.prototype.constructor=gb;gb.prototype.evalTelegram=function(c){var d={};if(165==c.rorg){var a=c.userData.readUInt8(3),b=c.userData.readUInt16BE(1);c=c.userData.readUInt8(0);1==(a>>3&1)&&(d.temperature=parseFloat((c/255*(this._tmpMax-this._tmpMin)+this._tmpMin).toFixed(1)),d.temperature_raw=c,d.illumination=b,d.illumination_raw=b,b=a>>4&15,d.energy=parseFloat((b/15*100).toFixed(1)),d.energy_raw=b,d.temperature_avail=a>>1&1?!0:!1,d.temperature_avail||delete d.temperature,d.energy_avail=
a&1?!0:!1,d.energy_avail||delete d.energy)}return d};var nc=function(c){M.call(this,c);this._data="a5-06-05";this._ill2Min=0;this._ill2Max=5100;this._ill1Min=0;this._ill1Max=10200};nc.STATES=M.STATES;nc.prototype=new M;nc.prototype.constructor=nc;var W=function(c){t.call(this,c);this._data="a5-07-??";this._params||(this._params={reset_timeout:30});this._resetTO=null};W.COMMANDS=["reset"];W.prototype=new t;W.prototype.constructor=W;W.prototype._startPIROffTO=function(){this._resetTO&&(clearTimeout(this._resetTO),
...
d,c.changed=!0);this._states.state={value:"off",time:(new Date).getTime()};require("x.hub.m.enocean.js")._onEOEvents(this,[c])};W.prototype.executeCommand=function(c,d,a){if(d&&d.value)switch(d.value){case "reset":this._reset();a&&a();break;default:a&&a(Error("no such command"))}else a&&a(Error("command invalid"))};W.prototype.fromJSON=function(c){if(!g.prototype.fromJSON.call(this,c))return null;this._params||(this._params={reset_timeout:30});return this};W.prototype.fromDBJSON=function(c){if(!g.prototype.fromDBJSON.call(this,
c))return null;this._params||(this._params={reset_timeout:30});return this};var ea=function(c){W.call(this,c);this._data="a5-07-01"};ea.COMMANDS=["reset"];ea.STATES=["voltage","voltage_raw","state","state_raw","voltage_avail"];ea.prototype=new W;ea.prototype.constructor=ea;ea.prototype.evalTelegram=function(c){var d={};if(165==c.rorg){var a=c.userData.readUInt8(3),b=c.userData.readUInt8(2);c=c.userData.readUInt8(0);1==(a>>3&1)&&(d.voltage=parseFloat((c/250*5).toFixed(1)),d.voltage_raw=c,d.state=128<=
b?"on":"off",d.state_raw=b,d.voltage_avail=a&1?!0:!1,d.voltage_avail||delete d.voltage)}"on"==d.state?this._startPIROffTO():"off"==d.state&&this._stopPIROffTO();return d};var Ta=function(c){W.call(this,c);this._data="a5-07-02"};Ta.COMMANDS=["reset"];Ta.STATES=["voltage","voltage_raw","state","state_raw"];Ta.prototype=new W;Ta.prototype.constructor=Ta;Ta.prototype.evalTelegram=function(c){var d={};if(165==c.rorg){var a=c.userData.readUInt8(3);c=c.userData.readUInt8(0);1==(a>>3&1)&&(d.voltage=parseFloat((c/
250*5).toFixed(1)),d.voltage_raw=c,a=a>>7&1,d.state=a?"on":"off",d.state_raw=a)}"on"==d.state?this._startPIROffTO():"off"==d.state&&this._stopPIROffTO();return d};var Ua=function(c){W.call(this,c);this._data="a5-07-03"};Ua.COMMANDS=["reset"];Ua.STATES="voltage voltage_raw illumination illumination_raw state state_raw".split(" ");Ua.prototype=new W;Ua.prototype.constructor=Ua;Ua.prototype.evalTelegram=function(c){var d={};if(165==c.rorg){var a=c.userData.readUInt8(3),b=c.userData.readUInt16BE(1);c=
...
b;a&=1;switch(a){case 0:d.button="pressed";break;case 1:d.button="released"}d.button_raw=a}}return d};B.prototype.fromJSON=function(c){if(!g.prototype.fromJSON.call(this,c))return null;this._params||(this._params={minSP:18,maxSP:26});return this};B.prototype.fromDBJSON=function(c){if(!g.prototype.fromDBJSON.call(this,c))return null;this._params||(this._params={minSP:18,maxSP:26});return this};var ma=function(c){B.call(this,c);this._data="a5-10-02"};ma.STATES="fan_speed fan_speed_raw setpoint setpoint_raw temperature temperature_raw slider slider_raw".split(" ");
ma.prototype=new B;ma.prototype.constructor=ma;ma.prototype.evalTelegram=function(c){var d=B.prototype.evalTelegram.call(this,c);if(0==Object.keys(d).length)return d;delete d.button;delete d.button_raw;c=c.userData.readUInt8(3)&1;d.slider=c?"day":"night";d.slider_raw=c;return d};var Ja=function(c){B.call(this,c);this._data="a5-10-03";this.TEACH_IN_VARIATION=1};Ja.STATES=["setpoint","setpoint_raw","temperature","temperature_raw"];Ja.prototype=new B;Ja.prototype.constructor=Ja;Ja.prototype.evalTelegram=
...
delete c.button_raw;return c};var sb=function(c){B.call(this,c);this._data="a5-10-05"};sb.STATES="setpoint setpoint_raw temperature temperature_raw button button_raw".split(" ");sb.prototype=new B;sb.prototype.constructor=sb;sb.prototype.evalTelegram=function(c){c=B.prototype.evalTelegram.call(this,c);if(0==Object.keys(c).length)return c;delete c.fan_speed;delete c.fan_speed_raw;return c};var Ca=function(c){ma.call(this,c);this._data="a5-10-06"};Ca.STATES="setpoint setpoint_raw temperature temperature_raw slider slider_raw".split(" ");
Ca.prototype=new ma;Ca.prototype.constructor=Ca;Ca.prototype.evalTelegram=function(c){c=ma.prototype.evalTelegram.call(this,c);if(0==Object.keys(c).length)return c;delete c.fan_speed;delete c.fan_speed_raw;return c};var tb=function(c){B.call(this,c);this._data="a5-10-07"};tb.STATES=["fan_speed","fan_speed_raw","temperature","temperature_raw"];tb.prototype=new B;tb.prototype.constructor=tb;tb.prototype.evalTelegram=function(c){c=B.prototype.evalTelegram.call(this,c);if(0==Object.keys(c).length)return c;
delete c.setpoint;delete c.setpoint_raw;delete c.button;delete c.button_raw;return c};var qa=function(c){B.call(this,c);this._data="a5-10-08";this._params=null};qa.STATES="fan_speed fan_speed_raw temperature temperature_raw button button_raw".split(" ");qa.prototype=new B;qa.prototype.constructor=qa;qa.prototype.evalTelegram=function(c){c=B.prototype.evalTelegram.call(this,c);if(0==Object.keys(c).length)return c;delete c.setpoint;delete c.setpoint_raw;return c};qa.prototype.fromJSON=function(c){return g.prototype.fromJSON.call(this,
c)};qa.prototype.fromDBJSON=function(c){return g.prototype.fromDBJSON.call(this,c)};var ra=function(c){ma.call(this,c);this._data="a5-10-09";this._params=null};ra.STATES="fan_speed fan_speed_raw temperature temperature_raw slider slider_raw".split(" ");ra.prototype=new ma;ra.prototype.constructor=ra;ra.prototype.evalTelegram=function(c){c=ma.prototype.evalTelegram.call(this,c);if(0==Object.keys(c).length)return c;delete c.setpoint;delete c.setpoint_raw;return c};ra.prototype.fromJSON=function(c){return g.prototype.fromJSON.call(this,
c)};ra.prototype.fromDBJSON=function(c){return g.prototype.fromDBJSON.call(this,c)};var Da=function(c){B.call(this,c);this._data="a5-10-0a"};Da.STATES="setpoint setpoint_raw temperature temperature_raw contact contact_raw".split(" ");Da.prototype=new B;Da.prototype.constructor=Da;Da.prototype.evalTelegram=function(c){var d=B.prototype.evalTelegram.call(this,c);if(0==Object.keys(d).length)return d;delete d.fan_speed;delete d.fan_speed_raw;delete d.button;delete d.button_raw;c=c.userData.readUInt8(3)&
1;d.contact=c?"open":"closed";d.contact_raw=c;return d};var Ka=function(c){Da.call(this,c);this._data="a5-10-0b";this._params=null};Ka.STATES=["temperature","temperature_raw","contact","contact_raw"];Ka.prototype=new Da;Ka.prototype.constructor=Ka;Ka.prototype.evalTelegram=function(c){c=Da.prototype.evalTelegram.call(this,c);if(0==Object.keys(c).length)return c;delete c.setpoint;delete c.setpoint_raw;return c};Ka.prototype.fromJSON=function(c){return g.prototype.fromJSON.call(this,c)};Ka.prototype.fromDBJSON=
function(c){return g.prototype.fromDBJSON.call(this,c)};var ub=function(c){qa.call(this,c);this._data="a5-10-0c"};ub.STATES=["temperature","temperature_raw","button","button_raw"];ub.prototype=new qa;ub.prototype.constructor=ub;ub.prototype.evalTelegram=function(c){c=qa.prototype.evalTelegram.call(this,c);if(0==Object.keys(c).length)return c;delete c.fan_speed;delete c.fan_speed_raw;return c};var vb=function(c){ra.call(this,c);this._data="a5-10-0d"};vb.STATES=["temperature","temperature_raw","slider",
"slider_raw"];vb.prototype=new ra;vb.prototype.constructor=vb;vb.prototype.evalTelegram=function(c){c=ra.prototype.evalTelegram.call(this,c);if(0==Object.keys(c).length)return c;delete c.fan_speed;delete c.fan_speed_raw;return c};var S=function(c){Wa.call(this,c);this._data="a5-10-10";this._params||(this._params={minSP:18,maxSP:26})};S.STATES="setpoint setpoint_raw humidity humidity_raw temperature temperature_raw button button_raw".split(" ");S.prototype=new Wa;S.prototype.constructor=S;S.prototype.evalTelegram=
...
S.prototype.fromJSON=function(c){if(!g.prototype.fromJSON.call(this,c))return null;this._params||(this._params={minSP:18,maxSP:26});return this};S.prototype.fromDBJSON=function(c){if(!g.prototype.fromDBJSON.call(this,c))return null;this._params||(this._params={minSP:18,maxSP:26});return this};var Ea=function(c){S.call(this,c);this._data="a5-10-11"};Ea.STATES="setpoint setpoint_raw humidity humidity_raw temperature temperature_raw slider slider_raw".split(" ");Ea.prototype=new S;Ea.prototype.constructor=
Ea;Ea.prototype.evalTelegram=function(c){var d=S.prototype.evalTelegram.call(this,c);if(0==Object.keys(d).length)return d;delete d.button;delete d.button_raw;c=c.userData.readUInt8(3)&1;d.slider=c?"day":"night";d.slider_raw=c;return d};var wb=function(c){S.call(this,c);this._data="a5-10-12"};wb.STATES="setpoint setpoint_raw humidity humidity_raw temperature temperature_raw".split(" ");wb.prototype=new S;wb.prototype.constructor=wb;wb.prototype.evalTelegram=function(c){c=S.prototype.evalTelegram.call(this,
c);if(0==Object.keys(c).length)return c;delete c.button;delete c.button_raw;return c};var xb=function(c){S.call(this,c);this._data="a5-10-13"};xb.STATES="humidity humidity_raw temperature temperature_raw button button_raw".split(" ");xb.prototype=new S;xb.prototype.constructor=xb;xb.prototype.evalTelegram=function(c){c=S.prototype.evalTelegram.call(this,c);if(0==Object.keys(c).length)return c;delete c.setpoint;delete c.setpoint_raw;return c};var yb=function(c){Ea.call(this,c);this._data="a5-10-14"};
yb.STATES="humidity humidity_raw temperature temperature_raw slider slider_raw".split(" ");yb.prototype=new Ea;yb.prototype.constructor=yb;yb.prototype.evalTelegram=function(c){c=Ea.prototype.evalTelegram.call(this,c);if(0==Object.keys(c).length)return c;delete c.setpoint;delete c.setpoint_raw;return c};var Xa=function(c){t.call(this,c);this._data="a5-11-??"};Xa.prototype=new t;Xa.prototype.constructor=Xa;var zb=function(c){Xa.call(this,c);this._data="a5-11-03"};zb.STATES="position angle position_flag position_flag_raw angle_flag angle_flag_raw error error_raw end_position end_position_raw state state_raw service_mode position_mode power energy current voltage power_raw power_unit energy_unit current_unit voltage_unit power_unit_raw".split(" ");
...
c<<8|e,d.power_unit_raw=b,e="mW W kW MW Wh kWh MWh GWh mA 1/10A mV 1/10V".split(" "),3>=b?(d.power=d.power_raw,d.power_unit=e[b]):7>=b?(d.energy=d.power_raw,d.energy_unit=e[b]):9>=b?(d.current=d.power_raw,d.current_unit=e[b]):11>=b&&(d.voltage=d.power_raw,d.voltage_unit=e[b])}}}return d};var fa=function(c){t.call(this,c);this._data="a5-12-??"};fa.STATES="meter_raw channel_raw type_raw scale_raw scale meter current cumulative".split(" ");fa.prototype=new t;fa.prototype.constructor=fa;fa.prototype.evalTelegram=
function(c){var d={};if(165==c.rorg){var a=c.userData.readUInt8(3);c=c.userData.readUInt32BE(0);if(1==(a>>3&1)){c=c>>8&16777215;d.meter_raw=c;d.channel_raw=a>>4&15;var b=a>>2&1;d.type_raw=b;a&=3;d.scale_raw=a;switch(a){case 0:d.scale=1;d.meter=c;break;case 1:d.scale=.1;d.meter=.1*c;break;case 2:d.scale=.01;d.meter=.01*c;break;case 3:d.scale=.001,d.meter=.001*c}b?d.current=d.meter:d.cumulative=d.meter}}return d};var Ab=function(c){fa.call(this,c);this._data="a5-12-00"};Ab.STATES=["current","counter",
"channel"];Ab.prototype=new fa;Ab.prototype.constructor=Ab;Ab.prototype.evalTelegram=function(c){c=fa.prototype.evalTelegram.call(this,c);c.counter=c.cumulative;c.channel=c.channel_raw;return c};var na=function(c){fa.call(this,c);this._data="a5-12-01"};na.STATES=["power","energy","tariff"];na.prototype=new fa;na.prototype.constructor=na;na.prototype.evalTelegram=function(c){c=fa.prototype.evalTelegram.call(this,c);c.energy=c.cumulative;c.power=c.current;c.tariff=c.channel_raw;return c};var La=function(c){fa.call(this,
c);this._data="a5-12-02"};La.STATES=["volume","flow","tariff"];La.prototype=new fa;La.prototype.constructor=La;La.prototype.evalTelegram=function(c){c=fa.prototype.evalTelegram.call(this,c);c.volume=c.cumulative;c.flow=c.current;c.tariff=c.channel_raw;return c};var qc=function(c){La.call(this,c);this._data="a5-12-03"};qc.STATES=["volume","flow","tariff"];qc.prototype=new La;qc.prototype.constructor=qc;var T=function(c){t.call(this,c);this._data="a5-13-??"};T.STATES="lux lux_raw temperature temperature_raw wind wind_raw day_night rain sun_west sun_west_raw sun_south sun_south_raw sun_east sun_east_raw hemisphere day month year date_src weekday hour min sec time_format am_pm time_src elv azm latitude longitude latitude_raw longitude_raw".split(" ");
T.prototype=new t;T.prototype.constructor=T;T.prototype.evalTelegram=function(c){var d={};if(165==c.rorg){var a=c.userData.readUInt8(3),b=c.userData.readUInt8(2),e=c.userData.readUInt8(1),f=c.userData.readUInt8(0);if(1==(a>>3&1))switch(a>>4&15){case 1:d.lux=parseFloat((f/255*1E3).toFixed(1));d.lux_raw=f;var g=e;d.temperature=parseFloat((g/255*120-40).toFixed(1));d.temperature_raw=g;d.wind=parseFloat((b/255*70).toFixed(1));d.wind_raw=b;d.day_night=a>>2&1?"night":"day";d.rain=a>>1&1?"true":"false";
...
f;b=c.userData.readUInt16BE(1)&511;d.azm=b;d.azm_raw=b;break;case 6:c=(f>>4&15)<<8|e,b|=(f&15)<<8,d.latitude=parseFloat((c/4095*180-90).toFixed(1)),d.latitude_raw=c,d.longitude=parseFloat((b/4095*360-180).toFixed(1)),d.longitude_raw=b}}return d};var rc=function(c){T.call(this,c);this._data="a5-13-01"};rc.STATES="lux lux_raw temperature temperature_raw wind wind_raw day_night rain sun_west sun_west_raw sun_south sun_south_raw sun_east sun_east_raw hemisphere day month year date_src weekday hour min sec time_format am_pm time_src elv azm latitude longitude latitude_raw longitude_raw".split(" ");
rc.prototype=new T;rc.prototype.constructor=rc;var sc=function(c){T.call(this,c);this._data="a5-13-02"};sc.STATES="sun_west sun_west_raw sun_south sun_south_raw sun_east sun_east_raw hemisphere".split(" ");sc.prototype=new T;sc.prototype.constructor=sc;var tc=function(c){T.call(this,c);this._data="a5-13-03"};tc.STATES=["day","month","year","date_src"];tc.prototype=new T;tc.prototype.constructor=tc;var uc=function(c){T.call(this,c);this._data="a5-13-04"};uc.STATES="weekday hour min sec time_format am_pm time_src".split(" ");
uc.prototype=new T;uc.prototype.constructor=uc;var vc=function(c){T.call(this,c);this._data="a5-13-05"};vc.STATES=["elv","azm"];vc.prototype=new T;vc.prototype.constructor=vc;var wc=function(c){T.call(this,c);this._data="a5-13-06"};wc.STATES=["latitude","longitude"];wc.prototype=new T;wc.prototype.constructor=wc;var Bb=function(c){g.call(this,c);this._data="a5-14-01"};Bb.STATES=["voltage","voltage_raw","state"];Bb.prototype=new g;Bb.prototype.constructor=Bb;Bb.prototype.evalTelegram=function(c){var d=
...
this._params.display;"undefined"!=typeof this._display_new&&null!=this._display_new&&(l=this._display_new,this._params.display=this._display_new,f=!0,this._display_new=null);if("undefined"==typeof l||null==l)l=this._defaultDisplay,this._params.display=l;if("undefined"!=typeof this._button_lock_new&&null!=this._button_lock_new){var ia="locked"==this._button_lock_new?1:0;this._states.button_lock={value:this._button_lock_new,time:b};this._button_lock_new=null;delete e.button_lock}else"undefined"!=typeof d.button_lock&&
null!=d.button_lock?ia="locked"==d.button_lock?1:0:this._states.button_lock&&this._states.button_lock.value&&(ia="locked"==this._states.button_lock.value?1:0);if("undefined"==typeof ia||null==ia)ia=0,e.button_lock="unlocked";d=0;"undefined"!=typeof this._service_command_new&&null!=this._service_command_new&&(d=this._service_command_new,this._service_command_new=null);q=new Buffer([q,g,(h&1)<<6|k&63,(l&3)<<4|8|(ia&1)<<2|d&3]);f&&require("x.hub.m.enocean.js")._deviceHandler.deviceParamsUpdated();f=
this._senderID;f||(f=x.hub.m.enocean.SENDER_ID);f=new x.hub.m.enocean.ESP3.Telegram.ADT(165,q,this._address,f,0);c.sendTelegram(f,!0,function(c){a&&a(c,e)})};var Za=function(c){t.call(this,c);this._data="a5-30-??"};Za.prototype=new t;Za.prototype.constructor=Za;var Ma=function(c){g.call(this,c);this._data="a5-30-01"};Ma.STATES=["battery_low","battery_raw","state","state_raw"];Ma.prototype=new Za;Ma.prototype.constructor=Ma;Ma.prototype.evalTelegram=function(c){var d={};if(165==c.rorg){var a=c.userData.readUInt8(3),
b=c.userData.readUInt8(2);c=c.userData.readUInt8(1);1==(a>>3&1)&&(d.battery_low=120>=c?!0:!1,d.battery_raw=c,d.state=195>=b?"closed":"open",d.state_raw=b)}return d};var Lb=function(c){g.call(this,c);this._data="a5-30-01\u00b4"};Lb.STATES=["state"];Lb.prototype=new Za;Lb.prototype.constructor=Lb;Lb.prototype.evalTelegram=function(c){var d={};165==c.rorg&&(c=c.userData.readUInt8(3),1==(c>>3&1)&&(d.state=c&1?"open":"closed"));return d};var X=function(c){g.call(this,c);this._data="a5-30-03"};X.STATES=
"temperature temperature_raw wake input3 input2 input1 input0".split(" ");X.prototype=new Za;X.prototype.constructor=X;X.prototype.evalTelegram=function(c){var d={};if(165==c.rorg){var a=c.userData.readUInt8(3),b=c.userData.readUInt8(2);c=c.userData.readUInt8(1);1==(a>>3&1)&&(d.temperature=(255-c)/255*40,d.temperature_raw=c,d.wake=b>>4&1,d.input3=b>>3&1,d.input2=b>>2&1,d.input1=b>>1&1,d.input0=b&1)}return d};var Mb=function(c){g.call(this,c);this._data="a5-30-04"};Mb.STATES=["analog_input","input2",
"input1","input0"];Mb.prototype=new Za;Mb.prototype.constructor=Mb;Mb.prototype.evalTelegram=function(c){var d={};if(165==c.rorg){var a=c.userData.readUInt8(3);c=c.userData.readUInt8(2);1==(a>>3&1)&&(d.analog_input=c,d.input2=a>>2&1,d.input1=a>>1&1,d.input0=a&1)}return d};var xc=function(c){t.call(this,c);this._data="a5-38-??"};xc.prototype=new t;xc.prototype.constructor=xc;var I=function(c){xc.call(this,c);this._data="a5-38-08"};I.prototype=new xc;I.prototype.constructor=I;I.prototype.evalTelegram=
function(c){var d={};if(165==c.rorg){var a=c.userData.readUInt8(3),b=c.userData.readUInt8(2),e=c.userData.readUInt8(1);c=c.userData.readUInt8(0);if(1==(a>>3&1))switch(c){case 2:d.level=Math.round(e/255*100),d.ramp=b,d.dim_range=a>>2&1?"relative":"absolute",d.store_final_value=a>>1&1,d.state=a&1?"on":"off"}}return d};I.prototype.switching=function(c,d,a){var b=this._senderID;this._senderID||(b=x.hub.m.enocean.SENDER_ID);d=new Buffer([1,d.TIM>>8&255,d.TIM&255,8|(d.LCK&1)<<2|(d.DEL&1)<<1|d.SW&1]);b=
new x.hub.m.enocean.ESP3.Telegram.BS4(d,b,0);b.setDstId(this._address);c.sendTelegram(b,!0,function(c){a&&a(c)})};I.prototype.dimming=function(c,d,a){var b=this._senderID;this._senderID||(b=x.hub.m.enocean.SENDER_ID);d=new Buffer([2,d.EDIM,d.RMP,8|(d.EDIMR&1)<<2|(d.STR&1)<<1|d.SW&1]);b=new x.hub.m.enocean.ESP3.Telegram.BS4(d,b,0);b.setDstId(this._address);c.sendTelegram(b,!0,function(c){a&&a(c)})};I.prototype.blind=function(c,d,a){var b=this._senderID;this._senderID||(b=x.hub.m.enocean.SENDER_ID);
d=new Buffer([7,d.P1,d.P2,(d.FUNC&15)<<4|8|(d.SSF&1)<<2|(d.PAF&1)<<1|d.SMF&1]);b=new x.hub.m.enocean.ESP3.Telegram.BS4(d,b,0);b.setDstId(this._address);c.sendTelegram(b,!0,function(c){a&&a(c)})};var yc=function(c){t.call(this,c);this._data="a5-3F-7F"};yc.prototype=new t;yc.prototype.constructor=yc;var ha=function(c){g.call(this,c);this._data="d2-??-??";this.UNIQUE_GATEWAY_SENDERID=!0};ha.prototype=new g;ha.prototype.constructor=ha;var E=function(c){ha.call(this,c);this._data="d2-01-??";this._lastQuery=
{};this._initCount=0};E.STATES="power_failure_detection power_failure over_current_switch_off error_level io_channel local_control output_value output_state".split(" ");E.prototype=new ha;E.prototype.constructor=E;E.prototype.init=function(c){var d=this.getIOs();if(0<d.length){var a=require("x.hub.m.enocean.js")._esp3,b=0,e=this,f=function(){b++;b<d.length?e.statusQuery(a,{IO:d[b]},f):c&&c()};this.statusQuery(a,{IO:d[b]},f)}else c&&c()};E.prototype.getStatesBuffer=function(){0==Object.keys(this._states).length?
(100>=this._initCount&&0==this._initCount%10?this.init():100<=this._initCount&&600>=this._initCount&&0==this._initCount%60?this.init():this._initCount=0,this._initCount++):this._initCount=0;return this._states};E.prototype.getIOs=function(){return[]};E.prototype.setOutput=function(c,d,a){var b=this._senderID;this._senderID||(b=x.hub.m.enocean.SENDER_ID);d=new Buffer([1,(d.DV&7)<<5|d.IO&31,d.OV&127]);b=new x.hub.m.enocean.ESP3.Telegram.VLD(d,b,0);this._senderID!=this._address&&b.setDstId(this._address);
c.sendTelegram(b,!0,function(c){a&&a(c)})};E.prototype.setLocal=function(c,d,a){d=new Buffer([(d.DE&1)<<7|2,(d.OC&1)<<7|(d.RO&1)<<6|(d.LC&1)<<5|d.IO&31,(d.DT2&15)<<4|d.DT3&15,(d.DN&1)<<7|(d.PF&1)<<6|(d.DS&3)<<4|d.DT1&15]);d=new x.hub.m.enocean.ESP3.Telegram.VLD(d,x.hub.m.enocean.SENDER_ID,0);d.setDstId(this._address);c.sendTelegram(d,!0,function(c){a&&a(c)})};E.prototype.statusQuery=function(c,d,a){this._senderID?(this._lastQuery[d.IO]=(new Date).getTime(),d=new Buffer([3,d.IO&31]),d=new x.hub.m.enocean.ESP3.Telegram.VLD(d,
this._senderID,0),d.setDstId(this._address),c.sendTelegram(d,!0,function(c){a&&a(c)})):a&&a(Error("no senderID"))};E.prototype.measurementQuery=function(c,d,a){d=new Buffer([6,(d.QU&1)<<5|d.IO&31]);d=new x.hub.m.enocean.ESP3.Telegram.VLD(d,this._senderID,0);d.setDstId(this._address);c.sendTelegram(d,!0,function(c){a&&a(c)})};E.prototype.evalTelegram=function(c){var d={};if(210==c.rorg){var a=c.userData.readUInt8(0);switch(a&15){case 4:if(3==c.userData.length){var b=a>>7&1,e=a>>6&1;a=c.userData.readUInt8(1);
var f=a>>7&1,g=a>>5&3,h=a&31;a=c.userData.readUInt8(2);c=a&127;d.power_failure_detection=b?!0:!1;d.power_failure=e?!0:!1;d.over_current_switch_off=f;d.error_level=g;d.io_channel=h;d.local_control=a>>7&1?!0:!1;d.output_value=c;d.output_state=c?"on":"off"}break;case 7:if(6==c.userData.length){a=c.userData.readUInt8(1);b=a>>5&7;h=a&31;a=c.userData.readUInt32BE(2);switch(b){case 0:d.unit="Ws";break;case 1:d.unit="Wh";break;case 2:d.unit="KWh";break;case 3:d.unit="W";break;case 4:d.unit="KW"}d.io_channel=
h;d.value=a}}}return d};var oa=function(c){E.call(this,c);this._data="d2-01-00"};oa.COMMANDS=["on","off","toggle"];oa.STATES="power_failure_detection power_failure over_current_switch_off error_level io_channel local_control output_value output_state".split(" ");oa.prototype=new E;oa.prototype.constructor=oa;oa.prototype.getIOs=function(){return[0]};oa.prototype.executeCommand=function(c,d,a){if(d&&d.value){var b=this;switch(d.value){case "on":this.activeStateChange({output_value:100,output_state:"on"});
this.setOutput(c,{DV:0,IO:0,OV:100},a);break;case "off":this.activeStateChange({output_value:0,output_state:"off"});this.setOutput(c,{DV:0,IO:0,OV:0},a);break;case "toggle":this._states.output_state?this.executeCommand(c,{value:"on"==this._states.output_state.value?"off":"on"},a):this.init(function(){setTimeout(function(){b._states.output_state?b.executeCommand(c,d,a):a&&a(Error("unkown current status"))},200)})}}else a&&a(Error("command invalid"))};var Nb=function(c){oa.call(this,c);this._data="d2-01-01"};
Nb.COMMANDS=["on","off","toggle"];Nb.STATES="power_failure_detection power_failure over_current_switch_off error_level io_channel local_control output_value output_state".split(" ");Nb.prototype=new oa;Nb.prototype.constructor=Nb;var Ob=function(c){oa.call(this,c);this._data="d2-01-03";this._lastOnLevel=-1};Ob.prototype=new oa;Ob.prototype.constructor=Ob;Ob.prototype.evalData=function(c,d,a){(c=this.evalTelegram(d))?((0==c.output_value||"off"==c.output_state)&&this._states.output_value&&this._states.output_value.value&&
(this._lastOnLevel=this._states.output_value.value),c=this.checkStateChange(c),a&&a(null,c)):a&&a(Error("data format invalid"))};Ob.prototype.executeCommand=function(c,d,a){if(d&&d.value){if("dimTo"==d.value.substr(0,5)&&5<d.value.length){var b=d.value.substr(5);d={value:"dimTo",ext:b}}else"toggleTo"==d.value.substr(0,8)&&8<d.value.length&&(b=d.value.substr(8),d={value:"toggleTo",ext:b});(new Date).getTime();var e=this;switch(d.value){case "on":b=this._lastOnLevel;if(-1==b||0==b)b=100;this.setOutput(c,
{DV:0,IO:0,OV:b},function(c){c||e.activeStateChange({output_value:b,output_state:"on"});a&&a(c)});break;case "off":this._states.output_value&&this._states.output_value.value&&(this._lastOnLevel=this._states.output_value.value);this.setOutput(c,{DV:0,IO:0,OV:0},function(c){c||e.activeStateChange({output_value:0,output_state:"off"});a&&a(c)});break;case "toggle":if(!this._states.output_state){this.init(function(){setTimeout(function(){e._states.output_state?e.executeCommand(c,d,a):a&&a(Error("unkown current status"))},
200)});break}this.executeCommand(c,{value:"on"==this._states.output_state.value?"off":"on"},a);break;case "toggleTo":if(!this._states.output_state){this.init(function(){setTimeout(function(){e._states.output_state?e.executeCommand(c,d,a):a&&a(Error("unkown current status"))},200)});break}"on"==this._states.output_state.value?this.executeCommand(c,{value:"off"},a):this.executeCommand(c,{value:"dimTo",ext:d.ext},a);break;case "dimTo":if("undefined"==typeof d.ext||null==d.ext){a&&a(Error("dim to value invalid"));
break}b=parseFloat(d.ext);0>b&&(b=0);100<b&&(b=100);this.setOutput(c,{DV:0,IO:0,OV:b},function(c){c||e.activeStateChange({output_value:b,output_state:0==b?"off":"on"});a&&a(c)});break;case "dimUp":if(!this._states.output_state){this.init(function(){setTimeout(function(){e._states.output_state?e.executeCommand(c,d,a):a&&a(Error("unkown current status"))},200)});break}b=parseInt(this._states.output_value.value);b+=5;100<b&&(b=100);this.executeCommand(c,{value:"dimTo",ext:b},a);break;case "dimDown":if(!this._states.output_state){this.init(function(){setTimeout(function(){e._states.output_state?
e.executeCommand(c,d,a):a&&a(Error("unkown current status"))},200)});break}b=parseInt(this._states.output_value.value);b-=5;0>b&&(b=0);this.executeCommand(c,{value:"dimTo",ext:b},a);break;default:a&&a(Error("unknow command"))}}else a&&a(Error("command invalid"))};var Fa=function(c){E.call(this,c);this._data="d2-01-11"};Fa.COMMANDS="ch1On ch1Off ch1Toggle ch2On ch2Off ch2Toggle".split(" ");Fa.STATES="power_failure_detection power_failure over_current_switch_off error_level io_channel local_control output_value output_state ch1_output_value ch1_output_state ch2_output_value ch2_output_state".split(" ");
Fa.prototype=new E;Fa.prototype.constructor=Fa;Fa.prototype.getIOs=function(){return[0,1]};Fa.prototype.evalTelegram=function(c){if(c=E.prototype.evalTelegram.call(this,c))switch(c.io_channel){case 0:c.ch1_output_value=c.output_value;c.ch1_output_state=c.output_state;break;case 1:c.ch2_output_value=c.output_value,c.ch2_output_state=c.output_state}return c};Fa.prototype.executeCommand=function(c,d,a){if(d&&d.value){var b=this;switch(d.value){case "ch1On":this.activeStateChange({ch1_output_value:100,
ch1_output_state:"on"});this.setOutput(c,{DV:0,IO:0,OV:100},a);break;case "ch1Off":this.activeStateChange({ch1_output_value:0,ch1_output_state:"off"});this.setOutput(c,{DV:0,IO:0,OV:0},a);break;case "ch1Toggle":if(!this._states.output_state){this.init(function(){setTimeout(function(){b._states.output_state?b.executeCommand(c,d,a):a&&a(Error("unkown current status"))},200)});break}var e="on"==this._states.ch1_output_state.value?"off":"on";this.activeStateChange({ch1_output_value:"on"==e?100:0,ch1_output_state:e});
this.executeCommand(c,{value:"on"==e?"ch1On":"ch1Off"},a);break;case "ch2On":this.activeStateChange({ch2_output_value:100,ch2_output_state:"on"});this.setOutput(c,{DV:0,IO:1,OV:100},a);break;case "ch2Off":this.activeStateChange({ch2_output_value:0,ch2_output_state:"off"});this.setOutput(c,{DV:0,IO:1,OV:0},a);break;case "ch2Toggle":if(!this._states.output_state){this.init(function(){setTimeout(function(){b._states.output_state?b.executeCommand(c,d,a):a&&a(Error("unkown current status"))},200)});break}e=
"on"==this._states.ch2_output_state.value?"off":"on";this.activeStateChange({ch2_output_value:"on"==e?100:0,ch2_output_state:e});this.executeCommand(c,{value:"on"==e?"ch2On":"ch2Off"},a);break;default:a&&a(Error("unknown command"))}}else a&&a(Error("command invalid"))};var sa=function(c){E.call(this,c);this._data="d2-01-13";this._queryInterval=3E4};sa.COMMANDS="ch1On ch1Off ch1Toggle ch2On ch2Off ch2Toggle ch3On ch3Off ch3Toggle ch4On ch4Off ch4Toggle".split(" ");sa.STATES="power_failure_detection power_failure over_current_switch_off error_level io_channel local_control output_value output_state ch1_output_value ch1_output_state ch2_output_value ch2_output_state ch3_output_value ch3_output_state ch4_output_value ch4_output_state".split(" ");
sa.prototype=new E;sa.prototype.constructor=sa;sa.prototype.getStatesBuffer=function(){var c=[];this._states.ch1_output_state||(!this._lastQuery[0]||now-this._lastQuery[0]>this._queryInterval)&&c.push(0);this._states.ch2_output_state||(!this._lastQuery[1]||now-this._lastQuery[1]>this._queryInterval)&&c.push(1);this._states.ch3_output_state||(!this._lastQuery[2]||now-this._lastQuery[2]>this._queryInterval)&&c.push(2);this._states.ch4_output_state||(!this._lastQuery[3]||now-this._lastQuery[3]>this._queryInterval)&&
c.push(3);0<c.length&&this._queryStates(c);return this._states};sa.prototype._queryStates=function(c,d){var a=require("x.hub.m.enocean.js")._esp3,b=0,e=this,f=function(){b++;b<c.length?e.statusQuery(a,{IO:c[b]},f):d&&d()};this.statusQuery(a,{IO:c[b]},f)};sa.prototype.getIOs=function(){return[0,1,2,3]};sa.prototype.evalTelegram=function(c){if(c=E.prototype.evalTelegram.call(this,c))switch(c.io_channel){case 0:c.ch1_output_value=c.output_value;c.ch1_output_state=c.output_state;break;case 1:c.ch2_output_value=
c.output_value;c.ch2_output_state=c.output_state;break;case 2:c.ch3_output_value=c.output_value;c.ch3_output_state=c.output_state;break;case 3:c.ch4_output_value=c.output_value,c.ch4_output_state=c.output_state}return c};sa.prototype.executeCommand=function(c,d,a){if(d&&d.value){var b=this;switch(d.value?d.value.substr(0,3):null){case "ch1":var e=0;var f="ch1_output_value";var q="ch1_output_state";break;case "ch2":e=1;f="ch2_output_value";q="ch2_output_state";break;case "ch3":e=2;f="ch3_output_value";
q="ch3_output_state";break;case "ch4":e=3,f="ch4_output_value",q="ch4_output_state"}switch(d.value){case "ch1On":case "ch2On":case "ch3On":case "ch4On":var g={};g[f]=100;g[q]="on";var h={DV:0,IO:e,OV:100};this.activeStateChange(g);this.setOutput(c,h,a);break;case "ch1Off":case "ch2Off":case "ch3Off":case "ch4Off":g={};g[f]=0;g[q]="off";h={DV:0,IO:e,OV:0};this.activeStateChange(g);this.setOutput(c,h,a);break;case "ch1Toggle":case "ch2Toggle":case "ch3Toggle":case "ch4Toggle":if(!this._states.output_state){this.init(function(){setTimeout(function(){b._states.output_state?
b.executeCommand(c,d,a):a&&a(Error("unkown current status"))},200)});break}if(!this._states[q]){a&&a(Error("state unknown"));break}h="on"==this._states[q].value?"off":"on";g={};g[f]="on"==h?100:0;g[q]=h;h={DV:0,IO:e,OV:"on"==h?100:0};this.activeStateChange(g);this.setOutput(c,h,a);break;default:a&&a(Error("unknown command"))}}else a&&a(Error("command invalid"))};var ta=function(c){E.call(this,c);this._data="d2-01-14";this._queryInterval=3E4};ta.COMMANDS="ch1On ch1Off ch1Toggle ch2On ch2Off ch2Toggle ch3On ch3Off ch3Toggle ch4On ch4Off ch4Toggle ch5On ch5Off ch5Toggle ch6On ch6Off ch6Toggle ch7On ch7Off ch7Toggle ch8On ch8Off ch8Toggle".split(" ");
ta.STATES="power_failure_detection power_failure over_current_switch_off error_level io_channel local_control output_value output_state ch1_output_value ch1_output_state ch2_output_value ch2_output_state ch3_output_value ch3_output_state ch4_output_value ch4_output_state ch5_output_value ch5_output_state ch6_output_value ch6_output_state ch7_output_value ch7_output_state ch8_output_value ch8_output_state".split(" ");ta.prototype=new E;ta.prototype.constructor=ta;ta.prototype._queryStates=function(c,
d){var a=require("x.hub.m.enocean.js")._esp3,b=0,e=this,f=function(){b++;b<c.length?e.statusQuery(a,{IO:c[b]},f):d&&d()};this.statusQuery(a,{IO:c[b]},f)};ta.prototype.getStatesBuffer=function(){var c=(new Date).getTime(),d=[];this._states.ch1_output_state||(!this._lastQuery[0]||c-this._lastQuery[0]>this._queryInterval)&&d.push(0);this._states.ch2_output_state||(!this._lastQuery[1]||c-this._lastQuery[1]>this._queryInterval)&&d.push(1);this._states.ch3_output_state||(!this._lastQuery[2]||c-this._lastQuery[2]>
...
c-this._lastQuery[7]>this._queryInterval)&&d.push(7);0<d.length&&this._queryStates(d);return this._states};ta.prototype.getIOs=function(){return[0,1,2,3,4,5,6,7]};ta.prototype.evalTelegram=function(c){if(c=E.prototype.evalTelegram.call(this,c))switch(c.io_channel){case 0:c.ch1_output_value=c.output_value;c.ch1_output_state=c.output_state;break;case 1:c.ch2_output_value=c.output_value;c.ch2_output_state=c.output_state;break;case 2:c.ch3_output_value=c.output_value;c.ch3_output_state=c.output_state;
break;case 3:c.ch4_output_value=c.output_value;c.ch4_output_state=c.output_state;break;case 4:c.ch5_output_value=c.output_value;c.ch5_output_state=c.output_state;break;case 5:c.ch6_output_value=c.output_value;c.ch6_output_state=c.output_state;break;case 6:c.ch7_output_value=c.output_value;c.ch7_output_state=c.output_state;break;case 7:c.ch8_output_value=c.output_value,c.ch8_output_state=c.output_state}return c};ta.prototype.executeCommand=function(c,d,a){if(d&&d.value){var b=this;switch(d.value?d.value.substr(0,
...
{};g[f]=100;g[q]="on";var h={DV:0,IO:e,OV:100};this.activeStateChange(g);this.setOutput(c,h,a);break;case "ch1Off":case "ch2Off":case "ch3Off":case "ch4Off":case "ch5Off":case "ch6Off":case "ch7Off":case "ch8Off":g={};g[f]=0;g[q]="off";h={DV:0,IO:e,OV:0};this.activeStateChange(g);this.setOutput(c,h,a);break;case "ch1Toggle":case "ch2Toggle":case "ch3Toggle":case "ch4Toggle":case "ch5Toggle":case "ch6Toggle":case "ch7Toggle":case "ch8Toggle":if(!this._states.output_state){this.init(function(){setTimeout(function(){b._states.output_state?
b.executeCommand(c,d,a):a&&a(Error("unkown current status"))},200)});break}if(!this._states[q]){a&&a(Error("state unknown"));break}h="on"==this._states[q].value?"off":"on";g={};g[f]="on"==h?100:0;g[q]=h;h={DV:0,IO:e,OV:"on"==h?100:0};this.activeStateChange(g);this.setOutput(c,h,a);break;default:a&&a(Error("unknown command"))}}else a&&a(Error("command invalid"))};var zc=function(c){ha.call(this,c);this._data="d2-05-??"};zc.prototype=new ha;zc.prototype.constructor=zc;var N=function(c){zc.call(this,
c);this._data="d2-05-00"};N.COMMANDS="moveUp moveDown moveTo stepUp stepDown lamellaUp lamellaDown lamellaTo stop setRunTime setRotationTime setParams[15.2s]:[10,20,30ms]:[0-3]".split(" ");N.STATES=["state","angle","lock","channel"];N.prototype=new zc;N.prototype.constructor=N;N.prototype.init=function(c){var d=require("x.hub.m.enocean.js")._esp3;this.query(d,{CHN:0},c)};N.prototype.getStatesBuffer=function(){0==Object.keys(this._states).length&&this.init();return this._states};N.prototype.goToPositionAngle=
function(c,d,a){var b=this._senderID;this._senderID||(b=x.hub.m.enocean.SENDER_ID);d=new Buffer([d.POS&127,d.ANG&127,(d.REPO&7)<<4|d.LOCK&7,(d.CHN&15)<<4|1]);b=new x.hub.m.enocean.ESP3.Telegram.VLD(d,b,0);b.setDstId(this._address);c.sendTelegram(b,!0,function(c){a&&a(c)})};N.prototype.stop=function(c,d,a){var b=this._senderID;this._senderID||(b=x.hub.m.enocean.SENDER_ID);d=new Buffer([(d.CHN&15)<<4|2]);b=new x.hub.m.enocean.ESP3.Telegram.VLD(d,b,0);b.setDstId(this._address);c.sendTelegram(b,!0,function(c){a&&
a(c)})};N.prototype.query=function(c,d,a){var b=this._senderID;this._senderID||(b=x.hub.m.enocean.SENDER_ID);d=new Buffer([(d.CHN&15)<<4|3]);b=new x.hub.m.enocean.ESP3.Telegram.VLD(d,b,0);b.setDstId(this._address);c.sendTelegram(b,!0,function(c){a&&a(c)})};N.prototype.setParameters=function(c,d,a){var b=this._senderID;this._senderID||(b=x.hub.m.enocean.SENDER_ID);d=new Buffer([d.VERT>>8&127,d.VERT&255,d.ROT&255,d.AA&7,(d.CHN&15)<<4|5]);b=new x.hub.m.enocean.ESP3.Telegram.VLD(d,b,0);b.setDstId(this._address);
c.sendTelegram(b,!0,function(c){a&&a(c)})};N.prototype.evalTelegram=function(c){var d={};if(210==c.rorg)switch(c.userData.readUInt8(c.userData.length-1)&15){case 4:if(4==c.userData.length){var a=c.userData.readUInt8(0);d.state=a&127;a=c.userData.readUInt8(1);d.angle=a&127;a=c.userData.readUInt8(2);switch(a&7){case 0:d.lock="normal";break;case 1:d.lock="blockage_mode";break;case 2:d.lock="alarm_mode"}a=c.userData.readUInt8(3);d.channel=a>>4&15}}return d};N.prototype.executeCommand=function(c,d,a){if(d&&
...
break}f=100*parseFloat(d.ext);499>=f&&(f=500);this.setParameters(c,{VERT:f,ROT:255,AA:7,CHN:b},a);break;case "setRotationTime":if(!d.ext){a&&a(Error("parameters is null"));break}f=32767;q=parseInt(d.ext)/10;this.setParameters(c,{VERT:f,ROT:q,AA:7,CHN:b},a);break;case "setParams":if(!d.ext){a&&a(Error("parameters is null"));break}g=d.ext.split(":");if(3!=g.length){a&&a(Error("parameters format invalid"));break}f=g[0]?100*parseFloat(g[0]):32767;499>=f&&(f=32767);q=g[1]?parseInt(g[1])/10:255;g=g[2]?
parseInt(g[2]):7;this.setParameters(c,{VERT:f,ROT:q,AA:g,CHN:b},a);break;default:a&&a(Error("unknow command"))}}else a&&a(Error("command invalid"))};var Ac=function(c){ha.call(this,c);this._data="d2-06-??"};Ac.prototype=new ha;Ac.prototype.constructor=Ac;var Aa=function(c){ha.call(this,c);this._data="d2-06-01";this._states={pending:{value:!1,time:(new Date).getTime()}};this._vbir_new=this._suir_new=this._blcr_new=this._hccr_new=this._vacation_new=null};Aa.COMMANDS="vacationOn vacationOff handleClosedClickOn handleClosedClickOff batteryLowClickOn batteryLowClickOff setSensorUpdateInterval setVacationBlinkInterval".split(" ");
Aa.STATES="bal ppal state handle window br bl motion vacation temperature humidity illumination battery hccr blcr suir vbir".split(" ");Aa.prototype=new Ac;Aa.prototype.constructor=Aa;Aa.prototype.executeCommand=function(c,d,a){c=(new Date).getTime();if(d&&d.value){"setSensorUpdateInterval"==d.value.substr(0,23)&&23<d.value.length?(d=d.value.substr(23),d={value:"setSensorUpdateInterval",ext:d}):"setVacationBlinkInterval"==d.value.substr(0,24)&&24<d.value.length&&(d=d.value.substr(24),d={value:"setVacationBlinkInterval",
...
null;l._vbir_new=null;var h={pending:!1};h.vacation=a?"on":"off";b&&(h.hccr=1==b?"off":"on");e&&(h.blcr=1==e?"off":"on");f&&(h.suir=f);g&&(h.vbir=g);l.activeStateChange(h);d&&d(c)})};var Ba=function(c){ha.call(this,c);this._data="d2-06-02";this._states={pending:{value:!1,time:(new Date).getTime()}};this._vbis_new=this._suis_new=this._blcs_new=this._lacs_new=this._vacation_new=null};Ba.COMMANDS="vacationOn vacationOff lockActiveClickOn lockActiveClickOff batteryLowClickOn batteryLowClickOff setSensorUpdateInterval setVacationBlinkInterval".split(" ");
Ba.STATES="operation_mode handle window state temperature humidity battery vacation hccr blcr suir vbir".split(" ");Ba.prototype=new Ac;Ba.prototype.constructor=Ba;Ba.prototype.executeCommand=function(c,d,a){c=(new Date).getTime();if(d&&d.value){"setSensorUpdateInterval"==d.value.substr(0,23)&&23<d.value.length?(d=d.value.substr(23),d={value:"setSensorUpdateInterval",ext:d}):"setVacationBlinkInterval"==d.value.substr(0,24)&&24<d.value.length&&(d=d.value.substr(24),d={value:"setVacationBlinkInterval",
...
5*c);if("tilted"==d.window)d.state="tilted";else switch(d.lock){case "unlocked":d.state="open";break;case "locked":d.state="closed"}break;case 16:a=c.userData.readUInt8(1),b=c.userData.readUInt16BE(2),e=c=c.userData.readUInt8(4),d.vacation=a>>7&1?"on":"off",d.hccr=a>>6&1?"on":"off",d.blcr=a>>5&1?"on":"off",5<=b&&(d.suir=b),3<=e&&(d.vbir=e)}return d};Ba.prototype._sendResponse=function(c,d){var a=0;this._vacation_new&&"on"==this._vacation_new?a=1:this._vacation_new&&"off"==this._vacation_new&&(a=2);
var b=0;this._lacs_new&&"off"==this._lacs_new?b=1:this._lacs_new&&"on"==this._lacs_new&&(b=2);var e=0;this._blcs_new&&"off"==this._blcs_new?e=1:this._blcs_new&&"on"==this._blcs_new&&(e=2);var f=0;this._suis_new&&(f=this._suis_new);var g=0;this._vbis_new&&(g=this._vbis_new);var h=new Buffer([128,128|(a&3)<<4|(b&3)<<2|e&3,f>>8&255,f&255,g]),k=this._senderID;k||(k=x.hub.m.enocean.SENDER_ID);h=new x.hub.m.enocean.ESP3.Telegram.VLD(h,k,0);var l=this;c.sendTelegram(h,!0,function(c){l._vacation_new=null;
l._lacs_new=null;l._blcs_new=null;l._suis_new=null;l._vbis_new=null;var h={pending:!1};h.vacation=a?"on":"off";b&&(h.hccr=1==b?"off":"on");e&&(h.blcr=1==e?"off":"on");f&&(h.suir=f);g&&(h.vbir=g);l.activeStateChange(h);d&&d(c)})};var Bc=function(c){ha.call(this,c);this._data="d2-20-??"};Bc.prototype=new ha;Bc.prototype.constructor=Bc;var ca=function(c){Bc.call(this,c);this._data="d2-20-00";this._poller=null;this._pollInterval=6E4};ca.COMMANDS="setFanLevel fanLevelUp fanLevelDown requestStatus setHumLevel setCo2Level".split(" ");
ca.STATES="filter_remaining_time operating_time temperature message_code anti_freeze current_fan_level set_fan_level".split(" ");ca.prototype=new Bc;ca.prototype.constructor=ca;ca.prototype.init=function(c){var a=this;setTimeout(function(){var d=require("x.hub.m.enocean.js")._esp3;a.executeCommand(d,{value:"requestStatus"},c);a._restartPoller(d)},Math.floor(6E3*Math.random())+1E3)};ca.prototype.finalize=function(c){this._poller&&clearInterval(this._poller);c&&c()};ca.prototype._restartPoller=function(c){this._poller&&
clearInterval(this._poller);var a=this;this._poller=setInterval(function(){a.executeCommand(c,{value:"requestStatus"})},this._pollInterval)};ca.prototype.executeCommand=function(c,a,b){(new Date).getTime();if(a&&a.value){if("setFanLevel"==a.value.substr(0,11)&&11<a.value.length)a=a.value.substr(11),a={value:"setFanLevel",ext:a};else if("fanLevelUp"==a.value){var d=this.getBufferedState("set_fan_level");if("undefined"==typeof d||null==d){b&&b(Error("fanLevelUp unknown current fan level"));return}if(6==
...
b(Error("setCo2Level value invalid"));break}f=parseInt(a.ext);if(0>f||4<f){b&&b(Error("setCo2Level value invalid"));break}this._sendResponse(c,{LS:f,RS:1},function(a){e._restartPoller(c);b&&b(a)});break;case "requestStatus":this._sendResponse(c,{LS:5,RS:1},function(c){b&&b(c)});break;default:b&&b(Error("unknown command"))}}else b&&b(Error("command invalid"))};ca.prototype.evalData=function(c,a,b){c=this.evalTelegram(a);this._states&&this._states.set_fan_level||(c.set_fan_level=c.current_fan_level);
this._states&&this._states.set_fan_level&&5!=this._states.set_fan_level.value&&6!=this._states.set_fan_level.value&&(c.set_fan_level=c.current_fan_level);c=this.checkStateChange(c);b&&b(null,c)};ca.prototype.evalTelegram=function(c){var a={};if(210==c.rorg)if(1==c.userData.length){var b=c.userData.readUInt8(0)&7;a.current_fan_level=b}else{b=c.userData.readUInt8(0);var e=c.userData.readUInt8(1),f=c.userData.readUInt16LE(2),g=c.userData.readUInt8(4),h=c.userData.readUInt8(5),k=c.userData.readUInt8(6),
l=c.userData.readUInt16LE(7),m=c.userData.readUInt8(9),r=c.userData.readUInt8(10),ia=c.userData.readInt16BE(11);c=c.userData.readUInt8(13);a.filter_remaining_time=g+":"+f+":"+e+":"+b;a.operating_time=m+":"+l+":"+k+":"+h;a.temperature=ia/10;a.message_code=r;a.anti_freeze=c>>4&1?"on":"off";a.current_fan_level=c&7}return a};ca.prototype._sendResponse=function(c,a,b){var d=this._senderID;this._senderID||(d=x.hub.m.enocean.SENDER_ID);a=new Buffer([a.LS,a.RS]);d=new x.hub.m.enocean.ESP3.Telegram.VLD(a,
d,0);this._senderID!=this._address&&d.setDstId(this._address);c.sendTelegram(d,!0,function(c){b&&b(c)})};ca.prototype._activateSensorRegulation=function(c){var a=require("x.hub.m.enocean.js").getRehauHandler();a&&a.activateSensorRegulation(this.getAddress(),c)};ca.prototype._deactivateSensorRegulation=function(){var c=require("x.hub.m.enocean.js").getRehauHandler();c&&c.deactivateSensorRegulation(this.getAddress())};var Pb=function(c){Q.call(this,c);this._data="eltako_contact";this._vendor="eltako";
this._eepAlias="f6-10-00"};Pb.STATES=["contact","contact_raw"];Pb.prototype=new Q;Pb.prototype.constructor=Pb;Pb.prototype.evalTelegram=function(c){var a={};246==c.rorg&&(c=c.userData,240==c?a.contact="closed":224==c&&(a.contact="open"),a.contact_raw=c);return a};var Na=function(c){Va.call(this,c);this._data="eltako_motion";this._vendor="eltako";this._eepAlias="a5-08-01"};Na.STATES="voltage voltage_raw illumination illumination_raw state state_raw".split(" ");Na.prototype=new Va;Na.prototype.constructor=
Na;Na.prototype.evalTelegram=function(c){var a={};if(165==c.rorg){var b=c.userData.readUInt8(3);c.userData.readUInt8(2);var e=c.userData.readUInt8(1);c=c.userData.readUInt8(0);if(1==(b>>3&1)){a.voltage=parseFloat((c/255*5.1).toFixed(1));a.voltage_raw=c;a.illumination=parseFloat((e/255*2048).toFixed(1));a.illumination_raw=e;b=b>>1&1;switch(b){case 0:a.state="on";break;case 1:a.state="off"}a.state_raw=b}}return a};var la=function(c){I.call(this,c);this._data="eltako_switch";this._vendor="eltako";this._eepAlias=
"f6-02-01"};la.COMMANDS=["on","off","toggle"];la.STATES=["state"];la.prototype=new I;la.prototype.constructor=la;la.prototype.getTeachinType=function(){return"4BS"};la.prototype.handleLearnTelegram=function(c,a){if(a&&246==a.rorg)require("x.hub.m.enocean.js")._deviceHandler.onLearnDevice({address:c._learnAddress,senderID:c._learnSenderID,data:c._learnProfile,vendor:c._learnVendor},{address:a.senderID,senderID:c._learnSenderID,data:this._data,vendor:this._vendor},function(a,d){c._learnFinish(a,0,d)})};
la.prototype.getTeachinTelegram=function(c,a,b){c=new Buffer([224,64,13,128]);return new x.hub.m.enocean.ESP3.Telegram.BS4(c,a,0)};la.prototype.evalTelegram=function(c){var a={};if(246==c.rorg)switch(c.userData){case 112:a.state="on";break;case 80:a.state="off"}return a};la.prototype.executeCommand=function(c,a,b){if(a&&a.value)switch((new Date).getTime(),a.value){case "on":this.switching(c,{TIM:0,LCK:0,DEL:0,SW:1},function(c){b&&b(c)});break;case "off":this.switching(c,{TIM:0,LCK:0,DEL:0,SW:0},function(c){b&&
b(c)});break;case "toggle":if(!this._states.state){b&&b(Error("unknow previous switch state"));break}"on"==this._states.state.value?this.executeCommand(c,{value:"off"},b):this.executeCommand(c,{value:"on"},b);break;default:b&&b(Error("unknow command"))}else b&&b(Error("command invalid"))};var Nc=function(){var c=function(c){la.call(this,c);this.TEACH_IN_VARIATION=3;this._data="eltako_tf_switch"};c.prototype=new la;c.prototype.constructor=c;c.prototype.handleTeachinTelegram=function(c,a){if(a&&165==
a.rorg&&a.userData){var d=a.userData.toString("hex"),b=c._teachSenderID;if(d&&b&&b.substr(2)==d.substr(0,6))require("x.hub.m.enocean.js")._deviceHandler.onLearnDevice({address:c._teachID,senderID:c._teachSenderID,data:c._teachProfile,vendor:c._teachVendor},{address:a.senderID,senderID:c._teachSenderID,data:c._teachProfile,vendor:c._teachVendor},function(a,d){c._teachFinish(a,d)})}};return c}(),G=function(c){I.call(this,c);this._data="eltako_dimmer";this._vendor="eltako";this._eepAlias="a5-38-08";
this._lastOnLevel=-1};G.COMMANDS="on off toggle dimTo dimUp dimDown toggleTo setRampTime".split(" ");G.STATES=["state","level","ramp_time"];G.prototype=new I;G.prototype.constructor=G;G.prototype.setDefaultParams=function(){this._params||(this._params={});if("undefined"==typeof this._params.ramp_time||null==this._params.ramp_time)this._params.ramp_time=0};G.prototype.handleLearnTelegram=function(c,a){if(a&&165==a.rorg)require("x.hub.m.enocean.js")._deviceHandler.onLearnDevice({address:c._learnAddress,
...
0,d)})};$a.prototype.evalTelegram=function(c){var a={};if(246==c.rorg)switch(c.userData){case 112:a.state="on";break;case 80:a.state="off"}return a};var Qb=function(c){G.call(this,c);this._data="eltako_fsud"};Qb.COMMANDS="on off toggle dimTo dimUp dimDown toggleTo setRampTime".split(" ");Qb.STATES=["state","ramp_time"];Qb.prototype=new G;Qb.prototype.constructor=G;Qb.prototype.getTeachinTelegram=function(c,a,b){c=new Buffer([2,0,0,0]);return new x.hub.m.enocean.ESP3.Telegram.BS4(c,a,0)};var U=function(c){yc.call(this,
c);this._data="eltako_blind";this._vendor="eltako";this._eepAlias="f6-02-01";this._syncRunning=!1;this._syncCB=this._syncTO=null};U.COMMANDS="up down stop stepUp stepDown setRV setRunTime moveTo sync".split(" ");U.STATES=["pos","sync"];U.prototype=new yc;U.prototype.constructor=U;U.prototype.setDefaultParams=function(){this._params||(this._params={});if("undefined"==typeof this._params.rv||null==this._params.rv)this._params.rv=200;if("undefined"==typeof this._params.rt||null==this._params.rt)this._params.rt=
200};U.prototype.handleLearnTelegram=function(c,a){if(a&&246==a.rorg)require("x.hub.m.enocean.js")._deviceHandler.onLearnDevice({address:c._learnAddress,senderID:c._learnSenderID,data:c._learnProfile,vendor:c._learnVendor},{address:a.senderID,senderID:c._learnSenderID,data:this._data,vendor:this._vendor},function(a,d){c._learnFinish(a,0,d)})};U.prototype.getTeachinTelegram=function(c,a,b){c=new Buffer([255,248,13,128]);return new x.hub.m.enocean.ESP3.Telegram.BS4(c,a,0)};U.prototype.getStatesBuffer=
function(){var c=JSON.parse(JSON.stringify(this._states));c.sync||(c.sync={value:!1,time:-1});c.rv={value:this._params.rv,time:-1};c.rt={value:this._params.rt,time:-1};return c};U.prototype.evalData=function(c,a,b){(c=this.evalTelegram(a))?(a=this.checkStateChange(c),c.sync&&this._syncRunning&&(this._syncRunning=!1,this._syncTO&&(clearTimeout(this._syncTO),this._syncTO=null),this._syncCB&&(this._syncCB(),this._syncCB=null)),b&&b(null,a)):b&&b(Error("data format invalid"))};U.prototype.evalTelegram=
function(c){var a={};if(246==c.rorg)switch(c.userData){case 112:a.sync=!0;a.pos=0;break;case 80:a.sync=!0,a.pos=100}else if(165==c.rorg){var b=c.userData.readUInt16BE(0);c=c.userData.readUInt8(2);var e=this._params.rt;e||(e=200);var f=this._states.pos?this._states.pos.value:null;f||(f=0);if("undefined"!=typeof f&&null!=f)switch(b=10*b/e,c){case 1:a.pos=Math.max(0,Math.round(f-b));break;case 2:a.pos=Math.min(100,Math.round(f+b))}}return a};U.prototype.executeCommand=function(c,a,b){if(a&&a.value){if("stepUp"==
...
function(c){b&&b(c)});break;default:b&&b(Error("unknow command"))}}else b&&b(Error("command invalid"))};U.prototype.snyc=function(c,a){if(this._syncRunning)a&&a(Error("sync running"));else{var d=this,b=this._params.rv;b||(b=200);this._syncRunning=!0;this._syncTO=setTimeout(function(){d._syncRunning=!1;d._syncTO=null;d._states.pos={value:0,time:(new Date).getTime()}},1E3*(b+2));this.doReq(c,{TIME:b,CMD:1,LCK:0,TYPE:0},function(c){a&&a(c)})}};U.prototype.doReq=function(c,a,b){var d=this._senderID;this._senderID||
(d=x.hub.m.enocean.SENDER_ID);if(a.TYPE){var e=Math.round(10*a.TIME)>>8&255;var f=Math.round(10*a.TIME)&255}else e=0,f=Math.round(a.TIME)&255;a=new Buffer([e,f,a.CMD,8|(a.LCK&1)<<2|(a.TYPE&1)<<1]);d=new x.hub.m.enocean.ESP3.Telegram.BS4(a,d,0);d.setDstId(this._address);c.sendTelegram(d,!0,function(c){b&&b(c)})};var Qc=function(){var c=function(c){U.call(this,c);this.TEACH_IN_VARIATION=3;this._data="eltako_tf_blind"};c.prototype=new U;c.prototype.constructor=c;c.prototype.handleTeachinTelegram=function(c,
...
(this._humMax-this._humMin)+this._humMin).toFixed(1)),a.humidity_raw=f,a.temperature=parseFloat((e/250*(this._tempMax-this._tempMin)+this._tempMin).toFixed(1)),a.temperature_raw=e,a.available=b>>1&1?!0:!1)}return a};var Oa=function(c){Sa.call(this,c);this._data="eltako_lux";this._vendor="eltako";this._eepAlias="a5-06-01";this._ill1Max=3E4;this._ill1Min=300};Oa.STATES="illumination2 illumination2_raw illumination1 illumination1_raw illumination illumination_raw".split(" ");Oa.prototype=new Sa;Oa.prototype.constructor=
Oa;Oa.prototype.evalTelegram=function(c){var a={};if(165==c.rorg){var b=c.userData.readUInt8(3);c.userData.readUInt8(2);var e=c.userData.readUInt8(1);c=c.userData.readUInt8(0);1==(b>>3&1)&&(a.illumination2=c,a.illumination2_raw=c,a.illumination1=parseFloat((e/255*(this._ill1Max-this._ill1Min)+this._ill1Min).toFixed(1)),a.illumination1_raw=e,a.illumination=e?a.illumination1:a.illumination2,a.illumination_raw=e?a.illumination1_raw:a.illumination2_raw)}return a};var Cc=function(c){Ia.call(this,c);this._data=
"eltako_lux2";this._vendor="eltako";this._eepAlias="a5-06-02";this._ill2Min=0;this._ill2Max=1024};Cc.STATES=Ia.STATES;Cc.prototype=new Ia;Cc.prototype.constructor=Cc;var F=function(c){e.call(this,c);this._data="eltako_buttons";this._vendor="eltako";this._eepAlias="f6-02-01";this._longPressThreshold=1E3;this.BUTTONS=["button1","button2","button3","button4"]};F.STATES=["button1","button2","button3","button4"];F.EVENTS=["shortPress","longPress","press","release"];F.prototype=new e;F.prototype.constructor=
...
Ub.prototype=new e;Ub.prototype.constructor=Ub;Ub.prototype.evalTelegram=function(a){var c={};if(246==a.rorg)switch(a.userData){case 48:c.keycard="guest_card";case 32:c.keycard="service_card";case 16:c.keycard="inserted";case 0:c.keycard="takeout"}return c};var ua=function(a){Ca.call(this,a);this._data="eltako_thermo";this._vendor="eltako";this._eepAlias="a5-10-06"};ua.STATES="setpoint setpoint_raw temperature temperature_raw night_reduce night_reduce_raw".split(" ");ua.prototype=new Ca;ua.prototype.constructor=
...
"eltako";this._eepAlias="a5-10-12"};Ic.STATES="setpoint setpoint_raw temperature temperature_raw night_reduce night_reduce_raw".split(" ");Ic.prototype=new ua;Ic.prototype.constructor=Ic;var Wb=function(a){Ja.call(this,a);this._data="eltako_ftr78s";this._vendor="eltako";this._eepAlias="a5-10-03"};Wb.STATES=["setpoint","setpoint_raw","temperature","temperature_raw"];Wb.prototype=new Ja;Wb.prototype.constructor=Wb;Wb.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3),
e=a.userData.readUInt8(2);a=a.userData.readUInt8(1);1==(b>>3&1)&&(c.setpoint=parseFloat((a/255*22+8).toFixed(1)),c.setpoint_raw=a,c.temperature=parseFloat(((255-e)/255*40).toFixed(1)),c.temperature_raw=e)}return c};var ab=function(a){na.call(this,a);this._data="eltako_powermeter";this._vendor="eltako";this._eepAlias="a5-12-01"};ab.STATES=["power","energy","tariff"];ab.prototype=new na;ab.prototype.constructor=ab;ab.prototype.evalTelegram=function(a){var c=na.prototype.evalTelegram.call(this,a);165==
a.rorg&&143==a.userData.readUInt8(3)&&(c={});return c};var Jc=function(a){na.call(this,a);this._data="eltako_powermeter2";this._vendor="eltako";this._eepAlias="a5-12-01"};Jc.STATES=["power","tariff"];Jc.prototype=new na;Jc.prototype.constructor=ab;Jc.prototype.evalTelegram=function(a){a=na.prototype.evalTelegram.call(this,a);delete a.energy;delete a.tariff;return a};var bb=function(a){F.call(this,a);this._data="eltako_fzs"};bb.STATES=["button"];bb.prototype=new F;bb.prototype.constructor=bb;bb.prototype.evalTelegram=
...
this._vendor="eltako";this._eepAlias="f6-02-01"};Yb.STATES=["state"];Yb.prototype=new h;Yb.prototype.constructor=Yb;Yb.prototype.evalTelegram=function(a){var c={};if(246==a.rorg)switch(a.userData){case 112:c.state="on";break;case 80:c.state="off"}return c};var Zb=function(a){X.call(this,a);this._data="eltako_heat";this._vendor="eltako";this._eepAlias="a5-30-03"};Zb.STATES=["temperature","temperature_raw","alarm","alarm_raw"];Zb.prototype=new X;Zb.prototype.constructor=Zb;Zb.prototype.evalTelegram=
function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3),e=a.userData.readUInt8(2),f=a.userData.readUInt8(1);a.userData.readUInt8(0);1==(b>>3&1)&&(c.temperature=parseFloat(((255-f)/255*40).toFixed(1)),c.temperature_raw=f,c.alarm=15==e?"alarm":"ok",c.alarm_raw=e)}return c};var $b=function(a){X.call(this,a);this._data="eltako_water_m3";this._vendor="eltako";this._eepAlias="a5-30-03"};$b.STATES=["water","water_raw"];$b.prototype=new X;$b.prototype.constructor=$b;$b.prototype.evalTelegram=function(a){var c=
{};if(165==a.rorg){var b=a.userData.readUInt8(3);a=a.userData.readUInt8(2);1==(b>>3&1)&&(c.water=15==a,c.water_raw=a)}return c};var ac=function(a){Ma.call(this,a);this._data="eltako_water_m4";this._vendor="eltako";this._eepAlias="a5-30-01"};ac.STATES=["water","water_raw"];ac.prototype=new Ma;ac.prototype.constructor=ac;ac.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3);a=a.userData.readUInt8(2);1==(b>>3&1)&&(c.water=0==a,c.water_raw=a)}return c};var va=function(a){I.call(this,
a);this.TEACH_IN_VARIATION=3;this._data="peha_powerswitch";this._vendor="peha";this._eepAlias="a5-38-08"};va.COMMANDS=["on","off","toggle"];va.STATES="state state_raw level rgb power energy current voltage power_raw power_unit energy_unit current_unit voltage_unit power_unit_raw op_hour error error_raw service_mode op_hour_flag op_hour_flag_raw mode_raw".split(" ");va.prototype=new I;va.prototype.constructor=va;va.prototype.getTeachinType=function(){return"4BS"};va.prototype.evalTelegram=function(a){return Ya.prototype.evalTelegram.call(this,
...
A.STATES="battery pre_alarm alarm window pre_alarm_enabled error pending alarm_enabled pre_alarm_enabled_device timeout".split(" ");A.prototype=new g;A.prototype.constructor=A;A.prototype.setDefaultParams=function(){var a=require("x.hub.m.enocean.js")._rehauHandler;if(a){var b=a.getSmartguardSetting(this._address),e=!0,f=!0;b&&(e=b.isAlarmActive(),f=b.isPreAlarmActive());this.activeStateChange({pending:!1,alarm_enabled:e,pre_alarm_enabled:f,timeout:!1,alarm_task_active:a.getAlarm(),pre_alarm_task_active:a.getAlarm()})}};
A.prototype.getStatesBuffer=function(){return this._states};A.prototype.evalData=function(a,b,e){var c=this.evalTelegram(b);if(c){c.timeout=!1;this._deviceTO&&(clearTimeout(this._deviceTO),this._deviceTO=this._startTimeoutTimer());if(208==b.rorg)b=this.checkStateChange(c);else{var d=!1;210==b.rorg&&2==b.userData.length&&(d=!0);b=this.getBufferedState("alarm_task_active");var f=this.getBufferedState("pre_alarm_task_active"),g=this.getBufferedState("alarm_enabled"),h=this.getBufferedState("pre_alarm_enabled");
c.pre_alarm?f?h?this._startPreAlarmTimer():c.pre_alarm=!1:c.pre_alarm=!1:this._clearPreAlarmTimer();c.alarm?b?g?this._startAlarmTimer():c.alarm=!1:c.alarm=!1:this._clearAlarmTimer();b=this.checkStateChange(c);var k=this;this._executePendingCommand(a,function(){k._reportStates(c)},d)}e&&e(null,b)}else e&&e(Error("data format invalid"))};A.prototype.evalTelegram=function(a){var c={},b=!1;if(210==a.rorg){if(1==a.userData.length)b=a.userData.readUInt8(0);else{var e=a.userData.readUInt8(0);b=a.userData.readUInt8(1)}2==
a.userData.length&&(c.battery=e);c.pre_alarm=b>>7&1?!0:!1;c.alarm=b>>6&1?!0:!1;c.window=b>>5&1?"closed":"open";c.pre_alarm_enabled_device=b>>4&1?!0:!1;c.error=b&15;b=!0}else 208==a.rorg&&(b=a.userData.readUInt8(0),c.battery=Math.round(b/100*255),c.battery_raw=b,b=!0);return b?c:null};A.prototype.executeCommand=function(a,b,e){if(b&&b.value){switch(b.value){case "alertOn":this._setAlarm(!0);break;case "alertOff":this._setAlarm(!1);break;case "alertToggle":this._states&&this._states.alarm_enabled?this._setAlarm(!this._states.alarm_enabled.value):
...
case "alarmTaskOff":this._setAlarmTask(!1);break;case "preAlarmTaskOn":this._setPreAlarmTask(!0);break;case "preAlarmTaskOff":this._setPreAlarmTask(!1);break;default:e&&e(Error("unknow command"));return}e&&e()}else e&&e(Error("command invalid"))};A.prototype._executePendingCommand=function(a,b,e){var c={AL:1,RSA:0,RSP:0,PAE:1},d=this._isAlarmActive();c.AL=d?1:0;d=this._isPreAlarmActive();c.PAE=d?1:0;this._reset_alarm_new&&(c.RSA="on"==this._reset_alarm_new?1:0);this._reset_pre_alarm_new&&(c.RSP="on"==
this._reset_pre_alarm_new?1:0);var f={pending:!1};1==c.RSP&&(f.pre_alarm=!1);1==c.RSA&&(f.alarm=!1);this._reset_pre_alarm_new=this._reset_alarm_new=null;var g=this;this._sendVLD(a,c,function(a){g.activeStateChange(f);b&&b(a)},e)};A.prototype._sendVLD=function(a,b,e,f){var c=this._senderID;this._senderID||(c=x.hub.m.enocean.SENDER_ID);b=(b.AL&1)<<7|(b.RSA&1)<<6|(b.RSP&1)<<5|(b.PAE&1)<<4;f=f?new Buffer([0,b]):new Buffer([b]);c=new x.hub.m.enocean.ESP3.Telegram.VLD(f,c,0);c.setDstId(this._address);a.sendTelegram(c,
!0,function(a){e&&e(a)})};A.prototype._reportStates=function(a){if(a&&0<Object.keys(a).length){var c=require("x.hub.m.enocean.js").getRehauHandler();c&&(a.alarm_enabled=this.getBufferedState("alarm_enabled"),a.pre_alarm_enabled=this.getBufferedState("pre_alarm_enabled"),c.onReceiveWindowSensorStates(this,a))}};A.prototype._setAlarm=function(a){this.activeStateChange({alarm_enabled:a});require("x.hub.m.enocean.js")._rehauHandler.setSmartGuardAlarm(this._address,a)};A.prototype._setPreAlarm=function(a){this.activeStateChange({pre_alarm_enabled:a});
...
originalEEP:this._originalEEP}};A.prototype.fromDBJSON=function(a){if(!a||!a.id||!a.eep||a.eep!=this._data)return null;this._address=a.id;this._senderID=a.senderID;this._vendor=a.vendor?a.vendor:this._vendor;this._virtual=a.virtual?!0:!1;this._params=a.params;this._hopCount=a.hopCount;this._saLearnMode=a.saLearnMode;a.originalEEP&&(this._originalEEP=a.originalEEP);this.setDefaultParams();return this};var Mc=function(a){A.call(this,a);this._data="d2-06-10"};Mc.prototype=new A;Mc.prototype.constructor=
Mc;var Kc=function(a){X.call(this,a);this._data="afriso_water_con";this._vendor="afriso";this._eepAlias="a5-30-03"};Kc.prototype=new X;Kc.prototype.constructor=Kc;Kc.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3),e=a.userData.readUInt8(2);a=a.userData.readUInt8(1);1==(b>>3&1)&&(c.temperature=(255-a)/255*40,c.temperature_raw=a,c.water=0==(e>>4&1)?!0:!1)}return c};var bc=function(a){z.call(this,a);this._data="afriso_water_eco";this._vendor="afriso";this._eepAlias=
"f6-05-01"};bc.prototype=new z;bc.prototype.constructor=bc;bc.prototype.evalTelegram=function(a){var c={};246==a.rorg&&(a=a.nu,1==a?c.water="true":0==a&&(c.water="false"));return c};bc.prototype.onLearn=function(){this._states.water={value:!1,time:(new Date).getTime()}};var Lc=function(a){X.call(this,a);this._data="afriso_asd_10";this._vendor="afriso";this._eepAlias="a5-30-03"};Lc.prototype=new X;Lc.prototype.constructor=Lc;Lc.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3),
e=a.userData.readUInt8(2);a=a.userData.readUInt8(1);1==(b>>3&1)&&(c.temperature=(255-a)/255*40,c.temperature_raw=a,c.smoke=0==(e>>4&1)?!0:!1)}return c};var cc=function(a){Q.call(this,a);this._data="hoppe_door";this._vendor="hoppe";this._eepAlias="f6-10-00"};cc.STATES=["door"];cc.prototype=new Q;cc.prototype.constructor=cc;cc.prototype.evalTelegram=function(a){var c={};246==a.rorg&&(a=a.userData,0==(a&208^192)?c.door="open":0==(a&240^240)&&(c.door="closed"),c.handle_raw=a);return c};var Oc=function(){var a=
...
a))return null;a&&a.gpInfo&&(this._gpInfo=a.gpInfo);return this};return a}(),Rc=function(){var a=function(a){Oc.call(this,a);this._data="afriso_ais_10";this._vendor="afriso";this._eepAlias="gp"};a.prototype=new Oc;a.prototype.constructor=a;a.prototype.isGPMatch=function(a,c){return 45!=a?!1:8==c};a.prototype.evalTelegram=function(a){var c={};if(178==a.rorg){var b=a.data.readUInt8(0)>>7&1,d=a.data.readUInt8(0)>>6&1;a=a.data.readUInt8(0)>>5&1;c.alarm=1==b?"on":"off";c.active=1==d?"on":"off";c.powerAlarm=
1==a?"alarm":"no_change"}return c};a.prototype.executeCommand=function(a,c,b){if(c&&c.value){switch(c.value){case "arming":this._setActive(a,!0,b);break;case "disarming":this._setActive(a,!1,b);break;case "toggleArming":this._states&&this._states.active?this._setActive(a,"off"==this._states.active.value,b):this._setActive(a,!0,b);break;case "alarmOn":this._setAlarm(a,!0,b);break;case "alarmOff":this._setAlarm(a,!1,b);break;case "toggleAlarm":this._states&&this._states.alarm?this._setAlarm(a,"off"==
this._states.alarm.value,b):this._setAlarm(a,!1,b);break;default:b&&b(Error("unknow command"));return}b&&b()}else b&&b(Error("command invalid"))};a.prototype._setActive=function(a,c,b){var d=!1;this._states&&this._states.alarm&&"on"==this._states.alarm.value&&(d=!0);this._sendGPCD(a,d,c,b)};a.prototype._setAlarm=function(a,c,b){var d=!0;this._states&&this._states.active&&"off"==this._states.active.value&&(d=!1);this._sendGPCD(a,c,d,b)};a.prototype._sendGPCD=function(a,c,b,e){var d=this._senderID;
this._senderID||(d=x.hub.m.enocean.SENDER_ID);var f=0;c&&(f|=128);b&&(f|=64);c=new Buffer(1);c.writeUInt8(f,0);d=new x.hub.m.enocean.ESP3.Telegram.GP_CD(c,d,0);d.setDstId(this._address);a.sendTelegram(d,!0,function(a){e&&e(a)})};return a}(),xa=function(){var a=function(a){ea.call(this,a);this._data="eltako_tf_ttb";this._vendor="eltako";this._eepAlias="a5-07-01";this._params={reset_timeout:300}};a.prototype=new ea;a.prototype.constructor=a;a.prototype.evalTelegram=function(a){return 246==a.rorg?k.prototype.evalTelegram.call(this,
a):165==a.rorg?ea.prototype.evalTelegram.call(this,a):{}};a.prototype.checkStateChange=function(a){return a.button?k.prototype.checkStateChange.call(this,a):ea.prototype.checkStateChange.call(this,a)};a.prototype.fromJSON=function(a){ea.prototype.fromJSON.call(this,a);this._params={reset_timeout:300};return this};var b=function(a){X.call(this,a);this._data="eltako_tf_smoke";this._vendor="eltako";this._eepAlias="a5-30-03"};b.STATES=["temperature","temperature_raw","smoke","smoke_raw"];b.prototype=
new X;b.prototype.constructor=b;b.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3),d=a.userData.readUInt8(2),e=a.userData.readUInt8(1);a.userData.readUInt8(0);1==(b>>3&1)&&(c.temperature=parseFloat(((255-e)/255*40).toFixed(1)),c.temperature_raw=e,c.smoke=15==d?!0:!1,c.smoke_raw=d)}return c};var e=function(a){Q.call(this,a);this._data="eltako_tf_contact";this._vendor="eltako";this._eepAlias="d5-00-01"};e.STATES=["contact","contact_raw","voltage","voltage_raw"];
e.prototype=new P;e.prototype.constructor=e;e.prototype.evalTelegram=function(a){var c={};if(213==a.rorg){var b=a.userData;1==(b>>3&1)&&(b&=1,c.contact=b?"closed":"open",c.contact_raw=b)}else if(165==a.rorg){b=a.userData.readUInt8(3);a.userData.readUInt8(2);var d=a.userData.readUInt8(1);a=a.userData.readUInt8(0);1==(b>>3&1)&&(c.voltage=parseFloat(d/255*5).toFixed(1),c.voltage_raw=d,c.energy=parseFloat(a/255*5).toFixed(1),c.energy_raw=a)}return c};var f=function(a){Na.call(this,a);this._data="eltako_motion2";
this._vendor="eltako";this._eepAlias="a5-08-01"};f.STATES="voltage voltage_raw illumination illumination_raw state state_raw".split(" ");f.prototype=new Na;f.prototype.constructor=f;f.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3);a.userData.readUInt8(2);var d=a.userData.readUInt8(1);a=a.userData.readUInt8(0);if(1==(b>>3&1)){c.voltage=parseFloat((a/255*5.1).toFixed(1));c.voltage_raw=a;c.illumination=parseFloat((d/255*510).toFixed(1));c.illumination_raw=d;
switch(b){case 13:c.state="on";break;case 15:c.state="off"}c.motion_raw=b}}return c};var g=function(a){ea.call(this,a);this._data="eltako_tf_motion";this._vendor="eltako";this._eepAlias="a5-07-01"};g.STATES=["motion","motion_raw"];g.prototype=new ea;g.prototype.constructor=g;g.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3);a=a.userData.readUInt8(2);1==(b>>3&1)&&(c.motion=200==a||255==a?!0:!1,c.motion_raw=a)}return c};var h=function(a){I.call(this,a);this._data=
"eltako_tf_input";this._vendor="eltako";this._eepAlias="a5-38-08"};h.STATES=["state","state_raw"];h.prototype=new I;h.prototype.constructor=h;h.prototype.evalTelegram=function(a){var c={};165==a.rorg&&(a=a.userData.readUInt8(3),1==(a>>3&1)&&(c.input=8==a?!1:!0,c.input_raw=a));return c};var l=function(a){Ca.call(this,a);this._data="eltako_tf_thermo";this._vendor="eltako";this._eepAlias="a5-10-06"};l.STATES="setpoint setpoint_raw temperature temperature_raw night_reduce night_reduce_raw".split(" ");
l.prototype=new ua;l.prototype.constructor=l;l.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3),d=a.userData.readUInt8(2),e=a.userData.readUInt8(1);a.userData.readUInt8(0);1==(b>>3&1)&&(c.setpoint=parseFloat((e/255*40).toFixed(1)),c.setpoint_raw=e,c.temperature=parseFloat(((255-d)/255*40).toFixed(1)),c.temperature_raw=d)}return c};var m=function(a){Oa.call(this,a);this._data="eltako_tf_lux"};m.prototype=new Oa;m.prototype.constructor=m;var r=function(a){I.call(this,
a);this._data="eltako_dimmer_knob";this._vendor="eltako";this._eepAlias="a5-38-08"};r.STATES=["state","dimmerLevel"];r.prototype=new I;r.prototype.constructor=r;r.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3),d=a.userData.readUInt8(2),e=a.userData.readUInt8(1);a=a.userData.readUInt8(0);if(1==(b>>3&1))switch(a){case 2:c.dimmerLevel=e,c.ramp=d,c.dim_range=b>>2&1?"relative":"absolute",c.store_final_value=b>>1&1,c.state=b&1?"on":"off"}}return c};var p=function(a){Nc.call(this,
a);this.TEACH_IN_VARIATION=3;this._data="eltako_tf_alarm"};p.prototype=new Nc;p.prototype.constructor=p;p.prototype.evalTelegram=function(a){var c={};if(246==a.rorg)switch(a.userData){case 48:c.active=!0;break;case 16:c.active=!1}else 165==a.rorg&&(a=a.userData.readUInt8(3),8==a?c.alarm="ok":9==a&&(c.alarm="alarm"));return c};p.prototype.executeCommand=function(a,c,b){if(c&&c.value){var d=null;switch(c.value){case "triggerAlarm":d=new Buffer([1,0,0,9]);break;case "deactivate":d=new Buffer([1,0,0,
12]);break;case "activate":d=new Buffer([1,0,0,8]);break;default:b&&b(Error("unknow command"))}c=this._senderID;this._senderID||(c=x.hub.m.enocean.SENDER_ID);d=new x.hub.m.enocean.ESP3.Telegram.BS4(d,c,0);d.setDstId(this._address);a.sendTelegram(d,!0,function(a){b&&b(a)})}else b&&b(Error("command invalid"))};var n=function(a){F.call(this,a);this._data="eltako_f6t";this._vendor="eltako";this.BUTTONS="buttonCO buttonCI buttonBO buttonBI buttonAO buttonAI".split(" ")};n.STATES="buttonCO buttonCI buttonBO buttonBI buttonAO buttonAI".split(" ");
n.prototype=new F;n.prototype.constructor=n;n.prototype.evalTelegram=function(a){var c={};if(246==a.rorg){var b=parseInt(this._address,16),d=a.senderID?parseInt(a.senderID,16):null;if(d&&d==b+1)switch(a.userData){case 112:c.buttonCI="pressed";break;case 80:c.buttonCO="pressed";break;case 0:for(a=0;a<this.BUTTONS.length;a++)this.BUTTONS[a]&&(c[this.BUTTONS[a]]="released")}else switch(a.userData){case 112:c.buttonAI="pressed";break;case 80:c.buttonAO="pressed";break;case 48:c.buttonBI="pressed";break;
case 16:c.buttonBO="pressed";break;case 0:for(a=0;a<this.BUTTONS.length;a++)this.BUTTONS[a]&&(c[this.BUTTONS[a]]="released")}}return c};return{TF_TTB:a,TF_RWB:b,TF_FKB:e,TF_BHSB:g,TF_BHSB_FBH:f,TF_Input:h,TF_Thermo:l,TF_Lux:m,Dimmer_Knob:r,TF_Alarm:p,Eltako_F6T:n}}();return{"f6-??-??":e,"f6-01-01":k,"f6-02-01":h,"f6-02-02":l,"f6-02-03":r,"f6-02-04":m,"f6-03-01":u,"f6-03-02":y,"f6-04-01":C,"f6-04-02":J,"f6-05-00":K,"f6-05-01":z,"f6-05-02":w,"f6-10-00":Q,"f6-10-01":V,"d5-xx-xx":a,"d5-??-??":Y,"d5-00-01":P,
"f6-so-da":f,"a5-??-??":t,"a5-02-01":Z,"a5-02-02":L,"a5-02-03":pa,"a5-02-04":O,"a5-02-05":R,"a5-02-06":da,"a5-02-07":aa,"a5-02-08":ba,"a5-02-09":Qa,"a5-02-0a":v,"a5-02-0b":n,"a5-02-10":H,"a5-02-11":dc,"a5-02-12":Pa,"a5-02-13":ec,"a5-02-14":fc,"a5-02-15":Ga,"a5-02-16":gc,"a5-02-17":db,"a5-02-18":hc,"a5-02-19":ic,"a5-02-1a":jc,"a5-02-1b":kc,"a5-02-20":Ha,"a5-02-30":lc,"a5-04-01":mc,"a5-04-02":Ra,"a5-04-03":eb,"a5-06-01":Sa,"a5-06-02":Ia,"a5-06-03":fb,"a5-06-04":gb,"a5-06-05":nc,"a5-07-01":ea,"a5-07-02":Ta,
"a5-07-03":Ua,"a5-08-01":Va,"a5-08-02":oc,"a5-08-03":pc,"a5-09-02":hb,"a5-09-04":ib,"a5-09-05":jb,"a5-09-06":kb,"a5-09-07":lb,"a5-09-08":mb,"a5-09-09":nb,"a5-09-0a":ob,"a5-09-0b":pb,"a5-09-0c":qb,"a5-10-01":B,"a5-10-02":ma,"a5-10-03":Ja,"a5-10-04":rb,"a5-10-05":sb,"a5-10-06":Ca,"a5-10-07":tb,"a5-10-08":qa,"a5-10-09":ra,"a5-10-0a":Da,"a5-10-0b":Ka,"a5-10-0c":ub,"a5-10-0d":vb,"a5-10-10":S,"a5-10-11":Ea,"a5-10-12":wb,"a5-10-13":xb,"a5-10-14":yb,"a5-12-00":Ab,"a5-12-01":na,"a5-12-02":La,"a5-12-03":qc,
"a5-13-01":rc,"a5-13-02":sc,"a5-13-03":tc,"a5-13-04":uc,"a5-13-05":vc,"a5-13-06":wc,"a5-14-01":Bb,"a5-14-02":Cb,"a5-14-03":Db,"a5-14-04":Eb,"a5-14-05":Fb,"a5-14-06":Gb,"a5-14-07":Hb,"a5-14-08":Ib,"a5-14-09":Jb,"a5-14-0a":Kb,"a5-20-04":ka,"a5-30-01":Ma,"a5-30-02":Lb,"a5-30-03":X,"a5-30-04":Mb,"a5-38-08":I,"d2-??-??":ha,"d2-01-00":oa,"d2-01-01":Nb,"d2-01-03":Ob,"d2-01-11":Fa,"d2-01-13":sa,"d2-01-14":ta,"d2-05-00":N,"d2-05-01":za,"d2-06-01":Aa,"d2-06-02":Ba,"d2-06-10":Mc,"d2-06-50":b,"d2-20-00":ca,eltako_dimmer:G,
eltako_dimmer2:$a,eltako_fsud:Qb,eltako_motion:Na,eltako_contact:Pb,eltako_weather:Rb,eltako_lux:Oa,eltako_lux2:Cc,eltako_sender2:Ec,eltako_sender4:Fc,eltako_button1:Dc,eltako_button2:Gc,eltako_button4:Hc,eltako_blind:U,eltako_fsm60b:Sb,eltako_fkf:Tb,eltako_fkc:Ub,eltako_thermo:ua,eltako_ftr65hb:Vb,eltako_futh65d:Ic,eltako_ftr78s:Wb,eltako_powermeter:ab,eltako_powermeter2:Jc,eltako_fzs:bb,eltako_switch:la,eltako_relay:Yb,eltako_relay2:Xb,eltako_heat:Zb,eltako_water_m3:$b,eltako_water_m4:ac,eltako_tf_switch:Nc,
eltako_tf_dimmer:Pc,eltako_tf_blind:Qc,peha_switch:cb,peha_powerswitch:va,peha_blind:wa,"bb-aa-cc":A,afriso_water_con:Kc,afriso_water_eco:bc,afriso_asd_10:Lc,hoppe_door:cc,gp:Oc,afriso_ais_10:Rc,eltako_tf_ttb:xa.TF_TTB,eltako_tf_smoke:xa.TF_RWB,eltako_tf_contact:xa.TF_FKB,eltako_tf_motion:xa.TF_BHSB,eltako_motion2:xa.TF_BHSB_FBH,eltako_tf_thermo:xa.TF_Thermo,eltako_tf_input:xa.TF_Input,eltako_tf_lux:xa.TF_Lux,eltako_dimmer_knob:xa.Dimmer_Knob,eltako_tf_alarm:xa.TF_Alarm,eltako_f6t:xa.Eltako_F6T,parseDBJson:function(a){if(!a||
!a.eep)return null;var c=this[a.eep];if(!c)return null;c=new c;return c=c.fromDBJSON(a)},parseJson:function(a){if(!a||!a.data)return null;var c=this[a.data];if(!c)return null;c=new c;return c=c.fromJSON(a)}}}();
...
this._logger.log("info","config siegenia window:"+JSON.stringify(b));this._logger.log("info","window id:"+a+" sender id:"+e);var g=parseInt(b.alive),h=parseInt(b.sync),l=parseInt(b.eep),r=parseInt(b.type),m=parseInt(b.alarm);b=parseInt(b.alarm_sens);var u=[128,2,127,240,1,140,57,45,245],y=[192,13,127,242,49,0,0,2,g>>8&255],C=[193,g&255,0,1,2,h>>8&255,h&255,0,2],J=[194,1,l,0,3,1,r,0,4],K=[195,1,m,0,5,1,b,0,0],z=[128,2,127,240,2,140,57,45,245],w=this;this._logger.log("info","send config siegenia window (data1):"+
(new Buffer(u)).toString("hex"));this._esp3._recomm.sendRawSysEx(new Buffer(u),a,e,function(b){if(b&&(w._logger.log("warn","config siegenia window error (data1):"+b.message+" ["+b.code+"]"),100!=b.code)){f&&f(b);return}w._logger.log("info","send config siegenia window (data2):"+(new Buffer(y)).toString("hex"));w._esp3._recomm.sendRawSysEx(new Buffer(y),a,e,function(b){if(b&&(w._logger.log("warn","config siegenia window error (data2):"+b.message+" ["+b.code+"]"),100!=b.code)){f&&f(b);return}w._logger.log("info",
"send config siegenia window (data3):"+(new Buffer(C)).toString("hex"));w._esp3._recomm.sendRawSysEx(new Buffer(C),a,e,function(b){if(b&&(w._logger.log("warn","config siegenia window error (data3):"+b.message+" ["+b.code+"]"),100!=b.code)){f&&f(b);return}w._logger.log("info","send config siegenia window (data4):"+(new Buffer(J)).toString("hex"));w._esp3._recomm.sendRawSysEx(new Buffer(J),a,e,function(b){if(b&&(w._logger.log("warn","config siegenia window error (data4):"+b.message+" ["+b.code+"]"),
100!=b.code)){f&&f(b);return}w._logger.log("info","send config siegenia window (data5):"+(new Buffer(K)).toString("hex"));w._esp3._recomm.sendRawSysEx(new Buffer(K),a,e,function(b){if(b&&(w._logger.log("warn","config siegenia window error (data5):"+b.message+" ["+b.code+"]"),100!=b.code)){f&&f(b);return}w._logger.log("info","send config siegenia window (data6):"+(new Buffer(z)).toString("hex"));w._esp3._recomm.sendRawSysEx(new Buffer(z),a,e,function(a){a&&w._logger.log("warn","config siegenia window error (data5):"+
...
e);e.setHumiditySensorID(b);this._saveData(f)}else f&&f(Error("inoventID is null"))};f.prototype.setCo2Accessory=function(a,b,f){if(a){var e=this.getInoventAccessory(a);e||(e=new g(a),this._inoventAccessories[a]=e);e.setCo2SensorID(b);this._saveData(f)}else f&&f(Error("inoventID is null"))};f.prototype.activateSensorRegulation=function(a,b){(a=this.getInoventAccessory(a))&&a.activateSensorRegulation(b)};f.prototype.deactivateSensorRegulation=function(a){(a=this.getInoventAccessory(a))&&a.deactivateSensorRegulation()};
f.prototype.isWindowOpen=function(){var a=this._mainHandler.getDeviceHandler(),b=a.findDeviceWithData("bb-aa-cc");(a=a.findDeviceWithData("d2-06-10"))&&(b=b.concat(a));a=!1;for(var f=0;f<b.length;f++){var g=b[f];if(g&&"open"==g.getBufferedState("window")){a=!0;break}}return a};f.prototype.setAlarm=function(a,b){this._windowAlarm.setAlarm(a);var e=this._mainHandler.getDeviceHandler(),f=e.findDeviceWithData("bb-aa-cc");(e=e.findDeviceWithData("d2-06-10"))&&(f=f.concat(e));e=this._mainHandler.getESP3();
for(var g=0;g<f.length;g++){var k=f[g];k&&(k.executeCommand(e,{value:a?"alarmTaskOn":"alarmTaskOff"}),k.executeCommand(e,{value:a?"preAlarmTaskOn":"preAlarmTaskOff"}))}b&&b()};f.prototype.getAlarm=function(){return this._windowAlarm.getAlarm()};f.prototype.setSmartGuardAlarm=function(b,f,g){if(b){var e=this._smartguardSettings[b];e||(e=new a(b),this._smartguardSettings[b]=e);e.setAlarm(f);this._saveData(g)}else g&&g(Error("smartguardID invalid"))};f.prototype.setSmartGuardPreAlarm=function(b,f,g){if(b){var e=
this._smartguardSettings[b];e||(e=new a(b),this._smartguardSettings[b]=e);e.setPreAlarm(f);this._saveData(g)}else g&&g(Error("smartguardID invalid"))};f.prototype.onReceiveWindowSensorStates=function(a,b){this._windowAlarm.onReceiveWindowSensorStates(a,b)};f.prototype.onDeleteDevice=function(a){if(a&&(a=a.getAddress()))if(this.getInoventAccessory(a))this.deleteInoventAccessory(a);else if(this.getSmartguardSetting(a))this.deleteSmartguardSetting(a);else{var b=!1,e;for(e in this._inoventAccessories){var f=
this._inoventAccessories[e];f&&(f.getHumiditySensorID()==a&&(f.setHumiditySensorID(null),b=!0),f.getCo2SensorID()==a&&(f.setCo2SensorID(null),b=!0))}b&&this._saveData()}};f.prototype.onDeviceEvent=function(a,b){var e=function(a){for(var b=null,e=0;e<a.length;e++){var f=a[e];if(f&&"humidity"==f.key){b=f.value;break}}return b},f=function(a){for(var b=null,e=0;e<a.length;e++){var f=a[e];if(f&&"co2"==f.key){b=f.value;break}}return b};if(a){var g=a.getAddress();if(g){var k=null;switch(a.getData()){case "a5-04-01":case "a5-04-03":case "a5-10-12":k=
e(b);break;case "a5-09-08":case "a5-09-09":k=f(b);break;default:return}if(void 0!=k&&null!=k)for(var u in this._inoventAccessories)if(a=this._inoventAccessories[u])a.getHumiditySensorID()==g&&a.executeHumidityRegulation(k),a.getCo2SensorID()==g&&a.executeCo2Regulation(k)}}};f.prototype._loadInoventAccessories=function(a){var b=this;this._loadFile(function(e,f){e?a&&a(e):(e=b._jsonToAccessoriesMap(f),f=b._jsonToSmartGuardSettingsMap(f),a&&a(null,e,f))})};f.prototype._jsonToAccessoriesMap=function(a){if(!a||
!a.inovent)return{};var b={},e;for(e in a.inovent){var f=a.inovent[e];if(f){var r=new g(e);r.fromJSON(f);b[e]=r}}return b};f.prototype._jsonToSmartGuardSettingsMap=function(b){if(!b||!b.smartguard)return{};var e={},f;for(f in b.smartguard){var g=b.smartguard[f];if(g){var r=new a(f);r.fromJSON(g);e[f]=r}}return e};f.prototype._loadFile=function(a){var b=this._getFilePath();fs_extra.ensureFile(b,function(e){e?a&&a(e):fs_extra.readFile(b,"utf8",function(b,e){if(b)a&&a(b);else if(e)try{var f=JSON.parse(e);
a&&a(null,f)}catch(u){a&&a(u)}else a&&a(null,{})})})};f.prototype._getFilePath=function(){var a=require("x.hub.fileman.js").fileManager,b=require("path");require("fs");a=a.getUserRootDataPath();return b.resolve(a,this.REHAU_FILE)};f.prototype._saveData=function(a){var b=this._accessoriesMapToJson(this._inoventAccessories),e=this._settingsMapToJson(this._smartguardSettings);this._saveFile({inovent:b?b:{},smartguard:e?e:{}},function(b){a&&a(b)})};f.prototype._accessoriesMapToJson=function(a){if(!a)return{};
var b={},e;for(e in a){var f=a[e];f&&(f=f.toJSON(),b[e]=f)}return b};f.prototype._settingsMapToJson=function(a){if(!a)return{};var b={},e;for(e in a){var f=a[e];f&&(f=f.toJSON(),b[e]=f)}return b};f.prototype._saveFile=function(a,b){var e=this._getFilePath();fs_extra.writeFile(e,JSON.stringify(a,null,2),function(a){b&&b(a)})};return f}();
...
f.on("x.hub.peripheralman.ADD_SEIRAL",function(b){console.log("ADD_SEIRAL",b);b.type||a._usb.attachSerial(b.port)});f.on("x.hub.peripheralman.REMOVE_SEIRAL",function(b){console.log("REMOVE_SEIRAL",b);b.type||a._usb.removeSerial(b.port)});global.ENOCEAN_PORT&&"A20"!=global.PLATFORM&&"PI2"!=global.PLATFORM&&a._usb.attachSerial(global.ENOCEAN_PORT);this._secHandler.init(function(){a._rehauHandler.init(a,function(){a._deviceHandler.init(function(){b&&b({})})})})};g.prototype.getSystems=function(){return["enocean"]};
g.prototype.addStateDevice=function(b,a){a&&a({})};g.prototype.getAllStates=function(){var b=[],a=this._deviceHandler.getAllDevices(),f;for(f in a)if(a.hasOwnProperty(f)){var e=a[f];e&&b.push({device:e.toJSON(),states:e.getStatesBuffer()})}return b};g.prototype.getStates=function(b){if(!b||!b.address)return null;var a=null;(b=this._deviceHandler.getDevice(b.address.toLowerCase()))&&(a=b.getStatesBuffer());return a};g.prototype.getState=function(b,a,f){var e=this.getStates(b),g=null;e&&"undefined"!=
typeof e[a]&&null!=e[a]?(g=e[a],f&&f({data:g})):f&&this.updateStates(b,function(b){b.error?f&&f(b):(b.data&&(g=e[a]),f({data:g}))});return g};g.prototype.executeCommand=function(b,a,f){this._esp3._baseID?this._esp3._baseID.toLowerCase()!=x.hub.m.enocean.SENDER_ID.toLowerCase()?f&&f({error:Error("enocean stick has a different baseID")}):b&&b.address?((b=b.address)&&(b=b.toLowerCase()),(b=this._deviceHandler.getDevice(b))?b.executeCommand?b.executeCommand(this._esp3,a,function(a){f&&f({error:a})}):
f&&f({error:Error("device dese not support command")}):f&&f({error:Error("no such device")})):f&&f({error:Error("device invalid")}):f&&f({error:Error("enocean stick not found")})};g.prototype.checkDeviceMatch=function(b,a){if(!(a&&a.device&&b&&b.device))return!1;(b=b.device.address)&&(b=b.toLowerCase());(a=a.device.address)&&(a=a.toLowerCase());return b==a};g.prototype.updateStates=function(b,a){a&&a({error:Error("not supported yet")})};g.prototype.executeCommandLegacy=function(b,a,f,e){b?e&&e({error:Error("not supported yet")}):
this._esp3?a?this.executeCommand({address:a},{value:f},function(a){e&&e({error:a?a.error:null})}):e&&e({error:Error("address invalid")}):e&&e({error:Error("not inited")})};g.prototype.getAllStatesLegacy=function(b,a){var f=[],e=this.getAllStates(),g=this._secHandler.getUnsyncDevice(),h=this;e.forEach(function(b){if(b&&b.device&&b.states){var e=b.device.address,k={type:"ENOCEAN",adr:e,data:b.device.data,vendor:b.device.vendor,state:{}},l;for(l in b.states)k.state[l]=b.states[l].value;h._secHandler.isSecureDevice(e)?
(k.deviceProtocol="secure",k.state.security_state=g[e]?"nok":"ok"):k.deviceProtocol="normal";a&&"1"==a.config&&(k.senderID=b.device.senderID,k.virtual=b.device.virtual,k.params=b.device.params,e&&g[e]&&(k.rlc_unsync=!0));f.push(k)}});b&&b({data:f})};g.prototype.getEnoceanInfo=function(){return{baseID:x.hub.m.enocean.SENDER_ID,usb_connected:null!=this._esp3._serial,usb_baseID:this._esp3._baseID,num_free_senderID:this._deviceHandler.getFreeSenderIdCount()}};g.prototype.learnDevice=function(b,a){var f=
b?b.senderID:null,e=b?b.data:null,g=b?b.vendor:null,h=b?b.address:null;if(h){e=this._deviceHandler.findDevice(b);if(!e){a&&a({error:Error("device not found")});return}var l=e.toJSON();e=l.data;g=l.vendor;f||(sednerID=l.senderID)}l={};l.saLearnMode=b?b.saLearnMode:null;this._learnHandler.learn(e,h,f,g,null,function(b,e,f){b?a&&a({error:b}):(b={},1==e?b.op=1:(b=f.toJSON(),b.op=0),a&&a({data:b}))},l)};g.prototype.learnSoda=function(b){if(this._esp3._serial){var a=this,f=setTimeout(function(){a._esp3.removeListener(e);
b&&b({error:Error("learn timeout")})},2E4),e={_onEOTelegram:function(g){if(246==g.rorg&&(192==g.userData||208==g.userData||240==g.userData)){clearTimeout(f);a._esp3.removeListener(e);var h={address:g.senderID,data:"f6-so-da",vendor:"soda"};a.addSensor(g.senderID,"f6-so-da","soda",null,function(a){a.error?b&&b(a):b&&b({data:h})})}}};this._esp3.addListener(e)}else b&&b({error:Error("port not opened")})};g.prototype.teachinDevice=function(b,a){if(b)if(b.data){b.adr&&!b.address&&(b.address=b.adr);var f=
this._deviceHandler.findDevice(b);f=f?f.toJSON():b;b.data!=f.data?a&&a({error:Error("device of another type with the same address exists")}):b.vendor&&b.vendor!=f.vendor?a&&a({error:Error("device of another vendor with the same address exists")}):this._learnHandler.teachin(f.data,f.address,f.senderID,f.vendor,function(b,f,g){b?a&&a({error:b}):(b={},f&&(b=f.toJSON()),g&&(b.op=g),a&&a({data:b}))})}else a&&a({error:Error("data is null")});else a&&a({error:Error("query is null")})};g.prototype.generateVirtualDevice=
function(b,a){this._deviceHandler.generateVirtual(b,function(b,e){a&&a({error:b,data:e?e.toJSON():null})})};g.prototype._onEOFrame=function(b,a){this._trackers.forEach(function(f){f.onFrame(b,a)})};g.prototype._onEOTelegram=function(b){this._trackers.forEach(function(a){a.onTelegram(b)});var a=this._deviceHandler.getDevice(b.senderID);if(a){var f=this;a.evalData(this._esp3,b,function(b,g){b||0==g.length||f._onEOEvents(a,g)})}};g.prototype._onEOEvents=function(b,a){var f=require("x.hub.eventbus.js");
this._trackers.forEach(function(e){e.onResolveEvents(b._address,a)});this._rehauHandler.onDeviceEvent(b,a);var e=b.toJSON();e.sys="aio";e.type="ENOCEAN";for(var g=0,h=0;h<a.length;h++){var l=a[h];if(l&&("shortPress"==l.value||"longPress"==l.value||"pressed"==l.value||"released"==l.value)){g++;var r={type:"ENOCEAN",adr:e.address,data:e.data,vendor:e.vendor,state:{}};r.state[l.key]=l.value;f.emit("gatewayevent",r,{address:"ENOCEAN"},"BTN")}}if(g==a.length)(e=b.getStatesLegacy())&&f.emit("udpevent",
e,"STA");else if(e=b.getStatesLegacy())f.emit("gatewayevent",e,{address:"ENOCEAN"},"STA"),f.emit("udpevent",e,"STA")};g.prototype._saveEnoceanEvents=function(b,a){var f=require("x.hub.datastore.js").dataStore;f&&f.openDB(function(e,f){if(!e){e=b._address;for(var g=[],k=(new Date).toISOString(),r=0;r<a.length;r++){var m=a[r];if(m&&m.changed){m=m.key+":"+m.value;var u=null;u=0==g.length?"SELECT '"+e+"' AS 'window', '"+m+"' AS 'state', '"+k+"' AS 'time'":"UNION ALL SELECT '"+e+"', '"+m+"', '"+k+"'";
g.push(u)}}0<g.length&&(e=g.join(" "),f.run("INSERT INTO windowstate(window, state, time) "+e+";",function(a){f.close()}))}})};g.prototype.addSensor=function(b,a){b?b.data?"siegenia"!=b.vendor||b.params?this._deviceHandler.addDevice(b,function(b,e){a&&a({error:b,data:e?e.toJSON():null})}):a&&a({error:Error("siegenia windows params is null")}):a&&a({error:Error("enocean profile is null")}):a&&a({error:Error("enocean device is null")})};g.prototype.updateSensor=function(b,a,f){b?a?this._deviceHandler.updateDevice(b,
a,function(a,b){f&&f({error:a,data:b?b.toJSON():null})}):f&&f({error:Error("device info is null")}):f&&f({error:Error("device address is null")})};g.prototype.delSensor=function(b,a){b?this._deviceHandler.deleteDevice({address:b},function(b){a&&a({error:b})}):a&&a({error:Error("enocean id is null")})};g.prototype.resetDefaultSenderID=function(b){x.hub.m.enocean.SENDER_ID=null;localStorage&&localStorage.setItem("x.hub.m.enocean.SENDER_ID","");b&&b({})};g.prototype.setRehauAlarm=function(b,a){this._rehauHandler.setAlarm(b,
a)};g.prototype.isRehauWindowOpen=function(){return this._rehauHandler.isWindowOpen()};g.prototype.setInoventHumidityAccessory=function(b,a,f){this._rehauHandler.setHumidityAccessory(b,a,function(a){f&&f({error:a})})};g.prototype.setInoventCo2Accessory=function(b,a,f){this._rehauHandler.setCo2Accessory(b,a,function(a){f&&f({error:a})})};g.prototype.getInoventAccessories=function(b,a){b=this._rehauHandler.getInoventAccessory(b);a&&a({data:b?b.toJSON():{}})};g.prototype.__addTelegramTracker=function(b){b&&
b.onTelegram&&b.onResolveEvents&&-1==this._trackers.indexOf(b)&&this._trackers.push(b)};g.prototype.__removeTelegramTracker=function(b){b&&(b=this._trackers.indexOf(b),-1!=b&&this._trackers.splice(b,1))};g.prototype.__sendEspFrame=function(b,a,f,e,g){a=a?new Buffer(a,"hex"):null;f=f?new Buffer(f,"hex"):null;e=e?!0:!1;b=new x.hub.m.enocean.ESP3.ESP3_Frame(b,a,f);this._esp3.sendFrame(b,e,function(a,b){g&&g({error:a,data:b?b.toJSON():null})})};g.prototype.__simulateRawEnoceanPacket=function(b,a){this._esp3.onSerialData(new Buffer(b,
"hex"));a&&a()};g.prototype._doSDK=function(b,a){if(b&&b.method){var f="send_"+b.method;if(this._sdk[f])this._sdk[f](b.params,function(b){a&&a({error:b})});else a&&a({error:Error("no such method")})}else a&&a({error:Error("data invalid")})};return g}();"undefined"!=typeof exports&&"undefined"!=typeof module&&module.exports&&(exports=module.exports=new x.hub.m.enocean.Handler);
