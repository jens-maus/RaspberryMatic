...
function(){return M.resolve(this)};d.resolve=function(a){return new d(a.data)};var l=function(a){this.data=a};l.prototype.toJSON=function(){return{data:this.data.toString("hex")}};l.prototype.toFrame=function(){return new e(5,this.data,null)};l.prototype.toCommandCommand=function(){return pa.resolve(this)};l.resolve=function(a){return new l(a.data)};var h=function(a){this.data=a};h.prototype.toJSON=function(){return{data:this.data.toString("hex")}};h.prototype.toFrame=function(){return new e(4,this.data,
...
v.ESP3_Frame=e;v.Telegram=k;v.RADIO_ERP1_Packet=g;v.Event=m;v.Response=t;v.COMMAND_COMMAND=pa;v.SA_COMMAND=M;return v}();
...
K.prototype=new m;K.prototype.constructor=K;var pa=function(c){m.call(this,c);this._data="a5-02-03";this._tmpMin=-20;this._tmpMax=20};pa.STATES=["temperature","temperature_raw"];pa.prototype=new m;pa.prototype.constructor=pa;var M=function(c){m.call(this,c);this._data="a5-02-04";this._tmpMin=-10;this._tmpMax=30};M.STATES=["temperature","temperature_raw"];M.prototype=new m;M.prototype.constructor=M;var P=function(c){m.call(this,c);this._data="a5-02-05";this._tmpMin=0;this._tmpMax=40};P.STATES=["temperature",
...
b;a&=1;switch(a){case 0:f.button="pressed";break;case 1:f.button="released"}f.button_raw=a}}return f};D.prototype.fromJSON=function(c){if(!e.prototype.fromJSON.call(this,c))return null;this._params||(this._params={minSP:18,maxSP:26});return this};D.prototype.fromDBJSON=function(c){if(!e.prototype.fromDBJSON.call(this,c))return null;this._params||(this._params={minSP:18,maxSP:26});return this};var ma=function(c){D.call(this,c);this._data="a5-10-02"};ma.STATES="fan_speed fan_speed_raw setpoint setpoint_raw temperature temperature_raw slider slider_raw".split(" ");
ma.prototype=new D;ma.prototype.constructor=ma;ma.prototype.evalTelegram=function(c){var f=D.prototype.evalTelegram.call(this,c);if(0==Object.keys(f).length)return f;delete f.button;delete f.button_raw;c=c.userData.readUInt8(3)&1;f.slider=c?"day":"night";f.slider_raw=c;return f};var Ia=function(c){D.call(this,c);this._data="a5-10-03";this.TEACH_IN_VARIATION=1};Ia.STATES=["setpoint","setpoint_raw","temperature","temperature_raw"];Ia.prototype=new D;Ia.prototype.constructor=Ia;Ia.prototype.evalTelegram=
...
"channel"];Ab.prototype=new ea;Ab.prototype.constructor=Ab;Ab.prototype.evalTelegram=function(c){c=ea.prototype.evalTelegram.call(this,c);c.counter=c.cumulative;c.channel=c.channel_raw;return c};var na=function(c){ea.call(this,c);this._data="a5-12-01"};na.STATES=["power","energy","tariff"];na.prototype=new ea;na.prototype.constructor=na;na.prototype.evalTelegram=function(c){c=ea.prototype.evalTelegram.call(this,c);c.energy=c.cumulative;c.power=c.current;c.tariff=c.channel_raw;return c};var Ka=function(c){ea.call(this,
...
function(c,a,b){if(a=this.evalTelegram(a)){var f=this;this._sendResponse(c,a,function(c,a){c=f.checkStateChange(a);b&&b(null,c)})}else b&&b(Error("data format invalid"))};ja.prototype.evalTelegram=function(c){var a={};if(165==c.rorg){var b=c.userData.readUInt8(3),d=c.userData.readUInt8(2),e=c.userData.readUInt8(1);c=c.userData.readUInt8(0);if(1==(b>>3&1)){a.valve=c;a.measurement=b>>7&1?"inactive":"active";a.button_lock=b>>2&1?"locked":"unlocked";c=b>>1&1;b&=1;a.temperature_selection=c?"setpoint":
...
"W";break;case 4:a.unit="KW"}a.io_channel=l;a.value=b}}}return a};var oa=function(c){G.call(this,c);this._data="d2-01-00"};oa.COMMANDS=["on","off","toggle"];oa.STATES="power_failure_detection power_failure over_current_switch_off error_level io_channel local_control output_value output_state".split(" ");oa.prototype=new G;oa.prototype.constructor=oa;oa.prototype.getIOs=function(){return[0]};oa.prototype.executeCommand=function(c,a,b){if(a&&a.value){var f=this;switch(a.value){case "on":this.activeStateChange({output_value:100,
output_state:"on"});this.setOutput(c,{DV:0,IO:0,OV:100},b);break;case "off":this.activeStateChange({output_value:0,output_state:"off"});this.setOutput(c,{DV:0,IO:0,OV:0},b);break;case "toggle":this._states.output_state?this.executeCommand(c,{value:"on"==this._states.output_state.value?"off":"on"},b):this.init(function(){setTimeout(function(){f._states.output_state?f.executeCommand(c,a,b):b&&b(Error("unkown current status"))},200)})}}else b&&b(Error("command invalid"))};var Nb=function(c){oa.call(this,
c);this._data="d2-01-01"};Nb.COMMANDS=["on","off","toggle"];Nb.STATES="power_failure_detection power_failure over_current_switch_off error_level io_channel local_control output_value output_state".split(" ");Nb.prototype=new oa;Nb.prototype.constructor=Nb;var Ob=function(c){oa.call(this,c);this._data="d2-01-03";this._lastOnLevel=-1};Ob.prototype=new oa;Ob.prototype.constructor=Ob;Ob.prototype.evalData=function(c,a,b){(c=this.evalTelegram(a))?((0==c.output_value||"off"==c.output_state)&&this._states.output_value&&
...
sa.prototype._queryStates=function(a,f){var c=require("x.hub.m.enocean.js")._esp3,b=0,d=this,e=function(){b++;b<a.length?d.statusQuery(c,{IO:a[b]},e):f&&f()};this.statusQuery(c,{IO:a[b]},e)};sa.prototype.getIOs=function(){return[0,1,2,3]};sa.prototype.evalTelegram=function(a){if(a=G.prototype.evalTelegram.call(this,a))switch(a.io_channel){case 0:a.ch1_output_value=a.output_value;a.ch1_output_state=a.output_state;break;case 1:a.ch2_output_value=a.output_value;a.ch2_output_state=a.output_state;break;
case 2:a.ch3_output_value=a.output_value;a.ch3_output_state=a.output_state;break;case 3:a.ch4_output_value=a.output_value,a.ch4_output_state=a.output_state}return a};sa.prototype.executeCommand=function(a,f,b){if(f&&f.value){var c=this;switch(f.value?f.value.substr(0,3):null){case "ch1":var d=0;var e="ch1_output_value";var g="ch1_output_state";break;case "ch2":d=1;e="ch2_output_value";g="ch2_output_state";break;case "ch3":d=2;e="ch3_output_value";g="ch3_output_state";break;case "ch4":d=3,e="ch4_output_value",
...
c.executeCommand(a,f,b):b&&b(Error("unkown current status"))},200)});break}if(!this._states[g]){b&&b(Error("state unknown"));break}h="on"==this._states[g].value?"off":"on";r={};r[e]="on"==h?100:0;r[g]=h;h={DV:0,IO:d,OV:"on"==h?100:0};this.activeStateChange(r);this.setOutput(a,h,b);break;default:b&&b(Error("unknown command"))}}else b&&b(Error("command invalid"))};var ta=function(a){G.call(this,a);this._data="d2-01-14";this._queryInterval=3E4};ta.COMMANDS="ch1On ch1Off ch1Toggle ch2On ch2Off ch2Toggle ch3On ch3Off ch3Toggle ch4On ch4Off ch4Toggle ch5On ch5Off ch5Toggle ch6On ch6Off ch6Toggle ch7On ch7Off ch7Toggle ch8On ch8Off ch8Toggle".split(" ");
ta.STATES="power_failure_detection power_failure over_current_switch_off error_level io_channel local_control output_value output_state ch1_output_value ch1_output_state ch2_output_value ch2_output_state ch3_output_value ch3_output_state ch4_output_value ch4_output_state ch5_output_value ch5_output_state ch6_output_value ch6_output_state ch7_output_value ch7_output_state ch8_output_value ch8_output_state".split(" ");ta.prototype=new G;ta.prototype.constructor=ta;ta.prototype._queryStates=function(a,
f){var c=require("x.hub.m.enocean.js")._esp3,b=0,d=this,e=function(){b++;b<a.length?d.statusQuery(c,{IO:a[b]},e):f&&f()};this.statusQuery(c,{IO:a[b]},e)};ta.prototype.getStatesBuffer=function(){var a=(new Date).getTime(),f=[];this._states.ch1_output_state||(!this._lastQuery[0]||a-this._lastQuery[0]>this._queryInterval)&&f.push(0);this._states.ch2_output_state||(!this._lastQuery[1]||a-this._lastQuery[1]>this._queryInterval)&&f.push(1);this._states.ch3_output_state||(!this._lastQuery[2]||a-this._lastQuery[2]>
...
(c=x.hub.m.enocean.SENDER_ID);if(b.TYPE){var f=Math.round(10*b.TIME)>>8&255;var e=Math.round(10*b.TIME)&255}else f=0,e=Math.round(b.TIME)&255;b=new Buffer([f,e,b.CMD,8|(b.LCK&1)<<2|(b.TYPE&1)<<1]);c=new x.hub.m.enocean.ESP3.Telegram.BS4(b,c,0);c.setDstId(this._address);a.sendTelegram(c,!0,function(a){d&&d(a)})};var Sc=function(){var a=function(a){T.call(this,a);this.TEACH_IN_VARIATION=3;this._data="eltako_tf_blind"};a.prototype=new T;a.prototype.constructor=a;a.prototype.handleTeachinTelegram=function(a,
...
Ub.prototype=new d;Ub.prototype.constructor=Ub;Ub.prototype.evalTelegram=function(a){var b={};if(246==a.rorg)switch(a.userData){case 48:b.keycard="guest_card";case 32:b.keycard="service_card";case 16:b.keycard="inserted";case 0:b.keycard="takeout"}return b};var la=function(a){Ba.call(this,a);this._data="eltako_thermo";this._vendor="eltako";this._eepAlias="a5-10-06"};la.STATES="setpoint setpoint_raw temperature temperature_raw night_reduce night_reduce_raw".split(" ");la.prototype=new Ba;la.prototype.constructor=
la;la.prototype.evalTelegram=function(a){var b={};if(165==a.rorg){var c=a.userData.readUInt8(3),d=a.userData.readUInt8(2),e=a.userData.readUInt8(1);a=a.userData.readUInt8(0);1==(c>>3&1)&&(b.night_reduce=6>=a?0:12>=a?1:19>=a?2:25>=a?3:31>=a?4:5,b.night_reduce_raw=a,b.setpoint=parseFloat((e/255*40).toFixed(1)),b.setpoint_raw=e,b.temperature=parseFloat(((255-d)/255*40).toFixed(1)),b.temperature_raw=d)}return b};var Vb=function(a){la.call(this,a);this._data="eltako_ftr65hb";this._vendor="eltako";this._eepAlias=
"a5-10-06"};Vb.STATES=["setpoint","setpoint_raw","temperature","temperature_raw"];Vb.prototype=new la;Vb.prototype.constructor=Vb;Vb.prototype.evalTelegram=function(a){var b={};if(165==a.rorg){var c=a.userData.readUInt8(3),d=a.userData.readUInt8(2);a=a.userData.readUInt8(1);1==(c>>3&1)&&(b.setpoint=parseFloat((a/255*40).toFixed(1)),b.setpoint_raw=a,b.temperature=parseFloat(((255-d)/255*40).toFixed(1)),b.temperature_raw=d)}return b};var Ic=function(a){la.call(this,a);this._data="eltako_futh55d";this._vendor=
"eltako";this._eepAlias="a5-10-12"};Ic.STATES="setpoint setpoint_raw temperature temperature_raw night_reduce night_reduce_raw".split(" ");Ic.prototype=new la;Ic.prototype.constructor=Ic;var Jc=function(a){la.call(this,a);this._data="eltako_futh65d";this._vendor="eltako";this._eepAlias="a5-10-12"};Jc.STATES="setpoint setpoint_raw temperature temperature_raw night_reduce night_reduce_raw".split(" ");Jc.prototype=new la;Jc.prototype.constructor=Jc;var Wb=function(a){Ia.call(this,a);this._data="eltako_ftr78s";
this._vendor="eltako";this._eepAlias="a5-10-03"};Wb.STATES=["setpoint","setpoint_raw","temperature","temperature_raw"];Wb.prototype=new Ia;Wb.prototype.constructor=Wb;Wb.prototype.evalTelegram=function(a){var b={};if(165==a.rorg){var c=a.userData.readUInt8(3),d=a.userData.readUInt8(2);a=a.userData.readUInt8(1);1==(c>>3&1)&&(b.setpoint=parseFloat((a/255*22+8).toFixed(1)),b.setpoint_raw=a,b.temperature=parseFloat(((255-d)/255*40).toFixed(1)),b.temperature_raw=d)}return b};var ab=function(a){na.call(this,
a);this._data="eltako_powermeter";this._vendor="eltako";this._eepAlias="a5-12-01"};ab.STATES=["power","energy","tariff"];ab.prototype=new na;ab.prototype.constructor=ab;ab.prototype.evalTelegram=function(a){var b=na.prototype.evalTelegram.call(this,a);165==a.rorg&&143==a.userData.readUInt8(3)&&(b={});return b};var Kc=function(a){na.call(this,a);this._data="eltako_powermeter2";this._vendor="eltako";this._eepAlias="a5-12-01"};Kc.STATES=["power","tariff"];Kc.prototype=new na;Kc.prototype.constructor=
ab;Kc.prototype.evalTelegram=function(a){a=na.prototype.evalTelegram.call(this,a);delete a.energy;delete a.tariff;return a};var bb=function(a){H.call(this,a);this._data="eltako_fzs"};bb.STATES=["button"];bb.prototype=new H;bb.prototype.constructor=bb;bb.prototype.evalTelegram=function(a){var b={};if(246==a.rorg)switch(a.userData){case 48:b.button="pressed";break;case 0:b.button="released"}return b};bb.prototype.checkStateChange=function(a){var b=this._states,c=[],d=(new Date).getTime(),e;for(e in a){var g=
{};g.key=e;g.value=a[e];g.changed=!1;var h=b[e]?b[e].value:null,l=b[e]?b[e].time:null,k=a[e];h!=k&&(g.oldvalue=h,g.changed=!0);this._states[e]={value:a[e],time:d};g.changed&&c.push(g);"pressed"==h&&"released"==k&&(!l||d-l<this._longPressThreshold?(g={},g.key=e,g.value="shortPress"):(g={},g.key=e,g.value="longPress"),g.changed=!0,c.push(g))}return c};var Xb=function(a){h.call(this,a);this._data="eltako_relay2";this._vendor="eltako";this._eepAlias="f6-02-01"};Xb.STATES=["ch1","ch2"];Xb.prototype=new h;
Xb.prototype.constructor=Xb;Xb.prototype.evalTelegram=function(a){var b={};if(246==a.rorg)switch(a.userData){case 112:b.ch1="on";break;case 80:b.ch1="off";break;case 48:b.ch2="on";break;case 16:b.ch2="off"}return b};var Yb=function(a){h.call(this,a);this._data="eltako_relay";this._vendor="eltako";this._eepAlias="f6-02-01"};Yb.STATES=["state"];Yb.prototype=new h;Yb.prototype.constructor=Yb;Yb.prototype.evalTelegram=function(a){var b={};if(246==a.rorg)switch(a.userData){case 112:b.state="on";break;
case 80:b.state="off"}return b};var Zb=function(a){W.call(this,a);this._data="eltako_heat";this._vendor="eltako";this._eepAlias="a5-30-03"};Zb.STATES=["temperature","temperature_raw","alarm","alarm_raw"];Zb.prototype=new W;Zb.prototype.constructor=Zb;Zb.prototype.evalTelegram=function(a){var b={};if(165==a.rorg){var c=a.userData.readUInt8(3),d=a.userData.readUInt8(2),e=a.userData.readUInt8(1);a.userData.readUInt8(0);1==(c>>3&1)&&(b.temperature=parseFloat(((255-e)/255*40).toFixed(1)),b.temperature_raw=
e,b.alarm=15==d?"alarm":"ok",b.alarm_raw=d)}return b};var $b=function(a){W.call(this,a);this._data="eltako_water_m3";this._vendor="eltako";this._eepAlias="a5-30-03"};$b.STATES=["water","water_raw"];$b.prototype=new W;$b.prototype.constructor=$b;$b.prototype.evalTelegram=function(a){var b={};if(165==a.rorg){var c=a.userData.readUInt8(3);a=a.userData.readUInt8(2);1==(c>>3&1)&&(b.water=15==a,b.water_raw=a)}return b};var ac=function(a){La.call(this,a);this._data="eltako_water_m4";this._vendor="eltako";
this._eepAlias="a5-30-01"};ac.STATES=["water","water_raw"];ac.prototype=new La;ac.prototype.constructor=ac;ac.prototype.evalTelegram=function(a){var b={};if(165==a.rorg){var c=a.userData.readUInt8(3);a=a.userData.readUInt8(2);1==(c>>3&1)&&(b.water=0==a,b.water_raw=a)}return b};var va=function(a){J.call(this,a);this.TEACH_IN_VARIATION=3;this._data="peha_powerswitch";this._vendor="peha";this._eepAlias="a5-38-08"};va.COMMANDS=["on","off","toggle"];va.STATES="state state_raw level rgb power energy current voltage power_raw power_unit energy_unit current_unit voltage_unit power_unit_raw op_hour error error_raw service_mode op_hour_flag op_hour_flag_raw mode_raw".split(" ");
va.prototype=new J;va.prototype.constructor=va;va.prototype.getTeachinType=function(){return"4BS"};va.prototype.evalTelegram=function(a){return Ya.prototype.evalTelegram.call(this,a)};va.prototype.executeCommand=function(a,b,d){if(b&&b.value){(new Date).getTime();var c=this;switch(b.value){case "on":this.switching(a,{TIM:0,LCK:0,DEL:0,SW:1},function(a){a||c.activeStateChange({state:"on"});d&&d(a)});break;case "off":this.switching(a,{TIM:0,LCK:0,DEL:0,SW:0},function(a){a||c.activeStateChange({state:"off"});
...
originalEEP:this._originalEEP}};B.prototype.fromDBJSON=function(a){if(!a||!a.id||!a.eep||a.eep!=this._data)return null;this._address=a.id;this._senderID=a.senderID;this._vendor=a.vendor?a.vendor:this._vendor;this._virtual=a.virtual?!0:!1;this._params=a.params;this._hopCount=a.hopCount;this._saLearnMode=a.saLearnMode;a.originalEEP&&(this._originalEEP=a.originalEEP);this.setDefaultParams();return this};var Oc=function(a){B.call(this,a);this._data="d2-06-10"};Oc.prototype=new B;Oc.prototype.constructor=
Oc;var Lc=function(a){B.call(this,a);this._data="d2-06-ff"};Lc.prototype=new B;Lc.prototype.constructor=Lc;Lc.prototype.evalTelegram=function(a){var b={},c=!1;if(210==a.rorg){if(1==a.userData.length)c=a.userData.readUInt8(0);else{var d=a.userData.readUInt8(0);c=a.userData.readUInt8(1)}2==a.userData.length&&(b.battery=d);a=c>>2&3;b.pre_alarm=c>>7&1?!0:!1;b.alarm=c>>6&1?!0:!1;b.window=a?"closed":"open";b.pre_alarm_enabled_device=c>>4&1?!0:!1;0==a?b.window="closed":1==a?b.window="tilted":3==a&&(b.window=
"open");c=!0}else 208==a.rorg&&(c=a.userData.readUInt8(0),b.battery=c,c=!0);return c?b:null};var Mc=function(a){W.call(this,a);this._data="afriso_water_con";this._vendor="afriso";this._eepAlias="a5-30-03"};Mc.prototype=new W;Mc.prototype.constructor=Mc;Mc.prototype.evalTelegram=function(a){var b={};if(165==a.rorg){var c=a.userData.readUInt8(3),d=a.userData.readUInt8(2);a=a.userData.readUInt8(1);1==(c>>3&1)&&(b.temperature=(255-a)/255*40,b.temperature_raw=a,b.water=0==(d>>4&1)?!0:!1)}return b};var bc=
function(a){w.call(this,a);this._data="afriso_water_eco";this._vendor="afriso";this._eepAlias="f6-05-01"};bc.prototype=new w;bc.prototype.constructor=bc;bc.prototype.evalTelegram=function(a){var b={};246==a.rorg&&(a=a.nu,1==a?b.water="true":0==a&&(b.water="false"));return b};bc.prototype.onLearn=function(){this._states.water={value:!1,time:(new Date).getTime()}};var Nc=function(a){W.call(this,a);this._data="afriso_asd_10";this._vendor="afriso";this._eepAlias="a5-30-03"};Nc.prototype=new W;Nc.prototype.constructor=
Nc;Nc.prototype.evalTelegram=function(a){var b={};if(165==a.rorg){var c=a.userData.readUInt8(3),d=a.userData.readUInt8(2);a=a.userData.readUInt8(1);1==(c>>3&1)&&(b.temperature=(255-a)/255*40,b.temperature_raw=a,b.smoke=0==(d>>4&1)?!0:!1)}return b};var cc=function(a){O.call(this,a);this._data="hoppe_door";this._vendor="hoppe";this._eepAlias="f6-10-00"};cc.STATES=["door"];cc.prototype=new O;cc.prototype.constructor=cc;cc.prototype.evalTelegram=function(a){var b={};246==a.rorg&&(a=a.userData,0==(a&208^
192)?b.door="open":0==(a&240^240)&&(b.door="closed"),b.handle_raw=a);return b};var Qc=function(){var a=function(a){e.call(this,a);this._data="gp";this._gpInfo=null};a.prototype=new e;a.prototype.constructor=a;a.prototype.toJSON=function(){var a=e.prototype.toJSON.call(this);a.gpInfo=this._gpInfo;return a};a.prototype.fromJSON=function(a){if(!e.prototype.fromJSON.call(this,a))return null;a&&a.gpInfo&&(this._gpInfo=a.gpInfo);return this};a.prototype.toDBJSON=function(){var a=e.prototype.toDBJSON.call(this);
a.gpInfo=this._gpInfo;return a};a.prototype.fromDBJSON=function(a){if(!e.prototype.fromDBJSON.call(this,a))return null;a&&a.gpInfo&&(this._gpInfo=a.gpInfo);return this};return a}(),Tc=function(){var a=function(a){Qc.call(this,a);this._data="afriso_ais_10";this._vendor="afriso";this._eepAlias="gp"};a.prototype=new Qc;a.prototype.constructor=a;a.prototype.isGPMatch=function(a,b){return 45!=a?!1:8==b};a.prototype.evalTelegram=function(a){var b={};if(178==a.rorg){var c=a.data.readUInt8(0)>>7&1,d=a.data.readUInt8(0)>>
...
c>>2&1?"relative":"absolute",b.store_final_value=c>>1&1,b.state=c&1?"on":"off"}}return b};var m=function(a){Pc.call(this,a);this.TEACH_IN_VARIATION=3;this._data="eltako_tf_alarm"};m.prototype=new Pc;m.prototype.constructor=m;m.prototype.evalTelegram=function(a){var b={};if(246==a.rorg)switch(a.userData){case 48:b.active=!0;break;case 16:b.active=!1}else 165==a.rorg&&(a=a.userData.readUInt8(3),8==a?b.alarm="ok":9==a&&(b.alarm="alarm"));return b};m.prototype.executeCommand=function(a,b,c){if(b&&b.value){var d=
...
"f6-03-02":u,"f6-04-01":E,"f6-04-02":y,"f6-05-00":C,"f6-05-01":w,"f6-05-02":A,"f6-10-00":O,"f6-10-01":U,"d5-xx-xx":a,"d5-??-??":X,"d5-00-01":N,"f6-so-da":g,"a5-??-??":t,"a5-02-01":Y,"a5-02-02":K,"a5-02-03":pa,"a5-02-04":M,"a5-02-05":P,"a5-02-06":ca,"a5-02-07":Z,"a5-02-08":aa,"a5-02-09":Qa,"a5-02-0a":v,"a5-02-0b":z,"a5-02-10":Oa,"a5-02-11":dc,"a5-02-12":Pa,"a5-02-13":ec,"a5-02-14":fc,"a5-02-15":Ga,"a5-02-16":gc,"a5-02-17":db,"a5-02-18":hc,"a5-02-19":ic,"a5-02-1a":jc,"a5-02-1b":kc,"a5-02-20":Fa,"a5-02-30":lc,
"a5-04-01":mc,"a5-04-02":Ra,"a5-04-03":eb,"a5-06-01":Sa,"a5-06-02":Ha,"a5-06-03":fb,"a5-06-04":gb,"a5-06-05":nc,"a5-07-01":da,"a5-07-02":Ta,"a5-07-03":Ua,"a5-08-01":Va,"a5-08-02":oc,"a5-08-03":pc,"a5-09-02":hb,"a5-09-04":ib,"a5-09-05":jb,"a5-09-06":kb,"a5-09-07":lb,"a5-09-08":mb,"a5-09-09":nb,"a5-09-0a":ob,"a5-09-0b":pb,"a5-09-0c":qb,"a5-10-01":D,"a5-10-02":ma,"a5-10-03":Ia,"a5-10-04":rb,"a5-10-05":sb,"a5-10-06":Ba,"a5-10-07":tb,"a5-10-08":qa,"a5-10-09":ra,"a5-10-0a":Ca,"a5-10-0b":Ja,"a5-10-0c":ub,
"a5-10-0d":vb,"a5-10-10":Q,"a5-10-11":Da,"a5-10-12":wb,"a5-10-13":xb,"a5-10-14":yb,"a5-12-00":Ab,"a5-12-01":na,"a5-12-02":Ka,"a5-12-03":qc,"a5-13-01":rc,"a5-13-02":sc,"a5-13-03":tc,"a5-13-04":uc,"a5-13-05":vc,"a5-13-06":wc,"a5-14-01":Bb,"a5-14-02":Cb,"a5-14-03":Db,"a5-14-04":Eb,"a5-14-05":Fb,"a5-14-06":Gb,"a5-14-07":Hb,"a5-14-08":Ib,"a5-14-09":Jb,"a5-14-0a":Kb,"a5-20-04":ja,"a5-30-01":La,"a5-30-02":Lb,"a5-30-03":W,"a5-30-04":Mb,"a5-38-08":J,"d2-??-??":fa,"d2-01-00":oa,"d2-01-01":Nb,"d2-01-03":Ob,
"d2-01-11":Ea,"d2-01-13":sa,"d2-01-14":ta,"d2-05-00":S,"d2-05-01":ua,"d2-06-01":za,"d2-06-02":Aa,"d2-06-10":Oc,"d2-06-ff":Lc,"d2-06-50":b,"d2-20-00":ba,eltako_dimmer:I,eltako_dimmer2:$a,eltako_fsud:Qb,eltako_motion:Ma,eltako_contact:Pb,eltako_weather:Rb,eltako_lux:Na,eltako_lux2:Cc,eltako_sender2:Ec,eltako_sender4:Fc,eltako_button1:Dc,eltako_button2:Gc,eltako_button4:Hc,eltako_blind:T,eltako_fsm60b:Sb,eltako_fkf:Tb,eltako_fkc:Ub,eltako_thermo:la,eltako_ftr65hb:Vb,eltako_futh55d:Ic,eltako_futh65d:Jc,
eltako_ftr78s:Wb,eltako_powermeter:ab,eltako_powermeter2:Kc,eltako_fzs:bb,eltako_switch:ka,eltako_relay:Yb,eltako_relay2:Xb,eltako_heat:Zb,eltako_water_m3:$b,eltako_water_m4:ac,eltako_tf_switch:Pc,eltako_tf_dimmer:Rc,eltako_tf_blind:Sc,peha_switch:cb,peha_powerswitch:va,peha_blind:wa,"bb-aa-cc":B,afriso_water_con:Mc,afriso_water_eco:bc,afriso_asd_10:Nc,hoppe_door:cc,gp:Qc,afriso_ais_10:Tc,eltako_tf_ttb:xa.TF_TTB,eltako_tf_smoke:xa.TF_RWB,eltako_tf_contact:xa.TF_FKB,eltako_tf_motion:xa.TF_BHSB,eltako_motion2:xa.TF_BHSB_FBH,
...
e.prototype.getDeviceHandler=function(){return this._deviceHandler};e.prototype.getRehauHandler=function(){return this._rehauHandler};e.prototype.getESP3=function(){return this._esp3};e.prototype.init=function(b){localStorage&&localStorage.getItem("x.hub.m.enocean.SENDER_ID")&&(x.hub.m.enocean.SENDER_ID=localStorage.getItem("x.hub.m.enocean.SENDER_ID"));localStorage&&localStorage.getItem("x.hub.m.enocean.ESP2_BAUDRATE")&&(this._esp2._baudrate=parseInt(localStorage.getItem("x.hub.m.enocean.ESP2_BAUDRATE")));
var a=this,e=require("x.hub.eventbus.js");e.on("x.hub.peripheralman.ADD_ENOCEAN",function(b){console.log("ADD_ENOCEAN",b);a._usb.attachSerial(b.port)});e.on("x.hub.peripheralman.REMOVE_ENOCEAN",function(b){console.log("REMOVE_ENOCEAN",b);a._usb.removeSerial(b.port)});e.on("x.hub.peripheralman.ADD_SEIRAL",function(b){console.log("ADD_SEIRAL",b);b.type||a._usb.attachSerial(b.port)});e.on("x.hub.peripheralman.REMOVE_SEIRAL",function(b){console.log("REMOVE_SEIRAL",b);b.type||a._usb.removeSerial(b.port)});
global.ENOCEAN_PORT&&"A20"!=global.PLATFORM&&"PI2"!=global.PLATFORM&&a._usb.attachSerial(global.ENOCEAN_PORT);global.ENOCEAN_FGW14_PORT&&"A20"!=global.PLATFORM&&"PI2"!=global.PLATFORM&&a._usb.attachSerial(global.ENOCEAN_FGW14_PORT);e.on("gatewayevent",function(b,e,g){if(b&&e&&"ENOCEAN"!=e.address&&"STA"==g)a._rehauHandler.onDeviceEvent({_type:b.type,_adr:b.adr,getType:function(){return this._type},getAddress:function(){return this._adr}},b.state)});this._secHandler.init(function(){a._rehauHandler.init(a,
function(){a._deviceHandler.init(function(){b&&b({})})})})};e.prototype.getSystems=function(){return["enocean"]};e.prototype.addStateDevice=function(b,a){a&&a({})};e.prototype.getAllStates=function(){var b=[],a=this._deviceHandler.getAllDevices(),e;for(e in a)if(a.hasOwnProperty(e)){var d=a[e];d&&b.push({device:d.toJSON(),states:d.getStatesBuffer()})}return b};e.prototype.getStates=function(b){if(!b||!b.address)return null;var a=null;(b=this._deviceHandler.getDevice(b.address.toLowerCase()))&&(a=
b.getStatesBuffer());return a};e.prototype.getState=function(b,a,e){var d=this.getStates(b),g=null;d&&"undefined"!=typeof d[a]&&null!=d[a]?(g=d[a],e&&e({data:g})):e&&this.updateStates(b,function(b){b.error?e&&e(b):(b.data&&(g=d[a]),e({data:g}))});return g};e.prototype.executeCommand=function(b,a,e){this._esp3._baseID?this._esp3._baseID.toLowerCase()!=x.hub.m.enocean.SENDER_ID.toLowerCase()?e&&e({error:Error("enocean stick has a different baseID")}):b&&b.address?((b=b.address)&&(b=b.toLowerCase()),
(b=this._deviceHandler.getDevice(b))?b.executeCommand?b.executeCommand(this._esp3,a,function(a){e&&e({error:a})}):e&&e({error:Error("device dese not support command")}):e&&e({error:Error("no such device")})):e&&e({error:Error("device invalid")}):e&&e({error:Error("enocean stick not found")})};e.prototype.checkDeviceMatch=function(b,a){if(!(a&&a.device&&b&&b.device))return!1;(b=b.device.address)&&(b=b.toLowerCase());(a=a.device.address)&&(a=a.toLowerCase());return b==a};e.prototype.updateStates=function(b,
a){a&&a({error:Error("not supported yet")})};e.prototype.executeCommandLegacy=function(b,a,e,d){b?d&&d({error:Error("not supported yet")}):this._esp3?a?this.executeCommand({address:a},{value:e},function(a){d&&d({error:a?a.error:null})}):d&&d({error:Error("address invalid")}):d&&d({error:Error("not inited")})};e.prototype.getAllStatesLegacy=function(b,a){var e=[],d=this.getAllStates(),l=this._secHandler.getUnsyncDevice(),h=this;d.forEach(function(b){if(b&&b.device&&b.states){var d=b.device.address,
g={type:"ENOCEAN",adr:d,data:b.device.data,vendor:b.device.vendor,state:{}},k;for(k in b.states)g.state[k]=b.states[k].value;h._secHandler.isSecureDevice(d)?(g.deviceProtocol="secure",g.state.security_state=l[d]?"nok":"ok"):g.deviceProtocol="normal";a&&"1"==a.config&&(g.senderID=b.device.senderID,g.virtual=b.device.virtual,g.params=b.device.params,d&&l[d]&&(g.rlc_unsync=!0));e.push(g)}});b&&b({data:e})};e.prototype.getEnoceanInfo=function(){var b={baseID:x.hub.m.enocean.SENDER_ID,usb_connected:null!=
this._esp3._serial,usb_baseID:this._esp3._baseID,num_free_senderID:this._deviceHandler.getFreeSenderIdCount(),fgw14_connected:null!=this._esp2.getSerial(),fgw14_baudrate:this._esp2._baudrate};b.fgw14_connected&&(b.fgw14_port=this._esp2.getSerial().getPort(),b.fgw14_baseID=this._esp2._baseID);return b};e.prototype.learnDevice=function(b,a){var e=b?b.senderID:null,d=b?b.data:null,l=b?b.vendor:null,h=b?b.address:null;if(h){d=this._deviceHandler.findDevice(b);if(!d){a&&a({error:Error("device not found")});
return}var k=d.toJSON();d=k.data;l=k.vendor;e||(sednerID=k.senderID)}k={};k.saLearnMode=b?b.saLearnMode:null;this._learnHandler.learn(d,h,e,l,null,function(b,d,e){b?a&&a({error:b}):(b={},1==d?b.op=1:(b=e.toJSON(),b.op=0),a&&a({data:b}))},k)};e.prototype.learnSoda=function(b){if(this._esp3._serial){var a=this,e=setTimeout(function(){a._esp3.removeListener(d);b&&b({error:Error("learn timeout")})},2E4),d={_onEOTelegram:function(g){if(246==g.rorg&&(192==g.userData||208==g.userData||240==g.userData)){clearTimeout(e);
a._esp3.removeListener(d);var h={address:g.senderID,data:"f6-so-da",vendor:"soda"};a.addSensor(g.senderID,"f6-so-da","soda",null,function(a){a.error?b&&b(a):b&&b({data:h})})}}};this._esp3.addListener(d)}else b&&b({error:Error("port not opened")})};e.prototype.teachinDevice=function(b,a){if(b)if(b.data){b.adr&&!b.address&&(b.address=b.adr);var e=this._deviceHandler.findDevice(b);e=e?e.toJSON():b;b.data!=e.data?a&&a({error:Error("device of another type with the same address exists")}):b.vendor&&b.vendor!=
e.vendor?a&&a({error:Error("device of another vendor with the same address exists")}):this._learnHandler.teachin(e.data,e.address,e.senderID,e.vendor,function(b,e,g){b?a&&a({error:b}):(b={},e&&(b=e.toJSON()),g&&(b.op=g),a&&a({data:b}))})}else a&&a({error:Error("data is null")});else a&&a({error:Error("query is null")})};e.prototype.generateVirtualDevice=function(b,a){this._deviceHandler.generateVirtual(b,function(b,d){a&&a({error:b,data:d?d.toJSON():null})})};e.prototype.setFGW14Baudrate=function(b,
a){this._esp2?(localStorage.setItem("x.hub.m.enocean.ESP2_BAUDRATE",b),this._esp2._baudrate=b,a&&a({})):a&&a({error:{code:"01000",message:"no esp2 object"}})};e.prototype.sendToFGW14=function(b,a){this._logger.log("trace","stm -> fgw14, forward esp3 telegram:"+b.toString("hex"));if(this._esp2||this._esp2.getSerial())if(b=x.hub.m.enocean.Util.buffer2esp3(b))if(b=x.hub.m.enocean.Util.esp3toesp2(b)){this._logger.log("trace","stm -> fgw14, convert to esp2 telegram:"+b.toBuffer().toString("hex"));var e=
this;this._esp2.sendTelegram(b,null,function(b){e._logger.log("trace","stm -> fgw14, forward finish "+(b?"failed:"+b.messsage:"success"));d=new x.hub.m.enocean.ESP3.Response(0);l=d.toPacket().toFrame().toBuffer();a&&a(l)})}else{this._logger.log("trace","stm -> fgw14, failed to convert esp3 telegram to esp2 telegram");var d=new x.hub.m.enocean.ESP3.Response(3);var l=d.toPacket().toFrame().toBuffer();a&&a(l)}else this._logger.log("trace","stm -> fgw14, invalid esp3 telegram"),d=new x.hub.m.enocean.ESP3.Response(3),
l=d.toPacket().toFrame().toBuffer(),a&&a(l);else this._logger.log("trace","stm -> fgw14, fgw14 not connected"),d=new x.hub.m.enocean.ESP3.Response(1),l=d.toPacket().toFrame().toBuffer(),a&&a(l)};e.prototype._onESP2Telegram=function(b){if("CA"==global.HARDWARE_VERSION){var a=x.hub.m.enocean.Util.esp2toesp3(b);if(a){var e=this;b=a.toPacket().toFrame().toBuffer();this._logger.log("trace","convert to esp3 telegram:"+JSON.stringify(a.toJSON()));this._logger.log("trace","convert to esp3:"+b.toString("hex")+
" and forward to stm");(a=require("x.hub.v6.js").getSTM())&&a.sendCommand(144,b,function(a){e._logger.log("trace","forward to stm result:"+JSON.stringify(a))})}}};e.prototype._onEOFrame=function(b,a){this._trackers.forEach(function(e){e.onFrame(b,a)})};e.prototype._onEOTelegram=function(b){this._trackers.forEach(function(a){a.onTelegram(b)});var a=this._deviceHandler.getDevice(b.senderID);if(a){var e=this;a.evalData(this._esp3,b,function(b,g){b||0==g.length||e._onEOEvents(a,g)})}};e.prototype._onEOEvents=
function(b,a){var e=require("x.hub.eventbus.js");this._trackers.forEach(function(d){d.onResolveEvents(b._address,a)});this._rehauHandler.onDeviceEvent(b,a);var d=b.toJSON();d.sys="aio";d.type="ENOCEAN";for(var l=0,h=0;h<a.length;h++){var k=a[h];if(k)if("shortPress"==k.value||"longPress"==k.value||"pressed"==k.value||"released"==k.value){l++;var n={type:"ENOCEAN",adr:d.address,data:d.data,vendor:d.vendor,state:{}};n.state[k.key]=k.value;e.emit("gatewayevent",n,{address:"ENOCEAN"},"BTN")}else if("d2-06-50"==
d.data&&"burglary"==k.key){n={type:"ENOCEAN",adr:d.address,data:d.data,vendor:d.vendor,state:{}};n.state[k.key]=k.value;e.emit("gatewayevent",n,{address:"ENOCEAN"},"STA");return}}if(l==a.length)(d=b.getStatesLegacy())&&e.emit("udpevent",d,"STA");else if(d=b.getStatesLegacy())e.emit("gatewayevent",d,{address:"ENOCEAN"},"STA"),e.emit("udpevent",d,"STA")};e.prototype._saveEnoceanEvents=function(b,a){var e=require("x.hub.datastore.js").dataStore;e&&e.openDB(function(d,e){if(!d){d=b._address;for(var g=
[],k=(new Date).toISOString(),l=0;l<a.length;l++){var q=a[l];if(q&&q.changed){q=q.key+":"+q.value;var p=null;p=0==g.length?"SELECT '"+d+"' AS 'window', '"+q+"' AS 'state', '"+k+"' AS 'time'":"UNION ALL SELECT '"+d+"', '"+q+"', '"+k+"'";g.push(p)}}0<g.length&&(d=g.join(" "),e.run("INSERT INTO windowstate(window, state, time) "+d+";",function(a){e.close()}))}})};e.prototype.addSensor=function(b,a){b?b.data?"siegenia"!=b.vendor||b.params?this._deviceHandler.addDevice(b,function(b,d){a&&a({error:b,data:d?
d.toJSON():null})}):a&&a({error:Error("siegenia windows params is null")}):a&&a({error:Error("enocean profile is null")}):a&&a({error:Error("enocean device is null")})};e.prototype.updateSensor=function(b,a,e){b?a?this._deviceHandler.updateDevice(b,a,function(a,b){e&&e({error:a,data:b?b.toJSON():null})}):e&&e({error:Error("device info is null")}):e&&e({error:Error("device address is null")})};e.prototype.delSensor=function(b,a){b?this._deviceHandler.deleteDevice({address:b},function(b){a&&a({error:b})}):
a&&a({error:Error("enocean id is null")})};e.prototype.resetDefaultSenderID=function(b){x.hub.m.enocean.SENDER_ID=null;localStorage&&localStorage.setItem("x.hub.m.enocean.SENDER_ID","");b&&b({})};e.prototype.setRehauAlarm=function(b,a){this._rehauHandler.setAlarm(b,a)};e.prototype.isRehauWindowOpen=function(){return this._rehauHandler.isWindowOpen()};e.prototype.setInoventHumidityAccessory=function(b,a,e){this._rehauHandler.setHumidityAccessory(b,a,function(a){e&&e({error:a})})};e.prototype.setInoventCo2Accessory=
function(b,a,e){this._rehauHandler.setCo2Accessory(b,a,function(a){e&&e({error:a})})};e.prototype.getInoventAccessories=function(b,a){b=this._rehauHandler.getInoventAccessory(b);a&&a({data:b?b.toJSON():{}})};e.prototype.__addTelegramTracker=function(b){b&&b.onTelegram&&b.onResolveEvents&&-1==this._trackers.indexOf(b)&&this._trackers.push(b)};e.prototype.__removeTelegramTracker=function(b){b&&(b=this._trackers.indexOf(b),-1!=b&&this._trackers.splice(b,1))};e.prototype.__sendEspFrame=function(b,a,e,
d,l){a=a?new Buffer(a,"hex"):null;e=e?new Buffer(e,"hex"):null;d=d?!0:!1;b=new x.hub.m.enocean.ESP3.ESP3_Frame(b,a,e);this._esp3.sendFrame(b,d,function(a,b){l&&l({error:a,data:b?b.toJSON():null})})};e.prototype.__simulateRawEnoceanPacket=function(b,a){this._esp3.onSerialData(new Buffer(b,"hex"));a&&a()};e.prototype._doSDK=function(b,a){if(b&&b.method){var e="send_"+b.method;if(this._sdk[e])this._sdk[e](b.params,function(b){a&&a({error:b})});else a&&a({error:Error("no such method")})}else a&&a({error:Error("data invalid")})};
return e}();"undefined"!=typeof exports&&"undefined"!=typeof module&&module.exports&&(exports=module.exports=new x.hub.m.enocean.Handler);
