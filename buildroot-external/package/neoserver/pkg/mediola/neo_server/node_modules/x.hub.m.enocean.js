...
case 212:return U.resolve(a);case 53:return X.resolve(a);case 49:return O.resolve(a);case 64:return z.resolve(a);case 176:return p.resolve(a);case 178:return u.resolve(a);default:return null}};var p=function(){var a=function(a,b,e){8<=e&&(e=8);0>=e&&(e=1);var f=Math.floor(b/8),m=b%8;b=Math.pow(2,e)-1;if(8<m+e)return e=16-m-e,a.readUInt16BE(f)>>e&b;e=8-m-e;return a.readUInt8(f)>>e&b},b=function(a){this.type=a};b.prototype.getType=function(){return this.type};b.resolve=function(b,f){if(f+2>8*b.length)return null;
...
this._learnHandler&&this._learnHandler.onEvent)this._learnHandler.onEvent(a)};v.ESP3_Frame=g;v.Telegram=l;v.RADIO_ERP1_Packet=f;v.Event=n;v.Response=t;v.COMMAND_COMMAND=oa;v.SA_COMMAND=N;return v}();
...
K.prototype=new n;K.prototype.constructor=K;var oa=function(c){n.call(this,c);this._data="a5-02-03";this._tmpMin=-20;this._tmpMax=20};oa.STATES=["temperature","temperature_raw"];oa.prototype=new n;oa.prototype.constructor=oa;var N=function(c){n.call(this,c);this._data="a5-02-04";this._tmpMin=-10;this._tmpMax=30};N.STATES=["temperature","temperature_raw"];N.prototype=new n;N.prototype.constructor=N;var Q=function(c){n.call(this,c);this._data="a5-02-05";this._tmpMin=0;this._tmpMax=40};Q.STATES=["temperature",
"temperature_raw"];Q.prototype=new n;Q.prototype.constructor=Q;var ca=function(c){n.call(this,c);this._data="a5-02-06";this._tmpMin=10;this._tmpMax=50};ca.STATES=["temperature","temperature_raw"];ca.prototype=new n;ca.prototype.constructor=ca;var Z=function(c){n.call(this,c);this._data="a5-02-07";this._tmpMin=20;this._tmpMax=60};Z.STATES=["temperature","temperature_raw"];Z.prototype=new n;Z.prototype.constructor=Z;var aa=function(c){n.call(this,c);this._data="a5-02-08";this._tmpMin=30;this._tmpMax=
...
"f6-03-02":z,"f6-04-01":C,"f6-04-02":I,"f6-05-00":J,"f6-05-01":A,"f6-05-02":w,"f6-10-00":P,"f6-10-01":U,"d5-xx-xx":a,"d5-??-??":X,"d5-00-01":O,"f6-so-da":f,"a5-??-??":t,"a5-02-01":Y,"a5-02-02":K,"a5-02-03":oa,"a5-02-04":N,"a5-02-05":Q,"a5-02-06":ca,"a5-02-07":Z,"a5-02-08":aa,"a5-02-09":Qa,"a5-02-0a":v,"a5-02-0b":m,"a5-02-10":Oa,"a5-02-11":dc,"a5-02-12":Pa,"a5-02-13":ec,"a5-02-14":fc,"a5-02-15":Ga,"a5-02-16":gc,"a5-02-17":db,"a5-02-18":hc,"a5-02-19":ic,"a5-02-1a":jc,"a5-02-1b":kc,"a5-02-20":Fa,"a5-02-30":lc,
