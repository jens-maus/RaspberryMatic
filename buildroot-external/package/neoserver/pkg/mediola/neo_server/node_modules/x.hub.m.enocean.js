...
this._learnProfile=this._learnCallback=null;this._secTeachInFrames={};this._teaching=!1;this._teachingTO=this._teachVendor=this._teachSenderID=this._teachID=this._teachProfile=this._teachCallback=null;var b=this;this._teachinTelegramCB={_onEOTelegram:function(a){b.onTeachInResponseTelegram(a)}};this._gpLearn=new g(this)};b.prototype.learn=function(a,b,e,k,h,g,r){if(this._learning)g&&g(Error("learning process running"));else if(this._teaching)g&&g(Error("teach-in process running"));else{if(!h||0>=
h)h=3E4;this._learning=!0;this._learnCallback=g;this._learnProfile=a?a.toLowerCase():null;this._learnAddress=b?b.toLowerCase():null;this._learnVendor=k?k:"general";this._learnSenderID=e?e.toLowerCase():null;this._secTeachInFrames={};this._saParams=null;!a||"bb-aa-cc"!=a.toLowerCase()&&"d2-06-10"!=a.toLowerCase()&&"d2-06-ff"!=a.toLowerCase()||(this._saParams={extended:1},r&&"undefined"!=typeof r.saLearnMode&&null!=r.saLearnMode&&(a=parseInt(r.saLearnMode),isNaN(a)&&(a=1),0>a&&(a=1),2<a&&(a=1),this._saParams.extended=
...
function(a,b){g._teachFinish(a,b)}))})};b.prototype._teachin4BSV3=function(a,b,e){var f=e;if(!e){f=require("x.hub.m.enocean.js")._deviceHandler.getNextFreeSenderId();if(!f){this._teachFinish(Error("no more sender ID available"));return}this._teachSenderID=f}e=a;var g=x.hub.m.enocean.profiles[e];g||(e=this._getRealProfile(e),g=x.hub.m.enocean.profiles[a]);g&&(g=new g,g._eepAlias&&(a=g._eepAlias));g&&g.getTeachinTelegram?f=g.getTeachinTelegram(b,f,x.hub.m.enocean.MANUFACTURE_ID):(a=this._fromProfileStr(a),
a=new Buffer([(a.func&63)<<2|a.type>>6&2,(a.type&31)<<3|x.hub.m.enocean.MANUFACTURE_ID>>8&7,x.hub.m.enocean.MANUFACTURE_ID&255,128]),f=new x.hub.m.enocean.ESP3.Telegram.BS4(a,f,0));var l=this;this._controller._esp3.addListener(this._teachinTelegramCB);this._controller._esp3.sendTelegram(f,!0,function(a){a&&l._teachFinish(a)})};b.prototype._teachinUTE=function(a,b,e){b=e;if(!e){b=require("x.hub.m.enocean.js")._deviceHandler.getNextFreeSenderId();if(!b){this._teachFinish(Error("no more sender ID available"));
...
function(e){e?b&&b(e):a.readFile(f,"utf8",function(a,e){if(a)b&&b(a);else if(e)try{a={};var f=JSON.parse(e),g;for(g in f){var h=x.hub.m.enocean.profiles.parseDBJson(f[g]);h&&(a[g]=h)}b&&b(null,a)}catch(u){b&&b(u)}else b&&b(null,{})})})};g.prototype._saveDevices=function(b,a){var f=this._getFile(),e={},g;for(g in b)e[g]=b[g].toDBJSON();fs_extra.writeFile(f,JSON.stringify(e,null,2),function(b){a&&a(b)})};return g}();
...
retCode:this.retCode.toString(16),resData:this.resData?this.resData.toString("hex"):null,optData:this.optData?this.optData.toString("hex"):null}};a.prototype.toFrame=function(){var a=new Buffer(1);a.writeUInt8(this.retCode,0);this.resData&&(a=Buffer.concat([a,this.resData]));return new g(2,a,this.optData)};a.prototype.toResponse=function(){return t.resolve(this)};a.resolve=function(b){var e;var n=b.data.readUInt8(0);1<b.data.length&&(e=b.data.slice(1));return new a(n,e,b.optData)};var f=function(a,
...
function(){return N.resolve(this)};e.resolve=function(a){return new e(a.data)};var k=function(a){this.data=a};k.prototype.toJSON=function(){return{data:this.data.toString("hex")}};k.prototype.toFrame=function(){return new g(5,this.data,null)};k.prototype.toCommandCommand=function(){return oa.resolve(this)};k.resolve=function(a){return new k(a.data)};var h=function(a){this.data=a};h.prototype.toJSON=function(){return{data:this.data.toString("hex")}};h.prototype.toFrame=function(){return new g(4,this.data,
...
case 212:return U.resolve(a);case 53:return X.resolve(a);case 49:return O.resolve(a);case 64:return z.resolve(a);case 176:return r.resolve(a);case 178:return u.resolve(a);default:return null}};var r=function(){var a=function(a,b,e){8<=e&&(e=8);0>=e&&(e=1);var f=Math.floor(b/8),n=b%8;b=Math.pow(2,e)-1;if(8<n+e)return e=16-n-e,a.readUInt16BE(f)>>e&b;e=8-n-e;return a.readUInt8(f)>>e&b},b=function(a){this.type=a};b.prototype.getType=function(){return this.type};b.resolve=function(b,f){if(f+2>8*b.length)return null;
var n=a(b,f,2),k=null;switch(n){case 0:k=e.resovle(b,f);break;case 1:k={type:n,sigType:b.readUInt16BE(0)>>6&255,valueType:b.readUInt16BE(0)>>2&3,resolution:b.readUInt16BE(0)&15,engMin:b.readUInt8(2),scalingMin:b.readUInt16BE(3)>>12&15,engMax:b.readUInt16BE(3)>>4&255,scalingMax:b.readUInt16BE(3)&15};break;case 2:k=g.resovle(b,f);break;case 3:k=h.resovle(b,f)}return k};var e=function(a,b,e){this.type=0;this.sigType=a;this.dataLen=b;this.data=e};e.prototype=new b;e.prototype.constructor=e;e.prototype.getBitLength=
function(){return 2==this.sigType?50:18};e.prototype.getProductID=function(){return 2==this.sigType?this.data?this.data.readUInt32BE(0):null:null};e.resovle=function(b,f){if(f+18>8*b.legnth)return null;var n=a(b,f+2,8),g=a(b,f+10,8),h=null;if(2==n){if(f+50>8*b.legnth)return null;h=new Buffer(4);h.writeUInt8(a(b,f+18,8),0);h.writeUInt8(a(b,f+26,8),1);h.writeUInt8(a(b,f+34,8),2);h.writeUInt8(a(b,f+42,8),3)}else 1==n&&(h=null);return new e(n,g,h)};var f=function(a,b,e,f,n,g,h){this.type=1;this.sigType=
a;this.valueType=b;this.resolution=e;this.engMin=f;this.scalMin=n;this.engMax=g;this.scalMax=h};f.prototype=new b;f.prototype.constructor=f;f.prototype.getBitLength=function(){return 40};f.prototype.toJSON=function(){return{sigType:this.sigType,valueType:this.valueType,resolution:this.resolution,engMin:this.engMin,scalMin:this.scalMin,engMax:this.engMax,scalMax:this.scalMax}};f.resovle=function(b,e){if(e+40>8*b.length)return null;var n=a(b,e+2,8),g=a(b,e+10,2),h=a(b,e+12,4),k=a(b,e+16,8),Oa=a(b,e+
24,4),l=a(b,e+28,8);b=a(b,e+36,4);return new f(n,g,h,k,Oa,l,b)};var g=function(a,b){this.type=2;this.sigType=a;this.valueType=b};g.prototype=new b;g.prototype.constructor=g;g.prototype.getBitLength=function(){return 12};g.resovle=function(b,e){if(e+12>8*b.length)return null;var f=a(b,e+2,8);b=a(b,e+10,2);return new g(f,b)};g.prototype.toJSON=function(){return{sigType:this.sigType,valueType:this.valueType}};var h=function(a,b,e){this.type=3;this.sigType=a;this.valueType=b;this.resolution=e};h.prototype=
new b;h.prototype.constructor=h;h.prototype.getBitLength=function(){return 16};h.prototype.toJSON=function(){return{sigType:this.sigType,valueType:this.valueType,resolution:this.resolution}};h.resovle=function(b,e){if(e+16>8*b.length)return null;var f=a(b,e+2,8),n=a(b,e+10,2);b=a(b,e+12,4);return new h(f,n,b)};var k=function(a,b,e){l.call(this,176);this.manufacturerID=a;this.dataDirection=b;this.purpose=e;this.productID=null;this.outboudChannels={};this.inboundChannels={};this.status=this.senderID=
...
this.inboundChannels[b].toJSON();return a};k.resolve=function(a){var e=a.data;a=e.readUInt16BE(1)>>5&2047;var f=e.readUInt16BE(1)>>4&1,n=e.readUInt16BE(1)>>2&3;a=new k(a,f,n);f=e.slice(3,e.length-5);n=e.slice(e.length-5,e.length-1);e=e.readUInt8(e.length-1);a.senderID=n.toString("hex");a.status=e;for(var g=n=e=0;;){var h=b.resolve(f,n);if(!h)break;0==e?0==h.getType()?a.productID=h.getProductID():(a.outboudChannels[g]=h,g++,e=1):1==e?0==h.getType()?e=2:(a.outboudChannels[g]=h,g++,e=1):2==e&&(a.inboundChannels[g]=
h,g++);n+=h.getBitLength()}return a};return k}(),m=function(){var a=function(a,b,e,f,n){l.call(this,177);this.manufacturerID=a;this.result=b;this.chnAcknoledgement=e;this.senderID=f;this.status=n};a.prototype=new l;a.prototype.constructor=a;a.prototype.toPacket=function(){var a=new Buffer(3);a.writeUInt8(this.rorg,0);a.writeUInt16BE(this.manufacturerID<<5|this.result<<3,1);if(3==this.result){var b=[];if(this.chnAcknoledgement){for(var e=Math.ceil(this.chnAcknoledgement.length/8),n=0;n<e.length;n++)b.push(0);
for(e=0;e<this.chnAcknoledgement.length;e++)n=Math.floor(e/8),b[n]|=chnAcknoledgement[e]<<8-e%8-1}a=Buffer.concat([a,new Buffer(b)])}a=Buffer.concat([a,new Buffer(this.senderID,"hex")]);a=Buffer.concat([a,new Buffer([this.status])]);b=1;e="FFFFFFFF";n=255;var g=0;this.optData&&(b=this.optData.subTelNum,e=this.optData.dstId,n=this.optData.dBm,g=this.optData.securityLvl);return new f(a,!0,b,e,n,g)};a.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),manufacturerID:this.manufacturerID.toString(16),
...
b=b.readUInt8(b.length-1);var g;a.hasOpt&&(g={subTelNum:a.subTelNum,dstId:a.dstId,dBm:a.dBm,securityLvl:a.securityLvl});return new w(e,f,b,g)};var P=function(a,b,e,f,g){l.call(this,166);this.rorg_en=a;this.data=b;this.dstID=e;this.senderID=f;this.status=g};P.prototype=new l;P.prototype.constructor=P;P.prototype.toPacket=function(){var a=new Buffer(2);a.writeUInt8(this.rorg,0);a.writeUInt8(this.rorg_en,1);a=Buffer.concat([a,this.data]);a=Buffer.concat([a,new Buffer(this.dstID,"hex")]);a=Buffer.concat([a,
new Buffer(this.senderID,"hex")]);a=Buffer.concat([a,new Buffer([this.status])]);return new f(a,!1)};var U=function(a,b,e,f,g,h,k,m,r,p,t){l.call(this,212);this.cmd=a;this.ute=b;this.rspExpected=e;this.subtype=f;this.numChannel=g;this.manufactureID=h;this.eepType=k;this.eepFunc=m;this.eepRorg=r;this.senderID=p;this.status=t};U.prototype=new l;U.prototype.constructor=U;U.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),ute:this.ute,rspExpected:this.rspExpected,subtype:this.subtype,cmd:this.cmd,
...
7);a=Buffer.concat([a,new Buffer(this.senderID,"hex")]);a=Buffer.concat([a,new Buffer([this.status])]);return this.optData?new f(a,!0,this.optData.subTelNum,this.optData.dstId,this.optData.dBm,this.optData.securityLvl):new f(a,!1)};U.resolve=function(a){var b=a.data.slice(1,8),e=a.data.slice(8,12).toString("hex"),f=a.data.readUInt8(12),g=b.readUInt8(0)>>7&1,h=b.readUInt8(0)&15,n=b.readUInt8(1),k=b.slice(2,4).toString("hex"),l=b.readUInt8(4),m=b.readUInt8(5),r=b.readUInt8(6),p=b.readUInt8(0)>>6&1;
b=b.readUInt8(0)>>4&3;e=new U(h,g,p,b,n,k,l,m,r,e,f);a.hasOpt&&(e.optData={subTelNum:a.subTelNum,dstId:a.dstId,dBm:a.dBm,securityLvl:a.securityLvl});return e};var X=function(a,b,e,f){l.call(this,53,f);this.userData=a;this.senderID=b;this.status=e};X.prototype=new l;X.prototype.constructor=X;X.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),userData:this.userData.toString("hex"),senderID:this.senderID,status:this.status,optData:this.optData}};X.resolve=function(a){var b=a.data,e=b.slice(1,
b.length-5),f=b.slice(b.length-5,b.length-1).toString("hex");b=b.readUInt8(b.length-1);var g;a.hasOpt&&(g={subTelNum:a.subTelNum,dstId:a.dstId,dBm:a.dBm,securityLvl:a.securityLvl});return new X(e,f,b,g)};var O=function(a,b,e,f){l.call(this,49,f);this.userData=a;this.senderID=b;this.status=e};O.prototype=new l;O.prototype.constructor=O;O.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),userData:this.userData.toString("hex"),senderID:this.senderID,status:this.status,optData:this.optData}};
O.prototype.convertToPacket=function(a){a=Buffer.concat([a,new Buffer(this.senderID,"hex"),new Buffer([this.status])]);return this.optData?new f(a,!0,this.optData.subTelNum,this.optData.dstId,this.optData.dBm,this.optData.securityLvl):new f(a,!1)};O.resolve=function(a){var b=a.data,e=b.slice(1,b.length-5),f=b.slice(b.length-5,b.length-1).toString("hex");b=b.readUInt8(b.length-1);var g;a.hasOpt&&(g={subTelNum:a.subTelNum,dstId:a.dstId,dBm:a.dBm,securityLvl:a.securityLvl});return new O(e,f,b,g)};l.SIG=
C;l.RPS=I;l.BS1=J;l.BS4=A;l.VLD=w;l.ADT=P;l.UTE=U;l.TS=X;l.SM=O;l.GP_TI=r;l.GP_TR=m;l.GP_CD=u;var t=function(a,b){this._code=a;this._rspData=b};t.CODE={0:"RET_OK",1:"RET_ERROR",2:"RET_NOT_SUPPORTED",3:"RET_WRONG_PARAM",4:"RET_OPERATION_DENIED",5:"RET_LOCK_SET",6:"RET_BUFFER_TO_SMALL",7:"RET_NO_FREE_BUFFER"};t.prototype.toJSON=function(){return{code:this._code,rspData:this._rspData?this._rspData.toString("hex"):null}};t.prototype.toPacket=function(){return new a(this._code,this._rspData)};t.resolve=
function(a){return new t(a.retCode,a.resData)};m=function(a,b){t.call(this,0);this._responseTime=a;this._confirmCode=b};m.prototype.toPacket=function(){var b=new Buffer(3);b.writeUInt16BE(this._responseTime,0);b.writeUInt8(this._confirmCode,2);return new a(this._code,b)};m.prototype.toJSON=function(){return{code:this._code,responseTime:this._responseTime,confirmCode:this._confirmCode}};t.Response_OK_SA_CONFIRM_LEARN=m;var p=function(a){this._code=a};p.resolve=function(a){if(!a.data)return null;switch(a.data.readUInt8(0)){case 1:return Y.resolve(a);
case 2:return K.resolve(a);default:return null}};var Y=function(){this._code=1};Y.prototype=new p;Y.prototype.constructor=Y;Y.prototype.toJSON=function(){return{code:this._code}};Y.prototype.toPacket=function(){var a=new Buffer(1);a.writeUInt8(this._code,0);return new h(a)};Y.resolve=function(a){return new Y};var K=function(a,b,e,f,g,h,k){this._code=2;this._priority=a;this._manufacturerId=b;this._eep=e;this._rssi=f;this._pm_candidateId=g;this._sa_clientId=h;this._hop_count=k};K.prototype=new p;K.prototype.constructor=
...
function(a){var b=a.data;a=b.readUInt8(1);var e=b.readUInt16BE(2)&1023,f=b.slice(4,7).toString("hex"),g=b.readUInt8(7),h=b.slice(8,12).toString("hex"),k=b.slice(12,16).toString("hex");b=b.readUInt8(16);return new K(a,e,f,g,h,k,b)};p.SA_RECLAIM_NOT_SUCCESSFUL=Y;p.SA_CONFIRM_LEARN=K;var oa=function(a){this._code=a};oa.resolve=function(a){if(!a.data)return null;switch(a.data.readUInt8(0)){case 9:return CO_WR_REPEATER.resolve(a);default:return null}};CO_WR_REPEATER=function(a,b){this._code=9;this._enable=
...
CO_WR_REPEATER;var N=function(a){this._code=a};N.resolve=function(a){if(!a.data)return null;switch(a.data.readUInt8(0)){case 1:return Q.resolve(a);case 6:return Z.resolve(a);case 8:return aa.resolve(a);default:return null}};var Q=function(a,b,e){this._code=1;this._enable=a;this._extended=b;this._timeout=e};Q.prototype=new N;Q.prototype.constructor=Q;Q.prototype.toJSON=function(){return{code:this._code,enable:this._enable,extended:this._extended,timeout:this._timeout}};Q.prototype.toPacket=function(){var a=
new Buffer(7);a.writeUInt8(this._code,0);a.writeUInt8(this._enable,1);a.writeUInt8(this._extended,2);a.writeUInt32BE(this._timeout,3);return new e(a)};Q.resolve=function(a){var b=a.data;a=b.readUInt8(1);var e=b.readUInt8(2);b=b.readUInt32BE(3);return new Q(a,e,b)};var ca=function(a){this._code=5;this._saClientId=a};ca.prototype=new N;ca.prototype.constructor=ca;ca.prototype.toJSON=function(){return{code:this._code,clientId:this._saClientId}};ca.prototype.toPacket=function(){var a=new Buffer(1);a.writeUInt8(this._code,
0);a=Buffer.concat([a,new Buffer(this._saClientId,"hex")]);return new e(a)};ca.resolve=function(a){a=a.data.slice(1,5).toString("hex");return new ca(a)};var Z=function(){this._code=6};Z.prototype=new N;Z.prototype.constructor=Z;Z.prototype.toJSON=function(){return{code:this._code}};Z.prototype.toPacket=function(){var a=new Buffer(1);a.writeUInt8(this._code,0);return new e(a)};Z.resolve=function(a){return new Z};var aa=function(a){this._code=8;this._mailBoxCount=a};aa.prototype=new N;aa.prototype.constructor=
aa;aa.prototype.toJSON=function(){return{code:this._code,mailBoxCount:this._mailBoxCount}};aa.prototype.toPacket=function(){var a=new Buffer(2);a.writeUInt8(this._code,0);a.writeUInt8(this._mailBoxCount,1);return new e(a)};aa.resolve=function(a){a=a.data.readUInt8(1);return new aa(a)};N.SA_WR_LEARNMODE=Q;N.SA_WR_RESET=ca;N.SA_RD_LEARNEDCLIENTS=Z;N.SA_WR_POSTMASTER=aa;var Qa=function(){var a=function(a){this._esp3=a;this._buffer={}};a.prototype.receiveChainedTelegram=function(a){var b=a.getSenderID(),
e=a.getSeq(),f=a.getIdx();this._buffer[b]||(this._buffer[b]={});var g=this._buffer[b];g[e]||(g[e]=[]);g=g[e];for(var h=0;h<=f;h++)h!=f?g.length<f&&(g[h]=null):g[h]=a;this._checkChain(b,e)};a.prototype._checkChain=function(a,b){var e=this._buffer[a][b];if(e[0]){var g=e[0],h=g.getLen(),k=g.getCRORG();g=0;var l=new Buffer(1);l.writeUInt8(k);for(k=0;k<e.length;k++){var n=e[k];if(!n)return;n=n.getData();g+=n.length;l=Buffer.concat([l,n])}g>=h&&(delete this._buffer[a][b],l=Buffer.concat([l,new Buffer(a,
...
this._learnHandler&&this._learnHandler.onEvent)this._learnHandler.onEvent(a)};v.ESP3_Frame=g;v.Telegram=l;v.RADIO_ERP1_Packet=f;v.Event=p;v.Response=t;v.COMMAND_COMMAND=oa;v.SA_COMMAND=N;return v}();
...
d,a){if(this._senderID)if(d&&d.value){var b=this,e=100;switch(d.value){case "longPress":e=this._longPressThreshold;case "shortPress":var q=this.buildData(1);var f=new x.hub.m.enocean.ESP3.Telegram.RPS(q,this._senderID,1,1,0,null);c.sendTelegram(f,!0,function(d){d?a&&a(d):(b.activeStateChange({button:"pressed"}),setTimeout(function(){q=b.buildData(0);f=new x.hub.m.enocean.ESP3.Telegram.RPS(q,b._senderID,1,1,0,null);c.sendTelegram(f,!0,function(c){b.activeStateChange({button:"released"});a&&a(c)})},
e))});break;case "press":q=this.buildData(1);f=new x.hub.m.enocean.ESP3.Telegram.RPS(q,this._senderID,1,1,0,null);c.sendTelegram(f,!0,function(c){b.activeStateChange({button:"pressed"});a&&a(c)});break;case "release":q=this.buildData(0),f=new x.hub.m.enocean.ESP3.Telegram.RPS(q,this._senderID,1,1,0,null),c.sendTelegram(f,!0,function(c){b.activeStateChange({button:"released"});a&&a(c)})}}else a&&a(Error("command invalid"));else a&&a(Error("sender id is null"))};var h=function(c){e.call(this,c);this._data=
...
1&7,e=c.userData&1,f=c.t21,g=c.nu;c=c.userData>>4&1?"pressed":"released";if(0==f&&1==g){switch(a){case 0:var h=c;break;case 1:var k=c;break;case 2:var l=c;break;case 3:var m=c;break;case 4:var ha=c;break;case 5:var r=c;break;case 6:var p=c;break;case 7:var n=c}if(e)switch(b){case 0:h=c;break;case 1:k=c;break;case 2:l=c;break;case 3:m=c;break;case 4:ha=c;break;case 5:r=c;break;case 6:p=c;break;case 7:n=c}}else if(0==f&&0==g)switch(a){case 0:case 7:n=p=r=ha=m=l=k=h=c}h&&(d.buttonAI=h);k&&(d.buttonAO=
k);l&&(d.buttonBI=l);m&&(d.buttonBO=m);ha&&(d.buttonCI=ha);r&&(d.buttonCO=r);p&&(d.buttonDI=p);n&&(d.buttonDO=n)}return d};u.prototype.executeCommand=function(c,d,a){if(this._senderID)if(d&&d.value){var b=this,e=100,q=d.value.substr(d.value.length-2),f={},g=0;switch(q){case "AI":g=0;break;case "AO":g=1;break;case "BI":g=2;break;case "BO":g=3;break;case "CI":g=4;break;case "CO":g=5;break;case "DI":g=6;break;case "DO":g=7}switch(d.value){case "longPressAI":case "longPressAO":case "longPressBI":case "longPressBO":case "longPressCI":case "longPressCO":case "longPressDI":case "longPressDO":e=
this._longPressThreshold;case "shortPressAI":case "shortPressAO":case "shortPressBI":case "shortPressBO":case "shortPressCI":case "shortPressCO":case "shortPressDI":case "shortPressDO":var h=this.buildData(g,1,0,0);var k=new x.hub.m.enocean.ESP3.Telegram.RPS(h,this._senderID,1,1,0,null);c.sendTelegram(k,!0,function(d){d?a&&a(d):(f["button"+q]="pressed",b.activeStateChange(f),setTimeout(function(){h=b.buildData(0,0,0,0);k=new x.hub.m.enocean.ESP3.Telegram.RPS(h,b._senderID,1,1,0,null);c.sendTelegram(k,
!0,function(c){f["button"+q]="released";b.activeStateChange(f);a&&a(c)})},e))});break;case "pressAI":case "pressAO":case "pressBI":case "pressBO":case "pressCI":case "pressCO":case "pressDI":case "pressDO":h=this.buildData(g,1,0,0);k=new x.hub.m.enocean.ESP3.Telegram.RPS(h,this._senderID,1,1,0,null);c.sendTelegram(k,!0,function(c){f["button"+q]="pressed";b.activeStateChange(f);a&&a(c)});break;case "releaseAI":case "releaseAO":case "releaseBI":case "releaseBO":case "releaseCI":case "releaseCO":case "releaseDI":case "releaseDO":h=
...
"middle"):0==(c&15^15)?(d.window="closed",d.handle_pos="down"):0==(c&15^13)&&(d.window="tilted",d.handle_pos="up"),d.handle_raw=c);return d};var X=function(c){g.call(this,c);this._data="d5-??-??"};X.prototype=new g;X.prototype.constructor=X;var O=function(c){X.call(this,c);this._data="d5-00-01"};O.STATES=["contact","contact_raw"];O.prototype=new X;O.prototype.constructor=O;O.prototype.evalTelegram=function(c){var d={};213==c.rorg&&(c=c.userData,1==(c>>3&1)&&(c&=1,d.contact=c?"closed":"open",d.contact_raw=
...
c.rorg){var a=c.userData.readUInt8(3);c=c.userData.readUInt8(2);1==(a>>3&1)&&(d.temperature=parseFloat(((255-c)/255*(this._tmpMax-this._tmpMin)+this._tmpMin).toFixed(1)),d.temperature_raw=c)}return d};var Y=function(c){p.call(this,c);this._data="a5-02-01";this._tmpMin=-40;this._tmpMax=0};Y.STATES=["temperature","temperature_raw"];Y.prototype=new p;Y.prototype.constructor=Y;var K=function(c){p.call(this,c);this._data="a5-02-02";this._tmpMin=-30;this._tmpMax=10};K.STATES=["temperature","temperature_raw"];
K.prototype=new p;K.prototype.constructor=K;var oa=function(c){p.call(this,c);this._data="a5-02-03";this._tmpMin=-20;this._tmpMax=20};oa.STATES=["temperature","temperature_raw"];oa.prototype=new p;oa.prototype.constructor=oa;var N=function(c){p.call(this,c);this._data="a5-02-04";this._tmpMin=-10;this._tmpMax=30};N.STATES=["temperature","temperature_raw"];N.prototype=new p;N.prototype.constructor=N;var Q=function(c){p.call(this,c);this._data="a5-02-05";this._tmpMin=0;this._tmpMax=40};Q.STATES=["temperature",
"temperature_raw"];Q.prototype=new p;Q.prototype.constructor=Q;var ca=function(c){p.call(this,c);this._data="a5-02-06";this._tmpMin=10;this._tmpMax=50};ca.STATES=["temperature","temperature_raw"];ca.prototype=new p;ca.prototype.constructor=ca;var Z=function(c){p.call(this,c);this._data="a5-02-07";this._tmpMin=20;this._tmpMax=60};Z.STATES=["temperature","temperature_raw"];Z.prototype=new p;Z.prototype.constructor=Z;var aa=function(c){p.call(this,c);this._data="a5-02-08";this._tmpMin=30;this._tmpMax=
70};aa.STATES=["temperature","temperature_raw"];aa.prototype=new p;aa.prototype.constructor=aa;var Qa=function(c){p.call(this,c);this._data="a5-02-09";this._tmpMin=40;this._tmpMax=80};Qa.STATES=["temperature","temperature_raw"];Qa.prototype=new p;Qa.prototype.constructor=Qa;var v=function(c){p.call(this,c);this._data="a5-02-0a";this._tmpMin=50;this._tmpMax=90};v.STATES=["temperature","temperature_raw"];v.prototype=new p;v.prototype.constructor=v;var n=function(c){p.call(this,c);this._data="a5-02-0b";
this._tmpMin=60;this._tmpMax=100};n.STATES=["temperature","temperature_raw"];n.prototype=new p;n.prototype.constructor=n;var Oa=function(c){p.call(this,c);this._data="a5-02-10";this._tmpMin=-60;this._tmpMax=20};Oa.STATES=["temperature","temperature_raw"];Oa.prototype=new p;Oa.prototype.constructor=Oa;var dc=function(c){p.call(this,c);this._data="a5-02-11";this._tmpMin=-50;this._tmpMax=30};dc.STATES=["temperature","temperature_raw"];dc.prototype=new p;dc.prototype.constructor=dc;var Pa=function(c){p.call(this,
...
c.userData.readUInt8(0);1==(a>>3&1)&&(d.voltage=parseFloat((c/250*5).toFixed(1)),d.voltage_raw=c,b=b>>6&1023,d.illumination=b,d.illumination_raw=b,a=a>>7&1,d.state=a?"on":"off",d.state_raw=a)}"on"==d.state?this._startPIROffTO():"off"==d.state&&this._stopPIROffTO();return d};var xa=function(c){t.call(this,c);this._data="a5-08-??";this._svcMin=0;this._svcMax=5.1;this._illMin=0;this._illMax=510;this._tmpMin=0;this._tmpMax=51};xa.prototype=new t;xa.prototype.constructor=xa;xa.prototype.evalTelegram=function(c){var d=
...
"off"}d.state_raw=b;a&=1;switch(a){case 0:d.button="pressed";break;case 1:d.button="released"}d.button_raw=a}}return d};var Va=function(c){xa.call(this,c);this._data="a5-08-01"};Va.STATES="voltage voltage_raw illumination illumination_raw temperature temperature_raw state state_raw button button_raw".split(" ");Va.prototype=new xa;Va.prototype.constructor=Va;var oc=function(c){xa.call(this,c);this._data="a5-08-02";this._illMax=1020};oc.STATES="voltage voltage_raw illumination illumination_raw temperature temperature_raw state state_raw button button_raw".split(" ");
oc.prototype=new xa;oc.prototype.constructor=oc;var pc=function(c){xa.call(this,c);this._data="a5-08-03";this._illMax=1530;this._tmpMin=-30;this._tmpMax=50};pc.STATES="voltage voltage_raw illumination illumination_raw temperature temperature_raw state state_raw button button_raw".split(" ");pc.prototype=new xa;pc.prototype.constructor=pc;var D=function(c){t.call(this,c);this._data="a5-09-??"};D.prototype=new t;D.prototype.constructor=D;var hb=function(c){D.call(this,c);this._data="a5-09-02";this._svcMin=
...
"slider_raw"];vb.prototype=new qa;vb.prototype.constructor=vb;vb.prototype.evalTelegram=function(c){c=qa.prototype.evalTelegram.call(this,c);if(0==Object.keys(c).length)return c;delete c.fan_speed;delete c.fan_speed_raw;return c};var R=function(c){Wa.call(this,c);this._data="a5-10-10";this._params||(this._params={minSP:18,maxSP:26})};R.STATES="setpoint setpoint_raw humidity humidity_raw temperature temperature_raw button button_raw".split(" ");R.prototype=new Wa;R.prototype.constructor=R;R.prototype.evalTelegram=
...
R.prototype.fromJSON=function(c){if(!g.prototype.fromJSON.call(this,c))return null;this._params||(this._params={minSP:18,maxSP:26});return this};R.prototype.fromDBJSON=function(c){if(!g.prototype.fromDBJSON.call(this,c))return null;this._params||(this._params={minSP:18,maxSP:26});return this};var Da=function(c){R.call(this,c);this._data="a5-10-11"};Da.STATES="setpoint setpoint_raw humidity humidity_raw temperature temperature_raw slider slider_raw".split(" ");Da.prototype=new R;Da.prototype.constructor=
Da;Da.prototype.evalTelegram=function(c){var d=R.prototype.evalTelegram.call(this,c);if(0==Object.keys(d).length)return d;delete d.button;delete d.button_raw;c=c.userData.readUInt8(3)&1;d.slider=c?"day":"night";d.slider_raw=c;return d};var wb=function(c){R.call(this,c);this._data="a5-10-12"};wb.STATES="setpoint setpoint_raw humidity humidity_raw temperature temperature_raw".split(" ");wb.prototype=new R;wb.prototype.constructor=wb;wb.prototype.evalTelegram=function(c){c=R.prototype.evalTelegram.call(this,
c);if(0==Object.keys(c).length)return c;delete c.button;delete c.button_raw;return c};var xb=function(c){R.call(this,c);this._data="a5-10-13"};xb.STATES="humidity humidity_raw temperature temperature_raw button button_raw".split(" ");xb.prototype=new R;xb.prototype.constructor=xb;xb.prototype.evalTelegram=function(c){c=R.prototype.evalTelegram.call(this,c);if(0==Object.keys(c).length)return c;delete c.setpoint;delete c.setpoint_raw;return c};var yb=function(c){Da.call(this,c);this._data="a5-10-14"};
...
c);this._data="a5-12-02"};Ka.STATES=["volume","flow","tariff"];Ka.prototype=new ea;Ka.prototype.constructor=Ka;Ka.prototype.evalTelegram=function(c){c=ea.prototype.evalTelegram.call(this,c);c.volume=c.cumulative;c.flow=c.current;c.tariff=c.channel_raw;return c};var qc=function(c){Ka.call(this,c);this._data="a5-12-03"};qc.STATES=["volume","flow","tariff"];qc.prototype=new Ka;qc.prototype.constructor=qc;var S=function(c){t.call(this,c);this._data="a5-13-??"};S.STATES="lux lux_raw temperature temperature_raw wind wind_raw day_night rain sun_west sun_west_raw sun_south sun_south_raw sun_east sun_east_raw hemisphere day month year date_src weekday hour min sec time_format am_pm time_src elv azm latitude longitude latitude_raw longitude_raw".split(" ");
S.prototype=new t;S.prototype.constructor=S;S.prototype.evalTelegram=function(c){var d={};if(165==c.rorg){var a=c.userData.readUInt8(3),b=c.userData.readUInt8(2),e=c.userData.readUInt8(1),f=c.userData.readUInt8(0);if(1==(a>>3&1))switch(a>>4&15){case 1:d.lux=parseFloat((f/255*1E3).toFixed(1));d.lux_raw=f;var g=e;d.temperature=parseFloat((g/255*120-40).toFixed(1));d.temperature_raw=g;d.wind=parseFloat((b/255*70).toFixed(1));d.wind_raw=b;d.day_night=a>>2&1?"night":"day";d.rain=a>>1&1?"true":"false";
...
f;b=c.userData.readUInt16BE(1)&511;d.azm=b;d.azm_raw=b;break;case 6:c=(f>>4&15)<<8|e,b|=(f&15)<<8,d.latitude=parseFloat((c/4095*180-90).toFixed(1)),d.latitude_raw=c,d.longitude=parseFloat((b/4095*360-180).toFixed(1)),d.longitude_raw=b}}return d};var rc=function(c){S.call(this,c);this._data="a5-13-01"};rc.STATES="lux lux_raw temperature temperature_raw wind wind_raw day_night rain sun_west sun_west_raw sun_south sun_south_raw sun_east sun_east_raw hemisphere day month year date_src weekday hour min sec time_format am_pm time_src elv azm latitude longitude latitude_raw longitude_raw".split(" ");
rc.prototype=new S;rc.prototype.constructor=rc;var sc=function(c){S.call(this,c);this._data="a5-13-02"};sc.STATES="sun_west sun_west_raw sun_south sun_south_raw sun_east sun_east_raw hemisphere".split(" ");sc.prototype=new S;sc.prototype.constructor=sc;var tc=function(c){S.call(this,c);this._data="a5-13-03"};tc.STATES=["day","month","year","date_src"];tc.prototype=new S;tc.prototype.constructor=tc;var uc=function(c){S.call(this,c);this._data="a5-13-04"};uc.STATES="weekday hour min sec time_format am_pm time_src".split(" ");
uc.prototype=new S;uc.prototype.constructor=uc;var vc=function(c){S.call(this,c);this._data="a5-13-05"};vc.STATES=["elv","azm"];vc.prototype=new S;vc.prototype.constructor=vc;var wc=function(c){S.call(this,c);this._data="a5-13-06"};wc.STATES=["latitude","longitude"];wc.prototype=new S;wc.prototype.constructor=wc;var Bb=function(c){g.call(this,c);this._data="a5-14-01"};Bb.STATES=["voltage","voltage_raw","state"];Bb.prototype=new g;Bb.prototype.constructor=Bb;Bb.prototype.evalTelegram=function(c){var d=
...
null!=d.button_lock?ha="locked"==d.button_lock?1:0:this._states.button_lock&&this._states.button_lock.value&&(ha="locked"==this._states.button_lock.value?1:0);if("undefined"==typeof ha||null==ha)ha=0,e.button_lock="unlocked";d=0;"undefined"!=typeof this._service_command_new&&null!=this._service_command_new&&(d=this._service_command_new,this._service_command_new=null);q=new Buffer([q,g,(h&1)<<6|k&63,(l&3)<<4|8|(ha&1)<<2|d&3]);f&&require("x.hub.m.enocean.js")._deviceHandler.deviceParamsUpdated();f=
...
e.executeCommand(c,d,a):a&&a(Error("unkown current status"))},200)});break}b=parseInt(this._states.output_value.value);b-=5;0>b&&(b=0);this.executeCommand(c,{value:"dimTo",ext:b},a);break;default:a&&a(Error("unknow command"))}}else a&&a(Error("command invalid"))};var Ea=function(c){E.call(this,c);this._data="d2-01-11"};Ea.COMMANDS="ch1On ch1Off ch1Toggle ch2On ch2Off ch2Toggle".split(" ");Ea.STATES="power_failure_detection power_failure over_current_switch_off error_level io_channel local_control output_value output_state ch1_output_value ch1_output_state ch2_output_value ch2_output_state".split(" ");
Ea.prototype=new E;Ea.prototype.constructor=Ea;Ea.prototype.getIOs=function(){return[0,1]};Ea.prototype.evalTelegram=function(c){if(c=E.prototype.evalTelegram.call(this,c))switch(c.io_channel){case 0:c.ch1_output_value=c.output_value;c.ch1_output_state=c.output_state;break;case 1:c.ch2_output_value=c.output_value,c.ch2_output_state=c.output_state}return c};Ea.prototype.executeCommand=function(c,d,a){if(d&&d.value){var b=this;switch(d.value){case "ch1On":this.activeStateChange({ch1_output_value:100,
...
b.executeCommand(c,d,a):a&&a(Error("unkown current status"))},200)});break}if(!this._states[q]){a&&a(Error("state unknown"));break}h="on"==this._states[q].value?"off":"on";g={};g[f]="on"==h?100:0;g[q]=h;h={DV:0,IO:e,OV:"on"==h?100:0};this.activeStateChange(g);this.setOutput(c,h,a);break;default:a&&a(Error("unknown command"))}}else a&&a(Error("command invalid"))};var zc=function(c){fa.call(this,c);this._data="d2-05-??"};zc.prototype=new fa;zc.prototype.constructor=zc;var M=function(c){zc.call(this,
c);this._data="d2-05-00"};M.COMMANDS="moveUp moveDown moveTo stepUp stepDown lamellaUp lamellaDown lamellaTo stop setRunTime setRotationTime setParams[15.2s]:[10,20,30ms]:[0-3]".split(" ");M.STATES=["state","angle","lock","channel"];M.prototype=new zc;M.prototype.constructor=M;M.prototype.init=function(c){var d=require("x.hub.m.enocean.js")._esp3;this.query(d,{CHN:0},c)};M.prototype.getStatesBuffer=function(){0==Object.keys(this._states).length&&this.init();return this._states};M.prototype.goToPositionAngle=
function(c,d,a){var b=this._senderID;this._senderID||(b=x.hub.m.enocean.SENDER_ID);d=new Buffer([d.POS&127,d.ANG&127,(d.REPO&7)<<4|d.LOCK&7,(d.CHN&15)<<4|1]);b=new x.hub.m.enocean.ESP3.Telegram.VLD(d,b,0);b.setDstId(this._address);c.sendTelegram(b,!0,function(c){a&&a(c)})};M.prototype.stop=function(c,d,a){var b=this._senderID;this._senderID||(b=x.hub.m.enocean.SENDER_ID);d=new Buffer([(d.CHN&15)<<4|2]);b=new x.hub.m.enocean.ESP3.Telegram.VLD(d,b,0);b.setDstId(this._address);c.sendTelegram(b,!0,function(c){a&&
a(c)})};M.prototype.query=function(c,d,a){var b=this._senderID;this._senderID||(b=x.hub.m.enocean.SENDER_ID);d=new Buffer([(d.CHN&15)<<4|3]);b=new x.hub.m.enocean.ESP3.Telegram.VLD(d,b,0);b.setDstId(this._address);c.sendTelegram(b,!0,function(c){a&&a(c)})};M.prototype.setParameters=function(c,d,a){var b=this._senderID;this._senderID||(b=x.hub.m.enocean.SENDER_ID);d=new Buffer([d.VERT>>8&127,d.VERT&255,d.ROT&255,d.AA&7,(d.CHN&15)<<4|5]);b=new x.hub.m.enocean.ESP3.Telegram.VLD(d,b,0);b.setDstId(this._address);
c.sendTelegram(b,!0,function(c){a&&a(c)})};M.prototype.evalTelegram=function(c){var d={};if(210==c.rorg)switch(c.userData.readUInt8(c.userData.length-1)&15){case 4:if(4==c.userData.length){var a=c.userData.readUInt8(0);d.state=a&127;a=c.userData.readUInt8(1);d.angle=a&127;a=c.userData.readUInt8(2);switch(a&7){case 0:d.lock="normal";break;case 1:d.lock="blockage_mode";break;case 2:d.lock="alarm_mode"}a=c.userData.readUInt8(3);d.channel=a>>4&15}}return d};M.prototype.executeCommand=function(c,d,a){if(d&&
...
l=c.userData.readUInt16LE(7),m=c.userData.readUInt8(9),r=c.userData.readUInt8(10),ha=c.userData.readInt16BE(11);c=c.userData.readUInt8(13);a.filter_remaining_time=g+":"+f+":"+e+":"+b;a.operating_time=m+":"+l+":"+k+":"+h;a.temperature=ha/10;a.message_code=r;a.anti_freeze=c>>4&1?"on":"off";a.current_fan_level=c&7}return a};ba.prototype._sendResponse=function(c,a,b){var d=this._senderID;this._senderID||(d=x.hub.m.enocean.SENDER_ID);a=new Buffer([a.LS,a.RS]);d=new x.hub.m.enocean.ESP3.Telegram.VLD(a,
d,0);this._senderID!=this._address&&d.setDstId(this._address);c.sendTelegram(d,!0,function(c){b&&b(c)})};ba.prototype._activateSensorRegulation=function(c){var a=require("x.hub.m.enocean.js").getRehauHandler();a&&a.activateSensorRegulation(this.getAddress(),c)};ba.prototype._deactivateSensorRegulation=function(){var c=require("x.hub.m.enocean.js").getRehauHandler();c&&c.deactivateSensorRegulation(this.getAddress())};var Pb=function(c){P.call(this,c);this._data="eltako_contact";this._vendor="eltako";
this._eepAlias="f6-10-00"};Pb.STATES=["contact","contact_raw"];Pb.prototype=new P;Pb.prototype.constructor=Pb;Pb.prototype.evalTelegram=function(c){var a={};246==c.rorg&&(c=c.userData,240==c?a.contact="closed":224==c&&(a.contact="open"),a.contact_raw=c);return a};var Ma=function(c){Va.call(this,c);this._data="eltako_motion";this._vendor="eltako";this._eepAlias="a5-08-01"};Ma.STATES="voltage voltage_raw illumination illumination_raw state state_raw".split(" ");Ma.prototype=new Va;Ma.prototype.constructor=
...
Ub.prototype=new e;Ub.prototype.constructor=Ub;Ub.prototype.evalTelegram=function(a){var c={};if(246==a.rorg)switch(a.userData){case 48:c.keycard="guest_card";case 32:c.keycard="service_card";case 16:c.keycard="inserted";case 0:c.keycard="takeout"}return c};var ta=function(a){Ba.call(this,a);this._data="eltako_thermo";this._vendor="eltako";this._eepAlias="a5-10-06"};ta.STATES="setpoint setpoint_raw temperature temperature_raw night_reduce night_reduce_raw".split(" ");ta.prototype=new Ba;ta.prototype.constructor=
ta;ta.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3),e=a.userData.readUInt8(2),f=a.userData.readUInt8(1);a=a.userData.readUInt8(0);1==(b>>3&1)&&(c.night_reduce=6>=a?0:12>=a?1:19>=a?2:25>=a?3:31>=a?4:5,c.night_reduce_raw=a,c.setpoint=parseFloat((f/255*40).toFixed(1)),c.setpoint_raw=f,c.temperature=parseFloat(((255-e)/255*40).toFixed(1)),c.temperature_raw=e)}return c};var Vb=function(a){ta.call(this,a);this._data="eltako_ftr65hb";this._vendor="eltako";this._eepAlias=
"a5-10-06"};Vb.STATES=["setpoint","setpoint_raw","temperature","temperature_raw"];Vb.prototype=new ta;Vb.prototype.constructor=Vb;Vb.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3),e=a.userData.readUInt8(2);a=a.userData.readUInt8(1);1==(b>>3&1)&&(c.setpoint=parseFloat((a/255*40).toFixed(1)),c.setpoint_raw=a,c.temperature=parseFloat(((255-e)/255*40).toFixed(1)),c.temperature_raw=e)}return c};var Ic=function(a){ta.call(this,a);this._data="eltako_futh65d";this._vendor=
...
{};if(165==a.rorg){var b=a.userData.readUInt8(3);a=a.userData.readUInt8(2);1==(b>>3&1)&&(c.water=15==a,c.water_raw=a)}return c};var ac=function(a){La.call(this,a);this._data="eltako_water_m4";this._vendor="eltako";this._eepAlias="a5-30-01"};ac.STATES=["water","water_raw"];ac.prototype=new La;ac.prototype.constructor=ac;ac.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3);a=a.userData.readUInt8(2);1==(b>>3&1)&&(c.water=0==a,c.water_raw=a)}return c};var ua=function(a){H.call(this,
a);this.TEACH_IN_VARIATION=3;this._data="peha_powerswitch";this._vendor="peha";this._eepAlias="a5-38-08"};ua.COMMANDS=["on","off","toggle"];ua.STATES="state state_raw level rgb power energy current voltage power_raw power_unit energy_unit current_unit voltage_unit power_unit_raw op_hour error error_raw service_mode op_hour_flag op_hour_flag_raw mode_raw".split(" ");ua.prototype=new H;ua.prototype.constructor=ua;ua.prototype.getTeachinType=function(){return"4BS"};ua.prototype.evalTelegram=function(a){return Ya.prototype.evalTelegram.call(this,
a)};ua.prototype.executeCommand=function(a,b,e){if(b&&b.value){(new Date).getTime();var c=this;switch(b.value){case "on":this.switching(a,{TIM:0,LCK:0,DEL:0,SW:1},function(a){a||c.activeStateChange({state:"on"});e&&e(a)});break;case "off":this.switching(a,{TIM:0,LCK:0,DEL:0,SW:0},function(a){a||c.activeStateChange({state:"off"});e&&e(a)});break;case "toggle":if(!this._states.state){e&&e(Error("unknow previous switch state"));break}"on"==this._states.state.value?this.executeCommand(a,{value:"off"},
e):this.executeCommand(a,{value:"on"},e);break;default:e&&e(Error("unknow command"))}}else e&&e(Error("command invalid"))};var cb=function(a){ua.call(this,a);this.TEACH_IN_VARIATION=3;this._data="peha_switch";this._vendor="peha";this._eepAlias="a5-38-08"};cb.COMMANDS=["on","off","toggle"];cb.STATES="state state_raw level rgb power energy current voltage power_raw power_unit energy_unit current_unit voltage_unit power_unit_raw op_hour error error_raw service_mode op_hour_flag op_hour_flag_raw mode_raw".split(" ");
cb.prototype=new ua;cb.prototype.constructor=cb;cb.prototype.evalTelegram=function(a){a=Ya.prototype.evalTelegram.call(this,a);delete a.power;delete a.energy;delete a.current;delete a.voltage;delete a.power_unit;delete a.energy_unit;delete a.current_unit;delete a.voltage_unit;return a};var va=function(a){H.call(this,a);this.TEACH_IN_VARIATION=3;this._data="peha_blind";this._vendor="peha";this._eepAlias="a5-38-08";this._initCount=0};va.COMMANDS="up down stop stepUp stepDown moveTo lamellaUp lamellaDown lamellaStepUp lamellaStepDown lamellaTo setRunTime setLamellaRuntime".split(" ");
va.STATES="position angle position_flag position_flag_raw angle_flag angle_flag_raw error error_raw end_position end_position_raw state state_raw service_mode position_mode".split(" ");va.prototype=new H;va.prototype.constructor=va;va.prototype.init=function(a){var c=require("x.hub.m.enocean.js")._esp3;this.blind(c,{P1:0,P2:0,FUNC:0,SSF:0,PAF:0,SMF:0},function(c){a&&a()})};va.prototype.getTeachinType=function(){return"4BS"};va.prototype.getStatesBuffer=function(){0==Object.keys(this._states).length?
(100>=this._initCount&&0==this._initCount%10?this.init():100<=this._initCount&&600>=this._initCount&&0==this._initCount%60?this.init():this._initCount=0,this._initCount++):this._initCount=0;return this._states};va.prototype.evalTelegram=function(a){return zb.prototype.evalTelegram.call(this,a)};va.prototype.executeCommand=function(a,b,e){if(b&&b.value){(new Date).getTime();var c=this;if("stepUp"==b.value.substr(0,6)&&6<b.value.length){var d=b.value.substr(6);b={value:"stepUp",ext:d}}else"stepDown"==
...
"open");b=!0}else 208==a.rorg&&(b=a.userData.readUInt8(0),c.battery=Math.round(b/100*255),c.battery_raw=b,b=!0);return b?c:null};var Lc=function(a){W.call(this,a);this._data="afriso_water_con";this._vendor="afriso";this._eepAlias="a5-30-03"};Lc.prototype=new W;Lc.prototype.constructor=Lc;Lc.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3),e=a.userData.readUInt8(2);a=a.userData.readUInt8(1);1==(b>>3&1)&&(c.temperature=(255-a)/255*40,c.temperature_raw=a,c.water=
0==(e>>4&1)?!0:!1)}return c};var bc=function(a){A.call(this,a);this._data="afriso_water_eco";this._vendor="afriso";this._eepAlias="f6-05-01"};bc.prototype=new A;bc.prototype.constructor=bc;bc.prototype.evalTelegram=function(a){var c={};246==a.rorg&&(a=a.nu,1==a?c.water="true":0==a&&(c.water="false"));return c};bc.prototype.onLearn=function(){this._states.water={value:!1,time:(new Date).getTime()}};var Mc=function(a){W.call(this,a);this._data="afriso_asd_10";this._vendor="afriso";this._eepAlias="a5-30-03"};
Mc.prototype=new W;Mc.prototype.constructor=Mc;Mc.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3),e=a.userData.readUInt8(2);a=a.userData.readUInt8(1);1==(b>>3&1)&&(c.temperature=(255-a)/255*40,c.temperature_raw=a,c.smoke=0==(e>>4&1)?!0:!1)}return c};var cc=function(a){P.call(this,a);this._data="hoppe_door";this._vendor="hoppe";this._eepAlias="f6-10-00"};cc.STATES=["door"];cc.prototype=new P;cc.prototype.constructor=cc;cc.prototype.evalTelegram=function(a){var c=
{};246==a.rorg&&(a=a.userData,0==(a&208^192)?c.door="open":0==(a&240^240)&&(c.door="closed"),c.handle_raw=a);return c};var Pc=function(){var a=function(a){g.call(this,a);this._data="gp";this._gpInfo=null};a.prototype=new g;a.prototype.constructor=a;a.prototype.toJSON=function(){var a=g.prototype.toJSON.call(this);a.gpInfo=this._gpInfo;return a};a.prototype.fromJSON=function(a){if(!g.prototype.fromJSON.call(this,a))return null;a&&a.gpInfo&&(this._gpInfo=a.gpInfo);return this};a.prototype.toDBJSON=
function(){var a=g.prototype.toDBJSON.call(this);a.gpInfo=this._gpInfo;return a};a.prototype.fromDBJSON=function(a){if(!g.prototype.fromDBJSON.call(this,a))return null;a&&a.gpInfo&&(this._gpInfo=a.gpInfo);return this};return a}(),Sc=function(){var a=function(a){Pc.call(this,a);this._data="afriso_ais_10";this._vendor="afriso";this._eepAlias="gp"};a.prototype=new Pc;a.prototype.constructor=a;a.prototype.isGPMatch=function(a,c){return 45!=a?!1:8==c};a.prototype.evalTelegram=function(a){var c={};if(178==
a.rorg){var b=a.data.readUInt8(0)>>7&1,d=a.data.readUInt8(0)>>6&1;a=a.data.readUInt8(0)>>5&1;c.alarm=1==b?"on":"off";c.active=1==d?"on":"off";c.powerAlarm=1==a?"alarm":"no_change"}return c};a.prototype.executeCommand=function(a,c,b){if(c&&c.value){switch(c.value){case "arming":this._setActive(a,!0,b);break;case "disarming":this._setActive(a,!1,b);break;case "toggleArming":this._states&&this._states.active?this._setActive(a,"off"==this._states.active.value,b):this._setActive(a,!0,b);break;case "alarmOn":this._setAlarm(a,
!0,b);break;case "alarmOff":this._setAlarm(a,!1,b);break;case "toggleAlarm":this._states&&this._states.alarm?this._setAlarm(a,"off"==this._states.alarm.value,b):this._setAlarm(a,!1,b);break;default:b&&b(Error("unknow command"));return}b&&b()}else b&&b(Error("command invalid"))};a.prototype._setActive=function(a,c,b){var d=!1;this._states&&this._states.alarm&&"on"==this._states.alarm.value&&(d=!0);this._sendGPCD(a,d,c,b)};a.prototype._setAlarm=function(a,c,b){var d=!0;this._states&&this._states.active&&
"off"==this._states.active.value&&(d=!1);this._sendGPCD(a,c,d,b)};a.prototype._sendGPCD=function(a,c,b,e){var d=this._senderID;this._senderID||(d=x.hub.m.enocean.SENDER_ID);var f=0;c&&(f|=128);b&&(f|=64);c=new Buffer(1);c.writeUInt8(f,0);d=new x.hub.m.enocean.ESP3.Telegram.GP_CD(c,d,0);d.setDstId(this._address);a.sendTelegram(d,!0,function(a){e&&e(a)})};return a}(),wa=function(){var a=function(a){da.call(this,a);this._data="eltako_tf_ttb";this._vendor="eltako";this._eepAlias="a5-07-01";this._params=
{reset_timeout:300}};a.prototype=new da;a.prototype.constructor=a;a.prototype.evalTelegram=function(a){return 246==a.rorg?k.prototype.evalTelegram.call(this,a):165==a.rorg?da.prototype.evalTelegram.call(this,a):{}};a.prototype.checkStateChange=function(a){return a.button?k.prototype.checkStateChange.call(this,a):da.prototype.checkStateChange.call(this,a)};a.prototype.fromJSON=function(a){da.prototype.fromJSON.call(this,a);this._params={reset_timeout:300};return this};var b=function(a){W.call(this,
a);this._data="eltako_tf_smoke";this._vendor="eltako";this._eepAlias="a5-30-03"};b.STATES=["temperature","temperature_raw","smoke","smoke_raw"];b.prototype=new W;b.prototype.constructor=b;b.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3),d=a.userData.readUInt8(2),e=a.userData.readUInt8(1);a.userData.readUInt8(0);1==(b>>3&1)&&(c.temperature=parseFloat(((255-e)/255*40).toFixed(1)),c.temperature_raw=e,c.smoke=15==d?!0:!1,c.smoke_raw=d)}return c};var e=function(a){P.call(this,
a);this._data="eltako_tf_contact";this._vendor="eltako";this._eepAlias="d5-00-01"};e.STATES=["contact","contact_raw","voltage","voltage_raw"];e.prototype=new O;e.prototype.constructor=e;e.prototype.evalTelegram=function(a){var c={};if(213==a.rorg){var b=a.userData;1==(b>>3&1)&&(b&=1,c.contact=b?"closed":"open",c.contact_raw=b)}else if(165==a.rorg){b=a.userData.readUInt8(3);a.userData.readUInt8(2);var d=a.userData.readUInt8(1);a=a.userData.readUInt8(0);1==(b>>3&1)&&(c.voltage=parseFloat(d/255*5).toFixed(1),
c.voltage_raw=d,c.energy=parseFloat(a/255*5).toFixed(1),c.energy_raw=a)}return c};var f=function(a){Ma.call(this,a);this._data="eltako_motion2";this._vendor="eltako";this._eepAlias="a5-08-01"};f.STATES="voltage voltage_raw illumination illumination_raw state state_raw".split(" ");f.prototype=new Ma;f.prototype.constructor=f;f.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3);a.userData.readUInt8(2);var d=a.userData.readUInt8(1);a=a.userData.readUInt8(0);if(1==
(b>>3&1)){c.voltage=parseFloat((a/255*5.1).toFixed(1));c.voltage_raw=a;c.illumination=parseFloat((d/255*510).toFixed(1));c.illumination_raw=d;switch(b){case 13:c.state="on";break;case 15:c.state="off"}c.motion_raw=b}}return c};var g=function(a){da.call(this,a);this._data="eltako_tf_motion";this._vendor="eltako";this._eepAlias="a5-07-01"};g.STATES=["motion","motion_raw"];g.prototype=new da;g.prototype.constructor=g;g.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3);
a=a.userData.readUInt8(2);1==(b>>3&1)&&(c.motion=200==a||255==a?!0:!1,c.motion_raw=a)}return c};var h=function(a){H.call(this,a);this._data="eltako_tf_input";this._vendor="eltako";this._eepAlias="a5-38-08"};h.STATES=["state","state_raw"];h.prototype=new H;h.prototype.constructor=h;h.prototype.evalTelegram=function(a){var c={};165==a.rorg&&(a=a.userData.readUInt8(3),1==(a>>3&1)&&(c.input=8==a?!1:!0,c.input_raw=a));return c};var l=function(a){Ba.call(this,a);this._data="eltako_tf_thermo";this._vendor=
"eltako";this._eepAlias="a5-10-06"};l.STATES="setpoint setpoint_raw temperature temperature_raw night_reduce night_reduce_raw".split(" ");l.prototype=new ta;l.prototype.constructor=l;l.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3),d=a.userData.readUInt8(2),e=a.userData.readUInt8(1);a.userData.readUInt8(0);1==(b>>3&1)&&(c.setpoint=parseFloat((e/255*40).toFixed(1)),c.setpoint_raw=e,c.temperature=parseFloat(((255-d)/255*40).toFixed(1)),c.temperature_raw=d)}return c};
var m=function(a){Na.call(this,a);this._data="eltako_tf_lux"};m.prototype=new Na;m.prototype.constructor=m;var r=function(a){H.call(this,a);this._data="eltako_dimmer_knob";this._vendor="eltako";this._eepAlias="a5-38-08"};r.STATES=["state","dimmerLevel"];r.prototype=new H;r.prototype.constructor=r;r.prototype.evalTelegram=function(a){var c={};if(165==a.rorg){var b=a.userData.readUInt8(3),d=a.userData.readUInt8(2),e=a.userData.readUInt8(1);a=a.userData.readUInt8(0);if(1==(b>>3&1))switch(a){case 2:c.dimmerLevel=
e,c.ramp=d,c.dim_range=b>>2&1?"relative":"absolute",c.store_final_value=b>>1&1,c.state=b&1?"on":"off"}}return c};var p=function(a){Oc.call(this,a);this.TEACH_IN_VARIATION=3;this._data="eltako_tf_alarm"};p.prototype=new Oc;p.prototype.constructor=p;p.prototype.evalTelegram=function(a){var c={};if(246==a.rorg)switch(a.userData){case 48:c.active=!0;break;case 16:c.active=!1}else 165==a.rorg&&(a=a.userData.readUInt8(3),8==a?c.alarm="ok":9==a&&(c.alarm="alarm"));return c};p.prototype.executeCommand=function(a,
c,b){if(c&&c.value){var d=null;switch(c.value){case "triggerAlarm":d=new Buffer([1,0,0,9]);break;case "deactivate":d=new Buffer([1,0,0,12]);break;case "activate":d=new Buffer([1,0,0,8]);break;default:b&&b(Error("unknow command"))}c=this._senderID;this._senderID||(c=x.hub.m.enocean.SENDER_ID);d=new x.hub.m.enocean.ESP3.Telegram.BS4(d,c,0);d.setDstId(this._address);a.sendTelegram(d,!0,function(a){b&&b(a)})}else b&&b(Error("command invalid"))};var n=function(a){F.call(this,a);this._data="eltako_f6t";
this._vendor="eltako";this.BUTTONS="buttonCO buttonCI buttonBO buttonBI buttonAO buttonAI".split(" ")};n.STATES="buttonCO buttonCI buttonBO buttonBI buttonAO buttonAI".split(" ");n.prototype=new F;n.prototype.constructor=n;n.prototype.evalTelegram=function(a){var c={};if(246==a.rorg){var b=parseInt(this._address,16),d=a.senderID?parseInt(a.senderID,16):null;if(d&&d==b+1)switch(a.userData){case 112:c.buttonCI="pressed";break;case 80:c.buttonCO="pressed";break;case 0:for(a=0;a<this.BUTTONS.length;a++)this.BUTTONS[a]&&
(c[this.BUTTONS[a]]="released")}else switch(a.userData){case 112:c.buttonAI="pressed";break;case 80:c.buttonAO="pressed";break;case 48:c.buttonBI="pressed";break;case 16:c.buttonBO="pressed";break;case 0:for(a=0;a<this.BUTTONS.length;a++)this.BUTTONS[a]&&(c[this.BUTTONS[a]]="released")}}return c};return{TF_TTB:a,TF_RWB:b,TF_FKB:e,TF_BHSB:g,TF_BHSB_FBH:f,TF_Input:h,TF_Thermo:l,TF_Lux:m,Dimmer_Knob:r,TF_Alarm:p,Eltako_F6T:n}}();return{"f6-??-??":e,"f6-01-01":k,"f6-02-01":h,"f6-02-02":l,"f6-02-03":r,
"f6-02-04":m,"f6-03-01":u,"f6-03-02":z,"f6-04-01":C,"f6-04-02":I,"f6-05-00":J,"f6-05-01":A,"f6-05-02":w,"f6-10-00":P,"f6-10-01":U,"d5-xx-xx":a,"d5-??-??":X,"d5-00-01":O,"f6-so-da":f,"a5-??-??":t,"a5-02-01":Y,"a5-02-02":K,"a5-02-03":oa,"a5-02-04":N,"a5-02-05":Q,"a5-02-06":ca,"a5-02-07":Z,"a5-02-08":aa,"a5-02-09":Qa,"a5-02-0a":v,"a5-02-0b":n,"a5-02-10":Oa,"a5-02-11":dc,"a5-02-12":Pa,"a5-02-13":ec,"a5-02-14":fc,"a5-02-15":Ga,"a5-02-16":gc,"a5-02-17":db,"a5-02-18":hc,"a5-02-19":ic,"a5-02-1a":jc,"a5-02-1b":kc,
"a5-02-20":Fa,"a5-02-30":lc,"a5-04-01":mc,"a5-04-02":Ra,"a5-04-03":eb,"a5-06-01":Sa,"a5-06-02":Ha,"a5-06-03":fb,"a5-06-04":gb,"a5-06-05":nc,"a5-07-01":da,"a5-07-02":Ta,"a5-07-03":Ua,"a5-08-01":Va,"a5-08-02":oc,"a5-08-03":pc,"a5-09-02":hb,"a5-09-04":ib,"a5-09-05":jb,"a5-09-06":kb,"a5-09-07":lb,"a5-09-08":mb,"a5-09-09":nb,"a5-09-0a":ob,"a5-09-0b":pb,"a5-09-0c":qb,"a5-10-01":B,"a5-10-02":la,"a5-10-03":Ia,"a5-10-04":rb,"a5-10-05":sb,"a5-10-06":Ba,"a5-10-07":tb,"a5-10-08":pa,"a5-10-09":qa,"a5-10-0a":Ca,
"a5-10-0b":Ja,"a5-10-0c":ub,"a5-10-0d":vb,"a5-10-10":R,"a5-10-11":Da,"a5-10-12":wb,"a5-10-13":xb,"a5-10-14":yb,"a5-12-00":Ab,"a5-12-01":ma,"a5-12-02":Ka,"a5-12-03":qc,"a5-13-01":rc,"a5-13-02":sc,"a5-13-03":tc,"a5-13-04":uc,"a5-13-05":vc,"a5-13-06":wc,"a5-14-01":Bb,"a5-14-02":Cb,"a5-14-03":Db,"a5-14-04":Eb,"a5-14-05":Fb,"a5-14-06":Gb,"a5-14-07":Hb,"a5-14-08":Ib,"a5-14-09":Jb,"a5-14-0a":Kb,"a5-20-04":ja,"a5-30-01":La,"a5-30-02":Lb,"a5-30-03":W,"a5-30-04":Mb,"a5-38-08":H,"d2-??-??":fa,"d2-01-00":na,
"d2-01-01":Nb,"d2-01-03":Ob,"d2-01-11":Ea,"d2-01-13":ra,"d2-01-14":sa,"d2-05-00":M,"d2-05-01":ya,"d2-06-01":za,"d2-06-02":Aa,"d2-06-10":Nc,"d2-06-ff":Kc,"d2-06-50":b,"d2-20-00":ba,eltako_dimmer:G,eltako_dimmer2:$a,eltako_fsud:Qb,eltako_motion:Ma,eltako_contact:Pb,eltako_weather:Rb,eltako_lux:Na,eltako_lux2:Cc,eltako_sender2:Ec,eltako_sender4:Fc,eltako_button1:Dc,eltako_button2:Gc,eltako_button4:Hc,eltako_blind:T,eltako_fsm60b:Sb,eltako_fkf:Tb,eltako_fkc:Ub,eltako_thermo:ta,eltako_ftr65hb:Vb,eltako_futh65d:Ic,
eltako_ftr78s:Wb,eltako_powermeter:ab,eltako_powermeter2:Jc,eltako_fzs:bb,eltako_switch:ka,eltako_relay:Yb,eltako_relay2:Xb,eltako_heat:Zb,eltako_water_m3:$b,eltako_water_m4:ac,eltako_tf_switch:Oc,eltako_tf_dimmer:Qc,eltako_tf_blind:Rc,peha_switch:cb,peha_powerswitch:ua,peha_blind:va,"bb-aa-cc":y,afriso_water_con:Lc,afriso_water_eco:bc,afriso_asd_10:Mc,hoppe_door:cc,gp:Pc,afriso_ais_10:Sc,eltako_tf_ttb:wa.TF_TTB,eltako_tf_smoke:wa.TF_RWB,eltako_tf_contact:wa.TF_FKB,eltako_tf_motion:wa.TF_BHSB,eltako_motion2:wa.TF_BHSB_FBH,
eltako_tf_thermo:wa.TF_Thermo,eltako_tf_input:wa.TF_Input,eltako_tf_lux:wa.TF_Lux,eltako_dimmer_knob:wa.Dimmer_Knob,eltako_tf_alarm:wa.TF_Alarm,eltako_f6t:wa.Eltako_F6T,parseDBJson:function(a){if(!a||!a.eep)return null;var c=this[a.eep];if(!c)return null;c=new c;return c=c.fromDBJSON(a)},parseJson:function(a){if(!a||!a.data)return null;var c=this[a.data];if(!c)return null;c=new c;return c=c.fromJSON(a)}}}();
...
f.prototype.isWindowOpen=function(){var a=this._mainHandler.getDeviceHandler(),b=a.findDeviceWithData("bb-aa-cc"),f=a.findDeviceWithData("d2-06-10");a=a.findDeviceWithData("d2-06-ff");f&&(b=b.concat(f));a&&(b=b.concat(a));f=!1;for(a=0;a<b.length;a++){var g=b[a];if(g&&"open"==g.getBufferedState("window")){f=!0;break}}return f};f.prototype.setAlarm=function(a,b){this._windowAlarm.setAlarm(a);var e=this._mainHandler.getDeviceHandler(),f=e.findDeviceWithData("bb-aa-cc"),g=e.findDeviceWithData("d2-06-10");
e=e.findDeviceWithData("d2-06-ff");g&&(f=f.concat(g));e&&(f=f.concat(e));g=this._mainHandler.getESP3();for(e=0;e<f.length;e++){var k=f[e];k&&(k.executeCommand(g,{value:a?"alarmTaskOn":"alarmTaskOff"}),k.executeCommand(g,{value:a?"preAlarmTaskOn":"preAlarmTaskOff"}))}b&&b()};f.prototype.getAlarm=function(){return this._windowAlarm.getAlarm()};f.prototype.setSmartGuardAlarm=function(b,f,g){if(b){var e=this._smartguardSettings[b];e||(e=new a(b),this._smartguardSettings[b]=e);e.setAlarm(f);this._saveData(g)}else g&&
g(Error("smartguardID invalid"))};f.prototype.setSmartGuardPreAlarm=function(b,f,g){if(b){var e=this._smartguardSettings[b];e||(e=new a(b),this._smartguardSettings[b]=e);e.setPreAlarm(f);this._saveData(g)}else g&&g(Error("smartguardID invalid"))};f.prototype.onReceiveWindowSensorStates=function(a,b){this._windowAlarm.onReceiveWindowSensorStates(a,b)};f.prototype.onDeleteDevice=function(a){if(a&&(a=a.getAddress()))if(this.getInoventAccessory(a))this.deleteInoventAccessory(a);else if(this.getSmartguardSetting(a))this.deleteSmartguardSetting(a);
else{var b=!1,e;for(e in this._inoventAccessories){var f=this._inoventAccessories[e];f&&(f.getHumiditySensorID()==a&&(f.setHumiditySensorID(null),b=!0),f.getCo2SensorID()==a&&(f.setCo2SensorID(null),b=!0))}b&&this._saveData()}};f.prototype.onDeviceEvent=function(a,b){var e=function(a){for(var b=null,e=0;e<a.length;e++){var f=a[e];if(f&&"humidity"==f.key){b=f.value;break}}return b},f=function(a){for(var b=null,e=0;e<a.length;e++){var f=a[e];if(f&&"co2"==f.key){b=f.value;break}}return b};if(a){var g=
a.getAddress();if(g){var k=null;switch(a.getData()){case "a5-04-01":case "a5-04-03":case "a5-10-12":k=e(b);break;case "a5-09-08":case "a5-09-09":k=f(b);break;default:return}if(void 0!=k&&null!=k)for(var u in this._inoventAccessories)if(a=this._inoventAccessories[u])a.getHumiditySensorID()==g&&a.executeHumidityRegulation(k),a.getCo2SensorID()==g&&a.executeCo2Regulation(k)}}};f.prototype._loadInoventAccessories=function(a){var b=this;this._loadFile(function(e,f){e?a&&a(e):(e=b._jsonToAccessoriesMap(f),
f=b._jsonToSmartGuardSettingsMap(f),a&&a(null,e,f))})};f.prototype._jsonToAccessoriesMap=function(a){if(!a||!a.inovent)return{};var b={},e;for(e in a.inovent){var f=a.inovent[e];if(f){var r=new g(e);r.fromJSON(f);b[e]=r}}return b};f.prototype._jsonToSmartGuardSettingsMap=function(b){if(!b||!b.smartguard)return{};var e={},f;for(f in b.smartguard){var g=b.smartguard[f];if(g){var r=new a(f);r.fromJSON(g);e[f]=r}}return e};f.prototype._loadFile=function(a){var b=this._getFilePath();fs_extra.ensureFile(b,
function(e){e?a&&a(e):fs_extra.readFile(b,"utf8",function(b,e){if(b)a&&a(b);else if(e)try{var f=JSON.parse(e);a&&a(null,f)}catch(u){a&&a(u)}else a&&a(null,{})})})};f.prototype._getFilePath=function(){var a=require("x.hub.fileman.js").fileManager,b=require("path");require("fs");a=a.getUserRootDataPath();return b.resolve(a,this.REHAU_FILE)};f.prototype._saveData=function(a){var b=this._accessoriesMapToJson(this._inoventAccessories),e=this._settingsMapToJson(this._smartguardSettings);this._saveFile({inovent:b?
b:{},smartguard:e?e:{}},function(b){a&&a(b)})};f.prototype._accessoriesMapToJson=function(a){if(!a)return{};var b={},e;for(e in a){var f=a[e];f&&(f=f.toJSON(),b[e]=f)}return b};f.prototype._settingsMapToJson=function(a){if(!a)return{};var b={},e;for(e in a){var f=a[e];f&&(f=f.toJSON(),b[e]=f)}return b};f.prototype._saveFile=function(a,b){var e=this._getFilePath();fs_extra.writeFile(e,JSON.stringify(a,null,2),function(a){b&&b(a)})};return f}();
...
this._trackers.forEach(function(e){e.onResolveEvents(b._address,a)});this._rehauHandler.onDeviceEvent(b,a);var e=b.toJSON();e.sys="aio";e.type="ENOCEAN";for(var g=0,h=0;h<a.length;h++){var l=a[h];if(l)if("shortPress"==l.value||"longPress"==l.value||"pressed"==l.value||"released"==l.value){g++;var r={type:"ENOCEAN",adr:e.address,data:e.data,vendor:e.vendor,state:{}};r.state[l.key]=l.value;f.emit("gatewayevent",r,{address:"ENOCEAN"},"BTN")}else if("d2-06-50"==e.data&&"burglary"==l.key){r={type:"ENOCEAN",
adr:e.address,data:e.data,vendor:e.vendor,state:{}};r.state[l.key]=l.value;f.emit("gatewayevent",r,{address:"ENOCEAN"},"STA");return}}if(g==a.length)(e=b.getStatesLegacy())&&f.emit("udpevent",e,"STA");else if(e=b.getStatesLegacy())f.emit("gatewayevent",e,{address:"ENOCEAN"},"STA"),f.emit("udpevent",e,"STA")};g.prototype._saveEnoceanEvents=function(b,a){var f=require("x.hub.datastore.js").dataStore;f&&f.openDB(function(e,f){if(!e){e=b._address;for(var g=[],k=(new Date).toISOString(),r=0;r<a.length;r++){var m=
a[r];if(m&&m.changed){m=m.key+":"+m.value;var u=null;u=0==g.length?"SELECT '"+e+"' AS 'window', '"+m+"' AS 'state', '"+k+"' AS 'time'":"UNION ALL SELECT '"+e+"', '"+m+"', '"+k+"'";g.push(u)}}0<g.length&&(e=g.join(" "),f.run("INSERT INTO windowstate(window, state, time) "+e+";",function(a){f.close()}))}})};g.prototype.addSensor=function(b,a){b?b.data?"siegenia"!=b.vendor||b.params?this._deviceHandler.addDevice(b,function(b,e){a&&a({error:b,data:e?e.toJSON():null})}):a&&a({error:Error("siegenia windows params is null")}):
a&&a({error:Error("enocean profile is null")}):a&&a({error:Error("enocean device is null")})};g.prototype.updateSensor=function(b,a,f){b?a?this._deviceHandler.updateDevice(b,a,function(a,b){f&&f({error:a,data:b?b.toJSON():null})}):f&&f({error:Error("device info is null")}):f&&f({error:Error("device address is null")})};g.prototype.delSensor=function(b,a){b?this._deviceHandler.deleteDevice({address:b},function(b){a&&a({error:b})}):a&&a({error:Error("enocean id is null")})};g.prototype.resetDefaultSenderID=
function(b){x.hub.m.enocean.SENDER_ID=null;localStorage&&localStorage.setItem("x.hub.m.enocean.SENDER_ID","");b&&b({})};g.prototype.setRehauAlarm=function(b,a){this._rehauHandler.setAlarm(b,a)};g.prototype.isRehauWindowOpen=function(){return this._rehauHandler.isWindowOpen()};g.prototype.setInoventHumidityAccessory=function(b,a,f){this._rehauHandler.setHumidityAccessory(b,a,function(a){f&&f({error:a})})};g.prototype.setInoventCo2Accessory=function(b,a,f){this._rehauHandler.setCo2Accessory(b,a,function(a){f&&
f({error:a})})};g.prototype.getInoventAccessories=function(b,a){b=this._rehauHandler.getInoventAccessory(b);a&&a({data:b?b.toJSON():{}})};g.prototype.__addTelegramTracker=function(b){b&&b.onTelegram&&b.onResolveEvents&&-1==this._trackers.indexOf(b)&&this._trackers.push(b)};g.prototype.__removeTelegramTracker=function(b){b&&(b=this._trackers.indexOf(b),-1!=b&&this._trackers.splice(b,1))};g.prototype.__sendEspFrame=function(b,a,f,e,g){a=a?new Buffer(a,"hex"):null;f=f?new Buffer(f,"hex"):null;e=e?!0:
!1;b=new x.hub.m.enocean.ESP3.ESP3_Frame(b,a,f);this._esp3.sendFrame(b,e,function(a,b){g&&g({error:a,data:b?b.toJSON():null})})};g.prototype.__simulateRawEnoceanPacket=function(b,a){this._esp3.onSerialData(new Buffer(b,"hex"));a&&a()};g.prototype._doSDK=function(b,a){if(b&&b.method){var f="send_"+b.method;if(this._sdk[f])this._sdk[f](b.params,function(b){a&&a({error:b})});else a&&a({error:Error("no such method")})}else a&&a({error:Error("data invalid")})};return g}();
"undefined"!=typeof exports&&"undefined"!=typeof module&&module.exports&&(exports=module.exports=new x.hub.m.enocean.Handler);
