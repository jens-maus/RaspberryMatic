...
"hex");this._bufShiftLeft(f,1);a.readUInt8(0)&128&&(f=this._xor(f,c));return{k1:a,k2:f}};e.prototype._doAES128=function(a,f,c){f||(f=new Buffer("00000000000000000000000000000000","hex"));a=crypto.createCipheriv("aes128",a,f);a.setAutoPadding(!1);c=a.update(c);a=a.final();return Buffer.concat([c,a])};e.prototype._xor=function(a,f){for(var c=Math.max(a.length,f.length),e=new Buffer(c),h=0;h<c;h++){var g=0,r=0;h<a.length&&(g=a.readUInt8(h));h<f.length&&(r=f.readUInt8(h));e.writeUInt8(g^r,h)}return e};
...
this.securityLvl])]));return new g(1,a,c)};f.prototype.toRadioTelegram=function(){return l.resolve(this)};f.resolve=function(a){var c=!1;if(a.optData){c=!0;var e=a.optData.readUInt8(0);var n=a.optData.slice(1,5).toString("hex");var g=a.optData.readUInt8(5);var h=a.optData.readUInt8(6)}return new f(a.data,c,e,n,g,h)};var c=function(a){this.data=a};c.prototype.toJSON=function(){return{data:this.data.toString("hex")}};c.prototype.toFrame=function(){return new g(6,this.data,null)};c.prototype.toSACommand=
...
null)};h.prototype.toEvent=function(){return p.resolve(this)};h.resolve=function(a){return new h(a.data)};var l=function(a,c){this.rorg=a;this.optData=c;this.optData||(this.optData={subTelNum:1,dstId:"FFFFFFFF",dBm:255,securityLvl:0})};l.prototype.setDstId=function(a){this.optData.dstId=a?a:"FFFFFFFF"};l.resolve=function(a){if(!a.data)return null;switch(a.data.readUInt8(0)){case 208:return C.resolve(a);case 246:return I.resolve(a);case 213:return J.resolve(a);case 165:return z.resolve(a);case 210:return w.resolve(a);
case 212:return S.resolve(a);case 53:return X.resolve(a);case 49:return T.resolve(a);case 64:return y.resolve(a);case 176:return r.resolve(a);case 178:return v.resolve(a);default:return null}};var r=function(){var a=function(a,c,e){8<=e&&(e=8);0>=e&&(e=1);var f=Math.floor(c/8),n=c%8;c=Math.pow(2,e)-1;if(8<n+e)return e=16-n-e,a.readUInt16BE(f)>>e&c;e=8-n-e;return a.readUInt8(f)>>e&c},c=function(a){this.type=a};c.prototype.getType=function(){return this.type};c.resolve=function(c,n){if(n+2>8*c.length)return null;
var h=a(c,n,2),H=null;switch(h){case 0:H=e.resovle(c,n);break;case 1:H={type:h,sigType:c.readUInt16BE(0)>>6&255,valueType:c.readUInt16BE(0)>>2&3,resolution:c.readUInt16BE(0)&15,engMin:c.readUInt8(2),scalingMin:c.readUInt16BE(3)>>12&15,engMax:c.readUInt16BE(3)>>4&255,scalingMax:c.readUInt16BE(3)&15};break;case 2:H=f.resovle(c,n);break;case 3:H=g.resovle(c,n)}return H};var e=function(a,c,e){this.type=0;this.sigType=a;this.dataLen=c;this.data=e};e.prototype=new c;e.prototype.constructor=e;e.prototype.getBitLength=
function(){return 2==this.sigType?50:18};e.prototype.getProductID=function(){return 2==this.sigType?this.data?this.data.readUInt32BE(0):null:null};e.resovle=function(c,f){if(f+18>8*c.legnth)return null;var n=a(c,f+2,8),g=a(c,f+10,8),h=null;if(2==n){if(f+50>8*c.legnth)return null;h=new Buffer(4);h.writeUInt8(a(c,f+18,8),0);h.writeUInt8(a(c,f+26,8),1);h.writeUInt8(a(c,f+34,8),2);h.writeUInt8(a(c,f+42,8),3)}else 1==n&&(h=null);return new e(n,g,h)};new c;var f=function(a,c){this.type=2;this.sigType=a;
this.valueType=c};f.prototype=new c;f.prototype.constructor=f;f.prototype.getBitLength=function(){return 12};f.resovle=function(c,e){if(e+12>8*c.length)return null;var n=a(c,e+2,8);c=a(c,e+10,2);return new f(n,c)};f.prototype.toJSON=function(){return{sigType:this.sigType,valueType:this.valueType}};var g=function(a,c,e){this.type=3;this.sigType=a;this.valueType=c;this.resolution=e};g.prototype=new c;g.prototype.constructor=g;g.prototype.getBitLength=function(){return 16};g.prototype.toJSON=function(){return{sigType:this.sigType,
valueType:this.valueType,resolution:this.resolution}};g.resovle=function(c,e){if(e+16>8*c.length)return null;var f=a(c,e+2,8),n=a(c,e+10,2);c=a(c,e+12,4);return new g(f,n,c)};var h=function(a,c,e){l.call(this,176);this.manufacturerID=a;this.dataDirection=c;this.purpose=e;this.productID=null;this.outboudChannels={};this.inboundChannels={};this.status=this.senderID=null};h.prototype=new l;h.prototype.constructor=h;h.prototype.getManufacturerId=function(){return this.manufacturerID};h.prototype.getProductId=
function(){return this.productID};h.prototype.toJSON=function(){var a={manufacturerID:this.manufacturerID,dataDirection:this.dataDirection,purpose:this.purpose,productID:this.productID,outboudChannels:{},inboundChannels:{}},c;for(c in this.outboudChannels)a.outboudChannels[c]=this.outboudChannels[c].toJSON();for(c in this.inboundChannels)a.inboundChannels[c]=this.inboundChannels[c].toJSON();return a};h.resolve=function(a){var e=a.data;a=e.readUInt16BE(1)>>5&2047;var f=e.readUInt16BE(1)>>4&1,n=e.readUInt16BE(1)>>
2&3;a=new h(a,f,n);f=e.slice(3,e.length-5);n=e.slice(e.length-5,e.length-1);e=e.readUInt8(e.length-1);a.senderID=n.toString("hex");a.status=e;for(var g=n=e=0;;){var H=c.resolve(f,n);if(!H)break;0==e?0==H.getType()?a.productID=H.getProductID():(a.outboudChannels[g]=H,g++,e=1):1==e?0==H.getType()?e=2:(a.outboudChannels[g]=H,g++,e=1):2==e&&(a.inboundChannels[g]=H,g++);n+=H.getBitLength()}return a};return h}(),m=function(){var a=function(a,c,e,f,n){l.call(this,177);this.manufacturerID=a;this.result=c;
this.chnAcknoledgement=e;this.senderID=f;this.status=n};a.prototype=new l;a.prototype.constructor=a;a.prototype.toPacket=function(){var a=new Buffer(3);a.writeUInt8(this.rorg,0);a.writeUInt16BE(this.manufacturerID<<5|this.result<<3,1);if(3==this.result){var c=[];if(this.chnAcknoledgement){for(var e=Math.ceil(this.chnAcknoledgement.length/8),n=0;n<e.length;n++)c.push(0);for(e=0;e<this.chnAcknoledgement.length;e++)n=Math.floor(e/8),c[n]|=chnAcknoledgement[e]<<8-e%8-1}a=Buffer.concat([a,new Buffer(c)])}a=
Buffer.concat([a,new Buffer(this.senderID,"hex")]);a=Buffer.concat([a,new Buffer([this.status])]);c=1;e="FFFFFFFF";n=255;var g=0;this.optData&&(c=this.optData.subTelNum,e=this.optData.dstId,n=this.optData.dBm,g=this.optData.securityLvl);return new f(a,!0,c,e,n,g)};a.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),manufacturerID:this.manufacturerID.toString(16),result:this.result,chnAcknoledgement:this.chnAcknoledgement,senderID:this.senderID,receiverID:this.receiverID}};return a}(),
v=function(){var a=function(a,c,e){l.call(this,178);this.data=a;this.senderID=c;this.status=e};a.prototype=new l;a.prototype.constructor=a;a.prototype.toPacket=function(){var a=new Buffer(1);a.writeUInt8(this.rorg,0);this.data&&(a=Buffer.concat([a,this.data]));a=Buffer.concat([a,new Buffer(this.senderID,"hex")]);a=Buffer.concat([a,new Buffer([this.status])]);var c=1,e="FFFFFFFF",n=255,g=0;this.optData&&(c=this.optData.subTelNum,e=this.optData.dstId,n=this.optData.dBm,g=this.optData.securityLvl);return new f(a,
!0,c,e,n,g)};a.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),data:this.data?this.data.toString("hex"):null,senderID:this.senderID,status:this.status}};a.resolve=function(c){var e=c.data;c=e.slice(1,e.length-5);var f=e.slice(e.length-5,e.length-1);e=e.readUInt8(e.length-1);return new a(c,f.toString("hex"),e)};return a}(),y=function(a,c,e,f,g,h,k,m){l.call(this,64,m);this.seq=a;this.idx=c;this.len=e;this.crorg=f;this.data=g;this.senderID=h;this.status=k};y.prototype=new l;y.prototype.constructor=
...
status:this.status}};y.resolve=function(a){var c=a.data,e=c.readUInt8(1)>>6&3,f=c.readUInt8(1)&63;if(0==f){var n=c.readUInt16BE(2);var g=c.readUInt8(4);var h=c.slice(5,c.length-5)}else g=n=null,h=c.slice(2,c.length-5);var k=c.slice(c.length-5,c.length-1).toString("hex");c=c.readUInt8(c.length-1);var l;a.hasOpt&&(l={subTelNum:a.subTelNum,dstId:a.dstId,dBm:a.dBm,securityLvl:a.securityLvl});return new y(e,f,n,g,h,k,c,l)};var C=function(a,c,e,f){l.call(this,208,f);this.messageIndex=a;this.userData=c;
...
k,m,r,p,t){l.call(this,212);this.cmd=a;this.ute=c;this.rspExpected=e;this.subtype=f;this.numChannel=g;this.manufactureID=h;this.eepType=k;this.eepFunc=m;this.eepRorg=r;this.senderID=p;this.status=t};S.prototype=new l;S.prototype.constructor=S;S.prototype.toJSON=function(){return{rorg:this.rorg.toString(16),ute:this.ute,rspExpected:this.rspExpected,subtype:this.subtype,cmd:this.cmd,numChannel:this.numChannel,manufactureID:this.manufactureID,eepType:this.eepType.toString(16),eepFunc:this.eepFunc.toString(16),
...
new p;Y.prototype.constructor=Y;Y.prototype.toJSON=function(){return{code:this._code}};Y.prototype.toPacket=function(){var a=new Buffer(1);a.writeUInt8(this._code,0);return new h(a)};Y.resolve=function(a){return new Y};var K=function(a,c,e,f,g,h,k){this._code=2;this._priority=a;this._manufacturerId=c;this._eep=e;this._rssi=f;this._pm_candidateId=g;this._sa_clientId=h;this._hop_count=k};K.prototype=new p;K.prototype.constructor=K;K.prototype.getEEP=function(){return this._eep?this._eep.substr(0,2)+
...
7).toString("hex"),g=c.readUInt8(7),h=c.slice(8,12).toString("hex"),k=c.slice(12,16).toString("hex");c=c.readUInt8(16);return new K(a,e,f,g,h,k,c)};p.SA_RECLAIM_NOT_SUCCESSFUL=Y;p.SA_CONFIRM_LEARN=K;var oa=function(a){this._code=a};oa.resolve=function(a){if(!a.data)return null;switch(a.data.readUInt8(0)){case 9:return CO_WR_REPEATER.resolve(a);default:return null}};CO_WR_REPEATER=function(a,c){this._code=9;this._enable=a;this._level=c};CO_WR_REPEATER.prototype=new oa;CO_WR_REPEATER.prototype.constructor=
...
(g[e]=[]);g=g[e];for(var h=0;h<=f;h++)h!=f?g.length<f&&(g[h]=null):g[h]=a;this._checkChain(c,e)};a.prototype._checkChain=function(a,c){var e=this._buffer[a][c];if(e[0]){var g=e[0],h=g.getLen(),k=g.getCRORG();g=0;var n=new Buffer(1);n.writeUInt8(k);for(k=0;k<e.length;k++){var l=e[k];if(!l)return;l=l.getData();g+=l.length;n=Buffer.concat([n,l])}g>=h&&(delete this._buffer[a][c],n=Buffer.concat([n,new Buffer(a,"hex")]),n=Buffer.concat([n,new Buffer("00","hex")]),a=new f(n,!1),this._esp3._onEORadio_ERP1(a))}};
...
u.ESP3_Frame=g;u.Telegram=l;u.RADIO_ERP1_Packet=f;u.Event=p;u.Response=t;u.COMMAND_COMMAND=oa;u.SA_COMMAND=N;return u}();
...
b));return d};var t=function(b){g.call(this,b);this._data="a5-??-??";this.TEACH_IN_VARIATION=2;this.UNIQUE_GATEWAY_SENDERID=!0};t.prototype=new g;t.prototype.constructor=t;t.prototype.getTeachinType=function(){return"4BS"};t.prototype.isTeachinBidirectional=function(){return!1};var p=function(b){t.call(this,b);this._data="a5-02-??";this._tmpMin=-40;this._tmpMax=0};p.STATES=["temperature","temperature_raw"];p.prototype=new t;p.prototype.constructor=p;p.prototype.evalTelegram=function(b){var d={};if(165==
b.rorg){var a=b.userData.readUInt8(3);b=b.userData.readUInt8(2);1==(a>>3&1)&&(d.temperature=parseFloat(((255-b)/255*(this._tmpMax-this._tmpMin)+this._tmpMin).toFixed(1)),d.temperature_raw=b)}return d};var Y=function(b){p.call(this,b);this._data="a5-02-01";this._tmpMin=-40;this._tmpMax=0};Y.STATES=["temperature","temperature_raw"];Y.prototype=new p;Y.prototype.constructor=Y;var K=function(b){p.call(this,b);this._data="a5-02-02";this._tmpMin=-30;this._tmpMax=10};K.STATES=["temperature","temperature_raw"];
K.prototype=new p;K.prototype.constructor=K;var oa=function(b){p.call(this,b);this._data="a5-02-03";this._tmpMin=-20;this._tmpMax=20};oa.STATES=["temperature","temperature_raw"];oa.prototype=new p;oa.prototype.constructor=oa;var N=function(b){p.call(this,b);this._data="a5-02-04";this._tmpMin=-10;this._tmpMax=30};N.STATES=["temperature","temperature_raw"];N.prototype=new p;N.prototype.constructor=N;var O=function(b){p.call(this,b);this._data="a5-02-05";this._tmpMin=0;this._tmpMax=40};O.STATES=["temperature",
"temperature_raw"];O.prototype=new p;O.prototype.constructor=O;var ca=function(b){p.call(this,b);this._data="a5-02-06";this._tmpMin=10;this._tmpMax=50};ca.STATES=["temperature","temperature_raw"];ca.prototype=new p;ca.prototype.constructor=ca;var Z=function(b){p.call(this,b);this._data="a5-02-07";this._tmpMin=20;this._tmpMax=60};Z.STATES=["temperature","temperature_raw"];Z.prototype=new p;Z.prototype.constructor=Z;var aa=function(b){p.call(this,b);this._data="a5-02-08";this._tmpMin=30;this._tmpMax=
70};aa.STATES=["temperature","temperature_raw"];aa.prototype=new p;aa.prototype.constructor=aa;var Ma=function(b){p.call(this,b);this._data="a5-02-09";this._tmpMin=40;this._tmpMax=80};Ma.STATES=["temperature","temperature_raw"];Ma.prototype=new p;Ma.prototype.constructor=Ma;var u=function(b){p.call(this,b);this._data="a5-02-0a";this._tmpMin=50;this._tmpMax=90};u.STATES=["temperature","temperature_raw"];u.prototype=new p;u.prototype.constructor=u;var n=function(b){p.call(this,b);this._data="a5-02-0b";
this._tmpMin=60;this._tmpMax=100};n.STATES=["temperature","temperature_raw"];n.prototype=new p;n.prototype.constructor=n;var H=function(b){p.call(this,b);this._data="a5-02-10";this._tmpMin=-60;this._tmpMax=20};H.STATES=["temperature","temperature_raw"];H.prototype=new p;H.prototype.constructor=H;var bc=function(b){p.call(this,b);this._data="a5-02-11";this._tmpMin=-50;this._tmpMax=30};bc.STATES=["temperature","temperature_raw"];bc.prototype=new p;bc.prototype.constructor=bc;var La=function(b){p.call(this,
b);this._data="a5-02-12";this._tmpMin=-40;this._tmpMax=40};La.STATES=["temperature","temperature_raw"];La.prototype=new p;La.prototype.constructor=La;var cc=function(b){p.call(this,b);this._data="a5-02-13";this._tmpMin=-30;this._tmpMax=50};cc.STATES=["temperature","temperature_raw"];cc.prototype=new p;cc.prototype.constructor=cc;var dc=function(b){p.call(this,b);this._data="a5-02-14";this._tmpMin=-20;this._tmpMax=60};dc.STATES=["temperature","temperature_raw"];dc.prototype=new p;dc.prototype.constructor=
dc;var Da=function(b){p.call(this,b);this._data="a5-02-15";this._tmpMin=-10;this._tmpMax=70};Da.STATES=["temperature","temperature_raw"];Da.prototype=new p;Da.prototype.constructor=Da;var ec=function(b){p.call(this,b);this._data="a5-02-16";this._tmpMin=0;this._tmpMax=80};ec.STATES=["temperature","temperature_raw"];ec.prototype=new p;ec.prototype.constructor=ec;var $a=function(b){p.call(this,b);this._data="a5-02-17";this._tmpMin=10;this._tmpMax=90};$a.STATES=["temperature","temperature_raw"];$a.prototype=
new p;$a.prototype.constructor=$a;var fc=function(b){p.call(this,b);this._data="a5-02-18";this._tmpMin=20;this._tmpMax=100};fc.STATES=["temperature","temperature_raw"];fc.prototype=new p;fc.prototype.constructor=fc;var gc=function(b){p.call(this,b);this._data="a5-02-19";this._tmpMin=30;this._tmpMax=110};gc.STATES=["temperature","temperature_raw"];gc.prototype=new p;gc.prototype.constructor=gc;var hc=function(b){p.call(this,b);this._data="a5-02-1a";this._tmpMin=40;this._tmpMax=120};hc.STATES=["temperature",
"temperature_raw"];hc.prototype=new p;hc.prototype.constructor=hc;var ic=function(b){p.call(this,b);this._data="a5-02-1b";this._tmpMin=50;this._tmpMax=130};ic.STATES=["temperature","temperature_raw"];ic.prototype=new p;ic.prototype.constructor=ic;var Ea=function(b){t.call(this,b);this._data="a5-02-20";this._tmpMin=-10;this._tmpMax=41.2};Ea.STATES=["temperature","temperature_raw"];Ea.prototype=new t;Ea.prototype.constructor=Ea;Ea.prototype.evalTelegram=function(b){var d={};if(165==b.rorg){var a=b.userData.readUInt8(3);
b=b.userData.readUInt16BE(1);1==(a>>3&1)&&(a=b&1023,d.temperature=parseFloat(((1023-a)/1023*(this._tmpMax-this._tmpMin)+this._tmpMin).toFixed(1)),d.temperature_raw=a)}return d};var jc=function(b){Ea.call(this,b);this._data="a5-02-30";this._tmpMin=-40;this._tmpMax=62.3};jc.STATES=["temperature","temperature_raw"];jc.prototype=new Ea;jc.prototype.constructor=jc;var ha=function(b){t.call(this,b);this._data="a5-04-??";this._humMin=0;this._humMax=100;this._tempMin=0;this._tempMax=40};ha.STATES=["humidity",
...
b);this._data="a5-06-01"};Oa.STATES=L.STATES;Oa.prototype=new L;Oa.prototype.constructor=Oa;var Fa=function(b){L.call(this,b);this._data="a5-06-02";this._ill2Min=0;this._ill2Max=510;this._ill1Min=0;this._ill1Max=1020};Fa.STATES=L.STATES;Fa.prototype=new L;Fa.prototype.constructor=Fa;var bb=function(b){L.call(this,b);this._data="a5-06-03";this._svcMin=0;this._svcMax=5.1};bb.STATES=["voltage","voltage_raw","illumination","illumination_raw"];bb.prototype=new L;bb.prototype.constructor=bb;bb.prototype.evalTelegram=
...
"off"}d.state_raw=c;a&=1;switch(a){case 0:d.button="pressed";break;case 1:d.button="released"}d.button_raw=a}}return d};var Ra=function(b){va.call(this,b);this._data="a5-08-01"};Ra.STATES="voltage voltage_raw illumination illumination_raw temperature temperature_raw state state_raw button button_raw".split(" ");Ra.prototype=new va;Ra.prototype.constructor=Ra;var mc=function(b){va.call(this,b);this._data="a5-08-02";this._illMax=1020};mc.STATES="voltage voltage_raw illumination illumination_raw temperature temperature_raw state state_raw button button_raw".split(" ");
mc.prototype=new va;mc.prototype.constructor=mc;var nc=function(b){va.call(this,b);this._data="a5-08-03";this._illMax=1530;this._tmpMin=-30;this._tmpMax=50};nc.STATES="voltage voltage_raw illumination illumination_raw temperature temperature_raw state state_raw button button_raw".split(" ");nc.prototype=new va;nc.prototype.constructor=nc;var D=function(b){t.call(this,b);this._data="a5-09-??"};D.prototype=new t;D.prototype.constructor=D;var db=function(b){D.call(this,b);this._data="a5-09-02";this._svcMin=
...
la.prototype=new B;la.prototype.constructor=la;la.prototype.evalTelegram=function(b){var d=B.prototype.evalTelegram.call(this,b);if(0==Object.keys(d).length)return d;delete d.button;delete d.button_raw;b=b.userData.readUInt8(3)&1;d.slider=b?"day":"night";d.slider_raw=b;return d};var Ga=function(b){B.call(this,b);this._data="a5-10-03";this.TEACH_IN_VARIATION=1};Ga.STATES=["setpoint","setpoint_raw","temperature","temperature_raw"];Ga.prototype=new B;Ga.prototype.constructor=Ga;Ga.prototype.evalTelegram=
...
delete b.button_raw;return b};var ob=function(b){B.call(this,b);this._data="a5-10-05"};ob.STATES="setpoint setpoint_raw temperature temperature_raw button button_raw".split(" ");ob.prototype=new B;ob.prototype.constructor=ob;ob.prototype.evalTelegram=function(b){b=B.prototype.evalTelegram.call(this,b);if(0==Object.keys(b).length)return b;delete b.fan_speed;delete b.fan_speed_raw;return b};var Ha=function(b){la.call(this,b);this._data="a5-10-06"};Ha.STATES="setpoint setpoint_raw temperature temperature_raw slider slider_raw".split(" ");
Ha.prototype=new la;Ha.prototype.constructor=Ha;Ha.prototype.evalTelegram=function(b){b=la.prototype.evalTelegram.call(this,b);if(0==Object.keys(b).length)return b;delete b.fan_speed;delete b.fan_speed_raw;return b};var pb=function(b){B.call(this,b);this._data="a5-10-07"};pb.STATES=["fan_speed","fan_speed_raw","temperature","temperature_raw"];pb.prototype=new B;pb.prototype.constructor=pb;pb.prototype.evalTelegram=function(b){b=B.prototype.evalTelegram.call(this,b);if(0==Object.keys(b).length)return b;
...
b)};qa.prototype.fromDBJSON=function(b){return g.prototype.fromDBJSON.call(this,b)};var Aa=function(b){B.call(this,b);this._data="a5-10-0a"};Aa.STATES="setpoint setpoint_raw temperature temperature_raw contact contact_raw".split(" ");Aa.prototype=new B;Aa.prototype.constructor=Aa;Aa.prototype.evalTelegram=function(b){var d=B.prototype.evalTelegram.call(this,b);if(0==Object.keys(d).length)return d;delete d.fan_speed;delete d.fan_speed_raw;delete d.button;delete d.button_raw;b=b.userData.readUInt8(3)&
1;d.contact=b?"open":"closed";d.contact_raw=b;return d};var Ia=function(b){Aa.call(this,b);this._data="a5-10-0b";this._params=null};Ia.STATES=["temperature","temperature_raw","contact","contact_raw"];Ia.prototype=new Aa;Ia.prototype.constructor=Ia;Ia.prototype.evalTelegram=function(b){b=Aa.prototype.evalTelegram.call(this,b);if(0==Object.keys(b).length)return b;delete b.setpoint;delete b.setpoint_raw;return b};Ia.prototype.fromJSON=function(b){return g.prototype.fromJSON.call(this,b)};Ia.prototype.fromDBJSON=
...
P.prototype.fromJSON=function(b){if(!g.prototype.fromJSON.call(this,b))return null;this._params||(this._params={minSP:18,maxSP:26});return this};P.prototype.fromDBJSON=function(b){if(!g.prototype.fromDBJSON.call(this,b))return null;this._params||(this._params={minSP:18,maxSP:26});return this};var Ba=function(b){P.call(this,b);this._data="a5-10-11"};Ba.STATES="setpoint setpoint_raw humidity humidity_raw temperature temperature_raw slider slider_raw".split(" ");Ba.prototype=new P;Ba.prototype.constructor=
Ba;Ba.prototype.evalTelegram=function(b){var d=P.prototype.evalTelegram.call(this,b);if(0==Object.keys(d).length)return d;delete d.button;delete d.button_raw;b=b.userData.readUInt8(3)&1;d.slider=b?"day":"night";d.slider_raw=b;return d};var sb=function(b){P.call(this,b);this._data="a5-10-12"};sb.STATES="setpoint setpoint_raw humidity humidity_raw temperature temperature_raw".split(" ");sb.prototype=new P;sb.prototype.constructor=sb;sb.prototype.evalTelegram=function(b){b=P.prototype.evalTelegram.call(this,
b);if(0==Object.keys(b).length)return b;delete b.button;delete b.button_raw;return b};var tb=function(b){P.call(this,b);this._data="a5-10-13"};tb.STATES="humidity humidity_raw temperature temperature_raw button button_raw".split(" ");tb.prototype=new P;tb.prototype.constructor=tb;tb.prototype.evalTelegram=function(b){b=P.prototype.evalTelegram.call(this,b);if(0==Object.keys(b).length)return b;delete b.setpoint;delete b.setpoint_raw;return b};var ub=function(b){Ba.call(this,b);this._data="a5-10-14"};
ub.STATES="humidity humidity_raw temperature temperature_raw slider slider_raw".split(" ");ub.prototype=new Ba;ub.prototype.constructor=ub;ub.prototype.evalTelegram=function(b){b=Ba.prototype.evalTelegram.call(this,b);if(0==Object.keys(b).length)return b;delete b.setpoint;delete b.setpoint_raw;return b};var Ta=function(b){t.call(this,b);this._data="a5-11-??"};Ta.prototype=new t;Ta.prototype.constructor=Ta;var vb=function(b){Ta.call(this,b);this._data="a5-11-03"};vb.STATES="position angle position_flag position_flag_raw angle_flag angle_flag_raw error error_raw end_position end_position_raw state state_raw service_mode position_mode power energy current voltage power_raw power_unit energy_unit current_unit voltage_unit power_unit_raw".split(" ");
...
f;c=b.userData.readUInt16BE(1)&511;d.azm=c;d.azm_raw=c;break;case 6:b=(f>>4&15)<<8|e,c|=(f&15)<<8,d.latitude=parseFloat((b/4095*180-90).toFixed(1)),d.latitude_raw=b,d.longitude=parseFloat((c/4095*360-180).toFixed(1)),d.longitude_raw=c}}return d};var pc=function(b){Q.call(this,b);this._data="a5-13-01"};pc.STATES="lux lux_raw temperature temperature_raw wind wind_raw day_night rain sun_west sun_west_raw sun_south sun_south_raw sun_east sun_east_raw hemisphere day month year date_src weekday hour min sec time_format am_pm time_src elv azm latitude longitude latitude_raw longitude_raw".split(" ");
pc.prototype=new Q;pc.prototype.constructor=pc;var qc=function(b){Q.call(this,b);this._data="a5-13-02"};qc.STATES="sun_west sun_west_raw sun_south sun_south_raw sun_east sun_east_raw hemisphere".split(" ");qc.prototype=new Q;qc.prototype.constructor=qc;var rc=function(b){Q.call(this,b);this._data="a5-13-03"};rc.STATES=["day","month","year","date_src"];rc.prototype=new Q;rc.prototype.constructor=rc;var sc=function(b){Q.call(this,b);this._data="a5-13-04"};sc.STATES="weekday hour min sec time_format am_pm time_src".split(" ");
sc.prototype=new Q;sc.prototype.constructor=sc;var tc=function(b){Q.call(this,b);this._data="a5-13-05"};tc.STATES=["elv","azm"];tc.prototype=new Q;tc.prototype.constructor=tc;var uc=function(b){Q.call(this,b);this._data="a5-13-06"};uc.STATES=["latitude","longitude"];uc.prototype=new Q;uc.prototype.constructor=uc;var xb=function(b){g.call(this,b);this._data="a5-14-01"};xb.STATES=["voltage","voltage_raw","state"];xb.prototype=new g;xb.prototype.constructor=xb;xb.prototype.evalTelegram=function(b){var d=
...
q,this._address,f,0);b.sendTelegram(f,!0,function(b){a&&a(b,e)})};var Va=function(b){t.call(this,b);this._data="a5-30-??"};Va.prototype=new t;Va.prototype.constructor=Va;var Ka=function(b){g.call(this,b);this._data="a5-30-01"};Ka.STATES=["battery_low","battery_raw","state","state_raw"];Ka.prototype=new Va;Ka.prototype.constructor=Ka;Ka.prototype.evalTelegram=function(b){var d={};if(165==b.rorg){var a=b.userData.readUInt8(3),c=b.userData.readUInt8(2);b=b.userData.readUInt8(1);1==(a>>3&1)&&(d.battery_low=
...
function(b){var d={};if(165==b.rorg){var a=b.userData.readUInt8(3);b=b.userData.readUInt8(2);1==(a>>3&1)&&(d.analog_input=b,d.input2=a>>2&1,d.input1=a>>1&1,d.input0=a&1)}return d};var vc=function(b){t.call(this,b);this._data="a5-38-??"};vc.prototype=new t;vc.prototype.constructor=vc;var W=function(b){vc.call(this,b);this._data="a5-38-08"};W.prototype=new vc;W.prototype.constructor=W;W.prototype.evalTelegram=function(b){var d={};if(165==b.rorg){var a=b.userData.readUInt8(3),c=b.userData.readUInt8(2),
...
a(Error("unknow command"))}}else a&&a(Error("command invalid"))};var Ca=function(b){E.call(this,b);this._data="d2-01-11"};Ca.COMMANDS="ch1On ch1Off ch1Toggle ch2On ch2Off ch2Toggle".split(" ");Ca.STATES="power_failure_detection power_failure over_current_switch_off error_level io_channel local_control output_value output_state ch1_output_value ch1_output_state ch2_output_value ch2_output_state".split(" ");Ca.prototype=new E;Ca.prototype.constructor=Ca;Ca.prototype.getIOs=function(){return[0,1]};Ca.prototype.evalTelegram=
function(b){if(b=E.prototype.evalTelegram.call(this,b))switch(b.io_channel){case 0:b.ch1_output_value=b.output_value;b.ch1_output_state=b.output_state;break;case 1:b.ch2_output_value=b.output_value,b.ch2_output_state=b.output_state}return b};Ca.prototype.executeCommand=function(b,d,a){if(d&&d.value){var c=this;switch(d.value){case "ch1On":this.activeStateChange({ch1_output_value:100,ch1_output_state:"on"});this.setOutput(b,{DV:0,IO:0,OV:100},a);break;case "ch1Off":this.activeStateChange({ch1_output_value:0,
...
parseInt(g[2]):7;this.setParameters(b,{VERT:f,ROT:q,AA:g,CHN:c},a);break;default:a&&a(Error("unknow command"))}}else a&&a(Error("command invalid"))};var yc=function(b){fa.call(this,b);this._data="d2-06-??"};yc.prototype=new fa;yc.prototype.constructor=yc;var xa=function(b){fa.call(this,b);this._data="d2-06-01";this._states={pending:{value:!1,time:(new Date).getTime()}};this._vbir_new=this._suir_new=this._blcr_new=this._hccr_new=this._vacation_new=null};xa.COMMANDS="vacationOn vacationOff handleClosedClickOn handleClosedClickOff batteryLowClickOn batteryLowClickOff setSensorUpdateInterval setVacationBlinkInterval".split(" ");
xa.STATES="bal ppal state handle window br bl motion vacation temperature humidity illumination battery hccr blcr suir vbir".split(" ");xa.prototype=new yc;xa.prototype.constructor=xa;xa.prototype.executeCommand=function(b,d,a){b=(new Date).getTime();if(d&&d.value){"setSensorUpdateInterval"==d.value.substr(0,23)&&23<d.value.length?(d=d.value.substr(23),d={value:"setSensorUpdateInterval",ext:d}):"setVacationBlinkInterval"==d.value.substr(0,24)&&24<d.value.length&&(d=d.value.substr(24),d={value:"setVacationBlinkInterval",
...
ya.STATES="operation_mode handle window state temperature humidity battery vacation hccr blcr suir vbir".split(" ");ya.prototype=new yc;ya.prototype.constructor=ya;ya.prototype.executeCommand=function(b,d,a){b=(new Date).getTime();if(d&&d.value){"setSensorUpdateInterval"==d.value.substr(0,23)&&23<d.value.length?(d=d.value.substr(23),d={value:"setSensorUpdateInterval",ext:d}):"setVacationBlinkInterval"==d.value.substr(0,24)&&24<d.value.length&&(d=d.value.substr(24),d={value:"setVacationBlinkInterval",
...
l._lacs_new=null;l._blcs_new=null;l._suis_new=null;l._vbis_new=null;var h={pending:!1};h.vacation=d?"on":"off";c&&(h.hccr=1==c?"off":"on");e&&(h.blcr=1==e?"off":"on");f&&(h.suir=f);g&&(h.vbir=g);l.activeStateChange(h);a&&a(b)})};var zc=function(b){fa.call(this,b);this._data="d2-20-??"};zc.prototype=new fa;zc.prototype.constructor=zc;var ba=function(b){zc.call(this,b);this._data="d2-20-00";this._poller=null;this._pollInterval=6E4};ba.COMMANDS="setFanLevel fanLevelUp fanLevelDown requestStatus setHumLevel setCo2Level".split(" ");
ba.STATES="filter_remaining_time operating_time temperature message_code anti_freeze current_fan_level set_fan_level".split(" ");ba.prototype=new zc;ba.prototype.constructor=ba;ba.prototype.init=function(b){var a=this;setTimeout(function(){var d=require("x.hub.m.enocean.js")._esp3;a.executeCommand(d,{value:"requestStatus"},b);a._restartPoller(d)},Math.floor(6E3*Math.random())+1E3)};ba.prototype.finalize=function(b){this._poller&&clearInterval(this._poller);b&&b()};ba.prototype._restartPoller=function(b){this._poller&&
...
Nb.prototype=new F;Nb.prototype.constructor=F;Nb.prototype.getTeachinTelegram=function(b,a,c){b=new Buffer([2,0,0,0]);return new x.hub.m.enocean.ESP3.Telegram.BS4(b,a,0)};var R=function(b){wc.call(this,b);this._data="eltako_blind";this._vendor="eltako";this._eepAlias="f6-02-01";this._syncRunning=!1;this._syncCB=this._syncTO=null};R.COMMANDS="up down stop stepUp stepDown setRV setRunTime moveTo sync".split(" ");R.STATES=["pos","sync"];R.prototype=new wc;R.prototype.constructor=R;R.prototype.setDefaultParams=
...
(a[this.BUTTONS[2]]="pressed");break;case 16:this.BUTTONS[3]&&(a[this.BUTTONS[3]]="pressed");break;case 0:for(b=0;b<this.BUTTONS.length;b++)this.BUTTONS[b]&&(a[this.BUTTONS[b]]="released")}return a};G.prototype.checkStateChange=function(b){var a=this._states,c=[],e=(new Date).getTime(),f;for(f in b){var g={};g.key=f;g.value=b[f];g.changed=!1;var h=a[f]?a[f].value:null,k=a[f]?a[f].time:null,l=b[f];h!=l&&(g.oldvalue=h,g.changed=!0);this._states[f]={value:b[f],time:e};g.changed&&("pressed"==l||"released"==
l&&"pressed"==h)&&c.push(g);"pressed"==h&&"released"==l&&(!k||e-k<this._longPressThreshold?(g={},g.key=f,g.value="shortPress"):(g={},g.key=f,g.value="longPress"),g.changed=!0,c.push(g))}return c};var Bc=function(b){G.call(this,b);this._data="eltako_button1";this.BUTTONS=[null,null,null,"button"]};Bc.STATES=["button"];Bc.prototype=new G;Bc.prototype.constructor=Bc;var Cc=function(b){G.call(this,b);this._data="eltako_sender2";this.BUTTONS=["A1","A3"]};Cc.STATES=["A1","A3"];Cc.prototype=new G;Cc.prototype.constructor=
Cc;var Dc=function(b){G.call(this,b);this._data="eltako_sender4";this.BUTTONS=["E1","E2","E3","E4"]};Dc.STATES=["E1","E2","E3","E4"];Dc.prototype=new G;Dc.prototype.constructor=Dc;var Ec=function(b){G.call(this,b);this._data="eltako_button2";this.BUTTONS=["buttonO","buttonI"]};Ec.STATES=["buttonO","buttonI"];Ec.prototype=new G;Ec.prototype.constructor=Ec;var Fc=function(b){G.call(this,b);this._data="eltako_button4";this.BUTTONS=["BO","BI","AO","AI"]};Fc.STATES=["BO","BI","AO","AI"];Fc.prototype=new G;
Fc.prototype.constructor=Fc;var Qb=function(b){G.call(this,b);this._data="eltako_fsm60b"};Qb.STATES=["button"];Qb.prototype=new G;Qb.prototype.constructor=Qb;Qb.prototype.evalTelegram=function(b){var a={};if(246==b.rorg)switch(b.userData){case 112:case 80:case 16:a.button="pressed";break;case 0:a.button="released"}return a};var Rb=function(a){c.call(this,a);this._data="eltako_fkf";this._vendor="eltako";this._eepAlias="f6-04-01"};Rb.STATES=["keycard"];Rb.prototype=new c;Rb.prototype.constructor=Rb;
Rb.prototype.evalTelegram=function(a){var b={};if(246==a.rorg)switch(a.userData){case 16:b.keycard="inserted";case 0:b.keycard="takeout"}return b};var Sb=function(a){c.call(this,a);this._data="eltako_fkc";this._vendor="eltako";this._eepAlias="f6-04-01"};Sb.STATES=["keycard"];Sb.prototype=new c;Sb.prototype.constructor=Sb;Sb.prototype.evalTelegram=function(a){var b={};if(246==a.rorg)switch(a.userData){case 48:b.keycard="guest_card";case 32:b.keycard="service_card";case 16:b.keycard="inserted";case 0:b.keycard=
"takeout"}return b};var za=function(a){Ha.call(this,a);this._data="eltako_thermo";this._vendor="eltako";this._eepAlias="a5-10-06"};za.STATES="setpoint setpoint_raw temperature temperature_raw night_reduce night_reduce_raw".split(" ");za.prototype=new Ha;za.prototype.constructor=za;za.prototype.evalTelegram=function(a){var b={};if(165==a.rorg){var c=a.userData.readUInt8(3),e=a.userData.readUInt8(2),f=a.userData.readUInt8(1);a=a.userData.readUInt8(0);1==(c>>3&1)&&(b.night_reduce=6>=a?0:12>=a?1:19>=
a?2:25>=a?3:31>=a?4:5,b.night_reduce_raw=a,b.setpoint=parseFloat((f/255*40).toFixed(1)),b.setpoint_raw=f,b.temperature=parseFloat(((255-e)/255*40).toFixed(1)),b.temperature_raw=e)}return b};var Tb=function(a){za.call(this,a);this._data="eltako_ftr65hb";this._vendor="eltako";this._eepAlias="a5-10-06"};Tb.STATES=["setpoint","setpoint_raw","temperature","temperature_raw"];Tb.prototype=new za;Tb.prototype.constructor=Tb;Tb.prototype.evalTelegram=function(a){var b={};if(165==a.rorg){var c=a.userData.readUInt8(3),
e=a.userData.readUInt8(2);a=a.userData.readUInt8(1);1==(c>>3&1)&&(b.setpoint=parseFloat((a/255*40).toFixed(1)),b.setpoint_raw=a,b.temperature=parseFloat(((255-e)/255*40).toFixed(1)),b.temperature_raw=e)}return b};var Gc=function(a){za.call(this,a);this._data="eltako_futh65d";this._vendor="eltako";this._eepAlias="a5-10-12"};Gc.STATES="setpoint setpoint_raw temperature temperature_raw night_reduce night_reduce_raw".split(" ");Gc.prototype=new za;Gc.prototype.constructor=Gc;var Ub=function(a){Ga.call(this,
a);this._data="eltako_ftr78s";this._vendor="eltako";this._eepAlias="a5-10-03"};Ub.STATES=["setpoint","setpoint_raw","temperature","temperature_raw"];Ub.prototype=new Ga;Ub.prototype.constructor=Ub;Ub.prototype.evalTelegram=function(a){var b={};if(165==a.rorg){var c=a.userData.readUInt8(3),e=a.userData.readUInt8(2);a=a.userData.readUInt8(1);1==(c>>3&1)&&(b.setpoint=parseFloat((a/255*22+8).toFixed(1)),b.setpoint_raw=a,b.temperature=parseFloat(((255-e)/255*40).toFixed(1)),b.temperature_raw=e)}return b};
var Xa=function(a){ma.call(this,a);this._data="eltako_powermeter";this._vendor="eltako";this._eepAlias="a5-12-01"};Xa.STATES=["power","energy","tariff"];Xa.prototype=new ma;Xa.prototype.constructor=Xa;Xa.prototype.evalTelegram=function(a){var b=ma.prototype.evalTelegram.call(this,a);165==a.rorg&&143==a.userData.readUInt8(3)&&(b={});return b};var Hc=function(a){ma.call(this,a);this._data="eltako_powermeter2";this._vendor="eltako";this._eepAlias="a5-12-01"};Hc.STATES=["power","tariff"];Hc.prototype=
new ma;Hc.prototype.constructor=Xa;Hc.prototype.evalTelegram=function(a){a=ma.prototype.evalTelegram.call(this,a);delete a.energy;delete a.tariff;return a};var Ya=function(a){G.call(this,a);this._data="eltako_fzs"};Ya.STATES=["button"];Ya.prototype=new G;Ya.prototype.constructor=Ya;Ya.prototype.evalTelegram=function(a){var b={};if(246==a.rorg)switch(a.userData){case 48:b.button="pressed";break;case 0:b.button="released"}return b};Ya.prototype.checkStateChange=function(a){var b=this._states,c=[],e=
(new Date).getTime(),f;for(f in a){var g={};g.key=f;g.value=a[f];g.changed=!1;var h=b[f]?b[f].value:null,k=b[f]?b[f].time:null,l=a[f];h!=l&&(g.oldvalue=h,g.changed=!0);this._states[f]={value:a[f],time:e};g.changed&&c.push(g);"pressed"==h&&"released"==l&&(!k||e-k<this._longPressThreshold?(g={},g.key=f,g.value="shortPress"):(g={},g.key=f,g.value="longPress"),g.changed=!0,c.push(g))}return c};var Vb=function(a){h.call(this,a);this._data="eltako_relay2";this._vendor="eltako";this._eepAlias="f6-02-01"};
Vb.STATES=["ch1","ch2"];Vb.prototype=new h;Vb.prototype.constructor=Vb;Vb.prototype.evalTelegram=function(a){var b={};if(246==a.rorg)switch(a.userData){case 112:b.ch1="on";break;case 80:b.ch1="off";break;case 48:b.ch2="on";break;case 16:b.ch2="off"}return b};var Wb=function(a){h.call(this,a);this._data="eltako_relay";this._vendor="eltako";this._eepAlias="f6-02-01"};Wb.STATES=["state"];Wb.prototype=new h;Wb.prototype.constructor=Wb;Wb.prototype.evalTelegram=function(a){var b={};if(246==a.rorg)switch(a.userData){case 112:b.state=
"on";break;case 80:b.state="off"}return b};var Xb=function(a){ea.call(this,a);this._data="eltako_heat";this._vendor="eltako";this._eepAlias="a5-30-03"};Xb.STATES=["temperature","temperature_raw","alarm","alarm_raw"];Xb.prototype=new ea;Xb.prototype.constructor=Xb;Xb.prototype.evalTelegram=function(a){var b={};if(165==a.rorg){var c=a.userData.readUInt8(3),e=a.userData.readUInt8(2),f=a.userData.readUInt8(1);a.userData.readUInt8(0);1==(c>>3&1)&&(b.temperature=parseFloat(((255-f)/255*40).toFixed(1)),
b.temperature_raw=f,b.alarm=15==e?"alarm":"ok",b.alarm_raw=e)}return b};var Yb=function(a){ea.call(this,a);this._data="eltako_water_m3";this._vendor="eltako";this._eepAlias="a5-30-03"};Yb.STATES=["water","water_raw"];Yb.prototype=new ea;Yb.prototype.constructor=Yb;Yb.prototype.evalTelegram=function(a){var b={};if(165==a.rorg){var c=a.userData.readUInt8(3);a=a.userData.readUInt8(2);1==(c>>3&1)&&(b.water=15==a,b.water_raw=a)}return b};var Zb=function(a){Ka.call(this,a);this._data="eltako_water_m4";
this._vendor="eltako";this._eepAlias="a5-30-01"};Zb.STATES=["water","water_raw"];Zb.prototype=new Ka;Zb.prototype.constructor=Zb;Zb.prototype.evalTelegram=function(a){var b={};if(165==a.rorg){var c=a.userData.readUInt8(3);a=a.userData.readUInt8(2);1==(c>>3&1)&&(b.water=0==a,b.water_raw=a)}return b};var ta=function(a){W.call(this,a);this.TEACH_IN_VARIATION=3;this._data="peha_powerswitch";this._vendor="peha";this._eepAlias="a5-38-08"};ta.COMMANDS=["on","off","toggle"];ta.STATES="state state_raw level rgb power energy current voltage power_raw power_unit energy_unit current_unit voltage_unit power_unit_raw op_hour error error_raw service_mode op_hour_flag op_hour_flag_raw mode_raw".split(" ");
...
originalEEP:this._originalEEP}};A.prototype.fromDBJSON=function(a){if(!a||!a.id||!a.eep||a.eep!=this._data)return null;this._address=a.id;this._senderID=a.senderID;this._vendor=a.vendor?a.vendor:this._vendor;this._virtual=a.virtual?!0:!1;this._params=a.params;this._hopCount=a.hopCount;this._saLearnMode=a.saLearnMode;a.originalEEP&&(this._originalEEP=a.originalEEP);this.setDefaultParams();return this};var Kc=function(a){A.call(this,a);this._data="d2-06-10"};Kc.prototype=new A;Kc.prototype.constructor=
Kc;var Ic=function(a){ea.call(this,a);this._data="afriso_water_con";this._vendor="afriso";this._eepAlias="a5-30-03"};Ic.prototype=new ea;Ic.prototype.constructor=Ic;Ic.prototype.evalTelegram=function(a){var b={};if(165==a.rorg){var c=a.userData.readUInt8(3),e=a.userData.readUInt8(2);a=a.userData.readUInt8(1);1==(c>>3&1)&&(b.temperature=(255-a)/255*40,b.temperature_raw=a,b.water=0==(e>>4&1)?!0:!1)}return b};var $b=function(a){z.call(this,a);this._data="afriso_water_eco";this._vendor="afriso";this._eepAlias=
"f6-05-01"};$b.prototype=new z;$b.prototype.constructor=$b;$b.prototype.evalTelegram=function(a){var b={};246==a.rorg&&(a=a.nu,1==a?b.water="true":0==a&&(b.water="false"));return b};$b.prototype.onLearn=function(){this._states.water={value:!1,time:(new Date).getTime()}};var Jc=function(a){ea.call(this,a);this._data="afriso_asd_10";this._vendor="afriso";this._eepAlias="a5-30-03"};Jc.prototype=new ea;Jc.prototype.constructor=Jc;Jc.prototype.evalTelegram=function(a){var b={};if(165==a.rorg){var c=a.userData.readUInt8(3),
e=a.userData.readUInt8(2);a=a.userData.readUInt8(1);1==(c>>3&1)&&(b.temperature=(255-a)/255*40,b.temperature_raw=a,b.smoke=0==(e>>4&1)?!0:!1)}return b};var ac=function(a){U.call(this,a);this._data="hoppe_door";this._vendor="hoppe";this._eepAlias="f6-10-00"};ac.STATES=["door"];ac.prototype=new U;ac.prototype.constructor=ac;ac.prototype.evalTelegram=function(a){var b={};246==a.rorg&&(a=a.userData,0==(a&208^192)?b.door="open":0==(a&240^240)&&(b.door="closed"),b.handle_raw=a);return b};var Lc=function(){var a=
...
a))return null;a&&a.gpInfo&&(this._gpInfo=a.gpInfo);return this};return a}(),Pc=function(){var a=function(a){Lc.call(this,a);this._data="afriso_ais_10";this._vendor="afriso";this._eepAlias="gp"};a.prototype=new Lc;a.prototype.constructor=a;a.prototype.isGPMatch=function(a,b){return 45!=a?!1:8==b};a.prototype.evalTelegram=function(a){var b={};if(178==a.rorg){var c=a.data.readUInt8(0)>>7&1,d=a.data.readUInt8(0)>>6&1;a=a.data.readUInt8(0)>>5&1;b.alarm=1==c?"on":"off";b.active=1==d?"on":"off";b.powerAlarm=
...
this._senderID||(d=x.hub.m.enocean.SENDER_ID);var f=0;b&&(f|=128);c&&(f|=64);b=new Buffer(1);b.writeUInt8(f,0);d=new x.hub.m.enocean.ESP3.Telegram.GP_CD(b,d,0);d.setDstId(this._address);a.sendTelegram(d,!0,function(a){e&&e(a)})};return a}(),Qc=function(){var a=function(a){ka.call(this,a);this._data="eltako_tf_ttb";this._vendor="eltako";this._eepAlias="a5-07-01";this._params={reset_timeout:300}};a.prototype=new ka;a.prototype.constructor=a;a.prototype.evalTelegram=function(a){return 246==a.rorg?k.prototype.evalTelegram.call(this,
a):165==a.rorg?ka.prototype.evalTelegram.call(this,a):{}};a.prototype.checkStateChange=function(a){return a.button?k.prototype.checkStateChange.call(this,a):ka.prototype.checkStateChange.call(this,a)};a.prototype.fromJSON=function(a){ka.prototype.fromJSON.call(this,a);this._params={reset_timeout:300};return this};return{TF_TTB:a}}();return{"f6-??-??":c,"f6-01-01":k,"f6-02-01":h,"f6-02-02":l,"f6-02-03":r,"f6-02-04":m,"f6-03-01":v,"f6-03-02":y,"f6-04-01":C,"f6-04-02":I,"f6-05-00":J,"f6-05-01":z,"f6-05-02":w,
"f6-10-00":U,"f6-10-01":S,"d5-xx-xx":a,"d5-??-??":X,"d5-00-01":T,"f6-so-da":f,"a5-??-??":t,"a5-02-01":Y,"a5-02-02":K,"a5-02-03":oa,"a5-02-04":N,"a5-02-05":O,"a5-02-06":ca,"a5-02-07":Z,"a5-02-08":aa,"a5-02-09":Ma,"a5-02-0a":u,"a5-02-0b":n,"a5-02-10":H,"a5-02-11":bc,"a5-02-12":La,"a5-02-13":cc,"a5-02-14":dc,"a5-02-15":Da,"a5-02-16":ec,"a5-02-17":$a,"a5-02-18":fc,"a5-02-19":gc,"a5-02-1a":hc,"a5-02-1b":ic,"a5-02-20":Ea,"a5-02-30":jc,"a5-04-01":kc,"a5-04-02":Na,"a5-04-03":ab,"a5-06-01":Oa,"a5-06-02":Fa,
"a5-06-03":bb,"a5-06-04":cb,"a5-06-05":lc,"a5-07-01":ka,"a5-07-02":Pa,"a5-07-03":Qa,"a5-08-01":Ra,"a5-08-02":mc,"a5-08-03":nc,"a5-09-02":db,"a5-09-04":eb,"a5-09-05":fb,"a5-09-06":gb,"a5-09-07":hb,"a5-09-08":ib,"a5-09-09":jb,"a5-09-0a":kb,"a5-09-0b":lb,"a5-09-0c":mb,"a5-10-01":B,"a5-10-02":la,"a5-10-03":Ga,"a5-10-04":nb,"a5-10-05":ob,"a5-10-06":Ha,"a5-10-07":pb,"a5-10-08":pa,"a5-10-09":qa,"a5-10-0a":Aa,"a5-10-0b":Ia,"a5-10-0c":qb,"a5-10-0d":rb,"a5-10-10":P,"a5-10-11":Ba,"a5-10-12":sb,"a5-10-13":tb,
"a5-10-14":ub,"a5-12-00":wb,"a5-12-01":ma,"a5-12-02":Ja,"a5-12-03":oc,"a5-13-01":pc,"a5-13-02":qc,"a5-13-03":rc,"a5-13-04":sc,"a5-13-05":tc,"a5-13-06":uc,"a5-14-01":xb,"a5-14-02":yb,"a5-14-03":zb,"a5-14-04":Ab,"a5-14-05":Bb,"a5-14-06":Cb,"a5-14-07":Db,"a5-14-08":Eb,"a5-14-09":Fb,"a5-14-0a":Gb,"a5-20-04":ia,"a5-30-01":Ka,"a5-30-02":Hb,"a5-30-03":ea,"a5-30-04":Ib,"a5-38-08":W,"d2-??-??":fa,"d2-01-00":na,"d2-01-01":Jb,"d2-01-03":Kb,"d2-01-11":Ca,"d2-01-13":ra,"d2-01-14":sa,"d2-05-00":M,"d2-05-01":wa,
"d2-06-01":xa,"d2-06-02":ya,"d2-06-10":Kc,"d2-06-50":e,"d2-20-00":ba,eltako_dimmer:F,eltako_dimmer2:Wa,eltako_fsud:Nb,eltako_motion:Mb,eltako_contact:Lb,eltako_weather:Ob,eltako_lux:Pb,eltako_lux2:Ac,eltako_sender2:Cc,eltako_sender4:Dc,eltako_button1:Bc,eltako_button2:Ec,eltako_button4:Fc,eltako_blind:R,eltako_fsm60b:Qb,eltako_fkf:Rb,eltako_fkc:Sb,eltako_thermo:za,eltako_ftr65hb:Tb,eltako_futh65d:Gc,eltako_ftr78s:Ub,eltako_powermeter:Xa,eltako_powermeter2:Hc,eltako_fzs:Ya,eltako_switch:ja,eltako_relay:Wb,
eltako_relay2:Vb,eltako_heat:Xb,eltako_water_m3:Yb,eltako_water_m4:Zb,eltako_tf_switch:Mc,eltako_tf_dimmer:Nc,eltako_tf_blind:Oc,peha_switch:Za,peha_powerswitch:ta,peha_blind:ua,"bb-aa-cc":A,afriso_water_con:Ic,afriso_water_eco:$b,afriso_asd_10:Jc,hoppe_door:ac,gp:Lc,afriso_ais_10:Pc,eltako_tf_ttb:Qc.TF_TTB,parseDBJson:function(a){if(!a||!a.eep)return null;var b=this[a.eep];if(!b)return null;b=new b;return b=b.fromDBJSON(a)},parseJson:function(a){if(!a||!a.data)return null;var b=this[a.data];if(!b)return null;
b=new b;return b=b.fromJSON(a)}}}();
...
function(e,a){this._trackers.forEach(function(f){f.onFrame(e,a)})};g.prototype._onEOTelegram=function(e){this._trackers.forEach(function(a){a.onTelegram(e)});var a=this._deviceHandler.getDevice(e.senderID);if(a){var f=this;a.evalData(this._esp3,e,function(c,e){c||0==e.length||f._onEOEvents(a,e)})}};g.prototype._onEOEvents=function(e,a){var f=require("x.hub.eventbus.js");this._trackers.forEach(function(c){c.onResolveEvents(e._address,a)});this._rehauHandler.onDeviceEvent(e,a);var c=e.toJSON();c.sys=
"aio";c.type="ENOCEAN";for(var g=0,h=0;h<a.length;h++){var l=a[h];if(l&&("shortPress"==l.value||"longPress"==l.value||"pressed"==l.value||"released"==l.value)){g++;var r={type:"ENOCEAN",adr:c.address,data:c.data,vendor:c.vendor,state:{}};r.state[l.key]=l.value;f.emit("gatewayevent",r,{address:"ENOCEAN"},"BTN")}}g!=a.length&&(c=e.getStatesLegacy())&&(f.emit("gatewayevent",c,{address:"ENOCEAN"},"STA"),f.emit("udpevent",c,"STA"))};g.prototype._saveEnoceanEvents=function(e,a){var f=require("x.hub.datastore.js").dataStore;
f&&f.openDB(function(c,f){if(!c){c=e._address;for(var g=[],k=(new Date).toISOString(),r=0;r<a.length;r++){var m=a[r];if(m&&m.changed){m=m.key+":"+m.value;var v=null;v=0==g.length?"SELECT '"+c+"' AS 'window', '"+m+"' AS 'state', '"+k+"' AS 'time'":"UNION ALL SELECT '"+c+"', '"+m+"', '"+k+"'";g.push(v)}}0<g.length&&(c=g.join(" "),f.run("INSERT INTO windowstate(window, state, time) "+c+";",function(a){f.close()}))}})};g.prototype.addSensor=function(e,a){e?e.data?"siegenia"!=e.vendor||e.params?this._deviceHandler.addDevice(e,
function(e,c){a&&a({error:e,data:c?c.toJSON():null})}):a&&a({error:Error("siegenia windows params is null")}):a&&a({error:Error("enocean profile is null")}):a&&a({error:Error("enocean device is null")})};g.prototype.updateSensor=function(e,a,f){e?a?this._deviceHandler.updateDevice(e,a,function(a,e){f&&f({error:a,data:e?e.toJSON():null})}):f&&f({error:Error("device info is null")}):f&&f({error:Error("device address is null")})};g.prototype.delSensor=function(e,a){e?this._deviceHandler.deleteDevice({address:e},
function(e){a&&a({error:e})}):a&&a({error:Error("enocean id is null")})};g.prototype.resetDefaultSenderID=function(e){x.hub.m.enocean.SENDER_ID=null;localStorage&&localStorage.setItem("x.hub.m.enocean.SENDER_ID","");e&&e({})};g.prototype.setRehauAlarm=function(e,a){this._rehauHandler.setAlarm(e,a)};g.prototype.isRehauWindowOpen=function(){return this._rehauHandler.isWindowOpen()};g.prototype.setInoventHumidityAccessory=function(e,a,f){this._rehauHandler.setHumidityAccessory(e,a,function(a){f&&f({error:a})})};
g.prototype.setInoventCo2Accessory=function(e,a,f){this._rehauHandler.setCo2Accessory(e,a,function(a){f&&f({error:a})})};g.prototype.getInoventAccessories=function(e,a){e=this._rehauHandler.getInoventAccessory(e);a&&a({data:e?e.toJSON():{}})};g.prototype.__addTelegramTracker=function(e){e&&e.onTelegram&&e.onResolveEvents&&-1==this._trackers.indexOf(e)&&this._trackers.push(e)};g.prototype.__removeTelegramTracker=function(e){e&&(e=this._trackers.indexOf(e),-1!=e&&this._trackers.splice(e,1))};g.prototype.__sendEspFrame=
...
a({error:Error("data invalid")})};return g}();"undefined"!=typeof exports&&"undefined"!=typeof module&&module.exports&&(exports=module.exports=new x.hub.m.enocean.Handler);
