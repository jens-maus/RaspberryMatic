...
$jscomp.polyfillIsolated=function(q,h,e,g){var f=q.split(".");q=1===f.length;g=f[0];g=!q&&g in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var m=0;m<f.length-1;m++){var p=f[m];if(!(p in g))return;g=g[p]}f=f[f.length-1];e=$jscomp.IS_SYMBOL_NATIVE&&"es6"===e?g[f]:null;h=h(e);null!=h&&(q?$jscomp.defineProperty($jscomp.polyfills,f,{configurable:!0,writable:!0,value:h}):h!==e&&(void 0===$jscomp.propertyToPolyfillSymbol[f]&&(e=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[f]=$jscomp.IS_SYMBOL_NATIVE?
$jscomp.global.Symbol(f):$jscomp.POLYFILL_PREFIX+e+"$"+f),$jscomp.defineProperty(g,$jscomp.propertyToPolyfillSymbol[f],{configurable:!0,writable:!0,value:h})))};$jscomp.initSymbol=function(){};
$jscomp.polyfill("Symbol",function(q){if(q)return q;var h=function(m,p){this.$jscomp$symbol$id_=m;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:p})};h.prototype.toString=function(){return this.$jscomp$symbol$id_};var e="jscomp_symbol_"+(1E9*Math.random()>>>0)+"_",g=0,f=function(m){if(this instanceof f)throw new TypeError("Symbol is not a constructor");return new h(e+(m||"")+"_"+g++,m)};return f},"es6","es3");
