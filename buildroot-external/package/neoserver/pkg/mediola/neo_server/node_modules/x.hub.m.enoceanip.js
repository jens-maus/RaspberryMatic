var util=require("util"),EventEmitter=require("events"),x=x||{};x.hub=x.hub||{};x.hub.m=x.hub.m||{};x.hub.m.enoceanip=x.hub.m.enoceanip||{};x.hub.m.enoceanip.MODULE=require("xnm.aio.enoceanip.js");
...
e.prototype._resolveData=function(){var a=this._data.split("\n");2<=a.length&&0==a[1].length&&(this._onMessage(a[0]),a.splice(0,2),this._data=a.join("\n"),0<this._data.length&&this._resolveData())};e.prototype._onMessage=function(a){try{a=JSON.parse(a)}catch(d){return}if(a&&a.header&&"telegram"==a.header.content&&a.telegram){this._logger.log("debug","receive event:"+JSON.stringify(a.telegram));var b=this._devices[a.telegram.deviceId];if(b&&b.device&&b.device.gateway&&(a=x.hub.m.enoceanip.MODULE.resolveEvent(b.device.gateway,
b.device,a.telegram)))for(var c in a)this._produceEvent(b,c,a[c])}};e.prototype._produceEvent=function(a,b,c){var d=a.device;if(a.event&&a.event[b]){var e=a.event[b].callbacks;c={module:"enoceanip",device:d,gateway:d.gateway,data:{key:b,value:c,changed:!0}};for(d=0;d<e.length;d++){var f=e[d];if(f&&f.onEvent)f.onEvent(c)}}if("btn"==b.substr(0,3)&&b.indexOf(!1)&&-1==b.indexOf("longPress")){e=b.substr(3,2);c=(new Date).getTime();if(f=this._buttonEvents[a.device.deviceId])d=f.event,f=f.timestamp,d&&f&&
-1!=d.indexOf("pressed")&&-1!=b.indexOf("released")&&(1E3>c-f?this._produceEvent(a,"btn"+e+"shortPress",!0):this._produceEvent(a,"btn"+e+"longPress",!0));this._buttonEvents[a.device.deviceId]={event:b,timestamp:c}}};return e}();
...
this._getMonitor(a.gateway);d?d.removeStateDevice(a,function(a){b&&b({error:a})},c):b&&b({})}else b&&b(Error("device gateway format invalid"));else b&&b({error:Error("device json format invalid")})};e.prototype.getAllStates=function(){return[]};e.prototype.getStates=function(a){return null};e.prototype.getState=function(a,b,c){a?a.gateway?x.hub.m.enoceanip.MODULE.doStatus("xhub",a.gateway,a,{value:b},function(a,b){a?c&&c({error:a}):b?c&&c({data:{value:b.status}}):c&&c({error:Error("do status failed")})}):
c&&c(Error("device gateway format invalid")):c&&c({error:Error("device json format invalid")})};e.prototype.executeCommand=function(a,b,c){x.hub.m.enoceanip.MODULE.doCommand(a.gateway,a,b,c)};e.prototype.checkDeviceMatch=function(a,b){return b&&b.device&&a&&a.device?b.device.deviceId==a.device.deviceId:!1};e.prototype._startMonitor=function(a,b){if(a)if(a=x.hub.m.enoceanip.MODULE.resolveGateway(a)){var c=a.getIP(),d=a.getPort();c&&d?(c=c+":"+d,this._monitors[c]?b(null,this._monitors[c]):(a=new x.hub.m.enoceanip.Monitor(a),
this._monitors[c]=a,a.start(),b(null,a))):b(Error("gateway json format invalid"))}else b(Error("gateway json format invalid"));else b(Error("gateway json is null"))};e.prototype._getMonitor=function(a){if(a){var b=x.hub.m.enoceanip.MODULE.resolveGateway(a);if(b&&(a=b.getIP(),b=b.getPort(),a&&b))return this._monitors[a+":"+b]}};return e}();"undefined"!=typeof exports&&"undefined"!=typeof module&&module.exports&&(exports=module.exports=new x.hub.m.enoceanip.Handler);
