...
c[f];var h=g[f];d={key:f,value:d,changed:h!=d,oldValue:h};e&&e.sid&&e.changed&&e.changed.length&&(d.changed=!0,delete d.oldValue);h=require("x.hub.eventbus.js");require("x.hub.taskman.js");for(var k=0;k<b.length;k++){var l=b[k];!l||l.statusKey!=f&&"*"!=l.statusKey||h.emit("status",{module:"aio",device:a,gateway:null,data:d},l)}}};return b}();
...
d.executeCommand(a,c,b):b&&b({error:Error("no module for type ENOCEAN")});else{var e=x.hub.m.gateway.AIOMODULE.getGatewayFunctionForType(a.type);if(e){if("CODE"==a.type){var g=x.hub.m.gateway.AIOMODULE.Systems.Code._rebuildDevice(JSON.parse(JSON.stringify(a)));a=x.hub.m.gateway.AIOMODULE.Systems.Code._findIRCode(c,a);a=x.hub.m.gateway.AIOMODULE.Systems.Code._buildParam(a,g)}else a="BG"==a.type?x.hub.m.gateway.AIOMODULE.Systems.BG._buildParam(null,a,c):x.hub.m.gateway.AIOMODULE.getGatewayParams(a,
c.value);e="http://localhost/command?XC_FNC="+e;if(a)for(d in a)e+="&"+d+"="+encodeURIComponent(a[d]);try{var f=require("x.hub.js").server;f?f._doSTMCommandRequest(e,!1,function(a){b&&b({error:a})}):b&&b({error:Error("server not initialized")})}catch(h){b&&b({error:h})}}else b&&b({error:Error("unknow device type")})}}else b&&b({error:Error("device type is null")})};b.prototype._executeCommandLocal=function(a,b,e,d){var c=x.hub.m.gateway.AIOMODULE.devicemanager.getSystem(b,a);if(c&&c.buildQuery){var g=
...
data:b}},g=x.hub.m.gateway.AIOMODULE.resolveGateway(a);if(g){var f=[{id:"hub",device:b,status:{value:e}}],h=this;b&&"dev"==b.common_type?b.id?require("x.hub.commandman.js").commandHandlerV6.getDeviceStatesWithId(b.id,function(a,b){a?d&&d({error:a}):(a={value:b?b[e]:null,time:(new Date).getTime()},d&&d({error:null,data:a}))}):d&&d({error:Error("device json invalid")}):b&&b.type?"HM"==b.type&&"CA"!=global.HARDWARE_VERSION?require("x.hub.m.hm.js").getAllStatesLegacy(function(a){a=c(a,f,g);d&&d(a)}):
"ENOCEAN"==b.type&&"CA"!=global.HARDWARE_VERSION?require("x.hub.m.enocean.js").getAllStatesLegacy(function(a){a=c(a,f,g);d&&d(a)}):"ZWAVE2"==b.type?require("x.hub.m.zway.js").getAllStatesLegacy(function(a){a=c(a,f,g);d&&d(a)}):"KNX"==b.type?require("x.hub.m.knx.js").getAllStatesLegacy(function(a){a=c(a,f,g);d&&d(a)}):"ZIGBEE"==b.type?require("x.hub.m.zigbee.js").getAllStatesLegacy(function(a){a=c(a,f,g);d&&d(a)}):"ONOFF"==b.type||"FLOAT"==b.type||"INT"==b.type||"STRING"==b.type?require("x.hub.sysvarman.js").getSysvarStates(function(a){a=
c(a,f,g);d&&d(a)}):"TASK"==b.type?require("x.hub.taskman.js").readAllTasks(function(a){if(a.error)a=c(a,f,g);else{var b=[];a.data.forEach(function(a){a&&b.push({type:"TASK",id:a.id,active:a.active})});a=c({data:b},f,g)}d&&d(a)}):(a=require("x.hub.js").server)?(this._logger.log("trace","get states from ST directly"),a.doSTMCommand("XC_FNC=getStates",function(a){h._logger.log("trace","get states from ST return:"+JSON.stringify(a));if(a)if(a.XC_SUC){var b={data:null};Array.isArray(a.XC_SUC)?b.data=a.XC_SUC:
