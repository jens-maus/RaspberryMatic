...
a(Error("monitor not connected"));return}var b=this._getActivityStateCallbacks.length;a||(a=function(){});-1==this._getActivityStateCallbacks.indexOf(a)&&this._getActivityStateCallbacks.push(a);if(!b){var c=this;this._hub.getCurrentActivity(function(a,b){a||-1==b||c._updateActivityBuffer(b,"RUNNING");var d=c._getActivityStateCallbacks;c._getActivityStateCallbacks=[];d.forEach(function(c){c&&c(a,b)})})}};d.prototype._updateActivityBuffer=function(a,b){var c=!1,d=null;if(-1==a)this._produceEvent(-1,
{value:"?",time:-1},{value:"allOff",time:(new Date).getTime()}),this._produceEvent(-1,{value:"?",time:-1},{value:"off",time:(new Date).getTime()});else{for(var e in this._activities)if(this._activities.hasOwnProperty(e)){var f=this._activities[e];f.states||(f.states={state:{}});d=f.states.state;if(-1!=e)if(a!=e){if("on"==d.value){f.lastStatus="NO_ACTIVITY";var g={value:this._resolveState("NO_ACTIVITY"),time:(new Date).getTime()};f.states.state=g;this._produceEvent(e,d,g)}}else f.lastStatus=b,c=!0,
g={value:this._resolveState(b),time:(new Date).getTime()},f.states.state=g,this._produceEvent(e,d,g)}c||-1==a||(g={value:this._resolveState(b),time:(new Date).getTime()},this._activities[a]={activity:null,states:{state:g},lastStatus:b},this._produceEvent(a,d,g))}};d.prototype._produceEvent=function(a,b,c){if((a=this._activities[a]?this._activities[a].device:null)&&b){var d=c.value!=b.value;var e=require("x.hub.eventbus.js");d&&e.emit("status",{module:"harmony",device:a,gateway:a.gateway,data:{key:"event",
