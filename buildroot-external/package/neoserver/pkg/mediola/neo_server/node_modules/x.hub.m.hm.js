...
$jscomp.polyfillIsolated=function(p,n,q,h){var g=p.split(".");p=1===g.length;h=g[0];h=!p&&h in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var k=0;k<g.length-1;k++){var r=g[k];if(!(r in h))return;h=h[r]}g=g[g.length-1];q=$jscomp.IS_SYMBOL_NATIVE&&"es6"===q?h[g]:null;n=n(q);null!=n&&(p?$jscomp.defineProperty($jscomp.polyfills,g,{configurable:!0,writable:!0,value:n}):n!==q&&(void 0===$jscomp.propertyToPolyfillSymbol[g]&&(q=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[g]=$jscomp.IS_SYMBOL_NATIVE?
$jscomp.global.Symbol(g):$jscomp.POLYFILL_PREFIX+q+"$"+g),$jscomp.defineProperty(h,$jscomp.propertyToPolyfillSymbol[g],{configurable:!0,writable:!0,value:n})))};$jscomp.polyfill("Array.prototype.find",function(p){return p?p:function(n,q){return $jscomp.findInternal(this,n,q).v}},"es6","es3");$jscomp.arrayIteratorImpl=function(p){var n=0;return function(){return n<p.length?{done:!1,value:p[n++]}:{done:!0}}};$jscomp.arrayIterator=function(p){return{next:$jscomp.arrayIteratorImpl(p)}};
$jscomp.initSymbol=function(){};$jscomp.polyfill("Symbol",function(p){if(p)return p;var n=function(k,r){this.$jscomp$symbol$id_=k;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:r})};n.prototype.toString=function(){return this.$jscomp$symbol$id_};var q="jscomp_symbol_"+(1E9*Math.random()>>>0)+"_",h=0,g=function(k){if(this instanceof g)throw new TypeError("Symbol is not a constructor");return new n(q+(k||"")+"_"+h++,k)};return g},"es6","es3");
