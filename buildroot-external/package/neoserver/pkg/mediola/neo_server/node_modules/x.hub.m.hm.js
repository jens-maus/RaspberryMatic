var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(h,e,n){h instanceof String&&(h=String(h));for(var g=h.length,k=0;k<g;k++){var l=h[k];if(e.call(n,l,k,h))return{i:k,v:l}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(h,e,n){h!=Array.prototype&&h!=Object.prototype&&(h[e]=n.value)};$jscomp.getGlobal=function(h){h=["object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global,h];for(var e=0;e<h.length;++e){var n=h[e];if(n&&n.Math==Math)return n}return globalThis};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.polyfill=function(h,e,n,g){if(e){n=$jscomp.global;h=h.split(".");for(g=0;g<h.length-1;g++){var k=h[g];k in n||(n[k]={});n=n[k]}h=h[h.length-1];g=n[h];e=e(g);e!=g&&null!=e&&$jscomp.defineProperty(n,h,{configurable:!0,writable:!0,value:e})}};$jscomp.polyfill("Array.prototype.find",function(h){return h?h:function(e,h){return $jscomp.findInternal(this,e,h).v}},"es6","es3");$jscomp.arrayIteratorImpl=function(h){var e=0;return function(){return e<h.length?{done:!1,value:h[e++]}:{done:!0}}};
$jscomp.arrayIterator=function(h){return{next:$jscomp.arrayIteratorImpl(h)}};$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.SymbolClass=function(h,e){this.$jscomp$symbol$id_=h;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:e})};$jscomp.SymbolClass.prototype.toString=function(){return this.$jscomp$symbol$id_};
$jscomp.Symbol=function(){function h(n){if(this instanceof h)throw new TypeError("Symbol is not a constructor");return new $jscomp.SymbolClass($jscomp.SYMBOL_PREFIX+(n||"")+"_"+e++,n)}var e=0;return h}();
...
n&&l._updateStatusBuffer(k,n,h[n]):l._updateStatusBuffer(k,n,h[n]))}l._logger.log("trace","getValuesParamset finish:"+JSON.stringify(h));g&&g(null,h)}})};h.prototype.getParamset=function(k,g,e){this._client.getParamset(k,g,0,function(k,g){e&&e(k,g)})};h.prototype.setParamset=function(k,g,e,h){this._client.putParamset(k,g,e,function(g){h&&h(g)})};h.prototype.reportValueUsage=function(g,l,e,h){this._client.reportValueUsage(g,l,e,function(g,k){h&&h(g,k)})};h.prototype.getDevice=function(g){if(!g)return null;
...
function(){g.register(g._xmlrpcServer,function(){})})};n.prototype._onPong=function(){this._pingpong._onPong()};n.prototype.reset=function(g){var k=this;this._rfController.reset(function(){k._ipController.reset(function(){k._wiredController.reset(function(){g&&g()})})})};n.prototype.learnRF=function(g){this._rfController.learnNewDevice(function(k,l){g&&g(k,l)})};n.prototype.learnRFSN=function(g,k){this._rfController.learnNewDeviceSN(g,function(g,e){k&&k(g,e)})};n.prototype.learnIP=function(g,k,e){this._ipController.learnNewIPDevice(g,
k,function(g,k){e&&e(g,k)})};n.prototype.learnIPQR=function(g,k){this._ipController.learnNewIPDeviceQR(g,function(g,e){k&&k(g,e)})};n.prototype.deleteDevice=function(g,k,e){if(!g||!k)return e&&e(Error("argument invalid")),null;switch(g){case "BidCos-RF":g=this._rfController;break;case "BidCos-Wired":g=this._wiredController;break;case "HmIP-RF":g=this._ipController;break;default:e&&e(Error("no such interface"));return}g.deleteDevice(k,e)};n.prototype.getDevices=function(g){var k=0;this._rfController&&
k++;this._ipController&&k++;this._wiredController&&k++;var e=[],h=function(h){k--;h?g&&g(h):0==k&&g&&g(null,e)},m=this;this._rfController&&this._rfController.getBufferedDevices(function(g,k){g?(h&&h(g),h=null):(e=e.concat(m._parseDevices(k,"BidCos-RF")),h&&h())});this._ipController&&this._ipController.getBufferedDevices(function(g,k){g?(h&&h(g),h=null):(e=e.concat(m._parseDevices(k,"HmIP-RF")),h&&h())});this._wiredController&&this._wiredController.getBufferedDevices(function(g,k){g?(h&&h(g),h=null):
(e=e.concat(m._parseDevices(k,"BidCos-Wired")),h&&h())})};n.prototype.getParamset=function(g,k,e,h){if(g&&k&&e){var l=null;switch(g){case "BidCos-RF":l=this._rfController;break;case "BidCos-Wired":l=this._wiredController;break;case "HmIP-RF":l=this._ipController;break;default:h&&h(Error("unknow interface"));return}l.getParamset(k,e,function(g,k){h&&h(g,k)})}else h&&h(Error("argument invalid"))};n.prototype.setParamset=function(g,k,e,h,m){if(g&&k&&e&&h){var l=null;switch(g){case "BidCos-RF":l=this._rfController;
...
e,h,m)}};n.prototype._parseDevices=function(g,k){k||(k="BidCos-RF");var e=new (require("xnm.aio.hm.js").CCU),h={},m;for(m in g)if(g.hasOwnProperty(m)){var n=g[m],p={typename:"DEVICE",hsstype:n.TYPE,address:n.ADDRESS,interface:k,rfAddr:n.RF_ADDRESS,channels:{}};if(n.CHILDREN)for(var v=0,y=n.CHILDREN.length;v<y;v++){var u=n.CHILDREN[v];p.channels[u]={hsstype:g[u].TYPE,address:u}}h[m]=p}return e._parseDevices(h)};n.prototype._xmlrpcCall=function(g,k,e){this._logger.log("trace","receive call:"+g);this._logger.log("trace",
"params:"+JSON.stringify(k));if("event"==g&&"CENTRAL"==k[1]&&"PONG"==k[2])this._onPong(),e&&e(null,[]);else{var h=k[0].split("_");3<=h.length?(h=h[1],-1!=h.indexOf("2001")&&this._rfController?this._rfController._xmlrpcCall(g,k,e):-1!=h.indexOf("2010")&&this._ipController?this._ipController._xmlrpcCall(g,k,e):-1!=h.indexOf("2000")&&this._wiredController?this._wiredController._xmlrpcCall(g,k,e):e&&e(null,[])):e&&e(null,[])}};n.prototype._onNewDevices=function(g){this._logger.log("debug","find new devices");
...
else{var h=this,g=0,k=[],l=function(n,m){!n&&m&&(m.ip=h._monitors[g].ip,m.serialNumber=h._monitors[g].serialNumber,k.push(m));g++;g<h._monitors.length?h._monitors[g].getMonitorState(l):e&&e(null,k)};this._monitors[g].getMonitorState(l)}};h.prototype.deleteMonitor=function(h){for(var e=-1,g=0,k=this._monitors.length;g<k;g++){var l=this._monitors[g];if(l&&l.ip==h){e=g;break}}-1!=g&&this._monitors.splice(e,1)};h.prototype.onFindHomeMatic=function(h,n,g){var k=this.getMonitor(null,g),e=this.getMonitor(h);
e?(e.update(h,n,g),k&&k!=e&&(k.finalize(),this.deleteMonitor(k.ip))):(k&&(k.finalize(),this.deleteMonitor(k.ip)),this.startMonitorForIP(h,n))};h.prototype.onDeviceEvent=function(h,n){require("x.hub.m.hm.js").onDeviceEvent(h,n.isChip)};return h}();
x.hub.m.hm._Channel=function(){var h=function(){var g=[];this.map.forEach(function(k){k&&k.dpt&&k.state&&0<k.state.length&&-1==g.indexOf(k.dpt)&&g.push(k.dpt)});return g},e=function(g){var k=null;this.map.forEach(function(h){h&&h.dpt&&h.state&&-1!=h.state.indexOf(g)&&(k=h.dpt)});return k},n=function(g){var k=null;this.map.forEach(function(h){h&&h.dpt&&h.command&&-1!=h.command.indexOf(g)&&(k=h.dpt)});return k};return{"HmIP-RF":{T_MAINTENANCE:{map:[{dpt:"UNREACH",state:["timeout"],event:["timeout"]},
...
case "LOW_BAT":return{lowbat:k};case "ERROR_NON_FLAT_POSITIONING":return{sabotage:k}}return null}},SWITCH_TRANSMITTER:{map:[{dpt:"STATE",state:["switchTState"],event:["switchTState"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,k){var h=null;switch(g){case "STATE":h=1==k?{switchTState:"on"}:0==k?{switchTState:"off"}:{switchTState:"?"}}return h}},SWITCH_VIRTUAL_RECEIVER:{map:[{dpt:"STATE",state:["switchState"],event:["switchState"],command:["on","off","toggle"]}],getReadableDpts:h,
getDptFromState:e,parseDptState:function(g,k){var h=null;switch(g){case "STATE":h=1==k?{switchState:"on"}:0==k?{switchState:"off"}:{switchState:"?"}}return h},executeCommand:function(g,k,h,e,m){var l=n.call(this,e);"onFor"==e.substr(0,5)&&(l="STATE");if(l)switch(e){case "on":g.writeValue(k,h,l,!0,m);break;case "off":g.writeValue(k,h,l,!1,m);break;case "toggle":g.getState({interface:k,channel:h,datapoint:l},function(e,n){e?m&&m(e):n?(e=!0,n.value&&(e=!1),g.writeValue(k,h,l,e,m)):m&&m(Error("get switch current value return invalid"))});
break;default:"onFor"==e.substr(0,5)?(e=parseFloat(e.substr(5)),isNaN(e)?m&&m(Error("onFor command invalid")):(l="ON_TIME",g.writeValue(k,h,l,{type:"double",value:e},function(e){e?m&&m(e):(l="STATE",g.writeValue(k,h,l,!0,m))}))):m&&m(Error("no such command"))}else m&&m(Error("can not find datapoint for command:"+e))}},ENERGIE_METER_TRANSMITTER:{map:[{dpt:"ENERGY_COUNTER",state:["meterEnergyCounter"],event:["meterEnergyCounter"]},{dpt:"POWER",state:["meterPower"],event:["meterPower"]},{dpt:"CURRENT",
state:["meterCurrent"],event:["meterCurrent"]},{dpt:"VOLTAGE",state:["meterVoltage"],event:["meterVoltage"]},{dpt:"FREQUENCY",state:["meterFrequency"],event:["meterFrequency"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,k){switch(g){case "ENERGY_COUNTER":return{meterEnergyCounter:parseFloat(k).toFixed(2)};case "POWER":return{meterPower:parseFloat(k).toFixed(2)};case "CURRENT":return{meterCurrent:parseFloat(k).toFixed(2)};case "VOLTAGE":return{meterVoltage:parseFloat(k).toFixed(2)};
case "FREQUENCY":return{meterFrequency:parseFloat(k).toFixed(2)}}return null}},DIMMER_TRANSMITTER:{map:[{dpt:"LEVEL",state:["dimmerTLevel"],event:["dimmerTLevel"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,k){var h=null;switch(g){case "LEVEL":h={dimmerTLevel:Math.round(100*parseFloat(k))};break;case "COLOR":h={dimmerTColor:"off blue green torqoise red purple yellow white".split(" ")[parseInt(k)]}}return h}},DIMMER_VIRTUAL_RECEIVER:{map:[{dpt:"LEVEL",state:["dimmerLevel"],event:["dimmerLevel"],
command:["dimOff","dimUp","dimDown","dimTo","toggleTo"]},{dpt:"COLOR",state:["dimmerColor"],event:["dimmerColor"],command:["colorTo"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,k){var h=null;switch(g){case "LEVEL":h={dimmerLevel:Math.round(100*parseFloat(k))}}return h},executeCommand:function(g,k,h,e,m){if(e){if("dimOff"==e.substr(0,6))var l="dimOff";else if("dimUp"==e.substr(0,5)){l="dimUp";var p=e.substr(5)}else if("dimDown"==e.substr(0,7))l="dimDown",p=e.substr(7);else if("dimTo"==
e.substr(0,5)){if(l="dimTo",p=e.substr(5),!p){m&&m(Error("dimTo has no value"));return}}else if("toggleTo"==e.substr(0,8)){if(l="toggleTo",p=e.substr(8),!p){m&&m(Error("toggleTo has no value"));return}}else if("colorTo"==e.substr(0,7)&&(l="colorTo",p=e.substr(7),!p)){m&&m(Error("colorTo has no value"));return}var q=n.call(this,l);if(q)switch(l){case "dimOff":g.writeValue(k,h,q,{type:"double",value:0},m);break;case "dimUp":p||(p=10);p=parseInt(p)/100;g.getState({interface:k,channel:h,datapoint:q},
function(e,l){e?m&&m(e):"undefined"==typeof l||null==l?m&&m(Error("get dimmer current value return invalid")):(p=l.value+p,1<p&&(p=1),g.writeValue(k,h,q,{type:"double",value:p},m))});break;case "dimDown":p||(p=10);p=parseInt(p)/100;g.getState({interface:k,channel:h,datapoint:q},function(e,l){e?m&&m(e):"undefined"==typeof l||null==l?m&&m(Error("get dimmer current value return invalid")):(p=l.value-p,0>p&&(p=0),g.writeValue(k,h,q,{type:"double",value:p},m))});break;case "toggleTo":p=parseInt(p)/100;
g.getState({interface:k,channel:h,datapoint:q},function(e,l){e?m&&m(e):l?(l.value&&(p=0),g.writeValue(k,h,q,{type:"double",value:p},m)):m&&m(Error("get switch current value return invalid"))});break;case "dimTo":p=parseInt(p)/100;g.writeValue(k,h,q,{type:"double",value:p},m);break;case "colorTo":p=p.toLowerCase();p="off blue green torqoise red purple yellow white".split(" ").indexOf(p);if(-1==p){m&&m(Error("unknown color"));break}g.writeValue(k,h,q,{type:"double",value:p},m);break;default:m&&m(Error("no such command"))}else m&&
m(Error("can not find datapoint for command:"+e))}else m&&m(Error("command in null"))}},MOTIONDETECTOR_TRANSCEIVER:{map:[{dpt:"RESET_MOTION",command:["reset"]},{dpt:"MOTION",state:["state"],event:["state"]},{dpt:"ILLUMINATION",state:["illumination"],event:["illumination"]},{dpt:"MOTION_DETECTION_ACTIVE",state:["active"],event:["active"],command:["activate","deactivate","toggleActivate"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,k){var h=null;switch(g){case "MOTION":h={state:k?
"on":"off"};break;case "ILLUMINATION":h={illumination:k};break;case "MOTION_DETECTION_ACTIVE":h={active:k}}return h},executeCommand:function(g,k,h,e,m){if(e){var l=n.call(this,e);if(l)switch(e){case "reset":g.writeValue(k,h,l,!0,m);break;case "activate":g.writeValue(k,h,l,!0,m);break;case "deactivate":g.writeValue(k,h,l,!1,m);break;case "toggleActivate":g.getState({interface:k,channel:h,datapoint:l},function(e,n){e?m&&m(e):n?(e=!0,n.value&&(e=!1),g.writeValue(k,h,l,e,m)):m&&m(Error("get switch current value return invalid"))});
...
{dpt:"OPTICAL_ALARM_SELECTION",command:["setVisual"]},{dpt:"DURATION_UNIT",command:["setDuraionUnit"]},{dpt:"DURATION_VALUE",command:["setDuraion"]},{dpt:"STATE",state:["state"],event:["state"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,k){var h=null;switch(g){case "STATE":h=1==k?{state:"on"}:0==k?{state:"off"}:{state:"?"}}return h},executeCommand:function(g,k,h,e,m){if(e){var l=null;if("triggerAlarm"==e.substr(0,12)){l="triggerAlarm";var p=e.substr(12);if(!p){m&&m(Error("triggerAlarm format invalid"));
return}}if(n.call(this,l)||"triggerAlarm"==l)switch(l){case "triggerAlarm":var q=p.split(",");if(4>q.length){m&&m(Error("triggerAlarm format invalid"));break}g.writeValue(k,h,"ACOUSTIC_ALARM_SELECTION",{type:"double",value:parseInt(q[0])},function(e,l){e?m&&m(e):g.writeValue(k,h,"OPTICAL_ALARM_SELECTION",{type:"double",value:parseInt(q[1])},function(e,l){e?m&&m(e):g.writeValue(k,h,"DURATION_VALUE",{type:"double",value:parseInt(q[2])},function(e,l){e?m&&m(e):g.writeValue(k,h,"DURATION_UNIT",{type:"double",
...
{dpt:"ACTIVE_PROFILE",command:["setProfile"],state:["profile"],event:["profile"]},{dpt:"WINDOW_STATE",command:["winOpen","winClose"],state:["window"],event:["window"]},{dpt:"ACTUAL_TEMPERATURE",state:["temp"],event:["temp"]},{dpt:"BOOST_MODE",command:["boostOn","boostOff"],state:["boost"],event:["boost"]},{dpt:"LEVEL",command:["setValve","valveUp","valveDown"],state:["valve"],event:["valve"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,k){var h={};switch(g){case "ACTIVE_PROFILE":h.profile=
parseInt(k);break;case "ACTUAL_TEMPERATURE":h.temp=parseFloat(k);break;case "BOOST_MODE":h.boost=k;break;case "FROST_PROTECTION":h.frost=k;break;case "HUMIDITY":h.hum=parseInt(k);break;case "SET_POINT_MODE":0==k?h.mode="auto":1==k&&(h.mode="manu");break;case "SET_POINT_TEMPERATURE":h.state=parseFloat(k);break;case "LEVEL":h.valve=Math.round(100*parseFloat(k));break;case "WINDOW_STATE":switch(k){case 0:h.window="closed";break;case 1:h.window="open"}break;default:return null}return h},executeCommand:function(g,
k,h,e,m){if(e){var l=e;if("tempTo"==e.substr(0,6)){l="tempTo";var p=e.substr(6);if(!p){m&&m(Error("tempTo has no value"));return}}else if("tempUp"==e.substr(0,6))l="tempUp",p=e.substr(6);else if("tempDown"==e.substr(0,8))l="tempDown",p=e.substr(8);else if("setProfile"==e.substr(0,10)){if(l="setProfile",p=e.substr(10),!p){m&&m(Error("setProfile has no value"));return}}else if("setValve"==e.substr(0,8)){if(l="setValve",p=e.substr(8),!p){m&&m(Error("setValve has no value"));return}}else"valveUp"==e.substr(0,
7)?(l="valveUp",p=e.substr(7)):"valveDown"==e.substr(0,9)&&(l="valveDown",p=e.substr(9));var q=n.call(this,l);if(q)switch(l){case "tempTo":p=parseFloat(p);if(isNaN(p)){m&&m(Error("tempTo value invalid"));break}30.5<p&&(p=30.5);4.5>p&&(p=4.5);g.writeValue(k,h,q,{type:"double",value:p},m);break;case "tempUp":p||(p=1);p=parseFloat(p);if(isNaN(p)){m&&m(Error("tempUp value invalid"));break}g.getState({interface:k,channel:h,datapoint:q},function(e,l){e?m&&m(e):"undefined"==typeof l||null==l?m&&m(Error("get dimmer current value return invalid")):
(p=l.value+p,30.5<p&&(p=30.5),g.writeValue(k,h,q,{type:"double",value:p},m))});break;case "tempDown":p||(p=1);p=parseFloat(p);if(isNaN(p)){m&&m(Error("tempDown value invalid"));break}g.getState({interface:k,channel:h,datapoint:q},function(e,l){e?m&&m(e):"undefined"==typeof l||null==l?m&&m(Error("get dimmer current value return invalid")):(p=l.value-p,4.5>p&&(p=4.5),g.writeValue(k,h,q,{type:"double",value:p},m))});break;case "auto":g.writeValue(k,h,q,{type:"double",value:0},m);break;case "manu":g.writeValue(k,
h,q,{type:"double",value:1},m);break;case "setProfile":p=parseInt(p);if(isNaN(p)){m&&m(Error("setTemp value invalid"));break}g.writeValue(k,h,q,p,m);break;case "winOpen":g.writeValue(k,h,q,1,m);break;case "winClose":g.writeValue(k,h,q,0,m);break;case "boostOn":g.writeValue(k,h,q,!0,m);break;case "boostOff":g.writeValue(k,h,q,!1,m);break;case "setValve":p=parseInt(p);if(isNaN(p)){m&&m(Error("setValve value invalid"));break}p/=100;1<p&&(p=1);0>p&&(p=0);g.writeValue(k,h,q,{type:"double",value:p},m);
break;case "valveUp":p||(p=10);p=parseInt(p);if(isNaN(p)){m&&m(Error("tempUp value invalid"));break}p/=100;g.getState({interface:k,channel:h,datapoint:q},function(e,l){e?m&&m(e):"undefined"==typeof l||null==l?m&&m(Error("get dimmer current value return invalid")):(p=l.value+p,1<p&&(p=1),g.writeValue(k,h,q,{type:"double",value:p},m))});break;case "valveDown":p||(p=10);p=parseInt(p);if(isNaN(p)){m&&m(Error("tempUp value invalid"));break}p/=100;g.getState({interface:k,channel:h,datapoint:q},function(e,
l){e?m&&m(e):"undefined"==typeof l||null==l?m&&m(Error("get dimmer current value return invalid")):(p=l.value-p,0>p&&(p=0),g.writeValue(k,h,q,{type:"double",value:p},m))});break;default:m&&m(Error("no such command"))}else m&&m(Error("can not find datapoint for command:"+e))}else m&&m(Error("command in null"))}},SHUTTER_CONTACT_TRANSCEIVER:{map:[{dpt:"STATE",state:["state"],event:["state"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,k){var h=null;switch(g){case "STATE":h={state:0==
k?"closed":"open"}}return h}},SMOKE_DETECTOR:{map:[{dpt:"SMOKE_DETECTOR_COMMAND",command:"reservedAlarmOff intrusionAlarmOff intrusionAlarmOn smokeTest commTest commTestRepeated".split(" ")},{dpt:"SMOKE_DETECTOR_ALARM_STATUS",state:["state"],event:["state"]},{dpt:"SMOKE_DETECTOR_ALARM_STATUS",state:["alarmDetail"],event:["alarmDetail"]},{dpt:"SMOKE_DETECTOR_TEST_RESULT",state:["testResult"],event:["testResult"]},{dpt:"ERROR_CODE",state:["error"],event:["error"]}],getReadableDpts:h,getDptFromState:e,
parseDptState:function(g,k){var h=null;switch(g){case "SMOKE_DETECTOR_ALARM_STATUS":h={state:0==k?"ok":"smoke"};h.alarmDetail=k;break;case "SMOKE_DETECTOR_TEST_RESULT":switch(k){case 0:h={testResult:"none"};break;case 1:h={testResult:"smoke_ok"};break;case 2:h={testResult:"smoke_nok"};break;case 3:h={testResult:"comm_sent"};break;case 4:h={testResult:"comm_ok"}}break;case "ERROR_CODE":h={error:k}}return h},executeCommand:function(g,k,h,e,m){if(e){var l=n.call(this,e);if(l)switch(e){case "reservedAlarmOff":case "intrusionAlarmOff":case "intrusionAlarmOn":case "smokeTest":case "commTest":case "commTestRepeated":switch(e){case "reservedAlarmOff":var p=
0;break;case "intrusionAlarmOff":p=1;break;case "intrusionAlarmOn":p=2;break;case "smokeTest":p=3;break;case "commTest":p=4;break;case "commTestRepeated":p=5}g.writeValue(k,h,l,p,m);break;default:m&&m(Error("no such command"))}else m&&m(Error("can not find datapoint for command:"+e))}else m&&m(Error("command in null"))}},ROTARY_HANDLE_TRANSCEIVER:{map:[{dpt:"STATE",state:["state"],event:["state"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,k){var h=null;switch(g){case "STATE":switch(k){case 0:h=
{state:"closed"};break;case 1:h={state:"tilted"};break;case 2:h={state:"open"}}}return h}},SHUTTER_TRANSMITTER:{map:[{dpt:"LEVEL",state:["blindTLevel"],event:["blindTLevel"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,k){var h=null;switch(g){case "LEVEL":h={blindTLevel:Math.round(100*parseFloat(k))}}return h}},SHUTTER_VIRTUAL_RECEIVER:{map:[{dpt:"STOP",command:["stop"]},{dpt:"LEVEL",state:["blindLevel"],event:["blindLevel"],command:["moveUp","moveDown","stepUp","stepDown","moveTo"]}],
getReadableDpts:h,getDptFromState:e,parseDptState:function(g,k){var h=null;switch(g){case "LEVEL":h={blindLevel:Math.round(100*parseFloat(k))}}return h},executeCommand:function(g,k,h,e,m){if(e){if("moveUp"==e.substr(0,6))var l="moveUp";else if("moveDown"==e.substr(0,8)){l="moveDown";var p=e.substr(8)}else if("stepUp"==e.substr(0,6))l="stepUp",p=e.substr(6);else if("stepDown"==e.substr(0,8))l="stepDown",p=e.substr(8);else if("moveTo"==e.substr(0,6)){if(l="moveTo",p=e.substr(6),!p){m&&m(Error("moveTo has no value"));
return}}else"stop"==e.substr(0,4)&&(l="stop");var q=n.call(this,l);if(q)switch(l){case "moveUp":g.writeValue(k,h,q,{type:"double",value:1},m);break;case "moveDown":g.writeValue(k,h,q,{type:"double",value:0},m);break;case "stop":g.writeValue(k,h,q,!0,m);break;case "stepUp":p||(p=5);p=parseInt(p)/100;g.getState({interface:k,channel:h,datapoint:q},function(e,l){e?m&&m(e):"undefined"==typeof l||null==l?m&&m(Error("get dimmer current value return invalid")):(p=l.value+p,1<p&&(p=1),g.writeValue(k,h,q,{type:"double",
value:p},m))});break;case "stepDown":p||(p=5);p=parseInt(p)/100;g.getState({interface:k,channel:h,datapoint:q},function(e,l){e?m&&m(e):"undefined"==typeof l||null==l?m&&m(Error("get dimmer current value return invalid")):(p=l.value-p,0>p&&(p=0),g.writeValue(k,h,q,{type:"double",value:p},m))});break;case "moveTo":p=parseInt(p)/100;g.writeValue(k,h,q,{type:"double",value:p},m);break;default:m&&m(Error("no such command"))}else m&&m(Error("can not find datapoint for command:"+e))}else m&&m(Error("command in null"))}},
BLIND_TRANSMITTER:{map:[{dpt:"LEVEL",state:["blindTPos"],event:["blindTPos"]},{dpt:"LEVEL_2",state:["lamellaTPos"],event:["lamellaTPos"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,k){var h=null;switch(g){case "LEVEL":h={blindTPos:Math.round(100*parseFloat(k))};break;case "LEVEL_2":h={lamellaTPos:Math.round(100*parseFloat(k))}}return h}},BLIND_VIRTUAL_RECEIVER:{map:[{dpt:"STOP",command:["stop"]},{dpt:"LEVEL",state:["blindPos"],event:["blindPos"],command:["moveUp","moveDown","stepUp",
"stepDown","moveTo"]},{dpt:"LEVEL_2",state:["lamellaPos"],event:["lamellaPos"],command:["lamellaUp","lamellaDown","lamellaStepUp","lamellaStepDown","lamellaTo"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,k){var h=null;switch(g){case "LEVEL":h={blindPos:Math.round(100*parseFloat(k))};break;case "LEVEL_2":h={lamellaPos:Math.round(100*parseFloat(k))}}return h},executeCommand:function(g,k,h,e,m){if(e){var l=e;if("lamellaStepUp"==e.substr(0,13)){l="lamellaStepUp";var p=e.substr(13)}else if("lamellaStepDown"==
e.substr(0,15))l="lamellaStepDown",p=e.substr(15);else if("lamellaTo"==e.substr(0,9)){if(l="lamellaTo",p=e.substr(9),!p){m&&m(Error("lamellaTo has no value"));return}}else if("stepUp"==e.substr(0,6))l="stepUp",p=e.substr(6);else if("stepDown"==e.substr(0,8))l="stepDown",p=e.substr(8);else if("moveTo"==e.substr(0,6)){if(l="moveTo",p=e.substr(6),!p){m&&m(Error("moveTo has no value"));return}}else"stop"==e.substr(0,4)&&(l="stop");var q=n.call(this,l);if(q)switch(l){case "moveUp":case "moveDown":g.writeValue(k,
h,"LEVEL_2",{type:"double",value:"moveUp"==l?1:0},function(e){e?m&&m(e):g.writeValue(k,h,"LEVEL",{type:"double",value:"moveUp"==l?1:0},function(g){m&&m(g)})});break;case "stop":g.writeValue(k,h,q,!0,m);break;case "moveTo":p=parseInt(p)/100;g.writeValue(k,h,"LEVEL",{type:"double",value:p},m);break;case "lamellaUp":case "lamellaDown":g.getState({interface:k,channel:h,datapoint:"LEVEL"},function(e,n){e?m&&m(e):g.writeValue(k,h,"LEVEL",{type:"double",value:n.value},function(e){e?m&&m(e):g.writeValue(k,
h,"LEVEL_2",{type:"double",value:"lamellaUp"==l?1:0},function(g){m&&m(g)})})});break;case "stepUp":case "stepDown":p||(p=5);p=parseInt(p)/100;g.getState({interface:k,channel:h,datapoint:"LEVEL"},function(e,n){e?m&&m(e):"undefined"==typeof n||null==n?m&&m(Error("get jalousie current value return invalid")):(p="stepUp"==l?n.value+p:n.value-p,1<p&&(p=1),0>p&&(p=0),g.writeValue(k,h,"LEVEL",{type:"double",value:p},m))});break;case "lamellaStepUp":case "lamellaStepDown":p||(p=5);p=parseInt(p)/100;g.getState({interface:k,
channel:h,datapoint:"LEVEL"},function(e,n){if(e)m&&m(e);else if("undefined"==typeof n||null==n)m&&m(Error("get jalousie current value return invalid"));else{var q=n.value;g.getState({interface:k,channel:h,datapoint:"LEVEL_2"},function(e,n){e?m&&m(e):"undefined"==typeof n||null==n?m&&m(Error("get jalousie current value return invalid")):(p="lamellaStepUp"==l?n.value+p:n.value-p,1<p&&(p=1),0>p&&(p=0),g.writeValue(k,h,"LEVEL_2",{type:"double",value:p},function(e){e?m&&m(e):g.writeValue(k,h,"LEVEL",{type:"double",
value:q},m)}))})}});break;case "lamellaTo":p=parseInt(p)/100;g.writeValue(k,h,"LEVEL_2",{type:"double",value:p},m);break;default:m&&m(Error("no such command"))}else m&&m(Error("can not find datapoint for command:"+e))}else m&&m(Error("command in null"))}},PRESENCEDETECTOR_TRANSCEIVER:{map:[{dpt:"RESET_PRESENCE",command:["reset"]},{dpt:"PRESENCE_DETECTION_STATE",state:["state"],event:["state"]},{dpt:"ILLUMINATION",state:["illumination"],event:["illumination"]},{dpt:"CURRENT_ILLUMINATION",state:["current_illumination"],
...
break;default:m&&m(Error("no such command"))}else m&&m(Error("can not find datapoint for command:"+h))}else m&&m(Error("command in null"))}},WATER_DETECTION_TRANSMITTER:{map:[{dpt:"ALARMSTATE",state:["alarm"],event:["alarm"]},{dpt:"MOISTURE_DETECTED",state:["moisture"],event:["moisture"]},{dpt:"WATERLEVEL_DETECTED",state:["water"],event:["water"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,e){var k=null;switch(g){case "ALARMSTATE":k={alarm:e};break;case "MOISTURE_DETECTED":k={moisture:e};
break;case "WATERLEVEL_DETECTED":k={water:e}}return k}},ACCELERATION_TRANSCEIVER:{map:[{dpt:"MOTION",state:["motion"],event:["motion"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,e){var k=null;switch(g){case "MOTION":k={motion:e}}return k}},DOOR_RECEIVER:{map:[{dpt:"DOOR_STATE",state:["doorState"],event:["doorState"]},{dpt:"DOOR_COMMAND",command:["open","close","partialOpen","stop"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,e){var k=null;switch(g){case "DOOR_STATE":e=
...
getDptFromState:e,parseDptState:function(g,e){var k=null;switch(g){case "POWER_MAINS_FAILURE":k={powerMainsFailure:e}}return k}},ANALOG_INPUT_TRANSMITTER:{map:[{dpt:"VOLTAGE",state:["voltage"],event:["voltage"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,e){var k=null;switch(g){case "VOLTAGE":k={voltage:parseFloat(e)}}return k}}},"BidCos-RF":{MAINTENANCE:{device:"maintenance",map:[{dpt:"LOWBAT",state:["lowbat"],event:["lowbat"]},{dpt:"UNREACH",state:["timeout"],event:["timeout"]}],
...
case "PRESS_LONG":return{pressLong:e};case "PRESS_CONT":return{pressCont:e};case "PRESS_LONG_RELEASE":return{pressLongRel:e};default:return null}},executeCommand:function(g,e,h,q,m){var k=n.call(this,q);switch(q){case "pressShort":g.writeValue(e,h,k,!0,m);break;case "pressLong":g.writeValue(e,h,k,!0,m);break;default:m&&m(Error("no such command"))}}},SWITCH_INTERFACE:{device:"switch_interface",map:[{dpt:"PRESS",event:["press"],command:["press"]}],parseDptState:function(g,e){switch(g){case "PRESS":return{press:!0};
default:return null}},executeCommand:function(g,e,h,q,m){var k=n.call(this,q);switch(q){case "press":g.writeValue(e,h,k,!0,m);break;default:m&&m(Error("no such command"))}}},SHUTTER_CONTACT:{device:"contact",map:[{dpt:"STATE",state:["state"],event:["state"]},{dpt:"ERROR",state:["error"],event:["error"]},{dpt:"LOWBAT",state:["lowbat"],event:["lowbat"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,e){switch(g){case "STATE":return{state:e?"open":"closed"};case "ERROR":return{error:1==
e?"sabotage":"no_error"};case "LOWBAT":return{lowbat:e};default:return null}}},JALOUSIE:{device:"jalousie",map:[{dpt:"LEVEL",state:["jalState"],event:["jalState"],command:["moveUp","moveDown","stepUp","stepDown","%d"]},{dpt:"STOP",command:["stop"]},{dpt:"LEVEL_SLATS",state:["jalLmlState"],event:["jalLmlState"],command:["lamellaUp","lamellaDown","lamellaStepUp","lamellaStepDown","lamellaTo%d"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,e){var k=null;switch(g){case "LEVEL":e=Math.round(100*
parseFloat(e));k={jalState:e};break;case "LEVEL_SLATS":e=Math.round(100*parseFloat(e)),k={jalLmlState:e}}return k},executeCommand:function(g,e,h,q,m){var k=n.call(this,q);switch(q){case "moveUp":g.writeValue(e,h,k,{type:"double",value:1},m);break;case "moveDown":g.writeValue(e,h,k,{type:"double",value:0},m);break;case "stepUp":g.getState({interface:e,channel:h,datapoint:k},function(l,n){if(l)m&&m(l);else if(n){var p=n.value+.05;1<p&&(p=1);g.writeValue(e,h,k,{type:"double",value:p},function(l){l?m&&
m(l):(g.updateStatusBuffer(e,h,k,p,(new Date).getTime()+1E3),m&&m())})}else m&&m(Error("get current jalousie state result invalid"))});break;case "stepDown":g.getState({interface:e,channel:h,datapoint:k},function(l,n){if(l)m&&m(l);else if(n){var p=n.value-.05;0>p&&(p=0);g.writeValue(e,h,k,{type:"double",value:p},function(l){l?m&&m(l):(g.updateStatusBuffer(e,h,k,p,(new Date).getTime()+1E3),m&&m())})}else m&&m(Error("get current blind state result invalid"))});break;case "stop":g.writeValue(e,h,k,!0,
m);break;case "lamellaUp":g.writeValue(e,h,k,{type:"double",value:1},m);break;case "lamellaDown":g.writeValue(e,h,k,{type:"double",value:0},m);break;case "lamellaStepUp":g.getState({interface:e,channel:h,datapoint:k},function(l,n){if(l)m&&m(l);else if(n){var p=n.value+.05;1<p&&(p=1);g.writeValue(e,h,k,{type:"double",value:p},function(l){l?m&&m(l):(g.updateStatusBuffer(e,h,k,p,(new Date).getTime()+1E3),m&&m())})}else m&&m(Error("get current lamella state result invalid"))});break;case "lamellaStepDown":g.getState({interface:e,
channel:h,datapoint:k},function(l,n){if(l)m&&m(l);else if(n){var p=n.value-.05;0>p&&(p=0);g.writeValue(e,h,k,{type:"double",value:p},function(l){l?m&&m(l):(g.updateStatusBuffer(e,h,k,p,(new Date).getTime()+1E3),m&&m())})}else m&&m(Error("get current lamella state result invalid"))});break;default:if("lamellaTo"==q.substr(0,9)){q=q.substr(9);var l=parseInt(q);l/=100;k="LEVEL_SLATS";g.writeValue(e,h,k,{type:"double",value:l},function(n){n?m&&m(n):(g.updateStatusBuffer(e,h,k,l,(new Date).getTime()+1E3),
m&&m())})}else"moveTo"==q.substr(0,6)||q.match(/^[-+]?[0-9]+$/)?("moveTo"==q.substr(0,6)&&(q=q.substr(6)),l=parseInt(q),l/=100,k="LEVEL",g.writeValue(e,h,k,{type:"double",value:l},function(n){n?m&&m(n):(g.updateStatusBuffer(e,h,k,l,(new Date).getTime()+1E3),m&&m())})):m&&m(Error("no such command"))}}},MOD_EM8BIT_TRANSMITTER:{map:[{dpt:"STATE",state:["state8bit"],event:["state8bit"]},{dpt:"LOWBAT",state:["lowbat"],event:["lowbat"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,e){var h=
null;switch(g){case "STATE":e=parseInt(e);h={state8bit:e};break;case "LOWBAT":h={lowbat:e}}return h}},KEYMATIC:{device:"keymatic",map:[{dpt:"STATE",state:["state"],event:["state"],command:["open","close"]},{dpt:"OPEN",command:["openDoor"]},{dpt:"STATE_UNCERTAIN",state:["uncertain"],event:["uncertain"]},{dpt:"ERROR",state:["error"],event:["error"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,e){switch(g){case "STATE":return{state:e?"open":"closed"};case "STATE_UNCERTAIN":return{uncertain:e};
case "ERROR":switch(e){case 0:e="no_error";break;case 1:e="cluth_failure";break;case 2:e="motor_aborted"}return{error:e}}return null},executeCommand:function(g,e,h,q,m){var k=n.call(this,q);switch(q){case "open":g.writeValue(e,h,k,!0,m);break;case "close":g.writeValue(e,h,k,!1,m);break;case "openDoor":g.writeValue(e,h,k,!0,m);break;default:m&&m(Error("no such command"))}}},MOTION_DETECTOR:{device:"motion",map:[{dpt:"BRIGHTNESS",state:["bri"],event:["bri"]},{dpt:"MOTION",state:["state"],event:["state"]},
...
event:["error_reduced"]},{dpt:"LEVEL",state:["bri"],event:["bri"],command:["off","dimUp","dimDown","toggle","dimTo%d"]},{dpt:"LEVEL_REAL",state:["bri_real"],event:["bri_real"]},{dpt:"OLD_LEVEL",command:["on"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,e){var h={};switch(g){case "DIRECTION":h.direction=e;break;case "ERROR_OVERHEAT":h.error_overheat=e?!0:!1;break;case "ERROR_REDUCED":h.error_reduced=e?!0:!1;break;case "LEVEL":h.bri=Math.round(100*parseFloat(e));break;case "LEVEL_REAL":h.bri_real=
Math.round(100*parseFloat(e));break;default:return null}return h},executeCommand:function(g,e,h,q,m){var k=n.call(this,q);switch(q){case "on":g.writeValue(e,h,k,!0,m);break;case "off":g.writeValue(e,h,k,{type:"double",value:0},m);break;case "dimUp":g.getState({interface:e,channel:h,datapoint:k},function(l,n){if(l)m&&m(l);else if(n){var p=n.value+.05;1<p&&(p=1);g.writeValue(e,h,k,{type:"double",value:p},function(l){l?m&&m(l):(g.updateStatusBuffer(e,h,k,p,(new Date).getTime()+1E3),m&&m())})}else m&&
m(Error("get current jalousie state result invalid"))});break;case "dimDown":g.getState({interface:e,channel:h,datapoint:k},function(l,n){if(l)m&&m(l);else if(n){var p=n.value-.05;0>p&&(p=0);g.writeValue(e,h,k,{type:"double",value:p},function(l){l?m&&m(l):(g.updateStatusBuffer(e,h,k,p,(new Date).getTime()+1E3),m&&m())})}else m&&m(Error("get current blind state result invalid"))});break;case "toggle":k="LEVEL";g.getState({interface:e,channel:h,datapoint:k},function(l,n){l?m&&m(l):n?0!=n.value?g.writeValue(e,
h,k,{type:"double",value:0},m):g.writeValue(e,h,"OLD_LEVEL",!0,m):m&&m(Error("get current dimmer state result invalid"))});break;default:if("dimTo"==q.substr(0,5)){q=q.substr(5);var l=parseInt(q);l/=100;k="LEVEL";g.writeValue(e,h,k,{type:"double",value:l},function(n){n?m&&m(n):(g.updateStatusBuffer(e,h,k,l,(new Date).getTime()+1E3),m&&m())})}else m&&m(Error("no such command"))}}},DUAL_WHITE_COLOR:{device:"dualwhite",map:[{dpt:"DIRECTION",state:["color_direction"],event:["color_direction"]},{dpt:"LEVEL",
state:["color"],event:["color"],command:["colorOff","colorUp","colorDown","colorToggle","colorTo%d"]},{dpt:"LEVEL_REAL",state:["color_real"],event:["color_real"]},{dpt:"OLD_LEVEL",command:["colorOn"]}],getReadableDpts:h,getDptFromState:e,parseDptState:function(g,e){var h={};switch(g){case "DIRECTION":h.direction=e;break;case "LEVEL":h.color=Math.round(100*parseFloat(e));break;case "LEVEL_REAL":h.color_real=Math.round(100*parseFloat(e));break;default:return null}return h},executeCommand:function(g,
e,h,q,m){var k=n.call(this,q);switch(q){case "colorOn":g.writeValue(e,h,k,!0,m);break;case "colorOff":g.writeValue(e,h,k,{type:"double",value:0},m);break;case "colorUp":g.getState({interface:e,channel:h,datapoint:k},function(l,n){if(l)m&&m(l);else if(n){var p=n.value+.05;1<p&&(p=1);g.writeValue(e,h,k,{type:"double",value:p},function(l){l?m&&m(l):(g.updateStatusBuffer(e,h,k,p,(new Date).getTime()+1E3),m&&m())})}else m&&m(Error("get current jalousie state result invalid"))});break;case "colorDown":g.getState({interface:e,
channel:h,datapoint:k},function(l,n){if(l)m&&m(l);else if(n){var p=n.value-.05;0>p&&(p=0);g.writeValue(e,h,k,{type:"double",value:p},function(l){l?m&&m(l):(g.updateStatusBuffer(e,h,k,p,(new Date).getTime()+1E3),m&&m())})}else m&&m(Error("get current blind state result invalid"))});break;case "colorToggle":k="LEVEL";g.getState({interface:e,channel:h,datapoint:k},function(l,n){l?m&&m(l):n?0!=n.value?g.writeValue(e,h,k,{type:"double",value:0},m):g.writeValue(e,h,"OLD_LEVEL",!0,m):m&&m(Error("get current dimmer state result invalid"))});
break;default:if("colorTo"==q.substr(0,7)){q=q.substr(7);var l=parseInt(q);l/=100;k="LEVEL";g.writeValue(e,h,k,{type:"double",value:l},function(n){n?m&&m(n):(g.updateStatusBuffer(e,h,k,l,(new Date).getTime()+1E3),m&&m())})}else m&&m(Error("no such command"))}}}}}}();
x.hub.m.hm._Device=function(){var h=function(f,a,b){this.deviceType=f;this.deviceIF=a;this.deviceAdr=b;this.legacyType=null};h.prototype.initStates=function(f,a){var b=this._getReadableDpts();this._initDptStates(f,b,a)};h.prototype._getReadableDpts=function(){return[]};h.prototype._getDptFromRef=function(f){return null};h.prototype._initDptStates=function(f,a,b){if(a&&0!=a.length){var c=0,e=this,g=function(h,B){c++;c==a.length?b&&b():f.readValue(e.deviceIF,a[c].channel,a[c].dpt,g)};f.readValue(this.deviceIF,
a[c].channel,a[c].dpt,g)}else b&&b()};h.prototype.parseDptState=function(f,a,b){return null};h.prototype.toLegacyAdr=function(){return this.deviceType+"."+this.deviceIF+"."+this.deviceAdr};h.prototype.toLegacyType=function(){return this.legacyType};h.prototype.getSerial=function(){var f=this.deviceAdr,a=this.deviceAdr.indexOf(":");-1!=a&&(f=f.substr(0,a));return f};h.prototype.parseChnState=function(f,a){var b={},c;for(c in a){var e=this.parseDptState(f,c,a[c].value);if(e){var g={},h=a[c].time,k;
for(k in e)g[k]={value:e[k],time:h};b=x.hub.m.hm._Util.mergeObj(b,g)}}return b};h.prototype.parseStates=function(f){var a={},b;for(b in f){var c=this.parseChnState(b,f[b]);c&&(a=x.hub.m.hm._Util.mergeObj(a,c))}return a};h.prototype.executeCommand=function(f,a,b){b&&b()};h.prototype.getState=function(f,a,b){switch(a){case "timeout":var c={channel:this.deviceAdr+":0",dataPoint:"UNREACH"};break;default:c=this._getDptFromRef(a)}if(c){var e=this;f.getState({interface:this.deviceIF,channel:c.channel,datapoint:c.dataPoint},
function(f,g){f?b&&b(f):g?(f=e.parseDptState(c.channel,c.dataPoint,g.value))?b&&b(null,{value:f[a],time:g.time}):b&&b(null,null):b&&b(null,null)})}else b&&b(Error("no such state"))};h.prototype.isButton=function(){return!1};var e=function(f,a,b){h.call(this,f,a,b);this.channel=0;this.legacyType="maintenance"};util.inherits(e,h);e.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["BidCos-RF"].MAINTENANCE.getReadableDpts();b&&b.forEach(function(b){f.push({channel:a.deviceAdr+
...
this.channel&&(a+=":"+this.channel);a={channel:a,dataPoint:null};switch(f){case "lowbat":a.channel=0;a.dataPoint="LOWBAT";break;case "timeout":a.channel=0;a.dataPoint="UNREACH";break;case "state":a.dataPoint="STATE";break;case "inhibit":a.dataPoint="INHIBIT";break;case "working":a.dataPoint="WORKING";break;default:return null}return a};k.prototype.executeCommand=function(f,a,b){var c=this.deviceAdr;-1==c.indexOf(":")&&this.channel&&(c+=":"+this.channel);var e=this;switch(a){case "on":var g="STATE";
f.writeValue(this.deviceIF,c,g,!0,b);break;case "off":g="STATE";f.writeValue(this.deviceIF,c,g,!1,b);break;case "toggle":g="STATE";f.getState({interface:this.deviceIF,channel:c,datapoint:g},function(a,h){a?b&&b(a):h?(a=!0,h.value&&(a=!1),f.writeValue(e.deviceIF,c,g,a,b)):b&&b(Error("get switch current value return invalid"))});break;default:"onFor"==a.substr(0,5)?(a=parseFloat(a.substr(5)),isNaN(a)?b&&b(Error("onFor command invalid")):(g="ON_TIME",f.writeValue(this.deviceIF,c,g,{type:"double",value:a},
function(a){a?b&&b(a):(g="STATE",f.writeValue(e.deviceIF,c,g,!0,b))}))):b&&b(Error("no such command"))}};k.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g||0!=f&&f!=this.channel)return null;if(0==f)return c={},"UNREACH"==a?c.timeout=b:"LOWBAT"==a?c.lowbat=b:c["0_"+a.toLowerCase()]=b,c;var h;switch(a){case "STATE":return 1==b?h="on":
...
11)?((e=a.substr(11))||(e=1),e=parseFloat(e),a="stepDownFor"):"stepDown"==a.substr(0,8)&&((e=a.substr(8))||(e=5),e=parseInt(e)/100,a="stepDown");switch(a){case "stepUp":var h="LEVEL";f.getState({interface:this.deviceIF,channel:c,datapoint:h},function(a,B){if(a)b&&b(a);else if(B){e||(e=.05);var k=B.value+e;1<k&&(k=1);f.writeValue(g.deviceIF,c,h,{type:"double",value:k},function(a){a?b&&b(a):(f.updateStatusBuffer(g.deviceIF,c,h,k,(new Date).getTime()+1E3),b&&b())})}else b&&b(Error("get current blind state result invalid"))});
break;case "stepDown":h="LEVEL";f.getState({interface:this.deviceIF,channel:c,datapoint:h},function(a,B){if(a)b&&b(a);else if(B){e||(e=.05);var k=B.value-e;0>k&&(k=0);f.writeValue(g.deviceIF,c,h,{type:"double",value:k},function(a){a?b&&b(a):(f.updateStatusBuffer(g.deviceIF,c,h,k,(new Date).getTime()+1E3),b&&b())})}else b&&b(Error("get current blind state result invalid"))});break;case "stepUpFor":h="LEVEL";f.writeValue(this.deviceIF,c,h,{type:"double",value:1},function(a){a?b&&b(a):setTimeout(function(){h=
...
{};if(0==g)return c["0_"+a.toLowerCase()]=b,c;if(g==this.channel)switch(a){case "WINDOW_STATE":return c.window=b?"closed":"open",c;default:return u.prototype.parseDptState.call(this,f,a,b)}else return null};var S=function(f,a,b){h.call(this,f,a,b);this.weatherChannel=1;this.thermoChannel=2;this.legacyType="wallthermo"};util.inherits(S,h);S.prototype._getReadableDpts=function(){var f=[];f.push({channel:this.deviceAdr+":0",dpt:"UNREACH"});f.push({channel:this.deviceAdr+":0",dpt:"LOWBAT"});f.push({channel:this.deviceAdr+
":"+this.weatherChannel,dpt:"TEMPERATURE"});f.push({channel:this.deviceAdr+":"+this.weatherChannel,dpt:"HUMIDITY"});f.push({channel:this.deviceAdr+":"+this.thermoChannel,dpt:"SETPOINT"});f.push({channel:this.deviceAdr+":"+this.thermoChannel,dpt:"ADJUSTING_COMMAND"});f.push({channel:this.deviceAdr+":"+this.thermoChannel,dpt:"ADJUSTING_DATA"});return f};S.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a,dataPoint:null};switch(f){case "timeout":b.channel=a+":0";b.dataPoint="UNREACH";
break;case "lowbat":b.channel=a+":0";b.dataPoint="LOWBAT";break;case "temp":b.channel=a+":1";b.dataPoint="TEMPERATURE";break;case "hum":b.channel=a+":1";b.dataPoint="HUMIDITY";break;case "state":b.channel=a+":2";b.dataPoint="SETPOINT";break;case "adjusting_command":b.channel=a+":2";b.dataPoint="ADJUSTING_COMMAND";break;case "adjusting_data":b.channel=a+":2";b.dataPoint="ADJUSTING_DATA";break;default:return null}return b};S.prototype.executeCommand=function(f,a,b){var c=this.deviceAdr+":"+this.thermoChannel;
...
f.push({channel:this.deviceAdr+":"+this.thermoChannel,dpt:"SET_TEMPERATURE"});return f};T.prototype._getDptFromRef=function(f){var a={channel:this.deviceAdr+":"+this.thermoChannel,dataPoint:null};switch(f){case "mode":a.dataPoint="CONTROL_MODE";break;case "lowbat":a.dataPoint="LOWBAT_REPORTING";break;case "comm":a.dataPoint="COMMUNICATION_REPORTING";break;case "window":a.dataPoint="WINDOW_OPEN_REPORTING";break;case "batLvl":a.dataPoint="BATTERY_STATE";break;case "boostTime":a.dataPoint="BOOST_STATE";
break;case "temp":a.dataPoint="ACTUAL_TEMPERATURE";break;case "hum":a.dataPoint="ACTUAL_HUMIDITY";break;case "state":a.dataPoint="SET_TEMPERATURE";break;default:return null}return a};T.prototype.executeCommand=function(f,a,b){var c=this.deviceAdr+":"+this.thermoChannel,e=this;switch(a){case "setAuto":var g="AUTO_MODE";f.writeValue(this.deviceIF,c,g,!0,function(a){a||f.updateStatusBuffer(e.deviceIF,c,"CONTROL_MODE",0);b&&b(a)});break;case "setManu":g="SET_TEMPERATURE";f.getState({interface:this.deviceIF,
...
case "ERROR":return{error:1==b?"sabotage":"no_error"};case "LOWBAT":return{lowbat:b};default:return null}};var U=function(f,a,b){h.call(this,f,a,b);this.rainChannel=1;this.heatChannel=2;this.legacyType="rain"};util.inherits(U,h);U.prototype._getReadableDpts=function(){return[{channel:this.deviceAdr+":0",dpt:"UNREACH"},{channel:this.deviceAdr+":"+this.rainChannel,dpt:"STATE"},{channel:this.deviceAdr+":"+this.heatChannel,dpt:"STATE"},{channel:this.deviceAdr+":"+this.heatChannel,dpt:"INHIBIT"},{channel:this.deviceAdr+
":"+this.heatChannel,dpt:"WORKING"}]};U.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a,dataPoint:null};switch(f){case "timeout":b.channel=0;b.dataPoint="UNREACH";break;case "rain":b.channel=a+":"+this.rainChannel;b.dataPoint="STATE";break;case "heat":b.channel=a+":"+this.heatChannel;b.dataPoint="STATE";break;case "inhibit":b.channel=a+":"+this.heatChannel;b.dataPoint="INHIBIT";break;case "working":b.channel=a+":"+this.heatChannel;b.dataPoint="WORKING";break;default:return null}return b};
U.prototype.executeCommand=function(f,a,b){var c=this.deviceAdr;-1==c.indexOf(":")&&this.heatChannel&&(c+=":"+this.heatChannel);var e=this;switch(a){case "heaterOn":var g="STATE";f.writeValue(this.deviceIF,c,g,!0,b);break;case "heaterOff":g="STATE";f.writeValue(this.deviceIF,c,g,!1,b);break;case "heaterToggle":g="STATE";f.getState({interface:this.deviceIF,channel:c,datapoint:g},function(a,h){a?b&&b(a):h?(a=!0,h.value&&(a=!1),f.writeValue(e.deviceIF,c,g,a,b)):b&&b(Error("get switch current value return invalid"))});
break;default:b&&b(Error("no such command"))}};U.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;c={};if(0==f)return"UNREACH"==a?c.timeout=b:c["0_"+a.toLowerCase()]=b,c;if(1==f){switch(a){case "STATE":c.rain=1==b?"rain":"dry";break;default:return null}return c}if(2==f){switch(a){case "STATE":c.heat=b?"on":"off";break;case "INHIBIT":c.inhibit=
b;break;case "WORKING":c.working=b;break;default:return null}return c}};var G=function(f,a,b){h.call(this,f,a,b);this.ledChannel=1;this.chimeChannel=2;this.legacyType="gong2"};util.inherits(G,h);G.prototype._getReadableDpts=function(){return[{channel:this.deviceAdr+":0",dpt:"UNREACH"},{channel:this.deviceAdr+":"+this.ledChannel,dpt:"STATE"},{channel:this.deviceAdr+":"+this.ledChannel,dpt:"INHIBIT"},{channel:this.deviceAdr+":"+this.ledChannel,dpt:"WORKING"},{channel:this.deviceAdr+":"+this.chimeChannel,
dpt:"STATE"},{channel:this.deviceAdr+":"+this.chimeChannel,dpt:"INHIBIT"},{channel:this.deviceAdr+":"+this.chimeChannel,dpt:"WORKING"}]};G.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a,dataPoint:null};switch(f){case "timeout":b.channel=0;b.dataPoint="UNREACH";break;case "led":b.channel=a+":"+this.ledChannel;b.dataPoint="STATE";break;case "led_inhibit":b.channel=a+":"+this.ledChannel;b.dataPoint="INHIBIT";break;case "led_working":b.channel=a+":"+this.ledChannel;b.dataPoint=
"WORKING";break;case "chime":b.channel=a+":"+this.chimeChannel;b.dataPoint="STATE";break;case "chime_inhibit":b.channel=a+":"+this.chimeChannel;b.dataPoint="INHIBIT";break;case "chime_working":b.channel=a+":"+this.chimeChannel;b.dataPoint="WORKING";break;default:return null}return b};G.prototype.executeCommand=function(f,a,b){switch(a){case "ledOn":a=this.deviceAdr+":"+this.ledChannel;f.writeValue(this.deviceIF,a,"STATE",!0,b);break;case "ledOff":a=this.deviceAdr+":"+this.ledChannel;f.writeValue(this.deviceIF,
...
util.inherits(Ma,G);Ma.prototype.executeCommand=function(f,a,b){if(0==a.indexOf("vChannel")){var c=a.substr(8);c=parseInt(c);a=this.deviceAdr+":"+this.chimeChannel;f.writeValue(this.deviceIF,a,"SUBMIT","0.8,1,5,"+c,b)}else if(0==a.indexOf("setChime")){var e=a.substr(8);parseInt(c);a=this.deviceAdr+":"+this.chimeChannel;f.writeValue(this.deviceIF,a,"SUBMIT",e,b)}else 0==a.indexOf("ledGreen")?((c=a.substr(8))||(c=10),a=this.deviceAdr+":"+this.ledChannel,f.writeValue(this.deviceIF,a,"SUBMIT","1,10,"+
c+",34",b)):0==a.indexOf("ledRed")?((c=a.substr(6))||(c=10),a=this.deviceAdr+":"+this.ledChannel,f.writeValue(this.deviceIF,a,"SUBMIT","1,10,"+c+",18",b)):G.prototype.executeCommand.call(this,f,a,b)};var pa=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="window"};util.inherits(pa,h);pa.prototype._getReadableDpts=function(){return[{channel:this.deviceAdr+":0",dpt:"UNREACH"},{channel:this.deviceAdr+":"+this.channel,dpt:"STATE"},{channel:this.deviceAdr+":"+this.channel,dpt:"ERROR"},
...
c));if(e!=g||0!=f&&f!=this.channel)return null;c={};if(0==f)return"UNREACH"==a?c.timeout=b:"LOWBAT"==a?c.lowbat=b:c["0_"+a.toLowerCase()]=b,c;switch(a){case "STATE":c.state=b?"smoke":"ok";break;default:return null}return c};var V=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="siren"};util.inherits(V,h);V.prototype._getReadableDpts=function(){return[{channel:this.deviceAdr+":0",dpt:"UNREACH"},{channel:this.deviceAdr+":"+this.channel,dpt:"STATE"},{channel:this.deviceAdr+":"+this.channel,
dpt:"ERROR_POWER"},{channel:this.deviceAdr+":"+this.channel,dpt:"ERROR_SABOTAGE"},{channel:this.deviceAdr+":"+this.channel,dpt:"ERROR_BATTERY"},{channel:this.deviceAdr+":"+this.channel,dpt:"INHIBIT"},{channel:this.deviceAdr+":"+this.channel,dpt:"WORKING"},{channel:this.deviceAdr+":"+this.channel,dpt:"LOWBAT"}]};V.prototype._getDptFromRef=function(f){var a={channel:this.deviceAdr+":"+this.channel,dataPoint:null};switch(f){case "timeout":a.channel=0;a.dataPoint="UNREACH";break;case "state":a.dataPoint=
"STATE";break;case "error_power":a.dataPoint="ERROR_POWER";break;case "error_sabotage":a.dataPoint="ERROR_SABOTAGE";break;case "error_battery":a.dataPoint="ERROR_BATTERY";break;case "inhibit":a.dataPoint="INHIBIT";break;case "working":a.dataPoint="WORKING";break;default:return null}return a};V.prototype.executeCommand=function(f,a,b){var c=this.deviceAdr+":"+this.channel,e=this;switch(a){case "on":var g="STATE";f.writeValue(this.deviceIF,c,g,!0,b);break;case "off":g="STATE";f.writeValue(this.deviceIF,
c,g,!1,b);break;case "toggle":g="STATE";f.getState({interface:this.deviceIF,channel:c,datapoint:g},function(a,h){a?b&&b(a):(a=!0,h.value&&(a=!1),f.writeValue(e.deviceIF,c,g,a,b))});break;default:b&&b(Error("no such command"))}};V.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g||0!=f&&f!=this.channel)return null;c={};if(0==f)return"UNREACH"==
...
b;break;case "GAS_ENERGY_COUNTER":c.gas_energy=b;break;case "GAS_POWER":c.gas_power=b;break;case "ENERGY_COUNTER":c.energy=b;break;case "POWER":c.power=b;break;default:return null}return c};var P=function(f,a,b){h.call(this,f,a,b);this.dimChannel=1;this.rgbChannel=2;this.autoChannel=3;this.legacyType="rgb"};util.inherits(P,h);P.prototype._getReadableDpts=function(){return[{channel:this.deviceAdr+":0",dpt:"UNREACH"},{channel:this.deviceAdr+":"+this.dimChannel,dpt:"LEVEL"},{channel:this.deviceAdr+":"+
this.rgbChannel,dpt:"COLOR"},{channel:this.deviceAdr+":"+this.autoChannel,dpt:"PROGRAM"}]};P.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a,dataPoint:null};switch(f){case "timeout":b.channel=0;b.dataPoint="UNREACH";break;case "state":b.channel=a+":"+this.dimChannel;b.dataPoint="LEVEL";break;case "color":b.channel=a+":"+this.rgbChannel;b.dataPoint="COLOR";break;case "program":b.channel=a+":"+this.autoChannel;b.dataPoint="PROGRAM";break;case "inhibit":b.channel=a+":"+this.dimChannel;
b.dataPoint="INHIBIT";break;case "working":b.channel=a+":"+this.dimChannel;b.dataPoint="WORKING";break;case "direction":b.channel=a+":"+this.dimChannel;b.dataPoint="DIRECTION";break;default:return null}return b};P.prototype.executeCommand=function(f,a,b){var c=this;switch(a){case "on":var e=this.deviceAdr+":"+this.dimChannel;var g="OLD_LEVEL";f.writeValue(this.deviceIF,e,g,!0,b);break;case "off":e=this.deviceAdr+":"+this.dimChannel;g="LEVEL";f.writeValue(this.deviceIF,e,g,{type:"double",value:0},
...
":"+this.armingChannel,dpt:"LOWBAT"}]};W.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a,dataPoint:null};switch(f){case "timeout":b.channel=0;b.dataPoint="UNREACH";break;case "switchSensorInState":b.channel=a+":"+this.swChannel1;b.dataPoint="STATE";break;case "switchSensorExState":b.channel=a+":"+this.swChannel2;b.dataPoint="STATE";break;case "switchPanicState":b.channel=a+":"+this.panicChannel;b.dataPoint="STATE";break;case "arming":b.channel=a+":"+this.armingChannel;b.dataPoint=
"ARMSTATE";break;case "inhibit":b.channel=a+":"+this.armingChannel;b.dataPoint="INHIBIT";break;case "working":b.channel=a+":"+this.armingChannel;b.dataPoint="WORKING";break;case "sabotage":b.channel=a+":"+this.armingChannel;b.dataPoint="ERROR_SABOTAGE";break;case "lowbat":b.channel=a+":"+this.armingChannel;b.dataPoint="LOWBAT";break;default:return null}return b};W.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;
...
":"+this.armingChannel;f.writeValue(this.deviceIF,g,e,2,b);break;default:b&&b(Error("no such command"))}};var X=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="jalousie"};util.inherits(X,h);X.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["BidCos-RF"];f.push({channel:this.deviceAdr+":0",dpt:"UNREACH"});(b=b.JALOUSIE.getReadableDpts())&&b.forEach(function(b){f.push({channel:a.deviceAdr+":3",dpt:b})});return f};X.prototype._getDptFromRef=function(f){var a=
this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null},c=x.hub.m.hm._Channel["BidCos-RF"];switch(f){case "timeout":b.channel=a+":0";b.dataPoint="UNREACH";break;default:if(b.channel=a+":"+this.channel,b.dataPoint=c.JALOUSIE.getDptFromState(f),!b.dataPoint)return null}return b};X.prototype.executeCommand=function(f,a,b){x.hub.m.hm._Channel["BidCos-RF"].JALOUSIE.executeCommand(f,this.deviceIF,this.deviceAdr+":"+this.channel,a,b)};X.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==
c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;c=x.hub.m.hm._Channel["BidCos-RF"];if(0==f){if("UNREACH"==a)return{timeout:b};c={};c["0_"+a.toLowerCase()]=b;return c}return f==this.channel?c.JALOUSIE.parseDptState(a,b):null};var H=function(f,a,b){h.call(this,f,a,b);this.keyChannel1=1;this.keyChannel2=2;this.em8bitChannel=3;this.legacyType="mod_em_8bit"};util.inherits(H,h);H.prototype._getReadableDpts=
function(){var f=[],a=this,b=x.hub.m.hm._Channel["BidCos-RF"];f.push({channel:this.deviceAdr+":0",dpt:"UNREACH"});var c=b.KEY.getReadableDpts();c&&c.forEach(function(b){f.push({channel:a.deviceAdr+":1",dpt:b});f.push({channel:a.deviceAdr+":2",dpt:b})});(c=b.MOD_EM8BIT_TRANSMITTER.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+":3",dpt:b})});return f};H.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null};switch(f){case "timeout":b.channel=
a+":0";b.dataPoint="UNREACH";break;case "lowbat":b.channel=a+":3";b.dataPoint="LOWBAT";break;case "state8bit":b.channel=a+":3";b.dataPoint="STATE";break;default:return null}return b};H.prototype.executeCommand=function(f,a,b){var c=x.hub.m.hm._Channel["BidCos-RF"];switch(a){case "ch1pressShort":a=this.deviceAdr+":"+this.keyChannel1;c.KEY.executeCommand(f,this.deviceIF,a,"pressShort",b);break;case "ch1pressLong":a=this.deviceAdr+":"+this.keyChannel1;c.KEY.executeCommand(f,this.deviceIF,a,"pressLong",
...
!0),"undefined"!=typeof a.pressCont&&null!=a.pressCont&&(c.ch2pressCont=!0),a.pressLongRel&&(c.ch2pressLongRel=!0);return c}return f==this.em8bitChannel?e.MOD_EM8BIT_TRANSMITTER.parseDptState(a,b):null};H.prototype.isButton=function(){return!0};H.prototype.claimEvent=function(f,a){var b=this.deviceAdr;-1==b.indexOf(":")&&this.channel&&(b+=":"+this.channel);var c=this;f.reportValueUsage(this.deviceIF,b+":1","PRESS_SHORT",function(e,g){e&&console.error("button claim PRESS_SHORT event error:"+e.stack);
f.reportValueUsage(c.deviceIF,b+":1","PRESS_LONG",function(e,g){e&&console.error("button claim PRESS_LONG event error:"+e.stack);f.reportValueUsage(c.deviceIF,b+":2","PRESS_SHORT",function(e,g){e&&console.error("button claim PRESS_SHORT event error:"+e.stack);f.reportValueUsage(c.deviceIF,b+":2","PRESS_LONG",function(b,c){a&&a()})})})})};var I=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="mod_em_8"};util.inherits(I,h);I.prototype._getReadableDpts=function(){var f=[],a=this,b=
x.hub.m.hm._Channel["BidCos-RF"],c=b.KEY.getReadableDpts();c&&c.forEach(function(b){f.push({channel:a.deviceAdr+":"+a.channel,dpt:b})});(c=b.SWITCH_INTERFACE.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+":"+a.channel,dpt:b})});(c=b.SHUTTER_CONTACT.getReadableDpts())&&c.forEach(function(b){"ERROR"!=b&&f.push({channel:a.deviceAdr+":"+a.channel,dpt:b})});return f};I.prototype._getDptFromRef=function(f){var a={channel:this.deviceAdr+":"+this.channel,dataPoint:null};switch(f){case "state":a.dataPoint=
"STATE";break;case "lowbat":a.dataPoint="LOWBAT";break;default:return null}return a};I.prototype.executeCommand=function(f,a,b){var c=x.hub.m.hm._Channel["BidCos-RF"],e=this.deviceAdr+":"+this.channel;switch(a){case "pressShort":c.KEY.executeCommand(f,this.deviceIF,e,"pressShort",b);break;case "pressLong":c.KEY.executeCommand(f,this.deviceIF,e,"pressLong",b);break;case "press":c.SWITCH_INTERFACE.executeCommand(f,this.deviceIF,e,"press",b);break;default:b&&b(Error("no such command"))}};I.prototype.parseDptState=
...
b))&&f.press&&(e.press=!0);if(f=c.SHUTTER_CONTACT.parseDptState(a,b))f.state&&(e.state=f.state),"undefined"!=typeof f.lowbat&&null!=f.lowbat&&(e.lowbat=f.lowbat)}return e};I.prototype.isButton=function(){return!0};I.prototype.claimEvent=function(f,a){var b=this.deviceAdr;-1==b.indexOf(":")&&this.channel&&(b+=":"+this.channel);var c=this;f.reportValueUsage(this.deviceIF,b,"PRESS_SHORT",function(e,g){e&&console.error("button claim PRESS_SHORT event error:"+e.stack);f.reportValueUsage(c.deviceIF,b,"PRESS_LONG",
function(e,g){e&&console.error("button claim PRESS_LONG event error:"+e.stack);f.reportValueUsage(c.deviceIF,b,"PRESS",function(b,c){b&&console.error("button claim PRESS_SHORT event error:"+b.stack);a&&a()})})})};var Y=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="keymatic"};util.inherits(Y,h);Y.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["BidCos-RF"],c=b.MAINTENANCE.getReadableDpts();c&&c.forEach(function(b){f.push({channel:a.deviceAdr+":0",dpt:b})});
(c=b.KEYMATIC.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+":1",dpt:b})});return f};Y.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null};switch(f){case "timeout":b.channel=a+":0";b.dataPoint="UNREACH";break;case "lowbat":b.channel=a+":0";b.dataPoint="LOWBAT";break;case "state":b.channel=a+":1";b.dataPoint="STATE";break;case "uncertain":b.channel=a+":1";b.dataPoint="STATE_UNCERTAIN";break;case "error":b.channel=a+":1";b.dataPoint=
"ERROR";break;default:return null}return b};Y.prototype.executeCommand=function(f,a,b){var c=x.hub.m.hm._Channel["BidCos-RF"];switch(a){case "open":a=this.deviceAdr+":"+this.channel;c.KEYMATIC.executeCommand(f,this.deviceIF,a,"open",b);break;case "close":a=this.deviceAdr+":"+this.channel;c.KEYMATIC.executeCommand(f,this.deviceIF,a,"close",b);break;case "openDoor":a=this.deviceAdr+":"+this.channel;c.KEYMATIC.executeCommand(f,this.deviceIF,a,"openDoor",b);break;default:b&&b(Error("no such command"))}};
Y.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;c=x.hub.m.hm._Channel["BidCos-RF"];if(0==f){if("UNREACH"==a||"LOWBAT"==a)return c.MAINTENANCE.parseDptState(a,b);c={};c["0_"+a.toLowerCase()]=b;return c}return f==this.channel?a=c.KEYMATIC.parseDptState(a,b):null};var J=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType=
"ou_led16"};util.inherits(J,h);J.prototype._getReadableDpts=function(){return[{channel:this.deviceAdr+":"+this.channel,dpt:"LED_STATUS"}]};J.prototype._getDptFromRef=function(f){var a=this.deviceAdr;-1==a.indexOf(":")&&this.channel&&(a+=":"+this.channel);a={channel:a,dataPoint:null};switch(f){case "led":a.dataPoint="LED_STATUS";break;default:return null}return a};J.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;
c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g||0!=f&&f!=this.channel)return null;if(0==f)return c={},"UNREACH"==a?c.timeout=b:"LOWBAT"==a?c.lowbat=b:c["0_"+a.toLowerCase()]=b,c;switch(a){case "LED_STATUS":switch(b){case 0:return{led:"off"};case 1:return{led:"red"};case 2:return{led:"green"};case 3:return{led:"orange"};default:return null}default:return null}};J.prototype.executeCommand=function(f,a,b){var c=this.deviceAdr;-1==c.indexOf(":")&&this.channel&&(c+=":"+this.channel);
...
break;default:b&&b(Error("no such command"))}};J.prototype.isButton=function(){return!0};J.prototype.claimEvent=function(f,a){var b=this.deviceAdr;-1==b.indexOf(":")&&this.channel&&(b+=":"+this.channel);f.reportValueUsage(this.deviceIF,b,"PRESS_SHORT",function(b,f){b&&console.error("button claim PRESS_SHORT event error:"+b.stack);a&&a()})};var Na=function(f,a,b){h.call(this,f,a,b);this.channel=3;this.legacyType="hm_dis_ep_wm55"};util.inherits(Na,h);Na.prototype.executeCommand=function(f,a,b){if("submit"==
a.substr(0,6)){var c=a.substr(6);a=this.deviceAdr+":"+this.channel;f.writeValue(this.deviceIF,a,"SUBMIT",c,b)}else b&&b(Error("no such command"))};var Z=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="dualwhite"};util.inherits(Z,h);Z.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["BidCos-RF"],c=b.MAINTENANCE.getReadableDpts();c&&c.forEach(function(b){"UNREACH"==b&&f.push({channel:a.deviceAdr+":0",dpt:b})});(c=b.DUAL_WHITE_BRIGHTNESS.getReadableDpts())&&
c.forEach(function(b){f.push({channel:a.deviceAdr+":1",dpt:b})});(c=b.DUAL_WHITE_COLOR.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+":2",dpt:b})});return f};Z.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null},c=x.hub.m.hm._Channel["BidCos-RF"];switch(f){case "timeout":b.channel=a+":0";b.dataPoint=c.MAINTENANCE.getDptFromState(f);break;case "bri":case "bri_real":case "error_overheat":case "error_reduced":case "direction":b.channel=
a+":1";b.dataPoint=c.DUAL_WHITE_BRIGHTNESS.getDptFromState(f);break;case "color":case "color_real":case "color_direction":b.channel=a+":2";b.dataPoint=c.DIMMER_VIRTUAL_RECEIVER.getDptFromState(f);break;default:return null}return b};Z.prototype.executeCommand=function(f,a,b){var c=x.hub.m.hm._Channel["BidCos-RF"];switch(a){case "off":case "on":case "toggle":case "dimUp":case "dimDown":c.DUAL_WHITE_BRIGHTNESS.executeCommand(f,this.deviceIF,this.deviceAdr+":1",a,b);break;case "colorOff":case "colorOn":case "colorToggle":case "colorUp":case "colorDown":c.DUAL_WHITE_COLOR.executeCommand(f,
this.deviceIF,this.deviceAdr+":2",a,b);break;default:"dimTo"==a.substr(0,5)?c.DUAL_WHITE_BRIGHTNESS.executeCommand(f,this.deviceIF,this.deviceAdr+":1",a,b):"colorTo"==a.substr(0,7)?c.DUAL_WHITE_COLOR.executeCommand(f,this.deviceIF,this.deviceAdr+":2",a,b):b&&b(Error("no such command"))}};Z.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=
g)return null;c=x.hub.m.hm._Channel["BidCos-RF"];if(0==f){if("UNREACH"==a)return c.MAINTENANCE.parseDptState(a,b);c={};c["0_"+a.toLowerCase()]=b;return c}return 1==f?c.DUAL_WHITE_BRIGHTNESS.parseDptState(a,b):2==f?c.DUAL_WHITE_COLOR.parseDptState(a,b):null};var Pa=function(f,a,b){k.call(this,f,a,b);this.channel=3;this.legacyType="ip_switch"};util.inherits(Pa,k);var Aa=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_contact"};util.inherits(Aa,h);Aa.prototype._getReadableDpts=
...
a)return c.MAINTENANCE_BAT_EL.parseDptState(a,b);c={};c["0_"+a.toLowerCase()]=b;return c}return 1==f?c.SHUTTER_CONTACT_TRANSCEIVER.parseDptState(a,b):null};var aa=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_heater"};util.inherits(aa,h);aa.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"],c=b.MAINTENANCE_BAT_EL.getReadableDpts();c&&c.forEach(function(b){"SABOTAGE"!=b&&f.push({channel:a.deviceAdr+":0",dpt:b})});(c=b.HEATING_CLIMATECONTROL_TRANSCEIVER.getReadableDpts())&&
c.forEach(function(b){"HUMIDITY"!=b&&f.push({channel:a.deviceAdr+":1",dpt:b})});return f};aa.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null},c=x.hub.m.hm._Channel["HmIP-RF"];switch(f){case "timeout":case "lowbat":b.channel=a+":0";b.dataPoint=c.MAINTENANCE_BAT_EL.getDptFromState(f);break;case "profile":case "temp":case "boost":case "frost":case "mode":case "state":case "window":b.channel=a+":1";b.dataPoint=c.HEATING_CLIMATECONTROL_TRANSCEIVER.getDptFromState(f);
break;default:return null}return b};aa.prototype.executeCommand=function(f,a,b){x.hub.m.hm._Channel["HmIP-RF"].HEATING_CLIMATECONTROL_TRANSCEIVER.executeCommand(f,this.deviceIF,this.deviceAdr+":"+this.channel,a,b)};aa.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;c=x.hub.m.hm._Channel["HmIP-RF"];e=null;if(0==f){if("UNREACH"==
a||"LOW_BAT"==a)return c.MAINTENANCE.parseDptState(a,b);e={};e["0_"+a.toLowerCase()]=b;return e}return 1==f?c.HEATING_CLIMATECONTROL_TRANSCEIVER.parseDptState(a,b):e};var ba=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_powerswitch"};util.inherits(ba,h);ba.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"],c=b.MAINTENANCE.getReadableDpts();c&&c.forEach(function(b){"UNREACH"==b&&f.push({channel:a.deviceAdr+":0",dpt:b})});(c=b.SWITCH_VIRTUAL_RECEIVER.getReadableDpts())&&
c.forEach(function(b){f.push({channel:a.deviceAdr+":3",dpt:b})});(c=b.ENERGIE_METER_TRANSMITTER.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+":6",dpt:b})});return f};ba.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null},c=x.hub.m.hm._Channel["HmIP-RF"];switch(f){case "timeout":b.channel=a+":0";b.dataPoint=c.MAINTENANCE.getDptFromState(f);break;case "switchState":b.channel=a+":3";b.dataPoint=c.SWITCH_VIRTUAL_RECEIVER.getDptFromState("switchState");
break;case "meterVoltage":case "meterEnergyCounter":case "meterFrequency":case "meterPower":case "meterCurrent":b.channel=a+":6";b.dataPoint=c.ENERGIE_METER_TRANSMITTER.getDptFromState(f);break;default:return null}return b};ba.prototype.executeCommand=function(f,a,b){var c=x.hub.m.hm._Channel["HmIP-RF"];switch(a){case "on":var e=this.deviceAdr+":3";c.SWITCH_VIRTUAL_RECEIVER.executeCommand(f,this.deviceIF,e,"on",b);break;case "off":e=this.deviceAdr+":3";c.SWITCH_VIRTUAL_RECEIVER.executeCommand(f,this.deviceIF,
e,"off",b);break;case "toggle":e=this.deviceAdr+":3";c.SWITCH_VIRTUAL_RECEIVER.executeCommand(f,this.deviceIF,e,"toggle",b);break;default:"onFor"==a.substr(0,5)?(e=this.deviceAdr+":3",c.SWITCH_VIRTUAL_RECEIVER.executeCommand(f,this.deviceIF,e,a,b)):b&&b(Error("no such command"))}};ba.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;
c=x.hub.m.hm._Channel["HmIP-RF"];if(0==f){if("UNREACH"==a)return c.MAINTENANCE.parseDptState(a,b);c={};c["0_"+a.toLowerCase()]=b;return c}return 3==f?c.SWITCH_VIRTUAL_RECEIVER.parseDptState(a,b):6==f?c.ENERGIE_METER_TRANSMITTER.parseDptState(a,b):null};var C=function(f,a,b){h.call(this,f,a,b);this.channel=1;this._chKeyTransceivers=[];"HmIP-BSM"==f&&(this._chKeyTransceivers=[1,2]);this.legacyType="ip_energyactor"};util.inherits(C,h);C.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"],
c=b.MAINTENANCE.getReadableDpts();c&&c.forEach(function(b){"UNREACH"==b&&f.push({channel:a.deviceAdr+":0",dpt:b})});(c=b.SWITCH_TRANSMITTER.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+":3",dpt:b})});(c=b.SWITCH_VIRTUAL_RECEIVER.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+":4",dpt:b});f.push({channel:a.deviceAdr+":5",dpt:b});f.push({channel:a.deviceAdr+":6",dpt:b})});(c=b.ENERGIE_METER_TRANSMITTER.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+
":7",dpt:b})});return f};C.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null},c=x.hub.m.hm._Channel["HmIP-RF"];switch(f){case "timeout":b.channel=a+":0";b.dataPoint=c.MAINTENANCE.getDptFromState(f);break;case "switchState":b.channel=a+":3";b.dataPoint=c.SWITCH_TRANSMITTER.getDptFromState("switchTState");break;case "ch4State":b.channel=a+":4";b.dataPoint=c.SWITCH_VIRTUAL_RECEIVER.getDptFromState("switchState");break;case "ch5State":b.channel=a+":5";
b.dataPoint=c.SWITCH_VIRTUAL_RECEIVER.getDptFromState("switchState");break;case "ch6State":b.channel=a+":6";b.dataPoint=c.SWITCH_VIRTUAL_RECEIVER.getDptFromState("switchState");break;case "meterVoltage":case "meterEnergyCounter":case "meterFrequency":case "meterPower":case "meterCurrent":b.channel=a+":7";b.dataPoint=c.ENERGIE_METER_TRANSMITTER.getDptFromState(f);break;default:return null}return b};C.prototype.executeCommand=function(f,a,b){var c=null,e=x.hub.m.hm._Channel["HmIP-RF"];switch(a){case "on":case "ch4on":case "ch5on":case "ch6on":switch(a){case "on":case "ch4on":c=
...
f){if("UNREACH"==a)return e.MAINTENANCE.parseDptState(a,b);c={};c["0_"+a.toLowerCase()]=b;return c}if(3==f){if(a=e.SWITCH_TRANSMITTER.parseDptState(a,b))c={},c.switchState=a.switchTState;return c}if(4==f||5==f||6==f){if(a=e.SWITCH_VIRTUAL_RECEIVER.parseDptState(a,b))switch(c={},parseInt(f)){case 4:c.ch4State=a.switchState;break;case 5:c.ch5State=a.switchState;break;case 6:c.ch6State=a.switchState}return c}return 7==f?e.ENERGIE_METER_TRANSMITTER.parseDptState(a,b):null};C.prototype.isButton=function(){return 0<
this._chKeyTransceivers.length};C.prototype.claimEvent=function(f,a){var b=0,c=this,e=function(){b++;b<c._chKeyTransceivers.length?c._claimButtonEvent(c._chKeyTransceivers[b],f,e):a&&a()};this._claimButtonEvent(this._chKeyTransceivers[b],f,e)};C.prototype._claimButtonEvent=function(f,a,b){var c=this;a.reportValueUsage(this.deviceIF,this.deviceAdr+":"+f,"PRESS_SHORT",function(e,g){e&&console.error("button:"+f+" claim PRESS_SHORT event error:"+e.stack);a.reportValueUsage(c.deviceIF,c.deviceAdr+":"+
f,"PRESS_LONG",function(a,c){a&&console.error("button:"+f+" claim PRESS_LONG event error:"+a.stack);b&&b()})})};var ca=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_energyactor2"};util.inherits(ca,h);ca.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"],c=b.MAINTENANCE.getReadableDpts();c&&c.forEach(function(b){"UNREACH"==b&&f.push({channel:a.deviceAdr+":0",dpt:b})});(c=b.SWITCH_TRANSMITTER.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+
":1",dpt:b})});(c=b.SWITCH_VIRTUAL_RECEIVER.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+":2",dpt:b});f.push({channel:a.deviceAdr+":3",dpt:b});f.push({channel:a.deviceAdr+":4",dpt:b})});(c=b.ENERGIE_METER_TRANSMITTER.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+":5",dpt:b})});return f};ca.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null},c=x.hub.m.hm._Channel["HmIP-RF"];switch(f){case "timeout":b.channel=
a+":0";b.dataPoint=c.MAINTENANCE.getDptFromState(f);break;case "switchState":b.channel=a+":1";b.dataPoint=c.SWITCH_TRANSMITTER.getDptFromState("switchTState");break;case "ch2State":b.channel=a+":2";b.dataPoint=c.SWITCH_VIRTUAL_RECEIVER.getDptFromState("switchState");break;case "ch3State":b.channel=a+":3";b.dataPoint=c.SWITCH_VIRTUAL_RECEIVER.getDptFromState("switchState");break;case "ch4State":b.channel=a+":4";b.dataPoint=c.SWITCH_VIRTUAL_RECEIVER.getDptFromState("switchState");break;case "meterVoltage":case "meterEnergyCounter":case "meterFrequency":case "meterPower":case "meterCurrent":b.channel=
a+":5";b.dataPoint=c.ENERGIE_METER_TRANSMITTER.getDptFromState(f);break;default:return null}return b};ca.prototype.executeCommand=function(f,a,b){var c=null,e=x.hub.m.hm._Channel["HmIP-RF"];switch(a){case "on":case "ch2on":case "ch3on":case "ch4on":switch(a){case "on":case "ch2on":c=this.deviceAdr+":2";break;case "ch3on":c=this.deviceAdr+":3";break;case "ch4on":c=this.deviceAdr+":4"}e.SWITCH_VIRTUAL_RECEIVER.executeCommand(f,this.deviceIF,c,"on",b);break;case "off":case "ch2off":case "ch3off":case "ch4off":switch(a){case "off":case "ch2off":c=
...
ha.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;c=x.hub.m.hm._Channel["HmIP-RF"];if(0==f){if("UNREACH"==a||"LOW_BAT"==a||"SABOTAGE"==a)return c.MAINTENANCE_BAT_EL.parseDptState(a,b);c={};c["0_"+a.toLowerCase()]=b;return c}return 1==f?c.MOTIONDETECTOR_TRANSCEIVER.parseDptState(a,b):null};var K=function(f,a,b){h.call(this,
f,a,b);this.channel=3;this.legacyType="ip_motion2"};util.inherits(K,h);K.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"],c=b.MAINTENANCE_BAT_EL.getReadableDpts();c&&c.forEach(function(b){"SABOTAGE"!=b&&f.push({channel:a.deviceAdr+":0",dpt:b})});(c=b.MOTIONDETECTOR_TRANSCEIVER.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+":3",dpt:b})});return f};K.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,
dataPoint:null},c=x.hub.m.hm._Channel["HmIP-RF"];switch(f){case "timeout":case "lowbat":b.channel=a+":0";b.dataPoint=c.MAINTENANCE_BAT_EL.getDptFromState(f);break;case "state":case "illumination":case "active":b.channel=a+":3";b.dataPoint=c.MOTIONDETECTOR_TRANSCEIVER.getDptFromState(f);break;default:return null}return b};K.prototype.executeCommand=function(f,a,b){switch(a){case "reset":case "activate":case "deactivate":case "toggleActivate":break;default:b&&b(Error("no such command"))}};K.prototype.parseDptState=
...
c.KEY_TRANRECEIVER.parseDptState(a,b))&&(g.pressShort&&(e={btn2pressShort:!0}),g.pressLong&&(e={btn2pressLong:!0}));return 3==f?c.MOTIONDETECTOR_TRANSCEIVER.parseDptState(a,b):e};K.prototype.isButton=function(){return!0};K.prototype.claimEvent=function(f,a){var b=this.deviceAdr;-1==b.indexOf(":")&&this.channel&&(b+=":"+this.channel);var c=this;f.reportValueUsage(this.deviceIF,this.deviceAdr+":1","PRESS_SHORT",function(b,e){b&&console.error("button:1 claim PRESS_SHORT event error:"+b.stack);f.reportValueUsage(c.deviceIF,
c.deviceAdr+":1","PRESS_LONG",function(b,e){b&&console.error("button:1 claim PRESS_LONG event error:"+b.stack);f.reportValueUsage(c.deviceIF,c.deviceAdr+":2","PRESS_SHORT",function(b,e){b&&console.error("button:2 claim PRESS_SHORT event error:"+b.stack);f.reportValueUsage(c.deviceIF,c.deviceAdr+":2","PRESS_LONG",function(b,c){b&&console.error("button:2 claim PRESS_LONG event error:"+b.stack);a&&a()})})})})};var Q=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_button"};util.inherits(Q,
h);Q.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"].MAINTENANCE_BAT_EL.getReadableDpts();b&&b.forEach(function(b){"SABOTAGE"!=b&&f.push({channel:a.deviceAdr+":0",dpt:b})});return f};Q.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null},c=x.hub.m.hm._Channel["HmIP-RF"];switch(f){case "timeout":case "lowbat":b.channel=a+":0";b.dataPoint=c.MAINTENANCE_BAT_EL.getDptFromState(f);break;default:return null}return b};
Q.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;e=x.hub.m.hm._Channel["HmIP-RF"];c=null;if(0==f){if("UNREACH"==a||"LOW_BAT"==a)return e.MAINTENANCE_BAT_EL.parseDptState(a,b);c={};c["0_"+a.toLowerCase()]=b;return c}f==this.channel&&(a=e.KEY_TRANRECEIVER.parseDptState(a,b))&&(a.pressShort&&(c={pressShort:!0}),a.pressLong&&
(c={pressLong:!0}));return c};Q.prototype.isButton=function(){return!0};Q.prototype.claimEvent=function(f,a){var b=this.deviceAdr;-1==b.indexOf(":")&&this.channel&&(b+=":"+this.channel);var c=this;f.reportValueUsage(this.deviceIF,this.deviceAdr+":1","PRESS_SHORT",function(b,e){b&&console.error("button:1 claim PRESS_SHORT event error:"+b.stack);f.reportValueUsage(c.deviceIF,c.deviceAdr+":1","PRESS_LONG",function(b,c){b&&console.error("button:1 claim PRESS_LONG event error:"+b.stack);a&&a()})})};var R=
function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_button2"};util.inherits(R,h);R.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"].MAINTENANCE_BAT_EL.getReadableDpts();b&&b.forEach(function(b){"SABOTAGE"!=b&&f.push({channel:a.deviceAdr+":0",dpt:b})});return f};R.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null},c=x.hub.m.hm._Channel["HmIP-RF"];switch(f){case "timeout":case "lowbat":b.channel=
a+":0";b.dataPoint=c.MAINTENANCE_BAT_EL.getDptFromState(f);break;default:return null}return b};R.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;c=x.hub.m.hm._Channel["HmIP-RF"];e=null;if(0==f){if("UNREACH"==a||"LOW_BAT"==a)return c.MAINTENANCE_BAT_EL.parseDptState(a,b);e={};e["0_"+a.toLowerCase()]=b;return e}1==f&&(g=c.KEY_TRANRECEIVER.parseDptState(a,
b))&&(g.pressShort&&(e={btn1pressShort:!0}),g.pressLong&&(e={btn1pressLong:!0}));2==f&&(g=c.KEY_TRANRECEIVER.parseDptState(a,b))&&(g.pressShort&&(e={btn2pressShort:!0}),g.pressLong&&(e={btn2pressLong:!0}));return e};R.prototype.isButton=function(){return!0};R.prototype.claimEvent=function(f,a){var b=this.deviceAdr;-1==b.indexOf(":")&&this.channel&&(b+=":"+this.channel);var c=this;f.reportValueUsage(this.deviceIF,this.deviceAdr+":1","PRESS_SHORT",function(b,e){b&&console.error("button:1 claim PRESS_SHORT event error:"+
b.stack);f.reportValueUsage(c.deviceIF,c.deviceAdr+":1","PRESS_LONG",function(b,e){b&&console.error("button:1 claim PRESS_LONG event error:"+b.stack);f.reportValueUsage(c.deviceIF,c.deviceAdr+":2","PRESS_SHORT",function(b,e){b&&console.error("button:2 claim PRESS_SHORT event error:"+b.stack);f.reportValueUsage(c.deviceIF,c.deviceAdr+":2","PRESS_LONG",function(b,c){b&&console.error("button:2 claim PRESS_LONG event error:"+b.stack);a&&a()})})})})};var L=function(f,a,b){h.call(this,f,a,b);this.channel=
1;this.legacyType="ip_button4"};util.inherits(L,h);L.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"].MAINTENANCE_BAT_EL.getReadableDpts();b&&b.forEach(function(b){"SABOTAGE"!=b&&f.push({channel:a.deviceAdr+":0",dpt:b})});return f};L.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null},c=x.hub.m.hm._Channel["HmIP-RF"];switch(f){case "timeout":case "lowbat":b.channel=a+":0";b.dataPoint=c.MAINTENANCE_BAT_EL.getDptFromState(f);
break;default:return null}return b};L.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;e=x.hub.m.hm._Channel["HmIP-RF"];c=null;if(0==f){if("UNREACH"==a||"LOW_BAT"==a)return e.MAINTENANCE_BAT_EL.parseDptState(a,b);c={};c["0_"+a.toLowerCase()]=b;return c}if(1==f||2==f||3==f||4==f)if(a=e.KEY_TRANRECEIVER.parseDptState(a,b))c||
(c={}),a.pressShort&&(c["btn"+f+"pressShort"]=!0),a.pressLong&&(c["btn"+f+"pressLong"]=!0);return c};L.prototype.isButton=function(){return!0};L.prototype.claimEvent=function(f,a){var b=this.deviceAdr;-1==b.indexOf(":")&&this.channel&&(b+=":"+this.channel);var c=this;this._claimButtonEvent(1,f,function(){c._claimButtonEvent(2,f,function(){c._claimButtonEvent(3,f,function(){c._claimButtonEvent(4,f,function(){a&&a()})})})})};L.prototype._claimButtonEvent=function(f,a,b){var c=this;a.reportValueUsage(this.deviceIF,
this.deviceAdr+":"+f,"PRESS_SHORT",function(e,g){e&&console.error("button:"+f+" claim PRESS_SHORT event error:"+e.stack);a.reportValueUsage(c.deviceIF,c.deviceAdr+":"+f,"PRESS_LONG",function(a,c){a&&console.error("button:"+f+" claim PRESS_LONG event error:"+a.stack);b&&b()})})};var M=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_button6"};util.inherits(M,h);M.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"].MAINTENANCE_BAT_EL.getReadableDpts();
b&&b.forEach(function(b){"SABOTAGE"!=b&&f.push({channel:a.deviceAdr+":0",dpt:b})});return f};M.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null},c=x.hub.m.hm._Channel["HmIP-RF"];switch(f){case "timeout":case "lowbat":b.channel=a+":0";b.dataPoint=c.MAINTENANCE_BAT_EL.getDptFromState(f);break;default:return null}return b};M.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=
this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;e=x.hub.m.hm._Channel["HmIP-RF"];c=null;if(0==f){if("UNREACH"==a||"LOW_BAT"==a)return e.MAINTENANCE_BAT_EL.parseDptState(a,b);c={};c["0_"+a.toLowerCase()]=b;return c}if(1==f||2==f||3==f||4==f||5==f||6==f)if(a=e.KEY_TRANRECEIVER.parseDptState(a,b))c||(c={}),a.pressShort&&(c["btn"+f+"pressShort"]=!0),a.pressLong&&(c["btn"+f+"pressLong"]=!0);return c};M.prototype.isButton=function(){return!0};M.prototype.claimEvent=
function(f,a){var b=this.deviceAdr;-1==b.indexOf(":")&&this.channel&&(b+=":"+this.channel);var c=this;this._claimButtonEvent(1,f,function(){c._claimButtonEvent(2,f,function(){c._claimButtonEvent(3,f,function(){c._claimButtonEvent(4,f,function(){c._claimButtonEvent(5,f,function(){c._claimButtonEvent(6,f,function(){a&&a()})})})})})})};M.prototype._claimButtonEvent=function(f,a,b){var c=this;a.reportValueUsage(this.deviceIF,this.deviceAdr+":"+f,"PRESS_SHORT",function(e,g){e&&console.error("button:"+
...
b);c={};c["0_"+a.toLowerCase()]=b;return c}return 3==f?c.ALARM_SWITCH_VIRTUAL_RECEIVER.parseDptState(a,b):null};var D=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_wallthermo"};util.inherits(D,h);D.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"],c=b.MAINTENANCE_BAT_EL.getReadableDpts();c&&c.forEach(function(b){"SABOTAGE"!=b&&f.push({channel:a.deviceAdr+":0",dpt:b})});(c=b.HEATING_CLIMATECONTROL_TRANSCEIVER.getReadableDpts())&&c.forEach(function(b){"LEVEL"!=
b&&f.push({channel:a.deviceAdr+":1",dpt:b})});return f};D.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null},c=x.hub.m.hm._Channel["HmIP-RF"];switch(f){case "timeout":case "lowbat":b.channel=a+":0";b.dataPoint=c.MAINTENANCE_BAT_EL.getDptFromState(f);break;case "profile":case "temp":case "boost":case "frost":case "hum":case "mode":case "state":case "window":b.channel=a+":1";b.dataPoint=c.HEATING_CLIMATECONTROL_TRANSCEIVER.getDptFromState(f);break;
default:return null}return b};D.prototype.executeCommand=function(f,a,b){x.hub.m.hm._Channel["HmIP-RF"].HEATING_CLIMATECONTROL_TRANSCEIVER.executeCommand(f,this.deviceIF,this.deviceAdr+":"+this.channel,a,b)};D.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;c=x.hub.m.hm._Channel["HmIP-RF"];e=null;if(0==f){if("UNREACH"==a||
"LOW_BAT"==a)return c.MAINTENANCE_BAT_EL.parseDptState(a,b);e={};e["0_"+a.toLowerCase()]=b;return e}return 1==f?c.HEATING_CLIMATECONTROL_TRANSCEIVER.parseDptState(a,b):e};var Ba=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_wallthermo2"};util.inherits(Ba,D);Ba.prototype._getReadableDpts=function(){var f=D.prototype._getReadableDpts.call(this);f||(f=[]);var a=this,b=x.hub.m.hm._Channel["HmIP-RF"],c=b.CLIMATECONTROL_FLOOR_DIRECT_TRANSMITTER.getReadableDpts();c&&c.forEach(function(b){f.push({channel:a.deviceAdr+
...
a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;c=x.hub.m.hm._Channel["HmIP-RF"];e=null;if(0==f){if("UNREACH"==a||"LOW_BAT"==a||"SABOTAGE"==a)return c.MAINTENANCE_BAT_EL.parseDptState(a,b);e={};e["0_"+a.toLowerCase()]=b;return e}return 1==f?c.ROTARY_HANDLE_TRANSCEIVER.parseDptState(a,b):e};var z=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType=
"ip_blind"};util.inherits(z,h);z.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"],c=b.MAINTENANCE.getReadableDpts();c&&c.forEach(function(b){"UNREACH"==b&&f.push({channel:a.deviceAdr+":0",dpt:b})});(c=b.SHUTTER_TRANSMITTER.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+":3",dpt:b})});(c=b.SHUTTER_VIRTUAL_RECEIVER.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+":4",dpt:b});f.push({channel:a.deviceAdr+":5",dpt:b});f.push({channel:a.deviceAdr+
":6",dpt:b})});return f};z.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null},c=x.hub.m.hm._Channel["HmIP-RF"];switch(f){case "timeout":b.channel=a+":0";b.dataPoint=c.MAINTENANCE.getDptFromState(f);break;case "blindLevel":b.channel=a+":3";b.dataPoint=c.SHUTTER_TRANSMITTER.getDptFromState("blindTLevel");break;case "ch4Level":b.channel=a+":4";b.dataPoint=c.SHUTTER_VIRTUAL_RECEIVER.getDptFromState("blindLevel");break;case "ch5Level":b.channel=a+":5";
b.dataPoint=c.SHUTTER_VIRTUAL_RECEIVER.getDptFromState("blindLevel");break;case "ch6Level":b.channel=a+":6";b.dataPoint=c.SHUTTER_VIRTUAL_RECEIVER.getDptFromState("blindLevel");break;default:return null}return b};z.prototype.executeCommand=function(f,a,b){var c=null,e=x.hub.m.hm._Channel["HmIP-RF"],g=a;if(-1!=a.indexOf("stepUp")){var h=a.indexOf("stepUp");g=a.substr(0,h+6);var k=a.substr(h+6)}else-1!=a.indexOf("stepDown")?(h=a.indexOf("stepDown"),g=a.substr(0,h+8),k=a.substr(h+8)):-1!=a.indexOf("moveTo")?
...
this.deviceIF,this.deviceAdr+":4","moveUp",function(a,c){a?b&&b(a,c):e.SHUTTER_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":5","moveTo0",function(a,c){a?b&&b(a,c):e.SHUTTER_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":6","moveTo0",b)})});break;case "moveDown":e.SHUTTER_VIRTUAL_RECEIVER.executeCommand(f,this.deviceIF,this.deviceAdr+":4","moveDown",function(a,c){a?b&&b(a,c):e.SHUTTER_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":5","moveTo0",function(a,c){a?
...
l.deviceIF,l.deviceAdr+":5","moveTo0",function(a,c){a?b&&b(a,c):e.SHUTTER_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":6","moveTo0",function(a,c){a?b&&b(a,c):(c=k/100,1<c&&(c=1),0>c&&(c=0),f.updateStatusBuffer(l.deviceIF,l.deviceAdr+":3","LEVEL",c,(new Date).getTime()+1E3),b&&b(a))})})}))});break;case "stepDown":k=k?parseInt(k)/100:.05;f.getState({interface:this.deviceIF,channel:this.deviceAdr+":3",datapoint:"LEVEL"},function(a,c){a?b&&b(a):"undefined"==typeof c||null==c?b&&b(Error("get blind current value return invalid")):
(k=c.value-k,0>k&&(k=0),k=Math.round(100*k),e.SHUTTER_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":4","moveTo"+k,function(a,c){a?b&&b(a,c):e.SHUTTER_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":5","moveTo0",function(a,c){a?b&&b(a,c):e.SHUTTER_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":6","moveTo0",function(a,c){a?b&&b(a,c):(c=k/100,1<c&&(c=1),0>c&&(c=0),f.updateStatusBuffer(l.deviceIF,l.deviceAdr+":3","LEVEL",c,(new Date).getTime()+1E3),b&&b(a))})})}))});
break;case "moveTo":if(!k){b&&b(Error("moveTo has no value"));break}e.SHUTTER_VIRTUAL_RECEIVER.executeCommand(f,this.deviceIF,this.deviceAdr+":4","moveTo"+k,function(a,c){a?b&&b(a,c):e.SHUTTER_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":5","moveTo0",function(a,c){a?b&&b(a,c):e.SHUTTER_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":6","moveTo0",function(a,c){a?b&&b(a,c):(c=k/100,1<c&&(c=1),0>c&&(c=0),f.updateStatusBuffer(l.deviceIF,l.deviceAdr+":3","LEVEL",c,(new Date).getTime()+
...
e.REFERENCE_RUNNING_TIME_TOP_BOTTOM_VALUE={__rpcValueType:"double",__rpcValue:a.REFERENCE_RUNNING_TIME_TOP_BOTTOM_VALUE};f.setParamset(this.deviceIF,c,"MASTER",e,function(a){b&&b(a)})}else b&&b(Error("config data not complete"))}else b&&b(Error("config data invalid"))};z.prototype.isButton=function(){return!0};z.prototype.claimEvent=function(f,a){var b=this.deviceAdr;-1==b.indexOf(":")&&this.channel&&(b+=":"+this.channel);var c=this;this._claimButtonEvent(1,f,function(){c._claimButtonEvent(2,f,function(){a&&
a()})})};z.prototype._claimButtonEvent=function(f,a,b){var c=this;a.reportValueUsage(this.deviceIF,this.deviceAdr+":"+f,"PRESS_SHORT",function(e,g){e&&console.error("button:"+f+" claim PRESS_SHORT event error:"+e.stack);a.reportValueUsage(c.deviceIF,c.deviceAdr+":"+f,"PRESS_LONG",function(a,c){a&&console.error("button:"+f+" claim PRESS_LONG event error:"+a.stack);b&&b()})})};var A=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_jalousie"};util.inherits(A,h);A.prototype._getReadableDpts=
function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"],c=b.MAINTENANCE.getReadableDpts();c&&c.forEach(function(b){"UNREACH"==b&&f.push({channel:a.deviceAdr+":0",dpt:b})});(c=b.BLIND_TRANSMITTER.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+":3",dpt:b})});(c=b.BLIND_VIRTUAL_RECEIVER.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+":4",dpt:b});f.push({channel:a.deviceAdr+":5",dpt:b});f.push({channel:a.deviceAdr+":6",dpt:b})});return f};A.prototype._getDptFromRef=
...
c.BLIND_VIRTUAL_RECEIVER.getDptFromState("lamellaPos");break;default:return null}return b};A.prototype.executeCommand=function(f,a,b){var c=null,e=x.hub.m.hm._Channel["HmIP-RF"],g=a;if(-1!=a.indexOf("stepUp")){var h=a.indexOf("stepUp");g=a.substr(0,h+6);var k=a.substr(h+6)}else-1!=a.indexOf("stepDown")?(h=a.indexOf("stepDown"),g=a.substr(0,h+8),k=a.substr(h+8)):-1!=a.indexOf("moveTo")?(h=a.indexOf("moveTo"),g=a.substr(0,h+6),k=a.substr(h+6)):-1!=a.indexOf("stop")?(h=a.indexOf("stop"),g=a.substr(0,
h+4),k=a.substr(h+4)):-1!=a.indexOf("lamellaStepUp")?(h=a.indexOf("lamellaStepUp"),g=a.substr(0,h+13),k=a.substr(h+13)):-1!=a.indexOf("lamellaStepDown")?(h=a.indexOf("lamellaStepDown"),g=a.substr(0,h+15),k=a.substr(h+15)):-1!=a.indexOf("lamellaTo")&&(h=a.indexOf("lamellaTo"),g=a.substr(0,h+9),k=a.substr(h+9));var l=this;switch(g){case "stop":case "moveUp":case "moveDown":e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,this.deviceIF,this.deviceAdr+":4",g,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,
l.deviceIF,l.deviceAdr+":5",g,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":6",g,b)})});break;case "lamellaUp":case "lamellaDown":f.getState({interface:this.deviceIF,channel:this.deviceAdr+":3",datapoint:"LEVEL"},function(a,c){a?b&&b(a):"undefined"==typeof c||null==c?b&&b(Error("get blind current value return invalid")):(k=c.value,k=Math.round(100*k),e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":4",g,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,
l.deviceIF,l.deviceAdr+":4","moveTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":5",g,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":5","moveTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":6",g,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":6","moveTo"+k,function(a,c){b&&b(a,c)})})})})})}))});break;case "stepUp":k=
k?parseInt(k)/100:.05;f.getState({interface:this.deviceIF,channel:this.deviceAdr+":3",datapoint:"LEVEL"},function(a,c){a?b&&b(a):"undefined"==typeof c||null==c?b&&b(Error("get blind current value return invalid")):(k=c.value+k,1<k&&(k=1),k=Math.round(100*k),e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":4","moveTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":5","moveTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,
l.deviceIF,l.deviceAdr+":6","moveTo"+k,function(a,c){a?b&&b(a,c):(c=k/100,1<c&&(c=1),0>c&&(c=0),f.updateStatusBuffer(l.deviceIF,l.deviceAdr+":3","LEVEL",c,(new Date).getTime()+1E3),b&&b(a))})})}))});break;case "stepDown":k=k?parseInt(k)/100:.05;f.getState({interface:this.deviceIF,channel:this.deviceAdr+":3",datapoint:"LEVEL"},function(a,c){a?b&&b(a):"undefined"==typeof c||null==c?b&&b(Error("get blind current value return invalid")):(k=c.value-k,0>k&&(k=0),k=Math.round(100*k),e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,
l.deviceIF,l.deviceAdr+":4","moveTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":5","moveTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":6","moveTo"+k,function(a,c){a?b&&b(a,c):(c=k/100,1<c&&(c=1),0>c&&(c=0),f.updateStatusBuffer(l.deviceIF,l.deviceAdr+":3","LEVEL",c,(new Date).getTime()+1E3),b&&b(a))})})}))});break;case "moveTo":if(!k){b&&b(Error("moveTo has no value"));break}e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,
this.deviceIF,this.deviceAdr+":4","moveTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":5","moveTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":6","moveTo"+k,function(a,c){a?b&&b(a,c):(c=k/100,1<c&&(c=1),0>c&&(c=0),f.updateStatusBuffer(l.deviceIF,l.deviceAdr+":3","LEVEL",c,(new Date).getTime()+1E3),b&&b(a))})})});break;case "lamellaStepUp":k=k?parseInt(k)/100:.05;f.getState({interface:this.deviceIF,
channel:this.deviceAdr+":3",datapoint:"LEVEL"},function(a,c){if(a)b&&b(a);else if("undefined"==typeof c||null==c)b&&b(Error("get blind current value return invalid"));else{var g=c.value;g=Math.round(100*g);f.getState({interface:l.deviceIF,channel:l.deviceAdr+":3",datapoint:"LEVEL_2"},function(a,c){a?b&&b(a):"undefined"==typeof c||null==c?b&&b(Error("get lamella current value return invalid")):(k=c.value+k,1<k&&(k=1),k=Math.round(100*k),e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+
":4","lamellaTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":4","moveTo"+g,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":5","lamellaTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":5","moveTo"+g,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":6","lamellaTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,
l.deviceIF,l.deviceAdr+":6","moveTo"+g,function(a,c){a?b&&b(a,c):(c=k/100,1<c&&(c=1),0>c&&(c=0),f.updateStatusBuffer(l.deviceIF,l.deviceAdr+":3","LEVEL_2",c,(new Date).getTime()+1E3),b&&b(a))})})})})})}))})}});break;case "lamellaStepDown":k=k?parseInt(k)/100:.05;f.getState({interface:this.deviceIF,channel:this.deviceAdr+":3",datapoint:"LEVEL"},function(a,c){if(a)b&&b(a);else if("undefined"==typeof c||null==c)b&&b(Error("get blind current value return invalid"));else{var g=c.value;g=Math.round(100*
g);f.getState({interface:l.deviceIF,channel:l.deviceAdr+":3",datapoint:"LEVEL_2"},function(a,c){a?b&&b(a):"undefined"==typeof c||null==c?b&&b(Error("get lamella current value return invalid")):(k=c.value-k,0>k&&(k=0),k=Math.round(100*k),e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":4","lamellaTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":4","moveTo"+g,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,
l.deviceAdr+":5","lamellaTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":5","moveTo"+g,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":6","lamellaTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":6","moveTo"+g,function(a,c){a?b&&b(a,c):(c=k/100,1<c&&(c=1),0>c&&(c=0),f.updateStatusBuffer(l.deviceIF,l.deviceAdr+":3","LEVEL_2",c,(new Date).getTime()+1E3),b&&
b(a))})})})})})}))})}});break;case "lamellaTo":if(!k){b&&b(Error("lamellaTo has no value"));break}f.getState({interface:this.deviceIF,channel:this.deviceAdr+":3",datapoint:"LEVEL"},function(a,c){if(a)b&&b(a);else if("undefined"==typeof c||null==c)b&&b(Error("get blind current value return invalid"));else{var g=c.value;g=Math.round(100*g);e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":4","lamellaTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,
l.deviceAdr+":4","moveTo"+g,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":5","lamellaTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":5","moveTo"+g,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":6","lamellaTo"+k,function(a,c){a?b&&b(a,c):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,l.deviceAdr+":6","moveTo"+g,function(a,c){a?b&&b(a,c):(c=k/100,1<c&&
(c=1),0>c&&(c=0),f.updateStatusBuffer(l.deviceIF,l.deviceAdr+":3","LEVEL_2",c,(new Date).getTime()+1E3),b&&b(a))})})})})})})}});break;case "ch4stop":case "ch5stop":case "ch6stop":switch(g){case "ch4stop":c=this.deviceAdr+":4";break;case "ch5stop":c=this.deviceAdr+":5";break;case "ch6stop":c=this.deviceAdr+":6"}e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,this.deviceIF,c,"stop",b);break;case "ch4moveUp":case "ch5moveUp":case "ch6moveUp":switch(g){case "ch4moveUp":c=this.deviceAdr+":4";break;case "ch5moveUp":c=
this.deviceAdr+":5";break;case "ch6moveUp":c=this.deviceAdr+":6"}e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,this.deviceIF,c,"moveUp",b);break;case "ch4moveDown":case "ch5moveDown":case "ch6moveDown":switch(g){case "ch4moveDown":c=this.deviceAdr+":4";break;case "ch5moveDown":c=this.deviceAdr+":5";break;case "ch6moveDown":c=this.deviceAdr+":6"}e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,this.deviceIF,c,"moveDown",b);break;case "ch4lamellaUp":case "ch5lamellaUp":case "ch6lamellaUp":switch(g){case "ch4lamellaUp":c=
this.deviceAdr+":4";break;case "ch5lamellaUp":c=this.deviceAdr+":5";break;case "ch6lamellaUp":c=this.deviceAdr+":6"}f.getState({interface:this.deviceIF,channel:c,datapoint:"LEVEL"},function(a,g){if(a)b&&b(a);else if("undefined"==typeof g||null==g)b&&b(Error("get blind current value return invalid"));else{var k=g.value;k=Math.round(100*k);e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,c,"lamellaUp",function(a,g){a?b&&b(a):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,c,"moveTo"+k,function(a,
c){b&&b(a,c)})})}});break;case "ch4lamellaDown":case "ch5lamellaDown":case "ch6lamellaDown":switch(g){case "ch4lamellaDown":c=this.deviceAdr+":4";break;case "ch5lamellaDown":c=this.deviceAdr+":5";break;case "ch6lamellaDown":c=this.deviceAdr+":6"}f.getState({interface:this.deviceIF,channel:c,datapoint:"LEVEL"},function(a,g){if(a)b&&b(a);else if("undefined"==typeof g||null==g)b&&b(Error("get blind current value return invalid"));else{var k=g.value;k=Math.round(100*k);e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,
l.deviceIF,c,"lamellaDown",function(a,g){a?b&&b(a):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,c,"moveTo"+k,function(a,c){b&&b(a,c)})})}});break;case "ch4stepUp":case "ch5stepUp":case "ch6stepUp":switch(g){case "ch4stepUp":c=this.deviceAdr+":4";break;case "ch5stepUp":c=this.deviceAdr+":5";break;case "ch6stepUp":c=this.deviceAdr+":6"}e.SHUTTER_VIRTUAL_RECEIVER.executeCommand(f,this.deviceIF,c,"stepUp"+k,b);break;case "ch4stepDown":case "ch5stepDown":case "ch6stepDown":switch(g){case "ch4stepDown":c=
this.deviceAdr+":4";break;case "ch5stepDown":c=this.deviceAdr+":5";break;case "ch6stepDown":c=this.deviceAdr+":6"}e.SHUTTER_VIRTUAL_RECEIVER.executeCommand(f,this.deviceIF,c,"stepDown"+k,b);break;case "ch4lamellaStepUp":case "ch5lamellaStepUp":case "ch6lamellaStepUp":switch(g){case "ch4lamellaStepUp":c=this.deviceAdr+":4";break;case "ch5lamellaStepUp":c=this.deviceAdr+":5";break;case "ch6lamellaStepUp":c=this.deviceAdr+":6"}f.getState({interface:this.deviceIF,channel:c,datapoint:"LEVEL"},function(a,
g){if(a)b&&b(a);else if("undefined"==typeof g||null==g)b&&b(Error("get blind current value return invalid"));else{var h=g.value;h=Math.round(100*h);e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,c,"lamellaStepUp"+k,function(a,g){a?b&&b(a):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,c,"moveTo"+h,function(a,c){b&&b(a,c)})})}});break;case "ch4lamellaStepDown":case "ch5lamellaStepDown":case "ch6lamellaStepDown":switch(g){case "ch4lamellaStepDown":c=this.deviceAdr+":4";break;case "ch5lamellaStepDown":c=
this.deviceAdr+":5";break;case "ch6lamellaStepDown":c=this.deviceAdr+":6"}f.getState({interface:this.deviceIF,channel:c,datapoint:"LEVEL"},function(a,g){if(a)b&&b(a);else if("undefined"==typeof g||null==g)b&&b(Error("get blind current value return invalid"));else{var h=g.value;h=Math.round(100*h);e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,c,"lamellaStepDown"+k,function(a,g){a?b&&b(a):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,c,"moveTo"+h,function(a,c){b&&b(a,c)})})}});break;case "ch4moveTo":case "ch5moveTo":case "ch6moveTo":switch(g){case "ch4moveTo":c=
this.deviceAdr+":4";break;case "ch5moveTo":c=this.deviceAdr+":5";break;case "ch6moveTo":c=this.deviceAdr+":6"}e.SHUTTER_VIRTUAL_RECEIVER.executeCommand(f,this.deviceIF,c,"moveTo"+k,b);break;case "ch4lamellaTo":case "ch5lamellaTo":case "ch6lamellaTo":switch(g){case "ch4lamellaTo":c=this.deviceAdr+":4";break;case "ch5lamellaTo":c=this.deviceAdr+":5";break;case "ch6lamellaTo":c=this.deviceAdr+":6"}f.getState({interface:this.deviceIF,channel:c,datapoint:"LEVEL"},function(a,g){if(a)b&&b(a);else if("undefined"==
typeof g||null==g)b&&b(Error("get blind current value return invalid"));else{var h=g.value;h=Math.round(100*h);e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,c,"lamellaTo"+k,function(a,g){a?b&&b(a):e.BLIND_VIRTUAL_RECEIVER.executeCommand(f,l.deviceIF,c,"moveTo"+h,function(a,c){b&&b(a,c)})})}});break;default:b&&b(Error("no such command"))}};A.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");
-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;e=x.hub.m.hm._Channel["HmIP-RF"];c=null;if(0==f){if("UNREACH"==a)return e.MAINTENANCE.parseDptState(a,b);c={};c["0_"+a.toLowerCase()]=b;return c}if(3==f){if(b=e.BLIND_TRANSMITTER.parseDptState(a,b))c={},"LEVEL"==a?c.blindLevel=b.blindTPos:"LEVEL_2"==a&&(c.lamellaLevel=b.lamellaTPos);return c}if(4==f||5==f||6==f){if(b=e.BLIND_VIRTUAL_RECEIVER.parseDptState(a,b))switch(c={},parseInt(f)){case 4:"LEVEL"==a?c.ch4blindLevel=b.blindPos:"LEVEL_2"==
a&&(c.ch4lamellaLevel=b.lamellaPos);break;case 5:"LEVEL"==a?c.ch5blindLevel=b.blindPos:"LEVEL_2"==a&&(c.ch5lamellaLevel=b.lamellaPos);break;case 6:"LEVEL"==a?c.ch6blindLevel=b.blindPos:"LEVEL_2"==a&&(c.ch6lamellaLevel=b.lamellaPos)}return c}return null};A.prototype.getConfig=function(f,a){var b=this.deviceAdr+":3";f.getParamset(this.deviceIF,b,"MASTER",function(c,f){if(c)a&&a(c);else{var e={},g=null;f&&(g={CHANGE_OVER_DELAY:f.CHANGE_OVER_DELAY,REFERENCE_RUNNING_TIME_BOTTOM_TOP_UNIT:f.REFERENCE_RUNNING_TIME_BOTTOM_TOP_UNIT,
REFERENCE_RUNNING_TIME_BOTTOM_TOP_VALUE:f.REFERENCE_RUNNING_TIME_BOTTOM_TOP_VALUE,REFERENCE_RUNNING_TIME_TOP_BOTTOM_UNIT:f.REFERENCE_RUNNING_TIME_TOP_BOTTOM_UNIT,REFERENCE_RUNNING_TIME_TOP_BOTTOM_VALUE:f.REFERENCE_RUNNING_TIME_TOP_BOTTOM_VALUE,REFERENCE_RUNNING_TIME_SLATS_UNIT:f.REFERENCE_RUNNING_TIME_SLATS_UNIT,REFERENCE_RUNNING_TIME_SLATS_VALUE:f.REFERENCE_RUNNING_TIME_SLATS_VALUE,REFERENCE_RUN_COUNTER:f.REFERENCE_RUN_COUNTER});e[b]=g;a&&a(c,e)}})};A.prototype.setConfig=function(f,a,b){if(a){var c=
this.deviceAdr+":3";if(a=a[c]){var e={};e.CHANGE_OVER_DELAY={__rpcValueType:"double",__rpcValue:a.CHANGE_OVER_DELAY};e.REFERENCE_RUN_COUNTER=a.REFERENCE_RUN_COUNTER;e.REFERENCE_RUNNING_TIME_BOTTOM_TOP_UNIT={__rpcValueType:"double",__rpcValue:a.REFERENCE_RUNNING_TIME_BOTTOM_TOP_UNIT};e.REFERENCE_RUNNING_TIME_BOTTOM_TOP_VALUE={__rpcValueType:"double",__rpcValue:a.REFERENCE_RUNNING_TIME_BOTTOM_TOP_VALUE};e.REFERENCE_RUNNING_TIME_TOP_BOTTOM_UNIT={__rpcValueType:"double",__rpcValue:a.REFERENCE_RUNNING_TIME_TOP_BOTTOM_UNIT};
e.REFERENCE_RUNNING_TIME_TOP_BOTTOM_VALUE={__rpcValueType:"double",__rpcValue:a.REFERENCE_RUNNING_TIME_TOP_BOTTOM_VALUE};e.REFERENCE_RUNNING_TIME_SLATS_UNIT={__rpcValueType:"double",__rpcValue:a.REFERENCE_RUNNING_TIME_SLATS_UNIT};e.REFERENCE_RUNNING_TIME_SLATS_VALUE={__rpcValueType:"double",__rpcValue:a.REFERENCE_RUNNING_TIME_SLATS_VALUE};f.setParamset(this.deviceIF,c,"MASTER",e,function(a){b&&b(a)})}else b&&b(Error("config data not complete"))}else b&&b(Error("config data invalid"))};A.prototype.isButton=
function(){return!0};A.prototype.claimEvent=function(f,a){var b=this.deviceAdr;-1==b.indexOf(":")&&this.channel&&(b+=":"+this.channel);var c=this;this._claimButtonEvent(1,f,function(){c._claimButtonEvent(2,f,function(){a&&a()})})};A.prototype._claimButtonEvent=function(f,a,b){var c=this;a.reportValueUsage(this.deviceIF,this.deviceAdr+":"+f,"PRESS_SHORT",function(e,g){e&&console.error("button:"+f+" claim PRESS_SHORT event error:"+e.stack);a.reportValueUsage(c.deviceIF,c.deviceAdr+":"+f,"PRESS_LONG",
function(a,c){a&&console.error("button:"+f+" claim PRESS_LONG event error:"+a.stack);b&&b()})})};var ka=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_presence"};util.inherits(ka,h);ka.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"],c=b.MAINTENANCE_BAT_EL.getReadableDpts();c&&c.forEach(function(b){f.push({channel:a.deviceAdr+":0",dpt:b})});(c=b.PRESENCEDETECTOR_TRANSCEIVER.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+
...
a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;c=x.hub.m.hm._Channel["HmIP-RF"];return f==this.channel?c.CLIMATECONTROL_FLOOR_TRANSCEIVER.parseDptState(a,b):null};var Ea=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_floor_pump_heater"};util.inherits(Ea,h);Ea.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"].CLIMATECONTROL_FLOOR_PUMP_TRANSCEIVER.getReadableDpts();
...
b):null};var Ia=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_weather4"};util.inherits(Ia,h);Ia.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"],c=b.MAINTENANCE_BAT_CL.getReadableDpts();c&&c.forEach(function(b){f.push({channel:a.deviceAdr+":0",dpt:b})});(c=b.WEATHER_TRANSMIT.getReadableDpts())&&c.forEach(function(b){-1==b.indexOf("WIND_DIR")&&f.push({channel:a.deviceAdr+":1",dpt:b})});return f};Ia.prototype._getDptFromRef=function(f){var a=
...
c));if(e!=g)return null;c=x.hub.m.hm._Channel["HmIP-RF"];if(0==f){if("UNREACH"==a||"LOW_BAT"==a)return c.MAINTENANCE_BAT_CL.parseDptState(a,b);c={};c["0_"+a.toLowerCase()]=b;return c}return 1==f?c.WEATHER_TRANSMIT.parseDptState(a,b):null};var la=function(f,a,b){h.call(this,f,a,b);this.channel=2;this.legacyType="ip_direction"};util.inherits(la,h);la.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"],c=b.MAINTENANCE_BAT_EL.getReadableDpts();c&&c.forEach(function(b){f.push({channel:a.deviceAdr+
...
-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;e=x.hub.m.hm._Channel["HmIP-RF"];c=null;if(0==f){if("UNREACH"==a||"LOW_BAT"==a)return e.MAINTENANCE_BAT_EL.parseDptState(a,b);c={};c["0_"+a.toLowerCase()]=b;return c}if(2==f){if(a=e.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.parseDptState(a,b))c={},"undefined"!=typeof a.current_direction&&(c.current_passage_r2l=a.current_direction),"undefined"!=typeof a.last_direction&&(c.last_passage_r2l=a.last_direction),"undefined"!=typeof a.passage_counter&&
...
{value:"right_to_left",time:a.last_passage_r2l.time}:{value:"left_to_right",time:a.last_passage_l2r.time});delete a.current_passage_r2l;delete a.current_passage_l2r;delete a.last_passage_r2l;delete a.last_passage_l2r;return a};var N=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_button8"};util.inherits(N,h);N.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"].MAINTENANCE_BAT_EL.getReadableDpts();b&&b.forEach(function(b){"SABOTAGE"!=b&&f.push({channel:a.deviceAdr+
":0",dpt:b})});return f};N.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null},c=x.hub.m.hm._Channel["HmIP-RF"];switch(f){case "timeout":case "lowbat":b.channel=a+":0";b.dataPoint=c.MAINTENANCE_BAT_EL.getDptFromState(f);break;default:return null}return b};N.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,
c));if(e!=g)return null;e=x.hub.m.hm._Channel["HmIP-RF"];c=null;if(0==f){if("UNREACH"==a||"LOW_BAT"==a)return e.MAINTENANCE_BAT_EL.parseDptState(a,b);c={};c["0_"+a.toLowerCase()]=b;return c}if(1==f||2==f||3==f||4==f||5==f||6==f||7==f||8==f)if(a=e.KEY_TRANRECEIVER.parseDptState(a,b))c||(c={}),a.pressShort&&(c["btn"+f+"pressShort"]=!0),a.pressLong&&(c["btn"+f+"pressLong"]=!0);return c};N.prototype.isButton=function(){return!0};N.prototype.claimEvent=function(f,a){var b=this.deviceAdr;-1==b.indexOf(":")&&
this.channel&&(b+=":"+this.channel);var c=this;this._claimButtonEvent(1,f,function(){c._claimButtonEvent(2,f,function(){c._claimButtonEvent(3,f,function(){c._claimButtonEvent(4,f,function(){c._claimButtonEvent(5,f,function(){c._claimButtonEvent(6,f,function(){c._claimButtonEvent(7,f,function(){c._claimButtonEvent(8,f,function(){a&&a()})})})})})})})})};N.prototype._claimButtonEvent=function(f,a,b){var c=this;a.reportValueUsage(this.deviceIF,this.deviceAdr+":"+f,"PRESS_SHORT",function(e,g){e&&console.error("button:"+
f+" claim PRESS_SHORT event error:"+e.stack);a.reportValueUsage(c.deviceIF,c.deviceAdr+":"+f,"PRESS_LONG",function(a,c){a&&console.error("button:"+f+" claim PRESS_LONG event error:"+a.stack);b&&b()})})};var Ja=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_generic_input"};util.inherits(Ja,h);Ja.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"].GENERIC_INPUT_TRANSMITER.getReadableDpts();b&&b.forEach(function(b){f.push({channel:a.deviceAdr+
":"+a.channel,dpt:b})});return f};Ja.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null},c=x.hub.m.hm._Channel["HmIP-RF"];b.channel=a+":"+this.channel;f=c.GENERIC_INPUT_TRANSMITER.getDptFromState(f);if(!f)return null;b.dataPoint=f;return b};Ja.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));
if(e!=g)return null;c=x.hub.m.hm._Channel["HmIP-RF"];return f==this.channel?c.GENERIC_INPUT_TRANSMITER.parseDptState(a,b):null};var ma=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_analog_output"};util.inherits(ma,h);ma.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"].ANALOG_OUTPUT_TRANSCEIVER.getReadableDpts();b&&b.forEach(function(b){f.push({channel:a.deviceAdr+":"+a.channel,dpt:b})});return f};ma.prototype._getDptFromRef=function(f){var a=
...
f.indexOf(":");if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;c=x.hub.m.hm._Channel["HmIP-RF"];e=null;f==this.channel&&(e=c.ANALOG_OUTPUT_TRANSCEIVER.parseDptState(a,b));return e};var Ka=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_water"};util.inherits(Ka,h);Ka.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"],c=b.MAINTENANCE_BAT_CL.getReadableDpts();
...
b;return c}return 1==f?c.WATER_DETECTION_TRANSMITTER.parseDptState(a,b):null};var La=function(f,a,b){h.call(this,f,a,b);this.channel=1;this.legacyType="ip_acce"};util.inherits(La,h);La.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"],c=b.MAINTENANCE_BAT_EL.getReadableDpts();c&&c.forEach(function(b){"SABOTAGE"!=b&&f.push({channel:a.deviceAdr+":0",dpt:b})});(c=b.ACCELERATION_TRANSCEIVER.getReadableDpts())&&c.forEach(function(b){f.push({channel:a.deviceAdr+":1",
...
if(-1==c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;c=x.hub.m.hm._Channel["HmIP-RF"];if(0==f){if("UNREACH"==a||"LOW_BAT"==a||"OPERATING_VOLTAGE"==a||"ERROR_CODE"==a||"SENSOR_ERROR"==a)return c.MAINTENANCE_BAT_EL.parseDptState(a,b);c={};c["0_"+a.toLowerCase()]=b;return c}return 1==f?c.ACCELERATION_TRANSCEIVER.parseDptState(a,b):null};var E=function(f,a,b){h.call(this,f,a,b);this.channel=
1;this.legacyType="ip_garagedoor"};util.inherits(E,h);E.prototype._getReadableDpts=function(){var f=[],a=this,b=x.hub.m.hm._Channel["HmIP-RF"].MAINTENANCE_BAT_EL.getReadableDpts();b&&b.forEach(function(b){"SABOTAGE"!=b&&f.push({channel:a.deviceAdr+":0",dpt:b})});return f};E.prototype._getDptFromRef=function(f){var a=this.deviceAdr,b={channel:a+":"+this.channel,dataPoint:null},c=x.hub.m.hm._Channel["HmIP-RF"];switch(f){case "timeout":case "lowbat":case "voltage":case "errorCode":b.channel=a+":0";b.dataPoint=
c.MAINTENANCE_BAT_EL.getDptFromState(f);break;default:return null}return b};E.prototype.executeCommand=function(f,a,b){var c=x.hub.m.hm._Channel["HmIP-RF"];switch(a){case "on":var e=this.deviceAdr+":3";c.SWITCH_VIRTUAL_RECEIVER.executeCommand(f,this.deviceIF,e,"onFor0.5",b);break;default:"onFor"==a.substr(0,5)?(e=this.deviceAdr+":3",c.SWITCH_VIRTUAL_RECEIVER.executeCommand(f,this.deviceIF,e,a,b)):b&&b(Error("no such command"))}};E.prototype.parseDptState=function(f,a,b){var c=f.indexOf(":");if(-1==
c)return null;var e=f.substr(0,c);f=f.substr(c+1);var g=this.deviceAdr;c=this.deviceAdr.indexOf(":");-1!=c&&(g=this.deviceAdr.substr(0,c));if(e!=g)return null;e=x.hub.m.hm._Channel["HmIP-RF"];c=null;if(0==f){if("UNREACH"==a||"LOW_BAT"==a||"OPERATING_VOLTAGE"==a||"ERROR_CODE"==a)return e.MAINTENANCE_BAT_EL.parseDptState(a,b);c={};c["0_"+a.toLowerCase()]=b;return c}if(1==f){if(a=e.KEY_TRANRECEIVER.parseDptState(a,b))c||(c={}),a.pressShort&&(c.btnPressShort=!0),a.pressLong&&(c.btnPressLong=!0);return c}return null};
E.prototype.isButton=function(){return!0};E.prototype.claimEvent=function(f,a){this._claimButtonEvent(1,f,function(){a&&a()})};E.prototype._claimButtonEvent=function(f,a,b){var c=this;a.reportValueUsage(this.deviceIF,this.deviceAdr+":"+f,"PRESS_SHORT",function(e,g){e&&console.error("button:"+f+" claim PRESS_SHORT event error:"+e.stack);a.reportValueUsage(c.deviceIF,c.deviceAdr+":"+f,"PRESS_LONG",function(a,c){a&&console.error("button:"+f+" claim PRESS_LONG event error:"+a.stack);b&&b()})})};var Ta=
function(){var f=function(a,b,c){h.call(this,a,b,c);this._chMaintenance=0;this._chKeyTransceiver1=1;this._chKeyTransceiver2=2;this._chSwitchTransmitter3=3;this._chSwitchVirtualReceiver4=4;this._chDimmerTransmitter7=7;this._chDimmerVirtualReceiver8=8;this._chDimmerTransmitter11=11;this._chDimmerVirtualReceiver12=12;this._chDimmerWeekProfile=15;this.legacyType="ip_bsl"};util.inherits(f,h);f.prototype._getReadableDpts=function(){return[{channel:this.deviceAdr+":"+this._chMaintenance,dpt:"UNREACH"},{channel:this.deviceAdr+
...
this._chSwitchTransmitter3;b.dataPoint="STATE";break;case "led1Level":b.channel+=this._chDimmerTransmitter7;b.dataPoint="LEVEL";break;case "led1Color":b.channel+=this._chDimmerTransmitter7;b.dataPoint="COLOR";break;case "led2Level":b.channel+=this._chDimmerTransmitter11;b.dataPoint="LEVEL";break;case "led2Color":b.channel+=this._chDimmerTransmitter11;b.dataPoint="COLOR";break;default:return null}return b};f.prototype.executeCommand=function(a,b,c){var f=x.hub.m.hm._Channel["HmIP-RF"],e=this.getSerial();
var g=b;if(-1!=b.indexOf("dimUp")){var k=b.indexOf("dimUp");g=b.substr(0,k+5);k=b.substr(k)}else-1!=b.indexOf("dimDown")?(k=b.indexOf("dimDown"),g=b.substr(0,k+7),k=b.substr(k)):-1!=b.indexOf("dimTo")?(k=b.indexOf("dimTo"),g=b.substr(0,k+5),k=b.substr(k)):-1!=b.indexOf("toggleTo")?(k=b.indexOf("toggleTo"),g=b.substr(0,k+8),k=b.substr(k)):-1!=b.indexOf("colorTo")&&(k=b.indexOf("colorTo"),g=b.substr(0,k+7),k=b.substr(k));switch(g){case "on":case "off":case "toggle":b=e+":"+this._chSwitchVirtualReceiver4;
f.SWITCH_VIRTUAL_RECEIVER.executeCommand(a,this.deviceIF,b,g,c);break;case "led1on":case "led1off":case "led1dimUp":case "led1dimDown":case "led1dimTo":case "led1toggleTo":case "led1colorTo":case "led2on":case "led2off":case "led2dimUp":case "led2dimDown":case "led2dimTo":case "led2toggleTo":case "led2colorTo":b="led1"==g.substr(0,4)?e+":"+this._chDimmerVirtualReceiver12:e+":"+this._chDimmerVirtualReceiver8;"led1on"==g?k="dimTo100":"led1off"==g?k="dimOff":"led2on"==g?k="dimTo100":"led2off"==g&&(k=
"dimOff");f.DIMMER_VIRTUAL_RECEIVER.executeCommand(a,this.deviceIF,b,k,c);break;default:"onFor"==g.substr(0,5)?(b=e+":"+this._chSwitchVirtualReceiver4,f.SWITCH_VIRTUAL_RECEIVER.executeCommand(a,this.deviceIF,b,g,c)):c&&c(Error("no such command"))}};f.prototype.parseDptState=function(a,b,c){var f=a.indexOf(":");if(-1==f)return null;var e=a.substr(0,f);a=a.substr(f+1);f=this.getSerial();if(e!=f)return null;e=x.hub.m.hm._Channel["HmIP-RF"];switch(parseInt(a)){case this._chMaintenance:switch(b){case "UNREACH":return e.MAINTENANCE.parseDptState(b,
c);default:var g={};g["0_"+b.toLowerCase()]=c;return g}case this._chKeyTransceiver1:case this._chKeyTransceiver2:if(c=e.KEY_TRANRECEIVER.parseDptState(b,c))g||(g={}),c.pressShort&&(g["btn"+a+"pressShort"]=!0),c.pressLong&&(g["btn"+a+"pressLong"]=!0);return g;case this._chSwitchTransmitter3:switch(b){case "STATE":if(c=e.SWITCH_TRANSMITTER.parseDptState(b,c))g={},g.state=c.switchTState;return g;default:return null}case this._chDimmerTransmitter7:if(c=e.DIMMER_TRANSMITTER.parseDptState(b,c))g={},"LEVEL"==
b?g.led2Level=c.dimmerTLevel:"COLOR"==b&&(g.led2Color=c.dimmerTColor);return g;case this._chDimmerTransmitter11:if(c=e.DIMMER_TRANSMITTER.parseDptState(b,c))g={},"LEVEL"==b?g.led1Level=c.dimmerTLevel:"COLOR"==b&&(g.led1Color=c.dimmerTColor);return g;default:return null}};f.prototype.isButton=function(){return!0};f.prototype.claimEvent=function(a,b){var c=this.getSerial(),f=this;a.reportValueUsage(this.deviceIF,c+":"+this._chKeyTransceiver1,"PRESS_SHORT",function(e,g){e&&console.error("button:1 claim PRESS_SHORT event error:"+
e.stack);a.reportValueUsage(f.deviceIF,c+":"+f._chKeyTransceiver1,"PRESS_LONG",function(e,g){e&&console.error("button:1 claim PRESS_LONG event error:"+e.stack);a.reportValueUsage(f.deviceIF,c+":"+f._chKeyTransceiver2,"PRESS_SHORT",function(e,g){e&&console.error("button:2 claim PRESS_SHORT event error:"+e.stack);a.reportValueUsage(f.deviceIF,c+":"+f._chKeyTransceiver2,"PRESS_LONG",function(a,c){a&&console.error("button:2 claim PRESS_LONG event error:"+a.stack);b&&b()})})})})};return f}(),Ua=function(){var f=
function(a,b,c){h.call(this,a,b,c);this._chMaintenance=0;this._chDoorReceiver=1;this._chSimpleSwitchReceiver=2;this.legacyType="ip_tormatic"};util.inherits(f,h);f.prototype._getReadableDpts=function(){return[{channel:this.deviceAdr+":"+this._chMaintenance,dpt:"UNREACH"},{channel:this.deviceAdr+":"+this._chDoorReceiver,dpt:"DOOR_STATE"},{channel:this.deviceAdr+":"+this._chSimpleSwitchReceiver,dpt:"STATE"}]};f.prototype._getDptFromRef=function(a){var b={channel:this.getSerial()+":",dataPoint:null};
switch(a){case "timeout":b.channel+=this._chMaintenance;b.dataPoint="UNREACH";break;case "doorState":b.channel+=this._chDoorReceiver;b.dataPoint="DOOR_STATE";break;case "lightState":b.channel+=this._chSimpleSwitchReceiver;b.dataPoint="STATE";break;default:return null}return b};f.prototype.executeCommand=function(a,b,c){var f=x.hub.m.hm._Channel["HmIP-RF"],e=this.getSerial();switch(b){case "open":case "close":case "partialOpen":case "stop":e=e+":"+this._chDoorReceiver;f.DOOR_RECEIVER.executeCommand(a,
this.deviceIF,e,b,c);break;case "lightOn":case "lightOff":case "lightToggle":b=b.substr(5).toLowerCase();e=e+":"+this._chSimpleSwitchReceiver;f.SIMPLE_SWITCH_RECEIVER.executeCommand(a,this.deviceIF,e,b,c);break;default:c&&c(Error("no such command"))}};f.prototype.parseDptState=function(a,b,c){var f=a.indexOf(":");if(-1==f)return null;var e=a.substr(0,f);a=a.substr(f+1);f=this.getSerial();if(e!=f)return null;e=x.hub.m.hm._Channel["HmIP-RF"];switch(parseInt(a)){case this._chMaintenance:switch(b){case "UNREACH":return e.MAINTENANCE.parseDptState(b,
c);default:var g={};g["0_"+b.toLowerCase()]=c;return g}case this._chDoorReceiver:return(b=e.DOOR_RECEIVER.parseDptState(b,c))&&(g=b),g;case this._chSimpleSwitchReceiver:if(b=e.SIMPLE_SWITCH_RECEIVER.parseDptState(b,c))g={},g.lightState=b.state;return g;default:return null}};return f}(),Va=function(){var f=function(a,b,c){h.call(this,a,b,c);this._chMaintenance=0;this._chBrightness=1;this.legacyType="ip_lux"};util.inherits(f,h);f.prototype._getReadableDpts=function(){var a=[],b=this,c=x.hub.m.hm._Channel["HmIP-RF"],
...
f.MAINTENANCE_BAT_EL.getDptFromState(a);break;case "illu":case "avgIllu":case "maxIllu":case "minIllu":c.channel=b+":1";c.dataPoint=f.BRIGHTNESS_TRANSMITTER.getDptFromState(a);break;default:return null}return c};f.prototype.parseDptState=function(a,b,c){var f=a.indexOf(":");if(-1==f)return null;var e=a.substr(0,f);a=a.substr(f+1);var g=this.deviceAdr;f=this.deviceAdr.indexOf(":");-1!=f&&(g=this.deviceAdr.substr(0,f));if(e!=g)return null;f=x.hub.m.hm._Channel["HmIP-RF"];if(0==a){if("UNREACH"==b||"LOW_BAT"==
b||"OPERATING_VOLTAGE"==b)return f.MAINTENANCE_BAT_EL.parseDptState(b,c);f={};f["0_"+b.toLowerCase()]=c;return f}return 1==a?f.BRIGHTNESS_TRANSMITTER.parseDptState(b,c):null};return f}(),Wa=function(){var f=function(a,b,c){h.call(this,a,b,c);this._chMaintenance=0;this._chPowerMainsTransmitter=1;this.legacyType="ip_pmfs"};util.inherits(f,h);f.prototype._getReadableDpts=function(){var a=this.getSerial(),b=[],c=this,f=x.hub.m.hm._Channel["HmIP-RF"],e=f.MAINTENANCE.getReadableDpts();e&&e.forEach(function(f){"UNREACH"==
...
f.POWER_MAINS_TRANSMITTER.parseDptState(b,c):null};return f}(),Xa=function(){var f=function(a,b,c){h.call(this,a,b,c);this.channel=1;this.legacyType="ip_rotary"};util.inherits(f,h);f.prototype._getReadableDpts=function(){var a=[],b=this,c=x.hub.m.hm._Channel["HmIP-RF"].MAINTENANCE_BAT_EL.getReadableDpts();c&&c.forEach(function(c){"SABOTAGE"!=c&&"ERROR_CODE"!=c&&"SENSOR_ERROR"!=c&&a.push({channel:b.deviceAdr+":0",dpt:c})});return a};f.prototype._getDptFromRef=function(a){var b=this.deviceAdr,c={channel:b+
":"+this.channel,dataPoint:null},f=x.hub.m.hm._Channel["HmIP-RF"];switch(a){case "timeout":case "lowbat":case "voltage":c.channel=b+":0";c.dataPoint=f.MAINTENANCE_BAT_EL.getDptFromState(a);break;default:return null}return c};f.prototype.parseDptState=function(a,b,c){var f=a.indexOf(":");if(-1==f)return null;var e=a.substr(0,f);a=a.substr(f+1);var g=this.deviceAdr;f=this.deviceAdr.indexOf(":");-1!=f&&(g=this.deviceAdr.substr(0,f));if(e!=g)return null;e=x.hub.m.hm._Channel["HmIP-RF"];f=null;if(0==a){if("UNREACH"==
b||"LOW_BAT"==b||"OPERATING_VOLTAGE"==b)return e.MAINTENANCE_BAT_EL.parseDptState(b,c);f={};f["0_"+b.toLowerCase()]=c;return f}if(1==a||2==a||3==a)if(b=e.KEY_TRANRECEIVER.parseDptState(b,c))f||(f={}),b.pressShort&&(f["btn"+a+"pressShort"]=!0),b.pressLong&&(f["btn"+a+"pressLong"]=!0);return f};f.prototype.isButton=function(){return!0};f.prototype.claimEvent=function(a,b){var c=this.deviceAdr;-1==c.indexOf(":")&&this.channel&&(c+=":"+this.channel);var f=this;this._claimButtonEvent(1,a,function(){f._claimButtonEvent(2,
a,function(){f._claimButtonEvent(3,a,function(){b&&b()})})})};f.prototype._claimButtonEvent=function(a,b,c){var f=this;b.reportValueUsage(this.deviceIF,this.deviceAdr+":"+a,"PRESS_SHORT",function(e,g){e&&console.error("button:"+a+" claim PRESS_SHORT event error:"+e.stack);b.reportValueUsage(f.deviceIF,f.deviceAdr+":"+a,"PRESS_LONG",function(b,f){b&&console.error("button:"+a+" claim PRESS_LONG event error:"+b.stack);c&&c()})})};return f}(),Oa=function(){var f=function(a,b,c){h.call(this,a,b,c);this._chKeyTransceivers=
[1];this._chMaintenance=0;this._chMaintenanceDpts=["UNREACH","LOW_BAT"];this.legacyType=1==this._chKeyTransceivers.length?"ip_button":"ip_button"+this._chKeyTransceivers};util.inherits(f,h);f.prototype._getReadableDpts=function(){var a=[],b=this,c=this.getSerial(),f=x.hub.m.hm._Channel["HmIP-RF"].T_MAINTENANCE.getReadableDpts();f&&f.forEach(function(f){-1!=b._chMaintenanceDpts.indexOf(f)&&a.push({channel:c+":"+b._chMaintenance,dpt:f})});return a};f.prototype._getDptFromRef=function(a){return(a=x.hub.m.hm._Channel["HmIP-RF"].T_MAINTENANCE.getDptFromState(a))?
{channel:this.getSerial()+":"+this._chMaintenance,dataPoint:a}:null};f.prototype.parseDptState=function(a,b,c){var f=a.indexOf(":");if(-1==f)return null;var e=x.hub.m.hm._Channel["HmIP-RF"],g=a.substr(0,f);a=a.substr(f+1);f=this.getSerial();if(g!=f)return null;if(parseInt(a)==this._chMaintenance){if(-1!=this._chMaintenanceDpts.indexOf(b))return e.T_MAINTENANCE.parseDptState(b,c);var k={};k["0_"+b.toLowerCase()]=c;return k}if(-1!=this._chKeyTransceivers.indexOf(parseInt(a))){if(tmp=e.KEY_TRANRECEIVER.parseDptState(b,
c))k={},1==this._chKeyTransceivers.length?k=tmp:(tmp.pressShort&&(k["btn"+a+"pressShort"]=!0),tmp.pressLong&&(k["btn"+a+"pressLong"]=!0));return k}};f.prototype.isButton=function(){return!0};f.prototype.claimEvent=function(a,b){var c=0,f=this,e=function(){c++;c<f._chKeyTransceivers.length?f._claimButtonEvent(f._chKeyTransceivers[c],a,e):b&&b()};this._claimButtonEvent(this._chKeyTransceivers[c],a,e)};f.prototype._claimButtonEvent=function(a,b,c){var f=this;b.reportValueUsage(this.deviceIF,this.deviceAdr+
":"+a,"PRESS_SHORT",function(e,g){e&&console.error("button:"+a+" claim PRESS_SHORT event error:"+e.stack);b.reportValueUsage(f.deviceIF,f.deviceAdr+":"+a,"PRESS_LONG",function(b,f){b&&console.error("button:"+a+" claim PRESS_LONG event error:"+b.stack);c&&c()})})};f.parse=function(a){var b=null,c=a.address,e=a.address.indexOf(":");-1!=e&&(b=a.address.substr(e+1),c=a.address.substr(0,e));e=null;switch(a.type){case "HmIP-MOD-OC8":e=new f(a.type,a.interface,c),e._chMaintenance=0,e._chMaintenanceDpts=
["UNREACH","OPERATING_VOLTAGE"],e._chKeyTransceivers=[parseInt(b)]}return e};f.resolve=function(a,b){return"HmIP-MOD-OC8"==a?this._resolveIPMultiButton(a,b,1,8,["UNREACH","OPERATING_VOLTAGE"]):"HmIP-RCV-50"==a.substr(0,11)?this._resolveIPMultiButton(a,b,1,50,null):null};f._resolveIPMultiButton=function(a,b,c,e,g){var k,h=[];for(k=0;k<e;k++){var l=new f(a,b.interface,b.address+":"+(k+c));l._chMaintenance=0;g&&(l._chMaintenanceDpts=g);l._chKeyTransceivers=[k+c];h.push(l)}return h};return f}(),F=function(){var f=
function(a,b,c){h.call(this,a,b,c);this.channel=1;this._chMaintenance=this._switchIdx=0;this._chSwitchVirtualReceiver1=2;this._chSwitchVirtualReceiver2=3;this._chSwitchVirtualReceiver3=4;this._chSwitchWeekProfile=5;this.legacyType="ip_switch"};util.inherits(f,h);f.prototype._getReadableDpts=function(){return[{channel:this.deviceAdr+":"+this._chMaintenance,dpt:"UNREACH"},{channel:this.deviceAdr+":"+this.channel,dpt:"STATE"}]};f.prototype._getDptFromRef=function(a){var b={channel:this.getSerial()+":",
dataPoint:null};switch(a){case "timeout":b.channel+=this._chMaintenance;b.dataPoint="UNREACH";break;case "state":b.channel+=this.channel;b.dataPoint="STATE";break;default:return null}return b};f.prototype.executeCommand=function(a,b,c){var f=this.getSerial(),e=this;switch(b){case "on":var g="STATE";var k=f+":"+this._chSwitchVirtualReceiver1;a.writeValue(this.deviceIF,k,g,!0,c);break;case "off":g="STATE";k=f+":"+this._chSwitchVirtualReceiver1;a.writeValue(this.deviceIF,k,g,!1,c);break;case "toggle":g=
"STATE";k=f+":"+this.channel;a.getState({interface:this.deviceIF,channel:k,datapoint:g},function(b,h){b?c&&c(b):h?(b=!0,h.value&&(b=!1),g="STATE",k=f+":"+e._chSwitchVirtualReceiver1,a.writeValue(e.deviceIF,k,g,b,c)):c&&c(Error("get switch current value return invalid"))});break;default:"onFor"==b.substr(0,5)?(b=parseFloat(b.substr(5)),isNaN(b)?c&&c(Error("onFor command invalid")):(g="ON_TIME",k=f+":"+e._chSwitchVirtualReceiver1,a.writeValue(this.deviceIF,k,g,{type:"double",value:b},function(b){b?
c&&c(b):(g="STATE",k=f+":"+e._chSwitchVirtualReceiver1,a.writeValue(e.deviceIF,k,g,!0,c))}))):c&&c(Error("no such command"))}};f.prototype.parseDptState=function(a,b,c){var f=a.indexOf(":");if(-1==f)return null;var e=a.substr(0,f);a=a.substr(f+1);f=this.getSerial();if(e!=f)return null;switch(parseInt(a)){case this._chMaintenance:switch(b){case "UNREACH":return{timeout:c};default:return e={},e["0_"+b.toLowerCase()]=c,e}case this.channel:switch(b){case "STATE":return{state:1==c?"on":"off"};default:return null}default:return null}};
f.parse=function(a){var b=null,c=a.address.indexOf(":");-1!=c&&(b=a.address.substr(c+1));c=null;switch(a.type){case "HmIP-MOD-OC8":c=this._parseTSwitch(a,b,41)}return c};f._parseTSwitch=function(a,b,c){a=new f(a.type,a.interface,a.address);a._chMaintenance=0;a.channel=parseInt(b);a._chSwitchVirtualReceiver1=a.channel+1;a._chSwitchVirtualReceiver2=a.channel+2;a._chSwitchVirtualReceiver3=a.channel+3;a._chSwitchWeekProfile=c;return a};f.resolve=function(a,b,c,e){var g=[];if("HmIP-MOD-OC8"==a)for(l=0;8>
l;l++)d=new f(a,b.interface,b.address+":"+(4*l+9)),d._chMaintenance=0,d.channel=4*l+9,d._chSwitchVirtualReceiver1=d.channel+1,d._chSwitchVirtualReceiver2=d.channel+2,d._chSwitchVirtualReceiver3=d.channel+3,d._chSwitchWeekProfile=41,g.push(d);else if(!c||!c.length){c=[];if(b.channels)for(l in b.channels){var k=b.channels[l];if(k&&"SWITCH_TRANSMITTER"==k.type&&k.address){var h=k.address.indexOf(":");-1!=h&&(k=parseInt(k.address.substr(h+1)),isNaN(k)||c.push(k))}else k&&"SWITCH_WEEK_PROFILE"==k.type&&
k.addres&&(h=k.address.indexOf(":"),-1!=h&&(k=parseInt(k.address.substr(h+1)),isNaN(k)||(e=k)))}if(c&&c.length)for(var l=0;l<c.length;l++)d=new f(a,b.interface,b.address+":"+c[l]),d._chMaintenance=0,d.channel=c[l],d._switchIdx=l,d._chSwitchVirtualReceiver1=d.channel+1,d._chSwitchVirtualReceiver2=d.channel+2,d._chSwitchVirtualReceiver3=d.channel+3,d._chSwitchWeekProfile=e,g.push(d)}return g};return f}(),Qa=function(){var f=function(a,b,c){h.call(this,a,b,c);this.channel=1;this._chMaintenance=0;this._chDimmerVirtualReceiver1=
2;this._chDimmerVirtualReceiver2=3;this._chDimmerVirtualReceiver3=4;this._chDimmerWeekProfile=13;this.legacyType="ip_dimmer"};util.inherits(f,h);f.prototype._getReadableDpts=function(){var a=[],b=this,c=x.hub.m.hm._Channel["HmIP-RF"],f=c.MAINTENANCE.getReadableDpts();f&&f.forEach(function(c){"UNREACH"==c&&a.push({channel:b.deviceAdr+":"+b._chMaintenance,dpt:c})});(f=c.DIMMER_TRANSMITTER.getReadableDpts())&&f.forEach(function(c){a.push({channel:b.deviceAdr+":"+b.channel,dpt:c})});(f=c.DIMMER_VIRTUAL_RECEIVER.getReadableDpts())&&
...
b+":"+this.channel;c.dataPoint=f.DIMMER_TRANSMITTER.getDptFromState("dimmerTLevel");break;default:return null}return c};f.prototype.executeCommand=function(a,b,c){var f=x.hub.m.hm._Channel["HmIP-RF"],e=b;if(-1!=b.indexOf("dimUp")){var g=b.indexOf("dimUp");e=b.substr(0,g+5);var k=b.substr(g+5)}else-1!=b.indexOf("dimDown")?(g=b.indexOf("dimDown"),e=b.substr(0,g+7),k=b.substr(g+7)):-1!=b.indexOf("dimTo")?(g=b.indexOf("dimTo"),e=b.substr(0,g+5),k=b.substr(g+5)):-1!=b.indexOf("toggleTo")&&(g=b.indexOf("toggleTo"),
e=b.substr(0,g+8),k=b.substr(g+8));var h=this.getSerial(),l=this;switch(e){case "dimOff":f.DIMMER_VIRTUAL_RECEIVER.executeCommand(a,this.deviceIF,h+":"+this._chDimmerVirtualReceiver1,"dimOff",c);break;case "dimUp":k=k?parseInt(k)/100:.1;a.getState({interface:this.deviceIF,channel:h+":"+this.channel,datapoint:"LEVEL"},function(b,e){b?c&&c(b):"undefined"==typeof e||null==e?c&&c(Error("get dimmer current value return invalid")):(k=e.value+k,1<k&&(k=1),k=Math.round(100*k),f.DIMMER_VIRTUAL_RECEIVER.executeCommand(a,
l.deviceIF,h+":"+l._chDimmerVirtualReceiver1,"dimTo"+k,c))});break;case "dimDown":k=k?parseInt(k)/100:.1;a.getState({interface:this.deviceIF,channel:h+":"+this.channel,datapoint:"LEVEL"},function(b,e){b?c&&c(b):"undefined"==typeof e||null==e?c&&c(Error("get dimmer current value return invalid")):(k=e.value-k,0>k&&(k=0),k=Math.round(100*k),f.DIMMER_VIRTUAL_RECEIVER.executeCommand(a,l.deviceIF,h+":"+l._chDimmerVirtualReceiver1,"dimTo"+k,c))});break;case "dimTo":if(!k){c&&c(Error("dimTo has no value"));
break}f.DIMMER_VIRTUAL_RECEIVER.executeCommand(a,this.deviceIF,h+":"+l._chDimmerVirtualReceiver1,"dimTo"+k,channel);break;case "toggleTo":if(!k){c&&c(Error("toggle has no value"));break}a.getState({interface:this.deviceIF,channel:h+":"+this.channel,datapoint:"LEVEL"},function(b,e){b?c&&c(b):"undefined"==typeof e||null==e?c&&c(Error("get dimmer current value return invalid")):(e.value&&(k=0),f.DIMMER_VIRTUAL_RECEIVER.executeCommand(a,l.deviceIF,h+":"+l._chDimmerVirtualReceiver1,"dimTo"+k,c))});break;
default:c&&c(Error("no such command"))}};f.prototype.parseDptState=function(a,b,c){var f=a.indexOf(":");if(-1==f)return null;var e=a.substr(0,f);a=a.substr(f+1);f=this.getSerial();if(e!=f)return null;f=x.hub.m.hm._Channel["HmIP-RF"];e=null;switch(parseInt(a)){case this._chMaintenance:switch(b){case "UNREACH":return f.MAINTENANCE.parseDptState(b,c);default:return e={},e["0_"+b.toLowerCase()]=c,e}case this.channel:if(b=f.DIMMER_TRANSMITTER.parseDptState(b,c))e={},e.dimmerLevel=b.dimmerTLevel;return e}return null};
return f}(),Ra=function(){var f=function(a,b,c){h.call(this,a,b,c);this.channel=1;this._chMaintenance=0;this._chBlindVirtualReceiver1=2;this._chBlindVirtualReceiver2=3;this._chBlindVirtualReceiver3=4;this._chBlindWeekProfile=5;this.legacyType="ip_jalousie"};util.inherits(f,h);f.prototype._getReadableDpts=function(){var a=[],b=this,c=x.hub.m.hm._Channel["HmIP-RF"],f=c.MAINTENANCE.getReadableDpts();f&&f.forEach(function(c){"UNREACH"==c&&a.push({channel:b.deviceAdr+":"+b._chMaintenance,dpt:c})});(f=
...
switch(a){case "timeout":c.channel=b+":"+this._chMaintenance;c.dataPoint=f.MAINTENANCE.getDptFromState(a);break;case "blindLevel":c.channel=b+":"+this.channel;c.dataPoint=f.BLIND_TRANSMITTER.getDptFromState("blindTPos");break;case "lamellaLevel":c.channel=b+":"+this.channel;c.dataPoint=f.BLIND_TRANSMITTER.getDptFromState("lamellaTPos");break;default:return null}return c};f.prototype.executeCommand=function(a,b,c){var f=x.hub.m.hm._Channel["HmIP-RF"],e=b;if(-1!=b.indexOf("stepUp")){var g=b.indexOf("stepUp");
e=b.substr(0,g+6);var k=b.substr(g+6)}else-1!=b.indexOf("stepDown")?(g=b.indexOf("stepDown"),e=b.substr(0,g+8),k=b.substr(g+8)):-1!=b.indexOf("moveTo")?(g=b.indexOf("moveTo"),e=b.substr(0,g+6),k=b.substr(g+6)):-1!=b.indexOf("stop")?(g=b.indexOf("stop"),e=b.substr(0,g+4),k=b.substr(g+4)):-1!=b.indexOf("lamellaStepUp")?(g=b.indexOf("lamellaStepUp"),e=b.substr(0,g+13),k=b.substr(g+13)):-1!=b.indexOf("lamellaStepDown")?(g=b.indexOf("lamellaStepDown"),e=b.substr(0,g+15),k=b.substr(g+15)):-1!=b.indexOf("lamellaTo")&&
(g=b.indexOf("lamellaTo"),e=b.substr(0,g+9),k=b.substr(g+9));var h=this.getSerial(),l=this;switch(e){case "stop":case "moveUp":case "moveDown":f.BLIND_VIRTUAL_RECEIVER.executeCommand(a,this.deviceIF,h+":"+this._chBlindVirtualReceiver1,e,c);break;case "lamellaUp":case "lamellaDown":a.getState({interface:this.deviceIF,channel:h+":"+this.channel,datapoint:"LEVEL"},function(b,g){b?c&&c(b):"undefined"==typeof g||null==g?c&&c(Error("get blind current value return invalid")):f.BLIND_VIRTUAL_RECEIVER.executeCommand(a,
this.deviceIF,h+":"+this._chBlindVirtualReceiver1,"lamellaTo"+(e=100),function(b){b?c&&c(b):f.BLIND_VIRTUAL_RECEIVER.executeCommand(a,l.deviceIF,h+":"+l._chBlindVirtualReceiver1,"moveTo"+Math.round(100*g.value),c)})});break;case "stepUp":case "stepDown":k=k?parseInt(k)/100:.05;a.getState({interface:this.deviceIF,channel:h+":"+this.channel,datapoint:"LEVEL"},function(b,g){b?c&&c(b):"undefined"==typeof g||null==g?c&&c(Error("get blind current value return invalid")):(k="stepUp"==e?g.value+k:g.value-
k,1<k&&(k=1),0>k&&(k=0),k=Math.round(100*k),f.BLIND_VIRTUAL_RECEIVER.executeCommand(a,l.deviceIF,h+":"+l._chBlindVirtualReceiver1,"moveTo"+k,c))});break;case "moveTo":if(!k){c&&c(Error("moveTo has no value"));break}f.BLIND_VIRTUAL_RECEIVER.executeCommand(a,this.deviceIF,h+":"+this._chBlindVirtualReceiver1,"moveTo"+k,c);break;case "lamellaStepUp":case "lamellaStepDown":k=k?parseInt(k)/100:.05;a.getState({interface:this.deviceIF,channel:h+":"+this.channel,datapoint:"LEVEL"},function(b,g){if(b)c&&c(b);
else if("undefined"==typeof g||null==g)c&&c(Error("get blind current value return invalid"));else{var m=g.value;m=Math.round(100*m);a.getState({interface:l.deviceIF,channel:h+":"+l.channel,datapoint:"LEVEL_2"},function(b,g){b?c&&c(b):"undefined"==typeof g||null==g?c&&c(Error("get lamella current value return invalid")):(k="lamellaStepUp"==e?g.value+k:g.value-k,1<k&&(k=1),0>k&&(k=0),k=Math.round(100*k),f.BLIND_VIRTUAL_RECEIVER.executeCommand(a,l.deviceIF,h+":"+l._chBlindVirtualReceiver1,"lamellaTo"+
k,function(b,e){b?c&&c(b,e):f.BLIND_VIRTUAL_RECEIVER.executeCommand(a,l.deviceIF,h+":"+l._chBlindVirtualReceiver1,"moveTo"+m,c)}))})}});break;case "lamellaTo":if(!k){c&&c(Error("lamellaTo has no value"));break}a.getState({interface:this.deviceIF,channel:h+":"+this.channel,datapoint:"LEVEL"},function(b,e){if(b)c&&c(b);else if("undefined"==typeof e||null==e)c&&c(Error("get blind current value return invalid"));else{var g=e.value;g=Math.round(100*g);f.BLIND_VIRTUAL_RECEIVER.executeCommand(a,l.deviceIF,
h+":"+l._chBlindVirtualReceiver1,"lamellaTo"+k,function(b){b?c&&c(b):f.BLIND_VIRTUAL_RECEIVER.executeCommand(a,l.deviceIF,h+":"+l._chBlindVirtualReceiver1,"moveTo"+g,c)})}});break;default:c&&c(Error("no such command"))}};f.prototype.parseDptState=function(a,b,c){var f=a.indexOf(":");if(-1==f)return null;var e=a.substr(0,f);a=a.substr(f+1);f=this.getSerial();if(e!=f)return null;f=x.hub.m.hm._Channel["HmIP-RF"];e=null;switch(parseInt(a)){case this._chMaintenance:switch(b){case "UNREACH":return f.MAINTENANCE.parseDptState(b,
c);default:return e={},e["0_"+b.toLowerCase()]=c,e}case this.channel:if(c=f.BLIND_TRANSMITTER.parseDptState(b,c))e={},"LEVEL"==b?e.blindLevel=c.blindTPos:"LEVEL_2"==b&&(e.lamellaLevel=c.lamellaTPos);return e}return null};f.prototype.getConfig=function(a,b){var c=this.getSerial()+":"+this.channel;a.getParamset(this.deviceIF,c,"MASTER",function(a,f){if(a)b&&b(a);else{var e={},g=null;f&&(g={CHANGE_OVER_DELAY:f.CHANGE_OVER_DELAY,REFERENCE_RUNNING_TIME_BOTTOM_TOP_UNIT:f.REFERENCE_RUNNING_TIME_BOTTOM_TOP_UNIT,
REFERENCE_RUNNING_TIME_BOTTOM_TOP_VALUE:f.REFERENCE_RUNNING_TIME_BOTTOM_TOP_VALUE,REFERENCE_RUNNING_TIME_TOP_BOTTOM_UNIT:f.REFERENCE_RUNNING_TIME_TOP_BOTTOM_UNIT,REFERENCE_RUNNING_TIME_TOP_BOTTOM_VALUE:f.REFERENCE_RUNNING_TIME_TOP_BOTTOM_VALUE,REFERENCE_RUNNING_TIME_SLATS_UNIT:f.REFERENCE_RUNNING_TIME_SLATS_UNIT,REFERENCE_RUNNING_TIME_SLATS_VALUE:f.REFERENCE_RUNNING_TIME_SLATS_VALUE,REFERENCE_RUN_COUNTER:f.REFERENCE_RUN_COUNTER});e[c]=g;b&&b(a,e)}})};f.prototype.setConfig=function(a,b,c){if(b){var f=
...
e.REFERENCE_RUNNING_TIME_TOP_BOTTOM_VALUE={__rpcValueType:"double",__rpcValue:b.REFERENCE_RUNNING_TIME_TOP_BOTTOM_VALUE};e.REFERENCE_RUNNING_TIME_SLATS_UNIT={__rpcValueType:"double",__rpcValue:b.REFERENCE_RUNNING_TIME_SLATS_UNIT};e.REFERENCE_RUNNING_TIME_SLATS_VALUE={__rpcValueType:"double",__rpcValue:b.REFERENCE_RUNNING_TIME_SLATS_VALUE};a.setParamset(this.deviceIF,f,"MASTER",e,function(a){c&&c(a)})}else c&&c(Error("config data not complete"))}else c&&c(Error("config data invalid"))};return f}(),
w=function(){var f=function(a,c,f){h.call(this,a,c,f);this.channel=1;this._chMaintenance=0;this.legacyType="ip_multi_input"};util.inherits(f,h);f.prototype._getReadableDpts=function(){return[{channel:this.deviceAdr+":"+this._chMaintenance,dpt:"UNREACH"},{channel:this.deviceAdr+":"+this.channel,dpt:"STATE"}]};f.prototype._getDptFromRef=function(a){var b={channel:this.getSerial()+":",dataPoint:null};switch(a){case "timeout":b.channel+=this._chMaintenance;b.dataPoint="UNREACH";break;case "state":b.channel+=
this.channel;b.dataPoint="STATE";break;default:return null}return b};f.prototype.parseDptState=function(a,c,f){var b=a.indexOf(":");if(-1==b)return null;var e=a.substr(0,b);a=a.substr(b+1);b=this.getSerial();if(e!=b)return null;e=x.hub.m.hm._Channel["HmIP-RF"];switch(parseInt(a)){case this._chMaintenance:switch(c){case "UNREACH":return{timeout:f};default:return e={},e["0_"+c.toLowerCase()]=f,e}case this.channel:switch(c){case "STATE":return{state:1==f?"on":"off"};case "PRESS_SHORT":case "PRESS_LONG":return e.KEY_TRANRECEIVER.parseDptState(c,
f);default:return null}default:return null}};f.prototype.isButton=function(){return!0};f.prototype.claimEvent=function(a,c){this._claimButtonEvent(this.channel,a,function(){c&&c()})};f.prototype._claimButtonEvent=function(a,c,f){var b=this.getSerial()+":"+a,e=this;c.reportValueUsage(this.deviceIF,b,"PRESS_SHORT",function(g,k){g&&console.error("button:"+a+" claim PRESS_SHORT event error:"+g.stack);c.reportValueUsage(e.deviceIF,b,"PRESS_LONG",function(b,c){b&&console.error("button:"+a+" claim PRESS_LONG event error:"+
b.stack);f&&f()})})};var a=function(a,c,e){f.call(this,a,c,e);this.legacyType="ip_multi_input_bat"};util.inherits(a,f);a.prototype._getReadableDpts=function(){for(var a=x.hub.m.hm._Channel["HmIP-RF"].MAINTENANCE_BAT_EL.getReadableDpts,c=x.hub.m.hm._Channel["HmIP-RF"].MULTI_MODE_INPUT_TRANSMITTER.getReadableDpts,f=[],e=0;e<a.length;e++)f.push({channel:this.deviceAdr+":"+this._chMaintenance,dpt:a[e]});for(e=0;e<c.length;e++)f.push({channel:this.deviceAdr+":"+this.channel,dpt:c[e]});return f};a.prototype._getDptFromRef=
function(a){var b={channel:this.getSerial()+":",dataPoint:null},f=x.hub.m.hm._Channel["HmIP-RF"];switch(a){case "timeout":case "lowbat":case "voltage":case "errorCode":b.channel+=this._chMaintenance;b.dataPoint=f.MAINTENANCE_BAT_EL.getDptFromState(a);break;case "state":b.channel+=this.channel;b.dataPoint=f.MULTI_MODE_INPUT_TRANSMITTER.getDptFromState(a);break;default:return null}return b};a.prototype.parseDptState=function(a,c,f){var b=a.indexOf(":");if(-1==b)return null;var e=a.substr(0,b);a=a.substr(b+
1);b=this.getSerial();if(e!=b)return null;e=x.hub.m.hm._Channel["HmIP-RF"];switch(parseInt(a)){case this._chMaintenance:switch(c){case "UNREACH":case "LOW_BAT":case "OPERATING_VOLTAGE":case "ERROR_CODE":return e.MAINTENANCE_BAT_EL.parseDptState(c,f);default:return e={},e["0_"+c.toLowerCase()]=f,e}case this.channel:switch(c){case "STATE":case "PRESS_SHORT":case "PRESS_LONG":return e.MULTI_MODE_INPUT_TRANSMITTER.parseDptState(c,f);default:return null}default:return null}};f.resolve=function(b,c,e){if("HmIP-FCI"==
b.substr(0,8)){e=parseInt(b.substr(8));var g=a}else if("HmIP-MOD-RC"==b.substr(0,11))e=parseInt(b.substr(11)),g=a;else if("HmIPW-DRI"==b.substr(0,9))e=parseInt(b.substr(9)),g=f;else{if(!e||!e.length)if(e=[],c.channels)for(g in c.channels){var k=c.channels[g];if(k&&"MULTI_MODE_INPUT_TRANSMITTER"==k.type&&k.address){var h=k.address.indexOf(":");-1!=h&&(k=parseInt(k.address.substr(h+1)),isNaN(k)||e.push(k))}}if(!e||!e.length)return[];g=[];for(k=0;k<e.length;k++)h=new f(b,c.interface,c.address+":"+e[k]),
h._chMaintenance=0,h.channel=e[k],g.push(h);return g}return this._resolveIPMultiInput(b,c,e,g)};f._resolveIPMultiInput=function(a,c,f,e){var b,g=[];for(b=0;b<f;b++){var k=new e(a,c.interface,c.address+":"+(b+1));k._chMaintenance=0;k.channel=b+1;g.push(k)}return g};f.parse=function(b){var c=null,f=b.address,e=b.address.indexOf(":");-1!=e&&(c=b.address.substr(e+1),f=b.address.substr(0,e));e=w;if("HmIP-FCI1"==b.type||"HmIP-FCI6"==b.type||"HmIP-MOD-RC8"==b.type)e=a;b=new e(b.type,b.interface,f);b._chMaintenance=
0;b.channel=parseInt(c);return b};return f}(),Ya=function(){var f=function(a,b,c){h.call(this,a,b,c);this.channel=3;this._chKeyTransceivers=[];this._chMaintenance=0;this._chMaintenanceDpts=["UNREACH"];this._chMotionDetectorTransceiver=3;this.legacyType="ip_motion2"};util.inherits(f,h);f.prototype._getReadableDpts=function(){var a=[],b=this,c=x.hub.m.hm._Channel["HmIP-RF"],f=c.MAINTENANCE_BAT_EL.getReadableDpts();f&&f.forEach(function(c){-1!=b._chMaintenanceDpts.indexOf(c)&&a.push({channel:serialNum+
...
a.indexOf(":");if(-1==f)return null;var e=a.substr(0,f);a=a.substr(f+1);var g=this.deviceAdr;f=this.deviceAdr.indexOf(":");-1!=f&&(g=this.deviceAdr.substr(0,f));if(e!=g)return null;f=x.hub.m.hm._Channel["HmIP-RF"];e=null;if(0==a){if("UNREACH"==b||"LOW_BAT"==b)return f.MAINTENANCE_BAT_EL.parseDptState(b,c);e={};e["0_"+b.toLowerCase()]=c;return e}1==a&&(g=f.KEY_TRANRECEIVER.parseDptState(b,c))&&(g.pressShort&&(e={btn1pressShort:!0}),g.pressLong&&(e={btn1pressLong:!0}));2==a&&(g=f.KEY_TRANRECEIVER.parseDptState(b,
c))&&(g.pressShort&&(e={btn2pressShort:!0}),g.pressLong&&(e={btn2pressLong:!0}));return 3==a?f.MOTIONDETECTOR_TRANSCEIVER.parseDptState(b,c):e};f.prototype.isButton=function(){return 0<this._chKeyTransceivers.length};f.prototype.claimEvent=function(a,b){if(this._chKeyTransceivers&&this._chKeyTransceivers.length){var c=function(b,c,f,e){a.reportValueUsage(b,c+":"+f,"PRESS_SHORT",function(g,k){g&&console.error("button:1 claim PRESS_SHORT event error:"+g.stack);a.reportValueUsage(b,c+":"+f,"PRESS_LONG",
function(a,b){a&&console.error("button:1 claim PRESS_LONG event error:"+a.stack);e()})})},f=this,e=0,g=function(){e++;e<f._chKeyTransceivers.length?c(f.deviceIF,f.deviceAdr,f._chKeyTransceivers[e],g):b&&b()},k=this.deviceAdr;-1==k.indexOf(":")&&this.channel&&(k+=":"+this.channel);c(this.deviceIF,this.deviceAdr,this._chKeyTransceivers[e],g)}else b&&b()};f.resolve=function(a,b){b=new f(a,b.interface,b.address);"HmIPW-SMI55"==a&&(b._chKeyTransceivers=[1,2],b._chMotionDetectorTransceiver=3);return b};
return f}(),Sa=function(){var f=function(a,b,c){h.call(this,a,b,c);this.channel=1;this._chMaintenance=0;this.legacyType="ip_analog_input"};util.inherits(f,h);f.prototype._getReadableDpts=function(){return[{channel:this.deviceAdr+":"+this._chMaintenance,dpt:"UNREACH"},{channel:this.deviceAdr+":"+this.channel,dpt:"VOLTAGE"}]};f.prototype._getDptFromRef=function(a){var b={channel:this.getSerial()+":",dataPoint:null};switch(a){case "timeout":b.channel+=this._chMaintenance;b.dataPoint="UNREACH";break;
case "state":b.channel+=this.channel;b.dataPoint="VOLTAGE";break;default:return null}return b};f.prototype.parseDptState=function(a,b,c){var f=a.indexOf(":");if(-1==f)return null;var e=a.substr(0,f);a=a.substr(f+1);f=this.getSerial();if(e!=f)return null;switch(parseInt(a)){case this._chMaintenance:switch(b){case "UNREACH":return{timeout:c};default:return e={},e["0_"+b.toLowerCase()]=c,e}case this.channel:switch(b){case "VOLTAGE":return{voltage:parseFloat(c)};default:return null}default:return null}};
f.parse=function(a){var b=null,c=a.address,e=a.address.indexOf(":");-1!=e&&(b=a.address.substr(e+1),c=a.address.substr(0,e));a=new f(a.type,a.interface,c);a._chMaintenance=0;a.channel=parseInt(b);return a};return f}(),t={};t.CLASS_MAP={maintenance:e,button:n,vbutton:g,switch:k,dimmer:l,blind:q,powerswitch:m,weather:r,heater:y,heater2:u,heater3:na,wallthermo:S,wallthermo2:T,contact:oa,weatherstation:v,rain:U,gong2:G,gong:Ma,window:pa,temp:qa,co2:sa,motion:ta,smoke:ua,siren:V,capacity:va,switch_interface:O,
tilt:wa,temp2:ra,water:xa,weather2:p,energymeter:ya,rgb:P,lux:za,siren2:W,jalousie:X,mod_em_8bit:H,mod_em_8:I,keymatic:Y,ou_led16:J,hm_dis_ep_wm55:Na,dualwhite:Z};t.CLASS_MAP_IP={ip_switch:Pa,ip_contact:Aa,ip_heater:aa,ip_powerswitch:ba,ip_energyactor:C,ip_dimmer:da,ip_motion:ha,ip_motion2:K,ip_button2:R,ip_siren:ia,ip_wallthermo:D,ip_smoke:ja,ip_window:Ca,ip_button4:L,ip_dimmer2:ea,ip_energyactor2:ca,ip_blind:z,ip_jalousie:A,ip_presence:ka,ip_dimmer3:fa,ip_wallthermo2:Ba,ip_floor_heater:Da,ip_floor_pump_heater:Ea,
ip_button6:M,ip_weather:Fa,ip_weather2:Ga,ip_weather3:Ha,ip_weather4:Ia,ip_direction:la,ip_button8:N,ip_generic_input:Ja,ip_analog_output:ma,ip_water:Ka,ip_acce:La,ip_garagedoor:E,ip_bsl:Ta,ip_tormatic:Ua,ip_button:Q,ip_lux:Va,ip_pmfs:Wa,ip_rotary:Xa};t.parseJson=function(f){if(!(f&&f.type&&f.interface&&f.address))return null;switch(f.interface){case "BidCos-RF":f=this._parseRFDeviceJson(f);break;case "HmIP-RF":f=this._parseIPDeviceJson(f);break;default:return null}return f};t._parseRFDeviceJson=
...
if("HmIP-MIOB"==f.type)return t._parse_HMIP_MIOB(f);if("HmIP-FCI1"==f.type||"HmIP-FCI6"==f.type||"HmIP-MOD-RC8"==f.type)return w.parse(f);var a=null,b=f.address.indexOf(":");-1!=b&&(a=f.address.substr(b+1));switch(f.type){case "HmIP-WHS2":return this._parseTSwitch(f,a,9);case "HmIP-MOD-OC8":return 8>=parseInt(a)?Oa.parse(f):F.parse(f);case "HmIP-MIO16-PCB":return 13>parseInt(a)?Sa.parse(f):17>parseInt(a)?w.parse(f):F.parse(f)}a=t._getIPMetaIndex(f.type);if("undefined"==typeof a||null==a)return null;
a=x.hub.m.hm.IPDeviceCatagory[a];if(!a||!a.type)return null;var c=this.CLASS_MAP_IP[a.type];if(!c)return null;a=null;b=f.address.indexOf(":");-1!=b&&(a=f.address.substr(b+1));f=new c(f.type,f.interface,f.address);a&&(f.channel=parseInt(a));return f};t._parseIPW=function(f){var a=null;var b=f.address.indexOf(":");-1!=b&&(a=f.address.substr(b+1));return"HmIPW-DRS"==f.type.substr(0,9)?(b=parseInt(f.type.substr(9)),f=new F(f.type,f.interface,f.address),f._chMaintenance=0,f.channel=parseInt(a),f._chSwitchVirtualReceiver1=
...
a);var c=[];if(a.channels)for(var e in a.channels){var g=a.channels[e];g.type==b.channel&&c.push(g)}var k=this.CLASS_MAP[b.type];if(!k)return null;if("*"==b.channelNum){var h=[];c.forEach(function(b){var e=new k(f,a.interface,a.address),g=b.address.indexOf(":");1<c.length&&(e.deviceAdr=b.address);e.channel=b.address.substr(g+1);h.push(e)});return h}e=new k(f,a.interface,a.address);"undefined"!=typeof b.channelNum&&null!=b.channelNum&&(e.channel=b.channelNum);return e};t._resolveIPFromType=function(f,
a){if("HmIPW"==f.substr(0,5))return this._resolveIPW(f,a);if("HmIP-MOD-OC8"==f){var b=Oa.resolve(f,a),c=F.resolve(f,a);return b.concat(c)}if(0==f.indexOf("HmIP-FAL"))return t._resolve_HMIP_FAL_X(f,a);if(0==f.indexOf("HmIP-MIOB"))return t._resolve_HMIP_MIOB(f,a);if("HmIP-DRSI"==f.substr(0,9)){b=parseInt(f.substr(9));c=[];for(var e=1;e<=b;e++)c.push(e);return w.resolve(f,a,c)}if("HmIP-DRDI"==f.substr(0,9)){b=parseInt(f.substr(9));c=[];for(e=1;e<=b;e++)c.push(e);return w.resolve(f,a,c)}if("HmIP-DRBLI"==
f.substr(0,10)){b=parseInt(f.substr(10));c=[];for(e=1;e<=2*b;e++)c.push(e);return w.resolve(f,a,c)}switch(f){case "HmIP-PCBS2":return Oa._resolveIPMultiButton(f,a,1,2,["UNREACH","OPERATING_VOLTAGE"]);case "HmIP-WHS2":return this._resolveIPMultiSwitch(f,a,2);case "HmIP-FCI1":case "HmIP-FCI6":case "HmIP-MOD-RC8":return w.resolve(f,a);case "HmIP-MIO16-PCB":return t._resolve_HMIP_MIO16_PCB(f,a)}b=this._getIPMetaIndex(f);if("undefined"==typeof b||null==b)return null;b=x.hub.m.hm.IPDeviceCatagory[b];if(!b||
!b.type)return null;var g=[];if(a.channels)for(c in a.channels)e=a.channels[c],e.type==b.channel&&g.push(e);var k=this.CLASS_MAP_IP[b.type];if(!k)return null;if("*"==b.channelNum){var h=[];g.forEach(function(b){var c=new k(f,a.interface,a.address),e=b.address.indexOf(":");1<g.length&&(c.deviceAdr=b.address);c.channel=b.address.substr(e+1);h.push(c)});return h}c=new k(f,a.interface,a.address);"undefined"!=typeof b.channelNum&&null!=b.channelNum&&(c.channel=b.channelNum);return c};t._resolveIPW=function(f,
a){var b,c=[];if("HmIPW-DRS"==f.substr(0,9)){var e=parseInt(f.substr(9));c=this._resolveIPMultiSwitch(f,a,e)}else if("HmIPW-DRD"==f.substr(0,9))for(e=parseInt(f.substr(9)),b=0;b<e;b++){var g=new Qa(f,a.interface,a.address+":"+(4*b+1));g._chMaintenance=0;g.channel=4*b+1;g._chDimmerVirtualReceiver1=g.channel+1;g._chDimmerVirtualReceiver2=g.channel+2;g._chDimmerVirtualReceiver3=g.channel+3;g._chDimmerWeekProfile=4*e+1;c.push(g)}else if("HmIPW-DRBL"==f.substr(0,10))for(e=parseInt(f.substr(10)),b=0;b<
e;b++)g=new Ra(f,a.interface,a.address+":"+(4*b+1)),g._chMaintenance=0,g.channel=4*b+1,g._chBlindVirtualReceiver1=g.channel+1,g._chBlindVirtualReceiver2=g.channel+2,g._chBlindVirtualReceiver3=g.channel+3,g._chBlindWeekProfile=4*e+1,c.push(g);else if("HmIPW-DRI"==f.substr(0,9))for(e=parseInt(f.substr(9)),b=0;b<e;b++)g=new w(f,a.interface,a.address+":"+(b+1)),g._chMaintenance=0,g.channel=b+1,c.push(g);else if("HmIPW-FIO"==f.substr(0,9))for(e=parseInt(f.substr(9)),b=0;b<e;b++)g=new w(f,a.interface,a.address+
":"+(b+1)),g._chMaintenance=0,g.channel=b+1,c.push(g),g=new F(f,a.interface,a.address+":"+(4*b+e+1)),g._chMaintenance=0,g.channel=4*b+e+1,g._chSwitchVirtualReceiver1=g.channel+1,g._chSwitchVirtualReceiver2=g.channel+2,g._chSwitchVirtualReceiver3=g.channel+3,g._chSwitchWeekProfile=e+4*e+1,c.push(g);else"HmIPW-SMI55"==f&&(g=Ya.resolve(f,a),c.push(g));return c};t._resolveIPMultiSwitch=function(f,a,b){var c,e=[];for(c=0;c<b;c++){var g=new F(f,a.interface,a.address+":"+(4*c+1));g._chMaintenance=0;g.channel=
4*c+1;g._chSwitchVirtualReceiver1=g.channel+1;g._chSwitchVirtualReceiver2=g.channel+2;g._chSwitchVirtualReceiver3=g.channel+3;g._chSwitchWeekProfile=4*b+1;e.push(g)}return e};t._resolveRFFromTypeGeneral=function(f,a){var b=[];if(!a||!a.channels)return null;var c=a.channels,e;for(e in c){var g=c[e];if(g&&g.type&&x.hub.m.hm._Channel["BidCos-RF"][g.type]&&(g=x.hub.m.hm._Channel["BidCos-RF"][g.type].device)&&(g=this.CLASS_MAP[g])){g=new g(f,a.interface,e);var k=e.indexOf(":");g.channel=e.substr(k+1);
b.push(g)}}return b};t._resolve_HM_MOD_EM_8=function(f,a){var b=[];if(!a||!a.channels)return null;var c=a.channels,e;for(e in c){c=e.indexOf(":");c=e.substr(c+1);var g=new (0==c?this.CLASS_MAP.maintenance:this.CLASS_MAP.mod_em_8)(f,a.interface,e);g.channel=c;b.push(g)}return b};t._resolve_HM_OU_LED16=function(f,a){var b=[];if(!a||!a.channels)return null;var c=a.channels,e;for(e in c){c=e.indexOf(":");c=e.substr(c+1);var g=new (0==c?this.CLASS_MAP.maintenance:this.CLASS_MAP.ou_led16)(f,a.interface,
e);g.channel=c;b.push(g)}return b};t._resolve_HM_Dis_EP_WM55=function(f,a){var b=[];if(!a||!a.channels)return null;var c=a.channels,e;for(e in c){c=e.indexOf(":");c=e.substr(c+1);var g=null;0==c?g=this.CLASS_MAP.maintenance:1==c||2==c?g=this.CLASS_MAP.button:3==c&&(g=this.CLASS_MAP.hm_dis_ep_wm55);g&&(g=new g(f,a.interface,e),g.channel=c,b.push(g))}return b};t._resolve_HMIP_FAL_X=function(f,a){var b=[];if(!a||!a.channels)return null;var c=a.channels,e;for(e in c){var g=c[e],k=e.indexOf(":");k=e.substr(k+
1);if(0==k)var h=this.CLASS_MAP.maintenance;else"CLIMATECONTROL_FLOOR_PUMP_TRANSCEIVER"==g.type?h=this.CLASS_MAP_IP.ip_floor_pump_heater:"CLIMATECONTROL_FLOOR_TRANSCEIVER"==g.type&&(h=this.CLASS_MAP_IP.ip_floor_heater);h&&(g=new h(f,a.interface,e),g.channel=k,b.push(g))}return b};t._resolve_HMIP_MIOB=function(f,a){var b=[];if(!a||!a.channels)return null;var c=a.channels,e;for(e in c){c=e.indexOf(":");c=e.substr(c+1);var g=null;0==c?g=this.CLASS_MAP.maintenance:3==c||7==c?g=this.CLASS_MAP_IP.ip_switch:
9==c||10==c?g=this.CLASS_MAP_IP.ip_generic_input:11==c&&(g=this.CLASS_MAP_IP.ip_analog_output);g&&(g=new g(f,a.interface,e),g.channel=c,b.push(g))}return b};t._resolve_HMIP_MIO16_PCB=function(f,a){var b=[];if(!a||!a.channels)return null;var c=a.channels,e;for(e in c){c=e.indexOf(":");c=e.substr(c+1);var g;if(g=0==c?this.CLASS_MAP.maintenance:1<=c&&12>=c?Sa:13<=c&&16>=c?w:F)g=new g(f,a.interface,e),g.channel=c,b.push(g)}return b};t._getIPMetaIndex=function(f){for(var a in x.hub.m.hm.IPDeviceTypes)if(x.hub.m.hm.IPDeviceTypes.hasOwnProperty(a)&&
...
e[k];if(l)for(var n=0;n<h.length;n++){var m=h[n];m&&m.data&&(m.data.key==l.statusKey||"*"==m.data.key)&&g.emit("status",{module:"hm",device:m.device,gateway:m.gateway,data:m.data},l)}}};h.prototype.addStateDevice=function(e,h,g){if(e){e=JSON.parse(JSON.stringify(e));var k=x.hub.m.hm._Util.getDeviceHashCode(e),l=this._devices[k];l||(delete e.gateway,this._devices[k]=e);this._meta[k]||(this._meta[k]=[]);g&&this._meta[k].push(g);"HmIP-RCV-50"==e.type&&"HmIP-RCV"!=e.address.substr(0,8)&&(e=JSON.parse(JSON.stringify(e)),
k=0,l=e.address.split(":"),2<=l.length&&(k=l[1]),k&&(e.address="HmIP-RCV-1:"+k,k=x.hub.m.hm._Util.getDeviceHashCode(e),l=this._devices[k],l||(delete e.gateway,this._devices[k]=e),this._meta[k]||(this._meta[k]=[]),g&&this._meta[k].push(g)));h&&h()}else h&&h(Error("device json invalid"))};h.prototype.removeStateDevice=function(e,h,g){if(!e)h&&h(Error("device json invalid"));else if(g){e=JSON.parse(JSON.stringify(e));e=x.hub.m.hm._Util.getDeviceHashCode(e);var k=this._meta[e];if(k){for(var l=-1,n=0;n<
k.length;n++){var m=k[n];if(m&&"taskman"==m.src&&"taskman"==g.src&&m.taskID==g.taskID&&m.statusKey==g.statusKey){l=n;break}}0<=l&&k.splice(l,1);0==k.length&&(delete this._devices[e],delete this._meta[e])}h&&h()}};h.prototype.getAllStates=function(){var e=[],h;for(h in this._devices)if(this._devices.hasOwnProperty(h)){var g=this._devices[h];g&&g.device&&(g=this.getStates(g.device))&&e.push(g)}return e};h.prototype.getStates=function(e){if(!e)return null;e=JSON.parse(JSON.stringify(e));var h=x.hub.m.hm._Util.getDeviceHashCode(e),
g=this._devices[h];g||this.addStateDevice(e);var k=require("x.hub.m.hm.js")._monitorManager.getMonitor(this._gateway.ip,this._gateway.uuid);if(!k)return null;var l={};g=this._devices[h];for(var q in g.states)h=k.getBufferedState(g.states[q]),l[q]=this._resolveRawState(e,q,h);return{device:e,gateway:this._gateway,states:l}};h.prototype.updateStates=function(e,h){if(e){e=JSON.parse(JSON.stringify(e));var g=x.hub.m.hm._Util.getDeviceHashCode(e),k=this._devices[g];k||this.addStateDevice(e);k=this._devices[g];
this._updateStates(e,k.states,h)}else h&&h(Error("device json is null"))};h.prototype.getState=function(e,h,g){if(!e||!h)return g&&g(Error("argument invalid")),null;if("SysVar"==e.type||"CUxD"==e["interface"])x.hub.m.hm.HM_MODULE.doStatus("var",this._gateway,e,{value:h},function(e,k){e?g&&g(e):k?(e={value:k.status,time:(new Date).getTime()},g&&g(null,e)):g&&g(Error("get sys var status return null"))});else{e=JSON.parse(JSON.stringify(e));var k=x.hub.m.hm._Util.getDeviceHashCode(e);this._devices[k]||
this.addStateDevice(e);k=require("x.hub.m.hm.js")._monitorManager.getMonitor(this._gateway.ip,this._gateway.uuid);if(!k)return g&&g(Error("no monitor for gateway")),null;var l=x.hub.m.hm.HM_MODULE.resolveGateway(this._gateway);if(!l)return g&&g(Error("gateway json invalid")),null;var n=l.resolveDatapointInfo(e,h);if(!n)return g&&g(Error("device json or state ref invalid")),null;k.getState(n,function(k,q){if(k)g&&g(k);else if(q){k=l.resolveState(e,n,q.value);var m;k?Array.isArray(k)?k.forEach(function(e){e&&
e.key==h&&(m={value:e.value,time:q.time})}):m={value:k.value,time:q.time}:m={value:k,time:q.time};g&&g(null,m)}else g&&g(null,null)})}};h.prototype.executeCommand=function(e,h,g){var k=x.hub.m.hm.HM_MODULE.resolveGateway(this._gateway);if(!k)return g&&g(Error("gateway json invalid")),null;k.executeCommandCreator(e,h,g)};h.prototype.updateState=function(e,h,g){if(!e||!h)return g&&g(Error("argument invalid")),null;e=JSON.parse(JSON.stringify(e));var k=x.hub.m.hm._Util.getDeviceHashCode(e);this._devices[k]||
this.addStateDevice(e);k=require("x.hub.m.hm.js")._monitorManager.getMonitor(this._gateway.ip,this._gateway.uuid);if(!k)return g&&g(Error("no monitor for gateway")),null;var l=x.hub.m.hm.HM_MODULE.resolveGateway(this._gateway);if(!l)return g&&g(Error("gateway json invalid")),null;var n=l.resolveDatapointInfo(e,h);if(!n)return g&&g(Error("device json or state ref invalid")),null;k.updateState(n,function(k,q){if(k)g&&g(k);else{k=l.resolveState(e,n,q);var m;k?Array.isArray(k)?k.forEach(function(e){e&&
e.key==h&&(m={value:e.value})}):m={value:k.value}:m={value:k};g&&g(null,m)}})};h.prototype._startMonitor=function(e){var h=require("x.hub.m.hm.js")._monitorManager,g=this;h.startMonitor(this._gateway,{persistant:!0},function(k){var l=h.getMonitor(g._gateway.ip,g._gateway.uuid);if(l)l.on("new_devices",g._onNewDevices.bind(g));e&&e(k)})};h.prototype._onNewDevices=function(e){var h=[],g;for(g in e)if(e.hasOwnProperty(g)){var k=x.hub.m.hm._Device.resolve(e[g]);k&&0<k.length&&(k=k.filter(function(e){return e&&
e.isButton()}),h=h.concat(k))}var l=require("x.hub.m.hm.js")._monitorManager.getMonitor(this._gateway.ip,this._gateway.uuid);if(l&&0<h.length){var q=0,m=function(){q++;q<h.length&&h[q].claimEvent(l,m)};h[q].claimEvent(l,m)}};h.prototype._updateStates=function(e,h,g){var k=this;require("x.hub.m.hm.js")._monitorManager.startMonitor(this._gateway,{persistant:!0},function(l){l?g&&g(l):k._getStateByScript(e,h,g)})};h.prototype._resolveDetailDpt=function(e){var h=require("xnm.aio.hm.js").devicemanager,
g=h.applyUIFilter(e,{catagory:"status",elems:"*"}),k=g?g.status:null;h=(g=h.applyUIFilter(e,{catagory:"command",elems:"*"}))?g.command:null;g={states:{},commands:{}};if(k&&0<=k.length)for(var l=0;l<k.length;l++){var q=k[l],m=this._resolveDatapointRef(e,q.ref.value,!1);m&&(g.states[q.ref.value]=m)}if(h&&0<=h.length)for(l=0;l<h.length;l++)k=h[l],(m=this._resolveDatapointRef(e,k.ref.value,!0))&&(g.commands[k.ref.value]=m);return g};h.prototype.learnRFDevice=function(e){var h=require("x.hub.m.hm.js")._monitorManager.getMonitor(this._gateway.ip,
this._gateway.uuid);h?h.learnRF(function(g,k){if(g)e&&e(g);else{g=[];var h=new x.hub.m.hm.HM_MODULE.CCU,n;for(n in k){var m=k[n];m.hsstype=m.type;if(m.channels)for(n in m.channels)m.channels[n].hsstype=m.channels[n].type;(m=h._parseDevice(m))&&(g=g.concat(m))}e&&e(null,g)}}):e&&e(Error("monitor not started"))};h.prototype.learnIPDevice=function(e,h,g){var k=require("x.hub.m.hm.js")._monitorManager.getMonitor(this._gateway.ip,this._gateway.uuid);k?k.learnIP(e,h,function(e,k){if(e)g&&g(e);else{e=[];
var h=new x.hub.m.hm.HM_MODULE.CCU,l;for(l in k){var n=k[l];n.hsstype=n.type;if(n.channels)for(l in n.channels)n.channels[l].hsstype=n.channels[l].type;(n=h._parseDevice(n))&&(e=e.concat(n))}g&&g(null,e)}}):g&&g(Error("monitor not started"))};h.prototype.learnIPDeviceQR=function(e,h){var g=require("x.hub.m.hm.js")._monitorManager.getMonitor(this._gateway.ip,this._gateway.uuid);g?g.learnIPQR(e,function(e,g){if(e)h&&h(e);else{e=[];var k=new x.hub.m.hm.HM_MODULE.CCU,l;for(l in g){var n=g[l];n.hsstype=
n.type;if(n.channels)for(l in n.channels)n.channels[l].hsstype=n.channels[l].type;(n=k._parseDevice(n))&&(e=e.concat(n))}h&&h(null,e)}}):h&&h(Error("monitor not started"))};h.prototype.deleteDevice=function(e,h,g){var k=require("x.hub.m.hm.js")._monitorManager.getMonitor(this._gateway.ip,this._gateway.uuid);k?k.deleteDevice(e,h,g):g&&g(Error("monitor not started"))};h.prototype.getRFInterfaces=function(e){var h=require("x.hub.m.hm.js")._monitorManager.getMonitor(this._gateway.ip,this._gateway.uuid);
h?h.getRFInterfaces(e):e&&e(Error("monitor not started"))};return h}();x.hub.m.hm.ChipManager=function(h){x.hub.m.hm.Manager.call(this,h);this._logger=require("x.logger.js").getLogger("x.hub.m.hm.Manager.ChipManager")};util.inherits(x.hub.m.hm.ChipManager,x.hub.m.hm.Manager);
...
g){h&&h({error:e,data:g})}):(g=this._addManager(e.gateway),g.init(function(k){k?h&&h({error:k}):g.updateStates(e,function(e,g){h&&h({error:e,data:g})})}))}else h&&h({error:Error("device json format invalid")})};h.prototype.checkDeviceMatch=function(e,h){if(!(h&&h.device&&e&&e.device))return!1;if(h.gateway&&"mediola"!=h.gateway.uuid){h=x.hub.m.hm._Util.getDeviceHashCode(h.device);var g=x.hub.m.hm._Util.getDeviceHashCode(e.device);if(h==g)return!0;if("HmIP-RCV-50"==e.device.type&&"HmIP-RCV"!=e.device.address.substr(0,
8)){e=JSON.parse(JSON.stringify(e.device));g=0;var k=e.address.split(":");2<=k.length&&(g=k[1]);if(g)return e.address="HmIP-RCV-1:"+g,g=x.hub.m.hm._Util.getDeviceHashCode(e),h==g}return!1}g=e.device.address;e.device.interface&&e.device.type&&(g=e.device.type+"."+e.device.interface+"."+e.device.address);return g!=h.device.address?!1:!0};h.prototype._initChipManager=function(e){var h="127.0.0.1";global&&global.HM_CHIP&&(h=global.HM_CHIP);this._chipManager=new x.hub.m.hm.ChipManager({ip:h,username:global.HM_CHIP_USERNAME,
password:global.HM_CHIP_PASSWORD,uuid:"mediola"});this._chipManager.init(e)};h.prototype._initCCU3Manager=function(e){this._addManager({ip:"127.0.0.1",type:3}).init(function(h){e&&e(h)})};h.prototype._discover=function(e){this._discovery.discover(e)};h.prototype._onFindHM=function(e,h){this._logger.log("debug","find ccu:"+e.uuid+"@"+e.ip+" from netif:"+h);this._monitorManager.onFindHomeMatic(e.ip,h,e.uuid)};h.prototype._getManager=function(e){e=x.hub.m.hm._Util.getGatewayHashCode(e);return this._managers[e]};
h.prototype._addManager=function(e){var h=x.hub.m.hm._Util.getGatewayHashCode(e);e=new x.hub.m.hm.Manager(e);return this._managers[h]=e};h.prototype.onDeviceEvent=function(e,h){this._logger.log("trace","receive device event:"+JSON.stringify(e));require("x.hub.eventbus.js");if(h)this._chipManager&&(this._chipManager.checkButtonEvent(e),this._udpEvtProducer.onEvent(e));else for(var g in this._managers)if(h=this._managers[g])try{h.onDeviceEvent(e)}catch(k){console.error(k.stack)}};h.prototype.resetChip=
function(e){this._chipManager?this._chipManager.reset(function(){e&&e({})}):e&&e(Error("chip manager not inited"))};h.prototype.initManager=function(e,h){if(e){var g=this._getManager(e);g||(g=this._addManager(e));g.init(function(e){h&&h({error:e})})}else h&&h({error:Error("gateway invalid")})};h.prototype.learnRFDevice=function(e,h){if(e){var g=this._getManager(e);g?g.learnRFDevice(function(e,g){h&&h({error:e,data:g})}):(g=this._addManager(e),g.init(function(e){e?h&&h({error:e}):setTimeout(function(){g.learnRFDevice(function(e,
g){h&&h({error:e,data:g})})},3E3)}))}else this._chipManager?this._chipManager.learnRFDevice(function(e,g){if(e)h&&h({error:e});else{var k=[];g.forEach(function(e){if(e){var g=e.toLegacyAdr();e=e.toLegacyType();k.push({address:g,type:e})}});h&&h({data:k})}}):h&&h(Error("chip manager not inited"))};h.prototype.learnRFDeviceSN=function(e,h,g){if(e){var k=this._getManager(e);k?k.learnRFDevice(function(e,h){g&&g({error:e,data:h})}):(k=this._addManager(e),k.init(function(e){e?g&&g({error:e}):setTimeout(function(){k.learnRFDevice(function(e,
h){g&&g({error:e,data:h})})},3E3)}))}else this._chipManager?this._chipManager.learnRFDeviceSN(h,function(e,h){if(e)g&&g({error:e});else{var k=[];h.forEach(function(e){if(e){var g=e.toLegacyAdr();e=e.toLegacyType();k.push({address:g,type:e})}});g&&g({data:k})}}):g&&g(Error("chip manager not inited"))};h.prototype.learnIPDevice=function(e,h,g,k){if(e){var l=this._getManager(e);l?l.learnIPDevice(h,g,function(e,g){k&&k({error:e,data:g})}):(l=this._addManager(e),l.init(function(e){e?k&&k({error:e}):setTimeout(function(){l.learnIPDevice(h,
g,function(e,g){k&&k({error:e,data:g})})},3E3)}))}else h?g?this._chipManager?this._chipManager.learnIPDevice(h,g,function(e,g){if(e)k&&k({error:e});else{var h=[];g.forEach(function(e){if(e){var g=e.toLegacyAdr();e=e.toLegacyType();h.push({address:g,type:e})}});k&&k({data:h})}}):k&&k(Error("chip manager not inited")):k&&k({error:Error("key is null")}):k&&k({error:Error("sgtin is null")})};h.prototype.learnIPDeviceQR=function(e,h,g){if(h)if(e){var k=this._getManager(e);k?k.learnIPDeviceQR(h,function(e,
h){g&&g({error:e,data:h})}):(k=this._addManager(e),k.init(function(e){e?g&&g({error:e}):setTimeout(function(){k.learnIPDeviceQR(h,function(e,h){g&&g({error:e,data:h})})},3E3)}))}else this._chipManager?this._chipManager.learnIPDeviceQR(h,function(e,h){if(e)g&&g({error:e});else{var k=[];h.forEach(function(e){if(e){var g=e.toLegacyAdr();e=e.toLegacyType();k.push({address:g,type:e})}});g&&g({data:k})}}):g&&g(Error("chip manager not inited"));else g&&g({error:Error("qrKey is null")})};h.prototype.deleteDevice=
function(e,h,g){if(h){var k=h.split(".");3>k.length?g&&g({error:Error("address invalid")}):(h=k[1],k=k[2],e?g&&g({error:Error("not supported yet")}):this._chipManager?this._chipManager.deleteDevice(h,k,function(e){g&&g({error:e})}):g&&g(Error("chip manager not inited")))}else g&&g({error:Error("address invalid")})};h.prototype.getRFInterfaces=function(e,h){if(e){var g=this._getManager(e);g?g.getRFInterfaces(function(e,g){h&&h({error:e,data:g})}):(g=this._addManager(e),g.init(function(e){e?h&&h({error:e}):
setTimeout(function(){g.getRFInterfaces(function(e,g){h&&h({error:e,data:g})})},3E3)}))}else this._chipManager?this._chipManager.getRFInterfaces(function(e,g){h&&h({error:e,data:g})}):h&&h(Error("chip manager not inited"))};h.prototype.executeCommandLegacy=function(e,h,g,k){e?k&&k({error:Error("not supported yet")}):this._chipManager?h?this.executeCommand({address:h},{value:g},function(e){k&&k({error:e?e.error:null})}):k&&k({error:Error("address invalid")}):k&&k({error:Error("chip manager not inited")})};
h.prototype.getAllStatesLegacy=function(e){var h=[];try{this.getAllStates().forEach(function(e){if(e&&e.device&&e.states){var g={type:"HM",adr:e.device.toLegacyAdr(),state:{}},l;for(l in e.states)g.state[l]=e.states[l].value;h.push(g)}})}catch(g){console.error(g.stack)}e&&e({data:h})};h.prototype.getConfig=function(e,h){e?e.gateway&&"mediola"!=e.gateway.uuid?h&&h({error:Error("not supported yet")}):this._chipManager?this._chipManager.getConfig(e,function(e,k){h&&h({error:e,data:k})}):h&&h({error:Error("chip manager not inited")}):
h&&h({error:Error("device is null")})};h.prototype.setConfig=function(e,h,g){e?e.gateway&&"mediola"!=e.gateway.uuid?g&&g({error:Error("not supported yet")}):this._chipManager?this._chipManager.setConfig(e,h,function(e){g&&g({error:e})}):g&&g({error:Error("chip manager not inited")}):g&&g({error:Error("device is null")})};h.prototype.getMonitorStates=function(e){this._monitorManager.getMonitorStates(function(h,g){e&&e({error:h,data:g})})};h.prototype.getAllDevices=function(e){var h=[];try{this.getAllStates().forEach(function(e){e&&
e.device&&e.states&&(e={type:"HM",address:e.device.toLegacyAdr(),data:e.device.toLegacyType(),snr:e.device.getSerial(),_ver:"v5+"},h.push(e))})}catch(g){console.error(g.stack)}e&&e({data:h})};h.prototype.isWindowOpen=function(){try{for(var e=this.getAllStates(),h=0;h<e.length;h++){var g=e[h];if(g&&g.device&&g.states){var k=g.device.toLegacyType();if("window"==k){if(g.states.state&&"closed"!=g.states.state.value)return!0}else if("contact"==k){if(g.states.state&&"closed"!=g.states.state.value)return!0}else if("ip_contact"==
k){if(g.states.state&&"closed"!=g.states.state.value)return!0}else if("ip_window"==k&&g.states.state&&"closed"!=g.states.state.value)return!0}}}catch(l){return!1}};return h}();"undefined"!=typeof exports&&"undefined"!=typeof module&&module.exports&&(exports=module.exports=new x.hub.m.hm.Handler);
