...
x.hub.m.knx.DeviceHandler=function(){var c=function(a){this._logger=require("x.logger.js").getLogger("x.hub.m.knx.DeviceHandler");this._controller=a;this._gateways=[];this._devices=[]};c.prototype.IP_GATEWAY_FILE="knx_gateway.json";c.prototype.DEVICE_FILE="knx_device.json";c.prototype.init=function(a){this._logger.log("trace","init");var b=this,d=2;this._loadGateways(function(e,f){d--;e&&b._logger.log("warn","load knx ip gateways error:"+e.message);f&&(b._gateways=f);0==d&&a&&a()});this._loadDevices(function(e,
f){d--;e&&b._logger.log("warn","load knx devices error:"+e.message);f&&(b._devices=f);0==d&&a&&a()})};c.prototype.getIPGatewayObjs=function(){return this._gateways};c.prototype.getIPGatewayObj=function(a){for(var b=0;b<this._gateways.length;b++){var d=this._gateways[b];if(a==d.getID())return d}return null};c.prototype.getIPGateways=function(a){var b=[];this._gateways.forEach(function(a){a&&(a=a.toJSON())&&b.push(a)});a&&a(null,b)};c.prototype.addIPGateway=function(a,b){if(a&&a.ip){for(var d=[],e=
0;e<this._gateways.length;e++){var f=this._gateways[e];if(f){var c=f.getID(),h=f.getIP(),k=f.getMAC();d.push(c);if(h==a.ip){a=Error("find knx ip gateway with same ip");a.code="09002";b&&b(null,f.toJSON());return}if(k&&a.mac&&k==a.mac){a=Error("find knx ip gateway with mac address");a.code="09003";b&&b(a);return}}}for(f=1;-1!=d.indexOf(f);)f++;a.gid=f;var l=x.hub.m.knx.KNXIPGateway.fromJSON(a);if(l){this._gateways.push(l);var p=this;this._saveGateways(this._gateways,function(a){a?(a.code="09006",b&&
b(a)):p._controller._monitorManager.startMonitor(l,function(){b&&b(null,l.toJSON())})})}else a=Error("json format invalid"),a.code="09001",b&&b(a)}else a=Error("json format invalid"),a.code="09001",b&&b(a)};c.prototype.updateIPGateway=function(a,b){var d=x.hub.m.knx.KNXIPGateway.fromJSON(a);if(d){var e=null;this._gateways.forEach(function(a){a&&a.getID()==d.getID()&&(e=a)});if(e){var f=e.getIP(),c=e.getPort();e.updateJSON(a)}else this._gateways.push(d);var h=this;this._saveGateways(this._gateways,
function(d){d?(d.code="09006",b&&b(d)):f!=a.ip||c!=a.port?h._controller._monitorManager.stopMonitor(e,function(){h._controller._monitorManager.startMonitor(e,function(){b&&b(null,e.toJSON())})}):b&&b(null,e.toJSON())})}else{var k=Error("json format invalid");k.code="09001";b&&b(k)}};c.prototype.deleteIPGateway=function(a,b){if(a&&a.gid){for(var d=-1,e=null,f=0;f<this._gateways.length;f++){var c=this._gateways[f];if(c&&c.getID()==a.gid){d=f;e=c;break}}if(-1==d)b&&b();else{this._gateways.splice(d,1);
...
x.hub.m.knx.MonitorManager=function(){var c=function(a){this._logger=require("x.logger.js").getLogger("x.hub.m.knx.MonitorManager");this._controller=a;this._monitors={}};c.prototype.init=function(a){var b=this;if(this._controller&&this._controller._deviceHandler){var d=this._controller._deviceHandler.getIPGatewayObjs(),e=0,c=function(){e++;e<d.length&&b.startMonitor(d[e],c)};this.startMonitor(d[e],c)}a&&a()};c.prototype.startMonitor=function(a,b){if(a){var d=a.getIP(),e=a.getPort();this._startMonitor(d,
e,a,b)}else b&&b(Error("gateway is null"))};c.prototype._startMonitor=function(a,b,d,e){if(d){this._logger.log("info","start connect monitor to gateway "+d.getID()+" ("+a+":"+b+")");var c=b+"@"+a,g=this._monitors[c];g?(g.addGateway(d),e&&e()):(g=new x.hub.m.knx.Monitor(a,b),g.addGateway(d),g.setManager(this),this._monitors[c]=g,g.start(e))}else e&&e(Error("gateway is null"))};c.prototype.stopMonitor=function(a,b){var d=null,e=null,c;for(c in this._monitors){var g=this._monitors[c];if(g&&g.hasGateway(a)){d=
g;e=c;break}}if(d){var h=this;d.stopForGateway(a,function(a,d){d&&(h._logger.log("debug","monitor "+e+" stopped"),delete h._monitors[e]);b&&b(a)})}else b&&b()};c.prototype.stopAllMonitors=function(a){var b=Object.keys(this._monitors);if(0==b.length)a&&a();else{var d=0,e=this._monitors;this._monitors={};var c=function(){d++;d>=b.length?a&&a():e[b[d]].stop(c)};e[b[d]].stop(c)}};c.prototype.onFindKNX=function(a){if(a){var b=a.getIP(),d=a.getPort();a=a.getMAC();var e=d+"@"+b,c=null,g=null,h;for(h in this._monitors){var k=
this._monitors[h].getGatewayWithMac(a);if(k){c=k;g=h;break}}if(c&&g!=e){var l=this;this.stopMonitor(c,function(){l._startMonitor(b,d,c)})}}};c.prototype.listMonitors=function(a){var b=[],d;for(d in this._monitors)this._monitors.hasOwnProperty(d)&&b.push(this._monitors[d]);a&&a(null,b)};c.prototype.getMonitorForGateway=function(a){for(var b in this._monitors)if(this._monitors.hasOwnProperty(b)){var d=this._monitors[b];if(d&&d.hasGateway(a))return d}return null};return c}();
x.hub.m.knx.SearchHandler=function(){var c=require("xnm.aio.knx.js").Finder,a=function(a){this._logger=require("x.logger.js").getLogger("x.hub.m.knx.SearchHandler");this._controller=a;var b=this;this._searchListener=function(a,d){b._onFindKNX(a,d)};this._searching=!1;this._searchCB=[];this._searchResult=[];this._nextSearchTO=this._searchTO=null};a.SEARCH_INTERVAL=3E5;a.prototype.init=function(a){c.on("found",this._searchListener);this._search();a&&a()};a.prototype._onFindKNX=function(a,d){a=a.toJSON();
this._logger.log("info","find knx ip gateway:"+JSON.stringify(a));if(a.hapi&&a.hapi.ip&&a.mac){var b={ip:a.hapi.ip,port:a.hapi.port,mac:a.mac,name:a.name.replace(/\0/g,""),physical_address:a.physical_address,serial_number:a.serial_number};a=new x.hub.m.knx.KNXIPGateway;a.fromJSON(b);b=!1;for(var c=0;c<this._searchResult.length;c++){var g=this._searchResult[c];g&&g.getIP()==a.getIP()&&g.getPort()==a.getPort()&&(b=!0)}b||this._searchResult.push(a);if(this._controller&&this._controller._monitorManager)this._controller._monitorManager.onFindKNX(a,
d)}};a.prototype.search=function(a){a&&-1==this._searchCB.indexOf(a)&&this._searchCB.push(a);this._searching||this._search()};a.prototype._search=function(){this._logger.log("debug","start search knx ip gateway");this._searching=!0;this._nextSearchTO&&(this._logger.log("trace","clear next automatic search"),clearTimeout(this._nextSearchTO),this._nextSearchTO=null);var b=this;c.startSearchKNX();this._searchTO=setTimeout(function(){b._logger.log("trace","finish searching knx ip gateway");c.stopSearchKNX();
b._searching=!1;b._searchTO=null;var d=b._searchCB;b._searchCB=[];var e=b._searchResult;b._searchResult=[];b._nextSearchTO=setTimeout(function(){b._nextSearchTO=null;b._logger.log("trace","start next automatic search");b._search()},a.SEARCH_INTERVAL);d.forEach(function(a){a&&a(null,e)})},3E3)};return a}();
...
a({})})})};a.prototype.searchKNXGateway=function(a){this._searchHandler.search(function(b,c){if(b)a&&a({error:b});else{var d=[];c&&c.forEach(function(a){a&&(a=a.toJSON())&&d.push(a)});a&&a({data:d})}})};a.prototype.onMonitorMessage=function(a,d,e){var b=this._deviceHandler.getAllDevices(),g=require("xnm.aio.knx.js").KNXGateway;require("x.hub.eventbus.js");var h=this;b.forEach(function(b){if(b&&b.getGID()==a){var f=b.getChannels();if(f){var k=!1,n;for(n in f)if(f.hasOwnProperty(n)){var m=f[n];if(m&&
m.event&&m.event.ga&&g._adr2long(m.event.ga)==d){k=!0;break}}k&&(f=h.getStates(b),h._logger.log("info","receive event ("+e.toString("hex")+"@"+d+") for device "+b.getID()+":"+JSON.stringify(f)),b={type:"KNX",adr:b.getID(),state:f},c.sendSTAEvent(b))}}})};return a}();module.exports=new x.hub.m.knx.Handler;
