...
function(a){var d=this,c=require("fs-extra"),b=require("x.hub.fileman.js").fileManager,g=require("path");b=b.getUserRootDataPath();var f=g.resolve(b,e.FILE_NAME);c.ensureFile(f,function(b){b?a&&a(b):d._loadData(f,function(b,c){b?a&&a(b):(d._peripherals=c,a&&a())})})};e.prototype._loadData=function(a,d){require("fs").readFile(a,"utf8",function(a,b){if(a)d&&d(a);else if(b)try{var c=JSON.parse(b);d&&d(null,c)}catch(f){d&&d(f)}else d&&d(null,[])})};e.prototype._initUdevMonitor=function(){var a=require("udev").monitor();
a.on("add",this._onAdd.bind(this));a.on("remove",this._onRemove.bind(this));a.on("change",this._onChange.bind(this));a=this._listSerialDev();var d=this;a&&a.forEach(function(a){(a=d._udev2dev(a))&&d._onFindUsbDevice(a)})};e.prototype._listSerialDev=function(){if(global&&"EA"!=global.HARDWARE_VERSION&&"CA"!=global.HARDWARE_VERSION||global&&"A20"!=global.PLATFORM&&"PI-CM3+"!=global.PLATFORM)return null;var a=require("udev"),d=a.list("tty");a=a.list("net");var c=[];d&&(c=c.concat(d));a&&(c=c.concat(a));
...
c=[],b=0;b<d.length;b++){var e=d[b];e.type&&c.push({port:e.port,type:e.type,model:e.info?e.info.ID_MODEL:null,serial:e.info?e.info.ID_SERIAL:null,vendor:e.info?e.info.ID_VENDOR:null})}a&&a({data:c})};return e}();module.exports=new x.hub.peripheralman.Handler;
