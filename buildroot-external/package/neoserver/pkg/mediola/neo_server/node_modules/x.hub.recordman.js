...
require("fs").writeFile(this._rmFile,JSON.stringify(a,null,2),function(a){b&&b(a)})};c.prototype._sort=function(){var b=this._records.length-1;do{var a=!1;for(var c=0;c<b;++c)this._records[c].id>this._records[c+1].id&&(a=this._records[c],this._records[c]=this._records[c+1],this._records[c+1]=a,a=!0)}while(a)};return c}();
