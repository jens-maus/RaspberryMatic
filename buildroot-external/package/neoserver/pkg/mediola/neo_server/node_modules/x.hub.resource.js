...
a){return(b<<8)+parseInt(a,10)},0)>>>0};var e=function(){this._logger=require("x.logger.js").getLogger("x.hub.resource.ResourceManager");this._userResourceContainer=this._sysResourceContainer=this._userDataFolder=this._systemDataFolder=null};e.prototype.init=function(b,c){this._logger.log("info","init resource manager");this._systemDataFolder=b.getAppFolder();this._userDataFolder=b.getUserRootDataPath();this._init(c)};e.prototype.listFiles=function(b){var c={},a=this._sysResourceContainer.listFiles(b);
...
msg:"not found"}})}):a.status(404).json({XC_ERR:{code:"000404",msg:"not found"}})}});a.addRoute("/file/",{method:"POST",source:1,body:"stream",lock:1},function(b,a){if("/"==b.path.charAt(b.path.length-1))a.json({XC_ERR:{code:"000101",msg:"no file name"}});else{var c=b.path.substr(6),e=b.headers["content-length"];e&&parseInt(e)?d.createFile(c,b,function(b,c){b?a.json({XC_ERR:{code:"000101",msg:b.message}}):a.json({XC_SUC:{bytes:c}})}):d.deleteFile(c,function(b){b?a.json({XC_ERR:{code:"000101",msg:b.message}}):
