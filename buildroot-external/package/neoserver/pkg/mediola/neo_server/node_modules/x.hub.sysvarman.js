...
x.hub.sysvarman.SysvarManager=function(){var d=function(){this._logger=require("x.logger.js").getLogger("x.hub.sysvarman.SysvarManager");this._sysvarFile=null;this._sysvars={}};d.FILE_NAME="sysvar.json";d.prototype.init=function(a,b){this._logger.log("info","init sysvar mananger");var c=require("fs-extra"),e=require("path");this._sysvarFile||(this._sysvarFile=e.resolve(a.getUserRootDataPath(),d.FILE_NAME));var h=this;c.ensureFile(this._sysvarFile,function(a){a?b&&b(a):h._readData(function(a,c){!a&&
