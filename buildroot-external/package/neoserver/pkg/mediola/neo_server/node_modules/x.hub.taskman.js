...
g="true"==b.value?"true"!=String(c):"false"==b.value?"false"!=String(c):c!=b.value:">="==b.op?g=parseFloat(c)>=parseFloat(b.value):">"==b.op?g=parseFloat(c)>parseFloat(b.value):"<="==b.op?g=parseFloat(c)<=parseFloat(b.value):"<"==b.op&&(g=parseFloat(c)<parseFloat(b.value));b._logger.log("trace","condition "+(g?"match":"mismatch")+":"+JSON.stringify(b.toJSON()));b._trace&&b._trace.log("get status | "+b._getDescription()+" | success:"+JSON.stringify(a.data)+" | match="+g);e&&e(null,g)}})}else e&&e(Error("no status point or operator"));
else e&&e(Error("no device or gateway"))};m.prototype.cancel=function(a){this._running?(this._canceling=!0,this._cancelCB=a):a&&a(null,this._running)};m.prototype.isMatch=function(a){if(!a||!a.device)return!1;var e=a.device.sys;e&&"neoserver"!=e||(e="aio");e=require("x.hub.moduleman.js").modulemanager.getModule(e);if(!e||!e.checkDeviceMatch)return!1;var b=this._getDevice(),c=this._getGateway();if(!e.checkDeviceMatch({device:b,gateway:c},a))return!1;e=this.status;e.ref&&e.ref.value?e=e.ref.value:e.value&&
(e=e.value);return e!=a.data.key?!1:this.isValueMatch(a)};m.prototype.isValueMatch=function(a){if(!a||!a.data)return!1;var e=(new Date).getTime(),b=!1,c=this._lastStatus,g=a.data.value;this._lastStatus=g;"="==this.op||"changeTo"==this.op?(b="true"==this.value?"true"==String(a.data.value):"false"==this.value?"false"==String(a.data.value):this.value==a.data.value,"changeTo"==this.op&&g==c&&(b=!1)):">="==this.op?b=parseFloat(a.data.value)>=parseFloat(this.value):">"==this.op?b=parseFloat(a.data.value)>
...
b.name,a=JSON.parse(JSON.stringify(b.info)))}catch(J){}a||(a=JSON.parse(JSON.stringify(this.gateway)));a&&this.gateway.__neoIndex&&(a.__neoInfo={db:1,index:this.gateway.__neoIndex});return a};m.prototype._getDescription=function(){var a=null,b=null;if(this._deviceName||this._gatewayName)a=this._deviceName?this._deviceName:this._gatewayName;else if(this.device)try{b=JSON.parse(JSON.stringify(this.device)),b.username&&(b.username="xxxxxx"),b.password&&(b.password="xxxxxx"),a=JSON.stringify(b)}catch(J){a=
JSON.stringify(this.device)}else if(this.gateway)try{b=JSON.parse(JSON.stringify(this.gateway)),b.username&&(b.username="xxxxxx"),b.password&&(b.password="xxxxxx"),a=JSON.stringify(b)}catch(J){a=JSON.stringify(this.gateway)}b=this.status;this.status.ref&&(b=this.status.ref);b.value&&(b=b.value);return a+" | "+b+" "+this.op+" "+this.value};d.DeviceStatus=m;var r=function(){m.call(this);this.type=r.TYPE;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.CloudDeviceTrigger");this._cloudRuleID=
...
this.upperThreshold;a.lowerThreshold=this.lowerThreshold;return a};u.prototype.fromJSON=function(a){a&&(this.device=a.device,this.gateway=a.gateway,this.upperThreshold=a.upperThreshold,this.lowerThreshold=a.lowerThreshold)};d.DominoswissWS=u;var p=function(){d.call(this);this.type=p.TYPE};util.inherits(p,d);p.TYPE="action";d.Action=p;var D=function(){p.call(this);this.subtype=D.SUBTYPE;this.body=this.event=this.key=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.IFTTTMakerAction")};
util.inherits(D,p);D.SUBTYPE="iftttmaker";D.prototype.do=function(a){if(this.key||this.event){var b=a;a={hostname:"maker.ifttt.com",port:443,path:"/trigger/"+this.event+"/with/key/"+this.key,method:"POST",headers:{"Content-Type":"application/json"}};this._logger.log("trace","send https:"+JSON.stringify(a));this._logger.log("trace","with data:"+JSON.stringify(this.body));var e=this;a=require("https").request(a,function(a){a.setEncoding("utf8");var c="";a.on("data",function(a){c+=a});a.on("end",function(){e._logger.log("trace",
"action response:"+a.statusCode);e._logger.log("trace","with data:"+c);b&&(b(null,a.statusCode,c),b=null)})});a.on("error",function(a){e._logger.log("debug","do action err:"+a.stack);b&&(b(a),b=null)});a.setTimeout(5E3,function(){e._logger.log("debug","do action timeout");b&&(b(Error("timeout")),b=null)});if(this.body)try{var c=JSON.stringify(this.body);a.write(c)}catch(P){}a.end()}else a&&a(Error("no key or event"))};D.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;
a.key=this.key;a.event=this.event;a.body=this.body;return a};D.prototype.fromJSON=function(a){a&&(this.key=a.key,this.event=a.event,this.body=a.body)};d.IFTTTMakerAction=D;var A=function(){p.call(this);this.subtype=A.SUBTYPE;this._cancelCB=this._doCB=this.body=this.headers=this.query=this.pathname=this.port=this.hostname=this.auth=this.protocol=this.method=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.HttpAction")};util.inherits(A,p);A.SUBTYPE="http.action";A.prototype.do=
...
JSON.stringify(this.body);a.write(l)}catch(Q){}a.end()};A.prototype.cancel=function(a){this._running?(this._logger.log("trace","http action canceled"),this._doCB=null,this._running=!1,a&&a(null,!0)):a&&a(null,this._running)};A.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.method=this.method;a.protocol=this.protocol;a.auth=this.auth;a.hostname=this.hostname;a.port=this.port;a.pathname=this.pathname;a.query=this.query;a.headers=this.headers;a.body=this.body;
return a};A.prototype.fromJSON=function(a){a&&(this.subtype=a.subtype,this.method=a.method,this.protocol=a.protocol,this.auth=a.auth,this.hostname=a.hostname,this.port=a.port,this.pathname=a.pathname,this.query=a.query,this.headers=a.headers,this.body=a.body)};d.HttpAction=A;var t=function(){p.call(this);this.subtype=t.SUBTYPE;this._cancelCB=this.command=this.gateway=this.device=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.CommandAction");this._gatewayName=this._deviceName=
...
"alarm_on.mp3";break;case "alarm_off":a="alarm_off.mp3";break;case "pre_alarm":a="pre_alarm.mp3";break;case "alarm":a="alarm.mp3";break;default:return null}return{value:"playUrl",ext:"http://"+b+":"+c+"/resources/rehau_alarm/"+a}};d.CommandAction=t;var K=function(){p.call(this);this.subtype=K.SUBTYPE;this._cancelCB=this.command=this.gateway=this.device=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.BrelagUpperThresholdAction")};util.inherits(K,t);K.SUBTYPE="command.dominoswiss.upperthreshold";
K.prototype.do=function(a,b){if(b&&b.trigger&&b.trigger.type==u.TYPE){var c=b.trigger._lastTigger;c&&c.upperThreshold?t.prototype.do.call(this,a,b):a&&a()}else a&&a()};d.BrelagUpperThresholdAction=K;var L=function(){p.call(this);this.subtype=L.SUBTYPE;this._cancelCB=this.command=this.gateway=this.device=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.BrelagLowerThresholdAction")};util.inherits(L,t);L.SUBTYPE="command.dominoswiss.lowerthreshold";L.prototype.do=function(a,b){if(b&&
b.trigger&&b.trigger.type==u.TYPE){var c=b.trigger._lastTigger;c&&c.lowerThreshold?t.prototype.do.call(this,a,b):a&&a()}else a&&a()};d.BrelagUpperThresholdAction=L;var E=function(){p.call(this);this.subtype=E.SUBTYPE;this.actionID=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.CloudAction")};util.inherits(E,p);E.SUBTYPE="cloud_action";E.prototype.do=function(a){if(this.actionID){this._logger.log("trace","do cloud action:"+this.actionID);var b=require("x.hub.js").server;if(b)if(b=
b._cloudConnect){var c=JSON.stringify({type:"ACTION",data:this.actionID});c=new Buffer("EVT:"+c,"utf8");b.sendMessageActive("0103"+c.toString("hex"),function(b){a&&a(b)})}else a&&a(Error("no cloud connect"));else a&&a(Error("no server in hub"))}else a&&a(Error("action id is empty"))};E.prototype.cancel=function(a){a&&a(null,!1)};E.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.actionID=this.actionID;return a};E.prototype.fromJSON=function(a){a&&(this.actionID=
...
!1,a&&a(null,!0)):a&&a(null,this._running)};C.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.value=this.value;return a};C.prototype.fromJSON=function(a){a&&(this.value=a.value)};d.WaitAction=C;var y=function(){p.call(this);this.subtype=y.SUBTYPE;this.page=this.remote=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.ChangePageAction");this._cancelCB=null};util.inherits(y,p);y.SUBTYPE="remote.changepage";y.prototype.do=function(a){this._trace&&
...
l._sendEvent(b[k],h)};this._sendEvent(b[k],h)};y.prototype.cancel=function(a){this._running?(this._canceling=!0,this._cancelCB=a):a&&a(null,this._running)};y.prototype._sendEvent=function(a,b){var c=require("dgram"),g=require("unorm"),e={func:"changePage",remote:g.nfc(this.remote),page:g.nfc(this.page),time:Date.now()};e=new Buffer("{XC_EVT}"+JSON.stringify(e),"utf8");var d=c.createSocket({type:"udp4",reuseAddr:!0});d.bind(a,function(){d.setBroadcast(!0);d.send(e,0,e.length,1902,"255.255.255.255");
d.send(e,0,e.length,1902,"255.255.255.255",function(a){d.close();b&&b(a)})})};y.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.remote=this.remote;a.page=this.page;return a};y.prototype.fromJSON=function(a){a&&(this.remote=a.remote,this.page=a.page)};d.ChangePageAction=y;var z=function(){p.call(this);this.subtype=z.SUBTYPE;this.settings=this.action=this.popup=this.remote=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.PopupAction");
this._cancelCB=null};util.inherits(z,p);z.SUBTYPE="remote.popup";z.prototype.do=function(a){this._trace&&this._trace.log("execute popup action | "+this.remote+"."+this.popup+"."+this.action);this._running=!0;var b=[],c=require("os").networkInterfaces(),g;for(g in c)for(var e=c[g],d=0;d<e.length;d++){var f=e[d];"IPv4"==f.family&&0==f.internal&&b.push(f.address)}var l=this,k=0,h=function(){if(l._canceling){l._logger.log("trace","popup action canceled:"+JSON.stringify(l.toJSON()));l._canceling=!1;var c=
l._running;l._running=!1;var g=l._cancelCB;l._cancelCB=null;g&&g(null,c)}else k++,k>=b.length?(l._running=!1,a&&a()):l._sendEvent(b[k],h)};this._sendEvent(b[k],h)};z.prototype.cancel=function(a){this._running?(this._canceling=!0,this._cancelCB=a):a&&a(null,this._running)};z.prototype._sendEvent=function(a,b){var c=require("dgram"),g=require("unorm"),e={func:"popup",remote:g.nfc(this.remote),action:g.nfc(this.action),time:Date.now()};if(this.popup&&"open"===this.action&&(e.popup=g.nfc(this.popup),
this.settings))try{e.settings=g.nfc(JSON.stringify(this.settings))}catch(M){self._logger.log("error",M.message)}e=new Buffer("{XC_EVT}"+JSON.stringify(e),"utf8");var d=c.createSocket({type:"udp4",reuseAddr:!0});d.bind(a,function(){d.setBroadcast(!0);d.send(e,0,e.length,1902,"255.255.255.255");d.send(e,0,e.length,1902,"255.255.255.255",function(a){d.close();b&&b(a)})})};z.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.remote=this.remote;a.popup=this.popup;
a.action=this.action;a.settings=this.settings;return a};z.prototype.fromJSON=function(a){a&&(this.remote=a.remote,this.popup=a.popup,this.action=a.action,this.settings=a.settings)};d.PopupAction=z;var F=function(){t.call(this);this.subtype=F.SUBTYPE;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.AudioAction")};util.inherits(F,t);F.SUBTYPE="audio";F.prototype.do=function(a){if(this.device||this.gateway)if(this.command){var b=this.command;b.ref&&(b=b.ref);this._logger.log("trace",
"do audio command:"+JSON.stringify(this._toBluredJSON()));var c=this._getDevice(),g=this._getGateway();this._running=!0;this._trace&&this._trace.log("execute audio command | "+this._getDescription());var d=this;require("x.hub.commandman.js").commandHandler.executeCommand(c,g,b,function(b){b&&b.error?d._trace&&d._trace.log("execute command | "+d._getDescription()+" | error:"+b.error.message):d._trace&&d._trace.log("execute command | "+d._getDescription()+" | success");d._running=!1;a&&a()})}else a&&
a(Error("no command"));else a&&a(Error("no device or gateway"))};F.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.device=this.device;a.gateway=this.gateway;a.command=this.command;return a};F.prototype.fromJSON=function(a){a&&(this.device=a.device,this.gateway=a.gateway,this.command=a.command)};d.AudioAction=F;d.parse=function(e){if(!e||!e.type)return null;switch(e.type){case c.TYPE:var n=d.Root;break;case b.TYPE:n=b;break;case p.TYPE:switch(e.subtype){case t.SUBTYPE:n=
...
f;break;case k.TYPE:n=k;break;case h.TYPE:n=h;break;case q.TYPE:n=q;break;case r.TYPE:n=r;break;default:return null}n=new n;n.fromJSON(e);return n};return d}();
