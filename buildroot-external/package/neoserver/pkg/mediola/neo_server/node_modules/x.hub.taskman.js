...
a);a=this.astro.offTime.substr(a+1);g=parseInt(g);a=parseInt(a);if(d.hour()<g||d.hour()==g&&d.minute()<=a)return}g=d.day();0==g&&(g=7);if(!this.astro.week||7!=this.astro.week.length||"0"!=this.astro.week.charAt(g-1)){a=g=!1;var l=null,q=null;d=d.valueOf();var m=this.astro.start;m&&("00"==m.substr(0,2)&&(g=!0,m=h+m.substr(2)),m=b.tz(m,f),m.set({hour:0,minute:0,second:0,millisecond:0}),l=m.valueOf());var r=this.astro.end;r&&("00"==r.substr(0,2)&&(a=!0,r=h+r.substr(2)),r=b.tz(r,f),r.set({hour:23,minute:59,
second:59,millisecond:999}),q=r.valueOf());if(g&&a&&l>q){if(q<d&&l>d)return}else if(m&&l>d||r&&q<d)return;require("x.hub.taskman.js").taskManager.onTimerTick(this.taskID,JSON.stringify(this.astro))}};d.prototype.onLocationChange=function(){this.stop();this.start()};d.prototype.onTimeChange=function(){this.stop();this.start()};var b=function(){this._timers=[]};b.prototype.startTimer=function(b,f){b=new d(b,f);this._timers.push(b);b.start()};b.prototype.stopTimer=function(b){var c=[];this._timers.forEach(function(f){f.taskID==
b?f.stop():c.push(f)});this._timers=c};b.prototype.onLocationChange=function(){this._timers.forEach(function(b){b.onLocationChange()})};b.prototype.onTimeChange=function(){this._timers.forEach(function(b){b.onTimeChange()})};b.prototype.clear=function(){var b=this._timers;this._timers=[];b.forEach(function(b){b.stop()})};b.prototype.getSunriseSunset=function(b){var c=require("moment-timezone"),d=x.hub.taskman._Util._getTimeZone();b=c.tz(b,d);b.set({hour:12,minute:0,second:0,millisecond:0});c=x.hub.taskman._Util._getlatlong();
return require("suncalc").getTimes(b.toDate(),c.lat,c.long)};return new b}();
...
7==this.timer.week.length){g=[];"1"==this.timer.week.charAt(6)&&g.push(0);for(var l=0;6>l;l++)"1"==this.timer.week.charAt(l)&&g.push(l+1);g=g.join(",")}d.push(g);d=d.join(" ");g=x.hub.taskman._Util._getTimeZone();this._logger.log("debug","#"+this.taskID+" start timer:"+JSON.stringify(this.timer));this._logger.log("trace","start cron job:"+d+" tz:"+g);this._cronJob=new (require("cron").CronJob)(d,this.onFirstTick.bind(this),null,!0,g);l=require("moment-timezone");var q=(new Date).getTime();d=l.tz(q,
g);a=d.year();var m=!1;h=!1;var r=null,t=null,p=d.valueOf(),u=this.timer.start;u&&("00"==u.substr(0,2)&&(m=!0,u=a+u.substr(2)),u=l.tz(u,g),u.set({hour:0,minute:0,second:0,millisecond:0}),r=u.valueOf());var w=this.timer.end;w&&("00"==w.substr(0,2)&&(h=!0,w=a+w.substr(2)),w=l.tz(w,g),w.set({hour:23,minute:59,second:59,millisecond:999}),t=w.valueOf());if(m&&h&&r>t){if(t<p&&r>p)return}else if(u&&r>p||w&&t<p)return;if(a=this.timer.week)if(m=d.isoWeekday(),"1"!=a.charAt(m-1))return;m=l.tz(q,g);h=b.indexOf(":");
a=b.substr(0,h);h=b.substr(h+1);m.set({hour:parseInt(a),minute:parseInt(h),second:0,millisecond:0});if(!(m.valueOf()>d.valueOf()||(b=l.tz(q,g),h=f.indexOf(":"),a=f.substr(0,h),h=f.substr(h+1),b.set({hour:parseInt(a),minute:parseInt(h),second:0,millisecond:0}),b.valueOf()<d.valueOf()||!(f=this.timer.interval)))){f=1E3*parseInt(f);f=Math.ceil((d.valueOf()-m.valueOf())/f)*f+m.valueOf()-d.valueOf();this._logger.log("trace","first tick in "+f/1E3+" seconds");var v=this;this._starter=setTimeout(function(){v.onFirstTick()},
f)}}};d.prototype.stop=function(){this._logger.log("debug","stop timer:"+JSON.stringify(this.timer));this._cronJob&&(this._cronJob.stop(),this._cronJob=null);this._repeater&&(clearInterval(this._repeater),this._repeater=null);this._starter&&(clearTimeout(this._starter),this._starter=null)};d.prototype.onFirstTick=function(){this._logger.log("debug","periodic timer first tick:"+JSON.stringify(this.timer));var b=this.timer.interval;if(b){b=1E3*parseInt(b);var d=this;this._starter&&(clearTimeout(this._starter),
this._starter=null);this._repeater&&(clearInterval(this._repeater),this._repeater=null);this._repeater=setInterval(function(){d.onTick()},b);this.onTick()}};d.prototype.onTick=function(){this._logger.log("debug","#"+this.taskID+" periodic timer tick:"+JSON.stringify(this.timer));var b=require("moment-timezone"),d=this.timer.interval;d=1E3*parseInt(d);var k=x.hub.taskman._Util._getTimeZone(),h=(new Date).getTime();d=h+d;var a=b.tz(h,k);h=b.tz(h,k);var g=h.year(),l=!1,q=!1,m=null,r=null,t=h.valueOf(),
p=this.timer.start;p&&("00"==p.substr(0,2)&&(l=!0,p=g+p.substr(2)),p=b.tz(p,k),p.set({hour:0,minute:0,second:0,millisecond:0}),m=p.valueOf());var u=this.timer.end;u&&("00"==u.substr(0,2)&&(q=!0,u=g+u.substr(2)),u=b.tz(u,k),u.set({hour:23,minute:59,second:59,millisecond:999}),r=u.valueOf());if(l&&q&&m>r){if(r<t&&m>t)return}else if(p&&m>t||u&&r<t)return;(k=this.timer.endTime)||(k="23:59");g=k.indexOf(":");b=k.substr(0,g);k=k.substr(g+1);a.set({hour:parseInt(b),minute:parseInt(k),second:59,millisecond:999});
a.valueOf()<h.valueOf()?(this._logger.log("trace","repeater exceed end time:"+a.toString()),this._repeater&&(clearInterval(this._repeater),this._repeater=null)):(d>a.valueOf()&&(this._logger.log("trace","repeater next tick will exceed end time:"+a.toString()),this._repeater&&(clearInterval(this._repeater),this._repeater=null)),require("x.hub.taskman.js").taskManager.onTimerTick(this.taskID,JSON.stringify(this.timer)))};d.prototype.onLocationChange=function(){this.stop();this.start()};d.prototype.onTimeChange=
function(){this.stop();this.start()};var b=function(){this._timers=[]};b.prototype.startTimer=function(b,f){b=new d(b,f);this._timers.push(b);b.start()};b.prototype.stopTimer=function(b){var c=[];this._timers.forEach(function(d){d.taskID==b?d.stop():c.push(d)});this._timers=c};b.prototype.onLocationChange=function(){this._timers.forEach(function(b){b.onLocationChange()})};b.prototype.onTimeChange=function(){this._timers.forEach(function(b){b.onTimeChange()})};b.prototype.clear=function(){var b=this._timers;
...
b[d]?f|=b[d+1]:"XOR"==b[d]&&(f=f!=b[d+1]),d+=2;e&&e(null,f)}};this.flowIf[n].do(g,a)}else e&&e(null,!0)};b.prototype._doThenBlocks=function(e,a){var b=0,n=this;if(this.flowThen&&0!=this.flowThen.length){var c=function(){b++;b<n.flowThen.length?n.flowThen[b].do(c,a):e&&e()};this.flowThen[b].do(c,a)}else e&&e()};b.prototype._doElseBlocks=function(e,a){var b=0,n=this;if(this.flowElse&&0!=this.flowElse.length){var c=function(){b++;b<n.flowElse.length?n.flowElse[b].do(c,a):e&&e()};this.flowElse[b].do(c,
...
task:this._task})}};c.prototype.onStatusEvt=function(e){var a=!1;this._logger.log("trace","check trigger for status event");for(var b=null,c=0;c<this.flowIf.length;c++){var g=this.flowIf[c];if((g.type==m.TYPE||g.type==t.TYPE)&&g.isMatch(e)){this._logger.log("debug","trigger hit:"+JSON.stringify(g.toJSON()));a=!0;b=g;break}}a&&this._onTriggered(null,b)};c.prototype.onDedicatedStatusEvt=function(e){var a=!1;this._logger.log("trace","check trigger for status event");for(var b=null,c=0;c<this.flowIf.length;c++){var g=
this.flowIf[c];if(g.type==m.TYPE){if(g.isMatch(e)){this._logger.log("debug","trigger hit:"+JSON.stringify(g.toJSON()));a=!0;b=g;break}}else if(g.type==t.TYPE&&g.isMatch(e)){this._logger.log("debug","trigger hit:"+JSON.stringify(g.toJSON()));a=!0;b=g;break}}a&&this._onTriggered(null,b)};c.prototype.onIREvt=function(e){this._trace&&this._trace.log("root | receive ir event:"+JSON.stringify(e));var a=!1;this._logger.log("trace","check trigger for ir event");for(var b=0;b<this.flowIf.length;b++){var c=
this.flowIf[b];if(c.type==q.TYPE&&c.isMatch(e)){this._logger.log("debug","trigger hit:"+JSON.stringify(c.toJSON()));a=!0;break}}a&&this._onTriggered()};c.prototype.onTimerTick=function(e){this._trace&&this._trace.log("root | timer tick:"+e);this._onTriggered()};c.prototype.onHttpEvt=function(e,a){this._trace&&this._trace.log("root | receive http event:"+JSON.stringify(e));for(var b=!1,c=0;c<this.flowIf.length;c++){var g=this.flowIf[c];if(g.type==h.TYPE&&g.isMatch(e)){this._logger.log("info","trigger hit:"+
...
function(e){if(!e||!this.params)return!1;for(var a in this.params)if(a&&this.params[a]!=e[a]&&this.params[a]!=e[encodeURIComponent(a)])return!1;this._logger.log("trace","trigger hit:"+JSON.stringify(this.toJSON()));return!0};h.prototype.toJSON=function(){var e=d.prototype.toJSON.call(this);e.params=this.params;return e};h.prototype.fromJSON=function(e){e&&(this.params=e.params)};d.HttpTrigger=h;var a=function(){d.call(this);this.type=a.TYPE;this.op=this.end=this.start=this.week=this.time=null;this._logger=
require("x.logger.js").getLogger("x.hub.taskman._Block.Timer")};util.inherits(a,d);a.TYPE="timer";a.prototype.init=function(e){x.hub.taskman._TimerManager.startTimer(e,this)};a.prototype.do=function(e){this._trace&&this._trace.log("check time | "+this._getDescription());var a=require("moment-timezone"),b=x.hub.taskman._Util._getTimeZone(),c=(new Date).getTime();c=a.tz(c,b);var g=c.year(),d=!1,f=!1,l=null,k=null,q=c.valueOf(),h=this.start;h&&("00"==h.substr(0,2)&&(d=!0,h=g+h.substr(2)),h=a.tz(h,b),
h.set({hour:0,minute:0,second:0,millisecond:0}),l=h.valueOf());var m=this.end;m&&("00"==m.substr(0,2)&&(f=!0,m=g+m.substr(2)),m=a.tz(m,b),m.set({hour:23,minute:59,second:59,millisecond:999}),k=m.valueOf());if(d&&f&&l>k){if(k<q&&l>q){this._logger.log("trace","condition mismatch:"+JSON.stringify(this.toJSON()));e&&e(null,!1);return}}else if(h&&l>q||m&&k<q){this._logger.log("trace","condition mismatch:"+JSON.stringify(this.toJSON()));e&&e(null,!1);return}if(a=this.week)if(b=c.day(),0==b&&(b=7),"1"!=
...
JSON.stringify(this.toJSON()));e&&e(null,!0)};a.prototype.finalize=function(e){x.hub.taskman._TimerManager.stopTimer(e)};a.prototype.toJSON=function(){var e=d.prototype.toJSON.call(this);e.time=this.time;e.week=this.week;e.start=this.start;e.end=this.end;e.op=this.op;return e};a.prototype.fromJSON=function(e){e&&(this.time=e.time,this.week=e.week,this.start=e.start,this.end=e.end,this.op=e.op)};a.prototype._getDescription=function(){var e="time:"+this.time;e+=" week:"+this.week;e+=" start:"+this.start;
e+=" end:"+this.end;return e+=" op:"+this.op};d.Timer=a;var g=function(){d.call(this);this.type=g.TYPE;this.op=this.end=this.start=this.week=this.delay=this.offTime=this.astro=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.Astro")};util.inherits(g,d);g.TYPE="astro";g.prototype.init=function(e){x.hub.taskman._AstroManager.startTimer(e,this)};g.prototype.do=function(e){this._trace&&this._trace.log("check astro | "+this._getDescription());var a=require("moment-timezone"),b=
x.hub.taskman._Util._getTimeZone(),c=(new Date).getTime();c=a.tz(c,b);var g=c.year(),d=!1,f=!1,l=null,k=null,q=c.valueOf(),h=this.start;h&&("00"==h.substr(0,2)&&(d=!0,h=g+h.substr(2)),h=a.tz(h,b),h.set({hour:0,minute:0,second:0,millisecond:0}),l=h.valueOf());var m=this.end;m&&("00"==m.substr(0,2)&&(f=!0,m=g+m.substr(2)),m=a.tz(m,b),m.set({hour:23,minute:59,second:59,millisecond:999}),k=m.valueOf());if(d&&f&&l>k){if(k<q&&l>q){this._logger.log("trace","condition mismatch:"+JSON.stringify(this.toJSON()));
...
this.op&&c.valueOf()>=b?a=!0:">"==this.op&&c.valueOf()>b?a=!0:"<="==this.op&&c.valueOf()<=b?a=!0:"<"==this.op&&c.valueOf()<b?a=!0:("="==this.op||"=="==this.op)&&c.valueOf()==b&&(a=!0));this._logger.log("trace","condition "+(a?"match":"mismatch")+":"+JSON.stringify(this.toJSON()));e&&e(null,a)};g.prototype.finalize=function(e){x.hub.taskman._AstroManager.stopTimer(e)};g.prototype.toJSON=function(){var e=d.prototype.toJSON.call(this);e.astro=this.astro;e.offTime=this.offTime;e.delay=this.delay;e.week=
this.week;e.start=this.start;e.end=this.end;e.op=this.op;return e};g.prototype.fromJSON=function(e){e&&(this.astro=e.astro,this.offTime=e.offTime,this.delay=e.delay,this.week=e.week,this.start=e.start,this.end=e.end,this.op=e.op)};g.prototype._getDescription=function(){var e="astro:"+this.astro;e+=" offTime:"+this.offTime;e+=" delay:"+this.delay;e+=" week:"+this.week;e+=" start:"+this.start;e+=" end:"+this.end;return e+=" op:"+this.op};d.Astro=g;var l=function(){d.call(this);this.type=l.TYPE;this.end=
this.start=this.week=this.endTime=this.startTime=this.interval=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.Periodic")};util.inherits(l,d);l.TYPE="periodic";l.prototype.init=function(e){x.hub.taskman._PeriodicTimerManager.startTimer(e,this)};l.prototype.finalize=function(e){x.hub.taskman._PeriodicTimerManager.stopTimer(e)};l.prototype.toJSON=function(){var e=d.prototype.toJSON.call(this);e.interval=this.interval;e.startTime=this.startTime;e.endTime=this.endTime;e.week=
this.week;e.start=this.start;e.end=this.end;return e};l.prototype.fromJSON=function(e){e&&(this.interval=e.interval,this.startTime=e.startTime,this.endTime=e.endTime,this.week=e.week,this.start=e.start,this.end=e.end)};d.Periodic=l;var q=function(){d.call(this);this.type=q.TYPE;this._lastTiggerTime=this.ir=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.IRTrigger")};util.inherits(q,d);q.TYPE="ir";q.prototype.isMatch=function(e){if(!(e&&e.code&&this.ir&&this.ir.code))return!1;
var a=this._getDataCode(this.ir.code);e=this._getDataCode(e.code);if(a==e){a=(new Date).getTime();if(!this._lastTiggerTime)return this._lastTiggerTime=a,!0;if(1E3>a-this._lastTiggerTime)return!1;this._lastTiggerTime=a;return!0}return!1};q.prototype.toJSON=function(){var e=d.prototype.toJSON.call(this);e.ir=this.ir;return e};q.prototype.fromJSON=function(e){e&&(this.ir=e.ir)};q.prototype._getDataCode=function(e){e=new Buffer(e,"hex");var a=e.readInt8(8);return e.slice(4*a+9).toString("hex")};d.IRTrigger=
q;var m=function(){d.call(this);this.type=m.TYPE;this._cancelCB=this._lastStatus=this._lastTiggerTime=this.hysteresis=this.value=this.op=this.status=this.gateway=this.device=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.DeviceStatus");this._gatewayName=this._deviceName=null};util.inherits(m,d);m.TYPE="device.status";m.prototype.init=function(e){if((this.device||this.gateway)&&this.status){var a=null;this.gateway&&this.gateway.sys&&(a=this.gateway.sys);!a&&this.device&&this.device.sys&&
(a=this.device.sys);if(a&&("hm"!=a||this.gateway?"neoserver"==a&&(a="aio"):a="aio",(a=require("x.hub.moduleman.js").modulemanager.getModule(a))&&a.addStateDevice)){var b={},c=this._getDevice(),g=this._getGateway();c&&(b=c);delete b.gateway;g&&(b.gateway=g);c=this.status;c.ref&&c.ref.value?c=c.ref.value:c.value&&(c=c.value);a.addStateDevice(b,null,{taskID:e,statusKey:c,src:"taskman",callback:this})}}};m.prototype.finalize=function(e){if(this.device||this.gateway){var a=null;this.gateway&&this.gateway.sys&&
(a=this.gateway.sys);!a&&this.device&&this.device.sys&&(a=this.device.sys);if(a&&("hm"!=a||this.gateway?"neoserver"==a&&(a="aio"):a="aio",(a=require("x.hub.moduleman.js").modulemanager.getModule(a))&&a.removeStateDevice)){var b={},c=this._getDevice(),g=this._getGateway();c&&(b=c);delete b.gateway;g&&(b.gateway=g);c=this.status;c.ref&&c.ref.value?c=c.ref.value:c.value&&(c=c.value);a.removeStateDevice(b,null,{taskID:e,statusKey:c,src:"taskman",callback:this})}}};m.prototype.do=function(a){if(this.device||
this.gateway)if(this.status&&this.op){var e=this.status;this.status.ref&&(e=this.status.ref);e.value&&(e=e.value);e={value:e};this.status&&this.status.value?e=this.status:this.status&&this.status.ref&&(e=this.status.ref);var b=this,c=this._getDevice(),g=this._getGateway();this._logger.log("trace","get states:"+JSON.stringify(this._toBluredJSON()));this._trace&&this._trace.log("get status | "+this._getDescription());this._running=!0;require("x.hub.commandman.js").commandHandler.getState(c,g,e,function(e){if(b._canceling){b._logger.log("trace",
"get states canceled:"+JSON.stringify(b._toBluredJSON()));b._canceling=!1;e=b._running;b._running=!1;var c=b._cancelCB;b._cancelCB=null;c&&c(null,e)}else if(b._running=!1,!e||e.error?b._trace&&b._trace.log("get status | "+b._getDescription()+" | error:"+(e?e.error.message:"invalid response")):("undefined"==typeof e.data||null==e.data)&&b._trace&&b._trace.log("get status | "+b._getDescription()+" | error:no status"),!e||e.error)a&&a(e?e.error:Error("get state error"));else if("undefined"==typeof e.data||
null==e.data)a&&a(null,!1);else{c=e.data.value;var g=!1;"="==b.op||"=="==b.op?g="true"==b.value?"true"==String(c):"false"==b.value?"false"==String(c):c==b.value:"!="==b.op?g="true"==b.value?"true"!=String(c):"false"==b.value?"false"!=String(c):c!=b.value:">="==b.op?g=parseFloat(c)>=parseFloat(b.value):">"==b.op?g=parseFloat(c)>parseFloat(b.value):"<="==b.op?g=parseFloat(c)<=parseFloat(b.value):"<"==b.op&&(g=parseFloat(c)<parseFloat(b.value));b._logger.log("trace","condition "+(g?"match":"mismatch")+
...
id:this.device.id,state:a},comp:{value:this.value,operator:this.op}}};if("undefined"!=typeof this.hysteresis&&null!=this.hysteresis)if("="==this.op||"=="==this.op)a.event.comp.hyst=.1;else if(">="==this.op||">"==this.op)a.event.comp.hyst=parseFloat(this.value)-parseFloat(this.hysteresis);else if("<="==this.op||"<"==this.op)a.event.comp.hyst=parseFloat(this.hysteresis)-parseFloat(this.value);return a};d.CloudDeviceTrigger=r;var t=function(){d.call(this);this.type=t.TYPE;this.gateway=this.device=null;
...
this._lastHit=null};util.inherits(t,m);t.TYPE="device.dominoswiss.weatherstation";t.prototype.init=function(a){if(this.device||this.gateway){var e=null;this.gateway&&this.gateway.sys&&(e=this.gateway.sys);!e&&this.device&&this.device.sys&&(e=this.device.sys);if(e&&(e=require("x.hub.moduleman.js").modulemanager.getModule(e))&&e.addStateDevice){var b={},c=this._getDevice(),g=this._getGateway();c&&(b=c);delete b.gateway;g&&(b.gateway=g);e.addStateDevice(b,null,{taskID:a,statusKey:"*",src:"taskman"})}}};
t.prototype.finalize=function(a){if(this.device||this.gateway){var e=null;this.gateway&&this.gateway.sys&&(e=this.gateway.sys);!e&&this.device&&this.device.sys&&(e=this.device.sys);if(e&&(e=require("x.hub.moduleman.js").modulemanager.getModule(e))&&e.removeStateDevice){var b={},c=this._getDevice(),g=this._getGateway();c&&(b=c);delete b.gateway;g&&(b.gateway=g);e.removeStateDevice(b,null,{taskID:a,statusKey:"*",src:"taskman"})}}};t.prototype.isMatch=function(a){if(!a||!a.device||!a.device.sys)return!1;
var e=require("x.hub.moduleman.js").modulemanager.getModule(a.device.sys);if(!e||!e.checkDeviceMatch)return!1;var b=this._getDevice(),c=this._getGateway();if(!e.checkDeviceMatch({device:b,gateway:c},a))return!1;this._logger.log("trace","receive event for device:"+JSON.stringify(a));b=e=!1;c=this._matchUpperThreshold(a);a=this._matchLowerThreshold(a);this._logger.log("trace","upperMatch:"+c+" - lowerMatch:"+a);if("upper"==this._lastHit&&!a)return this._logger.log("trace","lastHit:upper - lowerMatch:"+
a),!1;if("lower"==this._lastHit&&!c)return this._logger.log("trace","lastHit:lower - upperMatch:"+c),!1;"upper"==this._lastHit&&a&&(this._lastHit=null);"lower"==this._lastHit&&c&&(this._lastHit=null);1==c&&(this._upperMatchCount+=1,65535<this._upperMatchCount&&(this._upperMatchCount=1));switch(this._upper_threshold_state){case 0:1==c&&("undefined"!=typeof this.upperThreshold.delay&&null!=this.upperThreshold.delay&&0<parseInt(this.upperThreshold.delay)?this._handleUpperThresholdDelay():(e=!0,this.upperThreshold.repeat&&
...
0)}switch(this._lower_threshold_state){case 0:1==a&&0<this._upperMatchCount&&("undefined"!=typeof this.lowerThreshold.delay&&null!=this.lowerThreshold.delay&&0<parseInt(this.lowerThreshold.delay)?this._handleLowerThresholdDelay():(b=!0,this._upperMatchCount=0,this.lowerThreshold.repeat&&this._handleLowerThresholdRepeat()));break;case 1:0==a&&(this._logger.log("trace","lower threshold not match, clear delay timeout"),this._lower_threshold_deley_to&&(clearTimeout(this._lower_threshold_deley_to),this._lower_threshold_deley_to=
null),this._lower_threshold_state=0);break;case 2:0==a&&(this._logger.log("trace","lower threshold not match, clear repeat timeout"),this._lower_threshold_repeat_to&&(clearTimeout(this._lower_threshold_repeat_to),this._lower_threshold_repeat_to=null),this._lower_threshold_state=0)}this._lastTigger={upperThreshold:e,lowerThreshold:b};this._logger.log("trace","upperHit:"+e+" - lowerHit:"+b);e?this._lastHit="upper":b&&(this._lastHit="lower");return e|b};t.prototype._matchUpperThreshold=function(a){if(!(this.upperThreshold&&
...
typeof e||null==e)e=0;return this._matchThreshold(b,e,a.data.value)};t.prototype._matchThreshold=function(a,b,c){return"="==a||"=="==a?"true"==b?"true"==String(c):"false"==b?"false"==String(c):b==c:">="==a?parseFloat(c)>=parseFloat(b):">"==a?parseFloat(c)>parseFloat(b):"<="==a?parseFloat(c)<=parseFloat(b):"<"==a?parseFloat(c)<parseFloat(b):!1};t.prototype._handleUpperThresholdDelay=function(){var a=this;this._upper_threshold_state=1;this._logger.log("trace","start upper threshold hit delay timeout:"+
...
a)}catch(N){}},c)};t.prototype._handleLowerThresholdRepeat=function(){var a=this;this._lower_threshold_state=2;var b=this.lowerThreshold.repeat,c=0;if(b&&"string"==typeof b&&b.match(/^([0-1]?[0-9]|2[0-3])(:[0-5][0-9])?$/g)){c=require("moment-timezone");var g=x.hub.taskman._Util._getTimeZone(),d=(new Date).getTime();d=c.tz(d,g);var f=parseInt(b.substr(0,b.indexOf(":")));b=parseInt(b.substr(b.indexOf(":")+1));var l=(new Date).getTime();l=c.tz(l,g);l.set({hour:f,minute:b,second:0,millisecond:0});c=l.valueOf()-
...
a._parent._onTriggered(null,a)}catch(N){}},c)};t.prototype.toJSON=function(){var a=d.prototype.toJSON.call(this);a.device=this.device;a.gateway=this.gateway;a.upperThreshold=this.upperThreshold;a.lowerThreshold=this.lowerThreshold;return a};t.prototype.fromJSON=function(a){a&&(this.device=a.device,this.gateway=a.gateway,this.upperThreshold=a.upperThreshold,this.lowerThreshold=a.lowerThreshold)};d.DominoswissWS=t;var p=function(){d.call(this);this.type=p.TYPE};util.inherits(p,d);p.TYPE="action";d.Action=
p;var u=function(){p.call(this);this.subtype=u.SUBTYPE;this.body=this.event=this.key=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.IFTTTMakerAction")};util.inherits(u,p);u.SUBTYPE="iftttmaker";u.prototype.do=function(a){if(this.key||this.event){var b=a;a={hostname:"maker.ifttt.com",port:443,path:"/trigger/"+this.event+"/with/key/"+this.key,method:"POST",headers:{"Content-Type":"application/json"}};this._logger.log("trace","send https:"+JSON.stringify(a));this._logger.log("trace",
"with data:"+JSON.stringify(this.body));var e=this;a=require("https").request(a,function(a){a.setEncoding("utf8");var c="";a.on("data",function(a){c+=a});a.on("end",function(){e._logger.log("trace","action response:"+a.statusCode);e._logger.log("trace","with data:"+c);b&&(b(null,a.statusCode,c),b=null)})});a.on("error",function(a){e._logger.log("debug","do action err:"+a.stack);b&&(b(a),b=null)});a.setTimeout(5E3,function(){e._logger.log("debug","do action timeout");b&&(b(Error("timeout")),b=null)});
if(this.body)try{var c=JSON.stringify(this.body);a.write(c)}catch(P){}a.end()}else a&&a(Error("no key or event"))};u.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.key=this.key;a.event=this.event;a.body=this.body;return a};u.prototype.fromJSON=function(a){a&&(this.key=a.key,this.event=a.event,this.body=a.body)};d.IFTTTMakerAction=u;var w=function(){p.call(this);this.subtype=w.SUBTYPE;this._cancelCB=this._doCB=this.body=this.headers=this.query=this.pathname=
this.port=this.hostname=this.auth=this.protocol=this.method=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.HttpAction")};util.inherits(w,p);w.SUBTYPE="http.action";w.prototype.do=function(a){var b=this.method;b||(b="GET");var e=this.protocol;e||(e="http");var c=this.port;if(!c||0>=parseInt(c))c="https"==e?443:80;var g=require("querystring"),d=this.pathname?this.pathname:"/";this.query&&(d+="?"+g.stringify(this.query));c={hostname:this.hostname,port:c,path:d,method:b,headers:this.headers};
this.auth&&(c.auth=this.auth);this._logger.log("trace","send "+e+" "+b+":"+JSON.stringify(c));this._logger.log("trace","with data:"+JSON.stringify(this.body));this._trace&&(this._trace.log("execute http | "+e+" "+b+":"+JSON.stringify(c)),this._trace.log("execute http | with data:"+JSON.stringify(this.body)));this._running=!0;this._doCB=a;var f=this;a=require(e).request(c,function(a){a.setEncoding("utf8");var b="";a.on("data",function(a){b+=a});a.on("end",function(){f._logger.log("trace","action response:"+
...
JSON.parse(JSON.stringify(this.gateway)),tmp.username&&(tmp.username="xxxxxx"),tmp.password&&(tmp.password="xxxxxx"),a=JSON.stringify(tmp)}catch(J){a=JSON.stringify(this.gateway)}var b=this.command;b.ref&&(b=b.ref);return a+" | "+JSON.stringify(b)};v.prototype._getLocalIP=function(){var a=require("os").networkInterfaces(),b;for(b in a)for(var c=a[b],g=0;g<c.length;g++){var d=c[g];if(d&&"IPv4"==d.family&&0==d.internal)return d.address}return null};v.prototype._getLocalPort=function(){var a=require("x.hub.js");
return a.server?a.server._port:null};v.prototype._buildSonosCommand=function(a){var b=this._getLocalIP(),c=this._getLocalPort();if(!b||!c)return null;switch(a){case "alarm_on":a="alarm_on.mp3";break;case "alarm_off":a="alarm_off.mp3";break;case "pre_alarm":a="pre_alarm.mp3";break;case "alarm":a="alarm.mp3";break;default:return null}return{value:"playUrl",ext:"http://"+b+":"+c+"/resources/rehau_alarm/"+a}};d.CommandAction=v;var K=function(){p.call(this);this.subtype=K.SUBTYPE;this._cancelCB=this.command=
this.gateway=this.device=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.BrelagUpperThresholdAction")};util.inherits(K,v);K.SUBTYPE="command.dominoswiss.upperthreshold";K.prototype.do=function(a,b){if(b&&b.trigger&&b.trigger.type==t.TYPE){var c=b.trigger._lastTigger;c&&c.upperThreshold?v.prototype.do.call(this,a,b):a&&a()}else a&&a()};d.BrelagUpperThresholdAction=K;var L=function(){p.call(this);this.subtype=L.SUBTYPE;this._cancelCB=this.command=this.gateway=this.device=null;
this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.BrelagLowerThresholdAction")};util.inherits(L,v);L.SUBTYPE="command.dominoswiss.lowerthreshold";L.prototype.do=function(a,b){if(b&&b.trigger&&b.trigger.type==t.TYPE){var c=b.trigger._lastTigger;c&&c.lowerThreshold?v.prototype.do.call(this,a,b):a&&a()}else a&&a()};d.BrelagUpperThresholdAction=L;var E=function(){p.call(this);this.subtype=E.SUBTYPE;this.actionID=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.CloudAction")};
util.inherits(E,p);E.SUBTYPE="cloud_action";E.prototype.do=function(a){if(this.actionID){this._logger.log("trace","do cloud action:"+this.actionID);var b=require("x.hub.js").server;if(b)if(b=b._cloudConnect){var c=JSON.stringify({type:"ACTION",data:this.actionID});c=new Buffer("EVT:"+c,"utf8");b.sendMessageActive("0103"+c.toString("hex"),function(b){a&&a(b)})}else a&&a(Error("no cloud connect"));else a&&a(Error("no server in hub"))}else a&&a(Error("action id is empty"))};E.prototype.cancel=function(a){a&&
a(null,!1)};E.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.actionID=this.actionID;return a};E.prototype.fromJSON=function(a){a&&(this.actionID=a.actionID)};var y=function(){p.call(this);this.subtype=y.SUBTYPE;this.macroName=this.groupName=null;this._canceling=!1;this._macroExecutorID=this._cancelCB=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.MacroAction")};util.inherits(y,p);y.SUBTYPE="macro";y.prototype.do=function(a){if(this.groupName&&
...
null,b&&b()):(c._running=!1,a&&a(b))},function(a){a&&a.id&&(c._macroExecutorID=a.id)})}else a&&a(Error("no group or macro"))};y.prototype.cancel=function(a){this._running?(this._canceling=!0,this._cancelCB=a,this._macroExecutorID&&require("x.hub.macroman.js").cancel(this._macroExecutorID)):a&&a(null,this._running)};y.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.groupName=this.groupName;a.macroName=this.macroName;return a};y.prototype.fromJSON=function(a){a&&
(this.groupName=a.groupName,this.macroName=a.macroName)};y.prototype._getDescription=function(){return this.groupName+"."+this.macroName};d.MacroAction=y;var C=function(){p.call(this);this._cancelCB=this.token=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.SnsAction")};util.inherits(C,p);C.prototype.do=function(a){if(this.token){var b=this;this._logger.log("trace","do sns:"+JSON.stringify(this.toJSON()));var c=new x.hub.taskman.Cloud;this._running=!0;this._trace&&this._trace.log("execute sns | "+
this._getDescription());c._doRequest("GET","/xhub/sns/dosns?token="+this.token,null,null,null,null,function(c,e){b._trace&&b._trace.log("execute sns | "+b._getDescription()+" | "+(c?"error:"+c.message:"response:"+e));b._canceling?(b._logger.log("trace","sns action canceled:"+JSON.stringify(b.toJSON())),b._canceling=!1,c=b._running,b._running=!1,e=b._cancelCB,b._cancelCB=null,e&&e(null,c)):(b._running=!1,c&&b._logger.log("warn","do sns error:"+c.stack),a&&a(c))})}else a&&a(Error("token is empty"))};
C.prototype.cancel=function(a){this._running?(this._canceling=!0,this._cancelCB=a):a&&a(null,this._running)};C.prototype._getDescription=function(){return this.subtype+"."+this.token};var G=function(){C.call(this);this.subtype=G.SUBTYPE;this.token=null};util.inherits(G,C);G.SUBTYPE="EMAIL";G.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.token=this.token;return a};G.prototype.fromJSON=function(a){a&&(this.token=a.token)};d.EmailAction=G;var H=function(){C.call(this);
this.subtype=H.SUBTYPE;this.token=null};util.inherits(H,C);H.SUBTYPE="PUSH";H.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.token=this.token;return a};H.prototype.fromJSON=function(a){a&&(this.token=a.token)};d.PushAction=H;var I=function(){C.call(this);this.subtype=I.SUBTYPE;this.token=null};util.inherits(I,C);I.SUBTYPE="SMS";I.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.token=this.token;return a};I.prototype.fromJSON=
function(a){a&&(this.token=a.token)};d.SmsAction=I;var O=function(a,b){this._runCallback=b;this._finishCallback=null;this._action=a;var c=this;this.runCallback=function(a){c._action.removeRunTask(c);c._runCallback&&c._runCallback(a)};this.finishCallback=function(){c._action.removeRunTask(c)}},z=function(){p.call(this);this.subtype=z.SUBTYPE;this.name=this.id=null;this._scriptRunTasks=[];this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.ScriptAction")};util.inherits(z,p);z.SUBTYPE=
...
!1;this._logger.log("trace","script action canceled:"+JSON.stringify(this.toJSON()));b.stopScript(this.id,function(){a&&a(null,!0)})}else a&&a(null,this._running)};z.prototype.removeRunTask=function(a){a=this._scriptRunTasks.indexOf(a);-1!=a&&this._scriptRunTasks.splice(a,1);0==this._scriptRunTasks.length&&(this._running=!1)};z.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.id=this.id;a.name=this.name;return a};z.prototype.fromJSON=function(a){a&&(this.id=
a.id,this.name=a.name)};d.ScriptAction=z;var D=function(){p.call(this);this.subtype=D.SUBTYPE;this._to=this.value=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.WaitAction")};util.inherits(D,p);D.SUBTYPE="wait";D.prototype.do=function(a){if(this.value){this._running=!0;var b=this;this._trace&&this._trace.log("execute wait | wait "+this.value+" ms");this._to=setTimeout(function(){b._trace&&b._trace.log("execute wait | wait expired");b._running=!1;b._to=null;a&&a()},this.value)}else a&&
a()};D.prototype.cancel=function(a){this._running?(this._to&&(this._logger.log("trace","wait action canceled:"+JSON.stringify(this.toJSON())),clearTimeout(this._to),this._to=null),this._running=!1,a&&a(null,!0)):a&&a(null,this._running)};D.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.value=this.value;return a};D.prototype.fromJSON=function(a){a&&(this.value=a.value)};d.WaitAction=D;var A=function(){p.call(this);this.subtype=A.SUBTYPE;this.page=this.remote=
null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.ChangePageAction");this._cancelCB=null};util.inherits(A,p);A.SUBTYPE="remote.changepage";A.prototype.do=function(a){this._trace&&this._trace.log("execute change page | "+this.remote+"."+this.page);this._running=!0;var b=[],c=require("os").networkInterfaces(),g;for(g in c)for(var e=c[g],d=0;d<e.length;d++){var f=e[d];"IPv4"==f.family&&0==f.internal&&b.push(f.address)}var l=this,k=0,q=function(){if(l._canceling){l._logger.log("trace",
"change page action canceled:"+JSON.stringify(l.toJSON()));l._canceling=!1;var c=l._running;l._running=!1;var g=l._cancelCB;l._cancelCB=null;g&&g(null,c)}else k++,k>=b.length?(l._running=!1,a&&a()):l._sendEvent(b[k],q)};this._sendEvent(b[k],q)};A.prototype.cancel=function(a){this._running?(this._canceling=!0,this._cancelCB=a):a&&a(null,this._running)};A.prototype._sendEvent=function(a,b){var c=require("dgram"),g=require("unorm"),e={func:"changePage",remote:g.nfc(this.remote),page:g.nfc(this.page),
time:Date.now()};e=new Buffer("{XC_EVT}"+JSON.stringify(e),"utf8");var d=c.createSocket({type:"udp4",reuseAddr:!0});d.bind(a,function(){d.setBroadcast(!0);d.send(e,0,e.length,1902,"255.255.255.255");d.send(e,0,e.length,1902,"255.255.255.255",function(a){d.close();b&&b(a)})})};A.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.remote=this.remote;a.page=this.page;return a};A.prototype.fromJSON=function(a){a&&(this.remote=a.remote,this.page=a.page)};d.ChangePageAction=
A;var B=function(){p.call(this);this.subtype=B.SUBTYPE;this.template=this.settings=this.action=this.popup=this.remote=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.PopupAction");this._cancelCB=null};util.inherits(B,p);B.SUBTYPE="remote.popup";B.prototype.do=function(a){this._trace&&this._trace.log("execute popup action | "+this.remote+"."+this.popup+"."+this.action);this._running=!0;var b=[],c=require("os").networkInterfaces(),g;for(g in c)for(var e=c[g],d=0;d<e.length;d++){var f=
e[d];"IPv4"==f.family&&0==f.internal&&b.push(f.address)}var l=this,k=0,q=function(){if(l._canceling){l._logger.log("trace","popup action canceled:"+JSON.stringify(l.toJSON()));l._canceling=!1;var c=l._running;l._running=!1;var g=l._cancelCB;l._cancelCB=null;g&&g(null,c)}else k++,k>=b.length?(l._running=!1,a&&a()):l._sendEvent(b[k],q)};this._sendEvent(b[k],q)};B.prototype.cancel=function(a){this._running?(this._canceling=!0,this._cancelCB=a):a&&a(null,this._running)};B.prototype._sendEvent=function(a,
b){var c=require("dgram"),g=require("unorm"),e={func:"popup",remote:g.nfc(this.remote),action:g.nfc(this.action),time:Date.now()};if(this.popup&&"open"===this.action&&(e.popup=g.nfc(this.popup),this.settings))try{e.settings=g.nfc(JSON.stringify(this.settings))}catch(M){self._logger.log("error",M.message)}e=new Buffer("{XC_EVT}"+JSON.stringify(e),"utf8");var d=c.createSocket({type:"udp4",reuseAddr:!0});d.bind(a,function(){d.setBroadcast(!0);d.send(e,0,e.length,1902,"255.255.255.255");d.send(e,0,e.length,
1902,"255.255.255.255",function(a){d.close();b&&b(a)})})};B.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.remote=this.remote;a.popup=this.popup;a.action=this.action;a.settings=this.settings;a.template=this.template;return a};B.prototype.fromJSON=function(a){a&&(this.remote=a.remote,this.popup=a.popup,this.action=a.action,this.settings=a.settings,this.template=a.template)};d.PopupAction=B;var F=function(){v.call(this);this.subtype=F.SUBTYPE;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.AudioAction")};
util.inherits(F,v);F.SUBTYPE="audio";F.prototype.do=function(a){if(this.device||this.gateway)if(this.command){var b=this.command;b.ref&&(b=b.ref);this._logger.log("trace","do audio command:"+JSON.stringify(this._toBluredJSON()));var c=this._getDevice(),g=this._getGateway();this._running=!0;this._trace&&this._trace.log("execute audio command | "+this._getDescription());var d=this;require("x.hub.commandman.js").commandHandler.executeCommand(c,g,b,function(b){b&&b.error?d._trace&&d._trace.log("execute command | "+
d._getDescription()+" | error:"+b.error.message):d._trace&&d._trace.log("execute command | "+d._getDescription()+" | success");d._running=!1;a&&a()})}else a&&a(Error("no command"));else a&&a(Error("no device or gateway"))};F.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.device=this.device;a.gateway=this.gateway;a.command=this.command;return a};F.prototype.fromJSON=function(a){a&&(this.device=a.device,this.gateway=a.gateway,this.command=a.command)};d.AudioAction=
F;d.parse=function(e){if(!e||!e.type)return null;switch(e.type){case c.TYPE:var n=d.Root;break;case b.TYPE:n=b;break;case p.TYPE:switch(e.subtype){case v.SUBTYPE:n=v;break;case K.SUBTYPE:n=K;break;case L.SUBTYPE:n=L;break;case G.SUBTYPE:n=G;break;case H.SUBTYPE:n=H;break;case I.SUBTYPE:n=I;break;case z.SUBTYPE:n=z;break;case D.SUBTYPE:n=D;break;case y.SUBTYPE:n=y;break;case u.SUBTYPE:n=u;break;case w.SUBTYPE:n=w;break;case A.SUBTYPE:n=A;break;case E.SUBTYPE:n=E;break;case F.SUBTYPE:n=F;break;case B.SUBTYPE:n=
B;break;default:return null}break;case m.TYPE:n=m;break;case t.TYPE:n=t;break;case a.TYPE:n=a;break;case g.TYPE:n=g;break;case l.TYPE:n=l;break;case f.TYPE:n=f;break;case k.TYPE:n=k;break;case h.TYPE:n=h;break;case q.TYPE:n=q;break;case r.TYPE:n=r;break;default:return null}n=new n;n.fromJSON(e);return n};return d}();
