...
g);a=d.year();var m=this.timer.start;if(m&&("00"==m.substr(0,2)&&(m+=m.substr(2)),m=l.tz(m,g),m.set({hour:0,minute:0,second:0,millisecond:0}),m.valueOf()>d.valueOf()))return;if(m=this.timer.end)if("00"==m.substr(0,2)&&(m=a+m.substr(2)),m=l.tz(m,g),m.set({hour:23,minute:59,second:59,millisecond:999}),m.valueOf()<d.valueOf())return;if(a=this.timer.week)if(m=d.isoWeekday(),"1"!=a.charAt(m-1))return;m=l.tz(q,g);h=b.indexOf(":");a=b.substr(0,h);h=b.substr(h+1);m.set({hour:parseInt(a),minute:parseInt(h),
second:0,millisecond:0});if(!(m.valueOf()>d.valueOf()||(b=l.tz(q,g),h=f.indexOf(":"),a=f.substr(0,h),h=f.substr(h+1),b.set({hour:parseInt(a),minute:parseInt(h),second:0,millisecond:0}),b.valueOf()<d.valueOf()||!(f=this.timer.interval)))){f=1E3*parseInt(f);f=Math.ceil((d.valueOf()-m.valueOf())/f)*f+m.valueOf()-d.valueOf();this._logger.log("trace","first tick in "+f/1E3+" seconds");var r=this;this._starter=setTimeout(function(){r.onFirstTick()},f)}}};d.prototype.stop=function(){this._logger.log("debug",
"stop timer:"+JSON.stringify(this.timer));this._cronJob&&(this._cronJob.stop(),this._cronJob=null);this._repeater&&(clearInterval(this._repeater),this._repeater=null);this._starter&&(clearTimeout(this._starter),this._starter=null)};d.prototype.onFirstTick=function(){this._logger.log("debug","periodic timer first tick:"+JSON.stringify(this.timer));var b=this.timer.interval;if(b){b=1E3*parseInt(b);var f=this;this._starter&&(clearTimeout(this._starter),this._starter=null);this._repeater&&(clearInterval(this._repeater),
this._repeater=null);this._repeater=setInterval(function(){f.onTick()},b);this.onTick()}};d.prototype.onTick=function(){this._logger.log("debug","#"+this.taskID+" periodic timer tick:"+JSON.stringify(this.timer));var b=require("moment-timezone"),f=this.timer.interval;f=1E3*parseInt(f);var d=x.hub.taskman._Util._getTimeZone(),h=(new Date).getTime();f=h+f;var a=b.tz(h,d);h=b.tz(h,d);var g=h.year(),l=this.timer.start;if(l&&("00"==l.substr(0,2)&&(l=g+l.substr(2)),l=b.tz(l,d),l.set({hour:0,minute:0,second:0,
millisecond:0}),l.valueOf()>h.valueOf()))return;if(l=this.timer.end)if("00"==l.substr(0,2)&&(l=g+l.substr(2)),l=b.tz(l,d),l.set({hour:23,minute:59,second:59,millisecond:999}),l.valueOf()<h.valueOf())return;(d=this.timer.endTime)||(d="23:59");g=d.indexOf(":");b=d.substr(0,g);d=d.substr(g+1);a.set({hour:parseInt(b),minute:parseInt(d),second:59,millisecond:999});a.valueOf()<h.valueOf()?(this._logger.log("trace","repeater exceed end time:"+a.toString()),this._repeater&&(clearInterval(this._repeater),
this._repeater=null)):(f>a.valueOf()&&(this._logger.log("trace","repeater next tick will exceed end time:"+a.toString()),this._repeater&&(clearInterval(this._repeater),this._repeater=null)),require("x.hub.taskman.js").taskManager.onTimerTick(this.taskID,JSON.stringify(this.timer)))};d.prototype.onLocationChange=function(){this.stop();this.start()};d.prototype.onTimerChange=function(){this.stop();this.start()};var b=function(){this._timers=[]};b.prototype.startTimer=function(b,f){b=new d(b,f);this._timers.push(b);
...
a,a.flowIf.push(e))});e.then&&0<e.then.length&&e.then.forEach(function(e){e&&(e=d.parse(e))&&a.flowThen.push(e)});e.else&&0<e.else.length&&e.else.forEach(function(e){e&&(e=d.parse(e))&&a.flowElse.push(e)})}};b.prototype._checkIfBlocks=function(e,a){var b=[],c=0,n=this;if(this.flowIf&&0!=this.flowIf.length){var g=function(d,f){c++;d?b.push(!1):b.push(f);if(c<n.flowIf.length)n.flowIf[c].do(g,a);else if(0==b.length)e&&e(null,!0);else{d=1;for(f=b[0];d<b.length&&d+1!=b.length;)"AND"==b[d]?f&=b[d+1]:"OR"==
b[d]?f|=b[d+1]:"XOR"==b[d]&&(f=f!=b[d+1]),d+=2;e&&e(null,f)}};this.flowIf[c].do(g,a)}else e&&e(null,!0)};b.prototype._doThenBlocks=function(e,a){var b=0,c=this;if(this.flowThen&&0!=this.flowThen.length){var n=function(){b++;b<c.flowThen.length?c.flowThen[b].do(n,a):e&&e()};this.flowThen[b].do(n,a)}else e&&e()};b.prototype._doElseBlocks=function(e,a){var b=0,c=this;if(this.flowElse&&0!=this.flowElse.length){var n=function(){b++;b<c.flowElse.length?c.flowElse[b].do(n,a):e&&e()};this.flowElse[b].do(n,
...
this.type=k.TYPE;this.children=[]};util.inherits(k,d);k.TYPE="bracket";k.prototype.do=function(e){var a=[],b=0,c=this;if(this.children&&0!==this.children.length){var g=function(d,n){b++;d?a.push(!1):a.push(n);if(b<c.children.length)c.children[b].do(g);else if(0===a.length)e&&e(null,!0);else{d=1;for(n=a[0];d<a.length&&d+1!=a.length;)"AND"==a[d]?n&=a[d+1]:"OR"==a[d]?n|=a[d+1]:"XOR"==a[d]&&(n=n!=a[d+1]),d+=2;e&&e(null,n)}};this.children[b].do(g)}else e&&e(null,!0)};k.prototype.toJSON=function(){var e=
...
var m=this.end;m&&("00"==m.substr(0,2)&&(f=!0,m=g+m.substr(2)),m=a.tz(m,b),m.set({hour:23,minute:59,second:59,millisecond:999}),k=m.valueOf());if(d&&f&&l>k){if(k<q&&l>q){this._logger.log("trace","condition mismatch:"+JSON.stringify(this.toJSON()));e&&e(null,!1);return}}else if(h&&l>q||m&&k<q){this._logger.log("trace","condition mismatch:"+JSON.stringify(this.toJSON()));e&&e(null,!1);return}if(a=this.week)if(b=c.day(),0==b&&(b=7),"1"!=a.charAt(b-1)){this._logger.log("trace","condition mismatch:"+JSON.stringify(this.toJSON()));
...
e.endTime,this.week=e.week,this.start=e.start,this.end=e.end)};d.Periodic=l;var q=function(){d.call(this);this.type=q.TYPE;this._lastTiggerTime=this.ir=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.IRTrigger")};util.inherits(q,d);q.TYPE="ir";q.prototype.isMatch=function(e){if(!(e&&e.code&&this.ir&&this.ir.code))return!1;var a=this._getDataCode(this.ir.code);e=this._getDataCode(e.code);if(a==e){a=(new Date).getTime();if(!this._lastTiggerTime)return this._lastTiggerTime=a,
!0;if(1E3>a-this._lastTiggerTime)return!1;this._lastTiggerTime=a;return!0}return!1};q.prototype.toJSON=function(){var e=d.prototype.toJSON.call(this);e.ir=this.ir;return e};q.prototype.fromJSON=function(e){e&&(this.ir=e.ir)};q.prototype._getDataCode=function(e){e=new Buffer(e,"hex");var a=e.readInt8(8);return e.slice(4*a+9).toString("hex")};d.IRTrigger=q;var m=function(){d.call(this);this.type=m.TYPE;this._cancelCB=this._lastStatus=this._lastTiggerTime=this.hysteresis=this.value=this.op=this.status=
this.gateway=this.device=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.DeviceStatus");this._gatewayName=this._deviceName=null};util.inherits(m,d);m.TYPE="device.status";m.prototype.init=function(e){if(this.device||this.gateway){var a=null;this.gateway&&this.gateway.sys&&(a=this.gateway.sys);!a&&this.device&&this.device.sys&&(a=this.device.sys);if(a&&("hm"!=a||this.gateway?"neoserver"==a&&(a="aio"):a="aio",(a=require("x.hub.moduleman.js").modulemanager.getModule(a))&&a.addStateDevice)){var b=
{},c=this._getDevice(),g=this._getGateway();c&&(b=c);delete b.gateway;g&&(b.gateway=g);c=this.status;c.ref&&c.ref.value?c=c.ref.value:c.value&&(c=c.value);a.addStateDevice(b,null,{taskID:e,statusKey:c,src:"taskman",callback:this})}}};m.prototype.finalize=function(a){if(this.device||this.gateway){var e=null;this.gateway&&this.gateway.sys&&(e=this.gateway.sys);!e&&this.device&&this.device.sys&&(e=this.device.sys);if(e&&(e=require("x.hub.moduleman.js").modulemanager.getModule(e))&&e.removeStateDevice){var b=
{},c=this._getDevice(),g=this._getGateway();c&&(b=c);delete b.gateway;g&&(b.gateway=g);c=this.status;c.ref&&c.ref.value?c=c.ref.value:c.value&&(c=c.value);e.removeStateDevice(b,null,{taskID:a,statusKey:c,src:"taskman",callback:this})}}};m.prototype.do=function(a){if(this.device||this.gateway)if(this.status&&this.op){var e=this.status;this.status.ref&&(e=this.status.ref);e.value&&(e=e.value);e={value:e};this.status&&this.status.value?e=this.status:this.status&&this.status.ref&&(e=this.status.ref);
var b=this,c=this._getDevice(),g=this._getGateway();this._logger.log("trace","get states:"+JSON.stringify(this._toBluredJSON()));this._trace&&this._trace.log("get status | "+this._getDescription());this._running=!0;require("x.hub.commandman.js").commandHandler.getState(c,g,e,function(e){if(b._canceling){b._logger.log("trace","get states canceled:"+JSON.stringify(b._toBluredJSON()));b._canceling=!1;e=b._running;b._running=!1;var c=b._cancelCB;b._cancelCB=null;c&&c(null,e)}else if(b._running=!1,!e||
e.error?b._trace&&b._trace.log("get status | "+b._getDescription()+" | error:"+(e?e.error.message:"invalid response")):("undefined"==typeof e.data||null==e.data)&&b._trace&&b._trace.log("get status | "+b._getDescription()+" | error:no status"),!e||e.error)a&&a(e?e.error:Error("get state error"));else if("undefined"==typeof e.data||null==e.data)a&&a(null,!1);else{c=e.data.value;var g=!1;"="==b.op||"=="==b.op?g="true"==b.value?"true"==String(c):"false"==b.value?"false"==String(c):c==b.value:"!="==b.op?
g="true"==b.value?"true"!=String(c):"false"==b.value?"false"!=String(c):c!=b.value:">="==b.op?g=parseFloat(c)>=parseFloat(b.value):">"==b.op?g=parseFloat(c)>parseFloat(b.value):"<="==b.op?g=parseFloat(c)<=parseFloat(b.value):"<"==b.op&&(g=parseFloat(c)<parseFloat(b.value));b._logger.log("trace","condition "+(g?"match":"mismatch")+":"+JSON.stringify(b.toJSON()));b._trace&&b._trace.log("get status | "+b._getDescription()+" | success:"+JSON.stringify(e.data)+" | match="+g);a&&a(null,g)}})}else a&&a(Error("no status point or operator"));
else a&&a(Error("no device or gateway"))};m.prototype.cancel=function(e){this._running?(this._canceling=!0,this._cancelCB=e):e&&e(null,this._running)};m.prototype.isMatch=function(e){if(!e||!e.device)return!1;var a=e.device.sys;a&&"neoserver"!=a||(a="aio");a=require("x.hub.moduleman.js").modulemanager.getModule(a);if(!a||!a.checkDeviceMatch)return!1;var b=this._getDevice(),c=this._getGateway();if(!a.checkDeviceMatch({device:b,gateway:c},e))return!1;a=this.status;a.ref&&a.ref.value?a=a.ref.value:a.value&&
(a=a.value);return a!=e.data.key?!1:this.isValueMatch(e)};m.prototype.isValueMatch=function(a){if(!a||!a.data)return!1;var e=(new Date).getTime(),b=!1,c=this._lastStatus,g=a.data.value;this._lastStatus=g;"="==this.op||"changeTo"==this.op?(b="true"==this.value?"true"==String(a.data.value):"false"==this.value?"false"==String(a.data.value):this.value==a.data.value,"changeTo"==this.op&&g==c&&(b=!1)):">="==this.op?b=parseFloat(a.data.value)>=parseFloat(this.value):">"==this.op?b=parseFloat(a.data.value)>
parseFloat(this.value):"<="==this.op?b=parseFloat(a.data.value)<=parseFloat(this.value):"<"==this.op?b=parseFloat(a.data.value)<parseFloat(this.value):"changed"==this.op?g!=c&&(b=!0):b=!1;c=this.value;"undefined"!=typeof this.hysteresis&&null!=this.hysteresis&&(c=this.hysteresis);g=!1;if(">"==this.op)g=parseFloat(a.data.value)<=parseFloat(c);else if(">="==this.op)g=parseFloat(a.data.value)<parseFloat(c);else if("<"==this.op)g=parseFloat(a.data.value)>=parseFloat(c);else if("<="==this.op)g=parseFloat(a.data.value)>
parseFloat(c);else if("="==this.op||"=="==this.op)g=a.data.value!=c;g&&(this._lastTiggerTime=null);this._trace&&(this._trace.log("trigger | "+this._getDescription()),this._trace.log("receive event | "+JSON.stringify(a.data)+" | hysteresis="+this.hysteresis+" | hit="+b));if(b){if(!this._lastTiggerTime)return this._lastTiggerTime=e,!0;if(1E3>e-this._lastTiggerTime||"undefined"!=typeof this.hysteresis&&null!=this.hysteresis&&this._lastTiggerTime||(a=this._getDevice())&&"aio"==a.sys&&"ENOCEAN"==a.type&&
("bb-aa-cc"==a.data||"d2-06-10"==a.data)&&this._lastTiggerTime)return!1;this._lastTiggerTime=e;return!0}return!1};m.prototype.onEvent=function(a){try{this.isValueMatch(a)&&this._parent&&this._parent._onTriggered&&this._parent._onTriggered(null,this)}catch(n){}};m.prototype.toJSON=function(){var a=d.prototype.toJSON.call(this);a.device=this.device;a.gateway=this.gateway;a.status=this.status;a.op=this.op;a.value=this.value;a.hysteresis=this.hysteresis;return a};m.prototype.fromJSON=function(a){a&&(this.device=
a.device,this.gateway=a.gateway,this.status=a.status,this.op=a.op,this.value=a.value,this.hysteresis=a.hysteresis)};m.prototype._toBluredJSON=function(){try{var a=JSON.parse(JSON.stringify(this.toJSON()));a.device&&(a.device.username&&(a.device.username="xxxxxx"),a.device.password&&(a.device.password="xxxxxx"));a.gateway&&(a.gateway.username&&(a.gateway.username="xxxxxx"),a.gateway.password&&(a.gateway.password="xxxxxx"));return a}catch(n){return this.toJSON()}};m.prototype._getDevice=function(){if(!this.device)return null;
var a=null;if(this.device.__neoIndex&&deviceman.deviceManager)try{var b=deviceman.deviceManager.findDeviceWithIndex(this.device.__neoIndex);b&&b.info&&(this._deviceName=b.name,a=JSON.parse(JSON.stringify(b.info)))}catch(I){}a||(a=JSON.parse(JSON.stringify(this.device)));return a};m.prototype._getGateway=function(){if(!this.gateway)return null;var a=null;if(this.gateway.__neoIndex&&deviceman.deviceManager)try{var b=deviceman.deviceManager.findGatewayWithIndex(this.gateway.__neoIndex);b&&b.info&&(this._gatewayName=
b.name,a=JSON.parse(JSON.stringify(b.info)))}catch(I){}a||(a=JSON.parse(JSON.stringify(this.gateway)));a&&this.gateway.__neoIndex&&(a.__neoInfo={db:1,index:this.gateway.__neoIndex});return a};m.prototype._getDescription=function(){var a=null,b=null;if(this._deviceName||this._gatewayName)a=this._deviceName?this._deviceName:this._gatewayName;else if(this.device)try{b=JSON.parse(JSON.stringify(this.device)),b.username&&(b.username="xxxxxx"),b.password&&(b.password="xxxxxx"),a=JSON.stringify(b)}catch(I){a=
JSON.stringify(this.device)}else if(this.gateway)try{b=JSON.parse(JSON.stringify(this.gateway)),b.username&&(b.username="xxxxxx"),b.password&&(b.password="xxxxxx"),a=JSON.stringify(b)}catch(I){a=JSON.stringify(this.gateway)}b=this.status;this.status.ref&&(b=this.status.ref);b.value&&(b=b.value);return a+" | "+b+" "+this.op+" "+this.value};d.DeviceStatus=m;var r=function(){m.call(this);this.type=r.TYPE;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.CloudDeviceTrigger");this._cloudRuleID=
null};util.inherits(r,m);r.TYPE="cloud.trigger.device";r.prototype.init=function(a){};r.prototype.finalize=function(a){};r.prototype.toCloudTriggerFormat=function(){var a=this.status;a.ref&&a.ref.value?a=a.ref.value:a.value&&(a=a.value);a={event:{sys:this.device.module,data:{connection:this.device.connection,id:this.device.id,state:a},comp:{value:this.value,operator:this.op}}};if("undefined"!=typeof this.hysteresis&&null!=this.hysteresis)if("="==this.op||"=="==this.op)a.event.comp.hyst=.1;else if(">="==
this.op||">"==this.op)a.event.comp.hyst=parseFloat(this.value)-parseFloat(this.hysteresis);else if("<="==this.op||"<"==this.op)a.event.comp.hyst=parseFloat(this.hysteresis)-parseFloat(this.value);return a};d.CloudDeviceTrigger=r;var u=function(){d.call(this);this.type=u.TYPE;this.gateway=this.device=null;this.upperThreshold={type:null,op:null,value:null,delay:null,repeat:null};this.lowerThreshold={type:null,op:null,value:null,delay:null,repeat:null};this._upper_threshold_state=0;this._upper_threshold_repeat_to=
this._upper_threshold_deley_to=null;this._lower_threshold_state=0;this._lower_threshold_repeat_to=this._lower_threshold_deley_to=null;this._lastTigger={upperThreshold:!1,lowerThreshold:!1};this._upperMatchCount=0;this._cancelCB=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.DominoswissWS");this._lastHit=null};util.inherits(u,m);u.TYPE="device.dominoswiss.weatherstation";u.prototype.init=function(a){if(this.device||this.gateway){var b=null;this.gateway&&this.gateway.sys&&
(b=this.gateway.sys);!b&&this.device&&this.device.sys&&(b=this.device.sys);if(b&&(b=require("x.hub.moduleman.js").modulemanager.getModule(b))&&b.addStateDevice){var e={},c=this._getDevice(),g=this._getGateway();c&&(e=c);delete e.gateway;g&&(e.gateway=g);b.addStateDevice(e,null,{taskID:a,statusKey:"*",src:"taskman"})}}};u.prototype.finalize=function(a){if(this.device||this.gateway){var b=null;this.gateway&&this.gateway.sys&&(b=this.gateway.sys);!b&&this.device&&this.device.sys&&(b=this.device.sys);
if(b&&(b=require("x.hub.moduleman.js").modulemanager.getModule(b))&&b.removeStateDevice){var e={},c=this._getDevice(),g=this._getGateway();c&&(e=c);delete e.gateway;g&&(e.gateway=g);b.removeStateDevice(e,null,{taskID:a,statusKey:"*",src:"taskman"})}}};u.prototype.isMatch=function(a){if(!a||!a.device||!a.device.sys)return!1;var b=require("x.hub.moduleman.js").modulemanager.getModule(a.device.sys);if(!b||!b.checkDeviceMatch)return!1;var e=this._getDevice(),c=this._getGateway();if(!b.checkDeviceMatch({device:e,
...
"start upper threshold hit repeat timeout:"+Math.round(c/1E3));this._upper_threshold_repeat_to=setTimeout(function(){a._logger.log("trace","upper threshold repeat timeout expired");a._upper_threshold_state=0;a._lastTigger={upperThreshold:!0,lowerThreshold:!1};if(a._parent&&"root"==a._parent.type)try{a._lastHit="upper",a._parent._onTriggered(null,a)}catch(L){}},c)};u.prototype._handleLowerThresholdRepeat=function(){var a=this;this._lower_threshold_state=2;var b=this.lowerThreshold.repeat,c=0;if(b&&
...
"start lower threshold hit repeat timeout:"+Math.round(c/1E3));this._lower_threshold_repeat_to=setTimeout(function(){a._logger.log("trace","lower threshold repeat timeout expired");a._upperMatchCount=0;a._lower_threshold_state=0;a._lastTigger={upperThreshold:!1,lowerThreshold:!0};if(a._parent&&"root"==a._parent.type)try{a._lastHit="lower",a._parent._onTriggered(null,a)}catch(L){}},c)};u.prototype.toJSON=function(){var a=d.prototype.toJSON.call(this);a.device=this.device;a.gateway=this.gateway;a.upperThreshold=
this.upperThreshold;a.lowerThreshold=this.lowerThreshold;return a};u.prototype.fromJSON=function(a){a&&(this.device=a.device,this.gateway=a.gateway,this.upperThreshold=a.upperThreshold,this.lowerThreshold=a.lowerThreshold)};d.DominoswissWS=u;var p=function(){d.call(this);this.type=p.TYPE};util.inherits(p,d);p.TYPE="action";d.Action=p;var C=function(){p.call(this);this.subtype=C.SUBTYPE;this.body=this.event=this.key=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.IFTTTMakerAction")};
util.inherits(C,p);C.SUBTYPE="iftttmaker";C.prototype.do=function(a){if(this.key||this.event){var b=a;a={hostname:"maker.ifttt.com",port:443,path:"/trigger/"+this.event+"/with/key/"+this.key,method:"POST",headers:{"Content-Type":"application/json"}};this._logger.log("trace","send https:"+JSON.stringify(a));this._logger.log("trace","with data:"+JSON.stringify(this.body));var e=this;a=require("https").request(a,function(a){a.setEncoding("utf8");var c="";a.on("data",function(a){c+=a});a.on("end",function(){e._logger.log("trace",
"action response:"+a.statusCode);e._logger.log("trace","with data:"+c);b&&(b(null,a.statusCode,c),b=null)})});a.on("error",function(a){e._logger.log("debug","do action err:"+a.stack);b&&(b(a),b=null)});a.setTimeout(5E3,function(){e._logger.log("debug","do action timeout");b&&(b(Error("timeout")),b=null)});if(this.body)try{var c=JSON.stringify(this.body);a.write(c)}catch(N){}a.end()}else a&&a(Error("no key or event"))};C.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;
a.key=this.key;a.event=this.event;a.body=this.body;return a};C.prototype.fromJSON=function(a){a&&(this.key=a.key,this.event=a.event,this.body=a.body)};d.IFTTTMakerAction=C;var z=function(){p.call(this);this.subtype=z.SUBTYPE;this._cancelCB=this._doCB=this.body=this.headers=this.query=this.pathname=this.port=this.hostname=this.auth=this.protocol=this.method=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.HttpAction")};util.inherits(z,p);z.SUBTYPE="http.action";z.prototype.do=
...
t.prototype.cancel=function(a){this._running?(this._canceling=!0,this._cancelCB=a):a&&a(null,this._running)};t.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.device=this.device;a.gateway=this.gateway;a.command=this.command;return a};t.prototype.fromJSON=function(a){a&&(this.device=a.device,this.gateway=a.gateway,this.command=a.command)};t.prototype._toBluredJSON=function(){try{var a=JSON.parse(JSON.stringify(this.toJSON()));a.device&&(a.device.username&&(a.device.username=
"xxxxxx"),a.device.password&&(a.device.password="xxxxxx"));a.gateway&&(a.gateway.username&&(a.gateway.username="xxxxxx"),a.gateway.password&&(a.gateway.password="xxxxxx"));return a}catch(n){return this.toJSON()}};t.prototype._getDevice=function(){if(!this.device)return null;var a=null;if(this.device.__neoIndex&&deviceman.deviceManager)try{var b=deviceman.deviceManager.findDeviceWithIndex(this.device.__neoIndex);b&&b.info&&(this._deviceName=b.name,a=JSON.parse(JSON.stringify(b.info)))}catch(I){}a||
(a=JSON.parse(JSON.stringify(this.device)));return a};t.prototype._getGateway=function(){if(!this.gateway)return null;var a=null;if(this.gateway.__neoIndex&&deviceman.deviceManager)try{var b=deviceman.deviceManager.findGatewayWithIndex(this.gateway.__neoIndex);b&&b.info&&(this._gatewayName=b.name,a=JSON.parse(JSON.stringify(b.info)))}catch(I){}a||(a=JSON.parse(JSON.stringify(this.gateway)));a&&this.gateway.__neoIndex&&(a.__neoInfo={db:1,index:this.gateway.__neoIndex});return a};t.prototype._getDescription=
function(){var a=null;if(this._deviceName||this._gatewayName)a=this._deviceName?this._deviceName:this._gatewayName;else if(this.device)try{tmp=JSON.parse(JSON.stringify(this.device)),tmp.username&&(tmp.username="xxxxxx"),tmp.password&&(tmp.password="xxxxxx"),a=JSON.stringify(tmp)}catch(I){a=JSON.stringify(this.device)}else if(this.gateway)try{tmp=JSON.parse(JSON.stringify(this.gateway)),tmp.username&&(tmp.username="xxxxxx"),tmp.password&&(tmp.password="xxxxxx"),a=JSON.stringify(tmp)}catch(I){a=JSON.stringify(this.gateway)}var b=
...
"alarm_on.mp3";break;case "alarm_off":a="alarm_off.mp3";break;case "pre_alarm":a="pre_alarm.mp3";break;case "alarm":a="alarm.mp3";break;default:return null}return{value:"playUrl",ext:"http://"+b+":"+c+"/resources/rehau_alarm/"+a}};d.CommandAction=t;var J=function(){p.call(this);this.subtype=J.SUBTYPE;this._cancelCB=this.command=this.gateway=this.device=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.BrelagUpperThresholdAction")};util.inherits(J,t);J.SUBTYPE="command.dominoswiss.upperthreshold";
J.prototype.do=function(a,b){if(b&&b.trigger&&b.trigger.type==u.TYPE){var c=b.trigger._lastTigger;c&&c.upperThreshold?t.prototype.do.call(this,a,b):a&&a()}else a&&a()};d.BrelagUpperThresholdAction=J;var K=function(){p.call(this);this.subtype=K.SUBTYPE;this._cancelCB=this.command=this.gateway=this.device=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.BrelagLowerThresholdAction")};util.inherits(K,t);K.SUBTYPE="command.dominoswiss.lowerthreshold";K.prototype.do=function(a,b){if(b&&
b.trigger&&b.trigger.type==u.TYPE){var c=b.trigger._lastTigger;c&&c.lowerThreshold?t.prototype.do.call(this,a,b):a&&a()}else a&&a()};d.BrelagUpperThresholdAction=K;var D=function(){p.call(this);this.subtype=D.SUBTYPE;this.actionID=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.CloudAction")};util.inherits(D,p);D.SUBTYPE="cloud_action";D.prototype.do=function(a){if(this.actionID){this._logger.log("trace","do cloud action:"+this.actionID);var b=require("x.hub.js").server;if(b)if(b=
...
a.actionID)};var v=function(){p.call(this);this.subtype=v.SUBTYPE;this.macroName=this.groupName=null;this._canceling=!1;this._macroExecutorID=this._cancelCB=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.MacroAction")};util.inherits(v,p);v.SUBTYPE="macro";v.prototype.do=function(a){if(this.groupName&&this.macroName){var b=require("x.hub.macroman.js");this._logger.log("trace","do macro:"+JSON.stringify(this.toJSON()));var c=this;this._running=!0;this._trace&&this._trace.log("execute macro | "+
...
!0,this._cancelCB=a,this._macroExecutorID&&require("x.hub.macroman.js").cancel(this._macroExecutorID)):a&&a(null,this._running)};v.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.groupName=this.groupName;a.macroName=this.macroName;return a};v.prototype.fromJSON=function(a){a&&(this.groupName=a.groupName,this.macroName=a.macroName)};v.prototype._getDescription=function(){return this.groupName+"."+this.macroName};d.MacroAction=v;var A=function(){p.call(this);
this._cancelCB=this.token=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.SnsAction")};util.inherits(A,p);A.prototype.do=function(a){if(this.token){var b=this;this._logger.log("trace","do sns:"+JSON.stringify(this.toJSON()));var c=new x.hub.taskman.Cloud;this._running=!0;this._trace&&this._trace.log("execute sns | "+this._getDescription());c._doRequest("GET","/xhub/sns/dosns?token="+this.token,null,null,null,null,function(c,e){b._trace&&b._trace.log("execute sns | "+b._getDescription()+
" | "+(c?"error:"+c.message:"response:"+e));b._canceling?(b._logger.log("trace","sns action canceled:"+JSON.stringify(b.toJSON())),b._canceling=!1,c=b._running,b._running=!1,e=b._cancelCB,b._cancelCB=null,e&&e(null,c)):(b._running=!1,c&&b._logger.log("warn","do sns error:"+c.stack),a&&a(c))})}else a&&a(Error("token is empty"))};A.prototype.cancel=function(a){this._running?(this._canceling=!0,this._cancelCB=a):a&&a(null,this._running)};A.prototype._getDescription=function(){return this.subtype+"."+
this.token};var F=function(){A.call(this);this.subtype=F.SUBTYPE;this.token=null};util.inherits(F,A);F.SUBTYPE="EMAIL";F.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.token=this.token;return a};F.prototype.fromJSON=function(a){a&&(this.token=a.token)};d.EmailAction=F;var G=function(){A.call(this);this.subtype=G.SUBTYPE;this.token=null};util.inherits(G,A);G.SUBTYPE="PUSH";G.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;
a.token=this.token;return a};G.prototype.fromJSON=function(a){a&&(this.token=a.token)};d.PushAction=G;var H=function(){A.call(this);this.subtype=H.SUBTYPE;this.token=null};util.inherits(H,A);H.SUBTYPE="SMS";H.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.token=this.token;return a};H.prototype.fromJSON=function(a){a&&(this.token=a.token)};d.SmsAction=H;var M=function(a,b){this._runCallback=b;this._finishCallback=null;this._action=a;var c=this;this.runCallback=
function(a){c._action.removeRunTask(c);c._runCallback&&c._runCallback(a)};this.finishCallback=function(){c._action.removeRunTask(c)}},w=function(){p.call(this);this.subtype=w.SUBTYPE;this.name=this.id=null;this._scriptRunTasks=[];this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.ScriptAction")};util.inherits(w,p);w.SUBTYPE="script";w.prototype.do=function(a){if(this.id){var b=require("x.hub.scriptman.js").scriptManager;this._logger.log("trace","do script:"+JSON.stringify(this.toJSON()));
this._running=!0;a=new M(this,a);this._scriptRunTasks.push(a);this._trace&&this._trace.log("execute skript | "+this.id);b.runScript(this.id,a.runCallback,a.finishCallback)}else a&&a(Error("no script id"))};w.prototype.cancel=function(a){if(this._running){var b=require("x.hub.scriptman.js").scriptManager;this._scriptRunTasks=[];this._running=!1;this._logger.log("trace","script action canceled:"+JSON.stringify(this.toJSON()));b.stopScript(this.id,function(){a&&a(null,!0)})}else a&&a(null,this._running)};
w.prototype.removeRunTask=function(a){a=this._scriptRunTasks.indexOf(a);-1!=a&&this._scriptRunTasks.splice(a,1);0==this._scriptRunTasks.length&&(this._running=!1)};w.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.id=this.id;a.name=this.name;return a};w.prototype.fromJSON=function(a){a&&(this.id=a.id,this.name=a.name)};d.ScriptAction=w;var B=function(){p.call(this);this.subtype=B.SUBTYPE;this._to=this.value=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.WaitAction")};
util.inherits(B,p);B.SUBTYPE="wait";B.prototype.do=function(a){if(this.value){this._running=!0;var b=this;this._trace&&this._trace.log("execute wait | wait "+this.value+" ms");this._to=setTimeout(function(){b._trace&&b._trace.log("execute wait | wait expired");b._running=!1;b._to=null;a&&a()},this.value)}else a&&a()};B.prototype.cancel=function(a){this._running?(this._to&&(this._logger.log("trace","wait action canceled:"+JSON.stringify(this.toJSON())),clearTimeout(this._to),this._to=null),this._running=
!1,a&&a(null,!0)):a&&a(null,this._running)};B.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.value=this.value;return a};B.prototype.fromJSON=function(a){a&&(this.value=a.value)};d.WaitAction=B;var y=function(){p.call(this);this.subtype=y.SUBTYPE;this.page=this.remote=null;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.ChangePageAction");this._cancelCB=null};util.inherits(y,p);y.SUBTYPE="remote.changepage";y.prototype.do=function(a){this._trace&&
this._trace.log("execute change page | "+this.remote+"."+this.page);this._running=!0;var b=[],c=require("os").networkInterfaces(),g;for(g in c)for(var e=c[g],d=0;d<e.length;d++){var f=e[d];"IPv4"==f.family&&0==f.internal&&b.push(f.address)}var l=this,k=0,h=function(){if(l._canceling){l._logger.log("trace","change page action canceled:"+JSON.stringify(l.toJSON()));l._canceling=!1;var c=l._running;l._running=!1;var g=l._cancelCB;l._cancelCB=null;g&&g(null,c)}else k++,k>=b.length?(l._running=!1,a&&a()):
l._sendEvent(b[k],h)};this._sendEvent(b[k],h)};y.prototype.cancel=function(a){this._running?(this._canceling=!0,this._cancelCB=a):a&&a(null,this._running)};y.prototype._sendEvent=function(a,b){var c=require("dgram"),g=require("unorm"),e={func:"changePage",remote:g.nfc(this.remote),page:g.nfc(this.page)};e=new Buffer("{XC_EVT}"+JSON.stringify(e),"utf8");var d=c.createSocket({type:"udp4",reuseAddr:!0});d.bind(a,function(){d.setBroadcast(!0);d.send(e,0,e.length,1902,"255.255.255.255");d.send(e,0,e.length,
1902,"255.255.255.255",function(a){d.close();b&&b(a)})})};y.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.remote=this.remote;a.page=this.page;return a};y.prototype.fromJSON=function(a){a&&(this.remote=a.remote,this.page=a.page)};d.ChangePageAction=y;var E=function(){t.call(this);this.subtype=E.SUBTYPE;this._logger=require("x.logger.js").getLogger("x.hub.taskman._Block.AudioAction")};util.inherits(E,t);E.SUBTYPE="audio";E.prototype.do=function(a){if(this.device||
this.gateway)if(this.command){var b=this.command;b.ref&&(b=b.ref);this._logger.log("trace","do audio command:"+JSON.stringify(this._toBluredJSON()));var c=this._getDevice(),g=this._getGateway();this._running=!0;this._trace&&this._trace.log("execute audio command | "+this._getDescription());var d=this;require("x.hub.commandman.js").commandHandler.executeCommand(c,g,b,function(b){b&&b.error?d._trace&&d._trace.log("execute command | "+d._getDescription()+" | error:"+b.error.message):d._trace&&d._trace.log("execute command | "+
d._getDescription()+" | success");d._running=!1;a&&a()})}else a&&a(Error("no command"));else a&&a(Error("no device or gateway"))};E.prototype.toJSON=function(){var a=p.prototype.toJSON.call(this);a.subtype=this.subtype;a.device=this.device;a.gateway=this.gateway;a.command=this.command;return a};E.prototype.fromJSON=function(a){a&&(this.device=a.device,this.gateway=a.gateway,this.command=a.command)};d.AudioAction=E;d.parse=function(e){if(!e||!e.type)return null;switch(e.type){case c.TYPE:var n=d.Root;
break;case b.TYPE:n=b;break;case p.TYPE:switch(e.subtype){case t.SUBTYPE:n=t;break;case J.SUBTYPE:n=J;break;case K.SUBTYPE:n=K;break;case F.SUBTYPE:n=F;break;case G.SUBTYPE:n=G;break;case H.SUBTYPE:n=H;break;case w.SUBTYPE:n=w;break;case B.SUBTYPE:n=B;break;case v.SUBTYPE:n=v;break;case C.SUBTYPE:n=C;break;case z.SUBTYPE:n=z;break;case y.SUBTYPE:n=y;break;case D.SUBTYPE:n=D;break;case E.SUBTYPE:n=E;break;default:return null}break;case m.TYPE:n=m;break;case u.TYPE:n=u;break;case a.TYPE:n=a;break;case g.TYPE:n=
g;break;case l.TYPE:n=l;break;case f.TYPE:n=f;break;case k.TYPE:n=k;break;case h.TYPE:n=h;break;case q.TYPE:n=q;break;case r.TYPE:n=r;break;default:return null}n=new n;n.fromJSON(e);return n};return d}();
...
f);break;case "ToggleTaskActive":this.toggleTaskActive(c.query.id,c.query.pin,f);break;case "SetAlarmActive":this.setAlarmActive(c.query.active,c.query.pin,f);break;case "SetAlarmDelay":this.setAlarmDelay(c.query.delay,c.query.pin,f);break;case "GetAlarmInfo":this.getAlarmInfo(f);break;case "SelectAlarmTask":this.selectAlarmTask(c.query.id,c.query.isAlarmTask,c.query.pin,f);break;case "SetAlarmPin":this.setAlarmPin(c.query.newPin,c.query.pin,f);break;case "GetCloudServer":f({data:x.hub.taskman.Cloud.prototype.URL});
