...
case 2:a.setColor(0,0,255);break;case 3:a.setColor(255,0,0);break;case 4:a.setColor(255,255,0);break;case 5:a.setColor(255,255,255);break;case 6:a.setColor(255,0,255);break;case 7:a.setColor(0,255,255)}else 90==a.type?(b=a.data.readUInt8(0),require("x.hub.action.js").getActionManager().executeActionWithId(b,function(){})):145==a.type&&require("x.hub.m.enocean.js").sendToFGW14(a.data,function(a){})};g.prototype._setSTMMode=function(a,b){var c=require("child_process").exec;c=c(g.MODE_SCRIPT+" "+a);
c.on("error",function(a){b&&(b(a),b=null)});c.on("close",function(c){b&&(b(0==c?null:Error("set stm mode: "+a+" failed")),b=null)})};g.prototype._flashFirmware=function(a,b){var c=this;a=new (require("xnm.aio.m10T.js").STMUpdater)(a);this._logger.log("trace","flash stm with dfu-util");a.startDFUUpdate("dfu-util",function(a){b&&a&&(a.error?(c._logger.log("trace","flash stm failed:"+a.error),b(Error(a.error)),b=null):a.state&&(c._logger.log("trace","flash stm progress:"+a.state),c.emit("flash",{progress:a.state}),
100==a.state&&(c._logger.log("trace","flash stm success"),b(),b=null)))},null,"v6p")};return g}();
...
d.remove(e.join(a,"data","localstorage","x.hub.Server.pwd"),function(a){c._logger.log("trace","backup general data "+(a?" failed:"+a.message:" success"));if(a){var d=Error("backup general data failed: "+a.message);d.code=a.code?a.code:-250}b(d)}):(c._logger.log("trace","backup general data success"),b())})})})}],function(a){d&&d(a)})};d.prototype.restore=function(a,b,d){var e=function(a,b,c){var d=require("fs"),e=require("fs-extra"),f=require("os").tmpdir(),g=require("path"),k=g.join(f,"restore"),
...
"restore system config"),k._sysConf.restore(a,function(a){k._logger.log("trace","restore system config"+(a?" failed:"+a.message:" success"));if(a){var c=Error("restore system config failed: "+a.message);c.code=a.code?a.code:-350}b(c)})):b()}],function(a){d&&d(a)})};d.prototype.updateFirmware=function(a,b){var d=this,g=function(a,b){d._recovery.setFirmwareUpdateUrl(a,function(a){b(a)})};this._logger.log("trace","update firmware with url:"+a);(function(a,b){if(a){a=require("url").parse(a);var c=80;
