...
null,{encodeURL:!1}),a.destroy()):b&&b(null,a):401!=a.statusCode||f?b(null,a):(f=null,a.headers&&a.headers["www-authenticate"]&&"Digest "==a.headers["www-authenticate"].substr(0,7)?(f=require("x.crypt.js").DigestAuth(a.headers["www-authenticate"],k.path,c.user,c.password))?l.getFile(e,c,b,f):b&&b(null,a):b&&b(null,a))});a.on("error",function(a){XC.debugf(a);l._getFileFallback(e,c,b)});a.end()};
