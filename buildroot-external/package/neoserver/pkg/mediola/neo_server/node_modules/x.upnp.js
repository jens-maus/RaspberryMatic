...
0,a.length,d,c)};b.prototype._onResponse=function(a,c){a=a.toString();this._logger.log("trace","receive ssdp");this._logger.log("trace",a);var d=x.upnp.SSDP.resolve(a);d&&(x.upnp._SSDPCache.putSSDP(c.address,d),this._callbacks.forEach(function(a){a&&a(c.address,d)}))};return b}();
...
this.uuid,{name:this.name,type:this.type,subtype:this.subtype,modelName:this.modelName,manufacturer:this.manufacturer,modelDescription:this.modelDescription,deviceType:this.deviceType,dlnaCap:this.X_DLNACAP,serialNumber:this.serialNumber}),a.contentDirectory=c,a.connectionManager=d,a):null};b.prototype.parseRenderer=function(a){var c=null,d=null,e=null,b=null,g=null;a.find("serviceList service").each(function(){var a=$(this),f=a.find("serviceType");a=a.find("controlURL");0<f.length&&0<a.length&&(f=
$(f[0]).text(),(a=$(a[0]).text())&&"/"==a.charAt(0)||(a="/"+a),-1!=f.indexOf("GroupRenderingControl")?b={type:f,url:a}:-1!=f.indexOf("RenderingControl")?c={type:f,url:a}:-1!=f.indexOf("ConnectionManager")?d={type:f,url:a}:-1!=f.indexOf("AVTransport")?e={type:f,url:a}:-1!=f.indexOf("Queue")&&(g={type:f,url:a}))});return c&&e?(a=new x.upnp.MediaRenderer,a.init(this.ip,this.port,this.uuid,{name:this.name,type:this.type,subtype:this.subtype,modelName:this.modelName,manufacturer:this.manufacturer,modelDescription:this.modelDescription,
deviceType:this.deviceType,dlnaCap:this.X_DLNACAP,serialNumber:this.serialNumber}),a.renderingControl=c,a.connectionManager=d,a.avTransport=e,a.groupRenderingControl=b,a.queue=g,a):null};return b}();
...
"<");a=a.replace(/&gt;/g,">");a=a.replace(/&amp;/g,"&");a=a.replace(/&quot;/g,'"');return a=a.replace(/&apos;/g,"'")};b.prototype._parseSOAPResponse=function(a,c){if(!a)return null;try{var b=$($.parseXML(a))}catch(e){return null}return b?(a=x.upnp.Util.findTag(b,c,"u"))&&0<a.length?$(a[0]):null:null};b.prototype.getURL=function(a){var c="http://"+this.ip;this.port&&80!=this.port&&(c+=":"+this.port);return c+a};b.prototype._getDuration=function(a){var c=a.split(":");3==c.length&&(a=3600*parseInt(c[0])+
60*parseInt(c[1])+parseInt(c[2]));return a};b.prototype._doSOAPRequest=function(a,c,b,e,f){var d="<u:"+b+' xmlns:u="'+c+'">',h;for(h in e)if(e.hasOwnProperty(h)){var k=e[h]+"";d+="<"+h+">"+(k?this._maskMetaData(k):"")+"</"+h+">"}var l=this;this._doRequest(a,'"'+c+"#"+b+'"',d+("</u:"+b+">"),function(a,c){a?f&&f(a):(a=l._parseSOAPResponse(c,b+"Response"))?f&&f(null,a):f&&f(Error(b+" reponse format invalid"))})};b.prototype._doRequest=function(a,c,b,e){(new x.upnp.SOAPClient).doRequest(a,c,b,function(a,
