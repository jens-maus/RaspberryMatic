var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(b,a,c){b instanceof String&&(b=String(b));for(var d=b.length,e=0;e<d;e++){var g=b[e];if(a.call(c,g,e,b))return{i:e,v:g}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(b,a,c){b!=Array.prototype&&b!=Object.prototype&&(b[a]=c.value)};
...
$jscomp.polyfill("Array.prototype.find",function(b){return b?b:function(a,c){return $jscomp.findInternal(this,a,c).v}},"es6","es3");var x=x||{};x.upnp=x.upnp||{};
...
break;case "M-SEARCH * HTTP/1.1":c.type="M-SEARCH";break;default:return null}for(var d=1;d<a.length&&"\r"!=a[d];d++){var e=a[d].trim(),g=e.indexOf(":");if(-1!=g){var f=e.substr(0,g);e=e.substr(g+1);f&&(c[f.toLowerCase()]=e.trim())}}if(!c.usn)return null;c._usnObj=x.upnp.Util.parseUSN(c.usn);return c};return b}();
x.upnp.UDPListener=function(){var b=function(){"undefined"!=typeof require&&require?(this._logger=require("x.logger.js").getLogger("x.upnp.UDPListener"),require("x.logger.js").setLevel("info","x.upnp.UDPListener")):this._logger={log:{}};this._callbacks=[];this._sockets=[];var a=require("os");require("dgram");if(a&&a.networkInterfaces){a=a.networkInterfaces();for(var c in a)for(var d=a[c],e=0;e<d.length;e++)this._addDiscoverSocket(d[e])}else this._addDiscoverSocket(null)};b.prototype._addDiscoverSocket=
...
b.prototype.sendMessage=function(a,c,d){a=new Buffer(a);for(var e=0;e<this._sockets.length;e++)this._sockets[e].send(a,0,a.length,d,c)};b.prototype._onResponse=function(a,c){a=a.toString();this._logger.log("trace","receive ssdp");this._logger.log("trace",a);var d=x.upnp.SSDP.resolve(a);d&&(x.upnp._SSDPCache.putSSDP(c.address,d),this._callbacks.forEach(function(a){a&&a(c.address,d)}))};return b}();
x.upnp.DescLoader=function(){var b=function(a,c){this.ip=a;this.port=80;this.uuid=c;this.subtype=this.type=this.name=null;"undefined"!=typeof require&&require?(this._logger=require("x.logger.js").getLogger("x.upnp.DescLoader"),require("x.logger.js").setLevel("info","x.upnp.DescLoader")):this._logger={log:{}}};b.prototype.load=function(a,c){var d=require("url").parse(a);d.port&&(this.port=d.port);var e=this;this._loadDeviceDesc2(a,function(a,d){a?c&&c(a):(a=e._parseDesc(d))?c&&c(null,a):c&&c(Error("device desc parse error"))})};
b.prototype._loadDeviceDesc=function(a,c){var d=this;this._logger.log("trace","load device descriptin from url:"+a);var e=c;$.ajax({url:a,type:"get",timeout:5E3,dataType:"text",cache:!0,success:function(a){d._logger.log("trace","http request success:"+a);e&&(e(null,a),e=null)},error:function(a,c){a="http request error:"+(a?a.status:"0")+"-"+c;d._logger.log("trace",a);e&&(e(Error(a)),e=null)}})};b.prototype._loadDeviceDesc2=function(a,c){this._logger.log("trace","load device descriptin from url:"+
a);a=require("url").parse(a);a={host:a.hostname,port:a.port,path:a.path,method:"GET"};var d=this,e="",b=require("http"),f=c,h=b.request(a,function(a){a.on("data",function(a){e+=a});a.on("end",function(){if(200==a.statusCode)d._logger.log("trace","http request success:"+e),f&&f(null,e);else{var c="http request error:"+a.statusCode+"-"+e;d._logger.log("trace",c);f&&f(Error(c))}f=null})});h.setTimeout&&h.setTimeout(2E3,function(){h.abort()});if(h.on&&"function"==typeof h.on)h.on("error",function(a){a||
(a=Error("http request error"));f&&f(a);f=null});h.end()};b.prototype._parseDesc=function(a){-1!=a.indexOf('xmlns:ms=" urn:microsoft-com:wmc-1-0"')&&(a=a.replace('xmlns:ms=" urn:microsoft-com:wmc-1-0"','xmlns:ms="urn:microsoft-com:wmc-1-0"'));var c=null;try{c=$($.parseXML(a))}catch(g){}if(!c)return null;a=c.find("device");if(!a||0==a.length)return null;a=$(a[0]);var d=this._parseDescXml(a);if(!d)return null;d.embeddedDevices=[];var e=this;c.find("deviceList device").each(function(){var a=$(this);
(a=e._parseDescXml(a))&&d.embeddedDevices.push(a)});return d};b.prototype._parseDescXml=function(a){if(!a)return null;var c=null,d=a.find("friendlyName");0<d.length&&(this.name=$(d[0]).text(),0==this.name.indexOf("Philips hue")?this.type="hue":0==this.name.indexOf("WeMo Switch")||0==this.name.indexOf("WeMo Insight")?(this.type="wemo",0==this.name.indexOf("WeMo Insight")&&(this.subtype="insight")):0<this.name.indexOf("Sonos")&&(this.type="sonos"));(d=a.find("deviceType"))&&0<d.length&&(this.deviceType=
$(d[0]).text());(d=a.find("manufacturer"))&&0<d.length&&(this.manufacturer=$(d[0]).text());(d=a.find("modelName"))&&0<d.length&&(this.modelName=$(d[0]).text());(d=a.find("modelDescription"))&&0<d.length&&(this.modelDescription=$(d[0]).text());(d=a.find("serialNumber"))&&0<d.length&&(this.serialNumber=$(d[0]).text());d=a.find("UDN");0<d.length&&(c=$(d[0]).text());d=a.find("X_DLNACAP");0<d.length&&(this.X_DLNACAP=$(d[0]).text());if(!this.name||!this.deviceType||!c)return null;6<c.length&&"uuid:"==c.substr(0,
5)&&!this.uuid&&(this.uuid=c.substr(5));c=x.upnp.Util.parseURN(this.deviceType);if(!c)return null;c.device&&"MediaServer"==c.device.type?a=this.parseServer(a):c.device&&"MediaRenderer"==c.device.type?a=this.parseRenderer(a):(a=new x.upnp.Device,a.init(this.ip,this.port,this.uuid,{name:this.name,type:this.type,subtype:this.subtype,modelName:this.modelName,manufacturer:this.manufacturer,modelDescription:this.modelDescription,deviceType:this.deviceType,dlnaCap:this.X_DLNACAP,serialNumber:this.serialNumber}));
return a};b.prototype.parseServer=function(a){var c=null,d=null;a.find("serviceList service").each(function(){var a=$(this),b=a.find("serviceType");a=a.find("controlURL");if(0<b.length&&0<a.length)if(b=$(b[0]).text(),(a=$(a[0]).text())&&"/"==a.charAt(0)||(a="/"+a),-1!=b.indexOf("ContentDirectory"))c={type:b,url:a};else if("urn:schemas-upnp-org:service:ConnectionManager:1"==b||"urn:schemas-upnp-org:service:ConnectionManager:2"==b)d={type:b,url:a}});return c&&d?(a=new x.upnp.MediaServer,a.init(this.ip,
this.port,this.uuid,{name:this.name,type:this.type,subtype:this.subtype,modelName:this.modelName,manufacturer:this.manufacturer,modelDescription:this.modelDescription,deviceType:this.deviceType,dlnaCap:this.X_DLNACAP,serialNumber:this.serialNumber}),a.contentDirectory=c,a.connectionManager=d,a):null};b.prototype.parseRenderer=function(a){var c=null,d=null,b=null,g=null,f=null;a.find("serviceList service").each(function(){var a=$(this),e=a.find("serviceType");a=a.find("controlURL");0<e.length&&0<a.length&&
(e=$(e[0]).text(),(a=$(a[0]).text())&&"/"==a.charAt(0)||(a="/"+a),-1!=e.indexOf("GroupRenderingControl")?g={type:e,url:a}:-1!=e.indexOf("RenderingControl")?c={type:e,url:a}:-1!=e.indexOf("ConnectionManager")?d={type:e,url:a}:-1!=e.indexOf("AVTransport")?b={type:e,url:a}:-1!=e.indexOf("Queue")&&(f={type:e,url:a}))});return c&&b?(a=new x.upnp.MediaRenderer,a.init(this.ip,this.port,this.uuid,{name:this.name,type:this.type,subtype:this.subtype,modelName:this.modelName,manufacturer:this.manufacturer,modelDescription:this.modelDescription,
deviceType:this.deviceType,dlnaCap:this.X_DLNACAP,serialNumber:this.serialNumber}),a.renderingControl=c,a.connectionManager=d,a.avTransport=b,a.groupRenderingControl=g,a.queue=f,a):null};return b}();
...
this._udpListener.sendMessage(this.M_SEARCH+"ST: "+a+"\r\n\r\n","239.255.255.250",1900);var c=x.upnp._DeviceCache.getDevicesWithTarget(a);if(c){var d=this;c.forEach(function(c){d._findDevice(a,c)})}};b.prototype._onReceiveSSDP=function(a,c){if("RESULT"==c.type){var d=c.getUUID(),e=c.st,b=x.upnp._DeviceCache.getDeviceCache(d);if(b&&b.device)b.targets&&-1!=b.targets.indexOf(e)||(x.upnp._DeviceCache.addTarget(d,e),this._findDevice(e,b.device));else if(!b||!b.loaded){var f=this;x.upnp._DeviceCache.setDescLoaded(d,
!0);(new x.upnp.DescLoader(a,d)).load(c.location,function(a,c){a||!c?x.upnp._DeviceCache.setDescLoaded(d,!1):(x.upnp._DeviceCache.putDevice(d,c,e),f._findDevice(e,c))})}}};return b}();
...
{type:b[2],ver:b[3]}:"service"==b[1]&&b[2]&&b[3]&&(a.service={type:b[2],ver:b[3]}));return a}return null},findTag:function(b,a,c){var d=b.find(a);return d&&0<d.length?d:c?(d=b.find(c+"\\:"+a))&&0<d.length?d:d=this._iterateTag(b,a,c):[]},_iterateTag:function(b,a,c){var d=[],e=b.prop("tagName");e&&(e==a||e==c+":"+a)&&d.push(b);if((b=b.children())&&0<b.length)for(e=0;e<b.length;e++){var g=this._iterateTag($(b[e]),a,c);g&&0<g.length&&(d=d.concat(g))}return d}};
x.upnp.SOAPClient=function(){var b=function(){"undefined"!=typeof require&&require?(this._logger=require("x.logger.js").getLogger("x.upnp.SOAPClient"),require("x.logger.js").setLevel("info","x.upnp.SOAPClient")):this._logger={log:{}}};b.prototype._getSOAPMessage=function(a){return'<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/" s:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/"><s:Body>'+a+"</s:Body>\n</s:Envelope>"};b.prototype.doRequest=function(a,c,d,b){d=this._getSOAPMessage(d);
var e=require("url").parse(a);c={host:e.hostname,port:e.port,path:e.path,method:"POST",headers:{"Content-Type":'text/xml; charset="utf-8"',"Content-Length":d.length,SOAPACTION:c,"User-Agent":"",Connection:"close"}};var f=this,h=require("http");c.port||(c.port=80);"https"==e.protocol&&(h=require("https"),"undefined"!=typeof process&&process&&process.env&&(process.env.NODE_TLS_REJECT_UNAUTHORIZED="0"),c.port||(c.port=443));this._logger.log("trace","send post to url:"+a);this._logger.log("trace","with headers:"+
JSON.stringify(c.headers));this._logger.log("trace","with data:"+d);var k=b,l=h.request(c,function(a){var c="";a.setEncoding("utf8");a.on("data",function(a){c+=a});a.on("end",function(){f._logger.log("trace","http reponse status code:"+a.statusCode);f._logger.log("trace","http reponse:"+c);var d;200!=a.statusCode&&(d=Error("http reponse status code:"+a.statusCode));k&&k(d,c,a.statusCode);k=null})});l.setTimeout&&l.setTimeout(2E4,function(){l.abort()});if(l.on&&"function"==typeof l.on)l.on("error",
function(a){a||(a=Error("soap request error"));f._logger.log("trace","soap request error:"+a.message);k&&k(a);k=null});l.write(d);l.end()};return b}();
...
(d=$(a[0]),c=d.getAttributes(),c=JSON.parse(JSON.stringify(c)));if(d)for(d=d.children(),a=0;a<d.length;a++)if(b=$(d[a])){var g=b.prop("tagName"),f=g.indexOf(":");-1!=f&&(g=g.substr(f+1));c[g]=b.text()}return c};b.prototype._maskMetaData=function(a){a=a.replace(/&/g,"&amp;");a=a.replace(/</g,"&lt;");a=a.replace(/>/g,"&gt;");a=a.replace(/'/g,"&apos;");a=a.replace(/\r/g,"");a=a.replace(/\n/g,"");return a=a.replace(/\t/g,"")};b.prototype._unmaskMetaData=function(a){if(!a)return a;a=a.replace(/&lt;/g,
...
60*parseInt(c[1])+parseInt(c[2]));return a};b.prototype._doSOAPRequest=function(a,c,d,b,g){var e="<u:"+d+' xmlns:u="'+c+'">',h;for(h in b)if(b.hasOwnProperty(h)){var k=b[h]+"";e+="<"+h+">"+(k?this._maskMetaData(k):"")+"</"+h+">"}var l=this;this._doRequest(a,'"'+c+"#"+d+'"',e+("</u:"+d+">"),function(a,c){a?g&&g(a):(a=l._parseSOAPResponse(c,d+"Response"))?g&&g(null,a):g&&g(Error(d+" reponse format invalid"))})};b.prototype._doRequest=function(a,c,b,e){(new x.upnp.SOAPClient).doRequest(a,c,b,function(a,
c){e&&e(null,c)})};return b}();
x.upnp.MediaServer=function(){var b=function(){this.connectionManager=this.contentDirectory=null};b.prototype=new x.upnp.Device;b.prototype.constructor=b;b.prototype.search=function(a,c,b,e){var d=this;c||(c="dc:title,upnp:artist,upnp:album,upnp:albumArtURI,res,res@protocolInfo,res@duration,res@resolution,res@size");var f='<u:Search xmlns:u="urn:schemas-upnp-org:service:ContentDirectory:1"><ContainerID>0</ContainerID>'+("<SearchCriteria>"+a+"</SearchCriteria>")+("<Filter>"+c+"</Filter>")+("<StartingIndex>"+
b+"</StartingIndex>");f+="<RequestedCount>"+this.chunkSize+"</RequestedCount>";f+="<SortCriteria></SortCriteria>";f+="</u:Search>";(new XCUPNPSOAPRequest).doRequest(this.getURL(this.contentDirectory),'"urn:schemas-upnp-org:service:ContentDirectory:1#Search"',f,function(f){if(f=d._parseSOAPResponse(f,!0)){var g=0,h=[];try{var m=$($.parseXML(f));h=d._getItems(m);g=$(m.children()[0]).children().length}catch(n){}g==d.chunkSize?(setTimeout(function(){d.search(a,c,b+d.chunkSize,e)},0),e(h,!1)):e(h,!0)}})};
b.prototype.browseMetaData=function(a,c){this._browseMetaData(a,function(a,b){a?c&&c(a):b&&b?c&&c(a,b):c&&c(Error("meta data invalid"))})};b.prototype.browseChildren=function(a,c,b,e,g){this._browseChildren(a,"*",c,b,null,function(a,c){if(a)g&&g(a);else if(c&&c.result){a=[];for(var b=0;b<c.result.length;b++){var d=c.result[b];e&&d["class"]?"object.container"==d["class"]?a.push(d):-1!=e.indexOf(d["class"])&&a.push(d):a.push(d)}g&&g(null,a,c.totalMatches)}else g&&g(null,[],0)})};b.prototype._getRes=
function(a){var c=null,b=0;a.find("res").each(function(){var a=$(this),d=a.attr("size");if(!c||d&&d>b)c=a,b=d});return c};b.prototype._getItems=function(a){var c=[],b=this;a.find("container").each(function(){var a=$(this),d=x.upnp.Util.findTag(a,"title","dc"),f=x.upnp.Util.findTag(a,"class","upnp");if(0<f.length&&0<d.length){f=$(f[0]).text();d=$(d[0]).text();d={type:"container","class":f,parentID:a.attr("parentID"),id:a.attr("id"),title:d};if(f=b._getRes(a)){var h=f.text(),k=null;f.attr("duration")&&
(k=b._getDuration(f.attr("duration")));d.res={url:h,dur:k}}a=x.upnp.Util.findTag(a,"albumArtURI","upnp");0<a.length&&(d.albumArtURI=$(a[0]).text());c.push(d)}});a.find("item").each(function(){var a=$(this),d=x.upnp.Util.findTag(a,"class","upnp"),f=x.upnp.Util.findTag(a,"title","dc");if(0<d.length&&0<f.length){d=$(d[0]).text();f=$(f[0]).text();f={type:"item",parentID:a.attr("parentID"),id:a.attr("id"),"class":d,title:f};var h=b._getRes(a,d);if(h){var k=h.text(),l=null;h.attr("duration")&&(l=b._getDuration(h.attr("duration")));
f.res={url:k,dur:l}}0==d.indexOf("object.item.audioItem")&&(f.info={},d=x.upnp.Util.findTag(a,"genre","upnp"),0<d.length&&(f.info.genre=$(d[0]).text()),d=x.upnp.Util.findTag(a,"artist","upnp"),0<d.length&&(f.info.artist=$(d[0]).text()),d=x.upnp.Util.findTag(a,"album","upnp"),0<d.length&&(f.info.album=$(d[0]).text()),d=x.upnp.Util.findTag(a,"albumArtURI","upnp"),0<d.length&&(f.info.albumArtURI=$(d[0]).text()));c.push(f)}});return c};b.prototype._browseMetaData=function(a,c){var b=this;this._browse(a,
"BrowseMetadata","*",0,0,null,function(a,d){if(a)c&&c(a);else{if(d.result)try{var e=$($.parseXML(d.result));d.meta=b._parseItemMetaData(e)}catch(h){c&&c(h);return}c(null,d)}})};b.prototype._browseChildren=function(a,c,d,b,g,f){var e=this;this._browse(a,"BrowseDirectChildren",c,d,b,g,function(a,c){if(a)f&&f(a);else{if(c.result)try{var b=$($.parseXML(c.result));c.result=e._getItems(b)}catch(n){f&&f(n);return}f(null,c)}})};b.prototype._browse=function(a,c,b,e,g,f,h){c||(c="BrowseDirectChildren");b||
(b="");f||(f="");a={ObjectID:a,BrowseFlag:c,Filter:b,StartingIndex:e,RequestedCount:g,SortCriteria:f};this._doSOAPRequest(this.getURL(this.contentDirectory.url),this.contentDirectory.type,"Browse",a,function(a,c){if(a)h&&h(a);else{a={};var b=c.find("Result");b&&0<b.length&&(a.result=$(b[0]).text());(b=c.find("NumberReturned"))&&0<b.length&&(a.numberReturned=$(b[0]).text());(b=c.find("TotalMatches"))&&0<b.length&&(a.totalMatches=$(b[0]).text());(b=c.find("UpdateID"))&&0<b.length&&(a.updateID=$(b[0]).text());
h&&h(null,a)}})};return b}();
...
d=c.find("CurrentSpeed");0<d.length&&(a.currentSpeed=$(d[0]).text());b&&b(null,a)}})};b.prototype._getPositionInfo=function(a,b){var c=this;this._doSOAPRequest(this.getURL(this.avTransport.url),this.avTransport.type,"GetPositionInfo",{InstanceID:a},function(a,d){if(a)b&&b(a);else{a={};var e=d.find("Track");0<e.length&&(a.track=$(e[0]).text());e=d.find("TrackDuration");0<e.length&&(a.trackDuration=$(e[0]).text());e=d.find("TrackMetaData");if(0<e.length)if(e=$(e[0]).text())try{var g=$($.parseXML(e));
a.trackMetaDataRaw=g;a.trackMetaData=c._parseItemMetaData(g)}catch(k){b&&b(k);return}else a.trackMetaDataRaw="",a.trackMetaData=null;e=d.find("TrackURI");0<e.length&&(a.trackURI=$(e[0]).text());e=d.find("RelTime");0<e.length&&(a.relTime=$(e[0]).text());e=d.find("AbsTime");0<e.length&&(a.absTime=$(e[0]).text());e=d.find("RelCount");0<e.length&&(a.relCount=$(e[0]).text());e=d.find("AbsCount");0<e.length&&(a.absCount=$(e[0]).text());b&&b(null,a)}})};b.prototype._getMediaInfo=function(a,b){var c=this;
this._doSOAPRequest(this.getURL(this.avTransport.url),this.avTransport.type,"GetMediaInfo",{InstanceID:a},function(a,d){if(a)b&&b(a);else{a={};var e=d.find("NrTracks");0<e.length&&(a.nrTracks=$(e[0]).text());e=d.find("MediaDuration");0<e.length&&(a.mediaDuration=$(e[0]).text());e=d.find("CurrentURI");0<e.length&&(a.currentURI=$(e[0]).text());e=d.find("CurrentURIMetaData");if(0<e.length)if((e=$(e[0]).text())&&"null"!=e.toLowerCase())try{var g=$($.parseXML(e));a.currentURIMetaDataRaw=g;a.currentURIMetaData=
c._parseItemMetaData(g)}catch(k){b&&b(k);return}else a.currentURIMetaDataRaw="",a.currentURIMetaData=null;e=d.find("NextURI");0<e.length&&(a.nextURI=$(e[0]).text());e=d.find("NextURIMetaData");if(0<e.length)if(e=$(e[0]).text())try{g=$($.parseXML(e)),a.nextURIMetaDataRaw=g,a.nextURIMetaData=c._parseItemMetaData(g)}catch(k){b&&b(k);return}else a.nextURIMetaDataRaw="",a.nextURIMetaData=null;e=d.find("PlayMedium");0<e.length&&(a.playMedium=$(e[0]).text());e=d.find("RecordMedium");0<e.length&&(a.ecordMedium=
...
x.upnp.XCUPNP=function(){var b=function(){this._udpListener=new x.upnp.UDPListener;this._discoveryService=new x.upnp.DiscoveryService(this._udpListener)};b.prototype.MediaServer=x.upnp.MediaServer;b.prototype.MediaRenderer=x.upnp.MediaRenderer;b.prototype.Device=x.upnp.Device;b.prototype.DescLoader=x.upnp.DescLoader;b.prototype.discoverDevices=function(a){this._discoveryService.addCallback("upnp:rootdevice",a);this._discoveryService.discoverTarget("upnp:rootdevice");var b=this;setTimeout(function(){b._discoveryService.removeCallback("upnp:rootdevice",
a)},5E3)};b.prototype.discoverDevicesWithTimeout=function(a,b){this._discoveryService.addCallback("upnp:rootdevice",b);this._discoveryService.discoverTarget("upnp:rootdevice");var c=this;setTimeout(function(){c._discoveryService.removeCallback("upnp:rootdevice",b)},a)};b.prototype.getDiscoveryService=function(){return this._discoveryService};return b}();var XCUPNP=x.upnp.XCUPNP;"undefined"!=typeof exports&&"undefined"!=typeof module&&module.exports&&(exports=module.exports=new x.upnp.XCUPNP);
