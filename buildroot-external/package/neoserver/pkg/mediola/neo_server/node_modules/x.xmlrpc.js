...
d=$(f[0]);b=d.prop("tagName");if("name"!=b)throw Error("struct member name invalid");b=d.text();if(!b)throw Error("struct member name invalid");d=$(f[1]);e[b]=this.deserializeValue(d)}}return e};x.xmlrpc.XML_CHAR_MAP={"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;","'":"&apos;"};x.xmlrpc.Handler.prototype._escapeXml=function(a){return a.replace(/[<>&"']/g,function(b){return x.xmlrpc.XML_CHAR_MAP[b]})};
...
x.xmlrpc.Handler.prototype._formatDateISO8601=function(a){var b=function(c){c=String(c);1===c.length&&(c="0"+c);return c};return Date.prototype.toISOString?a.toISOString():this.getUTCFullYear()+"-"+b(this.getUTCMonth()+1)+"-"+b(this.getUTCDate())+"T"+b(this.getUTCHours())+":"+b(this.getUTCMinutes())+":"+b(this.getUTCSeconds())+"."+String((this.getUTCMilliseconds()/1E3).toFixed(3)).slice(2,5)+"Z"};
