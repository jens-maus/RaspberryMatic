...
xnm.aio.artnet.Controller.prototype._doRequest=function(a,b,d){var c=[65,114,116,45,78,101,116,0];c=c.concat(a.concat([0,14]));c.push(0);c.push(0);c.push(0);c.push(0);a=b.length;512<a&&(a=512);c.push((a&65280)>>8);c.push(a&255);c=c.concat(b);b=require("dgram").createSocket("udp4");b.on("message",function(e,f){XC.debugf(e)});c=new Buffer(c);XC.debugf(c);b.send(c,0,18+a,this.port,this.ip,function(e,f){d&&d()})};
...
xnm.aio.artnet.Discovery=function(){this.detectedControllers={};this._sockets=[];var a=require("os"),b=require("dgram");if(a&&a.networkInterfaces){var d=this;b=b.createSocket("udp4");b.bind(6454,"0.0.0.0");b.on("message",function(f,g){d._receivedData(g.address,f)});a=a.networkInterfaces();for(var c in a){b=a[c];for(var e=0;e<b.length;e++)this._addDiscoverSocket(6454,b[e])}}else this._addDiscoverSocket(6454,null)};
...
xnm.aio.artnet.Discovery.prototype._addDiscoverSocket=function(a,b){var d=require("dgram"),c=this;if(b)"IPv4"==b.family&&0==b.internal&&(e=d.createSocket("udp4"),e.on("listening",function(){e.setBroadcast(!0)}),e.bind(a,b.address),this._sockets.push(e));else{var e=d.createSocket("udp4");e.on("message",function(f,g){c._receivedData(g.address,f)});this._sockets.push(e)}};
