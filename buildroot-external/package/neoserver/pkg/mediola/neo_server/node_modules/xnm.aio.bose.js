...
$jscomp.polyfillIsolated=function(g,c,a,b){var d=g.split(".");g=1===d.length;b=d[0];b=!g&&b in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var e=0;e<d.length-1;e++){var f=d[e];if(!(f in b))return;b=b[f]}d=d[d.length-1];a=$jscomp.IS_SYMBOL_NATIVE&&"es6"===a?b[d]:null;c=c(a);null!=c&&(g?$jscomp.defineProperty($jscomp.polyfills,d,{configurable:!0,writable:!0,value:c}):c!==a&&(void 0===$jscomp.propertyToPolyfillSymbol[d]&&(a=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[d]=$jscomp.IS_SYMBOL_NATIVE?
$jscomp.global.Symbol(d):$jscomp.POLYFILL_PREFIX+a+"$"+d),$jscomp.defineProperty(b,$jscomp.propertyToPolyfillSymbol[d],{configurable:!0,writable:!0,value:c})))};$jscomp.polyfill("Array.prototype.find",function(g){return g?g:function(c,a){return $jscomp.findInternal(this,c,a).v}},"es6","es3");var xnm=xnm||{};xnm.aio=xnm.aio||{};xnm.aio.bose=xnm.aio.bose||{};
...
"%positionState%":{value:"positionS"},"%shuffleState%":{value:"shuffleMode",options:["SHUFFLE_ON","SHUFFLE_OFF"]},"%volumeState%":{value:"volume",extMeta:"0-100"}};b.bass&&(d["%bass%"]={value:"setBass",value_t:"bass",ext:"%d",extMeta:b.bass},l["%bassState%"]={value:"bass",extMeta:b.bass});return a._injectToSmartWidgetTemplate(e,["media"],f,d,l,null)}}}();
