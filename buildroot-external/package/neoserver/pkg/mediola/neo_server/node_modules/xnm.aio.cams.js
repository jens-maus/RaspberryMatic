...
xnm.aio.cams=xnm.aio.cams||{};xnm.aio.cams._moveFromTmp=function(b,a,c){var e=require("fs"),d=e.createReadStream(b);a=e.createWriteStream(a);a.on("error",function(a){XC.debugf(a.message,"error");c&&c(a)});d.on("error",function(a){XC.debugf(a.message,"error");c&&c(a)});d.on("end",function(){try{e.unlinkSync(b)}catch(f){}c&&c()});d.pipe(a)};
