var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(c,a,b){c instanceof String&&(c=String(c));for(var d=c.length,e=0;e<d;e++){var g=c[e];if(a.call(b,g,e,c))return{i:e,v:g}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.ISOLATE_POLYFILLS=!1;$jscomp.FORCE_POLYFILL_PROMISE=!1;$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION=!1;
...
$jscomp.polyfillIsolated=function(c,a,b,d){var e=c.split(".");c=1===e.length;d=e[0];d=!c&&d in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var g=0;g<e.length-1;g++){var l=e[g];if(!(l in d))return;d=d[l]}e=e[e.length-1];b=$jscomp.IS_SYMBOL_NATIVE&&"es6"===b?d[e]:null;a=a(b);null!=a&&(c?$jscomp.defineProperty($jscomp.polyfills,e,{configurable:!0,writable:!0,value:a}):a!==b&&(void 0===$jscomp.propertyToPolyfillSymbol[e]&&(b=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[e]=$jscomp.IS_SYMBOL_NATIVE?
$jscomp.global.Symbol(e):$jscomp.POLYFILL_PREFIX+b+"$"+e),$jscomp.defineProperty(d,$jscomp.propertyToPolyfillSymbol[e],{configurable:!0,writable:!0,value:a})))};$jscomp.polyfill("Array.prototype.find",function(c){return c?c:function(a,b){return $jscomp.findInternal(this,a,b).v}},"es6","es3");$jscomp.arrayIteratorImpl=function(c){var a=0;return function(){return a<c.length?{done:!1,value:c[a++]}:{done:!0}}};$jscomp.arrayIterator=function(c){return{next:$jscomp.arrayIteratorImpl(c)}};
$jscomp.initSymbol=function(){};$jscomp.polyfill("Symbol",function(c){if(c)return c;var a=function(g,l){this.$jscomp$symbol$id_=g;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:l})};a.prototype.toString=function(){return this.$jscomp$symbol$id_};var b="jscomp_symbol_"+(1E9*Math.random()>>>0)+"_",d=0,e=function(g){if(this instanceof e)throw new TypeError("Symbol is not a constructor");return new a(b+(g||"")+"_"+d++,g)};return e},"es6","es3");
...
"es3");$jscomp.iteratorPrototype=function(c){c={next:c};c[Symbol.iterator]=function(){return this};return c};$jscomp.iteratorFromArray=function(c,a){c instanceof String&&(c+="");var b=0,d=!1,e={next:function(){if(!d&&b<c.length){var g=b++;return{value:a(g,c[g]),done:!1}}d=!0;return{done:!0,value:void 0}}};e[Symbol.iterator]=function(){return e};return e};$jscomp.polyfill("Array.prototype.keys",function(c){return c?c:function(){return $jscomp.iteratorFromArray(this,function(a){return a})}},"es6","es3");
var xnm=xnm||{};xnm.aio=xnm.aio||{};xnm.aio.cams=xnm.aio.cams||{};xnm.aio.cams._moveFromTmp=function(c,a,b){var d=require("fs"),e=d.createReadStream(c);a=d.createWriteStream(a);a.on("error",function(g){XC.debugf(g.message,"error");b&&b(g)});e.on("error",function(g){XC.debugf(g.message,"error");b&&b(g)});e.on("end",function(){try{d.unlinkSync(c)}catch(g){}b&&b()});e.pipe(a)};
xnm.aio.cams.rename=function(c,a,b,d){var e=function(){setTimeout(function(){b&&b()},100)};if("undefined"===typeof process||"object"!==typeof process.release||"node"!==process.release.name||"win32"!==process.platform&&!d){d=require("fs");try{d.renameSync(c,a)}catch(g){xnm.aio.cams.rename(c,a,e,!0);return}e&&e()}else this._moveFromTmp(c,a,e)};
...
xnm.aio.cams.SystemCam.prototype.executeCommand=function(c){if(this.controlurl){var a=this;this._$cam.find("key").each(function(){var b=$(this);if(b.attr("id")==c){var d=a.controlurl.replace("%@",b.attr("code")),e=null;a.controlpostdata&&(d=a.controlurl,e=a.controlpostdata.replace("%@",b.attr("code")));a._doRequest(d,e,function(g){g=500;if("left"==c||"right"==c)g=800;"XS100"==a._$cam.attr("id")?setTimeout(function(){d=a.controlurl.replace("%@","1");a._doRequest(d)},g):a._$cam.attr("stop")&&setTimeout(function(){d=
a.controlurl.replace("%@",a._$cam.attr("stop"));a._doRequest(d)},g/2)})}})}};xnm.aio.cams.JPEGCam=function(c,a,b,d){this._url=c;this._imgPath=b;this._imgPage=d;this._options=a;this._prevDone=!0};
xnm.aio.cams.JPEGCam.prototype._loadImage=function(c){var a=require("fs"),b=this;this._loadImage2Tmp(function(d,e){if(d&&a.existsSync(d)){var g=null;g="object"===typeof nw?nw.App.dataPath+"/../cams/":a.dataPath()+"/cams/";var l="image.jpg";b._options&&b._options.imageName&&(l=b._options.imageName);a.mkdirRecursiveSync(g);if(a.existsSync(g+l)){var f=g+l+"_"+(new Date).getTime();xnm.aio.cams.rename(g+l,f,function(){a.existsSync(f)&&a.unlinkSync(f);xnm.aio.cams.rename(d,g+l,function(){c&&c("file://"+
g+l+"?"+(new Date).getTime())})})}else xnm.aio.cams.rename(d,g+l,function(){c&&c("file://"+g+l+"?"+(new Date).getTime())})}else c&&c(null,e)})};xnm.aio.cams.JPEGCam.prototype._loadImage2Tmp=function(c){if(this._url)if(this._prevDone){var a=require("http");require("fs");var b=this;this._prevDone=!1;a.getFile(this._url,this._options,function(d,e){d?c&&c(d):(XC.debugf("failed to load "+b._url),c&&c(null,e));b._prevDone=!0},null,{encodeURL:!1})}else c&&c();else XC.debugf("[xnm.aio.cams.JPEGCam._loadImage] No URL set!")};
...
xnm.aio.cams.MJPEGCam.prototype._loadImage=function(c){var a=require("fs"),b=this;this._loadImage2Tmp(function(d){if(d){if(a.existsSync(d)){var e=null;e="object"===typeof nw?nw.App.dataPath+"/../cams/":a.dataPath()+"/cams/";var g="image.jpg";b._options&&b._options.imageName&&(g=b._options.imageName);a.mkdirRecursiveSync(e);if(a.existsSync(e+g)){var l=e+g+"_"+(new Date).getTime();xnm.aio.cams.rename(e+g,l,function(){a.existsSync(l)&&a.unlinkSync(l);xnm.aio.cams.rename(d,e+g,function(){c&&c("file://"+
e+g+"?"+(new Date).getTime())})})}else xnm.aio.cams.rename(d,e+g,function(){c&&c("file://"+e+g+"?"+(new Date).getTime())})}}else c&&c()})};
...
"");var d="&";-1==a.indexOf("?")&&(d="?");return a+=d+b};c.prototype._decodeXml=function(a){return a.replace(/&apos;/g,"'").replace(/&quot;/g,'"').replace(/&gt;/g,">").replace(/&lt;/g,"<").replace(/&amp;/g,"&")};c.prototype._doRequest=function(a,b,d,e,g){var l=require("url").parse(a),f=require("http");"https"==a.substring(0,5).toLowerCase()&&(f=require("https"),l.port||(l.port=443));l.port||(l.port=80);var h={host:l.hostname,port:l.port,path:l.path,method:"GET",headers:{"Content-Type":'text/xml; charset="utf-8"',
Connection:"close"}};g?h.headers.Authorization=g:b.user&&(b.password||(b.password=""),h.user=b.user,h.password=b.password,h.headers.Authorization="Basic "+(new Buffer(b.user+":"+b.password)).toString("base64"));d&&(h.method="POST",h.headers["Content-Length"]=d.length);var k=this;l=f.request(h,function(m){m.setEncoding("utf-8");var n="";m.on("data",function(p){n+=p});m.on("end",function(){XC.debugf("response:"+m.statusCode);if(401==m.statusCode&&!g&&m.headers&&m.headers["www-authenticate"]&&"Digest "==
m.headers["www-authenticate"].substr(0,7)){g=null;if(g=require("x.crypt.js").DigestAuth(m.headers["www-authenticate"],h.path,b.user,b.password,h.method)){g+=', opaque=""';XC.debugf("do digest auth:"+g);k._doRequest(a,b,d,e,g);return}var p=Error("http response:"+m.statusCode)}else 200!=m.statusCode&&(p=Error("http response:"+m.statusCode));e&&e(p,n)})});if(l.on)l.on("error",function(m){e&&e(m)});d&&l.write(d);l.end()};c.prototype.snapshot=function(a){this.getVideoInfo(function(b,d){b?a&&a(b):(b={user:d.username,
...
DoorBird.prototype.getStatesCreator=function(c,a,b){this.getStates(function(d,e){var g=[];if(!d&&e)for(d=0;d<a.length;d++)if(a[d]&&a[d].id&&a[d].status&&a[d].status.value){var l=a[d].status.value;null!=e[l]&&"undefined"!=typeof e[l]&&(l=e[l],g.push({id:a[d].id,status:l}))}b&&b(null,g)})};DoorBird.prototype.executeCommand=function(c,a){c&&c.value?"open_app"==c.value||"open_live"==c.value?(window&&window.XC&&window.XC.callHost&&window.XCHost&&window.XCHost.getType&&("iOS"==window.XCHost.getType()||
...
"get states");var a=require("xnm.aio.cams.js").getDoorBirdHandler(),b=a.getMonitor(this._options);b||(this._logger.log("trace","add monitor"),a._udpMonitor.isRunning()||a.startUdpMonitor(),b=a.addMonitor(this._options));var d={ring:!1,motion:!1,ringT:null,ringTStr:null,motionT:null,motionTStr:null},e=b._stateBuffer;if(e){this._logger.log("debug","buffered states in monitor:"+JSON.stringify(e));a=(new Date).getTime();for(var g in e)(b=e[g])&&b.length&&("motion"==g?1==b[0]&&1E4>=a-b[1]&&(d.motion=!0):
"ring"==g?1==b[0]&&1E4>=a-b[1]&&(d.ring=!0):"ringT"==g?(d.ringT=b[0],d.ringTStr=(new Date(b[0])).toLocaleString()):"motionT"==g&&(d.motionT=b[0],d.motionTStr=(new Date(b[0])).toLocaleString()))}if(d.ringT)this._logger.log("debug","return states:"+JSON.stringify(d)),c&&c(null,d);else{var l=this;this.getHistory("doorbell",1,function(f,h,k){null!=h&&(d.ringT=1E3*h,d.ringTStr=(new Date(1E3*h)).toLocaleString(),e.ringT=[d.ringT]);l._logger.log("debug","return states:"+JSON.stringify(d));c&&c(null,d)})}};
DoorBird.prototype.getInfo=function(c){this._doRequest("/bha-api/info.cgi",function(a,b){if(a)c&&c(a);else try{var d=JSON.parse(b);d&&d.BHA&&d.BHA.VERSION&&d.BHA.VERSION.length&&1==d.BHA.RETURNCODE?c&&c(null,d.BHA.VERSION[0]):c&&c(Error("info response invaild"))}catch(e){c&&c(e)}})};DoorBird.prototype.openDoor=function(c,a){this._logger.log("debug","open door (relay="+c+")");var b="/bha-api/open-door.cgi";c&&(b+="?r="+encodeURIComponent(c));var d=this;this._doRequest(b,function(e,g){d._logger.log("debug",
...
"&event="+c;this._logger.log("trace","load image: "+d);e={user:this._options.username,password:this._options.password};var g=this;require("xnm.aio.cams.js").createJPEGCam(d,e).loadImage(function(l,f){g._logger.log("trace","load image "+a+"@"+c+" finish: file="+l);b&&b(l,f)})};DoorBird.prototype.getHistory=function(c,a,b){var d=this;this._logger.log("trace","get history "+a+"@"+c);this._doRequest("/bha-api/history.cgi?index="+a+"&event="+c,function(e,g,l){e?(d._logger.log("trace","get history "+a+
"@"+c+" failed:"+e.message),b&&b(e)):(d._logger.log("trace","get history "+a+"@"+c+" headers:"+(l?JSON.stringify(l):"none")),g=e=null,l&&(void 0!=l["x-count"]&&null!=l["x-count"]&&(e=parseInt(l["x-count"])),void 0!=l["x-timestamp"]&&null!=l["x-timestamp"]&&(g=parseInt(l["x-timestamp"]))),b&&b(null,g,e))})};DoorBird.prototype._doRequest=function(c,a){var b=this._options.ip,d=this._options.port;d||(d=80);this._logger.log("trace","send to url:http://"+(b+":"+d+c));c={host:b,port:d,path:c,method:"GET",
headers:{Connection:"close"}};this._options.username&&(this._options.password||(this._options.password=""),c.headers.Authorization="Basic "+(new Buffer(this._options.username+":"+this._options.password)).toString("base64"));var e=require("http").request(c,function(g){g.setEncoding("utf-8");var l="";g.on("data",function(f){l+=f});g.on("end",function(){var f;200!=g.statusCode&&(f=Error("http response:"+g.statusCode));a&&a(f,l,g.headers)})});e.setTimeout&&e.setTimeout(2E3,function(){e.abort()});if(e.on)e.on("error",
function(g){a&&a(g)});e.end()};DoorBird.Handler=function(){var c=function(){this._logger=require("x.logger.js").getLogger("xnm.aio.cams.DoorBird.Handler.NativeDecrypter")};c.prototype.decrypt=function(f,h,k){this._logger.log("trace","decrypt data:"+f);h=h.substr(0,5);var m=this;XC.callHost("doorbird","decryptUdpMessage",{data:f,password:h},function(n){m._logger.log("trace","decrypt result:"+JSON.stringify(n));n?n.error?k&&k(Error(n.error)):k&&k(null,n):k&&k(Error("no reponse from xc doorbird module"))})};
var a=function(){this._logger=require("x.logger.js").getLogger("xnm.aio.cams.DoorBird.Handler.NodeJSDecrypter")};a.prototype.decrypt=function(f,h,k){this._logger.log("trace","decrypt data:"+f.substr(0,10)+"...");var m=parseInt(f.substr(8,8),16),n=parseInt(f.substr(16,8),16),p=new Buffer(f.substr(24,32),"hex"),q=new Buffer(f.substr(56,16),"hex");f=new Buffer(f.substr(72),"hex");h=new Buffer(h.substr(0,5),"utf8");var u=new Buffer(32);var r=require("sodium").api;r.crypto_pwhash_argon2i(u,h,p,m,n,1)?
(n=r.crypto_aead_chacha20poly1305_decrypt(f,null,q,u))?(h=n.slice(0,6).toString("utf8"),m=n.slice(6,14).toString("utf8").trim(),n=n.slice(14,18).readInt32BE(),h={intercom_id:h,event:m,timestamp:n},this._logger.log("trace","decrypt result:"+JSON.stringify(h)),k&&k(null,h)):k&&k(Error("decrypt failed")):k&&k(Error("password hash failed"))};var b=function(){this._logger=require("x.logger.js").getLogger("xnm.aio.cams.DoorBird.Handler.NWJSDecrypter")};b.prototype.decrypt=function(f,h,k){this._logger.log("trace",
"decrypt data:"+f);var m=this,n=parseInt(f.substr(8,8),16),p=parseInt(f.substr(16,8),16),q=new Buffer(f.substr(24,32),"hex"),u=new Buffer(f.substr(56,16),"hex"),r=new Buffer(f.substr(72),"hex");h=new Buffer(h.substr(0,5),"utf8");var t=null,x=new Buffer(32);t=require("libsodium-wrappers");t.ready.catch(function(v){k&&k(v)});t.ready.then(function(){var v=null;try{var w=t.crypto_pwhash(x.length,t.from_string(h.toString("utf8")),q,n,p,t.crypto_pwhash_ALG_ARGON2I13);v=t.crypto_aead_chacha20poly1305_decrypt(null,
r,null,u,w)}catch(y){k&&k(y);return}w=Buffer.from(v.slice(0,6)).toString("utf8");var z=Buffer.from(v.slice(6,14)).toString("utf8").trim();v=Buffer.from(v.slice(14,18)).readInt32BE();v={intercom_id:w,event:z,timestamp:v};m._logger.log("trace","(libsodium-wrappers) decrypt result:"+JSON.stringify(v));k&&k(null,v)})};var d=function(f,h){var k=this._gentId(f);this._logger=require("x.logger.js").getLogger("xnm.aio.cams.DoorBird.HttpMonitor.["+k+"]");this._listener=h;this._doorbird=f;this._running=!1;this._reconnectTO=
...
this._logger=require("x.logger.js").getLogger("xnm.aio.cams.DoorBird.HttpMonitor.["+f+"]");this._startHttpMonitor()};d.prototype._startHttpMonitor=function(){this._logger.log("debug","start http monitor");var f=this._doorbird.ip,h=this._doorbird.port,k=f.indexOf(":");-1==k||h||(h=f.substr(k+1));h||(h=80);var m=this;this._logger.log("trace","send to url:http://"+(f+":"+h+"/bha-api/monitor.cgi?ring=doorbell,motionsensor"));h={host:f,port:h,path:"/bha-api/monitor.cgi?ring=doorbell,motionsensor",method:"GET",
headers:{}};k=this._doorbird.username;var n=this._doorbird.password;k&&(h.auth=k+":"+(n?n:""));var p=!1,q=!1,u=require("http").request(h,function(r){r.setEncoding("utf-8");r.on("data",function(t){p=!0;m._dataTO&&(clearTimeout(m._dataTO),m._dataTO=null);m._dataTO=setTimeout(function(){m._logger.log("warn","monitor data timeout:"+f);u.abort();q||(q=!0,m._onClose(Error("data timeout")))},1E3*m.dataTimeout);m._onData(t)});r.on("end",function(){var t;509==r.statusCode?t=Error("door bird busy"):200!=r.statusCode&&
...
var e=function(f){this._logger=require("x.logger.js").getLogger("xnm.aio.cams.DoorBird.Handler.UdpMonitor");this._sockets=[];this._port=35344;this._running=!1;this._listener=f};e.prototype.start=function(){this._running||(this._running=!0,this._addDiscoverSocket(this._port,null))};e.prototype.isRunning=function(){return this._running};e.prototype._addDiscoverSocket=function(f,h){var k=require("dgram"),m=this;this._logger.log("trace","bind udp monitor on port "+f+(h?" ip "+h.address:""));if(!h){try{var n=
k.createSocket({reuseAddr:!0,type:"udp4"})}catch(p){n=k.createSocket("udp4")}n.on("message",function(p,q){m._receivedData(q.address,p)});n.on("error",function(p){m._logger.log("trace","bind udp monitor error "+p.message)});n.bind(f);this._sockets.push(n)}else if("IPv4"==h.family&&0==h.internal){try{n=k.createSocket({reuseAddr:!0,type:"udp4"})}catch(p){n=k.createSocket("udp4")}n.on("listening",function(){n.setBroadcast(!0)});n.on("message",function(p,q){m._receivedData(q.address,p)});n.on("error",
function(p){m._logger.log("trace","bind udp monitor error "+p.message)});n.bind(f,h.address);this._sockets.push(n)}};e.prototype._receivedData=function(f,h){h=h.toString("hex");this._logger.log("trace","receive data from "+f+" data "+h);if(this._listener&&this._listener.onUdpData)this._listener.onUdpData(f,h)};var g=function(f){var h=f.username+"@"+f.ip;this._logger=require("x.logger.js").getLogger("xnm.aio.cams.DoorBird.Monitor.["+h+"]");this._useHttpMonitor=this._supportHttpMonitor();this._doorbirdJSON=
f;this._httpMonitor=new d(f,this);this._listeners=[];this._stateBuffer={}};g.prototype._supportHttpMonitor=function(){var f=null;window&&!window.XCHost&&(f="node-webkit");window&&window.XCHost&&window.XCHost.getType&&(f=window.XCHost.getType());return"undefined"!==typeof nw?!0:"node-webkit"==f||"undefined"!=typeof process&&null!=process&&"node"==process.title?!0:!1};g.prototype.getRefId=function(){return doorBird.username+":"+doorBird.password+"@"+doorBird.ip+":"+doorBird.port};g.prototype.addListener=
function(f){f&&-1==this._listeners.indexOf(f)&&this._listeners.push(f)};g.prototype.removeListener=function(f){f=this._listeners.indexOf(f);-1!=f&&this._listeners.splice(f,1)};g.prototype.start=function(){this._logger.log("debug","start monitor");this._running||(this._running=!0,this._useHttpMonitor&&this._httpMonitor.start())};g.prototype.stop=function(){this._logger.log("debug","stop monitor");this._running&&(this._running=!1,this._listeners=[],this._useHttpMonitor&&this._httpMonitor.stop())};g.prototype.updateDoorbird=
function(f){if(this._doorbirdJSON&&this._doorbirdJSON.mac&&this._doorbirdJSON.mac==f.mac&&this._doorbirdJSON.ip!=f.ip){this._logger.log("debug","doorbird has new ip:"+f.ip);var h=this._doorbirdJSON.username+"@"+f.ip;this._logger=require("x.logger.js").getLogger("xnm.aio.cams.DoorBird.Monitor.["+h+"]");this._useHttpMonitor&&this._httpMonitor.updateIP(f.ip)}};g.prototype.onHttpData=function(f){this._logger.log("trace","receive notify:"+f.replace(/(\r\n|\n|\r)/gm,"\\n "));var h=f.indexOf("doorbell:"),
k=null,m=null;-1!=h&&(k=f.substr(h+9,1),k="H"==k?!0:!1);h=f.indexOf("motionsensor:");-1!=h&&(m=f.substr(h+13,1),m="H"==m?!0:!1);this._logger.log("debug","receive http event: ring="+k+" motion="+m);null!=m&&this._onEvent("motion",m);null!=k&&this._onEvent("ring",k)};g.prototype.onUdpData=function(f,h){this._logger.log("trace","decrypt udp data");var k=this._doorbirdJSON;if(k&&k.password){var m=this._getDecrypter();if(m){var n=this;m.decrypt(f,k.password,function(p,q){n._logger.log("trace","decrypt data "+
(p?"failed: "+p.message:"success"));!p&&q&&(k.username&&k.username.indexOf(q.intercom_id),n._logger.log("debug","receive udp event: "+JSON.stringify(q)),"motionsensor"==q.event||"motion"==q.event?n._onEvent("motion",!0):isNaN(parseInt(q.event))||n._onEvent("ring",!0));h&&h(p,q)})}else this._logger.log("trace","decrypt data failed: can not find decrypter"),h&&h(Error("can not find decrypter"))}else this._logger.log("trace","decrypt data failed: no password"),h&&h(Error("no password"))};g.prototype._onEvent=
function(f,h){var k=(new Date).getTime();this._stateBuffer[f]=[h,k];"ring"==f&&1==h?this._stateBuffer.ringT=[k]:"motion"==f&&1==h&&(this._stateBuffer.motionT=[k]);for(k=0;k<this._listeners.length;k++){var m=this._listeners[k];if(m.onEvent)try{m.onEvent(f,h)}catch(n){}}};g.prototype._getDecrypter=function(){var f=null;window&&!window.XCHost&&(f="node-webkit");window&&window.XCHost&&window.XCHost.getType&&(f=window.XCHost.getType());return"undefined"!==typeof nw?new b:"node-webkit"==f||"undefined"!=
typeof process&&null!=process&&"node"==process.title?new a:new c};var l=function(){this._logger=require("x.logger.js").getLogger("xnm.aio.cams.DoorBird.Handler");this._udpMonitor=new e(this);this._monitors={}};l.prototype.finalize=function(){for(var f in this._monitors){var h=this._monitors[f];h&&h.stop()}this._monitors={}};l.prototype.startUdpMonitor=function(){this._udpMonitor.start()};l.prototype.addMonitor=function(f){if(f){var h=f.username+":"+f.password+"@"+f.ip,k=this._monitors[h];if(k)throw Error("monitor already exit");
k=new g(JSON.parse(JSON.stringify(f)));this._monitors[h]=k;k.start();return k}};l.prototype.removeMonitor=function(f){if(f){f=f.username+":"+f.password+"@"+f.ip;var h=this._monitors[f];h&&(h.stop(),delete this._monitors[f])}};l.prototype.getMonitor=function(f){return f?this._monitors[f.username+":"+f.password+"@"+f.ip]:null};l.prototype.onUdpData=function(f,h){if(h&&"DEADBE"==h.substr(0,6).toUpperCase()&&"01"==h.substr(6,2)){var k=Object.keys(this._monitors);if(k.length){var m=0,n=this,p=function(){m++;
if(m<k.length)n._monitors[k[m]].onUdpData(h,p)};this._monitors[k[m]].onUdpData(h,p)}}};return l}();return DoorBird}();xnm.aio.cams.Foscam=function(c,a){xnm.aio.cams.Cam.call(this,c,a);this._logger=require("x.logger.js").getLogger("xnm.aio.cams.Foscam")};xnm.aio.cams.Foscam.prototype=new xnm.aio.cams.Cam;xnm.aio.cams.Foscam.prototype.constructor=xnm.aio.cams.Foscam;
...
password:this._options.password},null,function(e,g){b&&b(e,g)})):b&&b(Error("unknow preset command"))}else b&&b(Error("no control url"))};xnm.aio.cams.Welcome=function(c,a){xnm.aio.cams.Cam.call(this,c,a);this._logger=require("x.logger.js").getLogger("xnm.aio.cams.Welcome")};xnm.aio.cams.Welcome.prototype=new xnm.aio.cams.Cam;xnm.aio.cams.Welcome.prototype.constructor=xnm.aio.cams.Welcome;
...
xnm.aio.cams.DM=function(){var c=function(a,b){this.code=a;this.message=b;this.stack=Error().stack};c.prototype=Error();c.prototype.name="CamDMError";c.prototype.code=0;c.ERROR_CODE={DEFAULT:0,INDEX_EXISTS:1,ID_EXISTS:2,INVALID:3,UNKNOW:4,NOT_FOUND:5,IP_EXISTS:6};return{SYS:"cam",getIPDeviceType:function(a,b){var d=[],e;for(e in xnm.aio.cams.CAM_INFO)if(xnm.aio.cams.CAM_INFO.hasOwnProperty(e)){var g=xnm.aio.cams.CAM_INFO[e];if((!(b&&b.lm&&b.license)||b.lm.permitFeature("read",{sys:this.SYS,type:"system",
manufacturer:e},b.license))&&g.name){var l={category:"system",type:e,name:g.name,versions:[]};if(g.versions)for(var f=0;f<g.versions.length;f++){var h=g.versions[f];h&&h.id&&h.name&&l.versions.push({model:h.id,name:h.name,link:h.link})}d.push(l)}}if(a&&(a=a.getIPCams()))for(e=0;e<a.length;e++)if(l=a[e],(g=$(l).getAttributes())&&g.id&&g.name&&!xnm.aio.cams.CAM_INFO[g.id]&&(!(b&&b.lm&&b.license)||b.lm.permitFeature("read",{sys:this.SYS,type:"custom",manufacturer:g.id},b.license))&&(g={category:"custom",
type:g.id,name:g.name,versions:[]},d.push(g),l=$(l).children()))for(f=0;f<l.length;f++)(h=$(l[f]).getAttributes())&&h.id&&h.name&&g.versions.push({model:h.id,name:h.name});return[{sys:this.SYS,name:"IP Camera",types:d}]},createDevice:function(a,b,d){b=c.ERROR_CODE;a?a.type?a.ip?d(null,a):d(new c(b.INVALID,"ip is invalid")):d(new c(b.INVALID,"type is invalid")):d(new c(b.INVALID,"info is invalid"))},updateDevice:function(a,b,d){b=c.ERROR_CODE;a?a.type?a.ip?d(null,a):d(new c(b.INVALID,"ip is invalid")):
d(new c(b.INVALID,"type is invalid")):d(new c(b.INVALID,"info is invalid"))},deleteDevice:function(a,b,d){d()},applyUIFilter:function(a,b,d){var e=function(k,m){if("*"==k)return!0;for(var n=!1,p=0;p<k.length;p++)if(k[p]==m){n=!0;break}return n},g=function(k,m,n){var p=[];switch(n.catagory){case "command":k.command&&k.command.forEach(function(q){e(n.elems,q.type)&&(q=JSON.parse(JSON.stringify(q)),p.push(q))});break;case "status":k.status&&k.status.forEach(function(q){e(n.elems,q.type)&&(q=JSON.parse(JSON.stringify(q)),
p.push(q))})}return p},l=function(k,m){var n=[],p=xnm.aio.cams.DM.getCommandStatusMap(k,d);p&&(k=g(p,k,m),n=n.concat(k));return n};if(!a.sys)return null;var f=JSON.parse(JSON.stringify(a)),h=null;switch(b.catagory){case "command":h=l(a,b);f.command=h;break;case "status":h=l(a,b);f.status=h;break;default:return null}return h&&0!=h.length?f:null},applyNeoServerFilter:function(a,b,d){var e=function(k,m){if("*"==k)return!0;for(var n=!1,p=0;p<k.length;p++)if(k[p]==m){n=!0;break}return n},g=function(k,
...
l(a,b);f.command=h;break;case "status":h=l(a,b);f.status=h;break;default:return null}return h&&0!=h.length?f:null},applyIPEventFilter:function(a,b,d){return(a=this.getCamInfo(a,d))&&a.ipevt?{ipevt:a.ipevt}:null},getCamInfo:function(a,b){var d=function(f,h){for(var k in f)f.hasOwnProperty(k)&&(h[k]=f[k]);return h},e=function(f){var h=f.type;"tfcam"==f.type&&(h="telefunken");h=xnm.aio.cams.CAM_INFO[h];if(!h)return null;for(var k,m=0;m<h.versions.length;m++){var n=h.versions[m];if(n&&n.id==f.model){k=
n;break}}if(!k)return null;if(!k.link||k.link==f.type+"."+f.model)return k;f=k.link.indexOf(".");f=e({type:k.link.substr(0,f),model:k.link.substr(f+1)});if(!f)return null;f=JSON.parse(JSON.stringify(f));return d(k,f)},g=function(f,h){var k,m=h.find('cam[id="'+f.type+'"]');m&&0<m.length&&(k=m[0]);if(!k)return null;k=$(k).find('version[id="'+f.model+'"]');if(!k||0==k.length)return null;k=k[0];m=$(k).attr("link");if(!m||m==f.type+"."+f.model){k=$(k);h=k.getAttributes();h=JSON.parse(JSON.stringify(h));
k=k.children();for(f=0;f<k.length;f++){var n=$(k[f]);n&&(m=n.attr("id"),n=n.attr("code"),m&&n&&(h.keys||(h.keys=[]),h.keys.push({id:m,code:n})))}return h}f=m.indexOf(".");if(n=e({type:m.substr(0,f),model:m.substr(f+1)}))return h=JSON.parse(JSON.stringify(n)),d(k,h);n=g({type:m.substr(0,f),model:m.substr(f+1)},h);if(!n)return null;h=JSON.parse(JSON.stringify(n));return d(k,h)};if(!a.type||!a.model)return null;"system"!=a.type&&"custom"!=a.type||!a.manufacturer||(a=JSON.parse(JSON.stringify(a)),a.type=
a.manufacturer);var l=e(a);!l&&b&&(l=g(a,b));return l},getCommandStatusMap:function(a,b){b=this.getCamInfo(a,b);if(!b||!b.pantilt||"false"==b.pantilt)return null;var d={command:[]};if(b.keys)for(var e=0;e<b.keys.length;e++){var g=b.keys[e];d.command.push({type:"enum",name:g.id,ref:{value:g.id}})}b.command&&(d.command=d.command.concat(b.command));b.status&&(d.status=b.status);"system"==a.type&&"doorbird"==a.manufacturer&&(a.relays&&a.relays.length&&d.command.push({type:"enum",name:"open relay",ref:{value:"open_relay",
...
(this._foscamDiscovery=new xnm.aio.cams.FoscamDiscovery);this._foscamDiscovery.discoverCams()};c.prototype.getDoorBirdHandler=function(){return this._doorbirdHandler};c.prototype.discoverDoorbird=function(a,b){var d=this,e=require("x.mdns.js");e.clearRecordBuffer();e.discoverServiceWithTimeout("_axis-video._tcp.local",a,function(g,l){if(g)b&&b(g);else{g=[];for(var f=0;f<l.length;f++){var h=l[f];if(h.domain&&"Doorstation"==h.domain.substr(0,11)&&h.ip&&0<h.ip.length){var k={sys:"cam",type:"system",
manufacturer:"doorbird",ip:h.ip[0],port:80};h.info&&h.info.macaddress&&(k.mac=h.info.macaddress);(h=d.resolveDevice(k))&&g.push(h)}}b&&b(null,g)}})};c.prototype.finalize=function(a){this._doorbirdHandler&&this._doorbirdHandler.finalize();a&&a()};c.prototype.pause=function(a){this.finalize(a)};return c}();"undefined"!=typeof module&&null!=module&&(module.exports=new xnm.aio.cams.Handler);
