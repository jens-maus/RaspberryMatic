...
f){c?a&&a(c):c||!f||401!=f.statusCode||b?a&&a():(d._jpegCam=null,d.loadImage(a,!0))}):this.getLivePreview(function(c,b){!c&&b&&b.url&&b.token?(c="https://"+b.host+"/cameras/"+d._camID+"/live_preview",d._jpegCam=require("xnm.aio.cams.js").createJPEGCam(c,{headers:{Authorization:"Bearer "+b.token},imageName:d._camID+".jpg"}),d.loadImage(a,!0)):a&&a()})};e.parseJSON=function(a,b){return a&&a.connection&&a.id?new e(a.connection,a.id,b,a.format):null};return e}();
...
"/service/userInfo",null,null,function(c,b){a(c,b)})};b.prototype.getModulesInfo=function(a){var c="/service/moduleInfo";this._cloudservice._moduleFlags&&this._cloudservice._moduleFlags.bosch_enabled&&(c+="?bosch_enabled=true");this._cloudservice._doJsonRequest("GET",c,null,null,function(c,b){a(c,b)})};b.prototype.toCloudDevice=function(a,b){this._cloudservice._doJsonRequest("POST","/service/toCloudDevice",null,a,function(a,c){b(a,c)})};var d=function(c,d,g,h,k,l){this._logger=require("x.logger.js").getLogger("xnm.aio.cloudservice.CloudService");
this._ip=c;this._ip||(this._ip="cloud.mediola.com");this._port=d;this._port||(this._port=443);this._username=g;this._password=h;this._moduleInfo=k;this._moduleFlags=l||{};this._protocol="https";this._eapi=new a(this);this._ruleEngine=new e(this);this._service=new b(this)};d.prototype.getIP=function(){return this._ip};d.prototype.getPort=function(){return this._port};d.prototype.getUsername=function(){return this._password};d.prototype.getUserInfo=function(a){this._service.getUserInfo(a)};d.prototype.getModulesInfo=
function(a){this._service.getModulesInfo(a)};d.prototype.toCloudDevice=function(a,b){this._service.toCloudDevice(a,b)};d.prototype.doEAPIRequest=function(a,b,d,e,k,l){this._eapi.doRequest(a,b,d,e,k,l)};d.prototype.disconenct=function(a,b,d){this._eapi.disconenct(a,b,d)};d.prototype.getModuleConnectionInfo=function(a,b,d){this._eapi.getModuleConnectionInfo(a,b,d)};d.prototype.getModuleInfo=function(a,b){this._eapi.getModuleInfo(a,b)};d.prototype.getModuleDevices=function(a,b){this._eapi.getModuleDevices(a,
b)};d.prototype.getModuleStates=function(a,b){this._eapi.getModuleStates(a,b)};d.prototype.executeModuleCommand=function(a,b,d){this._eapi.executeModuleCommand(a,b,d)};d.prototype.getRules=function(a){this._ruleEngine.getRules(a)};d.prototype.addRule=function(a,b){this._ruleEngine.addRule(a,b)};d.prototype.updateRule=function(a,b,d){this._ruleEngine.updateRule(a,b,d)};d.prototype.deleteRule=function(a,b){this._ruleEngine.deleteRule(a,b)};d.prototype.deleteRules=function(a,b){this._ruleEngine.deleteRules(a,
b)};d.prototype.getAccessToken=function(a,b,d){a={sid:a};b&&(a.force=1);this._doJsonRequest("GET","/getAccessToken",a,null,function(a,b){a?d&&d(a):b?d&&d(null,b.at):d&&d(Error("invalid response"))})};d.prototype.executeCommandCreator=function(a,b,d){if(a&&a.module&&a.connection&&a.id)if(b&&b.value){var c={connection:a.connection,device:a.id,command:b.value};if("undefined"!=typeof b.ext&&null!=b.ext)if(Array.isArray(b.ext)){var e={};b.ext.forEach(function(a){a&&a.value&&(e[a.value]=a.ext)});c.value=
e}else c.value=b.ext;this.executeModuleCommand(a.module,c,function(a){d&&d(a)})}else d&&d(Error("command json invalid"));else d&&d(Error("device json invalid"))};d.prototype.getStatesCreator=function(a,b,d){var c=this;a=function(a,b){c.getModuleStates(a,function(c,d){b(c,d,a)})};var e=[],l;for(l=0;l<b.length;l++){var m=b[l];m&&m.device&&m.device.module&&-1==e.indexOf(m.device.module)&&e.push(m.device.module)}if(0==e.length)d&&d(null,[]);else{var f=0,g=[];for(l=0;l<e.length;l++)a(e[l],function(a,c,
m){f++;var l=[];if(!a&&c)for(var k=0;k<b.length;k++){var h=b[k];if(h&&h.id&&h.device&&h.device.module==m){var p=null;if(h.device&&h.device.connection&&h.device.id&&h.status&&h.status.value){var q=c[h.device.connection];q&&q[h.device.id]&&(q=q[h.device.id].states)&&(p=q[h.status.value])}if("undefined"==typeof p||null==p)p="?";g.push({id:h.id,status:p});l.push({id:h.id,status:p})}}"undefined"!=typeof commandhandler&&null!=commandhandler&&"undefined"!=typeof commandhandler.reportStates&&null!=commandhandler.reportStates&&
!a&&l&&0<l.length&&commandhandler.reportStates(null,l);f==e.length&&d&&d(null,g)})}};d.prototype.getDeviceList=function(a,b){this.getModuleDevices(a,function(c,d){if(c)b(c);else{c=[];if(d)for(var e in d){var l=d[e],m;for(m in l){var f=l[m];f&&(f.sys="cloudservice",f.module=a,f.connection=e,f.id=m,c.push(f))}}b(null,c)}})};d.prototype._doJsonRequest=function(a,b,d,e,k){var c=null;e&&(c=JSON.stringify(e));this._doRequest(a,b,d,c,function(a,b,c,d){a?k&&k(a):b?b.XC_ERR?(a=Error("error response:"+b.XC_ERR.msg),
a.code=b.XC_ERR.code,k&&k(a)):b.XC_SUC?k&&k(null,b.XC_SUC,c,d):k&&k(Error("unknown response")):k&&k(Error("invalid response"))})};d.prototype._resolveServerIP=function(a){if("/eapi/"==a.substr(0,6)&&(a=a.split("/")[3])&&this._moduleInfo&&this._moduleInfo[a]&&this._moduleInfo[a].domain){a=this._moduleInfo[a].domain;var b=a.indexOf(":");return-1!=b?a.substr(0,b):a}return this._ip};d.prototype._resolveServerPort=function(a){if("/eapi/"==a.substr(0,6)&&(a=a.split("/")[3])&&this._moduleInfo&&this._moduleInfo[a]&&
this._moduleInfo[a].domain){a=this._moduleInfo[a].domain;var b=a.indexOf(":");return-1!=b?parseInt(a.substr(b+1)):443}return this._port};d.prototype._doRequest=function(a,b,d,e,k){var c=b;c||(c="/");var m={};d&&(m=JSON.parse(JSON.stringify(d)));d="";for(var f in m)m.hasOwnProperty(f)&&(d&&(d+="&"),d+=f+"="+encodeURIComponent(m[f]));d&&(c+="?"+d);a={host:this._resolveServerIP(b),port:this._resolveServerPort(b),path:c,method:a,headers:{Connection:"close","Content-Type":"application/json; charset=UTF-8"}};
...
(c.headers.Authorization="*********"));c.auth&&(c.auth="********");this._logger.log("trace","do request:"+JSON.stringify(c));var g=this,h=k,n=b.request(a,function(a){a.setEncoding("utf-8");var b="";a.on("data",function(a){b+=a});a.on("end",function(){g._logger.log("trace","receive code:"+a.statusCode+" headers:"+JSON.stringify(a.headers)+" response:"+b);if(200==a.statusCode)try{var c=b?JSON.parse(b):null}catch(r){var d=r}else d=Error("http reponse:"+a.statusCode);h&&(h(d,c,a.statusCode,a.headers),
h=null)})});if(n.on)n.on("error",function(a){g._logger.log("trace","do request error:"+a.message);h&&(h(a),h=null)});n.setTimeout&&n.setTimeout(2E4,function(){g._logger.log("trace","do request timeout");n.abort();h&&(h(Error("timeout")),h=null)});e&&(this._logger.log("trace","do request send body:"+e),n.write(e));n.end()};d.prototype.toJSON=function(){return{sys:"cloudservice",username:this._username,password:this._password,ip:this._ip,port:this._port}};d.prototype.equalsTo=function(a){return a&&
a instanceof d?this._ip==a._ip&&this._port==a._port&&this._username==a._username&&this._password==a._password:!1};d.parseJSON=function(a){return a&&a.username&&a.password?new d(a.ip,a.port,a.username,a.password,a.moduleInfo,{bosch_enabled:a.bosch_enabled}):null};return d}();
...
JSON.parse(JSON.stringify(a));b.states&&(b.details={states:{}},b.states.motion&&(b.details.states.motion={value:"motion"}));break;case "contact":b=JSON.parse(JSON.stringify(a));b.states&&(b.details={states:{}},b.states.contact&&(b.details.states.state={value:"contact"}));break;case "window":b=JSON.parse(JSON.stringify(a)),b.states&&(b.details={states:{}},b.states.window&&(b.details.states.state={value:"window"}))}break;case "bosch":switch(a.type){case "switch":b={type:"switch",commands:{on:{},off:{},
toggle:{}},states:{state:{values:["on","off"]},power:{type:"FLOAT",unit:"W"},consumption:{type:"FLOAT",unit:"W"}},details:{commands:{on:{value:"on"},off:{value:"off"},toggle:{value:"toggle"}},states:{state:{value:"state"},power:{value:"power"},consumption:{value:"energy"}}}};break;case "shutter":b={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100}}},states:{position:{type:"INT",min:0,max:100}},details:{commands:{up:{value:"up"},down:{value:"down"},stop:{value:"stop"},
position:{value:"position"}},states:{position:{value:"position"}}}};break;case "heater":b={type:"heater",commands:{up:{},down:{},temperature:{value:{type:"FLOAT",min:5,max:30.5,step:.5}}},states:{state:{type:"FLOAT",min:5,max:30.5,step:.5},temperature:{type:"FLOAT"},mode:{values:["automatic","manual"]}},details:{commands:{up:{value:"up"},down:{value:"down"},temperature:{value:"temperature"}},states:{state:{value:"state"},temperature:{value:"temperature"},mode:{value:"mode"}}}};break;case "contact":b=
{type:"contact",states:{state:{values:["open","closed"]}},details:{states:{state:{value:"state"}}}}}}return b},supportSmartWidget:function(a,b){if(!a||!a.module)return!1;switch(a.module){case "gardena":case "netatmo":case "openweathermap":case "nuki":case "uhoo":return!0;case "ring":return"doorbell"==a.type;case "homematic":switch(a.type){case "home":return!0;case "room":return!0;case "enviroment":return!0;case "security":return!0;case "presence":return!0;case "smoke":return!0;case "water":return!0;
case "weather":return!0;default:return!1}default:return!1}},applySmartWidgetFilter:function(a,b,d,c,e){if(!b||!b.module)return null;var f=d=null,h=null,k=null;d=function(a,b){switch(a.module){case "bosch":"camera"===a.type&&(a.commands&&a.commands.position?b.push("bosch_cam"):b.push("bosch_cam_eyes"));break;case "gardena":switch(a.type){case "mower":b.push("gardena_mower");break;case "switch":b.push("gardena_switch");break;case "sensor":b.push("gardena_sensor");break;case "ic24":b.push("gardena_ic24");
break;case "valve":b.push("gardena_valve")}break;case "netatmo":switch(a.type){case "NAMain":b.push("netatmo_basestation");break;case "NAModule1":case "NAModule4":b.push("climate");b.push("notification");break;case "NAModule2":b.push("netatmo_wind");b.push("notification");break;case "NAModule3":b.push("netatmo_rain"),b.push("notification")}break;case "openweathermap":b.push("openweathermap");break;case "nuki":b.push("nuki");break;case "ring":switch(a.type){case "doorbell":b.push("motion")}break;case "uhoo":b.push("uhoo");
break;case "homematic":switch((a.states.battery||a.states.timeout||a.states.sabotage)&&b.push("notification"),a.type){case "home":b.push("weather_station");b.push("climate");b.push("home");break;case "enviroment":(a.states.temperature||a.states.humidity)&&b.push("climate");a.states.rain&&b.push("rain");break;case "security":a.states.motion&&b.push("motion");(a.states.moisture||a.states.water)&&b.push("sensor_water");a.states.presence&&b.push("motion");a.states.window&&(b.push("window"),b.push("contact"));
a.states.smoke&&b.push("smoke");break;case "presence":a.states.presence&&b.push("motion");break;case "smoke":a.states.smoke&&b.push("smoke");break;case "water":a.states.water&&b.push("sensor_water");break;case "weather":b.push("weather_station"),b.push("climate")}}return b}(b,d?d:[]);f=function(a,b){switch(a.module){case "bosch":"camera"===a.type&&(a=a.commands,b["%toggle%"]={value:"toggle"},a&&a.position&&(b["%camPosition%"]={value:"position",ext:"%d",extMeta:"-120-120"}));break;case "gardena":if(!a.commands)break;
switch(a.type){case "mower":b["%start%"]={value:"start_override_timer",ext:"%d",extMeta:"60-6000",scale:60};b["%park%"]={value:"park_until_next_task"};break;case "switch":b["%on%"]={value:"on"};b["%onFor%"]={value:"on_for",ext:"%d",extMeta:"60-7200",scale:60};b["%off%"]={value:"off"};break;case "ic24":b["%stopAll%"]={value:"stop_all_valve"};break;case "valve":b["%run%"]={value:"run",ext:"%d",extMeta:"60-3600",scale:60},b["%pause%"]={value:"pause",ext:"%d",extMeta:"60-604800",scale:60},b["%resume%"]=
{value:"resume"},b["%stop%"]={value:"stop"}}break;case "nuki":b["%unlock%"]={value:"unlock"};b["%lock%"]={value:"lock"};b["%open%"]={value:"lock_n_go"};break;case "homematic":if(a.commands)switch(a.type){case "home":a.commands.alarm_mode&&(b["%alarmModeDisarm%"]={value:"alarm_mode",ext:"disarmed"},b["%alarmModeProtectExternal%"]={value:"alarm_mode",ext:"external_protection"},b["%alarmModeProtectFull%"]={value:"alarm_mode",ext:"full_protection"}),a.commands.auto&&(b["%thermoAuto%"]={value:"auto"}),
a.commands.eco&&(b["%thermoEco%"]={value:"eco",extMeta:[{type:"time",name:"start",ref:{value:"start",ext:"%time"}},{type:"time",name:"end",ref:{value:"end",ext:"%time"}}]}),a.commands.vacation&&(b["%thermoVacation%"]={value:"vacation",extMeta:[{type:"float",name:"temperature",ref:{value:"temperature",ext:"%f",extMeta:"5-30",scale:.5}},{type:"time",name:"end",ref:{value:"end",ext:"%time"}}]})}}return b}(b,f?f:{});h=function(a,b){switch(a.module){case "bosch":"camera"===a.type&&(b["%camOnline%"]={value:"online"},
a.states&&a.states.position&&(b["%camPosition%"]={value:"position",extMeta:"-120-120"}),b["%camState%"]={value:"state"});break;case "gardena":if(!a.states)break;a.states.online&&(b["%online%"]={value:"online",options:["true","false"]});switch(a.type){case "mower":b["%state%"]={value:"state",options:"paused ok_cutting ok_cutting_timer_overridden ok_searching ok_leaving ok_charging parked_timer parked_park_selected parked_autotimer none".split(" ")};break;case "switch":b["%state%"]={value:"state",options:["off",
"forever_on","time_limited_on","scheduled_on"]};b["%duration%"]={value:"duration"};break;case "sensor":b["%tempAmbient%"]={value:"ambient_temperature"};b["%tempSoil%"]={value:"soil_temperature"};b["%humSoil%"]={value:"soil_humidity"};b["%light%"]={value:"light"};break;case "valve":b["%state%"]={value:"state",options:["closed","manual_watering","scheduled_watering"]},b["%duration%"]={value:"duration"}}break;case "netatmo":switch(a.type){case "NAMain":b["%tempState%"]={value:"temperature"};b["%humState%"]=
{value:"humidity"};b["%co2State%"]={value:"co2"};b["%noiseState%"]={value:"noise"};b["%pressureState%"]={value:"pressure"};break;case "NAModule1":case "NAModule4":b["%tempState%"]={value:"temperature"};b["%humState%"]={value:"humidity"};b["%lowbat%"]={value:"battery",conv_i:{"0|30":!0,"31|100":!1}};break;case "NAModule2":b["%windspeedState%"]={value:"wind_speed"};b["%windDirection%"]={value:"wind_direction"};b["%lowbat%"]={value:"battery",conv_i:{"0|30":!0,"31|100":!1}};break;case "NAModule3":b["%rain%"]=
{value:"rain"},b["%rain_last_hour%"]={value:"rain_last_hour"},b["%rain_last_day%"]={value:"rain_last_day"},b["%lowbat%"]={value:"battery",conv_i:{"0|30":!0,"31|100":!1}}}break;case "openweathermap":b["%tempState%"]={value:"temperature"};b["%humState%"]={value:"humidity"};b["%windspeedState%"]={value:"wind_speed"};b["%windDirection%"]={value:"wind_direction"};break;case "nuki":b["%lockStatus%"]={value:"state",conv_s:{locked:"locked",unlocked:"open"}};break;case "ring":switch(a.type){case "doorbell":b["%motionState%"]=
{value:"state",conv_s:{locked:"locked",unlocked:"open"}}}break;case "uhoo":b["%onlineState%"]={value:"online"};b["%tempState%"]={value:"temperature",extMeta:"-40-85"};b["%tempUnit%"]={value:"temperature_unit"};b["%humState%"]={value:"humidity",extMeta:"0-100"};b["%dustState%"]={value:"dust",extMeta:"0-200"};b["%vocState%"]={value:"voc",extMeta:"0-1200"};b["%co2State%"]={value:"co2",extMeta:"400-10000"};b["%coState%"]={value:"co",extMeta:"0-1000"};b["%pressureState%"]={value:"pressure",extMeta:"300-1100"};
b["%no2State%"]={value:"no2",extMeta:"0-1000"};b["%ozoneState%"]={value:"ozone",extMeta:"0-1000"};b["%measured%"]={value:"measured"};break;case "homematic":switch(a.states.battery&&(b["%lowbat%"]={value:"battery",conv_i:{"0|30":"true","31|100":"false"}}),a.states.timeout&&(b["%timeout%"]={value:"timeout"}),a.states.sabotage&&(b["%sabotage%"]={value:"sabotage"}),a.type){case "home":a.states.temperature&&(b["%tempState%"]={value:"temperature"});a.states.humidity&&(b["%humState%"]={value:"humidity"});
a.states.wind_speed&&(b["%windspeedState%"]={value:"wind_speed"});a.states.wind_direction&&(b["%windDirection%"]={value:"wind_direction"},b["%windDirection%"].conv_i={"0|22":"N","23|67":"NO","68|112":"O","113|157":"SO","158|202":"S","203|247":"SW","248|292":"W","293|337":"NW","338|360":"N"});a.states.alarm_mode&&(b["%alarmMode%"]={value:"alarm_mode"});a.states.mode&&(b["%thermoMode%"]={value:"mode"});break;case "enviroment":a.states.temperature&&(b["%tempState%"]={value:"temperature"});a.states.humidity&&
(b["%humState%"]={value:"humidity"});a.states.rain&&(b["%rainState%"]={value:"rain"});break;case "security":a.states.motion&&(b["%motionState%"]={value:"motion"});if(a.states.moisture||a.states.water)b["%waterState%"]={value:"water",conv_s:{"true":"water","false":"dry"}};a.states.presence&&(b["%motionState%"]||(b["%motionState%"]={value:"presence"}));a.states.window&&(b["%windowState%"]={value:"window"},b["%contactState%"]={value:"window"});a.states.smoke&&(b["%smokeState%"]={value:"smoke"});break;
case "presence":a.states.presence&&(b["%motionState%"]={value:"presence"});a.states.illumination&&(b["%motionBrightness%"]={value:"illumination"});break;case "smoke":a.states.smoke&&(b["%smokeState%"]={value:"smoke"});break;case "water":a.states.water&&(b["%waterState%"]={value:"water",conv_s:{"true":"water","false":"dry"}});break;case "weather":a.states.temperature&&(b["%tempState%"]={value:"temperature"}),a.states.humidity&&(b["%humState%"]={value:"humidity"}),a.states.illumination&&(b["%brightnessState%"]=
{value:"illumination"}),a.states.wind_speed&&(b["%windspeedState%"]={value:"wind_speed"}),a.states.wind_direction&&(b["%windDirection%"]={value:"wind_direction"},b["%windDirection%"].conv_i={"0|22":"N","23|67":"NO","68|112":"O","113|157":"SO","158|202":"S","203|247":"SW","248|292":"W","293|337":"NW","338|360":"N"}),a.states.rain&&(b["%rainingState%"]={value:"rain"}),a.states.rain_total&&(b["%rainingCounterState%"]={value:"rain_total"}),a.states.sunshine_total&&(b["%sunshineState%"]={value:"sunshine_total"})}}return b}(b,
h?h:{});k=function(a,b){return b}(b,k?k:{});a=a._injectToSmartWidgetTemplate(c,d,e,f,h,k);if(Array.isArray(a)&&"bosch"===b.module&&"camera"===b.type&&(!b.commands||!b.commands.toggle))for(b=0;b<a.length;b++)if((c=a[b])&&c.meta&&c.elements&&0===String(c.meta.type).indexOf("bosch_cam")&&(c=c.elements.buttons,Array.isArray(c)))for(e=0;e<c.length;e++)(d=c[e])&&d.action&&d.action.ref&&"toggle"===d.action.ref.value&&delete d.action;return a}}}();
