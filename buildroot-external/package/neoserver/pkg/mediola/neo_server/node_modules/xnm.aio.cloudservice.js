...
JSON.parse(JSON.stringify(a));b.states&&(b.details={states:{}},b.states.motion&&(b.details.states.motion={value:"motion"}));break;case "contact":b=JSON.parse(JSON.stringify(a));b.states&&(b.details={states:{}},b.states.contact&&(b.details.states.state={value:"contact"}));break;case "window":b=JSON.parse(JSON.stringify(a)),b.states&&(b.details={states:{}},b.states.window&&(b.details.states.state={value:"window"}))}}return b},supportSmartWidget:function(a,b){if(!a||!a.module)return!1;switch(a.module){case "gardena":case "netatmo":case "openweathermap":case "nuki":case "uhoo":return!0;
case "ring":return"doorbell"==a.type;case "homematic":switch(a.type){case "home":return!0;case "room":return!0;case "enviroment":return!0;case "security":return!0;case "presence":return!0;case "smoke":return!0;case "water":return!0;case "weather":return!0;default:return!1}default:return!1}},applySmartWidgetFilter:function(a,b,d,c,e){if(!b||!b.module)return null;var f=d=null,h=null,k=null;d=function(a,b){switch(a.module){case "bosch":"camera"===a.type&&b.push("bosch_cam");break;case "gardena":switch(a.type){case "mower":b.push("gardena_mower");
break;case "switch":b.push("gardena_switch");break;case "sensor":b.push("gardena_sensor");break;case "ic24":b.push("gardena_ic24");break;case "valve":b.push("gardena_valve")}break;case "netatmo":switch(a.type){case "NAMain":b.push("netatmo_basestation");break;case "NAModule1":case "NAModule4":b.push("climate");b.push("notification");break;case "NAModule2":b.push("netatmo_wind");b.push("notification");break;case "NAModule3":b.push("netatmo_rain"),b.push("notification")}break;case "openweathermap":b.push("openweathermap");
break;case "nuki":b.push("nuki");break;case "ring":switch(a.type){case "doorbell":b.push("motion")}break;case "uhoo":b.push("uhoo");break;case "homematic":switch((a.states.battery||a.states.timeout||a.states.sabotage)&&b.push("notification"),a.type){case "home":b.push("weather_station");b.push("climate");b.push("home");break;case "enviroment":(a.states.temperature||a.states.humidity)&&b.push("climate");a.states.rain&&b.push("rain");break;case "security":a.states.motion&&b.push("motion");(a.states.moisture||
a.states.water)&&b.push("sensor_water");a.states.presence&&b.push("motion");a.states.window&&(b.push("window"),b.push("contact"));a.states.smoke&&b.push("smoke");break;case "presence":a.states.presence&&b.push("motion");break;case "smoke":a.states.smoke&&b.push("smoke");break;case "water":a.states.water&&b.push("sensor_water");break;case "weather":b.push("weather_station"),b.push("climate")}}return b}(b,d?d:[]);f=function(a,b){switch(a.module){case "bosch":"camera"===a.type&&(b["%toggle%"]={value:"toggle"},
b["%camPosition%"]={value:"position",ext:"%d",extMeta:"-120-120"});break;case "gardena":if(!a.commands)break;switch(a.type){case "mower":b["%start%"]={value:"start_override_timer",ext:"%d",extMeta:"60-6000",scale:60};b["%park%"]={value:"park_until_next_task"};break;case "switch":b["%on%"]={value:"on"};b["%onFor%"]={value:"on_for",ext:"%d",extMeta:"60-7200",scale:60};b["%off%"]={value:"off"};break;case "ic24":b["%stopAll%"]={value:"stop_all_valve"};break;case "valve":b["%run%"]={value:"run",ext:"%d",
extMeta:"60-3600",scale:60},b["%pause%"]={value:"pause",ext:"%d",extMeta:"60-604800",scale:60},b["%resume%"]={value:"resume"},b["%stop%"]={value:"stop"}}break;case "nuki":b["%unlock%"]={value:"unlock"};b["%lock%"]={value:"lock"};b["%open%"]={value:"lock_n_go"};break;case "homematic":if(a.commands)switch(a.type){case "home":a.commands.alarm_mode&&(b["%alarmModeDisarm%"]={value:"alarm_mode",ext:"disarmed"},b["%alarmModeProtectExternal%"]={value:"alarm_mode",ext:"external_protection"},b["%alarmModeProtectFull%"]=
{value:"alarm_mode",ext:"full_protection"}),a.commands.auto&&(b["%thermoAuto%"]={value:"auto"}),a.commands.eco&&(b["%thermoEco%"]={value:"eco",extMeta:[{type:"time",name:"start",ref:{value:"start",ext:"%time"}},{type:"time",name:"end",ref:{value:"end",ext:"%time"}}]}),a.commands.vacation&&(b["%thermoVacation%"]={value:"vacation",extMeta:[{type:"float",name:"temperature",ref:{value:"temperature",ext:"%f",extMeta:"5-30",scale:.5}},{type:"time",name:"end",ref:{value:"end",ext:"%time"}}]})}}return b}(b,
f?f:{});h=function(a,b){switch(a.module){case "bosch":"camera"===a.type&&(b["%camOnline%"]={value:"online"},b["%camPosition%"]={value:"position",extMeta:"-120-120"},b["%camState%"]={value:"state"});break;case "gardena":if(!a.states)break;a.states.online&&(b["%online%"]={value:"online",options:["true","false"]});switch(a.type){case "mower":b["%state%"]={value:"state",options:"paused ok_cutting ok_cutting_timer_overridden ok_searching ok_leaving ok_charging parked_timer parked_park_selected parked_autotimer none".split(" ")};
break;case "switch":b["%state%"]={value:"state",options:["off","forever_on","time_limited_on","scheduled_on"]};b["%duration%"]={value:"duration"};break;case "sensor":b["%tempAmbient%"]={value:"ambient_temperature"};b["%tempSoil%"]={value:"soil_temperature"};b["%humSoil%"]={value:"soil_humidity"};b["%light%"]={value:"light"};break;case "valve":b["%state%"]={value:"state",options:["closed","manual_watering","scheduled_watering"]},b["%duration%"]={value:"duration"}}break;case "netatmo":switch(a.type){case "NAMain":b["%tempState%"]=
{value:"temperature"};b["%humState%"]={value:"humidity"};b["%co2State%"]={value:"co2"};b["%noiseState%"]={value:"noise"};b["%pressureState%"]={value:"pressure"};break;case "NAModule1":case "NAModule4":b["%tempState%"]={value:"temperature"};b["%humState%"]={value:"humidity"};b["%lowbat%"]={value:"battery",conv_i:{"0|30":!0,"31|100":!1}};break;case "NAModule2":b["%windspeedState%"]={value:"wind_speed"};b["%windDirection%"]={value:"wind_direction"};b["%lowbat%"]={value:"battery",conv_i:{"0|30":!0,"31|100":!1}};
break;case "NAModule3":b["%rain%"]={value:"rain"},b["%rain_last_hour%"]={value:"rain_last_hour"},b["%rain_last_day%"]={value:"rain_last_day"},b["%lowbat%"]={value:"battery",conv_i:{"0|30":!0,"31|100":!1}}}break;case "openweathermap":b["%tempState%"]={value:"temperature"};b["%humState%"]={value:"humidity"};b["%windspeedState%"]={value:"wind_speed"};b["%windDirection%"]={value:"wind_direction"};break;case "nuki":b["%lockStatus%"]={value:"state",conv_s:{locked:"locked",unlocked:"open"}};break;case "ring":switch(a.type){case "doorbell":b["%motionState%"]=
...
h?h:{});k=function(a,b){return b}(b,k?k:{});return a._injectToSmartWidgetTemplate(c,d,e,f,h,k)}}}();
