...
(a.format="hls");"string"!==typeof a.q&&"number"!==typeof a.q&&(a.q=1);this._cloudService.doEAPIRequest("ivideon","GET",d,a,null,function(c,a){b&&b(c,a)})};e.prototype.getArchiveStream=function(a,b){var d=this.getBaseURL()+"/record_stream";a||(a={});a.format||(a.format="hls");"string"!==typeof a.q&&"number"!==typeof a.q&&(a.q=1);this._cloudService.doEAPIRequest("ivideon","GET",d,a,null,function(c,a){if(c)b(c,a);else{var f=null;a&&"object"===typeof a&&(f=a.url);if("string"!==typeof f||0===f.length)c=
Error("Result did not contain an URL or it was an empty string: "+f);b(c,f)}})};e.prototype.getEvents=function(a,b){var d=this.getBaseURL()+"/events";a||(a={});a.limit||(a.limit=20);this._cloudService.doEAPIRequest("ivideon","POST",d,null,a,function(c,a){b&&b(c,a)})};e.prototype.getRecords=function(a,b){var d=this.getBaseURL()+"/records";this._cloudService.doEAPIRequest("ivideon","GET",d,a,null,function(c,a){b&&b(c,a)})};e.prototype.loadImage=function(a,b){var d=this;this._jpegCam?this._jpegCam.loadImage(function(c,
f){c?a&&a(c):c||!f||401!=f.statusCode||b?a&&a():(d._jpegCam=null,d.loadImage(a,!0))}):this.getLivePreview(function(c,b){if(!c&&b&&b.mediaUri&&b.accessCredentials){c=b.mediaUri;var f={headers:{}};b.accessCredentials&&b.accessCredentials.credentials&&(b=b.accessCredentials.credentials.split(":"),f.user=b[0],f.password=b[1]);d._jpegCam=require("xnm.aio.cams.js").createJPEGCam(c,f);d.loadImage(a,!0)}else a&&a()})};e.parseJSON=function(a,b){return a&&a.connection&&a.id?new e(a.connection,a.id,b,a.format):
null};return e}();
...
d(a)})}else d&&d(Error("command json invalid"));else d&&d(Error("device json invalid"))};d.prototype.getStatesCreator=function(a,b,d){var c=this;a=function(a,b){c.getModuleStates(a,function(c,d){b(c,d,a)})};var e=[],l;for(l=0;l<b.length;l++){var m=b[l];m&&m.device&&m.device.module&&-1==e.indexOf(m.device.module)&&e.push(m.device.module)}if(0==e.length)d&&d(null,[]);else{var f=0,g=[];for(l=0;l<e.length;l++)a(e[l],function(a,c,m){f++;var l=[];if(!a&&c)for(var h=0;h<b.length;h++){var k=b[h];if(k&&k.id&&
k.device&&k.device.module==m){var p=null;if(k.device&&k.device.connection&&k.device.id&&k.status&&k.status.value){var n=c[k.device.connection];n&&n[k.device.id]&&(n=n[k.device.id].states)&&(p=n[k.status.value])}if("undefined"==typeof p||null==p)p="?";g.push({id:k.id,status:p});l.push({id:k.id,status:p})}}"undefined"!=typeof commandhandler&&null!=commandhandler&&"undefined"!=typeof commandhandler.reportStates&&null!=commandhandler.reportStates&&!a&&l&&0<l.length&&commandhandler.reportStates(null,l);
f==e.length&&d&&d(null,g)})}};d.prototype.getDeviceList=function(a,b){this.getModuleDevices(a,function(c,d){if(c)b(c);else{c=[];if(d)for(var e in d){var l=d[e],m;for(m in l){var f=l[m];f&&(f.sys="cloudservice",f.module=a,f.connection=e,f.id=m,c.push(f))}}b(null,c)}})};d.prototype._doJsonRequest=function(a,b,d,e,h){var c=null;e&&(c=JSON.stringify(e));this._doRequest(a,b,d,c,function(a,b){a?h&&h(a):b?b.XC_ERR?(a=Error("error response:"+b.XC_ERR.msg),a.code=b.XC_ERR.code,h&&h(a)):b.XC_SUC?h&&h(null,
b.XC_SUC):h&&h(Error("unknown response")):h&&h(Error("invalid response"))})};d.prototype._resolveServerIP=function(a){if("/eapi/"==a.substr(0,6)&&(a=a.split("/")[3])&&this._moduleInfo&&this._moduleInfo[a]&&this._moduleInfo[a].domain){a=this._moduleInfo[a].domain;var b=a.indexOf(":");return-1!=b?a.substr(0,b):a}return this._ip};d.prototype._resolveServerPort=function(a){if("/eapi/"==a.substr(0,6)&&(a=a.split("/")[3])&&this._moduleInfo&&this._moduleInfo[a]&&this._moduleInfo[a].domain){a=this._moduleInfo[a].domain;
var b=a.indexOf(":");return-1!=b?parseInt(a.substr(b+1)):443}return this._port};d.prototype._doRequest=function(a,b,d,e,h){var c=b;c||(c="/");var m={};d&&(m=JSON.parse(JSON.stringify(d)));d="";for(var f in m)m.hasOwnProperty(f)&&(d&&(d+="&"),d+=f+"="+encodeURIComponent(m[f]));d&&(c+="?"+d);a={host:this._resolveServerIP(b),port:this._resolveServerPort(b),path:c,method:a,headers:{Connection:"close","Content-Type":"application/json; charset=UTF-8"}};if(this._username||this._password)a.auth=(this._username?
...
c.auth&&(c.auth="********");this._logger.log("trace","do request:"+JSON.stringify(c));var k=this,g=h,n=b.request(a,function(a){a.setEncoding("utf-8");var b="";a.on("data",function(a){b+=a});a.on("end",function(){k._logger.log("trace","receive code:"+a.statusCode+" headers:"+JSON.stringify(a.headers)+" response:"+b);if(200==a.statusCode)try{var c=b?JSON.parse(b):null}catch(q){var d=q}else d=Error("http reponse:"+a.statusCode);g&&(g(d,c,a.statusCode),g=null)})});if(n.on)n.on("error",function(a){k._logger.log("trace",
"do request error:"+a.message);g&&(g(a),g=null)});n.setTimeout&&n.setTimeout(2E4,function(){k._logger.log("trace","do request timeout");n.abort();g&&(g(Error("timeout")),g=null)});e&&(this._logger.log("trace","do request send body:"+e),n.write(e));n.end()};d.prototype.toJSON=function(){return{sys:"cloudservice",username:this._username,password:this._password,ip:this._ip,port:this._port}};d.prototype.equalsTo=function(a){return a&&a instanceof d?this._ip==a._ip&&this._port==a._port&&this._username==
...
a.status&&a.status.forEach(function(a){e(c.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))}):"ipevt"==c.catagory&&a.ipevt&&a.ipevt.forEach(function(a){e(c.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))});return d},k=function(a,b){var e=[],m=c.getCommandStatusMap(a,d);m&&(a=g(m,a,b),e=e.concat(a));return e};if(!a.sys)return null;var h=JSON.parse(JSON.stringify(a)),l=null;if("command"==b.catagory)l=k(a,b),h.command=l;else if("status"==b.catagory)l=k(a,b),h.status=l;else if("ipevt"==
b.catagory)l=k(a,b),h.ipevt=l;else return null;return l&&0!=l.length?h:null},applyIPEventFilter:function(a){return a?this.applyUIFilter(a,{catagory:"ipevt",elems:"*"}):null},getCommandStatusMap:function(a,b){var d=function(a,b){var c=null;if(b.values)if(Array.isArray(b.values))c={type:"enum",name:a,ref:{value:a,ext:"%e",extMeta:b.values}};else{if(0<Object.keys(b.values).length){c={type:"multi",name:a,ref:{value:a,ext:"%multi",extMeta:[]}};for(var e in b.values)(a=d(e,b.values[e]))&&c.ref.extMeta.push(a)}}else if(b.value){switch(b.value.type){case "FLOAT":c=
...
{type:"enum",name:a,ref:{value:a}};return c};if(!a)return null;b={command:[],status:[]};var c,e;if(a.commands)for(c in b.command=[],a.commands){var g=a.commands[c];"homematic"==a.module&&"eco"==c&&(g=JSON.parse(JSON.stringify(g)),delete g.values.duration);(e=d(c,g))&&b.command.push(e)}if(a.states)for(c in b.status=[],b.ipevt=[],a.states)if(g=a.states[c],g.values)0!=g.state&&b.status.push({type:"enum",name:c,ref:{value:c,options:g.values}}),0!=g.event&&b.ipevt.push({type:"enum",name:c,ref:{value:c,
options:g.values}});else{e=null;switch(g.type){case "BOOL":e={type:"enum",name:c,ref:{value:c,options:["true","false"]}};break;case "FLOAT":e={type:"float",name:c,ref:{value:c}};break;case "RGB":e={type:"rgb",name:c,ref:{value:c}};break;case "RGBW":e={type:"rgbw",name:c,ref:{value:c}};break;case "STRING":e={type:"string",name:c,ref:{value:c}};break;case "TIME":e={type:"int",name:c,ref:{value:c}};break;default:e={type:"int",name:c,ref:{value:c}}}void 0!=g.min&&null!=g.min&&void 0!=g.max&&null!=g.max&&
e&&(e.ref.extMeta=g.min+"-"+g.max);void 0!=g.step&&null!=g.step&&e&&(e.ref.scale=g.step);e&&(0!=g.state&&b.status.push(e),0!=g.event&&b.ipevt.push(e))}return b},toGeneralDevice:function(a,b,d){if(!a||!a.module)return null;b=null;switch(a.module){case "hue":case "lightify":b={type:"dimmer",commands:{},states:{},details:{commands:{},states:{}}};var c;if(a.commands)for(c in a.commands)switch(c){case "on":case "off":case "toggle":case "up":case "down":b.commands[c]={};b.details.commands[c]={value:c};
break;case "brightness":case "colorTemperature":b.commands[c]={value:{type:"INT"}};b.details.commands[c]={value:c,ext:"%d"};a.commands[c]&&a.commands[c].value&&(d=a.commands[c].value,isNaN(d.min)||isNaN(d.max)||(b.commands[c].value.min=d.min,b.commands[c].value.max=d.max,b.details.commands[c].extMeta=d.min+"-"+d.max));break;case "color":b.commands[c]={value:{type:"RGB"}},b.details.commands[c]={value:c,ext:"%rgb"},b.commands.white={},b.details.commands.white={value:"color",ext:"FFFFFF"},a.commands[c]&&
a.commands[c].value&&(d=a.commands[c].value,"RGBW"==d.type&&(b.commands[c].value.type="RGBW",b.details.commands[c].ext="%rgbw",b.details.commands.white={value:"color",ext:"FFFFFFFF"}))}if(a.states)for(c in a.states)switch(c){case "state":b.states.state={values:["on","off"]};b.details.states.state={value:"state"};break;case "brightness":b.states.brightness={value:{type:"INT",min:0,max:100}};b.details.states.brightness={value:"brightness",ext:"%d",extMeta:"0-100"};break;case "colorTemperature":b.states.colorTemperature=
{value:{type:"INT",min:154,max:500}};b.details.states.colorTemperature={value:"colorTemperature",ext:"%d",extMeta:"154-500"};break;case "color":b.states.color={type:"RGB"},b.details.states.color={value:"color",ext:"%rgb"},a.states[c]&&a.states[c].value&&(d=a.states[c].value,"RGBW"==d.type&&(b.states.color.type="RGBW",b.details.states.color.ext="%rgbw"))}break;case "somfy":b={type:"blind",commands:{},states:{},details:{commands:{},states:{}}};if(a.commands)for(c in a.commands)switch(c){case "open":case "close":b=
