...
xnm.aio.contronics.ExecEngine.prototype._doRequeset=function(a,b){if(a&&"string"==typeof a){var c=this,d="http://"+this.ip+":"+this.port+"/RP2";this._logger.log("trace","send POST to url:"+d+" data:"+a);var e=b;$.ajax({url:d,type:"POST",timeout:3E4,headers:{"Content-Type":"text/xml","Content-length":a.length,"User-Agent":"mediola",Connection:"keep-alive"},data:a,dataType:"text",cache:!0,success:function(a){c._logger.log("trace","http request success:"+a);e&&(e(null,a),e=null)},error:function(a,b){a=
"http request error:"+(a?a.status:"0")+"-"+b;c._logger.log("trace",a);e&&(e(Error(a)),e=null)}})}else b&&b(Error("data invalid"))};
...
xnm.aio.contronics.ExecEngine.prototype._signon=function(a){this._logger.log("debug","signon");var b=[0,1];if(this.user&&null!=this.password&&"undefined"!=typeof this.password){var c=this._encodeCred(this.user,this.password);b.push(c)}var d=this;this._doExecReq(b,function(b,c){if(c){var e=parseInt(c);d._logger.log("debug","signon:"+e);0>=e&&!b&&(b=Error("can not acquire session id"),b._errorCode=3)}else b||(d._logger.log("debug","signon return invalid response"),b=Error("invalid response"));a&&a(b,
b?null:e)})};xnm.aio.contronics.ExecEngine.prototype._signoff=function(a,b){this._logger.log("debug","signoff:"+a);this._doExecReq([a,2],function(a,d){b&&b(a,d)})};
...
xnm.aio.contronics.ExecEngine.prototype._changeValue=function(a,b,c,d){this._logger.log("debug","_changeValue:"+a);this._doExecReq([a,64,b+(null==c||"undefined"==typeof c?"":"="+c)],function(a,b){d&&d(a,b)})};
