var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(g,a,c){g instanceof String&&(g=String(g));for(var e=g.length,f=0;f<e;f++){var b=g[f];if(a.call(c,b,f,g))return{i:f,v:b}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(g,a,c){g!=Array.prototype&&g!=Object.prototype&&(g[a]=c.value)};$jscomp.getGlobal=function(g){g=["object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global,g];for(var a=0;a<g.length;++a){var c=g[a];if(c&&c.Math==Math)return c}return globalThis};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.polyfill=function(g,a,c,e){if(a){c=$jscomp.global;g=g.split(".");for(e=0;e<g.length-1;e++){var f=g[e];f in c||(c[f]={});c=c[f]}g=g[g.length-1];e=c[g];a=a(e);a!=e&&null!=a&&$jscomp.defineProperty(c,g,{configurable:!0,writable:!0,value:a})}};$jscomp.polyfill("Array.prototype.find",function(g){return g?g:function(a,c){return $jscomp.findInternal(this,a,c).v}},"es6","es3");var xnm=xnm||{};xnm.aio=xnm.aio||{};xnm.aio.denon=xnm.aio.denon||{};xnm.aio.marantz=xnm.aio.marantz||{};
...
"DOWN",function(a){d&&d(a)}):d&&d(Error("invalid command"))};f.prototype.setVolume=function(a,d,c){var b=null;switch(a){case 1:b="MV";break;case 2:b="Z2";break;case 3:b="Z3"}b?this._sendCommand(b,d,function(a){c&&c(a)}):c&&c(Error("invalid command"))};f.prototype.getVolume=function(a,c){var b=null;switch(a){case 1:b="ZM";break;case 2:b="Z2:VOLUME";break;case 3:b="Z3:VOLUME"}this._getState(b,function(a,b){a?c&&c(a):b?(a=parseInt(b)/10,c&&c(null,a,a-80)):c&&c(null,null)})};f.prototype.setMute=function(a,
c,e){var b=null;c=c?"ON":"OFF";switch(a){case 1:b="MU";break;case 2:b="Z2MU";break;case 3:b="Z3MU"}b&&c?this._sendCommand(b,c,function(a){e&&e(a)}):e&&e(Error("invalid command"))};f.prototype.toggleMute=function(a,c){var b=this;this.getMute(key,function(d,e){d?c&&c(d):(value="on"==e?!1:!0,b.setMute(a,value,c))})};f.prototype.getMute=function(a,c){var b=null;switch(a){case 1:b="MU";break;case 2:b="Z2MU";break;case 3:b="Z3MU"}this._getState(b,function(a,b){a?c&&c(a):b?c&&c(null,"ON"==b?"on":"off"):
