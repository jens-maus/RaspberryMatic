var xnm=xnm||{};xnm.aio=xnm.aio||{};xnm.aio.edimax=xnm.aio.edimax||{};xnm.aio.edimax.SmartPlug=function(a,b){this.ip=a;this.port=1E4;this.uuid=null;this.user="admin";this.password="1234";b&&(this.password=b);this._state="?";this.data="switch";this.CommandHandler=this.model=null};
...
xnm.aio.edimax.SmartPlug.prototype.getStatesCreator=function(a,b,c){this.getState(function(a){if(a){for(var e=[],g=0;g<b.length;g++){var f=b[g];if(f&&f.id&&f.status)switch(f.status.value){case "state":a.state&&"?"!=typeof a.state&&e.push({id:f.id,status:a.state});break;case "current":null!=a.current&&"undefined"!=typeof a.current&&"?"!=a.current&&e.push({id:f.id,status:a.current});break;case "power":null!=a.power&&"undefined"!=typeof a.power&&"?"!=a.power&&e.push({id:f.id,status:a.power})}}c&&c(null,
...
xnm.aio.edimax.Discovery=function(){this.Devices={};this._tmpCallbacks=[];this.callback=null;this._sockets=[];var a=require("os");require("dgram");if(a&&a.networkInterfaces){var a=a.networkInterfaces(),b;for(b in a)for(var c=a[b],d=0;d<c.length;d++)this._addDiscoverSocket(null,c[d])}else this._addDiscoverSocket(null,null)};
...
xnm.aio.edimax.Discovery.prototype._receivedData=function(a,b){b=b.toString("hex");b=new Buffer(b,"hex");if(186==b.length){this.Devices[a]=new xnm.aio.edimax.SmartPlug(a);this.Devices[a].uuid=this._getMAC(b.slice(0,6));var c=b.toString("hex");0<c.indexOf("53503131303157")?(this.Devices[a].data="switch",this.Devices[a].model="SP1101W"):0<c.indexOf("53503231303157")&&(this.Devices[a].data="powerswitch",this.Devices[a].model="SP2101W");this.callback&&this.Devices[a]&&this.callback(this.Devices[a]);if(this._tmpCallbacks&&
this.Devices[a])for(c=0;c<this._tmpCallbacks.length;c++)this._tmpCallbacks[c](this.Devices[a])}};
