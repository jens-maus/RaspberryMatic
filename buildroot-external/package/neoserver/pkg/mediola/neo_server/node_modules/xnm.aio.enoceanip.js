...
b.functions[d];c&&c.key&&("switch"==c.key?(a||(a={}),a.state=c.value):"localControl"==c.key&&(a||(a={}),a.local_control=c.value))}return a};return{Version_0_9:new a}}(),p=function(){var a=function(){};a.prototype.getMap=function(){return{command:[{type:"int",name:"dim to",ref:{value:"dimTo",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"stop dim",ref:{value:"stop"}},{type:"enum",name:"query status",ref:{value:"query"}}],status:[{type:"int",name:"state",ref:{value:"state",ext:"%d",extMeta:"0-100"}},
{type:"enum",name:"local control",ref:{value:"local_control",options:["off","on"]}}],ipevt:[{type:"int",name:"state",ref:{value:"state",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"local control",ref:{value:"local_control",options:["off","on"]}}]}};a.prototype.executeCommand=function(a,b,c,g){b=this.getPutStateBody(a,b);if(!b)return!1;c.setDeviceState(a.deviceId,b,function(a){g&&g(a)});return!0};a.prototype.getPutStateBody=function(a,b){a=null;switch(b.value){case "dimTo":if("undefined"==typeof b.ext||
null==b.ext)return null;b=parseInt(b.ext);0>b&&(b=0);100<b&&(b=100);a={state:{functions:[{key:"dimValue",value:b},{key:"rampingMode",value:"switch"}]}};break;case "stop":a={state:{functions:[{key:"dimValue",value:"invalid"},{key:"rampingMode",value:"stop"}]}};break;case "query":a={state:{functions:[{key:"query",value:"status"}]}}}return a};a.prototype.resolveState=function(a,b){if(!b||!b.functions)return null;a=null;for(var d=0;d<b.functions.length;d++){var c=b.functions[d];c&&c.key&&("dimValue"==
c.key?(a||(a={}),a.state=c.value):"localControl"==c.key&&(a||(a={}),a.local_control=c.value))}return a};return{Version_0_9:new a}}(),r=function(){var a=function(){};a.prototype.getMap=function(){return{command:[{type:"enum",name:"channel 1 on",ref:{value:"ch1on"}},{type:"enum",name:"channel 1 off",ref:{value:"ch1off"}},{type:"enum",name:"channel 2 on",ref:{value:"ch2on"}},{type:"enum",name:"channel 2 off",ref:{value:"ch2off"}},{type:"enum",name:"all on",ref:{value:"allOn"}},{type:"enum",name:"all off",
ref:{value:"allOff"}},{type:"enum",name:"query channel 1 status",ref:{value:"ch1query"}},{type:"enum",name:"query channel 2 status",ref:{value:"ch2query"}},{type:"enum",name:"query all status",ref:{value:"allQuery"}}],status:[{type:"enum",name:"channel 1 state",ref:{value:"ch1state",options:["off","on"]}},{type:"enum",name:"channel 2 state",ref:{value:"ch2state",options:["off","on"]}}],ipevt:[{type:"enum",name:"channel 1 state",ref:{value:"ch1state",options:["off","on"]}},{type:"enum",name:"channel 2 state",
ref:{value:"ch2state",options:["off","on"]}}]}};a.prototype.executeCommand=function(a,b,c,g){b=this.getPutStateBody(a,b);if(!b)return!1;c.setDeviceState(a.deviceId,b,function(a){g&&g(a)});return!0};a.prototype.getPutStateBody=function(a,b){a=null;switch(b.value){case "ch1on":a={state:{functions:[{key:"channel",value:0},{key:"switch",value:"on"}]}};break;case "ch1off":a={state:{functions:[{key:"channel",value:0},{key:"switch",value:"off"}]}};break;case "ch2on":a={state:{functions:[{key:"channel",value:1},
{key:"switch",value:"on"}]}};break;case "ch2off":a={state:{functions:[{key:"channel",value:1},{key:"switch",value:"off"}]}};break;case "allOn":a={state:{functions:[{key:"channel",value:"all"},{key:"switch",value:"on"}]}};break;case "allOff":a={state:{functions:[{key:"channel",value:"all"},{key:"switch",value:"off"}]}};break;case "ch1query":a={state:{functions:[{key:"channel",value:0},{key:"query",value:"status"}]}};break;case "ch2query":a={state:{functions:[{key:"channel",value:1},{key:"query",value:"status"}]}};
break;case "allQuery":a={state:{functions:[{key:"channel",value:"all"},{key:"query",value:"status"}]}}}return a};a.prototype.resolveState=function(a,b){if(!b||!b.functions)return null;a=null;for(var d=0;d<b.functions.length;d++){var c=b.functions[d];c&&c.key&&"switch"==c.key&&(a||(a={}),0==c.channel?a.ch1state=c.value:1==c.channel&&(a.ch2state=c.value))}return a};return{Version_0_9:new a}}(),q=function(){var a=function(){};a.prototype.getMap=function(){return{command:[{type:"int",name:"move to",ref:{value:"position",
ext:"%d",extMeta:"0-100"}},{type:"int",name:"angle to",ref:{value:"angle",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"move up",ref:{value:"moveUp"}},{type:"enum",name:"move down",ref:{value:"moveDown"}},{type:"enum",name:"stop",ref:{value:"stop"}},{type:"enum",name:"query status",ref:{value:"query"}}],status:[{type:"int",name:"position",ref:{value:"position",ext:"%d",extMeta:"0-100"}},{type:"int",name:"angle",ref:{value:"angle",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"locking mode",ref:{value:"lockingMode",
options:["block","unblock"]}}],ipevt:[{type:"int",name:"position",ref:{value:"position",ext:"%d",extMeta:"0-100"}},{type:"int",name:"angle",ref:{value:"angle",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"locking mode",ref:{value:"lockingMode",options:["block","unblock"]}}]}};a.prototype.executeCommand=function(a,b,c,g){b=this.getPutStateBody(a,b);if(!b)return!1;c.setDeviceState(a.deviceId,b,function(a){g&&g(a)});return!0};a.prototype.getPutStateBody=function(a,b){a=null;switch(b.value){case "moveUp":a=
{state:{functions:[{key:"position",value:0},{key:"angle",value:0}]}};break;case "moveDown":a={state:{functions:[{key:"position",value:100},{key:"angle",value:100}]}};break;case "position":if("undefined"==typeof b.ext||null==b.ext)return null;b=parseInt(b.ext);0>b&&(b=0);100<b&&(b=100);a={state:{functions:[{key:"position",value:b}]}};break;case "angle":if("undefined"==typeof b.ext||null==b.ext)return null;b=parseInt(b.ext);0>b&&(b=0);100<b&&(b=100);a={state:{functions:[{key:"angle",value:b}]}};break;
case "stop":a={state:{functions:[{key:"stop",value:!0}]}};break;case "query":a={state:{functions:[{key:"query",value:"status"}]}}}return a};a.prototype.resolveState=function(a,b){if(!b||!b.functions)return null;a=null;for(var c=0;c<b.functions.length;c++){var d=b.functions[c];if(d&&d.key)switch(d.key){case "buttonA0":a||(a={});switch(d.value){case "pressed":a.btnA0pressed=!0;break;case "released":a.btnA0released=!0}break;case "buttonAI":a||(a={});switch(d.value){case "pressed":a.btnAIpressed=!0;break;
case "released":a.btnAIreleased=!0}break;case "buttonB0":a||(a={});switch(d.value){case "pressed":a.btnB0pressed=!0;break;case "released":a.btnB0released=!0}break;case "buttonBI":a||(a={});switch(d.value){case "pressed":a.btnBIpressed=!0;break;case "released":a.btnBIreleased=!0}break;case "buttonC0":a||(a={});switch(d.value){case "pressed":a.btnC0pressed=!0;break;case "released":a.btnC0released=!0}break;case "buttonCI":a||(a={});switch(d.value){case "pressed":a.btnCIpressed=!0;break;case "released":a.btnCIreleased=
!0}break;case "buttonD0":a||(a={});switch(d.value){case "pressed":a.btnD0pressed=!0;break;case "released":a.btnD0released=!0}break;case "buttonDI":a||(a={});switch(d.value){case "pressed":a.btnDIpressed=!0;break;case "released":a.btnDIreleased=!0}break;default:a||(a={}),a[d.key]=d.value}}return a};return{Version_0_9:new a}}(),u=function(){var a=function(){};a.prototype.getMap=function(){return{status:[{type:"enum",name:"contact",ref:{value:"contact",options:["closed","open"]}}],ipevt:[{type:"enum",
name:"contact",ref:{value:"contact",options:["closed","open"]}}]}};a.prototype.resolveState=function(a,b){if(!b||!b.functions)return null;a=null;for(var d=0;d<b.functions.length;d++){var c=b.functions[d];c&&c.key&&(a||(a={}),a[c.key]=c.value)}return a};return{Version_0_9:new a}}();return{F6_02_01:f,F6_03_01:b,F6_05_01:e,F6_05_02:a,F6_10_00:g,A5_04_01:c,A5_07_03:l,A5_10_03:k,A5_20_01:m,A5_30_03:t,D2_01_01:n,D2_01_03:p,D2_01_11:r,D2_05_02:q,D5_00_01:u,getPorfile:function(a,b,c){a=a.replace(/-/g,"_").toUpperCase();
b="Version_"+(b+"").replace(/\./g,"_");return c&&this[a]&&this[a][b+"_"+c]?this[a][b+"_"+c]:this[a]?this[a][b]:null}}}();
...
b){if(a)e&&e(a);else{for(var c=[],g=0;g<b.length;g++){var f=b[g];if(f.target&&f.ip&&0<f.ip.length){var t=f.target.toLowerCase();if(-1!=t.indexOf("dcgw")||-1!=t.indexOf("opus"))f=new xnm.aio.enoceanip.DCGW(f.ip[0]),c.push(f)}}e&&e(a,c)}})};return f}();"undefined"!=typeof module&&null!=module&&(module.exports=new xnm.aio.enoceanip.Handler);
