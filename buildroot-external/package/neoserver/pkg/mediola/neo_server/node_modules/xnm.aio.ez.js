...
"send http request:"+JSON.stringify(a));this.username&&this.password&&(a.headers.Authorization="Basic "+(new Buffer(this.username+":"+this.password)).toString("base64"));var e=d,g=this,l=require("http").request(a,function(a){var c="";a.setEncoding("utf-8");a.on("data",function(a){c+=a});a.on("end",function(){g._logger.log("trace","http response code:"+a.statusCode+" body:"+c);if(200==a.statusCode)if(c=c.trim(),6>c.length||"data("!=c.substr(0,5))e&&e(Error("response fomart error:"+c)),e=null;else{for(var d=
c.substr(5),b=d.length-1;0<=b&&")"!=d.charAt(b);)--b;if(0>b)e&&e(Error("response fomart error:"+c)),e=null;else{d=d.substr(0,b);try{d=JSON.parse(d),e&&e(null,d),e=null}catch(m){e&&e(Error("response fomart error:"+c)),e=null}}}else e&&e(Error("http response code:"+a.statusCode+" "+c)),e=null})});l.setTimeout(2E3,function(){g._logger.log("trace","http request timeout");l.abort();e&&e(Error("http request timeout"));e=null});l.on("error",function(a){g._logger.log("trace","http request error:"+a.message);
e&&e(a);e=null});l.end()};b.prototype.getDevices=function(a){a||(a=function(){});var c=this._getDevicesCBs.length;-1==this._getDevicesCBs.indexOf(a)&&this._getDevicesCBs.push(a);if(0==c){var d=this;this.getActuators(function(a,c){if(a){c=d._getDevicesCBs;d._getDevicesCBs=[];for(var b=0;b<c.length;b++)c[b]&&c[b](a)}else{var f=[];c&&(f=f.concat(c));d.getSensors(function(a,c){var b=d._getDevicesCBs;d._getDevicesCBs=[];if(a)for(c=0;c<b.length;c++)b[c]&&b[c](a);else for(c&&(f=f.concat(c)),c=0;c<b.length;c++)b[c]&&
b[c](null,f)})}})}};b.prototype.getState=function(a){var c=function(a){var c={actuator:{},sensor:{}};if(a)for(var d=0;d<a.length;d++){var b=a[d];b.address&&("actuator"==b.type?c.actuator[b.address]=b.value:"sensor"==b.type&&(c.sensor[b.address]=b.value))}return c};if(this._deviceBuffer){var d=c(this._deviceBuffer);a&&a(null,d);a=null}this.getDevices(function(b,d){b?a&&a(b):(b=c(d),a&&a(null,b),a=null)})};b.prototype.executeCommand=function(a,c,b){a.address?c?this._doRequest("set_state_actuator",{number:a.address,
"function":c},function(a){b&&b(a)}):b&&b(Error("command invalid")):b&&b(Error("address invalid"))};b.prototype.executeCommandCreator=function(a,c,b){c&&c.value&&"func"==c.value&&c.ext?this.executeCommand(a,c.ext,function(a){b&&b(a)}):b&&b(Error("command invalid"))};b.prototype.getStatesCreator=function(a,c,b){this.getState(function(a,d){if(a)b&&b(a);else{a=[];for(var f=0;f<c.length;f++){var e=c[f];if(e&&e.id&&e.device){var h=e.device;if(h.type&&h.address){var k;"actuator"==h.type?k=d.actuator[h.address]:
"sensor"==h.type&&(k=d.sensor[h.address]);"undefined"!=typeof k&&null!=k&&a.push({id:e.id,status:k})}}}b&&b(null,a)}})};b.prototype.getActuators=function(a){this._doRequest("GET_LIST_ACTUATORS",null,function(c,b){if(c)a&&a(c);else{c=[];if(b&&b.actuator)for(var d=0;d<b.actuator.length;d++)"disabled"!=b.actuator[d].type&&c.push({sys:"xs1",type:"actuator",name:b.actuator[d].name,address:b.actuator[d].id,data:b.actuator[d].type,value:b.actuator[d].value,unit:b.actuator[d].unit,"function":b.actuator[d]["function"]});
a&&a(null,c)}})};b.prototype.getSensors=function(a){this._doRequest("GET_LIST_SENSORS",null,function(b,d){if(b)a&&a(b);else{b=[];if(d&&d.sensor)for(var c=0;c<d.sensor.length;c++)"disabled"!=d.sensor[c].type&&b.push({sys:"xs1",type:"sensor",name:d.sensor[c].name,address:d.sensor[c].id,data:d.sensor[c].type,value:d.sensor[c].value,unit:d.sensor[c].unit});a&&a(null,b)}})};b.prototype.toJSON=function(){return{sys:"xs1",ip:this.ip,port:this.port,password:this.password}};b.prototype.equalsTo=function(a){return a&&
