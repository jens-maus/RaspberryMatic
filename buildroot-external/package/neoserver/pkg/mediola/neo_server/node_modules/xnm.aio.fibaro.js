...
a.ext}else if("startProgram"==d){if("undefined"==typeof a.ext||null==a.ext){c&&c(Error("startProgram invalid"));return}d+=a.ext}else"undefined"!=typeof a.ext&&null!=a.ext&&("setValue"==d&&(d+=a.ext),"disarm"==d&&(d+=a.ext));this.executeCommand(b,d,function(a,b){c&&c(a,b)})}else c&&c(Error("command invalid"));else c&&c(Error("device invalid"))};e.prototype.getStatesCreator=function(b,a,c){if(a)if(0==a.length)c&&c(null,[]);else if(a){for(var d=[],f=0;f<a.length;f++){var k=a[f];k&&k.device&&k.device.address&&
d.push(k.device.address)}this.getStates(b,d,function(b,d,f){if(b)c&&c(b);else{b=[];if(d)for(var k=0;k<a.length;k++)if(a[k]){var m=a[k].id,g=a[k].device,h=a[k].status;if(m&&h&&h.value&&g&&g.address){var l="?";if("global_variable"==g.type)g=f[g.address],l=parseInt(g);else if(g=d[g.address])switch(h.value){case "onoffValue":l=g.value;l="true"==l?"on":"off";break;case "intValue":l=g.value;l=parseInt(l);break;case "boolValue":l=g.value;break;case "floatValue":l=g.value;l=parseFloat(l);break;case "setpointMode":l=
g.mode;l=e.SET_POINT_MODES[parseInt(l)];break;case "opMode":l=g.mode;l=e.OP_MODES[parseInt(l)];break;case "fanMode":l=g.mode;l=e.FAN_MODES[parseInt(l)];break;default:l=g[h.value]}if("undefined"==typeof l||null==l)l="?";b.push({id:m,status:l})}}c&&c(null,b)}})}else c&&c(Error("deviceList is null"));else c&&c(Error("deviceList is null"))};e.prototype.getDevices=function(b){var a={},c={};a[0]={name:"Unassigned"};var d=this;this._getRooms(function(f,e){if(f)b&&b(f);else{if(e)for(f=0;f<e.length;f++)a[e[f].id]=
{name:e[f].name,section:e[f].sectionID};d._getDevices(function(f,e){if(f)b&&b(f);else{if(e)for(f=0;f<e.length;f++){var g=e[f];g.visible&&"HC_user"!=g.type&&(c[g.id]={sys:"fibaro",name:g.name,address:g.id,room:g.roomID,type:g.type,baseType:g.baseType,actions:g.actions,states:g.properties})}d._getGlobalVariables(function(d,f){if(d)b&&b(d);else{d={};for(var e=0;e<f.length;e++){var g=f[e];g&&g.name&&(d[g.name]={sys:"fibaro",name:g.name,address:g.name,readOnly:g.readOnly,isEnum:g.isEnum,type:"global_variable"})}b&&
b(null,{rooms:a,devices:c,variables:d})}})}})}})};e.prototype.executeCommand=function(b,a,c){if("global_variable"==b.type)"undefined"==typeof a&&null==a?c&&c(Error("command ext invalid")):this._setGlobalVariableValue(b.address,a,function(a){c&&c(a)});else{var d=a,f=[];if("number"==typeof a)d="setValue",f.push(a);else if("string"==typeof a)if("on"==a)d="turnOn";else if("off"==a)d="turnOff";else{if("toggle"==a){var e=this;this._getDevices(function(a,d){if(a)c&&c(a);else{a=null;for(var f=0;f<d.length;f++){var g=
d[f];if(g.id&&g.properties&&g.id==b.address){"false"==g.properties.value?a="on":"true"==g.properties.value&&(a="off");break}}a?e.executeCommand(b,a,c):c&&c(Error("device has no on/off state"))}});return}if("arm"==a)d="setArmed",f=[1];else if(0==a.indexOf("disarm"))f=[0],f.push(a.replace(/disarm/g,"")),d="setArmed";else if(0==a.indexOf("dimTo"))f.push(parseInt(a.replace(/dimTo/g,""))),d="setValue";else if(0==a.indexOf("moveTo"))f.push(parseInt(a.replace(/moveTo/g,""))),d="setValue";else if(0==a.indexOf("setTo"))f.push(parseInt(a.replace(/setTo/g,
""))),d="setValue";else if(0==a.indexOf("setValue"))f.push(parseInt(a.replace(/setValue/g,""))),d="setValue";else if(0==a.indexOf("setSetpointMode"))f.push(parseInt(a.replace(/setSetpointMode/g,""))),d="setSetpointMode";else if(0==a.indexOf("setThermostatSetpoint"))a=a.replace(/setThermostatSetpoint/g,""),a=a.split(":"),f.push(parseInt(a[0]),parseFloat(a[1])),d="setThermostatSetpoint";else if(0==a.indexOf("setMode"))f.push(parseInt(a.replace(/setMode/g,""))),d="setMode";else if(0==a.indexOf("setFanMode"))f.push(parseInt(a.replace(/setFanMode/g,
""))),d="setFanMode";else if(0==a.indexOf("setTargetLevel"))f.push(parseFloat(a.replace(/setTargetLevel/g,""))),d="setTargetLevel";else if(0==a.indexOf("setTime"))f.push(parseInt(a.replace(/setTime/g,""))),d="setTime";else if(0==a.indexOf("setColor")){var g=a.replace(/setColor/g,"");f=g.substr(0,2);a=g.substr(2,2);d=g.substr(4,2);g=g.substr(6,2);f=[parseInt(f,16),parseInt(a,16),parseInt(d,16),parseInt(g,16)];d="setColor"}else 0==a.indexOf("startProgram")?(f.push(parseInt(a.replace(/startProgram/g,
""))),d="startProgram"):d=a}this._callAction(b.address,d,f,function(a,d){c&&c(a,d)})}};e.prototype.getStates=function(b,a,c){c||(c=function(){});var d=this._getStatesCBs.length;-1==this._getStatesCBs.indexOf(c)&&this._getStatesCBs.push(c);if(!(0<d)){var f=this;this.CommandHandler=b;this._getGlobalVariables(function(c,d){if(c){d=f._getStatesCBs;f._getStatesCBs=[];for(var b=0;b<d.length;b++)d[b](c)}else{var g={};for(b=0;b<d.length;b++)(c=d[b])&&c.name&&(g[c.name]=c.value);f._getDevices(function(c,d){if(c){d=
f._getStatesCBs;f._getStatesCBs=[];for(var b=0;b<d.length;b++)d[b](c)}else{c={};for(b=0;b<d.length;b++){var k=d[b];if(k.id&&k.properties&&(null==a||-1!=a.indexOf(k.id))){c[k.id]={};for(var m in k.properties)-1!=e.PROPERTY_LIST.indexOf(m)&&(c[k.id][m]=k.properties[m])}}d=f._getStatesCBs;f._getStatesCBs=[];for(b=0;b<d.length;b++)d[b](null,c,g)}})}})}};e.prototype.getStateValues=function(b,a){return a};e.prototype.toJSON=function(){return{sys:"fibaro",ip:this.ip,username:this.user,password:this.password,
...
d&&-1==this._callbacks.indexOf(d)&&this._callbacks.push(d);a||(a=5E3);if(!this._running){this._logger.log("debug","start search home center");var b=this;this._running=!0;this._createSockets(function(c){c?b._finishDiscover(c):(b._sendDiscoveryMessages(),b._searchTimeout=setTimeout(function(){b._finishDiscover(null,b._homeCenters)},a))})}};this._createSockets=function(a){var c=require("os");require("dgram");var b=this;if(c&&c.networkInterfaces){c=c.networkInterfaces();var f=[];for(n in c)if(c.hasOwnProperty(n))for(var e=
c[n],g=0;g<e.length;g++)"IPv4"==e[g].family&&0==e[g].internal&&f.push(e[g]);var h=0,m=0;var n=function(c,d){h++;c&&(m++,d&&(d=b._sockets.indexOf(d),-1!=d&&b._sockets.splice(d,1)));h==f.length&&(m==h?a&&a(c):a&&a())};for(c=0;c<f.length;c++)this._addDiscoverSocket(44444,f[c],n)}else this._addDiscoverSocket(44444,null,function(c,d){c&&d&&(d=b._sockets.indexOf(d),-1!=d&&b._sockets.splice(d,1));a&&a(c)})};this._closeSockets=function(){for(var a=0;a<this._sockets.length;a++)this._sockets[a].close()};this._addDiscoverSocket=
function(a,c,b){var d=this,e=require("dgram");try{var g=e.createSocket({reuseAddr:!0,type:"udp4"})}catch(h){g=e.createSocket("udp4")}g.on("listening",function(){g.setBroadcast(!0);g._listening=!0;d._logger.log("trace","success to bind on port:"+a+(c?" with interface:"+c.address:""));b&&b(null,g)});g.on("message",function(a,c){d._receivedData(c.address,a)});g.on("error",function(f){g._listening||(d._logger.log("trace","failed to bind on port:"+a+(c?" with interface:"+c.address:"")),b&&b(f,g))});try{c?
(d._logger.log("trace","try to bind on port:"+a+" with interface:"+c.address),g.bind(a,c.address)):(d._logger.log("trace","try to bind on port:"+a),g.bind(a)),this._sockets.push(g)}catch(h){b&&b(h)}};this._sendDiscoveryMessages=function(){for(var a=new Buffer([70,73,66,65,82,79]),c=0;c<this._sockets.length;c++)this._sockets[c].send(a,0,a.length,44444,"255.255.255.255")};this._receivedData=function(a,c){c=c.toString("hex");c=new Buffer(c,"hex");if(3<=c.length&&(c=c.toString(),this._logger.log("trace",
"receive packet:"+c+" from:"+a),c=c.split(" "),3==c.length&&"ACK"==c[0])){a=new e(a,null,null,c[2]);a.name=c[1];var b=!1;for(c=0;c<this._homeCenters.length;c++){var f=this._homeCenters[c];if(f&&f.uuid==a.uuid){b=!0;break}}if(!b)for(this._homeCenters.push(a),b=0;c<this._listeners.length;b++)this._listeners[b](a)}};this._finishDiscover=function(a,c){var b=this._callbacks;this._closeSockets();this._sockets=[];this._homeCenters=[];this._running=!1;this._listeners=[];this._callbacks=[];for(var f=0;f<b.length;f++){var e=
b[f];e&&e(a,c)}}};return e}();
...
"info is invalid"))},deleteDevice:function(b,a,c){c()},applyUIFilter:function(b,a){var c=this,d=function(a,b){if("*"==a)return!0;for(var c=!1,d=0;d<a.length;d++)if(a[d]==b){c=!0;break}return c},f=function(a,b,c){var f=[];switch(c.catagory){case "command":a.command&&a.command.forEach(function(a){d(c.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),f.push(a))});break;case "status":a.status&&a.status.forEach(function(a){d(c.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),f.push(a))})}return f},e=function(a,
...
xnm.aio.fibaro.HomeCenter.SET_POINT_MODES[parseInt(a)])&&g.ref.extMeta.push(a)});a.command.push(g)}}break;case "setThermostatSetpoint":d&&d.supportedModes&&(e=d.supportedModes.split(","),0<e.length&&e.forEach(function(c){var b=xnm.aio.fibaro.HomeCenter.SET_POINT_MODES[parseInt(c)];b&&a.command.push({type:"float",name:"set point ("+b+")",ref:{value:"setThermostatSetpoint"+c,ext:"%f",extMeta:"4.0-30.0",scale:"0.5"}})}));break;case "setMode":d&&d.supportedModes&&(e=d.supportedModes.split(","),0<e.length&&
