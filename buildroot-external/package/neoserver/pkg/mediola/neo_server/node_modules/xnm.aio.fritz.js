...
$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(a,d){return $jscomp.findInternal(this,a,d).v}},"es6","es3");var xnm=xnm||{};xnm.aio=xnm.aio||{};xnm.aio.fritz=xnm.aio.fritz||{};xnm.aio.fritz.SessionCache={_cache:{},STATE_TO:5E3,setSessionID:function(a,c){if(a){var d=this._cache[a];d||(this._cache[a]={},d=this._cache[a]);d.sessionID=c}},getSessionID:function(a){return a?this._cache[a]?this._cache[a].sessionID:null:null}};
...
b?28.5:253==b?7.5:(b/2).toFixed(1)):c.temp="?"),(b=$(e[0]).find("komfort"))&&b[0]&&((b=$(b[0]).text())?(b=parseInt(b),c.comfort=254==b?28.5:253==b?7.5:(b/2).toFixed(1)):c.comfort="?"),(b=$(e[0]).find("absenk"))&&b[0]&&((b=$(b[0]).text())?(b=parseInt(b),c.absenk=254==b?28.5:253==b?7.5:(b/2).toFixed(1)):c.absenk="?"),(b=$(e[0]).find("batterylow"))&&b[0]&&((b=$(b[0]).text())?(b=parseInt(b),c.batlow=1==b?!0:!1):c.batlow="?"));return d?c:null};
xnm.aio.fritz.Box.prototype.executeCommand=function(a,c,d){switch(c){case "on":var b="setswitchon";break;case "off":b="setswitchoff";break;case "toggle":b="setswitchtoggle";break;case "thermoOn":b="sethkrtsoll&param=254";break;case "thermoOff":b="sethkrtsoll&param=253";break;default:0==c.indexOf("temp")&&(b=c.replace("temp",""),b=parseFloat(b),b=7.5>=b||253==b?"sethkrtsoll&param=253":28.5<=b||254==b?"sethkrtsoll&param=254":"sethkrtsoll&param="+2*b)}b?this._sendRequest("/webservices/homeautoswitch.lua?ain="+
a.address+"&switchcmd="+b,function(a){d&&setTimeout(function(){d(a)},250)}):d&&d(Error("no such command "+c))};xnm.aio.fritz.Box.prototype.getStates=function(a,c){this.CommandHandler=a;for(a=0;a<c.length;a++)this.getState(c[a])};xnm.aio.fritz.Box.prototype.getStateValues=function(a,c){return c};
xnm.aio.fritz.Box.prototype.getDeviceName=function(a,c){this._logger.log("trace","get device name:"+a);this._sendRequest("/webservices/homeautoswitch.lua?ain="+a+"&switchcmd=getswitchname",function(a,b){c&&c(a,b)})};xnm.aio.fritz.Box.prototype.executeCommandCreator=function(a,c,d){if(a&&a.address&&c&&c.value){var b=c.value;if("temp"==c.value){if(!c.ext){d&&d(Error("parameter ext invalid"));return}b+=c.ext}this.executeCommand(a,b,function(){d&&d()})}else d&&d(Error("parameter invalid"))};
