...
require("x.logger.js").getLogger("xnm.aio.gealan.Fan");this._ip=a;this._port=b;this._port||(this._port=443);this._username=d;this._password=c;this._timeout=5E3;this._readMainCallbacks=[];this._readAmbientsCallbacks=[];this._readFilterCallbacks=[];this._readLogCallbacks=[];this._readFanCallbacks=[];this._readWlanScanCallbacks=[];this._readCounterCallbacks=[];this._httpReqBuffer=[];this._configUdpServerInterval=null;"undefined"!=typeof process&&null!=process&&process.env&&(this._keepAliveAgent=new (require("https").Agent)({keepAlive:!0,
maxSockets:1}))};c.prototype.executeCommandCreator=function(a,b,d){if(b&&b.value)switch(b.value){case "setLevel":a=parseInt(b.ext);if(isNaN(a)){d&&d(Error("level value invalid"));break}switch(a){case 0:this._setStandBy(d);break;case 1:this._setLevel1(d);break;case 2:this._setLevel2(d);break;case 3:this._setLevel3(d);break;case 4:this._setLevel4(d);break;case 5:this._setLevel5(d);break;default:d&&d(Error("level value out of range"))}break;case "automatic":this._setAutomatic(d);break;case "manual":this._setManual(d);
break;case "nextLevel":this._setNextLevel(d);break;case "previousLevel":this._setPreviousLevel(d);break;case "nightIn":a=parseInt(b.ext);if(isNaN(a)){d&&d(Error("night in value invalid"));break}switch(a){case 1:this._setNightIn1(d);break;case 2:this._setNightIn2(d);break;case 3:this._setNightIn3(d);break;default:d&&d(Error("night in value out of range"))}break;case "nightOut":a=parseInt(b.ext);if(isNaN(a)){d&&d(Error("night out value invalid"));break}switch(a){case 1:this._setNightOut1(d);break;case 2:this._setNightOut2(d);
break;case 3:this._setNightOut3(d);break;default:d&&d(Error("night out value out of range"))}break;case "resetFilter":this._resetFilter(calllback);break;case "resetError":this._resetError(calllback)}else d&&d(Error("command value is empty"))};c.prototype.getStatesCreator=function(a,b,d){for(var c=this,f=function(a,b,d){var g=[],f,e;switch(a){case "main":c.getMainStates(function(a,c){if(a)d(a);else{for(f=0;f<b.length;f++)if((e=b[f])&&e.id&&e.status)switch(e.status.value){case "tempIn":case "tempOut":case "humIn":g.push({id:e.id,
status:c[e.status.value]})}d(null,g)}});break;case "general":c.getGeneralStates(function(a,c){if(a)d(a);else{for(f=0;f<b.length;f++)if((e=b[f])&&e.id&&e.status)switch(e.status.value){case "level":case "mode":case "stateNr":case "stateNrInt":case "error":case "errorNr":case "nightSpeed":case "filterReplace":case "logEntries":case "humidityNr":case "freezeNr":case "usageMode":case "nightModeState":g.push({id:e.id,status:c[e.status.value]})}d(null,g)}});break;case "ambients":c.getAmbientsStates(function(a,
c){if(a)d(a);else{for(f=0;f<b.length;f++)if((e=b[f])&&e.id&&e.status)switch(e.status.value){case "temp1":case "temp2":case "temp3":case "temp4":case "hum1":case "hum2":g.push({id:e.id,status:c[e.status.value]})}d(null,g)}});break;case "filter":c.getFilterStates(function(a,c){if(a)d(a);else{for(f=0;f<b.length;f++)if((e=b[f])&&e.id&&e.status)switch(e.status.value){case "elapsed":case "remaining":g.push({id:e.id,status:c?c[e.status.value]:"?"})}d(null,g)}});break;case "fan":c.getFanStates(function(a,
c){if(a)d(a);else{for(f=0;f<b.length;f++)if((e=b[f])&&e.id&&e.status)switch(e.status.value){case "targetRSIn":case "currentRSIn":case "targetRSOut":case "currentRSOut":case "maxRS":case "minRS":g.push({id:e.id,status:c?c[e.status.value]:"?"})}d(null,g)}})}},e=[],k=0;k<b.length;k++){var m=b[k];if(m&&m.id&&m.status&&m.status.value)switch(m.status.value){case "tempIn":case "tempOut":case "humIn":-1==e.indexOf("main")&&e.push("main");break;case "level":case "mode":case "stateNr":case "stateNrInt":case "error":case "errorNr":case "nightSpeed":case "filterReplace":case "logEntries":case "humidityNr":case "freezeNr":case "usageMode":case "nightModeState":-1==
e.indexOf("general")&&e.push("general");break;case "temp1":case "temp2":case "temp3":case "temp4":case "hum1":case "hum2":-1==e.indexOf("ambients")&&e.push("ambients");break;case "elapsed":case "remaining":-1==e.indexOf("filter")&&e.push("filter");break;case "targetRSIn":case "currentRSIn":case "targetRSOut":case "currentRSOut":case "maxRS":case "minRS":-1==e.indexOf("fan")&&e.push("fan")}}if(0==e.length)d&&d(null,[]);else{var l=0,n=[],h=function(c,g){l++;!c&&g&&(n=n.concat(g),"undefined"!=typeof a&&
null!=a&&"undefined"!=typeof a.reportStates&&null!=a.reportStates&&a.reportStates(null,g));l<e.length?f(e[l],b,h):d&&d(null,n)};f(e[l],b,h)}};c.prototype.getMainStates=function(a){var b=this;this._readMain(function(d,c){d?a&&a(d):(d=b._resolveMainStates(c),a&&a(null,d))})};c.prototype._resolveMainStates=function(a){var b={};b.tempIn=parseInt(a.TempIn)/100;b.tempOut=parseInt(a.TempOut)/100;b.humIn=parseInt(a.HumidityIn)/100;return b};c.prototype.getGeneralStates=function(a){var b=this;this._readStatus(function(d,
c){d?a&&a(d):(d=b._resolveGeneralStates(c),a&&a(null,d))})};c.prototype._resolveGeneralStates=function(a){var b={};b.stateNr=parseInt(a.StateNr);5>=b.stateNr?(b.level=b.stateNr,b.mode="MANUAL"):(b.level="",b.mode=a.State);10==b.stateNr?(b.error=a.Error,b.errorNr=a.ErrorNr):(b.error="",b.errorNr="");b.nightSpeed=7==b.stateNr||8==b.stateNr?parseInt(a.NightSpeed):"";b.stateNrInt=parseInt(a.StateNrInternal);b.logEntries=parseInt(a.LOGEntries);b.filterReplace="yes"==a.ReplaceFilter;b.humidityNr=parseInt(a.StateOfHumidityNr);
b.freezeNr=parseInt(a.StateOfFreezeNr);b.usageMode=parseInt(a.UsageMode);b.nightModeState=parseInt(a.NightModeState);return b};c.prototype.getAmbientsStates=function(a){var b=this;this._readAmbients(function(d,c){d?a&&a(d):(d=b._resolveAmbientsStates(c),a&&a(null,d))})};c.prototype._resolveAmbientsStates=function(a){var b={};b.temp1=parseInt(a.Temp1)/100;b.temp2=parseInt(a.Temp2)/100;b.temp3=parseInt(a.Temp3)/100;b.temp4=parseInt(a.Temp4)/100;b.hum1=parseInt(a.Humidity1)/100;b.hum2=parseInt(a.Humidity2)/
100;return b};c.prototype.getFilterStates=function(a){var b=h.getFilterStates(this._ip);if("undefined"!=typeof b)null!=b&&(b=this._resolveFilterStates(b)),a&&a(null,b);else{var d=this;this.readFilter(function(b,c){h.setFilterStates(d._ip,b?null:c);b=d._resolveFilterStates(c);a&&a(null,b)})}};c.prototype._resolveFilterStates=function(a){var b={};b.elapsed=parseInt(a.Elapsed);b.remaining=parseInt(a.Remaining);return b};c.prototype.getFanStates=function(a){var b=h.getFanStates(this._ip);if("undefined"!=
typeof b)null!=b&&(b=this._resolveFanStates(b)),a&&a(null,b);else{var d=this;this.readFan(function(b,c){h.setFanStates(d._ip,b?null:c);b=d._resolveFanStates(c);a&&a(null,b)})}};c.prototype._resolveFanStates=function(a){var b={};b.targetRSIn=parseInt(a.TargetRotationSpeedIN);b.currentRSIn=parseInt(a.ActualRotationSpeedIN);b.targetRSOut=parseInt(a.TargetRotationSpeedOUT);b.currentRSOut=parseInt(a.ActualRotationSpeedOUT);b.maxRS=parseInt(a.MaxRotationSpeed);b.minRS=parseInt(a.MinRotationSpeed);return b};
...
ref:{value:"tempIn",ext:"%d"}},{type:"int",name:"temperature outside",ref:{value:"tempOut",ext:"%d"}},{type:"int",name:"humidity inside",ref:{value:"humIn",ext:"%d"}},{type:"int",name:"level",ref:{value:"level",ext:"%d",extMeta:"0-5"}},{type:"enum",name:"mode",ref:{value:"mode",options:"MANUAL AUTOMATIC NIGHT_IN NIGHT_OUT FLAP_CLOSED ERROR FROST_PROTECTION MOISTURE_PROTECTION".split(" ")}},{type:"int",name:"state no.",ref:{value:"stateNr",ext:"%d",extMeta:"0-12"}},{type:"int",name:"state no. (internal)",
ref:{value:"stateNrInt",ext:"%d"}},{type:"string",name:"error message",ref:{value:"error",ext:"%s"}},{type:"int",name:"error no.",ref:{value:"errorNr",ext:"%d"}},{type:"int",name:"night speed",ref:{value:"nightSpeed",ext:"%d",extMeta:"1-3"}},{type:"enum",name:"replace filter",ref:{value:"filterReplace",options:["true","false"]}},{type:"int",name:"log entries",ref:{value:"logEntries",ext:"%d"}},{type:"int",name:"humidity no.",ref:{value:"humidityNr",ext:"%d"}},{type:"int",name:"freeze no.",ref:{value:"freezeNr",
ext:"%d"}},{type:"int",name:"usage mode",ref:{value:"usageMode",ext:"%d"}},{type:"int",name:"night mode state",ref:{value:"nightModeState",ext:"%d"}},{type:"int",name:"temperature exhaust air (outside)",ref:{value:"temp1",ext:"%d"}},{type:"int",name:"temperature supply air (inside)",ref:{value:"temp2",ext:"%d"}},{type:"int",name:"temperature supply air (outside)",ref:{value:"temp3",ext:"%d"}},{type:"int",name:"temperature exhaust air (inside)",ref:{value:"temp4",ext:"%d"}},{type:"int",name:"humidity supply air (outside)",
ref:{value:"hum1",ext:"%d"}},{type:"int",name:"humidity exhaust air (inside)",ref:{value:"hum2",ext:"%d"}},{type:"int",name:"filter elapsed time",ref:{value:"elapsed",ext:"%d"}},{type:"int",name:"filter remaining time",ref:{value:"remaining",ext:"%d"}},{type:"int",name:"target rotation speed in",ref:{value:"targetRSIn",ext:"%d"}},{type:"int",name:"actual rotation speed in",ref:{value:"currentRSIn",ext:"%d"}},{type:"int",name:"target rotation speed out",ref:{value:"targetRSOut",ext:"%d"}},{type:"int",
name:"actual rotation speed out",ref:{value:"currentRSOut",ext:"%d"}},{type:"int",name:"max rotation speed",ref:{value:"maxRS",ext:"%d"}},{type:"int",name:"min rotation speed",ref:{value:"minRS",ext:"%d"}}]},c=function(a,b){this.code=a;this.message=b;this.stack=Error().stack};c.prototype=Error();c.prototype.name="GealanDMError";c.prototype.code=0;c.ERROR_CODE={DEFAULT:0,INDEX_EXISTS:1,ID_EXISTS:2,INVALID:3,UNKNOW:4,NOT_FOUND:5,IP_EXISTS:6};return{SYS:"gealan",getIPDeviceType:function(){return[{sys:this.SYS,
name:"Gealan Fan"}]},createDevice:function(a,b,d){b=c.ERROR_CODE;a?a.type?a.ip?d(null,a):d(new c(b.INVALID,"ip is invalid")):d(new c(b.INVALID,"type is invalid")):d(new c(b.INVALID,"info is invalid"))},updateDevice:function(a,b,d){b=c.ERROR_CODE;a?a.type?a.ip?d(null,a):d(new c(b.INVALID,"ip is invalid")):d(new c(b.INVALID,"type is invalid")):d(new c(b.INVALID,"info is invalid"))},deleteDevice:function(a,b,c){c()},applyUIFilter:function(a,b,c){var d=this,f=function(a,b){if("*"==a)return!0;for(var c=
!1,d=0;d<a.length;d++)if(a[d]==b){c=!0;break}return c},e=function(a,b,c){var d=[];switch(c.catagory){case "command":a.command&&a.command.forEach(function(a){f(c.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))});break;case "status":a.status&&a.status.forEach(function(a){f(c.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},h=function(a,b){var f=[],g=d.getCommandStatusMap(a,c);g&&(a=e(g,a,b),f=f.concat(a));return f};if(!a.sys)return null;var m=JSON.parse(JSON.stringify(a)),
l=null;switch(b.catagory){case "command":l=h(a,b);m.command=l;break;case "status":l=h(a,b);m.status=l;break;default:return null}return l&&0!=l.length?m:null},getCommandStatusMap:function(a,b){return h}}}();
