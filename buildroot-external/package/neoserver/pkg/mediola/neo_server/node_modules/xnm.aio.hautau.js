...
xnm.aio.hautau.Gateway=function(){var b=function(a,c){this._logger="undefined"==typeof require||null==require?{log:function(){}}:require("x.logger.js").getLogger("xnm.aio.hautau.Gateway");this.ip=a;this.port=c;this.port||(this.port=80);this.timeout=1E3;this._statesBuffer={};this._fifo=[]};b.DEVICETYPE_MAP={0:"general",1:"multisensor",2:"outputbox203v",4:"general",5:"ventra",6:"general",7:"general",8:"general",9:"drive",10:"general",11:"general",100:"general",101:"ska20cd",102:"drive",103:"hscd",104:"general",
106:"drive",107:"general",108:"general",255:"general"};b.prototype.executeCommandCreator=function(a,c,e){if(c&&c.value)if(a)if("undefined"==typeof a.address||null==a.address)e&&e(Error("device json format invali"));else switch(c.value){case "open":this._open(a.address,e);break;case "close":this._close(a.address,e);break;case "stop":this._stop(a.address,e);break;case "levelUp":this._setVentraLevel(a.address,"up",e);break;case "levelDown":this._setVentraLevel(a.address,"down",e);break;case "levelTo":this._setVentraLevel(a.address,
c.ext,e);break;case "keyboardOn":this._setVentraKeyboard(a.address,"on",e);break;case "keyboardOff":this._setVentraKeyboard(a.address,"off",e);break;case "lockOn":this._setHscdLock(a.address,"on",e);break;case "lockOff":this._setHscdLock(a.address,"off",e);break;default:e&&e(Error("command not exist"))}else e&&e(Error("device json is null"));else e&&e(Error("command json format invalid"))};b.prototype.getStatesCreator=function(a,c,e){for(var d={},b=0;b<c.length;b++)(a=c[b])&&a.device&&"undefined"!=
typeof a.device.address&&null!=a.device.address&&a.device.type&&(d[a.device.address]=a.device.type);var g=[],k=this,h=Object.keys(d);b=0;var m=function(a,f){if(!a&&f){a=h[b];if(f){for(var q=[],p=0;p<c.length;p++){var n=c[p];if(n&&n.id&&n.device&&n.device.address&&n.device.address==a&&n.status&&n.status.value){var l=f[n.status.value];"undefined"!=typeof l&&null!=l&&q.push({id:n.id,status:l})}}f=q}else f=[];f&&(g=g.concat(f))}b++;b<h.length?k._getDeviceStates(h[b],d[h[b]],m):e&&e(null,g)};this._getDeviceStates(h[b],
d[h[b]],m)};b.prototype.listDevices=function(a,c){var e=this,d=0,b=30;if("object"===typeof a&&null!==a){var g=Number(a.start);a=Number(a.end);!isNaN(g)&&0<=g&&255>=g&&(d=g);!isNaN(a)&&0<=a&&255>=a&&(b=a);b<d&&(b=d)}var k=d,h=0,m=[],l=function(a,f){a&&-3!=a.code?d==k&&5>h?(h++,e._ping(d,l)):c&&c(a,m):(!a&&f&&(f.sys="hautau",f.type=f.DeviceType,f.address=d,m.push(f)),d++,d>b?c&&c(null,m):e._ping(d,l))};this._ping(d,l)};b.prototype._getDeviceStates=function(a,c,e){var d=(new Date).getTime(),f=!1,g=this._statesBuffer[a];
g?g.timestamp&&3E3<d-g.timestamp&&(f=!0,g.timestamp=d):(f=!0,this._statesBuffer[a]={states:null,timestamp:d},g=this._statesBuffer[a]);c=b.DEVICETYPE_MAP[c];if("undefined"==typeof c||null==c)e&&e(Error("unknown device type"));else if(f){var k=this;switch(c){case "drive":this._getDriveStates(a,function(c,d){!c&&d&&(k._statesBuffer[a]={states:d,timestamp:(new Date).getTime()});e&&e(c,d)});break;case "multisensor":this._getMultiSensorStates(a,function(c,d){!c&&d&&(k._statesBuffer[a]={states:d,timestamp:(new Date).getTime()});
e&&e(c,d)});break;case "ska20cd":this._getSka20cdStates(a,function(c,d){!c&&d&&(k._statesBuffer[a]={states:d,timestamp:(new Date).getTime()});e&&e(c,d)});break;case "ventra":this._getVentraStates(a,function(c,d){!c&&d&&(k._statesBuffer[a]={states:d,timestamp:(new Date).getTime()});e&&e(c,d)});break;case "hscd":this._getHscdStates(a,function(c,d){!c&&d&&(k._statesBuffer[a]={states:d,timestamp:(new Date).getTime()});e&&e(c,d)});break;default:e&&e(null,null)}}else e&&e(null,g.states)};b.prototype._open=
function(a,c){this._executeRequest("/hautau/open",{adr:a},null,function(a,d){c&&c(a,d)})};b.prototype._close=function(a,c){this._executeRequest("/hautau/close",{adr:a},null,function(a,d){c&&c(a,d)})};b.prototype._stop=function(a,c){this._executeRequest("/hautau/stop",{adr:a},null,function(a,d){c&&c(a,d)})};b.prototype._getDriveStates=function(a,c){this._executeRequest("/hautau/drive",{adr:a,state:"show"},null,function(a,d){a?c&&c(a,d):(a={Closed:"yes"==d.Closed,Opened:"yes"==d.Opened,PowerCutoff:"yes"==
d.PowerCutoff,State:"yes"==d.Closed?"closed":"open"},c&&c(null,a))})};b.prototype._getMultiSensorStates=function(a,c){this._executeRequest("/hautau/multisensor",{adr:a,state:"show"},null,function(a,d){a?c&&c(a,d):(d.Temperature=d.Temperature.toFixed(1),c&&c(null,d))})};b.prototype._getSka20cdStates=function(a,c){this._executeRequest("/hautau/ska20cd",{adr:a,state:"show"},null,function(a,d){a?c&&c(a,d):(a={Closed:"yes"==d.Closed,Opened:"yes"==d.Opened,PowerCutoff:"yes"==d.PowerCutoff,State:"yes"==
d.Closed?"closed":"open"},c&&c(null,a))})};b.prototype._getVentraStates=function(a,c){this._executeRequest("/hautau/ventra",{adr:a,state:"show"},null,function(a,d){a?c&&c(a,d):(d.FilterChange="yes"==d.FilterChange,c&&c(null,d))})};b.prototype._setVentraLevel=function(a,c,b){var d=this;c||(c=0);this._executeRequest("/hautau/ventra",{adr:a,level:c},null,function(c,e){if(c)b&&b(c,e);else if("undefined"!=typeof e.Level&&null!=e.Level){c=(new Date).getTime();var f=d._statesBuffer[a];f||(d._statesBuffer[a]=
{states:{},timestamp:c},f=this._statesBuffer[a]);f.states.Level=e.Level}})};b.prototype._setVentraKeyboard=function(a,c,b){var d=this;this._executeRequest("/hautau/ventra",{adr:a,keyboard:c},null,function(c,e){if(c)b&&b(c,e);else if("undefined"!=typeof e.Keyboard&&null!=e.Keyboard){c=(new Date).getTime();var f=d._statesBuffer[a];f||(d._statesBuffer[a]={states:{},timestamp:c},f=this._statesBuffer[a]);f.states.Keyboard=e.Keyboard}})};b.prototype._getHscdStates=function(a,c){this._executeRequest("/hautau/hscd",
{adr:a,state:"show"},null,function(a,d){a?c&&c(a,d):(d.WindowDown="yes"==d.WindowDown,d.WindowClosed="yes"==d.WindowClosed,d.State=d.WindowClosed?"closed":"open",c&&c(null,d))})};b.prototype._setHscdLock=function(a,c,b){var d=this;this._executeRequest("/hautau/hscd",{adr:a,lock:c},null,function(c,e){if(c)b&&b(c,e);else if("undefined"!=typeof e.Lock&&null!=e.Lock){c=(new Date).getTime();var f=d._statesBuffer[a];f||(d._statesBuffer[a]={states:{},timestamp:c},f=this._statesBuffer[a]);f.states.Lock=e.Lock}})};
b.prototype._ping=function(a,c){this._executeRequest("/hautau/ping",{adr:a},2E3,c)};b.prototype._executeRequest=function(a,c,b,d){var e=this._fifo.length;this._fifo.push({path:a,params:c,timeout:b,callback:d});0==e&&this._doNextRequest()};b.prototype._doNextRequest=function(){if(0!=this._fifo.length){var a=this._fifo[0],c=this;this._doJsonRequest(a.path,a.params,a.timeout,function(b,d){try{a.callback&&a.callback(b,d)}catch(f){}c._fifo.splice(0,1);c._doNextRequest()})}};b.prototype._doJsonRequest=
function(a,c,b,d){this._doRequest("GET",a,c,b,function(a,c){if(a)d&&d(a);else if(c)try{var b=JSON.parse(c);"ok"!=b.Result?(a=Error(b.Result?b.Result:"result param is empty"),a.code=-3,d&&d(a)):d&&d(null,b)}catch(h){h.code=-2,d&&d(h)}else a=Error("request empty"),a.code=-2,d&&d(a)})};b.prototype._doRequest=function(a,c,b,d,f){d||(d=this.timeout);var e=this;c="http://"+this.ip+":"+this.port+c;if(b){var k=[],h;for(h in b){var m=b[h];if("undefined"==typeof m||null==m)m="";k.push(h+"="+encodeURIComponent(m))}c+=
"?"+k.join("&")}this._logger.log("trace","send "+a+" to url:"+c);var l=f;$.ajax({url:c,type:a,timeout:d,dataType:"text",cache:!0,success:function(a){e._logger.log("trace","http request success:"+a);l&&(l(null,a),l=null)},error:function(a,c){a="http request error:"+(a?a.status:"0")+"-"+c;e._logger.log("trace",a);l&&(a=Error(a),a.code=-1,l(a),l=null)}})};b.prototype.toJSON=function(){return{sys:"hautau",ip:this.ip,port:this.port}};b.prototype.equalsTo=function(a){return a&&a instanceof b?this.ip==a.ip&&
this.port==a.port:!1};b.parseJSON=function(a){return a.ip?new b(a.ip,a.port):null};return b}();
