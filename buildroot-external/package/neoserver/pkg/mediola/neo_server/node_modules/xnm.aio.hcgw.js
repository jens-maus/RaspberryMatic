...
xnm.aio.hcgw.Discovery.prototype._addDiscoverSocket=function(a,b){var c=require("dgram"),d=this;if(!b){try{var e=c.createSocket({reuseAddr:!0,type:"udp4"})}catch(f){e=c.createSocket("udp4")}e.on("message",function(f,h){d._receivedData(h.address,f.toString())});e.bind(a);this._sockets.push(e)}else if("IPv4"==b.family&&0==b.internal){try{e=c.createSocket({reuseAddr:!0,type:"udp4"})}catch(f){e=c.createSocket("udp4")}e.on("listening",function(){e.setBroadcast(!0)});e.on("message",function(f,h){d._receivedData(h.address,
f.toString())});e.bind(a,b.address);this._sockets.push(e)}};xnm.aio.hcgw.Discovery.prototype._sendDiscoveryMessages=function(a,b,c,d){a=new Buffer("SEARCH HCGW");for(b=0;b<this._sockets.length;b++)this._sockets[b].send(a,0,a.length,49880,"255.255.255.255")};xnm.aio.hcgw.Discovery.prototype.discoverGateways=function(){var a=this,b=0,c=setInterval(function(){a._sendDiscoveryMessages();1<=b++&&clearInterval(c)},250)};xnm.aio.hcgw.Handler=function(){this._Discovery=null;this.discoverGateways()};
