...
0!==b.data.gateways.length){b=b.data.gateways;var f;for(f=0;f<b.length;f++)if(b[f].index===a.gateway){var g=b[f];break}g?c(null,a):c(new d(e.NOT_FOUND,"gateway with index "+a.gateway+" not exists"))}else c(new d(e.NOT_FOUND,"gateway with index "+a.gateway+" not exists"));else c(new d(e.INVALID,"data is invalid"));else c(new d(e.INVALID,"address is invalid"));else c(new d(e.INVALID,"type is invalid"));else c(new d(e.INVALID,"gateway is invalid"));else c(new d(e.INVALID,"info is invalid"))},updateDevice:function(a,
b,c){var d=xnm.aio.hcgw.DM.DMError,e=xnm.aio.hcgw.DM.DMError.ERROR_CODE;if(a)if(a.address)if(a.type)if(a.data)if(b.data&&b.data.gateways&&0!==b.data.gateways.length){b=b.data.gateways;var f;for(f=0;f<b.length;f++)if(b[f].index===a.gateway){var g=b[f];break}g?c(null,a):c(new d(e.NOT_FOUND,"gateway with index "+a.gateway+" not exists"))}else c(new d(e.NOT_FOUND,"gateway with index "+a.gateway+" not exists"));else c(new d(e.INVALID,"data is invalid"));else c(new d(e.INVALID,"type is invalid"));else c(new d(e.INVALID,
"address is invalid"));else c(new d(e.INVALID,"info is invalid"))},deleteDevice:function(a,b,c){c()},applyUIFilter:function(a,b){var c=function(a,b){if("*"==a)return!0;for(var c=!1,d=0;d<a.length;d++)if(a[d]==b){c=!0;break}return c},d=function(a,b,d){var e=[];switch(d.catagory){case "command":a.command&&a.command.forEach(function(a){c(d.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),e.push(a))});break;case "status":a.status&&a.status.forEach(function(a){c(d.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),
e.push(a))})}return e},e=function(a,b){var c=[],e=null;switch(a.type){case "BS":e="heater"==a.data?xnm.aio.hcgw.DM.MAP.BS.heater:xnm.aio.hcgw.DM.MAP.BS.general;break;case "BS2":e=xnm.aio.hcgw.DM.MAP.BS2.general;break;case "ELRO":e=xnm.aio.hcgw.DM.MAP.ELRO.general;break;case "DY":case "DY2":e=xnm.aio.hcgw.DM.MAP.DY.shutter;break;case "IT":case "IT2":e="shutter"==a.data?xnm.aio.hcgw.DM.MAP.IT.shutter:"dimmer"==a.data?xnm.aio.hcgw.DM.MAP.IT.dimmer:xnm.aio.hcgw.DM.MAP.IT.general}e&&(a=d(e,a,b),c=c.concat(a));
return c};if(!a||null==a.type||"undefined"==typeof a.type)return null;var f=JSON.parse(JSON.stringify(a)),g=null;switch(b.catagory){case "command":g=e(a,b);f.command=g;break;case "status":g=e(a,b);f.status=g;break;default:return null}return g&&0!=g.length?f:null}};xnm.aio.hcgw.DM.DMError=function(a,b){this.code=a;this.message=b;this.stack=Error().stack};xnm.aio.hcgw.DM.DMError.prototype=Error();xnm.aio.hcgw.DM.DMError.prototype.name="HCGatewayDMError";xnm.aio.hcgw.DM.DMError.prototype.code=0;
xnm.aio.hcgw.DM.DMError.ERROR_CODE={DEFAULT:0,INDEX_EXISTS:1,ID_EXISTS:2,INVALID:3,UNKNOW:4,NOT_FOUND:5,IP_EXISTS:6};xnm.aio.hcgw.Handler.prototype.devicemanager=xnm.aio.hcgw.DM;xnm.aio.hcgw.Handler.prototype.registModule=function(a){a.register(xnm.aio.hcgw.DM.SYS,"hcgw")};xnm.aio.hcgw.Handler.prototype.resolveGateway=function(a){if(!a.ip)return null;var b=new xnm.aio.hcgw.Gateway(a.ip);a.port&&(b.port=a.port);null!=a.mode&&"undefined"!=typeof a.mode&&(b.mode=a.mode);return b};
xnm.aio.hcgw.Handler.prototype.getDeviceCommands=function(a,b){a=(a=xnm.aio.hcgw.DM.applyUIFilter(a,{catagory:"command",elems:"*"}))?a.command:[];b&&b(null,a)};xnm.aio.hcgw.Handler.prototype.doCommand=function(a,b,c,d){(a=this.resolveGateway(a))?a.executeCommandCreator(b,c,d):d&&d(Error("gateway json format invalid"))};
