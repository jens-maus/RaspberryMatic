...
a(Error("unknonwn device type"));var c=function(c){!c||-5!=c.code&&-6!=c.code||(c.source="heos");a&&a(c)};switch(d.value){case "play":this.play(b,c);break;case "pause":this.pause(b,c);break;case "stop":this.stop(b,c);break;case "previous":this.previous(b,c);break;case "next":this.next(b,c);break;case "toggleMute":"player"==e.type?this.togglePlayerMute(b,c):this.toggleGroupMute(b,c);break;case "mute":"player"==e.type?this.playerMute(b,!0,c):this.groupMute(b,!0,c);break;case "unmute":"player"==e.type?
