...
l;break}}}if(!f||!h)return null;for(l in a.channels)if(l==f){c=a.address;d=c.indexOf(":");-1!=d&&(c=c.substr(0,d));g=c+":"+a.channels[l].address;break}return g?{"interface":a["interface"],channel:g,channelType:f,datapoint:h}:null},getStatesCreator:function(a,c,d){for(var b=[],e=[],f=null,h=this,g=[],l=[],k=[],n=0;n<c.length;n++){var q=c[n],p=q.id,t=q.status,r=q.device;if(p&&r&&t)if(!r.type&&r.ip)"serviceMsg"==t.value?g.push(q):"ccuTime"==t.value?l.push(q):"cloudmaticState"==t.value&&k.push(q);else switch(r.type){case xnm.aio.hm.DM.SYSVAR:if(!r["class"]||
!xnm.aio.hm.SysVar[r["class"].toUpperCase()])continue;(f=xnm.aio.hm.SysVar[r["class"].toUpperCase()].buildStateScript(this,r,t))&&b.push({alias:p,script:f,device:r,status:t});break;case xnm.aio.hm.DM.PROG:continue;default:if(r&&"BidCos-RF"==r["interface"]&&r.type&&xnm.aio.hm.BidCosDevice[r.type]){var w=xnm.aio.hm.BidCosDevice[r.type];if(w.buildStateScript&&(f=w.buildStateScript(this,r,t))){b.push({alias:p,script:f,device:r,channel:null,status:t});break}}if(r&&"HmIP-RF"==r["interface"]){if((w=xnm.aio.hm.HmIPDevice.resolveJSON(r))&&
w.getBufferedState&&(q=w.getBufferedState(this,r,t),null!=q&&"undefined"!=typeof q)){e.push({alias:p,state:q});break}if(w&&w.buildStateScript&&(f=w.buildStateScript(this,r,t))){b.push({alias:p,script:f,device:r,channel:null,status:t});break}}if(r&&"VirtualDevices"==r["interface"]&&r.type&&(q=xnm.aio.hm.VirtualDevice[r.type])&&(q=new q,q.buildStateScript&&(f=q.buildStateScript(this,r,t)))){b.push({alias:p,script:f,device:r,channel:null,status:t});break}if(r.channels){w=r.channels;for(var u in w)if(w.hasOwnProperty(u)){var m=
null;"CUxD"==r["interface"]?m=xnm.aio.hm.CUxDChannel[u]:"HmIP-RF"==r["interface"]||"HmIP-HEATING"==r.type?m=xnm.aio.hm.HmIPChannel[u]:"HM-Sec-Sir-WM"!=r.type||"SWITCH_SENSOR_1"!=u&&"SWITCH_SENSOR_2"!=u?"HM-WDS30-OT2-SM-2"!=r.type||"WEATHER_1"!=u&&"WEATHER_2"!=u&&"WEATHER_3"!=u&&"WEATHER_4"!=u||(m=xnm.aio.hm.Channel.WEATHER):m=xnm.aio.hm.Channel.SWITCH_SENSOR;m||(m=xnm.aio.hm.Channel[u]);if(m&&m.getBufferedState&&(q=m.getBufferedState(this._statebuffer,r,r.channels[u],t),null!=q&&"undefined"!=typeof q)){e.push({alias:p,
state:q});break}if(m&&m.buildStateScript&&(f=m.buildStateScript(this,r,r.channels[u],t))){b.push({alias:p,script:f,device:r,channel:u,status:t});break}}}}}this.getCloudmaticStatus(a,k,function(c,k){"undefined"!=typeof a&&null!=a&&"undefined"!=typeof a.reportStates&&null!=a.reportStates&&!c&&k&&0<k.length&&a.reportStates(null,k);h.getServiceMessageStatus(a,g,function(c,g){h.getCCUStatus(a,l,function(a,c){0===b.length?(a=h.resolveStateResponse([],[],e),c&&(a=a?a.concat(c):c),g&&(a=a?a.concat(g):g),
k&&(a=a?a.concat(k):k),d&&d(null,a||[])):(f=h.buildScript(b),h._doRequest(f,!0,function(a,f){var l=null;if(a)d&&d(a);else{a=f.indexOf("<states>");var m=f.lastIndexOf("</states");if(m>a+8)try{l=f.substring(a+8,m);l=xnm.aio.hm.Util.decodeXml(l);var n=l.split("\r@@@\n");l={};for(f=0;f<n.length;f++){var v=n[f].indexOf("=");if(0<v){var x=n[f].substr(0,v);l[x]=n[f].substr(v+1)}}l=h.resolveStateResponse(b,l,e);c&&(l=l?l.concat(c):c);g&&(l=l?l.concat(g):g);k&&(l=l?l.concat(k):k);d&&d(null,l)}catch(J){d&&
...
f.systemvars[h],p=h;if(q.valuetype){switch(q.valuetype){case "2":g="binary";break;case "4":g="float";break;case "16":g="integer";break;case "20":g="string";break;default:g=null;break a}var t={};t.sys=xnm.aio.hm.DM.SYS;t.id=q.name;t.type=xnm.aio.hm.DM.SYSVAR;t.address=p;t["class"]=g;g=t}else g=null}g&&d.sysvars.push(g)}}if(e&&e.progs)for(h in n=e.progs,n)n.hasOwnProperty(h)&&(g=e.progs[h],q=h,g.name?(p={},p.sys=xnm.aio.hm.DM.SYS,p.id=g.name,p.address=q,p.type=xnm.aio.hm.DM.PROG,g=p):g=null,g&&d.progs.push(g));
...
this.cloudmatic.password:""))).toString("base64");var l=this,k="",n=require("http").request(c,function(a){200==a.statusCode?(a.setEncoding("binary"),a.on("data",function(a){k+=a}),a.on("end",function(){g&&g(null,k);g=null})):(l._logger.log("warn","Failed to post request to "+l.ip+" with status code:"+a.statusCode),g&&g(new TypeError("post request failed with status code:"+a.statusCode)),g=null)});n.setEncoding&&n.setEncoding("ISO-8859-1");if(n.setTimeout){c=6E4;if(null==b||"undefined"==typeof b)b=
0;b=parseInt(b);c=0<b?b:c;1E4>c&&(c=1E4);0<c&&n.setTimeout(c,function(){n.abort()})}if(n.on&&"function"==typeof n.on)n.on("error",function(a){a||(a=Error("http request error"));g&&g(a);g=null});n.write(a);n.end()}else d&&d(Error("cloudmatic config invalid"))}};
...
parseFloat(a),Math.round(100*a);default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "LEVEL":var b="blindPos";break;case "LEVEL_2":b="lamellaPos"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},PRESENCEDETECTOR_TRANSCEIVER:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "presenceOn":a="PRESENCE_DETECTION_ACTIVE";b="if(o!=null){o.State(1);}\n";break;case "presenceOff":a="PRESENCE_DETECTION_ACTIVE";
b="if(o!=null){o.State(0);}\n";break;case "presenceToggle":a="PRESENCE_DETECTION_ACTIVE";b="if(o!=null){if(o.Value()){o.State(0);}else{o.State(1);}}\n";break;case "presenceReset":a="RESET_PRESENCE";b="if(o!=null){o.State(1);}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "presenceIllu":a="ILLUMINATION";break;case "presenceState":a="PRESENCE_DETECTION_STATE";break;case "presenceActivate":a=
"PRESENCE_DETECTION_ACTIVE";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "presenceIllu":return parseFloat(a).toFixed(2);case "presenceState":return"true"==a?"on":"off";case "presenceActivate":return"true"==a?"on":"off";default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "ILLUMINATION":var b="presenceIllu";break;case "PRESENCE_DETECTION_STATE":b="presenceState";break;case "PRESENCE_DETECTION_ACTIVE":b=
...
a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "cl_fp_humidityLimiter":case "cl_fp_emergencyOP":case "cl_fp_frostProtection":return a;case "cl_fp_state":return"true"==a?"on":"off";default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "HUMIDITY_LIMITER":var b="cl_fp_humidityLimiter";break;case "EMERGENCY_OPERATION":b="cl_fp_emergencyOP";break;case "FROST_PROTECTION":b="cl_fp_frostProtection";break;case "STATE":b="cl_fp_state"}if(!b)return null;a=
this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},CLIMATECONTROL_FLOOR_TRANSCEIVER:{buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "cl_f_humidityLimiter":a="HUMIDITY_LIMITER";break;case "cl_f_emergencyOP":a="EMERGENCY_OPERATION";break;case "cl_f_frostProtection":a="FROST_PROTECTION";break;case "cl_f_state":a="STATE";break;case "cl_valve_level":a="LEVEL_STATUS";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,a)},
handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "cl_f_humidityLimiter":case "cl_f_emergencyOP":case "cl_f_frostProtection":return a;case "cl_f_state":return"true"==a?"on":"off";case "cl_valve_level":return 100*parseFloat(a);default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "HUMIDITY_LIMITER":var b="cl_f_humidityLimiter";break;case "EMERGENCY_OPERATION":b="cl_f_emergencyOP";break;case "FROST_PROTECTION":b="cl_f_frostProtection";break;case "STATE":b=
"cl_f_state";break;case "LEVEL_STATUS":b="cl_valve_level"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},WEATHER_TRANSMIT:{buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "weatherActualTemp":a="ACTUAL_TEMPERATURE";break;case "weatherHum":a="HUMIDITY";break;case "weatherIllu":a="ILLUMINATION";break;case "weatherSunD":a="SUNSHINEDURATION";break;case "weatherSunDOF":a="SUNSHINEDURATION_OVERFLOW";break;case "weatherSunTOR":a=
"SUNSHINE_THRESHOLD_OVERRUN";break;case "weatherWindS":a="WIND_SPEED";break;case "weatherWindTOR":a="WIND_THRESHOLD_OVERRUN";break;case "weatherRain":a="RAINING";break;case "weatherRainC":a="RAIN_COUNTER";break;case "weatherRainCOF":a="RAIN_COUNTER_OVERFLOW";break;case "weatherWindD":a="WIND_DIR";break;case "weatherWindDR":a="WIND_DIR_RANGE";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "weatherActualTemp":case "weatherIllu":case "weatherWindS":case "weatherRainC":case "weatherWindD":case "weatherWindDR":return parseFloat(parseFloat(a).toFixed(1));
case "weatherHum":case "weatherSunD":return parseInt(a);case "weatherSunDOF":case "weatherSunTOR":case "weatherWindTOR":case "weatherRain":case "weatherRainCOF":return a;default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "ACTUAL_TEMPERATURE":var b="weatherActualTemp";break;case "HUMIDITY":b="weatherHum";break;case "ILLUMINATION":b="weatherIllu";break;case "SUNSHINEDURATION":b="weatherSunD";break;case "SUNSHINEDURATION_OVERFLOW":b="weatherSunDOF";break;case "SUNSHINE_THRESHOLD_OVERRUN":b=
...
case "acousticDurUnit":var k=f.ext;break;case "acousticRepeat":var n=parseInt(f.ext)}}if("undefined"==typeof h||null==h||"undefined"==typeof g||null==g||"undefined"==typeof l||null==l||"undefined"==typeof k||null==k||"undefined"==typeof n||null==n)return null;"acousticPlay"==b.value?a.push(h):a=h.split(",");k=["S","M","H","10MS"].indexOf(k);g/=100;break;default:return null}if(0==a.length)return null;b="";h=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"DURATION_UNIT");b+='(datapoints.Get("'+h+'")).State('+
...
c);else if("btn"==c.value.substr(0,3)){var x=c.value.indexOf("press"),v=c.value.substr(3,x);v=parseInt(v);-1!=this._chKeyTransceivers.indexOf(v)&&(e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.buildCommandScript(a,b,{address:v},{value:c.value.substr(x)}))}e?a._doRequestMarked(e,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};a.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=
...
ext:c.ext},f=this._chDimmerVirtualReceiver1;if("ch"==c.value.substr(0,2)){var x=c.value.indexOf("dim");-1==x&&(x=c.value.indexOf("toggle"));if(-1==x){d&&d(Error("invalid command"));return}f=parseInt(c.value.substr(2,x));e.value=c.value.substr(x);if(f!=this._chDimmerVirtualReceiver1&&f!=this._chDimmerVirtualReceiver2&&f!=this._chDimmerVirtualReceiver3){d&&d(Error("invalid command"));return}}x=null;x={interface:b.interface,address:this.getAddress(),channels:b.channels};if(x=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(a,
x,{address:f},e)){var v=this;a._doRequestMarked(x,!0,{execute:function(e,f){e||v._handleCommandResponse(a,b,c,f);d&&d(e)}})}else d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};d.prototype._handleCommandResponse=function(a,b,c,d){if(this.useStateBuffer()){b=null;var e=d.indexOf("<v>");if(-1!=e){var f=d.indexOf("</v>");-1!=f&&(d=d.substring(e+3,f),b=Math.round(100*parseFloat(d)))}d=this.getAddress()+":"+this._chDimmerTransmitter+".LEVEL";switch(c.value){case "dimOn":delete a._statebuffer[d];
...
1};a.prototype.getCommandStatusMap=function(){return{command:[{type:"int",name:"set profile",ref:{value:"themoProf",ext:"%d",extMeta:"1-6",scale:"1"}},{type:"enum",name:"boost on",ref:{value:"themoBoostOn"}},{type:"enum",name:"boost off",ref:{value:"themoBoostOff"}},{type:"enum",name:"set auto mode",ref:{value:"themoAutoMode"}},{type:"enum",name:"set manu mode",ref:{value:"themoManuMode"}},{type:"float",name:"set temperature",ref:{value:"themoTemp",ext:"%f",extMeta:"4.5-30.5",scale:"0.5"}},{type:"enum",
name:"on",ref:{value:"themoTempOn"}},{type:"enum",name:"off",ref:{value:"themoTempOff"}},{type:"enum",name:"temperature up",ref:{value:"themoTempUp"}},{type:"enum",name:"temperature down",ref:{value:"themoTempDown"}},{type:"enum",name:"set window open",ref:{value:"themoWinOpen"}},{type:"enum",name:"set window close",ref:{value:"themoWinClose"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"int",name:"profile",ref:{value:"themoProf"}},{type:"float",
name:"actual temperature",ref:{value:"themoActualTemp",extMeta:"-10.0-56.0",scale:"0.1"}},{type:"enum",name:"boost mode",ref:{value:"themoBoostMode",options:["off","on"]}},{type:"enum",name:"frost protection",ref:{value:"themoFrost",options:["off","on"]}},{type:"int",name:"humidity",ref:{value:"themoHum"}},{type:"enum",name:"mode",ref:{value:"themoMode",options:["auto","manu"]}},{type:"float",name:"set temperature",ref:{value:"themoTemp",extMeta:"4.5-30.5",scale:"0.5"}},{type:"enum",name:"window state",
ref:{value:"themoWinState",options:["open","closed"]}}]}};a.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorVoltage",ext:"%f",extMeta:"0.0-25.2"}},{type:"int",name:"profile",ref:{value:"themoProf"}},{type:"float",name:"actual temperature",ref:{value:"themoActualTemp",extMeta:"-10.0-56.0",scale:"0.1"}},{type:"enum",name:"boost mode",ref:{value:"themoBoostMode",
options:["off","on"]}},{type:"enum",name:"frost protection",ref:{value:"themoFrost",options:["off","on"]}},{type:"int",name:"humidity",ref:{value:"themoHum"}},{type:"enum",name:"mode",ref:{value:"themoMode",options:["auto","manu"]}},{type:"float",name:"set temperature",ref:{value:"themoTemp",extMeta:"4.5-30.5",scale:"0.5"}},{type:"enum",name:"window state",ref:{value:"themoWinState",options:["open","closed"]}}]}};a.prototype.executeCommand=function(a,b,c,d){c?(script=xnm.aio.hm.HmIPChannel.HEATING_CLIMATECONTROL_TRANSCEIVER.buildCommandScript(a,
{interface:b.interface,address:this._address,channels:b.channels},{address:this._chHeatingClimateControlTransceiver},{value:c.value,ext:c.ext}))?a._doRequestMarked(script,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command")):d&&d(Error("command is null"))};a.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:this._chMaintenance},c);break;
case "themoProf":case "themoActualTemp":case "themoBoostMode":case "themoFrost":case "themoHum":case "themoMode":case "themoTemp":case "themoValveLevel":case "themoWinState":d=xnm.aio.hm.HmIPChannel.HEATING_CLIMATECONTROL_TRANSCEIVER.buildStateScript(a,b,{address:this._chHeatingClimateControlTransceiver},{value:c.value})}return d};a.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "themoProf":case "themoActualTemp":case "themoBoostMode":case "themoFrost":case "themoHum":case "themoMode":case "themoTemp":case "themoValveLevel":case "themoWinState":return xnm.aio.hm.HmIPChannel.HEATING_CLIMATECONTROL_TRANSCEIVER.handleStatusResponse(a,
b);default:return"?"}};a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(parseInt(d)){case this._chMaintenance:e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case this._chHeatingClimateControlTransceiver:e=xnm.aio.hm.HmIPChannel.HEATING_CLIMATECONTROL_TRANSCEIVER.resolveState(a,b,c)}return e};a.parseJSON=function(b){if(!b||!b.type||!b.channels)return null;var c=new a;c._type=
b.type;c._address=b.address;c._chMaintenanceHsstype="MAINTENANCE";return c};return a}(),h=function(){var a=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype="MAINTENANCE";this._chMotionDetectorTransceiver=1;this._chKeyTransceivers=[]};a.prototype.getCommandStatusMap=function(){var a={command:[{type:"enum",name:"reset",ref:{value:"motionReset"}},{type:"enum",name:"activate detection",ref:{value:"motionOn"}},{type:"enum",name:"deactivate detection",ref:{value:"motionOff"}},
{type:"enum",name:"toggle detection",ref:{value:"motionToggle"}}],status:[{type:"float",name:"illumination",ref:{value:"motionIllu"}},{type:"enum",name:"state",ref:{value:"motionState",options:["on","off"]}},{type:"enum",name:"detection activated",ref:{value:"motionActivate",options:["off","on"]}}]};a.status="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?a.status.concat([{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",
ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]):a.status.concat([{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]);return a};a.prototype.getIPEvtMap=function(){var a={ipevt:[{type:"float",name:"illumination",ref:{value:"motionIllu"}},{type:"enum",name:"state",ref:{value:"motionState",options:["on","off"]}},{type:"enum",name:"detection activated",ref:{value:"motionActivate",
...
name:"short press",ref:{value:"pressShort",options:["true"]}}),a.ipevt.push({type:"enum",name:"long press",ref:{value:"pressLong",options:["true"]}});else for(var b=0;b<this._chKeyTransceivers.length;b++){var c=this._chKeyTransceivers[b];c&&(a.ipevt.push({type:"enum",name:"button "+c+" short press",ref:{value:"btn"+c+"pressShort",options:["true"]}}),a.ipevt.push({type:"enum",name:"button "+c+" long press",ref:{value:"btn"+c+"pressLong",options:["true"]}}))}return a};a.prototype.executeCommand=function(a,
...
b,{address:this._chMaintenance},c);break;case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":a=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,b,{address:this._chMaintenance},c);break;default:a=xnm.aio.hm.HmIPChannel.MOTIONDETECTOR_TRANSCEIVER.buildStateScript(a,b,{address:this._chMotionDetectorTransceiver},{value:c.value})}return a};a.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,
b);case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,b);case "motionIllu":case "motionState":case "motionActivate":return xnm.aio.hm.HmIPChannel.MOTIONDETECTOR_TRANSCEIVER.handleStatusResponse(a,b);default:return"?"}};a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(parseInt(d)){case this._chMaintenance:e=
"MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(a,b,c):xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case this._chMotionDetectorTransceiver:e=xnm.aio.hm.HmIPChannel.MOTIONDETECTOR_TRANSCEIVER.resolveState(a,b,c)}return e};a.parseJSON=function(b){if(!b||!b.type||!b.channels)return null;var c=new a;c._type=b.type;c._address=b.address;"HmIP-SMI55"==b.type&&(c._chMaintenanceHsstype="MAINTENANCE_BAT_EL");-1!=b.type.indexOf("SMI55")&&
(c._chKeyTransceivers=[1,2],c._chMotionDetectorTransceiver=3);return c};return a}(),g=function(){var a=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype="MAINTENANCE";this._chPresenceDetectorTransceiver=1};a.prototype.getCommandStatusMap=function(){var a={command:[{type:"enum",name:"reset",ref:{value:"presenceReset"}},{type:"enum",name:"activate detection",ref:{value:"presenceOn"}},{type:"enum",name:"deactivate detection",ref:{value:"presenceOff"}},{type:"enum",
name:"toggle detection",ref:{value:"presenceToggle"}}],status:[{type:"float",name:"illumination",ref:{value:"presenceIllu"}},{type:"enum",name:"state",ref:{value:"presenceState",options:["on","off"]}},{type:"enum",name:"detection activated",ref:{value:"presenceActivate",options:["off","on"]}}]};a.status="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?a.status.concat([{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",
...
"MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(a,b,c):xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case this._chPresenceDetectorTransceiver:e=xnm.aio.hm.HmIPChannel.PRESENCEDETECTOR_TRANSCEIVER.resolveState(a,b,c)}return e};a.parseJSON=function(b){if(!b||!b.type||!b.channels)return null;var c=new a;c._type=b.type;c._address=b.address;"HmIP-SPI"==b.type&&(c._chMaintenanceHsstype="MAINTENANCE_BAT_EL");return c};return a}(),l=function(){var a=
...
"MAINTENANCE";for(var d in b.channels)"CLIMATECONTROL_FLOOR_TRANSCEIVER"==d.substr(0,32)&&(c._chHeatingClimateControlFloorTransceiver=parseInt(b.channels[d].address));return c};return a}(),k=function(){};k.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}},{type:"enum",name:"ch.4 on",ref:{value:"ch4on"}},{type:"enum",name:"ch.4 off",ref:{value:"ch4off"}},{type:"enum",
name:"ch.4 toggle",ref:{value:"ch4toggle"}},{type:"enum",name:"ch.5 on",ref:{value:"ch5on"}},{type:"enum",name:"ch.5 off",ref:{value:"ch5off"}},{type:"enum",name:"ch.5 toggle",ref:{value:"ch5toggle"}},{type:"enum",name:"ch.6 on",ref:{value:"ch6on"}},{type:"enum",name:"ch.6 off",ref:{value:"ch6off"}},{type:"enum",name:"ch.6 toggle",ref:{value:"ch6toggle"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"switch status",ref:{value:"switchState",
options:["off","on"]}},{type:"enum",name:"ch.4 status",ref:{value:"ch4State",options:["off","on"]}},{type:"enum",name:"ch.5 status",ref:{value:"ch5State",options:["off","on"]}},{type:"enum",name:"ch.6 status",ref:{value:"ch6State",options:["off","on"]}},{type:"float",name:"voltage",ref:{value:"meterVoltage",extMeta:"0.0-409.5",scale:"0.1",unit:"V"}},{type:"float",name:"energy counter",ref:{value:"meterEnergyCounter",extMeta:"0.0-838859.1",scale:"0.1",unit:"Wh"}},{type:"float",name:"frequency",ref:{value:"meterFrequency",
extMeta:"29.52-70.47",scale:"0.01",unit:"Hz"}},{type:"float",name:"power",ref:{value:"meterPower",extMeta:"0.0-163830.0",scale:"0.1",unit:"W"}},{type:"float",name:"current",ref:{value:"meterCurrent",extMeta:"0.0-65535.0",scale:"0.1",unit:"mA"}}]}};k.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;return{ipevt:JSON.parse(JSON.stringify(a))}};k.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;switch(c.value){case "on":case "ch4on":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,
...
{value:"switchState"});default:return"?"}};k.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "3":e=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.resolveState(a,b,c);break;case "4":case "5":case "6":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.resolveState(a,b,c);e.key="4"==d?"ch4State":"5"==d?"ch5State":"ch6State";break;case "7":e=xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.resolveState(a,
b,c)}return e};var n=function(){};n.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"dimOn"}},{type:"enum",name:"off",ref:{value:"dimOff"}},{type:"int",name:"dim up",ref:{value:"dimUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"dim down",ref:{value:"dimDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"dim to",ref:{value:"dimTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"toggle to",ref:{value:"toggleTo",ext:"%d",extMeta:"0-100",
...
{type:"int",name:"dimmer status",ref:{value:"dimmerTLevel",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.4 status",ref:{value:"ch4Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.5 status",ref:{value:"ch5Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.6 status",ref:{value:"ch6Level",extMeta:"0-100",unit:"%"}}]}};n.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;return{ipevt:JSON.parse(JSON.stringify(a))}};n.prototype.executeCommand=function(a,b,c,d){if(c){var e=
...
break;case "ch6Level":d=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:6},{value:"dimmerLevel"})}return d};n.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "dimmerTLevel":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(a,{value:"dimmerTLevel"});case "ch4Level":case "ch5Level":case "ch6Level":return xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.handleStatusResponse(a,
{value:"dimmerLevel"});default:return"?"}};n.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "3":e=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.resolveState(a,b,c);break;case "4":case "5":case "6":e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.resolveState(a,b,c),e.key="4"==d?"ch4Level":"5"==d?"ch5Level":"ch6Level"}return e};var q=function(){};q.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",
name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}}]}};q.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false","true"]}},{type:"enum",name:"button 1 short press",ref:{value:"btn1pressShort",options:["true"]}},{type:"enum",name:"button 1 long press",
ref:{value:"btn1pressLong",options:["true"]}},{type:"enum",name:"button 2 short press",ref:{value:"btn2pressShort",options:["true"]}},{type:"enum",name:"button 2 long press",ref:{value:"btn2pressLong",options:["true"]}}]}};q.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c)}return d};q.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,
b);default:return"?"}};q.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":case "2":e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c),"pressShort"==e.key?e.key="1"==d?"btn1pressShort":"btn2pressShort":"pressLong"==e.key&&(e.key="1"==d?"btn1pressLong":"btn2pressLong")}return e};var p=function(){};
p.prototype.getCommandStatusMap=function(){return{command:[{type:"multi",name:"trigger alarm",ref:{value:"alarmTrigger",ext:"%multi",extMeta:[{type:"enum",name:"set audio",ref:{value:"alarmAudio",ext:"%e",extMeta:"DISABLE_ACOUSTIC_SIGNAL FREQUENCY_RISING FREQUENCY_FALLING FREQUENCY_RISING_AND_FALLING FREQUENCY_ALTERNATING_LOW_HIGH FREQUENCY_ALTERNATING_LOW_MID_HIGH FREQUENCY_HIGHON_OFF FREQUENCY_HIGHON_LONGOFF FREQUENCY_LOWON_OFF_HIGHON_OFF FREQUENCY_LOWON_LONGOFF_HIGHON_LONGOFF LOW_BATTERY DISARMED INTERNALLY_ARMED EXTERNALLY_ARMED DELAYED_INTERNALLY_ARMED DELAYED_EXTERNALLY_ARMED EVENT ERROR".split(" ")}},
...
ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"sabotage",ref:{value:"errorSabo",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"alarmState",options:["on","off"]}}]}};p.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false",
"true"]}},{type:"enum",name:"sabotage",ref:{value:"errorSabo",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"alarmState",options:["on","off"]}}]}};p.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;switch(c.value){case "alarmTrigger":e=xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:3},c)}e?a._doRequestMarked(e,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};
p.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":case "errorSabo":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "alarmState":d=xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:3},c)}return d};p.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":case "errorSabo":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,
b);case "alarmState":return xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.handleStatusResponse(a,b);default:return"?"}};p.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "3":e=xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.resolveState(a,b,c)}return e};var t=function(){};t.prototype.getCommandStatusMap=
...
if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.SMOKE_DETECTOR.resolveState(a,b,c)}return e};var r=function(){};r.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"sabotage",ref:{value:"errorSabo",
options:["false","true"]}},{type:"enum",name:"window state",ref:{value:"handleState",options:["closed","tilted","open"]}}]}};r.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false","true"]}},{type:"enum",name:"sabotage",ref:{value:"errorSabo",options:["false","true"]}},{type:"enum",name:"window state",ref:{value:"handleState",options:["closed",
"tilted","open"]}}]}};r.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":case "errorSabo":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "handleState":d=xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.buildStateScript(a,b,{address:1},c)}return d};r.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":case "errorSabo":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,
...
b,c)}return e};var u=function(){};u.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"dimOn"}},{type:"enum",name:"off",ref:{value:"dimOff"}},{type:"int",name:"dim up",ref:{value:"dimUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"dim down",ref:{value:"dimDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"dim to",ref:{value:"dimTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"toggle to",ref:{value:"toggleTo",ext:"%d",extMeta:"0-100",
...
{type:"int",name:"dimmer status",ref:{value:"dimmerTLevel",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.3 status",ref:{value:"ch3Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.4 status",ref:{value:"ch4Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.5 status",ref:{value:"ch5Level",extMeta:"0-100",unit:"%"}}]}};u.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;return{ipevt:JSON.parse(JSON.stringify(a))}};u.prototype.executeCommand=function(a,b,c,d){if(c){var e=
...
b,{address:2},{value:"dimmerTLevel"});break;case "ch3Level":d=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:3},{value:"dimmerLevel"});break;case "ch4Level":d=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:4},{value:"dimmerLevel"});break;case "ch5Level":d=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:5},{value:"dimmerLevel"})}return d};u.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,
b);case "dimmerTLevel":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(a,{value:"dimmerTLevel"});case "ch3Level":case "ch4Level":case "ch5Level":return xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.handleStatusResponse(a,{value:"dimmerLevel"});default:return"?"}};u.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "2":e=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.resolveState(a,
b,c);break;case "3":case "4":case "5":e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.resolveState(a,b,c),e.key="3"==d?"ch3Level":"4"==d?"ch4Level":"ch5Level"}return e};var m=function(){};m.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"stop",ref:{value:"stop"}},{type:"enum",name:"move up",ref:{value:"moveUp"}},{type:"enum",name:"move down",ref:{value:"moveDown"}},{type:"int",name:"step up",ref:{value:"stepUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"step down",
...
ref:{value:"errorComm",options:["false","true"]}},{type:"int",name:"blind status",ref:{value:"blindTLevel",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.4 status",ref:{value:"ch4Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.5 status",ref:{value:"ch5Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.6 status",ref:{value:"ch6Level",extMeta:"0-100",unit:"%"}}]}};m.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;a=JSON.parse(JSON.stringify(a));a=a.concat([{type:"enum",
name:"button 1 short press",ref:{value:"btn1pressShort",options:["true"]}},{type:"enum",name:"button 1 long press",ref:{value:"btn1pressLong",options:["true"]}},{type:"enum",name:"button 2 short press",ref:{value:"btn2pressShort",options:["true"]}},{type:"enum",name:"button 2 long press",ref:{value:"btn2pressLong",options:["true"]}}]);return{ipevt:a}};m.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;e=4;var f=null;-1!=c.value.indexOf("ch5")?e=5:-1!=c.value.indexOf("ch6")&&(e=6);-1!=c.value.indexOf("stop")?
...
ref:{value:"passageR2LCOF",options:["false","true"]}}]}};D.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"passages detected",ref:{value:"passageCurrentDirection",options:["right_to_left","left_to_right"]}},{type:"enum",name:"previous passage",ref:{value:"passageLastDirection",options:["right_to_left","left_to_right"]}},
{type:"int",name:"passage count from left to right",ref:{value:"passageL2RC",extMeta:"0-127"}},{type:"enum",name:"passage count overflow from left to right",ref:{value:"passageL2RCOF",options:["false","true"]}},{type:"int",name:"passage count from right to left",ref:{value:"passageR2LC",extMeta:"0-127"}},{type:"enum",name:"passage count overflow from right to left",ref:{value:"passageR2LCOF",options:["false","true"]}}]}};D.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=
...
D.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "2":case "3":e=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.resolveState(a,b,c),"passageCurrentDirection"==e.key?e.key="passageCurrentDirection":"passageLastDirection"==e.key?e.key="passageLastDirection":"passageC"==e.key?e.key="2"==d?"passageR2LC":
"passageL2RC":"passageCOF"==e.key&&(e.key="2"==d?"passageR2LCOF":"passageL2RCOF")}return e};var E=function(){};E.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"waterAlarmState",options:["on","off"]}},{type:"enum",name:"moisture detected",ref:{value:"waterMoistureDetected",options:["true",
"false"]}},{type:"enum",name:"water detected",ref:{value:"waterWaterDetected",options:["true","false"]}}]}};E.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"waterAlarmState",options:["on","off"]}},{type:"enum",name:"moisture detected",ref:{value:"waterMoistureDetected",options:["true",
"false"]}},{type:"enum",name:"water detected",ref:{value:"waterWaterDetected",options:["true","false"]}}]}};E.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "waterAlarmState":d=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.buildStateScript(a,b,{address:1},{value:"waterAlarmState"});break;case "waterMoistureDetected":d=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.buildStateScript(a,
b,{address:1},{value:"waterMoistureDetected"});break;case "waterWaterDetected":d=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.buildStateScript(a,b,{address:1},{value:"waterWaterDetected"})}return d};E.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "waterAlarmState":case "waterMoistureDetected":case "waterWaterDetected":return xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.handleStatusResponse(a,
b);default:return"?"}};E.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.resolveState(a,b,c)}return e};var F=function(){};F.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false",
...
options:["false","true"]}}]}};F.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false","true"]}},{type:"int",name:"error code",ref:{value:"errorBatElCode",ext:"%d",extMeta:"0-255"}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0-25.2"}},{type:"enum",name:"sensor error",ref:{value:"errorBatElSensor",
options:["false","true"]}},{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"motion",ref:{value:"acceMotion",options:["false","true"]}}]}};F.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorBatElDutyCycle":case "errorBatElCode":case "errorBatElBat":case "errorBatElVoltage":case "errorBatElSensor":case "errorBatElComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,b,{address:0},
c);break;case "acceMotion":d=xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.buildStateScript(a,b,{address:1},c)}return d};F.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorBatElDutyCycle":case "errorBatElCode":case "errorBatElBat":case "errorBatElVoltage":case "errorBatElSensor":case "errorBatElComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,b);case "acceMotion":return xnm.aio.hm.HmIPChannel.ACCELERATION_TRANSCEIVER.handleStatusResponse(a,
b);default:return"?"}};F.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.ACCELERATION_TRANSCEIVER.resolveState(a,b,c)}return e};var A=function(){};A.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"float",name:"on for",ref:{value:"onFor",
ext:"%f",unit:"s"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]}};A.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;a=JSON.parse(JSON.stringify(a));a.push({type:"enum",name:"button short press",ref:{value:"btnPressShort",options:["true"]}});
a.push({type:"enum",name:"button long press",ref:{value:"btnPressLong",options:["true"]}});return{ipevt:a}};A.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;switch(c.value){case "on":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:3},{value:"onFor",ext:.5});break;case "onFor":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:3},c);break;default:d&&d(Error("unknown command"));return}e?a._doRequestMarked(e,!0,{execute:function(a,
b){d&&d(a)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};A.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":d=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,b,{address:0},c)}return d};A.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,
b);default:return"?"}};A.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c),"pressShort"==e.key?e.key="btnPressShort":"pressLong"==e.key&&(e.key="btnPressLong")}return e};var B=function(){};B.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",
...
B.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null,e;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "switchState":d=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.buildStateScript(a,b,{address:3},{value:"switchTState"});break;case "led1Level":case "led1Color":case "led2Level":case "led2Color":d="led1"==c.value.substr(0,4)?{address:11}:{address:7},"Level"==c.value.substr(4)?e={value:"dimmerTLevel"}:"Color"==c.value.substr(4)&&
(e={value:"dimmerTColor"}),d=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.buildStateScript(a,b,d,e)}return d};B.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "switchState":return xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.handleStatusResponse(a,{value:"switchTState"});case "led1Level":case "led2Level":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(a,{value:"dimmerTLevel"});
case "led1Color":case "led2Color":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(a,{value:"dimmerTColor"});default:return"?"}};B.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":case "2":e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c);"pressShort"==e.key?e.key="btn"+d+
...
b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.DOOR_RECEIVER.resolveState(a,b,c);break;case "2":e=xnm.aio.hm.HmIPChannel.SIMPLE_SWITCH_RECEIVER.resolveState(a,b,c)}return e};var G=function(){var a=function(){};a.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",
...
b);default:return"?"}};a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.BRIGHTNESS_TRANSMITTER.resolveState(a,b,c)}return e};return a}(),H=function(){var a=function(){};a.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",
...
var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.POWER_MAINS_TRANSMITTER.resolveState(a,b,c)}return e};return a}(),I=function(){var a=function(){};a.prototype.getCommandStatusMap=function(){return{command:[{type:"multi",name:"play sound",ref:{value:"acousticPlay",ext:"%multi",extMeta:[{type:"int",name:"set sound",ref:{value:"acousticSound",ext:"%d",extMeta:"0-255"}},
...
b,c)}return e};return a}();return{"HmIP-BSM":new k,"HmIP-BDT":new n,"HMIP-WRC2":new q,"HmIP-ASIR":new p,"HmIP-SWSD":new t,"HmIP-SRH":new r,"HmIP-FSM":new w,"HmIP-PDT":new u,"HmIP-BROLL":new m,"HmIP-FROLL":new m,"HmIP-BBL":new y,"HmIP-FBL":new y,"HmIP-WRC6":new C,"HmIP-SPDR":new D,"HmIP-SWD":new E,"HmIP-SAM":new F,"HmIP-WGC":new A,"HmIP-BSL":new B,"HmIP-MOD-TM":new z,"HmIP-SLO":new G,"HmIP-PMFS":new H,"HmIP-MP3P":new I,"HmIP-MOD-HO":new z,resolveJSON:function(k){if(!k||!k.type)return null;if("HmIP-PDT"==
k.type)return d.parseJSON(k);if(this[k.type])return this[k.type];var m=null;switch(k.type){case "HmIP-WHS2":m=c.parseJSON(k);break;case "HmIP-DBB":case "HmIP-BRC2":m=a.parseJSON(k);break;case "HmIP-RCV-50":m=a.parseJSON(k)}if("HmIPW-DRS"==k.type.substr(0,9))m=c.parseJSON(k);else if("HmIPW-DRD"==k.type.substr(0,9))m=d.parseJSON(k);else if("HmIPW-DRBL"==k.type.substr(0,10))m=b.parseJSON(k);else if("HmIPW-DRI"==k.type.substr(0,9))m=e.parseJSON(k);else if("HmIPW-FIO"==k.type.substr(0,9)){if(k.channels)for(var v in k.channels)if("MULTI_MODE_INPUT_TRANSMITTER"==
v.substr(0,28)){m=e.parseJSON(k);break}else if("SWITCH_TRANSMITTER"==v.substr(0,18)){m=c.parseJSON(k);break}}else if("HmIPW-STH"==k.type.substr(0,9)||"HmIPW-STHD"==k.type.substr(0,10)||"HmIPW-WTH"==k.type.substr(0,9))m=f.parseJSON(k);else if("HmIPW-SMI55"==k.type)m=h.parseJSON(k);else if("HmIPW-SPI"==k.type)m=g.parseJSON(k);else if("HmIP-FCI"==k.type.substr(0,8))m=e.parseJSON(k);else if("HmIP-MOD-RC"==k.type.substr(0,11))m=e.parseJSON(k);else if("HmIP-MOD-OC"==k.type.substr(0,11)){v=parseInt(k.type.substr(11));
var n=0,p=k.address.indexOf(":");-1!=p&&(n=parseInt(k.address.substr(p+1)));0<n&&n<=v?m=a.parseJSON(k):0!=n&&(m=c.parseJSON(k))}else if("HmIP-FDT"==k.type.substr(0,8))m=d.parseJSON(k);else if("HmIP-FALMOT"==k.type.substr(0,11))m=l.parseJSON(k);else if(this[k.type])return this[k.type];return m},parseDevice:function(a){return a.channels&&a.hsstype&&a["interface"]?0==a.hsstype.indexOf("HmIPW")?this._parseHMIPWDevice(a):this._parseHmIPRFDevice(a):null},_parseHMIPWDevice:function(a){var b=function(a){var b=
[];var c={sys:"hm"};c.id=a.name;c.type=a.hsstype;c.address=a.address;c.interface=a.interface;c.channels={};var d=0,e=JSON.parse(JSON.stringify(c)),f=null,g=a.channels,h=!1,l;for(l in g)if(g.hasOwnProperty(l)){var k=a.channels[l];if(k.hsstype&&("DIMMER_TRANSMITTER"==k.hsstype&&(0!=d&&(b.push(e),e=JSON.parse(JSON.stringify(c)),h=!1,f&&(e.channels.MAINTENANCE=f)),d++),k.address)){var m=k.address.indexOf(":");if(-1!==m){"DIMMER_VIRTUAL_RECEIVER"!=k.hsstype||h||(e.id=k.name?k.name:e.id,h=!0);m=k.address.substring(m+
1);"DIMMER_TRANSMITTER"==k.hsstype&&(e.address+=":"+m);var n={id:k.name,address:m,room:k.room,group:k.func};0==m?(f=n,e.channels.MAINTENANCE=f):e.channels[k.hsstype+":"+m]=n;if("DIMMER_WEEK_PROFILE"==k.hsstype){for(var v=0;v<b.length;v++)b[v].channels[k.hsstype+":"+m]=n;b.push(e)}}}}return b},c=function(a){var b=[];var c={sys:"hm"};c.id=a.name;c.type=a.hsstype;c.address=a.address;c.interface=a.interface;c.channels={};var d=0,e=JSON.parse(JSON.stringify(c)),f=null,g=a.channels,h=!1,k;for(k in g)if(g.hasOwnProperty(k)){var l=
a.channels[k];if(l.hsstype&&("BLIND_TRANSMITTER"==l.hsstype&&(0!=d&&(b.push(e),e=JSON.parse(JSON.stringify(c)),h=!1,f&&(e.channels.MAINTENANCE=f)),d++),l.address)){var m=l.address.indexOf(":");if(-1!==m){"BLIND_VIRTUAL_RECEIVER"!=l.hsstype||h||(e.id=l.name?l.name:e.id,h=!0);m=l.address.substring(m+1);"BLIND_TRANSMITTER"==l.hsstype&&(e.address+=":"+m);var n={id:l.name,address:m,room:l.room,group:l.func};0==m?(f=n,e.channels.MAINTENANCE=f):e.channels[l.hsstype+":"+m]=n;if("BLIND_WEEK_PROFILE"==l.hsstype){for(var v=
0;v<b.length;v++)b[v].channels[l.hsstype+":"+m]=n;b.push(e)}}}}return b},d=function(a){var b=[];var c={sys:"hm"};c.id=a.name;c.type=a.hsstype;c.address=a.address;c.interface=a.interface;c.channels={};var d=0,e=JSON.parse(JSON.stringify(c)),f=null,g=a.channels,h=!1,l;for(l in g)if(g.hasOwnProperty(l)){var k=a.channels[l];if(k.hsstype)if("ALARM_COND_SWITCH_TRANSMITTER"==k.hsstype)b.push(e);else if("MULTI_MODE_INPUT_TRANSMITTER"==k.hsstype&&(0!=d&&(b.push(e),e=JSON.parse(JSON.stringify(c)),h=!1,f&&(e.channels.MAINTENANCE=
f)),d++),k.address){var m=k.address.indexOf(":");if(-1!==m){"MULTI_MODE_INPUT_TRANSMITTER"!=k.hsstype||h||(e.id=k.name?k.name:e.id,h=!0);m=k.address.substring(m+1);"MULTI_MODE_INPUT_TRANSMITTER"==k.hsstype&&(e.address+=":"+m);var n={id:k.name,address:m,room:k.room,group:k.func};0==m?(f=n,e.channels.MAINTENANCE=f):e.channels[k.hsstype+":"+m]=n}}}return b},e=function(a){var b={sys:"hm"};b.id=a.name;b.type=a.hsstype;b.address=a.address;b.interface=a.interface;b.channels={};var c=0,d=!1,e=[];var f=[];
var g=JSON.parse(JSON.stringify(b)),h=null,k=a.channels,l;for(l in k)if(k.hasOwnProperty(l)){var m=a.channels[l];if(m.hsstype&&m.address){var n=m.address.indexOf(":");if(-1!==n){n=m.address.substring(n+1);var v={id:m.name,address:n,room:m.room,group:m.func};if("MAINTENANCE"==m.hsstype)h=v,g.channels.MAINTENANCE=h;else if("MULTI_MODE_INPUT_TRANSMITTER"==m.hsstype)g.channels[m.hsstype+":"+n]=v,g.id=m.name?m.name:g.id,g.address+=":"+n,e.push(g),g=JSON.parse(JSON.stringify(b)),h&&(g.channels.MAINTENANCE=
h);else if("SWITCH_TRANSMITTER"==m.hsstype)0!=c&&(f.push(g),g=JSON.parse(JSON.stringify(b)),d=!1,h&&(g.channels.MAINTENANCE=h)),c++,g.channels[m.hsstype+":"+n]=v,g.address+=":"+n;else if("SWITCH_VIRTUAL_RECEIVER"==m.hsstype&&!d)g.channels[m.hsstype+":"+n]=v,g.id=m.name?m.name:g.id,d=!0;else if("SWITCH_WEEK_PROFILE"==m.hsstype){for(var p=0;p<f.length;p++)f[p].channels[m.hsstype+":"+n]=v;f.push(g)}}}}return f.concat(e)},f=a.hsstype;if("HmIPW-DRS"==f.substr(0,9))return this._resolveHmIPMultiSwitch(a);
if("HmIPW-DRD"==f.substr(0,9))return b(a);if("HmIPW-DRBL"==f.substr(0,10))return c(a);if("HmIPW-DRI"==f.substr(0,9))return d(a);if("HmIPW-FIO"==f.substr(0,9))return e(a);if("HmIPW-SMI55"==f)return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1==["0","1","2","3"].indexOf(a)?0:-1!=["1","2"].indexOf(a)?2:1});if("HmIPW-SPI"==f)return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1==["0","1"].indexOf(a)?0:1});var g={};return this._resolveHmIPDeviceFromScript(a,function(a,b){if(!xnm.aio.hm.HMIP_CHANNEL[b])return 0;
g[b]||(g[b]=a);return g[b]!=a?0:1})},_parseHmIPRFDevice:function(a){if("HMIP-BSM"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1=="034567".split("").indexOf(a)?0:-1!=["4","5","6"].indexOf(a)?2:1});if("HMIP-FSM"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1=="012345".split("").indexOf(a)?0:-1!=["2","3","4"].indexOf(a)?2:1});if("HMIP-BDT"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,
b){return-1==["0","3","4","5","6"].indexOf(a)?0:-1!=["4","5","6"].indexOf(a)?2:1});if("HMIP-PDT"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1==["0","2","3","4","5"].indexOf(a)?0:-1!=["3","4","5"].indexOf(a)?2:1});if("HMIP-FDT"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1=="012345".split("").indexOf(a)?0:-1!=["2","3","4"].indexOf(a)?2:1});if("HMIP-BROLL"==a.hsstype.toUpperCase()||"HMIP-FROLL"==a.hsstype.toUpperCase()||
...
2:0});if("HmIP-MOD-OC"==a.hsstype.substr(0,11)){var b=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"KEY_TRANSCEIVER"==b?3:0});a=this._resolveHmIPMultiSwitch(a,[1,2,3,4,5,6,7,8]);return b?a?b.concat(a):b:a}if(-1!=a.hsstype.indexOf("HmIP-FCI"))return this._resolveHmIPDeviceFromScript(a,function(a,b){return 0==a?1:"MULTI_MODE_INPUT_TRANSMITTER"==b?3:0});b=this._getChannelCount(a.channels,"SWITCH_TRANSMITTER");var c=this._getChannelCount(a.channels,"SWITCH_VIRTUAL_RECEIVER");
if(1<this._getChannelCount(a.channels,"KEY_TRANSCEIVER"))return this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"KEY_TRANSCEIVER"==b?3:0});if(1<b&&1<c)return this._resolveHmIPMultiSwitch(a);var d={};return this._resolveHmIPDeviceFromScript(a,function(a,b){if(!xnm.aio.hm.HMIP_CHANNEL[b])return 0;d[b]||(d[b]=a);return d[b]!=a?0:1})},_getChannelCount:function(a,b){var c=0,d;for(d in a)a.hasOwnProperty(d)&&a[d].hsstype==b&&c++;return c},_parseDeviceBasic:function(a){var b={sys:"hm"};
b.id=a.name;b.type=a.hsstype;b.address=a.address;b.interface=a.interface;b.channels={};return b},_resolveHmIPMultiSwitch:function(a,b){var c=[];var d={sys:"hm"};d.id=a.name;d.type=a.hsstype;d.address=a.address;d.interface=a.interface;d.channels={};var e=0,f=JSON.parse(JSON.stringify(d)),g=null,h=a.channels,k=!1,l;for(l in h)if(h.hasOwnProperty(l)){var m=a.channels[l];if(m.hsstype&&("SWITCH_TRANSMITTER"==m.hsstype&&(0!=e&&(c.push(f),f=JSON.parse(JSON.stringify(d)),k=!1,g&&(f.channels.MAINTENANCE=g)),
e++),m.address)){var n=m.address.indexOf(":");if(-1!==n&&("SWITCH_VIRTUAL_RECEIVER"!=m.hsstype||k||(f.id=m.name?m.name:f.id,k=!0),n=m.address.substring(n+1),!b||-1==b.indexOf(parseInt(n)))){"SWITCH_TRANSMITTER"==m.hsstype&&(f.address+=":"+n);var p={id:m.name,address:n,room:m.room,group:m.func};0==n?(g=p,f.channels.MAINTENANCE=g):f.channels[m.hsstype+":"+n]=p;if("SWITCH_WEEK_PROFILE"==m.hsstype){for(var q=0;q<c.length;q++)c[q].channels[m.hsstype+":"+n]=p;c.push(f)}}}}return c},_resolveHmIPDeviceFromScript:function(a,
b){var c=[],d={sys:"hm"};d.id=a.name;d.type=a.hsstype;d.address=a.address;d["interface"]=a["interface"];d.channels={};var e=a.channels,f=!1,g;for(g in e)if(channel=a.channels[g],channel.address&&(e=channel.address.indexOf(":"),-1!==e)){e=channel.address.substring(e+1);var h=channel.hsstype;if(channel.hsstype){var k=1;b&&(k=b(e,h));0!=k&&(3==k?(k=JSON.parse(JSON.stringify(d)),k.address=k.address+":"+e,k.id=k.id+"("+k.address+")",k.channels[h]={id:channel.name,address:e,room:channel.room,group:channel.func},
c.push(k)):(f=!0,2==k&&(h=h+":"+e),d.channels[h]={id:channel.name,address:e,room:channel.room,group:channel.func}))}}f&&c.push(d);return c}}}();
...
h=b.elems,m;for(m in e)if(e.hasOwnProperty(m)){var r=f[m];if(r)for(var u in r)r.hasOwnProperty(u)&&("FHT_Multiventil"==a.cuxd&&"DIMMER"==m?m="FHT_Multiventil_Dimmer":"HMS_100_Contact"==a.cuxd&&"SENSOR"==m?m="HMS_100_Contact":"FHT_Contact"==a.cuxd&&"SENSOR"==m?m="FHT_Contact":"Security_Sensor"==a.cuxd&&"SENSOR"==m?m="Security_Sensor":"HMS_100_W/WD"==a.cuxd&&"SENSOR"==m&&(m="Security_Sensor"),xnm.aio.hm.CUxDMAP[m]?(b=g(xnm.aio.hm.CUxDMAP,m,u,r[u],h),c=c.concat(b)):xnm.aio.hm.MAP[m]&&(b=g(xnm.aio.hm.MAP,
m,u,r[u],h),c=c.concat(b)))}return c}if(a["interface"]&&"HmIP-RF"==a["interface"])return k(a,b);if(a["interface"]&&"BidCos-RF"==a["interface"]&&a.type&&xnm.aio.hm.BidCosDevice[a.type]&&(m=xnm.aio.hm.BidCosDevice[a.type])&&m.getCommandStatusMap&&(m=m.getCommandStatusMap(a))||a["interface"]&&"VirtualDevices"==a["interface"]&&-1==a.type.indexOf("HM-CC-VG")&&(m=d._getVirtualDevicesMap(a)))return l(m,b);if("DimmerKey"==a.type)return t(a,b);if("HM-Sec-Sir-WM"==a.type)return n(a,b);if("HM-WDS30-OT2-SM-2"==
a.type)return q(a,b);if("HM-ES-TX-WM"==a.type&&a.channels&&a.channels.POWERMETER_IEC1)return p(a,b);m=[];u=a.channels;a=xnm.aio.hm.DM._getChannels(a);f=b.elems;for(c in u)if(u.hasOwnProperty(c)&&(h=a[c]))for(e in h)h.hasOwnProperty(e)&&xnm.aio.hm.MAP[c]&&(b=g(xnm.aio.hm.MAP,c,e,h[e],f),m=m.concat(b));return m};if(!a.type)return null;var w=JSON.parse(JSON.stringify(a)),u=null;switch(c.catagory){case "command":u=e(a,c);w.command=u;break;case "status":u=e(a,c);w.status=u;break;default:return null}return u&&
0!=u.length?w:null},applyUIFilterGateway:function(a,c){var d=function(a,b){if("*"==a)return!0;for(var c=!1,d=0;d<a.length;d++)if(a[d]==b){c=!0;break}return c},b=function(a,b){var c=[],e=b.elems;if(a=xnm.aio.hm.MAP.CCU)switch(b.catagory){case "command":a.command&&a.command.forEach(function(a){d(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),c.push(a))});break;case "status":a.status&&a.status.forEach(function(a){d(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),c.push(a))})}return c},e=JSON.parse(JSON.stringify(a)),
...
name:"toggle detection"}),f["%motionReset%"]||(f["%motionReset%"]={value:"motionReset",name:"reset"}),h={"%motionState%":{value:"motionState",options:["on","off"],name:"state",conv_s:{on:"true",off:"false"}},"%motionBrightness%":{value:"motionIllu",name:"illumination"},"%motionActivate%":{value:"motionActivate",options:["off","on"],name:"detection activated"}},g=["motion"]);b.SMOKE_DETECTOR&&(h={"%smokeState%":{value:"smokeState",options:["on","off"],name:"alarm state"}},g=["smoke"]);b.ANALOG_OUTPUT_TRANSCEIVER&&
(f||(f={}),f["%dimOn%"]||(f["%dimOn%"]={value:"analogOutputTo",ext:100,name:"output to"}),f["%dimOff%"]||(f["%dimOff%"]={value:"analogOutputOff",name:"off"}),f["%dimUp%"]||(f["%dimUp%"]={value:"analogOutputUp",ext:5,name:"up"}),f["%dimDown%"]||(f["%dimDown%"]={value:"analogOutputDown",ext:5,name:"down"}),f["%dimTo%"]||(f["%dimTo%"]={value:"analogOutputTo",ext:"%d",extMeta:"0-100",name:"output to"}),h={"%dimmerState%":{value:"analogOutputLevel",ext:"%d",extMeta:"0-100",name:"output status"}},g=["dimmer"]);
return g&&0!=g.length?this._injectToSmartWidgetTemplate(c,g,d,f,h):null},_injectToSmartWidgetTemplate:function(a,c,d,b,e){var f=[];a||(b={});b||(b={});e||(e={});for(var h=0;h<a.length;h++){var g=a[h];if(g.meta&&-1!=c.indexOf(g.meta.type)&&g.elements){g=JSON.parse(JSON.stringify(g));var l=!1,k;for(k in g.elements){var n=g.elements[k];if(n&&Array.isArray(n))for(var q=0;q<n.length;q++){var p=n[q];if(p){if(p.action&&"command"==p.action.type&&p.action.ref&&p.action.ref.value){var t=p.action.ref.ext;b[p.action.ref.value]?
(p.action.ref=b[p.action.ref.value],t&&(p.action.ref.ext=t),p.action.device=d,l=!0):p.action=null}p.status&&p.status.ref&&p.status.ref.value&&(e[p.status.ref.value]?(p.status.ref=e[p.status.ref.value],p.status.device=d,l=!0):p.status=null)}}}l&&f.push(g)}}return f},toGeneralDevice:function(a,c){if(!a)return null;c={};for(e in a.channels){var d=e,b=d.indexOf(":");-1!=b&&(d=d.substr(0,b));c[d]=!0}var e=null;c.SWITCH&&(e={type:"switch",commands:{on:{},off:{},toggle:{}},states:{state:{values:["on","off"]}},
details:{commands:{on:{value:"on"},off:{value:"off"},toggle:{value:"toggle"}},states:{state:{value:"switchState"}}}});c.DIMMER&&(e={type:"dimmer",commands:{on:{},off:{},brightness:{value:{type:"INT",min:0,max:100,step:1}}},states:{brightness:{min:0,max:100,unit:"%"}},details:{commands:{on:{value:"dimTo",ext:100},off:{value:"dimOff"},brightness:{value:"dimTo",ext:"%d"}},states:{brightness:{value:"dimmerTLevel"}}}});c.BLIND&&(e={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",
min:0,max:100,step:1}}},states:{position:{min:0,max:100}},details:{commands:{up:{value:"blindUp"},down:{value:"blindDown"},stop:{value:"stop"},position:{value:"moveTo",ext:"%d"}},states:{position:{value:"blindLevel"}}}});c.JALOUSIE&&(e={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}},rotation:{value:{type:"INT",min:0,max:100,step:1}}},states:{position:{min:0,max:100},rotation:{min:0,max:100}},details:{commands:{up:{value:"jalUp"},down:{value:"jalDown"},
stop:{value:"jalStop"},position:{value:"jalRaw",ext:"%d"},rotation:{value:"jalLmlRaw",ext:"%d"}},states:{position:{value:"jalLevel"},rotation:{value:"jalLmlLevel"}}}});c.CLIMATECONTROL_REGULATOR&&(e={type:"heater",commands:{tempUp:{},tempDown:{},tempTo:{value:{type:"FLOAT",min:6,max:30,step:.5}}},states:{setpoint:{type:"FLOAT",min:6,max:30,step:.5,unit:"\u00b0C"},temperature:{type:"FLOAT"},humidity:{type:"INT"}},details:{commands:{tempUp:{value:"themoRTempUp"},tempDown:{value:"themoRTempDown"},tempTo:{value:"themoRTempRaw",
ext:"%f"}},states:{setpoint:{value:"themoRSetTemp"},temperature:{value:"weatherTemp"},humidity:{value:"weatherHum"}}}});c.THERMALCONTROL_TRANSMIT&&(e={type:"heater",commands:{tempUp:{},tempDown:{},tempTo:{value:{type:"FLOAT",min:4,max:30.5,step:.5}},auto:{},manu:{}},states:{setpoint:{type:"FLOAT",min:4,max:30.5,step:.5,unit:"\u00b0C"},temperature:{type:"FLOAT"},humidity:{type:"INT"}},details:{commands:{tempUp:{value:"themoTTempUp"},tempDown:{value:"themoTTempDown"},tempTo:{value:"themoTTempRaw",ext:"%f"},
auto:{value:"themoAutoMode"},manu:{value:"themoManuMode"}},states:{setpoint:{value:"themoTSetTemp"},temperature:{value:"themoTActualTemp"},humidity:{value:"themoTActualHum"},mode:{value:"themoTMode"}}}});c.CLIMATECONTROL_RT_TRANSCEIVER&&(e={type:"heater",commands:{tempUp:{},tempDown:{},tempTo:{value:{type:"FLOAT",min:4,max:30.5,step:.5}},auto:{},manu:{}},states:{setpoint:{type:"FLOAT",min:4,max:30.5,step:.5,unit:"\u00b0C"},temperature:{type:"FLOAT"},humidity:{type:"INT"}},details:{commands:{tempUp:{value:"themoTempUp"},
tempDown:{value:"themoTempDown"},tempTo:{value:"themoTempRaw",ext:"%f"},auto:{value:"themoAutoMode"},manu:{value:"themoManuMode"}},states:{setpoint:{value:"themoSetTemp"},temperature:{value:"themoActualTemp"},humidity:{value:"themoActualHum"},mode:{value:"themoMode"}}}});if("HmIP-WGC"==a.type)return null;c.SWITCH_VIRTUAL_RECEIVER&&(e={type:"switch",commands:{on:{},off:{},toggle:{}},states:{state:{values:["on","off"]}},details:{commands:{on:{value:"on"},off:{value:"off"},toggle:{value:"toggle"}},states:{state:{value:"switchState"}}}});
c.DIMMER_VIRTUAL_RECEIVER&&(e={type:"dimmer",commands:{on:{},off:{},brightness:{value:{type:"INT",min:0,max:100,step:1}}},states:{brightness:{min:0,max:100,unit:"%"}},details:{commands:{on:{value:"dimOn"},off:{value:"dimOff"},brightness:{value:"dimRaw",ext:"%d"}},states:{brightness:{value:"dimmerLevel"}}}});c.SHUTTER_VIRTUAL_RECEIVER&&(e={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}}},states:{position:{min:0,max:100}},details:{commands:{up:{value:"moveUp"},
down:{value:"moveDown"},stop:{value:"blindStop"},position:{value:"blindRaw",ext:"%d"}},states:{position:{value:"blindTLevel"}}}});c.BLIND_VIRTUAL_RECEIVER&&(e={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}},rotation:{value:{type:"INT",min:0,max:100,step:1}}},states:{position:{min:0,max:100},rotation:{min:0,max:100}},details:{commands:{up:{value:"moveUp"},down:{value:"moveDown"},stop:{value:"stop"},position:{value:"moveTo",ext:"%d"},rotation:{value:"lamellaTo",
ext:"%d"}},states:{position:{value:"blindTPos"},rotation:{value:"lamellaTPos"}}}});c.HEATING_CLIMATECONTROL_TRANSCEIVER&&(e={type:"heater",commands:{tempUp:{},tempDown:{},tempTo:{value:{type:"FLOAT",min:4,max:30.5,step:.5}},auto:{},manu:{}},states:{setpoint:{type:"FLOAT",min:4,max:30.5,step:.5,unit:"\u00b0C"},temperature:{type:"FLOAT"},humidity:{type:"INT"}},details:{commands:{tempUp:{value:"themoTempUp"},tempDown:{value:"themoTempDown"},tempTo:{value:"themoTemp",ext:"%f"},auto:{value:"themoTAutoMode"},
manu:{value:"themoTManuMode"}},states:{setpoint:{value:"themoTemp"},temperature:{value:"themoActualTemp"},humidity:{value:"themoHum"},mode:{value:"themoMode"}}}});return e}};xnm.aio.hm.Handler=function(){var a=require("x.logger.js");this._logger=a?a.getLogger("xnm.aio.hm.Handler"):{log:function(){}};xnm.aio.hm.Handler._logger=a?a.getLogger("xnm.aio.hm.Handler"):{log:function(){}}};
...
k.createSocket("udp4");n.on("listening",function(){n.setBroadcast(!0);var c=f.networkInterfaces(),g=[],h;for(h in c)for(var k=c[h],l=0;l<k.length;l++)"IPv4"==k[l].family&&0==k[l].internal&&g.push(k[l].address);var u=g.length;if(u)for(c=0;c<g.length;c++)d.call(e,n.address().port,g[c],function(c,d){u--;!c&&d&&b.push(d);u||a&&a(null,b)});else a&&a(null,b)});n.on("message",function(a,b){c.call(e,b,a)});n.bind(null)}else d.call(e,null,null,function(c,d){!c&&d&&b.push(d);a&&a(null,b)})}).call(this,function(a,
