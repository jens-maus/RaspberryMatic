...
if("BidCos-RF"==a["interface"]||"BidCos-Wired"==a["interface"]){var b=xnm.aio.hm.DM._getChannels(a);var e=xnm.aio.hm.MAP}else if("HmIP-RF"==a["interface"])b=xnm.aio.hm.DM._getHmIPChannels(a),e=xnm.aio.hm.HMIP_MAP;else if("CUxD"==a["interface"])b=xnm.aio.hm.DM._getCUxDChannels(a),e=xnm.aio.hm.CUxDMAP;else return null;var f=null,h=null,g=null,k;for(k in b){var l=b[k],n=e[k];if(n){for(var q in l)if(l=n[q]){if(l=d?l.command:l.status)for(var u=0;u<l.length;u++)if(l[u].ref.value==c){h=q;break}if(h)break}if(h){f=
k;break}}}if(!f||!h)return null;for(k in a.channels)if(k==f){c=a.address;d=c.indexOf(":");-1!=d&&(c=c.substr(0,d));g=c+":"+a.channels[k].address;break}return g?{"interface":a["interface"],channel:g,channelType:f,datapoint:h}:null},getStatesCreator:function(a,c,d){for(var b=[],e=[],f=null,h=this,g=[],k=[],l=[],n=0;n<c.length;n++){var q=c[n],u=q.id,r=q.status,t=q.device;if(u&&t&&r)if(!t.type&&t.ip)"serviceMsg"==r.value?g.push(q):"ccuTime"==r.value?k.push(q):"cloudmaticState"==r.value&&l.push(q);else switch(t.type){case xnm.aio.hm.DM.SYSVAR:if(!t["class"]||
!xnm.aio.hm.SysVar[t["class"].toUpperCase()])continue;(f=xnm.aio.hm.SysVar[t["class"].toUpperCase()].buildStateScript(this,t,r))&&b.push({alias:u,script:f,device:t,status:r});break;case xnm.aio.hm.DM.PROG:continue;default:if(t&&"BidCos-RF"==t["interface"]&&t.type&&xnm.aio.hm.BidCosDevice[t.type]){var x=xnm.aio.hm.BidCosDevice[t.type];if(x.buildStateScript&&(f=x.buildStateScript(this,t,r))){b.push({alias:u,script:f,device:t,channel:null,status:r});break}}if(t&&"HmIP-RF"==t["interface"]){if((x=xnm.aio.hm.HmIPDevice.resolveJSON(t))&&
x.getBufferedState&&(q=x.getBufferedState(this,t,r),null!=q&&"undefined"!=typeof q)){e.push({alias:u,state:q});break}if(x&&x.buildStateScript&&(f=x.buildStateScript(this,t,r))){b.push({alias:u,script:f,device:t,channel:null,status:r});break}}if(t&&"VirtualDevices"==t["interface"]&&t.type&&(q=xnm.aio.hm.VirtualDevice[t.type])&&(q=new q,q.buildStateScript&&(f=q.buildStateScript(this,t,r)))){b.push({alias:u,script:f,device:t,channel:null,status:r});break}if(t.channels){x=t.channels;for(var w in x)if(x.hasOwnProperty(w)){var m=
null;"CUxD"==t["interface"]?m=xnm.aio.hm.CUxDChannel[w]:"HmIP-RF"==t["interface"]||"HmIP-HEATING"==t.type?m=xnm.aio.hm.HmIPChannel[w]:"HM-Sec-Sir-WM"!=t.type||"SWITCH_SENSOR_1"!=w&&"SWITCH_SENSOR_2"!=w?"HM-WDS30-OT2-SM-2"!=t.type||"WEATHER_1"!=w&&"WEATHER_2"!=w&&"WEATHER_3"!=w&&"WEATHER_4"!=w||(m=xnm.aio.hm.Channel.WEATHER):m=xnm.aio.hm.Channel.SWITCH_SENSOR;m||(m=xnm.aio.hm.Channel[w]);if(m&&m.getBufferedState&&(q=m.getBufferedState(this._statebuffer,t,t.channels[w],r),null!=q&&"undefined"!=typeof q)){e.push({alias:u,
state:q});break}if(m&&m.buildStateScript&&(f=m.buildStateScript(this,t,t.channels[w],r))){b.push({alias:u,script:f,device:t,channel:w,status:r});break}}}}}this.getCloudmaticStatus(a,l,function(c,l){"undefined"!=typeof a&&null!=a&&"undefined"!=typeof a.reportStates&&null!=a.reportStates&&!c&&l&&0<l.length&&a.reportStates(null,l);h.getServiceMessageStatus(a,g,function(c,g){h.getCCUStatus(a,k,function(a,c){0===b.length?(a=h.resolveStateResponse([],[],e),c&&(a=a?a.concat(c):c),g&&(a=a?a.concat(g):g),
l&&(a=a?a.concat(l):l),d&&d(null,a||[])):(f=h.buildScript(b),h._doRequest(f,!0,function(a,f){var k=null;if(a)d&&d(a);else{a=f.indexOf("<states>");var m=f.lastIndexOf("</states");if(m>a+8)try{k=f.substring(a+8,m);k=xnm.aio.hm.Util.decodeXml(k);var n=k.split("\r@@@\n");k={};for(f=0;f<n.length;f++){var q=n[f].indexOf("=");if(0<q){var t=n[f].substr(0,q);k[t]=n[f].substr(q+1)}}k=h.resolveStateResponse(b,k,e);c&&(k=k?k.concat(c):c);g&&(k=k?k.concat(g):g);l&&(k=k?k.concat(l):l);d&&d(null,k)}catch(p){d&&
d(Error("response format error"))}else d&&d(Error("response format error"))}}))})})})},getDeviceList:function(a){this._logger.log("debug","get device list from ccu:"+this.ip);var c=this;this._getDevices(function(d,b){d?a&&a(d):c._getSysvars(function(d,f){d?a&&a(d):c._getProgs(function(d,e){if(d)a&&a(d);else{d={devices:[],sysvars:[],progs:[]};var g,h;b&&b.devices&&(g=c._parseDevices(b.devices))&&0<g.length&&(d.devices=d.devices.concat(g));if(f&&f.systemvars){var n=f.systemvars;for(h in n)if(n.hasOwnProperty(h)){a:{var q=
f.systemvars[h],u=h;if(q.valuetype){switch(q.valuetype){case "2":g="binary";break;case "4":g="float";break;case "16":g="integer";break;case "20":g="string";break;default:g=null;break a}var r={};r.sys=xnm.aio.hm.DM.SYS;r.id=q.name;r.type=xnm.aio.hm.DM.SYSVAR;r.address=u;r["class"]=g;g=r}else g=null}g&&d.sysvars.push(g)}}if(e&&e.progs)for(h in n=e.progs,n)n.hasOwnProperty(h)&&(g=e.progs[h],q=h,g.name?(u={},u.sys=xnm.aio.hm.DM.SYS,u.id=g.name,u.address=q,u.type=xnm.aio.hm.DM.PROG,g=u):g=null,g&&d.progs.push(g));
...
!0)}}if(0==c)return 0;for(var l in f)f.hasOwnProperty(l)&&(e+=1);return c>e?c:1}(a);if(0==h)return null;if(1<h&&"CUxD"!=a.interface)return e(a);h={};h.sys=xnm.aio.hm.DM.SYS;h.id=a.name;h.type=a.hsstype;h.address=a.address;h.rfAddr=a.rfAddr;h["interface"]=a["interface"];h.channels={};var g=a.channels,k=!1,l;for(l in g)if(g.hasOwnProperty(l)&&(e=a.channels[l],e.address)){var n=e.address.indexOf(":");if(-1!==n&&(n=e.address.substring(n+1),(0!=n||-1!=c.indexOf(a.hsstype))&&e.hsstype)){if("CUxD"==h["interface"]){if(!xnm.aio.hm.CUxDCHANNEL[e.hsstype]&&
!xnm.aio.hm.CHANNEL[e.hsstype])continue}else if(d(e.hsstype))continue;if(h.channels[e.hsstype]){var q=h.channels[e.hsstype];k=q.id;q=q.address;var u=b(h,e);u?e.hsstype=u:(-1==h.address.indexOf(":")&&1==Object.keys(h.channels).length&&(h.address=h.address+":"+h.channels[e.hsstype].address),"CUxD"==h["interface"]&&(u=xnm.aio.hm.MHMCCU._resolveCUxDType(h))&&(h.cuxd=u),h.id=k?k:q,f.push(h),h={},h.sys=xnm.aio.hm.DM.SYS,h.id=a.name,"CUxD"==a["interface"]&&e.name&&(h.id=e.name),h.type=a.hsstype,h.address=
a.address+":"+n,h["interface"]=a["interface"],h.channels={})}k=!0;n={id:e.name,address:n,room:e.room,group:e.func,datapoints:[]};var r;q=n.datapoints;if("CUxD"==h["interface"])n.datapoints=e.datapoints;else for(r in e.datapoints)e.datapoints.hasOwnProperty(r)&&(u=e.datapoints[r],u={name:u.name,valuetype:u.valuetype,operations:u.operations},q.push(u));h.channels[e.hsstype]=n}}k&&f.push(h);"CUxD"==h["interface"]&&(u=xnm.aio.hm.MHMCCU._resolveCUxDType(h))&&(h.cuxd=u);return f},getCloudmaticStatus:function(a,
...
"")+":"+(this.cloudmatic.password?this.cloudmatic.password:""))).toString("base64");var k=this,l="",n=require("http").request(c,function(a){200==a.statusCode?(a.setEncoding("binary"),a.on("data",function(a){l+=a}),a.on("end",function(){g&&g(null,l);g=null})):(k._logger.log("warn","Failed to post request to "+k.ip+" with status code:"+a.statusCode),g&&g(new TypeError("post request failed with status code:"+a.statusCode)),g=null)});n.setEncoding&&n.setEncoding("ISO-8859-1");if(n.setTimeout){c=6E4;if(null==
b||"undefined"==typeof b)b=0;b=parseInt(b);c=0<b?b:c;1E4>c&&(c=1E4);0<c&&n.setTimeout(c,function(){n.abort()})}if(n.on&&"function"==typeof n.on)n.on("error",function(a){a||(a=Error("http request error"));g&&g(a);g=null});n.write(a);n.end()}else d&&d(Error("cloudmatic config invalid"))}};
...
case "stepUp":b=null==b.ext||"undefined"==typeof b.ext?.05:"number"==typeof b.ext?(parseInt(b.ext)/100).toFixed(2):b.ext.match(/^[-+]?[0-9]+$/)?(parseInt(b.ext)/100).toFixed(2):.05;a._statebuffer&&(e=this.getBufferedState(a._statebuffer,c,d,{value:"blindPos"}));e=null==e||"undefined"==typeof e?"if(o!=null){var v=o.Value()+"+b+";if(v>1){v=1.0;}o.State(v);}\n":"if(o!=null){var v="+e/100+"+"+b+";if(v>1){v=1.0;}o.State(v);}\n";a="LEVEL";break;case "stepDown":b=null==b.ext||"undefined"==typeof b.ext?.05:
"number"==typeof b.ext?(parseInt(b.ext)/100).toFixed(2):b.ext.match(/^[-+]?[0-9]+$/)?(parseInt(b.ext)/100).toFixed(2):.05;a._statebuffer&&(e=this.getBufferedState(a._statebuffer,c,d,{value:"blindPos"}));e=null==e||"undefined"==typeof e?"if(o!=null){var v=o.Value()-"+b+";if(v<0){v=0.0;}o.State(v);}\n":"if(o!=null){var v="+e/100+"-"+b+";if(v<0){v=0.0;}o.State(v);}\n";a="LEVEL";break;case "moveTo":if(null==b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)b=parseInt(b.ext);else if(b.ext.match(/^[-+]?[0-9]+$/))b=
b.ext;else return null;a="LEVEL";b/=100;b=0>b?0:b;e="if(o!=null){o.State("+(1<b?1:b)+");}\n";break;case "lamellaStepUp":return b=null==b.ext||"undefined"==typeof b.ext?.05:"number"==typeof b.ext?(parseInt(b.ext)/100).toFixed(2):b.ext.match(/^[-+]?[0-9]+$/)?(parseInt(b.ext)/100).toFixed(2):.05,e='var s=dom.GetObject("'+c["interface"]+"."+c.address+":"+(d.stateAddress?d.stateAddress:d.address)+'.LEVEL");\n',e+='var o=dom.GetObject("'+c["interface"]+"."+c.address+":"+d.address+'.LEVEL_2");\n',e=e+("if(o!=null){var v=o.Value()+"+
b+';if(v>1){v=1.0;}o.State(v);}\no=dom.GetObject("')+(c["interface"]+"."+c.address+":"+d.address+'.LEVEL");\n'),e+'if(o!=null){o.State(s.Value());}\no="";s="";\n';case "lamellaStepDown":return b=null==b.ext||"undefined"==typeof b.ext?.05:"number"==typeof b.ext?(parseInt(b.ext)/100).toFixed(2):b.ext.match(/^[-+]?[0-9]+$/)?(parseInt(b.ext)/100).toFixed(2):.05,e='var s=dom.GetObject("'+c["interface"]+"."+c.address+":"+(d.stateAddress?d.stateAddress:d.address)+'.LEVEL");\n',e+='var o=dom.GetObject("'+
c["interface"]+"."+c.address+":"+d.address+'.LEVEL_2");\n',e=e+("if(o!=null){var v=o.Value()-"+b+';if(v<0){v=0.0;}o.State(v);}\no=dom.GetObject("')+(c["interface"]+"."+c.address+":"+d.address+'.LEVEL");\n'),e+'if(o!=null){o.State(s.Value());}\no="";s="";\n';case "lamellaTo":if(null==b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)b=parseInt(b.ext);else if(b.ext.match(/^[-+]?[0-9]+$/))b=b.ext;else return null;b/=100;b=0>b?0:b;e='var s=dom.GetObject("'+c["interface"]+"."+c.address+
":"+(d.stateAddress?d.stateAddress:d.address)+'.LEVEL");\n';e+='var o=dom.GetObject("'+c["interface"]+"."+c.address+":"+d.address+'.LEVEL_2");\n';e=e+("if(o!=null){o.State("+(1<b?1:b)+');}\no=dom.GetObject("')+(c["interface"]+"."+c.address+":"+d.address+'.LEVEL");\n');return e+'if(o!=null){o.State(s.Value());}\no="";s="";\n';default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,e)},handleCommandResponse:function(a,c,d,b,e){var f=c.address;if(c.channels&&c.channels.BLIND_TRANSMITTER)var h=
c.channels.BLIND_TRANSMITTER.address;if(f&&h)if("moveTo"==d.value)c="LEVEL",b=parseFloat(d.ext),a._statebuffer[f+":"+h+"."+c]={value:b,timestamp:(new Date).getTime()};else if("lamellaTo"==d.value)c="LEVEL_2",b=parseFloat(d.ext),a._statebuffer[f+":"+h+"."+c]={value:b,timestamp:(new Date).getTime()};else if("stepUp"==d.value||"stepDown"==d.value){if(c="LEVEL",b){d=b.indexOf("<v>");var g=b.indexOf("</v>");-1!=d&&-1!=g&&d+3<g&&(b=b.substr(d+3,g-d-3))&&(b=Math.round(100*parseFloat(b)),a._statebuffer[f+
":"+h+"."+c]={value:b,timestamp:(new Date).getTime()})}}else if("lamellaStepUp"==d.value||"lamellaStepDown"==d.value)if(c="LEVEL_2",b&&(d=b.indexOf("<v>"),g=b.indexOf("</v>"),-1!=d&&-1!=g&&d+3<g&&(b=b.substr(d+3,g-d-3))))b=Math.round(100*parseFloat(b)),a._statebuffer[f+":"+h+"."+c]={value:b,timestamp:(new Date).getTime()};e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "blindPos":var e="LEVEL";break;case "lamellaPos":e="LEVEL_2"}return c&&d&&e&&a?(b=a[c+":"+
d+"."+e],b&&null!=b.value&&"undefined"!=typeof b.value?3E3<=(new Date).getTime()-b.timestamp?(delete a[c+":"+d+"."+e],null):b.value:null):null},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "blindPos":a="LEVEL";break;case "lamellaPos":a="LEVEL_2";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "blindPos":return a=parseFloat(a),Math.round(100*a);case "lamellaPos":return a=
parseFloat(a),Math.round(100*a);default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "LEVEL":var b="blindPos";break;case "LEVEL_2":b="lamellaPos"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},BLIND_WEEK_PROFILE:{buildCommandScript:function(a,c,d,b){if(!(c.channels&&d&&d.address&&b.value))return null;var e;switch(b.value){case "setProfile":if(!b.ext)return null;a=e=null;for(var f=0;f<b.ext.length;f++){var h=b.ext[f];if(h)switch(h.value){case "mode":e=
h.ext;break;case "channels":a=h.ext}}if("undefined"==typeof e||null==e||"undefined"==typeof a||null==a)return null;b=2;"manu"==e&&(b=0);e='var o;o=dom.GetObject("'+(c["interface"]+"."+c.address+":"+d.address+'.WEEK_PROGRAM_TARGET_CHANNEL_LOCKS");\n');e=e+("if(o!=null){o.State("+a+');}\no=dom.GetObject("')+(c["interface"]+"."+c.address+":"+d.address+'.WEEK_PROGRAM_TARGET_CHANNEL_LOCK");\n');e+="if(o!=null){o.State("+parseInt(b)+");}\n";return e+'o="";\n';default:return null}},buildStateScript:function(a,
c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "profile":break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,"WEEK_PROGRAM_CHANNEL_LOCKS")},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "profile":return parseInt(a);default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "WEEK_PROGRAM_CHANNEL_LOCKS":var b="profile"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},PRESENCEDETECTOR_TRANSCEIVER:{buildCommandScript:function(a,
c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "presenceOn":a="PRESENCE_DETECTION_ACTIVE";b="if(o!=null){o.State(1);}\n";break;case "presenceOff":a="PRESENCE_DETECTION_ACTIVE";b="if(o!=null){o.State(0);}\n";break;case "presenceToggle":a="PRESENCE_DETECTION_ACTIVE";b="if(o!=null){if(o.Value()){o.State(0);}else{o.State(1);}}\n";break;case "presenceReset":a="RESET_PRESENCE";b="if(o!=null){o.State(1);}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},
...
"FROST_PROTECTION";break;case "cl_f_state":a="STATE";break;case "cl_valve_level":a="LEVEL";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "cl_f_humidityLimiter":case "cl_f_emergencyOP":case "cl_f_frostProtection":return a;case "cl_f_state":return"true"==a?"on":"off";case "cl_valve_level":return 100*parseFloat(a);default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "HUMIDITY_LIMITER":var b=
"cl_f_humidityLimiter";break;case "EMERGENCY_OPERATION":b="cl_f_emergencyOP";break;case "FROST_PROTECTION":b="cl_f_frostProtection";break;case "STATE":b="cl_f_state";break;case "LEVEL":b="cl_valve_level"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},WEATHER_TRANSMIT:{buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "weatherActualTemp":a="ACTUAL_TEMPERATURE";break;case "weatherHum":a="HUMIDITY";break;case "weatherIllu":a=
"ILLUMINATION";break;case "weatherSunD":a="SUNSHINEDURATION";break;case "weatherSunDOF":a="SUNSHINEDURATION_OVERFLOW";break;case "weatherSunTOR":a="SUNSHINE_THRESHOLD_OVERRUN";break;case "weatherWindS":a="WIND_SPEED";break;case "weatherWindTOR":a="WIND_THRESHOLD_OVERRUN";break;case "weatherRain":a="RAINING";break;case "weatherRainC":a="RAIN_COUNTER";break;case "weatherRainCOF":a="RAIN_COUNTER_OVERFLOW";break;case "weatherWindD":a="WIND_DIR";break;case "weatherWindDR":a="WIND_DIR_RANGE";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,
d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "weatherActualTemp":case "weatherIllu":case "weatherWindS":case "weatherRainC":case "weatherWindD":case "weatherWindDR":return parseFloat(parseFloat(a).toFixed(1));case "weatherHum":case "weatherSunD":return parseInt(a);case "weatherSunDOF":case "weatherSunTOR":case "weatherWindTOR":case "weatherRain":case "weatherRainCOF":return a;default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "ACTUAL_TEMPERATURE":var b=
"weatherActualTemp";break;case "HUMIDITY":b="weatherHum";break;case "ILLUMINATION":b="weatherIllu";break;case "SUNSHINEDURATION":b="weatherSunD";break;case "SUNSHINEDURATION_OVERFLOW":b="weatherSunDOF";break;case "SUNSHINE_THRESHOLD_OVERRUN":b="weatherSunTOR";break;case "WIND_SPEED":b="weatherWindS";break;case "WIND_THRESHOLD_OVERRUN":b="weatherWindTOR";break;case "RAINING":b="weatherRain";break;case "RAIN_COUNTER":b="weatherRainC";break;case "RAIN_COUNTER_OVERFLOW":b="weatherRainCOF";break;case "WIND_DIR":b=
"weatherWindD";break;case "WIND_DIR_RANGE":b="weatherWindDR"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},CLIMATE_TRANSCEIVER:{buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "climateActualTemp":a="ACTUAL_TEMPERATURE";break;case "climateHum":a="HUMIDITY";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "climateActualTemp":return parseFloat(parseFloat(a).toFixed(1));
...
case "acousticDurUnit":var l=f.ext;break;case "acousticRepeat":var n=parseInt(f.ext)}}if("undefined"==typeof h||null==h||"undefined"==typeof g||null==g||"undefined"==typeof k||null==k||"undefined"==typeof l||null==l||"undefined"==typeof n||null==n)return null;"acousticPlay"==b.value?a.push(h):a=h.split(",");l=["S","M","H","10MS"].indexOf(l);g/=100;break;default:return null}if(0==a.length)return null;b="";h=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"DURATION_UNIT");b+='(datapoints.Get("'+h+'")).State('+
...
switch(b.value){case "setLine":if(!b.ext)return null;for(a=0;a<b.ext.length;a++){var e=b.ext[a];if(e)switch(e.value){case "line":var f=e.ext;break;case "text":var h=e.ext;break;case "textAlign":var g=e.ext;break;case "textColor":var k=e.ext;break;case "bgColor":var l=e.ext;break;case "icon":var n=parseInt(e.ext)}}if(!(f&&g&&k&&l)||isNaN(n))return null;g=g.toUpperCase();k=k.toUpperCase();l=l.toUpperCase();b="{DDBC="+l+",DDTC="+k+",DDI="+n+",DDA="+g+",DDS="+h+",DDID="+f+",DDC=true}";f="";c=xnm.aio.hm.MHMCCU._getDataPointAddress(c,
d,"COMBINED_PARAMETER");return f+('dom.GetObject("'+c+'").State("'+b+'");\n');case "setSound":if(!b.ext)return null;for(a=0;a<b.ext.length;a++)if(e=b.ext[a])switch(e.value){case "sound":var q=parseInt(e.ext);break;case "repeat":var u=parseInt(e.ext);break;case "interval":var r=parseInt(e.ext)}if(isNaN(q)||isNaN(u)||isNaN(r))return null;b="{R="+u+",IN="+r+",ANS="+q+"}";f="";c=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"COMBINED_PARAMETER");return f+('dom.GetObject("'+c+'").State("'+b+'");\n');default:return null}}}};
...
default:var c=!1,b=[],e=["DIMMER","VIRTUAL_DIMMER"],f;for(f in a.channels){var h=a.channels[f];h&&h.hsstype&&-1!=e.indexOf(h.hsstype)&&(-1==b.indexOf(h.hsstype)?b.push(h.hsstype):c=!0)}return 0<b.length?this._parseDevice(a,b,c):null}},_parseDevice:function(a,d,b){var c=[],f=null,h=null,g;for(g in a.channels){var k=a.channels[g];if(k&&k.address&&k.hsstype){var l=k.address.indexOf(":");if(-1!==l){var n=k.address.substring(l+1),q={id:k.name,address:n,room:k.room,group:k.func,datapoints:[]};0==n&&(f=
k.hsstype,h=q);if(-1!=d.indexOf(k.hsstype))if(l=this._parseGeneralInfo(a),l.channels[k.hsstype]=q,b)l.id+=":"+n,l.address+=":"+n,c.push(l);else{c.push(l);break}}}}if(h&&f)for(a=0;a<c.length;a++)(l=c[a])&&(l.channels[f]=h);return c},_parseHMSecSirWM:function(a){this._parseGeneralInfo(a);var c={};c.sys=xnm.aio.hm.DM.SYS;c.id=a.name;c.type=a.hsstype;c.address=a.address;c.rfAddr=a.rfAddr;c["interface"]=a["interface"];c.channels={};var b=a.channels,e;for(e in b)if(b.hasOwnProperty(e)){var f=a.channels[e];
...
c);else if("btn"==c.value.substr(0,3)){var v=c.value.indexOf("press"),f=c.value.substr(3,v);f=parseInt(f);-1!=this._chKeyTransceivers.indexOf(f)&&(e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.buildCommandScript(a,b,{address:f},{value:c.value.substr(v)}))}e?a._doRequestMarked(e,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};a.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=
...
b,c))a=d.profile,"?"!=a&&(d.profile=a>>3*this._switchIdx&1?"manu":"auto")}return d};a.parseJSON=function(b,c,d){if(!b||!b.type||!b.channels)return null;var e=new a;e._type=b.type;e._address=b.address;var v=e._chSwitchWeekProfile=0,f;for(f in b.channels)"SWITCH_TRANSMITTER"==f.substr(0,18)?e._chSwitchTransmitter=parseInt(b.channels[f].address):"SWITCH_VIRTUAL_RECEIVER"==f.substr(0,23)?(v++,1==v?e._chSwitchVirtualReceiver1=parseInt(b.channels[f].address):2==v?e._chSwitchVirtualReceiver2=parseInt(b.channels[f].address):
3==v&&(e._chSwitchVirtualReceiver3=parseInt(b.channels[f].address))):"SWITCH_WEEK_PROFILE"==f.substr(0,19)&&(e._chSwitchWeekProfile=parseInt(b.channels[f].address));if(c&&d&&e._chSwitchTransmitter){b=[];for(v=0;v<d;v++)b.push(c+4*v);c=b.indexOf(e._chSwitchTransmitter);-1!=c&&(e._switchIdx=c)}return e};return a}(),d=function(){var a=function(){this._dimmerIdx=0;this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=null;this._chDimmerTransmitter=1;this._chDimmerVirtualReceiver1=
...
a.prototype.getIPEvtMap=function(){return{ipevt:this._getCommonMap().status}};a.prototype.useStateBuffer=function(){return"HmIPW-DRD"==this._type.substr(0,9)||"HmIP-DRDI"==this._type.substr(0,9)?!0:!1};a.prototype.executeCommand=function(a,b,c,d){if(c){var e={value:c.value,ext:c.ext},v=this._chDimmerVirtualReceiver1;if("ch"==c.value.substr(0,2)){var f=c.value.indexOf("dim");-1==f&&(f=c.value.indexOf("toggle"));if(-1==f){d&&d(Error("invalid command"));return}v=parseInt(c.value.substr(2,f));e.value=
c.value.substr(f);if(v!=this._chDimmerVirtualReceiver1&&v!=this._chDimmerVirtualReceiver2&&v!=this._chDimmerVirtualReceiver3){d&&d(Error("invalid command"));return}}f=null;var p={interface:b.interface,address:this.getAddress(),channels:b.channels};"setProfile"==c.value?this._chDimmerWeekProfile&&(e={value:"setProfile",ext:[{value:"mode",ext:c.ext},{value:"channels",ext:1<<3*this._dimmerIdx}]},f=xnm.aio.hm.HmIPChannel.DIMMER_WEEK_PROFILE.buildCommandScript(a,p,{address:this._chDimmerWeekProfile},e)):
f=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(a,p,{address:v},e);if(f){var L=this;a._doRequestMarked(f,!0,{execute:function(e,v){e||L._handleCommandResponse(a,b,c,v);d&&d(e)}})}else d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};a.prototype._handleCommandResponse=function(a,b,c,d){if(this.useStateBuffer()){b=null;var e=d.indexOf("<v>");if(-1!=e){var v=d.indexOf("</v>");-1!=v&&(d=d.substring(e+3,v),b=Math.round(100*parseFloat(d)))}d=this.getAddress()+":"+
...
xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case this._chBlindTransmitter:d=xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.resolveState(a,b,c);break;case this._chBlindWeekProfile:if(d=xnm.aio.hm.HmIPChannel.BLIND_WEEK_PROFILE.resolveState(a,b,c))a=d.profile,"?"!=a&&(d.profile=a>>3*this._blindIdx&1?"manu":"auto")}return d};a.parseJSON=function(b,c,d){if(!b||!b.type||!b.channels)return null;var e=new a;e._type=b.type;e._address=b.address;var f=e._chBlindWeekProfile=0,v;for(v in b.channels)"BLIND_TRANSMITTER"==
v.substr(0,17)?e._chBlindTransmitter=parseInt(b.channels[v].address):"BLIND_VIRTUAL_RECEIVER"==v.substr(0,22)?(f++,1==f?e._chBlindVirtualReceiver1=parseInt(b.channels[v].address):2==f?e._chBlindVirtualReceiver2=parseInt(b.channels[v].address):3==f&&(e._chBlindVirtualReceiver3=parseInt(b.channels[v].address))):"BLIND_WEEK_PROFILE"==v.substr(0,18)&&(e._chBlindWeekProfile=parseInt(b.channels[v].address));if(c&&d&&e._chBlindTransmitter){b=[];for(f=0;f<d;f++)b.push(c+4*f);c=b.indexOf(e._chBlindTransmitter);
...
return c};return a}(),n=function(){};n.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}},{type:"enum",name:"ch.4 on",ref:{value:"ch4on"}},{type:"enum",name:"ch.4 off",ref:{value:"ch4off"}},{type:"enum",name:"ch.4 toggle",ref:{value:"ch4toggle"}},{type:"enum",name:"ch.5 on",ref:{value:"ch5on"}},{type:"enum",name:"ch.5 off",ref:{value:"ch5off"}},{type:"enum",name:"ch.5 toggle",
ref:{value:"ch5toggle"}},{type:"enum",name:"ch.6 on",ref:{value:"ch6on"}},{type:"enum",name:"ch.6 off",ref:{value:"ch6off"}},{type:"enum",name:"ch.6 toggle",ref:{value:"ch6toggle"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"switch status",ref:{value:"switchState",options:["off","on"]}},{type:"enum",name:"ch.4 status",ref:{value:"ch4State",options:["off","on"]}},{type:"enum",name:"ch.5 status",ref:{value:"ch5State",options:["off",
"on"]}},{type:"enum",name:"ch.6 status",ref:{value:"ch6State",options:["off","on"]}},{type:"float",name:"voltage",ref:{value:"meterVoltage",extMeta:"0.0-409.5",scale:"0.1",unit:"V"}},{type:"float",name:"energy counter",ref:{value:"meterEnergyCounter",extMeta:"0.0-838859.1",scale:"0.1",unit:"Wh"}},{type:"float",name:"frequency",ref:{value:"meterFrequency",extMeta:"29.52-70.47",scale:"0.01",unit:"Hz"}},{type:"float",name:"power",ref:{value:"meterPower",extMeta:"0.0-163830.0",scale:"0.1",unit:"W"}},
{type:"float",name:"current",ref:{value:"meterCurrent",extMeta:"0.0-65535.0",scale:"0.1",unit:"mA"}}]}};n.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;return{ipevt:JSON.parse(JSON.stringify(a))}};n.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;switch(c.value){case "on":case "ch4on":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:4},{value:"on"});break;case "off":case "ch4off":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,
...
q.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "dimmerTLevel":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(a,{value:"dimmerTLevel"});case "ch4Level":case "ch5Level":case "ch6Level":return xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.handleStatusResponse(a,{value:"dimmerLevel"});default:return"?"}};q.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;
var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "3":e=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.resolveState(a,b,c);break;case "4":case "5":case "6":e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.resolveState(a,b,c),e.key="4"==d?"ch4Level":"5"==d?"ch5Level":"ch6Level"}return e};var u=function(){};u.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",
name:"battery low",ref:{value:"errorBat",options:["false","true"]}}]}};u.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false","true"]}},{type:"enum",name:"button 1 short press",ref:{value:"btn1pressShort",options:["true"]}},{type:"enum",name:"button 1 long press",ref:{value:"btn1pressLong",options:["true"]}},{type:"enum",name:"button 2 short press",
ref:{value:"btn2pressShort",options:["true"]}},{type:"enum",name:"button 2 long press",ref:{value:"btn2pressLong",options:["true"]}}]}};u.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c)}return d};u.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,
b);default:return"?"}};u.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":case "2":e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c),"pressShort"==e.key?e.key="1"==d?"btn1pressShort":"btn2pressShort":"pressLong"==e.key&&(e.key="1"==d?"btn1pressLong":"btn2pressLong")}return e};var r=function(){};
r.prototype.getCommandStatusMap=function(){return{command:[{type:"multi",name:"trigger alarm",ref:{value:"alarmTrigger",ext:"%multi",extMeta:[{type:"enum",name:"set audio",ref:{value:"alarmAudio",ext:"%e",extMeta:"DISABLE_ACOUSTIC_SIGNAL FREQUENCY_RISING FREQUENCY_FALLING FREQUENCY_RISING_AND_FALLING FREQUENCY_ALTERNATING_LOW_HIGH FREQUENCY_ALTERNATING_LOW_MID_HIGH FREQUENCY_HIGHON_OFF FREQUENCY_HIGHON_LONGOFF FREQUENCY_LOWON_OFF_HIGHON_OFF FREQUENCY_LOWON_LONGOFF_HIGHON_LONGOFF LOW_BATTERY DISARMED INTERNALLY_ARMED EXTERNALLY_ARMED DELAYED_INTERNALLY_ARMED DELAYED_EXTERNALLY_ARMED EVENT ERROR".split(" ")}},
...
ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"sabotage",ref:{value:"errorSabo",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"alarmState",options:["on","off"]}}]}};r.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false",
"true"]}},{type:"enum",name:"sabotage",ref:{value:"errorSabo",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"alarmState",options:["on","off"]}}]}};r.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;switch(c.value){case "alarmTrigger":e=xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:3},c)}e?a._doRequestMarked(e,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};
r.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":case "errorSabo":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "alarmState":d=xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:3},c)}return d};r.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":case "errorSabo":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,
b);case "alarmState":return xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.handleStatusResponse(a,b);default:return"?"}};r.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "3":e=xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.resolveState(a,b,c)}return e};var t=function(){};t.prototype.getCommandStatusMap=
...
"primary_alarm","intrusion_alarm","secondary_alarm"]}}]}};t.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"smokeState",options:["on","off"]}},{type:"enum",name:"alarm detail",ref:{value:"smokeAlarmDetail",options:["off","primary_alarm","intrusion_alarm","secondary_alarm"]}}]}};t.prototype.executeCommand=
function(a,b,c,d){if(c){var e=null;switch(c.value){case "intrusionAlarmOff":case "intrusionAlarmOn":e=xnm.aio.hm.HmIPChannel.SMOKE_DETECTOR.buildCommandScript(a,b,{address:1},c)}e?a._doRequestMarked(e,!0,{execute:function(a){d&&d(a)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};t.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;
case "smokeState":d=xnm.aio.hm.HmIPChannel.SMOKE_DETECTOR.buildStateScript(a,b,{address:3},c)}return d};t.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "smokeState":case "smokeAlarmDetail":return xnm.aio.hm.HmIPChannel.SMOKE_DETECTOR.handleStatusResponse(a,b);default:return"?"}};t.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");
if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.SMOKE_DETECTOR.resolveState(a,b,c)}return e};var x=function(){};x.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"sabotage",ref:{value:"errorSabo",
options:["false","true"]}},{type:"enum",name:"window state",ref:{value:"handleState",options:["closed","tilted","open"]}}]}};x.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false","true"]}},{type:"enum",name:"sabotage",ref:{value:"errorSabo",options:["false","true"]}},{type:"enum",name:"window state",ref:{value:"handleState",options:["closed",
"tilted","open"]}}]}};x.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":case "errorSabo":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "handleState":d=xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.buildStateScript(a,b,{address:1},c)}return d};x.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":case "errorSabo":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,
b);case "handleState":return xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.handleStatusResponse(a,b);default:return"?"}};x.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.resolveState(a,b,c)}return e};var w=function(){};w.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",
...
{value:"switchState"});default:return"?"}};w.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "1":e=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.resolveState(a,b,c);break;case "2":case "3":case "4":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.resolveState(a,b,c);e.key="2"==d?"ch2State":"3"==d?"ch3State":"ch4State";break;case "5":e=xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.resolveState(a,
b,c)}return e};var m=function(){};m.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"dimOn"}},{type:"enum",name:"off",ref:{value:"dimOff"}},{type:"int",name:"dim up",ref:{value:"dimUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"dim down",ref:{value:"dimDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"dim to",ref:{value:"dimTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"toggle to",ref:{value:"toggleTo",ext:"%d",extMeta:"0-100",
...
{type:"int",name:"dimmer status",ref:{value:"dimmerTLevel",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.3 status",ref:{value:"ch3Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.4 status",ref:{value:"ch4Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.5 status",ref:{value:"ch5Level",extMeta:"0-100",unit:"%"}}]}};m.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;return{ipevt:JSON.parse(JSON.stringify(a))}};m.prototype.executeCommand=function(a,b,c,d){if(c){var e=
...
5}e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:f},{value:"toggleTo",ext:c.ext})}e?a._doRequestMarked(e,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};m.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "dimmerTLevel":d=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.buildStateScript(a,
b,{address:2},{value:"dimmerTLevel"});break;case "ch3Level":d=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:3},{value:"dimmerLevel"});break;case "ch4Level":d=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:4},{value:"dimmerLevel"});break;case "ch5Level":d=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:5},{value:"dimmerLevel"})}return d};m.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,
b);case "dimmerTLevel":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(a,{value:"dimmerTLevel"});case "ch3Level":case "ch4Level":case "ch5Level":return xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.handleStatusResponse(a,{value:"dimmerLevel"});default:return"?"}};m.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "2":e=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.resolveState(a,
b,c);break;case "3":case "4":case "5":e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.resolveState(a,b,c),e.key="3"==d?"ch3Level":"4"==d?"ch4Level":"ch5Level"}return e};var y=function(){};y.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"stop",ref:{value:"stop"}},{type:"enum",name:"move up",ref:{value:"moveUp"}},{type:"enum",name:"move down",ref:{value:"moveDown"}},{type:"int",name:"step up",ref:{value:"stepUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"step down",
...
ref:{value:"errorComm",options:["false","true"]}},{type:"int",name:"blind status",ref:{value:"blindTLevel",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.4 status",ref:{value:"ch4Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.5 status",ref:{value:"ch5Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.6 status",ref:{value:"ch6Level",extMeta:"0-100",unit:"%"}}]}};y.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;a=JSON.parse(JSON.stringify(a));a=a.concat([{type:"enum",
name:"button 1 short press",ref:{value:"btn1pressShort",options:["true"]}},{type:"enum",name:"button 1 long press",ref:{value:"btn1pressLong",options:["true"]}},{type:"enum",name:"button 2 short press",ref:{value:"btn2pressShort",options:["true"]}},{type:"enum",name:"button 2 long press",ref:{value:"btn2pressLong",options:["true"]}}]);return{ipevt:a}};y.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;e=4;var f=null;-1!=c.value.indexOf("ch5")?e=5:-1!=c.value.indexOf("ch6")&&(e=6);-1!=c.value.indexOf("stop")?
...
z.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "blindTPos":return xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.handleStatusResponse(a,{value:"blindTPos"});case "lamellaTPos":return xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.handleStatusResponse(a,{value:"lamellaTPos"});case "ch4blindPos":case "ch5blindPos":case "ch6blindPos":return xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.handleStatusResponse(a,
{value:"blindPos"});case "ch4lamellaPos":case "ch5lamellaPos":case "ch6lamellaPos":return xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.handleStatusResponse(a,{value:"lamellaPos"});default:return"?"}};z.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "1":case "2":if(e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c))"pressShort"==e.key?e.key="btn"+d+"pressShort":"pressLong"==
e.key&&(e.key="btn"+d+"pressLong");break;case "3":e=xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.resolveState(a,b,c);break;case "4":case "5":case "6":if(e=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.resolveState(a,b,c))"LEVEL"==b.datapoint?e.key="4"==d?"ch4blindPos":"5"==d?"ch5blindPos":"ch6blindPos":"LEVEL_2"==b.datapoint&&(e.key="4"==d?"ch4lamellaPos":"5"==d?"ch5lamellaPos":"ch6lamellaPos")}return e};var D=function(){};D.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",
ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}}]}};D.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false","true"]}},{type:"enum",name:"button 1 short press",ref:{value:"btn1pressShort",options:["true"]}},{type:"enum",name:"button 1 long press",ref:{value:"btn1pressLong",
...
options:["true"]}},{type:"enum",name:"button 5 short press",ref:{value:"btn5pressShort",options:["true"]}},{type:"enum",name:"button 5 long press",ref:{value:"btn5pressLong",options:["true"]}},{type:"enum",name:"button 6 short press",ref:{value:"btn6pressShort",options:["true"]}},{type:"enum",name:"button 6 long press",ref:{value:"btn6pressLong",options:["true"]}}]}};D.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,
b,{address:0},c)}return d};D.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);default:return"?"}};D.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":case "2":case "3":case "4":case "5":case "6":e=
xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c),"pressShort"==e.key?e.key="btn"+d+"pressShort":"pressLong"==e.key&&(e.key="btn"+d+"pressLong")}return e};var E=function(){};E.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"passages detected",ref:{value:"passageCurrentDirection",options:["right_to_left",
...
ref:{value:"passageR2LCOF",options:["false","true"]}}]}};E.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"passages detected",ref:{value:"passageCurrentDirection",options:["right_to_left","left_to_right"]}},{type:"enum",name:"previous passage",ref:{value:"passageLastDirection",options:["right_to_left","left_to_right"]}},
{type:"int",name:"passage count from left to right",ref:{value:"passageL2RC",extMeta:"0-127"}},{type:"enum",name:"passage count overflow from left to right",ref:{value:"passageL2RCOF",options:["false","true"]}},{type:"int",name:"passage count from right to left",ref:{value:"passageR2LC",extMeta:"0-127"}},{type:"enum",name:"passage count overflow from right to left",ref:{value:"passageR2LCOF",options:["false","true"]}}]}};E.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=
...
E.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "2":case "3":e=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.resolveState(a,b,c),"passageCurrentDirection"==e.key?e.key="passageCurrentDirection":"passageLastDirection"==e.key?e.key="passageLastDirection":"passageC"==e.key?e.key="2"==d?"passageR2LC":
"passageL2RC":"passageCOF"==e.key&&(e.key="2"==d?"passageR2LCOF":"passageL2RCOF")}return e};var F=function(){};F.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"waterAlarmState",options:["on","off"]}},{type:"enum",name:"moisture detected",ref:{value:"waterMoistureDetected",options:["true",
"false"]}},{type:"enum",name:"water detected",ref:{value:"waterWaterDetected",options:["true","false"]}}]}};F.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"waterAlarmState",options:["on","off"]}},{type:"enum",name:"moisture detected",ref:{value:"waterMoistureDetected",options:["true",
"false"]}},{type:"enum",name:"water detected",ref:{value:"waterWaterDetected",options:["true","false"]}}]}};F.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "waterAlarmState":d=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.buildStateScript(a,b,{address:1},{value:"waterAlarmState"});break;case "waterMoistureDetected":d=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.buildStateScript(a,
b,{address:1},{value:"waterMoistureDetected"});break;case "waterWaterDetected":d=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.buildStateScript(a,b,{address:1},{value:"waterWaterDetected"})}return d};F.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "waterAlarmState":case "waterMoistureDetected":case "waterWaterDetected":return xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.handleStatusResponse(a,
b);default:return"?"}};F.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.resolveState(a,b,c)}return e};var G=function(){};G.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false",
...
options:["false","true"]}}]}};G.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false","true"]}},{type:"int",name:"error code",ref:{value:"errorBatElCode",ext:"%d",extMeta:"0-255"}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0-25.2"}},{type:"enum",name:"sensor error",ref:{value:"errorBatElSensor",
options:["false","true"]}},{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"motion",ref:{value:"acceMotion",options:["false","true"]}}]}};G.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorBatElDutyCycle":case "errorBatElCode":case "errorBatElBat":case "errorBatElVoltage":case "errorBatElSensor":case "errorBatElComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,b,{address:0},
c);break;case "acceMotion":d=xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.buildStateScript(a,b,{address:1},c)}return d};G.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorBatElDutyCycle":case "errorBatElCode":case "errorBatElBat":case "errorBatElVoltage":case "errorBatElSensor":case "errorBatElComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,b);case "acceMotion":return xnm.aio.hm.HmIPChannel.ACCELERATION_TRANSCEIVER.handleStatusResponse(a,
b);default:return"?"}};G.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.ACCELERATION_TRANSCEIVER.resolveState(a,b,c)}return e};var B=function(){};B.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"float",name:"on for",ref:{value:"onFor",
ext:"%f",unit:"s"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]}};B.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;a=JSON.parse(JSON.stringify(a));a.push({type:"enum",name:"button short press",ref:{value:"btnPressShort",options:["true"]}});
a.push({type:"enum",name:"button long press",ref:{value:"btnPressLong",options:["true"]}});return{ipevt:a}};B.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;switch(c.value){case "on":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:3},{value:"onFor",ext:.5});break;case "onFor":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:3},c);break;default:d&&d(Error("unknown command"));return}e?a._doRequestMarked(e,!0,{execute:function(a,
b){d&&d(a)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};B.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":d=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,b,{address:0},c)}return d};B.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,
b);default:return"?"}};B.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c),"pressShort"==e.key?e.key="btnPressShort":"pressLong"==e.key&&(e.key="btnPressLong")}return e};var C=function(){};C.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",
...
"on"]}},{type:"int",name:"led 1 status",ref:{value:"led1Level",extMeta:"0-100",unit:"%"}},{type:"enum",name:"led 1 color",ref:{value:"led1Color",options:"off blue green torqoise red purple yellow white".split(" ")}},{type:"int",name:"led 2 status",ref:{value:"led2Level",extMeta:"0-100",unit:"%"}},{type:"enum",name:"led 2 color",ref:{value:"led2Color",options:"off blue green torqoise red purple yellow white".split(" ")}}]}};C.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",
...
options:["open","closed","ventilation","unknown"]}},{type:"enum",name:"light status",ref:{value:"lightState",options:["off","on"]}}]}};A.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"door status",ref:{value:"doorState",options:["open","closed","ventilation","unknown"]}},{type:"enum",name:"light status",ref:{value:"lightState",options:["off","on"]}}]}};A.prototype.executeCommand=function(a,
...
d(Error("command is null"))};A.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "doorState":d=xnm.aio.hm.HmIPChannel.DOOR_RECEIVER.buildStateScript(a,b,{address:1},c);break;case "lightState":d=xnm.aio.hm.HmIPChannel.SIMPLE_SWITCH_RECEIVER.buildStateScript(a,b,{address:2},{value:"state"})}return d};A.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;
switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "doorState":return xnm.aio.hm.HmIPChannel.DOOR_RECEIVER.handleStatusResponse(a,b);case "lightState":return xnm.aio.hm.HmIPChannel.SIMPLE_SWITCH_RECEIVER.handleStatusResponse(a,{value:"state"});default:return"?"}};A.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,
b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.DOOR_RECEIVER.resolveState(a,b,c);break;case "2":e=xnm.aio.hm.HmIPChannel.SIMPLE_SWITCH_RECEIVER.resolveState(a,b,c)}return e};var H=function(){var a=function(){};a.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",
...
var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.POWER_MAINS_TRANSMITTER.resolveState(a,b,c)}return e};return a}(),J=function(){var a=function(){};a.prototype.getCommandStatusMap=function(){return{command:[{type:"multi",name:"play sound",ref:{value:"acousticPlay",ext:"%multi",extMeta:[{type:"int",name:"set sound",ref:{value:"acousticSound",ext:"%d",extMeta:"0-255"}},
...
var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(a,b,c);break;case "1":case "2":if(e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c))"pressShort"==e.key?e.key="btn"+d+"pressShort":"pressLong"==e.key&&(e.key="btn"+d+"pressLong")}return e};return a}();return{"HmIP-BSM":new n,"HmIP-BDT":new q,"HMIP-WRC2":new u,"HmIP-ASIR":new r,"HmIP-ASIR-2":new r,"HmIP-SWSD":new t,"HmIP-SRH":new x,
"HmIP-FSM":new w,"HmIP-PDT":new m,"HmIP-BROLL":new y,"HmIP-FROLL":new y,"HmIP-BBL":new z,"HmIP-FBL":new z,"HmIP-WRC6":new D,"HmIP-SPDR":new E,"HmIP-SWD":new F,"HmIP-SAM":new G,"HmIP-WGC":new B,"HmIP-BSL":new C,"HmIP-MOD-TM":new A,"HmIP-SLO":new H,"HmIP-PMFS":new I,"HmIP-MP3P":new J,"HmIP-MOD-HO":new A,"HmIP-WRCD":new K,resolveJSON:function(p){if(!p||!p.type)return null;if("HmIP-PDT"==p.type)return d.parseJSON(p);if(this[p.type])return this[p.type];var m=null;switch(p.type){case "HmIP-WHS2":m=c.parseJSON(p,
1,2);break;case "HmIP-DBB":case "HmIP-BRC2":m=a.parseJSON(p);break;case "HmIP-RCV-50":m=a.parseJSON(p)}if("HmIPW-DRS"==p.type.substr(0,9))m=c.parseJSON(p,1,parseInt(p.type.substr(9)));else if("HmIPW-DRD"==p.type.substr(0,9))m=d.parseJSON(p);else if("HmIPW-DRBL"==p.type.substr(0,10))m=b.parseJSON(p,1,parseInt(p.type.substr(10)));else if("HmIPW-DRI"==p.type.substr(0,9))m=e.parseJSON(p);else if("HmIPW-FIO"==p.type.substr(0,9)){var n=parseInt(p.type.substr(9));if(p.channels)for(var q in p.channels)if("MULTI_MODE_INPUT_TRANSMITTER"==
q.substr(0,28)){m=e.parseJSON(p);break}else if("SWITCH_TRANSMITTER"==q.substr(0,18)){m=c.parseJSON(p,n+1,n);break}}else if("HmIPW-STH"==p.type.substr(0,9)||"HmIPW-STHD"==p.type.substr(0,10)||"HmIPW-WTH"==p.type.substr(0,9))m=h.parseJSON(p);else if("HmIPW-SMI55"==p.type)m=g.parseJSON(p);else if("HmIPW-SPI"==p.type)m=k.parseJSON(p);else if("HmIP-WTH-B"==p.type)m=h.parseJSON(p);else if("HmIP-FCI"==p.type.substr(0,8))m=e.parseJSON(p);else if("HmIP-MOD-RC"==p.type.substr(0,11))m=e.parseJSON(p);else if("HmIP-MOD-OC"==
p.type.substr(0,11)){n=parseInt(p.type.substr(11));q=0;var r=p.address.indexOf(":");-1!=r&&(q=parseInt(p.address.substr(r+1)));0<q&&q<=n?m=a.parseJSON(p):0!=q&&(m=c.parseJSON(p,n+1,n))}else if("HmIP-FDT"==p.type.substr(0,8))m=d.parseJSON(p);else if("HmIP-FALMOT"==p.type.substr(0,11))m=l.parseJSON(p);else if("HmIP-PCBS"==p.type.substr(0,9))n=parseInt(p.type.substr(9)),isNaN(n)||(q=0,r=p.address.indexOf(":"),-1!=r&&(q=parseInt(p.address.substr(r+1))),0<q&&q<=n?m=a.parseJSON(p):0!=q&&(m=c.parseJSON(p,
n+1,n)));else if("HmIP-DRSI"==p.type.substr(0,9))n=parseInt(p.type.substr(9)),q=0,r=p.address.indexOf(":"),-1!=r&&(q=parseInt(p.address.substr(r+1))),0<q&&q<=n?m=e.parseJSON(p):0!=q&&(m=c.parseJSON(p,n+1,n));else if("HmIP-DRDI"==p.type.substr(0,9))n=parseInt(p.type.substr(9)),q=0,r=p.address.indexOf(":"),-1!=r&&(q=parseInt(p.address.substr(r+1))),0<q&&q<=n?m=e.parseJSON(p):0!=q&&(m=d.parseJSON(p,n+1,n));else if("HmIP-DRBLI"==p.type.substr(0,10))n=parseInt(p.type.substr(10)),q=0,r=p.address.indexOf(":"),
-1!=r&&(q=parseInt(p.address.substr(r+1))),0<q&&q<=2*n?m=e.parseJSON(p):0!=q&&(m=b.parseJSON(p,2*n+1,n));else if("HmIP-SCI"==p.type.substr(0,8))m=f.parseJSON(p);else if(this[p.type])return this[p.type];return m},parseDevice:function(a){return a.channels&&a.hsstype&&a["interface"]?0==a.hsstype.indexOf("HmIPW")?this._parseHMIPWDevice(a):this._parseHmIPRFDevice(a):null},_parseHMIPWDevice:function(a){var b=function(a){var b=[];var c={sys:"hm"};c.id=a.name;c.type=a.hsstype;c.address=a.address;c.interface=
a.interface;c.channels={};var d=0,e=JSON.parse(JSON.stringify(c)),f=null,g=a.channels,h=!1,k;for(k in g)if(g.hasOwnProperty(k)){var p=a.channels[k];if(p.hsstype)if("ALARM_COND_SWITCH_TRANSMITTER"==p.hsstype)b.push(e);else if("MULTI_MODE_INPUT_TRANSMITTER"==p.hsstype&&(0!=d&&(b.push(e),e=JSON.parse(JSON.stringify(c)),h=!1,f&&(e.channels.MAINTENANCE=f)),d++),p.address){var l=p.address.indexOf(":");if(-1!==l){"MULTI_MODE_INPUT_TRANSMITTER"!=p.hsstype||h||(e.id=p.name?p.name:e.id,h=!0);l=p.address.substring(l+
1);"MULTI_MODE_INPUT_TRANSMITTER"==p.hsstype&&(e.address+=":"+l);var m={id:p.name,address:l,room:p.room,group:p.func};0==l?(f=m,e.channels.MAINTENANCE=f):e.channels[p.hsstype+":"+l]=m}}}return b},c=function(a){var b={sys:"hm"};b.id=a.name;b.type=a.hsstype;b.address=a.address;b.interface=a.interface;b.channels={};var c=0,d=!1,e=[];var f=[];var g=JSON.parse(JSON.stringify(b)),h=null,k=a.channels,p;for(p in k)if(k.hasOwnProperty(p)){var l=a.channels[p];if(l.hsstype&&l.address){var m=l.address.indexOf(":");
if(-1!==m){m=l.address.substring(m+1);var n={id:l.name,address:m,room:l.room,group:l.func};if("MAINTENANCE"==l.hsstype)h=n,g.channels.MAINTENANCE=h;else if("MULTI_MODE_INPUT_TRANSMITTER"==l.hsstype)g.channels[l.hsstype+":"+m]=n,g.id=l.name?l.name:g.id,g.address+=":"+m,e.push(g),g=JSON.parse(JSON.stringify(b)),h&&(g.channels.MAINTENANCE=h);else if("SWITCH_TRANSMITTER"==l.hsstype)0!=c&&(f.push(g),g=JSON.parse(JSON.stringify(b)),d=!1,h&&(g.channels.MAINTENANCE=h)),c++,g.channels[l.hsstype+":"+m]=n,g.address+=
":"+m;else if("SWITCH_VIRTUAL_RECEIVER"==l.hsstype&&!d)g.channels[l.hsstype+":"+m]=n,g.id=l.name?l.name:g.id,d=!0;else if("SWITCH_WEEK_PROFILE"==l.hsstype){for(var q=0;q<f.length;q++)f[q].channels[l.hsstype+":"+m]=n;f.push(g)}}}}return f.concat(e)},d=a.hsstype;if("HmIPW-DRS"==d.substr(0,9))return this._resolveHmIPMultiSwitch(a);if("HmIPW-DRD"==d.substr(0,9))return this._resolveHmIPMultiDimmer(a);if("HmIPW-DRBL"==d.substr(0,10))return this._resolveHmIPMultiBlind(a);if("HmIPW-DRI"==d.substr(0,9))return b(a);
...
2:-1==["0","3","4","5","6"].indexOf(a)?0:-1!=["4","5","6"].indexOf(a)?2:1});if(-1!=a.hsstype.toUpperCase().indexOf("HMIP-WRC"))return"HMIP-WRCD"==a.hsstype.toUpperCase()?this._resolveHmIPDeviceFromScript(a,function(a,b){return 0==a?1:1==a||2==a?2:3==a?1:0}):this._resolveHmIPDeviceFromScript(a,function(a,b){return 0==a?1:"KEY_TRANSCEIVER"==b?2:0});if(0==a.hsstype.toUpperCase().indexOf("HMIP-FAL"))return this._resolveHmIPDeviceFromScript(a,function(a,b){return"CLIMATECONTROL_FLOOR_PUMP_TRANSCEIVER"==
b||"CLIMATECONTROL_FLOOR_TRANSCEIVER"==b?3:0});if("HMIP-SPDR"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1==["0","2","3"].indexOf(a)?0:-1!=["2","3"].indexOf(a)?2:1});if("HMIP-SMI55"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1==["0","1","2","3"].indexOf(a)?0:-1!=["1","2"].indexOf(a)?3:1});if("HMIP-MIOB"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1!=["3","7","9",
"10","11"].indexOf(a)?3:0});if("HMIP-SWD"==a.hsstype.toUpperCase()||"HMIP-SAM"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return 1});if("HMIP-WGC"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1=="012345".split("").indexOf(a)?0:-1!=["3","4","5"].indexOf(a)?2:1});if("HMIP-BSL"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1!="5 6 9 10 13 14".split(" ").indexOf(a)?0:-1!="1 2 7 8 11 12".split(" ").indexOf(a)?
2:1});if("HMIP-MOD-TM"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return 1});if("HMIP-SLO"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1!=["2","3"].indexOf(a)?0:1});if("HMIP-PMFS"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return 1});if("HMIP-MP3P"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1!=["0","1","5","9"].indexOf(a)?1:-1!="234678".split("").indexOf(a)?
2:0});if("HMIP-MOD-HO"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return 1});if("HMIP-SCI"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return 0==a||"SHUTTER_CONTACT_TRANSCEIVER"==b||"SHUTTER_CONTACT"==b?1:0});if("HmIP-MOD-OC"==a.hsstype.substr(0,11)){var b=parseInt(json.type.substr(11)),c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"KEY_TRANSCEIVER"==b?3:0}),d=[];for(i=1;i<=b;i++)d.push(i);
a=this._resolveHmIPMultiSwitch(a,d);return c?a?c.concat(a):c:a}if(-1!=a.hsstype.indexOf("HmIP-FCI"))return this._resolveHmIPDeviceFromScript(a,function(a,b){return 0==a?1:"MULTI_MODE_INPUT_TRANSMITTER"==b?3:0});if("HmIP-PCBS"==a.hsstype.substr(0,9)&&(b=parseInt(a.hsstype.substr(9)),!isNaN(b))){c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"KEY_TRANSCEIVER"==b?3:0});d=[];for(i=1;i<=b;i++)d.push(i);a=this._resolveHmIPMultiSwitch(a,d);return c?a?c.concat(a):c:a}if("HmIP-DRSI"==
a.hsstype.substr(0,9)){b=parseInt(a.hsstype.substr(9));c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"MULTI_MODE_INPUT_TRANSMITTER"==b?3:0});d=[];for(i=1;i<=b;i++)d.push(i);a=this._resolveHmIPMultiSwitch(a,d);return c?a?c.concat(a):c:a}if("HmIP-DRDI"==a.hsstype.substr(0,9)){b=parseInt(a.hsstype.substr(9));c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"MULTI_MODE_INPUT_TRANSMITTER"==b?3:0});d=[];for(i=1;i<=b;i++)d.push(i);a=this._resolveHmIPMultiDimmer(a,
d);return c?a?c.concat(a):c:a}if("HmIP-DRBLI"==a.hsstype.substr(0,10)){b=parseInt(a.hsstype.substr(10));c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"MULTI_MODE_INPUT_TRANSMITTER"==b?3:0});d=[];for(i=1;i<=2*b;i++)d.push(i);a=this._resolveHmIPMultiBlind(a,d);return c?a?c.concat(a):c:a}c=this._getChannelCount(a.channels,"SWITCH_TRANSMITTER");b=this._getChannelCount(a.channels,"SWITCH_VIRTUAL_RECEIVER");if(1<this._getChannelCount(a.channels,"KEY_TRANSCEIVER"))return this._resolveHmIPDeviceFromScript(a,
function(a,b){return"MAINTENANCE"==b?1:"KEY_TRANSCEIVER"==b?3:0});if(1<c&&1<b)return this._resolveHmIPMultiSwitch(a);var e={};return this._resolveHmIPDeviceFromScript(a,function(a,b){if(!xnm.aio.hm.HMIP_CHANNEL[b])return 0;e[b]||(e[b]=a);return e[b]!=a?0:1})},_getChannelCount:function(a,b){var c=0,d;for(d in a)a.hasOwnProperty(d)&&a[d].hsstype==b&&c++;return c},_parseDeviceBasic:function(a){var b={sys:"hm"};b.id=a.name;b.type=a.hsstype;b.address=a.address;b.interface=a.interface;b.channels={};return b},
_resolveHmIPMultiSwitch:function(a,b){var c=[];var d={sys:"hm"};d.id=a.name;d.type=a.hsstype;d.address=a.address;d.interface=a.interface;d.channels={};var e=0,f=JSON.parse(JSON.stringify(d)),g=null,h=a.channels,k=!1,l;for(l in h)if(h.hasOwnProperty(l)){var m=a.channels[l];if(m.hsstype&&("SWITCH_TRANSMITTER"==m.hsstype&&(0!=e&&(c.push(f),f=JSON.parse(JSON.stringify(d)),k=!1,g&&(f.channels.MAINTENANCE=g)),e++),m.address)){var n=m.address.indexOf(":");if(-1!==n&&("SWITCH_VIRTUAL_RECEIVER"!=m.hsstype||
k||(f.id=m.name?m.name:f.id,k=!0),n=m.address.substring(n+1),!b||-1==b.indexOf(parseInt(n)))){"SWITCH_TRANSMITTER"==m.hsstype&&(f.address+=":"+n);var p={id:m.name,address:n,room:m.room,group:m.func};0==n?(g=p,f.channels.MAINTENANCE=g):f.channels[m.hsstype+":"+n]=p;if("SWITCH_WEEK_PROFILE"==m.hsstype){for(var q=0;q<c.length;q++)c[q].channels[m.hsstype+":"+n]=p;c.push(f)}}}}return c},_resolveHmIPMultiDimmer:function(a,b){var c=[];var d={sys:"hm"};d.id=a.name;d.type=a.hsstype;d.address=a.address;d.interface=
a.interface;d.channels={};var e=0,f=JSON.parse(JSON.stringify(d)),g=null,h=a.channels,k=!1,l;for(l in h)if(h.hasOwnProperty(l)){var m=a.channels[l];if(m.hsstype&&("DIMMER_TRANSMITTER"==m.hsstype&&(0!=e&&(c.push(f),f=JSON.parse(JSON.stringify(d)),k=!1,g&&(f.channels.MAINTENANCE=g)),e++),m.address)){var n=m.address.indexOf(":");if(-1!==n&&("DIMMER_VIRTUAL_RECEIVER"!=m.hsstype||k||(f.id=m.name?m.name:f.id,k=!0),n=m.address.substring(n+1),!b||-1==b.indexOf(parseInt(n)))){"DIMMER_TRANSMITTER"==m.hsstype&&
(f.address+=":"+n);var q={id:m.name,address:n,room:m.room,group:m.func};0==n?(g=q,f.channels.MAINTENANCE=g):f.channels[m.hsstype+":"+n]=q;if("DIMMER_WEEK_PROFILE"==m.hsstype){for(var p=0;p<c.length;p++)c[p].channels[m.hsstype+":"+n]=q;c.push(f)}}}}return c},_resolveHmIPMultiBlind:function(a,b){var c=[];var d={sys:"hm"};d.id=a.name;d.type=a.hsstype;d.address=a.address;d.interface=a.interface;d.channels={};var e=0,f=JSON.parse(JSON.stringify(d)),g=null,h=a.channels,k=!1,l;for(l in h)if(h.hasOwnProperty(l)){var m=
a.channels[l];if(m.hsstype&&("BLIND_TRANSMITTER"==m.hsstype&&(0!=e&&(c.push(f),f=JSON.parse(JSON.stringify(d)),k=!1,g&&(f.channels.MAINTENANCE=g)),e++),m.address)){var n=m.address.indexOf(":");if(-1!==n&&("BLIND_VIRTUAL_RECEIVER"!=m.hsstype||k||(f.id=m.name?m.name:f.id,k=!0),n=m.address.substring(n+1),!b||-1==b.indexOf(parseInt(n)))){"BLIND_TRANSMITTER"==m.hsstype&&(f.address+=":"+n);var q={id:m.name,address:n,room:m.room,group:m.func};0==n?(g=q,f.channels.MAINTENANCE=g):f.channels[m.hsstype+":"+
n]=q;if("BLIND_WEEK_PROFILE"==m.hsstype){for(var p=0;p<c.length;p++)c[p].channels[m.hsstype+":"+n]=q;c.push(f)}}}}return c},_resolveHmIPDeviceFromScript:function(a,b){var c=[],d={sys:"hm"};d.id=a.name;d.type=a.hsstype;d.address=a.address;d["interface"]=a["interface"];d.channels={};var e=a.channels,f=!1,g;for(g in e)if(channel=a.channels[g],channel.address&&(e=channel.address.indexOf(":"),-1!==e)){e=channel.address.substring(e+1);var h=channel.hsstype;if(channel.hsstype){var k=1;b&&(k=b(e,h));0!=k&&
(3==k?(k=JSON.parse(JSON.stringify(d)),k.address=k.address+":"+e,k.id=k.id+"("+k.address+")",k.channels[h]={id:channel.name,address:e,room:channel.room,group:channel.func},c.push(k)):(f=!0,2==k&&(h=h+":"+e),d.channels[h]={id:channel.name,address:e,room:channel.room,group:channel.func}))}}f&&c.push(d);return c}}}();
...
xnm.aio.hm.HmIPDevice.resolveJSON(a);if(c&&c.getCommandStatusMap&&(c=c.getCommandStatusMap(a)))return k(c,b)}c=[];var d=a.channels;a=xnm.aio.hm.DM._getHmIPChannels(a);var e=b.elems,f;for(f in d)if(d.hasOwnProperty(f)){var h=a[f];if(h)for(var l in h)h.hasOwnProperty(l)&&xnm.aio.hm.HMIP_MAP[f]&&(b=g(xnm.aio.hm.HMIP_MAP,f,l,h[l],e),c=c.concat(b))}return c},n=function(a,c){var d=[],e=c.elems;a=xnm.aio.hm.HM_Sec_Sir_WM_MAP;switch(c.catagory){case "command":a.command.forEach(function(a){b(e,a.type)&&(a=
JSON.parse(JSON.stringify(a)),d.push(a))});break;case "status":a.status.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},q=function(a,c){var d=[],e=c.elems;a=xnm.aio.hm.HM_WDS30_OT2_SM_2_MAP;switch(c.catagory){case "status":a.status.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},u=function(a,c){var d=[],e=c.elems;a=xnm.aio.hm.HM_ES_TX_WM_MAP;switch(c.catagory){case "status":a.status.forEach(function(a){b(e,a.type)&&
(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},r=function(a,c){var d=[],e=c.elems;a=[{type:"int",name:"dim to",ref:{value:"dimRaw",ext:"%d",extMeta:"0-100",scale:"10"}}];switch(c.catagory){case "command":a.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},t=function(a,b){if("HmIP-HEATING"==a.type)return l(a,b);if(a["interface"]&&"CUxD"==a["interface"]){var c=[];a.cuxd||(a.cuxd=xnm.aio.hm.MHMCCU._resolveCUxDType(a));var e=a.channels,f=xnm.aio.hm.DM._getCUxDChannels(a),
h=b.elems,m;for(m in e)if(e.hasOwnProperty(m)){var t=f[m];if(t)for(var w in t)t.hasOwnProperty(w)&&("FHT_Multiventil"==a.cuxd&&"DIMMER"==m?m="FHT_Multiventil_Dimmer":"HMS_100_Contact"==a.cuxd&&"SENSOR"==m?m="HMS_100_Contact":"FHT_Contact"==a.cuxd&&"SENSOR"==m?m="FHT_Contact":"Security_Sensor"==a.cuxd&&"SENSOR"==m?m="Security_Sensor":"HMS_100_W/WD"==a.cuxd&&"SENSOR"==m&&(m="Security_Sensor"),xnm.aio.hm.CUxDMAP[m]?(b=g(xnm.aio.hm.CUxDMAP,m,w,t[w],h),c=c.concat(b)):xnm.aio.hm.MAP[m]&&(b=g(xnm.aio.hm.MAP,
m,w,t[w],h),c=c.concat(b)))}return c}if(a["interface"]&&"HmIP-RF"==a["interface"])return l(a,b);if(a["interface"]&&"BidCos-RF"==a["interface"]&&a.type&&xnm.aio.hm.BidCosDevice[a.type]&&(m=xnm.aio.hm.BidCosDevice[a.type])&&m.getCommandStatusMap&&(m=m.getCommandStatusMap(a))||a["interface"]&&"VirtualDevices"==a["interface"]&&-1==a.type.indexOf("HM-CC-VG")&&(m=d._getVirtualDevicesMap(a)))return k(m,b);if("DimmerKey"==a.type)return r(a,b);if("HM-Sec-Sir-WM"==a.type)return n(a,b);if("HM-WDS30-OT2-SM-2"==
a.type)return q(a,b);if("HM-ES-TX-WM"==a.type&&a.channels&&a.channels.POWERMETER_IEC1)return u(a,b);m=[];w=a.channels;a=xnm.aio.hm.DM._getChannels(a);f=b.elems;for(c in w)if(w.hasOwnProperty(c)&&(h=a[c]))for(e in h)h.hasOwnProperty(e)&&xnm.aio.hm.MAP[c]&&(b=g(xnm.aio.hm.MAP,c,e,h[e],f),m=m.concat(b));return m};if(!a.type)return null;var x=JSON.parse(JSON.stringify(a)),w=null;switch(c.catagory){case "command":w=e(a,c);x.command=w;break;case "status":w=e(a,c);x.status=w;break;default:return null}return w&&
0!=w.length?x:null},applyUIFilterGateway:function(a,c){var d=function(a,b){if("*"==a)return!0;for(var c=!1,d=0;d<a.length;d++)if(a[d]==b){c=!0;break}return c},b=function(a,b){var c=[],e=b.elems;if(a=xnm.aio.hm.MAP.CCU)switch(b.catagory){case "command":a.command&&a.command.forEach(function(a){d(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),c.push(a))});break;case "status":a.status&&a.status.forEach(function(a){d(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),c.push(a))})}return c},e=JSON.parse(JSON.stringify(a)),
...
ext:"%d",extMeta:"0-100",name:"output to"}),h={"%dimmerState%":{value:"analogOutputLevel",ext:"%d",extMeta:"0-100",name:"output status"}},g=["dimmer"]);return g&&0!=g.length?this._injectToSmartWidgetTemplate(c,g,d,f,h):null},_injectToSmartWidgetTemplate:function(a,c,d,b,e,f){var h=[];a||(b={});b||(b={});e||(e={});for(var g=0;g<a.length;g++){var k=a[g];if(k.meta&&-1!=c.indexOf(k.meta.type)&&k.elements){k=JSON.parse(JSON.stringify(k));var l=!1,n;for(n in k.elements){var q=k.elements[n];if(q&&Array.isArray(q))for(var u=
0;u<q.length;u++){var r=q[u];if(r){if(r.action&&"command"==r.action.type&&r.action.ref&&r.action.ref.value){var t=r.action.ref.ext;b[r.action.ref.value]?(r.action.ref=b[r.action.ref.value],t&&(r.action.ref.ext=t),r.action.device=d,l=!0):r.action=null}r.status&&r.status.ref&&r.status.ref.value&&(e[r.status.ref.value]?(r.status.ref=e[r.status.ref.value],r.status.device=d,l=!0):r.status=null);r.widget&&"%icon%"==r.widget.key_img&&f&&(r.widget.key_img=f["%icon%"])}}}l&&h.push(k)}}return h},toGeneralDevice:function(a,
c){if(!a)return null;c={};for(e in a.channels){var d=e,b=d.indexOf(":");-1!=b&&(d=d.substr(0,b));c[d]=!0}var e=null;c.SWITCH&&(e={type:"switch",commands:{on:{},off:{},toggle:{}},states:{state:{values:["on","off"]}},details:{commands:{on:{value:"on"},off:{value:"off"},toggle:{value:"toggle"}},states:{state:{value:"switchState"}}}});c.DIMMER&&(e={type:"dimmer",commands:{on:{},off:{},brightness:{value:{type:"INT",min:0,max:100,step:1}}},states:{brightness:{min:0,max:100,unit:"%"}},details:{commands:{on:{value:"dimTo",
ext:100},off:{value:"dimOff"},brightness:{value:"dimTo",ext:"%d"}},states:{brightness:{value:"dimmerTLevel"}}}});c.BLIND&&(e={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}}},states:{position:{min:0,max:100}},details:{commands:{up:{value:"blindUp"},down:{value:"blindDown"},stop:{value:"stop"},position:{value:"moveTo",ext:"%d"}},states:{position:{value:"blindLevel"}}}});c.JALOUSIE&&(e={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",
min:0,max:100,step:1}},rotation:{value:{type:"INT",min:0,max:100,step:1}}},states:{position:{min:0,max:100},rotation:{min:0,max:100}},details:{commands:{up:{value:"jalUp"},down:{value:"jalDown"},stop:{value:"jalStop"},position:{value:"jalRaw",ext:"%d"},rotation:{value:"jalLmlRaw",ext:"%d"}},states:{position:{value:"jalLevel"},rotation:{value:"jalLmlLevel"}}}});c.CLIMATECONTROL_REGULATOR&&(e={type:"heater",commands:{tempUp:{},tempDown:{},tempTo:{value:{type:"FLOAT",min:6,max:30,step:.5}}},states:{setpoint:{type:"FLOAT",
min:6,max:30,step:.5,unit:"\u00b0C"},temperature:{type:"FLOAT"},humidity:{type:"INT"}},details:{commands:{tempUp:{value:"themoRTempUp"},tempDown:{value:"themoRTempDown"},tempTo:{value:"themoRTempRaw",ext:"%f"}},states:{setpoint:{value:"themoRSetTemp"},temperature:{value:"weatherTemp"},humidity:{value:"weatherHum"}}}});c.THERMALCONTROL_TRANSMIT&&(e={type:"heater",commands:{tempUp:{},tempDown:{},tempTo:{value:{type:"FLOAT",min:4,max:30.5,step:.5}},auto:{},manu:{}},states:{setpoint:{type:"FLOAT",min:4,
max:30.5,step:.5,unit:"\u00b0C"},temperature:{type:"FLOAT"},humidity:{type:"INT"}},details:{commands:{tempUp:{value:"themoTTempUp"},tempDown:{value:"themoTTempDown"},tempTo:{value:"themoTTempRaw",ext:"%f"},auto:{value:"themoAutoMode"},manu:{value:"themoManuMode"}},states:{setpoint:{value:"themoTSetTemp"},temperature:{value:"themoTActualTemp"},humidity:{value:"themoTActualHum"},mode:{value:"themoTMode"}}}});c.CLIMATECONTROL_RT_TRANSCEIVER&&(e={type:"heater",commands:{tempUp:{},tempDown:{},tempTo:{value:{type:"FLOAT",
min:4,max:30.5,step:.5}},auto:{},manu:{}},states:{setpoint:{type:"FLOAT",min:4,max:30.5,step:.5,unit:"\u00b0C"},temperature:{type:"FLOAT"},humidity:{type:"INT"}},details:{commands:{tempUp:{value:"themoTempUp"},tempDown:{value:"themoTempDown"},tempTo:{value:"themoTempRaw",ext:"%f"},auto:{value:"themoAutoMode"},manu:{value:"themoManuMode"}},states:{setpoint:{value:"themoSetTemp"},temperature:{value:"themoActualTemp"},humidity:{value:"themoActualHum"},mode:{value:"themoMode"}}}});if("HmIP-WGC"==a.type)return null;
c.SWITCH_VIRTUAL_RECEIVER&&(e={type:"switch",commands:{on:{},off:{},toggle:{}},states:{state:{values:["on","off"]}},details:{commands:{on:{value:"on"},off:{value:"off"},toggle:{value:"toggle"}},states:{state:{value:"switchState"}}}});c.DIMMER_VIRTUAL_RECEIVER&&(e={type:"dimmer",commands:{on:{},off:{},brightness:{value:{type:"INT",min:0,max:100,step:1}}},states:{brightness:{min:0,max:100,unit:"%"}},details:{commands:{on:{value:"dimOn"},off:{value:"dimOff"},brightness:{value:"dimRaw",ext:"%d"}},states:{brightness:{value:"dimmerLevel"}}}});
c.SHUTTER_VIRTUAL_RECEIVER&&(e={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}}},states:{position:{min:0,max:100}},details:{commands:{up:{value:"moveUp"},down:{value:"moveDown"},stop:{value:"blindStop"},position:{value:"blindRaw",ext:"%d"}},states:{position:{value:"blindTLevel"}}}});c.BLIND_VIRTUAL_RECEIVER&&(e={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}},rotation:{value:{type:"INT",min:0,max:100,step:1}}},
states:{position:{min:0,max:100},rotation:{min:0,max:100}},details:{commands:{up:{value:"moveUp"},down:{value:"moveDown"},stop:{value:"stop"},position:{value:"moveTo",ext:"%d"},rotation:{value:"lamellaTo",ext:"%d"}},states:{position:{value:"blindTPos"},rotation:{value:"lamellaTPos"}}}});c.HEATING_CLIMATECONTROL_TRANSCEIVER&&(e={type:"heater",commands:{tempUp:{},tempDown:{},tempTo:{value:{type:"FLOAT",min:4,max:30.5,step:.5}},auto:{},manu:{}},states:{setpoint:{type:"FLOAT",min:4,max:30.5,step:.5,unit:"\u00b0C"},
...
d-2),f=(new Buffer(e,"hex")).toString();e=1;-1!=f.indexOf("CCU2")?e=2:-1!=f.indexOf("CCU3")&&(e=3);c=c.substr(d+2);d=a(c);if(-1!=d&&(c=c.substr(0,d))){c=(new Buffer(c,"hex")).toString();var h=new xnm.aio.hm.MHMCCU(b,"",80,8181,c,e);this._discoveryCallbacks&&this._discoveryCallbacks.forEach(function(a){a&&a(h)})}}}},d=function(a,b,d){xnm.aio.hm.Handler._logger.log("debug","create discover socket @:"+b);var e=require("dgram"),f=this;try{var g=e.createSocket({reuseAddr:!0,type:"udp4"})}catch(u){g=e.createSocket("udp4")}var h=
d;g.on("listening",function(){g.setBroadcast&&g.setBroadcast(!0);h&&(h(null,g),h=null)});g.on("message",function(a,b){c.call(f,b,a)});g.on("error",function(a){xnm.aio.hm.Handler._logger.log("warn","create discover socket error:"+a);h&&(h(a),h=null)});g.bind(a,b);return g},b=function(a,b){var c=new Buffer([2,165,219,48,1,101,81,51,45,42,0,42,0,73]);a.send(c,0,c.length,43439,"255.255.255.255",function(){b&&a.close()})},e=this;(function(a){var b=[],e=this,f=require("os"),l=require("dgram");if(f&&f.networkInterfaces){var n=
l.createSocket("udp4");n.on("listening",function(){n.setBroadcast(!0);var c=f.networkInterfaces(),g=[],h;for(h in c)for(var k=c[h],l=0;l<k.length;l++)"IPv4"==k[l].family&&0==k[l].internal&&g.push(k[l].address);var w=g.length;if(w)for(c=0;c<g.length;c++)d.call(e,n.address().port,g[c],function(c,d){w--;!c&&d&&b.push(d);w||a&&a(null,b)});else a&&a(null,b)});n.on("message",function(a,b){c.call(e,b,a)});n.bind(null)}else d.call(e,null,null,function(c,d){!c&&d&&b.push(d);a&&a(null,b)})}).call(this,function(a,
