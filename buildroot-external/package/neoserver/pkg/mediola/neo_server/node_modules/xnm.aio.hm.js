...
2:0});if("HMIP-MOD-HO"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return 1});if("HMIP-SCI"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return 0==a||"SHUTTER_CONTACT_TRANSCEIVER"==b||"SHUTTER_CONTACT"==b?1:0});if("HmIP-MOD-OC"==a.hsstype.substr(0,11)){var b=parseInt(a.hsstype.substr(11)),c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"KEY_TRANSCEIVER"==b?3:0}),d=[];for(i=1;i<=b;i++)d.push(i);
