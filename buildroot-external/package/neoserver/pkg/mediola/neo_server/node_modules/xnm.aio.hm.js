...
xnm.aio.hm.MHMCCU=function(a,c,d,b,e,f,g,h){var k=require("x.logger.js");this._logger=k?k.getLogger("xnm.aio.hm.MHMCCU"):{log:function(){}};this.type=f?f:1;this.ip=a;this.port=d?d:80;this.username=g;this.password=c;this.tclport=b?b:8181;this.uuid=e;this.cloudmatic=h;this._cloudmaticState="off";this._statebuffer={};this._reqNo=0};xnm.aio.hm.MHMCCU._cloneJSONObj=function(a){a=JSON.stringify(a);return a=JSON.parse(a)};
xnm.aio.hm.MHMCCU.prototype={executeCommand:function(a,c,d){if(a)if(c){var b=null,e=1,f=a.type,g={type:a.type,address:a.address,"interface":a["interface"],channels:{}},h=a.address.indexOf(":");0<h&&(e=a.address.substr(h+1),g.address=a.address.substr(0,h));g["interface"]||(g["interface"]=a.data);"on"==c?"DIMMER"==a.type&&(c="dimRaw",b=100):"off"==c?"DIMMER"==a.type&&(c="dimRaw",b=0):"toggle"!=c&&(0==c.indexOf("dimTo")&&(c=c.replace(/dimTo/g,"")),0==c.indexOf("moveTo")&&(c=c.replace(/moveTo/g,"")),
b=c=c.replace(/%/g,""),"DIMMER"==a.type?c="dimRaw":"FHT80b"==a.subtype&&(c="themoRTempRaw",e=2,f="CLIMATECONTROL_REGULATOR"));XC.debugf(g);c={value:c,ext:b};switch(a.type){case xnm.aio.hm.DM.SYSVAR:this.executeCommandCreator(a,c,d);break;case xnm.aio.hm.DM.PROG:this.executeCommandCreator(a,c,d);break;default:g.channels[f]={address:e},this.executeCommandCreator(g,c,d)}}else d&&d(Error("command invalid"));else d&&d(Error("device invalid"))},executeCCUCommand:function(a,c){if(a){var d=null;"cloudmaticOn"==
a.value?this._cloudmaticState="on":"cloudmaticOff"==a.value?this._cloudmaticState="off":"cloudmaticToggle"==a.value?this._cloudmaticState="on"==this._cloudmaticState?"off":"on":d=Error("unknown command");c&&c(d)}else c&&c(Error("command invalid"))},getStates:function(a,c,d){if(c&&0!=c.length){for(var b=[],e=0;e<c.length;e++){var f=c[e];switch(f.type){case xnm.aio.hm.DM.SYSVAR:b.push(c[e]);break;case xnm.aio.hm.DM.PROG:break;default:var g=f.channelAddress,h=f.channelName,k={type:f.type,address:f.address,
"interface":f["interface"],channels:{}},m=f.address.indexOf(":");0<m&&(g=f.address.substr(m+1),k.address=f.address.substr(0,m));k["interface"]||(k["interface"]=f.data);h||(h=f.type);"SWITCH"==f.type?(k.channels.SWITCH={address:1},b.push({id:f.id,device:k,status:{value:"switchState"}}),"meteringSwitch"==f.subtype&&(k.channels.POWERMETER={address:2},b.push({id:f.id+":current",device:k,status:{value:"meterPower"}}))):"FHT80b"==f.subtype?(k.channels.WEATHER={address:1},k.channels.CLIMATECONTROL_REGULATOR=
{address:2},b.push({id:f.id+":C",device:k,status:{value:"weatherTemp"}}),b.push({id:f.id+":T",device:k,status:{value:"themoRSetTemp"}}),b.push({id:f.id+":M",device:k,status:{value:"themoRMode"}})):(k.channels[h]={address:g},"DIMMER"==f.type&&b.push({id:f.id,device:k,status:{value:"dimmerLevel"}}))}}this.getStatesCreator(a,b,d)}else d&&d(null,{})},executeCommandCreator:function(a,c,d){var b=this,e=function(a,b,c,d){this.device=a;this.command=b;this.channel=c;this.callback=d};e.prototype.execute=function(c,
d){var e=this;if(c)this.callback&&this.callback(c);else{if("CUxD"==a["interface"])var g=xnm.aio.hm.CUxDChannel[this.channel];else"HmIP-RF"==a["interface"]||"HmIP-HEATING"==a.type?g=xnm.aio.hm.HmIPChannel[m]:"HM-Sec-Sir-WM"!=a.type||"SWITCH_SENSOR_1"!=m&&"SWITCH_SENSOR_2"!=m||(g=xnm.aio.hm.Channel.SWITCH_SENSOR);g||(g=xnm.aio.hm.Channel[this.channel]);g.handleCommandResponse?g.handleCommandResponse(b,this.device,this.command,d,function(){setTimeout(function(){e.callback&&e.callback()},500)}):setTimeout(function(){e.callback&&
...
break;case xnm.aio.hm.DM.PROG:f=xnm.aio.hm.Prog.buildCommandScript(this,a,c);if(!f){d&&d(Error("command is invalid"));break}this._doRequest(f,!0,function(a){d&&d(a)});break;default:if(a&&"BidCos-RF"==a["interface"]&&a.type&&xnm.aio.hm.BidCosDevice[a.type]){var g=xnm.aio.hm.BidCosDevice[a.type];if(g.executeCommand){g.executeCommand(this,a,c,d);break}}if(a&&"HmIP-RF"==a["interface"]&&(g=xnm.aio.hm.HmIPDevice.resolveJSON(a))&&g.executeCommand){g.executeCommand(this,a,c,d);break}if(a&&"VirtualDevices"==
a["interface"]&&a.type&&xnm.aio.hm.VirtualDevice[a.type]&&(g=xnm.aio.hm.VirtualDevice[a.type])&&(g=new g,g.executeCommand)){g.executeCommand(this,a,c,d);break}if(a.channels)if(f=null,"DimmerKey"==a.type)f=xnm.aio.hm.DimmerKey,(f=f.buildCommandScript(this,a,c))?this._doRequestMarked(f,!0,{execute:function(a){setTimeout(function(){d&&d(a)},3E3)}}):d&&d(Error("no correspondent channel for the command is found"));else{var h=a.channels,k=g=!1,m;for(m in h)if(h.hasOwnProperty(m)&&(f=null,"CUxD"==a["interface"]?
f=xnm.aio.hm.CUxDChannel[m]:"HmIP-RF"==a["interface"]||"HmIP-HEATING"==a.type?f=xnm.aio.hm.HmIPChannel[m]:"HM-Sec-Sir-WM"!=a.type||"SWITCH_SENSOR_1"!=m&&"SWITCH_SENSOR_2"!=m||(f=xnm.aio.hm.Channel.SWITCH_SENSOR),f||(f=xnm.aio.hm.Channel[m]),f&&(g=!0,f.buildCommandScript&&(f=f.buildCommandScript(this,a,a.channels[m],c))))){k=!0;c=new e(a,c,m,d);this._doRequestMarked(f,!0,c);break}g?k||d&&d(Error("no correspondent channel for the command is found")):d&&d(Error("no correspondent channel is found"))}else d&&
d(Error("device channels invalid"))}}else d&&d(Error("command invalid"))},buildScript:function(a){for(var c='var o;string states="";',d=0;d<a.length;d++){var b=a[d];c+='states = states # "'+d+'=";';c+=b.script;d<a.length-1&&(c+='states = states # "\\r@@@\\n";')}return c},resolveStateResponse:function(a,c,d){var b=[];if(d)for(var e=0;e<d.length;e++){var f=d[e];b.push({id:f.alias,status:f.state})}for(d=0;d<a.length;d++){f=a[d];e=f.alias;var g=f.channel;if(f.device){var h=f.device;switch(h.type){case xnm.aio.hm.DM.SYSVAR:if(!h["class"]||
!xnm.aio.hm.SysVar[h["class"].toUpperCase()]){b.push({id:e,status:"?"});continue}f=xnm.aio.hm.SysVar[h["class"].toUpperCase()].handleStatusResponse(c[d],f.status);b.push({id:e,status:f});break;case xnm.aio.hm.DM.PROG:b.push({id:e,status:"?"});break;default:if(h&&"BidCos-RF"==h["interface"]&&h.type&&xnm.aio.hm.BidCosDevice[h.type]){var k=xnm.aio.hm.BidCosDevice[h.type];if(k.handleStatusResponse){f=k.handleStatusResponse(c[d],f.status);b.push({id:e,status:f});continue}}if(h&&"HmIP-RF"==h["interface"]&&
(k=xnm.aio.hm.HmIPDevice.resolveJSON(h))&&k.handleStatusResponse){f=k.handleStatusResponse(c[d],f.status,this);b.push({id:e,status:f});continue}if(h&&"VirtualDevices"==h["interface"]&&h.type&&xnm.aio.hm.VirtualDevice[h.type]&&(k=xnm.aio.hm.VirtualDevice[h.type])&&(k=new k,k.handleStatusResponse)){f=k.handleStatusResponse(c[d],f.status);b.push({id:e,status:f});continue}k=null;"CUxD"==h["interface"]?k=xnm.aio.hm.CUxDChannel[g]:"HmIP-RF"==h["interface"]||"HmIP-HEATING"==h.type?k=xnm.aio.hm.HmIPChannel[g]:
"HM-Sec-Sir-WM"!=h.type||"SWITCH_SENSOR_1"!=g&&"SWITCH_SENSOR_2"!=g?"HM-WDS30-OT2-SM-2"!=h.type||"WEATHER_1"!=g&&"WEATHER_2"!=g&&"WEATHER_3"!=g&&"WEATHER_4"!=g||(k=xnm.aio.hm.Channel.WEATHER):k=xnm.aio.hm.Channel.SWITCH_SENSOR;k||(k=xnm.aio.hm.Channel[g]);k?k.handleStatusResponse?(f=k.handleStatusResponse(c[d],f.status),b.push({id:e,status:f})):b.push({id:e,status:c[e]}):b.push({id:e,status:"?"})}}else b.push({id:e,status:"?"})}return b},resolveState:function(a,c,d){if(!(a&&a.channels&&c&&c.channel&&
c.datapoint&&c["interface"]))return null;var b=c.channel.indexOf(":");if(-1==b)return null;if(a&&"BidCos-RF"==a["interface"]&&a.type){var e=xnm.aio.hm.BidCosDevice[a.type];if(e&&e.resolveState)return e.resolveState(a,c,d)}if(a&&"HmIP-RF"==a["interface"]&&a.type&&(e=xnm.aio.hm.HmIPDevice.resolveJSON(a))&&e.resolveState)return e.resolveState(a,c,d);b=c.channel.substr(b+1);var f;for(f in a.channels)if(a.channels.hasOwnProperty(f)&&a.channels[f].address==b){var g=f;"HM-Sec-Sir-WM"!=a.type||"SWITCH_SENSOR_1"!=
g&&"SWITCH_SENSOR_2"!=g?"HM-WDS30-OT2-SM-2"!=a.type||"WEATHER_1"!=g&&"WEATHER_2"!=g&&"WEATHER_3"!=g&&"WEATHER_4"!=g||(g="WEATHER"):g="SWITCH_SENSOR";break}if(!g)return null;var h;"BidCos-RF"==c["interface"]||"BidCos-Wired"==c["interface"]?h=xnm.aio.hm.Channel[g]:"HmIP-RF"==c["interface"]&&(h=xnm.aio.hm.HmIPChannel[g]);return h&&h.resolveState?h.resolveState(a,c,d):null},resolveDatapointInfo:function(a,c,d){if(!(a&&a["interface"]&&a.type&&a.address&&c)||"SysVar"==a.type||"Prog"==a.type)return null;
if("BidCos-RF"==a["interface"]||"BidCos-Wired"==a["interface"]){var b=xnm.aio.hm.DM._getChannels(a);var e=xnm.aio.hm.MAP}else if("HmIP-RF"==a["interface"])b=xnm.aio.hm.DM._getHmIPChannels(a),e=xnm.aio.hm.HMIP_MAP;else if("CUxD"==a["interface"])b=xnm.aio.hm.DM._getCUxDChannels(a),e=xnm.aio.hm.CUxDMAP;else return null;var f=null,g=null,h=null,k;for(k in b){var m=b[k],p=e[k];if(p){for(var t in m)if(m=p[t]){if(m=d?m.command:m.status)for(var r=0;r<m.length;r++)if(m[r].ref.value==c){g=t;break}if(g)break}if(g){f=
k;break}}}if(!f||!g)return null;for(k in a.channels)if(k==f){c=a.address;d=c.indexOf(":");-1!=d&&(c=c.substr(0,d));h=c+":"+a.channels[k].address;break}return h?{"interface":a["interface"],channel:h,channelType:f,datapoint:g}:null},getStatesCreator:function(a,c,d){for(var b=[],e=[],f=null,g=this,h=[],k=[],m=[],p=0;p<c.length;p++){var t=c[p],r=t.id,u=t.status,v=t.device;if(r&&v&&u)if(!v.type&&v.ip)"serviceMsg"==u.value?h.push(t):"ccuTime"==u.value?k.push(t):"cloudmaticState"==u.value&&m.push(t);else switch(v.type){case xnm.aio.hm.DM.SYSVAR:if(!v["class"]||
!xnm.aio.hm.SysVar[v["class"].toUpperCase()])continue;(f=xnm.aio.hm.SysVar[v["class"].toUpperCase()].buildStateScript(this,v,u))&&b.push({alias:r,script:f,device:v,status:u});break;case xnm.aio.hm.DM.PROG:continue;default:if(v&&"BidCos-RF"==v["interface"]&&v.type&&xnm.aio.hm.BidCosDevice[v.type]){var x=xnm.aio.hm.BidCosDevice[v.type];if(x.buildStateScript&&(f=x.buildStateScript(this,v,u))){b.push({alias:r,script:f,device:v,channel:null,status:u});break}}if(v&&"HmIP-RF"==v["interface"]){if((x=xnm.aio.hm.HmIPDevice.resolveJSON(v))&&
x.getBufferedState&&(t=x.getBufferedState(this,v,u),null!=t&&"undefined"!=typeof t)){e.push({alias:r,state:t});break}if(x&&x.buildStateScript&&(f=x.buildStateScript(this,v,u))){b.push({alias:r,script:f,device:v,channel:null,status:u});break}}if(v&&"VirtualDevices"==v["interface"]&&v.type&&(t=xnm.aio.hm.VirtualDevice[v.type])&&(t=new t,t.buildStateScript&&(f=t.buildStateScript(this,v,u)))){b.push({alias:r,script:f,device:v,channel:null,status:u});break}if(v.channels){x=v.channels;for(var y in x)if(x.hasOwnProperty(y)){var q=
null;"CUxD"==v["interface"]?q=xnm.aio.hm.CUxDChannel[y]:"HmIP-RF"==v["interface"]||"HmIP-HEATING"==v.type?q=xnm.aio.hm.HmIPChannel[y]:"HM-Sec-Sir-WM"!=v.type||"SWITCH_SENSOR_1"!=y&&"SWITCH_SENSOR_2"!=y?"HM-WDS30-OT2-SM-2"!=v.type||"WEATHER_1"!=y&&"WEATHER_2"!=y&&"WEATHER_3"!=y&&"WEATHER_4"!=y||(q=xnm.aio.hm.Channel.WEATHER):q=xnm.aio.hm.Channel.SWITCH_SENSOR;q||(q=xnm.aio.hm.Channel[y]);if(q&&q.getBufferedState&&(t=q.getBufferedState(this._statebuffer,v,v.channels[y],u),null!=t&&"undefined"!=typeof t)){e.push({alias:r,
state:t});break}if(q&&q.buildStateScript&&(f=q.buildStateScript(this,v,v.channels[y],u))){b.push({alias:r,script:f,device:v,channel:y,status:u});break}}}}}this.getCloudmaticStatus(a,m,function(c,m){"undefined"!=typeof a&&null!=a&&"undefined"!=typeof a.reportStates&&null!=a.reportStates&&!c&&m&&0<m.length&&a.reportStates(null,m);g.getServiceMessageStatus(a,h,function(c,h){g.getCCUStatus(a,k,function(a,c){0===b.length?(a=g.resolveStateResponse([],[],e),c&&(a=a?a.concat(c):c),h&&(a=a?a.concat(h):h),
m&&(a=a?a.concat(m):m),d&&d(null,a||[])):(f=g.buildScript(b),g._doRequest(f,!0,function(a,f){var k=null;if(a)d&&d(a);else{a=f.indexOf("<states>");var p=f.lastIndexOf("</states");if(p>a+8)try{k=f.substring(a+8,p);k=xnm.aio.hm.Util.decodeXml(k);var q=k.split("\r@@@\n");k={};for(f=0;f<q.length;f++){var t=q[f].indexOf("=");if(0<t){var v=q[f].substr(0,t);k[v]=q[f].substr(t+1)}}k=g.resolveStateResponse(b,k,e);c&&(k=k?k.concat(c):c);h&&(k=k?k.concat(h):h);m&&(k=k?k.concat(m):m);d&&d(null,k)}catch(L){d&&
d(Error("response format error"))}else d&&d(Error("response format error"))}}))})})})},getDeviceList:function(a){this._logger.log("debug","get device list from ccu:"+this.ip);var c=this;this._getDevices(function(d,b){d?a&&a(d):c._getSysvars(function(d,f){d?a&&a(d):c._getProgs(function(d,e){if(d)a&&a(d);else{d={devices:[],sysvars:[],progs:[]};var g,h;b&&b.devices&&(g=c._parseDevices(b.devices))&&0<g.length&&(d.devices=d.devices.concat(g));if(f&&f.systemvars){var p=f.systemvars;for(h in p)if(p.hasOwnProperty(h)){a:{var t=
f.systemvars[h],r=h;if(t.valuetype){switch(t.valuetype){case "2":g="binary";break;case "4":g="float";break;case "16":g="integer";break;case "20":g="string";break;default:g=null;break a}var u={};u.sys=xnm.aio.hm.DM.SYS;u.id=t.name;u.type=xnm.aio.hm.DM.SYSVAR;u.address=r;u["class"]=g;g=u}else g=null}g&&d.sysvars.push(g)}}if(e&&e.progs)for(h in p=e.progs,p)p.hasOwnProperty(h)&&(g=e.progs[h],t=h,g.name?(r={},r.sys=xnm.aio.hm.DM.SYS,r.id=g.name,r.address=t,r.type=xnm.aio.hm.DM.PROG,g=r):g=null,g&&d.progs.push(g));
...
c.length&&(d=d.concat(c));return d},_parseDevice:function(a){var c="HM-LC-Sw1-Ba-PCB HM-LC-Sw4-Ba-PCB HM-Sen-LI-O HM-Sec-SD HM-Sec-SD-Generic HM-Sec-Key HM-Sec-SCo HM-Sec-MDIR HM-Sen-MDIR-O HM-WDS40-TH-I HM-WDS40-TH-I-2 HM-WDS10-TH-O HM-WDS100-C6-O-2 HM-WDS100-C6-O HM-PB-6-WM55 HM-PB-2-WM55 HM-PB-4Dis-WM HM-SwI-3-FM HM-SCI-3-FM HM-PBI-4-FM HM-Sec-MDIR-2 HM-PB-2-WM55-2 HM-PB-2-FM HM-OU-CFM-TW".split(" "),d=function(a){return"WRAPPER"==a||"VIR-LG-RGBW-DIM-CH"==a?!1:!xnm.aio.hm.CHANNEL[a]||"VIRTUAL_DIMMER"==
a},b=function(a,b){if("CUxD"==a["interface"])if("WEATHER"==b.hsstype){if(a=b.datapoints)a:{b=b.datapoints;for(a=0;a<b.length;a++)if("BRIGHTNESS_WEST"==b[a]){a=!0;break a}a=!1}if(a)return"ENOCEAN_WEATHER2"}else if("SENSOR"==b.hsstype){if(a.channels.WEATHER&&a.channels.CLIMATECONTROL_REGULATOR&&a.channels.SWITCH)return"ENOCEAN_SENSOR_ERROR"}else if("SWITCH"==b.hsstype&&a.channels.SWITCH&&a.channels.POWERMETER)return"ENOCEAN_Bidi_Switch2";return null},e=function(a){var b=[],d=a.channels,e;for(e in d)if(d.hasOwnProperty(e)){var g=
a.channels[e];if(g.address){var f=g.address.indexOf(":");if(-1!==f){var h=g.address.substring(f+1);(0!=h||-1!=c.indexOf(a.hsstype))&&g.hsstype&&xnm.aio.hm.CHANNEL[g.hsstype]&&(f={},f.sys=xnm.aio.hm.DM.SYS,f.id=g.name?g.name:a.name,f.type=a.hsstype,f.address=g.address,f.rfAddr=a.rfAddr,f["interface"]=a["interface"],f.channels={},f.channels[g.hsstype]={id:g.name,address:h,room:g.room,group:g.func,datapoints:[]},b.push(f))}}}return b};if(!a.channels||!a["interface"])return null;if("VirtualDevices"==
a["interface"]&&xnm.aio.hm.VirtualDevice)return xnm.aio.hm.VirtualDevice.parseDevice(a);if("HmIP-RF"==a["interface"])return xnm.aio.hm.HmIPDevice.parseDevice(a);var f=[];if("BidCos-RF"==a["interface"]){if(f=xnm.aio.hm.BidCosDevice.parseDevice(a))return f;f=[]}var g=function(a){var b=a.channels;if(!b)return 0;var c=0,e=0,g={},f;for(f in b)if(b.hasOwnProperty(f)){var h=a.channels[f];if(h.address){var m=h.address.indexOf(":");-1!==m&&0!=h.address.substring(m+1)&&h.hsstype&&!d(h.hsstype)&&(c+=1,g[h.hsstype]=
!0)}}if(0==c)return 0;for(var k in g)g.hasOwnProperty(k)&&(e+=1);return c>e?c:1}(a);if(0==g)return null;if(1<g&&"CUxD"!=a.interface)return e(a);g={};g.sys=xnm.aio.hm.DM.SYS;g.id=a.name;g.type=a.hsstype;g.address=a.address;g.rfAddr=a.rfAddr;g["interface"]=a["interface"];g.channels={};var h=a.channels,k=!1,m;for(m in h)if(h.hasOwnProperty(m)&&(e=a.channels[m],e.address)){var p=e.address.indexOf(":");if(-1!==p&&(p=e.address.substring(p+1),(0!=p||-1!=c.indexOf(a.hsstype))&&e.hsstype)){if("CUxD"==g["interface"]){if(!xnm.aio.hm.CUxDCHANNEL[e.hsstype]&&
!xnm.aio.hm.CHANNEL[e.hsstype])continue}else if(d(e.hsstype))continue;if(g.channels[e.hsstype]){var t=g.channels[e.hsstype];k=t.id;t=t.address;var r=b(g,e);r?e.hsstype=r:(-1==g.address.indexOf(":")&&1==Object.keys(g.channels).length&&(g.address=g.address+":"+g.channels[e.hsstype].address),"CUxD"==g["interface"]&&(r=xnm.aio.hm.MHMCCU._resolveCUxDType(g))&&(g.cuxd=r),g.id=k?k:t,f.push(g),g={},g.sys=xnm.aio.hm.DM.SYS,g.id=a.name,"CUxD"==a["interface"]&&e.name&&(g.id=e.name),g.type=a.hsstype,g.address=
a.address+":"+p,g["interface"]=a["interface"],g.channels={})}k=!0;p={id:e.name,address:p,room:e.room,group:e.func,datapoints:[]};var u;t=p.datapoints;if("CUxD"==g["interface"])p.datapoints=e.datapoints;else for(u in e.datapoints)e.datapoints.hasOwnProperty(u)&&(r=e.datapoints[u],r={name:r.name,valuetype:r.valuetype,operations:r.operations},t.push(r));g.channels[e.hsstype]=p}}k&&f.push(g);"CUxD"==g["interface"]&&(r=xnm.aio.hm.MHMCCU._resolveCUxDType(g))&&(g.cuxd=r);return f},getCloudmaticStatus:function(a,
c,d){if(!c||0>=c.length)d&&d(null,[]);else{a=[];for(var b=0;b<c.length;b++){var e=c[b];if(e){var f=e.id;e=e.status;if(f&&e)switch(e.value){case "cloudmaticState":a.push({id:f,status:this._cloudmaticState})}}}d(null,a)}},getCCUStatus:function(a,c,d){!c||0>=c.length?d&&d(null,[]):(this._logger.log("debug","get ccu states:"+this.ip),this._doRequest('var ccutime=system.Date("%H:%M:%S").ToString();',!0,function(a,e){if(a)d&&d(a);else{if(!e)return null;a=[];var b=e.indexOf("<ccutime>"),g=e.lastIndexOf("</ccutime>");
if(g<=b+9)return null;e=e.substring(b+9,g);e=xnm.aio.hm.Util.decodeXml(e);for(b=0;b<c.length;b++){var h=c[b];if(h&&(g=h.id,h=h.status,g&&h))switch(h.value){case "ccuTime":a.push({id:g,status:e})}}d&&d(null,a)}}))},getServiceMessageStatus:function(a,c,d){!c||0>=c.length?d&&d(null,[]):this.getServiceMessage(function(a,e){if(a)d&&d(a);else if(e){a="";for(var b=[],g=0;g<e.length;g++)if(e[g].name&&e[g].error){switch(e[g].error){case "LOWBAT":var h="low battery";break;case "UNREACH":h="communication is interrupted";
break;case "STICKY_UNREACH":h="communication was interrupted";break;case "FAULT_REPORTING":h="reporing failure";break;case "ERROR":h="failure";break;default:h=e[g].error}a+=e[g].name+": "+h+"\n"}for(e=0;e<c.length;e++)if(h=c[e])if(g=h.id,h=h.status,g&&h)switch(h.value){case "serviceMsg":b.push({id:g,status:a})}d(null,b)}else d&&d(null,[])})},getServiceMessage:function(a){this._doRequest(xnm.aio.hm.MHMCCU._SCRIPT_GET_SEVICE_MESSAGE,!0,function(c,d){if(c)a&&a(c);else{if(d){c=d.indexOf("<res>");var b=
d.lastIndexOf("</res>");b<=c+5?d=null:(d=d.substring(c+5,b),d=xnm.aio.hm.Util.decodeXml(d),d=JSON.parse(d))}else d=null;a(null,d)}})},toJSON:function(){return{sys:xnm.aio.hm.DM.SYS,ip:this.ip,port:this.port,uuid:this.uuid,username:this.username,password:this.password,tclport:this.tclport,cloudmatic:this.cloudmatic,type:this.type}},equalsTo:function(a){return a&&a instanceof xnm.aio.hm.MHMCCU?this.ip==a.ip&&this.port==a.port&&this.username==a.username&&this.password==a.password:!1},_doRequestMarked:function(a,
c,d){this._doRequest(a,c,function(a,c){d&&d.execute.call(d,a,c)},5E3)},_doRequest:function(a,c,d,b){if("on"==this._cloudmaticState)this._doCloudmaticRequest(a,c,d,b);else{var e=this.port,f="/api/homematic.cgi";c&&(e=this.tclport,f="/tclrega.exe");var g=d;c={host:this.ip,port:e,path:f,method:"POST",headers:{"Content-Type":'text/xml; charset="ISO-8859-1"',"Content-Length":a.length,"User-Agent":"mediola",Connection:"close"}};if(this.username||this.password)c.auth=(this.username?this.username:"")+":"+
(this.password?this.password:""),c.headers.Authorization="Basic "+(new Buffer((this.username?this.username:"")+":"+(this.password?this.password:""))).toString("base64");d=JSON.parse(JSON.stringify(c));d.headers&&d.headers.Authorization&&(d.headers.Authorization="*********");d.auth&&(d.auth="********");var h=this._reqNo++;this._logger.log("trace","do request ["+h+"]:"+JSON.stringify(d));var k=this,m="",p=require("http").request(c,function(a){a.setEncoding("binary");a.on("data",function(a){m+=a});a.on("end",
function(){k._logger.log("trace","receive code ["+h+"]:"+a.statusCode+" response:"+m);var b;200!=a.statusCode&&(b=Error("post request failed with status code:"+a.statusCode));g&&g(b,m);g=null})});p.setEncoding&&p.setEncoding("ISO-8859-1");if(p.setTimeout){c=6E4;if(null==b||"undefined"==typeof b)b=0;b=parseInt(b);c=0<=b?b:c;0<c&&p.setTimeout(c,function(){k._logger.log("trace","do request timeout");p.abort()})}if(p.on&&"function"==typeof p.on)p.on("error",function(a){k._logger.log("trace","do request error:"+
(a?a.message:""));a||(a=Error("http request error"));g&&g(a);g=null});this._logger.log("trace","send body ["+h+"]:"+a);p.write(a);p.end()}},_doCloudmaticRequest:function(a,c,d,b){if(this.cloudmatic&&this.cloudmatic.id&&this.cloudmatic.username&&this.cloudmatic.password){var e=this.cloudmatic.id+".meine-homematic.de",f=this.port,g="/api/homematic.cgi";c&&(f=this.tclport,g="/tclrega.exe");var h=d;c={host:e,port:f,path:g,method:"POST",headers:{"Content-Type":'text/xml; charset="ISO-8859-1"',"Content-Length":a.length,
...
d.auth&&(d.auth="********");var k=this._reqNo++;this._logger.log("trace","do cloudmatic request ["+k+"]:"+JSON.stringify(d));var m=this,p="",t=require("http").request(c,function(a){a.setEncoding("binary");a.on("data",function(a){p+=a});a.on("end",function(){m._logger.log("trace","cloudmatic response code ["+k+"]:"+a.statusCode+" response:"+p);var b;200!=a.statusCode&&(b=Error("post request failed with status code:"+a.statusCode));h&&h(b,p);h=null})});t.setEncoding&&t.setEncoding("ISO-8859-1");if(t.setTimeout){c=
6E4;if(null==b||"undefined"==typeof b)b=0;b=parseInt(b);c=0<b?b:c;1E4>c&&(c=1E4);0<c&&t.setTimeout(c,function(){t.abort()})}if(t.on&&"function"==typeof t.on)t.on("error",function(a){a||(a=Error("http request error"));h&&h(a);h=null});this._logger.log("trace","send cloudmatic body ["+k+"]:"+a);t.write(a);t.end()}else d&&d(Error("cloudmatic config invalid"))}};
...
if(c.channels&&c.channels.DIMMER)var g=c.channels.DIMMER.address;if(f&&g)if("dimTo"==d.value||"dimRaw"==d.value||"dimOff"==d.value){c="LEVEL";b=0;switch(d.value){case "dimTo":case "dimRaw":b=parseFloat(d.ext);break;case "dimOff":b=0}a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()};e&&e()}else if("dimUp"==d.value||"dimDown"==d.value){c="LEVEL";if(b){d=b.indexOf("<v>");var h=b.indexOf("</v>");-1!=d&&-1!=h&&d+3<h&&(b=b.substr(d+3,h-d-3))&&(b=Math.round(1E4*parseFloat(b))/100,a._statebuffer[f+
":"+g+"."+c]={value:b,timestamp:(new Date).getTime()})}e&&e()}else"dimOn"==d.value||"toggleTo"==d.value?(delete a._statebuffer[f+":"+g+".LEVEL"],setTimeout(function(){e&&e()},3E3)):e&&e();else e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "dimmerLevel":var e="LEVEL"}return c&&d&&e&&a?(b=a[c+":"+d+"."+e],b&&null!=b.value&&"undefined"!=typeof b.value?3E3<=(new Date).getTime()-b.timestamp?(delete a[c+":"+d+"."+e],null):b.value:null):null},buildStateScript:function(a,
...
d.value||"dimDown"==d.value){c="LEVEL";if(b){d=b.indexOf("<v>");var h=b.indexOf("</v>");-1!=d&&-1!=h&&d+3<h&&(b=b.substr(d+3,h-d-3))&&(b=Math.round(1E4*parseFloat(b))/100,a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()})}e&&e()}else"dimOn"==d.value||"toggleTo"==d.value?(delete a._statebuffer[f+":"+g+".LEVEL"],setTimeout(function(){e&&e()},3E3)):e&&e();else e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "dimmerLevel":var e="LEVEL"}return c&&
...
d,a,b)},handleCommandResponse:function(a,c,d,b,e){var f=c.address;if(c.channels&&c.channels.BLIND)var g=c.channels.BLIND.address;if(f&&g)if("blindTo"==d.value||"blindRaw"==d.value){c="LEVEL";b=0;switch(d.value){case "blindTo":case "blindRaw":b=parseInt(d.ext)}a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()};e&&e()}else if("blindUp"==d.value||"blindDown"==d.value)delete a._statebuffer[f+":"+g+".LEVEL"],setTimeout(function(){e&&e()},3E3);else if("blindStop"==d.value)delete a._statebuffer[f+
":"+g+".LEVEL"],e&&e();else{if("blindStepUp"==d.value||"blindStepDown"==d.value){c="LEVEL";if(b){d=b.indexOf("<v>");var h=b.indexOf("</v>");-1!=d&&-1!=h&&d+3<h&&(b=b.substr(d+3,h-d-3))&&(b=Math.round(1E4*parseFloat(b))/100,a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()})}e&&e()}}else e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "blindLevel":var e="LEVEL"}return c&&d&&e&&a?(b=a[c+":"+d+"."+e],b&&null!=b.value&&"undefined"!=typeof b.value?
...
(30.5<b?30.5:b)+";o.State(v);}\n";break;case "themoBoostMode":a="BOOST_MODE";b="if(o!=null){o.State(1);}\n";break;case "themoComfortMode":a="COMFORT_MODE";b="if(o!=null){o.State(1);}\n";break;case "themoLoweringMode":a="LOWERING_MODE";b="if(o!=null){o.State(1);}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},handleCommandResponse:function(a,c,d,b,e){var f=c.address;if(c.channels&&c.channels.CLIMATECONTROL_RT_TRANSCEIVER)var g=c.channels.CLIMATECONTROL_RT_TRANSCEIVER.address;
if(f&&g)if("themoAutoMode"==d.value||"themoBoostMode"==d.value||"themoComfortMode"==d.value||"themoLoweringMode"==d.value)switch(c="CONTROL_MODE",d.value){case "themoAutoMode":a._statebuffer[f+":"+g+"."+c]={value:"auto",timestamp:(new Date).getTime()};break;case "themoBoostMode":a._statebuffer[f+":"+g+"."+c]={value:"boost",timestamp:(new Date).getTime()};break;case "themoComfortMode":delete a._statebuffer[f+":"+g+"."+c];break;case "themoLoweringMode":delete a._statebuffer[f+":"+g+"."+c]}else if("themoTempUp"==
d.value||"themoTempDown"==d.value){if(c="SET_TEMPERATURE",b){d=b.indexOf("<v>");var h=b.indexOf("</v>");-1!=d&&-1!=h&&d+3<h&&(b=b.substr(d+3,h-d-3))&&(b=Math.round(100*parseFloat(b))/100,a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()})}}else"themoTempTo"==d.value||"themoTempRaw"==d.value?(c="SET_TEMPERATURE",b=parseFloat(d.ext),a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()}):"themoTempOff"==d.value?a._statebuffer[f+":"+g+".SET_TEMPERATURE"]={value:4.5,
timestamp:(new Date).getTime()}:"themoManuMode"==d.value&&(c="SET_TEMPERATURE",b&&(d=b.indexOf("<v>"),h=b.indexOf("</v>"),-1!=d&&-1!=h&&d+3<h&&(b=b.substr(d+3,h-d-3)))&&(b=Math.round(100*parseFloat(b))/100,a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()}),a._statebuffer[f+":"+g+".CONTROL_MODE"]={value:"manu",timestamp:(new Date).getTime()});e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "themoSetTemp":var e="SET_TEMPERATURE";break;case "themoMode":e=
...
"LOWERING_MODE";b="if(o!=null){o.State(1);}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},handleCommandResponse:function(a,c,d,b,e){var f=c.address;if(c.channels&&c.channels.THERMALCONTROL_TRANSMIT)var g=c.channels.THERMALCONTROL_TRANSMIT.address;if(f&&g)if("themoTTempUp"==d.value||"themoTTempDown"==d.value){if(c="SET_TEMPERATURE",b){d=b.indexOf("<v>");var h=b.indexOf("</v>");-1!=d&&-1!=h&&d+3<h&&(b=b.substr(d+3,h-d-3))&&(b=Math.round(100*parseFloat(b))/100,a._statebuffer[f+
":"+g+"."+c]={value:b,timestamp:(new Date).getTime()})}}else"themoTTempRaw"==d.value||"themoTTempTo"==d.value?(c="SET_TEMPERATURE",b=parseFloat(d.ext),a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()}):"themoTTempOff"==d.value?a._statebuffer[f+":"+g+".SET_TEMPERATURE"]={value:4.5,timestamp:(new Date).getTime()}:"themoTManuMode"==d.value&&(c="SET_TEMPERATURE",b&&(d=b.indexOf("<v>"),h=b.indexOf("</v>"),-1!=d&&-1!=h&&d+3<h&&(b=b.substr(d+3,h-d-3))))&&(b=Math.round(100*parseFloat(b))/
100,a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()});e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "themoTSetTemp":var e="SET_TEMPERATURE"}return c&&d&&e&&a?(b=a[c+":"+d+"."+e],b&&null!=b.value&&"undefined"!=typeof b.value?3E3<=(new Date).getTime()-b.timestamp?(delete a[c+":"+d+"."+e],null):b.value:null):null},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "themoTMode":a="CONTROL_MODE";break;
...
"SETPOINT";b="if(o!=null){o.State(6.0);}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},handleCommandResponse:function(a,c,d,b,e){var f=c.address;if(c.channels&&c.channels.CLIMATECONTROL_REGULATOR)var g=c.channels.CLIMATECONTROL_REGULATOR.address;if(f&&g)if("themoRTempUp"==d.value||"themoRTempDown"==d.value){if(c="SETPOINT",b){d=b.indexOf("<v>");var h=b.indexOf("</v>");-1!=d&&-1!=h&&d+3<h&&(b=b.substr(d+3,h-d-3))&&(b=Math.round(100*parseFloat(b))/100,a._statebuffer[f+
":"+g+"."+c]={value:b,timestamp:(new Date).getTime()})}}else"themoRTempRaw"==d.value||"themoRTempTo"==d.value?(c="SETPOINT",b=parseFloat(d.ext),a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()}):"themoRTempClose"==d.value&&(a._statebuffer[f+":"+g+".SETPOINT"]={value:6,timestamp:(new Date).getTime()});e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "themoRSetTemp":var e="SETPOINT"}return c&&d&&e&&a?(b=a[c+":"+d+"."+e],b&&null!=b.value&&"undefined"!=
...
c,d,b,e){var f=c.address;if(c.channels&&c.channels.JALOUSIE)var g=c.channels.JALOUSIE.address;if(f&&g)if("jalRaw"==d.value)c="LEVEL",b=parseInt(d.ext),a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()},e&&e();else if("jalUp"==d.value||"jalDown"==d.value)delete a._statebuffer[f+":"+g+".LEVEL"],setTimeout(function(){e&&e()},3E3);else if("jalStop"==d.value)delete a._statebuffer[f+":"+g+".LEVEL"],delete a._statebuffer[f+":"+g+".LEVEL_SLATS"],e&&e();else if("jalStepUp"==d.value||"jalStepDown"==
d.value){c="LEVEL";if(b){d=b.indexOf("<v>");var h=b.indexOf("</v>");-1!=d&&-1!=h&&d+3<h&&(b=b.substr(d+3,h-d-3))&&(b=Math.round(1E4*parseFloat(b))/100,a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()})}e&&e()}else if("jalLmlRaw"==d.value)c="LEVEL_SLATS",b=parseInt(d.ext),a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()},e&&e();else if("jalLmlUp"==d.value||"jalLmlDown"==d.value)delete a._statebuffer[f+":"+g+".LEVEL_SLATS"],setTimeout(function(){e&&e()},3E3);
else{if("jalLmlStepUp"==d.value||"jalLmlStepDown"==d.value)c="LEVEL_SLATS",b&&(d=b.indexOf("<v>"),h=b.indexOf("</v>"),-1!=d&&-1!=h&&d+3<h&&(b=b.substr(d+3,h-d-3)))&&(b=Math.round(1E4*parseFloat(b))/100,a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()}),e&&e()}else e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "jalLevel":var e="LEVEL";break;case "jalLmlLevel":e="LEVEL_SLATS"}return c&&d&&e&&a?(b=a[c+":"+d+"."+e],b&&null!=b.value&&"undefined"!=
...
");}else{o.State(0.0);}}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},handleCommandResponse:function(a,c,d,b,e){var f=c.address;if(c.channels&&c.channels.DIMMER)var g=c.channels.DIMMER.address;if(f&&g)if("dualWBToggleTo"==d.value||"dualWBOff"==d.value){c="LEVEL";b=0;switch(d.value){case "dualWBToggleTo":b=parseFloat(d.ext);break;case "dualWBOff":b=0}a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()};e&&e()}else if("dualWBUp"==d.value||"dualWBDown"==
d.value){c="LEVEL";if(b){d=b.indexOf("<v>");var h=b.indexOf("</v>");-1!=d&&-1!=h&&d+3<h&&(b=b.substr(d+3,h-d-3))&&(b=Math.round(1E4*parseFloat(b))/100,a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()})}e&&e()}else"dualWBOn"==d.value||"dualWBToggleTo"==d.value?(delete a._statebuffer[f+":"+g+".LEVEL"],setTimeout(function(){e&&e()},3E3)):e&&e();else e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "dualWBLevel":var e="LEVEL"}return c&&d&&e&&
...
b="if(o!=null){real des = 0.0+o.Value(); if(des == 0.0){o.State("+(1<b?1:b).toFixed(2)+");}else{o.State(0.0);}}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},handleCommandResponse:function(a,c,d,b,e){var f=c.address;if(c.channels&&c.channels.DIMMER)var g=c.channels.DIMMER.address;f&&g?"dualWCOff"==d.value?(a._statebuffer[f+":"+g+".LEVEL"]={value:0,timestamp:(new Date).getTime()},e&&e()):"dualWCUp"==d.value||"dualWCDown"==d.value?(b&&(c=b.indexOf("<v>"),d=b.indexOf("</v>"),
-1!=c&&-1!=d&&c+3<d&&(b=b.substr(c+3,d-c-3)))&&(b=Math.round(1E4*parseFloat(b))/100,a._statebuffer[f+":"+g+".LEVEL"]={value:b,timestamp:(new Date).getTime()}),e&&e()):"dualWCOn"==d.value?(delete a._statebuffer[f+":"+g+".LEVEL"],setTimeout(function(){e&&e()},3E3)):e&&e():e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "dualWCLevel":var e="LEVEL"}return c&&d&&e&&a?(b=a[c+":"+d+"."+e],b&&null!=b.value&&"undefined"!=typeof b.value?3E3<=(new Date).getTime()-b.timestamp?
...
c,d,b);case "dimOn":case "dimOff":case "dimUp":case "dimDown":case "dimRaw":return xnm.aio.hm.Channel.DIMMER.buildCommandScript(a,c,d,b);case "dimToggle":a="TOGGLE";script="if(o!=null){o.State(1);}\n";break;case "dimStop":a="STOP";script="if(o!=null){o.State(1);}\n";break;case "dimColor":case "dimColorS":if(null==b.ext||"undefined"==typeof b.ext)return null;var e=b.ext;b=parseInt(e.substr(0,2),16);var f=parseInt(e.substr(2,2),16),g=parseInt(e.substr(4,2),16);e=parseInt(e.substr(6,2),16);if(isNaN(b)||
isNaN(f)||isNaN(g))return null;255<b&&(b=255);255<f&&(f=255);255<g&&(g=255);isNaN(e)&&(e=255);a="RGBW";script='if(o!=null){o.State("'+(b+","+f+","+g+","+e)+'");}\n';break;case "dimColorTemp":if(null==b.ext||"undefined"==typeof b.ext)return null;e=parseFloat(b.ext);if(isNaN(e))return null;a="WHITE";script="if(o!=null){o.State("+e+");}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,script)},handleCommandResponse:function(a,c,d,b,e){"dimTo"==d.value||"dimRaw"==d.value||
"dimOn"==d.value||"dimOff"==d.value||"dimToggle"==d.value||"dimColor"==d.value||"dimColorTemp"==d.value?setTimeout(function(){e&&e()},3E3):e&&e()},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "switchState":return xnm.aio.hm.Channel.SWITCH.buildStateScript(a,c,d,b);case "dimmerLevel":return xnm.aio.hm.Channel.DIMMER.buildStateScript(a,c,d,b);case "dimmerColor":a="RGBW";break;case "dimmerColorTemp":a="WHITE";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,
d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "switchState":return xnm.aio.hm.Channel.SWITCH.handleStatusResponse(a,c);case "dimmerLevel":return xnm.aio.hm.Channel.DIMMER.handleStatusResponse(a,c);case "dimmerColor":if(!a||"rgb("!=a.substr(0,4))return"?";a=a.substring(4,a.length-1);try{var d=a.split(","),b=parseInt(d[0]).toString(16);2!=b.length&&(b="0"+b);var e=parseInt(d[1]).toString(16);2!=e.length&&(e="0"+e);var f=parseInt(d[2]).toString(16);2!=f.length&&(f=
"0"+f);var g=parseInt(d[3]).toString(16);2!=g.length&&(g="0"+g);return b.toUpperCase()+e.toUpperCase()+f.toUpperCase()+g.toUpperCase()}catch(h){return"?"}case "dimmerColorTemp":return xnm.aio.hm.Util.formatFloatString(a);default:return"?"}}},CLIMATECONTROL_REGULATOR:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;a=null;switch(b.value){case "themoRTempUp":b="SETPOINT";a="if(o!=null){var v=o.Value()+2;if(v>99.5){v=99.5;}o.State(v);}\n";break;case "themoRTempDown":b="SETPOINT";
...
break;case "themoRValveOpen":b="STATE";a="if(o!=null){o.State(1);}\n";break;case "themoRValveClose":b="STATE";a="if(o!=null){o.State(0);}\n";break;case "themoRModeAuto":b="MODE_TEMPERATUR_REGULATOR";a="if(o!=null){o.State(0);}\n";break;case "themoRModeManu":b="MODE_TEMPERATUR_REGULATOR";a="if(o!=null){o.State(1);}\n";break;case "themoRComfortTempTo":case "themoRComfortTempRaw":if(null==b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)e=b.ext;else if(b.ext.match(/^[-+]?[0-9]*\.?[0-9]+$/))e=
parseFloat(b.ext);else return null;b="TEMPERATUR_COMFORT_VALUE";e=0>e?0:e;a="if(o!=null){o.State("+(99.5<e?99.5:e)+");}\n";break;case "themoRLowerTempTo":case "themoRLowerTempRaw":if(null==b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)e=b.ext;else if(b.ext.match(/^[-+]?[0-9]*\.?[0-9]+$/))e=parseFloat(b.ext);else return null;b="TEMPERATUR_LOWERING_VALUE";e=0>e?0:e;a="if(o!=null){o.State("+(99.5<e?99.5:e)+");}\n";break;case "themoRWinTempTo":case "themoRWinTempRaw":if(null==
b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)e=b.ext;else if(b.ext.match(/^[-+]?[0-9]*\.?[0-9]+$/))e=parseFloat(b.ext);else return null;b="TEMPERATUR_WINDOW_OPEN_VALUE";e=0>e?0:e;a="if(o!=null){o.State("+(99.5<e?99.5:e)+");}\n";break;case "themoRSetPartyEnd":if(null==b.ext||"undefined"==typeof b.ext)return null;e=b.ext;b="PARTY_END_TIME";a="if(o!=null){o.State('"+e+"');}\n";break;case "themoRValveState":if(null==b.ext||void 0==b.ext)return null;if("number"==typeof b.ext)e=
parseInt(b.ext);else if(b.ext.match(/^[-+]?[0-9]+$/))e=b.ext;else return null;b="VALVE_STATE";a+="if(o!=null){o.State("+e+");}\n";break;case "themoRSummerOn":b="SUMMER_MODE";a="if(o!=null){o.State(1);}\n";break;case "themoRSummerOff":b="SUMMER_MODE";a="if(o!=null){o.State(0);}\n";break;case "themoRSummerToggle":b="SUMMER_MODE";a="if(o!=null){if(o.Value()){o.State(0);}else{o.State(1);}}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,b,a)},buildStateScript:function(a,
...
d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "errorSdBat":case "errorSdComm":return a;default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "LOW_BAT":var b="errorSdBat";break;case "UNREACH":b="errorSdComm"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},MAINTENANCE_BAT_EL:{buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "errorBatElDutyCycle":a="DUTY_CYCLE";break;
case "errorBatElCode":a="ERROR_CODE";break;case "errorBatElBat":a="LOW_BAT";break;case "errorBatElVoltage":a="OPERATING_VOLTAGE";break;case "errorBatElSensor":a="SENSOR_ERROR";break;case "errorBatElComm":a="UNREACH";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "errorBatElDutyCycle":case "errorBatElBat":case "errorBatElSensor":case "errorBatElComm":return a;case "errorBatElCode":return parseInt(a);
case "errorBatElVoltage":return parseFloat(a);default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "DUTY_CYCLE":var b="errorBatElDutyCycle";break;case "ERROR_CODE":b="errorBatElCode";break;case "LOW_BAT":b="errorBatElBat";break;case "OPERATING_VOLTAGE":b="errorBatElVoltage";break;case "SENSOR_ERROR":b="errorBatElSensor";break;case "UNREACH":b="errorBatElComm"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},KEY_TRANSCEIVER:{buildCommandScript:function(a,
c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "pressShort":a="PRESS_SHORT";b="if(o!=null){o.State(1);}\n";break;case "pressLong":a="PRESS_LONG";b="if(o!=null){o.State(1);}\n";break;default:return null}if("HmIP-RCV-50"==c.type){var e='var o;o=dom.GetObject("HmIP-RF.'+(c.address+":"+d.address+"."+a+'");\n');"HmIP-RCV"!=c.address.substr(0,8)&&(e+='if(!o){o=dom.GetObject("HmIP-RF.HmIP-RCV-1:'+(d.address+"."+a)+'");}\n');return e+b+'o="";\n'}return xnm.aio.hm.Channel.buildCommandScript(c,
d,a,b)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "pressShort":case "pressLong":return!0;default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "PRESS_SHORT":var b="pressShort";break;case "PRESS_LONG":b="pressLong"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}},getIPEvtMap:function(a){if(a&&0!=a.length&&1!=a.length){for(var c={ipevt:[]},d=1;d<=a.length;d++)c.ipevt.push({type:"enum",name:"button "+d+" short press",
ref:{value:"btn"+d+"pressShort",options:["true"]}}),c.ipevt.push({type:"enum",name:"button "+d+" long press",ref:{value:"btn"+d+"pressLong",options:["true"]}});return c}return{ipevt:[{type:"enum",name:"short press",ref:{value:"pressShort",options:["true"]}},{type:"enum",name:"long press",ref:{value:"pressLong",options:["true"]}}]}}},SWITCH_TRANSMITTER:{buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "switchTState":break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,
d,"STATE")},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "switchTState":return"true"==a?"on":"off";default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "STATE":var b="switchTState"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},SWITCH_VIRTUAL_RECEIVER:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;a=null;switch(b.value){case "on":b="STATE";a="if(o!=null){o.State(1);}\n";break;case "off":b=
"STATE";a="if(o!=null){o.State(0);}\n";break;case "toggle":b="STATE";a="if(o!=null){if(o.Value()){o.State(0);}else{o.State(1);}}\n";break;case "onFor":if("undefined"==typeof b.ext||null==b.ext)return null;a='var o;o=dom.GetObject("'+(c["interface"]+"."+c.address+":"+d.address+'.ON_TIME");\n');a+="if(o!=null){o.State("+parseFloat(b.ext)+");}\n";a+='o=dom.GetObject("'+c["interface"]+"."+c.address+":"+d.address+'.STATE");\n';return a+'if(o!=null){o.State(1.0);}\no="";\n';case "setProfile":return"undefined"!=
typeof b.ext&&null!=b.ext&&c.device?a:null;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,b,a)},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "switchState":break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,"STATE")},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "switchState":return"true"==a?"on":"off";default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "STATE":var b=
"switchState"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},SWITCH_WEEK_PROFILE:{buildCommandScript:function(a,c,d,b){if(!(c.channels&&d&&d.address&&b.value))return null;var e;switch(b.value){case "setProfile":if(!b.ext)return null;a=e=null;for(var f=0;f<b.ext.length;f++){var g=b.ext[f];if(g)switch(g.value){case "mode":e=g.ext;break;case "channels":a=g.ext}}if("undefined"==typeof e||null==e||"undefined"==typeof a||null==a)return null;b=2;"manu"==e&&(b=0);e=
'var o;o=dom.GetObject("'+(c["interface"]+"."+c.address+":"+d.address+'.WEEK_PROGRAM_TARGET_CHANNEL_LOCKS");\n');e=e+("if(o!=null){o.State("+a+');}\no=dom.GetObject("')+(c["interface"]+"."+c.address+":"+d.address+'.WEEK_PROGRAM_TARGET_CHANNEL_LOCK");\n');e+="if(o!=null){o.State("+parseInt(b)+");}\n";return e+'o="";\n';default:return null}},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "profile":break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,
d,"WEEK_PROGRAM_CHANNEL_LOCKS")},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "profile":return parseInt(a);default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "WEEK_PROGRAM_CHANNEL_LOCKS":var b="profile"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},SHUTTER_CONTACT:{buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "shutterState":break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,
...
d,"STATE")},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "shutterTState":return 1==a?"open":"closed";default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "STATE":var b="shutterTState"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},HEATING_CLIMATECONTROL_TRANSCEIVER:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;var e=null;switch(b.value){case "themoProf":if(null==b.ext||"undefined"==
typeof b.ext)return null;if("number"==typeof b.ext)b=b.ext;else if(b.ext.match(/^\d+$/))b=parseInt(b.ext);else return null;a="ACTIVE_PROFILE";b="if(o!=null){o.State("+b+");}\n";break;case "themoBoostOn":a="BOOST_MODE";b="if(o!=null){o.State(1);}\n";break;case "themoBoostOff":a="BOOST_MODE";b="if(o!=null){o.State(0);}\n";break;case "themoAutoMode":a="CONTROL_MODE";b="if(o!=null){o.State(0);}\n";break;case "themoManuMode":a="CONTROL_MODE";b="if(o!=null){o.State(1);}\n";break;case "themoTempUp":a._statebuffer&&
(e=this.getBufferedState(a._statebuffer,c,d,{value:"themoTemp"}));b=null==e||"undefined"==typeof e?"if(o!=null){var v=o.State()+0.5;if(v>30.5){v=30.5;}o.State(v);}\n":"if(o!=null){var v="+e+"+0.5;if(v>30.5){v=30.5;}o.State(v);}\n";a="SET_POINT_TEMPERATURE";break;case "themoTempDown":a._statebuffer&&(e=this.getBufferedState(a._statebuffer,c,d,{value:"themoTemp"}));b=null==e||"undefined"==typeof e?"if(o!=null){var v=o.State()-0.5;if(v<4.5){v=4.5;}o.State(v);}\n":"if(o!=null){var v="+e+"-0.5;if(v<4.5){v=4.5;}o.State(v);}\n";
a="SET_POINT_TEMPERATURE";break;case "themoTemp":if(null==b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)b=b.ext;else if(b.ext.match(/^[-+]?[0-9]*\.?[0-9]+$/))b=parseFloat(b.ext);else return null;a="SET_POINT_TEMPERATURE";b=4.5>b?4.5:b;b="if(o!=null){o.State("+(30.5<b?30.5:b)+");}\n";break;case "themoTempOn":a="SET_POINT_TEMPERATURE";b="if(o!=null){o.State(30.5);}\n";break;case "themoTempOff":a="SET_POINT_TEMPERATURE";b="if(o!=null){o.State(4.5);}\n";break;case "themoValveLevel":if(null==
b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)b=b.ext;else if(b.ext.match(/^\d+$/))b=parseInt(b.ext);else return null;0>b&&(b=0);100<b&&(b=100);a="LEVEL";b="if(o!=null){o.State("+b/100+");}\n";break;case "themoWinOpen":a="WINDOW_STATE";b="if(o!=null){o.State(1);}\n";break;case "themoWinClose":a="WINDOW_STATE";b="if(o!=null){o.State(0);}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},handleCommandResponse:function(a,c,d,b,e){var f=c.address;
if(c.channels&&c.channels.HEATING_CLIMATECONTROL_TRANSCEIVER)var g=c.channels.HEATING_CLIMATECONTROL_TRANSCEIVER.address;if(f&&g)if("themoTempUp"==d.value||"themoTempDown"==d.value){if(c="SET_POINT_TEMPERATURE",b){d=b.indexOf("<v>");var h=b.indexOf("</v>");-1!=d&&-1!=h&&d+3<h&&(b=b.substr(d+3,h-d-3))&&(b=parseFloat(b).toFixed(1),a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()})}}else"themoTemp"==d.value?(c="SET_POINT_TEMPERATURE",b=parseFloat(d.ext),a._statebuffer[f+":"+g+"."+
c]={value:b,timestamp:(new Date).getTime()}):"themoTempOff"==d.value?a._statebuffer[f+":"+g+".SET_POINT_TEMPERATURE"]={value:4.5,timestamp:(new Date).getTime()}:"themoTempOn"==d.value&&(a._statebuffer[f+":"+g+".SET_POINT_TEMPERATURE"]={value:30.5,timestamp:(new Date).getTime()});e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "themoTemp":var e="SET_POINT_TEMPERATURE"}return c&&d&&e&&a?(b=a[c+":"+d+"."+e],b&&null!=b.value&&"undefined"!=typeof b.value?5E3<=(new Date).getTime()-
b.timestamp?(delete a[c+":"+d+"."+e],null):b.value:null):null},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "themoProf":a="ACTIVE_PROFILE";break;case "themoActualTemp":a="ACTUAL_TEMPERATURE";break;case "themoBoostMode":a="BOOST_MODE";break;case "themoFrost":a="FROST_PROTECTION";break;case "themoHum":a="HUMIDITY";break;case "themoMode":a="SET_POINT_MODE";break;case "themoTemp":a="SET_POINT_TEMPERATURE";break;case "themoValveLevel":a="LEVEL";break;case "themoWinState":a=
"WINDOW_STATE";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "themoProf":case "themoHum":return parseInt(a);case "themoActualTemp":case "themoTemp":return parseFloat(a).toFixed(1);case "themoBoostMode":case "themoFrost":return"true"==a?"on":"off";case "themoMode":switch(a){case "0":return"auto";case "1":return"manu";default:return"?"}case "themoValveLevel":return Math.round(100*parseFloat(a));
case "themoWinState":switch(a){case "1":case "2":return"open";case "0":return"closed";default:return"?"}default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "ACTIVE_PROFILE":var b="themoProf";break;case "ACTUAL_TEMPERATURE":b="themoActualTemp";break;case "BOOST_MODE":b="themoBoostMode";break;case "FROST_PROTECTION":b="themoFrost";break;case "HUMIDITY":b="themoHum";break;case "SET_POINT_MODE":b="themoMode";break;case "SET_POINT_TEMPERATURE":b="themoTemp";break;case "LEVEL":b="themoValveLevel";
break;case "WINDOW_STATE":b="themoWinState"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},MOTIONDETECTOR_TRANSCEIVER:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "motionOn":a="MOTION_DETECTION_ACTIVE";b="if(o!=null){o.State(1);}\n";break;case "motionOff":a="MOTION_DETECTION_ACTIVE";b="if(o!=null){o.State(0);}\n";break;case "motionToggle":a="MOTION_DETECTION_ACTIVE";b="if(o!=null){if(o.Value()){o.State(0);}else{o.State(1);}}\n";
break;case "motionReset":a="RESET_MOTION";b="if(o!=null){o.State(1);}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "motionIllu":a="ILLUMINATION";break;case "motionState":a="MOTION";break;case "motionActivate":a="MOTION_DETECTION_ACTIVE";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "motionIllu":return parseFloat(a).toFixed(2);
case "motionState":return"true"==a?"on":"off";case "motionActivate":return"true"==a?"on":"off";default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "ILLUMINATION":var b="motionIllu";break;case "MOTION":b="motionState";break;case "MOTION_DETECTION_ACTIVE":b="motionActivate"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},ENERGIE_METER_TRANSMITTER:{buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "meterEnergyCounter":a=
"ENERGY_COUNTER";break;case "meterPower":a="POWER";break;case "meterCurrent":a="CURRENT";break;case "meterVoltage":a="VOLTAGE";break;case "meterFrequency":a="FREQUENCY";break;default:return null}return'o=dom.GetObject("'+xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,a)+'");if(o!=null){states=states#o.Value();}else{states=states#"?";}'},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "meterEnergyCounter":return xnm.aio.hm.Util.formatFloatString(a);case "meterPower":return xnm.aio.hm.Util.formatFloatString(a);
...
"",{value:b});return{key:b,value:a}},getCommandStatusMap:function(){return{status:[{type:"float",name:"voltage",ref:{value:"meterVoltage",extMeta:"0.0-409.5",scale:"0.1",unit:"V"}},{type:"float",name:"energy counter",ref:{value:"meterEnergyCounter",extMeta:"0.0-838859.1",scale:"0.1",unit:"Wh"}},{type:"float",name:"frequency",ref:{value:"meterFrequency",extMeta:"29.52-70.47",scale:"0.01",unit:"Hz"}},{type:"float",name:"power",ref:{value:"meterPower",extMeta:"0.0-163830.0",scale:"0.1",unit:"W"}},{type:"float",
name:"current",ref:{value:"meterCurrent",extMeta:"0.0-65535.0",scale:"0.1",unit:"mA"}}]}},getIPEvtMap:function(){return{ipevt:this.getCommandStatusMap().status}}},SMOKE_DETECTOR:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "intrusionAlarmOff":a="SMOKE_DETECTOR_COMMAND";b="if(o!=null){o.State(1);}\n";break;case "intrusionAlarmOn":a="SMOKE_DETECTOR_COMMAND";b="if(o!=null){o.State(2);}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,
d,a,b)},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "smokeState":case "smokeAlarmDetail":break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,"SMOKE_DETECTOR_ALARM_STATUS")},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "smokeState":return 0==a?"off":"on";case "smokeAlarmDetail":if(0==a)return"off";if(1==a)return"primary_alarm";if(2==a)return"intrusion_alarm";if(3==a)return"secondary_alarm";break;default:return"?"}},
resolveState:function(a,c,d){switch(c.datapoint){case "SMOKE_DETECTOR_ALARM_STATUS":a=[];var b="smokeState";c=this.handleStatusResponse(d+"",{value:b});a.push({key:b,value:c});b="smokeAlarmDetail";c=this.handleStatusResponse(d+"",{value:b});a.push({key:b,value:c});return a}if(!b)return null;c=this.handleStatusResponse(d+"",{value:b});return{key:b,value:c}}},DIMMER_TRANSMITTER:{buildStateScript:function(a,c,d,b){if(!b.value)return null;switch(b.value){case "dimmerTLevel":a="LEVEL";break;case "dimmerTColor":a=
"COLOR";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "dimmerTLevel":return a=parseFloat(a),Math.round(100*a);case "dimmerTColor":return a=parseFloat(a),"off blue green torqoise red purple yellow white".split(" ")[a];default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "LEVEL":var b="dimmerTLevel";break;case "COLOR":b="dimmerTColor"}if(!b)return null;a=this.handleStatusResponse(d+
"",{value:b});return{key:b,value:a}}},DIMMER_VIRTUAL_RECEIVER:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;var e=null,f=null;e=f=null;switch(b.value){case "dimOn":e="LEVEL";f="if(o!=null){o.State(1.005);}\n";break;case "dimOff":e="LEVEL";f="if(o!=null){o.State(0.0);}\n";break;case "dimUp":f=null==b.ext||"undefined"==typeof b.ext?.1:"number"==typeof b.ext?(parseInt(b.ext)/100).toFixed(2):b.ext.match(/^[-+]?[0-9]+$/)?(parseInt(b.ext)/100).toFixed(2):.1;a._statebuffer&&
(e=this.getBufferedState(a._statebuffer,c,d,{value:"dimmerLevel"}));f=null==e||"undefined"==typeof e?"if(o!=null){var v=o.Value()+"+f+";if(v>1){v=1.0;}o.State(v);}\n":"if(o!=null){var v="+e/100+"+"+f+";if(v>1){v=1.0;}o.State(v);}\n";e="LEVEL";break;case "dimDown":f=null==b.ext||"undefined"==typeof b.ext?.1:"number"==typeof b.ext?(parseInt(b.ext)/100).toFixed(2):b.ext.match(/^[-+]?[0-9]+$/)?(parseInt(b.ext)/100).toFixed(2):.1;a._statebuffer&&(e=this.getBufferedState(a._statebuffer,c,d,{value:"dimmerLevel"}));
f=null==e||"undefined"==typeof e?"if(o!=null){var v=o.Value()-"+f+";if(v<0){v=0.0;}o.State(v);}\n":"if(o!=null){var v="+e/100+"-"+f+";if(v<0){v=0.0;}o.State(v);}\n";e="LEVEL";break;case "dimTo":if(null==b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)f=parseInt(b.ext);else if(b.ext.match(/^[-+]?[0-9]+$/))f=b.ext;else return null;e="LEVEL";f/=100;f=0>f?0:f;f="if(o!=null){o.State("+(1<f?1:f)+");}\n";break;case "toggleTo":if(null==b.ext||"undefined"==typeof b.ext)return null;if("number"==
typeof b.ext)f=parseInt(b.ext);else if("string"==typeof b.ext)f=b.ext.replace("%",""),f=parseInt(f);else return null;e="LEVEL";f/=100;f=0>f?0:f;f="if(o!=null){var v=0.0;real des = 0.0+o.Value(); if(des == 0.0){v="+(1<f?1:f).toFixed(2)+";o.State(v);}else{o.State(v);}}\n";break;case "color":if(null==b.ext||"undefined"==typeof b.ext)return null;switch(b.ext){case "off":f=0;break;case "blue":f=1;break;case "green":f=2;break;case "torqoise":f=3;break;case "red":f=4;break;case "purple":f=5;break;case "yellow":f=
6;break;case "white":f=7}e="COLOR";f="if(o!=null){o.State("+f+");}\n";break;case "colorPlay":case "colorPlayList":var g=[],h=[];if(!b.ext)return null;for(a=0;a<b.ext.length;a++)if(f=b.ext[a])switch(f.value){case "colorList":var k=f.ext;break;case "colorOnTime":var m=f.ext;break;case "colorLevel":var p=parseInt(f.ext);break;case "colorDur":var t=parseInt(f.ext);break;case "colorDurUnit":var r=f.ext;break;case "colorRepeat":var u=parseInt(f.ext)}if("undefined"==typeof k||null==k||"undefined"==typeof p||
null==p||"undefined"==typeof t||null==t||"undefined"==typeof r||null==r||"undefined"==typeof u||null==u||"undefined"==typeof m||null==m)return null;"colorPlay"==b.value?(h.push("100MS 200MS 300MS 400MS 500MS 700MS 1S 2S 3S 5S 7S 10S 20S 40S 50S ALWAYS".split(" ").indexOf(m)),g.push("off blue green torqoise red purple yellow white".split(" ").indexOf(k))):(b=k.split(","),b.forEach(function(a){g.push("off blue green torqoise red purple yellow white".split(" ").indexOf(a))}),b=m.split(","),b.forEach(function(a){h.push("100MS 200MS 300MS 400MS 500MS 700MS 1S 2S 3S 5S 7S 10S 20S 40S 50S ALWAYS".split(" ").indexOf(a))}));
r=["S","M","H","10MS"].indexOf(r);p/=100;if(0==g.length)return null;f="";m=null;m=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"DURATION_UNIT");f+='(datapoints.Get("'+m+'")).State('+r+");\n";m=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"LEVEL");f+='(datapoints.Get("'+m+'")).State('+p+");\n";m=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"RAMP_TIME_UNIT");f+='(datapoints.Get("'+m+'")).State(0);\n';m=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"RAMP_TIME_VALUE");f+='(datapoints.Get("'+m+'")).State(0);\n';
m=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"OUTPUT_SELECT_SIZE");f+='(datapoints.Get("'+m+'")).State('+g.length+");\n";m=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"REPETITIONS");f+='(datapoints.Get("'+m+'")).State('+u+");\n";for(a=1;a<=g.length;a++)m=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"COLOR_LIST_"+a),f+='(datapoints.Get("'+m+'")).State('+g[a-1]+");\n",m=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"ON_TIME_LIST_"+a),f+='(datapoints.Get("'+m+'")).State('+h[a-1]+");\n";m=xnm.aio.hm.MHMCCU._getDataPointAddress(c,
d,"DURATION_VALUE");return f+('(datapoints.Get("'+m+'")).State('+t+");\n");default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,e,f)},handleCommandResponse:function(a,c,d,b,e){var f=c.address;if(c.channels&&c.channels.DIMMER)var g=c.channels.DIMMER.address;if(f&&g)if("dimTo"==d.value||"dimOff"==d.value){c="LEVEL";switch(d.value){case "dimTo":var h=parseFloat(d.ext);break;case "dimOff":h=0}a._statebuffer[f+":"+g+"."+c]={value:h,timestamp:(new Date).getTime()};e&&e()}else"dimUp"==d.value||
"dimDown"==d.value?(c="LEVEL",b&&(d=b.indexOf("<v>"),h=b.indexOf("</v>"),-1!=d&&-1!=h&&d+3<h&&(h=b.substr(d+3,h-d-3)))&&(h=Math.round(100*parseFloat(h)),a._statebuffer[f+":"+g+"."+c]={value:h,timestamp:(new Date).getTime()}),e&&e()):"toggleTo"==d.value?(delete a._statebuffer[f+":"+g+".LEVEL"],setTimeout(function(){e&&e()},3E3)):e&&e();else e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "dimmerLevel":var e="LEVEL"}return c&&d&&e&&a?(b=a[c+":"+d+"."+e],b&&null!=
...
"dimmerLevel"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},DIMMER_WEEK_PROFILE:{buildCommandScript:function(a,c,d,b){if(!(c.channels&&d&&d.address&&b.value))return null;var e;switch(b.value){case "setProfile":if(!b.ext)return null;a=e=null;for(var f=0;f<b.ext.length;f++){var g=b.ext[f];if(g)switch(g.value){case "mode":e=g.ext;break;case "channels":a=g.ext}}if("undefined"==typeof e||null==e||"undefined"==typeof a||null==a)return null;b=2;"manu"==e&&(b=0);e=
'var o;o=dom.GetObject("'+(c["interface"]+"."+c.address+":"+d.address+'.WEEK_PROGRAM_TARGET_CHANNEL_LOCKS");\n');e=e+("if(o!=null){o.State("+a+');}\no=dom.GetObject("')+(c["interface"]+"."+c.address+":"+d.address+'.WEEK_PROGRAM_TARGET_CHANNEL_LOCK");\n');e+="if(o!=null){o.State("+parseInt(b)+");}\n";return e+'o="";\n';default:return null}},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "profile":break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,
d,"WEEK_PROGRAM_CHANNEL_LOCKS")},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "profile":return parseInt(a);default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "WEEK_PROGRAM_CHANNEL_LOCKS":var b="profile"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},ALARM_SWITCH_VIRTUAL_RECEIVER:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "alarmTrigger":if(!b.ext)return null;
for(a=0;a<b.ext.length;a++){var e=b.ext[a];if(e)switch(e.value){case "alarmAudio":var f=e.ext;break;case "alarmVisual":var g=e.ext;break;case "alarmDur":var h=e.ext;break;case "alarmDurUnit":var k=e.ext}}if("undefined"==typeof f||null==f||"undefined"==typeof g||null==g||"undefined"==typeof h||null==h||"undefined"==typeof k||null==k)return null;f="DISABLE_ACOUSTIC_SIGNAL FREQUENCY_RISING FREQUENCY_FALLING FREQUENCY_RISING_AND_FALLING FREQUENCY_ALTERNATING_LOW_HIGH FREQUENCY_ALTERNATING_LOW_MID_HIGH FREQUENCY_HIGHON_OFF FREQUENCY_HIGHON_LONGOFF FREQUENCY_LOWON_OFF_HIGHON_OFF FREQUENCY_LOWON_LONGOFF_HIGHON_LONGOFF LOW_BATTERY DISARMED INTERNALLY_ARMED EXTERNALLY_ARMED DELAYED_INTERNALLY_ARMED DELAYED_EXTERNALLY_ARMED EVENT ERROR".split(" ").indexOf(f);
-1==f&&(f=0);g="DISABLE_OPTICAL_SIGNAL BLINKING_ALTERNATELY_REPEATING BLINKING_BOTH_REPEATING DOUBLE_FLASHING_REPEATING FLASHING_BOTH_REPEATING CONFIRMATION_SIGNAL_0 CONFIRMATION_SIGNAL_1 CONFIRMATION_SIGNAL_2".split(" ").indexOf(g);-1==g&&(g=0);k=["S","M","H","D"].indexOf(k);-1==k&&(k=0);b="var o;";a=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"ACOUSTIC_ALARM_SELECTION");b=b+('o=dom.GetObject("'+a+'");o.State(')+(f+")");a=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"OPTICAL_ALARM_SELECTION");b=b+('o=dom.GetObject("'+
a+'");o.State(')+(g+")");a=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"DURATION_VALUE");b=b+('o=dom.GetObject("'+a+'");o.State(')+(h+")");a=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"DURATION_UNIT");return b=b+('o=dom.GetObject("'+a+'");o.State(')+(k+')o="";\n');default:return null}},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "alarmState":a="STATE";break;case "alarmAudioState":a="ACOUSTIC_ALARM_ACTIVE";break;case "alarmVisualState":a="OPTICAL_ALARM_ACTIVE";
...
"blindTLevel"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},SHUTTER_VIRTUAL_RECEIVER:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;var e=null;switch(b.value){case "stop":a="STOP";b="if(o!=null){o.State(1);}\n";break;case "moveUp":a="LEVEL";b="if(o!=null){o.State(1.0);}\n";break;case "moveDown":a="LEVEL";b="if(o!=null){o.State(0.0);}\n";break;case "stepUp":b=null==b.ext||"undefined"==typeof b.ext?.05:"number"==typeof b.ext?(parseInt(b.ext)/
100).toFixed(2):b.ext.match(/^[-+]?[0-9]+$/)?(parseInt(b.ext)/100).toFixed(2):.05;a._statebuffer&&(e=this.getBufferedState(a._statebuffer,c,d,{value:"blindLevel"}));b=null==e||"undefined"==typeof e?"if(o!=null){var v=o.Value()+"+b+";if(v>1){v=1.0;}o.State(v);}\n":"if(o!=null){var v="+e/100+"+"+b+";if(v>1){v=1.0;}o.State(v);}\n";a="LEVEL";break;case "stepDown":b=null==b.ext||"undefined"==typeof b.ext?.05:"number"==typeof b.ext?(parseInt(b.ext)/100).toFixed(2):b.ext.match(/^[-+]?[0-9]+$/)?(parseInt(b.ext)/
100).toFixed(2):.05;a._statebuffer&&(e=this.getBufferedState(a._statebuffer,c,d,{value:"blindLevel"}));b=null==e||"undefined"==typeof e?"if(o!=null){var v=o.Value()-"+b+";if(v<0){v=0.0;}o.State(v);}\n":"if(o!=null){var v="+e/100+"-"+b+";if(v<0){v=0.0;}o.State(v);}\n";a="LEVEL";break;case "moveTo":if(null==b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)b=parseInt(b.ext);else if(b.ext.match(/^[-+]?[0-9]+$/))b=b.ext;else return null;a="LEVEL";b/=100;b=0>b?0:b;b="if(o!=null){o.State("+
(1<b?1:b)+");}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},handleCommandResponse:function(a,c,d,b,e){var f=c.address;if(c.channels&&c.channels.SHUTTER_TRANSMITTER)var g=c.channels.SHUTTER_TRANSMITTER.address;if(f&&g)if("moveTo"==d.value)c="LEVEL",b=parseFloat(d.ext),a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()};else if("stepUp"==d.value||"stepDown"==d.value)if(c="LEVEL",b){d=b.indexOf("<v>");var h=b.indexOf("</v>");-1!=d&&-1!=h&&d+3<
h&&(b=b.substr(d+3,h-d-3))&&(b=Math.round(100*parseFloat(b)),a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()})}e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "blindLevel":var e="LEVEL"}return c&&d&&e&&a?(b=a[c+":"+d+"."+e],b&&null!=b.value&&"undefined"!=typeof b.value?3E3<=(new Date).getTime()-b.timestamp?(delete a[c+":"+d+"."+e],null):b.value:null):null},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "blindLevel":break;
...
return{key:b,value:a}}},BLIND_VIRTUAL_RECEIVER:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;var e=null;switch(b.value){case "stop":a="STOP";e="if(o!=null){o.State(1);}\n";break;case "moveUp":return e='var o;o=dom.GetObject("'+(c["interface"]+"."+c.address+":"+d.address+'.LEVEL_2");\n'),e=e+'if(o!=null){o.State(1.0);}\no=dom.GetObject("'+(c["interface"]+"."+c.address+":"+d.address+'.LEVEL");\n'),e+'if(o!=null){o.State(1.0);}\no="";\n';case "moveDown":return e='var o;o=dom.GetObject("'+
(c["interface"]+"."+c.address+":"+d.address+'.LEVEL_2");\n'),e=e+'if(o!=null){o.State(0.0);}\no=dom.GetObject("'+(c["interface"]+"."+c.address+":"+d.address+'.LEVEL");\n'),e+'if(o!=null){o.State(0.0);}\no="";\n';case "lamellaUp":return e='var o;o=dom.GetObject("'+(c["interface"]+"."+c.address+":"+d.address+'.LEVEL_2");\n'),e=e+'if(o!=null){o.State(1.0);}\no=dom.GetObject("'+(c["interface"]+"."+c.address+":"+d.address+'.LEVEL");\n'),e+'if(o!=null){o.State(o.Value());}\no="";\n';case "lamellaDown":return e=
'var o;o=dom.GetObject("'+(c["interface"]+"."+c.address+":"+d.address+'.LEVEL_2");\n'),e=e+'if(o!=null){o.State(0.0);}\no=dom.GetObject("'+(c["interface"]+"."+c.address+":"+d.address+'.LEVEL");\n'),e+'if(o!=null){o.State(o.Value());}\no="";\n';case "stepUp":b=null==b.ext||"undefined"==typeof b.ext?.05:"number"==typeof b.ext?(parseInt(b.ext)/100).toFixed(2):b.ext.match(/^[-+]?[0-9]+$/)?(parseInt(b.ext)/100).toFixed(2):.05;a._statebuffer&&(e=this.getBufferedState(a._statebuffer,c,d,{value:"blindPos"}));
e=null==e||"undefined"==typeof e?"if(o!=null){var v=o.Value()+"+b+";if(v>1){v=1.0;}o.State(v);}\n":"if(o!=null){var v="+e/100+"+"+b+";if(v>1){v=1.0;}o.State(v);}\n";a="LEVEL";break;case "stepDown":b=null==b.ext||"undefined"==typeof b.ext?.05:"number"==typeof b.ext?(parseInt(b.ext)/100).toFixed(2):b.ext.match(/^[-+]?[0-9]+$/)?(parseInt(b.ext)/100).toFixed(2):.05;a._statebuffer&&(e=this.getBufferedState(a._statebuffer,c,d,{value:"blindPos"}));e=null==e||"undefined"==typeof e?"if(o!=null){var v=o.Value()-"+
b+";if(v<0){v=0.0;}o.State(v);}\n":"if(o!=null){var v="+e/100+"-"+b+";if(v<0){v=0.0;}o.State(v);}\n";a="LEVEL";break;case "moveTo":if(null==b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)b=parseInt(b.ext);else if(b.ext.match(/^[-+]?[0-9]+$/))b=b.ext;else return null;a="LEVEL";b/=100;b=0>b?0:b;e="if(o!=null){o.State("+(1<b?1:b)+");}\n";break;case "lamellaStepUp":return b=null==b.ext||"undefined"==typeof b.ext?.05:"number"==typeof b.ext?(parseInt(b.ext)/100).toFixed(2):b.ext.match(/^[-+]?[0-9]+$/)?
(parseInt(b.ext)/100).toFixed(2):.05,e='var s=dom.GetObject("'+c["interface"]+"."+c.address+":"+(d.stateAddress?d.stateAddress:d.address)+'.LEVEL");\n',e+='var o=dom.GetObject("'+c["interface"]+"."+c.address+":"+d.address+'.LEVEL_2");\n',e=e+("if(o!=null){var v=o.Value()+"+b+';if(v>1){v=1.0;}o.State(v);}\no=dom.GetObject("')+(c["interface"]+"."+c.address+":"+d.address+'.LEVEL");\n'),e+'if(o!=null){o.State(s.Value());}\no="";s="";\n';case "lamellaStepDown":return b=null==b.ext||"undefined"==typeof b.ext?
.05:"number"==typeof b.ext?(parseInt(b.ext)/100).toFixed(2):b.ext.match(/^[-+]?[0-9]+$/)?(parseInt(b.ext)/100).toFixed(2):.05,e='var s=dom.GetObject("'+c["interface"]+"."+c.address+":"+(d.stateAddress?d.stateAddress:d.address)+'.LEVEL");\n',e+='var o=dom.GetObject("'+c["interface"]+"."+c.address+":"+d.address+'.LEVEL_2");\n',e=e+("if(o!=null){var v=o.Value()-"+b+';if(v<0){v=0.0;}o.State(v);}\no=dom.GetObject("')+(c["interface"]+"."+c.address+":"+d.address+'.LEVEL");\n'),e+'if(o!=null){o.State(s.Value());}\no="";s="";\n';
case "lamellaTo":if(null==b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)b=parseInt(b.ext);else if(b.ext.match(/^[-+]?[0-9]+$/))b=b.ext;else return null;b/=100;b=0>b?0:b;e='var s=dom.GetObject("'+c["interface"]+"."+c.address+":"+(d.stateAddress?d.stateAddress:d.address)+'.LEVEL");\n';e+='var o=dom.GetObject("'+c["interface"]+"."+c.address+":"+d.address+'.LEVEL_2");\n';e=e+("if(o!=null){o.State("+(1<b?1:b)+');}\no=dom.GetObject("')+(c["interface"]+"."+c.address+":"+d.address+
'.LEVEL");\n');return e+'if(o!=null){o.State(s.Value());}\no="";s="";\n';default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,e)},handleCommandResponse:function(a,c,d,b,e){var f=c.address;if(c.channels&&c.channels.BLIND_TRANSMITTER)var g=c.channels.BLIND_TRANSMITTER.address;if(f&&g)if("moveTo"==d.value)c="LEVEL",b=parseFloat(d.ext),a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()};else if("lamellaTo"==d.value)c="LEVEL_2",b=parseFloat(d.ext),a._statebuffer[f+
":"+g+"."+c]={value:b,timestamp:(new Date).getTime()};else if("stepUp"==d.value||"stepDown"==d.value){if(c="LEVEL",b){d=b.indexOf("<v>");var h=b.indexOf("</v>");-1!=d&&-1!=h&&d+3<h&&(b=b.substr(d+3,h-d-3))&&(b=Math.round(100*parseFloat(b)),a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()})}}else if("lamellaStepUp"==d.value||"lamellaStepDown"==d.value)if(c="LEVEL_2",b&&(d=b.indexOf("<v>"),h=b.indexOf("</v>"),-1!=d&&-1!=h&&d+3<h&&(b=b.substr(d+3,h-d-3))))b=Math.round(100*parseFloat(b)),
a._statebuffer[f+":"+g+"."+c]={value:b,timestamp:(new Date).getTime()};e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "blindPos":var e="LEVEL";break;case "lamellaPos":e="LEVEL_2"}return c&&d&&e&&a?(b=a[c+":"+d+"."+e],b&&null!=b.value&&"undefined"!=typeof b.value?3E3<=(new Date).getTime()-b.timestamp?(delete a[c+":"+d+"."+e],null):b.value:null):null},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "blindPos":a="LEVEL";
...
!b.value)return null;switch(b.value){case "weatherActualTemp":a="ACTUAL_TEMPERATURE";break;case "weatherHum":a="HUMIDITY";break;case "weatherIllu":a="ILLUMINATION";break;case "weatherSunD":a="SUNSHINEDURATION";break;case "weatherSunDOF":a="SUNSHINEDURATION_OVERFLOW";break;case "weatherSunTOR":a="SUNSHINE_THRESHOLD_OVERRUN";break;case "weatherWindS":a="WIND_SPEED";break;case "weatherWindTOR":a="WIND_THRESHOLD_OVERRUN";break;case "weatherRain":a="RAINING";break;case "weatherRainC":a="RAIN_COUNTER";
break;case "weatherRainCOF":a="RAIN_COUNTER_OVERFLOW";break;case "weatherWindD":a="WIND_DIR";break;case "weatherWindDR":a="WIND_DIR_RANGE";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "weatherActualTemp":case "weatherIllu":case "weatherWindS":case "weatherRainC":case "weatherWindD":case "weatherWindDR":return parseFloat(parseFloat(a).toFixed(1));case "weatherHum":case "weatherSunD":return parseInt(a);
case "weatherSunDOF":case "weatherSunTOR":case "weatherWindTOR":case "weatherRain":case "weatherRainCOF":return a;default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "ACTUAL_TEMPERATURE":var b="weatherActualTemp";break;case "HUMIDITY":b="weatherHum";break;case "ILLUMINATION":b="weatherIllu";break;case "SUNSHINEDURATION":b="weatherSunD";break;case "SUNSHINEDURATION_OVERFLOW":b="weatherSunDOF";break;case "SUNSHINE_THRESHOLD_OVERRUN":b="weatherSunTOR";break;case "WIND_SPEED":b=
"weatherWindS";break;case "WIND_THRESHOLD_OVERRUN":b="weatherWindTOR";break;case "RAINING":b="weatherRain";break;case "RAIN_COUNTER":b="weatherRainC";break;case "RAIN_COUNTER_OVERFLOW":b="weatherRainCOF";break;case "WIND_DIR":b="weatherWindD";break;case "WIND_DIR_RANGE":b="weatherWindDR"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},CLIMATE_TRANSCEIVER:{buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "climateActualTemp":a=
"ACTUAL_TEMPERATURE";break;case "climateHum":a="HUMIDITY";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "climateActualTemp":return parseFloat(parseFloat(a).toFixed(1));case "climateHum":return parseInt(a);default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "ACTUAL_TEMPERATURE":var b="climateActualTemp";break;case "HUMIDITY":b="climateHum"}if(!b)return null;a=this.handleStatusResponse(d+
"",{value:b});return{key:b,value:a}}},PASSAGE_DETECTOR_DIRECTION_TRANSMITTER:{buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "passageCurrentDirection":case "passageLastDirection":return d="CURRENT_PASSAGE_DIRECTION","passageLastDirection"==b.value&&(d="LAST_PASSAGE_DIRECTION"),b=xnm.aio.hm.MHMCCU._getDataPointAddress(c,{address:2},d),a='o=dom.GetObject("'+b+'");if(o!=null){states=states#o.Value();}else{states=states#"?";}',b=xnm.aio.hm.MHMCCU._getDataPointAddress(c,
{address:3},d),a+'states=states#"-";o=dom.GetObject("'+(b+'");if(o!=null){states=states#o.Value();}else{states=states#"?";}');case "passageCurrent":b="CURRENT_PASSAGE_DIRECTION";break;case "passageLast":b="LAST_PASSAGE_DIRECTION";break;case "passageCOF":b="PASSAGE_COUNTER_OVERFLOW";break;case "passageC":b="PASSAGE_COUNTER_VALUE";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,b)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "passageCurrentDirection":case "passageLastDirection":return a=
a.split("-"),2>a.length?"?":"true"==a[0]?"right_to_left":"left_to_right";case "passageCurrent":case "passageLast":case "passageCOF":return a;case "passageC":return parseInt(a);default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "CURRENT_PASSAGE_DIRECTION":var b="passageCurrent";break;case "LAST_PASSAGE_DIRECTION":b="passageLast";break;case "PASSAGE_COUNTER_OVERFLOW":b="passageCOF";break;case "PASSAGE_COUNTER_VALUE":b="passageC"}if(!b)return null;a=this.handleStatusResponse(d+
"",{value:b});switch(c.datapoint){case "CURRENT_PASSAGE_DIRECTION":b="passageCurrentDirection";a=c&&-1!=c.channel.indexOf(":2")?"right_to_left":"left_to_right";break;case "LAST_PASSAGE_DIRECTION":b="passageLastDirection";a=c&&-1!=c.channel.indexOf(":2")?"right_to_left":"left_to_right";break;case "PASSAGE_COUNTER_OVERFLOW":b="passageCOF";break;case "PASSAGE_COUNTER_VALUE":b="passageC"}return{key:b,value:a}}},GENERIC_INPUT_TRANSMITER:{buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;
switch(b.value){case "genInputChangeOver":a="CHANGE_OVER";break;case "genInputExtClock":a="EXTERNAL_CLOCK";break;case "genInputHumidityLimiter":a="HUMIDITY_LIMITER";break;case "genInputState":a="STATE";break;case "genInputTactileSwitch":a="TACTILE_SWITCH";break;case "genInputTempLimiter":a="TEMPERATURE_LIMITER";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "genInputChangeOver":case "genInputExtClock":case "genInputHumidityLimiter":case "genInputState":case "genInputTactileSwitch":case "genInputTempLimiter":return a;
...
break;case "analogOutputTo":if(null==b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)b=parseInt(b.ext);else if(b.ext.match(/^[-+]?[0-9]+$/))b=b.ext;else return null;a="LEVEL";b/=100;b=0>b?0:b;b="if(o!=null){o.State("+(1<b?1:b)+");}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},handleCommandResponse:function(a,c,d,b,e){var f=c.address;if(c.channels&&c.channels.DIMMER)var g=c.channels.DIMMER.address;if(f&&g)if("analogOutputTo"==d.value||"analogOutputOff"==
d.value){c="LEVEL";switch(d.value){case "analogOutputTo":var h=parseFloat(d.ext);break;case "analogOutputOff":h=0}a._statebuffer[f+":"+g+"."+c]={value:h,timestamp:(new Date).getTime()}}else if("analogOutputUp"==d.value||"analogOutputDown"==d.value)if(c="LEVEL",b&&(d=b.indexOf("<v>"),h=b.indexOf("</v>"),-1!=d&&-1!=h&&d+3<h&&(h=b.substr(d+3,h-d-3))))h=Math.round(100*parseFloat(h)),a._statebuffer[f+":"+g+"."+c]={value:h,timestamp:(new Date).getTime()};e&&e()},getBufferedState:function(a,c,d,b){c=c.address;
...
a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},ACOUSTIC_SIGNAL_VIRTUAL_RECEIVER:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;a=[];switch(b.value){case "acousticPlay":case "acousticPlayList":if(!b.ext)return null;for(var e=0;e<b.ext.length;e++){var f=b.ext[e];if(f)switch(f.value){case "acousticSound":var g=f.ext;break;case "acousticSoundList":g=f.ext;break;case "acousticLevel":var h=parseInt(f.ext);break;case "acousticDur":var k=parseInt(f.ext);break;
case "acousticDurUnit":var m=f.ext;break;case "acousticRepeat":var p=parseInt(f.ext)}}if("undefined"==typeof g||null==g||"undefined"==typeof h||null==h||"undefined"==typeof k||null==k||"undefined"==typeof m||null==m||"undefined"==typeof p||null==p)return null;"acousticPlay"==b.value?a.push(g):a=g.split(",");m=["S","M","H","10MS"].indexOf(m);h/=100;break;default:return null}if(0==a.length)return null;b="";g=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"DURATION_UNIT");b+='(datapoints.Get("'+g+'")).State('+
m+");\n";g=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"RAMP_TIME_UNIT");b+='(datapoints.Get("'+g+'")).State(0);\n';g=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"RAMP_TIME_VALUE");b+='(datapoints.Get("'+g+'")).State(0);\n';g=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"LEVEL");b+='(datapoints.Get("'+g+'")).State('+h+");\n";g=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"OUTPUT_SELECT_SIZE");b+='(datapoints.Get("'+g+'")).State('+a.length+");\n";g=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"REPETITIONS");
b+='(datapoints.Get("'+g+'")).State('+p+");\n";for(e=1;e<=a.length;e++)g=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"SOUNDFILE_LIST_"+e),b+='(datapoints.Get("'+g+'")).State('+a[e-1]+");\n";g=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"DURATION_VALUE");return b+('(datapoints.Get("'+g+'")).State('+k+");\n")},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "acousticLevel":a="LEVEL";break;case "acousticSoundfile":a="SOUNDFILE";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,
d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "acousticLevel":return a=parseFloat(a),Math.round(100*a);case "acousticSoundfile":return parseInt(a);default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "LEVEL":var b="acousticLevel";break;case "SOUNDFILE":b="acousticSoundfile"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},ACOUSTIC_DISPLAY_RECEIVER:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;
switch(b.value){case "setLine":if(!b.ext)return null;for(a=0;a<b.ext.length;a++){var e=b.ext[a];if(e)switch(e.value){case "line":var f=e.ext;break;case "text":var g=e.ext;break;case "textAlign":var h=e.ext;break;case "textColor":var k=e.ext;break;case "bgColor":var m=e.ext;break;case "icon":var p=parseInt(e.ext)}}if(!(f&&h&&k&&m)||isNaN(p))return null;h=h.toUpperCase();k=k.toUpperCase();m=m.toUpperCase();b="{DDBC="+m+",DDTC="+k+",DDI="+p+",DDA="+h+",DDS="+g+",DDID="+f+",DDC=true}";f="";c=xnm.aio.hm.MHMCCU._getDataPointAddress(c,
d,"COMBINED_PARAMETER");return f+('dom.GetObject("'+c+'").State("'+b+'");\n');case "setSound":if(!b.ext)return null;for(a=0;a<b.ext.length;a++)if(e=b.ext[a])switch(e.value){case "sound":var t=parseInt(e.ext);break;case "repeat":var r=parseInt(e.ext);break;case "interval":var u=parseInt(e.ext)}if(isNaN(t)||isNaN(r)||isNaN(u))return null;b="{R="+r+",IN="+u+",ANS="+t+"}";f="";c=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"COMBINED_PARAMETER");return f+('dom.GetObject("'+c+'").State("'+b+'");\n');default:return null}}},
ANALOG_INPUT_TRANSMITTER:{buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "analogInputVoltage":break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,"VOLTAGE")},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "analogInputVoltage":return parseFloat(a);default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "VOLTAGE":var b="analogInputVoltage"}if(!b)return null;a=this.handleStatusResponse(d+
"",{value:b});return{key:b,value:a}}}};
...
default:var c=!1,b=[],e=["DIMMER","VIRTUAL_DIMMER"],f;for(f in a.channels){var g=a.channels[f];g&&g.hsstype&&-1!=e.indexOf(g.hsstype)&&(-1==b.indexOf(g.hsstype)?b.push(g.hsstype):c=!0)}return 0<b.length?this._parseDevice(a,b,c):null}},_parseDevice:function(a,d,b){var c=[],f=null,g=null,h;for(h in a.channels){var k=a.channels[h];if(k&&k.address&&k.hsstype){var m=k.address.indexOf(":");if(-1!==m){var p=k.address.substring(m+1),t={id:k.name,address:p,room:k.room,group:k.func,datapoints:[]};0==p&&(f=
k.hsstype,g=t);if(-1!=d.indexOf(k.hsstype))if(m=this._parseGeneralInfo(a),m.channels[k.hsstype]=t,b)m.id+=":"+p,m.address+=":"+p,c.push(m);else{c.push(m);break}}}}if(g&&f)for(a=0;a<c.length;a++)(m=c[a])&&(m.channels[f]=g);return c},_parseHMSecSirWM:function(a){this._parseGeneralInfo(a);var c={};c.sys=xnm.aio.hm.DM.SYS;c.id=a.name;c.type=a.hsstype;c.address=a.address;c.rfAddr=a.rfAddr;c["interface"]=a["interface"];c.channels={};var b=a.channels,e;for(e in b)if(b.hasOwnProperty(e)){var f=a.channels[e];
if(f.address){var g=f.address.indexOf(":");-1!==g&&(g=f.address.substring(g+1),0!=g&&f.hsstype&&(f={id:f.name,address:g,room:f.room,group:f.func,datapoints:[]},1==g?c.channels.SWITCH_SENSOR_1=f:2==g?c.channels.SWITCH_SENSOR_2=f:3==g?c.channels.SWITCH_PANIC=f:4==g&&(c.channels.ARMING=f)))}}return[c]},_parseHM_WDS30_OT2_SM_2:function(a){var c=this._parseGeneralInfo(a),b=a.channels,e;for(e in b)if(b.hasOwnProperty(e)){var f=a.channels[e];if(f.address){var g=f.address.indexOf(":");if(-1!==g&&(g=f.address.substring(g+
1),f.hsstype)){var h={id:f.name,address:g,room:f.room,group:f.func,datapoints:[]};0==g?c.channels[f.hsstype]=h:1==g?c.channels.WEATHER_1=h:2==g?c.channels.WEATHER_2=h:3==g?c.channels.WEATHER_3=h:4==g&&(c.channels.WEATHER_4=h)}}}return[c]},_parseHM_ES_TX_WM:function(a){var c=this._parseGeneralInfo(a),b=a.channels,e;for(e in b)if(b.hasOwnProperty(e)){var f=a.channels[e];if(f.address){var g=f.address.indexOf(":");-1!==g&&(g=f.address.substring(g+1),0!=g&&f.hsstype&&(c.channels[f.hsstype]={id:f.name,
address:g,room:f.room,group:f.func,datapoints:[]}))}}return[c]},_parseHM_MOD_EM_8BIT:function(a){var c=this._parseGeneralInfo(a),b=a.channels,e;for(e in b)if(b.hasOwnProperty(e)){var f=a.channels[e];if(f.address){var g=f.address.indexOf(":");-1!==g&&(g=f.address.substring(g+1),0!=g&&f.hsstype&&(f={id:f.name,address:g,room:f.room,group:f.func,datapoints:[]},1==g?c.channels.KEY_1=f:2==g?c.channels.KEY_2=f:3==g&&(c.channels.MOD_EM8BIT_TRANSMITTER=f)))}}return[c]},_parseGeneralInfo:function(a){var c=
...
this._chKeyTransceivers[b];c&&(a.ipevt.push({type:"enum",name:"button "+c+" short press",ref:{value:"btn"+c+"pressShort",options:["true"]}}),a.ipevt.push({type:"enum",name:"button "+c+" long press",ref:{value:"btn"+c+"pressLong",options:["true"]}}))}return a};a.prototype.executeCommand=function(a,b,c,d){if(c){var n=null;b={interface:b.interface,address:this.getAddress(),channels:b.channels,type:b.type};if(1==this._chKeyTransceivers.length)n=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.buildCommandScript(a,
b,{address:this._chKeyTransceivers[0]},c);else if("btn"==c.value.substr(0,3)){var e=c.value.indexOf("press"),z=c.value.substr(3,e);z=parseInt(z);-1!=this._chKeyTransceivers.indexOf(z)&&(n=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.buildCommandScript(a,b,{address:z},{value:c.value.substr(e)}))}n?a._doRequestMarked(n,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};a.prototype.buildStateScript=function(a,b,c){if(!c)return null;
var d=null;switch(c.value){case "errorComm":case "errorBat":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c)}return d};a.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);default:return"?"}};a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var n=null;
switch(d){case "0":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;default:-1!=this._chKeyTransceivers.indexOf(parseInt(d))&&(n=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c),1<this._chKeyTransceivers.length&&n&&("pressShort"==n.key?n.key="btn"+d+"pressShort":"pressLong"==n.key&&(n.key="btn"+d+"pressLong")))}return n};a.parseJSON=function(b){if(!b||!b.type||!b.channels)return null;var c=new a;c._type=b.type;c._address=b.address;for(var d in b.channels){var n=b.channels[d];
0==n.address?c._chMaintenanaceHsstype=d:"KEY_TRANSCEIVER"==d&&c._chKeyTransceivers.push(parseInt(n.address))}return c};return a}(),c=function(){var a=function(){this._switchIdx=0;this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=null;this._chKeyTransceivers=[];this._chSwitchTransmitter=1;this._chSwitchVirtualReceiver1=2;this._chSwitchVirtualReceiver2=3;this._chSwitchVirtualReceiver3=4;this._chSwitchWeekProfile=17};a.prototype._getCommonMap=function(){for(var a={command:[{type:"enum",
name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}},{type:"float",name:"on for",ref:{value:"onFor",ext:"%f",unit:"s"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"switch status",ref:{value:"switchState",options:["off","on"]}}]},b=[this._chSwitchVirtualReceiver1,this._chSwitchVirtualReceiver2,this._chSwitchVirtualReceiver3],c=0;c<b.length;c++)a.command.push({type:"enum",
name:"ch."+b[c]+" on",ref:{value:"ch"+b[c]+"on"}}),a.command.push({type:"enum",name:"ch."+b[c]+" off",ref:{value:"ch"+b[c]+"off"}}),a.command.push({type:"enum",name:"ch."+b[c]+" toggle",ref:{value:"ch"+b[c]+"toggle"}}),a.command.push({type:"float",name:"ch."+b[c]+" on for",ref:{value:"ch"+b[c]+"onFor",ext:"%f",unit:"s"}}),a.status.push({type:"enum",name:"ch."+b[c]+" status",ref:{value:"ch"+b[c]+"State",options:["off","on"]}});return a};a.prototype.getAddress=function(){var a=this._address.indexOf(":");
return-1!=a?this._address.substr(0,a):this._address};a.prototype.getCommandStatusMap=function(){var a=JSON.parse(JSON.stringify(this._getCommonMap()));this._chSwitchWeekProfile&&(a.command.push({type:"enum",name:"set profile",ref:{value:"setProfile",ext:"%e",extMeta:["auto","manu"]}}),a.status.push({type:"enum",name:"profile",ref:{value:"profile",extMeta:["auto","manu"]}}));"HmIP-PCBS"==this._type.substr(0,9)&&a.status.push({type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",
extMeta:"0.0-25.2"}});return a};a.prototype.getIPEvtMap=function(){var a={ipevt:JSON.parse(JSON.stringify(this._getCommonMap())).status};"HmIP-PCBS"==this._type.substr(0,9)&&a.ipevt.push({type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}});if(this._chKeyTransceivers&&0<this._chKeyTransceivers.length){var b=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.getIPEvtMap(this._chKeyTransceivers);b&&b.ipevt&&(a.ipevt=a.ipevt.concat(b.ipevt))}return a};a.prototype.useStateBuffer=
function(){return"HmIPW-DRS"==this._type.substr(0,9)||"HmIP-DRSI"==this._type.substr(0,9)||"HmIP-PCBS"==this._type.substr(0,9)||"HmIP-MOD-OC"==this._type.substr(0,11)?!0:!1};a.prototype.executeCommand=function(a,b,c,d){if(c){var n=null,e={interface:b.interface,address:this.getAddress(),channels:b.channels};if("setProfile"==c.value)this._chSwitchWeekProfile&&(n={value:"setProfile",ext:[{value:"mode",ext:c.ext},{value:"channels",ext:1<<3*this._switchIdx}]},n=xnm.aio.hm.HmIPChannel.SWITCH_WEEK_PROFILE.buildCommandScript(a,
e,{address:this._chSwitchWeekProfile},n));else{var z=this._chSwitchVirtualReceiver1;n=JSON.parse(JSON.stringify(c));if("ch"==c.value.substr(0,2)){var l="ch"+this._chSwitchVirtualReceiver1,w="ch"+this._chSwitchVirtualReceiver2,g="ch"+this._chSwitchVirtualReceiver3;c.value.substr(0,l.length)==l?(z=this._chSwitchVirtualReceiver1,n.value=c.value.substr(l.length)):c.value.substr(0,w.length)==w?(z=this._chSwitchVirtualReceiver2,n.value=c.value.substr(w.length)):c.value.substr(0,g.length)==g&&(z=this._chSwitchVirtualReceiver3,
n.value=c.value.substr(g.length))}n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,e,{address:z},n)}if(n){var f=this;a._doRequestMarked(n,!0,{execute:function(n,e){n||f._handleCommandResponse(a,b,c,e);d&&d(n)}})}else d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};a.prototype._handleCommandResponse=function(a,b,c,d){if(this.useStateBuffer())switch(b=this.getAddress()+":"+this._chSwitchTransmitter+".STATE",c.value){case "on":a._statebuffer[b]={value:"on",timestamp:(new Date).getTime(),
expire:4E3};break;case "off":a._statebuffer[b]={value:"off",timestamp:(new Date).getTime(),expire:4E3};break;case "toggle":a._statebuffer[b]&&a._statebuffer[b].value&&(a._statebuffer[b]="on"==a._statebuffer[b].value?{value:"off",timestamp:(new Date).getTime(),expire:4E3}:{value:"on",timestamp:(new Date).getTime(),expire:4E3});break;case "onFor":c=1E3*parseFloat(c.ext),a._statebuffer[b]={value:"on",timestamp:(new Date).getTime(),expire:c}}};a.prototype.getBufferedState=function(a,b,c){if(!this.useStateBuffer()||
!c||!c.value||"switchState"!=c.value)return null;b=this.getAddress()+":"+this._chSwitchTransmitter+".STATE";if(!a._statebuffer[b])return null;c=a._statebuffer[b];if("undefined"==typeof c.value||null==c.value||!c.timestamp)return delete a._statebuffer[b],null;var d=c.timestamp,n=c.expire;n||(n=1E3);return(new Date).getTime()>d+n?(delete a._statebuffer[b],null):c.value};a.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;b={interface:b.interface,address:this.getAddress(),channels:b.channels};
switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:this._chMaintenance},c);break;case "errorBatElVoltage":d=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,b,{address:this._chMaintenance},c);break;case "switchState":d=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.buildStateScript(a,b,{address:this._chSwitchTransmitter},{value:"switchTState"});break;case "ch"+this._chSwitchVirtualReceiver1+"State":d=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildStateScript(a,
b,{address:this._chSwitchVirtualReceiver1},{value:"switchState"});break;case "ch"+this._chSwitchVirtualReceiver2+"State":d=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:this._chSwitchVirtualReceiver2},{value:"switchState"});break;case "ch"+this._chSwitchVirtualReceiver3+"State":d=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:this._chSwitchVirtualReceiver3},{value:"switchState"});break;case "profile":d=xnm.aio.hm.HmIPChannel.SWITCH_WEEK_PROFILE.buildStateScript(a,
b,{address:this._chSwitchWeekProfile},{value:"profile"})}return d};a.prototype.handleStatusResponse=function(a,b,c){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,b);case "switchState":return a=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.handleStatusResponse(a,{value:"switchTState"}),this.useStateBuffer()&&(b=this.getAddress()+":"+
this._chSwitchTransmitter+".STATE",c._statebuffer[b]={value:a,timestamp:(new Date).getTime(),expire:1E3}),a;case "ch"+this._chSwitchVirtualReceiver1+"State":case "ch"+this._chSwitchVirtualReceiver2+"State":case "ch"+this._chSwitchVirtualReceiver3+"State":return a=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.handleStatusResponse(a,{value:"switchState"});case "profile":return a=xnm.aio.hm.HmIPChannel.SWITCH_WEEK_PROFILE.handleStatusResponse(a,{value:"profile"}),"?"!=a&&(a=a>>3*this._switchIdx&1?"manu":
"auto"),a;default:return"?"}};a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var n=b.channel.substr(d+1);d=null;switch(parseInt(n)){case this._chMaintenance:d="HmIP-PCBS"==this._type.substr(0,9)?xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(a,b,c):xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case this._chSwitchTransmitter:if(d=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.resolveState(a,b,c))d.key="switchState";
break;case this._chSwitchVirtualReceiver1:case this._chSwitchVirtualReceiver2:case this._chSwitchVirtualReceiver3:if(d=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.resolveState(a,b,c))d.key="ch"+n+"State";break;case this._chSwitchWeekProfile:if(d=xnm.aio.hm.HmIPChannel.SWITCH_WEEK_PROFILE.resolveState(a,b,c))a=d.profile,"?"!=a&&(d.profile=a>>3*this._switchIdx&1?"manu":"auto");break;default:-1!=this._chKeyTransceivers.indexOf(parseInt(n))&&(d=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,
b,c),1<this._chKeyTransceivers.length&&d&&("pressShort"==d.key?d.key="btn"+n+"pressShort":"pressLong"==d.key&&(d.key="btn"+n+"pressLong")))}return d};a.parseJSON=function(b,c,d,e){if(!b||!b.type||!b.channels)return null;var n=new a;n._type=b.type;n._address=b.address;var l=n._chSwitchWeekProfile=0,z;for(z in b.channels)"KEY_TRANSCEIVER"==z.substr(0,15)&&e?n._chKeyTransceivers.push(parseInt(b.channels[z].address)):"SWITCH_TRANSMITTER"==z.substr(0,18)?n._chSwitchTransmitter=parseInt(b.channels[z].address):
"SWITCH_VIRTUAL_RECEIVER"==z.substr(0,23)?(l++,1==l?n._chSwitchVirtualReceiver1=parseInt(b.channels[z].address):2==l?n._chSwitchVirtualReceiver2=parseInt(b.channels[z].address):3==l&&(n._chSwitchVirtualReceiver3=parseInt(b.channels[z].address))):"SWITCH_WEEK_PROFILE"==z.substr(0,19)&&(n._chSwitchWeekProfile=parseInt(b.channels[z].address));if(c&&d&&n._chSwitchTransmitter){b=[];for(e=0;e<d;e++)b.push(c+4*e);c=b.indexOf(n._chSwitchTransmitter);-1!=c&&(n._switchIdx=c)}return n};return a}(),d=function(){var a=
function(){c.call(this);this._chEnergieMeterTransmitter=0};a.prototype=new c;a.prototype.constructor=a;a.prototype.getCommandStatusMap=function(){var a=c.prototype.getCommandStatusMap.call(this);if(!a)return null;var b=xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.getCommandStatusMap();b&&b.status&&(a.status=a.status?a.status.concat(b.status):b.status);return a};a.prototype.getIPEvtMap=function(){var a=c.prototype.getIPEvtMap.call(this);if(!a)return null;var b=xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.getIPEvtMap();
b&&b.ipevt&&(a.ipevt=a.ipevt?a.ipevt.concat(b.ipevt):b.ipevt);return a};a.prototype.buildStateScript=function(a,b,d){if(!d)return null;switch(d.value){case "meterVoltage":case "meterEnergyCounter":case "meterFrequency":case "meterPower":case "meterCurrent":a=xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.buildStateScript(a,b,{address:this._chEnergieMeterTransmitter},d);break;default:a=c.prototype.buildStateScript.call(this,a,b,d)}return a};a.prototype.handleStatusResponse=function(a,b,d){if("?"==
a)return a;switch(b.value){case "meterVoltage":case "meterEnergyCounter":case "meterFrequency":case "meterPower":case "meterCurrent":return xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.handleStatusResponse(a,b);default:return c.prototype.handleStatusResponse.call(this,a,b,d)}};a.prototype.resolveState=function(a,b,d){if(!b||!b.channel)return null;var n=b.channel.indexOf(":");if(-1==n)return null;n=b.channel.substr(n+1);switch(parseInt(n)){case this._chEnergieMeterTransmitter:a=xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.resolveState(a,
b,d);break;default:return c.prototype.resolveState.call(this,a,b,d)}return a};a.parseJSON=function(b,d){if(!b||!b.type||!b.channels)return null;d=c.parseJSON(b,null,null,d);if(!d)return null;var n=new a;n._switchIdx=d._switchIdx;n._type=d._type;n._address=d._address;n._chMaintenance=d._chMaintenance;n._chMaintenanceHsstype=d._chMaintenanceHsstype;n._chKeyTransceivers=d._chKeyTransceivers;n._chSwitchTransmitter=d._chSwitchTransmitter;n._chSwitchVirtualReceiver1=d._chSwitchVirtualReceiver1;n._chSwitchVirtualReceiver2=
d._chSwitchVirtualReceiver2;n._chSwitchVirtualReceiver3=d._chSwitchVirtualReceiver3;n._chSwitchWeekProfile=d._chSwitchWeekProfile;for(var e in b.channels)"ENERGIE_METER_TRANSMITTER"==e.substr(0,25)&&(n._chEnergieMeterTransmitter=parseInt(b.channels[e].address));return n};return a}(),b=function(){var a=function(){this._dimmerIdx=0;this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=null;this._chDimmerTransmitter=1;this._chDimmerVirtualReceiver1=2;this._chDimmerVirtualReceiver2=
3;this._chDimmerVirtualReceiver3=4;this._chDimmerWeekProfile=13};a.prototype._getCommonMap=function(){var a=function(a,b){a.command.push({type:"enum",name:"ch."+b+" on",ref:{value:"ch"+b+"dimOn"}});a.command.push({type:"enum",name:"ch."+b+" off",ref:{value:"ch"+b+"dimOff"}});a.command.push({type:"int",name:"ch."+b+" dim up",ref:{value:"ch"+b+"dimUp",ext:"%d",extMeta:"1-100",unit:"%"}});a.command.push({type:"int",name:"ch."+b+" dim down",ref:{value:"ch"+b+"dimDown",ext:"%d",extMeta:"1-100",unit:"%"}});
a.command.push({type:"int",name:"ch."+b+" dim to",ref:{value:"ch"+b+"dimTo",ext:"%d",extMeta:"1-100",unit:"%"}});a.command.push({type:"int",name:"ch."+b+" toggle to",ref:{value:"ch"+b+"toggleTo",ext:"%d",extMeta:"1-100",unit:"%"}});a.status.push({type:"int",name:"ch."+b+" status",ref:{value:"ch"+b+"Level",extMeta:"0-100",unit:"%"}})},b={command:[{type:"enum",name:"on",ref:{value:"dimOn"}},{type:"enum",name:"off",ref:{value:"dimOff"}},{type:"int",name:"dim up",ref:{value:"dimUp",ext:"%d",extMeta:"1-100",
unit:"%"}},{type:"int",name:"dim down",ref:{value:"dimDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"dim to",ref:{value:"dimTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"toggle to",ref:{value:"toggleTo",ext:"%d",extMeta:"0-100",unit:"%"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"int",name:"dimmer status",ref:{value:"dimmerTLevel",extMeta:"0-100",unit:"%"}}]};a(b,this._chDimmerVirtualReceiver1);a(b,this._chDimmerVirtualReceiver2);
a(b,this._chDimmerVirtualReceiver3);return b};a.prototype.getAddress=function(){var a=this._address.indexOf(":");return-1!=a?this._address.substr(0,a):this._address};a.prototype.getCommandStatusMap=function(){var a=this._getCommonMap();this._chDimmerWeekProfile&&(a.command.push({type:"enum",name:"set profile",ref:{value:"setProfile",ext:"%e",extMeta:["auto","manu"]}}),a.status.push({type:"enum",name:"profile",ref:{value:"profile",extMeta:["auto","manu"]}}));return a};a.prototype.getIPEvtMap=function(){return{ipevt:this._getCommonMap().status}};
a.prototype.useStateBuffer=function(){return"HmIPW-DRD"==this._type.substr(0,9)||"HmIP-DRDI"==this._type.substr(0,9)?!0:!1};a.prototype.executeCommand=function(a,b,c,d){if(c){var n={value:c.value,ext:c.ext},e=this._chDimmerVirtualReceiver1;if("ch"==c.value.substr(0,2)){var l=c.value.indexOf("dim");-1==l&&(l=c.value.indexOf("toggle"));if(-1==l){d&&d(Error("invalid command"));return}e=parseInt(c.value.substr(2,l));n.value=c.value.substr(l);if(e!=this._chDimmerVirtualReceiver1&&e!=this._chDimmerVirtualReceiver2&&
e!=this._chDimmerVirtualReceiver3){d&&d(Error("invalid command"));return}}l=null;var g={interface:b.interface,address:this.getAddress(),channels:b.channels};"setProfile"==c.value?this._chDimmerWeekProfile&&(n={value:"setProfile",ext:[{value:"mode",ext:c.ext},{value:"channels",ext:1<<3*this._dimmerIdx}]},l=xnm.aio.hm.HmIPChannel.DIMMER_WEEK_PROFILE.buildCommandScript(a,g,{address:this._chDimmerWeekProfile},n)):l=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(a,g,{address:e},n);if(l){var z=
this;a._doRequestMarked(l,!0,{execute:function(n,e){n||z._handleCommandResponse(a,b,c,e);d&&d(n)}})}else d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};a.prototype._handleCommandResponse=function(a,b,c,d){if(this.useStateBuffer()){b=null;var n=d.indexOf("<v>");if(-1!=n){var e=d.indexOf("</v>");-1!=e&&(d=d.substring(n+3,e),b=Math.round(100*parseFloat(d)))}d=this.getAddress()+":"+this._chDimmerTransmitter+".LEVEL";switch(c.value){case "dimOn":delete a._statebuffer[d];break;case "dimOff":a._statebuffer[d]=
{value:0,timestamp:(new Date).getTime(),expire:3E3};break;case "dimUp":null!=b&&(a._statebuffer[d]={value:b,timestamp:(new Date).getTime(),expire:3E3});break;case "dimDown":null!=b&&(a._statebuffer[d]={value:b,timestamp:(new Date).getTime(),expire:3E3});break;case "dimTo":b=parseInt(c.ext);null!=b&&(a._statebuffer[d]={value:b,timestamp:(new Date).getTime(),expire:3E3});break;case "toggleTo":null!=b&&(a._statebuffer[d]={value:b,timestamp:(new Date).getTime(),expire:3E3})}}};a.prototype.getBufferedState=
function(a,b,c){if(!this.useStateBuffer()||!c||!c.value||"dimmerTLevel"!=c.value)return null;b=this.getAddress()+":"+this._chDimmerTransmitter+".LEVEL";if(!a._statebuffer[b])return null;c=a._statebuffer[b];if("undefined"==typeof c.value||null==c.value||!c.timestamp)return delete a._statebuffer[b],null;var d=c.timestamp,n=c.expire;n||(n=1E3);return(new Date).getTime()>d+n?(delete a._statebuffer[b],null):c.value};a.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null,n={interface:b.interface,
address:this.getAddress(),channels:b.channels};switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,n,{address:this._chMaintenance},c);break;case "dimmerTLevel":d="HmIPW-DRD"!==this._type.substr(0,9)&&"HmIP-DRDI"!==this._type.substr(0,9)||"number"!==typeof this._chDimmerVirtualReceiver1?xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.buildStateScript(a,n,{address:this._chDimmerTransmitter},{value:"dimmerTLevel"}):xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,
n,{address:this._chDimmerVirtualReceiver1},{value:"dimmerLevel"});break;case "ch"+this._chDimmerVirtualReceiver1+"Level":d=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:this._chDimmerVirtualReceiver1},{value:"dimmerLevel"});break;case "ch"+this._chDimmerVirtualReceiver2+"Level":d=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:this._chDimmerVirtualReceiver2},{value:"dimmerLevel"});break;case "ch"+this._chDimmerVirtualReceiver3+"Level":d=
xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:this._chDimmerVirtualReceiver3},{value:"dimmerLevel"});break;case "profile":d=xnm.aio.hm.HmIPChannel.DIMMER_WEEK_PROFILE.buildStateScript(a,n,{address:this._chDimmerWeekProfile},{value:"profile"})}return d};a.prototype.handleStatusResponse=function(a,b,c){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "dimmerTLevel":return a=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(a,
{value:"dimmerTLevel"}),this.useStateBuffer()&&(b=this.getAddress()+":"+this._chDimmerTransmitter+".LEVEL",c._statebuffer[b]={value:a,timestamp:(new Date).getTime(),expire:1E3}),a;case "ch"+this._chDimmerVirtualReceiver1+"Level":case "ch"+this._chDimmerVirtualReceiver2+"Level":case "ch"+this._chDimmerVirtualReceiver3+"Level":return xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.handleStatusResponse(a,{value:"dimmerLevel"});case "profile":return a=xnm.aio.hm.HmIPChannel.DIMMER_WEEK_PROFILE.handleStatusResponse(a,
{value:"profile"}),"?"!=a&&(a=a>>3*this._dimmerIdx&1?"manu":"auto"),a;default:return"?"}};a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=b.channel.substr(d+1);d=null;switch(parseInt(e)){case this._chMaintenance:d=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case this._chDimmerTransmitter:d=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.resolveState(a,b,c);break;case this._chDimmerVirtualReceiver1:case this._chDimmerVirtualReceiver2:case this._chDimmerVirtualReceiver3:if(d=
xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.resolveState(a,b,c))d.key="ch"+e+"Level";break;case this._chDimmerWeekProfile:if(d=xnm.aio.hm.HmIPChannel.DIMMER_WEEK_PROFILE.resolveState(a,b,c))a=d.profile,"?"!=a&&(d.profile=a>>3*this._dimmerIdx&1?"manu":"auto")}return d};a.parseJSON=function(b,c,d){if(!b||!b.type||!b.channels)return null;var e=new a;e._type=b.type;e._address=b.address;var n=e._chDimmerWeekProfile=0,l;for(l in b.channels)"DIMMER_TRANSMITTER"==l.substr(0,18)?e._chDimmerTransmitter=
parseInt(b.channels[l].address):"DIMMER_VIRTUAL_RECEIVER"==l.substr(0,23)?(n++,1==n?e._chDimmerVirtualReceiver1=parseInt(b.channels[l].address):2==n?e._chDimmerVirtualReceiver2=parseInt(b.channels[l].address):3==n&&(e._chDimmerVirtualReceiver3=parseInt(b.channels[l].address))):"DIMMER_WEEK_PROFILE"==l.substr(0,19)&&(e._chDimmerWeekProfile=parseInt(b.channels[l].address));if(c&&d&&e._chSwitchTransmitter){b=[];for(n=0;n<d;n++)b.push(c+4*n);c=b.indexOf(e._chDimmerTransmitter);-1!=c&&(e._dimmerIdx=c)}return e};
return a}(),e=function(){var a=function(){this._blindIdx=0;this._address=this._type=null;this._chMaintenance=0;this._chBlindTransmitter=1;this._chBlindVirtualReceiver1=2;this._chBlindVirtualReceiver2=3;this._chBlindVirtualReceiver3=4;this._chBlindWeekProfile=17};a.prototype._getCommonMap=function(){return{command:[{type:"enum",name:"stop",ref:{value:"stop"}},{type:"enum",name:"move up",ref:{value:"moveUp"}},{type:"enum",name:"move down",ref:{value:"moveDown"}},{type:"int",name:"step up",ref:{value:"stepUp",
...
unit:"%"}},{type:"int",name:"lamella to",ref:{value:"lamellaTo",ext:"%d",extMeta:"0-100",unit:"%"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"int",name:"blind status",ref:{value:"blindTPos",extMeta:"0-100",unit:"%"}},{type:"int",name:"lamella status",ref:{value:"lamellaTPos",extMeta:"0-100",unit:"%"}}]}};a.prototype.getAddress=function(){var a=this._address.indexOf(":");return-1!=a?this._address.substr(0,a):this._address};a.prototype.getCommandStatusMap=
function(){var a=JSON.parse(JSON.stringify(this._getCommonMap()));this._chBlindWeekProfile&&(a.command.push({type:"enum",name:"set profile",ref:{value:"setProfile",ext:"%e",extMeta:["auto","manu"]}}),a.status.push({type:"enum",name:"profile",ref:{value:"profile",extMeta:["auto","manu"]}}));return a};a.prototype.getIPEvtMap=function(){return{ipevt:JSON.parse(JSON.stringify(this._getCommonMap())).status}};a.prototype.executeCommand=function(a,b,c,d){c?("setProfile"==c.value?this._chBlindWeekProfile&&
(c={value:"setProfile",ext:[{value:"mode",ext:c.ext},{value:"channels",ext:1<<3*this._blindIdx}]},script=xnm.aio.hm.HmIPChannel.BLIND_WEEK_PROFILE.buildCommandScript(a,{interface:b.interface,address:this.getAddress(),channels:b.channels},{address:this._chBlindWeekProfile},c)):script=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildCommandScript(a,{interface:b.interface,address:this.getAddress(),channels:b.channels},{address:this._chBlindVirtualReceiver1},{value:c.value,ext:c.ext}),script?a._doRequestMarked(script,
!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command"))):d&&d(Error("command is null"))};a.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;b={interface:b.interface,address:this.getAddress(),channels:b.channels};switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:this._chMaintenance},c);break;case "blindTPos":d=xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.buildStateScript(a,b,{address:this._chBlindTransmitter},
{value:"blindTPos"});break;case "lamellaTPos":d=xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.buildStateScript(a,b,{address:this._chBlindTransmitter},{value:"lamellaTPos"});break;case "profile":d=xnm.aio.hm.HmIPChannel.BLIND_WEEK_PROFILE.buildStateScript(a,b,{address:this._chBlindWeekProfile},{value:"profile"})}return d};a.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "blindTPos":return xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.handleStatusResponse(a,
{value:"blindTPos"});case "lamellaTPos":return xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.handleStatusResponse(a,{value:"lamellaTPos"});case "profile":return a=xnm.aio.hm.HmIPChannel.BLIND_WEEK_PROFILE.handleStatusResponse(a,{value:"profile"}),"?"!=a&&(a=a>>3*this._blindIdx&1?"manu":"auto"),a;default:return"?"}};a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=b.channel.substr(d+1);d=null;switch(parseInt(e)){case this._chMaintenance:d=
xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case this._chBlindTransmitter:d=xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.resolveState(a,b,c);break;case this._chBlindWeekProfile:if(d=xnm.aio.hm.HmIPChannel.BLIND_WEEK_PROFILE.resolveState(a,b,c))a=d.profile,"?"!=a&&(d.profile=a>>3*this._blindIdx&1?"manu":"auto")}return d};a.parseJSON=function(b,c,d){if(!b||!b.type||!b.channels)return null;var e=new a;e._type=b.type;e._address=b.address;var n=e._chBlindWeekProfile=0,l;for(l in b.channels)"BLIND_TRANSMITTER"==
l.substr(0,17)?e._chBlindTransmitter=parseInt(b.channels[l].address):"BLIND_VIRTUAL_RECEIVER"==l.substr(0,22)?(n++,1==n?e._chBlindVirtualReceiver1=parseInt(b.channels[l].address):2==n?e._chBlindVirtualReceiver2=parseInt(b.channels[l].address):3==n&&(e._chBlindVirtualReceiver3=parseInt(b.channels[l].address))):"BLIND_WEEK_PROFILE"==l.substr(0,18)&&(e._chBlindWeekProfile=parseInt(b.channels[l].address));if(c&&d&&e._chBlindTransmitter){b=[];for(n=0;n<d;n++)b.push(c+4*n);c=b.indexOf(e._chBlindTransmitter);
-1!=c&&(e._blindIdx=c)}return e};return a}(),f=function(){var a=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=null;this._chInputTransmitter=1};a.prototype.getCommandStatusMap=function(){var a="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?{status:[{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",
ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]}:{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]};a.status.push({type:"enum",name:"status",ref:{value:"state",options:["off","on"]}});return a};a.prototype.getIPEvtMap=function(){var a="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",
options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]}:{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]};a.ipevt.push({type:"enum",name:"status",ref:{value:"state",options:["off","on"]}});a.ipevt.push({type:"enum",name:"short press",ref:{value:"pressShort",options:["true"]}});a.ipevt.push({type:"enum",name:"long press",ref:{value:"pressLong",options:["true"]}});return a};a.prototype.buildStateScript=
function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:this._chMaintenance},c);break;case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":d=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,b,{address:this._chMaintenance},c);break;case "state":d=xnm.aio.hm.HmIPChannel.MULTI_MODE_INPUT_TRANSMITTER.buildStateScript(a,b,{address:this._chInputTransmitter},{value:"state"})}return d};a.prototype.handleStatusResponse=
function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,b);case "state":return xnm.aio.hm.HmIPChannel.MULTI_MODE_INPUT_TRANSMITTER.handleStatusResponse(a,{value:"state"});default:return"?"}};a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");
if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(parseInt(d)){case this._chMaintenance:e="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(a,b,c):xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case this._chInputTransmitter:e=xnm.aio.hm.HmIPChannel.MULTI_MODE_INPUT_TRANSMITTER.resolveState(a,b,c)}return e};a.parseJSON=function(b){if(!b||!b.type||!b.channels)return null;var c=new a;c._type=b.type;c._address=b.address;
if("HmIP-FCI"==b.type.substr(0,8)||"HmIP-MOD-RC"==b.type.substr(0,11))c._chMaintenanceHsstype="MAINTENANCE_BAT_EL";for(var d in b.channels)"MULTI_MODE_INPUT_TRANSMITTER"==d.substr(0,28)?c._chInputTransmitter=parseInt(b.channels[d].address):"KEY_TRANSCEIVER"==d.substr(0,15)&&"HmIP-MOD-RC"==b.type.substr(0,11)&&(c._chInputTransmitter=parseInt(b.channels[d].address));return c};return a}(),g=function(){var a=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=null;
this._chShutterContact=1;this._chShutterContactHsstype=null};a.prototype.getCommandStatusMap=function(){var a="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?{status:[{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]}:{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",
options:["false","true"]}}]};"SHUTTER_CONTACT_TRANSCEIVER"==this._chShutterContactHsstype?a.status.push({type:"enum",name:"status",ref:{value:"shutterTState",value_t:"contactState",options:["open","closed"]}}):a.status.push({type:"enum",name:"status",ref:{value:"shutterState",value_t:"contactState",options:["open","closed"]}});return a};a.prototype.getIPEvtMap=function(){var a="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorBatElComm",
options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]}:{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]};"SHUTTER_CONTACT_TRANSCEIVER"==this._chShutterContactHsstype?a.ipevt.push({type:"enum",name:"status",ref:{value:"shutterTState",value_t:"contactState",options:["open","closed"]}}):a.ipevt.push({type:"enum",
name:"status",ref:{value:"shutterState",value_t:"contactState",options:["open","closed"]}});return a};a.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:this._chMaintenance},c);break;case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":d=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,b,{address:this._chMaintenance},c);break;case "shutterState":d=xnm.aio.hm.HmIPChannel.SHUTTER_CONTACT.buildStateScript(a,
b,{address:this._chShutterContact},{value:"shutterState"});break;case "shutterTState":d=xnm.aio.hm.HmIPChannel.SHUTTER_CONTACT_TRANSCEIVER.buildStateScript(a,b,{address:this._chShutterContact},{value:"shutterTState"})}return d};a.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,
b);case "shutterState":return xnm.aio.hm.HmIPChannel.SHUTTER_CONTACT.handleStatusResponse(a,{value:"shutterState"});case "shutterTState":return xnm.aio.hm.HmIPChannel.SHUTTER_CONTACT_TRANSCEIVER.handleStatusResponse(a,{value:"shutterTState"});default:return"?"}};a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(parseInt(d)){case this._chMaintenance:e="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?
xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(a,b,c):xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case this._chShutterContact:e="SHUTTER_CONTACT_TRANSCEIVER"==this._chShutterContactHsstype?xnm.aio.hm.HmIPChannel.SHUTTER_CONTACT_TRANSCEIVER.resolveState(a,b,c):xnm.aio.hm.HmIPChannel.SHUTTER_CONTACT.resolveState(a,b,c)}return e};a.parseJSON=function(b){if(!b||!b.type||!b.channels)return null;var c=new a;c._type=b.type;c._address=b.address;"HmIP-SCI"==b.type.substr(0,8)&&(c._chMaintenanceHsstype=
"MAINTENANCE_BAT_EL");for(var d in b.channels)"SHUTTER_CONTACT_TRANSCEIVER"==d.substr(0,27)?(c._chShutterContact=parseInt(b.channels[d].address),c._chShutterContactHsstype="SHUTTER_CONTACT_TRANSCEIVER"):"SHUTTER_CONTACT"==d.substr(0,15)&&(c._chShutterContact=parseInt(b.channels[d].address),c._chShutterContactHsstype="SHUTTER_CONTACT");return c};return a}(),h=function(){var a=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=null;this._chHeatingClimateControlTransceiver=
1};a.prototype.getCommandStatusMap=function(){var a={command:[{type:"int",name:"set profile",ref:{value:"themoProf",ext:"%d",extMeta:"1-6",scale:"1"}},{type:"enum",name:"boost on",ref:{value:"themoBoostOn"}},{type:"enum",name:"boost off",ref:{value:"themoBoostOff"}},{type:"enum",name:"set auto mode",ref:{value:"themoAutoMode"}},{type:"enum",name:"set manu mode",ref:{value:"themoManuMode"}},{type:"float",name:"set temperature",ref:{value:"themoTemp",ext:"%f",extMeta:"4.5-30.5",scale:"0.5"}},{type:"enum",
name:"on",ref:{value:"themoTempOn"}},{type:"enum",name:"off",ref:{value:"themoTempOff"}},{type:"enum",name:"temperature up",ref:{value:"themoTempUp"}},{type:"enum",name:"temperature down",ref:{value:"themoTempDown"}}],status:[{type:"int",name:"profile",ref:{value:"themoProf"}},{type:"float",name:"actual temperature",ref:{value:"themoActualTemp",extMeta:"-10.0-56.0",scale:"0.1"}},{type:"enum",name:"boost mode",ref:{value:"themoBoostMode",options:["off","on"]}},{type:"enum",name:"frost protection",
ref:{value:"themoFrost",options:["off","on"]}},{type:"int",name:"humidity",ref:{value:"themoHum"}},{type:"enum",name:"mode",ref:{value:"themoMode",options:["auto","manu"]}},{type:"float",name:"set temperature",ref:{value:"themoTemp",extMeta:"4.5-30.5",scale:"0.5"}}]};"HmIP-WTH-B"!=this._type&&(a.command.push({type:"enum",name:"set window open",ref:{value:"themoWinOpen"}}),a.command.push({type:"enum",name:"set window close",ref:{value:"themoWinClose"}}),a.status.push({type:"enum",name:"window state",
ref:{value:"themoWinState",options:["open","closed"]}}));a.status="MAINTENANCE_BAT_CL"==this._chMaintenanceHsstype?a.status.concat([{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]):a.status.concat([{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false",
"true"]}}]);return a};a.prototype.getIPEvtMap=function(){var a={ipevt:[{type:"int",name:"profile",ref:{value:"themoProf"}},{type:"float",name:"actual temperature",ref:{value:"themoActualTemp",extMeta:"-10.0-56.0",scale:"0.1"}},{type:"enum",name:"boost mode",ref:{value:"themoBoostMode",options:["off","on"]}},{type:"enum",name:"frost protection",ref:{value:"themoFrost",options:["off","on"]}},{type:"int",name:"humidity",ref:{value:"themoHum"}},{type:"enum",name:"mode",ref:{value:"themoMode",options:["auto",
"manu"]}},{type:"float",name:"set temperature",ref:{value:"themoTemp",extMeta:"4.5-30.5",scale:"0.5"}},{type:"enum",name:"window state",ref:{value:"themoWinState",options:["open","closed"]}}]};"HmIP-WTH-B"!=this._type&&a.ipevt.push({type:"enum",name:"window state",ref:{value:"themoWinState",options:["open","closed"]}});a.ipevt="MAINTENANCE_BAT_CL"==this._chMaintenanceHsstype?a.ipevt.concat([{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",
name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]):a.ipevt.concat([{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]);return a};a.prototype.executeCommand=function(a,b,c,d){c?(script=xnm.aio.hm.HmIPChannel.HEATING_CLIMATECONTROL_TRANSCEIVER.buildCommandScript(a,{interface:b.interface,address:this._address,channels:b.channels},{address:this._chHeatingClimateControlTransceiver},
{value:c.value,ext:c.ext}))?a._doRequestMarked(script,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command")):d&&d(Error("command is null"))};a.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:this._chMaintenance},c);break;case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":d=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,
b,{address:this._chMaintenance},c);break;case "themoProf":case "themoActualTemp":case "themoBoostMode":case "themoFrost":case "themoHum":case "themoMode":case "themoTemp":case "themoValveLevel":case "themoWinState":d=xnm.aio.hm.HmIPChannel.HEATING_CLIMATECONTROL_TRANSCEIVER.buildStateScript(a,b,{address:this._chHeatingClimateControlTransceiver},{value:c.value})}return d};a.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,
b);case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,b);case "themoProf":case "themoActualTemp":case "themoBoostMode":case "themoFrost":case "themoHum":case "themoMode":case "themoTemp":case "themoValveLevel":case "themoWinState":return xnm.aio.hm.HmIPChannel.HEATING_CLIMATECONTROL_TRANSCEIVER.handleStatusResponse(a,b);default:return"?"}};a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;
var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(parseInt(d)){case this._chMaintenance:e="MAINTENANCE_BAT_CL"==this._chMaintenanceHsstype?xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(a,b,c):xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case this._chHeatingClimateControlTransceiver:e=xnm.aio.hm.HmIPChannel.HEATING_CLIMATECONTROL_TRANSCEIVER.resolveState(a,b,c)}return e};a.parseJSON=function(b){if(!b||!b.type||!b.channels)return null;
var c=new a;c._type=b.type;c._address=b.address;c._chMaintenanceHsstype="MAINTENANCE";"HmIP-WTH-B"==b.type&&(c._chMaintenanceHsstype="MAINTENANCE_BAT_CL");return c};return a}(),k=function(){var a=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype="MAINTENANCE";this._chMotionDetectorTransceiver=1;this._chKeyTransceivers=[]};a.prototype.getCommandStatusMap=function(){var a={command:[{type:"enum",name:"reset",ref:{value:"motionReset"}},{type:"enum",name:"activate detection",
ref:{value:"motionOn"}},{type:"enum",name:"deactivate detection",ref:{value:"motionOff"}},{type:"enum",name:"toggle detection",ref:{value:"motionToggle"}}],status:[{type:"float",name:"illumination",ref:{value:"motionIllu"}},{type:"enum",name:"state",ref:{value:"motionState",options:["on","off"]}},{type:"enum",name:"detection activated",ref:{value:"motionActivate",options:["off","on"]}}]};a.status="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?a.status.concat([{type:"enum",name:"communication error",
ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]):a.status.concat([{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]);return a};a.prototype.getIPEvtMap=function(){var a={ipevt:[{type:"float",name:"illumination",ref:{value:"motionIllu"}},{type:"enum",name:"state",ref:{value:"motionState",
options:["on","off"]}},{type:"enum",name:"detection activated",ref:{value:"motionActivate",options:["off","on"]}}]};a.ipevt="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?a.ipevt.concat([{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]):a.ipevt.concat([{type:"enum",name:"communication error",
ref:{value:"errorComm",options:["false","true"]}}]);if(1==this._chKeyTransceivers.length)a.ipevt.push({type:"enum",name:"short press",ref:{value:"pressShort",options:["true"]}}),a.ipevt.push({type:"enum",name:"long press",ref:{value:"pressLong",options:["true"]}});else for(var b=0;b<this._chKeyTransceivers.length;b++){var c=this._chKeyTransceivers[b];c&&(a.ipevt.push({type:"enum",name:"button "+c+" short press",ref:{value:"btn"+c+"pressShort",options:["true"]}}),a.ipevt.push({type:"enum",name:"button "+
c+" long press",ref:{value:"btn"+c+"pressLong",options:["true"]}}))}return a};a.prototype.executeCommand=function(a,b,c,d){c?(script=xnm.aio.hm.HmIPChannel.MOTIONDETECTOR_TRANSCEIVER.buildCommandScript(a,{interface:b.interface,address:this._address,channels:b.channels},{address:this._chMotionDetectorTransceiver},{value:c.value,ext:c.ext}))?a._doRequestMarked(script,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command")):d&&d(Error("command is null"))};a.prototype.buildStateScript=
function(a,b,c){if(!c)return null;switch(c.value){case "errorComm":a=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:this._chMaintenance},c);break;case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":a=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,b,{address:this._chMaintenance},c);break;default:a=xnm.aio.hm.HmIPChannel.MOTIONDETECTOR_TRANSCEIVER.buildStateScript(a,b,{address:this._chMotionDetectorTransceiver},{value:c.value})}return a};a.prototype.handleStatusResponse=
function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,b);case "motionIllu":case "motionState":case "motionActivate":return xnm.aio.hm.HmIPChannel.MOTIONDETECTOR_TRANSCEIVER.handleStatusResponse(a,b);default:return"?"}};a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;
var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(parseInt(d)){case this._chMaintenance:e="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(a,b,c):xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case this._chMotionDetectorTransceiver:e=xnm.aio.hm.HmIPChannel.MOTIONDETECTOR_TRANSCEIVER.resolveState(a,b,c);break;default:-1!=this._chKeyTransceivers.indexOf(parseInt(d))&&(e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,
b,c),1<this._chKeyTransceivers.length&&e&&("pressShort"==e.key?e.key="btn"+d+"pressShort":"pressLong"==e.key&&(e.key="btn"+d+"pressLong")))}return e};a.parseJSON=function(b){if(!b||!b.type||!b.channels)return null;var c=new a;c._type=b.type;c._address=b.address;"HmIP-SMI55"==b.type&&(c._chMaintenanceHsstype="MAINTENANCE_BAT_EL");-1!=b.type.indexOf("SMI55")&&(c._chKeyTransceivers=[1,2],c._chMotionDetectorTransceiver=3);return c};return a}(),m=function(){var a=function(){this._address=this._type=null;
this._chMaintenance=0;this._chMaintenanceHsstype="MAINTENANCE";this._chPresenceDetectorTransceiver=1};a.prototype.getCommandStatusMap=function(){var a={command:[{type:"enum",name:"reset",ref:{value:"presenceReset"}},{type:"enum",name:"activate detection",ref:{value:"presenceOn"}},{type:"enum",name:"deactivate detection",ref:{value:"presenceOff"}},{type:"enum",name:"toggle detection",ref:{value:"presenceToggle"}}],status:[{type:"float",name:"illumination",ref:{value:"presenceIllu"}},{type:"enum",name:"state",
ref:{value:"presenceState",options:["on","off"]}},{type:"enum",name:"detection activated",ref:{value:"presenceActivate",options:["off","on"]}}]};a.status="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?a.status.concat([{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]):
a.status.concat([{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]);return a};a.prototype.getIPEvtMap=function(){var a={ipevt:[{type:"float",name:"illumination",ref:{value:"presenceIllu"}},{type:"enum",name:"state",ref:{value:"presenceState",options:["on","off"]}},{type:"enum",name:"detection activated",ref:{value:"presenceActivate",options:["off","on"]}}]};a.ipevt="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?a.ipevt.concat([{type:"enum",name:"communication error",
ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]):a.ipevt.concat([{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]);return a};a.prototype.executeCommand=function(a,b,c,d){c?(script=xnm.aio.hm.HmIPChannel.PRESENCEDETECTOR_TRANSCEIVER.buildCommandScript(a,{interface:b.interface,
address:this._address,channels:b.channels},{address:this._chPresenceDetectorTransceiver},{value:c.value,ext:c.ext}))?a._doRequestMarked(script,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command")):d&&d(Error("command is null"))};a.prototype.buildStateScript=function(a,b,c){if(!c)return null;switch(c.value){case "errorComm":a=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:this._chMaintenance},c);break;case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":a=
xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,b,{address:this._chMaintenance},c);break;default:a=xnm.aio.hm.HmIPChannel.PRESENCEDETECTOR_TRANSCEIVER.buildStateScript(a,b,{address:this._chPresenceDetectorTransceiver},c)}return a};a.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,
b);case "presenceIllu":case "presenceState":case "presenceActivate":return xnm.aio.hm.HmIPChannel.PRESENCEDETECTOR_TRANSCEIVER.handleStatusResponse(a,b);default:return"?"}};a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(parseInt(d)){case this._chMaintenance:e="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(a,b,c):xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,
b,c);break;case this._chPresenceDetectorTransceiver:e=xnm.aio.hm.HmIPChannel.PRESENCEDETECTOR_TRANSCEIVER.resolveState(a,b,c)}return e};a.parseJSON=function(b){if(!b||!b.type||!b.channels)return null;var c=new a;c._type=b.type;c._address=b.address;"HmIP-SPI"==b.type&&(c._chMaintenanceHsstype="MAINTENANCE_BAT_EL");return c};return a}(),p=function(){var a=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=null;this._chHeatingClimateControlFloorTransceiver=1};a.prototype.getCommandStatusMap=
function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"humidity limiter",ref:{value:"cl_f_humidityLimiter",options:["true","false"]}},{type:"enum",name:"emergency operation",ref:{value:"cl_f_emergencyOP",options:["true","false"]}},{type:"enum",name:"frost protection",ref:{value:"cl_f_frostProtection",options:["true","false"]}},{type:"float",name:"valve level",ref:{value:"cl_valve_level",extMeta:"0-100"}}]}};a.prototype.getIPEvtMap=
function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"humidity limiter",ref:{value:"cl_f_humidityLimiter",options:["true","false"]}},{type:"enum",name:"emergency operation",ref:{value:"cl_f_emergencyOP",options:["true","false"]}},{type:"enum",name:"frost protection",ref:{value:"cl_f_frostProtection",options:["true","false"]}},{type:"float",name:"valve level",ref:{value:"cl_valve_level",extMeta:"0-100"}}]}};a.prototype.buildStateScript=
function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:this._chMaintenance},c);break;case "cl_f_humidityLimiter":case "cl_f_emergencyOP":case "cl_f_frostProtection":case "cl_valve_level":d=xnm.aio.hm.HmIPChannel.CLIMATECONTROL_FLOOR_TRANSCEIVER.buildStateScript(a,b,{address:this._chHeatingClimateControlFloorTransceiver},{value:c.value})}return d};a.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;
switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "cl_f_humidityLimiter":case "cl_f_emergencyOP":case "cl_f_frostProtection":case "cl_valve_level":return xnm.aio.hm.HmIPChannel.CLIMATECONTROL_FLOOR_TRANSCEIVER.handleStatusResponse(a,b);default:return"?"}};a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(parseInt(d)){case this._chMaintenance:e=
xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case this._chHeatingClimateControlFloorTransceiver:e=xnm.aio.hm.HmIPChannel.CLIMATECONTROL_FLOOR_TRANSCEIVER.resolveState(a,b,c)}return e};a.parseJSON=function(b){if(!b||!b.type||!b.channels)return null;var c=new a;c._type=b.type;c._address=b.address;c._chMaintenanceHsstype="MAINTENANCE";for(var d in b.channels)"CLIMATECONTROL_FLOOR_TRANSCEIVER"==d.substr(0,32)&&(c._chHeatingClimateControlFloorTransceiver=parseInt(b.channels[d].address));
return c};return a}(),t=function(){var a=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype="MAINTENANCE";this._chAnalogInputTransmitter=1};a.prototype.getCommandStatusMap=function(){return{status:[{type:"float",name:"input voltage",ref:{value:"analogInputVoltage",extMeta:"0.0-12.0"}},{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]}};a.prototype.getIPEvtMap=function(){return{ipevt:[{type:"float",name:"input voltage",
ref:{value:"analogInputVoltage",extMeta:"0.0-12.0"}},{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]}};a.prototype.buildStateScript=function(a,b,c){if(!c)return null;switch(c.value){case "errorComm":a=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:this._chMaintenance},c);break;default:a=xnm.aio.hm.HmIPChannel.ANALOG_INPUT_TRANSMITTER.buildStateScript(a,b,{address:this._chAnalogInputTransmitter},c)}return a};a.prototype.handleStatusResponse=
function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "analogInputVoltage":return xnm.aio.hm.HmIPChannel.ANALOG_INPUT_TRANSMITTER.handleStatusResponse(a,b);default:return"?"}};a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(parseInt(d)){case this._chMaintenance:e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,
b,c);break;case this._chAnalogInputTransmitter:e=xnm.aio.hm.HmIPChannel.ANALOG_INPUT_TRANSMITTER.resolveState(a,b,c)}return e};a.parseJSON=function(b){if(!b||!b.type||!b.channels)return null;var c=new a;c._type=b.type;c._address=b.address;for(var d in b.channels)"ANALOG_INPUT_TRANSMITTER"==d.substr(0,24)&&(c._chAnalogInputTransmitter=parseInt(b.channels[d].address));return c};return a}(),r=function(){};r.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"on"}},
{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}},{type:"enum",name:"ch.4 on",ref:{value:"ch4on"}},{type:"enum",name:"ch.4 off",ref:{value:"ch4off"}},{type:"enum",name:"ch.4 toggle",ref:{value:"ch4toggle"}},{type:"enum",name:"ch.5 on",ref:{value:"ch5on"}},{type:"enum",name:"ch.5 off",ref:{value:"ch5off"}},{type:"enum",name:"ch.5 toggle",ref:{value:"ch5toggle"}},{type:"enum",name:"ch.6 on",ref:{value:"ch6on"}},{type:"enum",name:"ch.6 off",ref:{value:"ch6off"}},
{type:"enum",name:"ch.6 toggle",ref:{value:"ch6toggle"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"switch status",ref:{value:"switchState",options:["off","on"]}},{type:"enum",name:"ch.4 status",ref:{value:"ch4State",options:["off","on"]}},{type:"enum",name:"ch.5 status",ref:{value:"ch5State",options:["off","on"]}},{type:"enum",name:"ch.6 status",ref:{value:"ch6State",options:["off","on"]}},{type:"float",name:"voltage",ref:{value:"meterVoltage",
extMeta:"0.0-409.5",scale:"0.1",unit:"V"}},{type:"float",name:"energy counter",ref:{value:"meterEnergyCounter",extMeta:"0.0-838859.1",scale:"0.1",unit:"Wh"}},{type:"float",name:"frequency",ref:{value:"meterFrequency",extMeta:"29.52-70.47",scale:"0.01",unit:"Hz"}},{type:"float",name:"power",ref:{value:"meterPower",extMeta:"0.0-163830.0",scale:"0.1",unit:"W"}},{type:"float",name:"current",ref:{value:"meterCurrent",extMeta:"0.0-65535.0",scale:"0.1",unit:"mA"}}]}};r.prototype.getIPEvtMap=function(){var a=
this.getCommandStatusMap().status;return{ipevt:JSON.parse(JSON.stringify(a))}};r.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;switch(c.value){case "on":case "ch4on":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:4},{value:"on"});break;case "off":case "ch4off":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:4},{value:"off"});break;case "toggle":case "ch4toggle":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,
...
ref:{value:"ch5Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.6 status",ref:{value:"ch6Level",extMeta:"0-100",unit:"%"}}]}};u.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;return{ipevt:JSON.parse(JSON.stringify(a))}};u.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;switch(c.value){case "dimOn":case "ch4dimOn":e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:4},{value:"dimOn"});break;case "dimOff":case "ch4dimOff":e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(a,
...
u.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "dimmerTLevel":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(a,{value:"dimmerTLevel"});case "ch4Level":case "ch5Level":case "ch6Level":return xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.handleStatusResponse(a,{value:"dimmerLevel"});default:return"?"}};u.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;
var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "3":e=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.resolveState(a,b,c);break;case "4":case "5":case "6":e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.resolveState(a,b,c),e.key="4"==d?"ch4Level":"5"==d?"ch5Level":"ch6Level"}return e};var v=function(){};v.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",
name:"battery low",ref:{value:"errorBat",options:["false","true"]}}]}};v.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false","true"]}},{type:"enum",name:"button 1 short press",ref:{value:"btn1pressShort",options:["true"]}},{type:"enum",name:"button 1 long press",ref:{value:"btn1pressLong",options:["true"]}},{type:"enum",name:"button 2 short press",
ref:{value:"btn2pressShort",options:["true"]}},{type:"enum",name:"button 2 long press",ref:{value:"btn2pressLong",options:["true"]}}]}};v.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c)}return d};v.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,
b);default:return"?"}};v.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":case "2":e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c),"pressShort"==e.key?e.key="1"==d?"btn1pressShort":"btn2pressShort":"pressLong"==e.key&&(e.key="1"==d?"btn1pressLong":"btn2pressLong")}return e};var x=function(){};
x.prototype.getCommandStatusMap=function(){return{command:[{type:"multi",name:"trigger alarm",ref:{value:"alarmTrigger",ext:"%multi",extMeta:[{type:"enum",name:"set audio",ref:{value:"alarmAudio",ext:"%e",extMeta:"DISABLE_ACOUSTIC_SIGNAL FREQUENCY_RISING FREQUENCY_FALLING FREQUENCY_RISING_AND_FALLING FREQUENCY_ALTERNATING_LOW_HIGH FREQUENCY_ALTERNATING_LOW_MID_HIGH FREQUENCY_HIGHON_OFF FREQUENCY_HIGHON_LONGOFF FREQUENCY_LOWON_OFF_HIGHON_OFF FREQUENCY_LOWON_LONGOFF_HIGHON_LONGOFF LOW_BATTERY DISARMED INTERNALLY_ARMED EXTERNALLY_ARMED DELAYED_INTERNALLY_ARMED DELAYED_EXTERNALLY_ARMED EVENT ERROR".split(" ")}},
...
ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"sabotage",ref:{value:"errorSabo",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatVoltage",ext:"%f",extMeta:"0-25.2"}},{type:"enum",name:"alarm state",ref:{value:"alarmState",options:["on","off"]}},{type:"enum",name:"alarm audio state",ref:{value:"alarmAudioState",options:["on","off"]}},{type:"enum",name:"alarm visual state",
ref:{value:"alarmVisualState",options:["on","off"]}}]}};x.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"sabotage",ref:{value:"errorSabo",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatVoltage",ext:"%f",extMeta:"0-25.2"}},{type:"enum",name:"alarm state",ref:{value:"alarmState",
options:["on","off"]}},{type:"enum",name:"alarm audio state",ref:{value:"alarmAudioState",options:["on","off"]}},{type:"enum",name:"alarm visual state",ref:{value:"alarmVisualState",options:["on","off"]}}]}};x.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;switch(c.value){case "alarmTrigger":e=xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:3},c)}e?a._doRequestMarked(e,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command"))}else d&&
d(Error("command is null"))};x.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":case "errorSabo":case "errorBatVoltage":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "alarmState":case "alarmAudioState":case "alarmVisualState":d=xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:3},c)}return d};x.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;
switch(b.value){case "errorComm":case "errorBat":case "errorSabo":case "errorBatVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "alarmState":case "alarmAudioState":case "alarmVisualState":return xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.handleStatusResponse(a,b);default:return"?"}};x.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=
xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "3":e=xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.resolveState(a,b,c)}return e};var y=function(){};y.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"intrusion alarm off",ref:{value:"intrusionAlarmOff"}},{type:"enum",name:"intrusion alarm on",ref:{value:"intrusionAlarmOn"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",
ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"smokeState",options:["on","off"]}},{type:"enum",name:"alarm detail",ref:{value:"smokeAlarmDetail",options:["off","primary_alarm","intrusion_alarm","secondary_alarm"]}}]}};y.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false","true"]}},{type:"enum",name:"alarm state",
ref:{value:"smokeState",options:["on","off"]}},{type:"enum",name:"alarm detail",ref:{value:"smokeAlarmDetail",options:["off","primary_alarm","intrusion_alarm","secondary_alarm"]}}]}};y.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;switch(c.value){case "intrusionAlarmOff":case "intrusionAlarmOn":e=xnm.aio.hm.HmIPChannel.SMOKE_DETECTOR.buildCommandScript(a,b,{address:1},c)}e?a._doRequestMarked(e,!0,{execute:function(a){d&&d(a)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};
y.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "smokeState":d=xnm.aio.hm.HmIPChannel.SMOKE_DETECTOR.buildStateScript(a,b,{address:3},c)}return d};y.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "smokeState":case "smokeAlarmDetail":return xnm.aio.hm.HmIPChannel.SMOKE_DETECTOR.handleStatusResponse(a,
b);default:return"?"}};y.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.SMOKE_DETECTOR.resolveState(a,b,c)}return e};var q=function(){};q.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},
{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"sabotage",ref:{value:"errorSabo",options:["false","true"]}},{type:"enum",name:"window state",ref:{value:"handleState",options:["closed","tilted","open"]}}]}};q.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false","true"]}},{type:"enum",name:"sabotage",
ref:{value:"errorSabo",options:["false","true"]}},{type:"enum",name:"window state",ref:{value:"handleState",options:["closed","tilted","open"]}}]}};q.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":case "errorSabo":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "handleState":d=xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.buildStateScript(a,b,{address:1},c)}return d};q.prototype.handleStatusResponse=
function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":case "errorSabo":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "handleState":return xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.handleStatusResponse(a,b);default:return"?"}};q.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,
b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.resolveState(a,b,c)}return e};var D=function(){};D.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}},{type:"enum",name:"ch.2 on",ref:{value:"ch2on"}},{type:"enum",name:"ch.2 off",ref:{value:"ch2off"}},{type:"enum",name:"ch.2 toggle",ref:{value:"ch2toggle"}},{type:"enum",name:"ch.3 on",ref:{value:"ch3on"}},
{type:"enum",name:"ch.3 off",ref:{value:"ch3off"}},{type:"enum",name:"ch.3 toggle",ref:{value:"ch3toggle"}},{type:"enum",name:"ch.4 on",ref:{value:"ch4on"}},{type:"enum",name:"ch.4 off",ref:{value:"ch4off"}},{type:"enum",name:"ch.4 toggle",ref:{value:"ch4toggle"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"switch status",ref:{value:"switchState",options:["off","on"]}},{type:"enum",name:"ch.2 status",ref:{value:"ch2State",options:["off",
"on"]}},{type:"enum",name:"ch.3 status",ref:{value:"ch3State",options:["off","on"]}},{type:"enum",name:"ch.4 status",ref:{value:"ch4State",options:["off","on"]}},{type:"float",name:"voltage",ref:{value:"meterVoltage",extMeta:"0.0-409.5",scale:"0.1",unit:"V"}},{type:"float",name:"energy counter",ref:{value:"meterEnergyCounter",extMeta:"0.0-838859.1",scale:"0.1",unit:"Wh"}},{type:"float",name:"frequency",ref:{value:"meterFrequency",extMeta:"29.52-70.47",scale:"0.01",unit:"Hz"}},{type:"float",name:"power",
ref:{value:"meterPower",extMeta:"0.0-163830.0",scale:"0.1",unit:"W"}},{type:"float",name:"current",ref:{value:"meterCurrent",extMeta:"0.0-65535.0",scale:"0.1",unit:"mA"}}]}};D.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;return{ipevt:JSON.parse(JSON.stringify(a))}};D.prototype.executeCommand=function(a,b,c,d){if(c){var e=null,g=null;switch(c.value){case "on":case "ch2on":case "ch3on":case "ch4on":switch(c.value){case "on":case "ch2on":g=2;break;case "ch3on":g=3;break;case "ch4on":g=
4}e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:g},{value:"on"});break;case "off":case "ch2off":case "ch3off":case "ch4off":switch(c.value){case "off":case "ch2off":g=2;break;case "ch3off":g=3;break;case "ch4off":g=4}e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:g},{value:"off"});break;case "toggle":case "ch2toggle":case "ch3toggle":case "ch4toggle":switch(c.value){case "toggle":case "ch2toggle":g=2;break;case "ch3toggle":g=3;break;
case "ch4toggle":g=4}e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:g},{value:"toggle"})}e?a._doRequestMarked(e,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};D.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "switchState":d=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.buildStateScript(a,
b,{address:1},{value:"switchTState"});break;case "ch2State":d=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:2},{value:"switchState"});break;case "ch3State":d=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:3},{value:"switchState"});break;case "ch4State":d=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:4},{value:"switchState"});break;case "meterVoltage":case "meterEnergyCounter":case "meterFrequency":case "meterPower":case "meterCurrent":d=
xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.buildStateScript(a,b,{address:5},c)}return d};D.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "meterVoltage":case "meterEnergyCounter":case "meterFrequency":case "meterPower":case "meterCurrent":return xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.handleStatusResponse(a,b);case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "switchState":return xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.handleStatusResponse(a,
{value:"switchTState"});case "ch2State":case "ch3State":case "ch4State":return xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.handleStatusResponse(a,{value:"switchState"});default:return"?"}};D.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "1":e=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.resolveState(a,b,c);break;case "2":case "3":case "4":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.resolveState(a,
b,c);e.key="2"==d?"ch2State":"3"==d?"ch3State":"ch4State";break;case "5":e=xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.resolveState(a,b,c)}return e};var E=function(){};E.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"dimOn"}},{type:"enum",name:"off",ref:{value:"dimOff"}},{type:"int",name:"dim up",ref:{value:"dimUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"dim down",ref:{value:"dimDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"dim to",
ref:{value:"dimTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"toggle to",ref:{value:"toggleTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"enum",name:"ch.3 on",ref:{value:"ch3dimOn"}},{type:"enum",name:"ch.3 off",ref:{value:"ch3dimOff"}},{type:"int",name:"ch.3 dim up",ref:{value:"ch3dimUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.3 dim down",ref:{value:"ch3dimDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.3 dim to",ref:{value:"ch3dimTo",ext:"%d",extMeta:"0-100",
unit:"%"}},{type:"int",name:"ch.3 toggle to",ref:{value:"ch3toggleTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"enum",name:"ch.4 on",ref:{value:"ch4dimOn"}},{type:"enum",name:"ch.4 off",ref:{value:"ch4dimOff"}},{type:"int",name:"ch.4 dim up",ref:{value:"ch4dimUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.4 dim down",ref:{value:"ch4dimDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.4 dim to",ref:{value:"ch4dimTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.4 toggle to",
ref:{value:"ch4toggleTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"enum",name:"ch.5 on",ref:{value:"ch5dimOn"}},{type:"enum",name:"ch.5 off",ref:{value:"ch5dimOff"}},{type:"int",name:"ch.5 dim up",ref:{value:"ch5dimUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.5 dim down",ref:{value:"ch5dimDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.5 dim to",ref:{value:"ch5dimTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.5 toggle to",ref:{value:"ch5toggleTo",ext:"%d",
extMeta:"0-100",unit:"%"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"int",name:"dimmer status",ref:{value:"dimmerTLevel",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.3 status",ref:{value:"ch3Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.4 status",ref:{value:"ch4Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.5 status",ref:{value:"ch5Level",extMeta:"0-100",unit:"%"}}]}};E.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;
return{ipevt:JSON.parse(JSON.stringify(a))}};E.prototype.executeCommand=function(a,b,c,d){if(c){var e=null,g=null;switch(c.value){case "dimOn":case "ch3dimOn":case "ch4dimOn":case "ch5dimOn":switch(c.value){case "dimOn":case "ch3dimOn":g=3;break;case "ch4dimOn":g=4;break;case "ch5dimOn":g=5}e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:g},{value:"dimOn"});break;case "dimOff":case "ch3dimOff":case "ch4dimOff":case "ch5dimOff":switch(c.value){case "dimOff":case "ch3dimOff":g=
3;break;case "ch4dimOff":g=4;break;case "ch5dimOff":g=5}e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:g},{value:"dimOff"});break;case "dimUp":case "ch3dimUp":case "ch4dimUp":case "ch5dimUp":switch(c.value){case "dimUp":case "ch3dimUp":g=3;break;case "ch4dimUp":g=4;break;case "ch5dimUp":g=5}e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:g},{value:"dimUp",ext:c.ext});break;case "dimDown":case "ch3dimDown":case "ch4dimDown":case "ch5dimDown":switch(c.value){case "dimDown":case "ch3dimDown":g=
3;break;case "ch4dimDown":g=4;break;case "ch5dimDown":g=5}e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:g},{value:"dimDown",ext:c.ext});break;case "dimTo":case "ch3dimTo":case "ch4dimTo":case "ch5dimTo":switch(c.value){case "dimTo":case "ch3dimTo":g=3;break;case "ch4dimTo":g=4;break;case "ch5dimTo":g=5}e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:g},{value:"dimTo",ext:c.ext});break;case "toggleTo":case "ch3toggleTo":case "ch4toggleTo":case "ch5toggleTo":switch(c.value){case "toggleTo":case "ch3toggleTo":g=
3;break;case "ch4toggleTo":g=4;break;case "ch5toggleTo":g=5}e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:g},{value:"toggleTo",ext:c.ext})}e?a._doRequestMarked(e,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};E.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},
c);break;case "dimmerTLevel":d=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.buildStateScript(a,b,{address:2},{value:"dimmerTLevel"});break;case "ch3Level":d=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:3},{value:"dimmerLevel"});break;case "ch4Level":d=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:4},{value:"dimmerLevel"});break;case "ch5Level":d=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:5},{value:"dimmerLevel"})}return d};
E.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "dimmerTLevel":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(a,{value:"dimmerTLevel"});case "ch3Level":case "ch4Level":case "ch5Level":return xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.handleStatusResponse(a,{value:"dimmerLevel"});default:return"?"}};E.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;
var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "2":e=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.resolveState(a,b,c);break;case "3":case "4":case "5":e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.resolveState(a,b,c),e.key="3"==d?"ch3Level":"4"==d?"ch4Level":"ch5Level"}return e};var A=function(){};A.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"stop",ref:{value:"stop"}},{type:"enum",name:"move up",ref:{value:"moveUp"}},
{type:"enum",name:"move down",ref:{value:"moveDown"}},{type:"int",name:"step up",ref:{value:"stepUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"step down",ref:{value:"stepDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"move to",ref:{value:"moveTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"enum",name:"ch.4 stop",ref:{value:"ch4stop"}},{type:"enum",name:"ch.4 move up",ref:{value:"ch4moveUp"}},{type:"enum",name:"ch.4 move down",ref:{value:"ch4moveDown"}},{type:"int",name:"ch.4 step up",
ref:{value:"ch4stepUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.4 step down",ref:{value:"ch4stepDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.4 move to",ref:{value:"ch4moveTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"enum",name:"ch.5 stop",ref:{value:"ch5stop"}},{type:"enum",name:"ch.5 move up",ref:{value:"ch5moveUp"}},{type:"enum",name:"ch.5 move down",ref:{value:"ch5moveDown"}},{type:"int",name:"ch.5 step up",ref:{value:"ch5stepUp",ext:"%d",extMeta:"1-100",unit:"%"}},
{type:"int",name:"ch.5 step down",ref:{value:"ch5stepDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.5 move to",ref:{value:"ch5moveTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"enum",name:"ch.6 stop",ref:{value:"ch6stop"}},{type:"enum",name:"ch.6 move up",ref:{value:"ch6moveUp"}},{type:"enum",name:"ch.6 move down",ref:{value:"ch6moveDown"}},{type:"int",name:"ch.6 step up",ref:{value:"ch6stepUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.6 step down",ref:{value:"ch6stepDown",
ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.6 move to",ref:{value:"ch6moveTo",ext:"%d",extMeta:"0-100",unit:"%"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"int",name:"blind status",ref:{value:"blindTLevel",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.4 status",ref:{value:"ch4Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.5 status",ref:{value:"ch5Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.6 status",
ref:{value:"ch6Level",extMeta:"0-100",unit:"%"}}]}};A.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;a=JSON.parse(JSON.stringify(a));a=a.concat([{type:"enum",name:"button 1 short press",ref:{value:"btn1pressShort",options:["true"]}},{type:"enum",name:"button 1 long press",ref:{value:"btn1pressLong",options:["true"]}},{type:"enum",name:"button 2 short press",ref:{value:"btn2pressShort",options:["true"]}},{type:"enum",name:"button 2 long press",ref:{value:"btn2pressLong",options:["true"]}}]);
return{ipevt:a}};A.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;e=4;var g=null;-1!=c.value.indexOf("ch5")?e=5:-1!=c.value.indexOf("ch6")&&(e=6);-1!=c.value.indexOf("stop")?g="stop":-1!=c.value.indexOf("moveUp")?g="moveUp":-1!=c.value.indexOf("moveDown")?g="moveDown":-1!=c.value.indexOf("stepUp")?g="stepUp":-1!=c.value.indexOf("stepDown")?g="stepDown":-1!=c.value.indexOf("moveTo")&&(g="moveTo");g?(e=xnm.aio.hm.HmIPChannel.SHUTTER_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:e},{value:g,
ext:c.ext}))?a._doRequestMarked(e,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command")):d&&d(Error("unknown command"))}else d&&d(Error("command is null"))};A.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "blindTLevel":d=xnm.aio.hm.HmIPChannel.SHUTTER_TRANSMITTER.buildStateScript(a,b,{address:3},{value:"blindTLevel"});
break;case "ch4Level":d=xnm.aio.hm.HmIPChannel.SHUTTER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:4},{value:"blindLevel"});break;case "ch5Level":d=xnm.aio.hm.HmIPChannel.SHUTTER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:5},{value:"blindLevel"});break;case "ch6Level":d=xnm.aio.hm.HmIPChannel.SHUTTER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:6},{value:"blindLevel"})}return d};A.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,
b);case "blindTLevel":return xnm.aio.hm.HmIPChannel.SHUTTER_TRANSMITTER.handleStatusResponse(a,{value:"blindTLevel"});case "ch4Level":case "ch5Level":case "ch6Level":return xnm.aio.hm.HmIPChannel.SHUTTER_VIRTUAL_RECEIVER.handleStatusResponse(a,{value:"blindLevel"});default:return"?"}};A.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "1":case "2":if(e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,
b,c))"pressShort"==e.key?e.key="btn"+d+"pressShort":"pressLong"==e.key&&(e.key="btn"+d+"pressLong");break;case "3":e=xnm.aio.hm.HmIPChannel.SHUTTER_TRANSMITTER.resolveState(a,b,c);break;case "4":case "5":case "6":if(e=xnm.aio.hm.HmIPChannel.SHUTTER_VIRTUAL_RECEIVER.resolveState(a,b,c))e.key="4"==d?"ch4Level":"5"==d?"ch5Level":"ch6Level"}return e};var B=function(){};B.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"stop",ref:{value:"stop"}},{type:"enum",name:"move up",ref:{value:"moveUp"}},
{type:"enum",name:"move down",ref:{value:"moveDown"}},{type:"int",name:"step up",ref:{value:"stepUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"step down",ref:{value:"stepDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"move to",ref:{value:"moveTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"enum",name:"lamella up",ref:{value:"lamellaUp"}},{type:"enum",name:"lamella down",ref:{value:"lamellaDown"}},{type:"int",name:"lamella step up",ref:{value:"lamellaStepUp",ext:"%d",extMeta:"1-10",
unit:"%"}},{type:"int",name:"lamella step down",ref:{value:"lamellaStepDown",ext:"%d",extMeta:"1-10",unit:"%"}},{type:"int",name:"lamella to",ref:{value:"lamellaTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"enum",name:"ch.4 stop",ref:{value:"ch4stop"}},{type:"enum",name:"ch.4 move up",ref:{value:"ch4moveUp"}},{type:"enum",name:"ch.4 move down",ref:{value:"ch4moveDown"}},{type:"int",name:"ch.4 step up",ref:{value:"ch4stepUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.4 step down",ref:{value:"ch4stepDown",
ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.4 move to",ref:{value:"ch4moveTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"enum",name:"ch.4 lamella up",ref:{value:"ch4lamellaUp"}},{type:"enum",name:"ch.4 lamella down",ref:{value:"ch4lamellaDown"}},{type:"int",name:"ch.4 lamella step up",ref:{value:"ch4lamellaStepUp",ext:"%d",extMeta:"1-10",unit:"%"}},{type:"int",name:"ch.4 lamella step down",ref:{value:"ch4lamellaStepDown",ext:"%d",extMeta:"1-10",unit:"%"}},{type:"int",name:"ch.4 lamella to",
ref:{value:"ch4lamellaTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"enum",name:"ch.5 stop",ref:{value:"ch5stop"}},{type:"enum",name:"ch.5 move up",ref:{value:"ch5moveUp"}},{type:"enum",name:"ch.5 move down",ref:{value:"ch5moveDown"}},{type:"int",name:"ch.5 step up",ref:{value:"ch5stepUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.5 step down",ref:{value:"ch5stepDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.5 move to",ref:{value:"ch5moveTo",ext:"%d",extMeta:"0-100",
unit:"%"}},{type:"enum",name:"ch.5 lamella up",ref:{value:"ch5lamellaUp"}},{type:"enum",name:"ch.5 lamella down",ref:{value:"ch5lamellaDown"}},{type:"int",name:"ch.5 lamella step up",ref:{value:"ch5lamellaStepUp",ext:"%d",extMeta:"1-10",unit:"%"}},{type:"int",name:"ch.5 lamella step down",ref:{value:"ch5lamellaStepDown",ext:"%d",extMeta:"1-10",unit:"%"}},{type:"int",name:"ch.5 lamella to",ref:{value:"ch5lamellaTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"enum",name:"ch.6 stop",ref:{value:"ch6stop"}},
{type:"enum",name:"ch.6 move up",ref:{value:"ch6moveUp"}},{type:"enum",name:"ch.6 move down",ref:{value:"ch6moveDown"}},{type:"int",name:"ch.6 step up",ref:{value:"ch6stepUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.6 step down",ref:{value:"ch6stepDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"ch.6 move to",ref:{value:"ch6moveTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"enum",name:"ch.6 lamella up",ref:{value:"ch6lamellaUp"}},{type:"enum",name:"ch.6 lamella down",ref:{value:"ch6lamellaDown"}},
{type:"int",name:"ch.6 lamella step up",ref:{value:"ch6lamellaStepUp",ext:"%d",extMeta:"1-10",unit:"%"}},{type:"int",name:"ch.6 lamella step down",ref:{value:"ch6lamellaStepDown",ext:"%d",extMeta:"1-10",unit:"%"}},{type:"int",name:"ch.6 lamella to",ref:{value:"ch6lamellaTo",ext:"%d",extMeta:"0-100",unit:"%"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"int",name:"blind status",ref:{value:"blindTPos",extMeta:"0-100",unit:"%"}},{type:"int",
name:"lamella status",ref:{value:"lamellaTPos",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.4 blind status",ref:{value:"ch4blindPos",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.4 lamella status",ref:{value:"ch4lamellaPos",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.5 blind status",ref:{value:"ch5blindPos",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.5 lamella status",ref:{value:"ch5lamellaPos",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.6 blind status",ref:{value:"ch6blindPos",extMeta:"0-100",
unit:"%"}},{type:"int",name:"ch.6 lamella status",ref:{value:"ch6lamellaPos",extMeta:"0-100",unit:"%"}}]}};B.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;a=JSON.parse(JSON.stringify(a));a=a.concat([{type:"enum",name:"button 1 short press",ref:{value:"btn1pressShort",options:["true"]}},{type:"enum",name:"button 1 long press",ref:{value:"btn1pressLong",options:["true"]}},{type:"enum",name:"button 2 short press",ref:{value:"btn2pressShort",options:["true"]}},{type:"enum",
name:"button 2 long press",ref:{value:"btn2pressLong",options:["true"]}}]);return{ipevt:a}};B.prototype.executeCommand=function(a,b,c,d){if(c){var e=4,g=null;-1!=c.value.indexOf("ch5")?e=5:-1!=c.value.indexOf("ch6")&&(e=6);-1!=c.value.indexOf("stop")?g="stop":-1!=c.value.indexOf("moveUp")?g="moveUp":-1!=c.value.indexOf("moveDown")?g="moveDown":-1!=c.value.indexOf("stepUp")?g="stepUp":-1!=c.value.indexOf("stepDown")?g="stepDown":-1!=c.value.indexOf("moveTo")?g="moveTo":-1!=c.value.indexOf("lamellaUp")?
g="lamellaUp":-1!=c.value.indexOf("lamellaDown")?g="lamellaDown":-1!=c.value.indexOf("lamellaStepUp")?g="lamellaStepUp":-1!=c.value.indexOf("lamellaStepDown")?g="lamellaStepDown":-1!=c.value.indexOf("lamellaTo")&&(g="lamellaTo");g?(b=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:e,stateAddress:3},{value:g,ext:c.ext}))?a._doRequestMarked(b,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command")):d&&d(Error("unknown command"))}else d&&
d(Error("command is null"))};B.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "blindTPos":d=xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.buildStateScript(a,b,{address:3},{value:"blindTPos"});break;case "lamellaTPos":d=xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.buildStateScript(a,b,{address:3},{value:"lamellaTPos"});break;case "ch4blindPos":d=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildStateScript(a,
b,{address:4},{value:"blindPos"});break;case "ch4lamellaPos":d=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:4},{value:"lamellaPos"});break;case "ch5blindPos":d=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:5},{value:"blindPos"});break;case "ch5lamellaPos":d=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:5},{value:"lamellaPos"});break;case "ch6blindPos":d=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildStateScript(a,
b,{address:6},{value:"blindPos"});break;case "ch6lamellaPos":d=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:6},{value:"lamellaPos"})}return d};B.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "blindTPos":return xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.handleStatusResponse(a,{value:"blindTPos"});case "lamellaTPos":return xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.handleStatusResponse(a,
{value:"lamellaTPos"});case "ch4blindPos":case "ch5blindPos":case "ch6blindPos":return xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.handleStatusResponse(a,{value:"blindPos"});case "ch4lamellaPos":case "ch5lamellaPos":case "ch6lamellaPos":return xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.handleStatusResponse(a,{value:"lamellaPos"});default:return"?"}};B.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);
var e=null;switch(d){case "1":case "2":if(e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c))"pressShort"==e.key?e.key="btn"+d+"pressShort":"pressLong"==e.key&&(e.key="btn"+d+"pressLong");break;case "3":e=xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.resolveState(a,b,c);break;case "4":case "5":case "6":if(e=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.resolveState(a,b,c))"LEVEL"==b.datapoint?e.key="4"==d?"ch4blindPos":"5"==d?"ch5blindPos":"ch6blindPos":"LEVEL_2"==b.datapoint&&(e.key="4"==d?
"ch4lamellaPos":"5"==d?"ch5lamellaPos":"ch6lamellaPos")}return e};var H=function(){};H.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}}]}};H.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",
...
ref:{value:"btn6pressLong",options:["true"]}}]}};H.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c)}return d};H.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);default:return"?"}};H.prototype.resolveState=function(a,b,c){if(!b||
!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":case "2":case "3":case "4":case "5":case "6":e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c),"pressShort"==e.key?e.key="btn"+d+"pressShort":"pressLong"==e.key&&(e.key="btn"+d+"pressLong")}return e};var I=function(){};I.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",
...
ref:{value:"passageL2RCOF",options:["false","true"]}},{type:"int",name:"passage count from right to left",ref:{value:"passageR2LC",extMeta:"0-127"}},{type:"enum",name:"passage count overflow from right to left",ref:{value:"passageR2LCOF",options:["false","true"]}}]}};I.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",
name:"passages detected",ref:{value:"passageCurrentDirection",options:["right_to_left","left_to_right"]}},{type:"enum",name:"previous passage",ref:{value:"passageLastDirection",options:["right_to_left","left_to_right"]}},{type:"int",name:"passage count from left to right",ref:{value:"passageL2RC",extMeta:"0-127"}},{type:"enum",name:"passage count overflow from left to right",ref:{value:"passageL2RCOF",options:["false","true"]}},{type:"int",name:"passage count from right to left",ref:{value:"passageR2LC",
extMeta:"0-127"}},{type:"enum",name:"passage count overflow from right to left",ref:{value:"passageR2LCOF",options:["false","true"]}}]}};I.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "passageCurrentDirection":d=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.buildStateScript(a,b,{address:2},{value:"passageCurrentDirection"});
...
b,{address:2},{value:"passageC"});break;case "passageR2LCOF":d=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.buildStateScript(a,b,{address:2},{value:"passageCOF"});break;case "passageL2RCurrent":d=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.buildStateScript(a,b,{address:3},{value:"passageCurrent"});break;case "passageL2RLast":d=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.buildStateScript(a,b,{address:3},{value:"passageLast"});break;case "passageL2RC":d=
xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.buildStateScript(a,b,{address:3},{value:"passageC"});break;case "passageL2RCOF":d=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.buildStateScript(a,b,{address:3},{value:"passageCOF"})}return d};I.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "passageCurrentDirection":case "passageLastDirection":return xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.handleStatusResponse(a,
b);case "passageR2LCurrent":case "passageL2RCurrent":return xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.handleStatusResponse(a,{value:"passageCurrent"});case "passageR2LLast":case "passageL2RLast":return xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.handleStatusResponse(a,{value:"passageLast"});case "passageR2LC":case "passageL2RC":return xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.handleStatusResponse(a,{value:"passageC"});case "passageL2RCOF":case "passageR2LCOF":return xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.handleStatusResponse(a,
{value:"passageCOF"});default:return"?"}};I.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "2":case "3":e=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.resolveState(a,b,c),"passageCurrentDirection"==e.key?e.key="passageCurrentDirection":"passageLastDirection"==e.key?e.key="passageLastDirection":
"passageC"==e.key?e.key="2"==d?"passageR2LC":"passageL2RC":"passageCOF"==e.key&&(e.key="2"==d?"passageR2LCOF":"passageL2RCOF")}return e};var J=function(){};J.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"waterAlarmState",options:["on","off"]}},{type:"enum",name:"moisture detected",
ref:{value:"waterMoistureDetected",options:["true","false"]}},{type:"enum",name:"water detected",ref:{value:"waterWaterDetected",options:["true","false"]}}]}};J.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"waterAlarmState",options:["on","off"]}},{type:"enum",name:"moisture detected",
ref:{value:"waterMoistureDetected",options:["true","false"]}},{type:"enum",name:"water detected",ref:{value:"waterWaterDetected",options:["true","false"]}}]}};J.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "waterAlarmState":d=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.buildStateScript(a,b,{address:1},{value:"waterAlarmState"});break;
case "waterMoistureDetected":d=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.buildStateScript(a,b,{address:1},{value:"waterMoistureDetected"});break;case "waterWaterDetected":d=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.buildStateScript(a,b,{address:1},{value:"waterWaterDetected"})}return d};J.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "waterAlarmState":case "waterMoistureDetected":case "waterWaterDetected":return xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.handleStatusResponse(a,
b);default:return"?"}};J.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.resolveState(a,b,c)}return e};var K=function(){};K.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false",
...
options:["false","true"]}}]}};K.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false","true"]}},{type:"int",name:"error code",ref:{value:"errorBatElCode",ext:"%d",extMeta:"0-255"}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0-25.2"}},{type:"enum",name:"sensor error",ref:{value:"errorBatElSensor",
options:["false","true"]}},{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"motion",ref:{value:"acceMotion",options:["false","true"]}}]}};K.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorBatElDutyCycle":case "errorBatElCode":case "errorBatElBat":case "errorBatElVoltage":case "errorBatElSensor":case "errorBatElComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,b,{address:0},
c);break;case "acceMotion":d=xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.buildStateScript(a,b,{address:1},c)}return d};K.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorBatElDutyCycle":case "errorBatElCode":case "errorBatElBat":case "errorBatElVoltage":case "errorBatElSensor":case "errorBatElComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,b);case "acceMotion":return xnm.aio.hm.HmIPChannel.ACCELERATION_TRANSCEIVER.handleStatusResponse(a,
b);default:return"?"}};K.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.ACCELERATION_TRANSCEIVER.resolveState(a,b,c)}return e};var F=function(){};F.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"float",name:"on for",ref:{value:"onFor",
ext:"%f",unit:"s"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]}};F.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;a=JSON.parse(JSON.stringify(a));a.push({type:"enum",name:"button short press",ref:{value:"btnPressShort",options:["true"]}});
a.push({type:"enum",name:"button long press",ref:{value:"btnPressLong",options:["true"]}});return{ipevt:a}};F.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;switch(c.value){case "on":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:3},{value:"onFor",ext:.5});break;case "onFor":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:3},c);break;default:d&&d(Error("unknown command"));return}e?a._doRequestMarked(e,!0,{execute:function(a,
b){d&&d(a)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};F.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":d=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,b,{address:0},c)}return d};F.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,
b);default:return"?"}};F.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c),"pressShort"==e.key?e.key="btnPressShort":"pressLong"==e.key&&(e.key="btnPressLong")}return e};var G=function(){};G.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",
...
"on"]}},{type:"int",name:"led 1 status",ref:{value:"led1Level",extMeta:"0-100",unit:"%"}},{type:"enum",name:"led 1 color",ref:{value:"led1Color",options:"off blue green torqoise red purple yellow white".split(" ")}},{type:"int",name:"led 2 status",ref:{value:"led2Level",extMeta:"0-100",unit:"%"}},{type:"enum",name:"led 2 color",ref:{value:"led2Color",options:"off blue green torqoise red purple yellow white".split(" ")}}]}};G.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",
ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"button 1 short press",ref:{value:"btn1pressShort",options:["true"]}},{type:"enum",name:"button 1 long press",ref:{value:"btn1pressLong",options:["true"]}},{type:"enum",name:"button 2 short press",ref:{value:"btn2pressShort",options:["true"]}},{type:"enum",name:"button 2 long press",ref:{value:"btn2pressLong",options:["true"]}},{type:"enum",name:"switch status",ref:{value:"switchState",options:["off","on"]}},{type:"int",name:"led 1 status",
ref:{value:"led1Level",extMeta:"0-100",unit:"%"}},{type:"enum",name:"led 1 color",ref:{value:"led1Color",options:"off blue green torqoise red purple yellow white".split(" ")}},{type:"int",name:"led 2 status",ref:{value:"led2Level",extMeta:"0-100",unit:"%"}},{type:"enum",name:"led 2 color",ref:{value:"led2Color",options:"off blue green torqoise red purple yellow white".split(" ")}}]}};G.prototype.executeCommand=function(a,b,c,d){if(c){var e=null,g=e=null;switch(c.value){case "on":case "off":case "toggle":e=
xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:4},c);break;case "led1On":case "led1Off":case "led1DimUp":case "led1DimDown":case "led1DimTo":case "led1ToggleTo":case "led1Color":case "led2On":case "led2Off":case "led2DimUp":case "led2DimDown":case "led2DimTo":case "led2ToggleTo":case "led2Color":g="led1"==c.value.substr(0,4)?{address:12}:{address:8};"On"==c.value.substr(4)?e={value:"dimOn"}:"Off"==c.value.substr(4)?e={value:"dimOff"}:"DimUp"==c.value.substr(4)?e={value:"dimUp",
ext:c.ext}:"DimDown"==c.value.substr(4)?e={value:"dimDown",ext:c.ext}:"DimTo"==c.value.substr(4)?e={value:"dimTo",ext:c.ext}:"ToggleTo"==c.value.substr(4)?e={value:"toggleTo",ext:c.ext}:"Color"==c.value.substr(4)&&(e={value:"color",ext:c.ext});e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(a,b,g,e);break;default:d&&d(Error("unknown command"));return}e?a._doRequestMarked(e,!0,{execute:function(a,b){d&&d(a)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};
G.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null,e;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "switchState":d=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.buildStateScript(a,b,{address:3},{value:"switchTState"});break;case "led1Level":case "led1Color":case "led2Level":case "led2Color":d="led1"==c.value.substr(0,4)?{address:11}:{address:7},"Level"==c.value.substr(4)?e={value:"dimmerTLevel"}:"Color"==c.value.substr(4)&&
(e={value:"dimmerTColor"}),d=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.buildStateScript(a,b,d,e)}return d};G.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "switchState":return xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.handleStatusResponse(a,{value:"switchTState"});case "led1Level":case "led2Level":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(a,{value:"dimmerTLevel"});
case "led1Color":case "led2Color":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(a,{value:"dimmerTColor"});default:return"?"}};G.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":case "2":e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c);"pressShort"==e.key?e.key="btn"+d+
"pressShort":"pressLong"==e.key&&(e.key="btn"+d+"pressLong");break;case "3":e=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.resolveState(a,b,c);break;case "7":case "11":e=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.resolveState(a,b,c),"7"==d?"dimmerTLevel"==e.key?e.key="led2Level":"dimmerTColor"==e.key&&(e.key="led2Color"):"11"==d&&("dimmerTLevel"==e.key?e.key="led1Level":"dimmerTColor"==e.key&&(e.key="led1Color"))}return e};var C=function(){};C.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",
...
d(Error("command is null"))};C.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "doorState":d=xnm.aio.hm.HmIPChannel.DOOR_RECEIVER.buildStateScript(a,b,{address:1},c);break;case "lightState":d=xnm.aio.hm.HmIPChannel.SIMPLE_SWITCH_RECEIVER.buildStateScript(a,b,{address:2},{value:"state"})}return d};C.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;
switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "doorState":return xnm.aio.hm.HmIPChannel.DOOR_RECEIVER.handleStatusResponse(a,b);case "lightState":return xnm.aio.hm.HmIPChannel.SIMPLE_SWITCH_RECEIVER.handleStatusResponse(a,{value:"state"});default:return"?"}};C.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,
b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.DOOR_RECEIVER.resolveState(a,b,c);break;case "2":if(e=xnm.aio.hm.HmIPChannel.SIMPLE_SWITCH_RECEIVER.resolveState(a,b,c))e.key="lightState"}return e};var M=function(){var a=function(){};a.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",
...
ref:{value:"briMinIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"}}]}};a.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0-25.2"}},{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"float",
...
var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.POWER_MAINS_TRANSMITTER.resolveState(a,b,c)}return e};return a}(),L=function(){var a=function(){};a.prototype.getCommandStatusMap=function(){return{command:[{type:"multi",name:"play sound",ref:{value:"acousticPlay",ext:"%multi",extMeta:[{type:"int",name:"set sound",ref:{value:"acousticSound",ext:"%d",extMeta:"0-255"}},
...
b,c)}return e};return a}(),O=function(){var a=function(){};a.prototype.getCommandStatusMap=function(){return{command:[{type:"multi",name:"set line",ref:{value:"setLine",ext:"%multi",extMeta:[{type:"enum",name:"line",ref:{value:"line",ext:"%e",extMeta:["1","2","3","4","5"]}},{type:"string",name:"text",ref:{value:"text",ext:"%s"}},{type:"enum",name:"text alignment",ref:{value:"textAlign",ext:"%e",extMeta:["center","left","right"]}},{type:"enum",name:"text color",ref:{value:"textColor",ext:"%e",extMeta:["black",
...
options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]}};a.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;a=JSON.parse(JSON.stringify(a));a=a.concat([{type:"enum",name:"button 1 short press",ref:{value:"btn1pressShort",options:["true"]}},{type:"enum",name:"button 1 long press",ref:{value:"btn1pressLong",options:["true"]}},
{type:"enum",name:"button 2 short press",ref:{value:"btn2pressShort",options:["true"]}},{type:"enum",name:"button 2 long press",ref:{value:"btn2pressLong",options:["true"]}}]);return{ipevt:a}};a.prototype.executeCommand=function(a,b,c,d){c?(b=xnm.aio.hm.HmIPChannel.ACOUSTIC_DISPLAY_RECEIVER.buildCommandScript(a,b,{address:3},c))?a._doRequestMarked(b,!0,{execute:function(a,b){d&&d(a)}}):d&&d(Error("invalid command")):d&&d(Error("command is null"))};a.prototype.buildStateScript=function(a,b,c){if(!c)return null;
var d=null;switch(c.value){case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":d=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,b,{address:0},c)}return d};a.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,b);default:return"?"}};a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;
var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(a,b,c);break;case "1":case "2":if(e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c))"pressShort"==e.key?e.key="btn"+d+"pressShort":"pressLong"==e.key&&(e.key="btn"+d+"pressLong")}return e};return a}(),P=function(){var a=function(){};a.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",
ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatVoltage",ext:"%f",extMeta:"0.0-25.2"}}]}};a.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatVoltage",
...
options:["true"]}}]}};a.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":case "errorBatVoltage":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c)}return d};a.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":case "errorBatVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);default:return"?"}};a.prototype.resolveState=
function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c);break;case "2":e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c);"pressShort"==e.key?e.key="roCWFast":"pressLong"==e.key&&(e.key="roCWSlow");break;case "3":e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,
b,c),"pressShort"==e.key?e.key="roACWFast":"pressLong"==e.key&&(e.key="roACWSlow")}return e};return a}();return{"HmIP-BSM":new r,"HmIP-BDT":new u,"HMIP-WRC2":new v,"HmIP-ASIR":new x,"HmIP-ASIR-2":new x,"HmIP-ASIR-O":new x,"HmIP-ASIR-B1":new x,"HmIP-SWSD":new y,"HmIP-SRH":new q,"HmIP-FSM":new D,"HmIP-PDT":new E,"HmIP-BROLL":new A,"HmIP-FROLL":new A,"HmIP-BBL":new B,"HmIP-FBL":new B,"HmIP-WRC6":new H,"HmIP-SPDR":new I,"HmIP-SWD":new J,"HmIP-SAM":new K,"HmIP-WGC":new F,"HmIP-BSL":new G,"HmIP-MOD-TM":new C,
"HmIP-SLO":new M,"HmIP-PMFS":new N,"HmIP-MP3P":new L,"HmIP-MOD-HO":new C,"HmIP-WRCD":new O,"HmIP-WRCR":new P,resolveJSON:function(l){if(!l||!l.type)return null;if("HmIP-PDT"==l.type)return b.parseJSON(l);if("HMIP-BSM"==l.type.toUpperCase().substr(0,8))return d.parseJSON(l,!0);if(this[l.type])return this[l.type];var n=null;switch(l.type){case "HmIP-WHS2":n=c.parseJSON(l,1,2);break;case "HmIP-DBB":case "HmIP-BRC2":n=a.parseJSON(l);break;case "HmIP-RCV-50":n=a.parseJSON(l)}if("HMIP-PS"==l.type.toUpperCase().substr(0,
7))n="HMIP-PSM"==l.type.toUpperCase().substr(0,8)?d.parseJSON(l):c.parseJSON(l);else if("HmIPW-DRS"==l.type.substr(0,9))n=c.parseJSON(l,1,parseInt(l.type.substr(9)));else if("HmIPW-DRD"==l.type.substr(0,9))n=b.parseJSON(l);else if("HmIPW-DRBL"==l.type.substr(0,10))n=e.parseJSON(l,1,parseInt(l.type.substr(10)));else if("HmIPW-DRI"==l.type.substr(0,9))n=f.parseJSON(l);else if("HmIPW-FIO"==l.type.substr(0,9)){var q=parseInt(l.type.substr(9));if(l.channels)for(var w in l.channels)if("MULTI_MODE_INPUT_TRANSMITTER"==
w.substr(0,28)){n=f.parseJSON(l);break}else if("SWITCH_TRANSMITTER"==w.substr(0,18)){n=c.parseJSON(l,q+1,q);break}}else if("HmIPW-STH"==l.type.substr(0,9)||"HmIPW-STHD"==l.type.substr(0,10)||"HmIPW-WTH"==l.type.substr(0,9))n=h.parseJSON(l);else if("HmIPW-SMI55"==l.type)n=k.parseJSON(l);else if("HmIPW-SPI"==l.type)n=m.parseJSON(l);else if("HmIP-WTH-B"==l.type)n=h.parseJSON(l);else if("HmIP-FCI"==l.type.substr(0,8))n=f.parseJSON(l);else if("HmIP-MOD-RC"==l.type.substr(0,11))n=f.parseJSON(l);else if("HmIP-MOD-OC"==
l.type.substr(0,11)){q=parseInt(l.type.substr(11));w=0;var r=l.address.indexOf(":");-1!=r&&(w=parseInt(l.address.substr(r+1)));0<w&&w<=q?n=a.parseJSON(l):0!=w&&(n=c.parseJSON(l,q+1,q))}else if("HmIP-FDT"==l.type.substr(0,8))n=b.parseJSON(l);else if("HmIP-FALMOT"==l.type.substr(0,11))n=p.parseJSON(l);else if("HmIP-PCBS"==l.type.substr(0,9))q=parseInt(l.type.substr(9)),isNaN(q)||(w=0,r=l.address.indexOf(":"),-1!=r&&(w=parseInt(l.address.substr(r+1))),0<w&&w<=q?n=a.parseJSON(l):0!=w&&(n=c.parseJSON(l,
q+1,q)));else if("HmIP-DRSI"==l.type.substr(0,9))q=parseInt(l.type.substr(9)),w=0,r=l.address.indexOf(":"),-1!=r&&(w=parseInt(l.address.substr(r+1))),0<w&&w<=q?n=f.parseJSON(l):0!=w&&(n=c.parseJSON(l,q+1,q));else if("HmIP-DRDI"==l.type.substr(0,9))q=parseInt(l.type.substr(9)),w=0,r=l.address.indexOf(":"),-1!=r&&(w=parseInt(l.address.substr(r+1))),0<w&&w<=q?n=f.parseJSON(l):0!=w&&(n=b.parseJSON(l,q+1,q));else if("HmIP-DRBLI"==l.type.substr(0,10))q=parseInt(l.type.substr(10)),w=0,r=l.address.indexOf(":"),
-1!=r&&(w=parseInt(l.address.substr(r+1))),0<w&&w<=2*q?n=f.parseJSON(l):0!=w&&(n=e.parseJSON(l,2*q+1,q));else if("HmIP-SCI"==l.type.substr(0,8))n=g.parseJSON(l);else if("HmIP-MIO16-PCB"==l.type)w=0,r=l.address.indexOf(":"),-1!=r&&(w=parseInt(l.address.substr(r+1))),n=0<w&&13>w?t.parseJSON(l):13<=w&&17>w?f.parseJSON(l):c.parseJSON(l,17,8);else if(this[l.type])return this[l.type];return n},parseDevice:function(a){return a.channels&&a.hsstype&&a["interface"]?0==a.hsstype.indexOf("HmIPW")?this._parseHMIPWDevice(a):
this._parseHmIPRFDevice(a):null},_parseHMIPWDevice:function(a){var b=function(a){var b=[];var c={sys:"hm"};c.id=a.name;c.type=a.hsstype;c.address=a.address;c.interface=a.interface;c.channels={};var d=0,e=JSON.parse(JSON.stringify(c)),g=null,f=a.channels,h=!1,m;for(m in f)if(f.hasOwnProperty(m)){var k=a.channels[m];if(k.hsstype)if("ALARM_COND_SWITCH_TRANSMITTER"==k.hsstype)b.push(e);else if("MULTI_MODE_INPUT_TRANSMITTER"==k.hsstype&&(0!=d&&(b.push(e),e=JSON.parse(JSON.stringify(c)),h=!1,g&&(e.channels.MAINTENANCE=
g)),d++),k.address){var l=k.address.indexOf(":");if(-1!==l){"MULTI_MODE_INPUT_TRANSMITTER"!=k.hsstype||h||(e.id=k.name?k.name:e.id,h=!0);l=k.address.substring(l+1);"MULTI_MODE_INPUT_TRANSMITTER"==k.hsstype&&(e.address+=":"+l);var n={id:k.name,address:l,room:k.room,group:k.func};0==l?(g=n,e.channels.MAINTENANCE=g):e.channels[k.hsstype+":"+l]=n}}}return b},c=function(a){var b={sys:"hm"};b.id=a.name;b.type=a.hsstype;b.address=a.address;b.interface=a.interface;b.channels={};var c=0,d=!1,e=[];var g=[];
var f=JSON.parse(JSON.stringify(b)),h=null,m=a.channels,k;for(k in m)if(m.hasOwnProperty(k)){var l=a.channels[k];if(l.hsstype&&l.address){var n=l.address.indexOf(":");if(-1!==n){n=l.address.substring(n+1);var p={id:l.name,address:n,room:l.room,group:l.func};if("MAINTENANCE"==l.hsstype)h=p,f.channels.MAINTENANCE=h;else if("MULTI_MODE_INPUT_TRANSMITTER"==l.hsstype)f.channels[l.hsstype+":"+n]=p,f.id=l.name?l.name:f.id,f.address+=":"+n,e.push(f),f=JSON.parse(JSON.stringify(b)),h&&(f.channels.MAINTENANCE=
h);else if("SWITCH_TRANSMITTER"==l.hsstype)0!=c&&(g.push(f),f=JSON.parse(JSON.stringify(b)),d=!1,h&&(f.channels.MAINTENANCE=h)),c++,f.channels[l.hsstype+":"+n]=p,f.address+=":"+n;else if("SWITCH_VIRTUAL_RECEIVER"==l.hsstype&&!d)f.channels[l.hsstype+":"+n]=p,f.id=l.name?l.name:f.id,d=!0;else if("SWITCH_WEEK_PROFILE"==l.hsstype){for(var q=0;q<g.length;q++)g[q].channels[l.hsstype+":"+n]=p;g.push(f)}}}}return g.concat(e)},d=a.hsstype;if("HmIPW-DRS"==d.substr(0,9))return this._resolveHmIPMultiSwitch(a);
if("HmIPW-DRD"==d.substr(0,9))return this._resolveHmIPMultiDimmer(a);if("HmIPW-DRBL"==d.substr(0,10))return this._resolveHmIPMultiBlind(a);if("HmIPW-DRI"==d.substr(0,9))return b(a);if("HmIPW-FIO"==d.substr(0,9))return c(a);if("HmIPW-SMI55"==d)return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1==["0","1","2","3"].indexOf(a)?0:-1!=["1","2"].indexOf(a)?2:1});if("HmIPW-SPI"==d)return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1==["0","1"].indexOf(a)?0:1});var e={};return this._resolveHmIPDeviceFromScript(a,
function(a,b){if(!xnm.aio.hm.HMIP_CHANNEL[b])return 0;e[b]||(e[b]=a);return e[b]!=a?0:1})},_parseHmIPRFDevice:function(a){if("HMIP-PS"==a.hsstype.toUpperCase().substr(0,7))return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1!=["3","4","5"].indexOf(a)?2:1});if("HMIP-BSM"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1!=["1","2","4","5","6"].indexOf(a)?2:1});if("HMIP-FSM"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,
b){return-1=="012345".split("").indexOf(a)?0:-1!=["2","3","4"].indexOf(a)?2:1});if("HMIP-BDT"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1==["0","3","4","5","6"].indexOf(a)?0:-1!=["4","5","6"].indexOf(a)?2:1});if("HMIP-PDT"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1=="023456".split("").indexOf(a)?0:-1!=["3","4","5"].indexOf(a)?2:1});if("HMIP-FDT"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,
function(a,b){return-1=="012345".split("").indexOf(a)?0:-1!=["2","3","4"].indexOf(a)?2:1});if("HMIP-BROLL"==a.hsstype.toUpperCase()||"HMIP-FROLL"==a.hsstype.toUpperCase()||"HMIP-FBL"==a.hsstype.toUpperCase()||"HMIP-BBL"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1!=["1","2"].indexOf(a)?2:-1==["0","3","4","5","6"].indexOf(a)?0:-1!=["4","5","6"].indexOf(a)?2:1});if(-1!=a.hsstype.toUpperCase().indexOf("HMIP-WRC"))return"HMIP-WRCD"==a.hsstype.toUpperCase()?
this._resolveHmIPDeviceFromScript(a,function(a,b){return 0==a?1:1==a||2==a?2:3==a?1:0}):"HMIP-WRCR"==a.hsstype.toUpperCase()?this._resolveHmIPDeviceFromScript(a,function(a,b){return 0==a||1==a||2==a||3==a?1:0}):this._resolveHmIPDeviceFromScript(a,function(a,b){return 0==a?1:"KEY_TRANSCEIVER"==b?2:0});if(0==a.hsstype.toUpperCase().indexOf("HMIP-FAL"))return this._resolveHmIPDeviceFromScript(a,function(a,b){return"CLIMATECONTROL_FLOOR_PUMP_TRANSCEIVER"==b||"CLIMATECONTROL_FLOOR_TRANSCEIVER"==b?3:0});
if("HMIP-SPDR"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1==["0","2","3"].indexOf(a)?0:-1!=["2","3"].indexOf(a)?2:1});if("HMIP-SMI55"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1==["0","1","2","3"].indexOf(a)?0:-1!=["1","2"].indexOf(a)?3:1});if("HMIP-MIOB"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1!=["3","7","9","10","11"].indexOf(a)?3:0});if("HMIP-SWD"==a.hsstype.toUpperCase()||
"HMIP-SAM"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return 1});if("HMIP-WGC"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1=="012345".split("").indexOf(a)?0:-1!=["3","4","5"].indexOf(a)?2:1});if("HMIP-BSL"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1!="5 6 9 10 13 14".split(" ").indexOf(a)?0:-1!="1 2 7 8 11 12".split(" ").indexOf(a)?2:1});if("HMIP-MOD-TM"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,
function(a,b){return 1});if("HMIP-SLO"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1!=["2","3"].indexOf(a)?0:1});if("HMIP-PMFS"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return 1});if("HMIP-MP3P"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1!=["0","1","5","9"].indexOf(a)?1:-1!="234678".split("").indexOf(a)?2:0});if("HMIP-MOD-HO"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,
function(a,b){return 1});if("HMIP-SCI"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return 0==a||"SHUTTER_CONTACT_TRANSCEIVER"==b||"SHUTTER_CONTACT"==b?1:0});if("HmIP-MOD-OC"==a.hsstype.substr(0,11)){var b=parseInt(a.hsstype.substr(11)),c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"KEY_TRANSCEIVER"==b?3:0}),d=[];for(i=1;i<=b;i++)d.push(i);a=this._resolveHmIPMultiSwitch(a,d);return c?a?c.concat(a):c:a}if(-1!=a.hsstype.indexOf("HmIP-FCI"))return this._resolveHmIPDeviceFromScript(a,
function(a,b){return 0==a?1:"MULTI_MODE_INPUT_TRANSMITTER"==b?3:0});if("HmIP-PCBS"==a.hsstype.substr(0,9)&&(b=parseInt(a.hsstype.substr(9)),!isNaN(b))){c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"KEY_TRANSCEIVER"==b?3:0});d=[];for(i=1;i<=b;i++)d.push(i);a=this._resolveHmIPMultiSwitch(a,d);return c?a?c.concat(a):c:a}if("HmIP-DRSI"==a.hsstype.substr(0,9)){b=parseInt(a.hsstype.substr(9));c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"MULTI_MODE_INPUT_TRANSMITTER"==
b?3:0});d=[];for(i=1;i<=b;i++)d.push(i);a=this._resolveHmIPMultiSwitch(a,d);return c?a?c.concat(a):c:a}if("HmIP-DRDI"==a.hsstype.substr(0,9)){b=parseInt(a.hsstype.substr(9));c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"MULTI_MODE_INPUT_TRANSMITTER"==b?3:0});d=[];for(i=1;i<=b;i++)d.push(i);a=this._resolveHmIPMultiDimmer(a,d);return c?a?c.concat(a):c:a}if("HmIP-DRBLI"==a.hsstype.substr(0,10)){b=parseInt(a.hsstype.substr(10));c=this._resolveHmIPDeviceFromScript(a,function(a,
b){return"MAINTENANCE"==b?1:"MULTI_MODE_INPUT_TRANSMITTER"==b?3:0});d=[];for(i=1;i<=2*b;i++)d.push(i);a=this._resolveHmIPMultiBlind(a,d);return c?a?c.concat(a):c:a}if("HmIP-MIO16-PCB"==a.hsstype){c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"ANALOG_INPUT_TRANSMITTER"==b||"MULTI_MODE_INPUT_TRANSMITTER"==b?3:0});d=[];for(i=1;16>=i;i++)d.push(i);a=this._resolveHmIPMultiSwitch(a,d);return c?a?c.concat(a):c:a}c=this._getChannelCount(a.channels,"SWITCH_TRANSMITTER");b=this._getChannelCount(a.channels,
"SWITCH_VIRTUAL_RECEIVER");if(1<this._getChannelCount(a.channels,"KEY_TRANSCEIVER"))return this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"KEY_TRANSCEIVER"==b?3:0});if(1<c&&1<b)return this._resolveHmIPMultiSwitch(a);var e={};return this._resolveHmIPDeviceFromScript(a,function(a,b){if(!xnm.aio.hm.HMIP_CHANNEL[b])return 0;e[b]||(e[b]=a);return e[b]!=a?0:1})},_getChannelCount:function(a,b){var c=0,d;for(d in a)a.hasOwnProperty(d)&&a[d].hsstype==b&&c++;return c},_parseDeviceBasic:function(a){var b=
{sys:"hm"};b.id=a.name;b.type=a.hsstype;b.address=a.address;b.interface=a.interface;b.channels={};return b},_resolveHmIPMultiSwitch:function(a,b){var c=[];var d={sys:"hm"};d.id=a.name;d.type=a.hsstype;d.address=a.address;d.interface=a.interface;d.channels={};var e=0,g=JSON.parse(JSON.stringify(d)),f=null,h=a.channels,m=!1,k;for(k in h)if(h.hasOwnProperty(k)){var p=a.channels[k];if(p.hsstype&&("SWITCH_TRANSMITTER"==p.hsstype&&(0!=e&&(c.push(g),g=JSON.parse(JSON.stringify(d)),m=!1,f&&(g.channels.MAINTENANCE=
f)),e++),p.address)){var l=p.address.indexOf(":");if(-1!==l&&("SWITCH_VIRTUAL_RECEIVER"!=p.hsstype||m||(g.id=p.name?p.name:g.id,m=!0),l=p.address.substring(l+1),!b||-1==b.indexOf(parseInt(l)))){"SWITCH_TRANSMITTER"==p.hsstype&&(g.address+=":"+l);var n={id:p.name,address:l,room:p.room,group:p.func};0==l?(f=n,g.channels.MAINTENANCE=f):g.channels[p.hsstype+":"+l]=n;if("SWITCH_WEEK_PROFILE"==p.hsstype){for(var q=0;q<c.length;q++)c[q].channels[p.hsstype+":"+l]=n;c.push(g)}}}}return c},_resolveHmIPMultiDimmer:function(a,
b){var c=[];var d={sys:"hm"};d.id=a.name;d.type=a.hsstype;d.address=a.address;d.interface=a.interface;d.channels={};var e=0,g=JSON.parse(JSON.stringify(d)),f=null,h=a.channels,m=!1,k;for(k in h)if(h.hasOwnProperty(k)){var p=a.channels[k];if(p.hsstype&&("DIMMER_TRANSMITTER"==p.hsstype&&(0!=e&&(c.push(g),g=JSON.parse(JSON.stringify(d)),m=!1,f&&(g.channels.MAINTENANCE=f)),e++),p.address)){var l=p.address.indexOf(":");if(-1!==l&&("DIMMER_VIRTUAL_RECEIVER"!=p.hsstype||m||(g.id=p.name?p.name:g.id,m=!0),
l=p.address.substring(l+1),!b||-1==b.indexOf(parseInt(l)))){"DIMMER_TRANSMITTER"==p.hsstype&&(g.address+=":"+l);var n={id:p.name,address:l,room:p.room,group:p.func};0==l?(f=n,g.channels.MAINTENANCE=f):g.channels[p.hsstype+":"+l]=n;if("DIMMER_WEEK_PROFILE"==p.hsstype){for(var q=0;q<c.length;q++)c[q].channels[p.hsstype+":"+l]=n;c.push(g)}}}}return c},_resolveHmIPMultiBlind:function(a,b){var c=[];var d={sys:"hm"};d.id=a.name;d.type=a.hsstype;d.address=a.address;d.interface=a.interface;d.channels={};
var e=0,g=JSON.parse(JSON.stringify(d)),f=null,h=a.channels,m=!1,k;for(k in h)if(h.hasOwnProperty(k)){var p=a.channels[k];if(p.hsstype&&("BLIND_TRANSMITTER"==p.hsstype&&(0!=e&&(c.push(g),g=JSON.parse(JSON.stringify(d)),m=!1,f&&(g.channels.MAINTENANCE=f)),e++),p.address)){var l=p.address.indexOf(":");if(-1!==l&&("BLIND_VIRTUAL_RECEIVER"!=p.hsstype||m||(g.id=p.name?p.name:g.id,m=!0),l=p.address.substring(l+1),!b||-1==b.indexOf(parseInt(l)))){"BLIND_TRANSMITTER"==p.hsstype&&(g.address+=":"+l);var n=
{id:p.name,address:l,room:p.room,group:p.func};0==l?(f=n,g.channels.MAINTENANCE=f):g.channels[p.hsstype+":"+l]=n;if("BLIND_WEEK_PROFILE"==p.hsstype){for(var q=0;q<c.length;q++)c[q].channels[p.hsstype+":"+l]=n;c.push(g)}}}}return c},_resolveHmIPDeviceFromScript:function(a,b){var c=[],d={sys:"hm"};d.id=a.name;d.type=a.hsstype;d.address=a.address;d["interface"]=a["interface"];d.channels={};var e=a.channels,g=!1,f;for(f in e)if(channel=a.channels[f],channel.address&&(e=channel.address.indexOf(":"),-1!==
e)){e=channel.address.substring(e+1);var h=channel.hsstype;if(channel.hsstype){var m=1;b&&(m=b(e,h));0!=m&&(3==m?(m=JSON.parse(JSON.stringify(d)),m.address=m.address+":"+e,m.id=m.id+"("+m.address+")",m.channels[h]={id:channel.name,address:e,room:channel.room,group:channel.func},c.push(m)):(g=!0,2==m&&(h=h+":"+e),d.channels[h]={id:channel.name,address:e,room:channel.room,group:channel.func}))}}g&&c.push(d);return c}}}();
...
a=this.handleStatusResponse(c+"",{value:d});return{key:d,value:a}}},"VIR-LG-RGB-DIM-CH":{buildCommandScript:function(a,b,c,d){if(!b.channels||!d.value)return null;var e=null;switch(d.value){case "rgbChOn":a="LEVEL";d="if(o!=null){o.State(1.0);}\n";break;case "rgbChOff":a="LEVEL";d="if(o!=null){o.State(0.0);}\n";break;case "rgbChUp":d=null==d.ext||"undefined"==typeof d.ext?.1:"number"==typeof d.ext?(parseInt(d.ext)/100).toFixed(2):d.ext.match(/^[-+]?[0-9]+$/)?(parseInt(d.ext)/100).toFixed(2):.1;a._statebuffer&&
(e=this.getBufferedState(a._statebuffer,b,c,{value:"rgbChLevel"}));d=null==e||"undefined"==typeof e?"if(o!=null){var v=o.Value()+"+d+";if(v>1){v=1.0;}o.State(v);}\n":"if(o!=null){var v="+e/100+"+"+d+";if(v>1){v=1.0;}o.State(v);}\n";a="LEVEL";break;case "rgbChDown":d=null==d.ext||"undefined"==typeof d.ext?.1:"number"==typeof d.ext?(parseInt(d.ext)/100).toFixed(2):d.ext.match(/^[-+]?[0-9]+$/)?(parseInt(d.ext)/100).toFixed(2):.1;a._statebuffer&&(e=this.getBufferedState(a._statebuffer,b,c,{value:"rgbChLevel"}));
d=null==e||"undefined"==typeof e?"if(o!=null){var v=o.Value()-"+d+";if(v<0){v=0.0;}o.State(v);}\n":"if(o!=null){var v="+e/100+"-"+d+";if(v<0){v=0.0;}o.State(v);}\n";a="LEVEL";break;case "rgbChLvlTo":if(null==d.ext||"undefined"==typeof d.ext)return null;if("number"==typeof d.ext)d=parseInt(d.ext);else if(d.ext.match(/^[-+]?[0-9]+$/))d=d.ext;else return null;a="LEVEL";d/=100;d=0>d?0:d;d="if(o!=null){o.State("+(1<d?1:d)+");}\n";break;case "rgbChRgbTo":if(null==d.ext||"undefined"==typeof d.ext)return null;
d=d.ext;if(6>d.length)return null;a="RGBW";e=parseInt(d.substr(0,2),16);var g=parseInt(d.substr(2,2),16);d=parseInt(d.substr(4,2),16);d='if(o!=null){o.State("rgb('+e+","+g+","+d+')");}\n';break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(b,c,a,d)},buildStateScript:function(a,b,c,d){if(!b.channels||!d.value)return null;switch(d.value){case "rgbChLevel":a="LEVEL";break;case "rgbChRgb":a="RGB";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(b,c,a)},handleStatusResponse:function(a,
b){if("?"==a)return a;switch(b.value){case "rgbChLevel":return parseFloat(a);case "rgbChRgb":return a;default:return"?"}},resolveState:function(a,b,c){switch(b.datapoint){case "LEVEL":var d="rgbChLevel";break;case "RGB":d="rgbChRgb"}if(!d)return null;a=this.handleStatusResponse(c+"",{value:d});return{key:d,value:a}}},"VIR-LG-WHITE-DIM-CH":{buildCommandScript:function(a,b,c,d){if(!b.channels||!d.value)return null;var e=null;switch(d.value){case "dimChOn":a="LEVEL";d="if(o!=null){o.State(1.0);}\n";
break;case "dimChOff":a="LEVEL";d="if(o!=null){o.State(0.0);}\n";break;case "dimChUp":d=null==d.ext||"undefined"==typeof d.ext?.1:"number"==typeof d.ext?(parseInt(d.ext)/100).toFixed(2):d.ext.match(/^[-+]?[0-9]+$/)?(parseInt(d.ext)/100).toFixed(2):.1;a._statebuffer&&(e=this.getBufferedState(a._statebuffer,b,c,{value:"rgbwChLevel"}));d=null==e||"undefined"==typeof e?"if(o!=null){var v=o.Value()+"+d+";if(v>1){v=1.0;}o.State(v);}\n":"if(o!=null){var v="+e/100+"+"+d+";if(v>1){v=1.0;}o.State(v);}\n";a=
"LEVEL";break;case "dimChDown":d=null==d.ext||"undefined"==typeof d.ext?.1:"number"==typeof d.ext?(parseInt(d.ext)/100).toFixed(2):d.ext.match(/^[-+]?[0-9]+$/)?(parseInt(d.ext)/100).toFixed(2):.1;a._statebuffer&&(e=this.getBufferedState(a._statebuffer,b,c,{value:"rgbwChLevel"}));d=null==e||"undefined"==typeof e?"if(o!=null){var v=o.Value()-"+d+";if(v<0){v=0.0;}o.State(v);}\n":"if(o!=null){var v="+e/100+"-"+d+";if(v<0){v=0.0;}o.State(v);}\n";a="LEVEL";break;case "dimChLvlTo":if(null==d.ext||"undefined"==
typeof d.ext)return null;if("number"==typeof d.ext)d=parseInt(d.ext);else if(d.ext.match(/^[-+]?[0-9]+$/))d=d.ext;else return null;a="LEVEL";d/=100;d=0>d?0:d;d="if(o!=null){o.State("+(1<d?1:d)+");}\n";break;case "dimChCtTo":if(null==d.ext||"undefined"==typeof d.ext)return null;if("number"==typeof d.ext)d=parseInt(d.ext);else if(d.ext.match(/^[-+]?[0-9]+$/))d=d.ext;else return null;a="WHITE";d="if(o!=null){o.State("+d+");}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(b,
c,a,d)},buildStateScript:function(a,b,c,d){if(!b.channels||!d.value)return null;switch(d.value){case "dimChLevel":a="LEVEL";break;case "dimChCt":a="WHITE";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(b,c,a)},handleStatusResponse:function(a,b){if("?"==a)return a;switch(b.value){case "dimChLevel":return parseFloat(a);case "dimChCt":return parseInt(a);default:return"?"}},resolveState:function(a,b,c){switch(b.datapoint){case "LEVEL":var d="dimChLevel";break;case "WHITE":d="dimChCt"}if(!d)return null;
a=this.handleStatusResponse(c+"",{value:d});return{key:d,value:a}}}}}(),c=function(){};c.prototype.executeCommand=function(b,c,d,e){if(d){var f=null;switch(d.value){case "onoffChOn":f=a["VIR-LG-ONOFF-CH"].buildCommandScript(b,c,{address:1},{value:"onoffChOn"});break;case "onoffChOff":f=a["VIR-LG-ONOFF-CH"].buildCommandScript(b,c,{address:1},{value:"onoffChOff"});break;case "onoffChToggle":f=a["VIR-LG-ONOFF-CH"].buildCommandScript(b,c,{address:1},{value:"onoffChToggle"})}f?b._doRequestMarked(f,!0,
{execute:function(a,c){"onoffChOn"!=d.value||a?setTimeout(function(){e&&e(a)},200):setTimeout(function(){b._doRequestMarked(f,!0,{execute:function(a,b){e&&e(a)}})},3E3)}}):e&&e(Error("invalid command"))}else e&&e(Error("command is null"))};c.prototype.buildStateScript=function(b,c,d){if(!d)return null;var e=null;switch(d.value){case "onoffChState":e=a["VIR-LG-ONOFF-CH"].buildStateScript(b,c,{address:1},d)}return e};c.prototype.handleStatusResponse=function(b,c){if("?"==b)return b;switch(c.value){case "onoffChState":return a["VIR-LG-ONOFF-CH"].handleStatusResponse(b,
c);default:return"?"}};c.prototype.resolveState=function(b,c,d){if(!c||!c.channel)return null;var e=c.channel.indexOf(":");if(-1==e)return null;var f=null;switch(c.channel.substr(e+1)){case "1":f=a["VIR-LG-ONOFF-CH"].resolveState(b,c,d)}return f};var d=function(){};d.prototype.executeCommand=function(b,c,d,e){d?(c=a["VIR-LG-RGBW-DIM-CH"].buildCommandScript(b,c,{address:1},d))?b._doRequestMarked(c,!0,{execute:function(a,b){setTimeout(function(){e&&e(a)},200)}}):e&&e(Error("invalid command")):e&&e(Error("command is null"))};
...
function(b,c,d,e){d?(c=a["VIR-LG-DIM-CH"].buildCommandScript(b,c,{address:1},d))?b._doRequestMarked(c,!0,{execute:function(a,b){setTimeout(function(){e&&e(a)},200)}}):e&&e(Error("invalid command")):e&&e(Error("command is null"))};b.prototype.buildStateScript=function(b,c,d){return d?a["VIR-LG-DIM-CH"].buildStateScript(b,c,{address:1},d):null};b.prototype.handleStatusResponse=function(b,c){return"?"==b?b:a["VIR-LG-DIM-CH"].handleStatusResponse(b,c)};b.prototype.resolveState=function(b,c,d){if(!c||
!c.channel)return null;var e=c.channel.indexOf(":");if(-1==e)return null;var f=null;switch(c.channel.substr(e+1)){case "1":f=a["VIR-LG-DIM-CH"].resolveState(b,c,d)}return f};var e=function(){};e.prototype.executeCommand=function(b,c,d,e){d?(c=a["VIR-LG-RGB-DIM-CH"].buildCommandScript(b,c,{address:1},d))?b._doRequestMarked(c,!0,{execute:function(a,b){setTimeout(function(){e&&e(a)},200)}}):e&&e(Error("invalid command")):e&&e(Error("command is null"))};e.prototype.buildStateScript=function(b,c,d){return d?
a["VIR-LG-RGB-DIM-CH"].buildStateScript(b,c,{address:1},d):null};e.prototype.handleStatusResponse=function(b,c){return"?"==b?b:a["VIR-LG-RGB-DIM-CH"].handleStatusResponse(b,c)};e.prototype.resolveState=function(b,c,d){if(!c||!c.channel)return null;var e=c.channel.indexOf(":");if(-1==e)return null;var f=null;switch(c.channel.substr(e+1)){case "1":f=a["VIR-LG-RGB-DIM-CH"].resolveState(b,c,d)}return f};var f=function(){};f.prototype.executeCommand=function(b,c,d,e){d?(c=a["VIR-LG-WHITE-DIM-CH"].buildCommandScript(b,
c,{address:1},d))?b._doRequestMarked(c,!0,{execute:function(a,b){setTimeout(function(){e&&e(a)},200)}}):e&&e(Error("invalid command")):e&&e(Error("command is null"))};f.prototype.buildStateScript=function(b,c,d){return d?a["VIR-LG-WHITE-DIM-CH"].buildStateScript(b,c,{address:1},d):null};f.prototype.handleStatusResponse=function(b,c){return"?"==b?b:a["VIR-LG-WHITE-DIM-CH"].handleStatusResponse(b,c)};f.prototype.resolveState=function(b,c,d){if(!c||!c.channel)return null;var e=c.channel.indexOf(":");
if(-1==e)return null;var f=null;switch(c.channel.substr(e+1)){case "1":f=a["VIR-LG-WHITE-DIM-CH"].resolveState(b,c,d)}return f};return{"VIR-LG-ONOFF":c,"VIR-LG-RGBW-DIM":d,"VIR-LG-DIM":b,"VIR-LG-RGB-DIM":e,"VIR-LG-WHITE-DIM":f,parseDevice:function(a){var b={sys:"hm"};b.id=a.name;b.type=a.hsstype;b.address=a.address;b["interface"]=a["interface"];b.channels={};var c=a.channels,d;for(d in c)if(c.hasOwnProperty(d)){var e=a.channels[d];if(e.address){var f=e.address.indexOf(":");-1!==f&&(f=e.address.substring(f+
1),e.hsstype&&(b.channels[e.hsstype]={id:e.name,address:f,room:e.room,group:e.func}))}}return[b]}}}();
...
c.length;f++)if(c[f].index===a.gateway){var g=c[f];break}g?d(null,a):d(new b(e.NOT_FOUND,"gateway with index "+a.gateway+" not exists"))}else d(new b(e.INVALID,"gateway is invalid"));else d(new b(e.INVALID,"channels is invalid"));else d(new b(e.INVALID,"type is invalid"));else d(new b(e.INVALID,"interface is invalid"));else d(new b(e.INVALID,"address is invalid"));else d(new b(e.INVALID,"info is invalid"))},deleteDevice:function(a,c,d){d()},_getChannels:function(a){var c={},d=void 0==xnm.aio.hm.TYPE[a.type];
...
applyUIFilter:function(a,c){var d=this,b=function(a,b){if("*"==a)return!0;for(var c=!1,d=0;d<a.length;d++)if(a[d]==b){c=!0;break}return c},e=function(a,b){switch(a.type){case "SysVar":return g(a,b);case "Prog":return f(a,b);default:return v(a,b)}},f=function(a,c){var d=[],e=c.elems;switch(c.catagory){case "command":[{type:"enum",name:"execute",ref:{value:"progExec"}}].forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},g=function(a,c){var d=[],e=c.elems;if(a["class"]&&
(a=xnm.aio.hm.MAP.SysVar[a["class"]]))switch(c.catagory){case "command":a.command&&a.command.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))});break;case "status":a.status&&a.status.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},h=function(a,d,e,f,g){var h=[];if(a=a[d][e])switch(c.catagory){case "command":a.command&&f.access&&-1!=f.access.indexOf("w")&&a.command.forEach(function(a){b(g,a.type)&&(a=JSON.parse(JSON.stringify(a)),
h.push(a))});break;case "status":a.status&&f.access&&-1!=f.access.indexOf("r")&&a.status.forEach(function(a){b(g,a.type)&&(a=JSON.parse(JSON.stringify(a)),h.push(a))})}return h},k=function(a,c){var d=[],e=c.elems;switch(c.catagory){case "command":a.command&&a.command.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))});break;case "status":a.status&&a.status.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},m=function(a,b){if(a){var c=
xnm.aio.hm.HmIPDevice.resolveJSON(a);if(c&&c.getCommandStatusMap&&(c=c.getCommandStatusMap(a)))return k(c,b)}c=[];var d=a.channels;a=xnm.aio.hm.DM._getHmIPChannels(a);var e=b.elems,f;for(f in d)if(d.hasOwnProperty(f)){var g=a[f];if(g)for(var m in g)g.hasOwnProperty(m)&&xnm.aio.hm.HMIP_MAP[f]&&(b=h(xnm.aio.hm.HMIP_MAP,f,m,g[m],e),c=c.concat(b))}return c},p=function(a,c){var d=[],e=c.elems;a=xnm.aio.hm.HM_Sec_Sir_WM_MAP;switch(c.catagory){case "command":a.command.forEach(function(a){b(e,a.type)&&(a=
JSON.parse(JSON.stringify(a)),d.push(a))});break;case "status":a.status.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},t=function(a,c){var d=[],e=c.elems;a=xnm.aio.hm.HM_WDS30_OT2_SM_2_MAP;switch(c.catagory){case "status":a.status.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},r=function(a,c){var d=[],e=c.elems;a=xnm.aio.hm.HM_ES_TX_WM_MAP;switch(c.catagory){case "status":a.status.forEach(function(a){b(e,a.type)&&
(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},u=function(a,c){var d=[],e=c.elems;a=[{type:"int",name:"dim to",ref:{value:"dimRaw",ext:"%d",extMeta:"0-100",scale:"10"}}];switch(c.catagory){case "command":a.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},v=function(a,b){if("HmIP-HEATING"==a.type)return m(a,b);if(a["interface"]&&"CUxD"==a["interface"]){var c=[];a.cuxd||(a.cuxd=xnm.aio.hm.MHMCCU._resolveCUxDType(a));var e=a.channels,f=xnm.aio.hm.DM._getCUxDChannels(a),
g=b.elems,q;for(q in e)if(e.hasOwnProperty(q)){var v=f[q];if(v)for(var x in v)v.hasOwnProperty(x)&&("FHT_Multiventil"==a.cuxd&&"DIMMER"==q?q="FHT_Multiventil_Dimmer":"HMS_100_Contact"==a.cuxd&&"SENSOR"==q?q="HMS_100_Contact":"FHT_Contact"==a.cuxd&&"SENSOR"==q?q="FHT_Contact":"Security_Sensor"==a.cuxd&&"SENSOR"==q?q="Security_Sensor":"HMS_100_W/WD"==a.cuxd&&"SENSOR"==q&&(q="Security_Sensor"),xnm.aio.hm.CUxDMAP[q]?(b=h(xnm.aio.hm.CUxDMAP,q,x,v[x],g),c=c.concat(b)):xnm.aio.hm.MAP[q]&&(b=h(xnm.aio.hm.MAP,
q,x,v[x],g),c=c.concat(b)))}return c}if(a["interface"]&&"HmIP-RF"==a["interface"])return m(a,b);if(a["interface"]&&"BidCos-RF"==a["interface"]&&a.type&&xnm.aio.hm.BidCosDevice[a.type]&&(q=xnm.aio.hm.BidCosDevice[a.type])&&q.getCommandStatusMap&&(q=q.getCommandStatusMap(a))||a["interface"]&&"VirtualDevices"==a["interface"]&&-1==a.type.indexOf("HM-CC-VG")&&(q=d._getVirtualDevicesMap(a)))return k(q,b);if("DimmerKey"==a.type)return u(a,b);if("HM-Sec-Sir-WM"==a.type)return p(a,b);if("HM-WDS30-OT2-SM-2"==
a.type)return t(a,b);if("HM-ES-TX-WM"==a.type&&a.channels&&a.channels.POWERMETER_IEC1)return r(a,b);q=[];x=a.channels;a=xnm.aio.hm.DM._getChannels(a);f=b.elems;for(c in x)if(x.hasOwnProperty(c)&&(g=a[c]))for(e in g)g.hasOwnProperty(e)&&xnm.aio.hm.MAP[c]&&(b=h(xnm.aio.hm.MAP,c,e,g[e],f),q=q.concat(b));return q};if(!a.type)return null;var x=JSON.parse(JSON.stringify(a)),y=null;switch(c.catagory){case "command":y=e(a,c);x.command=y;break;case "status":y=e(a,c);x.status=y;break;default:return null}return y&&
...
d.KEYMATIC||d.WINMATIC||d.SENSOR_FOR_CARBON_DIOXIDE||d.WATERDETECTIONSENSOR||d.LUXMETER?!0:!1:a["interface"]&&"HMIP-RF"==a["interface"].toUpperCase()?d.SWITCH_VIRTUAL_RECEIVER||d.DIMMER_VIRTUAL_RECEIVER||d.SHUTTER_VIRTUAL_RECEIVER||d.BLIND_VIRTUAL_RECEIVER||d.ENERGIE_METER_TRANSMITTER||d.HEATING_CLIMATECONTROL_TRANSCEIVER||d.SHUTTER_CONTACT_TRANSCEIVER||d.ROTARY_HANDLE_TRANSCEIVER||d.CLIMATE_TRANSCEIVER||d.WEATHER_TRANSMIT||d.SHUTTER_CONTACT||d.MOTIONDETECTOR_TRANSCEIVER||d.SMOKE_DETECTOR||d.ANALOG_OUTPUT_TRANSCEIVER||
d.PRESENCEDETECTOR_TRANSCEIVER||d.BRIGHTNESS_TRANSMITTER?!0:!1:"BidCos-Wired"==a["interface"]?d.DIGITAL_OUTPUT||d.DIGITAL_ANALOG_OUTPUT||d.SWITCH||d.DIMMER||d.BLIND?!0:!1:!1},applySmartWidgetFilter:function(a,c,d){return a&&"Prog"!=a.type&&"Sysvar"!=a.type?"BidCos-RF"==a["interface"]||"BidCos-Wired"==a["interface"]?this._applySmartWidget_BidCos(a,c,d):a["interface"]&&"HMIP-RF"==a["interface"].toUpperCase()?this._applySmartWidget_HmIP(a,c,d):null:null},_applySmartWidget_BidCos:function(a,c,d,b,e){if(!a.channels)return null;
b={};for(var f in a.channels)if(a.channels.hasOwnProperty(f)){e=f;var g=e.indexOf(":");-1!=g&&(e=e.substr(0,g));b[e]=!0}if(b.DIGITAL_OUTPUT){var h={"%on%":{value:"digOutOn",name:"on"},"%off%":{value:"digOutOff",name:"off"},"%toggle%":{value:"digOutToggle",name:"toggle"}};var k={"%switchState%":{value:"digOutState",options:["off","on"],name:"state"}};var m=["switch"]}b.DIGITAL_ANALOG_OUTPUT&&(h={"%on%":{value:"daOutOn",name:"on"},"%off%":{value:"daOutOff",name:"off"},"%toggle%":{value:"daOutToggle",
name:"toggle"}},k={"%switchState%":{value:"daOutState",options:["off","on"],name:"state"}},m=["switch"]);b.SWITCH&&(h={"%on%":{value:"on",name:"on"},"%off%":{value:"off",name:"off"},"%toggle%":{value:"toggle",name:"toggle"}},k={"%switchState%":{value:"switchState",options:["off","on"],name:"switch status"}},m=["switch"]);if(b.DIMMER||b.VIRTUAL_DIMMER)h={"%on%":{value:"dimOn",name:"on"},"%off%":{value:"dimOff",name:"off"},"%dimOn%":{value:"dimOn",name:"on"},"%dimOff%":{value:"dimOff",name:"off"},"%dimUp%":{value:"dimUp",
name:"dim up"},"%dimDown%":{value:"dimDown",name:"dim down"},"%dimTo%":{value:"dimRaw",ext:"%d",extMeta:"0-100",name:"dim to"}},k={"%dimmerState%":{value:"dimmerLevel",ext:"%d",extMeta:"0-100",name:"dimmer status"}},m=["switch","dimmer"];b.BLIND&&(h||(h={}),h["%stop%"]||(h["%stop%"]={value:"blindStop",name:"stop"}),h["%moveUp%"]||(h["%moveUp%"]={value:"blindUp",name:"move up"}),h["%moveDown%"]||(h["%moveDown%"]={value:"blindDown",name:"move down"}),h["%stepUp%"]||(h["%stepUp%"]={value:"blindStepUp",
name:"step up"}),h["%stepDown%"]||(h["%stepDown%"]={value:"blindStepDown",name:"step down"}),h["%moveTo%"]||(h["%moveTo%"]={value:"blindRaw",ext:"%d",extMeta:"0-100",name:"move to"}),k={"%shutterState%":{value:"blindLevel",ext:"%d",extMeta:"0-100",name:"blind status"}},m=["shutter"]);b.JALOUSIE&&(h||(h={}),h["%stop%"]||(h["%stop%"]={value:"jalStop",name:"stop"}),h["%moveUp%"]||(h["%moveUp%"]={value:"jalUp",name:"move up"}),h["%moveDown%"]||(h["%moveDown%"]={value:"jalDown",name:"move down"}),h["%stepUp%"]||
(h["%stepUp%"]={value:"jalStepUp",name:"step up"}),h["%stepDown%"]||(h["%stepDown%"]={value:"jalStepDown",name:"step down"}),h["%moveTo%"]||(h["%moveTo%"]={value:"jalRaw",ext:"%d",extMeta:"0-100",name:"move to"}),h["%lamellaUp%"]||(h["%lamellaUp%"]={value:"jalLmlUp",name:"lamella up"}),h["%lamellaDown%"]||(h["%lamellaDown%"]={value:"jalLmlDown",name:"lamella down"}),h["%lamellaStepUp%"]||(h["%lamellaStepUp%"]={value:"jalLmlStepUp",name:"lamella step up",ext:10}),h["%lamellaStepDown%"]||(h["%lamellaStepDown%"]=
{value:"jalLmlStepDown",name:"lamella step down",ext:10}),h["%lamellaTo%"]||(h["%lamellaTo%"]={value:"jalLmlRaw",ext:"%d",extMeta:"0-100",name:"lamella to"}),k={"%blindState%":{value:"jalLevel",ext:"%d",extMeta:"0-100",name:"status"},"%lamellaState%":{value:"jalLmlLevel",ext:"%d",extMeta:"0-100",name:"lamella status"}},m=["shutter","blind"]);b.POWERMETER&&(k||(k={}),k["%meterVoltage%"]||(k["%meterVoltage%"]={value:"meterVoltage",extMeta:"0.0-6553.5",scale:"0.1",unit:"V",name:"voltage"}),k["%meterEnergyCounter%"]||
(k["%meterEnergyCounter%"]={value:"meterEnergyCounter",extMeta:"0.0-838860.7",scale:"0.1",unit:"Wh",name:"energy counter"}),k["%meterFrequency%"]||(k["%meterFrequency%"]={value:"meterFrequency",extMeta:"48.72-51.27",scale:"0.01",unit:"Hz",name:"frequency"}),k["%meterPower%"]||(k["%meterPower%"]={value:"meterPower",extMeta:"0.0-167772.15",scale:"0.1",unit:"W",name:"power"}),k["%meterCurrent%"]||(k["%meterCurrent%"]={value:"meterCurrent",extMeta:"0.0-65535.0",scale:"0.1",unit:"mA",name:"current"}),
m||(m=[]),-1==m.indexOf("powermeter")&&m.push("powermeter"));b.CLIMATECONTROL_REGULATOR&&(h||(h={}),h["%thermoTempUp%"]||(h["%thermoTempUp%"]={value:"themoRTempUp",name:"temperature up"}),h["%thermoTempDown%"]||(h["%thermoTempDown%"]={value:"themoRTempDown",name:"temperature down"}),h["%thermoTempTo%"]||(h["%thermoTempTo%"]={value:"themoRTempRaw",ext:"%f",extMeta:"6-30",scale:"0.5",name:"temperature to"}),h["%thermoOn%"]||(h["%thermoOn%"]={value:"themoTempOn",name:"on"}),h["%thermoOff%"]||(h["%thermoOff%"]=
{value:"themoRTempClose",name:"close"}),k={"%thermoCurrentTemp%":{value:"weatherTemp",name:"temperature"},"%thermoHum%":{value:"weatherHum",name:"humidity"},"%thermoSetTemp%":{value:"themoRSetTemp",extMeta:"6-30",scale:"0.5",name:"set temperature"}},m=["thermostat"]);b.THERMALCONTROL_TRANSMIT&&(h||(h={}),h["%thermoAuto%"]||(h["%thermoAuto%"]={value:"themoTAutoMode",name:"set auto mode"}),h["%thermoManu%"]||(h["%thermoManu%"]={value:"themoTManuMode",ext:"20.0",name:"set manual mode"}),h["%thermoBoost%"]||
(h["%thermoBoost%"]={value:"themoTBoostMode",name:"set boost mode"}),h["%thermoTempUp%"]||(h["%thermoTempUp%"]={value:"themoTTempUp",name:"temperature up"}),h["%thermoTempDown%"]||(h["%thermoTempDown%"]={value:"themoTTempDown",name:"temperature down"}),h["%thermoTempTo%"]||(h["%thermoTempTo%"]={value:"themoTTempRaw",ext:"%f",extMeta:"4.5-30.5",scale:"0.5",name:"temperature to"}),h["%thermoOff%"]||(h["%thermoOff%"]={value:"themoTTempOff",name:"off"}),k={"%thermoCurrentTemp%":{value:"themoTActualTemp",
name:"actual temperature"},"%thermoHum%":{value:"themoTActualHum",name:"actual humidity"},"%thermoMode%":{value:"themoTMode",options:["auto","manu","party","boost"],name:"mode"},"%thermoSetTemp%":{value:"themoTSetTemp",extMeta:"4.5-30.5",scale:"0.5",name:"set temperature"},"%thermoWindow%":{value:"themoTWin",options:["open","closed"],name:"window open"}},m=["thermostat"]);b.CLIMATECONTROL_RT_TRANSCEIVER&&(h||(h={}),h["%thermoAuto%"]||(h["%thermoAuto%"]={value:"themoAutoMode",name:"set auto mode"}),
h["%thermoManu%"]||(h["%thermoManu%"]={value:"themoManuMode",ext:"20.0",name:"set manual mode"}),h["%thermoBoost%"]||(h["%thermoBoost%"]={value:"themoBoostMode",name:"set boost mode"}),h["%thermoTempUp%"]||(h["%thermoTempUp%"]={value:"themoTempUp",name:"temperature up"}),h["%thermoTempDown%"]||(h["%thermoTempDown%"]={value:"themoTempDown",name:"temperature down"}),h["%thermoTempTo%"]||(h["%thermoTempTo%"]={value:"themoTempRaw",ext:"%f",extMeta:"4.5-30.5",scale:"0.5",name:"temperature to"}),h["%thermoOff%"]||
(h["%thermoOff%"]={value:"themoTempOff",name:"off"}),k={"%thermoCurrentTemp%":{value:"themoActualTemp",name:"actual temperature"},"%thermoHum%":{value:"themoActualHum",name:"actual humidit"},"%thermoMode%":{value:"themoMode",options:["auto","manu","party","boost"],name:"mode"},"%thermoSetTemp%":{value:"themoSetTemp",extMeta:"4.5-30.5",scale:"0.5",name:"set temperature"},"%thermoWindow%":{value:"themoWinState",options:["open","closed"],name:"window state"}},m=["thermostat"]);b.SHUTTER_CONTACT&&(k=
{"%contactState%":{value:"shutterState",options:["closed","open"],name:"contact state"}},m=["contact"]);b.ROTARY_HANDLE_SENSOR&&(k={"%windowState%":{value:"handleState",options:["closed","tilted","open"],name:"handle state"}},m=["window"]);b.WEATHER&&((a=a.type)&&"HM-WDS30"==a.substr(0,8)?(k={"%tempState%":{value:"weatherTemp",name:"temperature"}},m=["climate"]):a&&"HM-WDS100"==a.substr(0,9)?(k={"%tempState%":{value:"weatherTemp",name:"temperature"},"%humState%":{value:"weatherHum",name:"humidity"},
"%brightnessState%":{value:"weatherBright",name:"brightness"},"%sunshineState%":{value:"weatherSunD",name:"sunshine duration"},"%windDirection%":{value:"weatherWindD",name:"wind direction",options:"N NO O SO S SW W NW".split(" ")},"%windspeedState%":{value:"weatherWindS",name:"wind speed"},"%rainingState%":{value:"weatherRaining",name:"raining"},"%rainingCounterState%":{value:"weatherRainCounter",name:"rain counter"}},m=["weather_station"]):(k={"%tempState%":{value:"weatherTemp",name:"temperature"},
"%humState%":{value:"weatherHum",name:"humidity"}},m=["climate"]));b.MOTION_DETECTOR&&(k={"%motionState%":{value:"motionState",options:["on","off"],name:"state"},"%motionBrightness%":{value:"motionBright",name:"brightness"}},m=["motion"]);b.SMOKE_DETECTOR&&(k={"%smokeState%":{value:"smokeState",options:["on","off"],name:"state"}},m=["smoke"]);b.SMOKE_DETECTOR_TEAM&&(k={"%smokeState%":{value:"smokeGroup1State",options:["on","off"],name:"state"}},m=["smoke"]);b.SMOKE_DETECTOR_TEAM_V2&&(k={"%smokeState%":{value:"smokeGroupState",
options:["on","off"],name:"state"}},m=["smoke"]);b.RGBW_COLOR&&(h||(h={}),h["%rgb%"]||(h["%rgb%"]={value:"rgb",ext:"%s",name:"rgb color"}),h["%white%"]||(h["%white%"]={value:"white",name:"white"}),m||(m=[]),-1==m.indexOf("rgb")&&m.push("rgb"));b.WINMATIC&&(h||(h={}),h["%windowUp%"]||(h["%windowUp%"]={value:"windowUp"}),h["%windowDown%"]||(h["%windowDown%"]={value:"windowDown"}),h["%windowTo%"]||(h["%windowTo%"]={value:"windowTo",ext:"%d",extMeta:"0-100"}),h["%windowLock%"]||(h["%windowLock%"]={value:"winLock"}),
h["%windowStop%"]||(h["%windowStop%"]={value:"winStop"}),k={"%windowLevel%":{value:"winLevel"}},m=["winmatic"]);b.KEYMATIC&&(h||(h={}),h["%lock%"]||(h["%lock%"]={value:"keyLock"}),h["%unlock%"]||(h["%unlock%"]={value:"keyOpen"}),h["%open%"]||(h["%open%"]={value:"keyOpenDo"}),k={"%lockStatus%":{value:"keyState",options:["open","lock"]}},m=["keymatic"]);b.SENSOR_FOR_CARBON_DIOXIDE&&(k={"%co2State%":{value:"co2State",options:["normal","added","added_strong"]}},m=["sensor_co2"]);b.WATERDETECTIONSENSOR&&
(k={"%waterState%":{value:"waterState",options:["dry","wet","water"]}},m=["sensor_water"]);if(b.LUXMETER){k={"%state%":{value:"luxState",extMeta:"0.00-100000.00",scale:"0.01"}};var p={"%icon%":"sun"};m=["generic_state"]}return m&&0!=m.length?this._injectToSmartWidgetTemplate(c,m,d,h,k,p):null},_applySmartWidget_HmIP:function(a,c,d,b,e){if(!a.channels||"HmIP-WGC"==a.type)return null;var f,g,h;if("HmIP-BSL"==a.type)return f||(f={}),f["%on%"]||(f["%on%"]={value:"on",name:"on"}),f["%off%"]||(f["%off%"]=
{value:"off",name:"off"}),f["%toggle%"]||(f["%toggle%"]={value:"toggle",name:"toggle"}),g||(g={}),g["%switchState%"]||(g["%switchState%"]={value:"switchState",options:["off","on"],name:"switch status"}),this._injectToSmartWidgetTemplate(c,["switch"],d,f,g);b={};for(var k in a.channels)if(a.channels.hasOwnProperty(k)){e=k;var m=e.indexOf(":");-1!=m&&(e=e.substr(0,m));b[e]=!0}b.SWITCH_VIRTUAL_RECEIVER&&(f||(f={}),"HmIP-BSM"==a.type?(f["%on%"]||(f["%on%"]={value:"ch4on",name:"ch.4 on"}),f["%off%"]||
(f["%off%"]={value:"ch4off",name:"ch.4 off"}),f["%toggle%"]||(f["%toggle%"]={value:"ch4toggle",name:"ch.4 toggle"})):(f["%on%"]||(f["%on%"]={value:"on",name:"on"}),f["%off%"]||(f["%off%"]={value:"off",name:"off"}),f["%toggle%"]||(f["%toggle%"]={value:"toggle",name:"toggle"})),g||(g={}),g["%switchState%"]||(g["%switchState%"]={value:"switchState",options:["off","on"],name:"switch status"}),h||(h=[]),-1==h.indexOf("switch")&&h.push("switch"));b.DIMMER_VIRTUAL_RECEIVER&&(f||(f={}),f["%on%"]||(f["%on%"]=
{value:"dimTo",ext:100,name:"dim to"}),f["%off%"]||(f["%off%"]={value:"dimOff",name:"off"}),f["%dimOn%"]||(f["%dimOn%"]={value:"dimTo",ext:100,name:"dim to"}),f["%dimOff%"]||(f["%dimOff%"]={value:"dimOff",name:"off"}),f["%dimUp%"]||(f["%dimUp%"]={value:"dimUp",ext:5,name:"dim up"}),f["%dimDown%"]||(f["%dimDown%"]={value:"dimDown",ext:5,name:"dim down"}),f["%dimTo%"]||(f["%dimTo%"]={value:"dimTo",ext:"%d",extMeta:"0-100",name:"dim to"}),g={"%dimmerState%":{value:"dimmerTLevel",ext:"%d",extMeta:"0-100",
name:"dimmer status"}},h=["switch","dimmer"]);b.SHUTTER_VIRTUAL_RECEIVER&&(f||(f={}),f["%stop%"]||(f["%stop%"]={value:"stop",name:"stop"}),f["%moveUp%"]||(f["%moveUp%"]={value:"moveUp",name:"move up"}),f["%moveDown%"]||(f["%moveDown%"]={value:"moveDown",name:"move down"}),f["%stepUp%"]||(f["%stepUp%"]={value:"stepUp",ext:5,name:"step up"}),f["%stepDown%"]||(f["%stepDown%"]={value:"stepDown",ext:5,name:"step down"}),f["%moveTo%"]||(f["%moveTo%"]={value:"moveTo",ext:"%d",extMeta:"0-100",name:"move to"}),
g={"%shutterState%":{value:"blindTLevel",ext:"%d",extMeta:"0-100",name:"blind status"}},h=["shutter"]);b.BLIND_VIRTUAL_RECEIVER&&(f||(f={}),f["%stop%"]||(f["%stop%"]={value:"stop",name:"stop"}),f["%moveUp%"]||(f["%moveUp%"]={value:"moveUp",name:"move up"}),f["%moveDown%"]||(f["%moveDown%"]={value:"moveDown",name:"move down"}),f["%stepUp%"]||(f["%stepUp%"]={value:"stepUp",ext:5,name:"step up"}),f["%stepDown%"]||(f["%stepDown%"]={value:"stepDown",ext:5,name:"step down"}),f["%moveTo%"]||(f["%moveTo%"]=
{value:"moveTo",ext:"%d",extMeta:"0-100",name:"move to"}),f["%lamellaUp%"]||(f["%lamellaUp%"]={value:"lamellaUp",name:"lamella up"}),f["%lamellaDown%"]||(f["%lamellaDown%"]={value:"lamellaDown",name:"lamella down"}),f["%lamellaStepUp%"]||(f["%lamellaStepUp%"]={value:"lamellaStepUp",ext:5,name:"lamella step up"}),f["%lamellaStepDown%"]||(f["%lamellaStepDown%"]={value:"lamellaStepDown",ext:5,name:"lamella step down"}),f["%lamellaTo%"]||(f["%lamellaTo%"]={value:"lamellaTo",ext:"%d",extMeta:"0-100",name:"lamella to"}),
g={"%blindState%":{value:"blindTPos",ext:"%d",extMeta:"0-100",name:"blind status"},"%lamellaState%":{value:"lamellaTPos",ext:"%d",extMeta:"0-100",name:"lamella status"}},h=["shutter","blind"]);b.ENERGIE_METER_TRANSMITTER&&(g||(g={}),g["%meterVoltage%"]||(g["%meterVoltage%"]={value:"meterVoltage",extMeta:"0.0-409.5",scale:"0.1",unit:"V",name:"voltage"}),g["%meterEnergyCounter%"]||(g["%meterEnergyCounter%"]={value:"meterEnergyCounter",extMeta:"0.0-838859.1",scale:"0.1",unit:"Wh",name:"energy counter"}),
g["%meterFrequency%"]||(g["%meterFrequency%"]={value:"meterFrequency",extMeta:"29.52-70.47",scale:"0.01",unit:"Hz",name:"frequency"}),g["%meterPower%"]||(g["%meterPower%"]={value:"meterPower",extMeta:"0.0-163830.0",scale:"0.1",unit:"W",name:"power"}),g["%meterCurrent%"]||(g["%meterCurrent%"]={value:"meterCurrent",extMeta:"0.0-65535.0",scale:"0.1",unit:"mA",name:"current"}),h||(h=[]),-1==h.indexOf("powermeter")&&h.push("powermeter"));b.HEATING_CLIMATECONTROL_TRANSCEIVER&&(f||(f={}),f["%thermoAuto%"]||
(f["%thermoAuto%"]={value:"themoAutoMode",name:"set auto mode"}),f["%thermoManu%"]||(f["%thermoManu%"]={value:"themoManuMode",name:"set manu mode"}),f["%thermoBoost%"]||(f["%thermoBoost%"]={value:"themoBoostOn",name:"boost on"}),f["%thermoTempUp%"]||(f["%thermoTempUp%"]={value:"themoTempUp",name:"temperature up"}),f["%thermoTempDown%"]||(f["%thermoTempDown%"]={value:"themoTempDown",name:"temperature down"}),f["%thermoTempTo%"]||(f["%thermoTempTo%"]={value:"themoTemp",ext:"%f",extMeta:"4.5-30.5",scale:"0.5",
name:"set temperature"}),f["%thermoOn%"]||(f["%thermoOn%"]={value:"themoTempOn",name:"on"}),f["%thermoOff%"]||(f["%thermoOff%"]={value:"themoTempOff",name:"off"}),f["%thermoBoostOff%"]||(f["%thermoBoostOff%"]={value:"themoBoostOff",name:"boost off"}),f["%thermoProfile%"]||(f["%thermoProfile%"]={value:"themoProf",ext:"%d",extMeta:"1-6",scale:"1",name:"set profile"}),g={"%thermoCurrentTemp%":{value:"themoActualTemp",name:"actual temperature"},"%thermoHum%":{value:"themoHum",name:"humidity"},"%thermoMode%":{value:"themoMode",
options:["auto","manu"],name:"mode"},"%thermoSetTemp%":{value:"themoTemp",extMeta:"4.5-30.5",scale:"0.5",name:"set temperature"},"%thermoProfile%":{value:"themoProf",ext:"%d",extMeta:"1-6",scale:"1",name:"set profile"},"%thermoBoostMode%":{value:"themoBoostMode",options:["off","on"],name:"boost mode"},"%thermoWindow%":{value:"themoWinState",options:["open","closed"],name:"window state"}},h=["thermostat"]);b.SHUTTER_CONTACT&&(g={"%contactState%":{value:"shutterState",options:["closed","open"],name:"contact state"}},
h=["contact"]);b.SHUTTER_CONTACT_TRANSCEIVER&&(g={"%contactState%":{value:"shutterTState",options:["closed","open"],name:"contact state"}},h=["contact"]);b.ROTARY_HANDLE_TRANSCEIVER&&(g={"%windowState%":{value:"handleState",options:["closed","tilted","open"],name:"handle state"}},h=["window"]);b.CLIMATE_TRANSCEIVER&&(g={"%tempState%":{value:"climateActualTemp",extMeta:"-3276.8-3276.7",scale:"0.1",name:"actual temperature"},"%humState%":{value:"climateHum",name:"humidity"}},h=["climate"]);b.WEATHER_TRANSMIT&&
(g={"%tempState%":{value:"weatherActualTemp",name:"actual temperature"},"%humState%":{value:"weatherHum",name:"humidity"},"%brightnessState%":{value:"weatherIllu",name:"brightness"},"%sunshineState%":{value:"weatherSunD",name:"sunshine duration"},"%windspeedState%":{value:"weatherWindS",name:"wind speed"}},"HmIP-SWO-PL"==a.type?(g["%rainingState%"]={value:"weatherRain",name:"raining"},g["%rainingCounterState%"]={value:"weatherRainC",name:"rain counter"}):"HmIP-SWO-PR"==a.type&&(g["%rainingState%"]=
{value:"weatherRain",name:"raining"},g["%rainingCounterState%"]={value:"weatherRainC",name:"rain counter"},g["%windDirection%"]={value:"weatherWindD",name:"wind direction"}),h=["weather_station"]);b.MOTIONDETECTOR_TRANSCEIVER&&(f||(f={}),f["%motionActivate%"]||(f["%motionActivate%"]={value:"motionOn",name:"activate detection"}),f["%motionDeactivate%"]||(f["%motionDeactivate%"]={value:"motionOff",name:"deactivate detection"}),f["%motionToggle%"]||(f["%motionToggle%"]={value:"motionToggle",name:"toggle detection"}),
f["%motionReset%"]||(f["%motionReset%"]={value:"motionReset",name:"reset"}),g={"%motionState%":{value:"motionState",options:["on","off"],name:"state",conv_s:{on:"true",off:"false"}},"%motionBrightness%":{value:"motionIllu",name:"illumination"},"%motionActivate%":{value:"motionActivate",options:["off","on"],name:"detection activated"}},h=["motion"]);b.PRESENCEDETECTOR_TRANSCEIVER&&(f||(f={}),f["%motionActivate%"]||(f["%motionActivate%"]={value:"presenceOn",name:"activate detection"}),f["%motionDeactivate%"]||
(f["%motionDeactivate%"]={value:"presenceOff",name:"deactivate detection"}),f["%motionToggle%"]||(f["%motionToggle%"]={value:"presenceToggle",name:"toggle detection"}),f["%motionReset%"]||(f["%motionReset%"]={value:"presenceReset",name:"reset"}),g={"%motionState%":{value:"presenceState",options:["on","off"],name:"state",conv_s:{on:"true",off:"false"}},"%motionBrightness%":{value:"presenceIllu",name:"illumination"},"%motionActivate%":{value:"presenceActivate",options:["off","on"],name:"detection activated"}},
h=["motion"]);b.SMOKE_DETECTOR&&(g={"%smokeState%":{value:"smokeState",options:["on","off"],name:"alarm state"}},h=["smoke"]);b.ANALOG_OUTPUT_TRANSCEIVER&&(f||(f={}),f["%dimOn%"]||(f["%dimOn%"]={value:"analogOutputTo",ext:100,name:"output to"}),f["%dimOff%"]||(f["%dimOff%"]={value:"analogOutputOff",name:"off"}),f["%dimUp%"]||(f["%dimUp%"]={value:"analogOutputUp",ext:5,name:"up"}),f["%dimDown%"]||(f["%dimDown%"]={value:"analogOutputDown",ext:5,name:"down"}),f["%dimTo%"]||(f["%dimTo%"]={value:"analogOutputTo",
ext:"%d",extMeta:"0-100",name:"output to"}),g={"%dimmerState%":{value:"analogOutputLevel",ext:"%d",extMeta:"0-100",name:"output status"}},h=["dimmer"]);b.BRIGHTNESS_TRANSMITTER&&(g={"%brightnessState%":{value:"briIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"},"%brightnessAvg%":{value:"briAvgIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"},"%brightnessMax%":{value:"briMaxIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"},"%brightnessMin%":{value:"briMinIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"}},
h=["lux"]);return h&&0!=h.length?this._injectToSmartWidgetTemplate(c,h,d,f,g):null},_injectToSmartWidgetTemplate:function(a,c,d,b,e,f){var g=[];a||(b={});b||(b={});e||(e={});for(var h=0;h<a.length;h++){var k=a[h];if(k.meta&&-1!=c.indexOf(k.meta.type)&&k.elements){k=JSON.parse(JSON.stringify(k));var m=!1,p;for(p in k.elements){var t=k.elements[p];if(t&&Array.isArray(t))for(var r=0;r<t.length;r++){var u=t[r];if(u){if(u.action&&"command"==u.action.type&&u.action.ref&&u.action.ref.value){var v=u.action.ref.ext;
b[u.action.ref.value]?(u.action.ref=b[u.action.ref.value],v&&(u.action.ref.ext=v),u.action.device=d,m=!0):u.action=null}u.status&&u.status.ref&&u.status.ref.value&&(e[u.status.ref.value]?(u.status.ref=e[u.status.ref.value],u.status.device=d,m=!0):u.status=null);u.widget&&"%icon%"==u.widget.key_img&&f&&(u.widget.key_img=f["%icon%"])}}}m&&g.push(k)}}return g},toGeneralDevice:function(a,c){if(!a)return null;c={};for(e in a.channels){var d=e,b=d.indexOf(":");-1!=b&&(d=d.substr(0,b));c[d]=!0}var e=null;
c.SWITCH&&(e={type:"switch",commands:{on:{},off:{},toggle:{}},states:{state:{values:["on","off"]}},details:{commands:{on:{value:"on"},off:{value:"off"},toggle:{value:"toggle"}},states:{state:{value:"switchState"}}}});c.DIMMER&&(e={type:"dimmer",commands:{on:{},off:{},brightness:{value:{type:"INT",min:0,max:100,step:1}}},states:{brightness:{min:0,max:100,unit:"%"}},details:{commands:{on:{value:"dimTo",ext:100},off:{value:"dimOff"},brightness:{value:"dimTo",ext:"%d"}},states:{brightness:{value:"dimmerTLevel"}}}});
c.BLIND&&(e={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}}},states:{position:{min:0,max:100}},details:{commands:{up:{value:"blindUp"},down:{value:"blindDown"},stop:{value:"stop"},position:{value:"moveTo",ext:"%d"}},states:{position:{value:"blindLevel"}}}});c.JALOUSIE&&(e={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}},rotation:{value:{type:"INT",min:0,max:100,step:1}}},states:{position:{min:0,max:100},
...
"off"]}},details:{commands:{on:{value:"on"},off:{value:"off"},toggle:{value:"toggle"}},states:{state:{value:"switchState"}}}});c.DIMMER_VIRTUAL_RECEIVER&&(e={type:"dimmer",commands:{on:{},off:{},brightness:{value:{type:"INT",min:0,max:100,step:1}}},states:{brightness:{min:0,max:100,unit:"%"}},details:{commands:{on:{value:"dimOn"},off:{value:"dimOff"},brightness:{value:"dimRaw",ext:"%d"}},states:{brightness:{value:"dimmerLevel"}}}});c.SHUTTER_VIRTUAL_RECEIVER&&(e={type:"blind",commands:{up:{},down:{},
stop:{},position:{value:{type:"INT",min:0,max:100,step:1}}},states:{position:{min:0,max:100}},details:{commands:{up:{value:"moveUp"},down:{value:"moveDown"},stop:{value:"blindStop"},position:{value:"blindRaw",ext:"%d"}},states:{position:{value:"blindTLevel"}}}});c.BLIND_VIRTUAL_RECEIVER&&(e={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}},rotation:{value:{type:"INT",min:0,max:100,step:1}}},states:{position:{min:0,max:100},rotation:{min:0,max:100}},details:{commands:{up:{value:"moveUp"},
down:{value:"moveDown"},stop:{value:"stop"},position:{value:"moveTo",ext:"%d"},rotation:{value:"lamellaTo",ext:"%d"}},states:{position:{value:"blindTPos"},rotation:{value:"lamellaTPos"}}}});c.HEATING_CLIMATECONTROL_TRANSCEIVER&&(e={type:"heater",commands:{tempUp:{},tempDown:{},tempTo:{value:{type:"FLOAT",min:4,max:30.5,step:.5}},auto:{},manu:{}},states:{setpoint:{type:"FLOAT",min:4,max:30.5,step:.5,unit:"\u00b0C"},temperature:{type:"FLOAT"},humidity:{type:"INT"}},details:{commands:{tempUp:{value:"themoTempUp"},
tempDown:{value:"themoTempDown"},tempTo:{value:"themoTemp",ext:"%f"},auto:{value:"themoTAutoMode"},manu:{value:"themoTManuMode"}},states:{setpoint:{value:"themoTemp"},temperature:{value:"themoActualTemp"},humidity:{value:"themoHum"},mode:{value:"themoMode"}}}});return e}};xnm.aio.hm.Handler=function(){var a=require("x.logger.js");this._logger=a?a.getLogger("xnm.aio.hm.Handler"):{log:function(){}};xnm.aio.hm.Handler._logger=a?a.getLogger("xnm.aio.hm.Handler"):{log:function(){}}};
...
d-2),f=(new Buffer(e,"hex")).toString();e=1;-1!=f.indexOf("CCU2")?e=2:-1!=f.indexOf("CCU3")&&(e=3);c=c.substr(d+2);d=a(c);if(-1!=d&&(c=c.substr(0,d))){c=(new Buffer(c,"hex")).toString();var g=new xnm.aio.hm.MHMCCU(b,"",80,8181,c,e);this._discoveryCallbacks&&this._discoveryCallbacks.forEach(function(a){a&&a(g)})}}}},d=function(a,b,d){xnm.aio.hm.Handler._logger.log("debug","create discover socket @:"+b);var e=require("dgram"),f=this;try{var g=e.createSocket({reuseAddr:!0,type:"udp4"})}catch(r){g=e.createSocket("udp4")}var h=
d;g.on("listening",function(){g.setBroadcast&&g.setBroadcast(!0);h&&(h(null,g),h=null)});g.on("message",function(a,b){c.call(f,b,a)});g.on("error",function(a){xnm.aio.hm.Handler._logger.log("warn","create discover socket error:"+a);h&&(h(a),h=null)});g.bind(a,b);return g},b=function(a,b){var c=new Buffer([2,165,219,48,1,101,81,51,45,42,0,42,0,73]);a.send(c,0,c.length,43439,"255.255.255.255",function(){b&&a.close()})},e=this;(function(a){var b=[],e=this,f=require("os"),m=require("dgram");if(f&&f.networkInterfaces){var p=
m.createSocket("udp4");p.on("listening",function(){p.setBroadcast(!0);var c=f.networkInterfaces(),g=[],h;for(h in c)for(var k=c[h],m=0;m<k.length;m++)"IPv4"==k[m].family&&0==k[m].internal&&g.push(k[m].address);var y=g.length;if(y)for(c=0;c<g.length;c++)d.call(e,p.address().port,g[c],function(c,d){y--;!c&&d&&b.push(d);y||a&&a(null,b)});else a&&a(null,b)});p.on("message",function(a,b){c.call(e,b,a)});p.bind(null)}else d.call(e,null,null,function(c,d){!c&&d&&b.push(d);a&&a(null,b)})}).call(this,function(a,
