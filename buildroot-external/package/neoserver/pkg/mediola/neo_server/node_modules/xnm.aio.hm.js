...
if("BidCos-RF"==a["interface"]||"BidCos-Wired"==a["interface"]){var b=xnm.aio.hm.DM._getChannels(a);var e=xnm.aio.hm.MAP}else if("HmIP-RF"==a["interface"])b=xnm.aio.hm.DM._getHmIPChannels(a),e=xnm.aio.hm.HMIP_MAP;else if("CUxD"==a["interface"])b=xnm.aio.hm.DM._getCUxDChannels(a),e=xnm.aio.hm.CUxDMAP;else return null;var f=null,h=null,g=null,l;for(l in b){var k=b[l],m=e[l];if(m){for(var r in k)if(k=m[r]){if(k=d?k.command:k.status)for(var q=0;q<k.length;q++)if(k[q].ref.value==c){h=r;break}if(h)break}if(h){f=
l;break}}}if(!f||!h)return null;for(l in a.channels)if(l==f){c=a.address;d=c.indexOf(":");-1!=d&&(c=c.substr(0,d));g=c+":"+a.channels[l].address;break}return g?{"interface":a["interface"],channel:g,channelType:f,datapoint:h}:null},getStatesCreator:function(a,c,d){for(var b=[],e=[],f=null,h=this,g=[],l=[],k=[],m=0;m<c.length;m++){var r=c[m],q=r.id,u=r.status,t=r.device;if(q&&t&&u)if(!t.type&&t.ip)"serviceMsg"==u.value?g.push(r):"ccuTime"==u.value?l.push(r):"cloudmaticState"==u.value&&k.push(r);else switch(t.type){case xnm.aio.hm.DM.SYSVAR:if(!t["class"]||
!xnm.aio.hm.SysVar[t["class"].toUpperCase()])continue;(f=xnm.aio.hm.SysVar[t["class"].toUpperCase()].buildStateScript(this,t,u))&&b.push({alias:q,script:f,device:t,status:u});break;case xnm.aio.hm.DM.PROG:continue;default:if(t&&"BidCos-RF"==t["interface"]&&t.type&&xnm.aio.hm.BidCosDevice[t.type]){var w=xnm.aio.hm.BidCosDevice[t.type];if(w.buildStateScript&&(f=w.buildStateScript(this,t,u))){b.push({alias:q,script:f,device:t,channel:null,status:u});break}}if(t&&"HmIP-RF"==t["interface"]){if((w=xnm.aio.hm.HmIPDevice.resolveJSON(t))&&
w.getBufferedState&&(r=w.getBufferedState(this,t,u),null!=r&&"undefined"!=typeof r)){e.push({alias:q,state:r});break}if(w&&w.buildStateScript&&(f=w.buildStateScript(this,t,u))){b.push({alias:q,script:f,device:t,channel:null,status:u});break}}if(t&&"VirtualDevices"==t["interface"]&&t.type&&(r=xnm.aio.hm.VirtualDevice[t.type])&&(r=new r,r.buildStateScript&&(f=r.buildStateScript(this,t,u)))){b.push({alias:q,script:f,device:t,channel:null,status:u});break}if(t.channels){w=t.channels;for(var v in w)if(w.hasOwnProperty(v)){var p=
null;"CUxD"==t["interface"]?p=xnm.aio.hm.CUxDChannel[v]:"HmIP-RF"==t["interface"]||"HmIP-HEATING"==t.type?p=xnm.aio.hm.HmIPChannel[v]:"HM-Sec-Sir-WM"!=t.type||"SWITCH_SENSOR_1"!=v&&"SWITCH_SENSOR_2"!=v?"HM-WDS30-OT2-SM-2"!=t.type||"WEATHER_1"!=v&&"WEATHER_2"!=v&&"WEATHER_3"!=v&&"WEATHER_4"!=v||(p=xnm.aio.hm.Channel.WEATHER):p=xnm.aio.hm.Channel.SWITCH_SENSOR;p||(p=xnm.aio.hm.Channel[v]);if(p&&p.getBufferedState&&(r=p.getBufferedState(this._statebuffer,t,t.channels[v],u),null!=r&&"undefined"!=typeof r)){e.push({alias:q,
state:r});break}if(p&&p.buildStateScript&&(f=p.buildStateScript(this,t,t.channels[v],u))){b.push({alias:q,script:f,device:t,channel:v,status:u});break}}}}}this.getCloudmaticStatus(a,k,function(c,k){"undefined"!=typeof a&&null!=a&&"undefined"!=typeof a.reportStates&&null!=a.reportStates&&!c&&k&&0<k.length&&a.reportStates(null,k);h.getServiceMessageStatus(a,g,function(c,g){h.getCCUStatus(a,l,function(a,c){0===b.length?(a=h.resolveStateResponse([],[],e),c&&(a=a?a.concat(c):c),g&&(a=a?a.concat(g):g),
...
d(Error("response format error"))}else d&&d(Error("response format error"))}}))})})})},getDeviceList:function(a){this._logger.log("debug","get device list from ccu:"+this.ip);var c=this;this._getDevices(function(d,b){d?a&&a(d):c._getSysvars(function(d,f){d?a&&a(d):c._getProgs(function(d,e){if(d)a&&a(d);else{d={devices:[],sysvars:[],progs:[]};var g,h;b&&b.devices&&(g=c._parseDevices(b.devices))&&0<g.length&&(d.devices=d.devices.concat(g));if(f&&f.systemvars){var m=f.systemvars;for(h in m)if(m.hasOwnProperty(h)){a:{var r=
f.systemvars[h],q=h;if(r.valuetype){switch(r.valuetype){case "2":g="binary";break;case "4":g="float";break;case "16":g="integer";break;case "20":g="string";break;default:g=null;break a}var u={};u.sys=xnm.aio.hm.DM.SYS;u.id=r.name;u.type=xnm.aio.hm.DM.SYSVAR;u.address=q;u["class"]=g;g=u}else g=null}g&&d.sysvars.push(g)}}if(e&&e.progs)for(h in m=e.progs,m)m.hasOwnProperty(h)&&(g=e.progs[h],r=h,g.name?(q={},q.sys=xnm.aio.hm.DM.SYS,q.id=g.name,q.address=r,q.type=xnm.aio.hm.DM.PROG,g=q):g=null,g&&d.progs.push(g));
...
if(0==h)return null;if(1<h&&"CUxD"!=a.interface)return e(a);h={};h.sys=xnm.aio.hm.DM.SYS;h.id=a.name;h.type=a.hsstype;h.address=a.address;h.rfAddr=a.rfAddr;h["interface"]=a["interface"];h.channels={};var g=a.channels,l=!1,k;for(k in g)if(g.hasOwnProperty(k)&&(e=a.channels[k],e.address)){var m=e.address.indexOf(":");if(-1!==m&&(m=e.address.substring(m+1),(0!=m||-1!=c.indexOf(a.hsstype))&&e.hsstype)){if("CUxD"==h["interface"]){if(!xnm.aio.hm.CUxDCHANNEL[e.hsstype]&&!xnm.aio.hm.CHANNEL[e.hsstype])continue}else if(d(e.hsstype))continue;
if(h.channels[e.hsstype]){var r=h.channels[e.hsstype];l=r.id;r=r.address;var q=b(h,e);q?e.hsstype=q:(-1==h.address.indexOf(":")&&1==Object.keys(h.channels).length&&(h.address=h.address+":"+h.channels[e.hsstype].address),"CUxD"==h["interface"]&&(q=xnm.aio.hm.MHMCCU._resolveCUxDType(h))&&(h.cuxd=q),h.id=l?l:r,f.push(h),h={},h.sys=xnm.aio.hm.DM.SYS,h.id=a.name,h.type=a.hsstype,h.address=a.address+":"+m,h["interface"]=a["interface"],h.channels={})}l=!0;m={id:e.name,address:m,room:e.room,group:e.func,
datapoints:[]};var u;r=m.datapoints;if("CUxD"==h["interface"])m.datapoints=e.datapoints;else for(u in e.datapoints)e.datapoints.hasOwnProperty(u)&&(q=e.datapoints[u],q={name:q.name,valuetype:q.valuetype,operations:q.operations},r.push(q));h.channels[e.hsstype]=m}}l&&f.push(h);"CUxD"==h["interface"]&&(q=xnm.aio.hm.MHMCCU._resolveCUxDType(h))&&(h.cuxd=q);return f},getCloudmaticStatus:function(a,c,d){if(!c||0>=c.length)d&&d(null,[]);else{a=[];for(var b=0;b<c.length;b++){var e=c[b];if(e){var f=e.id;e=
...
var l=this,k="",m=require("http").request(c,function(a){200==a.statusCode?(a.setEncoding("binary"),a.on("data",function(a){k+=a}),a.on("end",function(){g&&g(null,k);g=null})):(l._logger.log("warn","Failed to post request to "+l.ip+" with status code:"+a.statusCode),g&&g(new TypeError("post request failed with status code:"+a.statusCode)),g=null)});m.setEncoding&&m.setEncoding("ISO-8859-1");if(m.setTimeout){c=6E4;if(null==b||"undefined"==typeof b)b=0;b=parseInt(b);c=0<b?b:c;1E4>c&&(c=1E4);0<c&&m.setTimeout(c,
function(){m.abort()})}if(m.on&&"function"==typeof m.on)m.on("error",function(a){a||(a=Error("http request error"));g&&g(a);g=null});m.write(a);m.end()}else d&&d(Error("cloudmatic config invalid"))}};
...
STOP:{command:[{type:"enum",name:"stop",ref:{value:"jalStop"}}]},DIRECTION:{status:[{type:"enum",name:"direction",ref:{value:"jalDirection",options:["none","up","down","undefined"]}}]},LEVEL_SLATS:{command:[{type:"enum",name:"lamella up",ref:{value:"jalLmlUp"}},{type:"enum",name:"lamella down",ref:{value:"jalLmlDown"}},{type:"int",name:"lamella step up",ref:{value:"jalLmlStepUp",ext:"%d",extMeta:"5-50"}},{type:"int",name:"lamella step down",ref:{value:"jalLmlStepDown",ext:"%d",extMeta:"5-50"}},{type:"int",
name:"lamella to",ref:{value:"jalLmlRaw",ext:"%d",extMeta:"0-100"}}],status:[{type:"int",name:"lamella status",ref:{value:"jalLmlLevel"}}]}},SysVar:{binary:{command:[{type:"enum",name:"on",ref:{value:"binaryOn"}},{type:"enum",name:"off",ref:{value:"binaryOff"}},{type:"enum",name:"toggle",ref:{value:"binaryToggle"}}],status:[{type:"enum",name:"state",ref:{value:"binaryState",options:["on","off"]}},{type:"string",name:"mapped state",ref:{value:"mappedState"}}]},"float":{command:[{type:"float",name:"set value",
ref:{value:"rawFloatValue",ext:"%f",scale:"0.1"}}],status:[{type:"float",name:"state",ref:{value:"floatState",scale:"0.1"}}]},integer:{command:[{type:"int",name:"set value",ref:{value:"rawIntValue",ext:"%d"}}],status:[{type:"int",name:"state",ref:{value:"intState"}},{type:"string",name:"mapped state",ref:{value:"mappedState"}}]},string:{command:[{type:"string",name:"set value",ref:{value:"rawStringValue",ext:"%s"}}],status:[{type:"string",name:"state",ref:{value:"stringState"}}]}},CCU:{command:[{type:"enum",
name:"cloudmatic on",ref:{value:"cloudmaticOn"}},{type:"enum",name:"cloudmatic off",ref:{value:"cloudmaticOff"}},{type:"enum",name:"cloudmatic toggle",ref:{value:"cloudmaticToggle"}}],status:[{type:"string",name:"service message",ref:{value:"serviceMsg"}},{type:"string",name:"ccu time",ref:{value:"ccuTime"}},{type:"enum",name:"cloudmatic state",ref:{value:"cloudmaticState",options:["on","off"]}}]},MOD_EM8BIT_TRANSMITTER:{STATE:{status:[{type:"int",name:"status",ref:{value:"state8bit"}}]},LOWBAT:{status:[{type:"enum",
name:"low battery",ref:{value:"lowbat8bit",options:["true","false"]}}]}},DUAL_WHITE_BRIGHTNESS:{DIRECTION:{status:[{type:"enum",name:"dim direction",ref:{value:"dualWBDirection",options:["none","up","down","undefined"]}}]},ERROR_OVERHEAT:{status:[{type:"enum",name:"overheat error",ref:{value:"dualWBErrHeat",options:["no_error","over_heat"]}}]},ERROR_REDUCED:{status:[{type:"enum",name:"reduced error",ref:{value:"dualWBErrReduced",options:["no_error","reduced"]}}]},LEVEL:{command:[{type:"enum",name:"off",
ref:{value:"dualWBOff"}},{type:"enum",name:"dim up",ref:{value:"dualWBUp"}},{type:"enum",name:"dim down",ref:{value:"dualWBDown"}},{type:"int",name:"dim to",ref:{value:"dualWBTo",ext:"%d",extMeta:"0-100"}},{type:"int",name:"toggle to",ref:{value:"dualWBToggleTo",ext:"%d",extMeta:"1-100"}}],status:[{type:"int",name:"level status",ref:{value:"dualWBLevel"}}]},OLD_LEVEL:{command:[{type:"enum",name:"on",ref:{value:"dualWBOn"}}]}},DUAL_WHITE_COLOR:{DIRECTION:{status:[{type:"enum",name:"color direction",
ref:{value:"dualWCDirection",options:["none","up","down","undefined"]}}]},LEVEL:{command:[{type:"enum",name:"color off",ref:{value:"dualWCOff"}},{type:"enum",name:"color up",ref:{value:"dualWCUp"}},{type:"enum",name:"color down",ref:{value:"dualWCDown"}},{type:"int",name:"color to",ref:{value:"dualWCTo",ext:"%d",extMeta:"0-100"}},{type:"int",name:"color toggle to",ref:{value:"dualWCToggleTo",ext:"%d",extMeta:"0-100"}}],status:[{type:"int",name:"color status",ref:{value:"dualWCLevel"}}]},OLD_LEVEL:{command:[{type:"enum",
name:"color on",ref:{value:"dualWCOn"}}]}}};
...
{value:"switchState"});default:return"?"}};r.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "1":e=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.resolveState(a,b,c);break;case "2":case "3":case "4":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.resolveState(a,b,c);e.key="2"==d?"ch2State":"3"==d?"ch3State":"ch4State";break;case "5":e=xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.resolveState(a,
...
b,c),"passageCurrentDirection"==e.key?e.key="passageCurrentDirection":"passageLastDirection"==e.key?e.key="passageLastDirection":"passageC"==e.key?e.key="2"==d?"passageR2LC":"passageL2RC":"passageCOF"==e.key&&(e.key="2"==d?"passageR2LCOF":"passageL2RCOF")}return e};var p=function(){};p.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false",
"true"]}},{type:"enum",name:"alarm state",ref:{value:"waterAlarmState",options:["on","off"]}},{type:"enum",name:"moisture detected",ref:{value:"waterMoistureDetected",options:["true","false"]}},{type:"enum",name:"water detected",ref:{value:"waterWaterDetected",options:["true","false"]}}]}};p.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false",
"true"]}},{type:"enum",name:"alarm state",ref:{value:"waterAlarmState",options:["on","off"]}},{type:"enum",name:"moisture detected",ref:{value:"waterMoistureDetected",options:["true","false"]}},{type:"enum",name:"water detected",ref:{value:"waterWaterDetected",options:["true","false"]}}]}};p.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "waterAlarmState":d=
...
b,c)}return e};return a}();return{"HmIP-BSM":new f,"HmIP-BDT":new h,"HMIP-WRC2":new g,"HmIP-ASIR":new l,"HmIP-SWSD":new k,"HmIP-SRH":new m,"HmIP-FSM":new r,"HmIP-PDT":new q,"HmIP-BROLL":new u,"HmIP-FROLL":new u,"HmIP-BBL":new t,"HmIP-FBL":new t,"HmIP-WRC6":new w,"HmIP-SPDR":new v,"HmIP-SWD":new p,"HmIP-SAM":new A,"HmIP-WGC":new x,"HmIP-BSL":new y,"HmIP-MOD-TM":new z,"HmIP-SLO":new E,"HmIP-PMFS":new F,"HmIP-MP3P":new G,resolveJSON:function(f){if(!f||!f.type)return null;if("HmIP-PDT"==f.type)return d.parseJSON(f);
...
JSON.parse(JSON.stringify(a)),d.push(a))});break;case "status":a.status.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},r=function(a,c){var d=[],e=c.elems;a=xnm.aio.hm.HM_WDS30_OT2_SM_2_MAP;switch(c.catagory){case "status":a.status.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},q=function(a,c){var d=[],e=c.elems;a=xnm.aio.hm.HM_ES_TX_WM_MAP;switch(c.catagory){case "status":a.status.forEach(function(a){b(e,a.type)&&
