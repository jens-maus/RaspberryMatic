...
a["interface"]&&a.type&&xnm.aio.hm.VirtualDevice[a.type]&&(h=xnm.aio.hm.VirtualDevice[a.type])&&(h=new h,h.executeCommand)){h.executeCommand(this,a,c,d);break}if(a.channels)if(f=null,"DimmerKey"==a.type)f=xnm.aio.hm.DimmerKey,(f=f.buildCommandScript(this,a,c))?this._doRequestMarked(f,!0,{execute:function(a){setTimeout(function(){d&&d(a)},3E3)}}):d&&d(Error("no correspondent channel for the command is found"));else{var g=a.channels,k=h=!1,l;for(l in g)if(g.hasOwnProperty(l)&&(f=null,"CUxD"==a["interface"]?
f=xnm.aio.hm.CUxDChannel[l]:"HmIP-RF"==a["interface"]||"HmIP-HEATING"==a.type?f=xnm.aio.hm.HmIPChannel[l]:"HM-Sec-Sir-WM"!=a.type||"SWITCH_SENSOR_1"!=l&&"SWITCH_SENSOR_2"!=l||(f=xnm.aio.hm.Channel.SWITCH_SENSOR),f||(f=xnm.aio.hm.Channel[l]),f&&(h=!0,f.buildCommandScript&&(f=f.buildCommandScript(this,a,a.channels[l],c))))){k=!0;c=new e(a,c,l,d);this._doRequestMarked(f,!0,c);break}h?k||d&&d(Error("no correspondent channel for the command is found")):d&&d(Error("no correspondent channel is found"))}else d&&
...
!xnm.aio.hm.SysVar[g["class"].toUpperCase()]){b.push({id:e,status:"?"});continue}f=xnm.aio.hm.SysVar[g["class"].toUpperCase()].handleStatusResponse(c[d],f.status);b.push({id:e,status:f});break;case xnm.aio.hm.DM.PROG:b.push({id:e,status:"?"});break;default:if(g&&"BidCos-RF"==g["interface"]&&g.type&&xnm.aio.hm.BidCosDevice[g.type]){var k=xnm.aio.hm.BidCosDevice[g.type];if(k.handleStatusResponse){f=k.handleStatusResponse(c[d],f.status);b.push({id:e,status:f});continue}}if(g&&"HmIP-RF"==g["interface"]&&
(k=xnm.aio.hm.HmIPDevice.resolveJSON(g))&&k.handleStatusResponse){f=k.handleStatusResponse(c[d],f.status,this);b.push({id:e,status:f});continue}if(g&&"VirtualDevices"==g["interface"]&&g.type&&xnm.aio.hm.VirtualDevice[g.type]&&(k=xnm.aio.hm.VirtualDevice[g.type])&&(k=new k,k.handleStatusResponse)){f=k.handleStatusResponse(c[d],f.status);b.push({id:e,status:f});continue}k=null;"CUxD"==g["interface"]?k=xnm.aio.hm.CUxDChannel[h]:"HmIP-RF"==g["interface"]||"HmIP-HEATING"==g.type?k=xnm.aio.hm.HmIPChannel[h]:
"HM-Sec-Sir-WM"!=g.type||"SWITCH_SENSOR_1"!=h&&"SWITCH_SENSOR_2"!=h?"HM-WDS30-OT2-SM-2"!=g.type||"WEATHER_1"!=h&&"WEATHER_2"!=h&&"WEATHER_3"!=h&&"WEATHER_4"!=h||(k=xnm.aio.hm.Channel.WEATHER):k=xnm.aio.hm.Channel.SWITCH_SENSOR;k||(k=xnm.aio.hm.Channel[h]);k?k.handleStatusResponse?(f=k.handleStatusResponse(c[d],f.status),b.push({id:e,status:f})):b.push({id:e,status:c[e]}):b.push({id:e,status:"?"})}}else b.push({id:e,status:"?"})}return b},resolveState:function(a,c,d){if(!(a&&a.channels&&c&&c.channel&&
...
if("BidCos-RF"==a["interface"]||"BidCos-Wired"==a["interface"]){var b=xnm.aio.hm.DM._getChannels(a);var e=xnm.aio.hm.MAP}else if("HmIP-RF"==a["interface"])b=xnm.aio.hm.DM._getHmIPChannels(a),e=xnm.aio.hm.HMIP_MAP;else if("CUxD"==a["interface"])b=xnm.aio.hm.DM._getCUxDChannels(a),e=xnm.aio.hm.CUxDMAP;else return null;var f=null,h=null,g=null,k;for(k in b){var l=b[k],q=e[k];if(q){for(var p in l)if(l=q[p]){if(l=d?l.command:l.status)for(var r=0;r<l.length;r++)if(l[r].ref.value==c){h=p;break}if(h)break}if(h){f=
k;break}}}if(!f||!h)return null;for(k in a.channels)if(k==f){c=a.address;d=c.indexOf(":");-1!=d&&(c=c.substr(0,d));g=c+":"+a.channels[k].address;break}return g?{"interface":a["interface"],channel:g,channelType:f,datapoint:h}:null},getStatesCreator:function(a,c,d){for(var b=[],e=[],f=null,h=this,g=[],k=[],l=[],q=0;q<c.length;q++){var p=c[q],r=p.id,t=p.status,u=p.device;if(r&&u&&t)if(!u.type&&u.ip)"serviceMsg"==t.value?g.push(p):"ccuTime"==t.value?k.push(p):"cloudmaticState"==t.value&&l.push(p);else switch(u.type){case xnm.aio.hm.DM.SYSVAR:if(!u["class"]||
!xnm.aio.hm.SysVar[u["class"].toUpperCase()])continue;(f=xnm.aio.hm.SysVar[u["class"].toUpperCase()].buildStateScript(this,u,t))&&b.push({alias:r,script:f,device:u,status:t});break;case xnm.aio.hm.DM.PROG:continue;default:if(u&&"BidCos-RF"==u["interface"]&&u.type&&xnm.aio.hm.BidCosDevice[u.type]){var y=xnm.aio.hm.BidCosDevice[u.type];if(y.buildStateScript&&(f=y.buildStateScript(this,u,t))){b.push({alias:r,script:f,device:u,channel:null,status:t});break}}if(u&&"HmIP-RF"==u["interface"]){if((y=xnm.aio.hm.HmIPDevice.resolveJSON(u))&&
y.getBufferedState&&(p=y.getBufferedState(this,u,t),null!=p&&"undefined"!=typeof p)){e.push({alias:r,state:p});break}if(y&&y.buildStateScript&&(f=y.buildStateScript(this,u,t))){b.push({alias:r,script:f,device:u,channel:null,status:t});break}}if(u&&"VirtualDevices"==u["interface"]&&u.type&&(p=xnm.aio.hm.VirtualDevice[u.type])&&(p=new p,p.buildStateScript&&(f=p.buildStateScript(this,u,t)))){b.push({alias:r,script:f,device:u,channel:null,status:t});break}if(u.channels){y=u.channels;for(var w in y)if(y.hasOwnProperty(w)){var n=
null;"CUxD"==u["interface"]?n=xnm.aio.hm.CUxDChannel[w]:"HmIP-RF"==u["interface"]||"HmIP-HEATING"==u.type?n=xnm.aio.hm.HmIPChannel[w]:"HM-Sec-Sir-WM"!=u.type||"SWITCH_SENSOR_1"!=w&&"SWITCH_SENSOR_2"!=w?"HM-WDS30-OT2-SM-2"!=u.type||"WEATHER_1"!=w&&"WEATHER_2"!=w&&"WEATHER_3"!=w&&"WEATHER_4"!=w||(n=xnm.aio.hm.Channel.WEATHER):n=xnm.aio.hm.Channel.SWITCH_SENSOR;n||(n=xnm.aio.hm.Channel[w]);if(n&&n.getBufferedState&&(p=n.getBufferedState(this._statebuffer,u,u.channels[w],t),null!=p&&"undefined"!=typeof p)){e.push({alias:r,
state:p});break}if(n&&n.buildStateScript&&(f=n.buildStateScript(this,u,u.channels[w],t))){b.push({alias:r,script:f,device:u,channel:w,status:t});break}}}}}this.getCloudmaticStatus(a,l,function(c,l){"undefined"!=typeof a&&null!=a&&"undefined"!=typeof a.reportStates&&null!=a.reportStates&&!c&&l&&0<l.length&&a.reportStates(null,l);h.getServiceMessageStatus(a,g,function(c,g){h.getCCUStatus(a,k,function(a,c){0===b.length?(a=h.resolveStateResponse([],[],e),c&&(a=a?a.concat(c):c),g&&(a=a?a.concat(g):g),
l&&(a=a?a.concat(l):l),d&&d(null,a||[])):(f=h.buildScript(b),h._doRequest(f,!0,function(a,f){var k=null;if(a)d&&d(a);else{a=f.indexOf("<states>");var n=f.lastIndexOf("</states");if(n>a+8)try{k=f.substring(a+8,n);k=xnm.aio.hm.Util.decodeXml(k);var q=k.split("\r@@@\n");k={};for(f=0;f<q.length;f++){var p=q[f].indexOf("=");if(0<p){var u=q[f].substr(0,p);k[u]=q[f].substr(p+1)}}k=h.resolveStateResponse(b,k,e);c&&(k=k?k.concat(c):c);g&&(k=k?k.concat(g):g);l&&(k=k?k.concat(l):l);d&&d(null,k)}catch(K){d&&
d(Error("response format error"))}else d&&d(Error("response format error"))}}))})})})},getDeviceList:function(a){this._logger.log("debug","get device list from ccu:"+this.ip);var c=this;this._getDevices(function(d,b){d?a&&a(d):c._getSysvars(function(d,f){d?a&&a(d):c._getProgs(function(d,e){if(d)a&&a(d);else{d={devices:[],sysvars:[],progs:[]};var g,h;b&&b.devices&&(g=c._parseDevices(b.devices))&&0<g.length&&(d.devices=d.devices.concat(g));if(f&&f.systemvars){var q=f.systemvars;for(h in q)if(q.hasOwnProperty(h)){a:{var p=
f.systemvars[h],r=h;if(p.valuetype){switch(p.valuetype){case "2":g="binary";break;case "4":g="float";break;case "16":g="integer";break;case "20":g="string";break;default:g=null;break a}var t={};t.sys=xnm.aio.hm.DM.SYS;t.id=p.name;t.type=xnm.aio.hm.DM.SYSVAR;t.address=r;t["class"]=g;g=t}else g=null}g&&d.sysvars.push(g)}}if(e&&e.progs)for(h in q=e.progs,q)q.hasOwnProperty(h)&&(g=e.progs[h],p=h,g.name?(r={},r.sys=xnm.aio.hm.DM.SYS,r.id=g.name,r.address=p,r.type=xnm.aio.hm.DM.PROG,g=r):g=null,g&&d.progs.push(g));
...
a["interface"]&&xnm.aio.hm.VirtualDevice)return xnm.aio.hm.VirtualDevice.parseDevice(a);if("HmIP-RF"==a["interface"])return xnm.aio.hm.HmIPDevice.parseDevice(a);var f=[];if("BidCos-RF"==a["interface"]){if(f=xnm.aio.hm.BidCosDevice.parseDevice(a))return f;f=[]}var h=function(a){var b=a.channels;if(!b)return 0;var c=0,e=0,f={},g;for(g in b)if(b.hasOwnProperty(g)){var h=a.channels[g];if(h.address){var k=h.address.indexOf(":");-1!==k&&0!=h.address.substring(k+1)&&h.hsstype&&!d(h.hsstype)&&(c+=1,f[h.hsstype]=
!0)}}if(0==c)return 0;for(var l in f)f.hasOwnProperty(l)&&(e+=1);return c>e?c:1}(a);if(0==h)return null;if(1<h&&"CUxD"!=a.interface)return e(a);h={};h.sys=xnm.aio.hm.DM.SYS;h.id=a.name;h.type=a.hsstype;h.address=a.address;h.rfAddr=a.rfAddr;h["interface"]=a["interface"];h.channels={};var g=a.channels,k=!1,l;for(l in g)if(g.hasOwnProperty(l)&&(e=a.channels[l],e.address)){var q=e.address.indexOf(":");if(-1!==q&&(q=e.address.substring(q+1),(0!=q||-1!=c.indexOf(a.hsstype))&&e.hsstype)){if("CUxD"==h["interface"]){if(!xnm.aio.hm.CUxDCHANNEL[e.hsstype]&&
!xnm.aio.hm.CHANNEL[e.hsstype])continue}else if(d(e.hsstype))continue;if(h.channels[e.hsstype]){var p=h.channels[e.hsstype];k=p.id;p=p.address;var r=b(h,e);r?e.hsstype=r:(-1==h.address.indexOf(":")&&1==Object.keys(h.channels).length&&(h.address=h.address+":"+h.channels[e.hsstype].address),"CUxD"==h["interface"]&&(r=xnm.aio.hm.MHMCCU._resolveCUxDType(h))&&(h.cuxd=r),h.id=k?k:p,f.push(h),h={},h.sys=xnm.aio.hm.DM.SYS,h.id=a.name,"CUxD"==a["interface"]&&e.name&&(h.id=e.name),h.type=a.hsstype,h.address=
a.address+":"+q,h["interface"]=a["interface"],h.channels={})}k=!0;q={id:e.name,address:q,room:e.room,group:e.func,datapoints:[]};var t;p=q.datapoints;if("CUxD"==h["interface"])q.datapoints=e.datapoints;else for(t in e.datapoints)e.datapoints.hasOwnProperty(t)&&(r=e.datapoints[t],r={name:r.name,valuetype:r.valuetype,operations:r.operations},p.push(r));h.channels[e.hsstype]=q}}k&&f.push(h);"CUxD"==h["interface"]&&(r=xnm.aio.hm.MHMCCU._resolveCUxDType(h))&&(h.cuxd=r);return f},getCloudmaticStatus:function(a,
c,d){if(!c||0>=c.length)d&&d(null,[]);else{a=[];for(var b=0;b<c.length;b++){var e=c[b];if(e){var f=e.id;e=e.status;if(f&&e)switch(e.value){case "cloudmaticState":a.push({id:f,status:this._cloudmaticState})}}}d(null,a)}},getCCUStatus:function(a,c,d){!c||0>=c.length?d&&d(null,[]):(this._logger.log("debug","get ccu states:"+this.ip),this._doRequest('var ccutime=system.Date("%H:%M:%S").ToString();',!0,function(a,e){if(a)d&&d(a);else{if(!e)return null;a=[];var b=e.indexOf("<ccutime>"),h=e.lastIndexOf("</ccutime>");
if(h<=b+9)return null;e=e.substring(b+9,h);e=xnm.aio.hm.Util.decodeXml(e);for(b=0;b<c.length;b++){var g=c[b];if(g&&(h=g.id,g=g.status,h&&g))switch(g.value){case "ccuTime":a.push({id:h,status:e})}}d&&d(null,a)}}))},getServiceMessageStatus:function(a,c,d){!c||0>=c.length?d&&d(null,[]):this.getServiceMessage(function(a,e){if(a)d&&d(a);else if(e){a="";for(var b=[],h=0;h<e.length;h++)if(e[h].name&&e[h].error){switch(e[h].error){case "LOWBAT":var g="low battery";break;case "UNREACH":g="communication is interrupted";
break;case "STICKY_UNREACH":g="communication was interrupted";break;case "FAULT_REPORTING":g="reporing failure";break;case "ERROR":g="failure";break;default:g=e[h].error}a+=e[h].name+": "+g+"\n"}for(e=0;e<c.length;e++)if(g=c[e])if(h=g.id,g=g.status,h&&g)switch(g.value){case "serviceMsg":b.push({id:h,status:a})}d(null,b)}else d&&d(null,[])})},getServiceMessage:function(a){this._doRequest(xnm.aio.hm.MHMCCU._SCRIPT_GET_SEVICE_MESSAGE,!0,function(c,d){if(c)a&&a(c);else{if(d){c=d.indexOf("<res>");var b=
...
(this.password?this.password:""),c.headers.Authorization="Basic "+(new Buffer((this.username?this.username:"")+":"+(this.password?this.password:""))).toString("base64");var g=this,k="",l=require("http").request(c,function(a){200==a.statusCode?(a.setEncoding("binary"),a.on("data",function(a){k+=a}),a.on("end",function(){h&&h(null,k);h=null})):(g._logger.log("warn","Failed to post request to "+g.ip+" with status code:"+a.statusCode),h&&h(new TypeError("post request failed with status code:"+a.statusCode)),
h=null)});l.setEncoding&&l.setEncoding("ISO-8859-1");if(l.setTimeout){c=6E4;if(null==b||"undefined"==typeof b)b=0;b=parseInt(b);c=0<=b?b:c;0<c&&l.setTimeout(c,function(){l.abort()})}if(l.on&&"function"==typeof l.on)l.on("error",function(a){a||(a=Error("http request error"));h&&h(a);h=null});l.write(a);l.end()}},_doCloudmaticRequest:function(a,c,d,b){if(this.cloudmatic&&this.cloudmatic.id&&this.cloudmatic.username&&this.cloudmatic.password){var e=this.cloudmatic.id+".meine-homematic.de",f=this.port,
h="/api/homematic.cgi";c&&(f=this.tclport,h="/tclrega.exe");var g=d;c={host:e,port:f,path:h,method:"POST",headers:{"Content-Type":'text/xml; charset="ISO-8859-1"',"Content-Length":a.length,"User-Agent":"mediola",Connection:"close"}};if(this.cloudmatic.username||this.cloudmatic.password)c.auth=(this.cloudmatic.username?this.cloudmatic.username:"")+":"+(this.cloudmatic.password?this.cloudmatic.password:""),c.headers.Authorization="Basic "+(new Buffer((this.cloudmatic.username?this.cloudmatic.username:
"")+":"+(this.cloudmatic.password?this.cloudmatic.password:""))).toString("base64");var k=this,l="",q=require("http").request(c,function(a){200==a.statusCode?(a.setEncoding("binary"),a.on("data",function(a){l+=a}),a.on("end",function(){g&&g(null,l);g=null})):(k._logger.log("warn","Failed to post request to "+k.ip+" with status code:"+a.statusCode),g&&g(new TypeError("post request failed with status code:"+a.statusCode)),g=null)});q.setEncoding&&q.setEncoding("ISO-8859-1");if(q.setTimeout){c=6E4;if(null==
b||"undefined"==typeof b)b=0;b=parseInt(b);c=0<b?b:c;1E4>c&&(c=1E4);0<c&&q.setTimeout(c,function(){q.abort()})}if(q.on&&"function"==typeof q.on)q.on("error",function(a){a||(a=Error("http request error"));g&&g(a);g=null});q.write(a);q.end()}else d&&d(Error("cloudmatic config invalid"))}};
...
name:"wind speed",ref:{value:"weatherWindS"}}]},BRIGHTNESS:{status:[{type:"int",name:"brightness",ref:{value:"weatherBright"}}]},BAT_VOLTAGE:{status:[{type:"float",name:"battery voltage",ref:{value:"weatherBatVolt"}}]}},ROTARY_HANDLE_SENSOR:{STATE:{status:[{type:"enum",name:"handle state",ref:{value:"handleState",options:["closed","tilted","open"]}}]}},SHUTTER_CONTACT:{STATE:{status:[{type:"enum",name:"shutter state",ref:{value:"shutterState",options:["closed","open"]}}]}},MOTION_DETECTOR:{MOTION:{status:[{type:"enum",
name:"state",ref:{value:"motionState",options:["on","off"]}}]},BRIGHTNESS:{status:[{type:"float",name:"brightness",ref:{value:"motionBright"}}]}},CAPACITIVE_FILLING_LEVEL_SENSOR:{FILLING_LEVEL:{status:[{type:"float",name:"level",ref:{value:"fillingLevel"}}]}},SENSOR:{STATE:{status:[{type:"enum",name:"state",ref:{value:"sensorState",options:["false","true"]}}]},SUM:{status:[{type:"float",name:"meter sum",ref:{value:"sensorSum"}}]},MEAN5MINUTES:{status:[{type:"float",name:"meter mean value (5 min)",
ref:{value:"sensorMean5min"}}]},MAX5MINUTES:{status:[{type:"float",name:"meter max value (5 min)",ref:{value:"sensorMax5min"}}]},SUM_1H:{status:[{type:"float",name:"meter sum (1h)",ref:{value:"sensorSum1h"}}]},MAX_1H:{status:[{type:"float",name:"meter max value (1h)",ref:{value:"sensorMax1h"}}]},SUM_24H:{status:[{type:"float",name:"meter sum (24h)",ref:{value:"sensorSum24h"}}]},MAX_24H:{status:[{type:"float",name:"meter max value (24hn)",ref:{value:"sensorMax24h"}}]},METER:{status:[{type:"float",
name:"meter value",ref:{value:"sensorMeter"}}]},LAST_VALUE:{status:[{type:"float",name:"meter last value",ref:{value:"sensorLastValue"}}]},DISTANCE:{status:[{type:"float",name:"water distance",ref:{value:"sensorDistance"}}]},F_PERCENT:{status:[{type:"integer",name:"water fill percent",ref:{value:"sensorFPercent"}}]},F_LEVEL:{status:[{type:"float",name:"water fill level",ref:{value:"sensorFLevel"}}]},F_VOLUME:{status:[{type:"float",name:"water fill volume",ref:{value:"sensorFVolume"}}]},RELAIS1:{status:[{type:"enum",
name:"relais1 state",ref:{value:"sensorRelais1",options:["false","true"]}}]},RELAIS2:{status:[{type:"enum",name:"relais2 state",ref:{value:"sensorRelais2",options:["false","true"]}}]},INFO:{status:[{type:"string",name:"sensor info",ref:{value:"sensorInfo"}}]},SUM_DATE:{status:[{type:"string",name:"meter sum date",ref:{value:"sensorSumDate"}}]},SUM_RESET:{command:[{type:"enum",name:"meter sum reset",ref:{value:"sensorSumReset"}}]},MODE:{command:[{type:"enum",name:"aircon. auto mode",ref:{value:"sensModeAuto"}},
{type:"enum",name:"aircon. heat mode",ref:{value:"sensModeHeat"}},{type:"enum",name:"aircon. cool mode",ref:{value:"sensModeCool"}},{type:"enum",name:"aircon. fan only mode",ref:{value:"sensModeFanOnly"}},{type:"enum",name:"aircon. dry mode",ref:{value:"sensModeDry"}}],status:[{type:"enum",name:"aircon mode",ref:{value:"sensMode",options:["auto","heat","cool","fan_only","dry"]}}]},VANE:{command:[{type:"enum",name:"vertical swing",ref:{value:"sensSwingV"}},{type:"enum",name:"horizontal swing",ref:{value:"sensSwingH"}},
{type:"enum",name:"vertical and horizontal swing",ref:{value:"sensSwingVH"}},{type:"enum",name:"stop swing",ref:{value:"sensSwingS"}}],status:[{type:"enum",name:"swing mode",ref:{value:"sensSwing",options:["vertical","horizontal","both","stop"]}}]},SPEED:{command:[{type:"enum",name:"speed auto",ref:{value:"sensSpeedAuto"}},{type:"enum",name:"speed low",ref:{value:"sensSpeedLow"}},{type:"enum",name:"speed mid1",ref:{value:"sensSpeedMid1"}},{type:"enum",name:"speed mid2",ref:{value:"sensSpeedMid2"}},
{type:"enum",name:"speed mid3",ref:{value:"sensSpeedMid3"}},{type:"enum",name:"speed high",ref:{value:"sensSpeedHigh"}}],status:[{type:"enum",name:"speed",ref:{value:"sensSpeed",options:"auto low mid1 mid2 mid3 high".split(" ")}}]},ROOM:{command:[{type:"enum",name:"occupied",ref:{value:"sensRoomOccu"}},{type:"enum",name:"standby",ref:{value:"sensRoomStandby"}},{type:"enum",name:"unoccupied",ref:{value:"sensRoomUnoccu"}},{type:"enum",name:"off",ref:{value:"sensRoomOff"}}],status:[{type:"enum",name:"room",
ref:{value:"sensRoom",options:["occupied","standby","unoccupied","off"]}}]}},POWERMETER:{POWER:{status:[{type:"float",name:"power",ref:{value:"powerMeterPower"}}]},ENERGY_COUNTER:{status:[{type:"float",name:"energy counter",ref:{value:"powerMeterECount"}}]},SUM_1H:{status:[{type:"float",name:"meter sum (1h)",ref:{value:"powerMeterSum1h"}}]},SUM_24H:{status:[{type:"float",name:"meter sum (24h)",ref:{value:"powerMeterSum24h"}}]},VOLTAGE:{status:[{type:"float",name:"meter voltage",ref:{value:"powerMeterVoltage"}}]}},
DANGER:{STATE:{status:[{type:"enum",name:"alarm state",ref:{value:"dangerState",options:["ok","danger"]}}]}},EVENT_INTERFACE:{STATE:{command:[{type:"enum",name:"press",ref:{value:"evntIntfPress"}}]}},RELAIS:{STATE:{command:[{type:"enum",name:"on",ref:{value:"relaisOn"}},{type:"enum",name:"off",ref:{value:"relaisOff"}},{type:"enum",name:"toggle",ref:{value:"relaisToggle"}}],status:[{type:"enum",name:"relais status",ref:{value:"relaisState",options:["off","on"]}}]}},WRAPPER:{"[DATAPT]":{status:[{type:"float",
name:"value",ref:{value:"wrapperValue"}}]}},SYSTEM:{STATE:{command:[{type:"enum",name:"press",ref:{value:"systemPress"}}]}},FHT_Multiventil_Dimmer:{LEVEL:{command:[{type:"enum",name:"off",ref:{value:"valveOff"}},{type:"enum",name:"valve up",ref:{value:"valveUp"}},{type:"enum",name:"valve down",ref:{value:"valveDown"}},{type:"int",name:"valve to",ref:{value:"valveRaw",ext:"%d",extMeta:"0-100"}}],status:[{type:"float",name:"valve status",ref:{value:"valveLevel"}}]},OLD_LEVEL:{command:[{type:"enum",
name:"on",ref:{value:"valveOn"}}]}},POWER:{BAT_VOLTAGE:{status:[{type:"float",name:"battery voltage",ref:{value:"powBatVolt"}}]}},HMS_100_Contact:{STATE:{status:[{type:"enum",name:"state",ref:{value:"hmsContactState",options:["close","open"]}}]}},Security_Sensor:{STATE:{status:[{type:"enum",name:"state",ref:{value:"securityState",options:["ok","danger"]}}]}},FHT_Contact:{STATE:{status:[{type:"enum",name:"state",ref:{value:"fhtContactState",options:["close","open"]}}]}},ENOCEAN_WEATHER2:{BRIGHTNESS_WEST:{status:[{type:"int",
name:"brightness west",ref:{value:"eoWeather2BrightW"}}]},BRIGHTNESS_SOUTH:{status:[{type:"int",name:"brightness south",ref:{value:"eoWeather2BrightS"}}]},BRIGHTNESS_EAST:{status:[{type:"int",name:"brightness east",ref:{value:"eoWeather2BrightE"}}]}},ENOCEAN_SENSOR_ERROR:{ERROR:{status:[{type:"string",name:"error",ref:{value:"eoSensorErr"}}]}},ENOCEAN_Bidi_Switch2:{STATE:{status:[{type:"enum",name:"cosumer state",ref:{value:"bidiSwitch2State",options:["off","on"]}}]}}};
...
"0"+f);var h=parseInt(d[3]).toString(16);2!=h.length&&(h="0"+h);return b.toUpperCase()+e.toUpperCase()+f.toUpperCase()+h.toUpperCase()}catch(g){return"?"}case "dimmerColorTemp":return xnm.aio.hm.Util.formatFloatString(a);default:return"?"}}},CLIMATECONTROL_REGULATOR:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;a=null;switch(b.value){case "themoRTempUp":b="SETPOINT";a="if(o!=null){var v=o.Value()+2;if(v>99.5){v=99.5;}o.State(v);}\n";break;case "themoRTempDown":b="SETPOINT";
...
c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "pressShort":a="PRESS_SHORT";b="if(o!=null){o.State(1);}\n";break;case "pressLong":a="PRESS_LONG";b="if(o!=null){o.State(1);}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "pressShort":case "pressLong":return!0;default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "PRESS_SHORT":var b="pressShort";break;
case "PRESS_LONG":b="pressLong"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},SWITCH_TRANSMITTER:{buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "switchTState":break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,"STATE")},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "switchTState":return"true"==a?"on":"off";default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "STATE":var b=
"switchTState"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},SWITCH_VIRTUAL_RECEIVER:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;a=null;switch(b.value){case "on":b="STATE";a="if(o!=null){o.State(1);}\n";break;case "off":b="STATE";a="if(o!=null){o.State(0);}\n";break;case "toggle":b="STATE";a="if(o!=null){if(o.Value()){o.State(0);}else{o.State(1);}}\n";break;case "onFor":if("undefined"==typeof b.ext||null==b.ext)return null;a='var o;o=dom.GetObject("'+
(c["interface"]+"."+c.address+":"+d.address+'.ON_TIME");\n');a+="if(o!=null){o.State("+parseFloat(b.ext)+");}\n";a+='o=dom.GetObject("'+c["interface"]+"."+c.address+":"+d.address+'.STATE");\n';return a+'if(o!=null){o.State(1.0);}\no="";\n';case "setProfile":return"undefined"!=typeof b.ext&&null!=b.ext&&c.device?a:null;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,b,a)},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "switchState":break;
...
"WINDOW_STATE";b="if(o!=null){o.State(1);}\n";break;case "themoWinClose":a="WINDOW_STATE";b="if(o!=null){o.State(0);}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},handleCommandResponse:function(a,c,d,b,e){var f=c.address;if(c.channels&&c.channels.HEATING_CLIMATECONTROL_TRANSCEIVER)var h=c.channels.HEATING_CLIMATECONTROL_TRANSCEIVER.address;if(f&&h)if("themoTempUp"==d.value||"themoTempDown"==d.value){if(c="SET_POINT_TEMPERATURE",b){d=b.indexOf("<v>");var g=b.indexOf("</v>");
-1!=d&&-1!=g&&d+3<g&&(b=b.substr(d+3,g-d-3))&&(b=parseFloat(b).toFixed(1),a._statebuffer[f+":"+h+"."+c]={value:b,timestamp:(new Date).getTime()})}}else"themoTemp"==d.value?(c="SET_POINT_TEMPERATURE",b=parseFloat(d.ext),a._statebuffer[f+":"+h+"."+c]={value:b,timestamp:(new Date).getTime()}):"themoTempOff"==d.value?a._statebuffer[f+":"+h+".SET_POINT_TEMPERATURE"]={value:4.5,timestamp:(new Date).getTime()}:"themoTempOn"==d.value&&(a._statebuffer[f+":"+h+".SET_POINT_TEMPERATURE"]={value:30.5,timestamp:(new Date).getTime()});
e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "themoTemp":var e="SET_POINT_TEMPERATURE"}return c&&d&&e&&a?(b=a[c+":"+d+"."+e],b&&null!=b.value&&"undefined"!=typeof b.value?5E3<=(new Date).getTime()-b.timestamp?(delete a[c+":"+d+"."+e],null):b.value:null):null},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "themoProf":a="ACTIVE_PROFILE";break;case "themoActualTemp":a="ACTUAL_TEMPERATURE";break;case "themoBoostMode":a=
"BOOST_MODE";break;case "themoFrost":a="FROST_PROTECTION";break;case "themoHum":a="HUMIDITY";break;case "themoMode":a="SET_POINT_MODE";break;case "themoTemp":a="SET_POINT_TEMPERATURE";break;case "themoValveLevel":a="LEVEL";break;case "themoWinState":a="WINDOW_STATE";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "themoProf":case "themoHum":return parseInt(a);case "themoActualTemp":case "themoTemp":return parseFloat(a).toFixed(1);
...
"themoBoostMode";break;case "FROST_PROTECTION":b="themoFrost";break;case "HUMIDITY":b="themoHum";break;case "SET_POINT_MODE":b="themoMode";break;case "SET_POINT_TEMPERATURE":b="themoTemp";break;case "LEVEL":b="themoValveLevel";break;case "WINDOW_STATE":b="themoWinState"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},MOTIONDETECTOR_TRANSCEIVER:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "motionOn":a="MOTION_DETECTION_ACTIVE";
b="if(o!=null){o.State(1);}\n";break;case "motionOff":a="MOTION_DETECTION_ACTIVE";b="if(o!=null){o.State(0);}\n";break;case "motionToggle":a="MOTION_DETECTION_ACTIVE";b="if(o!=null){if(o.Value()){o.State(0);}else{o.State(1);}}\n";break;case "motionReset":a="RESET_MOTION";b="if(o!=null){o.State(1);}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "motionIllu":a="ILLUMINATION";
break;case "motionState":a="MOTION";break;case "motionActivate":a="MOTION_DETECTION_ACTIVE";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "motionIllu":return parseFloat(a).toFixed(2);case "motionState":return"true"==a?"on":"off";case "motionActivate":return"true"==a?"on":"off";default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "ILLUMINATION":var b="motionIllu";break;case "MOTION":b=
"motionState";break;case "MOTION_DETECTION_ACTIVE":b="motionActivate"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},ENERGIE_METER_TRANSMITTER:{buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "meterEnergyCounter":a="ENERGY_COUNTER";break;case "meterPower":a="POWER";break;case "meterCurrent":a="CURRENT";break;case "meterVoltage":a="VOLTAGE";break;case "meterFrequency":a="FREQUENCY";break;default:return null}return'o=dom.GetObject("'+
xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,a)+'");if(o!=null){states=states#o.Value();}else{states=states#"?";}'},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "meterEnergyCounter":return xnm.aio.hm.Util.formatFloatString(a);case "meterPower":return xnm.aio.hm.Util.formatFloatString(a);case "meterCurrent":return xnm.aio.hm.Util.formatFloatString(a);case "meterVoltage":return xnm.aio.hm.Util.formatFloatString(a);case "meterFrequency":return xnm.aio.hm.Util.formatFloatString(a);
default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "ENERGY_COUNTER":var b="meterEnergyCounter";break;case "POWER":b="meterPower";break;case "CURRENT":b="meterCurrent";break;case "VOLTAGE":b="meterVoltage";break;case "FREQUENCY":b="meterFrequency"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},SMOKE_DETECTOR:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "intrusionAlarmOff":a="SMOKE_DETECTOR_COMMAND";
...
null==b.ext||"undefined"==typeof b.ext?.1:"number"==typeof b.ext?(parseInt(b.ext)/100).toFixed(2):b.ext.match(/^[-+]?[0-9]+$/)?(parseInt(b.ext)/100).toFixed(2):.1;a._statebuffer&&(e=this.getBufferedState(a._statebuffer,c,d,{value:"dimmerLevel"}));f=null==e||"undefined"==typeof e?"if(o!=null){var v=o.Value()+"+f+";if(v>1){v=1.0;}o.State(v);}\n":"if(o!=null){var v="+e/100+"+"+f+";if(v>1){v=1.0;}o.State(v);}\n";e="LEVEL";break;case "dimDown":f=null==b.ext||"undefined"==typeof b.ext?.1:"number"==typeof b.ext?
(parseInt(b.ext)/100).toFixed(2):b.ext.match(/^[-+]?[0-9]+$/)?(parseInt(b.ext)/100).toFixed(2):.1;a._statebuffer&&(e=this.getBufferedState(a._statebuffer,c,d,{value:"dimmerLevel"}));f=null==e||"undefined"==typeof e?"if(o!=null){var v=o.Value()-"+f+";if(v<0){v=0.0;}o.State(v);}\n":"if(o!=null){var v="+e/100+"-"+f+";if(v<0){v=0.0;}o.State(v);}\n";e="LEVEL";break;case "dimTo":if(null==b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)f=parseInt(b.ext);else if(b.ext.match(/^[-+]?[0-9]+$/))f=
b.ext;else return null;e="LEVEL";f/=100;f=0>f?0:f;f="if(o!=null){o.State("+(1<f?1:f)+");}\n";break;case "toggleTo":if(null==b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)f=parseInt(b.ext);else if("string"==typeof b.ext)f=b.ext.replace("%",""),f=parseInt(f);else return null;e="LEVEL";f/=100;f=0>f?0:f;f="if(o!=null){var v=0.0;real des = 0.0+o.Value(); if(des == 0.0){v="+(1<f?1:f).toFixed(2)+";o.State(v);}else{o.State(v);}}\n";break;case "color":if(null==b.ext||"undefined"==
typeof b.ext)return null;switch(b.ext){case "off":f=0;break;case "blue":f=1;break;case "green":f=2;break;case "torqoise":f=3;break;case "red":f=4;break;case "purple":f=5;break;case "yellow":f=6;break;case "white":f=7}e="COLOR";f="if(o!=null){o.State("+f+");}\n";break;case "colorPlay":case "colorPlayList":var h=[],g=[];if(!b.ext)return null;for(a=0;a<b.ext.length;a++)if(f=b.ext[a])switch(f.value){case "colorList":var k=f.ext;break;case "colorOnTime":var l=f.ext;break;case "colorLevel":var q=parseInt(f.ext);
break;case "colorDur":var p=parseInt(f.ext);break;case "colorDurUnit":var r=f.ext;break;case "colorRepeat":var t=parseInt(f.ext)}if("undefined"==typeof k||null==k||"undefined"==typeof q||null==q||"undefined"==typeof p||null==p||"undefined"==typeof r||null==r||"undefined"==typeof t||null==t||"undefined"==typeof l||null==l)return null;"colorPlay"==b.value?(g.push("100MS 200MS 300MS 400MS 500MS 700MS 1S 2S 3S 5S 7S 10S 20S 40S 50S ALWAYS".split(" ").indexOf(l)),h.push("off blue green torqoise red purple yellow white".split(" ").indexOf(k))):
(b=k.split(","),b.forEach(function(a){h.push("off blue green torqoise red purple yellow white".split(" ").indexOf(a))}),b=l.split(","),b.forEach(function(a){g.push("100MS 200MS 300MS 400MS 500MS 700MS 1S 2S 3S 5S 7S 10S 20S 40S 50S ALWAYS".split(" ").indexOf(a))}));r=["S","M","H","10MS"].indexOf(r);q/=100;if(0==h.length)return null;f="";l=null;l=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"DURATION_UNIT");f+='(datapoints.Get("'+l+'")).State('+r+");\n";l=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"LEVEL");
f+='(datapoints.Get("'+l+'")).State('+q+");\n";l=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"RAMP_TIME_UNIT");f+='(datapoints.Get("'+l+'")).State(0);\n';l=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"RAMP_TIME_VALUE");f+='(datapoints.Get("'+l+'")).State(0);\n';l=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"OUTPUT_SELECT_SIZE");f+='(datapoints.Get("'+l+'")).State('+h.length+");\n";l=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"REPETITIONS");f+='(datapoints.Get("'+l+'")).State('+t+");\n";for(a=1;a<=h.length;a++)l=
xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"COLOR_LIST_"+a),f+='(datapoints.Get("'+l+'")).State('+h[a-1]+");\n",l=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"ON_TIME_LIST_"+a),f+='(datapoints.Get("'+l+'")).State('+g[a-1]+");\n";l=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"DURATION_VALUE");return f+('(datapoints.Get("'+l+'")).State('+p+");\n");default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,e,f)},handleCommandResponse:function(a,c,d,b,e){var f=c.address;if(c.channels&&c.channels.DIMMER)var h=
c.channels.DIMMER.address;if(f&&h)if("dimTo"==d.value||"dimOff"==d.value){c="LEVEL";switch(d.value){case "dimTo":var g=parseFloat(d.ext);break;case "dimOff":g=0}a._statebuffer[f+":"+h+"."+c]={value:g,timestamp:(new Date).getTime()};e&&e()}else"dimUp"==d.value||"dimDown"==d.value?(c="LEVEL",b&&(d=b.indexOf("<v>"),g=b.indexOf("</v>"),-1!=d&&-1!=g&&d+3<g&&(g=b.substr(d+3,g-d-3)))&&(g=Math.round(100*parseFloat(g)),a._statebuffer[f+":"+h+"."+c]={value:g,timestamp:(new Date).getTime()}),e&&e()):"toggleTo"==
d.value?(delete a._statebuffer[f+":"+h+".LEVEL"],setTimeout(function(){e&&e()},3E3)):e&&e();else e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "dimmerLevel":var e="LEVEL"}return c&&d&&e&&a?(b=a[c+":"+d+"."+e],b&&null!=b.value&&"undefined"!=typeof b.value?3E3<=(new Date).getTime()-b.timestamp?(delete a[c+":"+d+"."+e],null):b.value:null):null},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "dimmerLevel":break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,
d,"LEVEL")},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "dimmerLevel":return a=parseFloat(a),Math.round(100*a);default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "LEVEL":var b="dimmerLevel"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},DIMMER_WEEK_PROFILE:{buildCommandScript:function(a,c,d,b){if(!(c.channels&&d&&d.address&&b.value))return null;var e;switch(b.value){case "setProfile":if(!b.ext)return null;
a=e=null;for(var f=0;f<b.ext.length;f++){var h=b.ext[f];if(h)switch(h.value){case "mode":e=h.ext;break;case "channels":a=h.ext}}if("undefined"==typeof e||null==e||"undefined"==typeof a||null==a)return null;b=2;"manu"==e&&(b=0);e='var o;o=dom.GetObject("'+(c["interface"]+"."+c.address+":"+d.address+'.WEEK_PROGRAM_TARGET_CHANNEL_LOCKS");\n');e=e+("if(o!=null){o.State("+a+');}\no=dom.GetObject("')+(c["interface"]+"."+c.address+":"+d.address+'.WEEK_PROGRAM_TARGET_CHANNEL_LOCK");\n');e+="if(o!=null){o.State("+
parseInt(b)+");}\n";return e+'o="";\n';default:return null}},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "profile":break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,"WEEK_PROGRAM_CHANNEL_LOCKS")},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "profile":return parseInt(a);default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "WEEK_PROGRAM_CHANNEL_LOCKS":var b="profile"}if(!b)return null;
a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},ALARM_SWITCH_VIRTUAL_RECEIVER:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "alarmTrigger":if(!b.ext)return null;for(a=0;a<b.ext.length;a++){var e=b.ext[a];if(e)switch(e.value){case "alarmAudio":var f=e.ext;break;case "alarmVisual":var h=e.ext;break;case "alarmDur":var g=e.ext;break;case "alarmDurUnit":var k=e.ext}}if("undefined"==typeof f||null==f||"undefined"==typeof h||null==h||
"undefined"==typeof g||null==g||"undefined"==typeof k||null==k)return null;f="DISABLE_ACOUSTIC_SIGNAL FREQUENCY_RISING FREQUENCY_FALLING FREQUENCY_RISING_AND_FALLING FREQUENCY_ALTERNATING_LOW_HIGH FREQUENCY_ALTERNATING_LOW_MID_HIGH FREQUENCY_HIGHON_OFF FREQUENCY_HIGHON_LONGOFF FREQUENCY_LOWON_OFF_HIGHON_OFF FREQUENCY_LOWON_LONGOFF_HIGHON_LONGOFF LOW_BATTERY DISARMED INTERNALLY_ARMED EXTERNALLY_ARMED DELAYED_INTERNALLY_ARMED DELAYED_EXTERNALLY_ARMED EVENT ERROR".split(" ").indexOf(f);-1==f&&(f=0);
h="DISABLE_OPTICAL_SIGNAL BLINKING_ALTERNATELY_REPEATING BLINKING_BOTH_REPEATING DOUBLE_FLASHING_REPEATING FLASHING_BOTH_REPEATING CONFIRMATION_SIGNAL_0 CONFIRMATION_SIGNAL_1 CONFIRMATION_SIGNAL_2".split(" ").indexOf(h);-1==h&&(h=0);k=["S","M","H","D"].indexOf(k);-1==k&&(k=0);b="var o;";a=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"ACOUSTIC_ALARM_SELECTION");b=b+('o=dom.GetObject("'+a+'");o.State(')+(f+")");a=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"OPTICAL_ALARM_SELECTION");b=b+('o=dom.GetObject("'+
a+'");o.State(')+(h+")");a=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"DURATION_VALUE");b=b+('o=dom.GetObject("'+a+'");o.State(')+(g+")");a=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"DURATION_UNIT");return b=b+('o=dom.GetObject("'+a+'");o.State(')+(k+')o="";\n');default:return null}},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "alarmState":a="STATE";break;case "alarmAudioState":a="ACOUSTIC_ALARM_ACTIVE";break;case "alarmVisualState":a="OPTICAL_ALARM_ACTIVE";
...
(1<b?1:b)+");}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},handleCommandResponse:function(a,c,d,b,e){var f=c.address;if(c.channels&&c.channels.SHUTTER_TRANSMITTER)var h=c.channels.SHUTTER_TRANSMITTER.address;if(f&&h)if("moveTo"==d.value)c="LEVEL",b=parseFloat(d.ext),a._statebuffer[f+":"+h+"."+c]={value:b,timestamp:(new Date).getTime()};else if("stepUp"==d.value||"stepDown"==d.value)if(c="LEVEL",b){d=b.indexOf("<v>");var g=b.indexOf("</v>");-1!=d&&-1!=g&&d+3<
g&&(b=b.substr(d+3,g-d-3))&&(b=Math.round(100*parseFloat(b)),a._statebuffer[f+":"+h+"."+c]={value:b,timestamp:(new Date).getTime()})}e&&e()},getBufferedState:function(a,c,d,b){c=c.address;d=d.address;switch(b.value){case "blindLevel":var e="LEVEL"}return c&&d&&e&&a?(b=a[c+":"+d+"."+e],b&&null!=b.value&&"undefined"!=typeof b.value?3E3<=(new Date).getTime()-b.timestamp?(delete a[c+":"+d+"."+e],null):b.value:null):null},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "blindLevel":break;
...
break;case "analogOutputTo":if(null==b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)b=parseInt(b.ext);else if(b.ext.match(/^[-+]?[0-9]+$/))b=b.ext;else return null;a="LEVEL";b/=100;b=0>b?0:b;b="if(o!=null){o.State("+(1<b?1:b)+");}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},handleCommandResponse:function(a,c,d,b,e){var f=c.address;if(c.channels&&c.channels.DIMMER)var h=c.channels.DIMMER.address;if(f&&h)if("analogOutputTo"==d.value||"analogOutputOff"==
d.value){c="LEVEL";switch(d.value){case "analogOutputTo":var g=parseFloat(d.ext);break;case "analogOutputOff":g=0}a._statebuffer[f+":"+h+"."+c]={value:g,timestamp:(new Date).getTime()}}else if("analogOutputUp"==d.value||"analogOutputDown"==d.value)if(c="LEVEL",b&&(d=b.indexOf("<v>"),g=b.indexOf("</v>"),-1!=d&&-1!=g&&d+3<g&&(g=b.substr(d+3,g-d-3))))g=Math.round(100*parseFloat(g)),a._statebuffer[f+":"+h+"."+c]={value:g,timestamp:(new Date).getTime()};e&&e()},getBufferedState:function(a,c,d,b){c=c.address;
...
a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},ACOUSTIC_SIGNAL_VIRTUAL_RECEIVER:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;a=[];switch(b.value){case "acousticPlay":case "acousticPlayList":if(!b.ext)return null;for(var e=0;e<b.ext.length;e++){var f=b.ext[e];if(f)switch(f.value){case "acousticSound":var h=f.ext;break;case "acousticSoundList":h=f.ext;break;case "acousticLevel":var g=parseInt(f.ext);break;case "acousticDur":var k=parseInt(f.ext);break;
case "acousticDurUnit":var l=f.ext;break;case "acousticRepeat":var q=parseInt(f.ext)}}if("undefined"==typeof h||null==h||"undefined"==typeof g||null==g||"undefined"==typeof k||null==k||"undefined"==typeof l||null==l||"undefined"==typeof q||null==q)return null;"acousticPlay"==b.value?a.push(h):a=h.split(",");l=["S","M","H","10MS"].indexOf(l);g/=100;break;default:return null}if(0==a.length)return null;b="";h=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"DURATION_UNIT");b+='(datapoints.Get("'+h+'")).State('+
...
switch(b.value){case "setLine":if(!b.ext)return null;for(a=0;a<b.ext.length;a++){var e=b.ext[a];if(e)switch(e.value){case "line":var f=e.ext;break;case "text":var h=e.ext;break;case "textAlign":var g=e.ext;break;case "textColor":var k=e.ext;break;case "bgColor":var l=e.ext;break;case "icon":var q=parseInt(e.ext)}}if(!(f&&g&&k&&l)||isNaN(q))return null;g=g.toUpperCase();k=k.toUpperCase();l=l.toUpperCase();b="{DDBC="+l+",DDTC="+k+",DDI="+q+",DDA="+g+",DDS="+h+",DDID="+f+",DDC=true}";f="";c=xnm.aio.hm.MHMCCU._getDataPointAddress(c,
d,"COMBINED_PARAMETER");return f+('dom.GetObject("'+c+'").State("'+b+'");\n');case "setSound":if(!b.ext)return null;for(a=0;a<b.ext.length;a++)if(e=b.ext[a])switch(e.value){case "sound":var p=parseInt(e.ext);break;case "repeat":var r=parseInt(e.ext);break;case "interval":var t=parseInt(e.ext)}if(isNaN(p)||isNaN(r)||isNaN(t))return null;b="{R="+r+",IN="+t+",ANS="+p+"}";f="";c=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"COMBINED_PARAMETER");return f+('dom.GetObject("'+c+'").State("'+b+'");\n');default:return null}}},
...
default:var c=!1,b=[],e=["DIMMER","VIRTUAL_DIMMER"],f;for(f in a.channels){var h=a.channels[f];h&&h.hsstype&&-1!=e.indexOf(h.hsstype)&&(-1==b.indexOf(h.hsstype)?b.push(h.hsstype):c=!0)}return 0<b.length?this._parseDevice(a,b,c):null}},_parseDevice:function(a,d,b){var c=[],f=null,h=null,g;for(g in a.channels){var k=a.channels[g];if(k&&k.address&&k.hsstype){var l=k.address.indexOf(":");if(-1!==l){var q=k.address.substring(l+1),p={id:k.name,address:q,room:k.room,group:k.func,datapoints:[]};0==q&&(f=
k.hsstype,h=p);if(-1!=d.indexOf(k.hsstype))if(l=this._parseGeneralInfo(a),l.channels[k.hsstype]=p,b)l.id+=":"+q,l.address+=":"+q,c.push(l);else{c.push(l);break}}}}if(h&&f)for(a=0;a<c.length;a++)(l=c[a])&&(l.channels[f]=h);return c},_parseHMSecSirWM:function(a){this._parseGeneralInfo(a);var c={};c.sys=xnm.aio.hm.DM.SYS;c.id=a.name;c.type=a.hsstype;c.address=a.address;c.rfAddr=a.rfAddr;c["interface"]=a["interface"];c.channels={};var b=a.channels,e;for(e in b)if(b.hasOwnProperty(e)){var f=a.channels[e];
...
c);else if("btn"==c.value.substr(0,3)){var v=c.value.indexOf("press"),m=c.value.substr(3,v);m=parseInt(m);-1!=this._chKeyTransceivers.indexOf(m)&&(e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.buildCommandScript(a,b,{address:m},{value:c.value.substr(v)}))}e?a._doRequestMarked(e,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};a.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=
...
return a}(),c=function(){var a=function(){this._switchIdx=0;this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=null;this._chSwitchTransmitter=1;this._chSwitchVirtualReceiver1=2;this._chSwitchVirtualReceiver2=3;this._chSwitchVirtualReceiver3=4;this._chSwitchWeekProfile=17};a.prototype._getCommonMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}},{type:"float",
name:"on for",ref:{value:"onFor",ext:"%f",unit:"s"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"switch status",ref:{value:"switchState",options:["off","on"]}}]}};a.prototype.getAddress=function(){var a=this._address.indexOf(":");return-1!=a?this._address.substr(0,a):this._address};a.prototype.getCommandStatusMap=function(){var a=JSON.parse(JSON.stringify(this._getCommonMap()));this._chSwitchWeekProfile&&(a.command.push({type:"enum",
name:"set profile",ref:{value:"setProfile",ext:"%e",extMeta:["auto","manu"]}}),a.status.push({type:"enum",name:"profile",ref:{value:"profile",extMeta:["auto","manu"]}}));"HmIP-PCBS"==this._type.substr(0,9)&&a.status.push({type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}});return a};a.prototype.getIPEvtMap=function(){var a={ipevt:JSON.parse(JSON.stringify(this._getCommonMap())).status};"HmIP-PCBS"==this._type.substr(0,9)&&a.ipevt.push({type:"float",name:"battery voltage",
ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}});return a};a.prototype.useStateBuffer=function(){return"HmIPW-DRS"==this._type.substr(0,9)||"HmIP-DRSI"==this._type.substr(0,9)||"HmIP-PCBS"==this._type.substr(0,9)||"HmIP-MOD-OC"==this._type.substr(0,11)?!0:!1};a.prototype.executeCommand=function(a,b,c,d){if(c){var e=null,v={interface:b.interface,address:this.getAddress(),channels:b.channels};"setProfile"==c.value?this._chSwitchWeekProfile&&(e=xnm.aio.hm.HmIPChannel.SWITCH_WEEK_PROFILE.buildCommandScript(a,
v,{address:this._chSwitchWeekProfile},{value:"setProfile",ext:[{value:"mode",ext:c.ext},{value:"channels",ext:1<<3*this._switchIdx}]})):e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,v,{address:this._chSwitchVirtualReceiver1},c);if(e){var m=this;a._doRequestMarked(e,!0,{execute:function(e,v){e||m._handleCommandResponse(a,b,c,v);d&&d(e)}})}else d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};a.prototype._handleCommandResponse=function(a,b,c,d){if(this.useStateBuffer())switch(b=
this.getAddress()+":"+this._chSwitchTransmitter+".STATE",c.value){case "on":a._statebuffer[b]={value:"on",timestamp:(new Date).getTime(),expire:4E3};break;case "off":a._statebuffer[b]={value:"off",timestamp:(new Date).getTime(),expire:4E3};break;case "toggle":a._statebuffer[b]&&a._statebuffer[b].value&&(a._statebuffer[b]="on"==a._statebuffer[b].value?{value:"off",timestamp:(new Date).getTime(),expire:4E3}:{value:"on",timestamp:(new Date).getTime(),expire:4E3});break;case "onFor":c=1E3*parseFloat(c.ext),
a._statebuffer[b]={value:"on",timestamp:(new Date).getTime(),expire:c}}};a.prototype.getBufferedState=function(a,b,c){if(!this.useStateBuffer()||!c||!c.value||"switchState"!=c.value)return null;b=this.getAddress()+":"+this._chSwitchTransmitter+".STATE";if(!a._statebuffer[b])return null;c=a._statebuffer[b];if("undefined"==typeof c.value||null==c.value||!c.timestamp)return delete a._statebuffer[b],null;var d=c.timestamp,e=c.expire;e||(e=1E3);return(new Date).getTime()>d+e?(delete a._statebuffer[b],
null):c.value};a.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;b={interface:b.interface,address:this.getAddress(),channels:b.channels};switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:this._chMaintenance},c);break;case "errorBatElVoltage":d=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,b,{address:this._chMaintenance},c);break;case "switchState":d=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.buildStateScript(a,
b,{address:this._chSwitchTransmitter},{value:"switchTState"});break;case "profile":d=xnm.aio.hm.HmIPChannel.SWITCH_WEEK_PROFILE.buildStateScript(a,b,{address:this._chSwitchWeekProfile},{value:"profile"})}return d};a.prototype.handleStatusResponse=function(a,b,c){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,b);case "switchState":return a=
xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.handleStatusResponse(a,{value:"switchTState"}),this.useStateBuffer()&&(b=this.getAddress()+":"+this._chSwitchTransmitter+".STATE",c._statebuffer[b]={value:a,timestamp:(new Date).getTime(),expire:1E3}),a;case "profile":return a=xnm.aio.hm.HmIPChannel.SWITCH_WEEK_PROFILE.handleStatusResponse(a,{value:"profile"}),"?"!=a&&(a=a>>3*this._switchIdx&1?"manu":"auto"),a;default:return"?"}};a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=
b.channel.indexOf(":");if(-1==d)return null;var e=b.channel.substr(d+1);d=null;switch(parseInt(e)){case this._chMaintenance:d="HmIP-PCBS"==this._type.substr(0,9)?xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(a,b,c):xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case this._chSwitchTransmitter:if(d=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.resolveState(a,b,c))d.key="switchState";break;case this._chSwitchWeekProfile:if(d=xnm.aio.hm.HmIPChannel.SWITCH_WEEK_PROFILE.resolveState(a,
b,c))a=d.profile,"?"!=a&&(d.profile=a>>3*this._switchIdx&1?"manu":"auto")}return d};a.parseJSON=function(b,c,d){if(!b||!b.type||!b.channels)return null;var e=new a;e._type=b.type;e._address=b.address;var v=e._chSwitchWeekProfile=0,m;for(m in b.channels)"SWITCH_TRANSMITTER"==m.substr(0,18)?e._chSwitchTransmitter=parseInt(b.channels[m].address):"SWITCH_VIRTUAL_RECEIVER"==m.substr(0,23)?(v++,1==v?e._chSwitchVirtualReceiver1=parseInt(b.channels[m].address):2==v?e._chSwitchVirtualReceiver2=parseInt(b.channels[m].address):
3==v&&(e._chSwitchVirtualReceiver3=parseInt(b.channels[m].address))):"SWITCH_WEEK_PROFILE"==m.substr(0,19)&&(e._chSwitchWeekProfile=parseInt(b.channels[m].address));if(c&&d&&e._chSwitchTransmitter){b=[];for(v=0;v<d;v++)b.push(c+4*v);c=b.indexOf(e._chSwitchTransmitter);-1!=c&&(e._switchIdx=c)}return e};return a}(),d=function(){var a=function(){this._dimmerIdx=0;this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=null;this._chDimmerTransmitter=1;this._chDimmerVirtualReceiver1=
2;this._chDimmerVirtualReceiver2=3;this._chDimmerVirtualReceiver3=4;this._chDimmerWeekProfile=13};a.prototype._getCommonMap=function(){var a=function(a,b){a.command.push({type:"enum",name:"ch."+b+" on",ref:{value:"ch"+b+"dimOn"}});a.command.push({type:"enum",name:"ch."+b+" off",ref:{value:"ch"+b+"dimOff"}});a.command.push({type:"int",name:"ch."+b+" dim up",ref:{value:"ch"+b+"dimUp",ext:"%d",extMeta:"1-100",unit:"%"}});a.command.push({type:"int",name:"ch."+b+" dim down",ref:{value:"ch"+b+"dimDown",
ext:"%d",extMeta:"1-100",unit:"%"}});a.command.push({type:"int",name:"ch."+b+" dim to",ref:{value:"ch"+b+"dimTo",ext:"%d",extMeta:"1-100",unit:"%"}});a.command.push({type:"int",name:"ch."+b+" toggle to",ref:{value:"ch"+b+"toggleTo",ext:"%d",extMeta:"1-100",unit:"%"}});a.status.push({type:"int",name:"ch."+b+" status",ref:{value:"ch"+b+"Level",extMeta:"0-100",unit:"%"}})},b={command:[{type:"enum",name:"on",ref:{value:"dimOn"}},{type:"enum",name:"off",ref:{value:"dimOff"}},{type:"int",name:"dim up",
ref:{value:"dimUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"dim down",ref:{value:"dimDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"dim to",ref:{value:"dimTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"toggle to",ref:{value:"toggleTo",ext:"%d",extMeta:"0-100",unit:"%"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"int",name:"dimmer status",ref:{value:"dimmerTLevel",extMeta:"0-100",unit:"%"}}]};a(b,this._chDimmerVirtualReceiver1);
a(b,this._chDimmerVirtualReceiver2);a(b,this._chDimmerVirtualReceiver3);return b};a.prototype.getAddress=function(){var a=this._address.indexOf(":");return-1!=a?this._address.substr(0,a):this._address};a.prototype.getCommandStatusMap=function(){var a=this._getCommonMap();this._chDimmerWeekProfile&&(a.command.push({type:"enum",name:"set profile",ref:{value:"setProfile",ext:"%e",extMeta:["auto","manu"]}}),a.status.push({type:"enum",name:"profile",ref:{value:"profile",extMeta:["auto","manu"]}}));return a};
a.prototype.getIPEvtMap=function(){return{ipevt:this._getCommonMap().status}};a.prototype.useStateBuffer=function(){return"HmIPW-DRD"==this._type.substr(0,9)||"HmIP-DRDI"==this._type.substr(0,9)?!0:!1};a.prototype.executeCommand=function(a,b,c,d){if(c){var e={value:c.value,ext:c.ext},v=this._chDimmerVirtualReceiver1;if("ch"==c.value.substr(0,2)){var m=c.value.indexOf("dim");-1==m&&(m=c.value.indexOf("toggle"));if(-1==m){d&&d(Error("invalid command"));return}v=parseInt(c.value.substr(2,m));e.value=
c.value.substr(m);if(v!=this._chDimmerVirtualReceiver1&&v!=this._chDimmerVirtualReceiver2&&v!=this._chDimmerVirtualReceiver3){d&&d(Error("invalid command"));return}}m=null;var f={interface:b.interface,address:this.getAddress(),channels:b.channels};"setProfile"==c.value?this._chDimmerWeekProfile&&(e={value:"setProfile",ext:[{value:"mode",ext:c.ext},{value:"channels",ext:1<<3*this._dimmerIdx}]},m=xnm.aio.hm.HmIPChannel.DIMMER_WEEK_PROFILE.buildCommandScript(a,f,{address:this._chDimmerWeekProfile},e)):
m=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(a,f,{address:v},e);if(m){var O=this;a._doRequestMarked(m,!0,{execute:function(e,v){e||O._handleCommandResponse(a,b,c,v);d&&d(e)}})}else d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};a.prototype._handleCommandResponse=function(a,b,c,d){if(this.useStateBuffer()){b=null;var e=d.indexOf("<v>");if(-1!=e){var v=d.indexOf("</v>");-1!=v&&(d=d.substring(e+3,v),b=Math.round(100*parseFloat(d)))}d=this.getAddress()+":"+
this._chDimmerTransmitter+".LEVEL";switch(c.value){case "dimOn":delete a._statebuffer[d];break;case "dimOff":a._statebuffer[d]={value:0,timestamp:(new Date).getTime(),expire:3E3};break;case "dimUp":null!=b&&(a._statebuffer[d]={value:b,timestamp:(new Date).getTime(),expire:3E3});break;case "dimDown":null!=b&&(a._statebuffer[d]={value:b,timestamp:(new Date).getTime(),expire:3E3});break;case "dimTo":b=parseInt(c.ext);null!=b&&(a._statebuffer[d]={value:b,timestamp:(new Date).getTime(),expire:3E3});break;
case "toggleTo":null!=b&&(a._statebuffer[d]={value:b,timestamp:(new Date).getTime(),expire:3E3})}}};a.prototype.getBufferedState=function(a,b,c){if(!this.useStateBuffer()||!c||!c.value||"dimmerTLevel"!=c.value)return null;b=this.getAddress()+":"+this._chDimmerTransmitter+".LEVEL";if(!a._statebuffer[b])return null;c=a._statebuffer[b];if("undefined"==typeof c.value||null==c.value||!c.timestamp)return delete a._statebuffer[b],null;var d=c.timestamp,e=c.expire;e||(e=1E3);return(new Date).getTime()>d+
e?(delete a._statebuffer[b],null):c.value};a.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null,e={interface:b.interface,address:this.getAddress(),channels:b.channels};switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,e,{address:this._chMaintenance},c);break;case "dimmerTLevel":d=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.buildStateScript(a,e,{address:this._chDimmerTransmitter},{value:"dimmerTLevel"});break;case "ch"+this._chDimmerVirtualReceiver1+
"Level":d=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:this._chDimmerVirtualReceiver1},{value:"dimmerLevel"});break;case "ch"+this._chDimmerVirtualReceiver2+"Level":d=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:this._chDimmerVirtualReceiver2},{value:"dimmerLevel"});break;case "ch"+this._chDimmerVirtualReceiver3+"Level":d=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:this._chDimmerVirtualReceiver3},{value:"dimmerLevel"});
break;case "profile":d=xnm.aio.hm.HmIPChannel.DIMMER_WEEK_PROFILE.buildStateScript(a,e,{address:this._chDimmerWeekProfile},{value:"profile"})}return d};a.prototype.handleStatusResponse=function(a,b,c){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "dimmerTLevel":return a=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(a,{value:"dimmerTLevel"}),this.useStateBuffer()&&(b=this.getAddress()+":"+this._chDimmerTransmitter+
".LEVEL",c._statebuffer[b]={value:a,timestamp:(new Date).getTime(),expire:1E3}),a;case "ch"+this._chDimmerVirtualReceiver1+"Level":case "ch"+this._chDimmerVirtualReceiver2+"Level":case "ch"+this._chDimmerVirtualReceiver3+"Level":return xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.handleStatusResponse(a,{value:"dimmerLevel"});case "profile":return a=xnm.aio.hm.HmIPChannel.DIMMER_WEEK_PROFILE.handleStatusResponse(a,{value:"profile"}),"?"!=a&&(a=a>>3*this._dimmerIdx&1?"manu":"auto"),a;default:return"?"}};
a.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=b.channel.substr(d+1);d=null;switch(parseInt(e)){case this._chMaintenance:d=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case this._chDimmerTransmitter:d=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.resolveState(a,b,c);break;case this._chDimmerVirtualReceiver1:case this._chDimmerVirtualReceiver2:case this._chDimmerVirtualReceiver3:if(d=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.resolveState(a,
b,c))d.key="ch"+e+"Level";break;case this._chDimmerWeekProfile:if(d=xnm.aio.hm.HmIPChannel.DIMMER_WEEK_PROFILE.resolveState(a,b,c))a=d.profile,"?"!=a&&(d.profile=a>>3*this._dimmerIdx&1?"manu":"auto")}return d};a.parseJSON=function(b,c,d){if(!b||!b.type||!b.channels)return null;var e=new a;e._type=b.type;e._address=b.address;var v=e._chDimmerWeekProfile=0,m;for(m in b.channels)"DIMMER_TRANSMITTER"==m.substr(0,18)?e._chDimmerTransmitter=parseInt(b.channels[m].address):"DIMMER_VIRTUAL_RECEIVER"==m.substr(0,
23)?(v++,1==v?e._chDimmerVirtualReceiver1=parseInt(b.channels[m].address):2==v?e._chDimmerVirtualReceiver2=parseInt(b.channels[m].address):3==v&&(e._chDimmerVirtualReceiver3=parseInt(b.channels[m].address))):"DIMMER_WEEK_PROFILE"==m.substr(0,19)&&(e._chDimmerWeekProfile=parseInt(b.channels[m].address));if(c&&d&&e._chSwitchTransmitter){b=[];for(v=0;v<d;v++)b.push(c+4*v);c=b.indexOf(e._chDimmerTransmitter);-1!=c&&(e._dimmerIdx=c)}return e};return a}(),b=function(){var a=function(){this._blindIdx=0;
this._address=this._type=null;this._chMaintenance=0;this._chBlindTransmitter=1;this._chBlindVirtualReceiver1=2;this._chBlindVirtualReceiver2=3;this._chBlindVirtualReceiver3=4;this._chBlindWeekProfile=17};a.prototype._getCommonMap=function(){return{command:[{type:"enum",name:"stop",ref:{value:"stop"}},{type:"enum",name:"move up",ref:{value:"moveUp"}},{type:"enum",name:"move down",ref:{value:"moveDown"}},{type:"int",name:"step up",ref:{value:"stepUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",
name:"step down",ref:{value:"stepDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"move to",ref:{value:"moveTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"enum",name:"lamella up",ref:{value:"lamellaUp"}},{type:"enum",name:"lamella down",ref:{value:"lamellaDown"}},{type:"int",name:"lamella step up",ref:{value:"lamellaStepUp",ext:"%d",extMeta:"1-10",unit:"%"}},{type:"int",name:"lamella step down",ref:{value:"lamellaStepDown",ext:"%d",extMeta:"1-10",unit:"%"}},{type:"int",name:"lamella to",
ref:{value:"lamellaTo",ext:"%d",extMeta:"0-100",unit:"%"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"int",name:"blind status",ref:{value:"blindTPos",extMeta:"0-100",unit:"%"}},{type:"int",name:"lamella status",ref:{value:"lamellaTPos",extMeta:"0-100",unit:"%"}}]}};a.prototype.getAddress=function(){var a=this._address.indexOf(":");return-1!=a?this._address.substr(0,a):this._address};a.prototype.getCommandStatusMap=function(){var a=JSON.parse(JSON.stringify(this._getCommonMap()));
...
xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case this._chBlindTransmitter:d=xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.resolveState(a,b,c);break;case this._chBlindWeekProfile:if(d=xnm.aio.hm.HmIPChannel.BLIND_WEEK_PROFILE.resolveState(a,b,c))a=d.profile,"?"!=a&&(d.profile=a>>3*this._blindIdx&1?"manu":"auto")}return d};a.parseJSON=function(b,c,d){if(!b||!b.type||!b.channels)return null;var e=new a;e._type=b.type;e._address=b.address;var v=e._chBlindWeekProfile=0,m;for(m in b.channels)"BLIND_TRANSMITTER"==
m.substr(0,17)?e._chBlindTransmitter=parseInt(b.channels[m].address):"BLIND_VIRTUAL_RECEIVER"==m.substr(0,22)?(v++,1==v?e._chBlindVirtualReceiver1=parseInt(b.channels[m].address):2==v?e._chBlindVirtualReceiver2=parseInt(b.channels[m].address):3==v&&(e._chBlindVirtualReceiver3=parseInt(b.channels[m].address))):"BLIND_WEEK_PROFILE"==m.substr(0,18)&&(e._chBlindWeekProfile=parseInt(b.channels[m].address));if(c&&d&&e._chBlindTransmitter){b=[];for(v=0;v<d;v++)b.push(c+4*v);c=b.indexOf(e._chBlindTransmitter);
-1!=c&&(e._blindIdx=c)}return e};return a}(),e=function(){var a=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=null;this._chInputTransmitter=1};a.prototype.getCommandStatusMap=function(){var a="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?{status:[{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",
...
b,c);break;case this._chPresenceDetectorTransceiver:e=xnm.aio.hm.HmIPChannel.PRESENCEDETECTOR_TRANSCEIVER.resolveState(a,b,c)}return e};a.parseJSON=function(b){if(!b||!b.type||!b.channels)return null;var c=new a;c._type=b.type;c._address=b.address;"HmIP-SPI"==b.type&&(c._chMaintenanceHsstype="MAINTENANCE_BAT_EL");return c};return a}(),l=function(){var a=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=null;this._chHeatingClimateControlFloorTransceiver=1};a.prototype.getCommandStatusMap=
...
extMeta:"0.0-409.5",scale:"0.1",unit:"V"}},{type:"float",name:"energy counter",ref:{value:"meterEnergyCounter",extMeta:"0.0-838859.1",scale:"0.1",unit:"Wh"}},{type:"float",name:"frequency",ref:{value:"meterFrequency",extMeta:"29.52-70.47",scale:"0.01",unit:"Hz"}},{type:"float",name:"power",ref:{value:"meterPower",extMeta:"0.0-163830.0",scale:"0.1",unit:"W"}},{type:"float",name:"current",ref:{value:"meterCurrent",extMeta:"0.0-65535.0",scale:"0.1",unit:"mA"}}]}};p.prototype.getIPEvtMap=function(){var a=
this.getCommandStatusMap().status;return{ipevt:JSON.parse(JSON.stringify(a))}};p.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;switch(c.value){case "on":case "ch4on":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:4},{value:"on"});break;case "off":case "ch4off":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:4},{value:"off"});break;case "toggle":case "ch4toggle":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,
...
r.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "dimmerTLevel":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(a,{value:"dimmerTLevel"});case "ch4Level":case "ch5Level":case "ch6Level":return xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.handleStatusResponse(a,{value:"dimmerLevel"});default:return"?"}};r.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;
var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "3":e=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.resolveState(a,b,c);break;case "4":case "5":case "6":e=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.resolveState(a,b,c),e.key="4"==d?"ch4Level":"5"==d?"ch5Level":"ch6Level"}return e};var t=function(){};t.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",
name:"battery low",ref:{value:"errorBat",options:["false","true"]}}]}};t.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false","true"]}},{type:"enum",name:"button 1 short press",ref:{value:"btn1pressShort",options:["true"]}},{type:"enum",name:"button 1 long press",ref:{value:"btn1pressLong",options:["true"]}},{type:"enum",name:"button 2 short press",
ref:{value:"btn2pressShort",options:["true"]}},{type:"enum",name:"button 2 long press",ref:{value:"btn2pressLong",options:["true"]}}]}};t.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c)}return d};t.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,
b);default:return"?"}};t.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":case "2":e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c),"pressShort"==e.key?e.key="1"==d?"btn1pressShort":"btn2pressShort":"pressLong"==e.key&&(e.key="1"==d?"btn1pressLong":"btn2pressLong")}return e};var u=function(){};
u.prototype.getCommandStatusMap=function(){return{command:[{type:"multi",name:"trigger alarm",ref:{value:"alarmTrigger",ext:"%multi",extMeta:[{type:"enum",name:"set audio",ref:{value:"alarmAudio",ext:"%e",extMeta:"DISABLE_ACOUSTIC_SIGNAL FREQUENCY_RISING FREQUENCY_FALLING FREQUENCY_RISING_AND_FALLING FREQUENCY_ALTERNATING_LOW_HIGH FREQUENCY_ALTERNATING_LOW_MID_HIGH FREQUENCY_HIGHON_OFF FREQUENCY_HIGHON_LONGOFF FREQUENCY_LOWON_OFF_HIGHON_OFF FREQUENCY_LOWON_LONGOFF_HIGHON_LONGOFF LOW_BATTERY DISARMED INTERNALLY_ARMED EXTERNALLY_ARMED DELAYED_INTERNALLY_ARMED DELAYED_EXTERNALLY_ARMED EVENT ERROR".split(" ")}},
...
ref:{value:"alarmVisualState",options:["on","off"]}}]}};u.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"sabotage",ref:{value:"errorSabo",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatVoltage",ext:"%f",extMeta:"0-25.2"}},{type:"enum",name:"alarm state",ref:{value:"alarmState",
options:["on","off"]}},{type:"enum",name:"alarm audio state",ref:{value:"alarmAudioState",options:["on","off"]}},{type:"enum",name:"alarm visual state",ref:{value:"alarmVisualState",options:["on","off"]}}]}};u.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;switch(c.value){case "alarmTrigger":e=xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:3},c)}e?a._doRequestMarked(e,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command"))}else d&&
d(Error("command is null"))};u.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":case "errorSabo":case "errorBatVoltage":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "alarmState":case "alarmAudioState":case "alarmVisualState":d=xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.buildStateScript(a,b,{address:3},c)}return d};u.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;
switch(b.value){case "errorComm":case "errorBat":case "errorSabo":case "errorBatVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "alarmState":case "alarmAudioState":case "alarmVisualState":return xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.handleStatusResponse(a,b);default:return"?"}};u.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=
...
b);default:return"?"}};y.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.SMOKE_DETECTOR.resolveState(a,b,c)}return e};var w=function(){};w.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},
{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"sabotage",ref:{value:"errorSabo",options:["false","true"]}},{type:"enum",name:"window state",ref:{value:"handleState",options:["closed","tilted","open"]}}]}};w.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false","true"]}},{type:"enum",name:"sabotage",
ref:{value:"errorSabo",options:["false","true"]}},{type:"enum",name:"window state",ref:{value:"handleState",options:["closed","tilted","open"]}}]}};w.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":case "errorSabo":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "handleState":d=xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.buildStateScript(a,b,{address:1},c)}return d};w.prototype.handleStatusResponse=
function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":case "errorSabo":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "handleState":return xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.handleStatusResponse(a,b);default:return"?"}};w.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,
b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.resolveState(a,b,c)}return e};var n=function(){};n.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}},{type:"enum",name:"ch.2 on",ref:{value:"ch2on"}},{type:"enum",name:"ch.2 off",ref:{value:"ch2off"}},{type:"enum",name:"ch.2 toggle",ref:{value:"ch2toggle"}},{type:"enum",name:"ch.3 on",ref:{value:"ch3on"}},
...
ref:{value:"meterPower",extMeta:"0.0-163830.0",scale:"0.1",unit:"W"}},{type:"float",name:"current",ref:{value:"meterCurrent",extMeta:"0.0-65535.0",scale:"0.1",unit:"mA"}}]}};n.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;return{ipevt:JSON.parse(JSON.stringify(a))}};n.prototype.executeCommand=function(a,b,c,d){if(c){var e=null,f=null;switch(c.value){case "on":case "ch2on":case "ch3on":case "ch4on":switch(c.value){case "on":case "ch2on":f=2;break;case "ch3on":f=3;break;case "ch4on":f=
4}e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:f},{value:"on"});break;case "off":case "ch2off":case "ch3off":case "ch4off":switch(c.value){case "off":case "ch2off":f=2;break;case "ch3off":f=3;break;case "ch4off":f=4}e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:f},{value:"off"});break;case "toggle":case "ch2toggle":case "ch3toggle":case "ch4toggle":switch(c.value){case "toggle":case "ch2toggle":f=2;break;case "ch3toggle":f=3;break;
case "ch4toggle":f=4}e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:f},{value:"toggle"})}e?a._doRequestMarked(e,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};n.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "switchState":d=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.buildStateScript(a,
...
xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.buildStateScript(a,b,{address:5},c)}return d};n.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "meterVoltage":case "meterEnergyCounter":case "meterFrequency":case "meterPower":case "meterCurrent":return xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.handleStatusResponse(a,b);case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "switchState":return xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.handleStatusResponse(a,
{value:"switchTState"});case "ch2State":case "ch3State":case "ch4State":return xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.handleStatusResponse(a,{value:"switchState"});default:return"?"}};n.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "1":e=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.resolveState(a,b,c);break;case "2":case "3":case "4":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.resolveState(a,
b,c);e.key="2"==d?"ch2State":"3"==d?"ch3State":"ch4State";break;case "5":e=xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.resolveState(a,b,c)}return e};var C=function(){};C.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"dimOn"}},{type:"enum",name:"off",ref:{value:"dimOff"}},{type:"int",name:"dim up",ref:{value:"dimUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"dim down",ref:{value:"dimDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"dim to",
...
unit:"%"}},{type:"int",name:"ch.6 lamella status",ref:{value:"ch6lamellaPos",extMeta:"0-100",unit:"%"}}]}};A.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;a=JSON.parse(JSON.stringify(a));a=a.concat([{type:"enum",name:"button 1 short press",ref:{value:"btn1pressShort",options:["true"]}},{type:"enum",name:"button 1 long press",ref:{value:"btn1pressLong",options:["true"]}},{type:"enum",name:"button 2 short press",ref:{value:"btn2pressShort",options:["true"]}},{type:"enum",
name:"button 2 long press",ref:{value:"btn2pressLong",options:["true"]}}]);return{ipevt:a}};A.prototype.executeCommand=function(a,b,c,d){if(c){var e=4,f=null;-1!=c.value.indexOf("ch5")?e=5:-1!=c.value.indexOf("ch6")&&(e=6);-1!=c.value.indexOf("stop")?f="stop":-1!=c.value.indexOf("moveUp")?f="moveUp":-1!=c.value.indexOf("moveDown")?f="moveDown":-1!=c.value.indexOf("stepUp")?f="stepUp":-1!=c.value.indexOf("stepDown")?f="stepDown":-1!=c.value.indexOf("moveTo")?f="moveTo":-1!=c.value.indexOf("lamellaUp")?
f="lamellaUp":-1!=c.value.indexOf("lamellaDown")?f="lamellaDown":-1!=c.value.indexOf("lamellaStepUp")?f="lamellaStepUp":-1!=c.value.indexOf("lamellaStepDown")?f="lamellaStepDown":-1!=c.value.indexOf("lamellaTo")&&(f="lamellaTo");f?(b=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:e,stateAddress:3},{value:f,ext:c.ext}))?a._doRequestMarked(b,!0,{execute:function(a,b){setTimeout(function(){d&&d(a)},200)}}):d&&d(Error("invalid command")):d&&d(Error("unknown command"))}else d&&
...
"ch4lamellaPos":"5"==d?"ch5lamellaPos":"ch6lamellaPos")}return e};var F=function(){};F.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}}]}};F.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",
...
ref:{value:"btn6pressLong",options:["true"]}}]}};F.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c)}return d};F.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);default:return"?"}};F.prototype.resolveState=function(a,b,c){if(!b||
!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":case "2":case "3":case "4":case "5":case "6":e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c),"pressShort"==e.key?e.key="btn"+d+"pressShort":"pressLong"==e.key&&(e.key="btn"+d+"pressLong")}return e};var G=function(){};G.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",
...
{value:"passageCOF"});default:return"?"}};G.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "2":case "3":e=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.resolveState(a,b,c),"passageCurrentDirection"==e.key?e.key="passageCurrentDirection":"passageLastDirection"==e.key?e.key="passageLastDirection":
"passageC"==e.key?e.key="2"==d?"passageR2LC":"passageL2RC":"passageCOF"==e.key&&(e.key="2"==d?"passageR2LCOF":"passageL2RCOF")}return e};var H=function(){};H.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"waterAlarmState",options:["on","off"]}},{type:"enum",name:"moisture detected",
ref:{value:"waterMoistureDetected",options:["true","false"]}},{type:"enum",name:"water detected",ref:{value:"waterWaterDetected",options:["true","false"]}}]}};H.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"waterAlarmState",options:["on","off"]}},{type:"enum",name:"moisture detected",
ref:{value:"waterMoistureDetected",options:["true","false"]}},{type:"enum",name:"water detected",ref:{value:"waterWaterDetected",options:["true","false"]}}]}};H.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":case "errorBat":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "waterAlarmState":d=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.buildStateScript(a,b,{address:1},{value:"waterAlarmState"});break;
case "waterMoistureDetected":d=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.buildStateScript(a,b,{address:1},{value:"waterMoistureDetected"});break;case "waterWaterDetected":d=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.buildStateScript(a,b,{address:1},{value:"waterWaterDetected"})}return d};H.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "waterAlarmState":case "waterMoistureDetected":case "waterWaterDetected":return xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.handleStatusResponse(a,
b);default:return"?"}};H.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.resolveState(a,b,c)}return e};var I=function(){};I.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false",
...
options:["false","true"]}}]}};I.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false","true"]}},{type:"int",name:"error code",ref:{value:"errorBatElCode",ext:"%d",extMeta:"0-255"}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0-25.2"}},{type:"enum",name:"sensor error",ref:{value:"errorBatElSensor",
options:["false","true"]}},{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"motion",ref:{value:"acceMotion",options:["false","true"]}}]}};I.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorBatElDutyCycle":case "errorBatElCode":case "errorBatElBat":case "errorBatElVoltage":case "errorBatElSensor":case "errorBatElComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,b,{address:0},
c);break;case "acceMotion":d=xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.buildStateScript(a,b,{address:1},c)}return d};I.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorBatElDutyCycle":case "errorBatElCode":case "errorBatElBat":case "errorBatElVoltage":case "errorBatElSensor":case "errorBatElComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,b);case "acceMotion":return xnm.aio.hm.HmIPChannel.ACCELERATION_TRANSCEIVER.handleStatusResponse(a,
b);default:return"?"}};I.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.ACCELERATION_TRANSCEIVER.resolveState(a,b,c)}return e};var D=function(){};D.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"float",name:"on for",ref:{value:"onFor",
ext:"%f",unit:"s"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]}};D.prototype.getIPEvtMap=function(){var a=this.getCommandStatusMap().status;a=JSON.parse(JSON.stringify(a));a.push({type:"enum",name:"button short press",ref:{value:"btnPressShort",options:["true"]}});
a.push({type:"enum",name:"button long press",ref:{value:"btnPressLong",options:["true"]}});return{ipevt:a}};D.prototype.executeCommand=function(a,b,c,d){if(c){var e=null;switch(c.value){case "on":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:3},{value:"onFor",ext:.5});break;case "onFor":e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(a,b,{address:3},c);break;default:d&&d(Error("unknown command"));return}e?a._doRequestMarked(e,!0,{execute:function(a,
b){d&&d(a)}}):d&&d(Error("invalid command"))}else d&&d(Error("command is null"))};D.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":d=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(a,b,{address:0},c)}return d};D.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(a,
b);default:return"?"}};D.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c),"pressShort"==e.key?e.key="btnPressShort":"pressLong"==e.key&&(e.key="btnPressLong")}return e};var E=function(){};E.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",
...
E.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null,e;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "switchState":d=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.buildStateScript(a,b,{address:3},{value:"switchTState"});break;case "led1Level":case "led1Color":case "led2Level":case "led2Color":d="led1"==c.value.substr(0,4)?{address:11}:{address:7},"Level"==c.value.substr(4)?e={value:"dimmerTLevel"}:"Color"==c.value.substr(4)&&
(e={value:"dimmerTColor"}),d=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.buildStateScript(a,b,d,e)}return d};E.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "switchState":return xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.handleStatusResponse(a,{value:"switchTState"});case "led1Level":case "led2Level":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(a,{value:"dimmerTLevel"});
case "led1Color":case "led2Color":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(a,{value:"dimmerTColor"});default:return"?"}};E.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;d=b.channel.substr(d+1);var e=null;switch(d){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":case "2":e=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(a,b,c);"pressShort"==e.key?e.key="btn"+d+
"pressShort":"pressLong"==e.key&&(e.key="btn"+d+"pressLong");break;case "3":e=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.resolveState(a,b,c);break;case "7":case "11":e=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.resolveState(a,b,c),"7"==d?"dimmerTLevel"==e.key?e.key="led2Level":"dimmerTColor"==e.key&&(e.key="led2Color"):"11"==d&&("dimmerTLevel"==e.key?e.key="led1Level":"dimmerTColor"==e.key&&(e.key="led1Color"))}return e};var B=function(){};B.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",
...
options:["open","closed","ventilation","unknown"]}},{type:"enum",name:"light status",ref:{value:"lightState",options:["off","on"]}}]}};B.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"door status",ref:{value:"doorState",options:["open","closed","ventilation","unknown"]}},{type:"enum",name:"light status",ref:{value:"lightState",options:["off","on"]}}]}};B.prototype.executeCommand=function(a,
...
d(Error("command is null"))};B.prototype.buildStateScript=function(a,b,c){if(!c)return null;var d=null;switch(c.value){case "errorComm":d=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(a,b,{address:0},c);break;case "doorState":d=xnm.aio.hm.HmIPChannel.DOOR_RECEIVER.buildStateScript(a,b,{address:1},c);break;case "lightState":d=xnm.aio.hm.HmIPChannel.SIMPLE_SWITCH_RECEIVER.buildStateScript(a,b,{address:2},{value:"state"})}return d};B.prototype.handleStatusResponse=function(a,b){if("?"==a)return a;
switch(b.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(a,b);case "doorState":return xnm.aio.hm.HmIPChannel.DOOR_RECEIVER.handleStatusResponse(a,b);case "lightState":return xnm.aio.hm.HmIPChannel.SIMPLE_SWITCH_RECEIVER.handleStatusResponse(a,{value:"state"});default:return"?"}};B.prototype.resolveState=function(a,b,c){if(!b||!b.channel)return null;var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,
b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.DOOR_RECEIVER.resolveState(a,b,c);break;case "2":e=xnm.aio.hm.HmIPChannel.SIMPLE_SWITCH_RECEIVER.resolveState(a,b,c)}return e};var L=function(){var a=function(){};a.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",
...
var d=b.channel.indexOf(":");if(-1==d)return null;var e=null;switch(b.channel.substr(d+1)){case "0":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(a,b,c);break;case "1":e=xnm.aio.hm.HmIPChannel.POWER_MAINS_TRANSMITTER.resolveState(a,b,c)}return e};return a}(),N=function(){var a=function(){};a.prototype.getCommandStatusMap=function(){return{command:[{type:"multi",name:"play sound",ref:{value:"acousticPlay",ext:"%multi",extMeta:[{type:"int",name:"set sound",ref:{value:"acousticSound",ext:"%d",extMeta:"0-255"}},
...
b,c)}return e};return a}(),K=function(){var a=function(){};a.prototype.getCommandStatusMap=function(){return{command:[{type:"multi",name:"set line",ref:{value:"setLine",ext:"%multi",extMeta:[{type:"enum",name:"line",ref:{value:"line",ext:"%e",extMeta:["1","2","3","4","5"]}},{type:"string",name:"text",ref:{value:"text",ext:"%s"}},{type:"enum",name:"text alignment",ref:{value:"textAlign",ext:"%e",extMeta:["center","left","right"]}},{type:"enum",name:"text color",ref:{value:"textColor",ext:"%e",extMeta:["black",
...
b,c),"pressShort"==e.key?e.key="roACWFast":"pressLong"==e.key&&(e.key="roACWSlow")}return e};return a}();return{"HmIP-BSM":new p,"HmIP-BDT":new r,"HMIP-WRC2":new t,"HmIP-ASIR":new u,"HmIP-ASIR-2":new u,"HmIP-ASIR-O":new u,"HmIP-ASIR-B1":new u,"HmIP-SWSD":new y,"HmIP-SRH":new w,"HmIP-FSM":new n,"HmIP-PDT":new C,"HmIP-BROLL":new z,"HmIP-FROLL":new z,"HmIP-BBL":new A,"HmIP-FBL":new A,"HmIP-WRC6":new F,"HmIP-SPDR":new G,"HmIP-SWD":new H,"HmIP-SAM":new I,"HmIP-WGC":new D,"HmIP-BSL":new E,"HmIP-MOD-TM":new B,
"HmIP-SLO":new L,"HmIP-PMFS":new M,"HmIP-MP3P":new N,"HmIP-MOD-HO":new B,"HmIP-WRCD":new K,"HmIP-WRCR":new P,resolveJSON:function(m){if(!m||!m.type)return null;if("HmIP-PDT"==m.type)return d.parseJSON(m);if(this[m.type])return this[m.type];var n=null;switch(m.type){case "HmIP-WHS2":n=c.parseJSON(m,1,2);break;case "HmIP-DBB":case "HmIP-BRC2":n=a.parseJSON(m);break;case "HmIP-RCV-50":n=a.parseJSON(m)}if("HmIPW-DRS"==m.type.substr(0,9))n=c.parseJSON(m,1,parseInt(m.type.substr(9)));else if("HmIPW-DRD"==
m.type.substr(0,9))n=d.parseJSON(m);else if("HmIPW-DRBL"==m.type.substr(0,10))n=b.parseJSON(m,1,parseInt(m.type.substr(10)));else if("HmIPW-DRI"==m.type.substr(0,9))n=e.parseJSON(m);else if("HmIPW-FIO"==m.type.substr(0,9)){var p=parseInt(m.type.substr(9));if(m.channels)for(var x in m.channels)if("MULTI_MODE_INPUT_TRANSMITTER"==x.substr(0,28)){n=e.parseJSON(m);break}else if("SWITCH_TRANSMITTER"==x.substr(0,18)){n=c.parseJSON(m,p+1,p);break}}else if("HmIPW-STH"==m.type.substr(0,9)||"HmIPW-STHD"==m.type.substr(0,
10)||"HmIPW-WTH"==m.type.substr(0,9))n=h.parseJSON(m);else if("HmIPW-SMI55"==m.type)n=g.parseJSON(m);else if("HmIPW-SPI"==m.type)n=k.parseJSON(m);else if("HmIP-WTH-B"==m.type)n=h.parseJSON(m);else if("HmIP-FCI"==m.type.substr(0,8))n=e.parseJSON(m);else if("HmIP-MOD-RC"==m.type.substr(0,11))n=e.parseJSON(m);else if("HmIP-MOD-OC"==m.type.substr(0,11)){p=parseInt(m.type.substr(11));x=0;var r=m.address.indexOf(":");-1!=r&&(x=parseInt(m.address.substr(r+1)));0<x&&x<=p?n=a.parseJSON(m):0!=x&&(n=c.parseJSON(m,
p+1,p))}else if("HmIP-FDT"==m.type.substr(0,8))n=d.parseJSON(m);else if("HmIP-FALMOT"==m.type.substr(0,11))n=l.parseJSON(m);else if("HmIP-PCBS"==m.type.substr(0,9))p=parseInt(m.type.substr(9)),isNaN(p)||(x=0,r=m.address.indexOf(":"),-1!=r&&(x=parseInt(m.address.substr(r+1))),0<x&&x<=p?n=a.parseJSON(m):0!=x&&(n=c.parseJSON(m,p+1,p)));else if("HmIP-DRSI"==m.type.substr(0,9))p=parseInt(m.type.substr(9)),x=0,r=m.address.indexOf(":"),-1!=r&&(x=parseInt(m.address.substr(r+1))),0<x&&x<=p?n=e.parseJSON(m):
0!=x&&(n=c.parseJSON(m,p+1,p));else if("HmIP-DRDI"==m.type.substr(0,9))p=parseInt(m.type.substr(9)),x=0,r=m.address.indexOf(":"),-1!=r&&(x=parseInt(m.address.substr(r+1))),0<x&&x<=p?n=e.parseJSON(m):0!=x&&(n=d.parseJSON(m,p+1,p));else if("HmIP-DRBLI"==m.type.substr(0,10))p=parseInt(m.type.substr(10)),x=0,r=m.address.indexOf(":"),-1!=r&&(x=parseInt(m.address.substr(r+1))),0<x&&x<=2*p?n=e.parseJSON(m):0!=x&&(n=b.parseJSON(m,2*p+1,p));else if("HmIP-SCI"==m.type.substr(0,8))n=f.parseJSON(m);else if("HmIP-MIO16-PCB"==
m.type)x=0,r=m.address.indexOf(":"),-1!=r&&(x=parseInt(m.address.substr(r+1))),n=0<x&&13>x?q.parseJSON(m):13<=x&&17>x?e.parseJSON(m):c.parseJSON(m,17,8);else if(this[m.type])return this[m.type];return n},parseDevice:function(a){return a.channels&&a.hsstype&&a["interface"]?0==a.hsstype.indexOf("HmIPW")?this._parseHMIPWDevice(a):this._parseHmIPRFDevice(a):null},_parseHMIPWDevice:function(a){var b=function(a){var b=[];var c={sys:"hm"};c.id=a.name;c.type=a.hsstype;c.address=a.address;c.interface=a.interface;
c.channels={};var d=0,e=JSON.parse(JSON.stringify(c)),f=null,g=a.channels,h=!1,m;for(m in g)if(g.hasOwnProperty(m)){var k=a.channels[m];if(k.hsstype)if("ALARM_COND_SWITCH_TRANSMITTER"==k.hsstype)b.push(e);else if("MULTI_MODE_INPUT_TRANSMITTER"==k.hsstype&&(0!=d&&(b.push(e),e=JSON.parse(JSON.stringify(c)),h=!1,f&&(e.channels.MAINTENANCE=f)),d++),k.address){var l=k.address.indexOf(":");if(-1!==l){"MULTI_MODE_INPUT_TRANSMITTER"!=k.hsstype||h||(e.id=k.name?k.name:e.id,h=!0);l=k.address.substring(l+1);
"MULTI_MODE_INPUT_TRANSMITTER"==k.hsstype&&(e.address+=":"+l);var n={id:k.name,address:l,room:k.room,group:k.func};0==l?(f=n,e.channels.MAINTENANCE=f):e.channels[k.hsstype+":"+l]=n}}}return b},c=function(a){var b={sys:"hm"};b.id=a.name;b.type=a.hsstype;b.address=a.address;b.interface=a.interface;b.channels={};var c=0,d=!1,e=[];var f=[];var g=JSON.parse(JSON.stringify(b)),h=null,m=a.channels,k;for(k in m)if(m.hasOwnProperty(k)){var l=a.channels[k];if(l.hsstype&&l.address){var n=l.address.indexOf(":");
if(-1!==n){n=l.address.substring(n+1);var J={id:l.name,address:n,room:l.room,group:l.func};if("MAINTENANCE"==l.hsstype)h=J,g.channels.MAINTENANCE=h;else if("MULTI_MODE_INPUT_TRANSMITTER"==l.hsstype)g.channels[l.hsstype+":"+n]=J,g.id=l.name?l.name:g.id,g.address+=":"+n,e.push(g),g=JSON.parse(JSON.stringify(b)),h&&(g.channels.MAINTENANCE=h);else if("SWITCH_TRANSMITTER"==l.hsstype)0!=c&&(f.push(g),g=JSON.parse(JSON.stringify(b)),d=!1,h&&(g.channels.MAINTENANCE=h)),c++,g.channels[l.hsstype+":"+n]=J,g.address+=
":"+n;else if("SWITCH_VIRTUAL_RECEIVER"==l.hsstype&&!d)g.channels[l.hsstype+":"+n]=J,g.id=l.name?l.name:g.id,d=!0;else if("SWITCH_WEEK_PROFILE"==l.hsstype){for(var p=0;p<f.length;p++)f[p].channels[l.hsstype+":"+n]=J;f.push(g)}}}}return f.concat(e)},d=a.hsstype;if("HmIPW-DRS"==d.substr(0,9))return this._resolveHmIPMultiSwitch(a);if("HmIPW-DRD"==d.substr(0,9))return this._resolveHmIPMultiDimmer(a);if("HmIPW-DRBL"==d.substr(0,10))return this._resolveHmIPMultiBlind(a);if("HmIPW-DRI"==d.substr(0,9))return b(a);
if("HmIPW-FIO"==d.substr(0,9))return c(a);if("HmIPW-SMI55"==d)return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1==["0","1","2","3"].indexOf(a)?0:-1!=["1","2"].indexOf(a)?2:1});if("HmIPW-SPI"==d)return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1==["0","1"].indexOf(a)?0:1});var e={};return this._resolveHmIPDeviceFromScript(a,function(a,b){if(!xnm.aio.hm.HMIP_CHANNEL[b])return 0;e[b]||(e[b]=a);return e[b]!=a?0:1})},_parseHmIPRFDevice:function(a){if("HMIP-BSM"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,
...
function(a,b){return-1=="023456".split("").indexOf(a)?0:-1!=["3","4","5"].indexOf(a)?2:1});if("HMIP-FDT"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1=="012345".split("").indexOf(a)?0:-1!=["2","3","4"].indexOf(a)?2:1});if("HMIP-BROLL"==a.hsstype.toUpperCase()||"HMIP-FROLL"==a.hsstype.toUpperCase()||"HMIP-FBL"==a.hsstype.toUpperCase()||"HMIP-BBL"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1!=["1","2"].indexOf(a)?
2:-1==["0","3","4","5","6"].indexOf(a)?0:-1!=["4","5","6"].indexOf(a)?2:1});if(-1!=a.hsstype.toUpperCase().indexOf("HMIP-WRC"))return"HMIP-WRCD"==a.hsstype.toUpperCase()?this._resolveHmIPDeviceFromScript(a,function(a,b){return 0==a?1:1==a||2==a?2:3==a?1:0}):"HMIP-WRCR"==a.hsstype.toUpperCase()?this._resolveHmIPDeviceFromScript(a,function(a,b){return 0==a||1==a||2==a||3==a?1:0}):this._resolveHmIPDeviceFromScript(a,function(a,b){return 0==a?1:"KEY_TRANSCEIVER"==b?2:0});if(0==a.hsstype.toUpperCase().indexOf("HMIP-FAL"))return this._resolveHmIPDeviceFromScript(a,
function(a,b){return"CLIMATECONTROL_FLOOR_PUMP_TRANSCEIVER"==b||"CLIMATECONTROL_FLOOR_TRANSCEIVER"==b?3:0});if("HMIP-SPDR"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1==["0","2","3"].indexOf(a)?0:-1!=["2","3"].indexOf(a)?2:1});if("HMIP-SMI55"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1==["0","1","2","3"].indexOf(a)?0:-1!=["1","2"].indexOf(a)?3:1});if("HMIP-MIOB"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,
function(a,b){return-1!=["3","7","9","10","11"].indexOf(a)?3:0});if("HMIP-SWD"==a.hsstype.toUpperCase()||"HMIP-SAM"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return 1});if("HMIP-WGC"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1=="012345".split("").indexOf(a)?0:-1!=["3","4","5"].indexOf(a)?2:1});if("HMIP-BSL"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1!="5 6 9 10 13 14".split(" ").indexOf(a)?
0:-1!="1 2 7 8 11 12".split(" ").indexOf(a)?2:1});if("HMIP-MOD-TM"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return 1});if("HMIP-SLO"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1!=["2","3"].indexOf(a)?0:1});if("HMIP-PMFS"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return 1});if("HMIP-MP3P"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return-1!=
["0","1","5","9"].indexOf(a)?1:-1!="234678".split("").indexOf(a)?2:0});if("HMIP-MOD-HO"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return 1});if("HMIP-SCI"==a.hsstype.toUpperCase())return this._resolveHmIPDeviceFromScript(a,function(a,b){return 0==a||"SHUTTER_CONTACT_TRANSCEIVER"==b||"SHUTTER_CONTACT"==b?1:0});if("HmIP-MOD-OC"==a.hsstype.substr(0,11)){var b=parseInt(a.hsstype.substr(11)),c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==
b?1:"KEY_TRANSCEIVER"==b?3:0}),d=[];for(i=1;i<=b;i++)d.push(i);a=this._resolveHmIPMultiSwitch(a,d);return c?a?c.concat(a):c:a}if(-1!=a.hsstype.indexOf("HmIP-FCI"))return this._resolveHmIPDeviceFromScript(a,function(a,b){return 0==a?1:"MULTI_MODE_INPUT_TRANSMITTER"==b?3:0});if("HmIP-PCBS"==a.hsstype.substr(0,9)&&(b=parseInt(a.hsstype.substr(9)),!isNaN(b))){c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"KEY_TRANSCEIVER"==b?3:0});d=[];for(i=1;i<=b;i++)d.push(i);a=this._resolveHmIPMultiSwitch(a,
d);return c?a?c.concat(a):c:a}if("HmIP-DRSI"==a.hsstype.substr(0,9)){b=parseInt(a.hsstype.substr(9));c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"MULTI_MODE_INPUT_TRANSMITTER"==b?3:0});d=[];for(i=1;i<=b;i++)d.push(i);a=this._resolveHmIPMultiSwitch(a,d);return c?a?c.concat(a):c:a}if("HmIP-DRDI"==a.hsstype.substr(0,9)){b=parseInt(a.hsstype.substr(9));c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"MULTI_MODE_INPUT_TRANSMITTER"==b?3:0});
d=[];for(i=1;i<=b;i++)d.push(i);a=this._resolveHmIPMultiDimmer(a,d);return c?a?c.concat(a):c:a}if("HmIP-DRBLI"==a.hsstype.substr(0,10)){b=parseInt(a.hsstype.substr(10));c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"MULTI_MODE_INPUT_TRANSMITTER"==b?3:0});d=[];for(i=1;i<=2*b;i++)d.push(i);a=this._resolveHmIPMultiBlind(a,d);return c?a?c.concat(a):c:a}if("HmIP-MIO16-PCB"==a.hsstype){c=this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"ANALOG_INPUT_TRANSMITTER"==
b||"MULTI_MODE_INPUT_TRANSMITTER"==b?3:0});d=[];for(i=1;16>=i;i++)d.push(i);a=this._resolveHmIPMultiSwitch(a,d);return c?a?c.concat(a):c:a}c=this._getChannelCount(a.channels,"SWITCH_TRANSMITTER");b=this._getChannelCount(a.channels,"SWITCH_VIRTUAL_RECEIVER");if(1<this._getChannelCount(a.channels,"KEY_TRANSCEIVER"))return this._resolveHmIPDeviceFromScript(a,function(a,b){return"MAINTENANCE"==b?1:"KEY_TRANSCEIVER"==b?3:0});if(1<c&&1<b)return this._resolveHmIPMultiSwitch(a);var e={};return this._resolveHmIPDeviceFromScript(a,
function(a,b){if(!xnm.aio.hm.HMIP_CHANNEL[b])return 0;e[b]||(e[b]=a);return e[b]!=a?0:1})},_getChannelCount:function(a,b){var c=0,d;for(d in a)a.hasOwnProperty(d)&&a[d].hsstype==b&&c++;return c},_parseDeviceBasic:function(a){var b={sys:"hm"};b.id=a.name;b.type=a.hsstype;b.address=a.address;b.interface=a.interface;b.channels={};return b},_resolveHmIPMultiSwitch:function(a,b){var c=[];var d={sys:"hm"};d.id=a.name;d.type=a.hsstype;d.address=a.address;d.interface=a.interface;d.channels={};var e=0,f=JSON.parse(JSON.stringify(d)),
g=null,h=a.channels,k=!1,l;for(l in h)if(h.hasOwnProperty(l)){var n=a.channels[l];if(n.hsstype&&("SWITCH_TRANSMITTER"==n.hsstype&&(0!=e&&(c.push(f),f=JSON.parse(JSON.stringify(d)),k=!1,g&&(f.channels.MAINTENANCE=g)),e++),n.address)){var m=n.address.indexOf(":");if(-1!==m&&("SWITCH_VIRTUAL_RECEIVER"!=n.hsstype||k||(f.id=n.name?n.name:f.id,k=!0),m=n.address.substring(m+1),!b||-1==b.indexOf(parseInt(m)))){"SWITCH_TRANSMITTER"==n.hsstype&&(f.address+=":"+m);var p={id:n.name,address:m,room:n.room,group:n.func};
0==m?(g=p,f.channels.MAINTENANCE=g):f.channels[n.hsstype+":"+m]=p;if("SWITCH_WEEK_PROFILE"==n.hsstype){for(var q=0;q<c.length;q++)c[q].channels[n.hsstype+":"+m]=p;c.push(f)}}}}return c},_resolveHmIPMultiDimmer:function(a,b){var c=[];var d={sys:"hm"};d.id=a.name;d.type=a.hsstype;d.address=a.address;d.interface=a.interface;d.channels={};var e=0,f=JSON.parse(JSON.stringify(d)),g=null,h=a.channels,k=!1,l;for(l in h)if(h.hasOwnProperty(l)){var n=a.channels[l];if(n.hsstype&&("DIMMER_TRANSMITTER"==n.hsstype&&
(0!=e&&(c.push(f),f=JSON.parse(JSON.stringify(d)),k=!1,g&&(f.channels.MAINTENANCE=g)),e++),n.address)){var m=n.address.indexOf(":");if(-1!==m&&("DIMMER_VIRTUAL_RECEIVER"!=n.hsstype||k||(f.id=n.name?n.name:f.id,k=!0),m=n.address.substring(m+1),!b||-1==b.indexOf(parseInt(m)))){"DIMMER_TRANSMITTER"==n.hsstype&&(f.address+=":"+m);var p={id:n.name,address:m,room:n.room,group:n.func};0==m?(g=p,f.channels.MAINTENANCE=g):f.channels[n.hsstype+":"+m]=p;if("DIMMER_WEEK_PROFILE"==n.hsstype){for(var q=0;q<c.length;q++)c[q].channels[n.hsstype+
":"+m]=p;c.push(f)}}}}return c},_resolveHmIPMultiBlind:function(a,b){var c=[];var d={sys:"hm"};d.id=a.name;d.type=a.hsstype;d.address=a.address;d.interface=a.interface;d.channels={};var e=0,f=JSON.parse(JSON.stringify(d)),g=null,h=a.channels,k=!1,l;for(l in h)if(h.hasOwnProperty(l)){var n=a.channels[l];if(n.hsstype&&("BLIND_TRANSMITTER"==n.hsstype&&(0!=e&&(c.push(f),f=JSON.parse(JSON.stringify(d)),k=!1,g&&(f.channels.MAINTENANCE=g)),e++),n.address)){var m=n.address.indexOf(":");if(-1!==m&&("BLIND_VIRTUAL_RECEIVER"!=
n.hsstype||k||(f.id=n.name?n.name:f.id,k=!0),m=n.address.substring(m+1),!b||-1==b.indexOf(parseInt(m)))){"BLIND_TRANSMITTER"==n.hsstype&&(f.address+=":"+m);var p={id:n.name,address:m,room:n.room,group:n.func};0==m?(g=p,f.channels.MAINTENANCE=g):f.channels[n.hsstype+":"+m]=p;if("BLIND_WEEK_PROFILE"==n.hsstype){for(var q=0;q<c.length;q++)c[q].channels[n.hsstype+":"+m]=p;c.push(f)}}}}return c},_resolveHmIPDeviceFromScript:function(a,b){var c=[],d={sys:"hm"};d.id=a.name;d.type=a.hsstype;d.address=a.address;
d["interface"]=a["interface"];d.channels={};var e=a.channels,f=!1,g;for(g in e)if(channel=a.channels[g],channel.address&&(e=channel.address.indexOf(":"),-1!==e)){e=channel.address.substring(e+1);var h=channel.hsstype;if(channel.hsstype){var k=1;b&&(k=b(e,h));0!=k&&(3==k?(k=JSON.parse(JSON.stringify(d)),k.address=k.address+":"+e,k.id=k.id+"("+k.address+")",k.channels[h]={id:channel.name,address:e,room:channel.room,group:channel.func},c.push(k)):(f=!0,2==k&&(h=h+":"+e),d.channels[h]={id:channel.name,
address:e,room:channel.room,group:channel.func}))}}f&&c.push(d);return c}}}();
...
applyUIFilter:function(a,c){var d=this,b=function(a,b){if("*"==a)return!0;for(var c=!1,d=0;d<a.length;d++)if(a[d]==b){c=!0;break}return c},e=function(a,b){switch(a.type){case "SysVar":return h(a,b);case "Prog":return f(a,b);default:return u(a,b)}},f=function(a,c){var d=[],e=c.elems;switch(c.catagory){case "command":[{type:"enum",name:"execute",ref:{value:"progExec"}}].forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},h=function(a,c){var d=[],e=c.elems;if(a["class"]&&
(a=xnm.aio.hm.MAP.SysVar[a["class"]]))switch(c.catagory){case "command":a.command&&a.command.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))});break;case "status":a.status&&a.status.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},g=function(a,d,e,f,h){var g=[];if(a=a[d][e])switch(c.catagory){case "command":a.command&&f.access&&-1!=f.access.indexOf("w")&&a.command.forEach(function(a){b(h,a.type)&&(a=JSON.parse(JSON.stringify(a)),
g.push(a))});break;case "status":a.status&&f.access&&-1!=f.access.indexOf("r")&&a.status.forEach(function(a){b(h,a.type)&&(a=JSON.parse(JSON.stringify(a)),g.push(a))})}return g},k=function(a,c){var d=[],e=c.elems;switch(c.catagory){case "command":a.command&&a.command.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))});break;case "status":a.status&&a.status.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},l=function(a,b){if(a){var c=
xnm.aio.hm.HmIPDevice.resolveJSON(a);if(c&&c.getCommandStatusMap&&(c=c.getCommandStatusMap(a)))return k(c,b)}c=[];var d=a.channels;a=xnm.aio.hm.DM._getHmIPChannels(a);var e=b.elems,f;for(f in d)if(d.hasOwnProperty(f)){var h=a[f];if(h)for(var l in h)h.hasOwnProperty(l)&&xnm.aio.hm.HMIP_MAP[f]&&(b=g(xnm.aio.hm.HMIP_MAP,f,l,h[l],e),c=c.concat(b))}return c},q=function(a,c){var d=[],e=c.elems;a=xnm.aio.hm.HM_Sec_Sir_WM_MAP;switch(c.catagory){case "command":a.command.forEach(function(a){b(e,a.type)&&(a=
JSON.parse(JSON.stringify(a)),d.push(a))});break;case "status":a.status.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},p=function(a,c){var d=[],e=c.elems;a=xnm.aio.hm.HM_WDS30_OT2_SM_2_MAP;switch(c.catagory){case "status":a.status.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},r=function(a,c){var d=[],e=c.elems;a=xnm.aio.hm.HM_ES_TX_WM_MAP;switch(c.catagory){case "status":a.status.forEach(function(a){b(e,a.type)&&
(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},t=function(a,c){var d=[],e=c.elems;a=[{type:"int",name:"dim to",ref:{value:"dimRaw",ext:"%d",extMeta:"0-100",scale:"10"}}];switch(c.catagory){case "command":a.forEach(function(a){b(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},u=function(a,b){if("HmIP-HEATING"==a.type)return l(a,b);if(a["interface"]&&"CUxD"==a["interface"]){var c=[];a.cuxd||(a.cuxd=xnm.aio.hm.MHMCCU._resolveCUxDType(a));var e=a.channels,f=xnm.aio.hm.DM._getCUxDChannels(a),
h=b.elems,n;for(n in e)if(e.hasOwnProperty(n)){var u=f[n];if(u)for(var w in u)u.hasOwnProperty(w)&&("FHT_Multiventil"==a.cuxd&&"DIMMER"==n?n="FHT_Multiventil_Dimmer":"HMS_100_Contact"==a.cuxd&&"SENSOR"==n?n="HMS_100_Contact":"FHT_Contact"==a.cuxd&&"SENSOR"==n?n="FHT_Contact":"Security_Sensor"==a.cuxd&&"SENSOR"==n?n="Security_Sensor":"HMS_100_W/WD"==a.cuxd&&"SENSOR"==n&&(n="Security_Sensor"),xnm.aio.hm.CUxDMAP[n]?(b=g(xnm.aio.hm.CUxDMAP,n,w,u[w],h),c=c.concat(b)):xnm.aio.hm.MAP[n]&&(b=g(xnm.aio.hm.MAP,
n,w,u[w],h),c=c.concat(b)))}return c}if(a["interface"]&&"HmIP-RF"==a["interface"])return l(a,b);if(a["interface"]&&"BidCos-RF"==a["interface"]&&a.type&&xnm.aio.hm.BidCosDevice[a.type]&&(n=xnm.aio.hm.BidCosDevice[a.type])&&n.getCommandStatusMap&&(n=n.getCommandStatusMap(a))||a["interface"]&&"VirtualDevices"==a["interface"]&&-1==a.type.indexOf("HM-CC-VG")&&(n=d._getVirtualDevicesMap(a)))return k(n,b);if("DimmerKey"==a.type)return t(a,b);if("HM-Sec-Sir-WM"==a.type)return q(a,b);if("HM-WDS30-OT2-SM-2"==
a.type)return p(a,b);if("HM-ES-TX-WM"==a.type&&a.channels&&a.channels.POWERMETER_IEC1)return r(a,b);n=[];w=a.channels;a=xnm.aio.hm.DM._getChannels(a);f=b.elems;for(c in w)if(w.hasOwnProperty(c)&&(h=a[c]))for(e in h)h.hasOwnProperty(e)&&xnm.aio.hm.MAP[c]&&(b=g(xnm.aio.hm.MAP,c,e,h[e],f),n=n.concat(b));return n};if(!a.type)return null;var y=JSON.parse(JSON.stringify(a)),w=null;switch(c.catagory){case "command":w=e(a,c);y.command=w;break;case "status":w=e(a,c);y.status=w;break;default:return null}return w&&
0!=w.length?y:null},applyUIFilterGateway:function(a,c){var d=function(a,b){if("*"==a)return!0;for(var c=!1,d=0;d<a.length;d++)if(a[d]==b){c=!0;break}return c},b=function(a,b){var c=[],e=b.elems;if(a=xnm.aio.hm.MAP.CCU)switch(b.catagory){case "command":a.command&&a.command.forEach(function(a){d(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),c.push(a))});break;case "status":a.status&&a.status.forEach(function(a){d(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),c.push(a))})}return c},e=JSON.parse(JSON.stringify(a)),
...
b={};for(var f in a.channels)if(a.channels.hasOwnProperty(f)){e=f;var h=e.indexOf(":");-1!=h&&(e=e.substr(0,h));b[e]=!0}if(b.DIGITAL_OUTPUT){var g={"%on%":{value:"digOutOn",name:"on"},"%off%":{value:"digOutOff",name:"off"},"%toggle%":{value:"digOutToggle",name:"toggle"}};var k={"%switchState%":{value:"digOutState",options:["off","on"],name:"state"}};var l=["switch"]}b.DIGITAL_ANALOG_OUTPUT&&(g={"%on%":{value:"daOutOn",name:"on"},"%off%":{value:"daOutOff",name:"off"},"%toggle%":{value:"daOutToggle",
name:"toggle"}},k={"%switchState%":{value:"daOutState",options:["off","on"],name:"state"}},l=["switch"]);b.SWITCH&&(g={"%on%":{value:"on",name:"on"},"%off%":{value:"off",name:"off"},"%toggle%":{value:"toggle",name:"toggle"}},k={"%switchState%":{value:"switchState",options:["off","on"],name:"switch status"}},l=["switch"]);if(b.DIMMER||b.VIRTUAL_DIMMER)g={"%on%":{value:"dimOn",name:"on"},"%off%":{value:"dimOff",name:"off"},"%dimOn%":{value:"dimOn",name:"on"},"%dimOff%":{value:"dimOff",name:"off"},"%dimUp%":{value:"dimUp",
name:"dim up"},"%dimDown%":{value:"dimDown",name:"dim down"},"%dimTo%":{value:"dimRaw",ext:"%d",extMeta:"0-100",name:"dim to"}},k={"%dimmerState%":{value:"dimmerLevel",ext:"%d",extMeta:"0-100",name:"dimmer status"}},l=["switch","dimmer"];b.BLIND&&(g||(g={}),g["%stop%"]||(g["%stop%"]={value:"blindStop",name:"stop"}),g["%moveUp%"]||(g["%moveUp%"]={value:"blindUp",name:"move up"}),g["%moveDown%"]||(g["%moveDown%"]={value:"blindDown",name:"move down"}),g["%stepUp%"]||(g["%stepUp%"]={value:"blindStepUp",
name:"step up"}),g["%stepDown%"]||(g["%stepDown%"]={value:"blindStepDown",name:"step down"}),g["%moveTo%"]||(g["%moveTo%"]={value:"blindRaw",ext:"%d",extMeta:"0-100",name:"move to"}),k={"%shutterState%":{value:"blindLevel",ext:"%d",extMeta:"0-100",name:"blind status"}},l=["shutter"]);b.JALOUSIE&&(g||(g={}),g["%stop%"]||(g["%stop%"]={value:"jalStop",name:"stop"}),g["%moveUp%"]||(g["%moveUp%"]={value:"jalUp",name:"move up"}),g["%moveDown%"]||(g["%moveDown%"]={value:"jalDown",name:"move down"}),g["%stepUp%"]||
(g["%stepUp%"]={value:"jalStepUp",name:"step up"}),g["%stepDown%"]||(g["%stepDown%"]={value:"jalStepDown",name:"step down"}),g["%moveTo%"]||(g["%moveTo%"]={value:"jalRaw",ext:"%d",extMeta:"0-100",name:"move to"}),g["%lamellaUp%"]||(g["%lamellaUp%"]={value:"jalLmlUp",name:"lamella up"}),g["%lamellaDown%"]||(g["%lamellaDown%"]={value:"jalLmlDown",name:"lamella down"}),g["%lamellaStepUp%"]||(g["%lamellaStepUp%"]={value:"jalLmlStepUp",name:"lamella step up",ext:10}),g["%lamellaStepDown%"]||(g["%lamellaStepDown%"]=
{value:"jalLmlStepDown",name:"lamella step down",ext:10}),g["%lamellaTo%"]||(g["%lamellaTo%"]={value:"jalLmlRaw",ext:"%d",extMeta:"0-100",name:"lamella to"}),k={"%blindState%":{value:"jalLevel",ext:"%d",extMeta:"0-100",name:"status"},"%lamellaState%":{value:"jalLmlLevel",ext:"%d",extMeta:"0-100",name:"lamella status"}},l=["shutter","blind"]);b.POWERMETER&&(k||(k={}),k["%meterVoltage%"]||(k["%meterVoltage%"]={value:"meterVoltage",extMeta:"0.0-6553.5",scale:"0.1",unit:"V",name:"voltage"}),k["%meterEnergyCounter%"]||
...
l||(l=[]),-1==l.indexOf("powermeter")&&l.push("powermeter"));b.CLIMATECONTROL_REGULATOR&&(g||(g={}),g["%thermoTempUp%"]||(g["%thermoTempUp%"]={value:"themoRTempUp",name:"temperature up"}),g["%thermoTempDown%"]||(g["%thermoTempDown%"]={value:"themoRTempDown",name:"temperature down"}),g["%thermoTempTo%"]||(g["%thermoTempTo%"]={value:"themoRTempRaw",ext:"%f",extMeta:"6-30",scale:"0.5",name:"temperature to"}),g["%thermoOn%"]||(g["%thermoOn%"]={value:"themoTempOn",name:"on"}),g["%thermoOff%"]||(g["%thermoOff%"]=
{value:"themoRTempClose",name:"close"}),k={"%thermoCurrentTemp%":{value:"weatherTemp",name:"temperature"},"%thermoHum%":{value:"weatherHum",name:"humidity"},"%thermoSetTemp%":{value:"themoRSetTemp",extMeta:"6-30",scale:"0.5",name:"set temperature"}},l=["thermostat"]);b.THERMALCONTROL_TRANSMIT&&(g||(g={}),g["%thermoAuto%"]||(g["%thermoAuto%"]={value:"themoTAutoMode",name:"set auto mode"}),g["%thermoManu%"]||(g["%thermoManu%"]={value:"themoTManuMode",ext:"20.0",name:"set manual mode"}),g["%thermoBoost%"]||
(g["%thermoBoost%"]={value:"themoTBoostMode",name:"set boost mode"}),g["%thermoTempUp%"]||(g["%thermoTempUp%"]={value:"themoTTempUp",name:"temperature up"}),g["%thermoTempDown%"]||(g["%thermoTempDown%"]={value:"themoTTempDown",name:"temperature down"}),g["%thermoTempTo%"]||(g["%thermoTempTo%"]={value:"themoTTempRaw",ext:"%f",extMeta:"4.5-30.5",scale:"0.5",name:"temperature to"}),g["%thermoOff%"]||(g["%thermoOff%"]={value:"themoTTempOff",name:"off"}),k={"%thermoCurrentTemp%":{value:"themoTActualTemp",
name:"actual temperature"},"%thermoHum%":{value:"themoTActualHum",name:"actual humidity"},"%thermoMode%":{value:"themoTMode",options:["auto","manu","party","boost"],name:"mode"},"%thermoSetTemp%":{value:"themoTSetTemp",extMeta:"4.5-30.5",scale:"0.5",name:"set temperature"},"%thermoWindow%":{value:"themoTWin",options:["open","closed"],name:"window open"}},l=["thermostat"]);b.CLIMATECONTROL_RT_TRANSCEIVER&&(g||(g={}),g["%thermoAuto%"]||(g["%thermoAuto%"]={value:"themoAutoMode",name:"set auto mode"}),
g["%thermoManu%"]||(g["%thermoManu%"]={value:"themoManuMode",ext:"20.0",name:"set manual mode"}),g["%thermoBoost%"]||(g["%thermoBoost%"]={value:"themoBoostMode",name:"set boost mode"}),g["%thermoTempUp%"]||(g["%thermoTempUp%"]={value:"themoTempUp",name:"temperature up"}),g["%thermoTempDown%"]||(g["%thermoTempDown%"]={value:"themoTempDown",name:"temperature down"}),g["%thermoTempTo%"]||(g["%thermoTempTo%"]={value:"themoTempRaw",ext:"%f",extMeta:"4.5-30.5",scale:"0.5",name:"temperature to"}),g["%thermoOff%"]||
(g["%thermoOff%"]={value:"themoTempOff",name:"off"}),k={"%thermoCurrentTemp%":{value:"themoActualTemp",name:"actual temperature"},"%thermoHum%":{value:"themoActualHum",name:"actual humidit"},"%thermoMode%":{value:"themoMode",options:["auto","manu","party","boost"],name:"mode"},"%thermoSetTemp%":{value:"themoSetTemp",extMeta:"4.5-30.5",scale:"0.5",name:"set temperature"},"%thermoWindow%":{value:"themoWinState",options:["open","closed"],name:"window state"}},l=["thermostat"]);b.SHUTTER_CONTACT&&(k=
{"%contactState%":{value:"shutterState",options:["closed","open"],name:"shutter state"}},l=["contact"]);b.ROTARY_HANDLE_SENSOR&&(k={"%windowState%":{value:"handleState",options:["closed","tilted","open"],name:"handle state"}},l=["window"]);b.WEATHER&&((a=a.type)&&"HM-WDS30"==a.substr(0,8)?(k={"%tempState%":{value:"weatherTemp",name:"temperature"}},l=["climate"]):a&&"HM-WDS100"==a.substr(0,9)?(k={"%tempState%":{value:"weatherTemp",name:"temperature"},"%humState%":{value:"weatherHum",name:"humidity"},
"%brightnessState%":{value:"weatherBright",name:"brightness"},"%sunshineState%":{value:"weatherSunD",name:"sunshine duration"},"%windDirection%":{value:"weatherWindD",name:"wind direction",options:"N NO O SO S SW W NW".split(" ")},"%windspeedState%":{value:"weatherWindS",name:"wind speed"},"%rainingState%":{value:"weatherRaining",name:"raining"},"%rainingCounterState%":{value:"weatherRainCounter",name:"rain counter"}},l=["weather_station"]):(k={"%tempState%":{value:"weatherTemp",name:"temperature"},
"%humState%":{value:"weatherHum",name:"humidity"}},l=["climate"]));b.MOTION_DETECTOR&&(k={"%motionState%":{value:"motionState",options:["on","off"],name:"state"},"%motionBrightness%":{value:"motionBright",name:"brightness"}},l=["motion"]);b.SMOKE_DETECTOR&&(k={"%smokeState%":{value:"smokeState",options:["on","off"],name:"state"}},l=["smoke"]);b.SMOKE_DETECTOR_TEAM&&(k={"%smokeState%":{value:"smokeGroup1State",options:["on","off"],name:"state"}},l=["smoke"]);b.SMOKE_DETECTOR_TEAM_V2&&(k={"%smokeState%":{value:"smokeGroupState",
options:["on","off"],name:"state"}},l=["smoke"]);b.RGBW_COLOR&&(g||(g={}),g["%rgb%"]||(g["%rgb%"]={value:"rgb",ext:"%s",name:"rgb color"}),g["%white%"]||(g["%white%"]={value:"white",name:"white"}),l||(l=[]),-1==l.indexOf("rgb")&&l.push("rgb"));b.WINMATIC&&(g||(g={}),g["%windowUp%"]||(g["%windowUp%"]={value:"windowUp"}),g["%windowDown%"]||(g["%windowDown%"]={value:"windowDown"}),g["%windowTo%"]||(g["%windowTo%"]={value:"windowTo",ext:"%d",extMeta:"0-100"}),g["%windowLock%"]||(g["%windowLock%"]={value:"winLock"}),
g["%windowStop%"]||(g["%windowStop%"]={value:"winStop"}),k={"%windowLevel%":{value:"winLevel"}},l=["winmatic"]);b.KEYMATIC&&(g||(g={}),g["%lock%"]||(g["%lock%"]={value:"keyLock"}),g["%unlock%"]||(g["%unlock%"]={value:"keyOpen"}),g["%open%"]||(g["%open%"]={value:"keyOpenDo"}),k={"%lockStatus%":{value:"keyState",options:["open","lock"]}},l=["keymatic"]);b.SENSOR_FOR_CARBON_DIOXIDE&&(k={"%co2State%":{value:"co2State",options:["normal","added","added_strong"]}},l=["sensor_co2"]);b.WATERDETECTIONSENSOR&&
(k={"%waterState%":{value:"waterState",options:["dry","wet","water"]}},l=["sensor_water"]);if(b.LUXMETER){k={"%state%":{value:"luxState",extMeta:"0.00-100000.00",scale:"0.01"}};var q={"%icon%":"sun"};l=["generic_state"]}return l&&0!=l.length?this._injectToSmartWidgetTemplate(c,l,d,g,k,q):null},_applySmartWidget_HmIP:function(a,c,d,b,e){if(!a.channels||"HmIP-WGC"==a.type)return null;var f,h,g;if("HmIP-BSL"==a.type)return f||(f={}),f["%on%"]||(f["%on%"]={value:"on",name:"on"}),f["%off%"]||(f["%off%"]=
{value:"off",name:"off"}),f["%toggle%"]||(f["%toggle%"]={value:"toggle",name:"toggle"}),h||(h={}),h["%switchState%"]||(h["%switchState%"]={value:"switchState",options:["off","on"],name:"switch status"}),this._injectToSmartWidgetTemplate(c,["switch"],d,f,h);b={};for(var k in a.channels)if(a.channels.hasOwnProperty(k)){e=k;var l=e.indexOf(":");-1!=l&&(e=e.substr(0,l));b[e]=!0}b.SWITCH_VIRTUAL_RECEIVER&&(f||(f={}),"HmIP-BSM"==a.type?(f["%on%"]||(f["%on%"]={value:"ch4on",name:"ch.4 on"}),f["%off%"]||
(f["%off%"]={value:"ch4off",name:"ch.4 off"}),f["%toggle%"]||(f["%toggle%"]={value:"ch4toggle",name:"ch.4 toggle"})):(f["%on%"]||(f["%on%"]={value:"on",name:"on"}),f["%off%"]||(f["%off%"]={value:"off",name:"off"}),f["%toggle%"]||(f["%toggle%"]={value:"toggle",name:"toggle"})),h||(h={}),h["%switchState%"]||(h["%switchState%"]={value:"switchState",options:["off","on"],name:"switch status"}),g||(g=[]),-1==g.indexOf("switch")&&g.push("switch"));b.DIMMER_VIRTUAL_RECEIVER&&(f||(f={}),f["%on%"]||(f["%on%"]=
{value:"dimTo",ext:100,name:"dim to"}),f["%off%"]||(f["%off%"]={value:"dimOff",name:"off"}),f["%dimOn%"]||(f["%dimOn%"]={value:"dimTo",ext:100,name:"dim to"}),f["%dimOff%"]||(f["%dimOff%"]={value:"dimOff",name:"off"}),f["%dimUp%"]||(f["%dimUp%"]={value:"dimUp",ext:5,name:"dim up"}),f["%dimDown%"]||(f["%dimDown%"]={value:"dimDown",ext:5,name:"dim down"}),f["%dimTo%"]||(f["%dimTo%"]={value:"dimTo",ext:"%d",extMeta:"0-100",name:"dim to"}),h={"%dimmerState%":{value:"dimmerTLevel",ext:"%d",extMeta:"0-100",
name:"dimmer status"}},g=["switch","dimmer"]);b.SHUTTER_VIRTUAL_RECEIVER&&(f||(f={}),f["%stop%"]||(f["%stop%"]={value:"stop",name:"stop"}),f["%moveUp%"]||(f["%moveUp%"]={value:"moveUp",name:"move up"}),f["%moveDown%"]||(f["%moveDown%"]={value:"moveDown",name:"move down"}),f["%stepUp%"]||(f["%stepUp%"]={value:"stepUp",ext:5,name:"step up"}),f["%stepDown%"]||(f["%stepDown%"]={value:"stepDown",ext:5,name:"step down"}),f["%moveTo%"]||(f["%moveTo%"]={value:"moveTo",ext:"%d",extMeta:"0-100",name:"move to"}),
h={"%shutterState%":{value:"blindTLevel",ext:"%d",extMeta:"0-100",name:"blind status"}},g=["shutter"]);b.BLIND_VIRTUAL_RECEIVER&&(f||(f={}),f["%stop%"]||(f["%stop%"]={value:"stop",name:"stop"}),f["%moveUp%"]||(f["%moveUp%"]={value:"moveUp",name:"move up"}),f["%moveDown%"]||(f["%moveDown%"]={value:"moveDown",name:"move down"}),f["%stepUp%"]||(f["%stepUp%"]={value:"stepUp",ext:5,name:"step up"}),f["%stepDown%"]||(f["%stepDown%"]={value:"stepDown",ext:5,name:"step down"}),f["%moveTo%"]||(f["%moveTo%"]=
...
h={"%blindState%":{value:"blindTPos",ext:"%d",extMeta:"0-100",name:"blind status"},"%lamellaState%":{value:"lamellaTPos",ext:"%d",extMeta:"0-100",name:"lamella status"}},g=["shutter","blind"]);b.ENERGIE_METER_TRANSMITTER&&(h||(h={}),h["%meterVoltage%"]||(h["%meterVoltage%"]={value:"meterVoltage",extMeta:"0.0-409.5",scale:"0.1",unit:"V",name:"voltage"}),h["%meterEnergyCounter%"]||(h["%meterEnergyCounter%"]={value:"meterEnergyCounter",extMeta:"0.0-838859.1",scale:"0.1",unit:"Wh",name:"energy counter"}),
h["%meterFrequency%"]||(h["%meterFrequency%"]={value:"meterFrequency",extMeta:"29.52-70.47",scale:"0.01",unit:"Hz",name:"frequency"}),h["%meterPower%"]||(h["%meterPower%"]={value:"meterPower",extMeta:"0.0-163830.0",scale:"0.1",unit:"W",name:"power"}),h["%meterCurrent%"]||(h["%meterCurrent%"]={value:"meterCurrent",extMeta:"0.0-65535.0",scale:"0.1",unit:"mA",name:"current"}),g||(g=[]),-1==g.indexOf("powermeter")&&g.push("powermeter"));b.HEATING_CLIMATECONTROL_TRANSCEIVER&&(f||(f={}),f["%thermoAuto%"]||
...
options:["auto","manu"],name:"mode"},"%thermoSetTemp%":{value:"themoTemp",extMeta:"4.5-30.5",scale:"0.5",name:"set temperature"},"%thermoProfile%":{value:"themoProf",ext:"%d",extMeta:"1-6",scale:"1",name:"set profile"},"%thermoBoostMode%":{value:"themoBoostMode",options:["off","on"],name:"boost mode"},"%thermoWindow%":{value:"themoWinState",options:["open","closed"],name:"window state"}},g=["thermostat"]);b.SHUTTER_CONTACT&&(h={"%contactState%":{value:"shutterState",options:["closed","open"],name:"shutter state"}},
g=["contact"]);b.SHUTTER_CONTACT_TRANSCEIVER&&(h={"%contactState%":{value:"shutterTState",options:["closed","open"],name:"shutter state"}},g=["contact"]);b.ROTARY_HANDLE_TRANSCEIVER&&(h={"%windowState%":{value:"handleState",options:["closed","tilted","open"],name:"handle state"}},g=["window"]);b.CLIMATE_TRANSCEIVER&&(h={"%tempState%":{value:"climateActualTemp",extMeta:"-3276.8-3276.7",scale:"0.1",name:"actual temperature"},"%humState%":{value:"climateHum",name:"humidity"}},g=["climate"]);b.WEATHER_TRANSMIT&&
(h={"%tempState%":{value:"weatherActualTemp",name:"actual temperature"},"%humState%":{value:"weatherHum",name:"humidity"},"%brightnessState%":{value:"weatherIllu",name:"brightness"},"%sunshineState%":{value:"weatherSunD",name:"sunshine duration"},"%windspeedState%":{value:"weatherWindS",name:"wind speed"}},"HmIP-SWO-PL"==a.type?(h["%rainingState%"]={value:"weatherRain",name:"raining"},h["%rainingCounterState%"]={value:"weatherRainC",name:"rain counter"}):"HmIP-SWO-PR"==a.type&&(h["%rainingState%"]=
{value:"weatherRain",name:"raining"},h["%rainingCounterState%"]={value:"weatherRainC",name:"rain counter"},h["%windDirection%"]={value:"weatherWindD",name:"wind direction"}),g=["weather_station"]);b.MOTIONDETECTOR_TRANSCEIVER&&(f||(f={}),f["%motionActivate%"]||(f["%motionActivate%"]={value:"motionOn",name:"activate detection"}),f["%motionDeactivate%"]||(f["%motionDeactivate%"]={value:"motionOff",name:"deactivate detection"}),f["%motionToggle%"]||(f["%motionToggle%"]={value:"motionToggle",name:"toggle detection"}),
f["%motionReset%"]||(f["%motionReset%"]={value:"motionReset",name:"reset"}),h={"%motionState%":{value:"motionState",options:["on","off"],name:"state",conv_s:{on:"true",off:"false"}},"%motionBrightness%":{value:"motionIllu",name:"illumination"},"%motionActivate%":{value:"motionActivate",options:["off","on"],name:"detection activated"}},g=["motion"]);b.PRESENCEDETECTOR_TRANSCEIVER&&(f||(f={}),f["%motionActivate%"]||(f["%motionActivate%"]={value:"presenceOn",name:"activate detection"}),f["%motionDeactivate%"]||
(f["%motionDeactivate%"]={value:"presenceOff",name:"deactivate detection"}),f["%motionToggle%"]||(f["%motionToggle%"]={value:"presenceToggle",name:"toggle detection"}),f["%motionReset%"]||(f["%motionReset%"]={value:"presenceReset",name:"reset"}),h={"%motionState%":{value:"presenceState",options:["on","off"],name:"state",conv_s:{on:"true",off:"false"}},"%motionBrightness%":{value:"presenceIllu",name:"illumination"},"%motionActivate%":{value:"presenceActivate",options:["off","on"],name:"detection activated"}},
g=["motion"]);b.SMOKE_DETECTOR&&(h={"%smokeState%":{value:"smokeState",options:["on","off"],name:"alarm state"}},g=["smoke"]);b.ANALOG_OUTPUT_TRANSCEIVER&&(f||(f={}),f["%dimOn%"]||(f["%dimOn%"]={value:"analogOutputTo",ext:100,name:"output to"}),f["%dimOff%"]||(f["%dimOff%"]={value:"analogOutputOff",name:"off"}),f["%dimUp%"]||(f["%dimUp%"]={value:"analogOutputUp",ext:5,name:"up"}),f["%dimDown%"]||(f["%dimDown%"]={value:"analogOutputDown",ext:5,name:"down"}),f["%dimTo%"]||(f["%dimTo%"]={value:"analogOutputTo",
ext:"%d",extMeta:"0-100",name:"output to"}),h={"%dimmerState%":{value:"analogOutputLevel",ext:"%d",extMeta:"0-100",name:"output status"}},g=["dimmer"]);b.BRIGHTNESS_TRANSMITTER&&(h={"%brightnessState%":{value:"briIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"},"%brightnessAvg%":{value:"briAvgIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"},"%brightnessMax%":{value:"briMaxIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"},"%brightnessMin%":{value:"briMinIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"}},
g=["lux"]);return g&&0!=g.length?this._injectToSmartWidgetTemplate(c,g,d,f,h):null},_injectToSmartWidgetTemplate:function(a,c,d,b,e,f){var h=[];a||(b={});b||(b={});e||(e={});for(var g=0;g<a.length;g++){var k=a[g];if(k.meta&&-1!=c.indexOf(k.meta.type)&&k.elements){k=JSON.parse(JSON.stringify(k));var l=!1,q;for(q in k.elements){var p=k.elements[q];if(p&&Array.isArray(p))for(var r=0;r<p.length;r++){var t=p[r];if(t){if(t.action&&"command"==t.action.type&&t.action.ref&&t.action.ref.value){var u=t.action.ref.ext;
b[t.action.ref.value]?(t.action.ref=b[t.action.ref.value],u&&(t.action.ref.ext=u),t.action.device=d,l=!0):t.action=null}t.status&&t.status.ref&&t.status.ref.value&&(e[t.status.ref.value]?(t.status.ref=e[t.status.ref.value],t.status.device=d,l=!0):t.status=null);t.widget&&"%icon%"==t.widget.key_img&&f&&(t.widget.key_img=f["%icon%"])}}}l&&h.push(k)}}return h},toGeneralDevice:function(a,c){if(!a)return null;c={};for(e in a.channels){var d=e,b=d.indexOf(":");-1!=b&&(d=d.substr(0,b));c[d]=!0}var e=null;
...
d;g.on("listening",function(){g.setBroadcast&&g.setBroadcast(!0);h&&(h(null,g),h=null)});g.on("message",function(a,b){c.call(f,b,a)});g.on("error",function(a){xnm.aio.hm.Handler._logger.log("warn","create discover socket error:"+a);h&&(h(a),h=null)});g.bind(a,b);return g},b=function(a,b){var c=new Buffer([2,165,219,48,1,101,81,51,45,42,0,42,0,73]);a.send(c,0,c.length,43439,"255.255.255.255",function(){b&&a.close()})},e=this;(function(a){var b=[],e=this,f=require("os"),l=require("dgram");if(f&&f.networkInterfaces){var q=
l.createSocket("udp4");q.on("listening",function(){q.setBroadcast(!0);var c=f.networkInterfaces(),g=[],h;for(h in c)for(var k=c[h],l=0;l<k.length;l++)"IPv4"==k[l].family&&0==k[l].internal&&g.push(k[l].address);var w=g.length;if(w)for(c=0;c<g.length;c++)d.call(e,q.address().port,g[c],function(c,d){w--;!c&&d&&b.push(d);w||a&&a(null,b)});else a&&a(null,b)});q.on("message",function(a,b){c.call(e,b,a)});q.bind(null)}else d.call(e,null,null,function(c,d){!c&&d&&b.push(d);a&&a(null,b)})}).call(this,function(a,
