...
$jscomp.POLYFILL_PREFIX+f),$jscomp.defineProperty(b,$jscomp.propertyToPolyfillSymbol[f],{configurable:!0,writable:!0,value:c})))};$jscomp.initSymbol=function(){};
...
xnm.aio.hm.Util=function(){var a={"&amp;":"&","&quot;":'"',"&lt;":"<","&gt;":">"};return{formatFloatString:function(c){return"undefined"==typeof c||null==c||""==c?"?":parseFloat(c).toFixed(1)},decodeXml:function(c){return c.replace(/(&quot;|&lt;|&gt;|&amp;)/g,function(d,b){return a[b]})}}}();
...
state:x});break}if(w&&w.buildStateScript&&(l=w.buildStateScript(this,z,z.channels[L],A))){b.push({alias:y,script:l,device:z,channel:L,status:A});break}}}}}this.getCloudmaticStatus(a,q,function(C,B){"undefined"!=typeof a&&null!=a&&"undefined"!=typeof a.reportStates&&null!=a.reportStates&&!C&&B&&0<B.length&&a.reportStates(null,B);m.getServiceMessageStatus(a,p,function(I,D){m.getCCUStatus(a,t,function(M,G){0===b.length?(M=m.resolveStateResponse([],[],f),G&&(M=M?M.concat(G):G),D&&(M=M?M.concat(D):D),
B&&(M=M?M.concat(B):B),d&&d(null,M||[])):(l=m.buildScript(b),m._doRequest(l,!0,function(S,Q){var P=null;if(S)d&&d(S);else{S=Q.indexOf("<states>");var X=Q.lastIndexOf("</states");if(X>S+8)try{P=Q.substring(S+8,X);P=xnm.aio.hm.Util.decodeXml(P);var V=P.split("\r@@@\n");P={};for(Q=0;Q<V.length;Q++){var Y=V[Q].indexOf("=");if(0<Y){var aa=V[Q].substr(0,Y);P[aa]=V[Q].substr(Y+1)}}P=m.resolveStateResponse(b,P,f);G&&(P=P?P.concat(G):G);D&&(P=P?P.concat(D):D);B&&(P=P?P.concat(B):B);d&&d(null,P)}catch(ca){d&&
...
access:"re",min:0,max:163830},CONCENTRATION_STATUS:{type:"option",access:"re",values:{0:"NORMAL",1:"UNKNOWN",2:"OVERFLOW"}}}]},DOOR_LOCK_STATE_TRANSMITTER:{datapoints:[{ACTIVITY_STATE:{type:"option",access:"re",values:{0:"UNKNOWN",1:"UP",2:"DOWN",3:"STABLE"}},LOCK_STATE:{type:"option",access:"re",values:{0:"UNKNOWN",1:"LOCKED",2:"UNLOCKED"}},LOCK_TARGET_LEVEL:{type:"option",access:"w",values:{0:"LOCKED",1:"UNLOCKED",2:"OPEN"}},PROCESS:{type:"option",access:"re",values:{0:"STABLE",1:"NOT_STABLE"}},
SECTION:{type:"integer",access:"re",min:0,max:15},SECTION_STATUS:{type:"option",access:"re",values:{0:"NORMAL",1:"UNKNOWN"}},WP_OPTIONS:{type:"option",access:"rwe",values:{0:"NOP",1:"ON",2:"OFF"}}}]},ACCESS_RECEIVER:{datapoints:[{ACCESS_AUTHORIZATION:{type:"option",access:"w",values:{0:"DISABLE",1:"ENABLE"}},STATE:{type:"boolean",access:"re"}}]},RAIN_DETECTION_TRANSMITTER:{datapoints:[{ACTUAL_TEMPERATURE:{type:"float",access:"re",min:-3276.8,max:3276.7},HEATER_STATE:{type:"boolean",access:"re"},RAINING:{type:"boolean",
access:"re"}}]}};
...
extMeta:"0-163830",unit:"ppm"}}]},CONCENTRATION_STATUS:{status:[{type:"enum",name:"co2 sensor status",ref:{value:"co2SensorStatus",options:["normal","unknown","overflow"]}}]}},DOOR_LOCK_STATE_TRANSMITTER:{LOCK_STATE:{status:[{type:"enum",name:"lock state",ref:{value:"lockState",options:["unknown","locked","unlocked"]}}]},LOCK_TARGET_LEVEL:{command:[{type:"enum",name:"lock",ref:{value:"lock"}},{type:"enum",name:"unlock",ref:{value:"unlock"}},{type:"enum",name:"open",ref:{value:"open"}}]}},ACCESS_RECEIVER:{ACCESS_AUTHORIZATION:{command:[{type:"enum",
name:"user authorization: off",ref:{value:"accessAuthDisable"}},{type:"enum",name:"user authorization: on",ref:{value:"accessAuthEnable"}}]},STATE:{status:[{type:"enum",name:"user authorization",ref:{value:"accessAuthState",options:["on","off"]}}]}},RAIN_DETECTION_TRANSMITTER:{ACTUAL_TEMPERATURE:{status:[{type:"float",name:"temperature",ref:{value:"temperature",extMeta:"-3276.8-3276.7",scale:"0.1"}}]},HEATER_STATE:{status:[{type:"enum",name:"sensor heater",ref:{value:"sensorHeater",options:["on",
"off"]}}]},RAINING:{status:[{type:"enum",name:"raining",ref:{value:"raining",options:["true","false"]}}]}}};xnm.aio.hm.DimmerKey={buildCommandScript:function(a,c,d){if(!c.channels||!d.value)return null;a=c.channels[d.ext];return a?a='var o;o=dom.GetObject("'+(a+'");if(o!=null){o.State(1);}\no="";\n'):null}};
...
case "1":return"locked";case "2":return"unlocked"}}return"?"},resolveState:function(a,c,d){a={ACTIVITY_STATE:"activityState",LOCK_STATE:"lockState"}[c.datapoint];if(!a)return null;d=this.handleStatusResponse(d+"",{value:a});return{key:a,value:d}}},ACCESS_RECEIVER:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "accessAuthDisable":b="if(o!=null){o.State(0);}\n";a="ACCESS_AUTHORIZATION";break;case "accessAuthEnable":b="if(o!=null){o.State(1);}\n";a="ACCESS_AUTHORIZATION";
break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},buildStateScript:function(a,c,d,b){return c.channels&&b.value?(a={accessAuthState:"STATE"}[b.value])?xnm.aio.hm.Channel.buildStateScript(c,d,a):null:null},handleStatusResponse:function(a,c){if("?"===a)return a;switch(c.value){case "accessAuthState":switch(a){case "0":return"off";case "1":return"on"}}return"?"},resolveState:function(a,c,d){a={STATE:"accessAuthState"}[c.datapoint];if(!a)return null;d=this.handleStatusResponse(d+
"",{value:a});return{key:a,value:d}}}};
...
default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "ENERGY_COUNTER":var b="meterEnergyCounter";break;case "POWER":b="meterPower";break;case "CURRENT":b="meterCurrent";break;case "VOLTAGE":b="meterVoltage";break;case "FREQUENCY":b="meterFrequency"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}},getCommandStatusMap:function(){return{status:[{type:"float",name:"voltage",ref:{value:"meterVoltage",extMeta:"0.0-409.5",scale:"0.1",unit:"V"}},{type:"float",
name:"energy counter",ref:{value:"meterEnergyCounter",extMeta:"0.0-838859.1",scale:"0.1",unit:"Wh"}},{type:"float",name:"frequency",ref:{value:"meterFrequency",extMeta:"29.52-70.47",scale:"0.01",unit:"Hz"}},{type:"float",name:"power",ref:{value:"meterPower",extMeta:"0.0-163830.0",scale:"0.1",unit:"W"}},{type:"float",name:"current",ref:{value:"meterCurrent",extMeta:"0.0-65535.0",scale:"0.1",unit:"mA"}}]}},getIPEvtMap:function(){return{ipevt:this.getCommandStatusMap().status}}},SMOKE_DETECTOR:{buildCommandScript:function(a,
c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "intrusionAlarmOff":a="SMOKE_DETECTOR_COMMAND";b="if(o!=null){o.State(1);}\n";break;case "intrusionAlarmOn":a="SMOKE_DETECTOR_COMMAND";b="if(o!=null){o.State(2);}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "smokeState":case "smokeAlarmDetail":break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,
d,"SMOKE_DETECTOR_ALARM_STATUS")},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "smokeState":return 0==a?"off":"on";case "smokeAlarmDetail":if(0==a)return"off";if(1==a)return"primary_alarm";if(2==a)return"intrusion_alarm";if(3==a)return"secondary_alarm";break;default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "SMOKE_DETECTOR_ALARM_STATUS":a=[];var b="smokeState";c=this.handleStatusResponse(d+"",{value:b});a.push({key:b,value:c});b="smokeAlarmDetail";
c=this.handleStatusResponse(d+"",{value:b});a.push({key:b,value:c});return a}if(!b)return null;c=this.handleStatusResponse(d+"",{value:b});return{key:b,value:c}}},DIMMER_TRANSMITTER:{buildStateScript:function(a,c,d,b){if(!b.value)return null;switch(b.value){case "dimmerTLevel":a="LEVEL";break;case "dimmerTColor":a="COLOR";break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,d,a)},handleStatusResponse:function(a,c){if("?"==a)return a;switch(c.value){case "dimmerTLevel":return a=parseFloat(a),
Math.round(100*a);case "dimmerTColor":return a=parseFloat(a),"off blue green torqoise red purple yellow white".split(" ")[a];default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "LEVEL":var b="dimmerTLevel";break;case "COLOR":b="dimmerTColor"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}}},DIMMER_VIRTUAL_RECEIVER:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;var f=null,l=null;f=l=null;switch(b.value){case "dimOn":f=
"LEVEL";l="if(o!=null){o.State(1.005);}\n";break;case "dimOff":f="LEVEL";l="if(o!=null){o.State(0.0);}\n";break;case "dimUp":l=null==b.ext||"undefined"==typeof b.ext?.1:"number"==typeof b.ext?(parseInt(b.ext)/100).toFixed(2):b.ext.match(/^[-+]?[0-9]+$/)?(parseInt(b.ext)/100).toFixed(2):.1;a._statebuffer&&(f=this.getBufferedState(a._statebuffer,c,d,{value:"dimmerLevel"}));l=null==f||"undefined"==typeof f?"if(o!=null){var v=o.Value()+"+l+";if(v>1){v=1.0;}o.State(v);}\n":"if(o!=null){var v="+f/100+"+"+
l+";if(v>1){v=1.0;}o.State(v);}\n";f="LEVEL";break;case "dimDown":l=null==b.ext||"undefined"==typeof b.ext?.1:"number"==typeof b.ext?(parseInt(b.ext)/100).toFixed(2):b.ext.match(/^[-+]?[0-9]+$/)?(parseInt(b.ext)/100).toFixed(2):.1;a._statebuffer&&(f=this.getBufferedState(a._statebuffer,c,d,{value:"dimmerLevel"}));l=null==f||"undefined"==typeof f?"if(o!=null){var v=o.Value()-"+l+";if(v<0){v=0.0;}o.State(v);}\n":"if(o!=null){var v="+f/100+"-"+l+";if(v<0){v=0.0;}o.State(v);}\n";f="LEVEL";break;case "dimTo":if(null==
b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)l=parseInt(b.ext);else if(b.ext.match(/^[-+]?[0-9]+$/))l=b.ext;else return null;f="LEVEL";l/=100;l=0>l?0:l;l="if(o!=null){o.State("+(1<l?1:l)+");}\n";break;case "toggleTo":if(null==b.ext||"undefined"==typeof b.ext)return null;if("number"==typeof b.ext)l=parseInt(b.ext);else if("string"==typeof b.ext)l=b.ext.replace("%",""),l=parseInt(l);else return null;f="LEVEL";l/=100;l=0>l?0:l;l="if(o!=null){var v=0.0;real des = 0.0+o.Value(); if(des == 0.0){v="+
(1<l?1:l).toFixed(2)+";o.State(v);}else{o.State(v);}}\n";break;case "color":if(null==b.ext||"undefined"==typeof b.ext)return null;switch(b.ext){case "off":l=0;break;case "blue":l=1;break;case "green":l=2;break;case "torqoise":l=3;break;case "red":l=4;break;case "purple":l=5;break;case "yellow":l=6;break;case "white":l=7}f="COLOR";l="if(o!=null){o.State("+l+");}\n";break;case "colorPlay":case "colorPlayList":var m=[],p=[];if(!b.ext)return null;for(a=0;a<b.ext.length;a++)if(l=b.ext[a])switch(l.value){case "colorList":var t=
l.ext;break;case "colorOnTime":var q=l.ext;break;case "colorLevel":var v=parseInt(l.ext);break;case "colorDur":var x=parseInt(l.ext);break;case "colorDurUnit":var y=l.ext;break;case "colorRepeat":var A=parseInt(l.ext)}if("undefined"==typeof t||null==t||"undefined"==typeof v||null==v||"undefined"==typeof x||null==x||"undefined"==typeof y||null==y||"undefined"==typeof A||null==A||"undefined"==typeof q||null==q)return null;"colorPlay"==b.value?(p.push("100MS 200MS 300MS 400MS 500MS 700MS 1S 2S 3S 5S 7S 10S 20S 40S 50S ALWAYS".split(" ").indexOf(q)),
...
switch(b.value){case "setLine":if(!b.ext)return null;for(a=0;a<b.ext.length;a++){var f=b.ext[a];if(f)switch(f.value){case "line":var l=f.ext;break;case "text":var m=f.ext;break;case "textAlign":var p=f.ext;break;case "textColor":var t=f.ext;break;case "bgColor":var q=f.ext;break;case "icon":var v=parseInt(f.ext)}}if(!(l&&p&&t&&q)||isNaN(v))return null;p=p.toUpperCase();t=t.toUpperCase();q=q.toUpperCase();b="{DDBC="+q+",DDTC="+t+",DDI="+v+",DDA="+p+",DDS="+m+",DDID="+l+",DDC=true}";l="";c=xnm.aio.hm.MHMCCU._getDataPointAddress(c,
d,"COMBINED_PARAMETER");return l+('dom.GetObject("'+c+'").State("'+b+'");\n');case "setSound":if(!b.ext)return null;for(a=0;a<b.ext.length;a++)if(f=b.ext[a])switch(f.value){case "sound":var x=parseInt(f.ext);break;case "repeat":var y=parseInt(f.ext);break;case "interval":var A=parseInt(f.ext)}if(isNaN(x)||isNaN(y)||isNaN(A))return null;b="{R="+y+",IN="+A+",ANS="+x+"}";l="";c=xnm.aio.hm.MHMCCU._getDataPointAddress(c,d,"COMBINED_PARAMETER");return l+('dom.GetObject("'+c+'").State("'+b+'");\n');default:return null}}},
...
"",{value:b});return{key:b,value:a}}},RAIN_DETECTION_TRANSMITTER:{buildStateScript:function(a,c,d,b){return c.channels&&b.value?(a={temperature:"ACTUAL_TEMPERATURE",sensorHeater:"HEATER_STATE",raining:"RAINING"}[b.value])?xnm.aio.hm.Channel.buildStateScript(c,d,a):null:null},handleStatusResponse:function(a,c){if("?"===a)return a;var d="?";switch(c.value){case "temperature":d=parseFloat(a);break;case "sensorHeater":"true"==a?d="on":"false"==a&&(d="off");break;case "raining":d=a}return d},resolveState:function(a,
c,d){a={ACTUAL_TEMPERATURE:"temperature",HEATER_STATE:"sensorHeater",RAINING:"raining"}[c.datapoint];if(!a)return null;d=this.handleStatusResponse(String(d),{value:a});return{key:a,value:d}}}};
...
xnm.aio.hm.HmIPDevice=function(){var a=function(){var h=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanaceHsstype=null;this._chKeyTransceivers=[]};h.prototype.getAddress=function(){var e=this._address.indexOf(":");return-1!=e?this._address.substr(0,e):this._address};h.prototype.getCommandStatusMap=function(){var e={status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",
options:["false","true"]}}]};if("HmIP-BRC2"==this._type||"HmIP-MOD-OC"==this._type.substr(0,11))e.status=[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}];"HmIP-RCV-50"==this._type&&(e.command=[{type:"enum",name:"short press",ref:{value:"pressShort"}},{type:"enum",name:"long press",ref:{value:"pressLong"}}]);return e};h.prototype.getIPEvtMap=function(){var e={ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},
{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false","true"]}}]};if("HmIP-BRC2"==this._type||"HmIP-MOD-OC"==this._type.substr(0,11))e.ipevt=[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}];if(1==this._chKeyTransceivers.length)e.ipevt.push({type:"enum",name:"short press",ref:{value:"pressShort",options:["true"]}}),e.ipevt.push({type:"enum",name:"long press",ref:{value:"pressLong",options:["true"]}});else for(var g=0;g<this._chKeyTransceivers.length;g++){var k=
this._chKeyTransceivers[g];k&&(e.ipevt.push({type:"enum",name:"button "+k+" short press",ref:{value:"btn"+k+"pressShort",options:["true"]}}),e.ipevt.push({type:"enum",name:"button "+k+" long press",ref:{value:"btn"+k+"pressLong",options:["true"]}}))}return e};h.prototype.executeCommand=function(e,g,k,n){if(k){var r=null;g={interface:g.interface,address:this.getAddress(),channels:g.channels,type:g.type};if(1==this._chKeyTransceivers.length)r=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.buildCommandScript(e,
g,{address:this._chKeyTransceivers[0]},k);else if("btn"==k.value.substr(0,3)){var u=k.value.indexOf("press"),E=k.value.substr(3,u);E=parseInt(E);-1!=this._chKeyTransceivers.indexOf(E)&&(r=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.buildCommandScript(e,g,{address:E},{value:k.value.substr(u)}))}r?e._doRequestMarked(r,!0,{execute:function(K,N){setTimeout(function(){n&&n(K)},200)}}):n&&n(Error("invalid command"))}else n&&n(Error("command is null"))};h.prototype.buildStateScript=function(e,g,k){if(!k)return null;
var n=null;switch(k.value){case "errorComm":case "errorBat":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(e,g,{address:0},k)}return n};h.prototype.handleStatusResponse=function(e,g){if("?"==e)return e;switch(g.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(e,g);default:return"?"}};h.prototype.resolveState=function(e,g,k){if(!g||!g.channel)return null;var n=g.channel.indexOf(":");if(-1==n)return null;n=g.channel.substr(n+1);var r=null;
switch(n){case "0":r=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(e,g,k);break;default:-1!=this._chKeyTransceivers.indexOf(parseInt(n))&&(r=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(e,g,k),1<this._chKeyTransceivers.length&&r&&("pressShort"==r.key?r.key="btn"+n+"pressShort":"pressLong"==r.key&&(r.key="btn"+n+"pressLong")))}return r};h.parseJSON=function(e){if(!e||!e.type||!e.channels)return null;var g=new h;g._type=e.type;g._address=e.address;for(var k in e.channels){var n=e.channels[k];
0==n.address?g._chMaintenanaceHsstype=k:"KEY_TRANSCEIVER"==k&&g._chKeyTransceivers.push(parseInt(n.address))}return g};return h}(),c=function(){var h=function(){this._switchIdx=0;this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=null;this._chKeyTransceivers=[];this._chSwitchTransmitter=1;this._chSwitchVirtualReceiver1=2;this._chSwitchVirtualReceiver2=3;this._chSwitchVirtualReceiver3=4;this._chSwitchWeekProfile=17};h.prototype._getCommonMap=function(){for(var e={command:[{type:"enum",
...
name:"ch."+g[k]+" on",ref:{value:"ch"+g[k]+"on"}}),e.command.push({type:"enum",name:"ch."+g[k]+" off",ref:{value:"ch"+g[k]+"off"}}),e.command.push({type:"enum",name:"ch."+g[k]+" toggle",ref:{value:"ch"+g[k]+"toggle"}}),e.command.push({type:"float",name:"ch."+g[k]+" on for",ref:{value:"ch"+g[k]+"onFor",ext:"%f",unit:"s"}}),e.status.push({type:"enum",name:"ch."+g[k]+" status",ref:{value:"ch"+g[k]+"State",options:["off","on"]}});return e};h.prototype.getAddress=function(){var e=this._address.indexOf(":");
return-1!=e?this._address.substr(0,e):this._address};h.prototype.getCommandStatusMap=function(){var e=JSON.parse(JSON.stringify(this._getCommonMap()));this._chSwitchWeekProfile&&(e.command.push({type:"enum",name:"set profile",ref:{value:"setProfile",ext:"%e",extMeta:["auto","manu"]}}),e.status.push({type:"enum",name:"profile",ref:{value:"profile",extMeta:["auto","manu"]}}));"HmIP-PCBS"==this._type.substr(0,9)&&e.status.push({type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",
extMeta:"0.0-25.2"}});return e};h.prototype.getIPEvtMap=function(){var e={ipevt:JSON.parse(JSON.stringify(this._getCommonMap())).status};"HmIP-PCBS"==this._type.substr(0,9)&&e.ipevt.push({type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}});if(this._chKeyTransceivers&&0<this._chKeyTransceivers.length){var g=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.getIPEvtMap(this._chKeyTransceivers);g&&g.ipevt&&(e.ipevt=e.ipevt.concat(g.ipevt))}return e};h.prototype.useStateBuffer=
function(){return"HmIPW-DRS"==this._type.substr(0,9)||"HmIP-DRSI"==this._type.substr(0,9)||"HmIP-PCBS"==this._type.substr(0,9)||"HmIP-MOD-OC"==this._type.substr(0,11)?!0:!1};h.prototype.executeCommand=function(e,g,k,n){if(k){var r=null,u={interface:g.interface,address:this.getAddress(),channels:g.channels};if("setProfile"==k.value)this._chSwitchWeekProfile&&(r={value:"setProfile",ext:[{value:"mode",ext:k.ext},{value:"channels",ext:1<<3*this._switchIdx}]},r=xnm.aio.hm.HmIPChannel.SWITCH_WEEK_PROFILE.buildCommandScript(e,
u,{address:this._chSwitchWeekProfile},r));else{var E=this._chSwitchVirtualReceiver1;r=JSON.parse(JSON.stringify(k));if("ch"==k.value.substr(0,2)){var K="ch"+this._chSwitchVirtualReceiver1,N="ch"+this._chSwitchVirtualReceiver2,F="ch"+this._chSwitchVirtualReceiver3;k.value.substr(0,K.length)==K?(E=this._chSwitchVirtualReceiver1,r.value=k.value.substr(K.length)):k.value.substr(0,N.length)==N?(E=this._chSwitchVirtualReceiver2,r.value=k.value.substr(N.length)):k.value.substr(0,F.length)==F&&(E=this._chSwitchVirtualReceiver3,
r.value=k.value.substr(F.length))}r=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(e,u,{address:E},r)}if(r){var H=this;e._doRequestMarked(r,!0,{execute:function(R,T){R||H._handleCommandResponse(e,g,k,T);n&&n(R)}})}else n&&n(Error("invalid command"))}else n&&n(Error("command is null"))};h.prototype._handleCommandResponse=function(e,g,k,n){if(this.useStateBuffer())switch(g=this.getAddress()+":"+this._chSwitchTransmitter+".STATE",k.value){case "on":e._statebuffer[g]={value:"on",timestamp:(new Date).getTime(),
expire:4E3};break;case "off":e._statebuffer[g]={value:"off",timestamp:(new Date).getTime(),expire:4E3};break;case "toggle":e._statebuffer[g]&&e._statebuffer[g].value&&(e._statebuffer[g]="on"==e._statebuffer[g].value?{value:"off",timestamp:(new Date).getTime(),expire:4E3}:{value:"on",timestamp:(new Date).getTime(),expire:4E3});break;case "onFor":k=1E3*parseFloat(k.ext),e._statebuffer[g]={value:"on",timestamp:(new Date).getTime(),expire:k}}};h.prototype.getBufferedState=function(e,g,k){if(!this.useStateBuffer()||
!k||!k.value||"switchState"!=k.value)return null;g=this.getAddress()+":"+this._chSwitchTransmitter+".STATE";if(!e._statebuffer[g])return null;k=e._statebuffer[g];if("undefined"==typeof k.value||null==k.value||!k.timestamp)return delete e._statebuffer[g],null;var n=k.timestamp,r=k.expire;r||(r=1E3);return(new Date).getTime()>n+r?(delete e._statebuffer[g],null):k.value};h.prototype.buildStateScript=function(e,g,k){if(!k)return null;var n=null;g={interface:g.interface,address:this.getAddress(),channels:g.channels};
switch(k.value){case "errorComm":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(e,g,{address:this._chMaintenance},k);break;case "errorBatElVoltage":n=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(e,g,{address:this._chMaintenance},k);break;case "switchState":n=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.buildStateScript(e,g,{address:this._chSwitchTransmitter},{value:"switchTState"});break;case "ch"+this._chSwitchVirtualReceiver1+"State":n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildStateScript(e,
...
g,{address:this._chSwitchWeekProfile},{value:"profile"})}return n};h.prototype.handleStatusResponse=function(e,g,k){if("?"==e)return e;switch(g.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(e,g);case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(e,g);case "switchState":return e=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.handleStatusResponse(e,{value:"switchTState"}),this.useStateBuffer()&&(g=this.getAddress()+":"+
this._chSwitchTransmitter+".STATE",k._statebuffer[g]={value:e,timestamp:(new Date).getTime(),expire:1E3}),e;case "ch"+this._chSwitchVirtualReceiver1+"State":case "ch"+this._chSwitchVirtualReceiver2+"State":case "ch"+this._chSwitchVirtualReceiver3+"State":return e=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.handleStatusResponse(e,{value:"switchState"});case "profile":return e=xnm.aio.hm.HmIPChannel.SWITCH_WEEK_PROFILE.handleStatusResponse(e,{value:"profile"}),"?"!=e&&(e=e>>3*this._switchIdx&1?"manu":
"auto"),e;default:return"?"}};h.prototype.resolveState=function(e,g,k){if(!g||!g.channel)return null;var n=g.channel.indexOf(":");if(-1==n)return null;var r=g.channel.substr(n+1);n=null;switch(parseInt(r)){case this._chMaintenance:n="HmIP-PCBS"==this._type.substr(0,9)?xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(e,g,k):xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(e,g,k);break;case this._chSwitchTransmitter:if(n=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.resolveState(e,g,k))n.key="switchState";
break;case this._chSwitchVirtualReceiver1:case this._chSwitchVirtualReceiver2:case this._chSwitchVirtualReceiver3:if(n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.resolveState(e,g,k))n.key="ch"+r+"State";break;case this._chSwitchWeekProfile:if(n=xnm.aio.hm.HmIPChannel.SWITCH_WEEK_PROFILE.resolveState(e,g,k))e=n.profile,"?"!=e&&(n.profile=e>>3*this._switchIdx&1?"manu":"auto");break;default:-1!=this._chKeyTransceivers.indexOf(parseInt(r))&&(n=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(e,
g,k),1<this._chKeyTransceivers.length&&n&&("pressShort"==n.key?n.key="btn"+r+"pressShort":"pressLong"==n.key&&(n.key="btn"+r+"pressLong")))}return n};h.parseJSON=function(e,g,k,n){if(!e||!e.type||!e.channels)return null;var r=new h;r._type=e.type;r._address=e.address;var u=r._chSwitchWeekProfile=0,E;for(E in e.channels)"KEY_TRANSCEIVER"==E.substr(0,15)&&n?r._chKeyTransceivers.push(parseInt(e.channels[E].address)):"SWITCH_TRANSMITTER"==E.substr(0,18)?r._chSwitchTransmitter=parseInt(e.channels[E].address):
"SWITCH_VIRTUAL_RECEIVER"==E.substr(0,23)?(u++,1==u?r._chSwitchVirtualReceiver1=parseInt(e.channels[E].address):2==u?r._chSwitchVirtualReceiver2=parseInt(e.channels[E].address):3==u&&(r._chSwitchVirtualReceiver3=parseInt(e.channels[E].address))):"SWITCH_WEEK_PROFILE"==E.substr(0,19)&&(r._chSwitchWeekProfile=parseInt(e.channels[E].address));if(g&&k&&r._chSwitchTransmitter){e=[];for(n=0;n<k;n++)e.push(g+4*n);g=e.indexOf(r._chSwitchTransmitter);-1!=g&&(r._switchIdx=g)}return r};return h}(),d=function(){var h=
function(){c.call(this);this._chEnergieMeterTransmitter=0};h.prototype=new c;h.prototype.constructor=h;h.prototype.getCommandStatusMap=function(){var e=c.prototype.getCommandStatusMap.call(this);if(!e)return null;var g=xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.getCommandStatusMap();g&&g.status&&(e.status=e.status?e.status.concat(g.status):g.status);return e};h.prototype.getIPEvtMap=function(){var e=c.prototype.getIPEvtMap.call(this);if(!e)return null;var g=xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.getIPEvtMap();
g&&g.ipevt&&(e.ipevt=e.ipevt?e.ipevt.concat(g.ipevt):g.ipevt);return e};h.prototype.buildStateScript=function(e,g,k){if(!k)return null;switch(k.value){case "meterVoltage":case "meterEnergyCounter":case "meterFrequency":case "meterPower":case "meterCurrent":e=xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.buildStateScript(e,g,{address:this._chEnergieMeterTransmitter},k);break;default:e=c.prototype.buildStateScript.call(this,e,g,k)}return e};h.prototype.handleStatusResponse=function(e,g,k){if("?"==
e)return e;switch(g.value){case "meterVoltage":case "meterEnergyCounter":case "meterFrequency":case "meterPower":case "meterCurrent":return xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.handleStatusResponse(e,g);default:return c.prototype.handleStatusResponse.call(this,e,g,k)}};h.prototype.resolveState=function(e,g,k){if(!g||!g.channel)return null;var n=g.channel.indexOf(":");if(-1==n)return null;n=g.channel.substr(n+1);switch(parseInt(n)){case this._chEnergieMeterTransmitter:e=xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.resolveState(e,
g,k);break;default:return c.prototype.resolveState.call(this,e,g,k)}return e};h.parseJSON=function(e,g){if(!e||!e.type||!e.channels)return null;g=c.parseJSON(e,null,null,g);if(!g)return null;var k=new h;k._switchIdx=g._switchIdx;k._type=g._type;k._address=g._address;k._chMaintenance=g._chMaintenance;k._chMaintenanceHsstype=g._chMaintenanceHsstype;k._chKeyTransceivers=g._chKeyTransceivers;k._chSwitchTransmitter=g._chSwitchTransmitter;k._chSwitchVirtualReceiver1=g._chSwitchVirtualReceiver1;k._chSwitchVirtualReceiver2=
g._chSwitchVirtualReceiver2;k._chSwitchVirtualReceiver3=g._chSwitchVirtualReceiver3;k._chSwitchWeekProfile=g._chSwitchWeekProfile;for(var n in e.channels)"ENERGIE_METER_TRANSMITTER"==n.substr(0,25)&&(k._chEnergieMeterTransmitter=parseInt(e.channels[n].address));return k};return h}(),b=function(){var h=function(){this._dimmerIdx=0;this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=null;this._chDimmerTransmitter=1;this._chDimmerVirtualReceiver1=2;this._chDimmerVirtualReceiver2=
3;this._chDimmerVirtualReceiver3=4;this._chDimmerWeekProfile=13};h.prototype._getCommonMap=function(){var e=function(k,n){k.command.push({type:"enum",name:"ch."+n+" on",ref:{value:"ch"+n+"dimOn"}});k.command.push({type:"enum",name:"ch."+n+" off",ref:{value:"ch"+n+"dimOff"}});k.command.push({type:"int",name:"ch."+n+" dim up",ref:{value:"ch"+n+"dimUp",ext:"%d",extMeta:"1-100",unit:"%"}});k.command.push({type:"int",name:"ch."+n+" dim down",ref:{value:"ch"+n+"dimDown",ext:"%d",extMeta:"1-100",unit:"%"}});
k.command.push({type:"int",name:"ch."+n+" dim to",ref:{value:"ch"+n+"dimTo",ext:"%d",extMeta:"1-100",unit:"%"}});k.command.push({type:"int",name:"ch."+n+" toggle to",ref:{value:"ch"+n+"toggleTo",ext:"%d",extMeta:"1-100",unit:"%"}});k.status.push({type:"int",name:"ch."+n+" status",ref:{value:"ch"+n+"Level",extMeta:"0-100",unit:"%"}})},g={command:[{type:"enum",name:"on",ref:{value:"dimOn"}},{type:"enum",name:"off",ref:{value:"dimOff"}},{type:"int",name:"dim up",ref:{value:"dimUp",ext:"%d",extMeta:"1-100",
...
e(g,this._chDimmerVirtualReceiver3);return g};h.prototype.getAddress=function(){var e=this._address.indexOf(":");return-1!=e?this._address.substr(0,e):this._address};h.prototype.getCommandStatusMap=function(){var e=this._getCommonMap();this._chDimmerWeekProfile&&(e.command.push({type:"enum",name:"set profile",ref:{value:"setProfile",ext:"%e",extMeta:["auto","manu"]}}),e.status.push({type:"enum",name:"profile",ref:{value:"profile",extMeta:["auto","manu"]}}));return e};h.prototype.getIPEvtMap=function(){return{ipevt:this._getCommonMap().status}};
h.prototype.useStateBuffer=function(){return"HmIPW-DRD"==this._type.substr(0,9)||"HmIP-DRDI"==this._type.substr(0,9)?!0:!1};h.prototype.executeCommand=function(e,g,k,n){if(k){var r={value:k.value,ext:k.ext},u=this._chDimmerVirtualReceiver1;if("ch"==k.value.substr(0,2)){var E=k.value.indexOf("dim");-1==E&&(E=k.value.indexOf("toggle"));if(-1==E){n&&n(Error("invalid command"));return}u=parseInt(k.value.substr(2,E));r.value=k.value.substr(E);if(u!=this._chDimmerVirtualReceiver1&&u!=this._chDimmerVirtualReceiver2&&
u!=this._chDimmerVirtualReceiver3){n&&n(Error("invalid command"));return}}E=null;var K={interface:g.interface,address:this.getAddress(),channels:g.channels};"setProfile"==k.value?this._chDimmerWeekProfile&&(r={value:"setProfile",ext:[{value:"mode",ext:k.ext},{value:"channels",ext:1<<3*this._dimmerIdx}]},E=xnm.aio.hm.HmIPChannel.DIMMER_WEEK_PROFILE.buildCommandScript(e,K,{address:this._chDimmerWeekProfile},r)):E=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(e,K,{address:u},r);if(E){var N=
this;e._doRequestMarked(E,!0,{execute:function(F,H){F||N._handleCommandResponse(e,g,k,H);n&&n(F)}})}else n&&n(Error("invalid command"))}else n&&n(Error("command is null"))};h.prototype._handleCommandResponse=function(e,g,k,n){if(this.useStateBuffer()){g=null;var r=n.indexOf("<v>");if(-1!=r){var u=n.indexOf("</v>");-1!=u&&(n=n.substring(r+3,u),g=Math.round(100*parseFloat(n)))}n=this.getAddress()+":"+this._chDimmerTransmitter+".LEVEL";switch(k.value){case "dimOn":delete e._statebuffer[n];break;case "dimOff":e._statebuffer[n]=
{value:0,timestamp:(new Date).getTime(),expire:3E3};break;case "dimUp":null!=g&&(e._statebuffer[n]={value:g,timestamp:(new Date).getTime(),expire:3E3});break;case "dimDown":null!=g&&(e._statebuffer[n]={value:g,timestamp:(new Date).getTime(),expire:3E3});break;case "dimTo":g=parseInt(k.ext);null!=g&&(e._statebuffer[n]={value:g,timestamp:(new Date).getTime(),expire:3E3});break;case "toggleTo":null!=g&&(e._statebuffer[n]={value:g,timestamp:(new Date).getTime(),expire:3E3})}}};h.prototype.getBufferedState=
function(e,g,k){if(!this.useStateBuffer()||!k||!k.value||"dimmerTLevel"!=k.value)return null;g=this.getAddress()+":"+this._chDimmerTransmitter+".LEVEL";if(!e._statebuffer[g])return null;k=e._statebuffer[g];if("undefined"==typeof k.value||null==k.value||!k.timestamp)return delete e._statebuffer[g],null;var n=k.timestamp,r=k.expire;r||(r=1E3);return(new Date).getTime()>n+r?(delete e._statebuffer[g],null):k.value};h.prototype.buildStateScript=function(e,g,k){if(!k)return null;var n=null,r={interface:g.interface,
address:this.getAddress(),channels:g.channels};switch(k.value){case "errorComm":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(e,r,{address:this._chMaintenance},k);break;case "dimmerTLevel":n="HmIPW-DRD"!==this._type.substr(0,9)&&"HmIP-DRDI"!==this._type.substr(0,9)||"number"!==typeof this._chDimmerVirtualReceiver1?xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.buildStateScript(e,r,{address:this._chDimmerTransmitter},{value:"dimmerTLevel"}):xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(e,
...
xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(e,g,{address:this._chDimmerVirtualReceiver3},{value:"dimmerLevel"});break;case "profile":n=xnm.aio.hm.HmIPChannel.DIMMER_WEEK_PROFILE.buildStateScript(e,r,{address:this._chDimmerWeekProfile},{value:"profile"})}return n};h.prototype.handleStatusResponse=function(e,g,k){if("?"==e)return e;switch(g.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(e,g);case "dimmerTLevel":return e=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(e,
{value:"dimmerTLevel"}),this.useStateBuffer()&&(g=this.getAddress()+":"+this._chDimmerTransmitter+".LEVEL",k._statebuffer[g]={value:e,timestamp:(new Date).getTime(),expire:1E3}),e;case "ch"+this._chDimmerVirtualReceiver1+"Level":case "ch"+this._chDimmerVirtualReceiver2+"Level":case "ch"+this._chDimmerVirtualReceiver3+"Level":return xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.handleStatusResponse(e,{value:"dimmerLevel"});case "profile":return e=xnm.aio.hm.HmIPChannel.DIMMER_WEEK_PROFILE.handleStatusResponse(e,
{value:"profile"}),"?"!=e&&(e=e>>3*this._dimmerIdx&1?"manu":"auto"),e;default:return"?"}};h.prototype.resolveState=function(e,g,k){if(!g||!g.channel)return null;var n=g.channel.indexOf(":");if(-1==n)return null;var r=g.channel.substr(n+1);n=null;switch(parseInt(r)){case this._chMaintenance:n=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(e,g,k);break;case this._chDimmerTransmitter:n=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.resolveState(e,g,k);break;case this._chDimmerVirtualReceiver1:case this._chDimmerVirtualReceiver2:case this._chDimmerVirtualReceiver3:if(n=
xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.resolveState(e,g,k))n.key="ch"+r+"Level";break;case this._chDimmerWeekProfile:if(n=xnm.aio.hm.HmIPChannel.DIMMER_WEEK_PROFILE.resolveState(e,g,k))e=n.profile,"?"!=e&&(n.profile=e>>3*this._dimmerIdx&1?"manu":"auto")}return n};h.parseJSON=function(e,g,k){if(!e||!e.type||!e.channels)return null;var n=new h;n._type=e.type;n._address=e.address;var r=n._chDimmerWeekProfile=0,u;for(u in e.channels)"DIMMER_TRANSMITTER"==u.substr(0,18)?n._chDimmerTransmitter=
parseInt(e.channels[u].address):"DIMMER_VIRTUAL_RECEIVER"==u.substr(0,23)?(r++,1==r?n._chDimmerVirtualReceiver1=parseInt(e.channels[u].address):2==r?n._chDimmerVirtualReceiver2=parseInt(e.channels[u].address):3==r&&(n._chDimmerVirtualReceiver3=parseInt(e.channels[u].address))):"DIMMER_WEEK_PROFILE"==u.substr(0,19)&&(n._chDimmerWeekProfile=parseInt(e.channels[u].address));if(g&&k&&n._chSwitchTransmitter){e=[];for(r=0;r<k;r++)e.push(g+4*r);g=e.indexOf(n._chDimmerTransmitter);-1!=g&&(n._dimmerIdx=g)}return n};
return h}(),f=function(){var h=function(){this._blindIdx=0;this._address=this._type=null;this._chMaintenance=0;this._chBlindTransmitter=1;this._chBlindVirtualReceiver1=2;this._chBlindVirtualReceiver2=3;this._chBlindVirtualReceiver3=4;this._chBlindWeekProfile=17};h.prototype._getCommonMap=function(){return{command:[{type:"enum",name:"stop",ref:{value:"stop"}},{type:"enum",name:"move up",ref:{value:"moveUp"}},{type:"enum",name:"move down",ref:{value:"moveDown"}},{type:"int",name:"step up",ref:{value:"stepUp",
...
unit:"%"}},{type:"int",name:"lamella to",ref:{value:"lamellaTo",ext:"%d",extMeta:"0-100",unit:"%"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"int",name:"blind status",ref:{value:"blindTPos",extMeta:"0-100",unit:"%"}},{type:"int",name:"lamella status",ref:{value:"lamellaTPos",extMeta:"0-100",unit:"%"}}]}};h.prototype.getAddress=function(){var e=this._address.indexOf(":");return-1!=e?this._address.substr(0,e):this._address};h.prototype.getCommandStatusMap=
function(){var e=this._getCommonMap();if("HMIP-DRBLI4"===String(this._type).toUpperCase()){var g=[this._chBlindVirtualReceiver1,this._chBlindVirtualReceiver2,this._chBlindVirtualReceiver3];e.command=[];g.forEach(function(k){var n=[{type:"enum",name:"stop",ref:{value:"stop"}},{type:"enum",name:"move up",ref:{value:"moveUp"}},{type:"enum",name:"move down",ref:{value:"moveDown"}},{type:"int",name:"step up",ref:{value:"stepUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"step down",ref:{value:"stepDown",
ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"move to",ref:{value:"moveTo",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"enum",name:"lamella up",ref:{value:"lamellaUp"}},{type:"enum",name:"lamella down",ref:{value:"lamellaDown"}},{type:"int",name:"lamella step up",ref:{value:"lamellaStepUp",ext:"%d",extMeta:"1-10",unit:"%"}},{type:"int",name:"lamella step down",ref:{value:"lamellaStepDown",ext:"%d",extMeta:"1-10",unit:"%"}},{type:"int",name:"lamella to",ref:{value:"lamellaTo",ext:"%d",extMeta:"0-100",
unit:"%"}}];n.forEach(function(u){u.name="ch. "+k+": "+u.name;u.ref.value_t="ch"+k+u.ref.value;u.ref.value="ch"+k+"_"+u.ref.value});var r=[{type:"int",name:"blind status",ref:{value:"blindTPos",extMeta:"0-100",unit:"%"}},{type:"int",name:"lamella status",ref:{value:"lamellaTPos",extMeta:"0-100",unit:"%"}}];r.forEach(function(u){u.name="ch. "+k+": "+u.name;u.ref.value_t="ch"+k+u.ref.value;u.ref.value="ch"+k+"_"+u.ref.value});e.command=e.command.concat(n);e.status=e.status.concat(r)})}this._chBlindWeekProfile&&
(e.command.push({type:"enum",name:"set profile",ref:{value:"setProfile",ext:"%e",extMeta:["auto","manu"]}}),e.status.push({type:"enum",name:"profile",ref:{value:"profile",extMeta:["auto","manu"]}}));return e};h.prototype.getIPEvtMap=function(){return{ipevt:JSON.parse(JSON.stringify(this._getCommonMap())).status}};h.prototype.executeCommand=function(e,g,k,n){if(k){if("setProfile"==k.value)this._chBlindWeekProfile&&(k={value:"setProfile",ext:[{value:"mode",ext:k.ext},{value:"channels",ext:1<<3*this._blindIdx}]},
script=xnm.aio.hm.HmIPChannel.BLIND_WEEK_PROFILE.buildCommandScript(e,{interface:g.interface,address:this.getAddress(),channels:g.channels},{address:this._chBlindWeekProfile},k));else{var r=this._chBlindVirtualReceiver1,u=k.value;if("HMIP-DRBLI4"===String(this._type).toUpperCase()&&k.value.startsWith("ch")){var E=k.value.match(/^ch([0-9]+)_/);E&&(r=E[1],u=k.value.replace(/^ch([0-9]+)_/,""))}script=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildCommandScript(e,{interface:g.interface,address:this.getAddress(),
channels:g.channels},{address:r},{value:u,ext:k.ext})}script?e._doRequestMarked(script,!0,{execute:function(K,N){setTimeout(function(){n&&n(K)},200)}}):n&&n(Error("invalid command"))}else n&&n(Error("command is null"))};h.prototype.buildStateScript=function(e,g,k){if(!k)return null;var n=null;g={interface:g.interface,address:this.getAddress(),channels:g.channels};var r=this._chBlindTransmitter,u=k.value;if("HMIP-DRBLI4"===String(this._type).toUpperCase()){var E=k.value.match(/^ch([0-9]+)_/);E&&(r=
E[1],u=k.value.replace(/^ch([0-9]+)_/,""))}switch(u){case "errorComm":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(e,g,{address:this._chMaintenance},k);break;case "blindTPos":n=xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.buildStateScript(e,g,{address:r},{value:"blindTPos"});break;case "lamellaTPos":n=xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.buildStateScript(e,g,{address:r},{value:"lamellaTPos"});break;case "profile":n=xnm.aio.hm.HmIPChannel.BLIND_WEEK_PROFILE.buildStateScript(e,g,{address:this._chBlindWeekProfile},
{value:"profile"})}return n};h.prototype.handleStatusResponse=function(e,g){if("?"==e)return e;var k=g.value;"HMIP-DRBLI4"===String(this._type).toUpperCase()&&g.value.match(/^ch([0-9]+)_/)&&(k=g.value.replace(/^ch([0-9]+)_/,""));switch(k){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(e,g);case "blindTPos":return xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.handleStatusResponse(e,{value:"blindTPos"});case "lamellaTPos":return xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.handleStatusResponse(e,
{value:"lamellaTPos"});case "profile":return e=xnm.aio.hm.HmIPChannel.BLIND_WEEK_PROFILE.handleStatusResponse(e,{value:"profile"}),"?"!=e&&(e=e>>3*this._blindIdx&1?"manu":"auto"),e;default:return"?"}};h.prototype.resolveState=function(e,g,k){if(!g||!g.channel)return null;var n=g.channel.indexOf(":");if(-1==n)return null;var r=g.channel.substr(n+1);n=null;switch(parseInt(r)){case this._chMaintenance:n=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(e,g,k);break;case this._chBlindTransmitter:n=xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.resolveState(e,
g,k);break;case this._chBlindWeekProfile:if(n=xnm.aio.hm.HmIPChannel.BLIND_WEEK_PROFILE.resolveState(e,g,k))e=n.profile,"?"!=e&&(n.profile=e>>3*this._blindIdx&1?"manu":"auto")}return n};h.parseJSON=function(e,g,k){if(!e||!e.type||!e.channels)return null;var n=new h;n._type=e.type;n._address=e.address;var r=n._chBlindWeekProfile=0,u;for(u in e.channels)"BLIND_TRANSMITTER"==u.substr(0,17)?n._chBlindTransmitter=parseInt(e.channels[u].address):"BLIND_VIRTUAL_RECEIVER"==u.substr(0,22)?(r++,1==r?n._chBlindVirtualReceiver1=
parseInt(e.channels[u].address):2==r?n._chBlindVirtualReceiver2=parseInt(e.channels[u].address):3==r&&(n._chBlindVirtualReceiver3=parseInt(e.channels[u].address))):"BLIND_WEEK_PROFILE"==u.substr(0,18)&&(n._chBlindWeekProfile=parseInt(e.channels[u].address));if(g&&k&&n._chBlindTransmitter){e=[];for(r=0;r<k;r++)e.push(g+4*r);g=e.indexOf(n._chBlindTransmitter);-1!=g&&(n._blindIdx=g)}return n};return h}(),l=function(){var h=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=
null;this._chInputTransmitter=1};h.prototype.getCommandStatusMap=function(){var e="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?{status:[{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]}:{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false",
"true"]}}]};e.status.push({type:"enum",name:"status",ref:{value:"state",options:["off","on"]}});return e};h.prototype.getIPEvtMap=function(){var e="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]}:{ipevt:[{type:"enum",
name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]};e.ipevt.push({type:"enum",name:"status",ref:{value:"state",options:["off","on"]}});e.ipevt.push({type:"enum",name:"short press",ref:{value:"pressShort",options:["true"]}});e.ipevt.push({type:"enum",name:"long press",ref:{value:"pressLong",options:["true"]}});return e};h.prototype.buildStateScript=function(e,g,k){if(!k)return null;var n=null;switch(k.value){case "errorComm":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(e,
g,{address:this._chMaintenance},k);break;case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":n=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(e,g,{address:this._chMaintenance},k);break;case "state":n=xnm.aio.hm.HmIPChannel.MULTI_MODE_INPUT_TRANSMITTER.buildStateScript(e,g,{address:this._chInputTransmitter},{value:"state"})}return n};h.prototype.handleStatusResponse=function(e,g){if("?"==e)return e;switch(g.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(e,
g);case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(e,g);case "state":return xnm.aio.hm.HmIPChannel.MULTI_MODE_INPUT_TRANSMITTER.handleStatusResponse(e,{value:"state"});default:return"?"}};h.prototype.resolveState=function(e,g,k){if(!g||!g.channel)return null;var n=g.channel.indexOf(":");if(-1==n)return null;n=g.channel.substr(n+1);var r=null;switch(parseInt(n)){case this._chMaintenance:r="MAINTENANCE_BAT_EL"==
this._chMaintenanceHsstype?xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(e,g,k):xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(e,g,k);break;case this._chInputTransmitter:r=xnm.aio.hm.HmIPChannel.MULTI_MODE_INPUT_TRANSMITTER.resolveState(e,g,k)}return r};h.parseJSON=function(e){if(!e||!e.type||!e.channels)return null;var g=new h;g._type=e.type;g._address=e.address;if("HmIP-FCI"==e.type.substr(0,8)||"HmIP-MOD-RC"==e.type.substr(0,11))g._chMaintenanceHsstype="MAINTENANCE_BAT_EL";for(var k in e.channels)"MULTI_MODE_INPUT_TRANSMITTER"==
k.substr(0,28)?g._chInputTransmitter=parseInt(e.channels[k].address):"KEY_TRANSCEIVER"==k.substr(0,15)&&"HmIP-MOD-RC"==e.type.substr(0,11)&&(g._chInputTransmitter=parseInt(e.channels[k].address));return g};return h}(),m=function(){var h=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=null;this._chShutterContact=1;this._chShutterContactHsstype=null};h.prototype.getCommandStatusMap=function(){var e="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?{status:[{type:"enum",
...
options:["open","closed"]}}):e.status.push({type:"enum",name:"status",ref:{value:"shutterState",value_t:"contactState",options:["open","closed"]}});return e};h.prototype.getIPEvtMap=function(){var e="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",
ext:"%f",extMeta:"0.0-25.2"}}]}:{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]};"SHUTTER_CONTACT_TRANSCEIVER"==this._chShutterContactHsstype?e.ipevt.push({type:"enum",name:"status",ref:{value:"shutterTState",value_t:"contactState",options:["open","closed"]}}):e.ipevt.push({type:"enum",name:"status",ref:{value:"shutterState",value_t:"contactState",options:["open","closed"]}});return e};h.prototype.buildStateScript=function(e,g,k){if(!k)return null;
var n=null;switch(k.value){case "errorComm":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(e,g,{address:this._chMaintenance},k);break;case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":n=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(e,g,{address:this._chMaintenance},k);break;case "shutterState":n=xnm.aio.hm.HmIPChannel.SHUTTER_CONTACT.buildStateScript(e,g,{address:this._chShutterContact},{value:"shutterState"});break;case "shutterTState":n=xnm.aio.hm.HmIPChannel.SHUTTER_CONTACT_TRANSCEIVER.buildStateScript(e,
g,{address:this._chShutterContact},{value:"shutterTState"})}return n};h.prototype.handleStatusResponse=function(e,g){if("?"==e)return e;switch(g.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(e,g);case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(e,g);case "shutterState":return xnm.aio.hm.HmIPChannel.SHUTTER_CONTACT.handleStatusResponse(e,{value:"shutterState"});case "shutterTState":return xnm.aio.hm.HmIPChannel.SHUTTER_CONTACT_TRANSCEIVER.handleStatusResponse(e,
{value:"shutterTState"});default:return"?"}};h.prototype.resolveState=function(e,g,k){if(!g||!g.channel)return null;var n=g.channel.indexOf(":");if(-1==n)return null;n=g.channel.substr(n+1);var r=null;switch(parseInt(n)){case this._chMaintenance:r="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(e,g,k):xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(e,g,k);break;case this._chShutterContact:r="SHUTTER_CONTACT_TRANSCEIVER"==this._chShutterContactHsstype?
xnm.aio.hm.HmIPChannel.SHUTTER_CONTACT_TRANSCEIVER.resolveState(e,g,k):xnm.aio.hm.HmIPChannel.SHUTTER_CONTACT.resolveState(e,g,k)}return r};h.parseJSON=function(e){if(!e||!e.type||!e.channels)return null;var g=new h;g._type=e.type;g._address=e.address;"HmIP-SCI"==e.type.substr(0,8)&&(g._chMaintenanceHsstype="MAINTENANCE_BAT_EL");for(var k in e.channels)"SHUTTER_CONTACT_TRANSCEIVER"==k.substr(0,27)?(g._chShutterContact=parseInt(e.channels[k].address),g._chShutterContactHsstype="SHUTTER_CONTACT_TRANSCEIVER"):
"SHUTTER_CONTACT"==k.substr(0,15)&&(g._chShutterContact=parseInt(e.channels[k].address),g._chShutterContactHsstype="SHUTTER_CONTACT");return g};return h}(),p=function(){var h=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=null;this._chHeatingClimateControlTransceiver=1};h.prototype.getCommandStatusMap=function(){var e={command:[{type:"int",name:"set profile",ref:{value:"themoProf",ext:"%d",extMeta:"1-6",scale:"1"}},{type:"enum",name:"boost on",ref:{value:"themoBoostOn"}},
...
name:"window state",ref:{value:"themoWinState",options:["open","closed"]}});e.ipevt="MAINTENANCE_BAT_CL"==this._chMaintenanceHsstype?e.ipevt.concat([{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]):e.ipevt.concat([{type:"enum",name:"communication error",ref:{value:"errorComm",
options:["false","true"]}}]);return e};h.prototype.executeCommand=function(e,g,k,n){k?(script=xnm.aio.hm.HmIPChannel.HEATING_CLIMATECONTROL_TRANSCEIVER.buildCommandScript(e,{interface:g.interface,address:this._address,channels:g.channels},{address:this._chHeatingClimateControlTransceiver},{value:k.value,ext:k.ext}))?e._doRequestMarked(script,!0,{execute:function(r,u){setTimeout(function(){n&&n(r)},200)}}):n&&n(Error("invalid command")):n&&n(Error("command is null"))};h.prototype.buildStateScript=
function(e,g,k){if(!k)return null;var n=null;switch(k.value){case "errorComm":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(e,g,{address:this._chMaintenance},k);break;case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":n=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(e,g,{address:this._chMaintenance},k);break;case "themoProf":case "themoActualTemp":case "themoBoostMode":case "themoFrost":case "themoHum":case "themoMode":case "themoTemp":case "themoValveLevel":case "themoWinState":n=
xnm.aio.hm.HmIPChannel.HEATING_CLIMATECONTROL_TRANSCEIVER.buildStateScript(e,g,{address:this._chHeatingClimateControlTransceiver},{value:k.value})}return n};h.prototype.handleStatusResponse=function(e,g){if("?"==e)return e;switch(g.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(e,g);case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(e,g);case "themoProf":case "themoActualTemp":case "themoBoostMode":case "themoFrost":case "themoHum":case "themoMode":case "themoTemp":case "themoValveLevel":case "themoWinState":return xnm.aio.hm.HmIPChannel.HEATING_CLIMATECONTROL_TRANSCEIVER.handleStatusResponse(e,
g);default:return"?"}};h.prototype.resolveState=function(e,g,k){if(!g||!g.channel)return null;var n=g.channel.indexOf(":");if(-1==n)return null;n=g.channel.substr(n+1);var r=null;switch(parseInt(n)){case this._chMaintenance:r="MAINTENANCE_BAT_CL"==this._chMaintenanceHsstype?xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(e,g,k):xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(e,g,k);break;case this._chHeatingClimateControlTransceiver:r=xnm.aio.hm.HmIPChannel.HEATING_CLIMATECONTROL_TRANSCEIVER.resolveState(e,
g,k)}return r};h.parseJSON=function(e){if(!e||!e.type||!e.channels)return null;var g=new h;g._type=e.type;g._address=e.address;g._chMaintenanceHsstype="MAINTENANCE";"HmIP-WTH-B"==e.type&&(g._chMaintenanceHsstype="MAINTENANCE_BAT_CL");return g};return h}(),t=function(){var h=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype="MAINTENANCE";this._chMotionDetectorTransceiver=1;this._chKeyTransceivers=[]};h.prototype.getCommandStatusMap=function(){var e={command:[{type:"enum",
...
this._chMaintenanceHsstype?e.status.concat([{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]):e.status.concat([{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]);return e};h.prototype.getIPEvtMap=function(){var e={ipevt:[{type:"float",
...
ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]):e.ipevt.concat([{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]);if(1==this._chKeyTransceivers.length)e.ipevt.push({type:"enum",name:"short press",ref:{value:"pressShort",options:["true"]}}),e.ipevt.push({type:"enum",name:"long press",ref:{value:"pressLong",options:["true"]}});else for(var g=0;g<this._chKeyTransceivers.length;g++){var k=this._chKeyTransceivers[g];k&&(e.ipevt.push({type:"enum",
name:"button "+k+" short press",ref:{value:"btn"+k+"pressShort",options:["true"]}}),e.ipevt.push({type:"enum",name:"button "+k+" long press",ref:{value:"btn"+k+"pressLong",options:["true"]}}))}return e};h.prototype.executeCommand=function(e,g,k,n){k?(script=xnm.aio.hm.HmIPChannel.MOTIONDETECTOR_TRANSCEIVER.buildCommandScript(e,{interface:g.interface,address:this._address,channels:g.channels},{address:this._chMotionDetectorTransceiver},{value:k.value,ext:k.ext}))?e._doRequestMarked(script,!0,{execute:function(r,
u){setTimeout(function(){n&&n(r)},200)}}):n&&n(Error("invalid command")):n&&n(Error("command is null"))};h.prototype.buildStateScript=function(e,g,k){if(!k)return null;switch(k.value){case "errorComm":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(e,g,{address:this._chMaintenance},k);break;case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":e=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(e,g,{address:this._chMaintenance},k);break;default:e=xnm.aio.hm.HmIPChannel.MOTIONDETECTOR_TRANSCEIVER.buildStateScript(e,
g,{address:this._chMotionDetectorTransceiver},{value:k.value})}return e};h.prototype.handleStatusResponse=function(e,g){if("?"==e)return e;switch(g.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(e,g);case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(e,g);case "motionIllu":case "motionState":case "motionActivate":return xnm.aio.hm.HmIPChannel.MOTIONDETECTOR_TRANSCEIVER.handleStatusResponse(e,
g);default:return"?"}};h.prototype.resolveState=function(e,g,k){if(!g||!g.channel)return null;var n=g.channel.indexOf(":");if(-1==n)return null;n=g.channel.substr(n+1);var r=null;switch(parseInt(n)){case this._chMaintenance:r="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(e,g,k):xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(e,g,k);break;case this._chMotionDetectorTransceiver:r=xnm.aio.hm.HmIPChannel.MOTIONDETECTOR_TRANSCEIVER.resolveState(e,
g,k);break;default:-1!=this._chKeyTransceivers.indexOf(parseInt(n))&&(r=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(e,g,k),1<this._chKeyTransceivers.length&&r&&("pressShort"==r.key?r.key="btn"+n+"pressShort":"pressLong"==r.key&&(r.key="btn"+n+"pressLong")))}return r};h.parseJSON=function(e){if(!e||!e.type||!e.channels)return null;var g=new h;g._type=e.type;g._address=e.address;"HmIP-SMI55"==e.type&&(g._chMaintenanceHsstype="MAINTENANCE_BAT_EL");-1!=e.type.indexOf("SMI55")&&(g._chKeyTransceivers=
[1,2],g._chMotionDetectorTransceiver=3);return g};return h}(),q=function(){var h=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype="MAINTENANCE";this._chPresenceDetectorTransceiver=1};h.prototype.getCommandStatusMap=function(){var e={command:[{type:"enum",name:"reset",ref:{value:"presenceReset"}},{type:"enum",name:"activate detection",ref:{value:"presenceOn"}},{type:"enum",name:"deactivate detection",ref:{value:"presenceOff"}},{type:"enum",name:"toggle detection",
...
options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]):e.status.concat([{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]);return e};h.prototype.getIPEvtMap=function(){var e={ipevt:[{type:"float",name:"illumination",ref:{value:"presenceIllu"}},{type:"enum",name:"state",ref:{value:"presenceState",options:["on","off"]}},{type:"enum",name:"detection activated",ref:{value:"presenceActivate",
options:["off","on"]}}]};e.ipevt="MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?e.ipevt.concat([{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]):e.ipevt.concat([{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]);return e};h.prototype.executeCommand=
function(e,g,k,n){k?(script=xnm.aio.hm.HmIPChannel.PRESENCEDETECTOR_TRANSCEIVER.buildCommandScript(e,{interface:g.interface,address:this._address,channels:g.channels},{address:this._chPresenceDetectorTransceiver},{value:k.value,ext:k.ext}))?e._doRequestMarked(script,!0,{execute:function(r,u){setTimeout(function(){n&&n(r)},200)}}):n&&n(Error("invalid command")):n&&n(Error("command is null"))};h.prototype.buildStateScript=function(e,g,k){if(!k)return null;switch(k.value){case "errorComm":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(e,
g,{address:this._chMaintenance},k);break;case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":e=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(e,g,{address:this._chMaintenance},k);break;default:e=xnm.aio.hm.HmIPChannel.PRESENCEDETECTOR_TRANSCEIVER.buildStateScript(e,g,{address:this._chPresenceDetectorTransceiver},k)}return e};h.prototype.handleStatusResponse=function(e,g){if("?"==e)return e;switch(g.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(e,
g);case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(e,g);case "presenceIllu":case "presenceState":case "presenceActivate":return xnm.aio.hm.HmIPChannel.PRESENCEDETECTOR_TRANSCEIVER.handleStatusResponse(e,g);default:return"?"}};h.prototype.resolveState=function(e,g,k){if(!g||!g.channel)return null;var n=g.channel.indexOf(":");if(-1==n)return null;n=g.channel.substr(n+1);var r=null;switch(parseInt(n)){case this._chMaintenance:r=
"MAINTENANCE_BAT_EL"==this._chMaintenanceHsstype?xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(e,g,k):xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(e,g,k);break;case this._chPresenceDetectorTransceiver:r=xnm.aio.hm.HmIPChannel.PRESENCEDETECTOR_TRANSCEIVER.resolveState(e,g,k)}return r};h.parseJSON=function(e){if(!e||!e.type||!e.channels)return null;var g=new h;g._type=e.type;g._address=e.address;"HmIP-SPI"==e.type&&(g._chMaintenanceHsstype="MAINTENANCE_BAT_EL");return g};return h}(),v=function(){var h=
function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype=null;this._chHeatingClimateControlFloorTransceiver=1};h.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"humidity limiter",ref:{value:"cl_f_humidityLimiter",options:["true","false"]}},{type:"enum",name:"emergency operation",ref:{value:"cl_f_emergencyOP",options:["true","false"]}},{type:"enum",name:"frost protection",
ref:{value:"cl_f_frostProtection",options:["true","false"]}},{type:"float",name:"valve level",ref:{value:"cl_valve_level",extMeta:"0-100"}}]}};h.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"humidity limiter",ref:{value:"cl_f_humidityLimiter",options:["true","false"]}},{type:"enum",name:"emergency operation",ref:{value:"cl_f_emergencyOP",options:["true","false"]}},{type:"enum",name:"frost protection",
ref:{value:"cl_f_frostProtection",options:["true","false"]}},{type:"float",name:"valve level",ref:{value:"cl_valve_level",extMeta:"0-100"}}]}};h.prototype.buildStateScript=function(e,g,k){if(!k)return null;var n=null;switch(k.value){case "errorComm":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(e,g,{address:this._chMaintenance},k);break;case "cl_f_humidityLimiter":case "cl_f_emergencyOP":case "cl_f_frostProtection":case "cl_valve_level":n=xnm.aio.hm.HmIPChannel.CLIMATECONTROL_FLOOR_TRANSCEIVER.buildStateScript(e,
g,{address:this._chHeatingClimateControlFloorTransceiver},{value:k.value})}return n};h.prototype.handleStatusResponse=function(e,g){if("?"==e)return e;switch(g.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(e,g);case "cl_f_humidityLimiter":case "cl_f_emergencyOP":case "cl_f_frostProtection":case "cl_valve_level":return xnm.aio.hm.HmIPChannel.CLIMATECONTROL_FLOOR_TRANSCEIVER.handleStatusResponse(e,g);default:return"?"}};h.prototype.resolveState=function(e,g,
k){if(!g||!g.channel)return null;var n=g.channel.indexOf(":");if(-1==n)return null;n=g.channel.substr(n+1);var r=null;switch(parseInt(n)){case this._chMaintenance:r=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(e,g,k);break;case this._chHeatingClimateControlFloorTransceiver:r=xnm.aio.hm.HmIPChannel.CLIMATECONTROL_FLOOR_TRANSCEIVER.resolveState(e,g,k)}return r};h.parseJSON=function(e){if(!e||!e.type||!e.channels)return null;var g=new h;g._type=e.type;g._address=e.address;g._chMaintenanceHsstype=
"MAINTENANCE";for(var k in e.channels)"CLIMATECONTROL_FLOOR_TRANSCEIVER"==k.substr(0,32)&&(g._chHeatingClimateControlFloorTransceiver=parseInt(e.channels[k].address));return g};return h}(),x=function(){var h=function(){this._address=this._type=null;this._chMaintenance=0;this._chMaintenanceHsstype="MAINTENANCE";this._chAnalogInputTransmitter=1};h.prototype.getCommandStatusMap=function(){return{status:[{type:"float",name:"input voltage",ref:{value:"analogInputVoltage",extMeta:"0.0-12.0"}},{type:"enum",
name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]}};h.prototype.getIPEvtMap=function(){return{ipevt:[{type:"float",name:"input voltage",ref:{value:"analogInputVoltage",extMeta:"0.0-12.0"}},{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]}};h.prototype.buildStateScript=function(e,g,k){if(!k)return null;switch(k.value){case "errorComm":e=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(e,g,{address:this._chMaintenance},k);break;
default:e=xnm.aio.hm.HmIPChannel.ANALOG_INPUT_TRANSMITTER.buildStateScript(e,g,{address:this._chAnalogInputTransmitter},k)}return e};h.prototype.handleStatusResponse=function(e,g){if("?"==e)return e;switch(g.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(e,g);case "analogInputVoltage":return xnm.aio.hm.HmIPChannel.ANALOG_INPUT_TRANSMITTER.handleStatusResponse(e,g);default:return"?"}};h.prototype.resolveState=function(e,g,k){if(!g||!g.channel)return null;var n=
g.channel.indexOf(":");if(-1==n)return null;n=g.channel.substr(n+1);var r=null;switch(parseInt(n)){case this._chMaintenance:r=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(e,g,k);break;case this._chAnalogInputTransmitter:r=xnm.aio.hm.HmIPChannel.ANALOG_INPUT_TRANSMITTER.resolveState(e,g,k)}return r};h.parseJSON=function(e){if(!e||!e.type||!e.channels)return null;var g=new h;g._type=e.type;g._address=e.address;for(var k in e.channels)"ANALOG_INPUT_TRANSMITTER"==k.substr(0,24)&&(g._chAnalogInputTransmitter=
parseInt(e.channels[k].address));return g};return h}(),y=function(){};y.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}},{type:"enum",name:"ch.4 on",ref:{value:"ch4on"}},{type:"enum",name:"ch.4 off",ref:{value:"ch4off"}},{type:"enum",name:"ch.4 toggle",ref:{value:"ch4toggle"}},{type:"enum",name:"ch.5 on",ref:{value:"ch5on"}},{type:"enum",name:"ch.5 off",ref:{value:"ch5off"}},
...
scale:"0.1",unit:"W"}},{type:"float",name:"current",ref:{value:"meterCurrent",extMeta:"0.0-65535.0",scale:"0.1",unit:"mA"}}]}};y.prototype.getIPEvtMap=function(){var h=this.getCommandStatusMap().status;return{ipevt:JSON.parse(JSON.stringify(h))}};y.prototype.executeCommand=function(h,e,g,k){if(g){var n=null;switch(g.value){case "on":case "ch4on":n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:4},{value:"on"});break;case "off":case "ch4off":n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(h,
e,{address:4},{value:"off"});break;case "toggle":case "ch4toggle":n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:4},{value:"toggle"});break;case "ch5on":n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:5},{value:"on"});break;case "ch5off":n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:5},{value:"off"});break;case "ch5toggle":n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:5},
{value:"toggle"});break;case "ch6on":n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:6},{value:"on"});break;case "ch6off":n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:6},{value:"off"});break;case "ch6toggle":n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:6},{value:"toggle"})}n?h._doRequestMarked(n,!0,{execute:function(r,u){setTimeout(function(){k&&k(r)},200)}}):k&&k(Error("invalid command"))}else k&&
k(Error("command is null"))};y.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null;switch(g.value){case "errorComm":k=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(h,e,{address:0},g);break;case "switchState":k=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.buildStateScript(h,e,{address:3},{value:"switchTState"});break;case "ch4State":k=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:4},{value:"switchState"});break;case "ch5State":k=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildStateScript(h,
e,{address:5},{value:"switchState"});break;case "ch6State":k=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:6},{value:"switchState"});break;case "meterVoltage":case "meterEnergyCounter":case "meterFrequency":case "meterPower":case "meterCurrent":k=xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.buildStateScript(h,e,{address:7},g)}return k};y.prototype.handleStatusResponse=function(h,e){if("?"==h)return h;switch(e.value){case "meterVoltage":case "meterEnergyCounter":case "meterFrequency":case "meterPower":case "meterCurrent":return xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.handleStatusResponse(h,
e);case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(h,e);case "switchState":return xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.handleStatusResponse(h,{value:"switchTState"});case "ch4State":case "ch5State":case "ch6State":return xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.handleStatusResponse(h,{value:"switchState"});default:return"?"}};y.prototype.resolveState=function(h,e,g){if(!e||!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;k=e.channel.substr(k+
1);var n=null;switch(k){case "3":n=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.resolveState(h,e,g);break;case "4":case "5":case "6":n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.resolveState(h,e,g);n.key="4"==k?"ch4State":"5"==k?"ch5State":"ch6State";break;case "7":n=xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.resolveState(h,e,g)}return n};var A=function(){};A.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"dimOn"}},{type:"enum",name:"off",ref:{value:"dimOff"}},
...
ref:{value:"ch5Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.6 status",ref:{value:"ch6Level",extMeta:"0-100",unit:"%"}}]}};A.prototype.getIPEvtMap=function(){var h=this.getCommandStatusMap().status;return{ipevt:JSON.parse(JSON.stringify(h))}};A.prototype.executeCommand=function(h,e,g,k){if(g){var n=null;switch(g.value){case "dimOn":case "ch4dimOn":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:4},{value:"dimOn"});break;case "dimOff":case "ch4dimOff":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,
e,{address:4},{value:"dimOff"});break;case "dimUp":case "ch4dimUp":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:4},{value:"dimUp",ext:g.ext});break;case "dimDown":case "ch4dimDown":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:4},{value:"dimDown",ext:g.ext});break;case "dimTo":case "ch4dimTo":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:4},{value:"dimTo",ext:g.ext});break;case "toggleTo":case "ch4toggleTo":n=
xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:4},{value:"toggleTo",ext:g.ext});break;case "ch5dimOn":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:5},{value:"dimOn"});break;case "ch5dimOff":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:5},{value:"dimOff"});break;case "ch5dimUp":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:5},{value:"dimUp",ext:g.ext});break;case "ch5dimDown":n=
xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:5},{value:"dimDown",ext:g.ext});break;case "ch5dimTo":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:5},{value:"dimTo",ext:g.ext});break;case "ch5toggleTo":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:5},{value:"toggleTo",ext:g.ext});break;case "ch6dimOn":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:6},{value:"dimOn"});
break;case "ch6dimOff":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:6},{value:"dimOff"});break;case "ch6dimUp":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:6},{value:"dimUp",ext:g.ext});break;case "ch6dimDown":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:6},{value:"dimDown",ext:g.ext});break;case "ch6dimTo":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:6},
{value:"dimTo",ext:g.ext});break;case "ch6toggleTo":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:6},{value:"toggleTo",ext:g.ext})}n?h._doRequestMarked(n,!0,{execute:function(r,u){setTimeout(function(){k&&k(r)},200)}}):k&&k(Error("invalid command"))}else k&&k(Error("command is null"))};A.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null;switch(g.value){case "errorComm":k=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(h,e,{address:0},g);
break;case "dimmerTLevel":k=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.buildStateScript(h,e,{address:3},{value:"dimmerTLevel"});break;case "ch4Level":k=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:4},{value:"dimmerLevel"});break;case "ch5Level":k=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:5},{value:"dimmerLevel"});break;case "ch6Level":k=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:6},{value:"dimmerLevel"})}return k};
A.prototype.handleStatusResponse=function(h,e){if("?"==h)return h;switch(e.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(h,e);case "dimmerTLevel":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(h,{value:"dimmerTLevel"});case "ch4Level":case "ch5Level":case "ch6Level":return xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.handleStatusResponse(h,{value:"dimmerLevel"});default:return"?"}};A.prototype.resolveState=function(h,e,g){if(!e||!e.channel)return null;
var k=e.channel.indexOf(":");if(-1==k)return null;k=e.channel.substr(k+1);var n=null;switch(k){case "3":n=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.resolveState(h,e,g);break;case "4":case "5":case "6":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.resolveState(h,e,g),n.key="4"==k?"ch4Level":"5"==k?"ch5Level":"ch6Level"}return n};var z=function(){};z.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",
name:"battery low",ref:{value:"errorBat",options:["false","true"]}}]}};z.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false","true"]}},{type:"enum",name:"button 1 short press",ref:{value:"btn1pressShort",options:["true"]}},{type:"enum",name:"button 1 long press",ref:{value:"btn1pressLong",options:["true"]}},{type:"enum",name:"button 2 short press",
ref:{value:"btn2pressShort",options:["true"]}},{type:"enum",name:"button 2 long press",ref:{value:"btn2pressLong",options:["true"]}}]}};z.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null;switch(g.value){case "errorComm":case "errorBat":k=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(h,e,{address:0},g)}return k};z.prototype.handleStatusResponse=function(h,e){if("?"==h)return h;switch(e.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(h,
e);default:return"?"}};z.prototype.resolveState=function(h,e,g){if(!e||!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;k=e.channel.substr(k+1);var n=null;switch(k){case "0":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(h,e,g);break;case "1":case "2":n=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(h,e,g),"pressShort"==n.key?n.key="1"==k?"btn1pressShort":"btn2pressShort":"pressLong"==n.key&&(n.key="1"==k?"btn1pressLong":"btn2pressLong")}return n};var J=function(){};
...
ref:{value:"alarmVisualState",options:["on","off"]}}]}};J.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"sabotage",ref:{value:"errorSabo",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatVoltage",ext:"%f",extMeta:"0-25.2"}},{type:"enum",name:"alarm state",ref:{value:"alarmState",
options:["on","off"]}},{type:"enum",name:"alarm audio state",ref:{value:"alarmAudioState",options:["on","off"]}},{type:"enum",name:"alarm visual state",ref:{value:"alarmVisualState",options:["on","off"]}}]}};J.prototype.executeCommand=function(h,e,g,k){if(g){var n=null;switch(g.value){case "alarmTrigger":n=xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:3},g)}n?h._doRequestMarked(n,!0,{execute:function(r,u){setTimeout(function(){k&&k(r)},200)}}):k&&k(Error("invalid command"))}else k&&
k(Error("command is null"))};J.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null;switch(g.value){case "errorComm":case "errorBat":case "errorSabo":case "errorBatVoltage":k=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(h,e,{address:0},g);break;case "alarmState":case "alarmAudioState":case "alarmVisualState":k=xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:3},g)}return k};J.prototype.handleStatusResponse=function(h,e){if("?"==h)return h;
switch(e.value){case "errorComm":case "errorBat":case "errorSabo":case "errorBatVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(h,e);case "alarmState":case "alarmAudioState":case "alarmVisualState":return xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.handleStatusResponse(h,e);default:return"?"}};J.prototype.resolveState=function(h,e,g){if(!e||!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;var n=null;switch(e.channel.substr(k+1)){case "0":n=
xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(h,e,g);break;case "3":n=xnm.aio.hm.HmIPChannel.ALARM_SWITCH_VIRTUAL_RECEIVER.resolveState(h,e,g)}return n};var L=function(){};L.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"intrusion alarm off",ref:{value:"intrusionAlarmOff"}},{type:"enum",name:"intrusion alarm on",ref:{value:"intrusionAlarmOn"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",
ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"smokeState",options:["on","off"]}},{type:"enum",name:"alarm detail",ref:{value:"smokeAlarmDetail",options:["off","primary_alarm","intrusion_alarm","secondary_alarm"]}}]}};L.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false","true"]}},{type:"enum",name:"alarm state",
ref:{value:"smokeState",options:["on","off"]}},{type:"enum",name:"alarm detail",ref:{value:"smokeAlarmDetail",options:["off","primary_alarm","intrusion_alarm","secondary_alarm"]}}]}};L.prototype.executeCommand=function(h,e,g,k){if(g){var n=null;switch(g.value){case "intrusionAlarmOff":case "intrusionAlarmOn":n=xnm.aio.hm.HmIPChannel.SMOKE_DETECTOR.buildCommandScript(h,e,{address:1},g)}n?h._doRequestMarked(n,!0,{execute:function(r){k&&k(r)}}):k&&k(Error("invalid command"))}else k&&k(Error("command is null"))};
L.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null;switch(g.value){case "errorComm":case "errorBat":k=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(h,e,{address:0},g);break;case "smokeState":k=xnm.aio.hm.HmIPChannel.SMOKE_DETECTOR.buildStateScript(h,e,{address:1},g)}return k};L.prototype.handleStatusResponse=function(h,e){if("?"==h)return h;switch(e.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(h,e);case "smokeState":case "smokeAlarmDetail":return xnm.aio.hm.HmIPChannel.SMOKE_DETECTOR.handleStatusResponse(h,
e);default:return"?"}};L.prototype.resolveState=function(h,e,g){if(!e||!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;var n=null;switch(e.channel.substr(k+1)){case "0":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(h,e,g);break;case "1":n=xnm.aio.hm.HmIPChannel.SMOKE_DETECTOR.resolveState(h,e,g)}return n};var w=function(){};w.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},
...
ref:{value:"errorSabo",options:["false","true"]}},{type:"enum",name:"window state",ref:{value:"handleState",options:["closed","tilted","open"]}}]}};w.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null;switch(g.value){case "errorComm":case "errorBat":case "errorSabo":k=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(h,e,{address:0},g);break;case "handleState":k=xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.buildStateScript(h,e,{address:1},g)}return k};w.prototype.handleStatusResponse=
function(h,e){if("?"==h)return h;switch(e.value){case "errorComm":case "errorBat":case "errorSabo":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(h,e);case "handleState":return xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.handleStatusResponse(h,e);default:return"?"}};w.prototype.resolveState=function(h,e,g){if(!e||!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;var n=null;switch(e.channel.substr(k+1)){case "0":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(h,
e,g);break;case "1":n=xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.resolveState(h,e,g)}return n};var C=function(){};C.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}},{type:"enum",name:"ch.2 on",ref:{value:"ch2on"}},{type:"enum",name:"ch.2 off",ref:{value:"ch2off"}},{type:"enum",name:"ch.2 toggle",ref:{value:"ch2toggle"}},{type:"enum",name:"ch.3 on",ref:{value:"ch3on"}},
...
ref:{value:"meterPower",extMeta:"0.0-163830.0",scale:"0.1",unit:"W"}},{type:"float",name:"current",ref:{value:"meterCurrent",extMeta:"0.0-65535.0",scale:"0.1",unit:"mA"}}]}};C.prototype.getIPEvtMap=function(){var h=this.getCommandStatusMap().status;return{ipevt:JSON.parse(JSON.stringify(h))}};C.prototype.executeCommand=function(h,e,g,k){if(g){var n=null,r=null;switch(g.value){case "on":case "ch2on":case "ch3on":case "ch4on":switch(g.value){case "on":case "ch2on":r=2;break;case "ch3on":r=3;break;case "ch4on":r=
4}n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:r},{value:"on"});break;case "off":case "ch2off":case "ch3off":case "ch4off":switch(g.value){case "off":case "ch2off":r=2;break;case "ch3off":r=3;break;case "ch4off":r=4}n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:r},{value:"off"});break;case "toggle":case "ch2toggle":case "ch3toggle":case "ch4toggle":switch(g.value){case "toggle":case "ch2toggle":r=2;break;case "ch3toggle":r=3;break;
case "ch4toggle":r=4}n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:r},{value:"toggle"})}n?h._doRequestMarked(n,!0,{execute:function(u,E){setTimeout(function(){k&&k(u)},200)}}):k&&k(Error("invalid command"))}else k&&k(Error("command is null"))};C.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null;switch(g.value){case "errorComm":k=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(h,e,{address:0},g);break;case "switchState":k=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.buildStateScript(h,
e,{address:1},{value:"switchTState"});break;case "ch2State":k=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:2},{value:"switchState"});break;case "ch3State":k=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:3},{value:"switchState"});break;case "ch4State":k=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:4},{value:"switchState"});break;case "meterVoltage":case "meterEnergyCounter":case "meterFrequency":case "meterPower":case "meterCurrent":k=
xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.buildStateScript(h,e,{address:5},g)}return k};C.prototype.handleStatusResponse=function(h,e){if("?"==h)return h;switch(e.value){case "meterVoltage":case "meterEnergyCounter":case "meterFrequency":case "meterPower":case "meterCurrent":return xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.handleStatusResponse(h,e);case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(h,e);case "switchState":return xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.handleStatusResponse(h,
{value:"switchTState"});case "ch2State":case "ch3State":case "ch4State":return xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.handleStatusResponse(h,{value:"switchState"});default:return"?"}};C.prototype.resolveState=function(h,e,g){if(!e||!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;k=e.channel.substr(k+1);var n=null;switch(k){case "1":n=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.resolveState(h,e,g);break;case "2":case "3":case "4":n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.resolveState(h,
e,g);n.key="2"==k?"ch2State":"3"==k?"ch3State":"ch4State";break;case "5":n=xnm.aio.hm.HmIPChannel.ENERGIE_METER_TRANSMITTER.resolveState(h,e,g)}return n};var B=function(){};B.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"dimOn"}},{type:"enum",name:"off",ref:{value:"dimOff"}},{type:"int",name:"dim up",ref:{value:"dimUp",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"dim down",ref:{value:"dimDown",ext:"%d",extMeta:"1-100",unit:"%"}},{type:"int",name:"dim to",
...
extMeta:"0-100",unit:"%"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"int",name:"dimmer status",ref:{value:"dimmerTLevel",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.3 status",ref:{value:"ch3Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.4 status",ref:{value:"ch4Level",extMeta:"0-100",unit:"%"}},{type:"int",name:"ch.5 status",ref:{value:"ch5Level",extMeta:"0-100",unit:"%"}}]}};B.prototype.getIPEvtMap=function(){var h=this.getCommandStatusMap().status;
return{ipevt:JSON.parse(JSON.stringify(h))}};B.prototype.executeCommand=function(h,e,g,k){if(g){var n=null,r=null;switch(g.value){case "dimOn":case "ch3dimOn":case "ch4dimOn":case "ch5dimOn":switch(g.value){case "dimOn":case "ch3dimOn":r=3;break;case "ch4dimOn":r=4;break;case "ch5dimOn":r=5}n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:r},{value:"dimOn"});break;case "dimOff":case "ch3dimOff":case "ch4dimOff":case "ch5dimOff":switch(g.value){case "dimOff":case "ch3dimOff":r=
3;break;case "ch4dimOff":r=4;break;case "ch5dimOff":r=5}n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:r},{value:"dimOff"});break;case "dimUp":case "ch3dimUp":case "ch4dimUp":case "ch5dimUp":switch(g.value){case "dimUp":case "ch3dimUp":r=3;break;case "ch4dimUp":r=4;break;case "ch5dimUp":r=5}n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:r},{value:"dimUp",ext:g.ext});break;case "dimDown":case "ch3dimDown":case "ch4dimDown":case "ch5dimDown":switch(g.value){case "dimDown":case "ch3dimDown":r=
3;break;case "ch4dimDown":r=4;break;case "ch5dimDown":r=5}n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:r},{value:"dimDown",ext:g.ext});break;case "dimTo":case "ch3dimTo":case "ch4dimTo":case "ch5dimTo":switch(g.value){case "dimTo":case "ch3dimTo":r=3;break;case "ch4dimTo":r=4;break;case "ch5dimTo":r=5}n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:r},{value:"dimTo",ext:g.ext});break;case "toggleTo":case "ch3toggleTo":case "ch4toggleTo":case "ch5toggleTo":switch(g.value){case "toggleTo":case "ch3toggleTo":r=
3;break;case "ch4toggleTo":r=4;break;case "ch5toggleTo":r=5}n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:r},{value:"toggleTo",ext:g.ext})}n?h._doRequestMarked(n,!0,{execute:function(u,E){setTimeout(function(){k&&k(u)},200)}}):k&&k(Error("invalid command"))}else k&&k(Error("command is null"))};B.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null;switch(g.value){case "errorComm":k=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(h,e,{address:0},
g);break;case "dimmerTLevel":k=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.buildStateScript(h,e,{address:2},{value:"dimmerTLevel"});break;case "ch3Level":k=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:3},{value:"dimmerLevel"});break;case "ch4Level":k=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:4},{value:"dimmerLevel"});break;case "ch5Level":k=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:5},{value:"dimmerLevel"})}return k};
B.prototype.handleStatusResponse=function(h,e){if("?"==h)return h;switch(e.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(h,e);case "dimmerTLevel":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(h,{value:"dimmerTLevel"});case "ch3Level":case "ch4Level":case "ch5Level":return xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.handleStatusResponse(h,{value:"dimmerLevel"});default:return"?"}};B.prototype.resolveState=function(h,e,g){if(!e||!e.channel)return null;
var k=e.channel.indexOf(":");if(-1==k)return null;k=e.channel.substr(k+1);var n=null;switch(k){case "2":n=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.resolveState(h,e,g);break;case "3":case "4":case "5":n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.resolveState(h,e,g),n.key="3"==k?"ch3Level":"4"==k?"ch4Level":"ch5Level"}return n};var I=function(){};I.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"stop",ref:{value:"stop"}},{type:"enum",name:"move up",ref:{value:"moveUp"}},
...
ref:{value:"ch6Level",extMeta:"0-100",unit:"%"}}]}};I.prototype.getIPEvtMap=function(){var h=this.getCommandStatusMap().status;h=JSON.parse(JSON.stringify(h));h=h.concat([{type:"enum",name:"button 1 short press",ref:{value:"btn1pressShort",options:["true"]}},{type:"enum",name:"button 1 long press",ref:{value:"btn1pressLong",options:["true"]}},{type:"enum",name:"button 2 short press",ref:{value:"btn2pressShort",options:["true"]}},{type:"enum",name:"button 2 long press",ref:{value:"btn2pressLong",options:["true"]}}]);
return{ipevt:h}};I.prototype.executeCommand=function(h,e,g,k){if(g){var n=null;n=4;var r=null;-1!=g.value.indexOf("ch5")?n=5:-1!=g.value.indexOf("ch6")&&(n=6);-1!=g.value.indexOf("stop")?r="stop":-1!=g.value.indexOf("moveUp")?r="moveUp":-1!=g.value.indexOf("moveDown")?r="moveDown":-1!=g.value.indexOf("stepUp")?r="stepUp":-1!=g.value.indexOf("stepDown")?r="stepDown":-1!=g.value.indexOf("moveTo")&&(r="moveTo");r?(n=xnm.aio.hm.HmIPChannel.SHUTTER_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:n},{value:r,
ext:g.ext}))?h._doRequestMarked(n,!0,{execute:function(u,E){setTimeout(function(){k&&k(u)},200)}}):k&&k(Error("invalid command")):k&&k(Error("unknown command"))}else k&&k(Error("command is null"))};I.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null;switch(g.value){case "errorComm":k=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(h,e,{address:0},g);break;case "blindTLevel":k=xnm.aio.hm.HmIPChannel.SHUTTER_TRANSMITTER.buildStateScript(h,e,{address:3},{value:"blindTLevel"});
break;case "ch4Level":k=xnm.aio.hm.HmIPChannel.SHUTTER_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:4},{value:"blindLevel"});break;case "ch5Level":k=xnm.aio.hm.HmIPChannel.SHUTTER_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:5},{value:"blindLevel"});break;case "ch6Level":k=xnm.aio.hm.HmIPChannel.SHUTTER_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:6},{value:"blindLevel"})}return k};I.prototype.handleStatusResponse=function(h,e){if("?"==h)return h;switch(e.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(h,
e);case "blindTLevel":return xnm.aio.hm.HmIPChannel.SHUTTER_TRANSMITTER.handleStatusResponse(h,{value:"blindTLevel"});case "ch4Level":case "ch5Level":case "ch6Level":return xnm.aio.hm.HmIPChannel.SHUTTER_VIRTUAL_RECEIVER.handleStatusResponse(h,{value:"blindLevel"});default:return"?"}};I.prototype.resolveState=function(h,e,g){if(!e||!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;k=e.channel.substr(k+1);var n=null;switch(k){case "1":case "2":if(n=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(h,
e,g))"pressShort"==n.key?n.key="btn"+k+"pressShort":"pressLong"==n.key&&(n.key="btn"+k+"pressLong");break;case "3":n=xnm.aio.hm.HmIPChannel.SHUTTER_TRANSMITTER.resolveState(h,e,g);break;case "4":case "5":case "6":if(n=xnm.aio.hm.HmIPChannel.SHUTTER_VIRTUAL_RECEIVER.resolveState(h,e,g))n.key="4"==k?"ch4Level":"5"==k?"ch5Level":"ch6Level"}return n};var D=function(){};D.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"stop",ref:{value:"stop"}},{type:"enum",name:"move up",ref:{value:"moveUp"}},
...
unit:"%"}},{type:"int",name:"ch.6 lamella status",ref:{value:"ch6lamellaPos",extMeta:"0-100",unit:"%"}}]}};D.prototype.getIPEvtMap=function(){var h=this.getCommandStatusMap().status;h=JSON.parse(JSON.stringify(h));h=h.concat([{type:"enum",name:"button 1 short press",ref:{value:"btn1pressShort",options:["true"]}},{type:"enum",name:"button 1 long press",ref:{value:"btn1pressLong",options:["true"]}},{type:"enum",name:"button 2 short press",ref:{value:"btn2pressShort",options:["true"]}},{type:"enum",
name:"button 2 long press",ref:{value:"btn2pressLong",options:["true"]}}]);return{ipevt:h}};D.prototype.executeCommand=function(h,e,g,k){if(g){var n=4,r=null;-1!=g.value.indexOf("ch5")?n=5:-1!=g.value.indexOf("ch6")&&(n=6);-1!=g.value.indexOf("stop")?r="stop":-1!=g.value.indexOf("moveUp")?r="moveUp":-1!=g.value.indexOf("moveDown")?r="moveDown":-1!=g.value.indexOf("stepUp")?r="stepUp":-1!=g.value.indexOf("stepDown")?r="stepDown":-1!=g.value.indexOf("moveTo")?r="moveTo":-1!=g.value.indexOf("lamellaUp")?
r="lamellaUp":-1!=g.value.indexOf("lamellaDown")?r="lamellaDown":-1!=g.value.indexOf("lamellaStepUp")?r="lamellaStepUp":-1!=g.value.indexOf("lamellaStepDown")?r="lamellaStepDown":-1!=g.value.indexOf("lamellaTo")&&(r="lamellaTo");r?(e=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:n,stateAddress:3},{value:r,ext:g.ext}))?h._doRequestMarked(e,!0,{execute:function(u,E){setTimeout(function(){k&&k(u)},200)}}):k&&k(Error("invalid command")):k&&k(Error("unknown command"))}else k&&
k(Error("command is null"))};D.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null;switch(g.value){case "errorComm":k=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(h,e,{address:0},g);break;case "blindTPos":k=xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.buildStateScript(h,e,{address:3},{value:"blindTPos"});break;case "lamellaTPos":k=xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.buildStateScript(h,e,{address:3},{value:"lamellaTPos"});break;case "ch4blindPos":k=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildStateScript(h,
e,{address:4},{value:"blindPos"});break;case "ch4lamellaPos":k=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:4},{value:"lamellaPos"});break;case "ch5blindPos":k=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:5},{value:"blindPos"});break;case "ch5lamellaPos":k=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:5},{value:"lamellaPos"});break;case "ch6blindPos":k=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildStateScript(h,
e,{address:6},{value:"blindPos"});break;case "ch6lamellaPos":k=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.buildStateScript(h,e,{address:6},{value:"lamellaPos"})}return k};D.prototype.handleStatusResponse=function(h,e){if("?"==h)return h;switch(e.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(h,e);case "blindTPos":return xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.handleStatusResponse(h,{value:"blindTPos"});case "lamellaTPos":return xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.handleStatusResponse(h,
{value:"lamellaTPos"});case "ch4blindPos":case "ch5blindPos":case "ch6blindPos":return xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.handleStatusResponse(h,{value:"blindPos"});case "ch4lamellaPos":case "ch5lamellaPos":case "ch6lamellaPos":return xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.handleStatusResponse(h,{value:"lamellaPos"});default:return"?"}};D.prototype.resolveState=function(h,e,g){if(!e||!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;k=e.channel.substr(k+1);
var n=null;switch(k){case "1":case "2":if(n=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(h,e,g))"pressShort"==n.key?n.key="btn"+k+"pressShort":"pressLong"==n.key&&(n.key="btn"+k+"pressLong");break;case "3":n=xnm.aio.hm.HmIPChannel.BLIND_TRANSMITTER.resolveState(h,e,g);break;case "4":case "5":case "6":if(n=xnm.aio.hm.HmIPChannel.BLIND_VIRTUAL_RECEIVER.resolveState(h,e,g))"LEVEL"==e.datapoint?n.key="4"==k?"ch4blindPos":"5"==k?"ch5blindPos":"ch6blindPos":"LEVEL_2"==e.datapoint&&(n.key="4"==k?
"ch4lamellaPos":"5"==k?"ch5lamellaPos":"ch6lamellaPos")}return n};var M=function(){};M.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}}]}};M.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",
...
ref:{value:"btn6pressLong",options:["true"]}}]}};M.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null;switch(g.value){case "errorComm":case "errorBat":k=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(h,e,{address:0},g)}return k};M.prototype.handleStatusResponse=function(h,e){if("?"==h)return h;switch(e.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(h,e);default:return"?"}};M.prototype.resolveState=function(h,e,g){if(!e||
!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;k=e.channel.substr(k+1);var n=null;switch(k){case "0":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(h,e,g);break;case "1":case "2":case "3":case "4":case "5":case "6":n=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(h,e,g),"pressShort"==n.key?n.key="btn"+k+"pressShort":"pressLong"==n.key&&(n.key="btn"+k+"pressLong")}return n};var G=function(){};G.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",
...
extMeta:"0-127"}},{type:"enum",name:"passage count overflow from right to left",ref:{value:"passageR2LCOF",options:["false","true"]}}]}};G.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null;switch(g.value){case "errorComm":case "errorBat":k=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(h,e,{address:0},g);break;case "passageCurrentDirection":k=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.buildStateScript(h,e,{address:2},{value:"passageCurrentDirection"});
break;case "passageLastDirection":k=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.buildStateScript(h,e,{address:2},{value:"passageLastDirection"});break;case "passageR2LCurrent":k=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.buildStateScript(h,e,{address:2},{value:"passageCurrent"});break;case "passageR2LLast":k=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.buildStateScript(h,e,{address:2},{value:"passageLast"});break;case "passageR2LC":k=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.buildStateScript(h,
e,{address:2},{value:"passageC"});break;case "passageR2LCOF":k=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.buildStateScript(h,e,{address:2},{value:"passageCOF"});break;case "passageL2RCurrent":k=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.buildStateScript(h,e,{address:3},{value:"passageCurrent"});break;case "passageL2RLast":k=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.buildStateScript(h,e,{address:3},{value:"passageLast"});break;case "passageL2RC":k=
xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.buildStateScript(h,e,{address:3},{value:"passageC"});break;case "passageL2RCOF":k=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.buildStateScript(h,e,{address:3},{value:"passageCOF"})}return k};G.prototype.handleStatusResponse=function(h,e){if("?"==h)return h;switch(e.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(h,e);case "passageCurrentDirection":case "passageLastDirection":return xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.handleStatusResponse(h,
e);case "passageR2LCurrent":case "passageL2RCurrent":return xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.handleStatusResponse(h,{value:"passageCurrent"});case "passageR2LLast":case "passageL2RLast":return xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.handleStatusResponse(h,{value:"passageLast"});case "passageR2LC":case "passageL2RC":return xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.handleStatusResponse(h,{value:"passageC"});case "passageL2RCOF":case "passageR2LCOF":return xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.handleStatusResponse(h,
{value:"passageCOF"});default:return"?"}};G.prototype.resolveState=function(h,e,g){if(!e||!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;k=e.channel.substr(k+1);var n=null;switch(k){case "0":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(h,e,g);break;case "2":case "3":n=xnm.aio.hm.HmIPChannel.PASSAGE_DETECTOR_DIRECTION_TRANSMITTER.resolveState(h,e,g),"passageCurrentDirection"==n.key?n.key="passageCurrentDirection":"passageLastDirection"==n.key?n.key="passageLastDirection":
"passageC"==n.key?n.key="2"==k?"passageR2LC":"passageL2RC":"passageCOF"==n.key&&(n.key="2"==k?"passageR2LCOF":"passageL2RCOF")}return n};var S=function(){};S.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"waterAlarmState",options:["on","off"]}},{type:"enum",name:"moisture detected",
ref:{value:"waterMoistureDetected",options:["true","false"]}},{type:"enum",name:"water detected",ref:{value:"waterWaterDetected",options:["true","false"]}}]}};S.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"enum",name:"alarm state",ref:{value:"waterAlarmState",options:["on","off"]}},{type:"enum",name:"moisture detected",
ref:{value:"waterMoistureDetected",options:["true","false"]}},{type:"enum",name:"water detected",ref:{value:"waterWaterDetected",options:["true","false"]}}]}};S.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null;switch(g.value){case "errorComm":case "errorBat":k=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(h,e,{address:0},g);break;case "waterAlarmState":k=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.buildStateScript(h,e,{address:1},{value:"waterAlarmState"});break;
case "waterMoistureDetected":k=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.buildStateScript(h,e,{address:1},{value:"waterMoistureDetected"});break;case "waterWaterDetected":k=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.buildStateScript(h,e,{address:1},{value:"waterWaterDetected"})}return k};S.prototype.handleStatusResponse=function(h,e){if("?"==h)return h;switch(e.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(h,e);case "waterAlarmState":case "waterMoistureDetected":case "waterWaterDetected":return xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.handleStatusResponse(h,
e);default:return"?"}};S.prototype.resolveState=function(h,e,g){if(!e||!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;var n=null;switch(e.channel.substr(k+1)){case "0":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(h,e,g);break;case "1":n=xnm.aio.hm.HmIPChannel.WATER_DETECTION_TRANSMITTER.resolveState(h,e,g)}return n};var Q=function(){};Q.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false",
...
options:["false","true"]}}]}};Q.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false","true"]}},{type:"int",name:"error code",ref:{value:"errorBatElCode",ext:"%d",extMeta:"0-255"}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0-25.2"}},{type:"enum",name:"sensor error",ref:{value:"errorBatElSensor",
options:["false","true"]}},{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"motion",ref:{value:"acceMotion",options:["false","true"]}}]}};Q.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null;switch(g.value){case "errorBatElDutyCycle":case "errorBatElCode":case "errorBatElBat":case "errorBatElVoltage":case "errorBatElSensor":case "errorBatElComm":k=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(h,e,{address:0},
g);break;case "acceMotion":k=xnm.aio.hm.HmIPChannel.ROTARY_HANDLE_TRANSCEIVER.buildStateScript(h,e,{address:1},g)}return k};Q.prototype.handleStatusResponse=function(h,e){if("?"==h)return h;switch(e.value){case "errorBatElDutyCycle":case "errorBatElCode":case "errorBatElBat":case "errorBatElVoltage":case "errorBatElSensor":case "errorBatElComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(h,e);case "acceMotion":return xnm.aio.hm.HmIPChannel.ACCELERATION_TRANSCEIVER.handleStatusResponse(h,
e);default:return"?"}};Q.prototype.resolveState=function(h,e,g){if(!e||!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;var n=null;switch(e.channel.substr(k+1)){case "0":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(h,e,g);break;case "1":n=xnm.aio.hm.HmIPChannel.ACCELERATION_TRANSCEIVER.resolveState(h,e,g)}return n};var P=function(){};P.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"float",name:"on for",ref:{value:"onFor",
ext:"%f",unit:"s"}}],status:[{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]}};P.prototype.getIPEvtMap=function(){var h=this.getCommandStatusMap().status;h=JSON.parse(JSON.stringify(h));h.push({type:"enum",name:"button short press",ref:{value:"btnPressShort",options:["true"]}});
h.push({type:"enum",name:"button long press",ref:{value:"btnPressLong",options:["true"]}});return{ipevt:h}};P.prototype.executeCommand=function(h,e,g,k){if(g){var n=null;switch(g.value){case "on":n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:3},{value:"onFor",ext:.5});break;case "onFor":n=xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:3},g);break;default:k&&k(Error("unknown command"));return}n?h._doRequestMarked(n,!0,{execute:function(r,
u){k&&k(r)}}):k&&k(Error("invalid command"))}else k&&k(Error("command is null"))};P.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null;switch(g.value){case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":k=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(h,e,{address:0},g)}return k};P.prototype.handleStatusResponse=function(h,e){if("?"==h)return h;switch(e.value){case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(h,
e);default:return"?"}};P.prototype.resolveState=function(h,e,g){if(!e||!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;var n=null;switch(e.channel.substr(k+1)){case "0":n=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(h,e,g);break;case "1":n=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(h,e,g),"pressShort"==n.key?n.key="btnPressShort":"pressLong"==n.key&&(n.key="btnPressLong")}return n};var X=function(){};X.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",
...
ref:{value:"led1Level",extMeta:"0-100",unit:"%"}},{type:"enum",name:"led 1 color",ref:{value:"led1Color",options:"off blue green torqoise red purple yellow white".split(" ")}},{type:"int",name:"led 2 status",ref:{value:"led2Level",extMeta:"0-100",unit:"%"}},{type:"enum",name:"led 2 color",ref:{value:"led2Color",options:"off blue green torqoise red purple yellow white".split(" ")}}]}};X.prototype.executeCommand=function(h,e,g,k){if(g){var n=null,r=n=null;switch(g.value){case "on":case "off":case "toggle":n=
xnm.aio.hm.HmIPChannel.SWITCH_VIRTUAL_RECEIVER.buildCommandScript(h,e,{address:4},g);break;case "led1On":case "led1Off":case "led1DimUp":case "led1DimDown":case "led1DimTo":case "led1ToggleTo":case "led1Color":case "led2On":case "led2Off":case "led2DimUp":case "led2DimDown":case "led2DimTo":case "led2ToggleTo":case "led2Color":r="led1"==g.value.substr(0,4)?{address:12}:{address:8};"On"==g.value.substr(4)?n={value:"dimOn"}:"Off"==g.value.substr(4)?n={value:"dimOff"}:"DimUp"==g.value.substr(4)?n={value:"dimUp",
ext:g.ext}:"DimDown"==g.value.substr(4)?n={value:"dimDown",ext:g.ext}:"DimTo"==g.value.substr(4)?n={value:"dimTo",ext:g.ext}:"ToggleTo"==g.value.substr(4)?n={value:"toggleTo",ext:g.ext}:"Color"==g.value.substr(4)&&(n={value:"color",ext:g.ext});n=xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(h,e,r,n);break;default:k&&k(Error("unknown command"));return}n?h._doRequestMarked(n,!0,{execute:function(u,E){k&&k(u)}}):k&&k(Error("invalid command"))}else k&&k(Error("command is null"))};
X.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null,n;switch(g.value){case "errorComm":k=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(h,e,{address:0},g);break;case "switchState":k=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.buildStateScript(h,e,{address:3},{value:"switchTState"});break;case "led1Level":case "led1Color":case "led2Level":case "led2Color":k="led1"==g.value.substr(0,4)?{address:11}:{address:7},"Level"==g.value.substr(4)?n={value:"dimmerTLevel"}:"Color"==g.value.substr(4)&&
(n={value:"dimmerTColor"}),k=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.buildStateScript(h,e,k,n)}return k};X.prototype.handleStatusResponse=function(h,e){if("?"==h)return h;switch(e.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(h,e);case "switchState":return xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.handleStatusResponse(h,{value:"switchTState"});case "led1Level":case "led2Level":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(h,{value:"dimmerTLevel"});
case "led1Color":case "led2Color":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(h,{value:"dimmerTColor"});default:return"?"}};X.prototype.resolveState=function(h,e,g){if(!e||!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;k=e.channel.substr(k+1);var n=null;switch(k){case "0":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(h,e,g);break;case "1":case "2":n=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(h,e,g);"pressShort"==n.key?n.key="btn"+k+
"pressShort":"pressLong"==n.key&&(n.key="btn"+k+"pressLong");break;case "3":n=xnm.aio.hm.HmIPChannel.SWITCH_TRANSMITTER.resolveState(h,e,g);break;case "7":case "11":n=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.resolveState(h,e,g),"7"==k?"dimmerTLevel"==n.key?n.key="led2Level":"dimmerTColor"==n.key&&(n.key="led2Color"):"11"==k&&("dimmerTLevel"==n.key?n.key="led1Level":"dimmerTColor"==n.key&&(n.key="led1Color"))}return n};var V=function(){};V.prototype.getCommandStatusMap=function(){return{command:[{type:"enum",
...
options:["open","closed","ventilation","unknown"]}},{type:"enum",name:"light status",ref:{value:"lightState",options:["off","on"]}}]}};V.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"door status",ref:{value:"doorState",options:["open","closed","ventilation","unknown"]}},{type:"enum",name:"light status",ref:{value:"lightState",options:["off","on"]}}]}};V.prototype.executeCommand=function(h,
e,g,k){if(g){var n=null;switch(g.value){case "open":case "close":case "stop":case "partialOpen":n=xnm.aio.hm.HmIPChannel.DOOR_RECEIVER.buildCommandScript(h,e,{address:1},g);break;case "lightOn":case "lightOff":case "lightToggle":n=xnm.aio.hm.HmIPChannel.SIMPLE_SWITCH_RECEIVER.buildCommandScript(h,e,{address:2},{value:g.value.substr(5).toLowerCase()});break;default:k&&k(Error("unknown command"));return}n?h._doRequestMarked(n,!0,{execute:function(r,u){k&&k(r)}}):k&&k(Error("invalid command"))}else k&&
k(Error("command is null"))};V.prototype.buildStateScript=function(h,e,g){if(!g)return null;var k=null;switch(g.value){case "errorComm":k=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(h,e,{address:0},g);break;case "doorState":k=xnm.aio.hm.HmIPChannel.DOOR_RECEIVER.buildStateScript(h,e,{address:1},g);break;case "lightState":k=xnm.aio.hm.HmIPChannel.SIMPLE_SWITCH_RECEIVER.buildStateScript(h,e,{address:2},{value:"state"})}return k};V.prototype.handleStatusResponse=function(h,e){if("?"==h)return h;
switch(e.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(h,e);case "doorState":return xnm.aio.hm.HmIPChannel.DOOR_RECEIVER.handleStatusResponse(h,e);case "lightState":return xnm.aio.hm.HmIPChannel.SIMPLE_SWITCH_RECEIVER.handleStatusResponse(h,{value:"state"});default:return"?"}};V.prototype.resolveState=function(h,e,g){if(!e||!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;var n=null;switch(e.channel.substr(k+1)){case "0":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(h,
e,g);break;case "1":n=xnm.aio.hm.HmIPChannel.DOOR_RECEIVER.resolveState(h,e,g);break;case "2":if(n=xnm.aio.hm.HmIPChannel.SIMPLE_SWITCH_RECEIVER.resolveState(h,e,g))n.key="lightState"}return n};var Y=function(){var h=function(){};h.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",
...
ref:{value:"briMinIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"}}]}};h.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"duty cycle error",ref:{value:"errorBatElDutyCycle",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0-25.2"}},{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"float",
name:"average brightness",ref:{value:"briAvgIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"}},{type:"float",name:"current brightness",ref:{value:"briIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"}},{type:"float",name:"maximum brightness",ref:{value:"briMaxIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"}},{type:"float",name:"minimum brightness",ref:{value:"briMinIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"}}]}};h.prototype.buildStateScript=function(e,g,k){if(!k)return null;var n=null;switch(k.value){case "errorBatElDutyCycle":case "errorBatElBat":case "errorBatElVoltage":case "errorBatElComm":n=
xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(e,g,{address:0},k);break;case "briAvgIllu":case "briIllu":case "briMaxIllu":case "briMinIllu":n=xnm.aio.hm.HmIPChannel.BRIGHTNESS_TRANSMITTER.buildStateScript(e,g,{address:1},k)}return n};h.prototype.handleStatusResponse=function(e,g){if("?"==e)return e;switch(g.value){case "errorBatElDutyCycle":case "errorBatElBat":case "errorBatElVoltage":case "errorBatElComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(e,g);case "briAvgIllu":case "briIllu":case "briMaxIllu":case "briMinIllu":return xnm.aio.hm.HmIPChannel.BRIGHTNESS_TRANSMITTER.handleStatusResponse(e,
g);default:return"?"}};h.prototype.resolveState=function(e,g,k){if(!g||!g.channel)return null;var n=g.channel.indexOf(":");if(-1==n)return null;var r=null;switch(g.channel.substr(n+1)){case "0":r=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(e,g,k);break;case "1":r=xnm.aio.hm.HmIPChannel.BRIGHTNESS_TRANSMITTER.resolveState(e,g,k)}return r};return h}(),aa=function(){var h=function(){};h.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",
options:["false","true"]}},{type:"enum",name:"power failure",ref:{value:"powerMainsFailure",options:["false","true"]}}]}};h.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"power failure",ref:{value:"powerMainsFailure",options:["false","true"]}}]}};h.prototype.buildStateScript=function(e,g,k){if(!k)return null;var n=null;switch(k.value){case "errorComm":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(e,
g,{address:0},k);break;case "powerMainsFailure":n=xnm.aio.hm.HmIPChannel.POWER_MAINS_TRANSMITTER.buildStateScript(e,g,{address:1},k)}return n};h.prototype.handleStatusResponse=function(e,g){if("?"==e)return e;switch(g.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(e,g);case "powerMainsFailure":return xnm.aio.hm.HmIPChannel.POWER_MAINS_TRANSMITTER.handleStatusResponse(e,g);default:return"?"}};h.prototype.resolveState=function(e,g,k){if(!g||!g.channel)return null;
var n=g.channel.indexOf(":");if(-1==n)return null;var r=null;switch(g.channel.substr(n+1)){case "0":r=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(e,g,k);break;case "1":r=xnm.aio.hm.HmIPChannel.POWER_MAINS_TRANSMITTER.resolveState(e,g,k)}return r};return h}(),ca=function(){var h=function(){};h.prototype.getCommandStatusMap=function(){return{command:[{type:"multi",name:"play sound",ref:{value:"acousticPlay",ext:"%multi",extMeta:[{type:"int",name:"set sound",ref:{value:"acousticSound",ext:"%d",extMeta:"0-255"}},
...
{type:"enum",name:"communication error",ref:{value:"errorBatElComm",options:["false","true"]}},{type:"int",name:"sound level",ref:{value:"acousticTLevel",extMeta:"0-100"}},{type:"int",name:"sound file",ref:{value:"acousticTSoundfile",extMeta:"0-255"}},{type:"int",name:"led level",ref:{value:"dimmerTLevel",extMeta:"0-100",unit:"%"}},{type:"enum",name:"led color",ref:{value:"dimmerTColor",options:"off blue green torqoise red purple yellow white".split(" ")}}]}};h.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",
...
{type:"int",name:"led level",ref:{value:"dimmerTLevel",extMeta:"0-100",unit:"%"}},{type:"enum",name:"led color",ref:{value:"dimmerTColor",options:"off blue green torqoise red purple yellow white".split(" ")}}]}};h.prototype.executeCommand=function(e,g,k,n){if(k){var r=null;switch(k.value){case "acousticPlay":case "acousticPlayList":r=xnm.aio.hm.HmIPChannel.ACOUSTIC_SIGNAL_VIRTUAL_RECEIVER.buildCommandScript(e,g,{address:2},k);break;case "dimOn":case "dimOff":case "dimUp":case "dimDown":case "dimTo":case "toggleTo":case "color":case "colorPlay":case "colorPlayList":r=
xnm.aio.hm.HmIPChannel.DIMMER_VIRTUAL_RECEIVER.buildCommandScript(e,g,{address:6},k)}r?e._doRequestMarked(r,!0,{execute:function(u,E){n&&n(u)}}):n&&n(Error("invalid command"))}else n&&n(Error("command is null"))};h.prototype.buildStateScript=function(e,g,k){if(!k)return null;var n=null;switch(k.value){case "errorBatElDutyCycle":case "errorBatElBat":case "errorBatElVoltage":case "errorBatElComm":n=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(e,g,{address:0},k);break;case "acousticTLevel":case "acousticTSoundfile":n=
xnm.aio.hm.HmIPChannel.ACOUSTIC_SIGNAL_TRANSMITTER.buildStateScript(e,g,{address:1},k);break;case "dimmerTLevel":case "dimmerTColor":n=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.buildStateScript(e,g,{address:5},k)}return n};h.prototype.handleStatusResponse=function(e,g){if("?"==e)return e;switch(g.value){case "errorBatElDutyCycle":case "errorBatElBat":case "errorBatElVoltage":case "errorBatElComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(e,g);case "acousticTLevel":case "acousticTSoundfile":return xnm.aio.hm.HmIPChannel.ACOUSTIC_SIGNAL_TRANSMITTER.handleStatusResponse(e,
g);case "dimmerTLevel":case "dimmerTColor":return xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.handleStatusResponse(e,g);default:return"?"}};h.prototype.resolveState=function(e,g,k){if(!g||!g.channel)return null;var n=g.channel.indexOf(":");if(-1==n)return null;var r=null;switch(g.channel.substr(n+1)){case "0":r=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(e,g,k);break;case "1":r=xnm.aio.hm.HmIPChannel.ACOUSTIC_SIGNAL_TRANSMITTER.resolveState(e,g,k);break;case "5":r=xnm.aio.hm.HmIPChannel.DIMMER_TRANSMITTER.resolveState(e,
g,k)}return r};return h}(),da=function(){var h=function(){};h.prototype.getCommandStatusMap=function(){return{command:[{type:"multi",name:"set line",ref:{value:"setLine",ext:"%multi",extMeta:[{type:"enum",name:"line",ref:{value:"line",ext:"%e",extMeta:["1","2","3","4","5"]}},{type:"string",name:"text",ref:{value:"text",ext:"%s"}},{type:"enum",name:"text alignment",ref:{value:"textAlign",ext:"%e",extMeta:["center","left","right"]}},{type:"enum",name:"text color",ref:{value:"textColor",ext:"%e",extMeta:["black",
...
options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]}};h.prototype.getIPEvtMap=function(){var e=this.getCommandStatusMap().status;e=JSON.parse(JSON.stringify(e));e=e.concat([{type:"enum",name:"button 1 short press",ref:{value:"btn1pressShort",options:["true"]}},{type:"enum",name:"button 1 long press",ref:{value:"btn1pressLong",options:["true"]}},
{type:"enum",name:"button 2 short press",ref:{value:"btn2pressShort",options:["true"]}},{type:"enum",name:"button 2 long press",ref:{value:"btn2pressLong",options:["true"]}}]);return{ipevt:e}};h.prototype.executeCommand=function(e,g,k,n){k?(g=xnm.aio.hm.HmIPChannel.ACOUSTIC_DISPLAY_RECEIVER.buildCommandScript(e,g,{address:3},k))?e._doRequestMarked(g,!0,{execute:function(r,u){n&&n(r)}}):n&&n(Error("invalid command")):n&&n(Error("command is null"))};h.prototype.buildStateScript=function(e,g,k){if(!k)return null;
var n=null;switch(k.value){case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":n=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(e,g,{address:0},k)}return n};h.prototype.handleStatusResponse=function(e,g){if("?"==e)return e;switch(g.value){case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(e,g);default:return"?"}};h.prototype.resolveState=function(e,g,k){if(!g||!g.channel)return null;
var n=g.channel.indexOf(":");if(-1==n)return null;n=g.channel.substr(n+1);var r=null;switch(n){case "0":r=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.resolveState(e,g,k);break;case "1":case "2":if(r=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(e,g,k))"pressShort"==r.key?r.key="btn"+n+"pressShort":"pressLong"==r.key&&(r.key="btn"+n+"pressLong")}return r};return h}(),ea=function(){var h=function(){};h.prototype.getCommandStatusMap=function(){return{status:[{type:"enum",name:"communication error",
ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatVoltage",ext:"%f",extMeta:"0.0-25.2"}}]}};h.prototype.getIPEvtMap=function(){return{ipevt:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorLowbat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatVoltage",
...
options:["true"]}}]}};h.prototype.buildStateScript=function(e,g,k){if(!k)return null;var n=null;switch(k.value){case "errorComm":case "errorBat":case "errorBatVoltage":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(e,g,{address:0},k)}return n};h.prototype.handleStatusResponse=function(e,g){if("?"==e)return e;switch(g.value){case "errorComm":case "errorBat":case "errorBatVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(e,g);default:return"?"}};h.prototype.resolveState=
function(e,g,k){if(!g||!g.channel)return null;var n=g.channel.indexOf(":");if(-1==n)return null;var r=null;switch(g.channel.substr(n+1)){case "0":r=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(e,g,k);break;case "1":r=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(e,g,k);break;case "2":r=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(e,g,k);"pressShort"==r.key?r.key="roCWFast":"pressLong"==r.key&&(r.key="roCWSlow");break;case "3":r=xnm.aio.hm.HmIPChannel.KEY_TRANSCEIVER.resolveState(e,
g,k),"pressShort"==r.key?r.key="roACWFast":"pressLong"==r.key&&(r.key="roACWSlow")}return r};return h}();return{"HmIP-BSM":new y,"HmIP-BDT":new A,"HMIP-WRC2":new z,"HmIP-ASIR":new J,"HmIP-ASIR-2":new J,"HmIP-ASIR-O":new J,"HmIP-ASIR-B1":new J,"HmIP-SWSD":new L,"HmIP-SRH":new w,"HmIP-FSM":new C,"HmIP-PDT":new B,"HmIP-BROLL":new I,"HmIP-FROLL":new I,"HmIP-BBL":new D,"HmIP-FBL":new D,"HmIP-WRC6":new M,"HmIP-SPDR":new G,"HmIP-SWD":new S,"HmIP-SAM":new Q,"HmIP-WGC":new P,"HmIP-BSL":new X,"HmIP-MOD-TM":new V,
"HmIP-SLO":new Y,"HmIP-PMFS":new aa,"HmIP-MP3P":new ca,"HmIP-MOD-HO":new V,"HmIP-WRCD":new da,"HmIP-WRCR":new ea,"HmIP-STE2-PCB":{buildStateScript:function(h,e,g){return e.channels&&g.value?"errorComm"===g.value||"errorBat"===g.value?xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(h,e,{address:0},g):(h={tempSensor1:{dp:"ACTUAL_TEMPERATURE",chn:1},tempSensor2:{dp:"ACTUAL_TEMPERATURE",chn:2},tempDiff1m2:{dp:"ACTUAL_TEMPERATURE",chn:3},tempDiff2m1:{dp:"ACTUAL_TEMPERATURE",chn:3}}[g.value])?xnm.aio.hm.Channel.buildStateScript(e,
{address:h.chn},h.dp):null:null},getCommandStatusMap:function(h){return{status:[{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"errorBat",options:["false","true"]}},{type:"float",name:"temperature sensor 1",ref:{value:"tempSensor1",extMeta:"-3276.8-3276.7",scale:"0.1"}},{type:"float",name:"temperature sensor 2",ref:{value:"tempSensor2",extMeta:"-3276.8-3276.7",scale:"0.1"}},{type:"float",name:"temperature difference (1 - 2)",
ref:{value:"tempDiff1m2",extMeta:"-3276.8-3276.7",scale:"0.1"}},{type:"float",name:"temperature difference (2 - 1)",ref:{value:"tempDiff2m1",extMeta:"-3276.8-3276.7",scale:"0.1"}}]}},handleStatusResponse:function(h,e){if("?"===h)return h;var g="?";switch(e.value){case "errorComm":case "errorBat":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(h,e);case "tempSensor1":case "tempSensor2":case "tempDiff1m2":case "tempDiff2m1":g=parseFloat(h)}"tempDiff2m1"!==e.value||isNaN(g)||(g*=-1);isNaN(g)||
(g=Number(g).toFixed(1));return g},resolveState:function(h,e,g){if(!e||!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;var n=null;switch(e.channel.substr(k+1)){case "0":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.resolveState(h,e,g);break;case "1":n={key:"tempSensor1",value:g};break;case "2":n={key:"tempSensor2",value:g};break;case "3":n=[{key:"tempDiff1m2",value:g},{key:"tempDiff2m1",value:isNaN(g)?g:-g}]}return n}},"HmIP-DLD":{executeCommand:function(h,e,g,k){if(g){var n=null,
r=null,u=null;u="";var E={lock:"0",unlock:"1",open:"2"};switch(g.value){case "lock":case "unlock":case "open":n=1,r="LOCK_TARGET_LEVEL",u=E[g.value],u="if(o!=null){o.State("+u+");}\n"}if(!n&&String(g.value).startsWith("accessAuthSet")){n=parseInt(String(g.value).replace("accessAuthSet",""),10);n+=1;r="ACCESS_AUTHORIZATION";if("on"===g.ext)u="1";else if("off"===g.ext)u="0";else{k&&k(Error('ext value expected to be "on" or "off"'));return}u="if(o!=null){o.State("+u+");}\n"}if(isNaN(n))return null;(e=
xnm.aio.hm.Channel.buildCommandScript(e,{address:n},r,u))?h._doRequestMarked(e,!0,{execute:function(K,N){k&&k(K)}}):k&&k(Error("invalid command"))}else k&&k(Error("command is null"))},buildStateScript:function(h,e,g){var k=null;switch(g.value){case "maintBatBlBat":case "maintBatBlComm":case "maintBatBlDutyCycle":case "maintBatBlVoltage":k=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_BL.buildStateScript(h,e,{address:0},g);break;case "lockState":k=xnm.aio.hm.Channel.buildStateScript(e,{address:1},"LOCK_STATE")}!k&&
String(g.value).startsWith("accessAuthState")&&(h=parseInt(String(g.value).replace("accessAuthState",""),10),k=xnm.aio.hm.Channel.buildStateScript(e,{address:h+1},"ACCESS_RECEIVER"));return k},getCommandStatusMap:function(h){return{command:[{type:"enum",name:"lock",ref:{value:"lock"}},{type:"enum",name:"unlock",ref:{value:"unlock"}},{type:"enum",name:"open",ref:{value:"open"}},{type:"enum",name:"user 1 authorization",ref:{value:"accessAuthSet01",ext:"%e",extMeta:["on","off"]}},{type:"enum",name:"user 2 authorization",
ref:{value:"accessAuthSet02",ext:"%e",extMeta:["on","off"]}},{type:"enum",name:"user 3 authorization",ref:{value:"accessAuthSet03",ext:"%e",extMeta:["on","off"]}},{type:"enum",name:"user 4 authorization",ref:{value:"accessAuthSet04",ext:"%e",extMeta:["on","off"]}},{type:"enum",name:"user 5 authorization",ref:{value:"accessAuthSet05",ext:"%e",extMeta:["on","off"]}},{type:"enum",name:"user 6 authorization",ref:{value:"accessAuthSet06",ext:"%e",extMeta:["on","off"]}},{type:"enum",name:"user 7 authorization",
ref:{value:"accessAuthSet07",ext:"%e",extMeta:["on","off"]}},{type:"enum",name:"user 8 authorization",ref:{value:"accessAuthSet08",ext:"%e",extMeta:["on","off"]}}],status:[{type:"enum",name:"duty cycle error",ref:{value:"maintBatBlDutyCycle",value_t:"maintDutyCycle",options:["false","true"]}},{type:"enum",name:"battery low",ref:{value:"maintBatBlBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"maintBatBlVoltage",value_t:"maintBatVoltage",ext:"%f",extMeta:"0-25.2"}},
{type:"enum",name:"communication error",ref:{value:"maintBatBlComm",value_t:"maintErrorComm",options:["false","true"]}},{type:"enum",name:"lock state",ref:{value:"lockState",options:["unknown","locked","unlocked"]}},{type:"enum",name:"user 1 authorization",ref:{value:"accessAuthState01",options:["on","off"]}},{type:"enum",name:"user 2 authorization",ref:{value:"accessAuthState02",options:["on","off"]}},{type:"enum",name:"user 3 authorization",ref:{value:"accessAuthState03",options:["on","off"]}},
{type:"enum",name:"user 4 authorization",ref:{value:"accessAuthState04",options:["on","off"]}},{type:"enum",name:"user 5 authorization",ref:{value:"accessAuthState05",options:["on","off"]}},{type:"enum",name:"user 6 authorization",ref:{value:"accessAuthState06",options:["on","off"]}},{type:"enum",name:"user 7 authorization",ref:{value:"accessAuthState07",options:["on","off"]}},{type:"enum",name:"user 8 authorization",ref:{value:"accessAuthState08",options:["on","off"]}}]}},handleStatusResponse:function(h,
e){if("?"===h)return h;var g=["lock","unlock","open"];switch(e.value){case "maintBatBlBat":case "maintBatBlComm":case "maintBatBlDutyCycle":case "maintBatBlVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_BL.handleStatusResponse(h,e);case "lockState":return g[h]||"?"}if(String(e.value).startsWith("accessAuthState")){if("true"==h)return"on";if("false"==h)return"off"}return"?"},resolveState:function(h,e,g){if(!e||!e.channel)return null;var k=e.channel.indexOf(":");if(-1==k)return null;k=e.channel.substr(k+
1);var n=null,r=["unknown","locked","unlocked"];switch(k){case "0":n=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_BL.resolveState(h,e,g);break;case "1":n={key:"lockState",value:r[g]||"?"};break;case "2":case "3":case "4":case "5":case "6":case "7":case "8":case "9":n={key:"accessAuthState0"+(parseInt(k,10)-1),value:g?"on":"off"}}return n}},resolveJSON:function(h){if(!h||!h.type)return null;if("HmIP-PDT"==h.type)return b.parseJSON(h);if("HMIP-BSM"==h.type.toUpperCase().substr(0,8))return d.parseJSON(h,!0);
if(this[h.type])return this[h.type];var e=null;switch(h.type){case "HmIP-WHS2":e=c.parseJSON(h,1,2);break;case "HmIP-DBB":case "HmIP-BRC2":e=a.parseJSON(h);break;case "HmIP-RCV-50":e=a.parseJSON(h)}if("HMIP-PS"==h.type.toUpperCase().substr(0,7))e="HMIP-PSM"==h.type.toUpperCase().substr(0,8)?d.parseJSON(h):c.parseJSON(h);else if("HmIPW-DRS"==h.type.substr(0,9))e=c.parseJSON(h,1,parseInt(h.type.substr(9)));else if("HmIPW-DRD"==h.type.substr(0,9))e=b.parseJSON(h);else if("HmIPW-DRBL"==h.type.substr(0,
10))e=f.parseJSON(h,1,parseInt(h.type.substr(10)));else if("HmIPW-DRI"==h.type.substr(0,9))e=l.parseJSON(h);else if("HmIPW-FIO"==h.type.substr(0,9)){var g=parseInt(h.type.substr(9));if(h.channels)for(var k in h.channels)if("MULTI_MODE_INPUT_TRANSMITTER"==k.substr(0,28)){e=l.parseJSON(h);break}else if("SWITCH_TRANSMITTER"==k.substr(0,18)){e=c.parseJSON(h,g+1,g);break}}else if("HmIPW-STH"==h.type.substr(0,9)||"HmIPW-STHD"==h.type.substr(0,10)||"HmIPW-WTH"==h.type.substr(0,9))e=p.parseJSON(h);else if("HmIPW-SMI55"==
h.type)e=t.parseJSON(h);else if("HmIPW-SPI"==h.type)e=q.parseJSON(h);else if("HmIP-WTH-B"==h.type)e=p.parseJSON(h);else if("HmIP-FCI"==h.type.substr(0,8))e=l.parseJSON(h);else if("HmIP-MOD-RC"==h.type.substr(0,11))e=l.parseJSON(h);else if("HmIP-MOD-OC"==h.type.substr(0,11)){g=parseInt(h.type.substr(11));k=0;var n=h.address.indexOf(":");-1!=n&&(k=parseInt(h.address.substr(n+1)));0<k&&k<=g?e=a.parseJSON(h):0!=k&&(e=c.parseJSON(h,g+1,g))}else if("HmIP-FDT"==h.type.substr(0,8))e=b.parseJSON(h);else if("HmIP-FALMOT"==
h.type.substr(0,11))e=v.parseJSON(h);else if("HmIP-PCBS"==h.type.substr(0,9))g=parseInt(h.type.substr(9)),isNaN(g)||(k=0,n=h.address.indexOf(":"),-1!=n&&(k=parseInt(h.address.substr(n+1))),0<k&&k<=g?e=a.parseJSON(h):0!=k&&(e=c.parseJSON(h,g+1,g)));else if("HmIP-DRSI"==h.type.substr(0,9))g=parseInt(h.type.substr(9)),k=0,n=h.address.indexOf(":"),-1!=n&&(k=parseInt(h.address.substr(n+1))),0<k&&k<=g?e=l.parseJSON(h):0!=k&&(e=c.parseJSON(h,g+1,g));else if("HmIP-DRDI"==h.type.substr(0,9))g=parseInt(h.type.substr(9)),
k=0,n=h.address.indexOf(":"),-1!=n&&(k=parseInt(h.address.substr(n+1))),0<k&&k<=g?e=l.parseJSON(h):0!=k&&(e=b.parseJSON(h,g+1,g));else if("HmIP-DRBLI"==h.type.substr(0,10))g=parseInt(h.type.substr(10)),k=0,n=h.address.indexOf(":"),-1!=n&&(k=parseInt(h.address.substr(n+1))),0<k&&k<=2*g?e=l.parseJSON(h):0!=k&&(e=f.parseJSON(h,2*g+1,g));else if("HmIP-SCI"==h.type.substr(0,8))e=m.parseJSON(h);else if("HmIP-MIO16-PCB"==h.type)k=0,n=h.address.indexOf(":"),-1!=n&&(k=parseInt(h.address.substr(n+1))),e=0<
k&&13>k?x.parseJSON(h):13<=k&&17>k?l.parseJSON(h):c.parseJSON(h,17,8);else if(this[h.type])return this[h.type];return e},parseDevice:function(h){return h.channels&&h.hsstype&&h["interface"]?0==h.hsstype.indexOf("HmIPW")?this._parseHMIPWDevice(h):this._parseHmIPRFDevice(h):null},_parseHMIPWDevice:function(h){var e=function(r){var u=[];var E={sys:"hm"};E.id=r.name;E.type=r.hsstype;E.address=r.address;E.interface=r.interface;E.channels={};var K=0,N=JSON.parse(JSON.stringify(E)),F=null,H=r.channels,R=
!1,T;for(T in H)if(H.hasOwnProperty(T)){var U=r.channels[T];if(U.hsstype)if("ALARM_COND_SWITCH_TRANSMITTER"==U.hsstype)u.push(N);else if("MULTI_MODE_INPUT_TRANSMITTER"==U.hsstype&&(0!=K&&(u.push(N),N=JSON.parse(JSON.stringify(E)),R=!1,F&&(N.channels.MAINTENANCE=F)),K++),U.address){var O=U.address.indexOf(":");if(-1!==O){"MULTI_MODE_INPUT_TRANSMITTER"!=U.hsstype||R||(N.id=U.name?U.name:N.id,R=!0);O=U.address.substring(O+1);"MULTI_MODE_INPUT_TRANSMITTER"==U.hsstype&&(N.address+=":"+O);var W={id:U.name,
address:O,room:U.room,group:U.func};0==O?(F=W,N.channels.MAINTENANCE=F):N.channels[U.hsstype+":"+O]=W}}}return u},g=function(r){var u={sys:"hm"};u.id=r.name;u.type=r.hsstype;u.address=r.address;u.interface=r.interface;u.channels={};var E=0,K=!1,N=[];var F=[];var H=JSON.parse(JSON.stringify(u)),R=null,T=r.channels,U;for(U in T)if(T.hasOwnProperty(U)){var O=r.channels[U];if(O.hsstype&&O.address){var W=O.address.indexOf(":");if(-1!==W){W=O.address.substring(W+1);var Z={id:O.name,address:W,room:O.room,
group:O.func};if("MAINTENANCE"==O.hsstype)R=Z,H.channels.MAINTENANCE=R;else if("MULTI_MODE_INPUT_TRANSMITTER"==O.hsstype)H.channels[O.hsstype+":"+W]=Z,H.id=O.name?O.name:H.id,H.address+=":"+W,N.push(H),H=JSON.parse(JSON.stringify(u)),R&&(H.channels.MAINTENANCE=R);else if("SWITCH_TRANSMITTER"==O.hsstype)0!=E&&(F.push(H),H=JSON.parse(JSON.stringify(u)),K=!1,R&&(H.channels.MAINTENANCE=R)),E++,H.channels[O.hsstype+":"+W]=Z,H.address+=":"+W;else if("SWITCH_VIRTUAL_RECEIVER"==O.hsstype&&!K)H.channels[O.hsstype+
":"+W]=Z,H.id=O.name?O.name:H.id,K=!0;else if("SWITCH_WEEK_PROFILE"==O.hsstype){for(var ba=0;ba<F.length;ba++)F[ba].channels[O.hsstype+":"+W]=Z;F.push(H)}}}}return F.concat(N)},k=h.hsstype;if("HmIPW-DRS"==k.substr(0,9))return this._resolveHmIPMultiSwitch(h);if("HmIPW-DRD"==k.substr(0,9))return this._resolveHmIPMultiDimmer(h);if("HmIPW-DRBL"==k.substr(0,10))return this._resolveHmIPMultiBlind(h);if("HmIPW-DRI"==k.substr(0,9))return e(h);if("HmIPW-FIO"==k.substr(0,9))return g(h);if("HmIPW-SMI55"==k)return this._resolveHmIPDeviceFromScript(h,
function(r,u){return-1==["0","1","2","3"].indexOf(r)?0:-1!=["1","2"].indexOf(r)?2:1});if("HmIPW-SPI"==k)return this._resolveHmIPDeviceFromScript(h,function(r,u){return-1==["0","1"].indexOf(r)?0:1});var n={};return this._resolveHmIPDeviceFromScript(h,function(r,u){if(!xnm.aio.hm.HMIP_CHANNEL[u])return 0;n[u]||(n[u]=r);return n[u]!=r?0:1})},_parseHmIPRFDevice:function(h){var e=String(h.hsstype).toUpperCase();if("HMIP-PS"==e.substr(0,7))return this._resolveHmIPDeviceFromScript(h,function(r,u){return-1!=
["3","4","5"].indexOf(r)?2:1});if("HMIP-BSM"==e)return this._resolveHmIPDeviceFromScript(h,function(r,u){return-1!=["1","2","4","5","6"].indexOf(r)?2:1});if("HMIP-FSM"==e)return this._resolveHmIPDeviceFromScript(h,function(r,u){return-1=="012345".split("").indexOf(r)?0:-1!=["2","3","4"].indexOf(r)?2:1});if("HMIP-BDT"==e)return this._resolveHmIPDeviceFromScript(h,function(r,u){return-1==["0","3","4","5","6"].indexOf(r)?0:-1!=["4","5","6"].indexOf(r)?2:1});if("HMIP-PDT"==e)return this._resolveHmIPDeviceFromScript(h,
function(r,u){return-1=="023456".split("").indexOf(r)?0:-1!=["3","4","5"].indexOf(r)?2:1});if("HMIP-FDT"==e)return this._resolveHmIPDeviceFromScript(h,function(r,u){return-1=="012345".split("").indexOf(r)?0:-1!=["2","3","4"].indexOf(r)?2:1});if("HMIP-BROLL"==e||"HMIP-FROLL"==e||"HMIP-FBL"==e||"HMIP-BBL"==e)return this._resolveHmIPDeviceFromScript(h,function(r,u){return-1!=["1","2"].indexOf(r)?2:-1==["0","3","4","5","6"].indexOf(r)?0:-1!=["4","5","6"].indexOf(r)?2:1});if(-1!=e.indexOf("HMIP-WRC"))return"HMIP-WRCD"==
e?this._resolveHmIPDeviceFromScript(h,function(r,u){return 0==r?1:1==r||2==r?2:3==r?1:0}):"HMIP-WRCR"==e?this._resolveHmIPDeviceFromScript(h,function(r,u){return 0==r||1==r||2==r||3==r?1:0}):this._resolveHmIPDeviceFromScript(h,function(r,u){return 0==r?1:"KEY_TRANSCEIVER"==u?2:0});if(0==e.indexOf("HMIP-FAL"))return this._resolveHmIPDeviceFromScript(h,function(r,u){return"CLIMATECONTROL_FLOOR_PUMP_TRANSCEIVER"==u||"CLIMATECONTROL_FLOOR_TRANSCEIVER"==u?3:0});if("HMIP-SPDR"==e)return this._resolveHmIPDeviceFromScript(h,
function(r,u){return-1==["0","2","3"].indexOf(r)?0:-1!=["2","3"].indexOf(r)?2:1});if("HMIP-SMI55"==e)return this._resolveHmIPDeviceFromScript(h,function(r,u){return-1==["0","1","2","3"].indexOf(r)?0:-1!=["1","2"].indexOf(r)?3:1});if("HMIP-MIOB"==e)return this._resolveHmIPDeviceFromScript(h,function(r,u){return-1!=["3","7","9","10","11"].indexOf(r)?3:0});if("HMIP-SWD"==e||"HMIP-SAM"==e)return this._resolveHmIPDeviceFromScript(h,function(r,u){return 1});if("HMIP-WGC"==e)return this._resolveHmIPDeviceFromScript(h,
function(r,u){return-1=="012345".split("").indexOf(r)?0:-1!=["3","4","5"].indexOf(r)?2:1});if("HMIP-BSL"==e)return this._resolveHmIPDeviceFromScript(h,function(r,u){return-1!="5 6 9 10 13 14".split(" ").indexOf(r)?0:-1!="1 2 7 8 11 12".split(" ").indexOf(r)?2:1});if("HMIP-MOD-TM"==e)return this._resolveHmIPDeviceFromScript(h,function(r,u){return 1});if("HMIP-SLO"==e)return this._resolveHmIPDeviceFromScript(h,function(r,u){return-1!=["2","3"].indexOf(r)?0:1});if("HMIP-PMFS"==e)return this._resolveHmIPDeviceFromScript(h,
function(r,u){return 1});if("HMIP-MP3P"==e)return this._resolveHmIPDeviceFromScript(h,function(r,u){return-1!=["0","1","5","9"].indexOf(r)?1:-1!="234678".split("").indexOf(r)?2:0});if("HMIP-MOD-HO"==e)return this._resolveHmIPDeviceFromScript(h,function(r,u){return 1});if("HMIP-SCI"==e)return this._resolveHmIPDeviceFromScript(h,function(r,u){return 0==r||"SHUTTER_CONTACT_TRANSCEIVER"==u||"SHUTTER_CONTACT"==u?1:0});if("HMIP-MOD-OC"==e.substr(0,11)){var g=parseInt(h.hsstype.substr(11));e=this._resolveHmIPDeviceFromScript(h,
function(r,u){return"MAINTENANCE"==u?1:"KEY_TRANSCEIVER"==u?3:0});var k=[];for(i=1;i<=g;i++)k.push(i);h=this._resolveHmIPMultiSwitch(h,k);return e?h?e.concat(h):e:h}if(-1!=e.indexOf("HMIP-FCI"))return this._resolveHmIPDeviceFromScript(h,function(r,u){return 0==r?1:"MULTI_MODE_INPUT_TRANSMITTER"==u?3:0});if("HMIP-PCBS"==e.substr(0,9)&&(g=parseInt(h.hsstype.substr(9)),!isNaN(g))){e=this._resolveHmIPDeviceFromScript(h,function(r,u){return"MAINTENANCE"==u?1:"KEY_TRANSCEIVER"==u?3:0});k=[];for(i=1;i<=
g;i++)k.push(i);h=this._resolveHmIPMultiSwitch(h,k);return e?h?e.concat(h):e:h}if("HMIP-DRSI"==e.substr(0,9)){g=parseInt(h.hsstype.substr(9));e=this._resolveHmIPDeviceFromScript(h,function(r,u){return"MAINTENANCE"==u?1:"MULTI_MODE_INPUT_TRANSMITTER"==u?3:0});k=[];for(i=1;i<=g;i++)k.push(i);h=this._resolveHmIPMultiSwitch(h,k);return e?h?e.concat(h):e:h}if("HMIP-DRDI"==e.substr(0,9)){g=parseInt(h.hsstype.substr(9));e=this._resolveHmIPDeviceFromScript(h,function(r,u){return"MAINTENANCE"==u?1:"MULTI_MODE_INPUT_TRANSMITTER"==
u?3:0});k=[];for(i=1;i<=g;i++)k.push(i);h=this._resolveHmIPMultiDimmer(h,k);return e?h?e.concat(h):e:h}if("HMIP-DRBLI"==e.substr(0,10)){g=parseInt(h.hsstype.substr(10));e=this._resolveHmIPDeviceFromScript(h,function(r,u){return"MAINTENANCE"==u?1:"MULTI_MODE_INPUT_TRANSMITTER"==u?3:0});k=[];for(i=1;i<=2*g;i++)k.push(i);h=this._resolveHmIPMultiBlind(h,k);return e?h?e.concat(h):e:h}if("HMIP-MIO16-PCB"==e){e=this._resolveHmIPDeviceFromScript(h,function(r,u){return"MAINTENANCE"==u?1:"ANALOG_INPUT_TRANSMITTER"==
u||"MULTI_MODE_INPUT_TRANSMITTER"==u?3:0});k=[];for(i=1;16>=i;i++)k.push(i);h=this._resolveHmIPMultiSwitch(h,k);return e?h?e.concat(h):e:h}if("HMIP-STE2-PCB"===e)return this._resolveHmIPDeviceFromScript(h,function(r,u){return"MAINTENANCE"===u?1:"COND_SWITCH_TRANSMITTER_TEMPERATURE"===u?2:0});if("HMIP-DLD"===e)return this._resolveHmIPDeviceFromScript(h,function(r,u){return"MAINTENANCE_BAT_BL"===u||"DOOR_LOCK_STATE_TRANSMITTER"===u?1:"ACCESS_RECEIVER"===u?2:"SWITCH_WEEK_PROFILE"===u?1:0});g=this._getChannelCount(h.channels,
"SWITCH_TRANSMITTER");e=this._getChannelCount(h.channels,"SWITCH_VIRTUAL_RECEIVER");if(1<this._getChannelCount(h.channels,"KEY_TRANSCEIVER"))return this._resolveHmIPDeviceFromScript(h,function(r,u){return"MAINTENANCE"==u?1:"KEY_TRANSCEIVER"==u?3:0});if(1<g&&1<e)return this._resolveHmIPMultiSwitch(h);var n={};return this._resolveHmIPDeviceFromScript(h,function(r,u){if(!xnm.aio.hm.HMIP_CHANNEL[u])return 0;n[u]||(n[u]=r);return n[u]!=r?0:1})},_getChannelCount:function(h,e){var g=0,k;for(k in h)h.hasOwnProperty(k)&&
h[k].hsstype==e&&g++;return g},_parseDeviceBasic:function(h){var e={sys:"hm"};e.id=h.name;e.type=h.hsstype;e.address=h.address;e.interface=h.interface;e.channels={};return e},_resolveHmIPMultiSwitch:function(h,e){var g=[];var k={sys:"hm"};k.id=h.name;k.type=h.hsstype;k.address=h.address;k.interface=h.interface;k.channels={};var n=0,r=JSON.parse(JSON.stringify(k)),u=null,E=h.channels,K=!1,N;for(N in E)if(E.hasOwnProperty(N)){var F=h.channels[N];if(F.hsstype&&("SWITCH_TRANSMITTER"==F.hsstype&&(0!=n&&
(g.push(r),r=JSON.parse(JSON.stringify(k)),K=!1,u&&(r.channels.MAINTENANCE=u)),n++),F.address)){var H=F.address.indexOf(":");if(-1!==H&&("SWITCH_VIRTUAL_RECEIVER"!=F.hsstype||K||(r.id=F.name?F.name:r.id,K=!0),H=F.address.substring(H+1),!e||-1==e.indexOf(parseInt(H)))){"SWITCH_TRANSMITTER"==F.hsstype&&(r.address+=":"+H);var R={id:F.name,address:H,room:F.room,group:F.func};0==H?(u=R,r.channels.MAINTENANCE=u):r.channels[F.hsstype+":"+H]=R;if("SWITCH_WEEK_PROFILE"==F.hsstype){for(var T=0;T<g.length;T++)g[T].channels[F.hsstype+
":"+H]=R;g.push(r)}}}}return g},_resolveHmIPMultiDimmer:function(h,e){var g=[];var k={sys:"hm"};k.id=h.name;k.type=h.hsstype;k.address=h.address;k.interface=h.interface;k.channels={};var n=0,r=JSON.parse(JSON.stringify(k)),u=null,E=h.channels,K=!1,N;for(N in E)if(E.hasOwnProperty(N)){var F=h.channels[N];if(F.hsstype&&("DIMMER_TRANSMITTER"==F.hsstype&&(0!=n&&(g.push(r),r=JSON.parse(JSON.stringify(k)),K=!1,u&&(r.channels.MAINTENANCE=u)),n++),F.address)){var H=F.address.indexOf(":");if(-1!==H&&("DIMMER_VIRTUAL_RECEIVER"!=
F.hsstype||K||(r.id=F.name?F.name:r.id,K=!0),H=F.address.substring(H+1),!e||-1==e.indexOf(parseInt(H)))){"DIMMER_TRANSMITTER"==F.hsstype&&(r.address+=":"+H);var R={id:F.name,address:H,room:F.room,group:F.func};0==H?(u=R,r.channels.MAINTENANCE=u):r.channels[F.hsstype+":"+H]=R;if("DIMMER_WEEK_PROFILE"==F.hsstype){for(var T=0;T<g.length;T++)g[T].channels[F.hsstype+":"+H]=R;g.push(r)}}}}return g},_resolveHmIPMultiBlind:function(h,e){var g=[];var k={sys:"hm"};k.id=h.name;k.type=h.hsstype;k.address=h.address;
k.interface=h.interface;k.channels={};var n=0,r=JSON.parse(JSON.stringify(k)),u=null,E=h.channels,K=!1,N;for(N in E)if(E.hasOwnProperty(N)){var F=h.channels[N];if(F.hsstype&&("BLIND_TRANSMITTER"==F.hsstype&&(0!=n&&(g.push(r),r=JSON.parse(JSON.stringify(k)),K=!1,u&&(r.channels.MAINTENANCE=u)),n++),F.address)){var H=F.address.indexOf(":");if(-1!==H&&("BLIND_VIRTUAL_RECEIVER"!=F.hsstype||K||(r.id=F.name?F.name:r.id,K=!0),H=F.address.substring(H+1),!e||-1==e.indexOf(parseInt(H)))){"BLIND_TRANSMITTER"==
F.hsstype&&(r.address+=":"+H);var R={id:F.name,address:H,room:F.room,group:F.func};0==H?(u=R,r.channels.MAINTENANCE=u):r.channels[F.hsstype+":"+H]=R;if("BLIND_WEEK_PROFILE"==F.hsstype){for(var T=0;T<g.length;T++)g[T].channels[F.hsstype+":"+H]=R;g.push(r)}}}}return g},_resolveHmIPDeviceFromScript:function(h,e){var g=[],k={sys:"hm"};k.id=h.name;k.type=h.hsstype;k.address=h.address;k["interface"]=h["interface"];k.channels={};var n=h.channels,r=!1,u;for(u in n)if(channel=h.channels[u],channel.address&&
(n=channel.address.indexOf(":"),-1!==n)){n=channel.address.substring(n+1);var E=channel.hsstype;if(channel.hsstype){var K=1;e&&(K=e(n,E));0!=K&&(3==K?(K=JSON.parse(JSON.stringify(k)),K.address=K.address+":"+n,K.id=K.id+"("+K.address+")",K.channels[E]={id:channel.name,address:n,room:channel.room,group:channel.func},g.push(K)):(r=!0,2==K&&(E=E+":"+n),k.channels[E]={id:channel.name,address:n,room:channel.room,group:channel.func}))}}r&&g.push(k);return g}}}();
...
applyUIFilter:function(a,c){var d=this,b=function(w,C){if("*"==w)return!0;for(var B=!1,I=0;I<w.length;I++)if(w[I]==C){B=!0;break}return B},f=function(w,C){switch(w.type){case "SysVar":return m(w,C);case "Prog":return l(w,C);default:return z(w,C)}},l=function(w,C){var B=[],I=C.elems;switch(C.catagory){case "command":[{type:"enum",name:"execute",ref:{value:"progExec"}}].forEach(function(D){b(I,D.type)&&(D=JSON.parse(JSON.stringify(D)),B.push(D))})}return B},m=function(w,C){var B=[],I=C.elems;if(w["class"]&&
(w=xnm.aio.hm.MAP.SysVar[w["class"]]))switch(C.catagory){case "command":w.command&&w.command.forEach(function(D){b(I,D.type)&&(D=JSON.parse(JSON.stringify(D)),B.push(D))});break;case "status":w.status&&w.status.forEach(function(D){b(I,D.type)&&(D=JSON.parse(JSON.stringify(D)),B.push(D))})}return B},p=function(w,C,B,I,D){var M=[];if(w=w[C][B])switch(c.catagory){case "command":w.command&&I.access&&-1!=I.access.indexOf("w")&&w.command.forEach(function(G){b(D,G.type)&&(G=JSON.parse(JSON.stringify(G)),
M.push(G))});break;case "status":w.status&&I.access&&-1!=I.access.indexOf("r")&&w.status.forEach(function(G){b(D,G.type)&&(G=JSON.parse(JSON.stringify(G)),M.push(G))})}return M},t=function(w,C){var B=[],I=C.elems;switch(C.catagory){case "command":w.command&&w.command.forEach(function(D){b(I,D.type)&&(D=JSON.parse(JSON.stringify(D)),B.push(D))});break;case "status":w.status&&w.status.forEach(function(D){b(I,D.type)&&(D=JSON.parse(JSON.stringify(D)),B.push(D))})}return B},q=function(w,C){if(w){var B=
xnm.aio.hm.HmIPDevice.resolveJSON(w);if(B&&B.getCommandStatusMap&&(B=B.getCommandStatusMap(w)))return t(B,C)}B=[];var I=w.channels;w=xnm.aio.hm.DM._getHmIPChannels(w);var D=C.elems,M;for(M in I)if(I.hasOwnProperty(M)){var G=w[M];if(G)for(var S in G)G.hasOwnProperty(S)&&xnm.aio.hm.HMIP_MAP[M]&&(C=p(xnm.aio.hm.HMIP_MAP,M,S,G[S],D),B=B.concat(C))}return B},v=function(w,C){var B=[],I=C.elems;w=xnm.aio.hm.HM_Sec_Sir_WM_MAP;switch(C.catagory){case "command":w.command.forEach(function(D){b(I,D.type)&&(D=
JSON.parse(JSON.stringify(D)),B.push(D))});break;case "status":w.status.forEach(function(D){b(I,D.type)&&(D=JSON.parse(JSON.stringify(D)),B.push(D))})}return B},x=function(w,C){var B=[],I=C.elems;w=xnm.aio.hm.HM_WDS30_OT2_SM_2_MAP;switch(C.catagory){case "status":w.status.forEach(function(D){b(I,D.type)&&(D=JSON.parse(JSON.stringify(D)),B.push(D))})}return B},y=function(w,C){var B=[],I=C.elems;w=xnm.aio.hm.HM_ES_TX_WM_MAP;switch(C.catagory){case "status":w.status.forEach(function(D){b(I,D.type)&&
(D=JSON.parse(JSON.stringify(D)),B.push(D))})}return B},A=function(w,C){var B=[],I=C.elems;w=[{type:"int",name:"dim to",ref:{value:"dimRaw",ext:"%d",extMeta:"0-100",scale:"10"}}];switch(C.catagory){case "command":w.forEach(function(D){b(I,D.type)&&(D=JSON.parse(JSON.stringify(D)),B.push(D))})}return B},z=function(w,C){if("HmIP-HEATING"==w.type)return q(w,C);if(w["interface"]&&"CUxD"==w["interface"]){var B=[];w.cuxd||(w.cuxd=xnm.aio.hm.MHMCCU._resolveCUxDType(w));var I=w.channels,D=xnm.aio.hm.DM._getCUxDChannels(w),
M=C.elems,G;for(G in I)if(I.hasOwnProperty(G)){var S=D[G];if(S)for(var Q in S)S.hasOwnProperty(Q)&&("FHT_Multiventil"==w.cuxd&&"DIMMER"==G?G="FHT_Multiventil_Dimmer":"HMS_100_Contact"==w.cuxd&&"SENSOR"==G?G="HMS_100_Contact":"FHT_Contact"==w.cuxd&&"SENSOR"==G?G="FHT_Contact":"Security_Sensor"==w.cuxd&&"SENSOR"==G?G="Security_Sensor":"HMS_100_W/WD"==w.cuxd&&"SENSOR"==G&&(G="Security_Sensor"),xnm.aio.hm.CUxDMAP[G]?(C=p(xnm.aio.hm.CUxDMAP,G,Q,S[Q],M),B=B.concat(C)):xnm.aio.hm.MAP[G]&&(C=p(xnm.aio.hm.MAP,
G,Q,S[Q],M),B=B.concat(C)))}return B}if(w["interface"]&&"HmIP-RF"==w["interface"])return q(w,C);if(w["interface"]&&"BidCos-RF"==w["interface"]&&w.type&&xnm.aio.hm.BidCosDevice[w.type]&&(G=xnm.aio.hm.BidCosDevice[w.type])&&G.getCommandStatusMap&&(G=G.getCommandStatusMap(w))||w["interface"]&&"VirtualDevices"==w["interface"]&&-1==w.type.indexOf("HM-CC-VG")&&(G=d._getVirtualDevicesMap(w)))return t(G,C);if("DimmerKey"==w.type)return A(w,C);if("HM-Sec-Sir-WM"==w.type)return v(w,C);if("HM-WDS30-OT2-SM-2"==
w.type)return x(w,C);if("HM-ES-TX-WM"==w.type&&w.channels&&w.channels.POWERMETER_IEC1)return y(w,C);G=[];Q=w.channels;w=xnm.aio.hm.DM._getChannels(w);D=C.elems;for(B in Q)if(Q.hasOwnProperty(B)&&(M=w[B]))for(I in M)M.hasOwnProperty(I)&&xnm.aio.hm.MAP[B]&&(C=p(xnm.aio.hm.MAP,B,I,M[I],D),G=G.concat(C));return G};if(!a.type)return null;var J=JSON.parse(JSON.stringify(a)),L=null;switch(c.catagory){case "command":L=f(a,c);J.command=L;break;case "status":L=f(a,c);J.status=L;break;default:return null}return L&&
...
"Sysvar"==a.type)return!1;var c=a.channels;if(!c)return!1;var d={},b;for(b in c)if(c.hasOwnProperty(b)){var f=b,l=f.indexOf(":");-1!=l&&(f=f.substr(0,l));d[f]=!0}return"BidCos-RF"==a["interface"]?d.SWITCH||d.DIMMER||d.VIRTUAL_DIMMER||d.BLIND||d.JALOUSIE||d.POWERMETER||d.CLIMATECONTROL_REGULATOR||d.THERMALCONTROL_TRANSMIT||d.CLIMATECONTROL_RT_TRANSCEIVER||d.SHUTTER_CONTACT||d.ROTARY_HANDLE_SENSOR||d.WEATHER||d.MOTION_DETECTOR||d.SMOKE_DETECTOR||d.SMOKE_DETECTOR_TEAM||d.SMOKE_DETECTOR_TEAM_V2||d.RGBW_COLOR||
d.KEYMATIC||d.WINMATIC||d.SENSOR_FOR_CARBON_DIOXIDE||d.WATERDETECTIONSENSOR||d.LUXMETER?!0:!1:a["interface"]&&"HMIP-RF"==a["interface"].toUpperCase()?d.ANALOG_OUTPUT_TRANSCEIVER||d.BLIND_VIRTUAL_RECEIVER||d.BRIGHTNESS_TRANSMITTER||d.CLIMATE_TRANSCEIVER||d.DIMMER_VIRTUAL_RECEIVER||d.DOOR_LOCK_STATE_TRANSMITTER||d.ENERGIE_METER_TRANSMITTER||d.HEATING_CLIMATECONTROL_TRANSCEIVER||d.MOTIONDETECTOR_TRANSCEIVER||d.PRESENCEDETECTOR_TRANSCEIVER||d.RAIN_DETECTION_TRANSMITTER||d.ROTARY_HANDLE_TRANSCEIVER||d.SHUTTER_CONTACT||
d.SHUTTER_CONTACT_TRANSCEIVER||d.SHUTTER_VIRTUAL_RECEIVER||d.SMOKE_DETECTOR||d.SWITCH_VIRTUAL_RECEIVER||d.WEATHER_TRANSMIT?!0:!1:"BidCos-Wired"==a["interface"]?d.DIGITAL_OUTPUT||d.DIGITAL_ANALOG_OUTPUT||d.SWITCH||d.DIMMER||d.BLIND?!0:!1:!1},applySmartWidgetFilter:function(a,c,d){return a&&"Prog"!=a.type&&"Sysvar"!=a.type?"BidCos-RF"==a["interface"]||"BidCos-Wired"==a["interface"]?this._applySmartWidget_BidCos(a,c,d):a["interface"]&&"HMIP-RF"==a["interface"].toUpperCase()?this._applySmartWidget_HmIP(a,
c,d):null:null},_applySmartWidget_BidCos:function(a,c,d,b,f){if(!a.channels)return null;b={};for(var l in a.channels)if(a.channels.hasOwnProperty(l)){f=l;var m=f.indexOf(":");-1!=m&&(f=f.substr(0,m));b[f]=!0}if(b.DIGITAL_OUTPUT){var p={"%on%":{value:"digOutOn",name:"on"},"%off%":{value:"digOutOff",name:"off"},"%toggle%":{value:"digOutToggle",name:"toggle"}};var t={"%switchState%":{value:"digOutState",options:["off","on"],name:"state"}};var q=["switch"]}b.DIGITAL_ANALOG_OUTPUT&&(p={"%on%":{value:"daOutOn",
name:"on"},"%off%":{value:"daOutOff",name:"off"},"%toggle%":{value:"daOutToggle",name:"toggle"}},t={"%switchState%":{value:"daOutState",options:["off","on"],name:"state"}},q=["switch"]);b.SWITCH&&(p={"%on%":{value:"on",name:"on"},"%off%":{value:"off",name:"off"},"%toggle%":{value:"toggle",name:"toggle"}},t={"%switchState%":{value:"switchState",options:["off","on"],name:"switch status"}},q=["switch"]);if(b.DIMMER||b.VIRTUAL_DIMMER)p={"%on%":{value:"dimOn",name:"on"},"%off%":{value:"dimOff",name:"off"},
"%dimOn%":{value:"dimOn",name:"on"},"%dimOff%":{value:"dimOff",name:"off"},"%dimUp%":{value:"dimUp",name:"dim up"},"%dimDown%":{value:"dimDown",name:"dim down"},"%dimTo%":{value:"dimRaw",ext:"%d",extMeta:"0-100",name:"dim to"}},t={"%dimmerState%":{value:"dimmerLevel",ext:"%d",extMeta:"0-100",name:"dimmer status"}},q=["switch","dimmer"];b.BLIND&&(p||(p={}),p["%stop%"]||(p["%stop%"]={value:"blindStop",name:"stop"}),p["%moveUp%"]||(p["%moveUp%"]={value:"blindUp",name:"move up"}),p["%moveDown%"]||(p["%moveDown%"]=
{value:"blindDown",name:"move down"}),p["%stepUp%"]||(p["%stepUp%"]={value:"blindStepUp",name:"step up"}),p["%stepDown%"]||(p["%stepDown%"]={value:"blindStepDown",name:"step down"}),p["%moveTo%"]||(p["%moveTo%"]={value:"blindRaw",ext:"%d",extMeta:"0-100",name:"move to"}),t={"%shutterState%":{value:"blindLevel",ext:"%d",extMeta:"0-100",name:"blind status"}},q=["shutter"]);b.JALOUSIE&&(p||(p={}),p["%stop%"]||(p["%stop%"]={value:"jalStop",name:"stop"}),p["%moveUp%"]||(p["%moveUp%"]={value:"jalUp",name:"move up"}),
p["%moveDown%"]||(p["%moveDown%"]={value:"jalDown",name:"move down"}),p["%stepUp%"]||(p["%stepUp%"]={value:"jalStepUp",name:"step up"}),p["%stepDown%"]||(p["%stepDown%"]={value:"jalStepDown",name:"step down"}),p["%moveTo%"]||(p["%moveTo%"]={value:"jalRaw",ext:"%d",extMeta:"0-100",name:"move to"}),p["%lamellaUp%"]||(p["%lamellaUp%"]={value:"jalLmlUp",name:"lamella up"}),p["%lamellaDown%"]||(p["%lamellaDown%"]={value:"jalLmlDown",name:"lamella down"}),p["%lamellaStepUp%"]||(p["%lamellaStepUp%"]={value:"jalLmlStepUp",
name:"lamella step up",ext:10}),p["%lamellaStepDown%"]||(p["%lamellaStepDown%"]={value:"jalLmlStepDown",name:"lamella step down",ext:10}),p["%lamellaTo%"]||(p["%lamellaTo%"]={value:"jalLmlRaw",ext:"%d",extMeta:"0-100",name:"lamella to"}),t={"%blindState%":{value:"jalLevel",ext:"%d",extMeta:"0-100",name:"status"},"%lamellaState%":{value:"jalLmlLevel",ext:"%d",extMeta:"0-100",name:"lamella status"}},q=["shutter","blind"]);b.POWERMETER&&(t||(t={}),t["%meterVoltage%"]||(t["%meterVoltage%"]={value:"meterVoltage",
extMeta:"0.0-6553.5",scale:"0.1",unit:"V",name:"voltage"}),t["%meterEnergyCounter%"]||(t["%meterEnergyCounter%"]={value:"meterEnergyCounter",extMeta:"0.0-838860.7",scale:"0.1",unit:"Wh",name:"energy counter"}),t["%meterFrequency%"]||(t["%meterFrequency%"]={value:"meterFrequency",extMeta:"48.72-51.27",scale:"0.01",unit:"Hz",name:"frequency"}),t["%meterPower%"]||(t["%meterPower%"]={value:"meterPower",extMeta:"0.0-167772.15",scale:"0.1",unit:"W",name:"power"}),t["%meterCurrent%"]||(t["%meterCurrent%"]=
{value:"meterCurrent",extMeta:"0.0-65535.0",scale:"0.1",unit:"mA",name:"current"}),q||(q=[]),-1==q.indexOf("powermeter")&&q.push("powermeter"));b.CLIMATECONTROL_REGULATOR&&(p||(p={}),p["%thermoTempUp%"]||(p["%thermoTempUp%"]={value:"themoRTempUp",name:"temperature up"}),p["%thermoTempDown%"]||(p["%thermoTempDown%"]={value:"themoRTempDown",name:"temperature down"}),p["%thermoTempTo%"]||(p["%thermoTempTo%"]={value:"themoRTempRaw",ext:"%f",extMeta:"6-30",scale:"0.5",name:"temperature to"}),p["%thermoOn%"]||
(p["%thermoOn%"]={value:"themoTempOn",name:"on"}),p["%thermoOff%"]||(p["%thermoOff%"]={value:"themoRTempClose",name:"close"}),t={"%thermoCurrentTemp%":{value:"weatherTemp",name:"temperature"},"%thermoHum%":{value:"weatherHum",name:"humidity"},"%thermoSetTemp%":{value:"themoRSetTemp",extMeta:"6-30",scale:"0.5",name:"set temperature"}},q=["thermostat"]);b.THERMALCONTROL_TRANSMIT&&(p||(p={}),p["%thermoAuto%"]||(p["%thermoAuto%"]={value:"themoTAutoMode",name:"set auto mode"}),p["%thermoManu%"]||(p["%thermoManu%"]=
{value:"themoTManuMode",ext:"20.0",name:"set manual mode"}),p["%thermoBoost%"]||(p["%thermoBoost%"]={value:"themoTBoostMode",name:"set boost mode"}),p["%thermoTempUp%"]||(p["%thermoTempUp%"]={value:"themoTTempUp",name:"temperature up"}),p["%thermoTempDown%"]||(p["%thermoTempDown%"]={value:"themoTTempDown",name:"temperature down"}),p["%thermoTempTo%"]||(p["%thermoTempTo%"]={value:"themoTTempRaw",ext:"%f",extMeta:"4.5-30.5",scale:"0.5",name:"temperature to"}),p["%thermoOff%"]||(p["%thermoOff%"]={value:"themoTTempOff",
name:"off"}),t={"%thermoCurrentTemp%":{value:"themoTActualTemp",name:"actual temperature"},"%thermoHum%":{value:"themoTActualHum",name:"actual humidity"},"%thermoMode%":{value:"themoTMode",options:["auto","manu","party","boost"],name:"mode"},"%thermoSetTemp%":{value:"themoTSetTemp",extMeta:"4.5-30.5",scale:"0.5",name:"set temperature"},"%thermoWindow%":{value:"themoTWin",options:["open","closed"],name:"window open"}},q=["thermostat"]);b.CLIMATECONTROL_RT_TRANSCEIVER&&(p||(p={}),p["%thermoAuto%"]||
(p["%thermoAuto%"]={value:"themoAutoMode",name:"set auto mode"}),p["%thermoManu%"]||(p["%thermoManu%"]={value:"themoManuMode",ext:"20.0",name:"set manual mode"}),p["%thermoBoost%"]||(p["%thermoBoost%"]={value:"themoBoostMode",name:"set boost mode"}),p["%thermoTempUp%"]||(p["%thermoTempUp%"]={value:"themoTempUp",name:"temperature up"}),p["%thermoTempDown%"]||(p["%thermoTempDown%"]={value:"themoTempDown",name:"temperature down"}),p["%thermoTempTo%"]||(p["%thermoTempTo%"]={value:"themoTempRaw",ext:"%f",
extMeta:"4.5-30.5",scale:"0.5",name:"temperature to"}),p["%thermoOff%"]||(p["%thermoOff%"]={value:"themoTempOff",name:"off"}),t={"%thermoCurrentTemp%":{value:"themoActualTemp",name:"actual temperature"},"%thermoHum%":{value:"themoActualHum",name:"actual humidit"},"%thermoMode%":{value:"themoMode",options:["auto","manu","party","boost"],name:"mode"},"%thermoSetTemp%":{value:"themoSetTemp",extMeta:"4.5-30.5",scale:"0.5",name:"set temperature"},"%thermoWindow%":{value:"themoWinState",options:["open",
"closed"],name:"window state"}},q=["thermostat"]);b.SHUTTER_CONTACT&&(t={"%contactState%":{value:"shutterState",options:["closed","open"],name:"contact state"}},q=["contact"]);b.ROTARY_HANDLE_SENSOR&&(t={"%windowState%":{value:"handleState",options:["closed","tilted","open"],name:"handle state"}},q=["window"]);b.WEATHER&&((a=a.type)&&"HM-WDS30"==a.substr(0,8)?(t={"%tempState%":{value:"weatherTemp",name:"temperature"}},q=["climate"]):a&&"HM-WDS100"==a.substr(0,9)?(t={"%tempState%":{value:"weatherTemp",
name:"temperature"},"%humState%":{value:"weatherHum",name:"humidity"},"%brightnessState%":{value:"weatherBright",name:"brightness"},"%sunshineState%":{value:"weatherSunD",name:"sunshine duration"},"%windDirection%":{value:"weatherWindD",name:"wind direction",options:"N NO O SO S SW W NW".split(" ")},"%windspeedState%":{value:"weatherWindS",name:"wind speed"},"%rainingState%":{value:"weatherRaining",name:"raining"},"%rainingCounterState%":{value:"weatherRainCounter",name:"rain counter"}},q=["weather_station"]):
(t={"%tempState%":{value:"weatherTemp",name:"temperature"},"%humState%":{value:"weatherHum",name:"humidity"}},q=["climate"]));b.MOTION_DETECTOR&&(t={"%motionState%":{value:"motionState",options:["on","off"],name:"state"},"%motionBrightness%":{value:"motionBright",name:"brightness"}},q=["motion"]);b.SMOKE_DETECTOR&&(t={"%smokeState%":{value:"smokeState",options:["on","off"],name:"state"}},q=["smoke"]);b.SMOKE_DETECTOR_TEAM&&(t={"%smokeState%":{value:"smokeGroup1State",options:["on","off"],name:"state"}},
q=["smoke"]);b.SMOKE_DETECTOR_TEAM_V2&&(t={"%smokeState%":{value:"smokeGroupState",options:["on","off"],name:"state"}},q=["smoke"]);b.RGBW_COLOR&&(p||(p={}),p["%rgb%"]||(p["%rgb%"]={value:"rgb",ext:"%s",name:"rgb color"}),p["%white%"]||(p["%white%"]={value:"white",name:"white"}),q||(q=[]),-1==q.indexOf("rgb")&&q.push("rgb"));b.WINMATIC&&(p||(p={}),p["%windowUp%"]||(p["%windowUp%"]={value:"windowUp"}),p["%windowDown%"]||(p["%windowDown%"]={value:"windowDown"}),p["%windowTo%"]||(p["%windowTo%"]={value:"windowTo",
ext:"%d",extMeta:"0-100"}),p["%windowLock%"]||(p["%windowLock%"]={value:"winLock"}),p["%windowStop%"]||(p["%windowStop%"]={value:"winStop"}),t={"%windowLevel%":{value:"winLevel"}},q=["winmatic"]);b.KEYMATIC&&(p||(p={}),p["%lock%"]||(p["%lock%"]={value:"keyLock"}),p["%unlock%"]||(p["%unlock%"]={value:"keyOpen"}),p["%open%"]||(p["%open%"]={value:"keyOpenDo"}),t={"%lockStatus%":{value:"keyState",options:["open","lock"]}},q=["keymatic"]);b.SENSOR_FOR_CARBON_DIOXIDE&&(t={"%co2State%":{value:"co2State",
options:["normal","added","added_strong"]}},q=["sensor_co2"]);b.WATERDETECTIONSENSOR&&(t={"%waterState%":{value:"waterState",options:["dry","wet","water"]}},q=["sensor_water"]);if(b.LUXMETER){t={"%state%":{value:"luxState",extMeta:"0.00-100000.00",scale:"0.01"}};var v={"%icon%":"sun"};q=["generic_state"]}return q&&0!=q.length?this._injectToSmartWidgetTemplate(c,q,d,p,t,v):null},_applySmartWidget_HmIP:function(a,c,d,b,f){if(!a.channels||"HmIP-WGC"==a.type)return null;var l,m,p;if("HmIP-BSL"==a.type)return l||
(l={}),l["%on%"]||(l["%on%"]={value:"on",name:"on"}),l["%off%"]||(l["%off%"]={value:"off",name:"off"}),l["%toggle%"]||(l["%toggle%"]={value:"toggle",name:"toggle"}),m||(m={}),m["%switchState%"]||(m["%switchState%"]={value:"switchState",options:["off","on"],name:"switch status"}),this._injectToSmartWidgetTemplate(c,["switch"],d,l,m);b={};for(var t in a.channels)if(a.channels.hasOwnProperty(t)){f=t;var q=f.indexOf(":");-1!=q&&(f=f.substr(0,q));b[f]=!0}b.SWITCH_VIRTUAL_RECEIVER&&(l||(l={}),"HmIP-BSM"==
a.type?(l["%on%"]||(l["%on%"]={value:"ch4on",name:"ch.4 on"}),l["%off%"]||(l["%off%"]={value:"ch4off",name:"ch.4 off"}),l["%toggle%"]||(l["%toggle%"]={value:"ch4toggle",name:"ch.4 toggle"})):(l["%on%"]||(l["%on%"]={value:"on",name:"on"}),l["%off%"]||(l["%off%"]={value:"off",name:"off"}),l["%toggle%"]||(l["%toggle%"]={value:"toggle",name:"toggle"})),m||(m={}),m["%switchState%"]||(m["%switchState%"]={value:"switchState",options:["off","on"],name:"switch status"}),p||(p=[]),-1==p.indexOf("switch")&&
p.push("switch"));b.DIMMER_VIRTUAL_RECEIVER&&(l||(l={}),l["%on%"]||(l["%on%"]={value:"dimTo",ext:100,name:"dim to"}),l["%off%"]||(l["%off%"]={value:"dimOff",name:"off"}),l["%dimOn%"]||(l["%dimOn%"]={value:"dimTo",ext:100,name:"dim to"}),l["%dimOff%"]||(l["%dimOff%"]={value:"dimOff",name:"off"}),l["%dimUp%"]||(l["%dimUp%"]={value:"dimUp",ext:5,name:"dim up"}),l["%dimDown%"]||(l["%dimDown%"]={value:"dimDown",ext:5,name:"dim down"}),l["%dimTo%"]||(l["%dimTo%"]={value:"dimTo",ext:"%d",extMeta:"0-100",
name:"dim to"}),m={"%dimmerState%":{value:"dimmerTLevel",ext:"%d",extMeta:"0-100",name:"dimmer status"}},p=["switch","dimmer"]);b.SHUTTER_VIRTUAL_RECEIVER&&(l||(l={}),l["%stop%"]||(l["%stop%"]={value:"stop",name:"stop"}),l["%moveUp%"]||(l["%moveUp%"]={value:"moveUp",name:"move up"}),l["%moveDown%"]||(l["%moveDown%"]={value:"moveDown",name:"move down"}),l["%stepUp%"]||(l["%stepUp%"]={value:"stepUp",ext:5,name:"step up"}),l["%stepDown%"]||(l["%stepDown%"]={value:"stepDown",ext:5,name:"step down"}),
l["%moveTo%"]||(l["%moveTo%"]={value:"moveTo",ext:"%d",extMeta:"0-100",name:"move to"}),m={"%shutterState%":{value:"blindTLevel",ext:"%d",extMeta:"0-100",name:"blind status"}},p=["shutter"]);b.BLIND_VIRTUAL_RECEIVER&&(l||(l={}),l["%stop%"]||(l["%stop%"]={value:"stop",name:"stop"}),l["%moveUp%"]||(l["%moveUp%"]={value:"moveUp",name:"move up"}),l["%moveDown%"]||(l["%moveDown%"]={value:"moveDown",name:"move down"}),l["%stepUp%"]||(l["%stepUp%"]={value:"stepUp",ext:5,name:"step up"}),l["%stepDown%"]||
(l["%stepDown%"]={value:"stepDown",ext:5,name:"step down"}),l["%moveTo%"]||(l["%moveTo%"]={value:"moveTo",ext:"%d",extMeta:"0-100",name:"move to"}),l["%lamellaUp%"]||(l["%lamellaUp%"]={value:"lamellaUp",name:"lamella up"}),l["%lamellaDown%"]||(l["%lamellaDown%"]={value:"lamellaDown",name:"lamella down"}),l["%lamellaStepUp%"]||(l["%lamellaStepUp%"]={value:"lamellaStepUp",ext:5,name:"lamella step up"}),l["%lamellaStepDown%"]||(l["%lamellaStepDown%"]={value:"lamellaStepDown",ext:5,name:"lamella step down"}),
l["%lamellaTo%"]||(l["%lamellaTo%"]={value:"lamellaTo",ext:"%d",extMeta:"0-100",name:"lamella to"}),m={"%blindState%":{value:"blindTPos",ext:"%d",extMeta:"0-100",name:"blind status"},"%lamellaState%":{value:"lamellaTPos",ext:"%d",extMeta:"0-100",name:"lamella status"}},p=["shutter","blind"]);b.ENERGIE_METER_TRANSMITTER&&(m||(m={}),m["%meterVoltage%"]||(m["%meterVoltage%"]={value:"meterVoltage",extMeta:"0.0-409.5",scale:"0.1",unit:"V",name:"voltage"}),m["%meterEnergyCounter%"]||(m["%meterEnergyCounter%"]=
{value:"meterEnergyCounter",extMeta:"0.0-838859.1",scale:"0.1",unit:"Wh",name:"energy counter"}),m["%meterFrequency%"]||(m["%meterFrequency%"]={value:"meterFrequency",extMeta:"29.52-70.47",scale:"0.01",unit:"Hz",name:"frequency"}),m["%meterPower%"]||(m["%meterPower%"]={value:"meterPower",extMeta:"0.0-163830.0",scale:"0.1",unit:"W",name:"power"}),m["%meterCurrent%"]||(m["%meterCurrent%"]={value:"meterCurrent",extMeta:"0.0-65535.0",scale:"0.1",unit:"mA",name:"current"}),p||(p=[]),-1==p.indexOf("powermeter")&&
p.push("powermeter"));b.HEATING_CLIMATECONTROL_TRANSCEIVER&&(l||(l={}),l["%thermoAuto%"]||(l["%thermoAuto%"]={value:"themoAutoMode",name:"set auto mode"}),l["%thermoManu%"]||(l["%thermoManu%"]={value:"themoManuMode",name:"set manu mode"}),l["%thermoBoost%"]||(l["%thermoBoost%"]={value:"themoBoostOn",name:"boost on"}),l["%thermoTempUp%"]||(l["%thermoTempUp%"]={value:"themoTempUp",name:"temperature up"}),l["%thermoTempDown%"]||(l["%thermoTempDown%"]={value:"themoTempDown",name:"temperature down"}),
l["%thermoTempTo%"]||(l["%thermoTempTo%"]={value:"themoTemp",ext:"%f",extMeta:"4.5-30.5",scale:"0.5",name:"set temperature"}),l["%thermoOn%"]||(l["%thermoOn%"]={value:"themoTempOn",name:"on"}),l["%thermoOff%"]||(l["%thermoOff%"]={value:"themoTempOff",name:"off"}),l["%thermoBoostOff%"]||(l["%thermoBoostOff%"]={value:"themoBoostOff",name:"boost off"}),l["%thermoProfile%"]||(l["%thermoProfile%"]={value:"themoProf",ext:"%d",extMeta:"1-6",scale:"1",name:"set profile"}),m={"%thermoCurrentTemp%":{value:"themoActualTemp",
name:"actual temperature"},"%thermoHum%":{value:"themoHum",name:"humidity"},"%thermoMode%":{value:"themoMode",options:["auto","manu"],name:"mode"},"%thermoSetTemp%":{value:"themoTemp",extMeta:"4.5-30.5",scale:"0.5",name:"set temperature"},"%thermoProfile%":{value:"themoProf",ext:"%d",extMeta:"1-6",scale:"1",name:"set profile"},"%thermoBoostMode%":{value:"themoBoostMode",options:["off","on"],name:"boost mode"},"%thermoWindow%":{value:"themoWinState",options:["open","closed"],name:"window state"}},
p=["thermostat"]);b.SHUTTER_CONTACT&&(m={"%contactState%":{value:"shutterState",options:["closed","open"],name:"contact state"}},p=["contact"]);b.SHUTTER_CONTACT_TRANSCEIVER&&(m={"%contactState%":{value:"shutterTState",options:["closed","open"],name:"contact state"}},p=["contact"]);b.ROTARY_HANDLE_TRANSCEIVER&&(m={"%windowState%":{value:"handleState",options:["closed","tilted","open"],name:"handle state"}},p=["window"]);b.CLIMATE_TRANSCEIVER&&(m={"%tempState%":{value:"climateActualTemp",extMeta:"-3276.8-3276.7",
scale:"0.1",name:"actual temperature"},"%humState%":{value:"climateHum",name:"humidity"}},p=["climate"]);b.WEATHER_TRANSMIT&&(m={"%tempState%":{value:"weatherActualTemp",name:"actual temperature"},"%humState%":{value:"weatherHum",name:"humidity"},"%brightnessState%":{value:"weatherIllu",name:"brightness"},"%sunshineState%":{value:"weatherSunD",name:"sunshine duration"},"%windspeedState%":{value:"weatherWindS",name:"wind speed"}},"HmIP-SWO-PL"==a.type?(m["%rainingState%"]={value:"weatherRain",name:"raining"},
m["%rainingCounterState%"]={value:"weatherRainC",name:"rain counter"}):"HmIP-SWO-PR"==a.type&&(m["%rainingState%"]={value:"weatherRain",name:"raining"},m["%rainingCounterState%"]={value:"weatherRainC",name:"rain counter"},m["%windDirection%"]={value:"weatherWindD",name:"wind direction"}),p=["weather_station"]);b.MOTIONDETECTOR_TRANSCEIVER&&(l||(l={}),l["%motionActivate%"]||(l["%motionActivate%"]={value:"motionOn",name:"activate detection"}),l["%motionDeactivate%"]||(l["%motionDeactivate%"]={value:"motionOff",
name:"deactivate detection"}),l["%motionToggle%"]||(l["%motionToggle%"]={value:"motionToggle",name:"toggle detection"}),l["%motionReset%"]||(l["%motionReset%"]={value:"motionReset",name:"reset"}),m={"%motionState%":{value:"motionState",options:["on","off"],name:"state",conv_s:{on:"true",off:"false"}},"%motionBrightness%":{value:"motionIllu",name:"illumination"},"%motionActivate%":{value:"motionActivate",options:["off","on"],name:"detection activated"}},p=["motion"]);b.PRESENCEDETECTOR_TRANSCEIVER&&
(l||(l={}),l["%motionActivate%"]||(l["%motionActivate%"]={value:"presenceOn",name:"activate detection"}),l["%motionDeactivate%"]||(l["%motionDeactivate%"]={value:"presenceOff",name:"deactivate detection"}),l["%motionToggle%"]||(l["%motionToggle%"]={value:"presenceToggle",name:"toggle detection"}),l["%motionReset%"]||(l["%motionReset%"]={value:"presenceReset",name:"reset"}),m={"%motionState%":{value:"presenceState",options:["on","off"],name:"state",conv_s:{on:"true",off:"false"}},"%motionBrightness%":{value:"presenceIllu",
name:"illumination"},"%motionActivate%":{value:"presenceActivate",options:["off","on"],name:"detection activated"}},p=["motion"]);b.SMOKE_DETECTOR&&(m={"%smokeState%":{value:"smokeState",options:["on","off"],name:"alarm state"}},p=["smoke"]);b.ANALOG_OUTPUT_TRANSCEIVER&&(l||(l={}),l["%dimOn%"]||(l["%dimOn%"]={value:"analogOutputTo",ext:100,name:"output to"}),l["%dimOff%"]||(l["%dimOff%"]={value:"analogOutputOff",name:"off"}),l["%dimUp%"]||(l["%dimUp%"]={value:"analogOutputUp",ext:5,name:"up"}),l["%dimDown%"]||
(l["%dimDown%"]={value:"analogOutputDown",ext:5,name:"down"}),l["%dimTo%"]||(l["%dimTo%"]={value:"analogOutputTo",ext:"%d",extMeta:"0-100",name:"output to"}),m={"%dimmerState%":{value:"analogOutputLevel",ext:"%d",extMeta:"0-100",name:"output status"}},p=["dimmer"]);b.BRIGHTNESS_TRANSMITTER&&(m={"%brightnessState%":{value:"briIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"},"%brightnessAvg%":{value:"briAvgIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"},"%brightnessMax%":{value:"briMaxIllu",ext:"%f",
extMeta:"0-163830.0",unit:"lux"},"%brightnessMin%":{value:"briMinIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"}},p=["lux"]);b.RAIN_DETECTION_TRANSMITTER&&(m={"%rainState%":{value:"raining",options:["true","false"]},"%tempState%":{value:"temperature",extMeta:"-3276.8-3276.7",scale:"0.1"}},p=["rain"]);b.DOOR_LOCK_STATE_TRANSMITTER&&(l||(l={}),l["%lock%"]||(l["%lock%"]={value:"lock"}),l["%unlock%"]||(l["%unlock%"]={value:"unlock"}),l["%open%"]||(l["%open%"]={value:"open"}),m={"%lockStatus%":{value:"lockState",
options:["unknown","locked","unlocked"],conv_s:{unknown:"?",unlocked:"open"}}},p=["keymatic"]);return p&&0!=p.length?this._injectToSmartWidgetTemplate(c,p,d,l,m):null},_injectToSmartWidgetTemplate:function(a,c,d,b,f,l){var m=[];a||(b={});b||(b={});f||(f={});for(var p=0;p<a.length;p++){var t=a[p];if(t.meta&&-1!=c.indexOf(t.meta.type)&&t.elements){t=JSON.parse(JSON.stringify(t));var q=!1,v;for(v in t.elements){var x=t.elements[v];if(x&&Array.isArray(x))for(var y=0;y<x.length;y++){var A=x[y];if(A){if(A.action&&
"command"==A.action.type&&A.action.ref&&A.action.ref.value){var z=A.action.ref.ext;b[A.action.ref.value]?(A.action.ref=b[A.action.ref.value],z&&(A.action.ref.ext=z),A.action.device=d,q=!0):A.action=null}A.status&&A.status.ref&&A.status.ref.value&&(f[A.status.ref.value]?(A.status.ref=f[A.status.ref.value],A.status.device=d,q=!0):A.status=null);A.widget&&"%icon%"==A.widget.key_img&&l&&(A.widget.key_img=l["%icon%"])}}}q&&m.push(t)}}return m},toGeneralDevice:function(a,c){if(!a)return null;c={};for(f in a.channels){var d=
f,b=d.indexOf(":");-1!=b&&(d=d.substr(0,b));c[d]=!0}var f=null;c.SWITCH&&(f={type:"switch",commands:{on:{},off:{},toggle:{}},states:{state:{values:["on","off"]}},details:{commands:{on:{value:"on"},off:{value:"off"},toggle:{value:"toggle"}},states:{state:{value:"switchState"}}}});c.DIMMER&&(f={type:"dimmer",commands:{on:{},off:{},brightness:{value:{type:"INT",min:0,max:100,step:1}}},states:{brightness:{min:0,max:100,unit:"%"}},details:{commands:{on:{value:"dimTo",ext:100},off:{value:"dimOff"},brightness:{value:"dimTo",
ext:"%d"}},states:{brightness:{value:"dimmerTLevel"}}}});c.BLIND&&(f={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}}},states:{position:{min:0,max:100}},details:{commands:{up:{value:"blindUp"},down:{value:"blindDown"},stop:{value:"stop"},position:{value:"moveTo",ext:"%d"}},states:{position:{value:"blindLevel"}}}});c.JALOUSIE&&(f={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}},rotation:{value:{type:"INT",
min:0,max:100,step:1}}},states:{position:{min:0,max:100},rotation:{min:0,max:100}},details:{commands:{up:{value:"jalUp"},down:{value:"jalDown"},stop:{value:"jalStop"},position:{value:"jalRaw",ext:"%d"},rotation:{value:"jalLmlRaw",ext:"%d"}},states:{position:{value:"jalLevel"},rotation:{value:"jalLmlLevel"}}}});c.CLIMATECONTROL_REGULATOR&&(f={type:"heater",commands:{tempUp:{},tempDown:{},tempTo:{value:{type:"FLOAT",min:6,max:30,step:.5}}},states:{setpoint:{type:"FLOAT",min:6,max:30,step:.5,unit:"\u00b0C"},
temperature:{type:"FLOAT"},humidity:{type:"INT"}},details:{commands:{tempUp:{value:"themoRTempUp"},tempDown:{value:"themoRTempDown"},tempTo:{value:"themoRTempRaw",ext:"%f"}},states:{setpoint:{value:"themoRSetTemp"},temperature:{value:"weatherTemp"},humidity:{value:"weatherHum"}}}});c.THERMALCONTROL_TRANSMIT&&(f={type:"heater",commands:{tempUp:{},tempDown:{},tempTo:{value:{type:"FLOAT",min:4,max:30.5,step:.5}},auto:{},manu:{}},states:{setpoint:{type:"FLOAT",min:4,max:30.5,step:.5,unit:"\u00b0C"},temperature:{type:"FLOAT"},
humidity:{type:"INT"}},details:{commands:{tempUp:{value:"themoTTempUp"},tempDown:{value:"themoTTempDown"},tempTo:{value:"themoTTempRaw",ext:"%f"},auto:{value:"themoAutoMode"},manu:{value:"themoManuMode"}},states:{setpoint:{value:"themoTSetTemp"},temperature:{value:"themoTActualTemp"},humidity:{value:"themoTActualHum"},mode:{value:"themoTMode"}}}});c.CLIMATECONTROL_RT_TRANSCEIVER&&(f={type:"heater",commands:{tempUp:{},tempDown:{},tempTo:{value:{type:"FLOAT",min:4,max:30.5,step:.5}},auto:{},manu:{}},
states:{setpoint:{type:"FLOAT",min:4,max:30.5,step:.5,unit:"\u00b0C"},temperature:{type:"FLOAT"},humidity:{type:"INT"}},details:{commands:{tempUp:{value:"themoTempUp"},tempDown:{value:"themoTempDown"},tempTo:{value:"themoTempRaw",ext:"%f"},auto:{value:"themoAutoMode"},manu:{value:"themoManuMode"}},states:{setpoint:{value:"themoSetTemp"},temperature:{value:"themoActualTemp"},humidity:{value:"themoActualHum"},mode:{value:"themoMode"}}}});if("HmIP-WGC"==a.type)return null;c.SWITCH_VIRTUAL_RECEIVER&&
(f={type:"switch",commands:{on:{},off:{},toggle:{}},states:{state:{values:["on","off"]}},details:{commands:{on:{value:"on"},off:{value:"off"},toggle:{value:"toggle"}},states:{state:{value:"switchState"}}}});c.DIMMER_VIRTUAL_RECEIVER&&(f={type:"dimmer",commands:{on:{},off:{},brightness:{value:{type:"INT",min:0,max:100,step:1}}},states:{brightness:{min:0,max:100,unit:"%"}},details:{commands:{on:{value:"dimOn"},off:{value:"dimOff"},brightness:{value:"dimRaw",ext:"%d"}},states:{brightness:{value:"dimmerLevel"}}}});
c.SHUTTER_VIRTUAL_RECEIVER&&(f={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}}},states:{position:{min:0,max:100}},details:{commands:{up:{value:"moveUp"},down:{value:"moveDown"},stop:{value:"blindStop"},position:{value:"blindRaw",ext:"%d"}},states:{position:{value:"blindTLevel"}}}});c.BLIND_VIRTUAL_RECEIVER&&(f={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}},rotation:{value:{type:"INT",min:0,max:100,step:1}}},
states:{position:{min:0,max:100},rotation:{min:0,max:100}},details:{commands:{up:{value:"moveUp"},down:{value:"moveDown"},stop:{value:"stop"},position:{value:"moveTo",ext:"%d"},rotation:{value:"lamellaTo",ext:"%d"}},states:{position:{value:"blindTPos"},rotation:{value:"lamellaTPos"}}}});c.HEATING_CLIMATECONTROL_TRANSCEIVER&&(f={type:"heater",commands:{tempUp:{},tempDown:{},tempTo:{value:{type:"FLOAT",min:4,max:30.5,step:.5}},auto:{},manu:{}},states:{setpoint:{type:"FLOAT",min:4,max:30.5,step:.5,unit:"\u00b0C"},
...
xnm.aio.hm.Handler=function(){var a=require("x.logger.js");this._logger=a?a.getLogger("xnm.aio.hm.Handler"):{log:function(){}};xnm.aio.hm.Handler._logger=a?a.getLogger("xnm.aio.hm.Handler"):{log:function(){}}};
