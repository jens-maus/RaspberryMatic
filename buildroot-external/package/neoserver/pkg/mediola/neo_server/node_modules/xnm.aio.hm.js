...
SECTION:{type:"integer",access:"re",min:0,max:15},SECTION_STATUS:{type:"option",access:"re",values:{0:"NORMAL",1:"UNKNOWN"}},WP_OPTIONS:{type:"option",access:"rwe",values:{0:"NOP",1:"ON",2:"OFF"}}}]},DOOR_LOCK_STATE_TRANSCEIVER:{datapoints:[{LOCK_STATE:{type:"option",access:"re",values:{0:"UNKNOWN",1:"LOCKED",2:"UNLOCKED"}}}]},ACCESS_RECEIVER:{datapoints:[{ACCESS_AUTHORIZATION:{type:"option",access:"w",values:{0:"DISABLE",1:"ENABLE"}},STATE:{type:"boolean",access:"re"}}]},RAIN_DETECTION_TRANSMITTER:{datapoints:[{ACTUAL_TEMPERATURE:{type:"float",
access:"re",min:-3276.8,max:3276.7},HEATER_STATE:{type:"boolean",access:"re"},RAINING:{type:"boolean",access:"re"}}]}};
...
default:return"?"}},resolveState:function(a,c,d){switch(c.datapoint){case "ENERGY_COUNTER":var b="meterEnergyCounter";break;case "POWER":b="meterPower";break;case "CURRENT":b="meterCurrent";break;case "VOLTAGE":b="meterVoltage";break;case "FREQUENCY":b="meterFrequency"}if(!b)return null;a=this.handleStatusResponse(d+"",{value:b});return{key:b,value:a}},getCommandStatusMap:function(a){var c={status:[{type:"float",name:"voltage",ref:{value:"meterVoltage",extMeta:"0.0-409.5",scale:"0.1",unit:"V"}},{type:"float",
name:"energy counter",ref:{value:"meterEnergyCounter",extMeta:"0.0-838859.1",scale:"0.1",unit:"Wh"}},{type:"float",name:"power",ref:{value:"meterPower",extMeta:"0.0-163830.0",scale:"0.1",unit:"W"}},{type:"float",name:"current",ref:{value:"meterCurrent",extMeta:"0.0-65535.0",scale:"0.1",unit:"mA"}}]};a&&"HMIP-USBSM"===String(a.type).toUpperCase()||c.status.push({type:"float",name:"frequency",ref:{value:"meterFrequency",extMeta:"29.52-70.47",scale:"0.01",unit:"Hz"}});return c},getIPEvtMap:function(a){return{ipevt:this.getCommandStatusMap(a).status}}},
SMOKE_DETECTOR:{buildCommandScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "intrusionAlarmOff":a="SMOKE_DETECTOR_COMMAND";b="if(o!=null){o.State(1);}\n";break;case "intrusionAlarmOn":a="SMOKE_DETECTOR_COMMAND";b="if(o!=null){o.State(2);}\n";break;default:return null}return xnm.aio.hm.Channel.buildCommandScript(c,d,a,b)},buildStateScript:function(a,c,d,b){if(!c.channels||!b.value)return null;switch(b.value){case "smokeState":case "smokeAlarmDetail":break;default:return null}return xnm.aio.hm.Channel.buildStateScript(c,
...
name:"battery low",ref:{value:"errorBatElBat",options:["false","true"]}},{type:"float",name:"battery voltage",ref:{value:"errorBatElVoltage",ext:"%f",extMeta:"0.0-25.2"}}]):e.status.concat([{type:"enum",name:"communication error",ref:{value:"errorComm",options:["false","true"]}}]);return e};k.prototype.getIPEvtMap=function(){var e={ipevt:[{type:"int",name:"profile",ref:{value:"themoProf"}},{type:"float",name:"actual temperature",ref:{value:"themoActualTemp",extMeta:"-10.0-56.0",scale:"0.1"}},{type:"enum",
...
options:["false","true"]}}]);return e};k.prototype.executeCommand=function(e,g,h,n){h?(script=xnm.aio.hm.HmIPChannel.HEATING_CLIMATECONTROL_TRANSCEIVER.buildCommandScript(e,{interface:g.interface,address:this._address,channels:g.channels},{address:this._chHeatingClimateControlTransceiver},{value:h.value,ext:h.ext}))?e._doRequestMarked(script,!0,{execute:function(r,u){setTimeout(function(){n&&n(r)},200)}}):n&&n(Error("invalid command")):n&&n(Error("command is null"))};k.prototype.buildStateScript=
function(e,g,h){if(!h)return null;var n=null;switch(h.value){case "errorComm":n=xnm.aio.hm.HmIPChannel.MAINTENANCE.buildStateScript(e,g,{address:this._chMaintenance},h);break;case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":n=xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.buildStateScript(e,g,{address:this._chMaintenance},h);break;case "themoProf":case "themoActualTemp":case "themoBoostMode":case "themoFrost":case "themoHum":case "themoMode":case "themoTemp":case "themoValveLevel":case "themoWinState":n=
xnm.aio.hm.HmIPChannel.HEATING_CLIMATECONTROL_TRANSCEIVER.buildStateScript(e,g,{address:this._chHeatingClimateControlTransceiver},{value:h.value})}return n};k.prototype.handleStatusResponse=function(e,g){if("?"==e)return e;switch(g.value){case "errorComm":return xnm.aio.hm.HmIPChannel.MAINTENANCE.handleStatusResponse(e,g);case "errorBatElComm":case "errorBatElBat":case "errorBatElVoltage":return xnm.aio.hm.HmIPChannel.MAINTENANCE_BAT_EL.handleStatusResponse(e,g);case "themoProf":case "themoActualTemp":case "themoBoostMode":case "themoFrost":case "themoHum":case "themoMode":case "themoTemp":case "themoValveLevel":case "themoWinState":return xnm.aio.hm.HmIPChannel.HEATING_CLIMATECONTROL_TRANSCEIVER.handleStatusResponse(e,
...
"HMIP-RF"==a["interface"].toUpperCase()?this._applySmartWidget_HmIP(a,c,d):null:null},_applySmartWidget_BidCos:function(a,c,d,b,f){if(!a.channels)return null;b={};for(var l in a.channels)if(a.channels.hasOwnProperty(l)){f=l;var m=f.indexOf(":");-1!=m&&(f=f.substr(0,m));b[f]=!0}if(b.DIGITAL_OUTPUT){var p={"%on%":{value:"digOutOn",name:"on"},"%off%":{value:"digOutOff",name:"off"},"%toggle%":{value:"digOutToggle",name:"toggle"}};var t={"%switchState%":{value:"digOutState",options:["off","on"],name:"state"}};
var q=["switch"]}b.DIGITAL_ANALOG_OUTPUT&&(p={"%on%":{value:"daOutOn",name:"on"},"%off%":{value:"daOutOff",name:"off"},"%toggle%":{value:"daOutToggle",name:"toggle"}},t={"%switchState%":{value:"daOutState",options:["off","on"],name:"state"}},q=["switch"]);b.SWITCH&&(p={"%on%":{value:"on",name:"on"},"%off%":{value:"off",name:"off"},"%toggle%":{value:"toggle",name:"toggle"}},t={"%switchState%":{value:"switchState",options:["off","on"],name:"switch status"}},q=["switch"]);if(b.DIMMER||b.VIRTUAL_DIMMER)p=
{"%on%":{value:"dimOn",name:"on"},"%off%":{value:"dimOff",name:"off"},"%dimOn%":{value:"dimOn",name:"on"},"%dimOff%":{value:"dimOff",name:"off"},"%dimUp%":{value:"dimUp",name:"dim up"},"%dimDown%":{value:"dimDown",name:"dim down"},"%dimTo%":{value:"dimRaw",ext:"%d",extMeta:"0-100",name:"dim to"}},t={"%dimmerState%":{value:"dimmerLevel",ext:"%d",extMeta:"0-100",name:"dimmer status"}},q=["switch","dimmer"];b.BLIND&&(p||(p={}),p["%stop%"]||(p["%stop%"]={value:"blindStop",name:"stop"}),p["%moveUp%"]||
(p["%moveUp%"]={value:"blindUp",name:"move up"}),p["%moveDown%"]||(p["%moveDown%"]={value:"blindDown",name:"move down"}),p["%stepUp%"]||(p["%stepUp%"]={value:"blindStepUp",name:"step up"}),p["%stepDown%"]||(p["%stepDown%"]={value:"blindStepDown",name:"step down"}),p["%moveTo%"]||(p["%moveTo%"]={value:"blindRaw",ext:"%d",extMeta:"0-100",name:"move to"}),t={"%shutterState%":{value:"blindLevel",ext:"%d",extMeta:"0-100",name:"blind status"}},q=["shutter"]);b.JALOUSIE&&(p||(p={}),p["%stop%"]||(p["%stop%"]=
{value:"jalStop",name:"stop"}),p["%moveUp%"]||(p["%moveUp%"]={value:"jalUp",name:"move up"}),p["%moveDown%"]||(p["%moveDown%"]={value:"jalDown",name:"move down"}),p["%stepUp%"]||(p["%stepUp%"]={value:"jalStepUp",name:"step up"}),p["%stepDown%"]||(p["%stepDown%"]={value:"jalStepDown",name:"step down"}),p["%moveTo%"]||(p["%moveTo%"]={value:"jalRaw",ext:"%d",extMeta:"0-100",name:"move to"}),p["%lamellaUp%"]||(p["%lamellaUp%"]={value:"jalLmlUp",name:"lamella up"}),p["%lamellaDown%"]||(p["%lamellaDown%"]=
...
m={"%thermoCurrentTemp%":{value:"themoActualTemp",name:"actual temperature"},"%thermoHum%":{value:"themoHum",name:"humidity"},"%thermoMode%":{value:"themoMode",options:["auto","manu"],name:"mode"},"%thermoSetTemp%":{value:"themoTemp",extMeta:"4.5-30.5",scale:"0.5",name:"set temperature"},"%thermoProfile%":{value:"themoProf",ext:"%d",extMeta:"1-6",scale:"1",name:"set profile"},"%thermoBoostMode%":{value:"themoBoostMode",options:["off","on"],name:"boost mode"},"%thermoWindow%":{value:"themoWinState",
options:["open","closed"],name:"window state"}},p=["thermostat"]);b.SHUTTER_CONTACT&&(m={"%contactState%":{value:"shutterState",options:["closed","open"],name:"contact state"}},p=["contact"]);b.SHUTTER_CONTACT_TRANSCEIVER&&(m={"%contactState%":{value:"shutterTState",options:["closed","open"],name:"contact state"}},p=["contact"]);b.ROTARY_HANDLE_TRANSCEIVER&&(m={"%windowState%":{value:"handleState",options:["closed","tilted","open"],name:"handle state"}},p=["window"]);b.CLIMATE_TRANSCEIVER&&(m={"%tempState%":{value:"climateActualTemp",
extMeta:"-3276.8-3276.7",scale:"0.1",name:"actual temperature"},"%humState%":{value:"climateHum",name:"humidity"}},p=["climate"]);b.COND_SWITCH_TRANSMITTER_TEMPERATURE&&(m={"%tempState%":{value:"tempSensor1",extMeta:"-3276.8-3276.7",scale:"0.1"}},p=["climate"]);b.WEATHER_TRANSMIT&&(m={"%tempState%":{value:"weatherActualTemp",name:"actual temperature"},"%humState%":{value:"weatherHum",name:"humidity"},"%brightnessState%":{value:"weatherIllu",name:"brightness"},"%sunshineState%":{value:"weatherSunD",
name:"sunshine duration"},"%windspeedState%":{value:"weatherWindS",name:"wind speed"}},"HmIP-SWO-PL"==a.type?(m["%rainingState%"]={value:"weatherRain",name:"raining"},m["%rainingCounterState%"]={value:"weatherRainC",name:"rain counter"}):"HmIP-SWO-PR"==a.type&&(m["%rainingState%"]={value:"weatherRain",name:"raining"},m["%rainingCounterState%"]={value:"weatherRainC",name:"rain counter"},m["%windDirection%"]={value:"weatherWindD",name:"wind direction"}),p=["weather_station"]);b.MOTIONDETECTOR_TRANSCEIVER&&
(l||(l={}),l["%motionActivate%"]||(l["%motionActivate%"]={value:"motionOn",name:"activate detection"}),l["%motionDeactivate%"]||(l["%motionDeactivate%"]={value:"motionOff",name:"deactivate detection"}),l["%motionToggle%"]||(l["%motionToggle%"]={value:"motionToggle",name:"toggle detection"}),l["%motionReset%"]||(l["%motionReset%"]={value:"motionReset",name:"reset"}),m={"%motionState%":{value:"motionState",options:["on","off"],name:"state",conv_s:{on:"true",off:"false"}},"%motionBrightness%":{value:"motionIllu",
name:"illumination"},"%motionActivate%":{value:"motionActivate",options:["off","on"],name:"detection activated"}},p=["motion"]);b.PRESENCEDETECTOR_TRANSCEIVER&&(l||(l={}),l["%motionActivate%"]||(l["%motionActivate%"]={value:"presenceOn",name:"activate detection"}),l["%motionDeactivate%"]||(l["%motionDeactivate%"]={value:"presenceOff",name:"deactivate detection"}),l["%motionToggle%"]||(l["%motionToggle%"]={value:"presenceToggle",name:"toggle detection"}),l["%motionReset%"]||(l["%motionReset%"]={value:"presenceReset",
name:"reset"}),m={"%motionState%":{value:"presenceState",options:["on","off"],name:"state",conv_s:{on:"true",off:"false"}},"%motionBrightness%":{value:"presenceIllu",name:"illumination"},"%motionActivate%":{value:"presenceActivate",options:["off","on"],name:"detection activated"}},p=["motion"]);b.SMOKE_DETECTOR&&(m={"%smokeState%":{value:"smokeState",options:["on","off"],name:"alarm state"}},p=["smoke"]);b.ANALOG_OUTPUT_TRANSCEIVER&&(l||(l={}),l["%dimOn%"]||(l["%dimOn%"]={value:"analogOutputTo",ext:100,
name:"output to"}),l["%dimOff%"]||(l["%dimOff%"]={value:"analogOutputOff",name:"off"}),l["%dimUp%"]||(l["%dimUp%"]={value:"analogOutputUp",ext:5,name:"up"}),l["%dimDown%"]||(l["%dimDown%"]={value:"analogOutputDown",ext:5,name:"down"}),l["%dimTo%"]||(l["%dimTo%"]={value:"analogOutputTo",ext:"%d",extMeta:"0-100",name:"output to"}),m={"%dimmerState%":{value:"analogOutputLevel",ext:"%d",extMeta:"0-100",name:"output status"}},p=["dimmer"]);b.BRIGHTNESS_TRANSMITTER&&(m={"%brightnessState%":{value:"briIllu",
ext:"%f",extMeta:"0-163830.0",unit:"lux"},"%brightnessAvg%":{value:"briAvgIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"},"%brightnessMax%":{value:"briMaxIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"},"%brightnessMin%":{value:"briMinIllu",ext:"%f",extMeta:"0-163830.0",unit:"lux"}},p=["lux"]);b.RAIN_DETECTION_TRANSMITTER&&(m={"%rainState%":{value:"raining",options:["true","false"]},"%tempState%":{value:"temperature",extMeta:"-3276.8-3276.7",scale:"0.1"}},p=["rain"]);b.DOOR_LOCK_STATE_TRANSMITTER&&
(l||(l={}),l["%lock%"]||(l["%lock%"]={value:"lock"}),l["%unlock%"]||(l["%unlock%"]={value:"unlock"}),l["%open%"]||(l["%open%"]={value:"open"}),m={"%lockStatus%":{value:"lockState",options:["unknown","locked","unlocked"],conv_s:{unknown:"?",unlocked:"open"}}},p=["keymatic"]);return p&&0!=p.length?this._injectToSmartWidgetTemplate(c,p,d,l,m):null},_injectToSmartWidgetTemplate:function(a,c,d,b,f,l){var m=[];a||(b={});b||(b={});f||(f={});for(var p=0;p<a.length;p++){var t=a[p];if(t.meta&&-1!=c.indexOf(t.meta.type)&&
t.elements){t=JSON.parse(JSON.stringify(t));var q=!1,v;for(v in t.elements){var x=t.elements[v];if(x&&Array.isArray(x))for(var y=0;y<x.length;y++){var A=x[y];if(A){if(A.action&&"command"==A.action.type&&A.action.ref&&A.action.ref.value){var z=A.action.ref.ext;b[A.action.ref.value]?(A.action.ref=b[A.action.ref.value],z&&(A.action.ref.ext=z),A.action.device=d,q=!0):A.action=null}A.status&&A.status.ref&&A.status.ref.value&&(f[A.status.ref.value]?(A.status.ref=f[A.status.ref.value],A.status.device=d,
q=!0):A.status=null);A.widget&&"%icon%"==A.widget.key_img&&l&&(A.widget.key_img=l["%icon%"])}}}q&&m.push(t)}}return m},toGeneralDevice:function(a,c){if(!a)return null;c=null;var d={},b;for(b in a.channels){var f=b,l=f.indexOf(":");-1!=l&&(f=f.substr(0,l));d[f]=!0}d.SWITCH&&(c={type:"switch",commands:{on:{},off:{},toggle:{}},states:{state:{values:["on","off"]}},details:{commands:{on:{value:"on"},off:{value:"off"},toggle:{value:"toggle"}},states:{state:{value:"switchState"}}}});d.DIMMER&&(c={type:"dimmer",
commands:{on:{},off:{},brightness:{value:{type:"INT",min:0,max:100,step:1}}},states:{brightness:{min:0,max:100,unit:"%"}},details:{commands:{on:{value:"dimTo",ext:100},off:{value:"dimOff"},brightness:{value:"dimTo",ext:"%d"}},states:{brightness:{value:"dimmerTLevel"}}}});d.BLIND&&(c={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}}},states:{position:{min:0,max:100}},details:{commands:{up:{value:"blindUp"},down:{value:"blindDown"},stop:{value:"stop"},
position:{value:"moveTo",ext:"%d"}},states:{position:{value:"blindLevel"}}}});d.JALOUSIE&&(c={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}},rotation:{value:{type:"INT",min:0,max:100,step:1}}},states:{position:{min:0,max:100},rotation:{min:0,max:100}},details:{commands:{up:{value:"jalUp"},down:{value:"jalDown"},stop:{value:"jalStop"},position:{value:"jalRaw",ext:"%d"},rotation:{value:"jalLmlRaw",ext:"%d"}},states:{position:{value:"jalLevel"},rotation:{value:"jalLmlLevel"}}}});
d.CLIMATECONTROL_REGULATOR&&(c={type:"heater",commands:{tempUp:{},tempDown:{},tempTo:{value:{type:"FLOAT",min:6,max:30,step:.5}}},states:{setpoint:{type:"FLOAT",min:6,max:30,step:.5,unit:"\u00b0C"},temperature:{type:"FLOAT"},humidity:{type:"INT"}},details:{commands:{tempUp:{value:"themoRTempUp"},tempDown:{value:"themoRTempDown"},tempTo:{value:"themoRTempRaw",ext:"%f"}},states:{setpoint:{value:"themoRSetTemp"},temperature:{value:"weatherTemp"},humidity:{value:"weatherHum"}}}});d.THERMALCONTROL_TRANSMIT&&
(c={type:"heater",commands:{tempUp:{},tempDown:{},tempTo:{value:{type:"FLOAT",min:4,max:30.5,step:.5}},auto:{},manu:{}},states:{setpoint:{type:"FLOAT",min:4,max:30.5,step:.5,unit:"\u00b0C"},temperature:{type:"FLOAT"},humidity:{type:"INT"}},details:{commands:{tempUp:{value:"themoTTempUp"},tempDown:{value:"themoTTempDown"},tempTo:{value:"themoTTempRaw",ext:"%f"},auto:{value:"themoAutoMode"},manu:{value:"themoManuMode"}},states:{setpoint:{value:"themoTSetTemp"},temperature:{value:"themoTActualTemp"},
humidity:{value:"themoTActualHum"},mode:{value:"themoTMode"}}}});d.CLIMATECONTROL_RT_TRANSCEIVER&&(c={type:"heater",commands:{tempUp:{},tempDown:{},tempTo:{value:{type:"FLOAT",min:4,max:30.5,step:.5}},auto:{},manu:{}},states:{setpoint:{type:"FLOAT",min:4,max:30.5,step:.5,unit:"\u00b0C"},temperature:{type:"FLOAT"},humidity:{type:"INT"}},details:{commands:{tempUp:{value:"themoTempUp"},tempDown:{value:"themoTempDown"},tempTo:{value:"themoTempRaw",ext:"%f"},auto:{value:"themoAutoMode"},manu:{value:"themoManuMode"}},
states:{setpoint:{value:"themoSetTemp"},temperature:{value:"themoActualTemp"},humidity:{value:"themoActualHum"},mode:{value:"themoMode"}}}});if("HmIP-WGC"==a.type)return null;d.SWITCH_VIRTUAL_RECEIVER&&(c={type:"switch",commands:{on:{},off:{},toggle:{}},states:{state:{values:["on","off"]}},details:{commands:{on:{value:"on"},off:{value:"off"},toggle:{value:"toggle"}},states:{state:{value:"switchState"}}}});d.DIMMER_VIRTUAL_RECEIVER&&(c={type:"dimmer",commands:{on:{},off:{},brightness:{value:{type:"INT",
min:0,max:100,step:1}}},states:{brightness:{min:0,max:100,unit:"%"}},details:{commands:{on:{value:"dimOn"},off:{value:"dimOff"},brightness:{value:"dimRaw",ext:"%d"}},states:{brightness:{value:"dimmerLevel"}}}});d.SHUTTER_VIRTUAL_RECEIVER&&(c={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}}},states:{position:{min:0,max:100}},details:{commands:{up:{value:"moveUp"},down:{value:"moveDown"},stop:{value:"blindStop"},position:{value:"blindRaw",ext:"%d"}},states:{position:{value:"blindTLevel"}}}});
d.BLIND_VIRTUAL_RECEIVER&&(c={type:"blind",commands:{up:{},down:{},stop:{},position:{value:{type:"INT",min:0,max:100,step:1}},rotation:{value:{type:"INT",min:0,max:100,step:1}}},states:{position:{min:0,max:100},rotation:{min:0,max:100}},details:{commands:{up:{value:"moveUp"},down:{value:"moveDown"},stop:{value:"stop"},position:{value:"moveTo",ext:"%d"},rotation:{value:"lamellaTo",ext:"%d"}},states:{position:{value:"blindTPos"},rotation:{value:"lamellaTPos"}}}});d.HEATING_CLIMATECONTROL_TRANSCEIVER&&
...
mode:{value:"themoMode"}}}});return c}};xnm.aio.hm.Handler=function(){var a=require("x.logger.js");this._logger=a?a.getLogger("xnm.aio.hm.Handler"):{log:function(){}};xnm.aio.hm.Handler._logger=a?a.getLogger("xnm.aio.hm.Handler"):{log:function(){}}};
