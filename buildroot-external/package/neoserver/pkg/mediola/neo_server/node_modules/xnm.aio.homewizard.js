...
xnm.aio.homewizard.HomeWizard.prototype._doRequest=function(a,c){var b=this,f="http://"+this.ip+":"+this.port+"/"+this.password+"/"+a;this._logger.log("trace","send to url: http://"+this.ip+":"+this.port+"/xxxxxx/"+a);var e=c;$.ajax({url:f,type:"GET",timeout:1E4,dataType:"json",success:function(c){b._logger.log("trace","http request success:"+JSON.stringify(c));e&&(e(null,c),e=null)},error:function(c,a){c="http request error:"+(c?c.status:"0")+"-"+a;b._logger.log("trace",c);e&&(e(Error(c)),e=null)}})};
xnm.aio.homewizard.HomeWizard.prototype._sendRequest=function(a,c){this._doRequest(a,function(a,f){!a&&f&&f.response&&"ok"==f.status?f&&f.response&&"ok"==f.status?c&&c(null,f.response):(f&&f.status?(a=Error(f.status),a.errCode=f.error):a=Error("response is empty"),c&&c(a)):c&&c(a)})};xnm.aio.homewizard.HomeWizard.prototype.getDevices=function(a){this._sendRequest("get-sensors",function(c,b){a&&a(c,b)})};
xnm.aio.homewizard.HomeWizard.prototype._resolveState=function(a,c){if(!a||!a.type||!c||"undefined"==typeof a.address||null==a.address)return null;var b=null;switch(a.type){case "switch":case "dimmer":case "radiator":case "asun":case "somfy":var f="switches";break;case "wind":f="windmeters";break;case "rain":f="rainmeters";break;case "thermo":f="thermometers";break;case "doorbell":case "smoke":case "contact":case "motion":case "smoke868":f="kakusensors";break;case "energylink":f="energylinks";break;
default:return null}if(c[f])for(var e=0;e<c[f].length;e++)if(c[f][e]&&a.address+""==c[f][e].id+""){var d=c[f][e];break}if(d)switch(b={},a.type){case "switch":case "dimmer":case "radiator":case "asun":case "somfy":"undefined"!=typeof d.status&&null!=d.status&&(b.status=d.status);"undefined"!=typeof d.dimlevel&&null!=d.dimlevel&&(b.dimlevel=d.dimlevel);"undefined"!=typeof d.tte&&null!=d.tte&&(b.status=d.tte,b.tte=d.tte);break;case "wind":b.windLowBat="no"!=d.lowBattery;b.windS=d.ws;d.dir&&-1!=d.dir.indexOf(" ")&&
(a=d.dir.split(" "),b.windD=parseInt(a[1].trim()),b.windDS=a[0].trim());b.windGS=d.gu;b.windT=d.wc;b.windSMax=d["ws+"];b.windSMaxT=d["ws+t"];b.windSMin=d["ws-"];b.windSMinT=d["ws-t"];break;case "rain":b.rainLowBat="no"!=d.lowBattery;b.rainL=d.mm;b.rainL3h=d["3h"];break;case "thermo":b.thermoLowBat="no"!=d.lowBattery;b.thermoT=d.te;b.thermoH=d.hu;b.thermoTMax=d["te+"];b.thermoTMaxT=d["te+t"];b.thermoTMin=d["te-"];b.thermoTMinT=d["te-t"];b.thermoHMax=d["hu+"];b.thermoHMaxT=d["hu+t"];b.thermoHMin=d["hu-"];
b.thermoHMinT=d["hu-t"];break;case "doorbell":b.doorbellE=d.status?"ring":"none";b.doorbellET=d.timestamp;break;case "smoke":case "smoke868":b.smokeE=d.status?"alarm":"ok";b.smokeET=d.timestamp;break;case "motion":b.motionE=d.status&&"no"!=d.status?"on":"off";b.motionET=d.timestamp;break;case "contact":b.contactE=d.status?"open":"closed";b.contactET=d.timestamp;break;case "energylink":d.s1&&(b.s1Value=d.s1.po,b.s1TotalD=d.s1.dayTotal,b.s1Max=d.s1["po+"],b.s1MaxT=d.s1["po+t"],b.s1Min=d.s1["po-"],b.s1MinT=
d.s1["po-t"]),d.s2&&(b.s2Value=d.s2.po,b.s2TotalD=d.s2.dayTotal,b.s2Max=d.s2["po+"],b.s2MaxT=d.s2["po+t"],b.s2Min=d.s2["po-"],b.s2MinT=d.s2["po-t"])}return b};
...
e[0].state&&"off"==e[0].state.status&&(f="sw/"+a.address+"/on");d._sendRequest(f,function(c){b&&b(c)})});e=!1}}else if("up"==c)if("somfy"==a.type)f="sf/"+a.address+"/up";else{if("asun"==a.type||"brel"==a.type)f="sw/"+a.address+"/up"}else if("down"==c)if("somfy"==a.type)f="sf/"+a.address+"/down";else{if("asun"==a.type||"brel"==a.type)f="sw/"+a.address+"/down"}else"stop"==c?"somfy"==a.type?f="sf/"+a.address+"/stop":"brel"==a.type&&(f="sw/"+a.address+"/stop"):(0==c.indexOf("dimTo")&&(c=c.replace(/dimTo/g,
"")),0==c.indexOf("setTo")&&(c=c.replace(/setTo/g,"")),c=c.replace(/%/g,""),"dimmer"==a.type?f="sw/dim/"+a.address+"/"+c:"radiator"==a.type&&(f="sw/"+a.address+"/settarget/"+c));e&&!f?b&&b(Error("no such command")):e&&f&&this._sendRequest(f,function(c){b&&b(c)})};
xnm.aio.homewizard.HomeWizard.prototype.getStates=function(a,c,b){var f=this;this.CommandHandler=a;this._sendRequest("get-sensors",function(a,d){if(a)b&&b(a,c);else{for(a=0;a<c.length;a++){var e=f._resolveState(c[a],d);e&&(c[a].state=e)}b&&b(null,c)}})};xnm.aio.homewizard.HomeWizard.prototype.getStateValues=function(a,c){return c};
xnm.aio.homewizard.HomeWizard.prototype.executeCommandCreator=function(a,c,b){if(c&&c.value){var f=c.value;if("dimTo"==c.value){if("undefined"==typeof c.ext||null==c.ext){b&&b(Error("command dimTo ext format invalid"));return}f=c.value+c.ext}else if("setTo"==c.value){if("undefined"==typeof c.ext||null==c.ext){b&&b(Error("command setTo ext format invalid"));return}f=c.value+c.ext}this.executeCommand(a,f,function(c){b&&b(c)})}else b&&b(Error("command json format invalid"))};
...
ref:{value:"s2MinT"}}]},smoke868:{status:[{type:"enum",name:"last event",ref:{value:"smokeE",options:["ok","alarm"]}},{type:"string",name:"last event time",ref:{value:"smokeET"}}]}},getGatewayType:function(){return[{sys:this.SYS,name:"HomeWizard",port:80}]},getGatewayDeviceType:function(){return[{sys:this.SYS,type:"switch",name:"Switch"},{sys:this.SYS,type:"dimmer",name:"Dimmer"},{sys:this.SYS,type:"radiator",name:"Thermostat"},{sys:this.SYS,type:"somfy",name:"Somfy Blind"},{sys:this.SYS,type:"asun",
name:"ASUN Blind"}]},createGateway:function(c,b,f){b=a.ERROR_CODE;c?c.ip?c.password?f(null,c):f(new a(b.INVALID,"password is invalid")):f(new a(b.INVALID,"ip is invalid")):f(new a(b.INVALID,"info is invalid"))},updateGateway:function(c,b,f,e){c=a.ERROR_CODE;b?b.ip?b.password?e(null,b):e(new a(c.INVALID,"password is invalid")):e(new a(c.INVALID,"ip is invalid")):e(new a(c.INVALID,"update is invalid"))},deleteGateway:function(c,a,f){f()},createDevice:function(c,b,f){var e=a.ERROR_CODE;if(c)if(c.gateway)if(null==
c.address||"undefined"==typeof c.address)f(new a(e.INVALID,"address is invalid"));else if(null==c.type||"undefined"==typeof c.type)f(new a(e.INVALID,"type is invalid"));else if(b.data&&b.data.gateways&&0!==b.data.gateways.length){b=b.data.gateways;var d;for(d=0;d<b.length;d++)if(b[d].index===c.gateway){var g=b[d];break}g?f(null,c):f(new a(e.NOT_FOUND,"gateway with index "+c.gateway+" not exists"))}else f(new a(e.NOT_FOUND,"gateway with index "+c.gateway+" not exists"));else f(new a(e.INVALID,"gateway is invalid"));
else f(new a(e.INVALID,"info is invalid"))},updateDevice:function(c,b,f){var e=a.ERROR_CODE;if(c)if(c.gateway)if(null==c.address||"undefined"==typeof c.address)f(new a(e.INVALID,"address is invalid"));else if(null==c.type||"undefined"==typeof c.type)f(new a(e.INVALID,"type is invalid"));else if(b.data&&b.data.gateways&&0!==b.data.gateways.length){b=b.data.gateways;var d;for(d=0;d<b.length;d++)if(b[d].index===c.gateway){var g=b[d];break}g?f(null,c):f(new a(e.NOT_FOUND,"gateway with index "+c.gateway+
" not exists"))}else f(new a(e.NOT_FOUND,"gateway with index "+c.gateway+" not exists"));else f(new a(e.INVALID,"gateway is invalid"));else f(new a(e.INVALID,"info is invalid"))},deleteDevice:function(a,b,f){f()},applyUIFilter:function(a,b){var c=this,e=function(a,c){if("*"==a)return!0;for(var b=!1,d=0;d<a.length;d++)if(a[d]==c){b=!0;break}return b},d=function(a,c,b){var d=[];switch(b.catagory){case "command":a.command&&a.command.forEach(function(a){e(b.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),
d.push(a))});break;case "status":a.status&&a.status.forEach(function(a){e(b.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},g=function(a,b){var e=[],f=c.getCommandStatusMap(a);f&&(a=d(f,a,b),e=e.concat(a));return e};if(!a||null==a.type||"undefined"==typeof a.type)return null;var k=JSON.parse(JSON.stringify(a)),h=null;switch(b.catagory){case "command":h=g(a,b);k.command=h;break;case "status":h=g(a,b);k.status=h;break;default:return null}return h&&0!=h.length?k:null},getCommandStatusMap:function(a){return a&&
a.type?this.MAP[a.type]:null}}}();xnm.aio.homewizard.Handler=function(){this._logger=require("x.logger.js").getLogger("xnm.aio.homewizard.Handler");this.detectedHomeWizards={}};xnm.aio.homewizard.Handler.prototype.HomeWizard=xnm.aio.homewizard.HomeWizard;xnm.aio.homewizard.Handler.prototype.devicemanager=xnm.aio.homewizard.DM;xnm.aio.homewizard.Handler.prototype.registModule=function(a){a.register(this.devicemanager.SYS,"homewizard")};
xnm.aio.homewizard.Handler.prototype.resolveGateway=function(a){return a&&a.ip&&a.password?new xnm.aio.homewizard.HomeWizard(a.ip,a.port,a.password):null};xnm.aio.homewizard.Handler.prototype.getDeviceCommands=function(a,c){a=(a=xnm.aio.homewizard.DM.applyUIFilter(a,{catagory:"command",elems:"*"}))?a.command:[];c&&c(null,a)};xnm.aio.homewizard.Handler.prototype.getDeviceStatus=function(a,c){a=(a=xnm.aio.homewizard.DM.applyUIFilter(a,{catagory:"status",elems:"*"}))?a.status:[];c&&c(null,a)};
xnm.aio.homewizard.Handler.prototype.doCommand=function(a,c,b,f){(a=this.resolveGateway(a))?a.executeCommandCreator(c,b,function(a){f&&f(a)}):f&&f(Error("gateway json format invalid"))};xnm.aio.homewizard.Handler.prototype.doStatus=function(a,c,b,f,e){(c=this.resolveGateway(c))?c.getStatesCreator(null,[{id:a,device:b,status:f}],function(a,c){a?e&&e(a):e&&e(null,c[0])}):e&&e(Error("gateway json format invalid"))};
xnm.aio.homewizard.Handler.prototype.getDeviceList=function(a,c){if(a=this.resolveGateway(a)){var b=this;a.getDevices(function(a,e){if(a)c&&c(a);else{var d=[];e&&(e.switches&&e.switches.forEach(function(a){if(a)switch(a.type){case "switch":case "dimmer":case "radiator":case "somfy":case "asun":case "brel":d.push({sys:b.devicemanager.SYS,type:a.type,address:a.id,name:a.name})}}),e.scenes&&e.scenes.forEach(function(a){a&&d.push({sys:b.devicemanager.SYS,type:"scene",address:a.id,name:a.name})}),e.windmeters&&
e.windmeters.forEach(function(a){a&&d.push({sys:b.devicemanager.SYS,type:"wind",address:a.id,name:a.name})}),e.rainmeters&&e.rainmeters.forEach(function(a){a&&d.push({sys:b.devicemanager.SYS,type:"rain",address:a.id,name:a.name})}),e.thermometers&&e.thermometers.forEach(function(a){a&&d.push({sys:b.devicemanager.SYS,type:"thermo",address:a.id,name:a.name})}),e.kakusensors&&e.kakusensors.forEach(function(a){a&&a.type&&("doorbell"==a.type||"smoke"==a.type||"contact"==a.type||"motion"==a.type||"smoke868"==
a.type)&&d.push({sys:b.devicemanager.SYS,type:a.type,address:a.id,name:a.name})}),e.energylinks&&e.energylinks.forEach(function(a){a&&d.push({sys:b.devicemanager.SYS,type:"energylink",address:a.id,name:a.name})}));c&&c(null,d)}})}else c&&c(Error("gateway json format invalid"))};
