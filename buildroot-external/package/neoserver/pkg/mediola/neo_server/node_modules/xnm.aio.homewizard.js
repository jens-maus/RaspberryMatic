...
xnm.aio.homewizard.HomeWizard.prototype._doRequest=function(a,c){var b=this,f="http://"+this.ip+":"+this.port+"/"+this.password+"/"+a;this._logger.log("trace","send to url: http://"+this.ip+":"+this.port+"/xxxxxx/"+a);var e=c;$.ajax({url:f,type:"GET",timeout:1E4,dataType:"json",success:function(a){b._logger.log("trace","http request success:"+JSON.stringify(a));e&&(e(null,a),e=null)},error:function(a,c){a="http request error:"+(a?a.status:"0")+"-"+c;b._logger.log("trace",a);e&&(e(Error(a)),e=null)}})};
...
xnm.aio.homewizard.HomeWizard.prototype._resolveState=function(a,c){if(!a||!a.type||!c||"undefined"==typeof a.address||null==a.address)return null;var b=null;switch(a.type){case "switch":case "proswitch":case "dimmer":case "prodimmer":case "radiator":case "asun":case "somfy":var f="switches";break;case "wind":f="windmeters";break;case "rain":f="rainmeters";break;case "thermo":f="thermometers";break;case "doorbell":case "smoke":case "contact":case "motion":case "smoke868":f="kakusensors";break;case "energylink":f=
"energylinks";break;default:return null}if(c[f])for(var e=0;e<c[f].length;e++)if(c[f][e]&&a.address+""==c[f][e].id+""){var d=c[f][e];break}if(d)switch(b={},a.type){case "switch":case "proswitch":case "dimmer":case "prodimmer":case "radiator":case "asun":case "somfy":"undefined"!=typeof d.status&&null!=d.status&&(b.status=d.status);"undefined"!=typeof d.dimlevel&&null!=d.dimlevel&&(b.dimlevel=d.dimlevel);"undefined"!=typeof d.tte&&null!=d.tte&&(b.status=d.tte,b.tte=d.tte);"undefined"!=typeof d.color&&
null!=d.color&&(b.dimlevel=d.color.bri?d.color.bri:0);break;case "wind":b.windLowBat="no"!=d.lowBattery;b.windS=d.ws;d.dir&&-1!=d.dir.indexOf(" ")&&(a=d.dir.split(" "),b.windD=parseInt(a[1].trim()),b.windDS=a[0].trim());b.windGS=d.gu;b.windT=d.wc;b.windSMax=d["ws+"];b.windSMaxT=d["ws+t"];b.windSMin=d["ws-"];b.windSMinT=d["ws-t"];break;case "rain":b.rainLowBat="no"!=d.lowBattery;b.rainL=d.mm;b.rainL3h=d["3h"];break;case "thermo":b.thermoLowBat="no"!=d.lowBattery;b.thermoT=d.te;b.thermoH=d.hu;b.thermoTMax=
d["te+"];b.thermoTMaxT=d["te+t"];b.thermoTMin=d["te-"];b.thermoTMinT=d["te-t"];b.thermoHMax=d["hu+"];b.thermoHMaxT=d["hu+t"];b.thermoHMin=d["hu-"];b.thermoHMinT=d["hu-t"];break;case "doorbell":b.doorbellE=d.status?"ring":"none";b.doorbellET=d.timestamp;break;case "smoke":case "smoke868":b.smokeE=d.status?"alarm":"ok";b.smokeET=d.timestamp;break;case "motion":b.motionE=d.status&&"no"!=d.status?"on":"off";b.motionET=d.timestamp;break;case "contact":b.contactE=d.status?"open":"closed";b.contactET=d.timestamp;
break;case "energylink":d.s1&&(b.s1Value=d.s1.po,b.s1TotalD=d.s1.dayTotal,b.s1Max=d.s1["po+"],b.s1MaxT=d.s1["po+t"],b.s1Min=d.s1["po-"],b.s1MinT=d.s1["po-t"]),d.s2&&(b.s2Value=d.s2.po,b.s2TotalD=d.s2.dayTotal,b.s2Max=d.s2["po+"],b.s2MaxT=d.s2["po+t"],b.s2Min=d.s2["po-"],b.s2MinT=d.s2["po-t"])}return b};
xnm.aio.homewizard.HomeWizard.prototype.executeCommand=function(a,c,b){var f=null,e=!0;if("on"==c)"switch"==a.type||"dimmer"==a.type||"radiator"==a.type||"proswitch"==a.type||"prodimmer"==a.type?f="sw/"+a.address+"/on":"scene"==a.type&&(f="gp/"+a.address+"/on");else if("off"==c)"switch"==a.type||"dimmer"==a.type||"radiator"==a.type||"proswitch"==a.type||"prodimmer"==a.type?f="sw/"+a.address+"/off":"scene"==a.type&&(f="gp/"+a.address+"/off");else if("toggle"==c){if("switch"==a.type||"dimmer"==a.type||
"proswitch"==a.type||"prodimmer"==a.type){var d=this;this.getStates(null,[a],function(c,e){f="sw/"+a.address+"/off";1==e.length&&e[0].state&&"off"==e[0].state.status&&(f="sw/"+a.address+"/on");d._sendRequest(f,function(a){b&&b(a)})});e=!1}}else if("up"==c)if("somfy"==a.type)f="sf/"+a.address+"/up";else{if("asun"==a.type||"brel"==a.type)f="sw/"+a.address+"/up"}else if("down"==c)if("somfy"==a.type)f="sf/"+a.address+"/down";else{if("asun"==a.type||"brel"==a.type)f="sw/"+a.address+"/down"}else"stop"==
c?"somfy"==a.type?f="sf/"+a.address+"/stop":"brel"==a.type&&(f="sw/"+a.address+"/stop"):(0==c.indexOf("dimTo")&&(c=c.replace(/dimTo/g,"")),0==c.indexOf("setTo")&&(c=c.replace(/setTo/g,"")),c=c.replace(/%/g,""),"dimmer"==a.type?f="sw/dim/"+a.address+"/"+c:"radiator"==a.type&&(f="sw/"+a.address+"/settarget/"+c));e&&!f?b&&b(Error("no such command")):e&&f&&this._sendRequest(f,function(a){b&&b(a)})};
...
xnm.aio.homewizard.Handler.prototype.getDeviceList=function(a,c){if(a=this.resolveGateway(a)){var b=this;a.getDevices(function(a,e){if(a)c&&c(a);else{var d=[];e&&(e.switches&&e.switches.forEach(function(a){if(a)switch(a.type){case "switch":case "proswitch":case "dimmer":case "prodimmer":case "radiator":case "somfy":case "asun":case "brel":d.push({sys:b.devicemanager.SYS,type:a.type,address:a.id,name:a.name})}}),e.scenes&&e.scenes.forEach(function(a){a&&d.push({sys:b.devicemanager.SYS,type:"scene",
address:a.id,name:a.name})}),e.windmeters&&e.windmeters.forEach(function(a){a&&d.push({sys:b.devicemanager.SYS,type:"wind",address:a.id,name:a.name})}),e.rainmeters&&e.rainmeters.forEach(function(a){a&&d.push({sys:b.devicemanager.SYS,type:"rain",address:a.id,name:a.name})}),e.thermometers&&e.thermometers.forEach(function(a){a&&d.push({sys:b.devicemanager.SYS,type:"thermo",address:a.id,name:a.name})}),e.kakusensors&&e.kakusensors.forEach(function(a){a&&a.type&&("doorbell"==a.type||"smoke"==a.type||
"contact"==a.type||"motion"==a.type||"smoke868"==a.type)&&d.push({sys:b.devicemanager.SYS,type:a.type,address:a.id,name:a.name})}),e.energylinks&&e.energylinks.forEach(function(a){a&&d.push({sys:b.devicemanager.SYS,type:"energylink",address:a.id,name:a.name})}));c&&c(null,d)}})}else c&&c(Error("gateway json format invalid"))};
