...
k._FSM.MONITORING,this._onOpen(),this._dataLinkRetryCount=0}},_fsmDatalinkClosed:function(a){a?this._logger.log("trace","data link stopped due to error"):this._logger.log("trace","data link stopped");switch(this._stateMachine.state){case k._FSM.START_MONITOR:this._dataLink.removeAllListeners();this._dataLink=null;++this._dataLinkRetryCount<k.MAX_DL_RETRY_COUNT?(this._logger.log("trace","auto restart monitor tunnel"),this._stateMachine.state=k._FSM.START_MONITOR,this._startDataLink()):(this._stateMachine.state=
k._FSM.IDLE,this._onClose(!0));break;case k._FSM.MONITORING:this._dataLink.removeAllListeners();this._dataLink=null;++this._dataLinkRetryCount<k.MAX_DL_RETRY_COUNT?(this._logger.log("trace","auto restart monitor tunnel"),this._stateMachine.state=k._FSM.START_MONITOR,this._startDataLink()):(this._onError(Error("can not connect monitor tunnel to knx gateway")),this._stateMachine.state=k._FSM.IDLE,this._onClose(!0));break;case k._FSM.STOP_MONITOR:this._dataLink.removeAllListeners(),this._dataLink=null,
this._stateMachine.state=k._FSM.IDLE,this._onClose(!1)}},_fsmDataLinkMessage:function(a,c){switch(this._stateMachine.state){case k._FSM.MONITORING:c.getAPCI(),this._stateBuffer.setState(a,c.getData()),this._eventEmitter.emit("message",this.uuid,a,c)}},_fsmDatalinkError:function(a){this._onError(a)},_onOpen:function(){this._eventEmitter.emit("open")},_onError:function(a){this._eventEmitter.emit("error",a)},_onClose:function(a){this._eventEmitter.emit("close",a)},_sendCommand:function(a,c,b){this._dataLink?
this._sendCommandWithDL(this._dataLink,a,c,b):b&&b(Error("knx gateway not connected"))},_getState:function(a,c){this._dataLink?this._getStateWithDL(this._dataLink,a,c):c&&c(Error("knx gateway not connected"))},_sendCommandWithDL:function(a,c,b,e){var f=k._adr2long(c),d=new k.APDU(null,2,b),g=this;a.send(f,d,function(a){a||g._stateBuffer.setState(f,d.getData());e&&"function"===typeof e&&e(a)})},_getStateWithDL:function(a,c,b){c=k._adr2long(c);var e=new k.APDU(null,0,new Buffer([0]));a.send(c,e,b)},
_startDataLink:function(){var a=this;this._dataLink=new k._DataLink(this.ip,this.localIp);this._dataLink.on("connect",function(){a._fsmDatalinkOpen()});this._dataLink.on("close",function(c){a._fsmDatalinkClosed(c)});this._dataLink.on("error",function(c){a._logger.log("warn","monitor tunnel error:"+c.message);a._fsmDatalinkError(c)});this._dataLink.on("message",function(c,b){a._fsmDataLinkMessage(c,b)});this._dataLink.connect()},_stopDataLink:function(){this._dataLink&&this._dataLink.close()}};var u=
function(){var a=function(a,b){this._logger=Logger.getLogger("xnm.aio.knx.KNXGateway._DataLink ("+a+")");var c=this;this._tunnel=new t(a,null,b,null);this._tunnel.on("connect",function(){c._onTunnelConnect()});this._tunnel.on("end",function(){c._onTunnelEnd()});this._tunnel.on("close",function(a){c._onTunnelClose(a)});this._tunnel.on("message",function(a){c._onTunnelMessage(a)});this._tunnel.on("error",function(a){c._onTunnelError(a)});this._eventEmitter=new EventEmitter};a.prototype={on:function(a,
b){this._eventEmitter.on(a,b)},removeAllListeners:function(){this._eventEmitter.removeAllListeners()},removeListener:function(a,b){this._eventEmitter.removeListener(a,b)},connect:function(){this._tunnel.connect()},close:function(){this._tunnel.close()},send:function(a,b,e){this._logger.log("debug","send l_data.req "+b.toBuffer().toString("hex")+"@"+a);a=new p.L_Data_Req(a,b);this._tunnel.send(a,function(a){e&&e(a)})},_onTunnelConnect:function(){this._eventEmitter.emit("connect")},_onTunnelClose:function(a){this._eventEmitter.emit("close",
a)},_onTunnelEnd:function(){this._eventEmitter.emit("end")},_onTunnelMessage:function(a){var b="unknown";a&&a instanceof p.L_Data_Con?b="l_data.con":a&&a instanceof p.L_Data_Ind&&(b="l_data.ind");var c=a.getDstAddr();a=a.getAPDU();this._logger.log("debug","recive "+b+" "+a.toBuffer().toString("hex")+"@"+c);this._eventEmitter.emit("message",c,a)},_onTunnelError:function(a){this._eventEmitter.emit("error",a)}};return a}(),t=function(){var a=function(c,b,e,f){this._eventEmitter=new EventEmitter;this._ip=
c;this._port=b;if(!this._port||0>=this._port)this._port=a.DEFAULT_REMOTE_PORT;this._logger=require("x.logger.js").getLogger("xnm.aio.knx.KNXGateway._Tunnel ("+this._ip+":"+this._port+")");this._localIp=e;this._localPort=f;0>=this._localPort&&(this._localPort=null);this._socket=null;this._requestBuffer=[];this._stateMachine={state:a._STATE.IDLE,stateTimer:null,connectionStateTimer:null,connectionStateAckTimer:null,connection:{id:0,seqNo:0,recvSeqNo:0,hpai:{ip:null,port:0}},close_with_error:null};this._connectStateNackCount=
0};a.TUNNEL_ACK_TIMEOUT=1E3;a.CONNECT_REQUEST_TIMEOUT=1E4;a.CONNECTIONSTATE_REQUEST_INTERVAL=6E4;a.CONNECTIONSTATE_REQUEST_TIMEOUT=1E4;a.MAX_CONNECTIONSTATE_NACK_COUNT=3;a.DEFAULT_REMOTE_PORT=3671;a._STATE={IDLE:0,BINDUDP:1,CONNECT:2,TUNNELLING:3,DISCONNECT:4,CLOSEUDP:5};a.prototype={on:function(a,b){this._eventEmitter.on(a,b)},removeAllListeners:function(){this._eventEmitter.removeAllListeners()},connect:function(){this._fsmConnect()},close:function(){this._fsmClose(!1)},send:function(a,b){if(a){var c=
this._requestBuffer.length;this._requestBuffer.push({cEMI:a,callback:b,retry:!1,timer:null,seqNo:-1});0==c&&this._sendNextReq()}else b&&b(Error("cEMI is null"))},_sendNextReq:function(){if(0!=this._requestBuffer.length){var c=this._requestBuffer[0],b=this._stateMachine.connection.seqNo;-1!=c.seqNo?b=c.seqNo:c.seqNo=b;var e=this;this._send(b,c.cEMI,function(b){b?(c.callback&&c.callback(b),e._requestBuffer.splice(0,1),e._sendNextReq()):c.timer=setTimeout(function(){c.retry?(c.callback&&c.callback(Error("NACK due to timeout")),
e._requestBuffer.splice(0,1),e._fsmClose(!0)):(c.retry=!0,e._sendNextReq())},a.TUNNEL_ACK_TIMEOUT)})}},_send:function(c,b,e){var f=this;switch(this._stateMachine.state){case a._STATE.TUNNELLING:this._logger.log("debug","send cEMI "+b.toBuffer().toString("hex"));var d=(new r.TunnellingRequest(this._stateMachine.connection.id,c,b)).toBuffer();this._logger.log("debug","send TUNNELLING_REQUEST ("+c+") "+d.toString("hex"));this._socket.send(d,0,d.length,this._port,this._ip,function(a){a?f._logger.log("debug",
"send TUNNELLING_REQUEST ("+c+") "+d.toString("hex")+" error:"+a.message):f._logger.log("debug","send TUNNELLING_REQUEST ("+c+") "+d.toString("hex")+" finish");e&&e(null)});break;default:e&&e(Error("Tunnel is not connected"))}},_fsmConnect:function(){this._logger.log("debug","connect to knx");switch(this._stateMachine.state){case a._STATE.IDLE:this._stateMachine.state=a._STATE.BINDUDP,this._startListenerSocket()}},_fsmClose:function(c){this._stateMachine.close_with_error=c;switch(this._stateMachine.state){case a._STATE.IDLE:this._fsmClosed();
break;case a._STATE.BINDUDP:this._stateMachine.state=a._STATE.CLOSEUDP;this._stopListenerSocket();break;case a._STATE.CONNECT:this._clearStateMachineGuard();this._stateMachine.state=a._STATE.CLOSEUDP;this._stopListenerSocket();break;case a._STATE.TUNNELLING:c=(new r.DisconnectRequest(this._stateMachine.connection.id,this._stateMachine.connection.hpai)).toBuffer(),this._logger.log("debug","send DISCONNECT_REQUEST "+c.toString("hex")),this._socket.send(c,0,c.length,this._port,this._ip),this._stateMachine.state=
a._STATE.DISCONNECT,this._clearStateMachineGuard(),this._setStateMachineGuard(1E3,a._STATE.CLOSEUDP)}},_fsmError:function(a){this._eventEmitter.emit("error",a);this._fsmClose(!0)},_fsmUdpListening:function(){this._logger.log("debug","udp socket established");switch(this._stateMachine.state){case a._STATE.BINDUDP:this._stateMachine.state=a._STATE.CONNECT;this._clearStateMachineGuard();var c=this._socket.address();c={ip:c.address,port:c.port};this._logger.log("debug","send CONNECTION_REQUEST");c=(new r.ConnectionRequest(c,
c)).toBuffer();this._socket.send(c,0,c.length,this._port,this._ip);this._setStateMachineGuard(a.CONNECT_REQUEST_TIMEOUT,a._STATE.TUNNELLING)}},_fsmUdpMessage:function(c){var b=this,e=this._socket.address(),f=r.parseFrame(c);if(f)switch(this._stateMachine.state){case a._STATE.CONNECT:518===f.getType()&&(f.isConnectionStatusOK()?(this._clearStateMachineGuard(),c=f.getConnectionID(),this._logger.log("debug","receive CONNECTION_RESPONSE with connection id "+c),this._stateMachine.connection={},this._stateMachine.connection.id=
c,e={ip:e.address,port:e.port},this._stateMachine.connection.hpai=e,this._stateMachine.connection.seqNo=0,this._stateMachine.connection.recvSeqNo=0,this._stateMachine.state=a._STATE.TUNNELLING,this._sendConnectionStateRequest(),this._onConnected()):(e=f.getConnectionStatus(),c=Error("tunnel connection fail with error:"+e.toString(16)),c.code=e,this._fsmError(c)));break;case a._STATE.TUNNELLING:switch(f.getType()){case 1056:c=f.getConnectionID();if(c===this._stateMachine.connection.id){var d=f.getcEMI(),
g=f.getSeqNo(),l=!1;g==this._stateMachine.connection.recvSeqNo&&(l=!0);if(g==this._stateMachine.connection.recvSeqNo||g==this._stateMachine.connection.recvSeqNo-1)f=new r.TunnellingACK(c,g),e=f.toBuffer(),this._logger.log("trace","send TUNNELLING_ACK ("+g+") "+e.toString("hex")),this._socket.send(e,0,e.length,this._port,this._ip,function(a){try{l&&(d&&d instanceof p.L_Data_Con?(b._logger.log("debug","receive TUNNELLING_REQUEST ("+g+") l_data.con "+d.toBuffer().toString("hex")),b._onMessage(d)):d&&
d instanceof p.L_Data_Ind&&(b._logger.log("debug","receive TUNNELLING_REQUEST ("+g+") l_data.ind "+d.toBuffer().toString("hex")),b._onMessage(d)))}catch(h){}});g!=this._stateMachine.connection.recvSeqNo&&g!=this._stateMachine.connection.recvSeqNo-1||g!=this._stateMachine.connection.recvSeqNo||(this._stateMachine.connection.recvSeqNo++,255<this._stateMachine.connection.recvSeqNo&&(this._stateMachine.connection.recvSeqNo=0))}break;case 1057:c=f.getConnectionID();c===this._stateMachine.connection.id&&
...
a._logger=Logger.getLogger("xnm.aio.KNXGateway.IPFrame");a.parseFrame=function(c){var d=null;if(6>c.length)return a._logger.log("debug","data is too short"),null;var e=c.readUInt16BE(0);if(1552!==e)return a._logger.log("debug","data header&version is invalid:"+e),null;e=c.readUInt16BE(4);if(e>c.length)return a._logger.log("debug","data length in header is larger than actual size:"+e),null;var m=c.readUInt16BE(2);switch(m){case 514:14<=e&&(d=new b);break;case 518:8<=e&&(d=new f);break;case 520:8<=
e&&(d=new g);break;case 1057:10<=e&&(d=new k);break;case 1056:6<=e&&(d=new l);break;case 521:16<=e&&(d=new h);break;case 522:8<=e&&(d=new w);break;default:a._logger.log("debug","data type is unknow:"+m)}d&&(d._buffer=c);return d};a.prototype.getType=function(){return this._buffer.readUInt16BE(2)};a.prototype.getSize=function(){return this._buffer.readUInt16BE(4)};a.prototype.toBuffer=function(){return this._buffer};var c=function(b){var c=new Buffer(8);c.writeUInt16BE(2049,0);c.writeInt32BE(m(b.ip),
2);c.writeUInt16BE(b.port,6);a.call(this,513,c)};c.prototype=new a;c.prototype.constructor=c;var b=function(){a.call(this)};b.prototype=new a;b.prototype.constructor=b;b.prototype.getCtrlEndpointHPAI=function(){var a=this._buffer.readUInt32BE(8);a=n(a);var b=this._buffer.readUInt16BE(12),c={};c.ip=a;c.port=b;return c};b.prototype.getSerialNumber=function(){var a=(this._buffer.readUInt8(22)<<16)+(this._buffer.readUInt8(23)<<8)+this._buffer.readUInt8(24),b=(this._buffer.readUInt8(25)<<16)+(this._buffer.readUInt8(26)<<
8)+this._buffer.readUInt8(27);return a+""+b};b.prototype.getRoutingMulticastAddress=function(){return this._buffer.readUInt8(28)+"."+this._buffer.readUInt8(29)+"."+this._buffer.readUInt8(30)+"."+this._buffer.readUInt8(31)};b.prototype.getMAC=function(){return this._buffer.toString("hex",32,38)};b.prototype.getName=function(){return this._buffer.toString("utf8",38,68)};b.prototype.toJSON=function(){return{hapi:this.getCtrlEndpointHPAI(),structure_length:this._buffer.readUInt8(14),desciprtion_type_code:this._buffer.readUInt8(15),
knx_medium:this._buffer.readUInt8(16),device_status:this._buffer.readUInt8(17),physical_address:this._buffer.readUInt16BE(18),project_installation_id:this._buffer.readUInt16BE(20),serial_number:this.getSerialNumber(),routing_multicast_address:this.getRoutingMulticastAddress(),mac:this.getMAC(),name:this.getName()}};var e=function(b,c){var d=new Buffer(20);d.writeUInt16BE(2049,0);d.writeInt32BE(m(b.ip),2);d.writeUInt16BE(b.port,6);d.writeUInt16BE(2049,8);d.writeInt32BE(m(c.ip),10);d.writeUInt16BE(c.port,
14);d.writeUInt8(4,16);d.writeUInt8(4,17);d.writeUInt8(2,18);d.writeUInt8(0,19);a.call(this,517,d)};e.prototype=new a;e.prototype.constructor=e;var f=function(){a.call(this)};f.prototype=new a;f.prototype.constructor=f;f.prototype.getConnectionID=function(){return this._buffer.readUInt8(6)};f.prototype.isConnectionStatusOK=function(){return 0===this._buffer.readUInt8(7)};f.prototype.getCtrlEndpointHPAI=function(){var a=this._buffer.readUInt32BE(10);a=n(a);var b=this._buffer.readUInt16BE(14),c={};
c.ip=a;c.port=b;return c};f.prototype.getCRD=function(){return this._buffer.readUInt32BE(16)};f.prototype.getConnectionStatus=function(){return this._buffer.readUInt8(7)};var d=function(b,c){var d=new Buffer(10);d.writeUInt8(b,0);d.writeUInt8(0,1);d.writeUInt16BE(2049,2);d.writeInt32BE(m(c.ip),4);d.writeUInt16BE(c.port,8);a.call(this,519,d)};d.prototype=new a;d.prototype.constructor=d;var g=function(){a.call(this)};g.prototype=new a;g.prototype.constructor=g;g.prototype.getConnectionID=function(){return this._buffer.readUInt8(6)};
g.prototype.isConnectionStatusOK=function(){return 0===this._buffer.readUInt8(7)};var l=function(b,c,d){if(null!==b&&void 0!==b&&null!==c&&void 0!==c&&d){var e=new Buffer(4+d.getLength());e.writeUInt8(4,0);e.writeUInt8(b,1);e.writeUInt8(c,2);e.writeUInt8(0,3);d.toBuffer().copy(e,4);a.call(this,1056,e)}else a.call(this)};l.prototype=new a;l.prototype.constructor=l;l.prototype.getConnectionID=function(){return this._buffer.readUInt8(7)};l.prototype.getSeqNo=function(){return this._buffer.readUInt8(8)};
l.prototype.getcEMI=function(){var a=this._buffer.readUInt16BE(4);a=new Buffer(a-6-4);this._buffer.copy(a,0,10);return p.parseFrame(a)};var k=function(b,c){if(b){var d=new Buffer(4);d.writeUInt8(4,0);d.writeUInt8(b,1);d.writeUInt8(c,2);d.writeUInt8(0,3);a.call(this,1057,d)}else a.call(this)};k.prototype=new a;k.prototype.constructor=k;k.prototype.getConnectionID=function(){return this._buffer.readUInt8(7)};k.prototype.getSeqNo=function(){return this._buffer.readUInt8(8)};k.prototype.isOK=function(){return 0===
this._buffer.readUInt8(9)};var h=function(b,c){if(b&&null!==c){var d=new Buffer(10);d.writeUInt8(b,0);d.writeUInt8(0,1);d.writeUInt8(8,2);d.writeUInt8(1,3);d.writeInt32BE(m(c.ip),4);d.writeUInt16BE(c.port,8);a.call(this,521,d)}else a.call(this)};h.prototype=new a;h.prototype.constructor=h;h.prototype.getConnectionID=function(){return this._buffer.readUInt8(6)};h.prototype.getCtrlEndpointHPAI=function(){var a=this._buffer.readUInt32BE(10);a=n(a);var b=this._buffer.readUInt16BE(14),c={};c.ip=a;c.port=
b;return c};var w=function(b){if(b){var c=new Buffer(2);c.writeUInt8(b,0);c.writeUInt8(0,1);a.call(this,1057,c)}else a.call(this)};w.prototype=new a;w.prototype.constructor=w;w.prototype.getConnectionID=function(){return this._buffer.readUInt8(6)};w.prototype.isDisconnectOK=function(){return 0===this._buffer.readUInt8(7)};a.SearchRequest=c;a.SearchResponse=b;a.ConnectionRequest=e;a.ConnectionResponse=f;a.ConnectionStateRequest=d;a.ConnectionStateResponse=g;a.TunnellingRequest=l;a.TunnellingACK=k;
a.DisconnectRequest=h;a.DisconnectResponse=w;return a}(),p=function(){var a=function(a){this._buffer=a};a.parseFrame=function(a){var c=null;switch(a.readUInt8(0)){case b.MSG_CODE:c=new b;break;case e.MSG_CODE:c=new e}c&&(c._buffer=a);return c};a.prototype={getLength:function(){return this._buffer.length},getSrcAddr:function(){return this._buffer.readUInt16BE(4)},getDstAddr:function(){return this._buffer.readUInt16BE(6)},getDataLength:function(){return this._buffer.readUInt8(8)},getAPDU:function(){var a=
this.getDataLength()+1;a=new Buffer(a);this._buffer.copy(a,0,9,9+a.length);return v.parse(a)},toBuffer:function(){return this._buffer}};var c=function(a,b){var c=new Buffer(9+b.getLength());c.writeUInt8(17,0);c.writeUInt8(0,1);c.writeUInt8(188,2);c.writeUInt8(224,3);c.writeUInt8(0,4);c.writeUInt8(0,5);c.writeInt16BE(a,6);c.writeUInt8(b.getLength()-1,8);b.toBuffer().copy(c,9);this._buffer=c};c.MSG_CODE=17;c.prototype=new a;c.prototype.constructor=c;var b=function(){this._buffer=void 0};b.MSG_CODE=
46;b.prototype=new a;b.prototype.constructor=b;var e=function(){this._buffer=void 0};e.MSG_CODE=41;e.prototype=new a;e.prototype.constructor=e;a.L_Data_Req=c;a.L_Data_Con=b;a.L_Data_Ind=e;return a}(),v=function(){var a=function(a,b,e){b||(b=0);a||(a=0);var c=1;e&&1<e.length&&(c=e.length);this._buffer=new Buffer(1+c);this._buffer.writeUInt8(a|b>>2,0);a=e&&0<e.length?e.readUInt8(0):0;this._buffer.writeUInt8(b<<6|a,1);e&&1<e.length&&e.copy(this._buffer,2,1)};a.parse=function(c){var b=new a;b._buffer=
c;return b};a.prototype={getLength:function(){return this._buffer.length},getAPCI:function(){var a=this._buffer.readUInt8(0),b=this._buffer.readUInt8(1);return(a&3)<<2|(b&192)>>6&3},getData:function(){var a=this._buffer.length-1,b=this._buffer.readUInt8(1),e=new Buffer(a);e.writeUInt8(b&63,0);1<a&&this._buffer.copy(e,1,2);return e},toBuffer:function(){return this._buffer}};return a}();k._DataLink=u;k._Tunnel=t;k.IPFrame=r;k.cEMI=p;k.APDU=v;return k}();
...
f));return}this.setValue(d,c,b,e)}else e&&e(Error("unknown command:"+a))};r.prototype.setValue=function(a,c,b,e){switch(this.type){case "DPT-9":-671088.64>a&&(a=-671088.64);670760.96<a&&(a=670760.96);a=this._float2short(a);break;case "DPST-9-1":-273>a&&(a=-273);670760<a&&(a=670760);a=this._float2short(a);break;default:a=this._float2short(a)}(a=this._getBuffer(a))?m.prototype.setValue.call(this,a,c,b,function(a){e&&e(a)}.bind(this)):e&&e(Error("invalid value"))};r.prototype.incValue=function(a,c,b,
e,f){c=this._resolveValue(c);this.setValue(c+a,b,e,f)};r.prototype.decValue=function(a,c,b,e,f){c=this._resolveValue(c);this.setValue(c-a,b,e,f)};r.prototype._resolveDataRaw=function(a){return!a||3>a.length?0:a.readUInt16BE(1)};r.prototype._resolveData=function(a){if(!a||3>a.length)return 0;a=a.readUInt16BE(1);return this._resolveValue(a)};r.prototype._resolveValue=function(a){switch(this.type){case "DPT-9":case "DPST-9-1":return parseFloat(this._short2float(a).toFixed(2));default:return parseFloat(this._short2float(a).toFixed(2))}};
r.prototype._getBuffer=function(a){var c=new Buffer(3);c.writeUInt8(0,0);c.writeUInt16BE(a,1);return c};r.prototype._float2short=function(a){for(var c=100*a,b=0;-2048>c;c/=2)b++;for(;2047<c;c/=2)b++;c=Math.round(c)&2047;b=b<<3|c>>8;0>a&&(b|=128);return b<<8|c};r.prototype._short2float=function(a){var c=a>>15&1,b=a&2047|c<<11;1==c&&(b-=4096);return.01*b*Math.pow(2,a>>11&15)};var p=function(a){this.type=a};p.prototype=new m;p.prototype.constructor=p;p.prototype.doCommand=function(a,c,b,e){if(a){var f=
null,d=0;0==a.indexOf("setValue")&&(f=a.substr(0,8),d=parseFloat(a.substr(8)),!d||isNaN(d))&&(d=0);switch(f){case "setValue":break;default:e&&e(Error("unknown command:"+f));return}this.setValue(d,c,b,e)}else e&&e(Error("unknown command:"+a))};p.prototype.setValue=function(a,c,b,e){-3.40282347E38>a&&(a=-3.40282347E38);3.40282347E38<a&&(a=3.40282347E38);a=this._float2bytes(a);(a=this._getBuffer(a))?m.prototype.setValue.call(this,a,c,b,function(a){e&&e(a)}.bind(this)):e&&e(Error("invalid value"))};p.prototype.incValue=
function(a,c,b,e,f){c=this._resolveValue(c);this.setValue(c+a,b,e,f)};p.prototype.decValue=function(a,c,b,e,f){c=this._resolveValue(c);this.setValue(c-a,b,e,f)};p.prototype._resolveDataRaw=function(a){return!a||5>a.length?0:a.readUInt32BE(1)};p.prototype._resolveData=function(a){if(!a||5>a.length)return 0;a=a.readUInt32BE(1);return this._resolveValue(a)};p.prototype._resolveValue=function(a){return parseFloat(this._long2float(a).toFixed(2))};p.prototype._getBuffer=function(a){if(!a||4>a.length)return null;
var c=new Buffer(5);c.writeUInt8(0,0);for(var b=0;4>b;b++)c.writeUInt8(a[b],b+1);return c};p.prototype._float2bytes=function(a){return this._toIEEE754Single(a)};p.prototype._long2float=function(a){var c=new Buffer(4);c.writeUInt32BE(a);a=Array.prototype.slice.call(c);return this._fromIEEE754Single(a)};p.prototype._toIEEE754=function(a,c,b){var e=(1<<c-1)-1;if(isNaN(a)){var f=(1<<e)-1;e=1;var d=0}else if(Infinity===a||-Infinity===a)f=(1<<e)-1,e=0,d=0>a?1:0;else if(0===a)e=f=0,d=-Infinity===1/a?1:0;
else if(d=0>a,a=Math.abs(a),a>=Math.pow(2,1-e)){var g=Math.min(Math.floor(Math.log(a)/Math.LN2),e);f=g+e;e=a*Math.pow(2,b-g)-Math.pow(2,b)}else f=0,e=a/Math.pow(2,1-e-b);for(a=[];b;--b)a.push(e%2?1:0),e=Math.floor(e/2);for(b=c;b;--b)a.push(f%2?1:0),f=Math.floor(f/2);a.push(d?1:0);a.reverse();c=a.join("");for(d=[];c.length;)d.push(parseInt(c.substring(0,8),2)),c=c.substring(8);return d};p.prototype._fromIEEE754=function(a,c,b){for(var e=[],f=a.length;f;--f)for(var d=a[f-1],g=8;g;--g)e.push(d%2?1:0),
d>>=1;e.reverse();d=e.join("");a=(1<<c-1)-1;e=parseInt(d.substring(0,1),2)?-1:1;f=parseInt(d.substring(1,1+c),2);d=parseInt(d.substring(1+c),2);return f===(1<<c)-1?0!==d?NaN:Infinity*e:0<f?e*Math.pow(2,f-a)*(1+d/Math.pow(2,b)):0!==d?d/Math.pow(2,b)*Math.pow(2,-(a-1))*e:0*e};p.prototype._fromIEEE754Single=function(a){return this._fromIEEE754(a,8,23)};p.prototype._toIEEE754Single=function(a){return this._toIEEE754(a,8,23)};var v=function(a){this.type=a};v.prototype=new m;v.prototype.constructor=v;v.prototype.doCommand=
function(a,c,b,e){if(a){var f=a,d=0;0==a.indexOf("setValue")&&(f=a.substr(0,8),d=parseInt(a.substr(8)),!d||isNaN(d))&&(d=0);switch(f){case "auto":d=0;break;case "comfort":d=1;break;case "standby":d=2;break;case "economy":d=3;break;case "protection":d=4;break;case "setValue":break;default:e&&e(Error("unknown command:"+f));return}this.setValue(d,c,b,e)}else e&&e(Error("unknown command:"+a))};v.prototype.setValue=function(a,c,b,e){(a=this._getBuffer(a))?m.prototype.setValue.call(this,a,c,b,function(a){e&&
e(a)}.bind(this)):e&&e(Error("invalid value"))};v.prototype.incValue=function(a,c,b,e,f){c=this._resolveValue(c);c=c.value+a;this.setValue(c,b,e,f)};v.prototype.decValue=function(a,c,b,e,f){c=this._resolveValue(c);c=c.value-a;this.setValue(c,b,e,f)};v.prototype._resolveDataRaw=function(a){return!a||2>a.length?null:a.readUInt8(1)};v.prototype._resolveData=function(a){if(!a||2>a.length)return null;a=a.readUInt8(1);return this._resolveValue(a)};v.prototype._resolveValue=function(a){switch(this.type){case "DPT-20":break;
case "DPST-20-1":switch(a){case 0:a="autonomous";break;case 1:a="slave";break;case 2:a="master";break;default:a="unknow"}break;case "DPST-20-102":switch(a){case 0:a="auto";break;case 1:a="comfort";break;case 2:a="standby";break;case 3:a="economy";break;case 4:a="protection";break;default:a="unknow"}break;default:return null}return a};v.prototype._getBuffer=function(a){var c=new Buffer(2);c.writeUInt8(0,0);c.writeUInt8(a,1);return c};m.DPT1=n;m.DPT2=q;m.DPT3=k;m.DPT5=u;m.DPT6=t;m.DPT9=r;m.DPT14=p;
m.DPT20=v;return m}();
xnm.aio.knx.KNXGateway._Device=function(){var m=function(a){this._device=a};m.resolve=function(a){if(!a)return null;var c=null;switch(a.data){case "outlet":c=new q(a);break;case "lighting":c=new k(a);break;case "blind":c=new u(a);break;case "shutter":c=new t(a);break;case "heater":c=new r(a);break;case "1bit":c=new p(a);break;case "1byte":c=new v(a);break;case "general":c=new n(a)}return c};m.prototype={getDefaultChannel:function(){return null},executeCommand:function(a,c,b){this._parseCommand(a,function(a,
f,d,g){a?b&&b(a):(a=g.ga,(f=xnm.aio.knx.KNXGateway._DPT.resolve(g.type))?f.doCommand(d,c,a,function(a){b&&b(a)}.bind(this)):b&&b(Error("unknown actuator type:"+g.type)))})},_parseCommand:function(a,c){if(this._device)if(a){var b=a.indexOf("@");if(-1==b)c&&c(Error("command format invalid"));else{var e=a.substr(0,b);a=a.substr(b+1);e||(e=this.getDefaultChannel());this._device.channels&&this._device.channels[e]?(b=this._device.channels[e],b.actuator&&b.actuator.ga&&b.actuator.type?xnm.aio.knx.KNXGateway._DPT.resolve(b.actuator.type)?
