...
(b+=" ("+a.message+")");c({error:b,state:0})}});g.on("data",function(d){var e=!1;n=Buffer.concat([n,d]);var f=-1,l=null;for(d=0;d<n.length;d++)if(192==n[d])if(0>f)f=d;else if(l=n.slice(f,f+d+1),12==l.length&&0==l[9]&&0==l[10])if(!h&&8==l[2]||!k&&2==l[2]||3==l[2]){n=new Buffer([]);g.flush();e=!0;break}else f=d;else f=d;b._connTimeoutTimer&&(clearTimeout(b._connTimeoutTimer),b._connTimeoutTimer=null);h||k||(b._connTimeoutTimer=setTimeout(function(){h||k||(g.close(),c&&c({error:"communication error",
...
xnm.aio.m10T.V5Updater.prototype.waitForSerialConnection=function(d,c,a){if(this._useChromeAPI)this._chromeWaitForSerialConnection(d,c,a);else{var b=this,e=function(e,f){void 0==f&&(f=[]);if(a&&f&&a.length<f.length)for(e=0;e<f.length;e++){for(var g=!0,h=0;h<a.length;h++)if(f[e].comName==a[h].comName){g=!1;break}if(g){var m=f[e].comName;setTimeout(function(){c&&c(m)},1E3)}}else 0<d?setTimeout(function(){b.waitForSerialConnection(d-.5,c,f)},500):c&&c(null)},f=require("serialport");"undefined"!==typeof nw&&
