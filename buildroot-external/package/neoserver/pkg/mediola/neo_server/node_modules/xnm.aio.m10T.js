...
$jscomp.polyfill=function(d,c,a,b){if(c){a=$jscomp.global;d=d.split(".");for(b=0;b<d.length-1;b++){var e=d[b];e in a||(a[e]={});a=a[e]}d=d[d.length-1];b=a[d];c=c(b);c!=b&&null!=c&&$jscomp.defineProperty(a,d,{configurable:!0,writable:!0,value:c})}};
$jscomp.polyfill("String.prototype.endsWith",function(d){return d?d:function(c,a){var b=$jscomp.checkStringArgs(this,c,"endsWith");c+="";void 0===a&&(a=b.length);a=Math.max(0,Math.min(a|0,b.length));for(var d=c.length;0<d&&0<a;)if(b[--a]!=c[--d])return!1;return 0>=d}},"es6","es3");var xnm=xnm||{};xnm.aio=xnm.aio||{};xnm.aio.m10T=xnm.aio.m10T||{};
...
xnm.aio.m10T.STMSPIBootloader.prototype._waitForACK=function(d,c,a){if(1>c)a&&a(!1);else{var b=this;setTimeout(function(){b._spi.send([0,0,121],null,function(e){e.data&&121==e.data[1]?a&&a(!0):b._waitForACK(d,c-1,a)})},d)}};
...
e+'/bootloader/bootloader.bin" 0x10000 "'+e+'/main.bin" 0x8000 "'+e+'/partitions.bin"';e.endsWith(".bin")&&(g="python "+c+" --chip esp32 --port "+d+' --baud 115200 --before no_reset --after hard_reset write_flash -z --flash_mode dio --flash_freq 40m --flash_size detect 0x1000 "'+e+'"');var h=require("child_process").exec;g=h(g);g.stdout.on("data",function(a){a=a.trim();26<a.length&&0==a.indexOf("Writing at ")&&(a=parseInt(a.substr(26)),99<a&&(a=99),b._callback&&b._callback({error:null,state:a}))});
g.on("error",function(a){});g.on("close",function(c){b._callback&&(0==c?b._callback({error:null,state:100}):a({error:"esptool error",state:0}))})},500)})};
