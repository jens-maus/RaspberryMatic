...
9==c.length&&(delete a.state.valve,a.state.current=(((c[4]>>7&1)<<8|c[8])/10).toFixed(1))}a.state.battery=c[2]&128?"low":"OK"}};xnm.aio.max.Cube.prototype._evalLData=function(a,b){b=new Buffer(b,"base64");for(var c=0;c<b.length;){var e=b[c];if(0==e)break;var d=XC.getHexVal(b[c+1],2)+XC.getHexVal(b[c+2],2)+XC.getHexVal(b[c+3],2),g=b.slice(c+4,c+e+1);this._evalState(a,d,g);c+=e+1}return{l:a}};
