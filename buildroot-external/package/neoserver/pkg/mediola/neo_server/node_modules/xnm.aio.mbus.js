...
xnm.aio.mbus.MediolaBus.prototype._connect=function(b){var a=this;a._resetSendingState();a._messages=[];a._sending=!0;var d=Buffer.from([]),c=null,e=!1,h=!1,k=require("serialport");this._serialPort=k.SerialPort?new k.SerialPort(this._port,{baudrate:115200}):new k(this._port,{baudRate:115200});this._serialPort.on("open",function(){XC.debugf("opened port: "+a._port);b&&(b(!0),b=null);a._sending=!1;a._sendNextMessage()});this._serialPort.on("error",function(g){XC.debugf("port error: "+g.message);if(null!=
a._serialPort){try{a._serialPort.close()}catch(f){}a._serialPort=null}b&&(b(!1),b=null)});this._serialPort.on("close",function(g){a._serialPort=null});this._serialPort.on("data",function(g){d=Buffer.concat([d,g]);h=!1;c=null;e=!1;for(g=0;g<d.length;g++){var f=d[g];27==f||4==f||31==f?h?(c&&c.push(f),h=!1):27==f?h=!0:4==f?(e=!0,d=d.slice(g+1)):31==f&&(c=[],h=!1):(c&&c.push(f),h=!1);if(c&&e&&1!=c[0]&&0!=c[0]&&113==c[0]&&(c.shift(),c.pop(),f=Buffer.from(c),9<f.length&&f.length==(f[5]<<8)+f[6]+9&&(f[4]==
xnm.aio.mbus.TYPE_RES&&0<a._messages.length&&a._messages[0][0]==f[2]&&a._messages[0][1]==f[3]&&(a._resetSendingState(),a._messages.shift(),setTimeout(function(){a._sendNextMessage()},10)),a._onData))){var l=[];for(g=9;g<(f[5]<<8)+f[6]+9;g++)l.push(f[g]);a._onData({source:f[2]+"."+f[3],type:f[4],data:l})}}})};xnm.aio.mbus.MediolaBus.prototype._getAddressFromString=function(b){var a=null;b=b.split(".");2==b.length&&(a=parseInt(b[0]),b=parseInt(b[1]),a=((a&255)<<8)+(b&255));return a};
...
var h=a[b].split(".");if(2==h.length){var k=parseInt(h[0]);h=parseInt(h[1]);0<k&&18>k&&0<h&&5>h&&(e.push(3),e.push(k),e.push(1<<h-1))}else k=parseInt(h),"0"==h?e.push(1):(e.push(3),e.push(k),e.push(31));1<e.length&&this._sendMessage(d,1,e)}else"n26shutterfunction"==b.type.toLowerCase()&&(e="up"==a?[1,2]:"down"==a?[2,2]:"angle"==a?[3,2]:"stop"==a?[4,2]:[0,2],"A"==b.data?e.push(1):"D"==b.data&&e.push(2),2<e.length&&this._sendMessage(d,1,e))}};
