...
xnm.aio.minisafe.Importer.prototype._compareType=function(a,b,c){var d=a.physicalDevice,e=null,f;for(f in a.deviceInformation)if(a.deviceInformation[f].eep){e=a.deviceInformation[f].eep;break}if(null==e&&a.transmissionInformation)for(var g in a.transmissionInformation)if(a.transmissionInformation[g].eep){e=a.transmissionInformation[g].eep;break}if(!c){if(b.id.toLowerCase()==d.toLowerCase()||e&&b.data.toLowerCase()==e.toLowerCase()||0==d.toLowerCase().indexOf(b.id.toLowerCase())||0==b.id.toLowerCase().indexOf(d.toLowerCase()))return!0}else if(0<
d.toLowerCase().indexOf(b.id.toLowerCase())||0<b.id.toLowerCase().indexOf(d.toLowerCase()))return!0;return!1};
...
a.transmissionInformation[0].transmissionID);else{c=[];for(var e in a.transmissionInformation)a.transmissionInformation[e].transmissionID&&c.push(a.transmissionInformation[e].transmissionID);b.senderID=JSON.stringify(c)}if(e=this._AIODEVICES[b.vendor])for(var f in e)if(1==this._compareType(a,e[f],!1)){b.data=e[f].data;break}if(null==b.data&&(e=this._AIODEVICES.general))for(f in e)if(1==this._compareType(a,e[f],!1)){b.data=e[f].data;b.vendor="general";break}if(null==b.data){if(e=this._AIODEVICES[b.vendor])for(f in e)if(1==
this._compareType(a,e[f],!0)){b.data=e[f].data;break}if(null==b.data&&(e=this._AIODEVICES.general))for(f in e)if(1==this._compareType(a,e[f],!0)){b.data=e[f].data;b.vendor="general";break}}return null==b.data?null:b};xnm.aio.minisafe.Importer.prototype._setBaseAddress=function(a,b){a={type:"ENOCEAN",baseAdr:a};var c=new (require("xnm.aio.gateway.js").Gateway)(this._importIP);c.isV5=!0;c.timeout=2E3;c.password=this._importPassword;c.executeRequestV5("setConfig",a,function(a){a.error?b(!1):b(!0)})};
