...
{type:"enum",name:"identify",ref:{value:"identify"}},{type:"dynamic",name:"set scene",ref:{value:"scene",ext:"%dynamic"}},{type:"enum",name:"select next scene",ref:{value:"sceneNext"}},{type:"enum",name:"select previous scene",ref:{value:"scenePrev"}},{type:"enum",name:"select random scene",ref:{value:"sceneRandom"}}],status:[{type:"enum",name:"state",ref:{value:"on",options:["on","off"]}},{type:"int",name:"brightness",ref:{value:"brightness",extMeta:"0-100"}},{type:"enum",name:"color mode",ref:{value:"colorMode",
options:["ct","effect","hs"]}},{type:"int",name:"color temperature",ref:{value:"ct",extMeta:"1200-6500"}},{type:"int",name:"hue",ref:{value:"hue",extMeta:"0-360"}},{type:"int",name:"saturation",ref:{value:"sat",extMeta:"0-100"}},{type:"dynamic",name:"scene name",ref:{value:"effectSelected",ext:"%dynamic"}},{type:"int",name:"scene index",ref:{value:"effectIndex"}},{type:"string",name:"device name",ref:{value:"name"}},{type:"string",name:"model",ref:{value:"model"}},{type:"string",name:"serial number",
ref:{value:"serialNo"}},{type:"string",name:"firmware version",ref:{value:"firmwareVersion"}},{type:"int",name:"number of panels",ref:{value:"numPanels"}}],ipevt:[{type:"enum",name:"state",ref:{value:"on",options:["on","off"]}},{type:"int",name:"brightness",ref:{value:"brightness",extMeta:"0-100"}},{type:"enum",name:"color mode",ref:{value:"colorMode",options:["ct","effect","hs"]}},{type:"int",name:"color temperature",ref:{value:"ct",extMeta:"1200-6500"}},{type:"int",name:"hue",ref:{value:"hue",extMeta:"0-360"}},
{type:"int",name:"saturation",ref:{value:"sat",extMeta:"0-100"}},{type:"dynamic",name:"scene name",ref:{value:"effectSelected",ext:"%dynamic"}}]}},SYS:"nanoleaf",applyIPEventFilter:function(a,b){return a&&a.type?(a=xnm.aio.nanoleaf.DM.getIPevtMap(a))?{ipevt:a}:null:null},applyUIFilter:function(a,b,c){if(!a.sys)return null;var d=function(a,b){if("*"===a||"*"===a[0])return!0;for(var c=0;c<a.length;c++)if(a[c]==b)return!0;return!1},e=function(a,b,c){var e=[];switch(c.catagory){case "command":a.command&&
a.command.forEach(function(a){d(c.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),e.push(a))});break;case "status":a.status&&a.status.forEach(function(a){d(c.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),e.push(a))})}return e},h=function(a,b){var d=[],h=xnm.aio.nanoleaf.DM.getCommandStatusMap(a,c);h&&(a=e(h,a,b),d=d.concat(a));return d},g=JSON.parse(JSON.stringify(a)),f=null;switch(b.catagory){case "command":f=h(a,b);g.command=f;break;case "status":f=h(a,b);g.status=f;break;default:return null}return f&&
0!=f.length?g:null},createDevice:function(a,b,c){b=xnm.aio.nanoleaf.DM;a?a.type?a.ip?c(null,a):c(new b.Error(b.Error.ERROR_CODE.INVALID,"IP is missing")):c(new b.Error(b.Error.ERROR_CODE.INVALID,"type is missing")):c(new b.Error(b.Error.ERROR_CODE.INVALID,"info is missing"))},deleteDevice:function(a,b,c){a.ip&&a.token?(a=xnm.aio.nanoleaf.parseJSON(a))?a.deleteUser(function(a){c()}):c():c()},getCommandStatusMap:function(a,b){return a.type?xnm.aio.nanoleaf.DM.MAP[a.type]:null},getIPDeviceType:function(){return[{sys:xnm.aio.nanoleaf.DM.SYS,
name:"Nanoleaf"}]},getIPevtMap:function(a){return a.type?xnm.aio.nanoleaf.DM.MAP[a.type].ipevt||null:null},toGeneralDevice:function(a){return{type:"dimmer",commands:{brightness:{value:{type:"INT",min:0,max:100}},color:{value:{type:"RGB"}},colorTemperature:{value:{type:"INT",min:1200,max:6500}},down:{value:{type:"INT",min:-100,max:100}},off:{},on:{},toggle:{},up:{value:{type:"INT",min:-100,max:100}},white:{}},states:{brightness:{type:"INT",min:0,max:100,unit:"%"},colorTemperature:{type:"INT",min:1200,
max:6500},state:{values:["on","off"]}},details:{commands:{brightness:{value:"brightness",ext:"%d",extMeta:"0-100"},color:{value:"color"},colorTemperature:{value:"ct",ext:"%d",extMeta:"1200-6500"},down:{value:"brightnessInc",ext:"-10"},off:{value:"off"},on:{value:"on"},toggle:{value:"toggle"},up:{value:"brightnessInc",ext:"10"},white:{value:"color",ext:"#FFFFFF"}},states:{brightness:{value:"brightness"},colorTemperature:{value:"ct"},state:{value:"on"}}}}},updateDevice:function(a,b,c){b=xnm.aio.nanoleaf.DM;
a?a.type?a.ip?c(null,a):c(new b.Error(b.Error.ERROR_CODE.INVALID,"IP is missing")):c(new b.Error(b.Error.ERROR_CODE.INVALID,"type is missing")):c(new b.Error(b.Error.ERROR_CODE.INVALID,"info is missing"))}};xnm.aio.nanoleaf.DM.MAP.canvas={command:xnm.aio.nanoleaf.DM.MAP.device.command.slice(0),status:xnm.aio.nanoleaf.DM.MAP.device.status.slice(0),ipevt:xnm.aio.nanoleaf.DM.MAP.device.ipevt.slice(0)};
