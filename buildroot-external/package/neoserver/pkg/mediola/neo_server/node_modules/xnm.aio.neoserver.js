...
xnm.aio.neoserver.DM={SYS:"neoserver",GATEWAY_MAP:{cloud_forward:{command:[{type:"enum",name:"cloud forward on",ref:{value:"cfOn"}},{type:"enum",name:"cloud forward off",ref:{value:"cfOff"}},{type:"enum",name:"cloud forward toggle",ref:{value:"cfToggle"}}],status:[{type:"enum",name:"cloud forward settings",ref:{value:"cfSetting",options:["off","on"]}}]}},DMError:function(){var a=function(a,c){this.code=a;this.message=c;this.stack=Error().stack};a.prototype=Error();a.prototype.name="NEOServerDeviceManagerError";
a.prototype.code=0;a.ERROR_CODE={DEFAULT:0,INDEX_EXISTS:1,ID_EXISTS:2,INVALID:3,UNKNOW:4,NOT_FOUND:5,IP_EXISTS:6};return a}(),getSystem:function(a){if(!a||!a.type)return null;for(var b in xnm.aio.neoserver.systems)if(xnm.aio.neoserver.systems.hasOwnProperty(b)){var c=xnm.aio.neoserver.systems[b];if(c&&c.DM&&c.DM.TYPE&&c.DM.TYPE.toLowerCase()==a.type.toLowerCase())return c}return null},getGatewayType:function(){return{sys:this.SYS,name:"NEO SERVER"}},getGatewayDeviceType:function(a){var b=[],c;for(c in xnm.aio.neoserver.systems)if(xnm.aio.neoserver.systems.hasOwnProperty(c)){var d=
