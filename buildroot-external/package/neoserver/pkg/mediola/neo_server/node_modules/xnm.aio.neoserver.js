...
xnm.aio.neoserver.systems._SysVar={setVar:function(a,b,c,d,e){a._executeRequest("setVar",{id:c,type:b,value:d},{timeout:2E4},function(a){e&&e(a)})},delVar:function(a,b,c){a._executeRequest("delVar",{id:b},{timeout:2E4},function(a){c&&c(a)})},getSysVars:function(a,b){a._executeRequest("getStates",null,{timeout:2E4},function(a,d){if(a)b&&b(a);else{var e=[];if(d)for(var f=0;f<d.length;f++){var g=d[f];if(g.adr||g.id)switch(g.type){case xnm.aio.neoserver.systems.Boolean.DM.TYPE:case xnm.aio.neoserver.systems.Int.DM.TYPE:case xnm.aio.neoserver.systems.Float.DM.TYPE:case xnm.aio.neoserver.systems.String.DM.TYPE:e.push({type:g.type,
address:g.adr});break;case xnm.aio.neoserver.systems.Task.DM.TYPE:e.push({type:g.type,address:g.id})}}b&&b(null,e)}})}};
...
_executeCommand:function(a,b,c,d){xnm.aio.neoserver.systems._SysVar.setVar(a,this.DM.TYPE,b.address,c.value,d)},handleStateCreator:function(a,b,c){return b&&b.value?(a=this._handleState(a,c))?a[b.value]:null:null},_handleState:function(a,b){if(!(b.type&&"onoff"==b.type.toLowerCase()&&b.adr&&b.state&&a.address&&a.address&&a.address.toLowerCase()==b.adr.toLowerCase()))return null;var c=b.state;c&&(c=c.toLowerCase());return{state:c}},generateActionCode:function(a,b){if(!b||!b.address||2!=b.address.length||
!a)return null;var c;switch(a.value){case "on":c="01";break;case "off":c="00";break;case "toggle":c="0F";break;default:return null}return b.address+c},parseActionCode:function(a,b){if(!a||4!=a.length||!b||!b.address||2!=b.address.length)return null;var c=a.substr(0,2),d=a.substr(2,2);if(c.toLowerCase()!=b.address.toLowerCase())return null;c={};switch(d.toUpperCase()){case "01":c.value="on";break;case "00":c.value="off";break;case "0F":c.value="toggle";break;default:return null}return c},DM:{TYPE:"ONOFF",
MAP:{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}}],status:[{type:"enum",name:"status",ref:{value:"state",options:["off","on"]}}],ipevt:[{type:"enum",name:"status",ref:{value:"state",options:["off","on"]}}]},getGatewayDeviceType:function(a){return{type:this.TYPE,name:"Boolean System Variable"}},getCommandStatusMap:function(){return this.MAP},getIPevtMap:function(a,b){var c=this.getCommandStatusMap(a);if(!c)return null;
var d={ipevt:[]};c.ipevt&&(d.ipevt=c.ipevt);return d},createDevice:function(a,b,c){b=xnm.aio.neoserver.DM.DMError;var d=xnm.aio.neoserver.DM.DMError.ERROR_CODE;a.address?(a=JSON.parse(JSON.stringify(a)),c(null,a)):c(new b(d.INVALID,"parameter address is invalid"))},updateDevice:function(a,b,c){b=xnm.aio.neoserver.DM.DMError;var d=xnm.aio.neoserver.DM.DMError.ERROR_CODE;a.address?(a=JSON.parse(JSON.stringify(a)),c(null,a)):c(new b(d.INVALID,"parameter address is invalid"))},deleteDevice:function(a,
b,c,d){xnm.aio.neoserver.systems.Boolean.delVar(a,b.address,function(){d&&d(null,JSON.parse(JSON.stringify(b)))})}}};
...
b.adr&&b.state&&a.address&&a.address&&a.address.toLowerCase()==b.adr.toLowerCase()))return null;var c=parseInt(b.state,16);return{state:c&2147483648?c-4294967296:c}},DM:{TYPE:"INT",MAP:{command:[{type:"int",name:"set value",ref:{value:"setValue",ext:"%d",extMeta:"-2147483648-2147483647"}}],status:[{type:"int",name:"status",ref:{value:"state",extMeta:"-2147483648-2147483647"}}],ipevt:[{type:"int",name:"status",ref:{value:"state",extMeta:"-2147483648-2147483647"}}]},getGatewayDeviceType:function(){return{type:this.TYPE,
name:"Integer System Variable"}},getCommandStatusMap:function(){return this.MAP},getIPevtMap:function(a,b){var c=this.getCommandStatusMap(a);if(!c)return null;var d={ipevt:[]};c.ipevt&&(d.ipevt=c.ipevt);return d},getActionMap:function(){return{command:[]}},createDevice:function(a,b,c){b=xnm.aio.neoserver.DM.DMError;var d=xnm.aio.neoserver.DM.DMError.ERROR_CODE;a.address?(a=JSON.parse(JSON.stringify(a)),c(null,a)):c(new b(d.INVALID,"parameter address is invalid"))},updateDevice:function(a,b,c){b=xnm.aio.neoserver.DM.DMError;
...
var d={ipevt:[]};c.ipevt&&(d.ipevt=c.ipevt);return d},getActionMap:function(){return{command:[]}},createDevice:function(a,b,c){b=xnm.aio.neoserver.DM.DMError;var d=xnm.aio.neoserver.DM.DMError.ERROR_CODE;a.address?(a=JSON.parse(JSON.stringify(a)),c(null,a)):c(new b(d.INVALID,"parameter address is invalid"))},updateDevice:function(a,b,c){b=xnm.aio.neoserver.DM.DMError;var d=xnm.aio.neoserver.DM.DMError.ERROR_CODE;a.address?(a=JSON.parse(JSON.stringify(a)),c(null,a)):c(new b(d.INVALID,"parameter address is invalid"))},
...
xnm.aio.neoserver.systems.Task={executeCommandCreator:function(a,b,c,d){b?c&&c.value?b&&b.address?this._executeCommand(a,b,c,d):d&&d(Error("device address is empty")):d&&d(Error("device command is empty")):d&&d(Error("device is null"))},_executeCommand:function(a,b,c,d){var e,f;"on"==c.value?(e="SetTaskActive",f={id:b.address,active:!0}):"off"==c.value?(e="SetTaskActive",f={id:b.address,active:!1}):"toggle"==c.value&&(e="ToggleTaskActive",f={id:b.address});a._executeRequest(e,f,{timeout:2E3},function(a){d&&
d(a)})},handleStateCreator:function(a,b,c){return b&&b.value?(a=this._handleState(a,c))?a[b.value]:null:null},_handleState:function(a,b){return b.type&&"task"==b.type.toLowerCase()&&b.id&&a.address&&a.address==b.id?{state:b.active?"on":"off"}:null},DM:{TYPE:"TASK",MAP:{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}}],status:[{type:"enum",name:"status",ref:{value:"state",options:["off","on"]}}]},getGatewayDeviceType:function(){return{type:this.TYPE,
name:"Task System Variable"}},getCommandStatusMap:function(){return this.MAP},createDevice:function(a,b,c){b=xnm.aio.neoserver.DM.DMError;var d=xnm.aio.neoserver.DM.DMError.ERROR_CODE;a.address?(a=JSON.parse(JSON.stringify(a)),c(null,a)):c(new b(d.INVALID,"parameter address is invalid"))},updateDevice:function(a,b,c){b=xnm.aio.neoserver.DM.DMError;var d=xnm.aio.neoserver.DM.DMError.ERROR_CODE;a.address?(a=JSON.parse(JSON.stringify(a)),c(null,a)):c(new b(d.INVALID,"parameter address is invalid"))},
deleteDevice:function(a,b,c,d){d(null,b)}}};
...
b){var d=[],e=b.elems,k;k=a?xnm.aio.neoserver.DM.GATEWAY_MAP.cloud_forward:null;if(k)switch(b.catagory){case "command":k.command&&k.command.forEach(function(a){c(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))});break;case "status":k.status&&k.status.forEach(function(a){c(e,a.type)&&(a=JSON.parse(JSON.stringify(a)),d.push(a))})}return d},e=JSON.parse(JSON.stringify(a)),f=null;switch(b.catagory){case "command":f=d(a,b);e.command=f;break;case "status":f=d(a,b);e.status=f;break;default:return null}return f&&
...
(a=JSON.parse(JSON.stringify(a)),e.push(a))})}return e};if(!a.sys)return null;var f=JSON.parse(JSON.stringify(a));a=function(a,b,c){var d=[],f=null,l,f=xnm.aio.neoserver.DM.getSystem(a);"ipevt"==b.type?f&&f.DM&&f.DM.getIPevtMap&&(l=f.DM.getIPevtMap(a,c)):"action"==b.catagory&&f&&f.DM&&f.DM.getActionMap&&(l=f.DM.getActionMap(a));l||f&&f.DM&&f.DM.getCommandStatusMap&&(l=f.DM.getCommandStatusMap(a));l&&(f=e(l,a,b),d=d.concat(f));return d}(a,b,c);if("ipevt"==b.type)f.ipevt=a;else switch(b.catagory){case "command":f.command=
a;break;case "status":f.status=a}return a&&0!=a.length?f:null},createGateway:function(a,b,c){c(null,a)},updateGateway:function(a,b,c,d){d(null,b)},deleteGateway:function(a,b,c){c()},createDevice:function(a,b,c){var d=this.DMError,e=this.DMError.ERROR_CODE;if(a)if(a.gateway)if(a.type)if(b.data&&b.data.gateways&&0!==b.data.gateways.length){var f=b.data.gateways,g,h;for(g=0;g<f.length;g++)if(f[g].index===a.gateway){h=f[g];break}h?(d=this.getSystem(a,h.info))&&d.DM&&d.DM.createDevice?d.DM.createDevice(a,
...
g,h;for(g=0;g<f.length;g++)if(f[g].index===a.gateway){h=f[g];break}h?(d=this.getSystem(a))&&d.DM&&d.DM.updateDevice?d.DM.updateDevice(a,b,c):(a=JSON.parse(JSON.stringify(a)),c(null,a)):c(new d(e.NOT_FOUND,"gateway with index "+a.gateway+" not exists"))}else c(new d(e.NOT_FOUND,"gateway with index "+a.gateway+" not exists"));else c(new d(e.INVALID,"type is invalid"));else c(new d(e.INVALID,"gateway is invalid"));else c(new d(e.INVALID,"info is invalid"))},deleteDevice:function(a,b,c){var d=this.getSystem(a);
if(d&&d.DM&&d.DM.deleteDevice){var e=JSON.parse(JSON.stringify(a));b&&b.dm&&b.tenant&&b.tenant.index&&a&&a.gateway?b.dm.execute("read",b.tenant.index,"gateway",{filter:"prop",index:a.gateway,"info.sys":"neoserver"},function(f,g){if(!f&&g&&0!=g.length&&g[0]&&g[0].info){var h=require("xnm.aio.neoserver.js").resolveGateway(g[0].info);d.DM.deleteDevice(h,a,b,c)}else c&&c(null,e)}):c&&c(null,e)}else c()}};
...
xnm.aio.neoserver.Handler.prototype.resolveGateway=function(a){var b=require("xnm.aio.gateway.js");if(!a.ip)return null;b=new b.GatewayV5Plus(a.ip,a.port);a.username&&(b.user=a.username);a.password&&(b.password=a.password);b._sid=a.sid;return b};xnm.aio.neoserver.Handler.prototype.getDeviceCommands=function(a,b){var c;c=(c=a&&a.ip?xnm.aio.gateway.DM.applyUIFilterGateway(a,{catagory:"command",elems:"*"}):xnm.aio.gateway.DM.applyUIFilter(a,{catagory:"command",elems:"*"}))?c.command:[];b&&b(null,c)};
xnm.aio.neoserver.Handler.prototype.getDeviceStatus=function(a,b){var c;c=(c=a&&a.ip?xnm.aio.gateway.DM.applyUIFilterGateway(a,{catagory:"status",elems:"*"}):xnm.aio.gateway.DM.applyUIFilter(a,{catagory:"status",elems:"*"}))?c.status:[];b&&b(null,c)};xnm.aio.neoserver.Handler.prototype.regist=function(a,b,c){if(a=this.resolveGateway(a)){var d=xnm.aio.neoserver.DM.getSystem(b);d?d.regist(a,b,c):c&&c(Error("device type unknown"))}else c&&c(Error("gateway json format invalid"))};
...
xnm.aio.neoserver.Handler.prototype.getSysVars=function(a,b){if(a){var c=this.resolveGateway(a);c?xnm.aio.neoserver.systems._SysVar.getSysVars(c,b):b&&b(Error("gateway format invalid"))}else b&&b(Error("gateway json is null"))};"undefined"!=typeof module&&null!=module&&(module.exports=new xnm.aio.neoserver.Handler);
