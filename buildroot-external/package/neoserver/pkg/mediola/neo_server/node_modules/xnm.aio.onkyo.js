...
xnm.aio.onkyo.DM=function(){var b=function(b,e){this.code=b;this.message=e;this.stack=Error().stack};b.prototype=Error();b.prototype.name="OnkyoDMError";b.prototype.code=0;b.ERROR_CODE={DEFAULT:0,INDEX_EXISTS:1,ID_EXISTS:2,INVALID:3,UNKNOW:4,NOT_FOUND:5,IP_EXISTS:6};var e={avr:{command:[{type:"root",name:"global",value:"global",children:[{type:"string",name:"custom command",ref:{value:"customCMD",ext:"%s"}},{type:"enum",name:"open Onkyo Remote App",ref:{value:"openNative"}}]},{type:"root",name:"NET",
...
createDevice:function(e,h,f){h=b.ERROR_CODE;e?e.ip?f(null,e):f(new b(h.INVALID,"ip is invalid")):f(new b(h.INVALID,"info is invalid"))},updateDevice:function(e,h,f){h=b.ERROR_CODE;e?e.ip?f(null,e):f(new b(h.INVALID,"ip is invalid")):f(new b(h.INVALID,"info is invalid"))},deleteDevice:function(b,e,f){f()},applyUIFilter:function(b,e,f){var g=function(a,d,b){var c=[];a.forEach(function(a){if("root"==a.type){a=JSON.parse(JSON.stringify(a));var e=g(a.children,d,b);e&&0<e.length&&(a.children=e,c.push(a))}else{e=
b.elems;if("*"==e)e=!0;else{for(var f=!1,h=0;h<e.length;h++)if(e[h]==a.type){f=!0;break}e=f}e&&(a=JSON.parse(JSON.stringify(a)),c.push(a))}});return c},h=function(a,d){var c=[],b=xnm.aio.onkyo.DM.getCommandStatusMap(a,f);if(b){var e=[];switch(d.catagory){case "command":b.command&&(e=g(b.command,a,d));break;case "status":b.status&&(e=g(b.status,a,d))}c=c.concat(e)}return c};if(!b.sys)return null;var m=JSON.parse(JSON.stringify(b)),a=null;switch(e.catagory){case "command":a=h(b,e);m.command=a;break;
case "status":a=h(b,e);m.status=a;break;default:return null}return a&&0!=a.length?m:null},getCommandStatusMap:function(b){return b&&b.type?e[b.type]:null}}}();
