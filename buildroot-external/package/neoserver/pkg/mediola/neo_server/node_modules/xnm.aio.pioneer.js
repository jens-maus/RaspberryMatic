...
$jscomp.Symbol=function(){function e(h){if(this instanceof e)throw new TypeError("Symbol is not a constructor");return new $jscomp.SymbolClass($jscomp.SYMBOL_PREFIX+(h||"")+"_"+c++,h)}var c=0;return e}();
...
$jscomp.iteratorFromArray=function(e,c){$jscomp.initSymbolIterator();e instanceof String&&(e+="");var h=0,g={next:function(){if(h<e.length){var f=h++;return{value:c(f,e[f]),done:!1}}g.next=function(){return{done:!0,value:void 0}};return g.next()}};g[Symbol.iterator]=function(){return g};return g};
...
xnm.aio.pioneer.AVReceiver=function(){var e=[1,2,3,4,5],c=function(a,b,d,l){this._taskBuffer=a;this._avr=b;this._datapoints=d;this._callback=l};c.prototype.run=function(){this._avr._logger.log("debug","run status task: "+JSON.stringify(this._datapoints));var a=this,b={},d=0,l=function(c,e){if(c&&4!=c.errorCode&&5!=c.errorCode)1==c.errorCode||2==c.errorCode||3==c.errorCode?a._taskBuffer._finishAllTask(c):a._taskBuffer._finishLastTask(c);else{c=a._datapoints[d];var f=null,h=c.indexOf(":");0<h&&(f=c.substr(0,
h),c=c.substr(h+1));h="?";e&&(f||null==e[c]||"undefined"==typeof e[c]?f&&e[f]&&null!=e[f][c]&&"undefined"!=typeof e[f][c]&&(h=e[f][c]):h=e[c]);b[a._datapoints[d]]=h;d+=1;d<a._datapoints.length?(e=a._avr._getStateQuest(a._datapoints[d]),a._avr._doStateReq(e,l)):a._taskBuffer._finishLastTask(null,b)}},c=this._avr._getStateQuest(this._datapoints[d]);this._avr._doStateReq(c,l)};c.prototype.merge=function(a){if(a&&a._datapoints)if(this._datapoints){a=this._datapoints.concat(a._datapoints);for(var b=0;b<
...
function(){};f.prototype._onSocketError=function(a){a.errorCode=e[1];this._finishAllPacket(a)};f.prototype._onSocketClose=function(a){a=Error("socket closed");a.errorCode=e[2];this._finishAllPacket(a)};var k=function(a,b,d,c,e){this._ip=a;this._port=b;this._port||(this._port=23);this._uuid=d;this._name=c;this._model=e;this._logger=require("x.logger.js").getLogger("xnm.aio.pioneer.AVReceiver");this._socket=null;this._taskBuffer=new g(this);this._packetBuffer=new f(this)};k.prototype.executeCommandCreator=
function(a,b,d){if(b&&b.value)if("openNative"==b.value)window&&window.XC&&window.XC.callHost&&window.XCHost.getType&&("iOS"==window.XCHost.getType()?window.XC.callHost("SYSTEM","startApp",{scheme:"icontrolav5://"}):"Android"==window.XCHost.getType()&&window.XC.callHost("SYSTEM","startApp",{scheme:"jp.pioneer.avsoft.android.icontrolav2014"})),d&&d();else{a="";b.path&&b.path[0]&&"global"!=b.path[0]&&(a=b.path[0]+":");var c=a+b.value;if("setTo"==b.value||"tuner"==b.value){if(null==b.ext||"undefined"==
typeof b.ext){d&&d(Error("command setTo ext format invalid"));return}c+=b.ext}else if("audioMode"==b.value){if(!b.ext){d&&d(Error("command audioMode ext format invalid"));return}c=a+b.ext}else if("setInput"==b.value){if(!b.ext){d&&d(Error("command setInput ext format invalid"));return}c=a+b.ext}else if("setTone"==b.value){if(!b.ext){d&&d(Error("command setTone ext format invalid"));return}c+=b.ext}else if("bassTo"==b.value||"trebleTo"==b.value){if(null==b.ext||"undefined"==typeof b.ext){d&&d(Error("command ext format invalid"));
return}c+=b.ext}else if("customCMD"==b.value){if(!b.ext){d&&d(Error("command customCMD ext format invalid"));return}c=a+b.ext}this._executeCommand(c,function(a){a?d&&d(a):b.path&&b.path[0]&&"mainzone"==b.path[0]&&("on"==b.value||"off"==b.value||"toggle"==b.value)?setTimeout(function(){d&&d()},5E3):d&&d()})}else d&&d(Error("command json format invalid"))};k.prototype.getStatesCreator=function(a,b,d){a=function(a,b){for(var d=0;d<b.length;d++)if(b[d]===a)return!0;return!1};for(var c=[],e=[],f=0;f<b.length;f++)if(b[f]&&
b[f].id&&b[f].status&&b[f].status.value){var h="";b[f].status.path&&b[f].status.path[0]&&"global"!=b[f].status.path[0]&&(h=b[f].status.path[0]+":");var g=b[f].status.value;c.push({id:b[f].id,datapoint:h+g});a(h+g,e)||e.push(h+g)}this._getStates(e,function(a,b){if(a)d&&d(a);else{a=[];for(var l=0;l<c.length;l++){var e="?",f=c[l].id,h=c[l].datapoint;b&&null!=b[h]&&"undefined"!=typeof b[h]&&(e=b[h]);a.push({id:f,status:e})}d&&d(null,a)}})};k.prototype.executeCommand=function(a,b){this._executeCommand(a,
...
xnm.aio.pioneer.DM=function(){var e=function(c,e){this.code=c;this.message=e;this.stack=Error().stack};e.prototype=Error();e.prototype.name="PioneerDMError";e.prototype.code=0;e.ERROR_CODE={DEFAULT:0,INDEX_EXISTS:1,ID_EXISTS:2,INVALID:3,UNKNOW:4,NOT_FOUND:5,IP_EXISTS:6};var c={avr:{command:[{type:"root",name:"global",value:"global",children:[{type:"enum",name:"open pioneer iControlAV5",ref:{value:"openNative",value_t:"open_app_pioneer"}},{type:"enum",name:"tuner preset up",ref:{value:"tunerUp"}},
