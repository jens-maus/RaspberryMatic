...
b(Error("token invalid"));else b&&b(Error("sid invalid"))};f.prototype.deleteDevice=function(a,c,d,b){if(a)if(c){switch(d){case this.PUSH_TYPE.GCM:var e="NEO_GCM";break;case this.PUSH_TYPE.APNS:e="NEO_APNS";break;case this.PUSH_TYPE.APNS_SANDBOX:e="NEO_APNS_SANDBOX";break;case this.PUSH_TYPE.ADM:e="ADM";break;default:b&&b(Error("no such push type"))}d=g+"/deleteDevice?";a={sid:a.toUpperCase(),token:c,type:e};d+=$.param(a);$.ajax({url:d,timeout:4E3,cache:!1,dataType:"json",success:function(){b&&b(null)},
