...
a(null,b)}else{var f=this;this.getInfos(function(b){b?a&&a(b):f.getAllZoneInfo(a)})}};d.prototype.getCurrentZone=function(a){if(this._zonePlayer)a&&a(null,this._zonePlayer);else{var b=this;this.getInfos(function(c){c?a&&a(c):this._zonePlayer?b.getCurrentZone(a):a&&a(Error("no current zone"))})}};d.prototype.setCurrentZone=function(a,b){if(a)if(this._zones){var c=this._zones.zonePlayers[a],e=null;c||(e=Error("no such zone"));b&&b(e,c)}else{var f=this;this.getInfos(function(c){c?b&&b(c):f.setCurrentZone(a,
