...
xnm.aio.raumfeld.MasterPlayer=function(){var d=function(a,b,c){"undefined"!=typeof require&&require?(this._logger=require("x.logger.js").getLogger("xnm.aio.raumfeld.MasterDevice"),require("x.logger.js").setLevel("info","xnm.aio.raumfeld.MasterDevice")):this._logger={log:{}};this.ip=a;this.port=b;this.port||(this.port=47365);this.uuid=c;this._zonePlayer=this._zones=null;this._getInfoCbs=[];this._autoGetInfoTimeout=null};d.prototype.getIP=function(){return this.ip};d.prototype.getPort=function(){return this.port};
d.prototype.getUUID=function(){return this.uuid};d.prototype.executeCommandCreator=function(a,b,c){if(this._zonePlayer)this._zonePlayer.executeCommandCreator(a,b,c);else{var e=this;this.getInfos(function(f){f?c&&c(f):e._zonePlayer?e._zonePlayer.executeCommandCreator(a,b,c):c&&c(f)})}};d.prototype.getStatesCreator=function(a,b,c){if(this._zonePlayer)this._zonePlayer.getStatesCreator(a,b,c);else{var e=this;this.getInfos(function(f){f?c&&c(f):e._zonePlayer?e._zonePlayer.getStatesCreator(a,b,c):c&&c(f)})}};
d.prototype.play=function(a,b,c){if(this._zonePlayer)this._zonePlayer.play(a,b,c);else{var e=this;this.getInfos(function(f){f?c&&c(f):e._zonePlayer?e._zonePlayer.play(a,b,c):c&&c(f)})}};d.prototype.playFromContainer=function(a,b,c,e){if(this._zonePlayer)this._zonePlayer.playFromContainer(a,b,c,e);else{var f=this;this.getInfos(function(d){d?e&&e(d):f._zonePlayer?f._zonePlayer.playFromContainer(a,b,c,e):e&&e(d)})}};d.prototype.browser=function(a,b,c,e,f){if(this._zonePlayer)this._zonePlayer.browser(a,
b,c,e,f);else{var d=this;this.getInfos(function(g){g?f&&f(g):d._zonePlayer?d._zonePlayer.browser(a,b,c,e,f):f&&f(g)})}};d.prototype.getAllRoomInfo=function(a){if(this._zones){var b=[],c;for(c in this._zones.roomPlayers){var e=this._zones.roomPlayers[c];e&&b.push({uuid:e.getUUID(),name:e.getRoomName()})}a&&a(null,b)}else{var f=this;this.getInfos(function(b){b?a&&a(b):f._zones?f.getAllRoomInfo(a):a&&a(b)})}};d.prototype.getAllZoneInfo=function(a){if(this._zones){var b=[],c;for(c in this._zones.zonePlayers){var e=
this._zones.zonePlayers[c];e&&b.push({uuid:e.getUUID(),rooms:e.getRooms()})}a&&a(null,b)}else{var f=this;this.getInfos(function(b){b?a&&a(b):f.getAllZoneInfo(a)})}};d.prototype.getCurrentZone=function(a){if(this._zonePlayer)a&&a(null,this._zonePlayer);else{var b=this;this.getInfos(function(c){c?a&&a(c):this._zonePlayer?b.getCurrentZone(a):a&&a(Error("no current zone"))})}};d.prototype.setCurrentZone=function(a,b){if(a)if(this._zones){var c=this._zones.zonePlayers[a],e=null;c||(e=Error("no such zone"));
b&&b(e,c)}else{var f=this;this.getInfos(function(c){c?b&&b(c):f.setCurrentZone(a,b)})}else b&&b(Error("zone uuid invalid"))};d.prototype.addRoomToZone=function(a,b,c){var e="/"+this.uuid+"/connectRoomToZone?";e+="zoneUDN="+encodeURIComponent("uuid:"+b);e+="&roomUDN="+encodeURIComponent("uuid:"+a);var f=this;this._doGetRequest(this.ip,47365,e,function(a){a?c&&c(a):f.getInfos(c)})};d.prototype.dropRoom=function(a,b){var c="/"+this.uuid+"/dropRoomJob?";c+="roomUDN="+encodeURIComponent("uuid:"+a);var e=
this;this._doGetRequest(this.ip,47365,c,function(a){a?b&&b(a):e.getInfos(b)})};d.prototype.getRoomPlayer=function(a){if(!a||!a.uuid)return null;this._zones||(this._zones={zonePlayers:{},roomPlayers:{},dedicatePlayers:{}});var b=this._zones.roomPlayers[a.uuid];if(b)return b;if(!a.port||!a.port||!a.zone_uuid)return null;b=new xnm.aio.raumfeld.RoomPlayer(a.ip,a.port,a.zone_uuid,a.uuid);b._isDummy=!0;return this._zones.roomPlayers[a.uuid]=b};d.prototype.getDiscoveredRoomPlayer=function(a){if(!a)return null;
this._zones||(this._zones={zonePlayers:{},roomPlayers:{},dedicatePlayers:{}});a=this._zones.roomPlayers[a];return!a||a._isDummy?null:a};d.prototype.getRoomPlayers=function(){if(!this._zones)return null;var a=[],b;for(b in this._zones.roomPlayers)a.push(this._zones.roomPlayers[b]);return a};d.prototype.getDedicatePlayer=function(a){if(!a||!a.uuid)return null;this._zones||(this._zones={zonePlayers:{},roomPlayers:{},dedicatePlayers:{}});var b=this._zones.dedicatePlayers[a.uuid];if(b)return b;if(!a.port||
!a.port)return null;b=new xnm.aio.raumfeld.DedicatePlayer(a.ip,a.port,a.uuid);b._isDummy=!0;return this._zones.dedicatePlayers[a.uuid]=b};d.prototype.getDiscoveredDedicatePlayer=function(a){if(!a)return null;this._zones||(this._zones={zonePlayers:{},roomPlayers:{},dedicatePlayers:{}});a=this._zones.dedicatePlayers[a];return!a||a._isDummy?null:a};d.prototype.getDedicatePlayers=function(a){if(!this._zones)return null;var b=[];for(a in this._zones.dedicatePlayers)b.push(this._zones.dedicatePlayers[a]);
return b};d.prototype.getInfos=function(a){var b=this._getInfoCbs.length;a&&-1==this._getInfoCbs.indexOf(a)&&this._getInfoCbs.push(a);if(0==b){this._autoGetInfoTimeout&&(clearTimeout(this._autoGetInfoTimeout),this._autoGetInfoTimeout=null);var c=this;this._getInfos(function(a,b,d){c._autoGetInfoTimeout=setTimeout(function(){c.getInfos(null)},5E3);var e=c._getInfoCbs;c._getInfoCbs=[];e.forEach(function(c){c&&c(a,b,d)})})}};d.prototype._getInfos=function(a){var b=this;this._listDevices(function(c,e){c?
a&&a(c):b._getZones(function(c,d){c?a&&a(c):(b._updateBufferedZones(d,e),a&&a(null,d,e))})})};d.prototype._getZones=function(a){this._doGetRequest(this.ip,47365,"/"+this.uuid+"/getZones",function(b,c){if(b)a&&a(b);else try{var e={},d=$($.parseXML(c));d.find("zone").each(function(){var a=$(this),b=a.attr("udn");b&&(e[b]={},a.find("room").each(function(){var a=$(this),c=a.attr("udn"),d=a.attr("name");c&&d&&(e[b][c]={name:d,renderer:{}},a.find("renderer").each(function(){var a=$(this),d=a.attr("udn");
a=a.attr("name");d&&a&&(e[b][c].renderer[d]=a)}))}))});d.find("unassignedRooms").each(function(){var a=$(this);e.idle={};a.find("room").each(function(){var a=$(this),b=a.attr("udn"),c=a.attr("name");b&&c&&(e.idle[b]={name:c,renderer:{}},a.find("renderer").each(function(){var a=$(this),c=a.attr("udn");a=a.attr("name");c&&a&&(e.idle[b].renderer[c]=a)}))})});a&&a(null,e)}catch(g){a&&a(g)}})};d.prototype._listDevices=function(a){this._doGetRequest(this.ip,47365,"/"+this.uuid+"/listDevices",function(b,
c){if(b)a&&a(b);else try{var e={};$($.parseXML(c)).find("device").each(function(){var a=$(this),b=a.attr("udn");b&&(e[b]={udn:b,type:a.attr("type"),location:a.attr("location"),name:a.text()},a=require("url").parse(a.attr("location")),e[b].ip=a.hostname,e[b].port=a.port)});a&&a(null,e)}catch(f){a&&a(f)}})};d.prototype._updateBufferedZones=function(a,b){var c=[],e=[],d=[];this._zones||(this._zones={zonePlayers:{},roomPlayers:{},dedicatePlayers:{}});for(var g in a){c.push(g);var p=a[g];if("idle"!=g){var k=
g.substr(5),h=b[g];if(h)if(this._zones.zonePlayers[k]){var m=this._zones.zonePlayers[k];m.setIP(h.ip);m.setPort(h.port)}else m=new xnm.aio.raumfeld.ZonePlayer(h.ip,h.port,k),this._zones.zonePlayers[k]=m}m&&m.clearRoom();for(var v in p){e.push(v);var r=p[v];k=r.name;h=v.substr(5);m&&m.addRoom(h,k);if(this._zones.roomPlayers[h])var n=this._zones.roomPlayers[h];else n=new xnm.aio.raumfeld.RoomPlayer(null,null,null,h),this._zones.roomPlayers[h]=n;n.setZonePlayer(m);n.setRoomName(k);r=r.renderer;for(var u in r){d.push(u);
n=u.substr(5);var w=r[u],t=b[u];if(t){if(this._zones.dedicatePlayers[n]){var q=this._zones.dedicatePlayers[n];q.setIP(t.ip);q.setPort(t.port)}else q=new xnm.aio.raumfeld.DedicatePlayer(t.ip,t.port,n),this._zones.dedicatePlayers[n]=q;q.setName(w);q.setRoom(h,k)}}}}for(var l in this._zones.zonePlayers)-1==c.indexOf("uuid:"+l)&&delete this._zones.zonePlayers[l];for(l in this._zones.roomPlayers)-1==e.indexOf("uuid:"+l)&&delete this._zones.roomPlayers[l];for(l in this._zones.dedicatePlayers)-1==d.indexOf("uuid:"+
l)&&delete this._zones.dedicatePlayers[l];if(!this._zonePlayer||!this._zones.zonePlayers[this._zonePlayer.getUUID()])for(l in this._zonePlayer=null,this._zones.zonePlayers)if(this._zones.zonePlayers[l]){this._zonePlayer=this._zones.zonePlayers[l];break}};d.prototype._doGetRequest=function(a,b,c,e){var d=this;a="http://"+a+":"+b+c;this._logger.log("trace","send get to url:"+a);var g=e;$.ajax({url:a,type:"GET",timeout:2E3,dataType:"text",cache:!0,success:function(a){d._logger.log("trace","http request success:"+
a);g&&(g(null,a),g=null)},error:function(a,b){a="http request error:"+(a?a.status:"0")+"-"+b;d._logger.log("trace",a);g&&(g(Error(a)),g=null)}})};d.prototype.toJSON=function(){return{sys:"raumfeld",ip:this.getIP(),port:this.getPort(),uuid:this.getUUID(),type:"master",model:"Raumfeld"}};d.prototype.equalsTo=function(a){return a&&a instanceof d?this.getIP()==a.getIP()&&this.getPort()==a.getPort():!1};return d}();
...
break}this._zonePlayer.setVolumeRoom(this.uuid,b,c);break;default:c&&c(Error("unknown command"))}else c&&c(Error("room uuid invalid"));else c&&c(Error("no zone play for this room"))};d.prototype._getStates=function(a){if(this._zonePlayer)if(this.uuid){var b=function(){e--;0==e&&a&&a(null,c)},c={},e=2;this._zonePlayer.isRoomMuted(this.uuid,function(a,e){a||(c.muted=e);b()});this._zonePlayer.getRoomVolume(this.uuid,function(a,e){a||(c.volume=e);b()})}else a&&a(Error("room uuid invalid"));else a&&a(Error("no zone play for this room"))};
...
xnm.aio.raumfeld.Discovery=function(){var d=function(){"undefined"!=typeof require&&require?(this._logger=require("x.logger.js").getLogger("xnm.aio.raumfeld.Discovery"),require("x.logger.js").setLevel("info","xnm.aio.raumfeld.Discovery")):this._logger={log:{}};this._masterPlayer=this._upnpCB=null;this._mediaServer={};this._mediaRenderer={};this._searchRaumfeldCB=[];this._autoSearchTimeout=null;this.searchRaumfeld(null)};d.prototype.getPlayer=function(a){if(!a||!a.type||!a.uuid)return null;if("master"==
a.type){if(!this._masterPlayer){if(!a.ip||!a.port)return null;this._masterPlayer=new xnm.aio.raumfeld.MasterPlayer(a.ip,a.port,a.uuid);this._masterPlayer._isDummy=!0}a=this._masterPlayer}else if("room"==a.type)a=this._masterPlayer.getRoomPlayer(a);else if("player"==a.type)a=this._masterPlayer.getDedicatePlayer(a);else return null;a&&!a._isDummy||this.searchRaumfeld(null);return a};d.prototype.getDiscoveredPlayer=function(a,b){if(!a||!b)return null;if("master"==a)a=this._masterPlayer;else if("room"==
a)a=this._masterPlayer.getDiscoveredRoomPlayer(b);else if("player"==a)a=this._masterPlayer.getDiscoveredDedicatePlayer(b);else return null;a&&!a._isDummy||this.searchRaumfeld(null);return a};d.prototype.getBufferedMediaServers=function(){var a=[],b;for(b in this._mediaServer)if(this._mediaServer.hasOwnProperty(b)){var c=this._mediaServer[b];c.manufacturer&&-1!=c.manufacturer.indexOf("Raumfeld")&&(c._raumfeldMaster=!0);a.push(c)}return a};d.prototype.getBufferedPlayers=function(){if(!this._masterPlayer)return[];
var a=null,b;for(b in this._mediaServer)if(this._mediaServer.hasOwnProperty(b)){var c=this._mediaServer[b];if(c&&c.ip==this._masterPlayer.getIP()){a=c.uuid;break}}if(!a)return[];var d=[];d.push(this._masterPlayer.toJSON());(b=this._masterPlayer.getRoomPlayers())&&b.forEach(function(b){b&&(b=b.toJSON(),b.server_uuid=a,d.push(b))});var f=this;(b=this._masterPlayer.getDedicatePlayers())&&b.forEach(function(b){b=b.toJSON();var c=b.uuid;b.server_uuid=a;if(c=f._mediaRenderer[c])b.model=c.modelName;d.push(b)});
return d};d.prototype.searchRaumfeld=function(a){var b=this._searchRaumfeldCB.length;a&&-1==this._searchRaumfeldCB.indexOf(a)&&this._searchRaumfeldCB.push(a);if(0==b){this._autoSearchTimeout&&(clearTimeout(this._autoSearchTimeout),this._autoSearchTimeout=null);this._search();var c=this;setTimeout(function(){c._autoSearchTimeout=setTimeout(function(){c._logger.log("trace","auto search timeout, search again");c.searchRaumfeld(null)},3E4);var a=c._searchRaumfeldCB;c._searchRaumfeldCB=[];a.forEach(function(a){a&&
