...
b.prototype.sendCommand=function(c,a){var b=this._packetBuffer.length;this._packetBuffer.push({command:c,callback:a});null!=this._session||this._sessionCreating?this._session&&0==b&&this._sendNextPacket():this._createSession()};b.prototype._buildPacket=function(c,a,b){var d=[128,0,0,0,17,255,255,0,255,0,255,255,255,255,255,255,255,255,255,255,0,255];d[5]=a[0];d[6]=a[1];d[8]=b;for(a=0;a<c.length;a++)d[10+a]=c[a];for(b=a=0;b<c.length;b++)a+=c[b];d[21]=a&255;return new Buffer(d)};b.prototype._sendNextPacket=
...
b.prototype.equalsTo=function(a){return a&&a instanceof xnm.aio.rgb.MiLightV6?this.ip==a.ip&&this.port==a.port:!1};b.prototype.toJSON=function(){return{sys:xnm.aio.rgb.MiLightV6.DM.SYS,ip:this.ip,port:this.port,uuid:this.uuid}};b.parseJSON=function(a){if(!a.ip)return null;var c=new b(a.ip,a.port,a.uuid);return(a=d.getBridge(a.ip))?a:c};b.init=function(){d.init()};return b}();
