...
xnm.aio.rgb.Util={rgbToHsv:function(d,a,b){d/=255;a/=255;b/=255;var c=Math.max(d,a,b),e=Math.min(d,a,b),f,h,g=c,k=c-e;h=0==c?0:k/c;if(c==e)f=0;else{switch(c){case d:f=(a-b)/k+(a<b?6:0);break;case a:f=(b-d)/k+2;break;case b:f=(d-a)/k+4}f=Math.round(60*f);h=Math.round(100*h);g=Math.round(100*g)}return[f,h,g]},hsvToMilightColor:function(d){return(432-Math.floor(Number(d[0])/360*255))%256},rgbToHue:function(d,a,b){d=this.rgbToHsv(d,a,b);return(432-Math.floor(Number(d[0])/360*255))%256}};
xnm.aio.rgb.ArtNetNode=function(){var d=[65,114,116,45,78,101,116,0,0,80,0,14,0,0,0,0,0,3],a=function(b,c){this.ip=b;this.port=c;this.port||(this.port=6454)};a.prototype.executeCommandCreator=function(b,c,a){this._executeCommand(c,function(c){a&&a(c)})};a.prototype.equalsTo=function(b){return b&&b instanceof a?this.ip==b.ip&&this.port==b.port:!1};a.prototype.toJSON=function(){return{sys:xnm.aio.rgb.DMX4ALL.DM.SYS,ip:this.ip,port:this.port}};a.prototype._executeCommand=function(b,c){if(b){var a;switch(b.value){case "hex":a=
b.ext;break;default:c&&c(Error("no such command:"+b.value));return}a?(a=this._buildData(a),this._doRequest(a,function(){c&&c()})):c&&c(Error("command is empty"))}else c&&c(Error("command format invalid"))};a.prototype._buildData=function(a){0!=a.length%2&&(a="0"+a);var c=d.slice();c[16]=a.length/2>>8&15;c[17]=a.length/2&15;for(var e=0;e<a.length/2;e++){var f=a.substr(2*e,2);c.push(parseInt(f,16))}return c};a.prototype._doRequest=function(a,c){var e=require("dgram"),f=new Buffer(a),d=e.createSocket("udp4");
...
xnm.aio.rgb.WiFiLED2=function(){var d=function(a,b){var c=require("x.logger.js");this._logger=c?c.getLogger("xnm.aio.rgb.WiFiLED2"):{log:function(){}};this.ip=a;this.port=b;this.port||(this.port=5E4)};d.prototype._doRequest=function(a,b){this._logger.log("trace","send to "+this.ip+" data:"+JSON.stringify(a));var c=require("dgram"),e=new Buffer(a),f=c.createSocket("udp4");f.send(e,0,e.length,this.port,this.ip,function(c){f.close();b&&setTimeout(function(){b(c)},250)})};d.prototype.executeCommand=function(a,
b){var c=[32,0,85];if("on"==a)c[0]=34;else if("off"==a)c[0]=33;else if("up"==a)c[0]=35;else if("down"==a)c[0]=36;else if("modeUp"==a)c[0]=39;else if("modeDown"==a)c[0]=40;else if("speedUp"==a)c[0]=37;else if("speedDown"==a)c[0]=38;else if("allBulbsOn"==a)c[0]=53;else if("allBulbsOff"==a)c[0]=57;else if("bulbUp"==a)c[0]=60;else if("bulbDown"==a)c[0]=52;else if("bulbLightUp"==a)c[0]=62;else if("bulbLightDown"==a)c[0]=63;else if("zone1On"==a)c[0]=56;else if("zone1Off"==a)c[0]=59;else if("zone2On"==a)c[0]=
61;else if("zone2Off"==a)c[0]=51;else if("zone3On"==a)c[0]=55;else if("zone3Off"==a)c[0]=58;else if("zone4On"==a)c[0]=50;else if("zone4Off"==a)c[0]=54;else if(6==a.length){var e=parseInt(a.substr(0,2),16),f=parseInt(a.substr(2,2),16),d=parseInt(a.substr(4,2),16),g=0,k=85,l=d,n=f;d<=e&&d<=f?(l=f,n=e,g=86,k=170):f<=e&&f<=d&&(l=e,n=d,g=171,k=255);g=(255==l?g+n/255*((k-g)/2):k-l/255*((k-g)/2))+10;255<g&&(g-=255);0==e&&0==f&&0==d?c[0]=21:c[1]=g}this._doRequest(c,b)};d.prototype.executeCommandCreator=function(a,
b,c){a=b.value;if("rgb"==a||"rgbS"==a)a=b.ext;this.executeCommand(a,function(){c&&c()})};d.prototype.equalsTo=function(a){return a&&a instanceof xnm.aio.rgb.WiFiLED2?this.ip==a.ip&&this.port==a.port:!1};d.parseJSON=function(a){return a.ip?new d(a.ip,a.port):null};return d}();
...
0,f=0,d=0,g=0,k=100;if(a._stateBuffer[this.ip]){var l=a._stateBuffer[this.ip];null!=l.red&&"undefined"!=typeof l.red&&(e=l.red);null!=l.green&&"undefined"!=typeof l.green&&(f=l.green);null!=l.blue&&"undefined"!=typeof l.blue&&(d=l.blue);null!=l.white&&"undefined"!=typeof l.white&&(g=l.white);null!=l.bri&&"undefined"!=typeof l.bri&&(k=l.bri)}switch(b.value){case "off":g=d=f=e=0;break;case "red":case "green":case "blue":case "white":if(null==b.ext||"undefined"==typeof b.ext){c&&c(Error("command red value invalid"));
return}if("number"==typeof b.ext)switch(b.value){case "red":e=parseInt(b.ext);break;case "green":f=parseInt(b.ext);break;case "blue":d=parseInt(b.ext);break;case "white":g=parseInt(b.ext)}else if(b.ext.match(/^[-+]?[0-9]+$/))switch(b.value){case "red":e=parseInt(b.ext);break;case "green":f=parseInt(b.ext);break;case "blue":d=parseInt(b.ext);break;case "white":g=parseInt(b.ext)}else{c&&c(Error("command red value invalid"));return}break;case "rgb":case "rgbS":if(!b.ext||6>b.ext.length){c&&c(Error("command rgb value invalid"));
return}e=parseInt(b.ext.substr(0,2),16);f=parseInt(b.ext.substr(2,2),16);d=parseInt(b.ext.substr(4,2),16);break;case "rgbw":case "rgbwS":if(!b.ext||8>b.ext.length){c&&c(Error("command rgbw value invalid"));return}e=parseInt(b.ext.substr(0,2),16);f=parseInt(b.ext.substr(2,2),16);d=parseInt(b.ext.substr(4,2),16);g=parseInt(b.ext.substr(6,2),16);break;case "brightness":if(null==b.ext||"undefined"==typeof b.ext){c&&c(Error("command brightness value invalid"));return}if("number"==typeof b.ext)k=parseInt(b.ext);
else if(b.ext.match(/^[-+]?[0-9]+$/))k=parseInt(b.ext);else{c&&c(Error("command brightness value invalid"));return}break;default:c&&c(Error("no such command:"+b.value));return}a._stateBuffer[this.ip]={red:e,green:f,blue:d,white:g,bri:k};e=this._buildColor(e,f,d,g,k/100);this._doRequest(new Buffer(e),function(){c&&c()})}else c&&c(Error("command format invalid"))};a.prototype._buildColor=function(a,c,e,f,h){a=Math.round(a*h);c=Math.round(c*h);e=Math.round(e*h);f=Math.round(f*h);255<a&&(a=255);255<c&&
(c=255);255<e&&(e=255);255<f&&(f=255);h=d.slice();h[17]=4;h[18]=a;h[19]=c;h[20]=e;h.push(f);return h};a.prototype._doRequest=function(a,c){var e=require("dgram").createSocket("udp4");e.send(a,0,a.length,this.port,this.ip,function(a){e.close();c&&c(a)})};a._stateBuffer={};a._discovery=function(b,c){if(!a._logger){var e=require("x.logger.js");a._logger=e?e.getLogger("xnm.aio.rgb.DMX4ALL"):{log:function(){}}}var e=function(c,b){var f=require("dgram"),e=b,d=f.createSocket("udp4");d.on("listening",function(){a._logger.log("trace",
"listener socket started");d.setBroadcast(!0);e&&(e(null,d),e=null)});d.on("message",function(a,b){c(a,b)});d.on("error",function(c){e?(a._logger.log("warn","create listener socket error:"+c),e(c),e=null):a._logger.log("warn","listener socket error:"+c)});d.bind(6454)},f=function(c,b){var f=b,e=require("dgram").createSocket("udp4");e.on("listening",function(){a._logger.log("trace","sender socket started:"+c);e.setBroadcast(!0);f&&(f(null,e),f=null)});e.on("error",function(c){f&&(f(c),f=null)});e.bind(null,
c)},d=function(c){var a=[],b=[],e=require("os");require("dgram");if(e&&e.networkInterfaces){var e=e.networkInterfaces(),d;for(d in e)if(e.hasOwnProperty(d))for(var h=e[d],g=0;g<h.length;g++)"IPv4"==h[g].family&&0==h[g].internal&&a.push(h[g].address)}else a.push("0.0.0.0");var k=0;for(d=0;d<a.length;d++)e=a[d],"0.0.0.0"==e&&(e=null),f(e,function(f,e){k++;!f&&e&&b.push(e);k==a.length&&c&&c(null,b)})},g=function(c,a){if(0==c.length)a();else for(var b=new Buffer([65,114,116,45,78,101,116,0,0,32,0,14,
0,0]),f=0,e=0;e<c.length;e++)c[e].send(b,0,b.length,6454,"255.255.255.255",function(){f++;f==c.length&&a()})};if(c){this._discoveryCallback||(this._discoveryCallback=[]);for(var k=!1,l=0;l<this._discoveryCallback.length;l++)if(this._discoveryCallback[l]===c){k=!0;break}k||this._discoveryCallback.push(c);if(!this._discoverRunning){this._discoverResults={};this._discoverRunning=!0;var n,p,q=this._discoverResults,m=this;e(function(c){c=c.toString("hex");var b=c.substr(0,16);if(16<c.length&&"4172742d4e657400"==
b.toLowerCase()&&(b=c.substr(16,4),20<c.length&&"0021"==b.toLowerCase()&&28<c.length)){var f=parseInt(c.substr(20,2),16)+"."+parseInt(c.substr(22,2),16)+"."+parseInt(c.substr(24,2),16)+"."+parseInt(c.substr(26,2),16),b=c.substr(48,4);52<c.length&&"1a2c"==b.toLowerCase()&&(b=c.substr(52,36),88<c.length&&"4172744e65742d4c45442044696d6d657200"==b.toLowerCase()&&(q[f]=new a(f)))}},function(c,a){if(c){for(var f=0;f<m._discoveryCallback.length;f++)m._discoveryCallback[f](c);m._discoverRunning=!1}else n=
a,d(function(c,a){if(c){for(var f=0;f<m._discoveryCallback.length;f++)m._discoveryCallback[f](c);m._discoverRunning=!1;n.end()}else p=a,g(p,function(){setTimeout(function(){for(var c=0;c<p.length;c++)p[c].close();n.close();for(c=0;c<m._discoveryCallback.length;c++){var a=[],b;for(b in m._discoverResults)m._discoverResults.hasOwnProperty(b)&&a.push(m._discoverResults[b]);m._discoveryCallback[c](null,a)}m._discoverRunning=!1;m._discoveryCallback=[]},b)})})})}}};a.parseJSON=function(b){return b.ip?new a(b.ip,
b.port):null};return a}();
...
xnm.aio.rgb.MiLight=function(){var d=function(a,b,c){var e=require("x.logger.js");this._logger=e?e.getLogger("xnm.aio.rgb.MiLight"):{log:function(){}};this.ip=a;this.port=b;this.port||(this.port=8899);this.uuid=c};d.prototype._doRequest=function(a,b){this._logger.log("trace","send to "+this.ip+" data:"+JSON.stringify(a));var c=require("dgram"),e=new Buffer(a),f=c.createSocket("udp4"),d=this;f.send(e,0,e.length,this.port,this.ip,function(c){c&&d._logger.log("warn","send data error:"+c.message);f.close();
b&&setTimeout(function(){b(c)},250)})};d.prototype.executeCommand=function(a,b,c){if(a&&a.type&&null!=b&&"undefined"!=typeof b)switch(a.type){case "easy_rgbw":case "easy_white":if(null==a.address||"undefined"==typeof a.address){c&&c(Error("address invalid"));break}"easy_rgbw"==a.type?this._execEasyRGBW(a.address,b,c):this._execEasyWhite(a.address,b,c);break;case "rgb":this._execRGB(b,c);break;default:c&&c(Error(a.type+" not supported"))}else c&&c(Error("argument invalid"))};d.prototype.executeCommandCreator=
function(a,b,c){if(a&&a.type&&b){var e=b.value;switch(a.type){case "easy_rgbw":case "easy_white":switch(b.value){case "brightness":case "rgbS":case "rgb":e=b.ext}break;case "rgb":switch(b.value){case "rgbS":case "rgb":e=b.ext}}null==e||"undefined"==typeof e?c&&c(Error("command invalid")):this.executeCommand(a,e,function(a){c&&c(a)})}else c&&c(Error("argument invalid"))};d.prototype._execEasyRGBW=function(a,b,c){var e,f=this;switch(b){case "speedDown":case "speedUp":case "discoMode":case "on":case "off":e=
this._buildEasyRGBWData(a,b);this._doRequest(e,c);break;default:"white"==b||6==b.length||0<=parseInt(b)&&100>=parseInt(b)?(e=this._buildEasyRGBWData(a,"on"),this._doRequest(e,function(d){d?c&&c(d):(e=f._buildEasyRGBWData(a,b),setTimeout(function(){f._doRequest(e,c)},100))})):c&&c(Error("no such command"))}};d.prototype._buildEasyRGBWData=function(a,b){a=parseInt(a);var c=[255,0,85];switch(b){case "speedDown":c[0]=67;break;case "speedUp":c[0]=68;break;case "discoMode":c[0]=77;break;case "on":switch(a){case 0:c[0]=
66;break;case 1:c[0]=69;break;case 2:c[0]=71;break;case 3:c[0]=73;break;case 4:c[0]=75}break;case "off":switch(a){case 0:c[0]=65;break;case 1:c[0]=70;break;case 2:c[0]=72;break;case 3:c[0]=74;break;case 4:c[0]=76}break;case "white":switch(a){case 0:c[0]=194;break;case 1:c[0]=197;break;case 2:c[0]=199;break;case 3:c[0]=201;break;case 4:c[0]=203}break;default:if(6==b.length){var e=parseInt(b.substr(0,2),16),f=parseInt(b.substr(2,2),16),d=parseInt(b.substr(4,2),16),g=0,k=85,l=d,n=f;d<=e&&d<=f?(l=f,n=
e,g=86,k=170):f<=e&&f<=d&&(l=e,n=d,g=171,k=255);g=(255==l?g+n/255*((k-g)/2):k-l/255*((k-g)/2))+10;255<g&&(g-=255);if(0==e&&0==f&&0==d)return this._buildEasyRGBWData(a,"off");c[0]=64;c[1]=g}else if(0<=parseInt(b)&&100>=parseInt(b)){g=Math.round(parseInt(b)/100*26)+1;1>g?g=1:27<g&&(g=27);if(1==g)return this._buildEasyRGBWData(a,"off");c[0]=78;c[1]=g}}return 255==c[0]?null:c};d.prototype._execEasyWhite=function(a,b,c){var e,f=this;switch(b){case "briUp":case "briDown":case "warmUp":case "coolUp":case "on":case "off":e=
this._buildEasyWhiteData(a,b);this._doRequest(e,c);break;case "night":case "fullbri":e="night"==b?this._buildEasyWhiteData(a,"off"):this._buildEasyWhiteData(a,"on");this._doRequest(e,function(d){d?c&&c(d):(e=f._buildEasyWhiteData(a,b),setTimeout(function(){f._doRequest(e,c)},100))});break;default:c&&c(Error("no such command"))}};d.prototype._buildEasyWhiteData=function(a,b){a=parseInt(a);var c=[255,0,85];switch(b){case "briUp":c[0]=60;break;case "briDown":c[0]=52;break;case "warmUp":c[0]=62;break;
...
case 3:c[0]=183;break;case 4:c[0]=178}}return 255==c[0]?null:c};d.prototype._execRGB=function(a,b){var c,e=this;switch(a){case "speedDown":case "speedUp":case "briUp":case "briDown":case "modeUp":case "modeDown":case "on":case "off":c=this._buildRGBData(a);this._doRequest(c,b);break;default:6==a.length?(c=this._buildRGBData("on"),this._doRequest(c,function(f){f?b&&b(f):(c=e._buildRGBData(a),setTimeout(function(){e._doRequest(c,b)},100))})):b&&b(Error("no such command"))}};d.prototype._buildRGBData=
function(a){var b=[255,0,85];switch(a){case "off":b[0]=33;break;case "on":b[0]=34;break;case "briUp":b[0]=35;break;case "briDown":b[0]=36;break;case "speedUp":b[0]=37;break;case "speedDown":b[0]=38;break;case "modeUp":b[0]=39;break;case "modeDown":b[0]=40;break;default:if(6==a.length){var c=parseInt(a.substr(0,2),16),e=parseInt(a.substr(2,2),16);a=parseInt(a.substr(4,2),16);var f=0,d=85,g=a,k=e;a<=c&&a<=e?(g=e,k=c,f=86,d=170):e<=c&&e<=a&&(g=c,k=a,f=171,d=255);f=(255==g?f+k/255*((d-f)/2):d-g/255*((d-
...
xnm.aio.rgb.MiLight.Discovery=function(){var d=function(){var a=require("x.logger.js");this._logger=a?a.getLogger("xnm.aio.rgb.MiLight.Discovery"):{log:function(){}};this._searching=!1;this._tempCallbacks=[];this._callbacks=[];this._controllers={};this._sockets=[];a=require("os");require("dgram");if(a&&a.networkInterfaces){var a=a.networkInterfaces(),b;for(b in a)if(a.hasOwnProperty(b))for(var c=a[b],e=0;e<c.length;e++)this._addDiscoverSocket(48899,c[e])}else this._addDiscoverSocket(48899,null)};
d.prototype.discoverDevices=function(a){this._addCallback(a,this._callbacks);this._sendDiscoveryMessages()};d.prototype.discoverWithTimeout=function(a,b){this._addCallback(b,this._tempCallbacks);this._searching||(this._controllers={},this._searching=!0,this._sendDiscoveryMessages());var c=this;setTimeout(function(){c._removeCallback(b,c._tempCallbacks);var a=[],f;for(f in c._controllers)c._controllers.hasOwnProperty(f)&&c._controllers[f]&&a.push(c._controllers[f]);b(a);0==c._tempCallbacks.length&&
(c._searching=!1)},a)};d.prototype._addCallback=function(a,b){if(a)for(var c=0;c<b.length;c++)if(b[c]===a)return;b.push(a)};d.prototype._removeCallback=function(a,b){if(a){for(var c=-1,e=0;e<b.length;e++)if(b[e]===a){c=e;break}-1!=c&&b.splice(c,1)}};d.prototype._addDiscoverSocket=function(a,b){var c=require("dgram"),e=this,f;try{f=c.createSocket({reuseAddr:!0,type:"udp4"})}catch(d){f=c.createSocket("udp4")}b?"IPv4"==b.family&&0==b.internal&&(f.on("listening",function(){f.setBroadcast(!0)}),f.on("message",
function(c,a){e._receivedData(a.address,c)}),f.on("error",function(c){e._logger.log("warn","milight listener error on address:"+b.address+" mesage:"+(c?c.message:null))}),f.bind(a,b.address),this._logger.log("start listener on address:"+b.address+"-port:"+a),this._sockets.push(f)):(f.on("message",function(c,a){e._receivedData(a.address,c)}),f.on("error",function(c){e._logger.log("warn","milight listener error:"+(c?c.message:null))}),f.bind(a),this._logger.log("debug","start listener on address:[ANY]-port:"+
a),this._sockets.push(f))};d.prototype._receivedData=function(a,b){"object"==typeof b&&(b=b.toString());this._logger.log("trace","receive discovery response:"+b);var c=b.split(",");if(2<=c.length){var e=c[0],f=c[1],c=c[2];if(e&&f)for(e=c?new xnm.aio.rgb.MiLightV6(e,null,f):new xnm.aio.rgb.MiLight(e,null,f),this._controllers[f]=e,f=0;f<this._callbacks.length;f++)if(this._callbacks[f])this._callbacks[f](e)}};d.prototype._sendDiscoveryMessages=function(){for(var a="Link_Wi-Fi",b=0;b<this._sockets.length;b++)this._sockets[b].send(a,
0,a.length,48899,"255.255.255.255");a="HF-A11ASSISTHREAD";for(b=0;b<this._sockets.length;b++)this._sockets[b].send(a,0,a.length,48899,"255.255.255.255")};return d}();
...
xnm.aio.rgb.MiLightV6=function(){var d={bridges:{},socket:null,init:function(){this.socket=new a(this)},receiveData:function(c,a){var b=this.bridges[c];b&&b.receiveData(a)},getBridge:function(c){return this.bridges[c]},setBridge:function(c,a){this.bridges[c]=a},sendPacket:function(c,a,b){this.socket&&this.socket.sendPacket(c,a,b)}},a=function(c){var a=require("x.logger.js");this._logger=a?a.getLogger("xnm.aio.rgb.MiLightV6.UdpSocket"):{log:function(){}};this._listener=c;this._sockets=[];c=require("os");
require("dgram");if(c&&c.networkInterfaces){c=c.networkInterfaces();for(var b in c)if(c.hasOwnProperty(b))for(var a=c[b],d=0;d<a.length;d++)this._addDiscoverSocket(5987,a[d])}else this._addDiscoverSocket(5987,null)};a.prototype._receivedData=function(c,a){a=a.toString("hex");a=new Buffer(a,"hex");this._listener&&this._listener.receiveData(c,a)};a.prototype._addDiscoverSocket=function(c,a){var b=require("dgram"),d=this,g;if(!a){try{g=b.createSocket({reuseAddr:!0,type:"udp4"})}catch(k){g=b.createSocket("udp4")}g.on("message",
function(c,a){d._receivedData(a.address,c)});g.on("error",function(a){d._logger.log("error","udp socket at"+c+" error:"+a.message)});g.bind(c);this._sockets.push(g)}else if("IPv4"==a.family&&0==a.internal){try{g=b.createSocket({reuseAddr:!0,type:"udp4"})}catch(l){g=b.createSocket("udp4")}g.on("listening",function(){g.setBroadcast(!0)});g.on("message",function(c,a){d._receivedData(a.address,c)});g.on("error",function(b){d._logger.log("error","udp socket at"+c+"@"+a.address+" error:"+b.message)});g.bind(c,
a.address);this._sockets.push(g)}};a.prototype.sendPacket=function(c,a,b){for(var d=0;d<this._sockets.length;d++)this._sockets[d].send(c,0,c.length,b,a)};var b=function(c,a,b){var h=require("x.logger.js");this._logger=h?h.getLogger("xnm.aio.rgb.MiLightV6"):{log:function(){}};this.ip=c;this.port=a;this.port||(this.port=5987);this.uuid=b;d.getBridge(c)||d.setBridge(c,this);this._packetBuffer=[];this._sessionCreating=!1;this._session=this._sessionCreateTimeout=null;this._seqNo=-1};b.prototype.executeCommandCreator=
function(c,a,b){if(c&&c.type&&a){var d;switch(c.type){case "wifi_box":d=this._buildWifiBoxCommand(a.value,a.ext);break;case "rgb":d=this._buildRGBCommand(a.value,a.ext);break;case "rgbw":if("undefined"==typeof c.address||null==c.address){b&&b(Error("device has no address"));return}d=this._buildRGBWCommand(c.address,a.value,a.ext);break;case "rgbww_cw":if("undefined"==typeof c.address||null==c.address){b&&b(Error("device has no address"));return}d=this._buildRGBWWCommand(c.address,a.value,a.ext);break;
case "ww_cw":if("undefined"==typeof c.address||null==c.address){b&&b(Error("device has no address"));return}d=this._buildWWCommand(c.address,a.value,a.ext)}d?this.sendCommand(d,function(c){b&&b(c)}):b&&b(Error("command invalid"))}else b&&b(Error("argument invalid"))};b.prototype._buildWifiBoxCommand=function(c,a){var b=[49,0,0,0,255,255,0,0,0,1];switch(c){case "on":b[4]=3;b[5]=3;break;case "off":b[4]=3;b[5]=4;break;case "white":b[4]=3;b[5]=5;break;case "speedUp":b[4]=3;b[5]=2;break;case "speedDown":b[4]=
3;b[5]=1;break;case "mode":if(!b)return null;b[4]=4;b[5]=parseInt(a);break;case "brightness":b[4]=2;b[5]=parseInt(a);break;case "rgb":case "rgbS":if(!a||6>a.length)return null;var d=parseInt(a.substr(0,2),16),g=parseInt(a.substr(2,2),16),k=parseInt(a.substr(4,2),16),d=xnm.aio.rgb.Util.rgbToHue(d,g,k),d=Math.min(Math.max(d,0),255),d=255-d-82;0>d&&(d=255+d);b[4]=1;b[5]=d;b[6]=d;b[7]=d;b[8]=d;break;default:return null}return b};b.prototype._buildRGBWWCommand=function(c,a,b){var d=[49,0,0,8,255,255,0,
...
function(c,a){var b=[49,0,0,5,255,255,0,0,0,1];switch(c){case "on":b[4]=2;b[5]=9;break;case "off":b[4]=2;b[5]=10;break;case "briUp":b[4]=2;b[5]=1;break;case "briDown":b[4]=2;b[5]=2;break;case "speedUp":b[4]=2;b[5]=3;break;case "speedDown":b[4]=2;b[5]=4;break;case "modeUp":b[4]=2;b[5]=5;break;case "modeDown":b[4]=2;b[5]=6;break;case "rgb":case "rgbS":if(!a||6>a.length)return null;var d=parseInt(a.substr(0,2),16),g=parseInt(a.substr(2,2),16),k=parseInt(a.substr(4,2),16),d=xnm.aio.rgb.Util.rgbToHue(d,
g,k),d=Math.min(Math.max(d,0),255),d=255-d-55;0>d&&(d=255+d);b[4]=1;b[5]=d;b[6]=d;b[7]=d;b[8]=d;break;default:return null}return b};b.prototype._buildWWCommand=function(c,b,a){a=[49,0,0,1,255,255,0,0,0,255];a[9]=parseInt(c);switch(b){case "on":a[4]=1;a[5]=7;break;case "off":a[4]=1;a[5]=8;break;case "night":a[4]=1;a[5]=6;break;case "briUp":a[4]=1;a[5]=1;break;case "briDown":a[4]=1;a[5]=2;break;case "briMax":a[4]=129;a[5]=7;break;case "warmer":a[4]=1;a[5]=3;break;case "cooler":a[4]=1;a[5]=4;break;default:return null}return a};
b.prototype.sendCommand=function(a,b){var d=this._packetBuffer.length;this._packetBuffer.push({command:a,callback:b});null!=this._session||this._sessionCreating?this._session&&0==d&&this._sendNextPacket():this._createSession()};b.prototype._buildPacket=function(a,b,d){var h=[128,0,0,0,17,255,255,0,255,0,255,255,255,255,255,255,255,255,255,255,0,255];h[5]=b[0];h[6]=b[1];h[8]=d;for(b=0;b<a.length;b++)h[10+b]=a[b];for(d=b=0;d<a.length;d++)b+=a[d];h[21]=b&255;return new Buffer(h)};b.prototype._sendNextPacket=
function(){if(0<this._packetBuffer.length){var a=this._packetBuffer[0];if(a){if(a.command){var b=this._buildPacket(a.command,this._session,this._seqNo++);d.sendPacket(b,this.ip,this.port)}a.callback&&a.callback()}this._packetBuffer.splice(0,1);this._sendNextPacket()}else this._sessionCreating=!1,this._session=this._sessionCreateTimeout=null,this._seqNo=-1};b.prototype._cancelAllPacket=function(){var a=this._packetBuffer;this._packetBuffer=[];for(var b=0;b<a.length;b++){var d=a[b];d&&d.callback&&d.callback(Error("can not create session"))}};
b.prototype._createSession=function(){if(!this._sessionCreating){this._sessionCreating=!0;var a=this,b=new Buffer([32,0,0,0,22,2,98,58,213,237,163,1,174,8,45,70,97,65,167,246,220,175,211,230,0,0,30]);d.sendPacket(b,this.ip,this.port);setTimeout(function(){a._sessionCreated(!1)},2E3)}};b.prototype._sessionCreated=function(a){a?(this._sessionCreating=!1,this._sessionCreateTimeout&&(clearTimeout(this._sessionCreateTimeout),this._sessionCreateTimeout=null),this._seqNo=0,this._sendNextPacket()):(this._sessionCreating=
!1,this._sessionCreateTimeout&&(clearTimeout(this._sessionCreateTimeout),this._sessionCreateTimeout=null),this._session=null,this._seqNo=-1,this._cancelAllPacket())};b.prototype.receiveData=function(a){this._logger.log("trace","receive data from:"+this.ip);this._logger.log("trace","receive data:"+a.toString("hex"));if(40==a[0]){this._session=[];for(var b=19;21>b;b++)this._session.push(a[b]);this._logger.log("trace","get session id:"+(new Buffer(this._session)).toString("hex"));this._sessionCreated(!0)}};
b.prototype.equalsTo=function(a){return a&&a instanceof xnm.aio.rgb.MiLightV6?this.ip==a.ip&&this.port==a.port:!1};b.prototype.toJSON=function(){return{sys:xnm.aio.rgb.MiLightV6.DM.SYS,ip:this.ip,port:this.port,uuid:this.uuid}};b.parseJSON=function(a){if(!a.ip)return null;var e=new b(a.ip,a.port,a.uuid);return(a=d.getBridge(a.ip))?a:e};b.init=function(){d.init()};return b}();
...
updateGateway:function(d,a,b,c){d=xnm.aio.rgb.DMError;b=xnm.aio.rgb.DMError.ERROR_CODE;a?a.ip?c(null,a):c(new d(b.INVALID,"ip is invalid")):c(new d(b.INVALID,"update is invalid"))},deleteGateway:function(d,a,b){b()},createDevice:function(d,a,b){var c=xnm.aio.rgb.DMError,e=xnm.aio.rgb.DMError.ERROR_CODE;if(d)if(d.gateway)if(null==d.type||"undefined"==typeof d.type)b(new c(e.INVALID,"type is invalid"));else if(a.data&&a.data.gateways&&0!==a.data.gateways.length){a=a.data.gateways;var f,h;for(f=0;f<
a.length;f++)if(a[f].index===d.gateway){h=a[f];break}h?b(null,d):b(new c(e.NOT_FOUND,"gateway with index "+d.gateway+" not exists"))}else b(new c(e.NOT_FOUND,"gateway with index "+d.gateway+" not exists"));else b(new c(e.INVALID,"gateway is invalid"));else b(new c(e.INVALID,"info is invalid"))},updateDevice:function(d,a,b){var c=xnm.aio.rgb.DMError,e=xnm.aio.rgb.DMError.ERROR_CODE;if(d)if(d.gateway)if(null==d.type||"undefined"==typeof d.type)b(new c(e.INVALID,"type is invalid"));else{if("easy_rgbw"==
d.type||"easy_white"==d.type)if(null==d.address||"undefined"==typeof d.address){b(new c(e.INVALID,"address is invalid"));return}if(a.data&&a.data.gateways&&0!==a.data.gateways.length){a=a.data.gateways;var f,h;for(f=0;f<a.length;f++)if(a[f].index===d.gateway){h=a[f];break}h?b(null,d):b(new c(e.NOT_FOUND,"gateway with index "+d.gateway+" not exists"))}else b(new c(e.NOT_FOUND,"gateway with index "+d.gateway+" not exists"))}else b(new c(e.INVALID,"gateway is invalid"));else b(new c(e.INVALID,"info is invalid"))},
deleteDevice:function(d,a,b){b()},getCommandStatusMap:function(d){return d?this.MAP[d.type]:null}}}();
...
a,b):b&&b(new c(e.INVALID,"no such sys:"+d.sys))}else b&&b(new c(e.INVALID,"sys is invalid"));else b&&b(new c(e.INVALID,"info is invalid"))},updateGateway:function(d,a,b,c){var e=xnm.aio.rgb.DMError,f=xnm.aio.rgb.DMError.ERROR_CODE;if(a)if(a.sys){var h=this._getSystem(a.sys);h&&h.DM&&h.DM.updateGateway?h.DM.updateGateway(d,a,b,c):c&&c(new e(f.INVALID,"no such sys:"+a.sys))}else c&&c(new e(f.INVALID,"sys is invalid"));else c(new e(f.INVALID,"info is invalid"))},deleteGateway:function(d,a,b){var c=
...
a.type)&&(a=JSON.parse(JSON.stringify(a)),e.push(a))})}return e},e=function(a,b){var d=[],e=null,f;a.sys&&(e=this._getSystem(a.sys))&&e.DM&&e.DM.getCommandStatusMap&&(f=e.DM.getCommandStatusMap(a));f&&(e=c(f,a,b),d=d.concat(e));return d};if(!d.sys)return null;var f=JSON.parse(JSON.stringify(d)),h=null;switch(a.catagory){case "command":h=e.call(this,d,a);f.command=h;break;case "status":h=e.call(this,d,a);f.status=h;break;default:return null}return h&&0!=h.length?f:null}}}();
...
b){var c=xnm.aio.rgb.DM.applyUIFilter(a,{catagory:"command",elems:"*"}),c=c?c.command:[];b&&b(null,c)};d.prototype.doWifiLED2Command=function(a,b,c){(a=this.resolveDevice(a))?a.executeCommandCreator(null,b,function(a){c&&c(a)}):c&&c(Error("device json format invalid"))};d.prototype.doDMX4ALLCommand=function(a,b,c){(a=this.resolveDevice(a))?a.executeCommandCreator(null,b,function(a){c&&c(a)}):c&&c(Error("device json format invalid"))};d.prototype.discoverDMX4ALLWithTimeout=function(a,b){xnm.aio.rgb.DMX4ALL._discovery(a,
...
b,c,d){(a=this.resolveGateway(a))?a.executeCommandCreator(b,c,function(a){d&&d(a)}):d&&d(Error("gateway json format invalid"))};d.prototype.discoverEasyLEDWithTimeout=function(a,b){this._milightDiscovery.discoverWithTimeout(a,function(a){var d=[];if(a)for(var f=0;f<a.length;f++)a[f]&&d.push(new xnm.aio.rgb.EasyLED(a[f].ip,a[f].port,a[f].uuid));b&&b(null,d)})};return d}();"undefined"!=typeof module&&null!=module&&(module.exports=new xnm.aio.rgb.Handler);
