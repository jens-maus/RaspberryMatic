...
b,c,d){var e=null;if("GET"!==b&&"undefined"!==typeof c.data&&null!==c.data)try{e=JSON.stringify(c.data)}catch(k){xnm.aio.shelly._logger.log("error","[doRequest] Failed to parse body. Error: "+k.message);d&&d(k,null);return}var f=require("http");a=xnm.aio.shelly._buildRequestOptions(a,b,c,e);f=f.request(a,function(a){xnm.aio.shelly._handleResponse(b,c,a,d)});"function"===typeof f.setEncoding&&f.setEncoding("utf8");if("function"===typeof f.on)f.on("error",function(a){a&&xnm.aio.shelly._logger.log("error",
...
xnm.aio.shelly.DM={MAP:{1:{command:[{type:"enum",name:"on",ref:{value:"ch1_on",value_t:"on"}},{type:"enum",name:"off",ref:{value:"ch1_off",value_t:"off"}},{type:"enum",name:"toggle",ref:{value:"ch1_toggle",value_t:"toggle"}}],status:[{type:"enum",name:"state",ref:{value:"ch1_state",value_t:"state",options:["on","off"]}}]},dimmer:{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}},{type:"int",name:"brightness",
...
name:"temperature (Fahrenheit)",ref:{value:"tempF",ext:"%f",unit:"\u00b0F"}}]},em3:{command:[{type:"enum",name:"reset all data",ref:{value:"reset"}},{type:"enum",name:"meter 1: reset totals",ref:{value:"ch1_reset",value_t:"meter1reset"}},{type:"enum",name:"meter 2: reset totals",ref:{value:"ch2_reset",value_t:"meter2reset"}},{type:"enum",name:"meter 3: reset totals",ref:{value:"ch3_reset",value_t:"meter3reset"}}],status:[{type:"float",name:"meter 1: power",ref:{value:"ch1_power",value_t:"meter1power",
ext:"%f",unit:"W"}},{type:"float",name:"meter 1: current",ref:{value:"ch1_current",value_t:"meter1current",ext:"%f",unit:"A"}},{type:"float",name:"meter 1: voltage",ref:{value:"ch1_voltage",value_t:"meter1voltage",ext:"%f",unit:"V"}},{type:"float",name:"meter 1: total",ref:{value:"ch1_total",value_t:"meter1total",ext:"%f",unit:"Wh"}},{type:"float",name:"meter 1: total returned",ref:{value:"ch1_totalReturned",value_t:"meter1totalReturned",ext:"%f",unit:"Wh"}},{type:"float",name:"meter 2: power",ref:{value:"ch2_power",
value_t:"meter2power",ext:"%f",unit:"W"}},{type:"float",name:"meter 2: current",ref:{value:"ch2_current",value_t:"meter2current",ext:"%f",unit:"A"}},{type:"float",name:"meter 2: voltage",ref:{value:"ch2_voltage",value_t:"meter2voltage",ext:"%f",unit:"V"}},{type:"float",name:"meter 2: total",ref:{value:"ch2_total",value_t:"meter2total",ext:"%f",unit:"Wh"}},{type:"float",name:"meter 2: total returned",ref:{value:"ch2_totalReturned",value_t:"meter2totalReturned",ext:"%f",unit:"Wh"}},{type:"float",name:"meter 3: power",
ref:{value:"ch3_power",value_t:"meter3power",ext:"%f",unit:"W"}},{type:"float",name:"meter 3: current",ref:{value:"ch3_current",value_t:"meter3current",ext:"%f",unit:"A"}},{type:"float",name:"meter 3: voltage",ref:{value:"ch3_voltage",value_t:"meter3voltage",ext:"%f",unit:"V"}},{type:"float",name:"meter 3: total",ref:{value:"ch3_total",value_t:"meter3total",ext:"%f",unit:"Wh"}},{type:"float",name:"meter 3: total returned",ref:{value:"ch3_totalReturned",value_t:"meter3totalReturned",ext:"%f",unit:"Wh"}}]},
plug:{command:[{type:"enum",name:"on",ref:{value:"ch1_on",value_t:"on"}},{type:"enum",name:"off",ref:{value:"ch1_off",value_t:"off"}},{type:"enum",name:"toggle",ref:{value:"ch1_toggle",value_t:"toggle"}}],status:[{type:"enum",name:"state",ref:{value:"ch1_state",value_t:"state",options:["on","off"]}},{type:"float",name:"power",ref:{value:"ch1_power",value_t:"power",ext:"%f",unit:"W"}},{type:"float",name:"power total",ref:{value:"ch1_powerTotal",value_t:"powerTotal",ext:"%f",unit:"Wmin"}}]},rgbw2:{command:[{type:"enum",
name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}},{type:"int",name:"color brightness",ref:{value:"gain",value_t:"colorGain",ext:"%d",extMeta:"0-100"}},{type:"rgb",name:"color",ref:{value:"color",ext:"%rgb"}},{type:"rgbw",name:"rgb + white color",ref:{value:"color",ext:"%rgbw"}},{type:"int",name:"red",ref:{value:"red",ext:"%d",extMeta:"0-100"}},{type:"int",name:"green",ref:{value:"green",ext:"%d",extMeta:"0-100"}},{type:"int",name:"blue",
ref:{value:"blue",ext:"%d",extMeta:"0-100"}},{type:"int",name:"white",ref:{value:"white",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"effect",ref:{value:"effect",ext:"%e",extMeta:["off","Meteor shower","Gradual change","Flash","Red/Green change"]}},{type:"enum",name:"white 1: on",ref:{value:"ch1_on",value_t:"white1on"}},{type:"enum",name:"white 2: on",ref:{value:"ch2_on",value_t:"white2on"}},{type:"enum",name:"white 3: on",ref:{value:"ch3_on",value_t:"white3on"}},{type:"enum",name:"white 4: on",
ref:{value:"ch4_on",value_t:"white4on"}},{type:"enum",name:"white 1: off",ref:{value:"ch1_off",value_t:"white1off"}},{type:"enum",name:"white 2: off",ref:{value:"ch2_off",value_t:"white2off"}},{type:"enum",name:"white 3: off",ref:{value:"ch3_off",value_t:"white3off"}},{type:"enum",name:"white 4: off",ref:{value:"ch4_off",value_t:"white4off"}},{type:"int",name:"white 1: brightness",ref:{value:"ch1_brightness",value_t:"white1bri",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 2: brightness",
ref:{value:"ch2_brightness",value_t:"white2bri",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 3: brightness",ref:{value:"ch3_brightness",value_t:"white3bri",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 4: brightness",ref:{value:"ch4_brightness",value_t:"white4bri",ext:"%d",extMeta:"0-100",unit:"%"}}],status:[{type:"enum",name:"mode",ref:{value:"mode",options:["color","white"]}},{type:"enum",name:"state",ref:{value:"state",options:["on","off"]}},{type:"int",name:"color brightness",
ref:{value:"gain",value_t:"colorGain",ext:"%d",extMeta:"0-100"}},{type:"float",name:"power",ref:{value:"power",ext:"%f",unit:"W"}},{type:"rgbw",name:"color",ref:{value:"color",ext:"%s"}},{type:"rgbw",name:"rgb + white color",ref:{value:"color_white",ext:"%s"}},{type:"int",name:"red",ref:{value:"red",ext:"%d",extMeta:"0-100"}},{type:"int",name:"green",ref:{value:"green",ext:"%d",extMeta:"0-100"}},{type:"int",name:"blue",ref:{value:"blue",ext:"%d",extMeta:"0-100"}},{type:"int",name:"white",ref:{value:"white",
ext:"%d",extMeta:"0-100"}},{type:"enum",name:"effect",ref:{value:"effect",options:["off","Meteor shower","Gradual change","Flash","Red/Green change"]}},{type:"enum",name:"white 1: state",ref:{value:"ch1_state",value_t:"white1state",options:["on","off"]}},{type:"enum",name:"white 2: state",ref:{value:"ch2_state",value_t:"white2state",options:["on","off"]}},{type:"enum",name:"white 3: state",ref:{value:"ch3_state",value_t:"white3state",options:["on","off"]}},{type:"enum",name:"white 4: state",ref:{value:"ch4_state",
value_t:"white4state",options:["on","off"]}},{type:"int",name:"white 1: brightness",ref:{value:"ch1_brightness",value_t:"white1bri",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 2: brightness",ref:{value:"ch2_brightness",value_t:"white2bri",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 3: brightness",ref:{value:"ch3_brightness",value_t:"white3bri",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 4: brightness",ref:{value:"ch4_brightness",value_t:"white4bri",extMeta:"0-100",unit:"%"}},
{type:"float",name:"white 1: power",ref:{value:"ch1_power",value_t:"white1power",ext:"%f",unit:"W"}},{type:"float",name:"white 2: power",ref:{value:"ch2_power",value_t:"white2power",ext:"%f",unit:"W"}},{type:"float",name:"white 3: power",ref:{value:"ch3_power",value_t:"white3power",ext:"%f",unit:"W"}},{type:"float",name:"white 4: power",ref:{value:"ch4_power",value_t:"white4power",ext:"%f",unit:"W"}}]},switch:{command:[{type:"enum",name:"switch 1 on",ref:{value:"ch1_on",value_t:"switch1on"}},{type:"enum",
name:"switch 1 off",ref:{value:"ch1_off",value_t:"switch1off"}},{type:"enum",name:"switch 1 toggle",ref:{value:"ch1_toggle",value_t:"switch1toggle"}},{type:"enum",name:"switch 2 on",ref:{value:"ch2_on",value_t:"switch2on"}},{type:"enum",name:"switch 2 off",ref:{value:"ch2_off",value_t:"switch2off"}},{type:"enum",name:"switch 2 toggle",ref:{value:"ch2_toggle",value_t:"switch2toggle"}},{type:"int",name:"shutter position",ref:{value:"position",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"shutter up",
ref:{value:"up",value_t:"moveUp"}},{type:"enum",name:"shutter down",ref:{value:"down",value_t:"moveDown"}},{type:"enum",name:"shutter stop",ref:{value:"stop"}}],status:[{type:"enum",name:"switch 1 state",ref:{value:"ch1_state",value_t:"switch1state",options:["on","off"]}},{type:"enum",name:"switch 2 state",ref:{value:"ch2_state",value_t:"switch2state",options:["on","off"]}},{type:"enum",name:"shutter state",ref:{value:"roller_state",options:["open","closed","middle"]}},{type:"int",name:"shutter position",
ref:{value:"position",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"shutter last direction",ref:{value:"roller_lastDirection",options:["open","closed"]}},{type:"enum",name:"shutter stop reason",ref:{value:"roller_stopReason",options:["normal","safety_switch","obstacle"]}},{type:"float",name:"shutter power",ref:{value:"roller_power",ext:"%f",unit:"W"}},{type:"float",name:"power",ref:{value:"ch1_power",value_t:"power",ext:"%f",unit:"W"}},{type:"float",name:"power total",ref:{value:"ch1_powerTotal",
value_t:"powerTotal",ext:"%f",unit:"Wmin"}}]},switch25:{command:[{type:"enum",name:"switch 1 on",ref:{value:"ch1_on",value_t:"switch1on"}},{type:"enum",name:"switch 1 off",ref:{value:"ch1_off",value_t:"switch1off"}},{type:"enum",name:"switch 1 toggle",ref:{value:"ch1_toggle",value_t:"switch1toggle"}},{type:"enum",name:"switch 2 on",ref:{value:"ch2_on",value_t:"switch2on"}},{type:"enum",name:"switch 2 off",ref:{value:"ch2_off",value_t:"switch2off"}},{type:"enum",name:"switch 2 toggle",ref:{value:"ch2_toggle",
value_t:"switch2toggle"}},{type:"int",name:"shutter position",ref:{value:"position",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"shutter up",ref:{value:"up",value_t:"moveUp"}},{type:"enum",name:"shutter down",ref:{value:"down",value_t:"moveDown"}},{type:"enum",name:"shutter stop",ref:{value:"stop"}}],status:[{type:"enum",name:"switch 1 state",ref:{value:"ch1_state",value_t:"switch1state",options:["on","off"]}},{type:"enum",name:"switch 1 over temperature",ref:{value:"ch1_overTemp",value_t:"switch1overTemp",
options:["true","false"]}},{type:"enum",name:"switch 2 state",ref:{value:"ch2_state",value_t:"switch2state",options:["on","off"]}},{type:"enum",name:"switch 2 over temperature",ref:{value:"ch2_overTemp",value_t:"switch2overTemp",options:["true","false"]}},{type:"enum",name:"shutter state",ref:{value:"roller_state",options:["open","closed","middle"]}},{type:"int",name:"shutter position",ref:{value:"position",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"shutter last direction",ref:{value:"roller_lastDirection",
options:["open","closed"]}},{type:"enum",name:"shutter stop reason",ref:{value:"roller_stopReason",options:["normal","safety_switch","obstacle"]}},{type:"float",name:"shutter power",ref:{value:"roller_power",ext:"%f",unit:"W"}},{type:"enum",name:"shutter over temperature",ref:{value:"roller_overTemp",options:["true","false"]}},{type:"float",name:"meter 1 power",ref:{value:"ch1_power",value_t:"meter1power",ext:"%f",unit:"W"}},{type:"float",name:"meter 1 power total",ref:{value:"ch1_powerTotal",value_t:"meter1powerTotal",
ext:"%f",unit:"Wmin"}},{type:"float",name:"meter 2 power",ref:{value:"ch2_power",value_t:"meter2power",ext:"%f",unit:"W"}},{type:"float",name:"meter 2 power total",ref:{value:"ch2_powerTotal",value_t:"meter2powerTotal",ext:"%f",unit:"Wmin"}},{type:"float",name:"temperature (Celsius)",ref:{value:"tempC",ext:"%f",unit:"\u00b0C"}},{type:"float",name:"temperature (Fahrenheit)",ref:{value:"tempF",ext:"%f",unit:"\u00b0F"}}]}},SYS:"shelly",applyUIFilter:function(a,b,c){if(!a.sys)return null;var d=function(a,
b){if("*"===a||"*"===a[0])return!0;for(var c=0;c<a.length;c++)if(a[c]==b)return!0;return!1},e=function(a,b,c){var e=[];switch(c.catagory){case "command":a.command&&a.command.forEach(function(a){d(c.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),e.push(a))});break;case "status":a.status&&a.status.forEach(function(a){d(c.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),e.push(a))})}return e},f=function(a,b){var d=[],f=xnm.aio.shelly.DM.getCommandStatusMap(a,c);f&&(a=e(f,a,b),d=d.concat(a));return d},
k=JSON.parse(JSON.stringify(a)),g=null;switch(b.catagory){case "command":g=f(a,b);k.command=g;break;case "status":g=f(a,b);k.status=g;break;default:return null}return g&&0!=g.length?k:null},createDevice:function(a,b,c){b=xnm.aio.shelly.DM;a?a.type?a.ip?c(null,a):c(new b.Error(b.Error.ERROR_CODE.INVALID,"IP is missing")):c(new b.Error(b.Error.ERROR_CODE.INVALID,"type is missing")):c(new b.Error(b.Error.ERROR_CODE.INVALID,"info is missing"))},deleteDevice:function(a,b,c){c&&c()},getCommandStatusMap:function(a,
b){if(!a.type)return null;b=xnm.aio.shelly.DM.MAP[a.type]||null;if(!b)return b;b={command:b.command.slice(0),status:b.status.slice(0)};a.type===xnm.aio.shelly.RGBW2.TYPE?"color"===a.mode?(b.command.splice(11,12),b.status.splice(11,12)):"white"===a.mode&&(b.command.splice(0,11),b.status.splice(1,10)):a.type===xnm.aio.shelly.Switch2.TYPE?"roller"===a.mode?(b.command.splice(0,6),b.status.splice(0,2)):"relay"===a.mode&&(b.command.splice(6,4),b.status.splice(2,5)):a.type===xnm.aio.shelly.Switch25.TYPE&&
("roller"===a.mode?(b.command.splice(0,6),b.status.splice(0,4)):"relay"===a.mode&&(b.command.splice(6,4),b.status.splice(4,6)));return b},getIPDeviceType:function(){return[{sys:xnm.aio.shelly.DM.SYS,name:"Shelly"}]},toGeneralDevice:function(a){return(a=xnm.aio.shelly.parseJSON(a))&&"function"===typeof a.toGeneralDevice?a.toGeneralDevice():null},updateDevice:function(a,b,c){b=xnm.aio.shelly.DM;a?a.type?a.ip?c(null,a):c(new b.Error(b.Error.ERROR_CODE.INVALID,"IP is missing")):c(new b.Error(b.Error.ERROR_CODE.INVALID,
"type is missing")):c(new b.Error(b.Error.ERROR_CODE.INVALID,"info is missing"))}};xnm.aio.shelly.DM.MAP["1pm"]={command:xnm.aio.shelly.DM.MAP["1"].command.slice(0),status:xnm.aio.shelly.DM.MAP["1"].status.slice(0)};
...
equalsTo:function(a){return a&&a instanceof xnm.aio.shelly.Device?this.ip===a.ip&&this.id===a.id:!1},executeCommand:function(a,b,c){(a=xnm.aio.shelly.parseJSON(a))?a._executeCommand(b,c):(b=Error("Could not create device from data."),c&&c(b,null))},executeCommandCreator:function(a,b,c){b&&b.value?this.executeCommand(a,b,function(a){c&&c(a)}):c&&c(Error("Command value is empty."))},getState:function(a){xnm.aio.shelly._logger.log("trace","[Device.getState] Sending request.");xnm.aio.shelly.doRequest(this,
"GET",{path:"status"},function(b,c){b?a&&a(b,null):a&&a(null,c.response)})},getStatesCreator:function(a,b,c){var d=this;this.getState(function(a,f){if(f){a=[];for(var e=0;e<b.length;e++){var g=b[e];if(g&&g.id&&g.status){var h=d._getStateFromResult(f,g.status.value);null!==h&&a.push({id:g.id,status:h})}}c&&c(null,a)}else c&&c(Error("Failed to get states."))})},toJSON:function(){return{sys:xnm.aio.shelly.DM.SYS,type:this.type,ip:this.ip,id:this.id,firmware:this.firmware}}};
...
xnm.aio.shelly.GenericSwitch.prototype.cmdMoveUp=function(a){xnm.aio.shelly._logger.log("trace","[GenericSwitch.cmdMoveUp] Sending request.");xnm.aio.shelly.doRequest(this,"GET",{path:"roller/0?go=open"},function(b,c){a&&a(b,c)})};xnm.aio.shelly.GenericSwitch.prototype.cmdOff=function(a,b){a={path:"relay/"+a+"?turn=off"};xnm.aio.shelly._logger.log("trace","[GenericSwitch.cmdOff] Sending request.");xnm.aio.shelly.doRequest(this,"GET",a,function(a,d){b&&b(a,d)})};
xnm.aio.shelly.GenericSwitch.prototype.cmdOn=function(a,b){a={path:"relay/"+a+"?turn=on"};xnm.aio.shelly._logger.log("trace","[GenericSwitch.cmdOn] Sending request.");xnm.aio.shelly.doRequest(this,"GET",a,function(a,d){b&&b(a,d)})};
xnm.aio.shelly.GenericSwitch.prototype.cmdSetPosition=function(a,b){"number"!==typeof a||isNaN(a)||0>a||100<a?(a=Error("Invalid value for position: "+a),xnm.aio.shelly._logger.log("error","[GenericSwitch.cmdSetPosition] "+a.message),b&&b(a,null)):(a={path:"roller/0?go=to_pos&roller_pos="+Math.round(100-a)},xnm.aio.shelly._logger.log("trace","[GenericSwitch.cmdSetPosition] Sending request."),xnm.aio.shelly.doRequest(this,"GET",a,function(a,d){b&&b(a,d)}))};
xnm.aio.shelly.GenericSwitch.prototype.cmdToggle=function(a,b){a={path:"relay/"+a+"?turn=toggle"};xnm.aio.shelly._logger.log("trace","[GenericSwitch.cmdToggle] Sending request.");xnm.aio.shelly.doRequest(this,"GET",a,function(a,d){b&&b(a,d)})};xnm.aio.shelly.Switch1=function(a,b){xnm.aio.shelly.GenericSwitch.call(this,a,b);this.type=xnm.aio.shelly.Switch1.TYPE};xnm.aio.shelly.Switch1.TYPE="1";xnm.aio.shelly.Switch1.prototype=Object.create(xnm.aio.shelly.GenericSwitch.prototype);
xnm.aio.shelly.Switch1.constructor=xnm.aio.shelly.Switch1;xnm.aio.shelly.Switch1.prototype.toGeneralDevice=function(){return{type:"switch",commands:{on:{},off:{},toggle:{}},states:{state:{values:["on","off"]}},details:{commands:{on:{value:"ch1_on"},off:{value:"ch1_off"},toggle:{value:"ch1_toggle"}},states:{state:{value:"ch1_state"}}}}};xnm.aio.shelly.Switch1PM=function(a,b){xnm.aio.shelly.Switch1.call(this,a,b);this.type=xnm.aio.shelly.Switch1PM.TYPE};xnm.aio.shelly.Switch1PM.TYPE="1pm";
xnm.aio.shelly.Switch1PM.prototype=Object.create(xnm.aio.shelly.Switch1.prototype);xnm.aio.shelly.Switch1PM.constructor=xnm.aio.shelly.Switch1PM;
...
c.brightness:0;case "temp":return c.temp;case "mode":return c.mode;case "state":return c.ison?"on":"off"}}return xnm.aio.shelly.Device.prototype._getStateFromResult.call(this,a,b)};xnm.aio.shelly.GenericLight.prototype.cmdOff=function(a){var b={path:"light/0?turn=off"};this instanceof xnm.aio.shelly.RGBW2&&(b.path="color/0?turn=off");xnm.aio.shelly._logger.log("trace","[GenericLight.cmdOff] Sending request.");xnm.aio.shelly.doRequest(this,"GET",b,function(b,d){a&&a(b,d)})};
xnm.aio.shelly.GenericLight.prototype.cmdOn=function(a){var b={path:"light/0?turn=on"};this instanceof xnm.aio.shelly.RGBW2&&(b.path="color/0?turn=on");xnm.aio.shelly._logger.log("trace","[GenericLight.cmdOn] Sending request.");xnm.aio.shelly.doRequest(this,"GET",b,function(b,d){a&&a(b,d)})};
...
xnm.aio.shelly.doRequest(this,"GET",c,function(a,c){b&&b(a,c)})}};
...
c};xnm.aio.shelly._logger.log("trace","[GenericLight.cmdSetColor] Sending request.");xnm.aio.shelly.doRequest(this,"GET",a,function(a,c){b&&b(a,c)})}};
xnm.aio.shelly.GenericLight.prototype.cmdSetEffect=function(a,b){"string"===typeof a&&"function"===typeof this.getEffectIndex&&(a=this.getEffectIndex(a));"number"!==typeof a||0>a?(a=Error("Invalid value for effect: "+a),xnm.aio.shelly._logger.log("error","[GenericLight.cmdSetEffect] "+a.message),b&&b(a,null)):(a={path:"color/0?turn=on&mode=color&effect="+a},xnm.aio.shelly._logger.log("trace","[GenericLight.cmdSetEffect] Sending request."),xnm.aio.shelly.doRequest(this,"GET",a,function(a,d){b&&b(a,
d)}))};
...
"[GenericLight.cmdSetSingleColor] Sending request."),xnm.aio.shelly.doRequest(this,"GET",a,function(a,b){c&&c(a,b)}))};
xnm.aio.shelly.GenericLight.prototype.cmdSetGain=function(a,b){"number"!==typeof a||isNaN(a)||0>a||100<a?(a=Error("Invalid value for gain: "+a),xnm.aio.shelly._logger.log("error","[GenericLight.cmdSetGain] "+a.message),b&&b(a,null)):(a={path:"color/0?turn=on&mode=color&gain="+a},xnm.aio.shelly._logger.log("trace","[GenericLight.cmdSetGain] Sending request."),xnm.aio.shelly.doRequest(this,"GET",a,function(a,d){b&&b(a,d)}))};
xnm.aio.shelly.GenericLight.prototype.cmdSetMode=function(a,b){if(0>["color","white"].indexOf(a))a=Error("Invalid value for mode: "+a),xnm.aio.shelly._logger.log("error","[GenericLight.cmdSetMode] "+a.message),b&&b(a,null);else{var c={};c.path=this instanceof xnm.aio.shelly.RGBW2?"settings/?mode="+a:"light/0?turn=on&mode="+a;xnm.aio.shelly._logger.log("trace","[GenericLight.cmdSetMode] Sending request.");xnm.aio.shelly.doRequest(this,"GET",c,function(a,c){b&&b(a,c)})}};
xnm.aio.shelly.GenericLight.prototype.cmdToggle=function(a){var b={path:"light/0?turn=toggle"};this instanceof xnm.aio.shelly.RGBW2&&(b.path="color/0?turn=toggle");xnm.aio.shelly._logger.log("trace","[GenericLight.cmdToggle] Sending request.");xnm.aio.shelly.doRequest(this,"GET",b,function(b,d){a&&a(b,d)})};xnm.aio.shelly.Dimmer=function(a,b){xnm.aio.shelly.GenericLight.call(this,a,b);this.type=xnm.aio.shelly.Dimmer.TYPE};xnm.aio.shelly.Dimmer.TYPE="dimmer";xnm.aio.shelly.Dimmer.prototype=Object.create(xnm.aio.shelly.GenericLight.prototype);
...
xnm.aio.shelly.RGBW2.prototype.cmdSetWhiteBrightness=function(a,b,c){"number"!==typeof b||isNaN(b)||0>b||100<b?(a=Error("Invalid value for brightness: "+b),xnm.aio.shelly._logger.log("error","[RGBW2.cmdSetWhiteBrightness] "+a.message),c&&c(a,null)):(a={path:"white/"+a+"?turn=on&brightness="+b},xnm.aio.shelly._logger.log("trace","[RGBW2.cmdSetWhiteBrightness] Sending request."),xnm.aio.shelly.doRequest(this,"GET",a,function(a,b){c&&c(a,b)}))};
xnm.aio.shelly.RGBW2.prototype.cmdWhiteOff=function(a,b){a={path:"white/"+a+"?turn=off"};xnm.aio.shelly._logger.log("trace","[RGBW2.cmdWhiteOff] Sending request.");xnm.aio.shelly.doRequest(this,"GET",a,function(a,d){b&&b(a,d)})};xnm.aio.shelly.RGBW2.prototype.cmdWhiteOn=function(a,b){a={path:"white/"+a+"?turn=on"};xnm.aio.shelly._logger.log("trace","[RGBW2.cmdWhiteOn] Sending request.");xnm.aio.shelly.doRequest(this,"GET",a,function(a,d){b&&b(a,d)})};
xnm.aio.shelly.RGBW2.prototype.cmdWhiteToggle=function(a,b){a={path:"white/"+a+"?turn=toggle"};xnm.aio.shelly._logger.log("trace","[RGBW2.cmdWhiteToggle] Sending request.");xnm.aio.shelly.doRequest(this,"GET",a,function(a,d){b&&b(a,d)})};xnm.aio.shelly.RGBW2.prototype.getEffectIndex=function(a){a=String(a).toLowerCase();for(var b=xnm.aio.shelly.RGBW2.EFFECTS,c=0;c<b.length;c++)if(b[c].toLowerCase()===a)return c;return 0};
...
xnm.aio.shelly.Handler.prototype={devicemanager:xnm.aio.shelly.DM,discoverWithTimeout:function(a,b){var c=require("x.mdns.js");c.clearRecordBuffer();if("number"!==typeof a||isNaN(a))a=1E4;c.discoverServiceWithTimeout("_http._tcp.local",a,function(a,c){if(a)b&&b(a,null);else{for(var d=[],e=0;e<c.length;e++){var g=c[e];if(0===String(g.target).indexOf("shelly")&&g.ip&&0<g.ip.length&&g.info){var h=String(g.info.id).substring(6);h=h.split("-");h.splice(h.length-1,1);h=h.join("-");d.push({firmware:g.info.fw_id,
id:g.info.id,ip:g.ip[0],port:80,sys:xnm.aio.shelly.DM.SYS,type:h})}}b&&b(a,d)}})},doCommand:function(a,b,c){var d=this.resolveDevice(a);d?d.executeCommandCreator(a,b,function(a){c&&c(a)}):c&&c(Error("device format invalid"))},doStatus:function(a,b,c,d){(b=this.resolveDevice(b))?b.getStatesCreator(null,[{id:a,status:c}],function(a,b){a?d&&d(a):d&&d(null,b[0])}):d&&d(Error("device format invalid"))},getDeviceCommands:function(a,b){a=(a=xnm.aio.shelly.DM.applyUIFilter(a,{catagory:"command",elems:"*"}))?
