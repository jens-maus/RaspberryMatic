...
b,c,d){var e=null;c.path&&xnm.aio.shelly._logger.log("trace","[doRequest] Request path: "+c.path);if("GET"!==b&&"undefined"!==typeof c.data&&null!==c.data)try{e=JSON.stringify(c.data)}catch(h){xnm.aio.shelly._logger.log("error","[doRequest] Failed to parse body. Error: "+h.message);d&&d(h,null);return}var f=require("http");a=xnm.aio.shelly._buildRequestOptions(a,b,c,e);f=f.request(a,function(h){xnm.aio.shelly._handleResponse(b,c,h,d)});"function"===typeof f.setEncoding&&f.setEncoding("utf8");if("function"===
typeof f.on)f.on("error",function(h){h&&xnm.aio.shelly._logger.log("error","[doRequest] Error: "+h.message);d&&d(h);d=null});"number"!==typeof c.timeout||isNaN(c.timeout)||"function"!==typeof f.setTimeout||f.setTimeout(c.timeout);e&&f.write(e);f.end()},parseJSON:function(a){if(!a||!a.ip)return xnm.aio.shelly._logger.log("warn","[parseJSON] Missing IP."),null;var b=xnm.aio.shelly;switch(a.type){case b.Bulb.TYPE:return new b.Bulb(a.ip,a);case b.Dimmer.TYPE:return new b.Dimmer(a.ip,a);case b.EM3.TYPE:return new b.EM3(a.ip,
a);case b.Flood.TYPE:return new b.Flood(a.ip,a);case b.HT.TYPE:return new b.HT(a.ip,a);case b.Plug.TYPE:return new b.Plug(a.ip,a);case b.PlugS.TYPE:return new b.PlugS(a.ip,a);case b.RGBW2.TYPE:return new b.RGBW2(a.ip,a);case b.Switch1.TYPE:return new b.Switch1(a.ip,a);case b.Switch1PM.TYPE:return new b.Switch1PM(a.ip,a);case b.Switch2.TYPE:return new b.Switch2(a.ip,a);case b.Switch25.TYPE:return new b.Switch25(a.ip,a)}return new b.Device(a.ip,a)}};
...
ext:"%f",unit:"%"}}]},bulb:{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}},{type:"int",name:"color brightness",ref:{value:"gain",value_t:"colorGain",ext:"%d",extMeta:"0-100"}},{type:"rgb",name:"color",ref:{value:"color",ext:"%rgb"}},{type:"rgbw",name:"rgb + white color",ref:{value:"color_white",ext:"%rgbw"}},{type:"int",name:"red",ref:{value:"red",ext:"%d",extMeta:"0-100"}},{type:"int",name:"green",ref:{value:"green",
ext:"%d",extMeta:"0-100"}},{type:"int",name:"blue",ref:{value:"blue",ext:"%d",extMeta:"0-100"}},{type:"int",name:"white",ref:{value:"white",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"effect",ref:{value:"effect",ext:"%e",extMeta:"off;Meteor shower;Gradual change;Flash;Breath;On/Off gradual;Red/Green change".split(";")}},{type:"int",name:"white: brightness",ref:{value:"ch1_brightness",value_t:"white1bri",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"color temperature",ref:{value:"temp",value_t:"ct",
ext:"%d",extMeta:"3000-6500",unit:"K"}}],status:[{type:"enum",name:"mode",ref:{value:"mode",options:["color","white"]}},{type:"float",name:"power",ref:{value:"ch1_power",value_t:"power",ext:"%f",unit:"W"}},{type:"enum",name:"state",ref:{value:"state",options:["on","off"]}},{type:"int",name:"color brightness",ref:{value:"gain",value_t:"colorGain",ext:"%d",extMeta:"0-100"}},{type:"float",name:"power",ref:{value:"power",ext:"%f",unit:"W"}},{type:"rgbw",name:"color",ref:{value:"color",ext:"%s"}},{type:"rgbw",
name:"rgb + white color",ref:{value:"color_white",ext:"%s"}},{type:"int",name:"red",ref:{value:"red",ext:"%d",extMeta:"0-100"}},{type:"int",name:"green",ref:{value:"green",ext:"%d",extMeta:"0-100"}},{type:"int",name:"blue",ref:{value:"blue",ext:"%d",extMeta:"0-100"}},{type:"int",name:"white",ref:{value:"white",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"effect",ref:{value:"effect",options:"off;Meteor shower;Gradual change;Flash;Breath;On/Off gradual;Red/Green change".split(";")}},{type:"int",name:"white: brightness",
ref:{value:"ch1_brightness",value_t:"white1bri",extMeta:"0-100",unit:"%"}},{type:"int",name:"color temperature",ref:{value:"temp",value_t:"ct",extMeta:"3000-6500",unit:"K"}}]},dimmer:{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}},{type:"int",name:"brightness",ref:{value:"brightness",ext:"%d",extMeta:"0-100",unit:"%"}}],status:[{type:"enum",name:"state",ref:{value:"state",options:["on","off"]}},{type:"int",
name:"brightness",ref:{value:"brightness",extMeta:"0-100",unit:"%"}},{type:"float",name:"power",ref:{value:"ch1_power",value_t:"power",ext:"%f",unit:"W"}},{type:"float",name:"power total",ref:{value:"ch1_powerTotal",value_t:"powerTotal",ext:"%f",unit:"Wmin"}},{type:"float",name:"temperature (Celsius)",ref:{value:"tempC",ext:"%f",unit:"\u00b0C"}},{type:"float",name:"temperature (Fahrenheit)",ref:{value:"tempF",ext:"%f",unit:"\u00b0F"}}]},em3:{command:[{type:"enum",name:"reset all data",ref:{value:"reset"}},
{type:"enum",name:"meter 1: reset totals",ref:{value:"ch1_reset",value_t:"meter1reset"}},{type:"enum",name:"meter 2: reset totals",ref:{value:"ch2_reset",value_t:"meter2reset"}},{type:"enum",name:"meter 3: reset totals",ref:{value:"ch3_reset",value_t:"meter3reset"}}],status:[{type:"float",name:"meter 1: power",ref:{value:"ch1_power",value_t:"meter1power",ext:"%f",unit:"W"}},{type:"float",name:"meter 1: current",ref:{value:"ch1_current",value_t:"meter1current",ext:"%f",unit:"A"}},{type:"float",name:"meter 1: voltage",
ref:{value:"ch1_voltage",value_t:"meter1voltage",ext:"%f",unit:"V"}},{type:"float",name:"meter 1: total",ref:{value:"ch1_total",value_t:"meter1total",ext:"%f",unit:"Wh"}},{type:"float",name:"meter 1: total returned",ref:{value:"ch1_totalReturned",value_t:"meter1totalReturned",ext:"%f",unit:"Wh"}},{type:"float",name:"meter 2: power",ref:{value:"ch2_power",value_t:"meter2power",ext:"%f",unit:"W"}},{type:"float",name:"meter 2: current",ref:{value:"ch2_current",value_t:"meter2current",ext:"%f",unit:"A"}},
{type:"float",name:"meter 2: voltage",ref:{value:"ch2_voltage",value_t:"meter2voltage",ext:"%f",unit:"V"}},{type:"float",name:"meter 2: total",ref:{value:"ch2_total",value_t:"meter2total",ext:"%f",unit:"Wh"}},{type:"float",name:"meter 2: total returned",ref:{value:"ch2_totalReturned",value_t:"meter2totalReturned",ext:"%f",unit:"Wh"}},{type:"float",name:"meter 3: power",ref:{value:"ch3_power",value_t:"meter3power",ext:"%f",unit:"W"}},{type:"float",name:"meter 3: current",ref:{value:"ch3_current",value_t:"meter3current",
ext:"%f",unit:"A"}},{type:"float",name:"meter 3: voltage",ref:{value:"ch3_voltage",value_t:"meter3voltage",ext:"%f",unit:"V"}},{type:"float",name:"meter 3: total",ref:{value:"ch3_total",value_t:"meter3total",ext:"%f",unit:"Wh"}},{type:"float",name:"meter 3: total returned",ref:{value:"ch3_totalReturned",value_t:"meter3totalReturned",ext:"%f",unit:"Wh"}}]},flood:{command:[],status:[{type:"enum",name:"flood detected",ref:{value:"flood",options:["true","false"]}},{type:"enum",name:"rain mode",ref:{value:"rainMode",
options:["true","false"]}},{type:"string",name:"device activation reasons",ref:{value:"actReasons",ext:"%s"}},{type:"float",name:"temperature (Celsius)",ref:{value:"tempC",ext:"%f",unit:"\u00b0C"}},{type:"float",name:"temperature (Fahrenheit)",ref:{value:"tempF",ext:"%f",unit:"\u00b0F"}},{type:"int",name:"battery capacity",ref:{value:"batCapacity",value_t:"battery_level",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"float",name:"battery voltage",ref:{value:"batVoltage",ext:"%f",unit:"V"}}]},ht:{command:[],
status:[{type:"int",name:"relative humidity",ref:{value:"humRel",ext:"%d",unit:"%"}},{type:"string",name:"device activation reasons",ref:{value:"actReasons",ext:"%s"}},{type:"float",name:"temperature (Celsius)",ref:{value:"tempC",ext:"%f",unit:"\u00b0C"}},{type:"float",name:"temperature (Fahrenheit)",ref:{value:"tempF",ext:"%f",unit:"\u00b0F"}},{type:"int",name:"battery capacity",ref:{value:"batCapacity",value_t:"battery_level",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"float",name:"battery voltage",
ref:{value:"batVoltage",ext:"%f",unit:"V"}}]},plug:{command:[{type:"enum",name:"on",ref:{value:"ch1_on",value_t:"on"}},{type:"enum",name:"off",ref:{value:"ch1_off",value_t:"off"}},{type:"enum",name:"toggle",ref:{value:"ch1_toggle",value_t:"toggle"}}],status:[{type:"enum",name:"state",ref:{value:"ch1_state",value_t:"state",options:["on","off"]}},{type:"float",name:"power",ref:{value:"ch1_power",value_t:"power",ext:"%f",unit:"W"}},{type:"float",name:"power total",ref:{value:"ch1_powerTotal",value_t:"powerTotal",
ext:"%f",unit:"Wmin"}}]},rgbw2:{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}},{type:"int",name:"color brightness",ref:{value:"gain",value_t:"colorGain",ext:"%d",extMeta:"0-100"}},{type:"rgb",name:"color",ref:{value:"color",ext:"%rgb"}},{type:"rgbw",name:"rgb + white color",ref:{value:"color_white",ext:"%rgbw"}},{type:"int",name:"red",ref:{value:"red",ext:"%d",extMeta:"0-100"}},{type:"int",name:"green",
ref:{value:"green",ext:"%d",extMeta:"0-100"}},{type:"int",name:"blue",ref:{value:"blue",ext:"%d",extMeta:"0-100"}},{type:"int",name:"white",ref:{value:"white",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"effect",ref:{value:"effect",ext:"%e",extMeta:["off","Meteor shower","Gradual change","Flash","Red/Green change"]}},{type:"enum",name:"white 1: on",ref:{value:"ch1_on",value_t:"white1on"}},{type:"enum",name:"white 2: on",ref:{value:"ch2_on",value_t:"white2on"}},{type:"enum",name:"white 3: on",ref:{value:"ch3_on",
value_t:"white3on"}},{type:"enum",name:"white 4: on",ref:{value:"ch4_on",value_t:"white4on"}},{type:"enum",name:"white 1: off",ref:{value:"ch1_off",value_t:"white1off"}},{type:"enum",name:"white 2: off",ref:{value:"ch2_off",value_t:"white2off"}},{type:"enum",name:"white 3: off",ref:{value:"ch3_off",value_t:"white3off"}},{type:"enum",name:"white 4: off",ref:{value:"ch4_off",value_t:"white4off"}},{type:"int",name:"white 1: brightness",ref:{value:"ch1_brightness",value_t:"white1bri",ext:"%d",extMeta:"0-100",
unit:"%"}},{type:"int",name:"white 2: brightness",ref:{value:"ch2_brightness",value_t:"white2bri",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 3: brightness",ref:{value:"ch3_brightness",value_t:"white3bri",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 4: brightness",ref:{value:"ch4_brightness",value_t:"white4bri",ext:"%d",extMeta:"0-100",unit:"%"}}],status:[{type:"enum",name:"mode",ref:{value:"mode",options:["color","white"]}},{type:"enum",name:"state",ref:{value:"state",
options:["on","off"]}},{type:"int",name:"color brightness",ref:{value:"gain",value_t:"colorGain",ext:"%d",extMeta:"0-100"}},{type:"float",name:"power",ref:{value:"power",ext:"%f",unit:"W"}},{type:"rgbw",name:"color",ref:{value:"color",ext:"%s"}},{type:"rgbw",name:"rgb + white color",ref:{value:"color_white",ext:"%s"}},{type:"int",name:"red",ref:{value:"red",ext:"%d",extMeta:"0-100"}},{type:"int",name:"green",ref:{value:"green",ext:"%d",extMeta:"0-100"}},{type:"int",name:"blue",ref:{value:"blue",ext:"%d",
extMeta:"0-100"}},{type:"int",name:"white",ref:{value:"white",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"effect",ref:{value:"effect",options:["off","Meteor shower","Gradual change","Flash","Red/Green change"]}},{type:"enum",name:"white 1: state",ref:{value:"ch1_state",value_t:"white1state",options:["on","off"]}},{type:"enum",name:"white 2: state",ref:{value:"ch2_state",value_t:"white2state",options:["on","off"]}},{type:"enum",name:"white 3: state",ref:{value:"ch3_state",value_t:"white3state",options:["on",
"off"]}},{type:"enum",name:"white 4: state",ref:{value:"ch4_state",value_t:"white4state",options:["on","off"]}},{type:"int",name:"white 1: brightness",ref:{value:"ch1_brightness",value_t:"white1bri",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 2: brightness",ref:{value:"ch2_brightness",value_t:"white2bri",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 3: brightness",ref:{value:"ch3_brightness",value_t:"white3bri",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 4: brightness",ref:{value:"ch4_brightness",
value_t:"white4bri",extMeta:"0-100",unit:"%"}},{type:"float",name:"white 1: power",ref:{value:"ch1_power",value_t:"white1power",ext:"%f",unit:"W"}},{type:"float",name:"white 2: power",ref:{value:"ch2_power",value_t:"white2power",ext:"%f",unit:"W"}},{type:"float",name:"white 3: power",ref:{value:"ch3_power",value_t:"white3power",ext:"%f",unit:"W"}},{type:"float",name:"white 4: power",ref:{value:"ch4_power",value_t:"white4power",ext:"%f",unit:"W"}}]},switch:{command:[{type:"enum",name:"switch 1 on",
ref:{value:"ch1_on",value_t:"switch1on"}},{type:"enum",name:"switch 1 off",ref:{value:"ch1_off",value_t:"switch1off"}},{type:"enum",name:"switch 1 toggle",ref:{value:"ch1_toggle",value_t:"switch1toggle"}},{type:"enum",name:"switch 2 on",ref:{value:"ch2_on",value_t:"switch2on"}},{type:"enum",name:"switch 2 off",ref:{value:"ch2_off",value_t:"switch2off"}},{type:"enum",name:"switch 2 toggle",ref:{value:"ch2_toggle",value_t:"switch2toggle"}},{type:"int",name:"shutter position",ref:{value:"position",ext:"%d",
extMeta:"0-100"}},{type:"enum",name:"shutter up",ref:{value:"up",value_t:"moveUp"}},{type:"enum",name:"shutter down",ref:{value:"down",value_t:"moveDown"}},{type:"enum",name:"shutter stop",ref:{value:"stop"}}],status:[{type:"enum",name:"switch 1 state",ref:{value:"ch1_state",value_t:"switch1state",options:["on","off"]}},{type:"enum",name:"switch 2 state",ref:{value:"ch2_state",value_t:"switch2state",options:["on","off"]}},{type:"enum",name:"shutter state",ref:{value:"roller_state",options:["open",
"closed","middle"]}},{type:"int",name:"shutter position",ref:{value:"position",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"shutter last direction",ref:{value:"roller_lastDirection",options:["open","closed"]}},{type:"enum",name:"shutter stop reason",ref:{value:"roller_stopReason",options:["normal","safety_switch","obstacle"]}},{type:"float",name:"shutter power",ref:{value:"roller_power",ext:"%f",unit:"W"}},{type:"float",name:"power",ref:{value:"ch1_power",value_t:"power",ext:"%f",unit:"W"}},{type:"float",
name:"power total",ref:{value:"ch1_powerTotal",value_t:"powerTotal",ext:"%f",unit:"Wmin"}}]},switch25:{command:[{type:"enum",name:"switch 1 on",ref:{value:"ch1_on",value_t:"switch1on"}},{type:"enum",name:"switch 1 off",ref:{value:"ch1_off",value_t:"switch1off"}},{type:"enum",name:"switch 1 toggle",ref:{value:"ch1_toggle",value_t:"switch1toggle"}},{type:"enum",name:"switch 2 on",ref:{value:"ch2_on",value_t:"switch2on"}},{type:"enum",name:"switch 2 off",ref:{value:"ch2_off",value_t:"switch2off"}},{type:"enum",
name:"switch 2 toggle",ref:{value:"ch2_toggle",value_t:"switch2toggle"}},{type:"int",name:"shutter position",ref:{value:"position",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"shutter up",ref:{value:"up",value_t:"moveUp"}},{type:"enum",name:"shutter down",ref:{value:"down",value_t:"moveDown"}},{type:"enum",name:"shutter stop",ref:{value:"stop"}}],status:[{type:"enum",name:"switch 1 state",ref:{value:"ch1_state",value_t:"switch1state",options:["on","off"]}},{type:"enum",name:"switch 1 over temperature",
ref:{value:"ch1_overTemp",value_t:"switch1overTemp",options:["true","false"]}},{type:"enum",name:"switch 2 state",ref:{value:"ch2_state",value_t:"switch2state",options:["on","off"]}},{type:"enum",name:"switch 2 over temperature",ref:{value:"ch2_overTemp",value_t:"switch2overTemp",options:["true","false"]}},{type:"enum",name:"shutter state",ref:{value:"roller_state",options:["open","closed","middle"]}},{type:"int",name:"shutter position",ref:{value:"position",ext:"%d",extMeta:"0-100"}},{type:"enum",
name:"shutter last direction",ref:{value:"roller_lastDirection",options:["open","closed"]}},{type:"enum",name:"shutter stop reason",ref:{value:"roller_stopReason",options:["normal","safety_switch","obstacle"]}},{type:"float",name:"shutter power",ref:{value:"roller_power",ext:"%f",unit:"W"}},{type:"enum",name:"shutter over temperature",ref:{value:"roller_overTemp",options:["true","false"]}},{type:"float",name:"meter 1 power",ref:{value:"ch1_power",value_t:"meter1power",ext:"%f",unit:"W"}},{type:"float",
name:"meter 1 power total",ref:{value:"ch1_powerTotal",value_t:"meter1powerTotal",ext:"%f",unit:"Wmin"}},{type:"float",name:"meter 2 power",ref:{value:"ch2_power",value_t:"meter2power",ext:"%f",unit:"W"}},{type:"float",name:"meter 2 power total",ref:{value:"ch2_powerTotal",value_t:"meter2powerTotal",ext:"%f",unit:"Wmin"}},{type:"float",name:"temperature (Celsius)",ref:{value:"tempC",ext:"%f",unit:"\u00b0C"}},{type:"float",name:"temperature (Fahrenheit)",ref:{value:"tempF",ext:"%f",unit:"\u00b0F"}}]}},
SYS:"shelly",applyUIFilter:function(a,b,c){if(!a.sys)return null;var d=function(g,p){if("*"===g||"*"===g[0])return!0;for(var l=0;l<g.length;l++)if(g[l]==p)return!0;return!1},e=function(g,p,l){var n=[];switch(l.catagory){case "command":g.command&&g.command.forEach(function(m){d(l.elems,m.type)&&(m=JSON.parse(JSON.stringify(m)),n.push(m))});break;case "status":g.status&&g.status.forEach(function(m){d(l.elems,m.type)&&(m=JSON.parse(JSON.stringify(m)),n.push(m))})}return n},f=function(g,p){var l=[],n=
xnm.aio.shelly.DM.getCommandStatusMap(g,c);n&&(g=e(n,g,p),l=l.concat(g));return l},h=JSON.parse(JSON.stringify(a)),k=null;switch(b.catagory){case "command":k=f(a,b);h.command=k;break;case "status":k=f(a,b);h.status=k;break;default:return null}return k&&0!=k.length?h:null},createDevice:function(a,b,c){b=xnm.aio.shelly.DM;a?a.type?a.ip?c(null,a):c(new b.Error(b.Error.ERROR_CODE.INVALID,"IP is missing")):c(new b.Error(b.Error.ERROR_CODE.INVALID,"type is missing")):c(new b.Error(b.Error.ERROR_CODE.INVALID,
"info is missing"))},deleteDevice:function(a,b,c){c&&c()},getCommandStatusMap:function(a,b){if(!a.type)return null;b=xnm.aio.shelly.DM.MAP[a.type]||null;if(!b)return b;b={command:b.command.slice(0),status:b.status.slice(0)};a.type===xnm.aio.shelly.RGBW2.TYPE?"color"===a.mode?(b.command.splice(11,12),b.status.splice(11,12)):"white"===a.mode&&(b.command.splice(0,11),b.status.splice(1,10)):a.type===xnm.aio.shelly.Switch2.TYPE?"roller"===a.mode?(b.command.splice(0,6),b.status.splice(0,2)):"relay"===a.mode&&
(b.command.splice(6,4),b.status.splice(2,5)):a.type===xnm.aio.shelly.Switch25.TYPE&&("roller"===a.mode?(b.command.splice(0,6),b.status.splice(0,4)):"relay"===a.mode&&(b.command.splice(6,4),b.status.splice(4,6)));return b},getIPDeviceType:function(){return[{sys:xnm.aio.shelly.DM.SYS,name:"Shelly"}]},toGeneralDevice:function(a){return(a=xnm.aio.shelly.parseJSON(a))&&"function"===typeof a.toGeneralDevice?a.toGeneralDevice():null},updateDevice:function(a,b,c){b=xnm.aio.shelly.DM;a?a.type?a.ip?c(null,
a):c(new b.Error(b.Error.ERROR_CODE.INVALID,"IP is missing")):c(new b.Error(b.Error.ERROR_CODE.INVALID,"type is missing")):c(new b.Error(b.Error.ERROR_CODE.INVALID,"info is missing"))}};xnm.aio.shelly.DM.MAP["1pm"]={command:xnm.aio.shelly.DM.MAP["1"].command.slice(0),status:xnm.aio.shelly.DM.MAP["1"].status.slice(0)};
...
xnm.aio.shelly.Device=function(a,b){this.ip=a;this.port=80;this.type=null;b&&(this.firmware=b.firmware||null,this.id=b.id||null,this.mode=b.mode||null,this.password=b.password||null,this.port=b.port||this.port,this.roller_dir=b.roller_dir||"open100",this.type=b.type,this.username=b.username||null)};
xnm.aio.shelly.Device.prototype={_getStateFromResult:function(a,b){if(!a||!b)return null;if("actReasons"===b)return Array.isArray(a.act_reasons)?a.act_reasons.join(", "):null;if(a.bat){var c=a.bat;switch(b){case "batCapacity":return c.value;case "batVoltage":return c.voltage}}if(Array.isArray(a.meters)){if(0<a.meters.length)switch(c=a.meters[0],b){case "ch1_power":return c.power;case "ch1_powerTotal":return c.total}if(1<a.meters.length)switch(c=a.meters[1],b){case "ch2_power":return c.power;case "ch2_powerTotal":return c.total}}if(a.tmp)switch(c=
a.tmp,b){case "tempC":return c.tC;case "tempF":return c.tF}switch(b){case "overTemp":return a.overtemperature?"true":"false"}return null},equalsTo:function(a){return a&&a instanceof xnm.aio.shelly.Device?this.ip===a.ip&&this.port===a.port&&this.id===a.id:!1},executeCommand:function(a,b,c){(a=xnm.aio.shelly.parseJSON(a))?a._executeCommand(b,c):(b=Error("Could not create device from data."),c&&c(b,null))},executeCommandCreator:function(a,b,c){b&&b.value?this.executeCommand(a,b,function(d){c&&c(d)}):
c&&c(Error("Command value is empty."))},getState:function(a){xnm.aio.shelly._logger.log("trace","[Device.getState] Sending request.");xnm.aio.shelly.doRequest(this,"GET",{path:"status"},function(b,c){b?a&&a(b,null):a&&a(null,c.response)})},getStatesCreator:function(a,b,c){var d=this;this.getState(function(e,f){if(f){e=[];for(var h=0;h<b.length;h++){var k=b[h];if(k&&k.id&&k.status){var g=d._getStateFromResult(f,k.status.value);null!==g&&e.push({id:k.id,status:g})}}c&&c(null,e)}else c&&c(Error("Failed to get states."))})},
toJSON:function(){return{sys:xnm.aio.shelly.DM.SYS,type:this.type,ip:this.ip,id:this.id,firmware:this.firmware}}};xnm.aio.shelly.GenericSwitch=function(a,b){xnm.aio.shelly.Device.call(this,a,b)};xnm.aio.shelly.GenericSwitch.prototype=Object.create(xnm.aio.shelly.Device.prototype);xnm.aio.shelly.GenericSwitch.constructor=xnm.aio.shelly.GenericSwitch;
...
xnm.aio.shelly.GenericSwitch.prototype._getStateFromResult=function(a,b){if(!a||!b)return null;if(Array.isArray(a.relays)){if(0<a.relays.length){var c=a.relays[0];switch(b){case "ch1_overTemp":return c.overtemperature?"true":"false";case "ch1_state":return c.ison?"on":"off"}}if(1<a.relays.length)switch(c=a.relays[1],b){case "ch2_overTemp":return c.overtemperature?"true":"false";case "ch2_state":return c.ison?"on":"off"}}if(Array.isArray(a.rollers)&&0<a.rollers.length)switch(c=a.rollers[0],b){case "position":return"open0"===
this.roller_dir?c.current_pos:100-c.current_pos;case "roller_lastDirection":return"close"===c.last_direction?"closed":c.last_direction;case "roller_overTemp":return c.overtemperature?"true":"false";case "roller_power":return c.power;case "roller_state":if("open0"===this.roller_dir){if(66<=c.current_pos)return"closed";if(33>=c.current_pos)return"open"}else{if(66<=c.current_pos)return"open";if(33>=c.current_pos)return"closed"}return"middle";case "roller_stopReason":return c.stop_reason}if(a.ext_temperature&&
0===b.indexOf("addonTemp")){c=a.ext_temperature;var d=b.substring(9,10);c=c[d];d=b.substring(10,11);if(c&&(c=c["t"+d],"number"===typeof c))return c}return a.ext_humidity&&0===b.indexOf("addonHum")&&(c=a.ext_humidity,d=b.substring(8,9),c=c[d])&&(c=c.hum,"number"===typeof c)?c:xnm.aio.shelly.Device.prototype._getStateFromResult.call(this,a,b)};
xnm.aio.shelly.GenericSwitch.prototype.cmdMoveDown=function(a){xnm.aio.shelly._logger.log("trace","[GenericSwitch.cmdMoveDown] Sending request.");xnm.aio.shelly.doRequest(this,"GET",{path:"roller/0?go=close"},function(b,c){a&&a(b,c)})};xnm.aio.shelly.GenericSwitch.prototype.cmdMoveStop=function(a){xnm.aio.shelly._logger.log("trace","[GenericSwitch.cmdMoveStop] Sending request.");xnm.aio.shelly.doRequest(this,"GET",{path:"roller/0?go=stop"},function(b,c){a&&a(b,c)})};
xnm.aio.shelly.GenericSwitch.prototype.cmdMoveUp=function(a){xnm.aio.shelly._logger.log("trace","[GenericSwitch.cmdMoveUp] Sending request.");xnm.aio.shelly.doRequest(this,"GET",{path:"roller/0?go=open"},function(b,c){a&&a(b,c)})};xnm.aio.shelly.GenericSwitch.prototype.cmdOff=function(a,b){a={path:"relay/"+a+"?turn=off"};xnm.aio.shelly._logger.log("trace","[GenericSwitch.cmdOff] Sending request.");xnm.aio.shelly.doRequest(this,"GET",a,function(c,d){b&&b(c,d)})};
xnm.aio.shelly.GenericSwitch.prototype.cmdOn=function(a,b){a={path:"relay/"+a+"?turn=on"};xnm.aio.shelly._logger.log("trace","[GenericSwitch.cmdOn] Sending request.");xnm.aio.shelly.doRequest(this,"GET",a,function(c,d){b&&b(c,d)})};
xnm.aio.shelly.GenericSwitch.prototype.cmdSetPosition=function(a,b){"number"!==typeof a||isNaN(a)||0>a||100<a?(a=Error("Invalid value for position: "+a),xnm.aio.shelly._logger.log("error","[GenericSwitch.cmdSetPosition] "+a.message),b&&b(a,null)):("open100"===this.roller_dir&&(a=100-a),a={path:"roller/0?go=to_pos&roller_pos="+Math.round(a)},xnm.aio.shelly._logger.log("trace","[GenericSwitch.cmdSetPosition] Sending request."),xnm.aio.shelly.doRequest(this,"GET",a,function(c,d){b&&b(c,d)}))};
...
case "toggle":this.cmdToggle(b);break;case "white":this.cmdSetSingleColor("white",a.ext,b);break;case "effect":this.cmdSetEffect(a.ext,b);break;case "temp":this.cmdSetColorTemp(a.ext,b);break;default:a=Error("Unknown command: "+a.value),xnm.aio.shelly._logger.log("warn","[GenericLight._executeCommand] "+a.message),b(a,null)}};
...
c.brightness:0;case "temp":return c.temp;case "mode":return c.mode;case "state":return c.ison?"on":"off"}}return xnm.aio.shelly.Device.prototype._getStateFromResult.call(this,a,b)};
xnm.aio.shelly.GenericLight.prototype.cmdOff=function(a){var b={path:"light/0?turn=off"};!(this instanceof xnm.aio.shelly.Bulb)&&this instanceof xnm.aio.shelly.RGBW2&&(b.path="color/0?turn=off");xnm.aio.shelly._logger.log("trace","[GenericLight.cmdOff] Sending request.");xnm.aio.shelly.doRequest(this,"GET",b,function(c,d){a&&a(c,d)})};
xnm.aio.shelly.GenericLight.prototype.cmdOn=function(a){var b={path:"light/0?turn=on"};!(this instanceof xnm.aio.shelly.Bulb)&&this instanceof xnm.aio.shelly.RGBW2&&(b.path="color/0?turn=on");xnm.aio.shelly._logger.log("trace","[GenericLight.cmdOn] Sending request.");xnm.aio.shelly.doRequest(this,"GET",b,function(c,d){a&&a(c,d)})};
...
xnm.aio.shelly.GenericLight.prototype.cmdSetColorTemp=function(a,b){"number"!==typeof a||isNaN(a)||3E3>a||6500<a?(a=Error("Invalid value for color temperature: "+a),xnm.aio.shelly._logger.log("error","[GenericLight.cmdSetColorTemp] "+a.message),b&&b(a,null)):(a={path:"white/0?turn=on&mode=white&temp="+Math.round(a)},xnm.aio.shelly._logger.log("trace","[GenericLight.cmdSetColorTemp] Sending request."),xnm.aio.shelly.doRequest(this,"GET",a,function(c,d){b&&b(c,d)}))};
...
xnm.aio.shelly.GenericLight.prototype.cmdSetMode=function(a,b){if(0>["color","white"].indexOf(a))a=Error("Invalid value for mode: "+a),xnm.aio.shelly._logger.log("error","[GenericLight.cmdSetMode] "+a.message),b&&b(a,null);else{var c={};c.path=this instanceof xnm.aio.shelly.Bulb||this instanceof xnm.aio.shelly.RGBW2?"settings/?mode="+a:"light/0?turn=on&mode="+a;xnm.aio.shelly._logger.log("trace","[GenericLight.cmdSetMode] Sending request.");xnm.aio.shelly.doRequest(this,"GET",c,function(d,e){b&&b(d,
e)})}};xnm.aio.shelly.GenericLight.prototype.cmdToggle=function(a){var b={path:"light/0?turn=toggle"};!(this instanceof xnm.aio.shelly.Bulb)&&this instanceof xnm.aio.shelly.RGBW2&&(b.path="color/0?turn=toggle");xnm.aio.shelly._logger.log("trace","[GenericLight.cmdToggle] Sending request.");xnm.aio.shelly.doRequest(this,"GET",b,function(c,d){a&&a(c,d)})};xnm.aio.shelly.Dimmer=function(a,b){xnm.aio.shelly.GenericLight.call(this,a,b);this.type=xnm.aio.shelly.Dimmer.TYPE};xnm.aio.shelly.Dimmer.TYPE="dimmer";
xnm.aio.shelly.Dimmer.prototype=Object.create(xnm.aio.shelly.GenericLight.prototype);xnm.aio.shelly.Dimmer.constructor=xnm.aio.shelly.Dimmer;
...
xnm.aio.shelly.RGBW2.prototype.cmdWhiteToggle=function(a,b){a={path:"white/"+a+"?turn=toggle"};xnm.aio.shelly._logger.log("trace","[RGBW2.cmdWhiteToggle] Sending request.");xnm.aio.shelly.doRequest(this,"GET",a,function(c,d){b&&b(c,d)})};xnm.aio.shelly.RGBW2.prototype.getEffectIndex=function(a){a=String(a).toLowerCase();for(var b=this.getEffects(),c=0;c<b.length;c++)if(b[c].toLowerCase()===a)return c;return 0};xnm.aio.shelly.RGBW2.prototype.getEffectName=function(a){return this.getEffects()[a]||a};
xnm.aio.shelly.RGBW2.prototype.getEffects=function(){return xnm.aio.shelly.RGBW2.EFFECTS};
...
ch4_brightness:{value:"ch4_brightness",ext:"%d",extMeta:"0-100",unit:"%"},ch4_power:{value:"ch4_power",ext:"%f",unit:"W"},mode:{value:"mode"}}}}:null};xnm.aio.shelly.Bulb=function(a,b){xnm.aio.shelly.RGBW2.call(this,a,b);this.type=xnm.aio.shelly.Bulb.TYPE;this.mode=this.mode||"color"};xnm.aio.shelly.Bulb.EFFECTS="off;Meteor shower;Gradual change;Flash;Breath;On/Off gradual;Red/Green change".split(";");xnm.aio.shelly.Bulb.TYPE="bulb";xnm.aio.shelly.Bulb.prototype=Object.create(xnm.aio.shelly.RGBW2.prototype);
xnm.aio.shelly.Bulb.constructor=xnm.aio.shelly.Bulb;xnm.aio.shelly.Bulb.prototype.getEffects=function(){return xnm.aio.shelly.Bulb.EFFECTS};
...
min:0,max:100},color:{type:"RGB"},color_white:{type:"RGBW"},red:{type:"INT",min:0,max:100},green:{type:"INT",min:0,max:100},blue:{type:"INT",min:0,max:100},white:{type:"INT",min:0,max:100},gain:{type:"INT",min:0,max:100},mode:{values:["color","white"]},state:{values:["on","off"]},power:{type:"FLOAT"},effect:{values:xnm.aio.shelly.Bulb.EFFECTS.slice(0)}},details:{commands:{on:{value:"on"},off:{value:"off"},toggle:{value:"toggle"},brightness:{value:"gain",ext:"%d",extMeta:"0-100",unit:"%"},color:{value:"color",
...
red:{value:"red",ext:"%d",extMeta:"0-100"},green:{value:"green",ext:"%d",extMeta:"0-100"},blue:{value:"blue",ext:"%d",extMeta:"0-100"},white:{value:"white",ext:"%d",extMeta:"0-100"},gain:{value:"gain",ext:"%d",extMeta:"0-100"},mode:{value:"mode"},state:{value:"state"},power:{value:"power",ext:"%f",unit:"W"},effect:{value:"effect"}}}}:"white"===this.mode?{type:"dimmer",commands:{on:{},off:{},brightness:{value:{type:"INT",min:0,max:100}}},states:{state:{values:["on","off"]},brightness:{type:"INT",min:0,
max:100},power:{type:"FLOAT"},mode:{values:["color","white"]}},details:{commands:{on:{value:"ch1_on"},off:{value:"ch1_off"},brightness:{value:"ch1_brightness",ext:"%d",extMeta:"0-100",unit:"%"}},states:{state:{value:"ch1_state"},brightness:{value:"ch1_brightness",ext:"%d",extMeta:"0-100",unit:"%"},power:{value:"ch1_power",ext:"%f",unit:"W"},mode:{value:"mode"}}}}:null};xnm.aio.shelly.Flood=function(a,b){xnm.aio.shelly.Device.call(this,a,b);this.type=xnm.aio.shelly.Flood.TYPE};
xnm.aio.shelly.Flood.TYPE="flood";xnm.aio.shelly.Flood.prototype=Object.create(xnm.aio.shelly.Device.prototype);xnm.aio.shelly.Flood.constructor=xnm.aio.shelly.Flood;xnm.aio.shelly.Flood.prototype._getStateFromResult=function(a,b){return a&&b?"flood"===b?"undefined"===typeof a.flood?null:a.flood?"true":"false":"rainMode"===b?"undefined"===typeof a.rain_sensor?null:a.rain_sensor?"true":"false":xnm.aio.shelly.Device.prototype._getStateFromResult.call(this,a,b):null};
xnm.aio.shelly.Flood.prototype.toGeneralDevice=function(){return{type:"sensor",states:{flood:{values:["true","false"]},rainMode:{value:["true","false"]},tempC:{type:"FLOAT"},tempF:{type:"FLOAT"},batCapacity:{type:"INT",min:0,max:100,unit:"%"}},details:{states:{flood:{value:"flood"},rainMode:{value:"rainMode"},tempC:{value:"tempC",ext:"%f",unit:"\u00b0C"},tempF:{value:"tempF",ext:"%f",unit:"\u00b0F"},batCapacity:{value:"batCapacity",ext:"%d",extMeta:"0-100",unit:"%"}}}}};
xnm.aio.shelly.HT=function(a,b){xnm.aio.shelly.Device.call(this,a,b);this.type=xnm.aio.shelly.HT.TYPE};xnm.aio.shelly.HT.TYPE="ht";xnm.aio.shelly.HT.prototype=Object.create(xnm.aio.shelly.Device.prototype);xnm.aio.shelly.HT.constructor=xnm.aio.shelly.HT;xnm.aio.shelly.HT.prototype._getStateFromResult=function(a,b){return a&&b?"humRel"===b?a.hum&&"undefined"!==typeof a.hum?a.hum.value:null:xnm.aio.shelly.Device.prototype._getStateFromResult.call(this,a,b):null};
xnm.aio.shelly.HT.prototype.toGeneralDevice=function(){return{type:"sensor",states:{humidity:{type:"INT"},tempC:{type:"FLOAT"},tempF:{type:"FLOAT"},batCapacity:{type:"INT",min:0,max:100,unit:"%"}},details:{states:{humidity:{value:"humRel",ext:"%d",unit:"%"},tempC:{value:"tempC",ext:"%f",unit:"\u00b0C"},tempF:{value:"tempF",ext:"%f",unit:"\u00b0F"},batCapacity:{value:"batCapacity",ext:"%d",extMeta:"0-100",unit:"%"}}}}};
xnm.aio.shelly.Handler=function(){var a=require("x.logger.js");a&&(xnm.aio.shelly._logger=a.getLogger("xnm.aio.shelly"))};
