...
"[doRequest] Error: "+a.message);d&&d(a);d=null});"number"!==typeof c.timeout||isNaN(c.timeout)||"function"!==typeof f.setTimeout||f.setTimeout(c.timeout);e&&f.write(e);f.end()},parseJSON:function(a){if(!a||!a.ip)return xnm.aio.shelly._logger.log("warn","[parseJSON] Missing IP."),null;var b=xnm.aio.shelly;switch(a.type){case b.Dimmer.TYPE:return new b.Dimmer(a.ip,a);case b.Plug.TYPE:return new b.Plug(a.ip,a);case b.PlugS.TYPE:return new b.PlugS(a.ip,a);case b.RGBW2.TYPE:return new b.RGBW2(a.ip,a);
case b.Switch1.TYPE:return new b.Switch1(a.ip,a);case b.Switch1PM.TYPE:return new b.Switch1PM(a.ip,a);case b.Switch2.TYPE:return new b.Switch2(a.ip,a);case b.Switch25.TYPE:return new b.Switch25(a.ip,a)}return new b.Device(a.ip,a)}};
xnm.aio.shelly.DM={MAP:{1:{command:[{type:"enum",name:"on",ref:{value:"ch1_on"}},{type:"enum",name:"off",ref:{value:"ch1_off"}},{type:"enum",name:"toggle",ref:{value:"ch1_toggle"}}],status:[{type:"enum",name:"state",ref:{value:"ch1_state",options:["on","off"]}}]},dimmer:{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}},{type:"int",name:"brightness",ref:{value:"brightness",ext:"%d",extMeta:"0-100",unit:"%"}}],
status:[{type:"enum",name:"state",ref:{value:"state",options:["on","off"]}},{type:"int",name:"brightness",ref:{value:"brightness",extMeta:"0-100",unit:"%"}},{type:"float",name:"power",ref:{value:"ch1_power",ext:"%f",unit:"W"}},{type:"float",name:"power total",ref:{value:"ch1_powerTotal",ext:"%f",unit:"Wmin"}},{type:"float",name:"temperature (Celsius)",ref:{value:"tempC",ext:"%f",unit:"\u00b0C"}},{type:"float",name:"temperature (Fahrenheit)",ref:{value:"tempF",ext:"%f",unit:"\u00b0F"}}]},plug:{command:[{type:"enum",
name:"on",ref:{value:"ch1_on"}},{type:"enum",name:"off",ref:{value:"ch1_off"}},{type:"enum",name:"toggle",ref:{value:"ch1_toggle"}}],status:[{type:"enum",name:"state",ref:{value:"ch1_state",options:["on","off"]}},{type:"float",name:"power",ref:{value:"ch1_power",ext:"%f",unit:"W"}},{type:"float",name:"power total",ref:{value:"ch1_powerTotal",ext:"%f",unit:"Wmin"}}]},rgbw2:{command:[{type:"enum",name:"on",ref:{value:"on"}},{type:"enum",name:"off",ref:{value:"off"}},{type:"enum",name:"toggle",ref:{value:"toggle"}},
{type:"int",name:"color brightness",ref:{value:"gain",ext:"%d",extMeta:"0-100"}},{type:"rgb",name:"color",ref:{value:"color",ext:"%rgb"}},{type:"rgbw",name:"rgb + white color",ref:{value:"color",ext:"%rgbw"}},{type:"int",name:"red",ref:{value:"red",ext:"%d",extMeta:"0-100"}},{type:"int",name:"green",ref:{value:"green",ext:"%d",extMeta:"0-100"}},{type:"int",name:"blue",ref:{value:"blue",ext:"%d",extMeta:"0-100"}},{type:"int",name:"white",ref:{value:"white",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"effect",
ref:{value:"effect",ext:"%e",extMeta:["off","Meteor shower","Gradual change","Flash","Red/Green change"]}},{type:"enum",name:"white 1: on",ref:{value:"ch1_on"}},{type:"enum",name:"white 2: on",ref:{value:"ch2_on"}},{type:"enum",name:"white 3: on",ref:{value:"ch3_on"}},{type:"enum",name:"white 4: on",ref:{value:"ch4_on"}},{type:"enum",name:"white 1: off",ref:{value:"ch1_off"}},{type:"enum",name:"white 2: off",ref:{value:"ch2_off"}},{type:"enum",name:"white 3: off",ref:{value:"ch3_off"}},{type:"enum",
name:"white 4: off",ref:{value:"ch4_off"}},{type:"int",name:"white 1: brightness",ref:{value:"ch1_brightness",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 2: brightness",ref:{value:"ch2_brightness",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 3: brightness",ref:{value:"ch3_brightness",ext:"%d",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 4: brightness",ref:{value:"ch4_brightness",ext:"%d",extMeta:"0-100",unit:"%"}}],status:[{type:"enum",name:"mode",ref:{value:"mode",
options:["color","white"]}},{type:"enum",name:"state",ref:{value:"state",options:["on","off"]}},{type:"int",name:"color brightness",ref:{value:"gain",ext:"%d",extMeta:"0-100"}},{type:"float",name:"power",ref:{value:"power",ext:"%f",unit:"W"}},{type:"rgbw",name:"color",ref:{value:"color",ext:"%s"}},{type:"rgbw",name:"rgb + white color",ref:{value:"color_white",ext:"%s"}},{type:"int",name:"red",ref:{value:"red",ext:"%d",extMeta:"0-100"}},{type:"int",name:"green",ref:{value:"green",ext:"%d",extMeta:"0-100"}},
{type:"int",name:"blue",ref:{value:"blue",ext:"%d",extMeta:"0-100"}},{type:"int",name:"white",ref:{value:"white",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"effect",ref:{value:"effect",options:["off","Meteor shower","Gradual change","Flash","Red/Green change"]}},{type:"enum",name:"white 1: state",ref:{value:"ch1_state",options:["on","off"]}},{type:"enum",name:"white 2: state",ref:{value:"ch2_state",options:["on","off"]}},{type:"enum",name:"white 3: state",ref:{value:"ch3_state",options:["on","off"]}},
{type:"enum",name:"white 4: state",ref:{value:"ch4_state",options:["on","off"]}},{type:"int",name:"white 1: brightness",ref:{value:"ch1_brightness",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 2: brightness",ref:{value:"ch2_brightness",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 3: brightness",ref:{value:"ch3_brightness",extMeta:"0-100",unit:"%"}},{type:"int",name:"white 4: brightness",ref:{value:"ch4_brightness",extMeta:"0-100",unit:"%"}},{type:"float",name:"white 1: power",ref:{value:"ch1_power",
ext:"%f",unit:"W"}},{type:"float",name:"white 2: power",ref:{value:"ch2_power",ext:"%f",unit:"W"}},{type:"float",name:"white 3: power",ref:{value:"ch3_power",ext:"%f",unit:"W"}},{type:"float",name:"white 4: power",ref:{value:"ch4_power",ext:"%f",unit:"W"}}]},switch:{command:[{type:"enum",name:"switch 1 on",ref:{value:"ch1_on"}},{type:"enum",name:"switch 1 off",ref:{value:"ch1_off"}},{type:"enum",name:"switch 1 toggle",ref:{value:"ch1_toggle"}},{type:"enum",name:"switch 2 on",ref:{value:"ch2_on"}},
{type:"enum",name:"switch 2 off",ref:{value:"ch2_off"}},{type:"enum",name:"switch 2 toggle",ref:{value:"ch2_toggle"}},{type:"int",name:"shutter position",ref:{value:"position",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"shutter up",ref:{value:"up"}},{type:"enum",name:"shutter down",ref:{value:"down"}},{type:"enum",name:"shutter stop",ref:{value:"stop"}}],status:[{type:"enum",name:"switch 1 state",ref:{value:"ch1_state",options:["on","off"]}},{type:"enum",name:"switch 2 state",ref:{value:"ch2_state",
options:["on","off"]}},{type:"enum",name:"shutter state",ref:{value:"roller_state",options:["open","closed","middle"]}},{type:"int",name:"shutter position",ref:{value:"position",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"shutter last direction",ref:{value:"roller_lastDirection",options:["open","closed"]}},{type:"enum",name:"shutter stop reason",ref:{value:"roller_stopReason",options:["normal","safety_switch","obstacle"]}},{type:"float",name:"shutter power",ref:{value:"roller_power",ext:"%f",unit:"W"}},
{type:"float",name:"power",ref:{value:"ch1_power",ext:"%f",unit:"W"}},{type:"float",name:"power total",ref:{value:"ch1_powerTotal",ext:"%f",unit:"Wmin"}}]},switch25:{command:[{type:"enum",name:"switch 1 on",ref:{value:"ch1_on"}},{type:"enum",name:"switch 1 off",ref:{value:"ch1_off"}},{type:"enum",name:"switch 1 toggle",ref:{value:"ch1_toggle"}},{type:"enum",name:"switch 2 on",ref:{value:"ch2_on"}},{type:"enum",name:"switch 2 off",ref:{value:"ch2_off"}},{type:"enum",name:"switch 2 toggle",ref:{value:"ch2_toggle"}},
{type:"int",name:"shutter position",ref:{value:"position",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"shutter up",ref:{value:"up"}},{type:"enum",name:"shutter down",ref:{value:"down"}},{type:"enum",name:"shutter stop",ref:{value:"stop"}}],status:[{type:"enum",name:"switch 1 state",ref:{value:"ch1_state",options:["on","off"]}},{type:"enum",name:"switch 1 over temperature",ref:{value:"ch1_overTemp",options:["true","false"]}},{type:"enum",name:"switch 2 state",ref:{value:"ch2_state",options:["on",
"off"]}},{type:"enum",name:"switch 2 over temperature",ref:{value:"ch2_overTemp",options:["true","false"]}},{type:"enum",name:"shutter state",ref:{value:"roller_state",options:["open","closed","middle"]}},{type:"int",name:"shutter position",ref:{value:"position",ext:"%d",extMeta:"0-100"}},{type:"enum",name:"shutter last direction",ref:{value:"roller_lastDirection",options:["open","closed"]}},{type:"enum",name:"shutter stop reason",ref:{value:"roller_stopReason",options:["normal","safety_switch","obstacle"]}},
{type:"float",name:"shutter power",ref:{value:"roller_power",ext:"%f",unit:"W"}},{type:"enum",name:"shutter over temperature",ref:{value:"roller_overTemp",options:["true","false"]}},{type:"float",name:"meter 1 power",ref:{value:"ch1_power",ext:"%f",unit:"W"}},{type:"float",name:"meter 1 power total",ref:{value:"ch1_powerTotal",ext:"%f",unit:"Wmin"}},{type:"float",name:"meter 2 power",ref:{value:"ch2_power",ext:"%f",unit:"W"}},{type:"float",name:"meter 2 power total",ref:{value:"ch2_powerTotal",ext:"%f",
unit:"Wmin"}},{type:"float",name:"temperature (Celsius)",ref:{value:"tempC",ext:"%f",unit:"\u00b0C"}},{type:"float",name:"temperature (Fahrenheit)",ref:{value:"tempF",ext:"%f",unit:"\u00b0F"}}]}},SYS:"shelly",applyUIFilter:function(a,b,c){if(!a.sys)return null;var d=function(a,b){if("*"===a||"*"===a[0])return!0;for(var c=0;c<a.length;c++)if(a[c]==b)return!0;return!1},e=function(a,b,c){var e=[];switch(c.catagory){case "command":a.command&&a.command.forEach(function(a){d(c.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),
e.push(a))});break;case "status":a.status&&a.status.forEach(function(a){d(c.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),e.push(a))})}return e},f=function(a,b){var d=[],f=xnm.aio.shelly.DM.getCommandStatusMap(a,c);f&&(a=e(f,a,b),d=d.concat(a));return d},k=JSON.parse(JSON.stringify(a)),g=null;switch(b.catagory){case "command":g=f(a,b);k.command=g;break;case "status":g=f(a,b);k.status=g;break;default:return null}return g&&0!=g.length?k:null},createDevice:function(a,b,c){b=xnm.aio.shelly.DM;a?a.type?
a.ip?c(null,a):c(new b.Error(b.Error.ERROR_CODE.INVALID,"IP is missing")):c(new b.Error(b.Error.ERROR_CODE.INVALID,"type is missing")):c(new b.Error(b.Error.ERROR_CODE.INVALID,"info is missing"))},deleteDevice:function(a,b,c){c&&c()},getCommandStatusMap:function(a,b){if(!a.type)return null;b=xnm.aio.shelly.DM.MAP[a.type]||null;if(!b)return b;b={command:b.command.slice(0),status:b.status.slice(0)};a.type===xnm.aio.shelly.RGBW2.TYPE?"color"===a.mode?(b.command.splice(11,12),b.status.splice(11,8)):"white"===
a.mode&&(b.command.splice(0,11),b.status.splice(1,10)):a.type===xnm.aio.shelly.Switch2.TYPE?"roller"===a.mode?(b.command.splice(0,6),b.status.splice(0,2)):"relay"===a.mode&&(b.command.splice(6,4),b.status.splice(2,5)):a.type===xnm.aio.shelly.Switch25.TYPE&&("roller"===a.mode?(b.command.splice(0,6),b.status.splice(0,4)):"relay"===a.mode&&(b.command.splice(6,4),b.status.splice(4,6)));return b},getIPDeviceType:function(){return[{sys:xnm.aio.shelly.DM.SYS,name:"Shelly"}]},toGeneralDevice:function(a){return(a=
xnm.aio.shelly.parseJSON(a))&&"function"===typeof a.toGeneralDevice?a.toGeneralDevice():null},updateDevice:function(a,b,c){b=xnm.aio.shelly.DM;a?a.type?a.ip?c(null,a):c(new b.Error(b.Error.ERROR_CODE.INVALID,"IP is missing")):c(new b.Error(b.Error.ERROR_CODE.INVALID,"type is missing")):c(new b.Error(b.Error.ERROR_CODE.INVALID,"info is missing"))}};xnm.aio.shelly.DM.MAP["1pm"]={command:xnm.aio.shelly.DM.MAP["1"].command.slice(0),status:xnm.aio.shelly.DM.MAP["1"].status.slice(0)};
xnm.aio.shelly.DM.MAP["1pm"].status.push({type:"float",name:"power",ref:{value:"ch1_power",ext:"%f",unit:"W"}},{type:"float",name:"power total",ref:{value:"ch1_powerTotal",ext:"%f",unit:"Wmin"}},{type:"enum",name:"over temperature",ref:{value:"overTemp",options:["true","false"]}},{type:"float",name:"temperature (Celsius)",ref:{value:"tempC",ext:"%f",unit:"\u00b0C"}},{type:"float",name:"temperature (Fahrenheit)",ref:{value:"tempF",ext:"%f",unit:"\u00b0F"}});
