...
ref:{value:"tempC",ext:"%f",unit:"\u00b0C"}},{type:"float",name:"temperature (Fahrenheit)",ref:{value:"tempF",ext:"%f",unit:"\u00b0F"}}]}},SYS:"shelly",applyUIFilter:function(a,b,c){if(!a.sys)return null;var d=function(a,b){if("*"===a||"*"===a[0])return!0;for(var c=0;c<a.length;c++)if(a[c]==b)return!0;return!1},e=function(a,b,c){var e=[];switch(c.catagory){case "command":a.command&&a.command.forEach(function(a){d(c.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),e.push(a))});break;case "status":a.status&&
a.status.forEach(function(a){d(c.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),e.push(a))})}return e},f=function(a,b){var d=[],f=xnm.aio.shelly.DM.getCommandStatusMap(a,c);f&&(a=e(f,a,b),d=d.concat(a));return d},k=JSON.parse(JSON.stringify(a)),g=null;switch(b.catagory){case "command":g=f(a,b);k.command=g;break;case "status":g=f(a,b);k.status=g;break;default:return null}return g&&0!=g.length?k:null},createDevice:function(a,b,c){b=xnm.aio.shelly.DM;a?a.type?a.ip?c(null,a):c(new b.Error(b.Error.ERROR_CODE.INVALID,
...
xnm.aio.shelly.GenericSwitch.prototype.cmdOff=function(a,b){a={path:"relay/"+a+"?turn=off"};xnm.aio.shelly._logger.log("trace","[GenericSwitch.cmdOff] Sending request.");xnm.aio.shelly.doRequest(this,"GET",a,function(a,d){b&&b(a,d)})};xnm.aio.shelly.GenericSwitch.prototype.cmdOn=function(a,b){a={path:"relay/"+a+"?turn=on"};xnm.aio.shelly._logger.log("trace","[GenericSwitch.cmdOn] Sending request.");xnm.aio.shelly.doRequest(this,"GET",a,function(a,d){b&&b(a,d)})};
