...
a.STATE.ESTABLISHED)b&&b(null,this);else if("undefined"!=typeof b&&null!=b&&-1==this._startCallbacks.indexOf(b)&&this._startCallbacks.push(b),this._state==a.STATE.IDLE){this._logger.log("trace","start session "+this.ip);var c=this;this._state=a.STATE.CONNECT;this._connect(function(b){if(b){c._state=a.STATE.IDLE;for(var d=0;d<c._startCallbacks.length;d++){var f=c._startCallbacks[d];f&&f(b)}c._startCallbacks=[]}else c._state=a.STATE.LOGIN,c._login(function(b){var d=c._startCallbacks;c._startCallbacks=
[];b?c.stop():(c._state=a.STATE.ESTABLISHED,c._keepAliveIV=setInterval(function(){c._keepAlive()},5E3),c._autoClose&&(c._idleTO=setTimeout(function(){c.stop()},6E4)));for(var e=0;e<d.length;e++){var f=d[e];f&&f(b)}})})}};a.prototype.stop=function(b){this._state!=a.STATE.IDLE&&(this._logger.log("trace","stop session "+this.ip),this._onSessionClose());b&&b()};a.prototype.send=function(b,a){if(this._autoClose&&this._idleTO){var c=this;clearTimeout(this._idleTO);this._idleTO=setTimeout(function(){c.stop()},
...
for(var c in a)a.hasOwnProperty(c)&&(this._isObject(a[c])?this._deepMerge(b[c],a[c]):b[c]=a[c]);return b};a.prototype._isObject=function(b){return b&&"object"===typeof b&&!Array.isArray(b)};a.STATE={IDLE:0,CONNECT:1,LOGIN:2,ESTABLISHED:3};return a}();
...
this._device.ip);var a=this;this._running=!0;xnm.aio.siegenia._SessionManager.startSession(this._device,function(c,e){c?(a._session=null,a._logger.log("warn","start monitor "+a._device.ip+" error:"+c.message+" code:"+c.code),a._running?(a._restart(c.code?120:30),b&&b(null,a)):b&&b(c)):(a._session=e,a._session._monitor=a,a._session.send({command:"getDeviceParams"},function(){}),b&&b(null,a))})}};a.prototype.stop=function(b){this._logger.log("trace","stop monitor:"+this._device.ip);this._autoRestartTO&&
...
null;this._running&&this._restart()};a.prototype.onData=function(b,a){this._logger.log("trace","receive data:"+JSON.stringify(b));for(var c=0;c<this._callbacks.length;c++)this._callbacks[c](b,a)};return a}();
xnm.aio.siegenia._SessionManager={_sessions:{},_monitors:{},getSession:function(a){return this._sessions[a]},setSession:function(a,b){this._sessions[a]=b},startSession:function(a,b){if(a&&a.ip){var c=a.ip,d=this.getSession(c);if("undefined"==typeof d||null==d)d=new xnm.aio.siegenia._Session(a),this.setSession(c,d);d.start(function(a){b&&b(a,d)})}else b&&b(Error("ws device invalid"))},stopSession:function(a,b){a&&a.ip?(a=this.getSession(a.ip),("undefined"==typeof a||null==a)&&b&&b(),a.stop(function(a){b&&
b(a)})):b&&b(Error("ws device invalid"))},startMonitorSession:function(a,b,c){if(a&&a.ip){var d=a.ip;if(this._monitors[d])this._monitors[d].addCallback(b);else{a=new xnm.aio.siegenia._SessionMonitor(a);a.addCallback(b);var e=this;a.start(function(b,a){b?c&&c(b):e._monitors[d]=a})}}else c&&c(Error("ws device invalid"))},stopMonitorSession:function(a,b){console.log("=======>","stop monitor session");if(a&&a.ip){var c=a.ip;if(this._monitors[c]){var d=this;this._monitors[c].stop(function(){d._monitors[c]=
null;b&&b()})}else b&&b()}else b&&b(Error("ws device invalid"))}};xnm.aio.siegenia._IQONTROLStateCallbacks={};
xnm.aio.siegenia.WSDevice=function(){var a=function(){this.ip=null;this.port=443;this.user="user";this.password="0000";this._serial=this._subvariant=this._variant=this._type=this._data=null};a.prototype.CONNECTION_ERROR=513;a.prototype.connect=function(b){var a=this;xnm.aio.siegenia._SessionManager.startSession(this,function(c,e){c?b&&b(c):(a._session=e,b&&b(null,e))})};a.prototype.send=function(b,a,d){b?b.send(a,function(b,a){b?d&&d(b):a&&"ok"==a.status?d&&d(null,a.data):d&&d(Error(a?a.status:"response invalid"))}):
d&&d(Error("session invalid"))};a.prototype.disconnect=function(b){xnm.aio.siegenia._SessionManager.stopSession(this,function(a){b&&b(a)})};a.prototype.startMonitoring=function(b,a){var c=this;xnm.aio.siegenia._SessionManager.startMonitorSession(this,function(a,d){(a=c._resolveData(a,d))&&b(a)},function(b){a&&a(b)})};a.prototype._resolveData=function(b,a){var c=null;b&&512!=b.id&&b.data&&!b.data.token&&a&&(c=this.computeStates(a));return c};a.prototype.toJSON=function(){return{sys:"siegenia",ip:this.ip,
port:this.port,username:this.user,password:this.password,data:this._data,type:this._type,variant:this._variant,subvariant:this._subvariant,serial:this._serial}};a.prototype.equalsTo=function(b){return b&&b instanceof xnm.aio.siegenia.WSDevice?this.ip==b.ip&&this.port==b.port:!1};return a}();
xnm.aio.siegenia.Genius=function(a,b,c,d,e){this.ip=a;b&&(this.user=b);c&&(this.password=c);e&&(this.port=e);this.type="B";d&&(this.type=d);var f=this;this._dataCallback=function(b,a){b=f._resolveData(b,a);a=xnm.aio.siegenia._IQONTROLStateCallbacks[f.ip];b&&a&&a.id&&a.ch&&f._doStateCallback(a.id,a.ch,b)}};xnm.aio.siegenia.Genius.prototype=new xnm.aio.siegenia.WSDevice;xnm.aio.siegenia.Genius.prototype.constructor=xnm.aio.siegenia.Genius;xnm.aio.siegenia.Genius.prototype.CMD_GETDEVICE=256;
...
{command:"setDeviceParams"},"axxentDK"==this.type)e.params={openclose:"CLOSE"};else if("axxentHSA"==this.type)e.params={openclose:{0:"CLOSE_WO_LOCK"}};else{if("axxentHSA2"==this.type){this.execute(this.CMD_WING1_CLOSE,null,function(b,a){b?c&&c(b,a):d.execute(d.CMD_WING2_CLOSE,null,function(b,a){c&&c(b,a)})});return}e.params="mh10"==this.type?{relais2:!0}:{relais1:!1}}else if(a==this.CMD_OPEN_TO_TURN)e={command:"setDeviceParams"},"axxentDK"==this.type&&(e.params={openclose:"OPEN_TO_TURN"});else if(a==
...
a==this.CMD_WING2_LOCK?e={command:"setDeviceParams",params:{openclose:{1:"CLOSE"}}}:a==this.CMD_SET_STOPOVER?(f=Math.round(parseInt(b)/10),3>f&&(f=3),e={command:"setDeviceParams",params:{stopover:f}}):a==this.CMD_SILENT_ON?e={command:"setDeviceParams",params:{silent_state:!0}}:a==this.CMD_SILENT_OFF&&(e={command:"setDeviceParams",params:{silent_state:!1}});e?(d=this,this.connect(function(b,a){b?(b.code=d.CONNECTION_ERROR,c&&c(b)):(a.setDataCallback(d._dataCallback),d.send(a,e,function(b,a){setTimeout(function(){c&&
c(b,a)},250)}))})):c&&c(Error("no such command"))};xnm.aio.siegenia.Genius.prototype.getDevice=function(a){this.execute(this.CMD_GETDEVICE,null,function(b,c){a&&a(b,c)})};xnm.aio.siegenia.Genius.prototype.getState=function(a){this.execute(this.CMD_GETPARAMS,null,function(b,c){a&&a(b,c)})};
...
xnm.aio.siegenia.Genius.prototype.executeCommandCreator=function(a,b,c){if(b&&b.value){var d=b.value;switch(d){case "setImpulse":case "setTimer":case "setStopover":if("undefined"==typeof b.ext||null==b.ext){c&&c(Error("command ext invalid"));return}d+=b.ext}this.executeCommand(a,d,function(b){c&&c(b)})}else c&&c(Error("command value is empty"))};
xnm.aio.siegenia.Genius.prototype.getStatesCreator=function(a,b,c){var d=this;this._getState(function(a,f){if(f){var e=null;a?e={error:a.message}:f&&(e=d.computeStates(f));a=[];for(f=0;f<b.length;f++){var h=b[f];if(h&&h.id&&h.status&&h.status.value){var k=e[h.status.value];"undefined"!=typeof k&&null!=k&&a.push({id:h.id,status:k})}}c&&c(null,a)}else c&&c(Error("get state error"))})};
xnm.aio.siegenia.Genius.prototype.getSingleDeviceStatesCreator=function(a,b,c,d){var e=this;this._getState(function(b,a){if(a){var c=null;b?c={error:b.message}:a&&(c=e.computeStates(a));d&&d(null,c)}else d&&d(Error("get state error"))})};xnm.aio.siegenia.Genius.prototype._getState=function(a){var b=this;this.connect(function(c,d){c?(c.code=b.CONNECTION_ERROR,a&&a(c)):d&&d._deviceParam?a&&a(null,d._deviceParam):b.send(d,{command:"getDeviceParams"},function(b,c){setTimeout(function(){a&&a(b,c)},250)})})};
xnm.aio.siegenia.AEROPAC=function(a,b,c,d,e){this.ip=a;b&&(this.user=b);c&&(this.password=c);e&&(this.port=e);this.type="aeropac";d&&(this.type=d);this.CommandHandler=null;var f=this;this._dataCallback=function(b,a){b=f._resolveData(b,a);a=xnm.aio.siegenia._IQONTROLStateCallbacks[f.ip];b&&a&&a.id&&a.ch&&f._doStateCallback(a.id,a.ch,b)}};xnm.aio.siegenia.AEROPAC.prototype=new xnm.aio.siegenia.WSDevice;xnm.aio.siegenia.AEROPAC.prototype.constructor=xnm.aio.siegenia.Genius;
...
a){b?(b.code=g.CONNECTION_ERROR,c&&c(b)):(a.setDataCallback(g._dataCallback),g.send(a,d,function(b,a){setTimeout(function(){c&&c(b,a)},250)}))})}else c&&c(Error("no such command"))};xnm.aio.siegenia.AEROPAC.prototype.getState=function(a){this.execute(this.CMD_GETPARAMS,null,function(b,c){a&&a(b,c)})};
...
b=b.replace(/setAutoTo/g,"")):0==b.indexOf("setSensorTo")&&(a=this.CMD_SETSENSORSENSITIVITY,b=b.replace(/setSensorTo/g,"")),d=parseInt(b),"aerotube"==this.type?(15>d&&(d=15),100<d&&(d=100)):"aerovital"==this.type?(0>d&&(d=0),100<d&&(d=100)):"aeromatVT"==this.type?(a=this.CMD_SETFANPOWER,0==d&&(d=1),100<d&&(d=100)):(a=this.CMD_SETFANLEVEL,7<d&&(d=7)));a?this.execute(a,d,function(b,a){c(b,a)}):c&&c()};
xnm.aio.siegenia.AEROPAC.prototype.computeStates=function(a){var b={};1==a.automode?b.automode="on":0==a.automode&&(b.automode="off");"undefined"!=typeof a.airquality&&null!=a.airquality&&(b.airquality=""+a.airquality);void 0!=a.fanpower&&(b.fanpower="aerotube"==this.type?(a.fanpower/100*45).toFixed(1):"aerovital"==this.type?(a.fanpower/100*60).toFixed(1):(a.fanpower/100*21).toFixed(1),b.state=0==a.fanpower?1==b.automode?"on":"off":"on");void 0!=a.fanlevel&&(b.fanlevel=""+a.fanlevel,b.state=0==a.fanlevel?
"off":"on");a.devicestate&&void 0!=a.devicestate.deviceactive&&(b.state=1==a.devicestate.deviceactive?"on":"off");a.automode_maxairflow&&("aerotube"==this.type?b.autoairflow=(a.automode_maxairflow/100*45).toFixed(1):"aerovital"==this.type&&(b.autoairflow=(a.automode_maxairflow/100*60).toFixed(1)));void 0!=a.automode_co2sensity&&(b.autosensitivity=""+a.automode_co2sensity);void 0!=a.fanmode&&(b.fanmode=a.fanmode.toLowerCase());if(a.timer){b.activeTimer=a.timer.activetimer;var c=[];a.timer.timer_valid>>
...
xnm.aio.siegenia.AEROPAC.prototype.executeCommandCreator=function(a,b,c){if(b&&b.value){var d=b.value;switch(d){case "setTo":if("undefined"==typeof b.ext||null==b.ext){c&&c(Error("command ext invalid"));return}var e=parseInt(b.ext);"aeromatVT"==this.type&&(e=Math.round(parseInt(b.ext)/21*100));"aerovital"==this.type&&(e=Math.round(parseInt(b.ext)/60*100));"aerotube"==this.type&&(e=Math.round(parseInt(b.ext)/45*100));d+=e;break;case "setAutoTo":if("undefined"==typeof b.ext||null==b.ext){c&&c(Error("command ext invalid"));
return}e=parseInt(b.ext);"aerovital"==this.type&&(e=Math.round(parseInt(b.ext)/60*100));"aerotube"==this.type&&(e=Math.round(parseInt(b.ext)/45*100));d+=e;break;case "setSensorTo":if("undefined"==typeof b.ext||null==b.ext){c&&c(Error("command ext invalid"));return}e=parseInt(b.ext);d+=e;break;case "setTimer":case "setDailyPowerOn":if("undefined"==typeof b.ext||null==b.ext){c&&c(Error("command ext invalid"));return}e=b.ext;d+=e}this.executeCommand(a,d,function(b){c&&c(b)})}else c&&c(Error("command value is empty"))};
xnm.aio.siegenia.AEROPAC.prototype.getStatesCreator=function(a,b,c){var d=this;this._getState(function(a,f){if(f){var e=null;a?e={error:a.message}:f&&(e=d.computeStates(f));a=[];for(f=0;f<b.length;f++){var h=b[f];if(h&&h.id&&h.status&&h.status.value){var k=e[h.status.value];"undefined"!=typeof k&&null!=k&&a.push({id:h.id,status:k})}}c&&c(null,a)}else c&&c(Error("get state error"))})};
...
ref:{value:"warning",options:["REPLACE_AIRFILTER","FROST_PROTECTION"]}}]},sensoair:{command:[{type:"enum",name:"leds on",ref:{value:"ledsOn"}},{type:"enum",name:"leds off",ref:{value:"ledsOff"}}],status:[{type:"enum",name:"leds",ref:{value:"leds",options:["on","off"]}},{type:"int",name:"airquality",ref:{value:"airquality",extMeta:"1-7"}},{type:"string",name:"warnings",ref:{value:"warnings",ext:"%s"}}],ipevt:[{type:"int",name:"airquality",ref:{value:"airquality"}}]}},registModule:function(b){b.register(this.SYS,
...
"info is invalid"))},updateDevice:function(b,c,d){c=a.ERROR_CODE;b?b.ip?b.data?d(null,b):d(new a(c.INVALID,"data is invalid")):d(new a(c.INVALID,"ip is invalid")):d(new a(c.INVALID,"info is invalid"))},deleteDevice:function(b,a,d){d()},applyUIFilter:function(b,a,d){var c=function(b,a){if("*"==b)return!0;for(var c=!1,d=0;d<b.length;d++)if(b[d]==a){c=!0;break}return c},f=function(b,a,d){var e=[];switch(d.catagory){case "command":b.command&&b.command.forEach(function(b){c(d.elems,b.type)&&(b=JSON.parse(JSON.stringify(b)),
e.push(b))});break;case "status":b.status&&b.status.forEach(function(b){c(d.elems,b.type)&&(b=JSON.parse(JSON.stringify(b)),e.push(b))})}return e},g=function(b,a){var c=[],e=xnm.aio.siegenia.DM.getCommandStatusMap(b,d);e&&(b=f(e,b,a),c=c.concat(b));return c};if(!b.sys)return null;var h=JSON.parse(JSON.stringify(b)),k=null;switch(a.catagory){case "command":k=g(b,a);h.command=k;break;case "status":k=g(b,a);h.status=k;break;default:return null}return k&&0!=k.length?h:null},applyIPEventFilter:function(b,
a){a=xnm.aio.siegenia.DM.getCommandStatusMap(b);if(!a)return null;b=JSON.parse(JSON.stringify(b));b.ipevt=a.ipevt;return b},getCommandStatusMap:function(b){return b&&b.data?this.MAP[b.data]:null}}}();
xnm.aio.siegenia.Handler=function(){var a=function(){this._logger=require("x.logger.js").getLogger("xnm.aio.siegenia.Handler");var b=this;this._discoverCallbacks=[];this._mdnsCallback=function(a,d){b._findSiegeniaDevice(a,d)};this._discoverTO=null;this._discoverRunning=!1};a.prototype.SessionManager=xnm.aio.siegenia._SessionManager;a.prototype.getStateValues=function(b,a){return"genius"==b.type?(new xnm.aio.siegenia.Genius).getStateValues(a):"aeropac"==b.type?(new xnm.aio.siegenia.AEROPAC).getStateValues(a):
{}};a.prototype.getDeviceStatesList=function(b){var a=[];"geniusA"==b.data?a.push({type:"enum",name:"state",ref:{value:"state",options:["open","closed"]}}):"geniusB"==b.data?(a.push({type:"enum",name:"state",ref:{value:"state",options:["open","closed","locked"]}}),a.push({type:"enum",name:"mode",ref:{value:"mode",options:["day","night"]}})):"axxentDK"==b.data?(a.push({type:"enum",name:"state",ref:{value:"state",options:["open","closed","moving","turning_position"]}}),a.push({type:"enum",name:"silent state",
ref:{value:"silent_state",options:["on","off"]}}),a.push({type:"enum",name:"timerEnabled",ref:{value:"timerEnabled",options:["enabled","disabled"]}}),a.push({type:"string",name:"remainingTime",ref:{value:"remainingTime"}})):"axxentHSA"==b.data?(a.push({type:"enum",name:"state",ref:{value:"state",options:"open closed locked gap stopover stop moving".split(" ")}}),a.push({type:"enum",name:"timerEnabled",ref:{value:"timerEnabled",options:["enabled","disabled"]}}),a.push({type:"string",name:"remainingTime",
ref:{value:"remainingTime"}})):"axxentHSA2"==b.data?(a.push({type:"enum",name:"1. wing state",ref:{value:"wing1state",options:"open closed locked gap stopover stop moving".split(" ")}}),a.push({type:"enum",name:"2. wing state",ref:{value:"wing2state",options:"open closed locked gap stopover stop moving".split(" ")}}),a.push({type:"enum",name:"timerEnabled",ref:{value:"timerEnabled",options:["enabled","disabled"]}}),a.push({type:"string",name:"remainingTime",ref:{value:"remainingTime"}})):"mh10"!=
b.data&&("aeropac"==b.data?(a.push({type:"enum",name:"state",ref:{value:"state",options:["on","off"]}}),a.push({type:"int",name:"fanlevel",ref:{value:"fanlevel"}}),a.push({type:"string",name:"timeRemaining",ref:{value:"timeRemaining"}}),a.push({type:"enum",name:"timerEnabled",ref:{value:"timerEnabled",options:["enabled","disabled"]}}),a.push({type:"string",name:"dailyPowerOnTime",ref:{value:"dailyPowerOnTime"}}),a.push({type:"enum",name:"dailyPowerOnEnabled",ref:{value:"dailyPowerOnEnabled",options:["enabled",
"disabled"]}})):"aeromatVT"==b.data?(a.push({type:"enum",name:"state",ref:{value:"state",options:["on","off"]}}),a.push({type:"enum",name:"automode",ref:{value:"automode",options:["on","off"]}}),a.push({type:"float",name:"fanpower",ref:{value:"fanpower"}}),a.push({type:"int",name:"airquality",ref:{value:"airquality"}}),a.push({type:"float",name:"indoorTemp",ref:{value:"indoorTemp"}}),a.push({type:"float",name:"outdoorTemp",ref:{value:"outdoorTemp"}}),a.push({type:"float",name:"indoorHum",ref:{value:"indoorHum"}}),
a.push({type:"float",name:"outdoorHum",ref:{value:"outdoorHum"}})):"aerotube"==b.data?(a.push({type:"enum",name:"state",ref:{value:"state",options:["on","off"]}}),a.push({type:"enum",name:"fanmode",ref:{value:"fanmode",options:["in","out","in_out"]}}),a.push({type:"enum",name:"automode",ref:{value:"automode",options:["on","off"]}}),a.push({type:"float",name:"fanpower",ref:{value:"fanpower"}}),a.push({type:"float",name:"autoairflow",ref:{value:"autoairflow"}}),a.push({type:"float",name:"indoorTemp",
ref:{value:"indoorTemp"}}),a.push({type:"float",name:"indoorHum",ref:{value:"indoorHum"}})):"aerovital"==b.data?(a.push({type:"enum",name:"state",ref:{value:"state",options:["on","off"]}}),a.push({type:"enum",name:"fanmode",ref:{value:"fanmode",options:["in","out","in_out","in_out_wrg"]}}),a.push({type:"enum",name:"automode",ref:{value:"automode",options:["on","off"]}}),a.push({type:"float",name:"fanpower",ref:{value:"fanpower"}}),a.push({type:"float",name:"autoairflow",ref:{value:"autoairflow"}}),
a.push({type:"int",name:"autosensitivity",ref:{value:"autosensitivity"}}),a.push({type:"float",name:"indoorTemp",ref:{value:"indoorTemp"}}),a.push({type:"float",name:"outdoorTemp",ref:{value:"outdoorTemp"}}),a.push({type:"float",name:"indoorHum",ref:{value:"indoorHum"}}),a.push({type:"float",name:"outdoorHum",ref:{value:"outdoorHum"}}),a.push({type:"int",name:"airquality",ref:{value:"airquality"}})):"sensoair"==b.data&&(a.push({type:"enum",name:"leds",ref:{value:"leds",options:["on","off"]}}),a.push({type:"int",
name:"airquality",ref:{value:"airquality"}})));a.push({type:"array",name:"warnings",ref:{value:"warnings"}});return a};a.prototype.getDeviceCommandList=function(a,c){c=[];if("geniusA"==a.data||"axxentDK"==a.data||"axxentHSA"==a.data||"aOpener"==a.data||"axxentHSA2"==a.data)c.push({id:window.XC_Text.open,cmd:"open"}),c.push({id:window.XC_Text.close,cmd:"close"}),"axxentHSA"==a.data&&(c.push({id:window.XC_Text.stop,cmd:"stop"}),c.push({id:window.XC_Text.lock,cmd:"lock"}),c.push({id:window.XC_Text.open_gap,
...
cmd:"automodeOn"}),c.push({id:window.XC_Text.automode_off,cmd:"automodeOff"}),a=0;21>a;a++){var b=10*Math.round(a/21*100)/10;c.push({id:window.XC_Text.fan_power+" "+(a+1)+" m3/h",cmd:"setTo"+b})}else if("aerotube"==a.data){c.push({id:window.XC_Text.on,cmd:"on"});c.push({id:window.XC_Text.off,cmd:"off"});c.push({id:window.XC_Text.automode_on,cmd:"automodeOn"});c.push({id:window.XC_Text.automode_off,cmd:"automodeOff"});c.push({id:window.XC_Text.fanmode_in,cmd:"fanmodeIn"});c.push({id:window.XC_Text.fanmode_out,
cmd:"fanmodeOut"});c.push({id:window.XC_Text.fanmode_inout,cmd:"fanmodeInOut"});for(a=7;45>a;a++)b=10*Math.round(a/45*100)/10,c.push({id:window.XC_Text.fan_power+" "+(a+1)+" m3/h",cmd:"setTo"+b});for(a=7;45>a;a++)b=10*Math.round(a/45*100)/10,c.push({id:window.XC_Text.auto_fan_power+" "+(a+1)+" m3/h",cmd:"setAutoTo"+b})}else if("aerovital"==a.data){c.push({id:window.XC_Text.on,cmd:"on"});c.push({id:window.XC_Text.off,cmd:"off"});c.push({id:window.XC_Text.automode_on,cmd:"automodeOn"});c.push({id:window.XC_Text.automode_off,
cmd:"automodeOff"});c.push({id:window.XC_Text.fanmode_in,cmd:"fanmodeIn"});c.push({id:window.XC_Text.fanmode_out,cmd:"fanmodeOut"});c.push({id:window.XC_Text.fanmode_inout,cmd:"fanmodeInOut"});c.push({id:window.XC_Text.fanmode_inout_wrg,cmd:"fanmodeInOutWRG"});for(a=0;60>a;a++)b=10*Math.round(a/60*100)/10,c.push({id:window.XC_Text.fan_power+" "+(a+1)+" m3/h",cmd:"setTo"+b});for(a=0;60>a;a++)b=10*Math.round(a/60*100)/10,c.push({id:window.XC_Text.auto_fan_power+" "+(a+1)+" m3/h",cmd:"setAutoTo"+b});
for(a=0;100>a;a+=5)c.push({id:window.XC_Text.auto_fan_power+" "+(a+1)+" m3/h",cmd:"setSensorTo"+a})}else"sensoair"==a.data&&(c.push({id:window.XC_Text.ledsOn,cmd:"ledsOn"}),c.push({id:window.XC_Text.ledsOff,cmd:"ledsOff"}));return c};a.prototype.getDevice=function(a){return"geniusA"==a.data?new this.Genius(a.address,"user",a.pwd,"A"):"geniusB"==a.data?new this.Genius(a.address,"user",a.pwd,"B"):"mh10"==a.data?new this.Genius(a.address,"user",a.pwd,"mh10"):"axxentDK"==a.data?new this.Genius(a.address,
...
-1!=a&&(XC.debugf("stop siegenia discovery with the correct callback"),this._discoverCallbacks.splice(a,1)));require("x.mdns.js").stopDiscover("_siegenia._tcp.local",this._mdnsCallback)};a.prototype._findSiegeniaDevice=function(a,c){if(a)for(c=0;c<this._discoverCallbacks.length;c++)(g=this._discoverCallbacks[c])&&g(a,e);else if(c){this._logger.log("trace","receive mdns response:"+JSON.stringify(c));var b=g=null;if(c.ip&&c.ip[0]&&c.domain&&c.info){1==c.info.model?g="aeropac":2==c.info.model?g="aeromatVT":
3==c.info.model?g="axxentDK":4==c.info.model?g="sensoair":5==c.info.model?g="aerovital":6==c.info.model?(1==c.info.variant&&0==c.info.subvariant?(g="axxentHSA",b="MHS400 Schema A"):1==c.info.variant&&1==c.info.subvariant?(g="axxentHSA",b="DRIVE axxent HSA Schema A"):2==c.info.variant&&1==c.info.subvariant&&(g="axxentHSA2",b="DRIVE axxent HSA Schema C"),g||(g="geniusB")):8==c.info.model?g="aerotube":10==c.info.model&&(1==c.info.variant?(g="aOpener",b="A-opener"):2==c.info.variant?(g="geniusA",b="GENIUS A"):
3==c.info.variant?(g="geniusB",b="GENIUS B"):4==c.info.variant&&(g="mh10",b="MH10"),g||(g="axxentHSA"));var e=c.domain.split(".")[0];var f=c.ip[0];e={sys:"siegenia",ip:f,port:443,username:"user",password:null,data:g,model:c.info.model,variant:c.info.variant,subvariant:c.info.subvariant,serial:c.info.serial,address:f,name:e,subtype:b}}if(e)for(this._logger.log("trace","find siegenia device:"+JSON.stringify(e)),c=0;c<this._discoverCallbacks.length;c++){var g=this._discoverCallbacks[c];g&&g(a,e)}}};
a.prototype.devicemanager=xnm.aio.siegenia.DM;a.prototype.registModule=function(a){a.register(this.devicemanager.SYS,"siegenia")};a.prototype.resolveDevice=function(a){if(!a||!a.ip||!a.data)return null;var b=null;switch(a.data){case "geniusA":case "geniusB":case "mh10":case "axxentDK":case "axxentHSA":case "axxentHSA2":case "aOpener":var d=this.Genius;var e=a.data;"geniusA"==a.data?e="A":"geniusB"==a.data&&(e="B");break;case "aeropac":case "aeromatVT":case "aerotube":case "aerovital":case "sensoair":d=
this.AEROPAC,e=a.data}d&&e&&(b=new d(a.ip,a.username,a.password,e,a.port));b&&(b._data=a.data,b._type=a.type,b._variant=a.variant,b._subvariant=a.subvariant,b._serial=a.serial);return b};a.prototype.getDeviceCommands=function(a,c){a=(a=this.devicemanager.applyUIFilter(a,{catagory:"command",elems:"*"}))?a.command:[];c&&c(null,a)};a.prototype.getDeviceStatus=function(a,c){a=(a=this.devicemanager.applyUIFilter(a,{catagory:"status",elems:"*"}))?a.status:[];c&&c(null,a)};a.prototype.doCommand=function(a,
c,d){var b=this.resolveDevice(a);b?b.executeCommandCreator(a,c,function(a){d&&d(a)}):d&&d(Error("device json format invalid"))};a.prototype.doStatus=function(a,c,d,e){var b=this.resolveDevice(c);b?b.getStatesCreator(null,[{id:a,device:c,status:d}],function(a,b){a?e&&e(a):e&&e(null,b[0])}):e&&e(Error("device json format invalid"))};a.prototype.discoverWithTimeout=function(a,c){if(!this._discoverRunning){var b={},e=function(a,c){!a&&c&&c.ip&&!b[c.ip]&&(b[c.ip]=c)},f=this;this.discoveryStart(e);this._discoverTO=
setTimeout(function(){f.discoveryStop(e);var a=[],d;for(d in b)b.hasOwnProperty(d)&&a.push(b[d]);c&&c(null,a)},a)}};return a}();"undefined"!=typeof exports&&"undefined"!=typeof module&&module.exports&&(exports=module.exports=new xnm.aio.siegenia.Handler);
