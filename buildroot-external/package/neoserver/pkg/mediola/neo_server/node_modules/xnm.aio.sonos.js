...
UNKNOW:4,NOT_FOUND:5,IP_EXISTS:6};return{SYS:"sonos",getIPDeviceType:function(){return[{sys:this.SYS,name:"Sonos Player",port:1400}]},createDevice:function(b,c,d){c=a.ERROR_CODE;b?b.type?b.ip?d(null,b):d(new a(c.INVALID,"ip is invalid")):d(new a(c.INVALID,"type is invalid")):d(new a(c.INVALID,"info is invalid"))},updateDevice:function(b,c,d){c=a.ERROR_CODE;b?b.type?b.ip?d(null,b):d(new a(c.INVALID,"ip is invalid")):d(new a(c.INVALID,"type is invalid")):d(new a(c.INVALID,"info is invalid"))},deleteDevice:function(a,
c,d){d()},applyUIFilter:function(a,c,d){var b=function(a,b){if("*"==a)return!0;for(var c=!1,d=0;d<a.length;d++)if(a[d]==b){c=!0;break}return c},e=function(a,c,d){var e=[];switch(d.catagory){case "command":a.command&&a.command.forEach(function(a){b(d.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),e.push(a))});break;case "status":a.status&&a.status.forEach(function(a){b(d.elems,a.type)&&(a=JSON.parse(JSON.stringify(a)),e.push(a))})}return e},h=function(a,b){var c=[],f=xnm.aio.sonos.DM.getCommandStatusMap(a,
d);f&&(a=e(f,a,b),c=c.concat(a));return c};if(!a.sys)return null;var k=JSON.parse(JSON.stringify(a)),l=null;switch(c.catagory){case "command":l=h(a,c);k.command=l;break;case "status":l=h(a,c);k.status=l;break;default:return null}return l&&0!=l.length?k:null},getCommandStatusMap:function(a,c){return a.type?d[a.type]:null}}}();
