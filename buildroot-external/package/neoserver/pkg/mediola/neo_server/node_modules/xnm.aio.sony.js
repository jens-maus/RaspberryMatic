...
function(a,c){var d=this,e=this._buildSoapReq(a);this._doRequest(e,function(b){b&&b._code&&d._logger.log("warn","sony access forbidden");c&&c(b)})};a.prototype._register=function(a){var c=this,d="http://"+this.ip+":50002/?action=register&name=aioRemote&registrationType=initial&deviceId=aioRemote%3A00-00-00-00-00-00";this._logger.log("trace","register:"+d);$.ajax({url:d,method:"GET",timeout:3E3,cache:!1,headers:{"Content-Type":"text/xml; charset=UTF-8","X-CERS-DEVICE-ID":"aioRemote:00-00-00-00-00-00"},
...
"http request error:"+c);var e;a&&401==a.status?(e=Error("http response 401"),e._errSource="xnm.aio.sony.IRCC",e._code=401,e._device=d,b(e),b=null):a&&403==a.status?(e=Error("http response 403"),e._errSource="xnm.aio.sony.IRCC",e._code=403,e._device=d,b(e),b=null):b&&(b(Error(c?c:"http error")),b=null)}})};a.prototype._buildSoapReq=function(f){return a.SOAP_PREFIX+f+a.SOAP_SUFFIX};return a}();
