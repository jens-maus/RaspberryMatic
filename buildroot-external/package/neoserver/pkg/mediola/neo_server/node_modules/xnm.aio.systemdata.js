...
for(var b=0,c=0;c<a.length;c++)b<a[c].index&&(b=a[c].index);return b+1};this.addGateway=function(a,b){if(!("gtw"===b.common_type?0<this.getGateways(function(a){return a.info.address==b.address}).length:0<this.getGateways(function(a){return a.info.mac==b.mac}).length)){var c=this._getNextIndex(this._sysData.gateways);a=this._getFreeGatewayName(a);this._sysData.gateways.push({name:a,index:c,info:b});this.save();return this._sysData.gateways[this._sysData.gateways.length-1]}};this.saveGateway=function(a){for(var b=
...
function(a){return{ip:a.ip,tz:a.TZ,mac:a.mac,ntp:a.ntp,sys:"aio",lat:a.LAT,hwv:a.hwv,port:80,long:a.LONG,name:a.name,server:a.server,rfmode:a.RFM,username:"user",password:"",firmware:a.msv,gateway_vendor:"mediola",_cloudAccessActive:!(Number("0x"+a.cfg)&64)}};this._getFreeGatewayName=function(a){for(var b=this,c=1,d="",e=function(){return!b.getGateways(function(b){return b.name===a+d},!0)[0]};!e();)c++,d=" "+c;return a+d};this._unlearnDevice=function(a){var b=this._getGatewayByDevice(a);if(b){var c=
require("xnm.aio.gateway.js");if(b=c.resolveGateway(b.info))if(c=c.devicemanager.getSystem(a.info,b.info))c.delSensor&&c.delSensor(b,a.info.address,function(a){a&&XC.debugf("SystemData: unlearn device error: "+a)}),c.deleteDevice&&a.info.id&&c.deleteDevice(b,{id:a.info.id},function(a){a&&XC.debugf("SystemData: unlearn device error: "+a)})}};this._getGatewayByDevice=function(a){return this.getGateways(function(b){return b.index===a.info.gateway},!0)[0]};this.init()};xnm.aio.systemdata.Handler=function(){};
