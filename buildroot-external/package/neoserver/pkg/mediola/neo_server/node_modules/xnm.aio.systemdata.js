...
"macros.xml"==a?b='<?xml version="1.0" encoding="UTF-8" ?>\r\n<locations><location id="default"></location></locations>':"ircodes.xml"==a&&(b='<?xml version="1.0" encoding="UTF-8" ?>\r\n<ircodes></ircodes>');return $.parseXML(b)};this._loadXMLFile=function(a,b){var d;!this._demoMode&&window.localStorage&&(d=XC.localStorage.getItem(this._path+a));if(d){var c;try{c=$.parseXML(d)}catch(e){c=this._getEmptyXML(a)}b.call(this,c)}else if(this._demoMode){var f=this._path+a,h=this;$.ajax({type:"GET",url:f,
dataType:"xml",context:this,isLocal:!0,success:b,error:function(a,c,d){require("fs").readFile(f,"utf8",function(a,c){!a&&c&&b.call(h,$.parseXML(c))})}})}else b.call(this,this._getEmptyXML(a))};this.getXMLString=function(a){var b='<?xml version="1.0" encoding="UTF-8" ?>\r\n';"devices"==a?b=this.$devicesXML.getXMLString():"macros"==a?b=this.$macrosXML.getXMLString():"ircodes"==a&&(b=this.$ircodesXML.getXMLString());return b};this.saveData=function(a){if(!this._demoMode)if("devices"==a)XC.debugf("save devices.xml"),
...
b.length&&b[0]==e&&b[1]==f&&b[2]==c&&a.attr("action",e+"."+f+"."+d))});b.attr("id",d);this.saveData("ircodes");this.saveData("macros")};this.getDeviceData=function(a){a=a.split(".");if(2==a.length){var b=null,d=a[1].split(":");2==d.length&&(a[1]=d[0],b=d[1]);var d=null,c=this.$devicesXML.find("locations location[id='"+a[0]+"'] device[id='"+a[1]+"']");c&&0<c.length?(c=$(c[0]),d={},d.location=a[0],d.id=c.attr("id"),d.type=c.attr("type"),d.gateway=c.attr("gateway"),d.address=c.attr("address"),d.pwd=
