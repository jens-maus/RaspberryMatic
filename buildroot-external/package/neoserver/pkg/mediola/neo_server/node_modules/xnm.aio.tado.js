...
null;try{n=JSON.parse(p),e&&(e(null,n),e=null)}catch(r){e&&(e(Error("https response invalid json")),e=null)}}else e&&(e(Error("https response code:"+h.statusCode),p),e=null)})});f.on("error",function(h){m._logger.log("trace","send https request err:"+h.message);e&&(e(h),e=null)});f.setTimeout(2E3,function(){m._logger.log("trace","send https request timeout");f.abort();e&&(e(Error("https request timeout")),e=null)});b&&f.write(b);f.end()};d.prototype.toJSON=function(){return{sys:xnm.aio.tado.DM.SYS,
