var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(d,a,c){d instanceof String&&(d=String(d));for(var b=d.length,e=0;e<b;e++){var f=d[e];if(a.call(c,f,e,d))return{i:e,v:f}}return{i:-1,v:void 0}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(d,a,c){d!=Array.prototype&&d!=Object.prototype&&(d[a]=c.value)};
...
$jscomp.polyfill("Array.prototype.find",function(d){return d?d:function(a,c){return $jscomp.findInternal(this,a,c).v}},"es6","es3");var xnm=xnm||{};xnm.aio=xnm.aio||{};xnm.aio.yamaha=xnm.aio.yamaha||{};
...
"HDMI1;HDMI2;HDMI3;HDMI4;HDMI5;HDMI6;AUDIO1;AUDIO2;AV1;AV2;AV3;AV4;AV5;AV6;TUNER;USB;NET RADIO;Bluetooth;AUX;V-AUX;NET;SERVER;AirPlay;JUKE;Spotify;MusicCast Link;MULTI CH;PHONO;CD;TV;MD/CD-R;BD/HD DVD;DVD;CBL/SAT;DVR;VCR;V-AUX;DOCK;PC/MCX".split(";");d.prototype.executeCommandCreator=function(a,c,b){if(c&&c.value)if("openNative"==c.value)window&&window.XC&&window.XC.callHost&&window.XCHost&&window.XCHost.getType&&("iOS"==window.XCHost.getType()?window.XC.callHost("SYSTEM","startApp",{scheme:"jp.co.yamaha.avkk.avcontroller://"}):
"Android"==window.XCHost.getType()&&window.XC.callHost("SYSTEM","startApp",{scheme:"com.yamaha.av.avcontroller"})),b&&b();else{a="";c.path&&c.path[0]&&"global"!=c.path[0]&&(a=c.path[0]+":");var e=a+c.value;if("sleep"==c.value){if(!c.ext){b&&b(Error("command sleep ext format invalid"));return}e+=c.ext.replace(/min/g,"")}else if("setInput"==c.value){if(!c.ext){b&&b(Error("command setInput ext format invalid"));return}e=a+c.ext}else if("audioMode"==c.value){if(!c.ext){b&&b(Error("command audioMode ext format invalid"));
return}e=a+c.ext}else if("setTo"==c.value){if(null==c.ext||"undefined"==typeof c.ext){b&&b(Error("command setTo ext format invalid"));return}e+=c.ext}else if("dlgLevel"==c.value){if(null==c.ext||"undefined"==typeof c.ext){b&&b(Error("command dlgLevel ext format invalid"));return}e+=c.ext}else if("setVideoPreset"==c.value){if(null==c.ext||"undefined"==typeof c.ext){b&&b(Error("command setVideoPreset ext format invalid"));return}e+=c.ext}else if("customCMD"==c.value){if(!c.ext){b&&b(Error("command customCMD ext format invalid"));
return}e=a+c.ext}if(c.path&&c.path[0]&&"tuner"==c.path[0]&&(e=c.value,"tunerPreset"==c.value)){if(null==c.ext||"undefined"==typeof c.ext){b&&b(Error("command tunerPreset ext format invalid"));return}e="tuner"+c.ext}this.executeCommand(e,function(a){if(a)b&&b(a);else{if(c.path&&c.path[0]&&"mainzone"==c.path[0]){if("on"==c.value||"off"==c.value||"toggle"==c.value){setTimeout(function(){b&&b()},1E3);return}if("setTo"==c.value||"volumeUp"==c.value||"volumeDown"==c.value){setTimeout(function(){b&&b()},
10);return}}b&&b()}})}else b&&b(Error("command json format invalid"))};d.prototype.getStatesCreator=function(a,c,b){a=[];for(var e=0;e<c.length;e++)if(c[e]&&c[e].status&&c[e].status.path&&c[e].status.path[0]){var d=0;switch(c[e].status.path[0]){case "mainzone":d=1;break;case "zone2":d=2;break;case "zone3":d=3;break;case "zone4":d=4}d&&-1==a.indexOf(d)&&a.push(d)}this.getStates(a,function(a,e){a=[];for(var d=0;d<c.length;d++)if(c[d]&&c[d].id){var f="?";if(c[d].status&&c[d].status.value){var g="";c[d].status.path&&
c[d].status.path[0]&&"global"!=c[d].status.path[0]&&(g=c[d].status.path[0]);var h=c[d].status.value;e&&g&&e[g]&&e[g][h]&&(f=e[g][h])}a.push({id:c[d].id,status:f})}b&&b(null,a)})};d.prototype._doRequest=function(a,c,b){a='<?xml version="1.0" encoding="utf-8"?><YAMAHA_AV cmd="'+a+'">'+(c+"</YAMAHA_AV>");var e=this;c="http://"+this.ip+":"+this.port+"/YamahaRemoteControl/ctrl";this._logger.log("trace","send data:"+a);var d=b;$.ajax({url:c,type:"POST",timeout:this.timeout,data:a,dataType:"text",cache:!0,
headers:{"Content-Length":a.length},success:function(a){e._logger.log("trace","http request success:"+a);d&&(d(null,a),d=null)},error:function(a,b){b="http request error:"+(a?a.status:"0")+"-"+b;e._logger.log("trace",b);b=Error(b);b.code=a?a.status:0;d&&(d(b),d=null)}})};d.prototype._getStateValue=function(a,c,b){var d=null;a=a.find(c);0<a.length&&(d=$(a[0]).text());d&&b&&(d=d.toLowerCase());return d};d.prototype._parseStates=function(a,c){var b={};b.power=this._getStateValue(a,"Power_Control Power",
!0);"standby"==b.power&&(b.power="off");b.sleep=this._getStateValue(a,"Power_Control Sleep",!0);b.mute=this._getStateValue(a,"Volume Mute",!0);b.mute||(b.mute=this._getStateValue(a,"Vol Mute",!0));var d=this._getStateValue(a,"Volume Lvl Val");d||(d=this._getStateValue(a,"Vol Lvl Val"));b.volume=d?(parseFloat(d)/10).toFixed(1):null;b.input=this._getStateValue(a,"Input Input_Sel");"zone2"!=c&&"zone3"!=c&&"zone4"!=c&&(b.mode=this._getStateValue(a,"Surround Program_Sel Current Sound_Program"),b.enhancer=
this._getStateValue(a,"Surround Program_Sel Current Enhancer",!0),b.straight=this._getStateValue(a,"Surround Program_Sel Current Straight",!0),b.direct=this._getStateValue(a,"Sound_Video Pure_Direct Mode",!0),b.bass=this._getStateValue(a,"Sound_Video Extra_Bass",!0),"auto"==b.bass&&(b.bass="on"),b.ypao_volume=this._getStateValue(a,"Sound_Video YPAO_Volume",!0),"auto"==b.ypao_volume&&(b.ypao_volume="on"),b.dlgLevel=this._getStateValue(a,"Sound_Video Dialogue_Adjust Dialogue_Lvl"),b.videoPreset=this._getStateValue(a,
"Sound_Video HDMI Video Preset_Sel Current",!0),b.videoPreset&&(b.videoPreset=b.videoPreset.replace("preset ","")));return b};d.prototype.getStates=function(a,c){a&&0!=a.length||(a=[1]);var b={},d=0,f=this,g=function(e,k){var h=a[d];!e&&k&&(1==h?b.mainzone=k.mainzone:2==h?b.zone2=k.zone2:3==h?b.zone3=k.zone3:4==h&&(b.zone4=k.zone4));d++;d<a.length?f._getZoneStates(a[d],g):c&&c(null,b)};this._getZoneStates(a[d],g)};d.prototype._getZoneStates=function(a,c){var b=this;if(1==a){var d="Main_Zone";var f=
"mainzone"}else 2==a?(d="Zone_2",f="zone2"):3==a?(d="Zone_3",f="zone3"):4==a&&(d="Zone_4",f="zone4");this._doRequest("GET","<"+d+"><Basic_Status>GetParam</Basic_Status></"+d+">",function(a,d){if(a)c&&c(a);else try{var e=$($.parseXML(d));if(e){var g=e.find("Basic_Status");if(!g||0>=g.length)c&&c(Error(f+" status reponse has no basic status tag"));else{var h=$(g[0]);a={};a[f]=b._parseStates(h,f);c&&c(null,a)}}else c&&c(Error(f+" status reponse invalid"))}catch(l){c&&c(l)}})};d.prototype.executeCommand=
function(a,c){var b=null,d=!0,f=null,g=a.indexOf(":");0<g&&(f=a.substr(0,g),a=a.substr(g+1));var h=this;"on"==a?b="<Power_Control><Power>On</Power></Power_Control>":"off"==a||"standby"==a?b="<Power_Control><Power>Standby</Power></Power_Control>":"toggle"==a?b="<Power_Control><Power>On/Standby</Power></Power_Control>":"mute"==a?b="<Volume><Mute>On</Mute></Volume>":"unmute"==a?b="<Volume><Mute>Off</Mute></Volume>":"toggleMute"==a?b="<Volume><Mute>On/Off</Mute></Volume>":"volumeDown"==a?b="<Volume><Lvl><Val>Down</Val><Exp></Exp><Unit></Unit></Lvl></Volume>":
"volumeUp"==a?b="<Volume><Lvl><Val>Up</Val><Exp></Exp><Unit></Unit></Lvl></Volume>":"enhancerOn"==a?b="<Surround><Program_Sel><Current><Enhancer>On</Enhancer></Current></Program_Sel></Surround>":"enhancerOff"==a?b="<Surround><Program_Sel><Current><Enhancer>Off</Enhancer></Current></Program_Sel></Surround>":"directOn"==a?b="<Sound_Video><Pure_Direct><Mode>On</Mode></Pure_Direct></Sound_Video>":"directOff"==a?b="<Sound_Video><Pure_Direct><Mode>Off</Mode></Pure_Direct></Sound_Video>":"extraBassOn"==
a?b="<Sound_Video><Extra_Bass>Auto</Extra_Bass></Sound_Video>":"extraBassOff"==a?b="<Sound_Video><Extra_Bass>Off</Extra_Bass></Sound_Video>":"straightOn"==a?b="<Surround><Program_Sel><Current><Straight>On</Straight></Current></Program_Sel></Surround>":"straightOff"==a?b="<Surround><Program_Sel><Current><Straight>Off</Straight></Current></Program_Sel></Surround>":"Scene1"==a?b="<Scene><Scene_Sel>Scene 1</Scene_Sel></Scene>":"Scene2"==a?b="<Scene><Scene_Sel>Scene 2</Scene_Sel></Scene>":"Scene3"==a?
b="<Scene><Scene_Sel>Scene 3</Scene_Sel></Scene>":"Scene4"==a?b="<Scene><Scene_Sel>Scene 4</Scene_Sel></Scene>":"play"==a?b="<Play_Control><Playback>Play</Playback></Play_Control>":"pause"==a?b="<Play_Control><Playback>Pause</Playback></Play_Control>":"stop"==a?b="<Play_Control><Playback>Stop</Playback></Play_Control>":"previous"==a?b="<Play_Control><Playback>Skip Rev</Playback></Play_Control>":"next"==a?b="<Play_Control><Playback>Skip Fwd</Playback></Play_Control>":"up"==a?b="<Cursor_Control><Cursor>Up</Cursor></Cursor_Control>":
"down"==a?b="<Cursor_Control><Cursor>Down</Cursor></Cursor_Control>":"left"==a?b="<Cursor_Control><Cursor>Left</Cursor></Cursor_Control>":"right"==a?b="<Cursor_Control><Cursor>Right</Cursor></Cursor_Control>":"enter"==a?b="<Cursor_Control><Cursor>Sel</Cursor></Cursor_Control>":"return"==a?b="<Cursor_Control><Cursor>Return</Cursor></Cursor_Control>":0==a.indexOf("sleep")?(a=a.replace(/sleep/g,"").toLowerCase(),b="off"==a?"<Power_Control><Sleep>Off</Sleep></Power_Control>":"<Power_Control><Sleep>"+
a+" min</Sleep></Power_Control>"):0==a.indexOf("dlgLevel")?(a=a.replace(/dlgLevel/g,"").toLowerCase(),b="<Sound_Video><Dialogue_Adjust><Dialogue_Lvl>"+a+"</Dialogue_Lvl></Dialogue_Adjust></Sound_Video>"):0==a.indexOf("setVideoPreset")?(a=a.replace(/setVideoPreset/g,"").toLowerCase(),f="system",b="<Sound_Video><HDMI><Video><Presetl_Sel><Current>"+a+"</Current></Presetl_Sel></Video></HDMI></Sound_Video>"):0==a.indexOf("tuner")?(d=!1,a=a.replace(/tuner/g,""),b="Up"==a?"<Tuner><Play_Control><Preset><Preset_Sel>Up</Preset_Sel></Preset></Play_Control></Tuner>":
...
xnm.aio.yamaha.DM=function(){var d=function(a,b){this.code=a;this.message=b;this.stack=Error().stack};d.prototype=Error();d.prototype.name="YamahaDMError";d.prototype.code=0;d.ERROR_CODE={DEFAULT:0,INDEX_EXISTS:1,ID_EXISTS:2,INVALID:3,UNKNOW:4,NOT_FOUND:5,IP_EXISTS:6};var a={avr:{command:[{type:"root",name:"global",value:"global",children:[{type:"string",name:"custom command",ref:{value:"customCMD",ext:"%s"}},{type:"enum",name:"open yamaha AV Controller",ref:{value:"openNative"}}]},{type:"root",name:"tuner",
...
ref:{value:"return"}}]}],status:[{type:"root",name:"main zone",value:"mainzone",children:[{type:"float",name:"volume",ref:{value:"volume",unit:"db",extMeta:"-80.5-16.5",scale:"0.5"}},{type:"enum",name:"power",ref:{value:"power",options:["on","off"]}},{type:"enum",name:"mute",ref:{value:"mute",options:["on","off"]}},{type:"enum",name:"sleep",ref:{value:"sleep",options:["30min","60min","90min","120min","off"]}},{type:"enum",name:"input",ref:{value:"input",options:"HDMI1;HDMI2;HDMI3;HDMI4;HDMI5;HDMI6;AUDIO1;AUDIO2;AV1;AV2;AV3;AV4;AV5;AV6;TUNER;USB;NET RADIO;Bluetooth;AUX;V-AUX;NET;SERVER;AirPlay;JUKE;Spotify;MusicCast Link;MULTI CH;PHONO;MULTI CH;PHONO;CD;TV;MD/CD-R;BD/HD DVD;DVD;CBL/SAT;DVR;VCR;V-AUX;DOCK;PC/MCX".split(";")}},
...
return{SYS:"yamaha",getIPDeviceType:function(){return[{sys:this.SYS,name:"Yamaha AV Receiver",type:"avr"}]},createDevice:function(a,b,e){b=d.ERROR_CODE;a?a.ip?e(null,a):e(new d(b.INVALID,"ip is invalid")):e(new d(b.INVALID,"info is invalid"))},updateDevice:function(a,b,e){b=d.ERROR_CODE;a?a.ip?e(null,a):e(new d(b.INVALID,"ip is invalid")):e(new d(b.INVALID,"info is invalid"))},deleteDevice:function(a,b,d){d()},applyUIFilter:function(a,b,d){var c=function(a,b,d){var e=[];a.forEach(function(a){if("root"==
a.type){a=JSON.parse(JSON.stringify(a));var f=c(a.children,b,d);f&&0<f.length&&(a.children=f,e.push(a))}else{f=d.elems;if("*"==f)f=!0;else{for(var g=!1,h=0;h<f.length;h++)if(f[h]==a.type){g=!0;break}f=g}f&&(a=JSON.parse(JSON.stringify(a)),e.push(a))}});return e},e=function(a,b){var e=[],f=xnm.aio.yamaha.DM.getCommandStatusMap(a,d);if(f){var g=[];switch(b.catagory){case "command":f.command&&(g=c(f.command,a,b));break;case "status":f.status&&(g=c(f.status,a,b))}e=e.concat(g)}return e};if(!a.sys)return null;
