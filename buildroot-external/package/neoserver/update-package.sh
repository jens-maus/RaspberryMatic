...
cp -a ${TMPDIR}/data/bin pkg/mediola/
cp -a ${TMPDIR}/data/mediola_addon.cfg pkg/mediola/
chmod 644 pkg/mediola/mediola_addon.cfg
rm -rf pkg/mediola/rc.d
cp -a ${TMPDIR}/rc.d pkg/mediola/
rm -rf pkg/mediola/neo_server
cp -a ${TMPDIR}/data/neo_server pkg/mediola/
...
cp -a ${TMPDIR}/data/www overlay/opt/mediola/
