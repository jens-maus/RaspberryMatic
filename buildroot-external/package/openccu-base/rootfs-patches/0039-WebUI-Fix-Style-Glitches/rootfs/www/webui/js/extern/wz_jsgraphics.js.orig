...
20.04.2007 Harald Badberg
=========================

- Funktion this.drawImage2  ist neu
*/
...
function chkDHTM(x, i)
{
  ...
  /*
    Uncomment this when in quirks-mode. Otherwise the Circle of the WinMatic doesn´t work with the IE
...
text both horizontally (e.g. right) and vertically within that rectangle */
	...
	{
    this.htm += '<div style="position: relative; margin: 0; padding: 0; vertical-align: top; text-align: left; background-color: white;';
    ...
    //this.htm += '<div style="position: absolute; margin: 0; padding: 0; vertical-align: top; text-align: left; background-color: white;';
		if (x) this.htm += 'left:'   + x + 'px;';
		if (y) this.htm += 'top:'    + y + 'px;';
		if (w) this.htm += 'width:'  + w + 'px;';
		if (h) this.htm += 'height:' + h + 'px;';
		       this.htm += '">';
			   
		          this.htm += '<img src="' + imgSrc + '" ';
		if (imgw) this.htm += 'width="'    + w      + '" ';
		if (imgh) this.htm += 'height="'   + h      + '" ';
		if (a)    this.htm +=                a      + '" ';
		          this.htm += '>';
