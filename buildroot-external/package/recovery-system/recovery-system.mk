...
define RECOVERY_SYSTEM_BUILD_CMDS
	...
	$(MAKE) -C $(@D) BR2_EXTERNAL=$(RECOVERY_SYSTEM_PKGDIR)external BR2_RECOVERY_SYSTEM_VERSION=$(shell cat ../VERSION)-$(RECOVERY_SYSTEM_VER) BR2_PACKAGE_PSPLASH_PATCH=$(BR2_PACKAGE_PSPLASH_PATCH)
endef
