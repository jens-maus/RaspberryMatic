...
RECOVERY_SYSTEM_VERSION = 1.1.2
RECOVERY_SYSTEM_BUILDROOT = 2018.05.1
...
define RECOVERY_SYSTEM_BUILD_CMDS
	...
	$(MAKE) -C $(@D) BR2_EXTERNAL=$(RECOVERY_SYSTEM_PKGDIR)external BR2_RECOVERY_SYSTEM_VERSION=$(shell cat ../VERSION)-$(RECOVERY_SYSTEM_VERSION)
endef
