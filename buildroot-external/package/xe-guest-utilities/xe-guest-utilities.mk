...
XE_GUEST_UTILITIES_MAJOR_VERSION = 8
XE_GUEST_UTILITIES_MINOR_VERSION = 4
...
define XE_GUEST_UTILITIES_BUILD_CMDS
	...
	GOPROXY=https://proxy.golang.org,direct $(GO_BIN) mod vendor; \
	$(MAKE) PRODUCT_MAJOR_VERSION=$(XE_GUEST_UTILITIES_MAJOR_VERSION) PRODUCT_MINOR_VERSION=$(XE_GUEST_UTILITIES_MINOR_VERSION) PRODUCT_MICRO_VERSION=$(XE_GUEST_UTILITIES_MICRO_VERSION) GO_BUILD="$(GO_BIN) build"
endef
