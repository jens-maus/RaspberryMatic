...
XE_GUEST_UTILITIES_MINOR_VERSION = 33
...
define XE_GUEST_UTILITIES_BUILD_CMDS
	...
	$(GO_BIN) mod vendor; \
	$(MAKE) PRODUCT_MAJOR_VERSION=$(XE_GUEST_UTILITIES_MAJOR_VERSION) PRODUCT_MINOR_VERSION=$(XE_GUEST_UTILITIES_MINOR_VERSION) PRODUCT_MICRO_VERSION=$(XE_GUEST_UTILITIES_MICRO_VERSION)
endef
