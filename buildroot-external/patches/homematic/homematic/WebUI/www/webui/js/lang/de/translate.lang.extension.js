jQuery.extend(true,langJSON, {
  "de" : {
    ...
    "dialogSettingsCMDialogPerformSoftwareUpdateStart" : "Das Software-Update wird nun heruntergeladen und auf der " + HMIdentifier.de.CCUShortName + " installiert.<br/>",
    "dialogSettingsCMDialogPerformSoftwareLblUpdateStart" : "Software-Update starten",
    ...
    "dialogSettingsCMDialogHintPerformFirmwareUploadContent" : "Das Firmware-Update wird auf die " + HMIdentifier.de.CCUShortName + " %FCbertragen.<br/><br/>Dieser Vorgang kann einige Minuten dauern.",
