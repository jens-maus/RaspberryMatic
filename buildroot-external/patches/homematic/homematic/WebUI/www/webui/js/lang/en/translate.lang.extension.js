jQuery.extend(true, langJSON, {
  "en": {
    ...
    "dialogSettingsCMDialogPerformSoftwareUpdateStart" : "The software update will now be downloaded and installed to your " + HMIdentifier.en.CCUShortName + ".<br/>",
    "dialogSettingsCMDialogPerformSoftwareLblUpdateStart" : "Start software update",
    ...
    "dialogSettingsCMDialogHintPerformFirmwareUploadContent" : "The firmware update is currently being uploaded to your " + HMIdentifier.en.CCUShortName + ".<br/><br/>This process can take several minutes.",
