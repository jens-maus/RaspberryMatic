...
proc set_htmlParams {iface address pps pps_descr special_input_id peer_type} {
  ...
  append HTML_PARAMS(separate_1) "<div id=\"ch2ParamTbl\" class=\"_hidden\">"
    append HTML_PARAMS(separate_1) "<table class=\"ProfileTbl\">"
      ...
      append HTML_PARAMS(separate_1) "<tr name='sensor_3' class='_hidden'>"
        ...
        append HTML_PARAMS(separate_1) "<td>[getTextFieldIdentityString psDescr $CHANNEL $param $ps($param) separate_${special_input_id}_$prn $defaultVal][getHelpIcon "POWER_STRING_CH2_V2" $hlpBoxWidth [expr $hlpBoxHeight * 1.6]]</td>"
      append HTML_PARAMS(separate_1) "</tr>"
      ...
      append HTML_PARAMS(separate_1) "<tr name='sensor_3' class='_hidden'>"
        ...
        append HTML_PARAMS(separate_1) "<td>[getTextFieldIdentityString psDescr $CHANNEL $param $ps($param) separate_${special_input_id}_$prn $defaultVal][getHelpIcon "ENERGY_COUNTER_STRING_CH2_V2" $hlpBoxWidth $hlpBoxHeight]</td>"
      append HTML_PARAMS(separate_1) "</tr>"
