...
jQuery.extend(true,langJSON, {
  "de" : {
    ...
    "dialogSettingsAdvancedSettingsTitle" : "Erweiterte Einstellungen",
    "dialogSettingsAdvancedSettingsRebootHint" : "Damit die %C4nderungen wirksam werden, muss die "+HMIdentifier.de.CCUShortName +" neu gestartet werden.",
    "dialogSettingsAdvancedSettingsWatchDog" : "WatchDog-%DCberwachung",
    "dialogSettingsAdvancedSettingsInternetCheck" : "Internet-Check",
    "dialogSettingsAdvancedSettingsRpi4usb3Check" : "RPI4-USB3-Check",
    "dialogSettingsAdvancedSettingsHintWatchDogCheck1" : "<b>Internet-Check:</b><br/>Es wird eine Alarmmeldung generiert, falls die Internet-Verbindung ausf%E4llt",
    "dialogSettingsAdvancedSettingsHintWatchDogCheck2" : "<b>RPI4-USB3-Check:</b><br/>Es wird eine Alarmmeldung generiert, wenn ein RaspberryPi 4 mit aufgestecktem Funkmodul und angeschlossenem USB-Ger%E4t am USB3 Port verwendet wird.",
    "dialogSettingsAdvancedSettingsSystem" : "allgemeine System-Optionen",
    "dialogSettingsAdvancedSettingsMediola" : "Mediola NEO-Server",
    "dialogSettingsAdvancedSettingsCronBackup" : "cron-geplante Backups",
    "dialogSettingsAdvancedSettingsCronBackupPath" : "Backup-Pfad",
    "dialogSettingsAdvancedSettingsCronBackupPathPlaceholder" : "<Systemvorgabe>",
    "dialogSettingsAdvancedSettingsCronBackupMaxBackups" : "max. Backup-Anzahl",
    "dialogSettingsAdvancedSettingsCustomStoragePath" : "Storage-Pfad",
    "dialogSettingsAdvancedSettingsCustomStoragePathPlaceholder" : "<Systemvorgabe>",
    "dialogSettingsAdvancedSettingsDCVars" : "Duty-Cycle Variablen anlegen",
    "dialogSettingsAdvancedSettingsDisableLED" : "RF-LED deaktivieren",
    "dialogSettingsAdvancedSettingsDisableOnboardLED" : "Onboard-LED deaktivieren",
    "dialogSettingsAdvancedSettingsBadBlocksCheck" : "Bad Blocks Check",
    "dialogSettingsAdvancedSettingsFSTRIM" : "FSTRIM",
    "dialogSettingsAdvancedSettingsHintSystem1" : "<b>Mediola:</b><br/>Ist die Option deaktiviert, wird die NEO-Server Instanz nicht automatisch gestartet",
    "dialogSettingsAdvancedSettingsHintSystem2" : "<b>cron-geplante Backups:</b><br/>automatische Backups werden t%E4glich erzeugt und auf ein angeschlossenes (USB-)Medium oder einem anderen konfigurierten Pfad gespeichert",
    "dialogSettingsAdvancedSettingsHintSystem3" : "<b>Backup-Pfad:</b><br/>Speicherort der Backups",
    "dialogSettingsAdvancedSettingsHintSystem4" : "<b>max. Backup-Anzahl:</b><br/>es wird nur die angegebene Anzahl an Backups aufbewahrt (leer lassen, um automatisches L%F6schen zu deaktivieren)",
    "dialogSettingsAdvancedSettingsHintSystem5" : "<b>Duty-Cycle Variablen anlegen:</b><br/>Es werden automatisch Systemvariablen mit den DutyCycle-Werten aller Funk-Interfaces angelegt und aktualisiert",
    "dialogSettingsAdvancedSettingsHintSystem6" : "<b>RF-LED deaktivieren:</b><br/>Es wird die LED am RPI-RF-MOD deaktiviert",
    "dialogSettingsAdvancedSettingsHintSystem7" : "<b>Onboard-LED deaktivieren:</b><br/>Es werden die LEDs am RaspberryPi-Systemboard deaktiviert",
    "dialogSettingsAdvancedSettingsHintSystem8" : "<b>Bad Blocks Check:</b><br/>Es wird t%E4glich nachts eine Block-%DCberpr%FCfung der SD-Karte durchgef%FChrt",
    "dialogSettingsAdvancedSettingsHintSystem9" : "<b>FSTRIM:</b><br/>Es wird t%E4glich nachts FSTRIM zum Freigeben nicht mehr genutzter Speicherbereiche ausgef%FChrt",
    "dialogSettingsAdvancedSettingsHintSystem10" : "<b>Storage-Pfad:</b><br/>Pfad f%FCr Diagramme",
    "dialogSettingsAdvancedSettingsExpert" : "Experte",
    "dialogSettingsAdvancedSettingsDevConfig" : "DevConfig-Button",
    "dialogSettingsAdvancedSettingsHintExpert1" : "<b>DevConfig-Button:</b><br/>aktiviert den DevConfig-Button in der Systemsteuerung",
