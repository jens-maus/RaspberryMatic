...
jQuery.extend(true,langJSON, {
  "en" : {
    ...
    "dialogSettingsAdvancedSettingsTitle" : "Advanced settings",
    "dialogSettingsAdvancedSettingsRebootHint" : HMIdentifier.de.CCUShortName +" needs to be restartet in order to apply the changes.",
    "dialogSettingsAdvancedSettingsWatchDog" : "WatchDog-Monitoring",
    "dialogSettingsAdvancedSettingsInternetCheck" : "Internet-Check",
    "dialogSettingsAdvancedSettingsRpi4usb3Check" : "RPI4-USB3-Check",
    "dialogSettingsAdvancedSettingsHintWatchDogCheck1" : "<b>Internet-Check:</b><br/>an alarm is generated, if the internet connection fails",
    "dialogSettingsAdvancedSettingsHintWatchDogCheck2" : "<b>RPI4-USB3-Check:</b><br/>an alarm is generated when using a RaspberryPi 4 with stacked radio module and connected device(s) on usb3 port",
    "dialogSettingsAdvancedSettingsSystem" : "Common System Options",
    "dialogSettingsAdvancedSettingsMediola" : "Mediola NEO-Server",
    "dialogSettingsAdvancedSettingsCronBackup" : "cron-scheduled backups",
    "dialogSettingsAdvancedSettingsCronBackupPath" : "backup path",
    "dialogSettingsAdvancedSettingsCronBackupPathPlaceholder" : "<default>",
    "dialogSettingsAdvancedSettingsCronBackupMaxBackups" : "max. backup count",
    "dialogSettingsAdvancedSettingsCustomStoragePath" : "storage path",
    "dialogSettingsAdvancedSettingsCustomStoragePathPlaceholder" : "<default>",
    "dialogSettingsAdvancedSettingsDCVars" : "create Duty-Cycle variables",
    "dialogSettingsAdvancedSettingsDisableLED" : "disable rf leds",
    "dialogSettingsAdvancedSettingsDisableOnboardLED" : "disable onboard leds",
    "dialogSettingsAdvancedSettingsBadBlocksCheck" : "Bad Blocks Check",
    "dialogSettingsAdvancedSettingsFSTRIM" : "FSTRIM",
    "dialogSettingsAdvancedSettingsHintSystem1" : "<b>Mediola:</b><br/>if deactivated, the NEO-Server instance will not start on boot",
    "dialogSettingsAdvancedSettingsHintSystem2" : "<b>cron-scheduled backup:</b><br/>create daily backups and save them to a connected external (usb) stick",
    "dialogSettingsAdvancedSettingsHintSystem3" : "<b>backup path:</b><br/>location, where backups are saved",
    "dialogSettingsAdvancedSettingsHintSystem4" : "<b>max. backup count:</b><br/>indicates how many backups should be kept (leave empty, for no automatic delete)",
    "dialogSettingsAdvancedSettingsHintSystem5" : "<b>create Duty-Cycle variables:</b><br/>system variables containing the duty cycle value for each rf interface are generated and updated periodically",
    "dialogSettingsAdvancedSettingsHintSystem6" : "<b>disable rf leds:</b><br/>disables the RPI-RF-MOD led",
    "dialogSettingsAdvancedSettingsHintSystem7" : "<b>disable onboard leds:</b><br/>disables the leds on the raspberry pi system board",
    "dialogSettingsAdvancedSettingsHintSystem8" : "<b>Bad Blocks Check:</b><br/>nightly check for bad blocks (on SD cards)",
    "dialogSettingsAdvancedSettingsHintSystem9" : "<b>FSTRIM:</b><br/>nightly task to discard blocks which are not in use by the filesystem",
    "dialogSettingsAdvancedSettingsHintSystem10" : "<b>storage path:</b><br/>path for diagrams",
    "dialogSettingsAdvancedSettingsExpert" : "Expert",
    "dialogSettingsAdvancedSettingsDevConfig" : "DevConfig-Button",
    "dialogSettingsAdvancedSettingsHintExpert1" : "<b>DevConfig-Button:</b><br/>show the DevConfig button on the control panel",
    "dialogSettingsAdvancedSettingsMessageAlertMessageError1" : "error while saving",
