...
jQuery.extend(true,langJSON, {
  "en" : {
    ...
    "dialogSettingsAdvancedSettingsCustomStoragePath" : "Diagram Storage Path",
    ...
    "dialogSettingsAdvancedSettingsHintSystem9" : "<b>Diagram Storage Path:</b><br/>As an alternative to the default of saving diagram data to e.g. a connected USB drive, an own directory path can be entered here (requires reboot).",
