...
jQuery.extend(true,langJSON, {
  "en" : {
    ...
    "dialogSettingsNetworkCertificateLblUpload" : "Upload",
	  "dialogSettingsNetworkHintCertificateP1" : "A certificate is required to enable secure access to your  " + HMIdentifier.en.CCUFullNameText + ". If no certificate is available, one is automatically generated by the central unit.",
    "dialogSettingsNetworkHintCertificateP2" : "You have the option of replacing the automatically generated certificate with your own certificate or deleting the certificate currently in use.",
