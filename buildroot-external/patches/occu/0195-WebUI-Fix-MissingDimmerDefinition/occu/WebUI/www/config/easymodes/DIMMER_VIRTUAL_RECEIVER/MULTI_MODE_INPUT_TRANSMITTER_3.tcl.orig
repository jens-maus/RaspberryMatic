...
set SUBSET_2(SHORT_CT_RAMPON) 0
...
set SUBSET_5(SHORT_CT_RAMPOFF)  5
set SUBSET_5(SHORT_CT_RAMPON) 5
...
#1
  ...
  append HTML_PARAMS(separate_$prn) [subset2combobox {SUBSET_6 SUBSET_7} subset_$prn\_$pref separate_${special_input_id}_$prn\_$pref PROFILE_$prn]
...
#2
  ...
  append HTML_PARAMS(separate_$prn) "<tr><td>\${SWITCH_SIGNAL}&nbsp;\${at}</td><td>"
